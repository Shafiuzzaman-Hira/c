...
void ldv_spin_lock_queued_bufs_lock_of_pwc_device(void) ;
void ldv_spin_unlock_queued_bufs_lock_of_pwc_device(void) ;
...
{ 
  ...
  {
  {
  ldv_dev_set_drvdata_45(& vdev->dev, data);
  }
  return;
}
}
...
{ 
  ...
  ldv___ldv_spin_lock_50(& pdev->queued_bufs_lock);
  ...
  leave: 
  {
  ldv_spin_unlock_irqrestore_51(& pdev->queued_bufs_lock, flags);
  }
  return (buf);
}
}
...
{ 
  ...
  {
  flags = 0UL;
  ldv___ldv_spin_lock_52(& pdev->queued_bufs_lock);
  }
  goto ldv_35021;
  ldv_35020: 
  {
...
{ 
  ...
  {
  ldv___ldv_spin_lock_54(& pdev->queued_bufs_lock);
...
{ 
  ...
  __raw_spin_lock_init(& pdev->queued_bufs_lock.__annonCompField19.rlock, "&(&pdev->queued_bufs_lock)->rlock",
                       & __key___1);
...
{ 
  ...
  {
  {
  tmp = ldv_usb_register_driver_56(& pwc_driver, & __this_module, "pwc");
  }
  return (tmp);
}
}
...
{ 
  ...
  {
  {
  ldv_usb_deregister_57(& pwc_driver);
  }
  return;
}
}
...
{ 
  ...
  {
  {
  ldv_spin_lock_queued_bufs_lock_of_pwc_device();
...
{ 
  ...
  {
  {
  ldv_spin_unlock_queued_bufs_lock_of_pwc_device();
...
static int ldv_spin_queued_bufs_lock_of_pwc_device  =    1;
void ldv_spin_lock_queued_bufs_lock_of_pwc_device(void) 
{ 
  ...
  {
  {
  ldv_assert_linux_kernel_locking_spinlock__one_thread_double_lock(ldv_spin_queued_bufs_lock_of_pwc_device == 1);
  ldv_assume(ldv_spin_queued_bufs_lock_of_pwc_device == 1);
  ldv_spin_queued_bufs_lock_of_pwc_device = 2;
  }
  return;
}
}
...
{ 
  ...
  {
  {
  ldv_assert_linux_kernel_locking_spinlock__one_thread_double_unlock(ldv_spin_queued_bufs_lock_of_pwc_device == 2);
  ldv_assume(ldv_spin_queued_bufs_lock_of_pwc_device == 2);
  ldv_spin_queued_bufs_lock_of_pwc_device = 1;
  }
  return;
}
}
int ldv_spin_trylock_queued_bufs_lock_of_pwc_device(void) 
{ 
  int is_spin_held_by_another_thread ;

  {
  {
  ldv_assert_linux_kernel_locking_spinlock__one_thread_double_lock_try(ldv_spin_queued_bufs_lock_of_pwc_device == 1);
  ldv_assume(ldv_spin_queued_bufs_lock_of_pwc_device == 1);
  is_spin_held_by_another_thread = ldv_undef_int();
  }
  if (is_spin_held_by_another_thread != 0) {
...
void ldv_spin_unlock_wait_queued_bufs_lock_of_pwc_device(void) 
{ 
...
int ldv_spin_is_locked_queued_bufs_lock_of_pwc_device(void) 
{ 
  int is_spin_held_by_another_thread ;
  ...
  if (ldv_spin_queued_bufs_lock_of_pwc_device == 1 && is_spin_held_by_another_thread == 0) {
    return (0);
  } else {
    return (1);
  }
...
int ldv_spin_can_lock_queued_bufs_lock_of_pwc_device(void) 
{ 
  int tmp ;

  {
  {
  tmp = ldv_spin_is_locked_queued_bufs_lock_of_pwc_device();
  }
  return (tmp == 0);
}
}
int ldv_spin_is_contended_queued_bufs_lock_of_pwc_device(void) 
{ 
  int is_spin_contended ;
...
int ldv_atomic_dec_and_lock_queued_bufs_lock_of_pwc_device(void) 
{ 
  int atomic_value_after_dec ;
...
{ 
  ...
  ldv_assert_linux_kernel_locking_spinlock__one_thread_locked_at_exit(ldv_spin_queued_bufs_lock_of_pwc_device == 1);
...
{ 
  ...
  if (ldv_spin_queued_bufs_lock_of_pwc_device == 2) {
    return (1);
  } else {
...
#include "model/linux-3.14__complex_emg__linux-kernel-locking-spinlock__drivers-media-usb-pwc-pwc_true-unreach-call.cil.env.c"
