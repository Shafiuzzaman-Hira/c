...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-4.2-rc1.tar.xz-08_1a-drivers--atm--atmtcp.ko-entry_point.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
__inline static void atm_dev_put(struct atm_dev *dev )
{
  ...
  if (tmp___1 != 0) {
    ...
    if ((unsigned long )(dev->ops)->dev_close != (unsigned long )((void (* )(struct atm_dev * ))0)) {
