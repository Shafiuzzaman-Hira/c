...
void step(void) {
	// From: Req1Batch95has_floats
	var_1_1 = (abs (last_1_var_1_7));


	// From: Req2Batch95has_floats
	var_1_3 = ((var_1_4 - var_1_5) + (min (256.5f , (var_1_6 - 16.125f))));


	// From: Req5Batch95has_floats
	var_1_16 = var_1_17;


	// From: Req3Batch95has_floats
