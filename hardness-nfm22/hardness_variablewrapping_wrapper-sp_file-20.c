...
void step(void) {
	...
	if (stepLocal_1 >= (*(WrapperStruct00_var_1_11_Pointer))) {
		if ((*(WrapperStruct00_var_1_1_Pointer)) >= (*(WrapperStruct00_var_1_8_Pointer))) {
			...
			if (stepLocal_2 >= (abs ((*(WrapperStruct00_var_1_12_Pointer))))) {
	...
	if ((*(WrapperStruct00_var_1_10_Pointer)) || stepLocal_0) {
		...
		(*(WrapperStruct00_var_1_9_Pointer)) = ((*(WrapperStruct00_var_1_14_Pointer)) + (abs ((*(WrapperStruct00_var_1_14_Pointer)))));
	}
}
