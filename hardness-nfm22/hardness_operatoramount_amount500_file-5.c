...
void step(void) {
	...
	if (stepLocal_18 <= (last_1_var_1_71 + var_1_62)) {
		if (stepLocal_17 < last_1_var_1_105) {
			if (last_1_var_1_58) {
				var_1_71 = (max ((var_1_72 - (var_1_73 - var_1_54)) , var_1_43));
			} else {
				var_1_71 = ((max (var_1_72 , var_1_74)) - 50);
			}
		} else {
		...
		if ((last_1_var_1_107 >> var_1_76) <= stepLocal_16) {
			...
			if (var_1_3 <= (min (last_1_var_1_111 , last_1_var_1_35))) {
				var_1_71 = (max (var_1_80 , var_1_76));
			} else {
	...
	var_1_95 = ((min (var_1_55 , var_1_44)) - var_1_78);


	// From: Req28Batch5Amount500
	if (var_1_37 == var_1_68) {
		var_1_96 = (var_1_44 - (var_1_97 - (min (32 , var_1_79))));
	} else {
		var_1_96 = (5 - var_1_44);
	}
	...
	if (var_1_34 >= stepLocal_31) {
		...
		var_1_98 = (max (var_1_95 , var_1_78));
	}
	...
	if (stepLocal_15 > (var_1_62 - (var_1_71 + var_1_112))) {
		var_1_67 = (var_1_26 + (var_1_68 + (max (var_1_69 , 10.25f))));
	} else {
		var_1_67 = (abs (var_1_23));
	}


	// From: Req4Batch5Amount500
	if ((min (var_1_12 , var_1_114)) <= (var_1_105 / (max (-50 , var_1_32)))) {
		var_1_31 = (var_1_33 - var_1_34);
	}


	// From: Req14Batch5Amount500
	unsigned long int stepLocal_14 = min (var_1_112 , 10000u);
	...
	if (var_1_114 > (-1 % -32)) {
		if (var_1_47 && var_1_46) {
			var_1_70 = (min (var_1_53 , (var_1_55 - (64 - var_1_54))));
		}
	} else {
	...
	if (stepLocal_24 >= 64) {
		var_1_83 = (max (var_1_52 , var_1_79));
	} else {
	...
	if (stepLocal_26 <= var_1_103) {
		var_1_88 = (max (1000u , (3865917038u - var_1_74)));
	}


	// From: Req25Batch5Amount500
	if (var_1_46) {
		var_1_90 = (((max (var_1_73 , 10000000)) + (var_1_64 - var_1_39)) - var_1_98);
	} else {
		if (var_1_103 < (min ((var_1_43 - var_1_73) , (var_1_34 + var_1_39)))) {
			var_1_90 = -8;
		} else {
			var_1_90 = (((abs (var_1_91)) - (var_1_64 - var_1_39)) - var_1_103);
		}
	}
	...
	if (! var_1_106) {
		...
		if (var_1_36 >= 50.5) {
			...
			if (var_1_35 < var_1_23) {
				var_1_89 = (max ((max (var_1_55 , 0)) , (max (var_1_34 , (min (var_1_80 , var_1_74))))));
			} else {
				var_1_89 = ((max (var_1_55 , var_1_54)) + var_1_34);
			}
		}
	}
	...
	if ((max (var_1_25 , var_1_3)) > var_1_37) {
	...
	signed long int stepLocal_10 = var_1_33 - (max (var_1_34 , var_1_43));
	...
	signed long int stepLocal_22 = (min (16 , var_1_32)) + var_1_40;
	if (stepLocal_22 >= var_1_39) {
		var_1_82 = ((var_1_114 + (min (var_1_74 , var_1_100))) + var_1_103);
	} else {
	...
	if (stepLocal_32 >= (var_1_73 ^ (var_1_54 + var_1_100))) {
		var_1_99 = (min (var_1_55 , var_1_114));
	} else {
	...
	if (var_1_85 || var_1_27) {
		...
		var_1_87 = ((abs (var_1_20)) - (var_1_22 + var_1_26));
	}
	...
	if ((var_1_39 - var_1_34) != stepLocal_35) {
		if (stepLocal_36 <= var_1_100) {
			if (! var_1_85) {
				var_1_101 = (min (var_1_55 , var_1_77));
			} else {
				var_1_101 = (min (var_1_77 , var_1_34));
			}
		} else {
			var_1_101 = (min (((min (var_1_78 , var_1_79)) - var_1_97) , (var_1_34 - var_1_54)));
		}
	} else {
	...
	if (stepLocal_12 || (var_1_4 <= (var_1_108 + 49.2))) {
		if (var_1_46 && stepLocal_11) {
			if (var_1_29) {
				...
				var_1_48 = (min (var_1_49 , var_1_33));
			}
		}
	} else {
	...
	if (var_1_108 > (var_1_3 - var_1_4)) {
		if ((var_1_3 < var_1_4) && stepLocal_0) {
			if (-256 >= stepLocal_1) {
				var_1_1 = (min (var_1_83 , var_1_114));
			} else {
				var_1_1 = (((1000000000 - var_1_71) + (1000000000 - var_1_114)) - var_1_84);
			}
		} else {
			var_1_1 = (min ((var_1_71 - var_1_84) , ((64 - var_1_114) + -100)));
		}
	} else {
	...
	if (var_1_85) {
		if (var_1_4 < (- (max (var_1_3 , var_1_108)))) {
			var_1_14 = var_1_15;
		} else {
			if (var_1_27) {
				...
				if (256.5 < (var_1_4 - var_1_3)) {
					if (stepLocal_4 > (abs (var_1_40))) {
						var_1_14 = (abs (var_1_15));
					} else {
						if ((var_1_114 >> var_1_96) >= stepLocal_3) {
							var_1_14 = (var_1_20 + var_1_21);
						} else {
							var_1_14 = ((max (var_1_20 , var_1_21)) + ((min (var_1_22 , var_1_23)) - var_1_24));
						}
					}
				}
			}
		...
		if (var_1_24 < var_1_22) {
			if (stepLocal_5 <= ((abs (var_1_89)) % var_1_12)) {
				var_1_14 = (max (var_1_21 , var_1_15));
			} else {
				var_1_14 = (min (var_1_21 , (var_1_22 - var_1_23)));
			}
		} else {
	...
	if (var_1_55 <= (min (var_1_39 , (abs (var_1_52))))) {
		if (var_1_48 > var_1_53) {
			var_1_60 = var_1_54;
		} else {
			var_1_60 = (max ((var_1_100 + var_1_84) , (abs (var_1_89))));
		}
	} else {
	...
	if (var_1_59 >= stepLocal_28) {
		if (stepLocal_29 && var_1_106) {
			...
			var_1_92 = ((2102729077 - (1 + var_1_43)) - (abs (var_1_76)));
		}
	} else {
		if (stepLocal_27 == (min ((2989760416u - var_1_39) , (var_1_112 >> var_1_89)))) {
			if (! var_1_45) {
...
int property() {
	return (((((((((((((((((((((((((((((((((((((((((((((var_1_108 > (var_1_3 - var_1_4)) ? (((var_1_3 < var_1_4) && var_1_45) ? ((-256 >= var_1_112) ? (var_1_1 == ((signed long int) (min (var_1_83 , var_1_114)))) : (var_1_1 == ((signed long int) (((1000000000 - var_1_71) + (1000000000 - var_1_114)) - var_1_84)))) : (var_1_1 == ((signed long int) (min ((var_1_71 - var_1_84) , ((64 - var_1_114) + -100)))))) : ((var_1_114 >= ((var_1_83 / 100000) / var_1_12)) ? (var_1_1 == ((signed long int) var_1_70)) : 1)) && (var_1_85 ? ((var_1_4 < (- (max (var_1_3 , var_1_108)))) ? (var_1_14 == ((double) var_1_15)) : (var_1_27 ? (var_1_14 == ((double) (abs (var_1_15)))) : ((256.5 < (var_1_4 - var_1_3)) ? ((((var_1_112 + var_1_114) - var_1_89) > (abs (var_1_40))) ? (var_1_14 == ((double) (abs (var_1_15)))) : (((var_1_114 >> var_1_96) >= -128) ? (var_1_14 == ((double) (var_1_20 + var_1_21))) : (var_1_14 == ((double) ((max (var_1_20 , var_1_21)) + ((min (var_1_22 , var_1_23)) - var_1_24)))))) : 1))) : ((var_1_24 < var_1_22) ? ((var_1_96 <= ((abs (var_1_89)) % var_1_12)) ? (var_1_14 == ((double) (max (var_1_21 , var_1_15)))) : (var_1_14 == ((double) (min (var_1_21 , (var_1_22 - var_1_23)))))) : (var_1_14 == ((double) ((var_1_24 + (var_1_25 - var_1_26)) - var_1_23)))))) && ((var_1_35 < -0.375) ? (var_1_27 == ((unsigned char) (! var_1_28))) : ((((9.6 + var_1_4) <= var_1_3) && (var_1_112 > (var_1_98 * var_1_112))) ? ((! var_1_45) ? ((var_1_112 < var_1_98) ? (var_1_27 == ((unsigned char) var_1_28)) : ((var_1_45 && var_1_28) ? (var_1_27 == ((unsigned char) (var_1_45 && var_1_29))) : 1)) : (var_1_27 == ((unsigned char) ((var_1_28 && (! var_1_29)) && (var_1_45 || var_1_30))))) : (var_1_27 == ((unsigned char) (var_1_45 && (! var_1_28))))))) && (((min (var_1_12 , var_1_114)) <= (var_1_105 / (max (-50 , var_1_32)))) ? (var_1_31 == ((signed char) (var_1_33 - var_1_34))) : 1)) && ((var_1_40 != var_1_103) ? (var_1_30 ? (var_1_35 == ((double) var_1_26)) : (var_1_35 == ((double) var_1_36))) : (var_1_35 == ((double) var_1_37)))) && ((! last_1_var_1_102) ? (var_1_38 == ((unsigned short int) (54265 - last_1_var_1_103))) : (var_1_38 == ((unsigned short int) (var_1_39 - (last_1_var_1_100 + (var_1_34 + 4))))))) && (var_1_40 == ((signed short int) ((var_1_71 + var_1_112) - var_1_103)))) && (((var_1_33 - (max (var_1_34 , var_1_43))) != (var_1_89 << var_1_44)) ? (var_1_42 == ((signed long int) (var_1_114 + var_1_43))) : (var_1_42 == ((signed long int) (abs (var_1_31)))))) && ((var_1_22 > (31.6 / var_1_25)) ? ((var_1_39 < var_1_89) ? (var_1_45 == ((unsigned char) (var_1_102 || (var_1_85 || var_1_30)))) : ((var_1_24 > (var_1_36 / var_1_25)) ? ((var_1_111 > (- var_1_20)) ? (((var_1_21 <= var_1_22) && var_1_29) ? (var_1_45 == ((unsigned char) (var_1_28 || (var_1_46 && var_1_47)))) : 1) : 1) : (var_1_45 == ((unsigned char) ((var_1_103 <= var_1_38) || (! var_1_29)))))) : (var_1_45 == ((unsigned char) (! var_1_28))))) && (((var_1_38 > var_1_109) || (var_1_4 <= (var_1_108 + 49.2))) ? ((var_1_46 && var_1_30) ? (var_1_29 ? (var_1_48 == ((signed char) (var_1_44 - var_1_34))) : (var_1_48 == ((signed char) (min (var_1_49 , var_1_33))))) : 1) : (var_1_48 == ((signed char) (var_1_49 + var_1_51))))) && (((var_1_109 + (var_1_34 & var_1_107)) == (32 % var_1_39)) ? (var_1_56 == ((unsigned char) var_1_46)) : (var_1_56 == ((unsigned char) (((var_1_46 && var_1_58) && var_1_29) || var_1_57))))) && (((var_1_12 * 32) > (64 - (var_1_59 - last_1_var_1_114))) ? (var_1_58 == ((unsigned char) (last_1_var_1_56 && (var_1_29 || var_1_57)))) : (var_1_58 == ((unsigned char) var_1_57)))) && ((var_1_55 <= (min (var_1_39 , (abs (var_1_52))))) ? ((var_1_48 > var_1_53) ? (var_1_60 == ((unsigned long int) var_1_54)) : (var_1_60 == ((unsigned long int) (max ((var_1_100 + var_1_84) , (abs (var_1_89))))))) : ((var_1_12 > (var_1_98 | var_1_70)) ? (var_1_60 == ((unsigned long int) (var_1_62 - ((var_1_63 - var_1_114) + (var_1_64 - var_1_34))))) : ((var_1_52 <= -128) ? (var_1_60 == ((unsigned long int) var_1_43)) : 1)))) && ((var_1_108 > (- var_1_21)) ? ((var_1_114 != (min (var_1_112 , 10000u))) ? (var_1_65 == ((double) ((var_1_66 - (var_1_25 - 256.375)) - var_1_26))) : 1) : 1)) && ((100u > (var_1_62 - (var_1_71 + var_1_112))) ? (var_1_67 == ((float) (var_1_26 + (var_1_68 + (max (var_1_69 , 10.25f)))))) : (var_1_67 == ((float) (abs (var_1_23)))))) && ((var_1_114 > (-1 % -32)) ? ((var_1_47 && var_1_46) ? (var_1_70 == ((signed char) (min (var_1_53 , (var_1_55 - (64 - var_1_54)))))) : 1) : (var_1_70 == ((signed char) (var_1_55 - var_1_54))))) && ((var_1_44 <= (last_1_var_1_71 + var_1_62)) ? ((last_1_var_1_40 < last_1_var_1_105) ? (last_1_var_1_58 ? (var_1_71 == ((unsigned char) (max ((var_1_72 - (var_1_73 - var_1_54)) , var_1_43)))) : (var_1_71 == ((unsigned char) ((max (var_1_72 , var_1_74)) - 50)))) : ((last_1_var_1_40 > var_1_12) ? (var_1_71 == ((unsigned char) var_1_72)) : 1)) : (((last_1_var_1_107 >> var_1_76) <= var_1_59) ? ((var_1_49 == var_1_54) ? (var_1_71 == ((unsigned char) ((var_1_77 - var_1_76) - (var_1_78 + (var_1_79 - var_1_44))))) : (var_1_71 == ((unsigned char) ((var_1_73 - var_1_79) + var_1_44)))) : ((var_1_3 <= (min (last_1_var_1_111 , last_1_var_1_35))) ? (var_1_71 == ((unsigned char) (max (var_1_80 , var_1_76)))) : ((var_1_33 == last_1_var_1_48) ? (var_1_71 == ((unsigned char) (var_1_43 + var_1_73))) : 1))))) && ((((min (16 , var_1_32)) + var_1_40) >= var_1_39) ? (var_1_82 == ((signed long int) ((var_1_114 + (min (var_1_74 , var_1_100))) + var_1_103))) : ((var_1_114 < var_1_38) ? (var_1_82 == ((signed long int) var_1_96)) : 1))) && ((var_1_72 >= 64) ? (var_1_83 == ((signed short int) (max (var_1_52 , var_1_79)))) : ((var_1_23 >= var_1_69) ? (var_1_83 == ((signed short int) 100)) : (var_1_83 == ((signed short int) (var_1_78 + (var_1_96 + 16))))))) && ((! (var_1_32 >= var_1_77)) ? ((var_1_27 || var_1_46) ? (var_1_84 == ((unsigned short int) var_1_55)) : 1) : 1)) && (((max (var_1_25 , var_1_3)) > var_1_37) ? ((var_1_55 <= var_1_79) ? ((63.7f < var_1_65) ? (var_1_85 == ((unsigned char) (var_1_46 || (var_1_47 && (! var_1_29))))) : (var_1_85 == ((unsigned char) ((! (! var_1_58)) || var_1_28)))) : 1) : 1)) && ((var_1_85 || var_1_27) ? (var_1_87 == ((double) (var_1_22 - var_1_66))) : (var_1_87 == ((double) ((abs (var_1_20)) - (var_1_22 + var_1_26)))))) && (((var_1_39 - var_1_72) <= var_1_103) ? (var_1_88 == ((unsigned long int) (max (1000u , (3865917038u - var_1_74))))) : 1)) && ((! var_1_106) ? (var_1_89 == ((unsigned char) (var_1_79 + ((8 + var_1_54) + var_1_55)))) : ((var_1_36 >= 50.5) ? (var_1_89 == ((unsigned char) (var_1_72 - ((var_1_44 + var_1_54) + var_1_79)))) : ((var_1_35 < var_1_23) ? (var_1_89 == ((unsigned char) (max ((max (var_1_55 , 0)) , (max (var_1_34 , (min (var_1_80 , var_1_74)))))))) : (var_1_89 == ((unsigned char) ((max (var_1_55 , var_1_54)) + var_1_34))))))) && (var_1_46 ? (var_1_90 == ((signed long int) (((max (var_1_73 , 10000000)) + (var_1_64 - var_1_39)) - var_1_98))) : ((var_1_103 < (min ((var_1_43 - var_1_73) , (var_1_34 + var_1_39)))) ? (var_1_90 == ((signed long int) -8)) : (var_1_90 == ((signed long int) (((abs (var_1_91)) - (var_1_64 - var_1_39)) - var_1_103)))))) && ((var_1_59 >= (var_1_74 + (var_1_32 & var_1_72))) ? ((var_1_56 && var_1_106) ? (var_1_92 == ((signed long int) (var_1_33 + var_1_55))) : (var_1_92 == ((signed long int) ((2102729077 - (1 + var_1_43)) - (abs (var_1_76)))))) : ((((var_1_78 % var_1_77) * var_1_63) == (min ((2989760416u - var_1_39) , (var_1_112 >> var_1_89)))) ? ((! var_1_45) ? (var_1_92 == ((signed long int) (-1 - (var_1_93 - (var_1_79 + var_1_103))))) : (((var_1_66 == var_1_69) && var_1_106) ? (var_1_92 == ((signed long int) (((var_1_94 - var_1_80) - var_1_105) - 256))) : (var_1_92 == ((signed long int) (((var_1_94 - var_1_114) - var_1_80) - var_1_89))))) : 1))) && (var_1_95 == ((signed long int) ((min (var_1_55 , var_1_44)) - var_1_78)))) && ((var_1_37 == var_1_68) ? (var_1_96 == ((signed char) (var_1_44 - (var_1_97 - (min (32 , var_1_79)))))) : (var_1_96 == ((signed char) (5 - var_1_44))))) && ((var_1_34 >= var_1_49) ? (var_1_98 == ((signed short int) var_1_50)) : (var_1_98 == ((signed short int) (max (var_1_95 , var_1_78)))))) && (((var_1_55 << 2) >= (var_1_73 ^ (var_1_54 + var_1_100))) ? (var_1_99 == ((signed long int) (min (var_1_55 , var_1_114)))) : (var_1_99 == ((signed long int) (var_1_100 - var_1_76))))) && ((var_1_23 >= var_1_67) ? (var_1_100 == ((unsigned char) var_1_54)) : ((var_1_88 == (var_1_38 / var_1_39)) ? (var_1_100 == ((unsigned char) (var_1_77 - var_1_79))) : (var_1_100 == ((unsigned char) var_1_79))))) && (((var_1_39 - var_1_34) != var_1_84) ? ((var_1_103 <= var_1_100) ? ((! var_1_85) ? (var_1_101 == ((signed char) (min (var_1_55 , var_1_77)))) : (var_1_101 == ((signed char) (min (var_1_77 , var_1_34))))) : (var_1_101 == ((signed char) (min (((min (var_1_78 , var_1_79)) - var_1_97) , (var_1_34 - var_1_54)))))) : ((var_1_106 || var_1_85) ? (var_1_101 == ((signed char) (var_1_44 - (var_1_97 - var_1_55)))) : 1))) && (((var_1_96 % var_1_91) <= var_1_80) ? (var_1_102 == ((unsigned char) var_1_57)) : (var_1_102 == ((unsigned char) var_1_47)))) && (var_1_46 ? (var_1_103 == ((unsigned char) var_1_97)) : (var_1_103 == ((unsigned char) 1)))) && (var_1_58 ? (var_1_104 == ((unsigned long int) var_1_114)) : (var_1_104 == ((unsigned long int) var_1_39)))) && (var_1_46 ? (var_1_105 == ((unsigned short int) var_1_71)) : (var_1_105 == ((unsigned short int) var_1_114)))) && (var_1_106 == ((unsigned char) var_1_57))) && (var_1_102 ? (var_1_107 == ((unsigned long int) var_1_80)) : 1)) && (var_1_106 ? (var_1_108 == ((double) 25.25)) : 1)) && (var_1_45 ? (var_1_109 == ((unsigned long int) var_1_97)) : (var_1_109 == ((unsigned long int) var_1_44)))) && (var_1_85 ? (var_1_110 == ((signed short int) var_1_33)) : (var_1_110 == ((signed short int) var_1_105)))) && ((var_1_37 >= (var_1_21 + var_1_108)) ? (var_1_111 == ((float) ((var_1_24 - var_1_25) + var_1_23))) : 1)) && (var_1_112 == ((unsigned char) 25))) && (var_1_113 == ((signed short int) var_1_53))) && (var_1_114 == ((unsigned char) var_1_78))
;
}
int main(void) {
	isInitial = 1;
