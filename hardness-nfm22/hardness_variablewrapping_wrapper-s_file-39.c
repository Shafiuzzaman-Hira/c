...
void step(void) {
	// From: Req1Batch39Wrapper_S
	WrapperStruct00.var_1_1 = (((max (16 , 4)) + WrapperStruct00.var_1_2) - (WrapperStruct00.var_1_3 + (min (WrapperStruct00.var_1_4 , WrapperStruct00.var_1_5))));


	// From: Req2Batch39Wrapper_S
	if (WrapperStruct00.var_1_2 >= WrapperStruct00.var_1_1) {
		if ((abs (WrapperStruct00.var_1_7 + WrapperStruct00.var_1_8)) < WrapperStruct00.var_1_9) {
	...
	if (stepLocal_1 != WrapperStruct00.var_1_5) {
		if ((WrapperStruct00.var_1_3 / WrapperStruct00.var_1_11) < stepLocal_0) {
			WrapperStruct00.var_1_10 = (min (-256 , (min (WrapperStruct00.var_1_4 , (max (WrapperStruct00.var_1_5 , WrapperStruct00.var_1_2))))));
		} else {
...
int property() {
	return ((WrapperStruct00.var_1_1 == ((signed short int) (((max (16 , 4)) + WrapperStruct00.var_1_2) - (WrapperStruct00.var_1_3 + (min (WrapperStruct00.var_1_4 , WrapperStruct00.var_1_5)))))) && ((WrapperStruct00.var_1_2 >= WrapperStruct00.var_1_1) ? (((abs (WrapperStruct00.var_1_7 + WrapperStruct00.var_1_8)) < WrapperStruct00.var_1_9) ? (WrapperStruct00.var_1_6 == ((signed long int) WrapperStruct00.var_1_3)) : (WrapperStruct00.var_1_6 == ((signed long int) WrapperStruct00.var_1_1))) : (WrapperStruct00.var_1_6 == ((signed long int) WrapperStruct00.var_1_4)))) && (((WrapperStruct00.var_1_6 + (WrapperStruct00.var_1_4 << WrapperStruct00.var_1_2)) != WrapperStruct00.var_1_5) ? (((WrapperStruct00.var_1_3 / WrapperStruct00.var_1_11) < (WrapperStruct00.var_1_2 - (WrapperStruct00.var_1_12 - WrapperStruct00.var_1_5))) ? (WrapperStruct00.var_1_10 == ((signed long int) (min (-256 , (min (WrapperStruct00.var_1_4 , (max (WrapperStruct00.var_1_5 , WrapperStruct00.var_1_2)))))))) : (WrapperStruct00.var_1_10 == ((signed long int) WrapperStruct00.var_1_4))) : (WrapperStruct00.var_1_10 == ((signed long int) WrapperStruct00.var_1_2)))
;
}
int main(void) {
	isInitial = 1;
