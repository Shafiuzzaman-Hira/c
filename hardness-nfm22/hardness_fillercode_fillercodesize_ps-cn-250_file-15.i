...
void step(void) {
 ...
 if (var_1_30) {
  var_1_34 = ((((((((var_1_35) > ((-5 + var_1_29))) ? (var_1_35) : ((-5 + var_1_29))))) < ((var_1_33 - var_1_36))) ? (((((var_1_35) > ((-5 + var_1_29))) ? (var_1_35) : ((-5 + var_1_29))))) : ((var_1_33 - var_1_36))));
 }
 if (var_1_26 < ((((var_1_28) > (((((var_1_29) < (var_1_36)) ? (var_1_29) : (var_1_36))))) ? (var_1_28) : (((((var_1_29) < (var_1_36)) ? (var_1_29) : (var_1_36))))))) {
 ...
 if (var_1_27 && (var_1_35 > var_1_36)) {
  if (-4 <= (~ var_1_37)) {
   if (((var_1_33 * var_1_37) & var_1_26) >= ((((-128) < 0 ) ? -(-128) : (-128)))) {
    if (((((var_1_38) > (var_1_36)) ? (var_1_38) : (var_1_36))) > var_1_28) {
     if ((var_1_26 / ((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41)))) <= (var_1_42 * ((((var_1_38) < (var_1_37)) ? (var_1_38) : (var_1_37))))) {
      var_1_39 = ((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43)));
     }
    } else {
     var_1_39 = ((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43)));
    }
   } else {
    var_1_39 = ((((var_1_43) < (var_1_44)) ? (var_1_43) : (var_1_44)));
   }
  } else {
   var_1_39 = (var_1_45 + ((((var_1_46) < (var_1_47)) ? (var_1_46) : (var_1_47))));
  }
 } else {
  var_1_39 = var_1_46;
 }
 if (var_1_47 <= (((((- var_1_44)) < ((var_1_43 / var_1_49))) ? ((- var_1_44)) : ((var_1_43 / var_1_49))))) {
  if (var_1_30) {
   var_1_48 = ((((var_1_38) > (var_1_50)) ? (var_1_38) : (var_1_50)));
  } else {
   if (((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29))) > var_1_42) {
 ...
 if (var_1_30) {
  var_1_56 = (((((((((var_1_57) < 0 ) ? -(var_1_57) : (var_1_57)))) < (var_1_58)) ? (((((var_1_57) < 0 ) ? -(var_1_57) : (var_1_57)))) : (var_1_58))) + var_1_59);
 } else {
  var_1_56 = ((((var_1_54) > (((((((((var_1_58) < (var_1_55)) ? (var_1_58) : (var_1_55)))) > (var_1_59)) ? (((((var_1_58) < (var_1_55)) ? (var_1_58) : (var_1_55)))) : (var_1_59))))) ? (var_1_54) : (((((((((var_1_58) < (var_1_55)) ? (var_1_58) : (var_1_55)))) > (var_1_59)) ? (((((var_1_58) < (var_1_55)) ? (var_1_58) : (var_1_55)))) : (var_1_59))))));
 }
 if (var_1_34 != var_1_54) {
  if ((~ (var_1_52 / var_1_61)) == var_1_42) {
   if (((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28))) < (var_1_59 + 2)) {
    if ((var_1_40 * (var_1_44 / var_1_49)) >= var_1_45) {
     var_1_60 = (((((var_1_62) < 0 ) ? -(var_1_62) : (var_1_62))) - var_1_51);
    }
   }
  }
 } else {
  if ((var_1_63 * var_1_47) >= ((((var_1_40) < (((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))))) ? (var_1_40) : (((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))))))) {
   var_1_60 = var_1_38;
  }
 }
 if ((~ var_1_61) <= var_1_37) {
  var_1_64 = ((((var_1_50) < 0 ) ? -(var_1_50) : (var_1_50)));
 } else {
  if ((((((var_1_53) < 0 ) ? -(var_1_53) : (var_1_53))) + var_1_32) >= var_1_56) {
   var_1_64 = var_1_52;
  }
 }
 ...
 if (var_1_27) {
  if (var_1_51 >= (~ ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))))) {
   if (var_1_68) {
 ...
 if (var_1_66 || var_1_71) {
  ...
  if (var_1_39 >= var_1_46) {
   if (var_1_26 < var_1_53) {
    ...
    var_1_72 = ((((var_1_44) < 0 ) ? -(var_1_44) : (var_1_44)));
   }
  }
 }
 if (((((var_1_57) < 0 ) ? -(var_1_57) : (var_1_57))) > var_1_56) {
  if ((var_1_62 != var_1_52) || var_1_31) {
   var_1_73 = ((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43)));
  } else {
   var_1_73 = var_1_44;
  }
 } else {
 ...
 if (2u > (1u * var_1_75)) {
  if (var_1_64 >= (var_1_29 | var_1_33)) {
   var_1_74 = (((((var_1_48 - var_1_38)) > (((((var_1_55) < 0 ) ? -(var_1_55) : (var_1_55))))) ? ((var_1_48 - var_1_38)) : (((((var_1_55) < 0 ) ? -(var_1_55) : (var_1_55))))));
  } else {
   var_1_74 = ((((var_1_58) < (var_1_62)) ? (var_1_58) : (var_1_62)));
  }
 } else {
  if (var_1_67) {
   var_1_74 = ((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52)));
  }
 }
 if (var_1_71) {
  var_1_76 = ((((((((var_1_50) < (var_1_51)) ? (var_1_50) : (var_1_51)))) > (var_1_54)) ? (((((var_1_50) < (var_1_51)) ? (var_1_50) : (var_1_51)))) : (var_1_54)));
 }
 if ((var_1_54 & ((((var_1_74) < (var_1_34)) ? (var_1_74) : (var_1_34)))) < var_1_53) {
  if (((var_1_55 - var_1_51) <= (var_1_56 >> var_1_26)) && var_1_68) {
   var_1_77 = ((((var_1_45) > (var_1_44)) ? (var_1_45) : (var_1_44)));
  }
 }
 if (! (var_1_26 < var_1_52)) {
  var_1_78 = ((((var_1_62) < 0 ) ? -(var_1_62) : (var_1_62)));
 } else {
  if (var_1_49 < var_1_63) {
   var_1_78 = ((((((((var_1_62) < (var_1_79)) ? (var_1_62) : (var_1_79))) - var_1_52) < 0 ) ? -(((((var_1_62) < (var_1_79)) ? (var_1_62) : (var_1_79))) - var_1_52) : (((((var_1_62) < (var_1_79)) ? (var_1_62) : (var_1_79))) - var_1_52)));
  }
 }
 ...
 if (var_1_68) {
  ...
  if (var_1_77 > ((((var_1_45) > (((((var_1_49) < (var_1_73)) ? (var_1_49) : (var_1_73))))) ? (var_1_45) : (((((var_1_49) < (var_1_73)) ? (var_1_49) : (var_1_73))))))) {
 ...
 if ((((((256 * var_1_76)) > (var_1_36)) ? ((256 * var_1_76)) : (var_1_36))) >= var_1_50) {
