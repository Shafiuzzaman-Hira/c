...
void step(void) {
	// From: CodeObject1
	if ((var_1_24 / var_1_25) < (max (256.85 , var_1_26))) {
		var_1_23 = var_1_27;
	}
	...
	// From: CodeObject2
	if (var_1_29) {
		var_1_28 = (max (var_1_27 , (var_1_30 + var_1_31)));
	}


	// From: CodeObject3
	if (var_1_27 < (var_1_31 >> var_1_28)) {
		var_1_32 = (abs (min (var_1_30 , (max (var_1_31 , var_1_28)))));
	} else {
		if (var_1_30 >= (abs (var_1_33))) {
			var_1_32 = (max (var_1_27 , var_1_23));
		} else {
			var_1_32 = (abs (-8));
		}
	}
	...
	if ((var_1_35 / var_1_36) < var_1_37) {
		...
		if (var_1_29) {
			if ((max (var_1_31 , var_1_23)) <= (var_1_36 / (min (var_1_40 , var_1_41)))) {
				var_1_34 = (! var_1_39);
			}
		}
	}
	...
	if (var_1_32 > var_1_40) {
		var_1_47 = (min (var_1_48 , ((min (var_1_49 , var_1_50)) - var_1_51)));
	}


	// From: CodeObject8
	if (! (var_1_47 <= (var_1_36 % var_1_41))) {
		if ((var_1_49 - (abs (var_1_27))) < var_1_51) {
	...
	// From: CodeObject9
	if (var_1_40 < (abs (var_1_51 - var_1_54))) {
		if (var_1_25 == var_1_26) {
			var_1_53 = (var_1_51 + (abs (var_1_55)));
		}
	} else {
		if (var_1_46 || (var_1_30 <= (var_1_51 | var_1_35))) {
			var_1_53 = (min (var_1_51 , var_1_55));
		}
	}
	...
	if (var_1_36 > var_1_53) {
		if (-64 > var_1_32) {
			var_1_60 = (min ((abs (var_1_59)) , (min (var_1_61 , var_1_62))));
		}
	} else {
		var_1_60 = var_1_62;
	}
