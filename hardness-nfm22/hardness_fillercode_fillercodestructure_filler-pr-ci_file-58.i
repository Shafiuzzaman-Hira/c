...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch58Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_8) {
  ...
  var_1_35 = (((((var_1_17) > (var_1_17)) ? (var_1_17) : (var_1_17))) - var_1_17);
 }
 ...
 if ((var_1_14 / var_1_3) <= var_1_17) {
  if ((~ (var_1_17 - var_1_16)) < var_1_17) {
   if (((10 + var_1_17) <= (var_1_16 & var_1_17)) || var_1_9) {
    var_1_25 = var_1_16;
   }
  }
 } else {
 ...
 if (var_1_5 > (var_1_3 ^ (~ var_1_5))) {
  var_1_30 = (var_1_17 - var_1_17);
 } else {
  var_1_30 = (var_1_17 - var_1_17);
 }
