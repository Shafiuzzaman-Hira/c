...
void step(void) {
	...
	// From: CodeObject4
	if (var_1_31 >= (abs (var_1_36 - var_1_37))) {
		if (var_1_28 < var_1_30) {
			var_1_35 = (min (var_1_33 , var_1_24));
		}
	} else {
		var_1_35 = (abs (max (var_1_33 , (var_1_24 + var_1_34))));
	}


	// From: CodeObject5
	var_1_38 = (abs (var_1_24));
	...
	if (var_1_28 >= var_1_36) {
		if (var_1_40 || var_1_41) {
			if (((var_1_35 + var_1_24) & var_1_34) >= (var_1_33 + (~ var_1_26))) {
				var_1_39 = (max (var_1_42 , var_1_43));
			}
		} else {
			var_1_39 = (var_1_44 - (abs (var_1_45)));
		}
	} else {
		var_1_39 = (abs (abs (min (var_1_45 , var_1_44))));
	}
	...
	// From: CodeObject8
	var_1_48 = (min ((abs (var_1_30)) , var_1_27));


	// From: CodeObject9
	if (var_1_41) {
		var_1_49 = (max ((max ((min (var_1_30 , var_1_31)) , var_1_32)) , (abs (var_1_28))));
	}


	// From: CodeObject10
	if (var_1_29 < var_1_23) {
		var_1_50 = (max (var_1_46 , (var_1_51 - 5)));
	} else {
		if (var_1_30 >= var_1_49) {
			var_1_50 = (abs (abs (var_1_51)));
		} else {
			var_1_50 = (((abs (var_1_52)) + var_1_53) - (var_1_46 + (var_1_47 + var_1_54)));
		}
	}
	...
	// From: CodeObject12
	if (var_1_49 >= 99.75) {
		if ((var_1_31 * var_1_28) > ((abs (var_1_30)) * 0.2f)) {
