...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch3100_1loop.c", 13, "reach_error"); }
...
void step(void) {
 if (var_1_4 != (last_1_var_1_20 + last_1_var_1_10)) {
  ...
  if ((((((last_1_var_1_29) > (last_1_var_1_29)) ? (last_1_var_1_29) : (last_1_var_1_29))) > var_1_5) || var_1_7) {
   var_1_6 = var_1_9;
  } else {
   var_1_6 = var_1_7;
  }
 ...
 if (var_1_5 != stepLocal_3) {
  var_1_12 = ((((var_1_28) > (8u)) ? (var_1_28) : (8u)));
 }
 if (var_1_16 <= var_1_14) {
  if (var_1_28 == var_1_10) {
   if (var_1_7) {
    ...
    var_1_31 = (var_1_18 + ((((var_1_34) > (var_1_17)) ? (var_1_34) : (var_1_17))));
   }
  } else {
   var_1_31 = var_1_16;
  }
 ...
 if (! var_1_6) {
  if (var_1_31 < ((((var_1_16) < (var_1_18)) ? (var_1_16) : (var_1_18)))) {
 ...
 if ((var_1_14 * var_1_18) > var_1_16) {
  if (var_1_12 < stepLocal_4) {
   ...
   if (stepLocal_5 < var_1_21) {
    var_1_20 = ((((var_1_23) < (var_1_24)) ? (var_1_23) : (var_1_24)));
   } else {
 ...
 if (var_1_27 > stepLocal_10) {
  var_1_29 = (var_1_1 - ((((var_1_10) > (((((var_1_28) < (var_1_10)) ? (var_1_28) : (var_1_10))))) ? (var_1_10) : (((((var_1_28) < (var_1_10)) ? (var_1_28) : (var_1_10)))))));
 } else {
