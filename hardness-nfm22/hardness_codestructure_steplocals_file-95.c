...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch95stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch95stepLocals
	signed long int stepLocal_1 = (var_1_10 ^ var_1_7) / (max (-8 , var_1_5));
	...
	// From: Req5Batch95stepLocals
	if (var_1_2 != (var_1_3 / (abs (var_1_13)))) {
		var_1_12 = var_1_14;
	}


	// From: Req6Batch95stepLocals
	if (128 >= var_1_10) {
