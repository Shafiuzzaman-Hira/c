...
void step(void) {
	...
	// From: Req5Batch66Amount100
	var_1_15 = ((var_1_16 - var_1_17) - var_1_18);


	// From: Req12Batch66Amount100
	...
	// From: Req6Batch66Amount100
	if (var_1_33 >= 0.25) {
		var_1_19 = (var_1_17 + var_1_20);
	}


	// From: Req8Batch66Amount100
	if (var_1_27) {
		var_1_23 = (abs (4.5));
	}


	// From: Req2Batch66Amount100
	if ((var_1_33 * 8.2) < 10.4) {
		var_1_6 = (var_1_8 - var_1_9);
	}


	// From: Req10Batch66Amount100
