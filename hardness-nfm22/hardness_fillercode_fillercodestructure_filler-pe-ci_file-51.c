...
void step(void) {
	...
	// From: Req4Batch51Filler_PE_CI
	if ((min ((~ var_1_1) , 8)) > var_1_11) {
		var_1_17 = var_1_18;
	}


	// From: Req2Batch51Filler_PE_CI
	if (! (var_1_17 > var_1_5)) {
	...
	// From: CodeObject1
	if ((var_1_1 % (max (var_1_27 , var_1_28))) > var_1_1) {
		var_1_25 = ((max (var_1_30 , var_1_31)) - var_1_32);
	}


	// From: CodeObject2
	if (var_1_32 < (max (var_1_30 , (abs (var_1_5))))) {
		var_1_33 = (max (var_1_11 , var_1_11));
	} else {
		if (var_1_21) {
	...
	// From: CodeObject5
	if ((abs (1.000000095E7f)) < ((9.9999999999996E12f - var_1_31) / var_1_22)) {
		if (var_1_22 < (max (var_1_30 , (var_1_31 - var_1_32)))) {
			var_1_42 = var_1_11;
		}
	} else {
		var_1_42 = 100000u;
	...
	// From: CodeObject6
	var_1_44 = ((abs (var_1_37)) + (abs (max (var_1_11 , var_1_11))));


	// From: CodeObject7
	if (var_1_23) {
		var_1_45 = (max ((max (var_1_11 , var_1_11)) , var_1_37));
	} else {
		if (var_1_19 > (abs (var_1_9))) {
			var_1_45 = var_1_11;
		} else {
			var_1_45 = 10;
		}
