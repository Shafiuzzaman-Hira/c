...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch34100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch34100_while
	if ((- var_1_7) == var_1_10) {
		var_1_16 = (max ((var_1_18 - var_1_15) , var_1_11));
	}


	// From: Req12Batch34100_while
	var_1_31 = var_1_25;


	// From: Req1Batch34100_while
