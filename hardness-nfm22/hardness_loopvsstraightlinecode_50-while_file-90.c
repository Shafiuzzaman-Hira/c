...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch9050_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch9050_while
	if (((var_1_15 - var_1_12) + var_1_24) < var_1_24) {
		var_1_14 = var_1_12;
	}


	// From: Req5Batch9050_while
