...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch42stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch42stepLocals
	if (var_1_5 >= -2) {
		var_1_6 = (var_1_7 - 100);
	}


	// From: Req3Batch42stepLocals
	unsigned char stepLocal_2 = 49.5f <= var_1_9;
	signed short int stepLocal_1 = var_1_1;
	if (stepLocal_2 && (var_1_2 && var_1_10)) {
	...
	// From: Req4Batch42stepLocals
	unsigned char stepLocal_4 = var_1_6;
	signed long int stepLocal_3 = max ((max (var_1_3 , var_1_6)) , var_1_5);
	if (stepLocal_4 >= (var_1_1 / var_1_7)) {
