...
void step(void) {
	...
	// From: Req6Batch62Filler_PE_CO
	if (var_1_10 || var_1_20) {
		var_1_19 = (max (var_1_21 , 32));
	}


	// From: Req7Batch62Filler_PE_CO
	if (var_1_10) {
	...
	if (((var_1_19 >> var_1_19) % -10) >= var_1_17) {
		if ((var_1_37 - (abs (var_1_33))) != var_1_22) {
	...
	// From: CodeObject9
	if (var_1_37 < (min (var_1_33 , var_1_1))) {
