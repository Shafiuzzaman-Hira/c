...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch79Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch79Filler_PE_CO
	var_1_26 = var_1_16;


	// From: Req8Batch79Filler_PE_CO
	var_1_27 = 10u;


	// From: Req3Batch79Filler_PE_CO
	...
	// From: CodeObject3
	var_1_36 = ((max (var_1_20 , (abs (var_1_20)))) + var_1_7);
	...
	if (! (var_1_35 >= (var_1_41 - var_1_40))) {
		var_1_42 = (min ((var_1_7 - 256) , var_1_7));
	}


	// From: CodeObject6
	if (((var_1_27 * var_1_27) | var_1_7) <= (var_1_20 + 8u)) {
		if ((min (16u , var_1_20)) < var_1_27) {
			var_1_45 = var_1_46;
		} else {
			var_1_45 = ((var_1_27 != (var_1_20 % var_1_47)) || var_1_48);
		}
	}
	...
	// From: CodeObject7
	if (0.83f > var_1_35) {
		if ((var_1_7 + (abs (var_1_7))) <= var_1_7) {
			var_1_49 = var_1_35;
		}
	} else {
		var_1_49 = var_1_35;
