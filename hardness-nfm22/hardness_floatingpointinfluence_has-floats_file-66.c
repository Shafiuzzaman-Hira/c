...
void step(void) {
	// From: Req4Batch66has_floats
	var_1_18 = var_1_15;


	// From: Req5Batch66has_floats
	var_1_19 = var_1_12;


	// From: Req2Batch66has_floats
...
int property() {
	return (((((var_1_10 <= var_1_19) ? (var_1_1 == ((unsigned short int) (var_1_18 + ((var_1_10 + var_1_18) + (var_1_7 - var_1_18))))) : (var_1_1 == ((unsigned short int) (var_1_9 - var_1_7)))) && (((var_1_18 > last_1_var_1_10) || var_1_11) ? ((last_1_var_1_10 != var_1_18) ? (var_1_10 == ((unsigned char) var_1_12)) : (var_1_10 == ((unsigned char) (max ((var_1_13 + var_1_14) , (max (var_1_12 , var_1_15))))))) : 1)) && ((var_1_9 < var_1_10) ? (var_1_16 == ((signed long int) (var_1_7 + 16))) : ((var_1_11 || (var_1_19 <= last_1_var_1_16)) ? (var_1_16 == ((signed long int) var_1_10)) : (var_1_16 == ((signed long int) var_1_1))))) && (var_1_18 == ((unsigned char) var_1_15))) && (var_1_19 == ((unsigned long int) var_1_12))
;
}
int main(void) {
	isInitial = 1;
