...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch4625_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch4625_1loop
	signed long int stepLocal_1 = var_1_8 / var_1_4;
	signed long int stepLocal_0 = min (var_1_4 , var_1_8);
	if ((- var_1_2) >= 16.75) {
