...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch36Amount100.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch36Amount100
	if (last_1_var_1_33) {
		if (last_1_var_1_33) {
			var_1_7 = (max ((last_1_var_1_20 + last_1_var_1_20) , last_1_var_1_20));
		} else {
	...
	// From: Req8Batch36Amount100
	if (var_1_6 == (- (99.4f * var_1_4))) {
		var_1_25 = (min ((var_1_26 + var_1_27) , var_1_28));
	} else {
	...
	// From: Req9Batch36Amount100
	unsigned long int stepLocal_5 = var_1_16;
	if (var_1_18 >= stepLocal_5) {
		if ((- var_1_6) <= var_1_4) {
			var_1_29 = (max (var_1_5 , (var_1_6 - var_1_4)));
		} else {
			var_1_29 = (1.0000000000002E12 + (max ((abs (var_1_31)) , var_1_32)));
		}
	} else {
		var_1_29 = var_1_6;
	}
	...
	// From: Req11Batch36Amount100
	var_1_35 = var_1_7;


	// From: Req3Batch36Amount100
	if ((var_1_20 - var_1_20) == (min (var_1_20 , (var_1_20 >> var_1_12)))) {
		var_1_13 = 8;
	} else {
		var_1_13 = (max (var_1_25 , var_1_25));
	}


	// From: Req5Batch36Amount100
	if (var_1_13 >= var_1_18) {
		var_1_19 = (min (var_1_17 , var_1_20));
	}


	// From: Req10Batch36Amount100
	...
	// From: Req7Batch36Amount100
	unsigned char stepLocal_4 = var_1_20;
	if (stepLocal_4 < var_1_20) {
		var_1_22 = (min (((var_1_16 + 16) + (var_1_23 - var_1_21)) , var_1_20));
	} else {
		if (var_1_33) {
			var_1_22 = var_1_20;
		} else {
...
int property() {
	return ((((((((((var_1_33 ? (((-5 + 64) < var_1_19) ? (var_1_1 == ((float) (max ((var_1_4 - var_1_5) , (var_1_6 - 5.4f))))) : (var_1_1 == ((float) var_1_6))) : (var_1_1 == ((float) var_1_6))) && (last_1_var_1_33 ? (last_1_var_1_33 ? (var_1_7 == ((unsigned short int) (max ((last_1_var_1_20 + last_1_var_1_20) , last_1_var_1_20)))) : ((((last_1_var_1_20 + last_1_var_1_25) / var_1_12) <= last_1_var_1_20) ? (var_1_7 == ((unsigned short int) last_1_var_1_20)) : 1)) : 1)) && (((var_1_20 - var_1_20) == (min (var_1_20 , (var_1_20 >> var_1_12)))) ? (var_1_13 == ((signed short int) 8)) : (var_1_13 == ((signed short int) (max (var_1_25 , var_1_25)))))) && ((var_1_25 <= last_1_var_1_16) ? (var_1_16 == ((unsigned long int) ((abs (abs (3808567585u))) - var_1_20))) : ((last_1_var_1_16 == var_1_7) ? (var_1_16 == ((unsigned long int) (((var_1_17 + var_1_18) - last_1_var_1_16) - var_1_20))) : 1))) && ((var_1_13 >= var_1_18) ? (var_1_19 == ((unsigned long int) (min (var_1_17 , var_1_20)))) : 1)) && (last_1_var_1_33 ? (((last_1_var_1_16 * (var_1_10 & last_1_var_1_25)) > last_1_var_1_20) ? (last_1_var_1_33 ? (var_1_20 == ((unsigned char) var_1_21)) : (var_1_20 == ((unsigned char) var_1_21))) : 1) : (var_1_20 == ((unsigned char) 100)))) && ((var_1_20 < var_1_20) ? (var_1_22 == ((unsigned short int) (min (((var_1_16 + 16) + (var_1_23 - var_1_21)) , var_1_20)))) : (var_1_33 ? (var_1_22 == ((unsigned short int) var_1_20)) : (var_1_22 == ((unsigned short int) 2))))) && ((var_1_6 == (- (99.4f * var_1_4))) ? (var_1_25 == ((signed char) (min ((var_1_26 + var_1_27) , var_1_28)))) : (((last_1_var_1_20 ^ last_1_var_1_19) < last_1_var_1_20) ? (var_1_25 == ((signed char) var_1_27)) : (var_1_25 == ((signed char) var_1_26))))) && ((var_1_18 >= var_1_16) ? (((- var_1_6) <= var_1_4) ? (var_1_29 == ((double) (max (var_1_5 , (var_1_6 - var_1_4))))) : (var_1_29 == ((double) (1.0000000000002E12 + (max ((abs (var_1_31)) , var_1_32)))))) : (var_1_29 == ((double) var_1_6)))) && (((var_1_20 ^ var_1_23) > var_1_13) ? ((! (var_1_18 == (var_1_20 + var_1_7))) ? (var_1_33 == ((unsigned char) var_1_34)) : 1) : (var_1_2 ? (var_1_33 == ((unsigned char) 0)) : (var_1_33 == ((unsigned char) var_1_34))))) && (var_1_35 == ((unsigned short int) var_1_7))
;
}
int main(void) {
	isInitial = 1;
