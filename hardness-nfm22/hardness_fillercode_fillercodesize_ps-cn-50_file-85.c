...
void step(void) {
	...
	// From: Req5Batch85PS_CN_50
	var_1_13 = (abs (var_1_14));


	// From: Req7Batch85PS_CN_50
	var_1_16 = (var_1_6 && var_1_17);


	// From: Req6Batch85PS_CN_50
	if (var_1_5) {
		var_1_15 = (max (var_1_1 , (var_1_13 + (abs (var_1_14)))));
	}


	// From: Req3Batch85PS_CN_50
