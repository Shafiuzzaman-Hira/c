...
void step(void) {
	...
	if (WrapperStruct00.var_1_2) {
		WrapperStruct00.var_1_1 = (max ((max ((WrapperStruct00.var_1_3 + WrapperStruct00.var_1_4) , 50)) , WrapperStruct00.var_1_5));
	} else {
	...
	// From: Req2Batch71Wrapper_S
	if (WrapperStruct00.var_1_7) {
		WrapperStruct00.var_1_8 = (abs (WrapperStruct00.var_1_5));
	} else {
		WrapperStruct00.var_1_8 = (WrapperStruct00.var_1_1 + WrapperStruct00.var_1_3);
	}


	// From: Req4Batch71Wrapper_S
	WrapperStruct00.var_1_13 = WrapperStruct00.var_1_14;


	// From: Req5Batch71Wrapper_S
	WrapperStruct00.var_1_15 = WrapperStruct00.var_1_3;


	// From: Req3Batch71Wrapper_S
	if (WrapperStruct00.var_1_5 <= (max (WrapperStruct00.var_1_3 , (WrapperStruct00.var_1_10 - WrapperStruct00.var_1_4)))) {
