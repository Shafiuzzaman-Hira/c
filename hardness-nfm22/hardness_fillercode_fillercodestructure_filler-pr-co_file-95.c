...
void step(void) {
	...
	if (((var_1_31 - var_1_32) + (var_1_27 / var_1_33)) < (abs (var_1_12))) {
		if (var_1_11 >= 10u) {
			if (var_1_22) {
				var_1_30 = (abs (abs (var_1_7)));
			} else {
				var_1_30 = (min ((max (var_1_7 , var_1_1)) , (var_1_10 + 64)));
			}
		} else {
	...
	// From: CodeObject3
	if (var_1_20 >= (var_1_1 / (abs (var_1_19)))) {
		var_1_26 = var_1_27;
	}
