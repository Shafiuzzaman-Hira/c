...
void step(void) {
	...
	if (var_1_38 < var_1_26) {
		if (var_1_31) {
			var_1_45 = (var_1_46 + (min (25 , var_1_47)));
		} else {
	...
	if (var_1_38 > (var_1_45 % var_1_48)) {
		if ((abs (- var_1_28)) >= var_1_29) {
			var_1_50 = ((min (128 , var_1_51)) - (max (var_1_46 , var_1_48)));
		}
	}
	...
	// From: Req3Batch25PS_CN_100
	var_1_10 = (last_1_var_1_10 && var_1_11);


	// From: Req5Batch25PS_CN_100
	...
	// From: Req8Batch25PS_CN_100
	var_1_22 = last_1_var_1_22;


	// From: Req9Batch25PS_CN_100
	var_1_23 = var_1_14;


	// From: Req6Batch25PS_CN_100
	...
	// From: Req7Batch25PS_CN_100
	var_1_21 = var_1_22;


	// From: Req4Batch25PS_CN_100
	if (! (var_1_23 <= var_1_7)) {
