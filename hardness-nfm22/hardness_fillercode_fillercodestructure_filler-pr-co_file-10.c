...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch10Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject6
	if (var_1_17 >= ((~ 128u) % (min (var_1_39 , var_1_40)))) {
		if (var_1_8) {
			var_1_38 = (max ((64 + var_1_37) , var_1_23));
		} else {
			if ((max ((var_1_36 | var_1_23) , (var_1_30 & var_1_17))) < var_1_14) {
