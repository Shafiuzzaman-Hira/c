...
void step(void) {
	...
	// From: Req11Batch64Amount500
	if (var_1_41 < (last_1_var_1_51 & last_1_var_1_48)) {
		if (var_1_33) {
			if ((var_1_19 * (var_1_36 & 64u)) >= (var_1_18 + last_1_var_1_51)) {
				var_1_42 = (var_1_43 - var_1_35);
			} else {
				var_1_42 = (max (var_1_44 , ((var_1_45 - var_1_35) + (10 + var_1_46))));
			}
		} else {
			if (var_1_32 || ((max (last_1_var_1_63 , last_1_var_1_80)) == (var_1_46 / var_1_43))) {
				var_1_42 = (max (var_1_46 , var_1_45));
			} else {
				var_1_42 = (min ((min (var_1_46 , var_1_44)) , var_1_43));
			}
		}
	}


	// From: Req13Batch64Amount500
	if (var_1_33) {
		var_1_50 = (last_1_var_1_50 + var_1_42);
	}


	// From: Req6Batch64Amount500
	unsigned long int stepLocal_3 = last_1_var_1_76 * (var_1_17 - last_1_var_1_90);
	if (last_1_var_1_60) {
		var_1_27 = var_1_28;
	} else {
		if (last_1_var_1_65 != stepLocal_3) {
			if (63.25 <= (var_1_12 * (abs (last_1_var_1_68)))) {
	...
	// From: Req14Batch64Amount500
	var_1_51 = (var_1_49 - var_1_43);


	// From: Req16Batch64Amount500
	var_1_54 = ((var_1_55 - var_1_46) - (abs (var_1_35)));


	// From: Req34Batch64Amount500
	if (var_1_32) {
		var_1_82 = var_1_55;
	}


	// From: Req35Batch64Amount500
	var_1_83 = var_1_35;


	// From: Req36Batch64Amount500
	if (var_1_75) {
		var_1_84 = var_1_5;
	} else {
		var_1_84 = var_1_69;
	...
	// From: Req37Batch64Amount500
	var_1_85 = -200;


	// From: Req38Batch64Amount500
	var_1_86 = last_1_var_1_86;


	// From: Req39Batch64Amount500
	var_1_87 = var_1_70;


	// From: Req40Batch64Amount500
	var_1_88 = var_1_30;


	// From: Req42Batch64Amount500
	var_1_90 = var_1_46;


	// From: Req43Batch64Amount500
	if (var_1_30) {
		var_1_91 = var_1_69;
	} else {
		var_1_91 = var_1_71;
	...
	// From: Req7Batch64Amount500
	unsigned long int stepLocal_4 = var_1_19 << var_1_35;
	if (stepLocal_4 <= (min (var_1_15 , (var_1_22 >> var_1_62)))) {
		var_1_34 = (abs (32));
	} else {
	...
	// From: Req19Batch64Amount500
	if ((var_1_91 + var_1_6) < (max (var_1_12 , (var_1_68 * var_1_5)))) {
		var_1_60 = (! var_1_28);
	}


	// From: Req25Batch64Amount500
	if (! (var_1_15 > -64)) {
		if (var_1_60) {
			var_1_67 = ((max (var_1_55 , var_1_43)) - var_1_58);
		} else {
			var_1_67 = (var_1_46 + (max (var_1_35 , var_1_57)));
		}
	} else {
	...
	// From: Req31Batch64Amount500
	if (var_1_38 >= var_1_54) {
		var_1_78 = (60934 - var_1_42);
	} else {
		var_1_78 = (var_1_54 + (var_1_46 + (abs (var_1_67))));
	}


	// From: Req12Batch64Amount500
	if (var_1_31 || var_1_27) {
		if (var_1_88) {
			if ((max (10.8f , var_1_68)) >= (- var_1_12)) {
	...
	// From: Req9Batch64Amount500
	var_1_39 = (min (var_1_48 , last_1_var_1_39));


	// From: Req22Batch64Amount500
	if ((var_1_18 + var_1_57) >= (var_1_19 << var_1_26)) {
		var_1_63 = var_1_46;
	} else {
		var_1_63 = (var_1_36 + (var_1_78 - (max (var_1_45 , var_1_43))));
	}


	// From: Req45Batch64Amount500
	...
	// From: Req23Batch64Amount500
	if (var_1_61 > var_1_23) {
		var_1_64 = (var_1_6 - (abs (var_1_4)));
	} else {
		var_1_64 = (var_1_6 - var_1_5);
	}


	// From: Req27Batch64Amount500
	...
	// From: Req33Batch64Amount500
	if (var_1_60) {
		var_1_81 = var_1_51;
	}


	// From: Req44Batch64Amount500
	if (var_1_60) {
		var_1_92 = (max (var_1_58 , (max (var_1_42 , (var_1_49 - var_1_55)))));
	}


	// From: Req4Batch64Amount500
	if (var_1_11 != ((max (var_1_6 , 1.4f)) / var_1_12)) {
		if (var_1_6 >= var_1_94) {
			var_1_16 = (min (var_1_15 , var_1_86));
		} else {
			var_1_16 = (min (var_1_86 , (var_1_17 - (max (var_1_89 , var_1_92)))));
		}
	} else {
		var_1_16 = (var_1_86 + ((min (var_1_18 , var_1_19)) - var_1_89));
	}


	// From: Req1Batch64Amount500
	...
	// From: Req5Batch64Amount500
	if (var_1_5 != var_1_6) {
		if (var_1_12 >= (var_1_5 - var_1_6)) {
			if (var_1_19 < var_1_15) {
				var_1_20 = (max (var_1_51 , var_1_85));
			} else {
				if (var_1_12 <= var_1_1) {
	...
	// From: Req32Batch64Amount500
	if (var_1_35 < var_1_53) {
		if (var_1_20 <= ((~ var_1_54) + var_1_26)) {
			var_1_80 = (abs (var_1_41));
		} else {
			var_1_80 = (min ((var_1_35 + var_1_46) , var_1_55));
		}
	}


	// From: Req10Batch64Amount500
	if (((255.2 * var_1_64) * (max (var_1_4 , var_1_11))) == var_1_12) {
		var_1_40 = (50 + var_1_35);
	} else {
		if (var_1_31) {
			var_1_40 = (var_1_35 + (16 + (max (2 , var_1_41))));
		} else {
			if (3.8 < (- var_1_64)) {
				var_1_40 = (max (var_1_35 , var_1_41));
			}
		}
	}


	// From: Req15Batch64Amount500
	var_1_52 = ((min ((min (var_1_17 , 4285343471u)) , (var_1_53 - var_1_36))) - var_1_16);


	// From: Req18Batch64Amount500
	if (var_1_92 != (- 4u)) {
		var_1_59 = (((abs (last_1_var_1_59)) + var_1_78) - (min (var_1_55 , (max (var_1_35 , var_1_44)))));
	} else {
		if (var_1_22 == (var_1_38 - (max (var_1_45 , var_1_49)))) {
			var_1_59 = (max ((min ((min (var_1_43 , var_1_92)) , var_1_58)) , var_1_46));
		}
	}


	// From: Req30Batch64Amount500
	if (var_1_16 < var_1_63) {
		var_1_76 = (25 - ((var_1_77 - var_1_43) - (max (5 , var_1_16))));
	} else {
		if ((min (var_1_4 , (var_1_72 - var_1_5))) > 50.5f) {
			var_1_76 = (max (var_1_34 , last_1_var_1_76));
		} else {
			var_1_76 = ((min (var_1_85 , last_1_var_1_76)) - (var_1_23 + (min (var_1_44 , var_1_55))));
		}
	}


	// From: Req24Batch64Amount500
	signed long int stepLocal_19 = (128 + var_1_35) + var_1_76;
	if (var_1_86 < stepLocal_19) {
		if ((- var_1_11) <= var_1_6) {
			var_1_65 = (min (var_1_35 , (min ((abs (var_1_55)) , (max (var_1_57 , var_1_92))))));
		} else {
	...
	signed long int stepLocal_9 = max (var_1_35 , (var_1_82 - var_1_65));
	unsigned long int stepLocal_8 = var_1_25 / var_1_38;
	if (var_1_11 <= 9.2f) {
		var_1_56 = (abs (min (var_1_43 , var_1_45)));
	} else {
		if (stepLocal_12 < (abs (var_1_65))) {
			if (stepLocal_13 >= last_1_var_1_56) {
				if (last_1_var_1_56 == stepLocal_10) {
					if ((max ((2 + -1) , last_1_var_1_56)) > stepLocal_9) {
						if (var_1_33) {
							var_1_56 = var_1_35;
						} else {
							var_1_56 = ((min (var_1_55 , var_1_43)) - 64);
						}
					} else {
						if ((var_1_18 + var_1_25) > stepLocal_14) {
							var_1_56 = (var_1_36 + (max ((var_1_46 + var_1_35) , var_1_45)));
						} else {
							if (var_1_37) {
				...
				if (var_1_36 < stepLocal_11) {
					var_1_56 = (max (var_1_55 , var_1_46));
				} else {
					if (stepLocal_8 == var_1_46) {
						var_1_56 = (min (((200 - var_1_35) - (var_1_45 - 32)) , (min (var_1_36 , var_1_55))));
					} else {
						var_1_56 = ((max ((var_1_35 + 4) , var_1_36)) + 32);
					}
				}
			}
		} else {
			if (var_1_37) {
				...
				var_1_56 = (min (var_1_35 , 4));
			}
		}
	}


	// From: Req2Batch64Amount500
	unsigned short int stepLocal_0 = var_1_51;
	if (var_1_84 <= (max (49.4f , var_1_5))) {
		if (var_1_6 <= var_1_84) {
			if (((max (var_1_82 , var_1_16)) * (abs (var_1_56))) <= stepLocal_0) {
				var_1_8 = 5;
			} else {
				var_1_8 = (min (var_1_82 , (var_1_16 + var_1_56)));
			}
		} else {
		...
		if (var_1_5 <= (var_1_6 / var_1_11)) {
			if (((var_1_12 - var_1_6) - var_1_5) <= var_1_11) {
				...
				var_1_8 = ((max (var_1_82 , var_1_16)) + var_1_56);
			}
		} else {
			if (var_1_74) {
				var_1_8 = ((min (var_1_82 , 4)) + (min ((max (var_1_56 , var_1_16)) , var_1_54)));
			} else {
				var_1_8 = (min ((var_1_82 - (var_1_16 + var_1_67)) , var_1_56));
			}
		}
	}
}
...
int property() {
	return (((((((((((((((((((((((((((((((((((((((((((((var_1_39 <= var_1_92) ? (var_1_1 == ((float) (abs (var_1_4 + (var_1_5 - var_1_6))))) : (var_1_27 ? (var_1_1 == ((float) (max (var_1_6 , var_1_5)))) : 1)) && ((var_1_84 <= (max (49.4f , var_1_5))) ? ((var_1_6 <= var_1_84) ? ((((max (var_1_82 , var_1_16)) * (abs (var_1_56))) <= var_1_51) ? (var_1_8 == ((signed long int) 5)) : (var_1_8 == ((signed long int) (min (var_1_82 , (var_1_16 + var_1_56)))))) : (var_1_8 == ((signed long int) ((4 + var_1_16) + var_1_56)))) : ((var_1_5 <= (var_1_6 / var_1_11)) ? ((((var_1_12 - var_1_6) - var_1_5) <= var_1_11) ? (var_1_8 == ((signed long int) (var_1_56 + var_1_82))) : (var_1_8 == ((signed long int) ((max (var_1_82 , var_1_16)) + var_1_56)))) : (var_1_74 ? (var_1_8 == ((signed long int) ((min (var_1_82 , 4)) + (min ((max (var_1_56 , var_1_16)) , var_1_54))))) : (var_1_8 == ((signed long int) (min ((var_1_82 - (var_1_16 + var_1_67)) , var_1_56)))))))) && (((min (last_1_var_1_34 , 0)) >= last_1_var_1_67) ? (((var_1_12 <= var_1_4) && last_1_var_1_60) ? (var_1_15 == ((unsigned short int) 1)) : 1) : (var_1_15 == ((unsigned short int) last_1_var_1_92)))) && ((var_1_11 != ((max (var_1_6 , 1.4f)) / var_1_12)) ? ((var_1_6 >= var_1_94) ? (var_1_16 == ((unsigned long int) (min (var_1_15 , var_1_86)))) : (var_1_16 == ((unsigned long int) (min (var_1_86 , (var_1_17 - (max (var_1_89 , var_1_92)))))))) : (var_1_16 == ((unsigned long int) (var_1_86 + ((min (var_1_18 , var_1_19)) - var_1_89)))))) && ((var_1_5 != var_1_6) ? ((var_1_12 >= (var_1_5 - var_1_6)) ? ((var_1_19 < var_1_15) ? (var_1_20 == ((unsigned long int) (max (var_1_51 , var_1_85)))) : ((var_1_12 <= var_1_1) ? (var_1_20 == ((unsigned long int) ((var_1_18 + (var_1_22 + var_1_23)) - var_1_42))) : 1)) : (var_1_20 == ((unsigned long int) (var_1_17 - (var_1_48 + var_1_15))))) : (var_1_20 == ((unsigned long int) ((var_1_25 + var_1_26) - var_1_19))))) && (last_1_var_1_60 ? (var_1_27 == ((unsigned char) var_1_28)) : ((last_1_var_1_65 != (last_1_var_1_76 * (var_1_17 - last_1_var_1_90))) ? ((63.25 <= (var_1_12 * (abs (last_1_var_1_68)))) ? (var_1_27 == ((unsigned char) ((var_1_30 && var_1_31) && ((! var_1_28) && var_1_32)))) : (var_1_27 == ((unsigned char) ((! (var_1_30 && var_1_32)) || (var_1_31 && (var_1_28 && var_1_33)))))) : (var_1_27 == ((unsigned char) (var_1_30 && (! var_1_28))))))) && (((var_1_19 << var_1_35) <= (min (var_1_15 , (var_1_22 >> var_1_62)))) ? (var_1_34 == ((unsigned char) (abs (32)))) : (var_1_34 == ((unsigned char) (var_1_35 + var_1_36))))) && ((var_1_17 >= (var_1_38 - (var_1_19 - var_1_85))) ? (((! var_1_28) && (! (! var_1_32))) ? ((var_1_35 >= var_1_26) ? (((var_1_5 / var_1_11) <= (- var_1_4)) ? (var_1_32 ? (var_1_37 == ((unsigned char) ((var_1_75 || var_1_31) && (! var_1_28)))) : (var_1_37 == ((unsigned char) (! (var_1_60 && var_1_28))))) : (var_1_37 == ((unsigned char) (var_1_28 || var_1_33)))) : (var_1_37 == ((unsigned char) (var_1_33 || (! var_1_31))))) : (var_1_37 == ((unsigned char) var_1_28))) : (var_1_37 == ((unsigned char) 1)))) && (var_1_39 == ((unsigned long int) (min (var_1_48 , last_1_var_1_39))))) && ((((255.2 * var_1_64) * (max (var_1_4 , var_1_11))) == var_1_12) ? (var_1_40 == ((signed char) (50 + var_1_35))) : (var_1_31 ? (var_1_40 == ((signed char) (var_1_35 + (16 + (max (2 , var_1_41)))))) : ((3.8 < (- var_1_64)) ? (var_1_40 == ((signed char) (max (var_1_35 , var_1_41)))) : 1)))) && ((var_1_41 < (last_1_var_1_51 & last_1_var_1_48)) ? (var_1_33 ? (((var_1_19 * (var_1_36 & 64u)) >= (var_1_18 + last_1_var_1_51)) ? (var_1_42 == ((unsigned char) (var_1_43 - var_1_35))) : (var_1_42 == ((unsigned char) (max (var_1_44 , ((var_1_45 - var_1_35) + (10 + var_1_46))))))) : ((var_1_32 || ((max (last_1_var_1_63 , last_1_var_1_80)) == (var_1_46 / var_1_43))) ? (var_1_42 == ((unsigned char) (max (var_1_46 , var_1_45)))) : (var_1_42 == ((unsigned char) (min ((min (var_1_46 , var_1_44)) , var_1_43)))))) : 1)) && ((var_1_31 || var_1_27) ? (var_1_88 ? (((max (10.8f , var_1_68)) >= (- var_1_12)) ? (var_1_48 == ((unsigned short int) (var_1_49 - var_1_43))) : (var_1_48 == ((unsigned short int) var_1_85))) : (var_1_48 == ((unsigned short int) var_1_15))) : 1)) && (var_1_33 ? (var_1_50 == ((signed long int) (last_1_var_1_50 + var_1_42))) : 1)) && (var_1_51 == ((unsigned short int) (var_1_49 - var_1_43)))) && (var_1_52 == ((unsigned long int) ((min ((min (var_1_17 , 4285343471u)) , (var_1_53 - var_1_36))) - var_1_16)))) && (var_1_54 == ((unsigned char) ((var_1_55 - var_1_46) - (abs (var_1_35)))))) && ((var_1_11 <= 9.2f) ? (var_1_56 == ((unsigned char) (abs (min (var_1_43 , var_1_45))))) : (((4 - var_1_82) < (abs (var_1_65))) ? ((var_1_65 >= last_1_var_1_56) ? ((last_1_var_1_56 == (4 / var_1_55)) ? (((max ((2 + -1) , last_1_var_1_56)) > (max (var_1_35 , (var_1_82 - var_1_65)))) ? (var_1_33 ? (var_1_56 == ((unsigned char) var_1_35)) : (var_1_56 == ((unsigned char) ((min (var_1_55 , var_1_43)) - 64)))) : (((var_1_18 + var_1_25) > (var_1_17 - var_1_46)) ? (var_1_56 == ((unsigned char) (var_1_36 + (max ((var_1_46 + var_1_35) , var_1_45))))) : (var_1_37 ? (var_1_56 == ((unsigned char) (var_1_57 + var_1_46))) : 1))) : 1) : ((var_1_36 < (var_1_23 / (var_1_55 - var_1_58))) ? (var_1_56 == ((unsigned char) (max (var_1_55 , var_1_46)))) : (((var_1_25 / var_1_38) == var_1_46) ? (var_1_56 == ((unsigned char) (min (((200 - var_1_35) - (var_1_45 - 32)) , (min (var_1_36 , var_1_55)))))) : (var_1_56 == ((unsigned char) ((max ((var_1_35 + 4) , var_1_36)) + 32)))))) : (var_1_37 ? (var_1_56 == ((unsigned char) (var_1_36 + var_1_57))) : (var_1_56 == ((unsigned char) (min (var_1_35 , 4)))))))) && ((var_1_92 != (- 4u)) ? (var_1_59 == ((signed short int) (((abs (last_1_var_1_59)) + var_1_78) - (min (var_1_55 , (max (var_1_35 , var_1_44))))))) : ((var_1_22 == (var_1_38 - (max (var_1_45 , var_1_49)))) ? (var_1_59 == ((signed short int) (max ((min ((min (var_1_43 , var_1_92)) , var_1_58)) , var_1_46)))) : 1))) && (((var_1_91 + var_1_6) < (max (var_1_12 , (var_1_68 * var_1_5)))) ? (var_1_60 == ((unsigned char) (! var_1_28))) : 1)) && ((var_1_18 >= var_1_39) ? ((var_1_22 >= var_1_58) ? (var_1_61 == ((signed short int) (abs (var_1_55)))) : ((var_1_39 > var_1_26) ? (var_1_61 == ((signed short int) (var_1_58 + var_1_89))) : ((var_1_46 > var_1_54) ? (var_1_61 == ((signed short int) var_1_57)) : (var_1_61 == ((signed short int) var_1_55))))) : 1)) && (var_1_75 ? (var_1_62 == ((signed char) (var_1_58 - var_1_35))) : (var_1_62 == ((signed char) (var_1_35 - var_1_58))))) && (((var_1_18 + var_1_57) >= (var_1_19 << var_1_26)) ? (var_1_63 == ((signed short int) var_1_46)) : (var_1_63 == ((signed short int) (var_1_36 + (var_1_78 - (max (var_1_45 , var_1_43)))))))) && ((var_1_61 > var_1_23) ? (var_1_64 == ((float) (var_1_6 - (abs (var_1_4))))) : (var_1_64 == ((float) (var_1_6 - var_1_5))))) && ((var_1_86 < ((128 + var_1_35) + var_1_76)) ? (((- var_1_11) <= var_1_6) ? (var_1_65 == ((unsigned short int) (min (var_1_35 , (min ((abs (var_1_55)) , (max (var_1_57 , var_1_92)))))))) : (var_1_65 == ((unsigned short int) (var_1_49 - 128)))) : (var_1_65 == ((unsigned short int) (var_1_49 - ((var_1_66 - var_1_82) - var_1_36)))))) && ((! (var_1_15 > -64)) ? (var_1_60 ? (var_1_67 == ((unsigned char) ((max (var_1_55 , var_1_43)) - var_1_58))) : (var_1_67 == ((unsigned char) (var_1_46 + (max (var_1_35 , var_1_57)))))) : (var_1_67 == ((unsigned char) (var_1_55 - (var_1_45 - (5 + var_1_35))))))) && (last_1_var_1_75 ? (var_1_68 == ((float) (var_1_5 + var_1_6))) : ((last_1_var_1_67 > var_1_22) ? ((last_1_var_1_39 >= var_1_53) ? (var_1_68 == ((float) ((var_1_69 + (max (255.5f , var_1_70))) + (abs (var_1_6))))) : 1) : (var_1_68 == ((float) (((var_1_71 - var_1_72) + var_1_5) - var_1_6)))))) && ((var_1_41 < ((var_1_46 ^ var_1_57) % var_1_58)) ? (((var_1_90 * var_1_44) > var_1_89) ? (var_1_73 == ((unsigned long int) var_1_43)) : (var_1_73 == ((unsigned long int) (var_1_17 - last_1_var_1_73)))) : 1)) && (var_1_30 ? (var_1_74 == ((unsigned char) ((var_1_83 >= var_1_18) || (! var_1_28)))) : ((var_1_5 >= (128.625f - var_1_6)) ? (var_1_74 == ((unsigned char) (((var_1_94 / var_1_11) > var_1_68) || var_1_31))) : ((var_1_89 < var_1_65) ? ((! var_1_31) ? (var_1_74 == ((unsigned char) ((var_1_28 || var_1_27) && var_1_33))) : (var_1_74 == ((unsigned char) (! var_1_28)))) : 1)))) && (((8.5 != 3.5) || var_1_32) ? ((last_1_var_1_85 >= last_1_var_1_78) ? (var_1_75 == ((unsigned char) ((last_1_var_1_74 && (! var_1_30)) || var_1_28))) : 1) : (var_1_75 == ((unsigned char) (last_1_var_1_27 && var_1_28))))) && ((var_1_16 < var_1_63) ? (var_1_76 == ((signed long int) (25 - ((var_1_77 - var_1_43) - (max (5 , var_1_16)))))) : (((min (var_1_4 , (var_1_72 - var_1_5))) > 50.5f) ? (var_1_76 == ((signed long int) (max (var_1_34 , last_1_var_1_76)))) : (var_1_76 == ((signed long int) ((min (var_1_85 , last_1_var_1_76)) - (var_1_23 + (min (var_1_44 , var_1_55))))))))) && ((var_1_38 >= var_1_54) ? (var_1_78 == ((unsigned short int) (60934 - var_1_42))) : (var_1_78 == ((unsigned short int) (var_1_54 + (var_1_46 + (abs (var_1_67)))))))) && ((var_1_35 < var_1_53) ? ((var_1_20 <= ((~ var_1_54) + var_1_26)) ? (var_1_80 == ((signed char) (abs (var_1_41)))) : (var_1_80 == ((signed char) (min ((var_1_35 + var_1_46) , var_1_55))))) : 1)) && (var_1_60 ? (var_1_81 == ((unsigned long int) var_1_51)) : 1)) && (var_1_32 ? (var_1_82 == ((signed char) var_1_55)) : 1)) && (var_1_83 == ((signed char) var_1_35))) && (var_1_75 ? (var_1_84 == ((double) var_1_5)) : (var_1_84 == ((double) var_1_69)))) && (var_1_85 == ((signed short int) -200))) && (var_1_86 == ((signed short int) last_1_var_1_86))) && (var_1_87 == ((double) var_1_70))) && (var_1_88 == ((unsigned char) var_1_30))) && (var_1_27 ? (var_1_89 == ((signed long int) var_1_85)) : (var_1_89 == ((signed long int) var_1_41)))) && (var_1_90 == ((unsigned short int) var_1_46))) && (var_1_30 ? (var_1_91 == ((float) var_1_69)) : (var_1_91 == ((float) var_1_71)))) && (var_1_60 ? (var_1_92 == ((unsigned short int) (max (var_1_58 , (max (var_1_42 , (var_1_49 - var_1_55))))))) : 1)) && ((var_1_28 && (-500 < var_1_50)) ? (var_1_32 ? (var_1_94 == ((float) 99.25f)) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
