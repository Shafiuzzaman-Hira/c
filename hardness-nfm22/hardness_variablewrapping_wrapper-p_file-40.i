...
void step(void) {
 if ((*(var_1_3_Pointer))) {
  (*(var_1_16_Pointer)) = (((((*(var_1_17_Pointer))) > ((-2 + (*(var_1_18_Pointer))))) ? ((*(var_1_17_Pointer))) : ((-2 + (*(var_1_18_Pointer))))));
 }
 ...
 if ((*(var_1_19_Pointer)) != ((((last_1_var_1_13) < ((*(var_1_19_Pointer)))) ? (last_1_var_1_13) : ((*(var_1_19_Pointer)))))) {
...
int property() {
 return (((((((*(var_1_2_Pointer)) ? (((*(var_1_3_Pointer)) && ((*(var_1_19_Pointer)) <= (- 63.9f))) ? (((*(var_1_19_Pointer)) >= (*(var_1_19_Pointer))) ? ((*(var_1_3_Pointer)) ? ((*(var_1_1_Pointer)) == ((signed long int) (*(var_1_21_Pointer)))) : 1) : 1) : 1) : 1) && (((((*(var_1_16_Pointer)) / (*(var_1_8_Pointer))) / (*(var_1_9_Pointer))) >= ((*(var_1_21_Pointer)) | (*(var_1_16_Pointer)))) ? ((*(var_1_7_Pointer)) == ((unsigned char) ((*(var_1_11_Pointer)) - (*(var_1_12_Pointer))))) : ((*(var_1_7_Pointer)) == ((unsigned char) (*(var_1_12_Pointer)))))) && (((*(var_1_19_Pointer)) != ((((last_1_var_1_13) < ((*(var_1_19_Pointer)))) ? (last_1_var_1_13) : ((*(var_1_19_Pointer)))))) ? ((*(var_1_13_Pointer)) == ((double) ((*(var_1_15_Pointer)) + (127.4 - 8.25)))) : 1)) && ((*(var_1_3_Pointer)) ? ((*(var_1_16_Pointer)) == ((signed char) (((((*(var_1_17_Pointer))) > ((-2 + (*(var_1_18_Pointer))))) ? ((*(var_1_17_Pointer))) : ((-2 + (*(var_1_18_Pointer)))))))) : 1)) && ((*(var_1_19_Pointer)) == ((float) (*(var_1_15_Pointer))))) && ((*(var_1_20_Pointer)) == ((signed short int) (*(var_1_16_Pointer))))) && ((*(var_1_21_Pointer)) == ((signed short int) (*(var_1_18_Pointer))))
;
}
int main(void) {
 isInitial = 1;
