...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch59dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch59dependencies
	if (last_1_var_1_18) {
		if ((! last_1_var_1_15) || (last_1_var_1_19 < var_1_6)) {
	...
	// From: Req6Batch59dependencies
	var_1_17 = var_1_4;


	// From: Req7Batch59dependencies
	var_1_18 = var_1_16;


	// From: Req8Batch59dependencies
	var_1_19 = var_1_4;


	// From: Req1Batch59dependencies
	...
	// From: Req2Batch59dependencies
	if (var_1_17 < last_1_var_1_5) {
	...
	// From: Req4Batch59dependencies
	if (var_1_5 != ((var_1_6 / var_1_4) * (max (var_1_5 , var_1_19)))) {
		if (var_1_5 <= var_1_6) {
			var_1_13 = 32;
		} else {
			var_1_13 = var_1_14;
