...
void step(void) {
 ...
 if (BOOL_unsigned_char_Array_0[0]) {
  if (BOOL_unsigned_char_Array_0[1] && (float_Array_0[0] <= double_Array_0[0])) {
   if (((((float_Array_0[0]) > (double_Array_0[1])) ? (float_Array_0[0]) : (double_Array_0[1]))) > double_Array_0[0]) {
    unsigned_long_int_Array_0[0] = ((((((3725801564u - unsigned_char_Array_0[0]) - unsigned_char_Array_0[1])) > (unsigned_short_int_Array_0[0])) ? (((3725801564u - unsigned_char_Array_0[0]) - unsigned_char_Array_0[1])) : (unsigned_short_int_Array_0[0])));
   } else {
