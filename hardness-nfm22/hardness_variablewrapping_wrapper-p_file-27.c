...
void step(void) {
	...
	// From: Req1Batch27Wrapper_P
	signed long int stepLocal_0 = (*(var_1_11_Pointer));
	if (32 >= stepLocal_0) {
		(*(var_1_1_Pointer)) = ((*(var_1_3_Pointer)) + (max (((*(var_1_4_Pointer)) - (*(var_1_5_Pointer))) , (*(var_1_6_Pointer)))));
	} else {
		(*(var_1_1_Pointer)) = ((*(var_1_4_Pointer)) - (*(var_1_5_Pointer)));
	}


	// From: Req4Batch27Wrapper_P
	signed long int stepLocal_2 = max (((*(var_1_5_Pointer)) - (*(var_1_4_Pointer))) , (*(var_1_1_Pointer)));
	if ((*(var_1_8_Pointer))) {
