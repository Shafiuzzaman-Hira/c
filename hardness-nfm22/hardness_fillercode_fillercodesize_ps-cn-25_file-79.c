...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch79PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject3
	if (var_1_32 > 8) {
		if ((abs (var_1_35)) < (min ((abs (var_1_36)) , var_1_37))) {
			var_1_31 = var_1_33;
		}
	} else {
		var_1_31 = var_1_33;
	...
	// From: CodeObject5
	if (var_1_33 < ((var_1_32 - var_1_40) << var_1_34)) {
		if (var_1_40 > (var_1_41 ^ var_1_34)) {
	...
	// From: Req7Batch79PS_CN_25
	var_1_26 = var_1_16;


	// From: Req8Batch79PS_CN_25
	var_1_27 = 10u;


	// From: Req3Batch79PS_CN_25
