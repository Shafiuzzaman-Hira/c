...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch29PS_CN_25.c", 13, "reach_error"); }
...
double var_1_41 = 999999.644;
unsigned long int var_1_42 = 2718193706;
...
void step(void) {
	...
	// From: CodeObject6
	if ((var_1_42 - var_1_34) < var_1_35) {
		if (var_1_38 >= var_1_42) {
			var_1_41 = (abs (var_1_30));
		} else {
			var_1_41 = var_1_30;
		}
	}
	...
	// From: Req2Batch29PS_CN_25
	var_1_8 = (var_1_9 - (2 + var_1_10));


	// From: Req6Batch29PS_CN_25
	...
	// From: Req7Batch29PS_CN_25
	if (! ((var_1_9 - var_1_22) > var_1_12)) {
		var_1_27 = var_1_15;
	}


	// From: Req4Batch29PS_CN_25
