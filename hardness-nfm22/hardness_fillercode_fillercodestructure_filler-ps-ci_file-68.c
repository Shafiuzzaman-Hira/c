...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch68Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
	// From: CodeObject1
	var_1_17 = (var_1_5 || (var_1_14 && var_1_5));
	...
	if (var_1_31 >= var_1_32) {
		if ((var_1_12 > var_1_16) || var_1_14) {
			var_1_34 = ((var_1_1 && var_1_5) || var_1_5);
		}
	} else {
	...
	// From: CodeObject7
	if ((var_1_13 ^ (var_1_8 | var_1_8)) < (var_1_31 ^ var_1_8)) {
		var_1_37 = var_1_31;
	}
	...
	// From: Req8Batch68Filler_PS_CI
	var_1_16 = last_1_var_1_12;


	// From: Req6Batch68Filler_PS_CI
	...
	// From: Req7Batch68Filler_PS_CI
	var_1_15 = var_1_10;


	// From: Req3Batch68Filler_PS_CI
