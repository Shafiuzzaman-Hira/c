...
void step(void) {
 ...
 if (stepLocal_0 != (last_1_WrapperStruct00_var_1_18 ^ last_1_WrapperStruct00_var_1_13)) {
  ...
  (*(WrapperStruct00_var_1_7_Pointer)) = (((((*(WrapperStruct00_var_1_12_Pointer))) < ((*(WrapperStruct00_var_1_11_Pointer)))) ? ((*(WrapperStruct00_var_1_12_Pointer))) : ((*(WrapperStruct00_var_1_11_Pointer)))));
 }
 ...
 if (stepLocal_1 && (*(WrapperStruct00_var_1_14_Pointer))) {
  (*(WrapperStruct00_var_1_13_Pointer)) = (((((*(WrapperStruct00_var_1_15_Pointer))) < (100)) ? ((*(WrapperStruct00_var_1_15_Pointer))) : (100)));
 } else {
 ...
 if (stepLocal_2 > (*(WrapperStruct00_var_1_16_Pointer))) {
  if ((*(WrapperStruct00_var_1_3_Pointer)) < ((*(WrapperStruct00_var_1_5_Pointer)) - (*(WrapperStruct00_var_1_6_Pointer)))) {
   (*(WrapperStruct00_var_1_18_Pointer)) = (((((*(WrapperStruct00_var_1_15_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_15_Pointer))) : ((*(WrapperStruct00_var_1_15_Pointer)))));
  } else {
