...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch47normal.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch47normal
	if (var_1_5 >= (32796 - (min (var_1_6 , var_1_9)))) {
		if (var_1_10) {
			var_1_8 = var_1_11;
		}
	}
	...
	// From: Req5Batch47normal
	if (var_1_16) {
		if ((var_1_1 < 64) || var_1_10) {
			var_1_19 = var_1_17;
		}
	}


	// From: Req6Batch47normal
	if (var_1_6 <= var_1_4) {
		if (var_1_16) {
