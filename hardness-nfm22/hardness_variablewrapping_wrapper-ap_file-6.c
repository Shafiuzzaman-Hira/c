...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch6Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch6Wrapper_AP
	if (((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var2_Pointer)) - last_1_unsigned_long_int_Array_0_0_) == last_1_signed_long_int_Array_0_2_) {
		if ((((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) - (*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer))) - (*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer))) > (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))) {
			(*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)) = ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)));
		}
	} else {
	...
	if ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) > (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer))) {
		(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) = ((min ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)) , (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)))) - (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)));
	}


	// From: Req3Batch6Wrapper_AP
	...
	// From: Req5Batch6Wrapper_AP
	(*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)) = (min ((abs (last_1_unsigned_long_int_Array_0_0_)) , ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)))));


	// From: Req1Batch6Wrapper_AP
	...
	if (((max ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) , (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)))) / (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var2_Pointer))) > stepLocal_1) {
