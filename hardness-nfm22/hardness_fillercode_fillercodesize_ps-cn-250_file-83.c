...
void step(void) {
	...
	if (var_1_84 <= var_1_83) {
		var_1_85 = (min (var_1_40 , var_1_86));
	}
	...
	// From: Req2Batch83PS_CN_250
	var_1_7 = ((var_1_8 - var_1_9) - (100 - (var_1_10 + var_1_11)));


	// From: Req4Batch83PS_CN_250
	var_1_16 = (var_1_17 + (abs (var_1_18)));


	// From: Req7Batch83PS_CN_250
