...
void step(void) {
 ...
 if (var_1_22) {
  if ((((((var_1_20 >> var_1_21)) < (((((var_1_33) > (var_1_34)) ? (var_1_33) : (var_1_34))))) ? ((var_1_20 >> var_1_21)) : (((((var_1_33) > (var_1_34)) ? (var_1_33) : (var_1_34)))))) >= var_1_35) {
 ...
 if ((- (10000 + 8)) > ((((var_1_33) < 0 ) ? -(var_1_33) : (var_1_33)))) {
  var_1_44 = (var_1_45 + var_1_46);
 }
 if (var_1_27 < (var_1_41 - ((((var_1_46) < 0 ) ? -(var_1_46) : (var_1_46))))) {
  var_1_47 = ((((var_1_42) < 0 ) ? -(var_1_42) : (var_1_42)));
 }
 var_1_48 = (((((var_1_46) > (var_1_45)) ? (var_1_46) : (var_1_45))) + var_1_49);
 var_1_50 = ((((var_1_51) > (var_1_52)) ? (var_1_51) : (var_1_52)));
 if (var_1_48 >= ((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24)))) {
  if (var_1_24 >= var_1_54) {
   var_1_53 = (var_1_50 + (((((var_1_55 - var_1_52)) > ((var_1_56 - var_1_51))) ? ((var_1_55 - var_1_52)) : ((var_1_56 - var_1_51)))));
  } else {
   var_1_53 = (((((var_1_57) < (var_1_58)) ? (var_1_57) : (var_1_58))) - ((((((((var_1_52) > (var_1_51)) ? (var_1_52) : (var_1_51)))) < (5)) ? (((((var_1_52) > (var_1_51)) ? (var_1_52) : (var_1_51)))) : (5))));
  }
 } else {
  if (var_1_33 < var_1_34) {
   if (var_1_37) {
    if (var_1_59 != ((var_1_47 >> var_1_34) >> var_1_52)) {
     var_1_53 = ((((((((var_1_58) < (var_1_52)) ? (var_1_58) : (var_1_52)))) < (var_1_60)) ? (((((var_1_58) < (var_1_52)) ? (var_1_58) : (var_1_52)))) : (var_1_60)));
    } else {
 ...
 if (var_1_38) {
  if ((var_1_52 - var_1_50) < var_1_53) {
   var_1_61 = (var_1_49 + (((((32.2) > (var_1_62)) ? (32.2) : (var_1_62))) + var_1_63));
  } else {
   if (var_1_31) {
    var_1_61 = ((((var_1_30) < ((((((var_1_46 + var_1_45)) < (var_1_49)) ? ((var_1_46 + var_1_45)) : (var_1_49))))) ? (var_1_30) : ((((((var_1_46 + var_1_45)) < (var_1_49)) ? ((var_1_46 + var_1_45)) : (var_1_49))))));
   } else {
    var_1_61 = (((((var_1_64) < (0.75)) ? (var_1_64) : (0.75))) + ((((var_1_46) < 0 ) ? -(var_1_46) : (var_1_46))));
   }
  }
 } else {
  var_1_61 = var_1_64;
 }
 if (var_1_22 || (((((var_1_51) < (var_1_53)) ? (var_1_51) : (var_1_53))) <= var_1_55)) {
  if (var_1_36) {
   if (var_1_30 >= var_1_45) {
    if (var_1_32 && var_1_31) {
     var_1_65 = ((((var_1_58) < 0 ) ? -(var_1_58) : (var_1_58)));
    }
   } else {
    if ((((((var_1_33) < 0 ) ? -(var_1_33) : (var_1_33))) % ((((var_1_55) > (var_1_56)) ? (var_1_55) : (var_1_56)))) > ((((var_1_21) < (128)) ? (var_1_21) : (128)))) {
     var_1_65 = var_1_53;
    }
   }
  }
 ...
 if (1u < var_1_56) {
  var_1_66 = ((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52)));
 } else {
  if (var_1_21 >= var_1_52) {
   if (var_1_62 < (var_1_40 * ((((255.75) < 0 ) ? -(255.75) : (255.75))))) {
    if ((~ var_1_65) <= var_1_53) {
     if (var_1_33 != var_1_42) {
      var_1_66 = (var_1_50 - var_1_52);
     }
    } else {
     var_1_66 = ((((((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34)))) < (((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51))))) ? (((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34)))) : (((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51))))));
    }
   } else {
    var_1_66 = (var_1_50 - (26127 - (2 + var_1_51)));
   }
  } else {
   if (var_1_65 <= ((var_1_57 % var_1_56) >> ((((var_1_67) < (var_1_68)) ? (var_1_67) : (var_1_68))))) {
    var_1_66 = (var_1_50 - var_1_51);
   }
  }
 }
 if (((((var_1_67) < 0 ) ? -(var_1_67) : (var_1_67))) >= ((var_1_70 | var_1_71) * var_1_51)) {
  if (var_1_56 > var_1_50) {
   var_1_69 = ((((var_1_30) < ((((((var_1_64) > (var_1_62)) ? (var_1_64) : (var_1_62))) + (var_1_63 + var_1_72)))) ? (var_1_30) : ((((((var_1_64) > (var_1_62)) ? (var_1_64) : (var_1_62))) + (var_1_63 + var_1_72)))));
  } else {
   if (var_1_56 > (var_1_60 / ((((var_1_55) < 0 ) ? -(var_1_55) : (var_1_55))))) {
    var_1_69 = ((((((var_1_73 - var_1_74)) < (var_1_64)) ? ((var_1_73 - var_1_74)) : (var_1_64))) + var_1_46);
   } else {
    var_1_69 = (var_1_74 - ((((var_1_49) < 0 ) ? -(var_1_49) : (var_1_49))));
   }
  }
 }
 if (var_1_54 <= ((((var_1_74) < 0 ) ? -(var_1_74) : (var_1_74)))) {
  var_1_75 = ((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52)));
 } else {
  if (var_1_46 >= ((((var_1_74) < 0 ) ? -(var_1_74) : (var_1_74)))) {
   var_1_75 = (((var_1_76 - var_1_67) + var_1_77) - var_1_68);
  }
 }
 if (((((((((var_1_74) > (var_1_24)) ? (var_1_74) : (var_1_24)))) > (var_1_48)) ? (((((var_1_74) > (var_1_24)) ? (var_1_74) : (var_1_24)))) : (var_1_48))) < (var_1_64 + (8.5f - var_1_73))) {
  var_1_78 = (((((((((var_1_59) < (var_1_21)) ? (var_1_59) : (var_1_21))) - 10)) > (var_1_57)) ? ((((((var_1_59) < (var_1_21)) ? (var_1_59) : (var_1_21))) - 10)) : (var_1_57)));
 } else {
  var_1_78 = ((((var_1_68) > (var_1_58)) ? (var_1_68) : (var_1_58)));
 }
 if (256 > var_1_75) {
  var_1_79 = ((((var_1_51) > (var_1_76)) ? (var_1_51) : (var_1_76)));
 }
 if (((((var_1_34) < ((~ var_1_60))) ? (var_1_34) : ((~ var_1_60)))) >= var_1_33) {
  if (var_1_33 <= (var_1_67 - var_1_76)) {
   var_1_80 = ((((var_1_62) < 0 ) ? -(var_1_62) : (var_1_62)));
  }
 }
 if (var_1_28) {
 ...
 if (var_1_33 >= (8 & var_1_58)) {
  var_1_87 = ((((var_1_88) < 0 ) ? -(var_1_88) : (var_1_88)));
 }
 if (var_1_54 == (((((((var_1_46) < (1.4f)) ? (var_1_46) : (1.4f))) < 0 ) ? -((((var_1_46) < (1.4f)) ? (var_1_46) : (1.4f))) : ((((var_1_46) < (1.4f)) ? (var_1_46) : (1.4f)))))) {
  if (var_1_26) {
   var_1_89 = var_1_67;
  }
 }
