...
void step(void) {
	...
	// From: Req2Batch38stepLocals
	if (var_1_2 < (max (var_1_3 , (128.5 * var_1_5)))) {
		var_1_7 = (var_1_1 && (! 1));
	}


	// From: Req3Batch38stepLocals
