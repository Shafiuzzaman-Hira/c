...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch39dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch39dependencies
	if (((last_1_var_1_10 + last_1_var_1_14) ^ last_1_var_1_10) < (last_1_var_1_24 | -4)) {
	...
	// From: Req7Batch39dependencies
	var_1_24 = var_1_25;


	// From: Req8Batch39dependencies
	var_1_26 = var_1_8;


	// From: Req5Batch39dependencies
	if (var_1_26 >= var_1_7) {
		if (var_1_1 > var_1_11) {
			if (var_1_6 && var_1_16) {
	...
	// From: Req3Batch39dependencies
	var_1_10 = (min ((abs (var_1_11 - var_1_8)) , (max (0u , var_1_26))));


	// From: Req4Batch39dependencies
	if (var_1_26 < (var_1_8 / (1u + 16u))) {
		if (var_1_11 > (var_1_26 + 5u)) {
	...
	// From: Req2Batch39dependencies
	if (var_1_10 >= (min (var_1_1 , last_1_var_1_9))) {
		if (var_1_6) {
			var_1_9 = var_1_8;
		}
	}
