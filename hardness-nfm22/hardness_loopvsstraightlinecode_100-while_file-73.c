...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch73100_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req12Batch73100_while
	var_1_36 = (! var_1_37);


	// From: Req15Batch73100_while
	var_1_45 = var_1_21;


	// From: Req3Batch73100_while
	if ((! var_1_36) && var_1_36) {
		var_1_19 = (var_1_21 + var_1_22);
	}


	// From: Req5Batch73100_while
	if (((min (var_1_10 , 1.0000000000002E12)) >= var_1_22) && var_1_36) {
		var_1_25 = (max (var_1_16 , 2));
	}


	// From: Req8Batch73100_while
	if (var_1_36 || var_1_36) {
		var_1_29 = (var_1_30 - var_1_25);
	}


	// From: Req11Batch73100_while
	if (var_1_36) {
		if (! var_1_36) {
			var_1_33 = (abs (var_1_21));
		} else {
	...
	// From: Req6Batch73100_while
	if (! (var_1_18 > var_1_23)) {
		if (var_1_36) {
			var_1_26 = (max (var_1_22 , var_1_21));
		}
	} else {
		if (var_1_36) {
			var_1_26 = var_1_22;
	...
	// From: Req7Batch73100_while
	signed char stepLocal_3 = var_1_15;
	signed long int stepLocal_2 = min (var_1_17 , (~ var_1_25));
	if (var_1_26 > var_1_10) {
		...
		var_1_27 = ((min (var_1_22 , var_1_21)) + var_1_28);
	}


	// From: Req9Batch73100_while
	signed long int stepLocal_4 = 10 - var_1_23;
	if (stepLocal_4 <= var_1_16) {
		var_1_31 = (max (var_1_4 , (var_1_30 - var_1_25)));
	} else {
		if (var_1_36) {
			var_1_31 = var_1_23;
		} else {
	...
	// From: Req10Batch73100_while
	if (var_1_36) {
		var_1_32 = (var_1_23 + var_1_16);
	}


	// From: Req13Batch73100_while
	...
	// From: Req1Batch73100_while
	if (var_1_36) {
		var_1_1 = (var_1_25 + ((var_1_4 - var_1_23) - var_1_38));
	}


	// From: Req2Batch73100_while
	if ((min ((min (var_1_26 , var_1_45)) , -0.6)) == (var_1_10 - var_1_11)) {
...
int property() {
	return ((((((((((((((var_1_36 ? (var_1_1 == ((unsigned long int) (var_1_25 + ((var_1_4 - var_1_23) - var_1_38)))) : 1) && (((min ((min (var_1_26 , var_1_45)) , -0.6)) == (var_1_10 - var_1_11)) ? (var_1_7 == ((signed char) (max ((4 + var_1_12) , (min (var_1_13 , (var_1_14 + var_1_15))))))) : (var_1_7 == ((signed char) ((var_1_16 - var_1_17) - var_1_18))))) && (((! var_1_36) && var_1_36) ? (var_1_19 == ((float) (var_1_21 + var_1_22))) : 1)) && (((var_1_25 / (max (var_1_16 , var_1_4))) <= var_1_42) ? ((var_1_25 < var_1_18) ? (var_1_23 == ((unsigned char) var_1_17)) : (var_1_23 == ((unsigned char) var_1_16))) : (var_1_23 == ((unsigned char) var_1_18)))) && ((((min (var_1_10 , 1.0000000000002E12)) >= var_1_22) && var_1_36) ? (var_1_25 == ((unsigned char) (max (var_1_16 , 2)))) : 1)) && ((! (var_1_18 > var_1_23)) ? (var_1_36 ? (var_1_26 == ((float) (max (var_1_22 , var_1_21)))) : 1) : (var_1_36 ? (var_1_26 == ((float) var_1_22)) : 1))) && ((var_1_26 > var_1_10) ? ((var_1_15 != var_1_14) ? (((min (var_1_17 , (~ var_1_25))) <= var_1_29) ? (var_1_27 == ((double) var_1_22)) : 1) : 1) : (var_1_27 == ((double) ((min (var_1_22 , var_1_21)) + var_1_28))))) && ((var_1_36 || var_1_36) ? (var_1_29 == ((unsigned long int) (var_1_30 - var_1_25))) : 1)) && (((10 - var_1_23) <= var_1_16) ? (var_1_31 == ((unsigned long int) (max (var_1_4 , (var_1_30 - var_1_25))))) : (var_1_36 ? (var_1_31 == ((unsigned long int) var_1_23)) : (var_1_31 == ((unsigned long int) var_1_23))))) && (var_1_36 ? (var_1_32 == ((unsigned long int) (var_1_23 + var_1_16))) : 1)) && (var_1_36 ? ((! var_1_36) ? (var_1_33 == ((double) (abs (var_1_21)))) : (var_1_33 == ((double) (abs (var_1_34 - var_1_35))))) : 1)) && (var_1_36 == ((unsigned char) (! var_1_37)))) && ((var_1_12 > var_1_42) ? (var_1_38 == ((unsigned char) ((var_1_17 + (var_1_39 + 1)) + (var_1_40 - var_1_41)))) : 1)) && (var_1_37 ? (var_1_42 == ((unsigned long int) ((var_1_4 + (var_1_43 + var_1_44)) - var_1_25))) : (var_1_42 == ((unsigned long int) ((1634918646u - var_1_16) + var_1_40))))) && (var_1_45 == ((double) var_1_21))
;
}
int main(void) {
	isInitial = 1;
