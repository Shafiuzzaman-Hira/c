...
int property() {
	return (var_1_2 <= var_1_3) ? (var_1_1 == ((signed short int) ((max (16 , var_1_4)) - var_1_5))) : ((var_1_3 > (var_1_2 | (var_1_6 - 32))) ? (var_1_1 == ((signed short int) var_1_4)) : (var_1_1 == ((signed short int) var_1_4)))
;
}
int main(void) {
	isInitial = 1;
