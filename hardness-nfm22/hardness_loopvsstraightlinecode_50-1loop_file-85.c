...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch8550_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch8550_1loop
	var_1_13 = (abs (var_1_14));


	// From: Req7Batch8550_1loop
	var_1_16 = (var_1_6 && var_1_17);


	// From: Req6Batch8550_1loop
	if (var_1_5) {
		var_1_15 = (max (var_1_1 , (var_1_13 + (abs (var_1_14)))));
	}


	// From: Req3Batch8550_1loop
