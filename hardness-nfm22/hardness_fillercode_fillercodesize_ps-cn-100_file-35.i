...
void step(void) {
 if (var_1_27) {
  if (var_1_28 <= ((var_1_29 - var_1_30) >> 1)) {
   var_1_26 = ((((var_1_31) > (var_1_32)) ? (var_1_31) : (var_1_32)));
  }
 }
 if (var_1_29 > var_1_28) {
  var_1_33 = (((((((((var_1_34 - var_1_35)) > (var_1_36)) ? ((var_1_34 - var_1_35)) : (var_1_36)))) < (64)) ? ((((((var_1_34 - var_1_35)) > (var_1_36)) ? ((var_1_34 - var_1_35)) : (var_1_36)))) : (64)));
 } else {
  if (var_1_31 <= (((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))) - var_1_37)) {
   var_1_33 = var_1_36;
  }
 }
 if (-32 < (var_1_35 | var_1_34)) {
  if (var_1_28 < (var_1_35 | var_1_33)) {
   var_1_38 = ((((128) > (var_1_39)) ? (128) : (var_1_39)));
  } else {
   if (! var_1_27) {
    var_1_38 = ((((var_1_39) < (((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))))) ? (var_1_39) : (((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))))));
   }
  }
 } else {
  var_1_38 = ((((var_1_40) > (var_1_39)) ? (var_1_40) : (var_1_39)));
 }
 var_1_41 = (1.8 - var_1_42);
 if (var_1_34 > var_1_28) {
  if ((var_1_28 * (var_1_30 & var_1_35)) > (var_1_34 * ((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))))) {
   if ((3.6 - var_1_37) <= ((((var_1_41) > ((var_1_32 / 0.4))) ? (var_1_41) : ((var_1_32 / 0.4))))) {
    if (var_1_35 > -200) {
     var_1_43 = ((((var_1_44) > (var_1_45)) ? (var_1_44) : (var_1_45)));
    } else {
     if (var_1_40 == 4) {
      var_1_43 = (((((((32 + var_1_46) < 0 ) ? -(32 + var_1_46) : (32 + var_1_46))) < 0 ) ? -((((32 + var_1_46) < 0 ) ? -(32 + var_1_46) : (32 + var_1_46))) : ((((32 + var_1_46) < 0 ) ? -(32 + var_1_46) : (32 + var_1_46)))));
     }
    }
   }
  }
 ...
 if (var_1_27 && var_1_48) {
  var_1_47 = ((((((((var_1_43) > (var_1_40)) ? (var_1_43) : (var_1_40)))) < (var_1_44)) ? (((((var_1_43) > (var_1_40)) ? (var_1_43) : (var_1_40)))) : (var_1_44)));
 } else {
  var_1_47 = (((((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) < 0 ) ? -((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) : ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34)))));
 }
 if (((var_1_45 % var_1_50) / (var_1_51 - var_1_52)) >= ((((1) < (var_1_35)) ? (1) : (var_1_35)))) {
  var_1_49 = (((((var_1_44) > (var_1_43)) ? (var_1_44) : (var_1_43))) - ((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52))));
 } else {
  var_1_49 = ((((((((((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39)))) > (var_1_35)) ? (((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39)))) : (var_1_35)))) > (var_1_52)) ? (((((((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39)))) > (var_1_35)) ? (((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39)))) : (var_1_35)))) : (var_1_52)));
 }
 if (var_1_48) {
  var_1_53 = (10u + (((((var_1_54 - var_1_51)) > (var_1_46)) ? ((var_1_54 - var_1_51)) : (var_1_46))));
 }
 if (var_1_37 >= var_1_41) {
  var_1_55 = ((var_1_45 + var_1_39) + ((((((((var_1_46) < 0 ) ? -(var_1_46) : (var_1_46)))) > (((((var_1_50) < 0 ) ? -(var_1_50) : (var_1_50))))) ? (((((var_1_46) < 0 ) ? -(var_1_46) : (var_1_46)))) : (((((var_1_50) < 0 ) ? -(var_1_50) : (var_1_50)))))));
 } else {
  var_1_55 = ((((var_1_46) > (((((var_1_50) < (var_1_39)) ? (var_1_50) : (var_1_39))))) ? (var_1_46) : (((((var_1_50) < (var_1_39)) ? (var_1_50) : (var_1_39))))));
 }
