...
void step(void) {
	// From: Req24Batch44Amount250
	if ((var_1_19 - var_1_18) <= last_1_var_1_13) {
		var_1_60 = ((min ((last_1_var_1_23 + var_1_32) , var_1_21)) - 64);
	} else {
		var_1_60 = last_1_var_1_58;
	}


	// From: Req21Batch44Amount250
	if (last_1_var_1_49) {
		var_1_57 = var_1_32;
	}


	// From: Req3Batch44Amount250
	var_1_9 = (min (-10 , var_1_57));


	// From: Req20Batch44Amount250
	...
	// From: Req1Batch44Amount250
	if (last_1_var_1_60 >= last_1_var_1_23) {
		var_1_1 = (! var_1_4);
	}


	// From: Req22Batch44Amount250
	if (var_1_1) {
		var_1_58 = var_1_24;
	} else {
		var_1_58 = var_1_47;
	...
	// From: Req19Batch44Amount250
	if (last_1_var_1_53 <= (abs (var_1_58))) {
		if ((2 - var_1_33) != (~ (var_1_31 / var_1_47))) {
			var_1_53 = (min (var_1_47 , (min ((var_1_20 + var_1_41) , var_1_58))));
		} else {
			if (var_1_8 || var_1_1) {
				var_1_53 = (((var_1_54 - var_1_32) - (min (last_1_var_1_53 , var_1_31))) - var_1_20);
			} else {
				var_1_53 = ((var_1_55 - var_1_47) - (min (var_1_58 , var_1_20)));
			}
		}
	} else {
	...
	if ((min (var_1_17 , var_1_34)) < var_1_19) {
		if (var_1_53 < stepLocal_13) {
			...
			if (var_1_35 == (var_1_25 + (min (var_1_15 , var_1_17)))) {
				var_1_46 = (min ((abs (var_1_30)) , var_1_47));
			}
		}
	}


	// From: Req10Batch44Amount250
		...
		if (var_1_53 <= stepLocal_9) {
			if (var_1_15 <= var_1_29) {
				...
				if (((var_1_39 - var_1_33) >> var_1_57) > stepLocal_6) {
					if (var_1_4) {
						var_1_38 = (((max (var_1_41 , 1726043421u)) - var_1_21) + (var_1_30 + 8u));
					}
				} else {
					var_1_38 = var_1_21;
				}
	...
	if (var_1_20 <= stepLocal_12) {
		...
		if (var_1_38 < stepLocal_11) {
			...
			if ((var_1_22 * var_1_36) < (max ((var_1_37 + var_1_35) , 31.5))) {
	...
	// From: Req17Batch44Amount250
	signed long int stepLocal_15 = max (var_1_9 , var_1_31);
	signed long int stepLocal_14 = (min (var_1_46 , var_1_58)) / var_1_50;
...
int property() {
	return ((((((((((((((((((((((((last_1_var_1_60 >= last_1_var_1_23) ? (var_1_1 == ((unsigned char) (! var_1_4))) : 1) && ((var_1_23 <= (var_1_20 - var_1_58)) ? (var_1_5 == ((unsigned char) (var_1_26 || var_1_4))) : (var_1_5 == ((unsigned char) (! (! var_1_8)))))) && (var_1_9 == ((signed short int) (min (-10 , var_1_57))))) && (var_1_11 == ((unsigned char) ((var_1_8 || var_1_4) && var_1_12)))) && (var_1_26 ? ((var_1_20 > var_1_46) ? (var_1_13 == ((float) (max (var_1_15 , var_1_16)))) : 1) : (var_1_13 == ((float) (abs (var_1_17 - (var_1_18 - var_1_19))))))) && (var_1_20 == ((unsigned short int) (45013 - var_1_21)))) && (var_1_22 == ((float) (max ((max ((max (var_1_15 , var_1_16)) , var_1_19)) , var_1_17))))) && (((9999999.6 / var_1_18) > var_1_16) ? (var_1_23 == ((unsigned short int) (abs (var_1_21 + var_1_24)))) : 1)) && (var_1_25 == ((double) (max (((max (var_1_19 , 999.5)) - var_1_17) , var_1_16))))) && (((var_1_24 * var_1_60) > (var_1_20 - var_1_53)) ? (var_1_26 == ((unsigned char) (! ((var_1_4 && var_1_12) && var_1_28)))) : 1)) && (var_1_12 ? ((var_1_20 <= (var_1_53 >> var_1_56)) ? ((((var_1_30 + var_1_31) - var_1_21) >= 128) ? (((var_1_24 - var_1_20) <= (var_1_21 >> (var_1_32 + var_1_33))) ? (var_1_29 == ((double) (-0.4 + var_1_19))) : (var_1_29 == ((double) (((min (var_1_18 , var_1_34)) - var_1_19) - ((var_1_35 + var_1_36) + var_1_37))))) : 1) : 1) : 1)) && ((var_1_17 >= (- var_1_34)) ? ((var_1_23 <= -1) ? (((~ var_1_30) > (var_1_31 & (var_1_23 * var_1_58))) ? (var_1_38 == ((unsigned long int) var_1_24)) : 1) : (var_1_38 == ((unsigned long int) ((var_1_39 - (var_1_56 + 500u)) - 4u)))) : ((var_1_53 <= (var_1_56 ^ var_1_32)) ? ((var_1_15 <= var_1_29) ? (((var_1_24 * var_1_56) <= (var_1_31 - var_1_30)) ? (var_1_38 == ((unsigned long int) var_1_31)) : (var_1_38 == ((unsigned long int) 200u))) : ((((var_1_39 - var_1_33) >> var_1_57) > var_1_58) ? (var_1_4 ? (var_1_38 == ((unsigned long int) (((max (var_1_41 , 1726043421u)) - var_1_21) + (var_1_30 + 8u)))) : 1) : (var_1_38 == ((unsigned long int) var_1_21)))) : 1))) && ((! var_1_8) ? ((4 < var_1_57) ? (var_1_42 == ((float) var_1_19)) : (var_1_42 == ((float) (((16.24f - var_1_35) + var_1_36) + var_1_37)))) : ((var_1_23 != 64) ? (var_1_42 == ((float) (min (var_1_18 , var_1_19)))) : (var_1_42 == ((float) (255.84f - var_1_35)))))) && ((var_1_20 <= ((16 + var_1_9) - var_1_24)) ? (var_1_43 == ((unsigned char) (! 1))) : ((var_1_38 < var_1_21) ? (var_1_43 == ((unsigned char) (var_1_28 && var_1_12))) : (((var_1_22 * var_1_36) < (max ((var_1_37 + var_1_35) , 31.5))) ? (var_1_43 == ((unsigned char) (var_1_4 && (! var_1_28)))) : 1)))) && (((min (var_1_17 , var_1_34)) < var_1_19) ? ((var_1_53 < -5) ? (var_1_1 ? (var_1_12 ? (var_1_46 == ((signed short int) ((var_1_47 - var_1_32) - var_1_30))) : (var_1_46 == ((signed short int) var_1_31))) : (var_1_46 == ((signed short int) ((var_1_47 - var_1_31) - var_1_30)))) : ((var_1_35 == (var_1_25 + (min (var_1_15 , var_1_17)))) ? (var_1_46 == ((signed short int) (min ((abs (var_1_30)) , var_1_47)))) : 1)) : 1)) && ((var_1_20 == var_1_58) ? ((var_1_57 == var_1_58) ? (var_1_48 == ((double) (min (var_1_36 , var_1_19)))) : ((var_1_38 <= (var_1_60 ^ (var_1_58 * var_1_41))) ? (var_1_48 == ((double) (var_1_36 + var_1_19))) : 1)) : 1)) && ((((min (var_1_46 , var_1_58)) / var_1_50) > (var_1_33 << var_1_9)) ? (var_1_49 == ((unsigned char) ((var_1_12 && var_1_28) && (var_1_4 && (var_1_52 || var_1_51))))) : ((var_1_57 > (max (var_1_9 , var_1_31))) ? (var_1_49 == ((unsigned char) var_1_28)) : (var_1_49 == ((unsigned char) (! var_1_4)))))) && ((var_1_25 >= ((- var_1_19) / var_1_18)) ? (var_1_52 == ((unsigned char) var_1_12)) : (var_1_52 == ((unsigned char) (var_1_5 || var_1_12))))) && ((last_1_var_1_53 <= (abs (var_1_58))) ? (((2 - var_1_33) != (~ (var_1_31 / var_1_47))) ? (var_1_53 == ((unsigned long int) (min (var_1_47 , (min ((var_1_20 + var_1_41) , var_1_58)))))) : ((var_1_8 || var_1_1) ? (var_1_53 == ((unsigned long int) (((var_1_54 - var_1_32) - (min (last_1_var_1_53 , var_1_31))) - var_1_20))) : (var_1_53 == ((unsigned long int) ((var_1_55 - var_1_47) - (min (var_1_58 , var_1_20))))))) : (var_1_53 == ((unsigned long int) (var_1_39 - 8u))))) && (last_1_var_1_52 ? (var_1_56 == ((unsigned long int) (max (50u , var_1_41)))) : ((var_1_4 || last_1_var_1_49) ? (((last_1_var_1_48 / var_1_18) <= (- var_1_37)) ? (var_1_56 == ((unsigned long int) (var_1_55 - 100u))) : (var_1_56 == ((unsigned long int) var_1_39))) : 1))) && (last_1_var_1_49 ? (var_1_57 == ((signed char) var_1_32)) : 1)) && (var_1_1 ? (var_1_58 == ((unsigned short int) var_1_24)) : (var_1_58 == ((unsigned short int) var_1_47)))) && (var_1_12 ? (var_1_59 == ((signed short int) var_1_32)) : (var_1_59 == ((signed short int) var_1_58)))) && (((var_1_19 - var_1_18) <= last_1_var_1_13) ? (var_1_60 == ((signed long int) ((min ((last_1_var_1_23 + var_1_32) , var_1_21)) - 64))) : (var_1_60 == ((signed long int) last_1_var_1_58)))
;
}
int main(void) {
	isInitial = 1;
