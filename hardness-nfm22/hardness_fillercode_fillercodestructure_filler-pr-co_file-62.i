...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch62Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_31 = var_1_30;
 var_1_34 = (! (var_1_25 && var_1_30));
 if (((var_1_17 >> var_1_19) % -10) >= var_1_13) {
  if ((var_1_37 - ((((var_1_33) < 0 ) ? -(var_1_33) : (var_1_33)))) != var_1_1) {
 ...
 if (var_1_27) {
  var_1_42 = (var_1_34 && (var_1_30 || var_1_43));
 }
 ...
 if (var_1_37 < ((((var_1_33) < (var_1_22)) ? (var_1_33) : (var_1_22)))) {
