...
void step(void) {
 ...
 if (! var_1_38) {
  if ((var_1_41 + var_1_42) >= var_1_43) {
   if (var_1_28 <= ((((-100) < ((var_1_29 & 16))) ? (-100) : ((var_1_29 & 16))))) {
    if (var_1_43 < (var_1_44 - var_1_45)) {
     var_1_40 = (var_1_46 + (((((((var_1_47) < (var_1_48)) ? (var_1_47) : (var_1_48))) < 0 ) ? -((((var_1_47) < (var_1_48)) ? (var_1_47) : (var_1_48))) : ((((var_1_47) < (var_1_48)) ? (var_1_47) : (var_1_48))))));
    }
   }
  }
 } else {
  var_1_40 = (((((var_1_49) < ((var_1_50 + var_1_51))) ? (var_1_49) : ((var_1_50 + var_1_51)))) - var_1_52);
 }
 if ((var_1_26 % var_1_31) == var_1_30) {
  var_1_53 = ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34)));
 } else {
  if (var_1_29 < var_1_34) {
   var_1_53 = ((((var_1_34) > (var_1_54)) ? (var_1_34) : (var_1_54)));
  } else {
   if (var_1_43 < var_1_46) {
    var_1_53 = (var_1_34 + ((((var_1_55) < 0 ) ? -(var_1_55) : (var_1_55))));
   } else {
    var_1_53 = ((((var_1_34) > (var_1_55)) ? (var_1_34) : (var_1_55)));
   }
  }
 }
 if ((- (- var_1_26)) >= (var_1_34 * var_1_55)) {
  var_1_56 = ((((var_1_34) < (var_1_55)) ? (var_1_34) : (var_1_55)));
 } else {
  var_1_56 = var_1_55;
 }
 if (var_1_47 >= var_1_42) {
  var_1_57 = ((((var_1_33) < 0 ) ? -(var_1_33) : (var_1_33)));
 }
 if (((var_1_30 % var_1_59) + var_1_32) < ((((var_1_31) > (var_1_54)) ? (var_1_31) : (var_1_54)))) {
  var_1_58 = (! (! var_1_37));
 } else {
  if (((((var_1_29) > (var_1_55)) ? (var_1_29) : (var_1_55))) >= (var_1_32 ^ 5)) {
