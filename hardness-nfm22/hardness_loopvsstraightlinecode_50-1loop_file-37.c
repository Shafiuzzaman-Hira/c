...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch3750_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch3750_1loop
	var_1_17 = (var_1_18 - var_1_3);


	// From: Req3Batch3750_1loop
	if ((var_1_17 >= var_1_17) || (var_1_9 > last_1_var_1_10)) {
		var_1_10 = var_1_9;
	}


	// From: Req4Batch3750_1loop
