...
void step(void) {
	...
	// From: Req3Batch11Amount100
	if (! ((var_1_12 - var_1_13) <= (last_1_var_1_11 >> var_1_14))) {
		var_1_11 = var_1_13;
	}


	// From: Req7Batch11Amount100
	...
	// From: Req6Batch11Amount100
	var_1_17 = var_1_13;


	// From: Req9Batch11Amount100
	if (! var_1_2) {
