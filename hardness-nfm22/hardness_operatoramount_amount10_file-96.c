...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch96Amount10.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((-1000000000 < var_1_9) || stepLocal_0) {
...
int property() {
	return ((((-1000000000 < var_1_9) || var_1_3) ? (var_1_1 == ((unsigned char) (var_1_4 - var_1_5))) : 1) && (var_1_6 == ((float) ((abs (var_1_7)) + (min (127.5f , var_1_8)))))) && (var_1_9 == ((signed short int) var_1_4))
;
}
int main(void) {
	isInitial = 1;
