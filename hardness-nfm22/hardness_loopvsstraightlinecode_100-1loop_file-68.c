...
void step(void) {
	...
	// From: Req3Batch68100_1loop
	if (((var_1_7 | var_1_8) > var_1_17) && var_1_13) {
		var_1_11 = var_1_5;
	}


	// From: Req1Batch68100_1loop
