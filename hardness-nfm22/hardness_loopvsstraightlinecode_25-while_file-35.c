...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch3525_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch3525_while
	var_1_11 = (-32 + (var_1_12 + (min (10 , var_1_13))));


	// From: Req4Batch3525_while
	...
	// From: Req5Batch3525_while
	var_1_19 = var_1_5;


	// From: Req2Batch3525_while
	if (var_1_7) {
		if (var_1_8) {
