...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch7825_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch7825_1loop
	if (var_1_3) {
		var_1_14 = (2931747731u - var_1_10);
	}


	// From: Req1Batch7825_1loop
	...
	// From: Req2Batch7825_1loop
	if (var_1_14 > var_1_14) {
		var_1_8 = ((var_1_9 - var_1_10) + (min (-4 , (var_1_11 + var_1_12))));
	} else {
		var_1_8 = ((min (var_1_9 , var_1_10)) - var_1_13);
	}


	// From: Req4Batch7825_1loop
	if (var_1_11 >= var_1_1) {
...
int property() {
	return ((((var_1_2 && var_1_3) ? ((var_1_2 && (var_1_14 > last_1_var_1_1)) ? (var_1_1 == ((signed long int) (var_1_6 - var_1_7))) : (var_1_1 == ((signed long int) var_1_6))) : 1) && ((var_1_14 > var_1_14) ? (var_1_8 == ((signed short int) ((var_1_9 - var_1_10) + (min (-4 , (var_1_11 + var_1_12)))))) : (var_1_8 == ((signed short int) ((min (var_1_9 , var_1_10)) - var_1_13))))) && (var_1_3 ? (var_1_14 == ((unsigned long int) (2931747731u - var_1_10))) : 1)) && ((var_1_11 >= var_1_1) ? (var_1_15 == ((float) (max (var_1_16 , var_1_17)))) : 1)
;
}
int main(void) {
	isInitial = 1;
