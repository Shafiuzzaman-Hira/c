...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch98Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_27 < var_1_34) {
		if ((abs (max (var_1_34 , var_1_9))) <= var_1_1) {
	...
	// From: CodeObject4
	if (var_1_12 <= ((var_1_34 - var_1_31) - (min (var_1_9 , var_1_11)))) {
		var_1_33 = 128;
	}


	// From: CodeObject5
	if ((var_1_19 | var_1_12) > var_1_19) {
		if (-16 <= (max ((var_1_12 - var_1_31) , (abs (var_1_19))))) {
			var_1_35 = (63.2 - 7.4);
		} else {
	...
	// From: Req6Batch98Filler_PR_CO
	var_1_17 = var_1_18;


	// From: Req7Batch98Filler_PR_CO
	...
	// From: Req8Batch98Filler_PR_CO
	var_1_22 = var_1_18;


	// From: Req2Batch98Filler_PR_CO
	if (var_1_19 <= var_1_1) {
	...
	// From: CodeObject1
	if ((max ((abs (var_1_9)) , 2u)) > (var_1_1 & var_1_11)) {
		if (var_1_1 >= (var_1_27 - var_1_12)) {
			if (var_1_1 >= var_1_12) {
				var_1_23 = var_1_29;
			} else {
				var_1_23 = var_1_29;
