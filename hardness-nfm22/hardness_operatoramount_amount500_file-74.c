...
void step(void) {
	...
	if (last_1_var_1_69 == ((last_1_var_1_18 * var_1_12) / var_1_16)) {
		if ((min (last_1_var_1_58 , (var_1_8 * last_1_var_1_90))) >= last_1_var_1_30) {
	...
	if ((var_1_76 + 64) < stepLocal_28) {
		var_1_109 = (max (var_1_16 , var_1_34));
	} else {
		if (var_1_41) {
			var_1_109 = var_1_76;
		}
	...
	if ((var_1_10 - (abs (last_1_var_1_75))) <= last_1_var_1_30) {
		if (! last_1_var_1_23) {
			var_1_32 = ((var_1_16 - (max (var_1_15 , var_1_14))) + var_1_3);
		}
	} else {
	...
	if ((abs (var_1_109)) <= var_1_68) {
		if ((max (var_1_34 , var_1_32)) != last_1_var_1_85) {
			var_1_85 = (var_1_13 - var_1_12);
		} else {
			var_1_85 = ((max (var_1_12 , var_1_14)) - var_1_35);
		}
	} else {
	...
	if (var_1_104 > (var_1_15 ^ 25)) {
		var_1_88 = (((abs (var_1_8)) + var_1_63) - (abs (min (var_1_48 , var_1_62))));
	} else {
	...
	signed long int stepLocal_23 = max ((var_1_12 - var_1_3) , var_1_19);
	...
	if (var_1_44) {
		...
		var_1_82 = (min ((var_1_83 - var_1_81) , var_1_67));
	}
	...
	if (var_1_26 || stepLocal_11) {
		if (var_1_32 >= stepLocal_13) {
			if (((var_1_37 - var_1_59) - (6.8830512156473876E18 - var_1_60)) <= var_1_93) {
				if (var_1_44 || stepLocal_14) {
					if (! (var_1_44 && (var_1_19 < var_1_94))) {
						if (5 <= stepLocal_12) {
							var_1_58 = ((abs (var_1_39)) + var_1_7);
						} else {
							var_1_58 = (var_1_47 - (var_1_61 - (var_1_62 + var_1_63)));
						}
					} else {
						var_1_58 = ((min (63.4 , (var_1_63 + var_1_62))) - var_1_59);
					}
				} else {
					if (stepLocal_15 >= (var_1_16 / var_1_34)) {
						var_1_58 = (var_1_40 + 16.36);
					} else {
						var_1_58 = ((min (var_1_40 , var_1_63)) + var_1_8);
					}
				}
			} else {
			...
			var_1_58 = ((min (var_1_63 , (var_1_62 - var_1_64))) + (var_1_40 + var_1_39));
		}
	}
	...
	if (var_1_14 < stepLocal_0) {
		var_1_18 = ((max (var_1_19 , var_1_20)) - var_1_94);
	}
	...
	signed long int stepLocal_19 = min ((var_1_3 / var_1_55) , var_1_32);
	unsigned char stepLocal_18 = var_1_32;
	unsigned char stepLocal_17 = var_1_14;
	signed long int stepLocal_16 = min (var_1_15 , var_1_80);
	if (stepLocal_18 < var_1_82) {
		var_1_66 = var_1_39;
	} else {
		if (((var_1_84 % var_1_34) / (max (5 , var_1_16))) <= stepLocal_16) {
			if (stepLocal_19 <= var_1_16) {
				if (stepLocal_17 >= (var_1_104 * var_1_82)) {
					var_1_66 = (abs (max (var_1_39 , var_1_63)));
				} else {
					var_1_66 = (max ((var_1_48 - var_1_61) , var_1_8));
				}
			} else {
				var_1_66 = (min (var_1_60 , (min (var_1_47 , (var_1_8 + var_1_7)))));
			}
		} else {
	...
	if (((max (var_1_37 , var_1_10)) - var_1_11) >= ((var_1_4 + var_1_46) + var_1_8)) {
		var_1_38 = (var_1_7 + (min ((var_1_39 + var_1_40) , var_1_8)));
	} else {
		var_1_38 = var_1_40;
	}
	...
	unsigned long int stepLocal_8 = max (var_1_19 , var_1_67);
	unsigned char stepLocal_7 = (- var_1_84) != var_1_13;
	if ((var_1_8 == (var_1_47 - var_1_52)) || stepLocal_7) {
		if (var_1_47 > var_1_66) {
			var_1_51 = (((var_1_67 + var_1_13) + var_1_15) + (abs (var_1_34)));
		} else {
			if (((max (-32 , var_1_18)) + -16) > stepLocal_8) {
				var_1_51 = ((var_1_54 - (min (var_1_18 , var_1_17))) + var_1_35);
			} else {
				var_1_51 = (64 + (min ((var_1_54 - var_1_17) , var_1_3)));
			}
		}
	} else {
		var_1_51 = (min ((max (var_1_20 , var_1_3)) , ((var_1_54 + var_1_55) - last_1_var_1_51)));
	}


	// From: Req11Batch74Amount500
	if ((- var_1_46) <= ((var_1_37 - 100.869) - var_1_11)) {
		var_1_36 = (abs (var_1_15 + var_1_35));
	}
	...
	if (var_1_71 > stepLocal_20) {
		var_1_72 = (var_1_21 + (max (var_1_13 , var_1_12)));
	}
	...
	if (var_1_35 <= var_1_72) {
		if (var_1_93 < var_1_48) {
			var_1_69 = (min ((var_1_14 + var_1_16) , var_1_13));
		} else {
			var_1_69 = (abs (max ((200 - var_1_15) , (var_1_71 - var_1_13))));
		}
	}
	...
	if (1000.125 <= var_1_1) {
		if (255.5f >= var_1_40) {
			var_1_50 = (max ((max ((var_1_14 - var_1_35) , (min (var_1_34 , var_1_15)))) , var_1_12));
		}
	} else {
	...
	if ((100 / (min (var_1_16 , var_1_34))) != ((min (var_1_20 , var_1_50)) * var_1_109)) {
	...
	if (var_1_97 <= (var_1_37 * (var_1_88 * var_1_39))) {
		...
		if (var_1_49 <= (min ((var_1_7 + var_1_47) , var_1_93))) {
	...
	if (var_1_41) {
		var_1_27 = (max (var_1_50 , (last_1_var_1_27 - (max (var_1_16 , var_1_14)))));
	} else {
		if (var_1_41) {
			var_1_27 = (var_1_15 + (var_1_50 - var_1_14));
		} else {
			var_1_27 = (max (last_1_var_1_27 , var_1_50));
		}
	}
	...
	if (var_1_39 == var_1_97) {
		if ((var_1_27 & var_1_94) <= (max (var_1_12 , (4 / var_1_19)))) {
			var_1_65 = ((min (var_1_19 , var_1_20)) - (min (var_1_16 , var_1_14)));
		} else {
			var_1_65 = (34483 - (min ((var_1_54 - var_1_35) , var_1_15)));
		}
	}
	...
	if (var_1_44 || var_1_41) {
		...
		if ((var_1_61 + var_1_4) > (abs (var_1_103 * var_1_49))) {
			if ((max (var_1_35 , var_1_13)) <= var_1_27) {
				var_1_75 = (var_1_39 + var_1_63);
			} else {
				var_1_75 = var_1_63;
			}
		} else {
			var_1_75 = (abs (var_1_62));
		}
	}
	...
	if (var_1_13 > stepLocal_10) {
		var_1_56 = (min (var_1_65 , var_1_35));
	} else {
		if (stepLocal_9 && var_1_24) {
			var_1_56 = ((abs (var_1_50)) - var_1_21);
		} else {
			var_1_56 = (max (var_1_50 , var_1_99));
		}
	}


	// From: Req36Batch74Amount500
	if ((var_1_94 & var_1_15) == (var_1_82 - (min (var_1_71 , var_1_80)))) {
...
int property() {
	return (((((((((((((((((((((((((((((((((((((((((((((((((((var_1_72 <= (128 - var_1_3)) ? (var_1_1 == ((double) var_1_4)) : ((var_1_41 || var_1_96) ? (var_1_1 == ((double) (var_1_7 + var_1_8))) : 1)) && (var_1_28 ? ((255.5f != (var_1_10 - var_1_11)) ? (var_1_9 == ((unsigned char) ((abs (var_1_3)) + ((max (var_1_12 , var_1_13)) + (max (var_1_14 , var_1_15)))))) : 1) : ((! var_1_96) ? (var_1_9 == ((unsigned char) (var_1_3 + var_1_15))) : ((var_1_15 != var_1_12) ? (var_1_9 == ((unsigned char) ((var_1_16 - var_1_15) + var_1_3))) : 1)))) && (var_1_17 == ((unsigned long int) var_1_3))) && ((var_1_14 < var_1_12) ? (var_1_18 == ((unsigned short int) ((max (var_1_19 , var_1_20)) - var_1_94))) : 1)) && ((var_1_51 == var_1_13) ? (var_1_21 == ((unsigned char) var_1_13)) : 1)) && ((var_1_14 < var_1_3) ? (var_1_23 == ((unsigned char) ((! var_1_24) || (! (var_1_92 || var_1_25))))) : (var_1_23 == ((unsigned char) var_1_26)))) && (var_1_41 ? (var_1_27 == ((signed short int) (max (var_1_50 , (last_1_var_1_27 - (max (var_1_16 , var_1_14))))))) : (var_1_41 ? (var_1_27 == ((signed short int) (var_1_15 + (var_1_50 - var_1_14)))) : (var_1_27 == ((signed short int) (max (last_1_var_1_27 , var_1_50))))))) && (var_1_28 == ((unsigned char) (var_1_26 || var_1_29)))) && ((var_1_3 >= 10) ? ((var_1_32 >= (var_1_19 * var_1_82)) ? (var_1_96 ? (var_1_30 == ((float) var_1_4)) : (var_1_30 == ((float) var_1_4))) : (var_1_30 == ((float) var_1_8))) : 1)) && (((var_1_10 - (abs (last_1_var_1_75))) <= last_1_var_1_30) ? ((! last_1_var_1_23) ? (var_1_32 == ((unsigned char) ((var_1_16 - (max (var_1_15 , var_1_14))) + var_1_3))) : 1) : ((var_1_25 && var_1_26) ? (((var_1_13 << last_1_var_1_67) > last_1_var_1_73) ? (var_1_32 == ((unsigned char) ((var_1_15 + var_1_14) + (var_1_16 - (var_1_34 - var_1_35))))) : 1) : 1))) && (((- var_1_46) <= ((var_1_37 - 100.869) - var_1_11)) ? (var_1_36 == ((unsigned char) (abs (var_1_15 + var_1_35)))) : 1)) && ((((max (var_1_37 , var_1_10)) - var_1_11) >= ((var_1_4 + var_1_46) + var_1_8)) ? (var_1_38 == ((float) (var_1_7 + (min ((var_1_39 + var_1_40) , var_1_8))))) : (var_1_38 == ((float) var_1_40)))) && ((last_1_var_1_69 == ((last_1_var_1_18 * var_1_12) / var_1_16)) ? (((min (last_1_var_1_58 , (var_1_8 * last_1_var_1_90))) >= last_1_var_1_30) ? (var_1_41 == ((unsigned char) (var_1_24 && (last_1_var_1_41 || var_1_25)))) : (var_1_25 ? (var_1_41 == ((unsigned char) ((var_1_26 && var_1_29) || ((var_1_24 && var_1_44) || var_1_45)))) : 1)) : 1)) && (((24.8 * var_1_30) > 10.08) ? (var_1_46 == ((double) (var_1_47 - var_1_48))) : (var_1_46 == ((double) 31.9)))) && (((100 / (min (var_1_16 , var_1_34))) != ((min (var_1_20 , var_1_50)) * var_1_109)) ? (var_1_49 == ((float) (var_1_47 - var_1_48))) : (var_1_49 == ((float) var_1_7)))) && ((1000.125 <= var_1_1) ? ((255.5f >= var_1_40) ? (var_1_50 == ((signed char) (max ((max ((var_1_14 - var_1_35) , (min (var_1_34 , var_1_15)))) , var_1_12)))) : 1) : (var_1_50 == ((signed char) (var_1_12 - var_1_34))))) && (((var_1_8 == (var_1_47 - var_1_52)) || ((- var_1_84) != var_1_13)) ? ((var_1_47 > var_1_66) ? (var_1_51 == ((unsigned short int) (((var_1_67 + var_1_13) + var_1_15) + (abs (var_1_34))))) : ((((max (-32 , var_1_18)) + -16) > (max (var_1_19 , var_1_67))) ? (var_1_51 == ((unsigned short int) ((var_1_54 - (min (var_1_18 , var_1_17))) + var_1_35))) : (var_1_51 == ((unsigned short int) (64 + (min ((var_1_54 - var_1_17) , var_1_3))))))) : (var_1_51 == ((unsigned short int) (min ((max (var_1_20 , var_1_3)) , ((var_1_54 + var_1_55) - last_1_var_1_51))))))) && ((var_1_13 > (var_1_69 * var_1_55)) ? (var_1_56 == ((signed short int) (min (var_1_65 , var_1_35)))) : (((var_1_44 || var_1_26) && var_1_24) ? (var_1_56 == ((signed short int) ((abs (var_1_50)) - var_1_21))) : (var_1_56 == ((signed short int) (max (var_1_50 , var_1_99))))))) && ((var_1_26 || (var_1_15 >= (var_1_12 + var_1_20))) ? ((var_1_32 >= var_1_104) ? ((((var_1_37 - var_1_59) - (6.8830512156473876E18 - var_1_60)) <= var_1_93) ? ((var_1_44 || (32.125 <= var_1_48)) ? ((! (var_1_44 && (var_1_19 < var_1_94))) ? ((5 <= (var_1_20 / var_1_54)) ? (var_1_58 == ((double) ((abs (var_1_39)) + var_1_7))) : (var_1_58 == ((double) (var_1_47 - (var_1_61 - (var_1_62 + var_1_63)))))) : (var_1_58 == ((double) ((min (63.4 , (var_1_63 + var_1_62))) - var_1_59)))) : ((var_1_3 >= (var_1_16 / var_1_34)) ? (var_1_58 == ((double) (var_1_40 + 16.36))) : (var_1_58 == ((double) ((min (var_1_40 , var_1_63)) + var_1_8))))) : (var_1_58 == ((double) (var_1_62 - var_1_47)))) : (var_1_58 == ((double) ((min (var_1_63 , (var_1_62 - var_1_64))) + (var_1_40 + var_1_39))))) : 1)) && ((var_1_39 == var_1_97) ? (((var_1_27 & var_1_94) <= (max (var_1_12 , (4 / var_1_19)))) ? (var_1_65 == ((unsigned short int) ((min (var_1_19 , var_1_20)) - (min (var_1_16 , var_1_14))))) : (var_1_65 == ((unsigned short int) (34483 - (min ((var_1_54 - var_1_35) , var_1_15)))))) : 1)) && ((var_1_32 < var_1_82) ? (var_1_66 == ((double) var_1_39)) : ((((var_1_84 % var_1_34) / (max (5 , var_1_16))) <= (min (var_1_15 , var_1_80))) ? (((min ((var_1_3 / var_1_55) , var_1_32)) <= var_1_16) ? ((var_1_14 >= (var_1_104 * var_1_82)) ? (var_1_66 == ((double) (abs (max (var_1_39 , var_1_63))))) : (var_1_66 == ((double) (max ((var_1_48 - var_1_61) , var_1_8))))) : (var_1_66 == ((double) (min (var_1_60 , (min (var_1_47 , (var_1_8 + var_1_7)))))))) : (var_1_66 == ((double) (var_1_60 - var_1_48)))))) && ((var_1_59 <= ((7.2186781640908104E18 - var_1_60) - (var_1_64 + var_1_62))) ? (var_1_67 == ((unsigned long int) ((var_1_68 - var_1_3) + var_1_15))) : 1)) && ((var_1_35 <= var_1_72) ? ((var_1_93 < var_1_48) ? (var_1_69 == ((unsigned char) (min ((var_1_14 + var_1_16) , var_1_13)))) : (var_1_69 == ((unsigned char) (abs (max ((200 - var_1_15) , (var_1_71 - var_1_13))))))) : 1)) && ((var_1_71 > var_1_9) ? (var_1_72 == ((signed short int) (var_1_21 + (max (var_1_13 , var_1_12))))) : 1)) && (var_1_25 ? (var_1_73 == ((signed short int) (var_1_9 - ((2 + var_1_67) + (var_1_74 - var_1_14))))) : 1)) && ((var_1_44 || var_1_41) ? (((- var_1_36) < var_1_27) ? (var_1_75 == ((float) var_1_7)) : 1) : (((var_1_61 + var_1_4) > (abs (var_1_103 * var_1_49))) ? (((max (var_1_35 , var_1_13)) <= var_1_27) ? (var_1_75 == ((float) (var_1_39 + var_1_63))) : (var_1_75 == ((float) var_1_63))) : (var_1_75 == ((float) (abs (var_1_62))))))) && ((var_1_97 <= (var_1_37 * (var_1_88 * var_1_39))) ? (var_1_78 == ((signed char) var_1_77)) : ((var_1_49 <= (min ((var_1_7 + var_1_47) , var_1_93))) ? (var_1_78 == ((signed char) (var_1_77 - var_1_14))) : (var_1_78 == ((signed char) var_1_79))))) && ((var_1_109 <= var_1_106) ? (var_1_80 == ((signed char) ((var_1_81 - var_1_77) - var_1_34))) : 1)) && (var_1_44 ? ((var_1_29 || (var_1_4 <= var_1_7)) ? (((max ((var_1_12 - var_1_3) , var_1_19)) >= (200 / var_1_16)) ? (var_1_82 == ((unsigned long int) var_1_68)) : ((var_1_104 >= -8) ? (var_1_82 == ((unsigned long int) (3656069562u - var_1_76))) : (var_1_82 == ((unsigned long int) (var_1_14 + (1487268314u - var_1_32)))))) : (var_1_29 ? ((var_1_59 != var_1_52) ? (var_1_82 == ((unsigned long int) var_1_73)) : (var_1_82 == ((unsigned long int) (var_1_83 - last_1_var_1_82)))) : 1)) : (var_1_82 == ((unsigned long int) (min ((var_1_83 - var_1_81) , var_1_67)))))) && ((! ((var_1_98 + var_1_52) > var_1_88)) ? (var_1_84 == ((unsigned short int) var_1_12)) : 1)) && (((abs (var_1_109)) <= var_1_68) ? (((max (var_1_34 , var_1_32)) != last_1_var_1_85) ? (var_1_85 == ((signed char) (var_1_13 - var_1_12))) : (var_1_85 == ((signed char) ((max (var_1_12 , var_1_14)) - var_1_35)))) : (var_1_85 == ((signed char) ((var_1_14 + (var_1_76 + var_1_35)) - var_1_34))))) && ((var_1_13 >= ((~ 16) + var_1_102)) ? (var_1_86 == ((unsigned char) (var_1_34 + var_1_87))) : (var_1_86 == ((unsigned char) 5)))) && ((var_1_104 > (var_1_15 ^ 25)) ? (var_1_88 == ((float) (((abs (var_1_8)) + var_1_63) - (abs (min (var_1_48 , var_1_62)))))) : (var_1_88 == ((float) ((var_1_62 + var_1_63) - var_1_47))))) && (((! var_1_26) && (var_1_24 || var_1_23)) ? ((var_1_23 || var_1_29) ? (var_1_89 == ((signed short int) (var_1_77 - (var_1_15 + (var_1_74 - var_1_81))))) : 1) : (var_1_89 == ((signed short int) (var_1_67 + (var_1_35 - (var_1_74 - var_1_76))))))) && ((var_1_81 >= (var_1_3 + (var_1_17 * var_1_101))) ? (((var_1_60 + (- var_1_88)) <= (- var_1_47)) ? (var_1_90 == ((float) (var_1_59 - var_1_62))) : 1) : ((! var_1_23) ? (var_1_90 == ((float) (var_1_62 - var_1_60))) : (var_1_90 == ((float) 1000000.2f))))) && (((var_1_94 & var_1_15) == (var_1_82 - (min (var_1_71 , var_1_80)))) ? (var_1_92 == ((unsigned char) (var_1_26 && (var_1_45 && var_1_44)))) : ((! ((var_1_65 + var_1_16) == var_1_79)) ? (var_1_92 == ((unsigned char) (((var_1_55 << var_1_19) >= var_1_104) && var_1_29))) : (var_1_92 == ((unsigned char) (! (var_1_24 && var_1_25))))))) && (var_1_93 == ((double) var_1_59))) && (var_1_96 ? (var_1_94 == ((unsigned short int) var_1_16)) : (var_1_94 == ((unsigned short int) var_1_71)))) && (var_1_95 == ((float) 3.875f))) && (var_1_44 ? (var_1_96 == ((unsigned char) var_1_24)) : (var_1_96 == ((unsigned char) var_1_29)))) && (var_1_29 ? (var_1_97 == ((double) var_1_63)) : (var_1_97 == ((double) var_1_63)))) && (var_1_96 ? (var_1_98 == ((float) var_1_39)) : (var_1_98 == ((float) var_1_63)))) && (var_1_99 == ((signed short int) var_1_79))) && (var_1_26 ? (var_1_100 == ((unsigned long int) var_1_76)) : (var_1_100 == ((unsigned long int) var_1_20)))) && (var_1_26 ? (var_1_101 == ((signed short int) var_1_102)) : (var_1_101 == ((signed short int) var_1_35)))) && (var_1_92 ? (var_1_102 == ((signed short int) var_1_76)) : 1)) && (var_1_96 ? (var_1_103 == ((double) var_1_59)) : 1)) && (var_1_104 == ((unsigned char) var_1_34))) && (var_1_105 == ((signed short int) var_1_14))) && (var_1_106 == ((unsigned long int) ((var_1_107 - (var_1_20 + var_1_3)) - var_1_18)))) && (((var_1_76 + 64) < var_1_81) ? (var_1_109 == ((unsigned char) (max (var_1_16 , var_1_34)))) : (var_1_41 ? (var_1_109 == ((unsigned char) var_1_76)) : 1))
;
}
int main(void) {
	isInitial = 1;
