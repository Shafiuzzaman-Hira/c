...
void step(void) {
	...
	// From: Req4Batch58Wrapper_S
	WrapperStruct00.var_1_12 = WrapperStruct00.var_1_6;


	// From: Req1Batch58Wrapper_S
	...
	if (WrapperStruct00.var_1_10 <= stepLocal_0) {
		WrapperStruct00.var_1_1 = (min (WrapperStruct00.var_1_3 , ((WrapperStruct00.var_1_4 - 8) + 5)));
	} else {
	...
	if (WrapperStruct00.var_1_10 < stepLocal_3) {
		if (WrapperStruct00.var_1_9 && stepLocal_2) {
			WrapperStruct00.var_1_7 = (WrapperStruct00.var_1_4 + (abs (max (WrapperStruct00.var_1_10 , WrapperStruct00.var_1_3))));
		} else {
