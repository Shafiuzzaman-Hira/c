...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch87Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_30 > var_1_18) {
		...
		if (var_1_30 >= var_1_6) {
			if ((var_1_7 % var_1_17) > (var_1_41 + var_1_6)) {
				var_1_42 = (abs (abs (2)));
			} else {
				if ((var_1_18 & var_1_7) <= (min (var_1_41 , var_1_17))) {
					var_1_42 = var_1_17;
				} else {
					var_1_42 = var_1_17;
				}
	...
	// From: CodeObject5
	if (((max (var_1_41 , var_1_5)) & var_1_20) > (var_1_6 & var_1_7)) {
		var_1_44 = (abs (var_1_20));
	}


	// From: CodeObject6
	if (((var_1_32 % var_1_32) >> var_1_2) >= ((var_1_32 + var_1_20) + (var_1_41 / var_1_32))) {
		if (var_1_17 < var_1_6) {
