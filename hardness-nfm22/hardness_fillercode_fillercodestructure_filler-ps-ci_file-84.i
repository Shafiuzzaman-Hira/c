...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch84Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_19) {
  if (var_1_19) {
   var_1_27 = ((var_1_19 && var_1_29) || (var_1_30 || var_1_31));
  } else {
   if (var_1_19) {
 ...
 if (var_1_10 != ((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9)))) {
  var_1_33 = (5 + var_1_11);
 }
 if ((~ var_1_4) > (var_1_4 / var_1_11)) {
  var_1_35 = (((((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))) < 0 ) ? -((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))) : ((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11)))));
 }
 var_1_37 = ((((((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11)))) < (var_1_4)) ? (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11)))) : (var_1_4)));
 if (var_1_7 == var_1_11) {
  if ((var_1_39 - var_1_40) < var_1_21) {
   var_1_38 = ((((((((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21))) < 0 ) ? -((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21))) : ((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21))))) < 0 ) ? -(((((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21))) < 0 ) ? -((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21))) : ((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21))))) : (((((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21))) < 0 ) ? -((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21))) : ((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21)))))));
  }
 } else {
  if (var_1_40 >= var_1_39) {
   var_1_38 = ((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21)));
  }
 }
 if (! var_1_19) {
  if (((var_1_11 + -128) % var_1_10) >= var_1_15) {
   var_1_43 = var_1_3;
  }
 } else {
  var_1_43 = var_1_3;
