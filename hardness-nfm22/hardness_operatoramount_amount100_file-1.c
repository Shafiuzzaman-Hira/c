...
void step(void) {
	...
	// From: Req3Batch1Amount100
	var_1_14 = (var_1_15 + var_1_16);


	// From: Req2Batch1Amount100
	if (((- 16.1) + var_1_14) >= (var_1_11 - var_1_12)) {
		var_1_9 = var_1_13;
	}


	// From: Req6Batch1Amount100
