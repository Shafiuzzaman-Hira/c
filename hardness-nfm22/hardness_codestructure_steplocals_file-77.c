...
void step(void) {
	...
	// From: Req2Batch77stepLocals
	if ((- var_1_7) < (var_1_5 * var_1_4)) {
		var_1_8 = var_1_9;
	}


	// From: Req3Batch77stepLocals
	var_1_10 = (50 + ((var_1_11 + 10000) - var_1_12));


	// From: Req4Batch77stepLocals
	...
	// From: Req6Batch77stepLocals
	signed long int stepLocal_4 = - var_1_5;
	signed long int stepLocal_3 = var_1_7 + (128 + var_1_10);
	signed long int stepLocal_2 = (min (var_1_5 , var_1_17)) / var_1_11;
