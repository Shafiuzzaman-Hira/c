...
void step(void) {
 ...
 if (last_1_var_1_14 > stepLocal_0) {
  (*(var_1_8_Pointer)) = (((((-4 + (*(var_1_9_Pointer)))) < ((*(var_1_10_Pointer)))) ? ((-4 + (*(var_1_9_Pointer)))) : ((*(var_1_10_Pointer)))));
 }
