...
void step(void) {
	...
	// From: Req2Batch92stepLocals
	if (((min (var_1_11 , 16)) >> var_1_10) >= var_1_3) {
		if (var_1_7) {
			var_1_12 = var_1_10;
		}
	}
	...
	// From: Req3Batch92stepLocals
	unsigned long int stepLocal_1 = min (var_1_12 , var_1_8);
	if (((min (var_1_10 , var_1_3)) + (var_1_9 % var_1_14)) >= stepLocal_1) {
		var_1_13 = var_1_15;
	} else {
		var_1_13 = var_1_15;
	}
	...
	// From: Req5Batch92stepLocals
	var_1_17 = (4 - (min (var_1_18 , (var_1_19 - 1))));


	// From: Req6Batch92stepLocals
...
int property() {
	return (((((((var_1_2 == var_1_3) && (var_1_4 >= var_1_5)) ? (var_1_6 ? (var_1_7 ? (var_1_1 == ((unsigned short int) (min (var_1_8 , var_1_9)))) : (var_1_1 == ((unsigned short int) (max (var_1_9 , var_1_8))))) : (var_1_1 == ((unsigned short int) ((max (46167 , var_1_10)) - var_1_11)))) : (var_1_1 == ((unsigned short int) var_1_10))) && ((((min (var_1_11 , 16)) >> var_1_10) >= var_1_3) ? (var_1_7 ? (var_1_12 == ((unsigned long int) var_1_10)) : 1) : 1)) && ((((min (var_1_10 , var_1_3)) + (var_1_9 % var_1_14)) >= (min (var_1_12 , var_1_8))) ? (var_1_13 == ((double) var_1_15)) : (var_1_13 == ((double) var_1_15)))) && ((var_1_6 && (var_1_9 < (var_1_10 + var_1_12))) ? ((var_1_7 && var_1_6) ? (var_1_16 == ((signed long int) var_1_10)) : 1) : (var_1_16 == ((signed long int) var_1_8)))) && (var_1_17 == ((signed char) (4 - (min (var_1_18 , (var_1_19 - 1))))))) && (var_1_6 ? (var_1_20 == ((signed long int) ((var_1_8 - (var_1_21 - var_1_11)) + var_1_10))) : (((~ var_1_19) == var_1_12) ? (var_1_20 == ((signed long int) var_1_22)) : (var_1_20 == ((signed long int) var_1_10))))
;
}
int main(void) {
	isInitial = 1;
