...
void step(void) {
	...
	// From: CodeObject1
	if (var_1_11 < (var_1_12 - (abs (var_1_11)))) {
		if (var_1_10) {
			var_1_27 = var_1_24;
		}
	}
	...
	// From: CodeObject3
	if (var_1_10) {
		var_1_35 = (max (var_1_22 , var_1_23));
	} else {
		if (var_1_10) {
			if (-8 < var_1_22) {
				var_1_35 = (abs (var_1_37 - var_1_23));
			}
		}
	}


	// From: Req1Batch26Filler_PR_CI
	...
	// From: CodeObject5
	if ((abs (var_1_22)) < (var_1_9 % var_1_4)) {
	...
	// From: CodeObject6
	if (var_1_10) {
		var_1_46 = (var_1_24 + (abs (var_1_22)));
	} else {
