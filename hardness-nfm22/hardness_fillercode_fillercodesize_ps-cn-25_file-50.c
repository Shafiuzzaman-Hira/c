...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch50PS_CN_25.c", 13, "reach_error"); }
...
double var_1_42 = 15.95;
float var_1_43 = 64.25;
double var_1_44 = 99999999.4;
...
void step(void) {
	...
	// From: CodeObject4
	if ((var_1_31 * (var_1_38 % 1)) > var_1_32) {
		var_1_39 = var_1_40;
	}


	// From: CodeObject5
	if ((abs (var_1_35)) <= var_1_33) {
		if (var_1_34) {
			var_1_41 = (max (var_1_32 , var_1_31));
		}
	}
	...
	// From: Req3Batch50PS_CN_25
	if (var_1_8) {
		var_1_13 = (min ((var_1_14 + var_1_15) , (min (-0.2f , var_1_16))));
	}


	// From: Req6Batch50PS_CN_25
	if (var_1_8) {
		var_1_25 = (var_1_26 + var_1_27);
	}


	// From: Req8Batch50PS_CN_25
	var_1_29 = var_1_27;


	// From: Req9Batch50PS_CN_25
	var_1_30 = var_1_8;


	// From: Req2Batch50PS_CN_25
	...
	// From: Req4Batch50PS_CN_25
	var_1_17 = ((var_1_18 - 25) - var_1_25);


	// From: Req5Batch50PS_CN_25
