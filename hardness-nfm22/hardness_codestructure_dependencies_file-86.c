...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch86dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req6Batch86dependencies
	if (((last_1_var_1_16 % var_1_15) + (last_1_var_1_22 / var_1_20)) != last_1_var_1_10) {
		var_1_19 = var_1_9;
	} else {
		if (! (! last_1_var_1_6)) {
	...
	// From: Req2Batch86dependencies
	if (var_1_19) {
		var_1_6 = (last_1_var_1_6 || var_1_9);
	}


	// From: Req1Batch86dependencies
	if (last_1_var_1_10 <= (last_1_var_1_16 / -2)) {
	...
	// From: Req4Batch86dependencies
	if (! var_1_19) {
		if (((var_1_15 - var_1_12) * (- last_1_var_1_14)) <= var_1_11) {
			var_1_14 = var_1_11;
		}
	}


	// From: Req7Batch86dependencies
	var_1_22 = var_1_15;


	// From: Req5Batch86dependencies
