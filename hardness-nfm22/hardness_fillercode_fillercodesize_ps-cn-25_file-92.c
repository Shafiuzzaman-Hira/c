...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch92PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch92PS_CN_25
	var_1_17 = (4 - (min (var_1_18 , (var_1_19 - 1))));


	// From: Req6Batch92PS_CN_25
