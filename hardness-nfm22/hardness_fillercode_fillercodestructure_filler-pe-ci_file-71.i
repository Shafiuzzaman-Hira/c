...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch71Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((((((var_1_25) < (var_1_26)) ? (var_1_25) : (var_1_26))) - var_1_27) <= (var_1_11 + var_1_13)) {
  if (((((var_1_1) > ((var_1_20 / var_1_9))) ? (var_1_1) : ((var_1_20 / var_1_9)))) < var_1_14) {
 ...
 if ((var_1_5 % ((((var_1_16) < (var_1_16)) ? (var_1_16) : (var_1_16)))) <= var_1_4) {
 ...
 if ((var_1_17 * ((((var_1_16) < (var_1_47)) ? (var_1_16) : (var_1_47)))) < var_1_9) {
  var_1_49 = ((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16)));
 }
 if (var_1_5 < ((((var_1_16) < (var_1_36)) ? (var_1_16) : (var_1_36)))) {
  if (var_1_45) {
   var_1_50 = var_1_23;
  }
 }
