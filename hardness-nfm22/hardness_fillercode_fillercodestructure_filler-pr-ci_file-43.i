...
void step(void) {
 ...
 if (var_1_13 && (var_1_15 >= var_1_24)) {
  var_1_37 = ((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24)));
 }
 if ((- var_1_6) < var_1_5) {
  if (var_1_5 > var_1_5) {
   if (((var_1_15 % var_1_14) % ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)))) == (var_1_14 / var_1_14)) {
    var_1_39 = (((((var_1_43) > (var_1_44)) ? (var_1_43) : (var_1_44))) - var_1_12);
   }
  }
 } else {
 ...
 if ((var_1_15 | ((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10)))) > var_1_12) {
  if (var_1_13) {
   var_1_32 = ((((var_1_6) < (((((256.5f) > (var_1_5)) ? (256.5f) : (var_1_5))))) ? (var_1_6) : (((((256.5f) > (var_1_5)) ? (256.5f) : (var_1_5))))));
  }
 }
 var_1_48 = var_1_14;
 if (! var_1_13) {
