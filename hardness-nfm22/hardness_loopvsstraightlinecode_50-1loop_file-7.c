...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch750_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch750_1loop
	var_1_9 = (max (var_1_5 , var_1_6));


	// From: Req4Batch750_1loop
	...
	// From: Req6Batch750_1loop
	var_1_15 = (var_1_14 - (max ((var_1_16 + var_1_17) , 4)));


	// From: Req7Batch750_1loop
	if (var_1_4 > var_1_2) {
	...
	// From: Req8Batch750_1loop
	var_1_24 = 16;


	// From: Req1Batch750_1loop
