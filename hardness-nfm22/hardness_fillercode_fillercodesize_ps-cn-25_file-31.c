...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch31PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject4
	if ((var_1_29 - (abs (var_1_30))) < var_1_32) {
		var_1_31 = var_1_25;
	} else {
		if (((abs (var_1_30)) * (var_1_32 & var_1_29)) > 64) {
			var_1_31 = var_1_25;
		}
	}
	...
	// From: CodeObject5
	if (var_1_31) {
		var_1_33 = (min (var_1_34 , (max (var_1_35 , var_1_36))));
	}
	...
	// From: Req2Batch31PS_CN_25
	var_1_8 = (min ((var_1_5 + (64 - 16)) , 64));


	// From: Req4Batch31PS_CN_25
	...
	// From: Req6Batch31PS_CN_25
	var_1_17 = var_1_13;


	// From: Req7Batch31PS_CN_25
