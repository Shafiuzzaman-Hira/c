...
void step(void) {
 ...
 if ((*(var_1_2_Pointer)) > last_1_var_1_16) {
  if ((*(var_1_9_Pointer))) {
   if ((*(var_1_3_Pointer)) <= ((((last_1_var_1_16) < ((*(var_1_11_Pointer)))) ? (last_1_var_1_16) : ((*(var_1_11_Pointer)))))) {
