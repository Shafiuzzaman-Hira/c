...
void step(void) {
	...
	// From: CodeObject4
	if (var_1_1 <= (var_1_1 / (abs (var_1_9)))) {
		if ((var_1_20 / var_1_9) <= var_1_12) {
			var_1_32 = (min (var_1_20 , ((abs (var_1_35)) - (abs (var_1_1)))));
		}
	}


	// From: CodeObject5
	if ((abs (~ var_1_20)) >= (min (var_1_17 , 8u))) {
		var_1_36 = (abs (var_1_1));
	} else {
		var_1_36 = (var_1_37 - 2);
	}
	...
	if (var_1_24 > var_1_22) {
		if ((min (2 , 64)) < (max (var_1_37 , (var_1_7 + var_1_9)))) {
