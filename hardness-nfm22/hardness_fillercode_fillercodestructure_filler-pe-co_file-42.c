...
void step(void) {
	...
	// From: Req7Batch42Filler_PE_CO
	if (var_1_14 <= var_1_15) {
		var_1_19 = (var_1_12 || var_1_20);
	}


	// From: Req2Batch42Filler_PE_CO
	if (var_1_5 >= -2) {
		var_1_6 = (var_1_7 - 100);
	}


	// From: Req4Batch42Filler_PE_CO
	...
	// From: CodeObject3
	if ((- var_1_28) < (max (var_1_14 , var_1_29))) {
		var_1_30 = var_1_29;
	}


	// From: CodeObject4
	if ((min ((abs (var_1_27)) , var_1_13)) <= var_1_13) {
		var_1_31 = var_1_33;
	}
	...
	if (var_1_6 < (abs (var_1_6))) {
		var_1_34 = (max ((abs (var_1_6)) , var_1_33));
	}
