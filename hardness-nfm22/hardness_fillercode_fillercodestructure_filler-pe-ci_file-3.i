...
void step(void) {
 ...
 if (var_1_20 >= ((((var_1_14) > (var_1_23)) ? (var_1_14) : (var_1_23)))) {
  var_1_24 = ((((((((var_1_23) > (var_1_20)) ? (var_1_23) : (var_1_20)))) < (var_1_14)) ? (((((var_1_23) > (var_1_20)) ? (var_1_23) : (var_1_20)))) : (var_1_14)));
 } else {
  var_1_24 = (((((var_1_20) < 0 ) ? -(var_1_20) : (var_1_20))) + ((((var_1_23) < 0 ) ? -(var_1_23) : (var_1_23))));
 }
 var_1_28 = var_1_20;
 if (((var_1_6 ^ var_1_20) % var_1_21) > -10) {
  var_1_30 = ((((var_1_20) < 0 ) ? -(var_1_20) : (var_1_20)));
 }
 if ((~ var_1_5) <= (((((var_1_22) > (-16)) ? (var_1_22) : (-16))) & 16)) {
  var_1_32 = var_1_16;
 } else {
  if (var_1_14 <= (((((var_1_34) < (var_1_35)) ? (var_1_34) : (var_1_35))) - ((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22))))) {
   var_1_32 = var_1_16;
  } else {
   var_1_32 = var_1_16;
  }
