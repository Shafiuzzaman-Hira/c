...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch77dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch77dependencies
	if (var_1_3 != var_1_6) {
		if (var_1_13 >= (var_1_16 - (var_1_17 - 256))) {
			var_1_15 = var_1_18;
		} else {
			var_1_15 = var_1_18;
		}
	...
	// From: Req1Batch77dependencies
	if ((abs (var_1_4)) <= last_1_var_1_8) {
	...
	// From: Req2Batch77dependencies
	if ((- var_1_7) < (var_1_1 * var_1_4)) {
		var_1_8 = var_1_9;
	}


	// From: Req3Batch77dependencies
	var_1_10 = (50 + ((var_1_11 + 10000) - var_1_12));


	// From: Req6Batch77dependencies
	if (var_1_1 < (- var_1_10)) {
		if ((var_1_7 + (128 + var_1_1)) <= last_1_var_1_19) {
			var_1_19 = var_1_4;
		}
	} else {
		if (var_1_1 < ((min (var_1_10 , var_1_17)) / var_1_11)) {
