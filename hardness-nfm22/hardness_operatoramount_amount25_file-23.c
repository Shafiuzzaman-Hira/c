...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch23Amount25.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch23Amount25
	var_1_1 = (min (var_1_2 , var_1_3));


	// From: Req3Batch23Amount25
	var_1_10 = (max (var_1_2 , ((var_1_11 + var_1_12) - var_1_13)));


	// From: Req5Batch23Amount25
	var_1_18 = var_1_17;


	// From: Req6Batch23Amount25
	var_1_19 = var_1_20;


	// From: Req7Batch23Amount25
	var_1_21 = var_1_22;


	// From: Req2Batch23Amount25
	if ((var_1_19 / var_1_6) <= (var_1_19 + (var_1_8 - var_1_9))) {
		var_1_4 = (min (var_1_2 , var_1_3));
	}


	// From: Req4Batch23Amount25
	if (var_1_21) {
		if (! ((var_1_19 / var_1_6) < (var_1_8 - var_1_9))) {
			if (var_1_21) {
				var_1_14 = (! var_1_17);
			}
		}
...
int property() {
	return ((((((var_1_1 == ((unsigned long int) (min (var_1_2 , var_1_3)))) && (((var_1_19 / var_1_6) <= (var_1_19 + (var_1_8 - var_1_9))) ? (var_1_4 == ((unsigned long int) (min (var_1_2 , var_1_3)))) : 1)) && (var_1_10 == ((unsigned long int) (max (var_1_2 , ((var_1_11 + var_1_12) - var_1_13)))))) && (var_1_21 ? ((! ((var_1_19 / var_1_6) < (var_1_8 - var_1_9))) ? (var_1_21 ? (var_1_14 == ((unsigned char) (! var_1_17))) : 1) : 1) : 1)) && (var_1_18 == ((unsigned char) var_1_17))) && (var_1_19 == ((float) var_1_20))) && (var_1_21 == ((unsigned char) var_1_22))
;
}
int main(void) {
	isInitial = 1;
