...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch6450_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch6450_while
	var_1_19 = ((var_1_20 - var_1_21) - var_1_22);


	// From: Req6Batch6450_while
