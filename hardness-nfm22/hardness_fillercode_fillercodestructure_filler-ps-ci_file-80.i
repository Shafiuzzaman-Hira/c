...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch80Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_19) {
  var_1_32 = ((var_1_34 + ((((var_1_35) < (var_1_36)) ? (var_1_35) : (var_1_36)))) - ((var_1_9 + var_1_18) + ((((1000000000u) < (var_1_10)) ? (1000000000u) : (var_1_10)))));
 }
 if ((var_1_35 | var_1_10) > var_1_10) {
  if (var_1_29 <= ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4)))) {
   var_1_38 = ((((var_1_18) < ((((((var_1_23) < 0 ) ? -(var_1_23) : (var_1_23))) - var_1_36))) ? (var_1_18) : ((((((var_1_23) < 0 ) ? -(var_1_23) : (var_1_23))) - var_1_36))));
  } else {
 ...
 if ((((((var_1_30 * var_1_13)) < (var_1_29)) ? ((var_1_30 * var_1_13)) : (var_1_29))) >= (- var_1_16)) {
  if (var_1_35 > var_1_34) {
   var_1_40 = (8 + ((((var_1_10) < (var_1_10)) ? (var_1_10) : (var_1_10))));
  } else {
   var_1_40 = var_1_12;
  }
 }
