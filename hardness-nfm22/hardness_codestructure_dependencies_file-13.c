...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch13dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch13dependencies
	if ((~ last_1_var_1_21) != (last_1_var_1_22 >> var_1_4)) {
		if (var_1_5 || var_1_6) {
			var_1_1 = var_1_4;
		} else {
	...
	// From: Req2Batch13dependencies
	if (var_1_9) {
		var_1_8 = (var_1_10 - (var_1_11 - var_1_4));
	}


	// From: Req4Batch13dependencies
	if (var_1_4 > var_1_1) {
	...
	// From: Req6Batch13dependencies
	if (((- var_1_11) < 8) || var_1_9) {
		var_1_22 = (var_1_4 + (abs (var_1_11)));
	}


	// From: Req7Batch13dependencies
	var_1_23 = (var_1_11 + var_1_4);


	// From: Req8Batch13dependencies
