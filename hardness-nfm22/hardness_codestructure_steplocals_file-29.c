...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch29stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch29stepLocals
	var_1_8 = (var_1_9 - (2 + var_1_10));


	// From: Req3Batch29stepLocals
	if (var_1_2) {
