...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch6Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch6Amount25
	if ((var_1_6 * (var_1_7 + var_1_6)) > var_1_1) {
		var_1_18 = var_1_6;
	}


	// From: Req3Batch6Amount25
	if (var_1_13) {
