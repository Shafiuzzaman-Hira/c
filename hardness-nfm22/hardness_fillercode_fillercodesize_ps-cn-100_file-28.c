...
void step(void) {
	...
	// From: CodeObject2
	if ((var_1_25 < (abs (var_1_26))) || var_1_28) {
		var_1_27 = var_1_29;
	} else {
	...
	if ((var_1_33 * var_1_34) == var_1_35) {
		var_1_32 = (min (var_1_36 , (max (99.8 , var_1_37))));
	} else {
		if (var_1_33 < var_1_35) {
			if (var_1_35 != (var_1_33 / var_1_38)) {
				var_1_32 = (min (var_1_37 , var_1_36));
			}
		}
	}
	...
	if ((var_1_43 <= var_1_32) || var_1_44) {
		...
		if (var_1_32 == var_1_34) {
			var_1_46 = (max (var_1_47 , var_1_48));
		} else {
			var_1_46 = (abs (min (var_1_47 , var_1_48)));
		}
	}


	// From: CodeObject7
	var_1_49 = (max (8.44 , (var_1_50 - 1.25)));
	...
	if (var_1_43 >= (var_1_35 * var_1_38)) {
		if (32u <= (var_1_46 >> var_1_27)) {
			if (var_1_28) {
				var_1_51 = (var_1_52 - (abs (var_1_47)));
			}
		}
	}
	...
	if (32 >= (var_1_51 >> 4)) {
		if (var_1_45 || var_1_40) {
			var_1_53 = ((abs (5)) + (abs (-128 + var_1_46)));
		}
	}
	...
	if (var_1_50 < var_1_49) {
		var_1_54 = (min (var_1_55 , (var_1_56 - (var_1_57 - var_1_58))));
	} else {
		var_1_54 = (max (var_1_57 , 16));
	}


	// From: CodeObject11
	if ((var_1_61 * 128) > (abs (max (var_1_52 , var_1_58)))) {
