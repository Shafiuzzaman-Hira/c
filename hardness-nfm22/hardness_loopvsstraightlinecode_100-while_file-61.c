...
void step(void) {
	...
	// From: Req8Batch61100_while
	if ((min (var_1_21 , var_1_22)) >= (- 9.5)) {
		var_1_20 = var_1_7;
	}


	// From: Req1Batch61100_while
	var_1_1 = (var_1_2 - 8u);


	// From: Req4Batch61100_while
	...
	// From: Req5Batch61100_while
	if (var_1_12 >= var_1_7) {
		var_1_16 = var_1_17;
	}


	// From: Req11Batch61100_while
