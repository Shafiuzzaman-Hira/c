...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch53Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	...
	signed long int stepLocal_1 = min ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) , (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)));
	unsigned long int stepLocal_0 = (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var3_Pointer));
	if (stepLocal_1 != (min ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var2_Pointer)) , (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var3_Pointer))))) {
