...
void step(void) {
	...
	// From: CodeObject5
	if ((var_1_27 / var_1_32) < (max ((var_1_33 - var_1_34) , (max (1.0000000075E8 , var_1_28))))) {
	...
	if (var_1_32 > var_1_33) {
		var_1_35 = (min (var_1_25 , (abs (var_1_26))));
	}


	// From: CodeObject7
	var_1_38 = (min ((abs (var_1_36)) , (max (var_1_25 , (min (var_1_37 , var_1_26))))));
	...
	// From: Req4Batch27PS_CN_25
	if (var_1_6 == (var_1_4 / var_1_13)) {
		var_1_12 = var_1_11;
	}


	// From: Req6Batch27PS_CN_25
	var_1_20 = var_1_11;


	// From: Req7Batch27PS_CN_25
	var_1_21 = 8;


	// From: Req3Batch27PS_CN_25
