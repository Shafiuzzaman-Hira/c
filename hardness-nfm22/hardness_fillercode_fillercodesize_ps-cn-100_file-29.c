...
void step(void) {
	...
	if (var_1_32 && var_1_33) {
		var_1_31 = (abs (max ((var_1_34 - var_1_35) , (abs (var_1_36)))));
	} else {
		if ((abs (var_1_36)) > var_1_34) {
			if ((! var_1_33) && (var_1_30 > var_1_29)) {
				var_1_31 = ((min (var_1_35 , var_1_34)) - (var_1_37 + var_1_38));
			} else {
				var_1_31 = var_1_35;
			}
		}
	...
	if ((! (var_1_33 && var_1_32)) || ((32u & var_1_35) >= var_1_37)) {
		var_1_40 = (abs (var_1_41 - var_1_38));
	}


	// From: CodeObject5
	if (var_1_33) {
		var_1_42 = (max ((abs (var_1_38)) , (abs (var_1_37))));
	} else {
	...
	// From: CodeObject7
	if ((var_1_37 + var_1_40) < ((var_1_34 ^ var_1_42) ^ (abs (var_1_35)))) {
		var_1_47 = (3720292576u - var_1_40);
	} else {
		var_1_47 = (min (var_1_42 , var_1_34));
	}
	...
	if (var_1_44 >= var_1_39) {
		if ((~ var_1_42) >= (var_1_35 / var_1_41)) {
			var_1_50 = (min ((var_1_51 + var_1_52) , 25.55));
		} else {
			var_1_50 = (max (var_1_30 , var_1_44));
		}
	}
	...
	if (var_1_31 < var_1_47) {
		var_1_53 = (min (var_1_34 , var_1_40));
	} else {
		if (var_1_46 >= var_1_45) {
			var_1_53 = var_1_38;
		} else {
			var_1_53 = (min (var_1_34 , var_1_38));
		}
	}
	...
	// From: Req2Batch29PS_CN_100
	var_1_8 = (var_1_9 - (2 + var_1_10));


	// From: Req6Batch29PS_CN_100
	...
	// From: Req7Batch29PS_CN_100
	if (! ((var_1_9 - var_1_22) > var_1_12)) {
		var_1_27 = var_1_15;
	}


	// From: Req4Batch29PS_CN_100
