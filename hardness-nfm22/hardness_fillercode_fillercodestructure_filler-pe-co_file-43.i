...
void step(void) {
 ...
 var_1_31 = 64;
 if ((var_1_12 | ((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)))) > var_1_12) {
  if (var_1_34) {
 ...
 if ((- var_1_1) < var_1_36) {
  if (var_1_1 > var_1_36) {
   if (((var_1_23 % var_1_40) % ((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41)))) == (var_1_11 / var_1_42)) {
    var_1_39 = (((((var_1_43) > (var_1_44)) ? (var_1_43) : (var_1_44))) - var_1_26);
   }
  }
 } else {
