...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch4Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_14 != (abs (var_1_35))) {
		var_1_36 = (min ((var_1_14 - var_1_20) , (min ((var_1_24 + var_1_6) , var_1_6))));
	}


	// From: CodeObject7
	if ((var_1_21 * (var_1_38 - var_1_16)) <= var_1_21) {
		var_1_37 = ((var_1_39 - var_1_35) + var_1_16);
	} else {
		if (var_1_16 <= (var_1_38 * 64)) {
			var_1_37 = (max (var_1_16 , (abs (var_1_35))));
		}
	}


	// From: CodeObject8
	if (var_1_24 >= (var_1_17 ^ (var_1_9 % var_1_41))) {
		if (var_1_41 > var_1_9) {
			if (var_1_19 >= var_1_39) {
				if (64 < var_1_14) {
					var_1_40 = var_1_29;
				}
			}
