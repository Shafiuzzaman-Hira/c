...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch25PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject2
	if ((max (var_1_27 , (var_1_28 * var_1_29))) <= ((abs (var_1_30)) - 24.05)) {
		var_1_26 = var_1_25;
	}
	...
	// From: Req3Batch25PS_CN_10
	var_1_10 = (last_1_var_1_10 && var_1_11);


	// From: Req5Batch25PS_CN_10
	...
	// From: Req8Batch25PS_CN_10
	var_1_22 = last_1_var_1_22;


	// From: Req9Batch25PS_CN_10
	var_1_23 = var_1_14;


	// From: Req6Batch25PS_CN_10
	...
	// From: Req7Batch25PS_CN_10
	var_1_21 = var_1_22;


	// From: Req4Batch25PS_CN_10
	if (! (var_1_23 <= var_1_7)) {
