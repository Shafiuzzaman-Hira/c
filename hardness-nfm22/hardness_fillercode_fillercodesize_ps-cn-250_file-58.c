...
void step(void) {
	...
	// From: Req4Batch58PS_CN_250
	var_1_12 = (min (var_1_13 , var_1_14));


	// From: Req5Batch58PS_CN_250
	if (var_1_7) {
		var_1_15 = ((min (32 , (16 + var_1_16))) - var_1_17);
	}


	// From: Req6Batch58PS_CN_250
