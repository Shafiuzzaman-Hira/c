...
void step(void) {
	...
	// From: Req3Batch52Wrapper_P
	if ((*(var_1_7_Pointer))) {
		(*(var_1_10_Pointer)) = ((*(var_1_11_Pointer)) - (max (((*(var_1_12_Pointer)) - (*(var_1_13_Pointer))) , (*(var_1_14_Pointer)))));
	}


	// From: Req1Batch52Wrapper_P
