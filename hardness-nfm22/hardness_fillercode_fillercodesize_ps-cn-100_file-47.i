...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch47PS_CN_100.c", 13, "reach_error"); }
...
float var_1_51 = 2.4;
float var_1_52 = 15.25;
float var_1_53 = 99999999999999.75;
...
void step(void) {
 ...
 if (var_1_40 < var_1_44) {
  ...
  var_1_51 = (((((var_1_52 + var_1_53)) > (var_1_29)) ? ((var_1_52 + var_1_53)) : (var_1_29)));
 }
