...
void step(void) {
	// From: Req1Batch75Amount10
	var_1_1 = (var_1_2 - (max (var_1_3 , 1u)));


	// From: Req2Batch75Amount10
	unsigned long int stepLocal_0 = var_1_1;
	if (stepLocal_0 < var_1_3) {
		var_1_4 = var_1_5;
	} else {
		var_1_4 = (min ((min ((var_1_6 - var_1_7) , var_1_5)) , 0));
	}
}
...
int property() {
	return (var_1_1 == ((unsigned long int) (var_1_2 - (max (var_1_3 , 1u))))) && ((var_1_1 < var_1_3) ? (var_1_4 == ((signed long int) var_1_5)) : (var_1_4 == ((signed long int) (min ((min ((var_1_6 - var_1_7) , var_1_5)) , 0)))))
;
}
int main(void) {
	isInitial = 1;
