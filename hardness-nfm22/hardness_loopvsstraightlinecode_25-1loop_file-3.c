...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch325_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch325_1loop
	var_1_12 = var_1_13;


	// From: Req5Batch325_1loop
	var_1_14 = var_1_15;


	// From: Req2Batch325_1loop
	if (! var_1_14) {
...
int property() {
	return (((((! var_1_11) ? ((var_1_11 && var_1_14) ? (var_1_1 == ((unsigned char) (var_1_4 || var_1_5))) : 1) : 1) && ((! var_1_14) ? (var_1_6 == ((signed long int) (var_1_7 + var_1_8))) : (var_1_6 == ((signed long int) (((abs (var_1_9)) + var_1_10) + var_1_7))))) && ((var_1_8 <= var_1_7) ? ((var_1_10 >= var_1_9) ? (var_1_11 == ((unsigned char) (! var_1_5))) : (var_1_11 == ((unsigned char) (var_1_14 || (! var_1_5))))) : 1)) && (var_1_12 == ((double) var_1_13))) && (var_1_14 == ((unsigned char) var_1_15))
;
}
int main(void) {
	isInitial = 1;
