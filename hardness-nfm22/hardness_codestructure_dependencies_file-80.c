...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch80dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch80dependencies
	if (var_1_9 > 0) {
		var_1_19 = ((var_1_5 >= (- var_1_15)) && (var_1_11 && (var_1_20 && var_1_21)));
	}


	// From: Req3Batch80dependencies
	if (var_1_19) {
	...
	// From: Req5Batch80dependencies
	if ((var_1_17 <= (- var_1_16)) && var_1_19) {
		var_1_18 = var_1_10;
	}


	// From: Req7Batch80dependencies
	if (var_1_19) {
