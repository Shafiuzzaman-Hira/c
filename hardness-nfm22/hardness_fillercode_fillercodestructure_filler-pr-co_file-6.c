...
void step(void) {
	...
	if (var_1_19) {
		...
		var_1_33 = (max ((abs (var_1_8)) , var_1_29));
	}


	// From: CodeObject7
	if (var_1_8 > (min (var_1_16 , (max (var_1_29 , var_1_16))))) {
		if (-256 != var_1_35) {
	...
	if (500 != var_1_28) {
		if (var_1_8 != var_1_8) {
			var_1_38 = (abs (var_1_8));
		}
	}


	// From: Req1Batch6Filler_PR_CO
