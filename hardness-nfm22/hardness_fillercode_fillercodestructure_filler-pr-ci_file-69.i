...
void step(void) {
 ...
 if (var_1_10) {
  ...
  if ((var_1_6 % var_1_5) != (var_1_5 + var_1_7)) {
   ...
   if ((((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))) << var_1_6) > var_1_5) {
 ...
 if (var_1_20) {
  var_1_24 = ((((((var_1_7) > (var_1_5)) ? (var_1_7) : (var_1_5))) + var_1_5) + 1);
 }
 if (var_1_8 > var_1_6) {
  if (var_1_19 >= var_1_8) {
   var_1_30 = var_1_8;
 ...
 if (var_1_19 <= 100u) {
  var_1_31 = ((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8)));
 }
 ...
 if (var_1_8 >= ((((8) < (var_1_14)) ? (8) : (var_1_14)))) {
