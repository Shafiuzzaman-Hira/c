...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch76Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_16 < var_1_11) {
		...
		if ((- var_1_5) > var_1_1) {
			if (var_1_1 >= var_1_5) {
				var_1_34 = (abs (abs (var_1_17 - var_1_20)));
			} else {
				var_1_34 = var_1_17;
			}
		}
	...
	// From: CodeObject9
	if ((max (var_1_17 , var_1_18)) <= ((var_1_18 & var_1_17) & var_1_18)) {
		var_1_38 = (abs (var_1_18));
	}


	// From: Req1Batch76Filler_PR_CI
	if (! var_1_2) {
