...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch9650_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch9650_while
	var_1_31 = var_1_30;


	// From: Req1Batch9650_while
