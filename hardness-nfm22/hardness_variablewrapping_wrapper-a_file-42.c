...
void step(void) {
	...
	if (unsigned_char_Array_0[1] > unsigned_char_Array_0[1]) {
		signed_long_int_Array_0[0] = ((min (unsigned_char_Array_0[1] , unsigned_char_Array_0[1])) - 10);
	} else {
		signed_long_int_Array_0[0] = (max ((unsigned_char_Array_0[1] - unsigned_char_Array_0[1]) , (unsigned_char_Array_0[1] - unsigned_char_Array_0[1])));
	}
