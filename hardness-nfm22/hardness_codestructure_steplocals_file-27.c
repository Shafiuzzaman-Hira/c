...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch27stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch27stepLocals
	if (var_1_6 == (var_1_4 / var_1_13)) {
		var_1_12 = var_1_11;
	}


	// From: Req5Batch27stepLocals
	if (! var_1_2) {
		if (var_1_2 || var_1_3) {
	...
	// From: Req6Batch27stepLocals
	var_1_20 = var_1_11;


	// From: Req7Batch27stepLocals
	var_1_21 = 8;


	// From: Req8Batch27stepLocals
	var_1_22 = var_1_12;
}
