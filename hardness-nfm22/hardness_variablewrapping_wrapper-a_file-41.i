...
void step(void) {
 ...
 if (stepLocal_0 > unsigned_short_int_Array_0[0]) {
  if (BOOL_unsigned_char_Array_0[1]) {
   ...
   signed_char_Array_0[1][1] = ((((signed_char_Array_0[0][1]) < 0 ) ? -(signed_char_Array_0[0][1]) : (signed_char_Array_0[0][1])));
  }
 } else {
