...
void step(void) {
 ...
 var_1_25 = var_1_1;
 if (var_1_34 <= var_1_6) {
  var_1_37 = (((((32 - 2)) < (var_1_11)) ? ((32 - 2)) : (var_1_11)));
 } else {
  if (var_1_11 < var_1_6) {
   var_1_37 = ((((-8) < (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))))) ? (-8) : (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))))));
  } else {
 ...
 if (var_1_31 <= 9.6) {
  var_1_38 = (((((var_1_34 + var_1_1)) > (var_1_6)) ? ((var_1_34 + var_1_1)) : (var_1_6)));
 } else {
  if (var_1_6 <= var_1_6) {
   if (var_1_6 > (var_1_15 >> var_1_6)) {
    var_1_38 = ((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6)));
   } else {
    var_1_38 = ((((var_1_34) < (((((var_1_6) < (var_1_6)) ? (var_1_6) : (var_1_6))))) ? (var_1_34) : (((((var_1_6) < (var_1_6)) ? (var_1_6) : (var_1_6))))));
   }
  }
 }
 ...
 if ((var_1_1 < ((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))) || var_1_28) {
  var_1_27 = var_1_6;
 }
