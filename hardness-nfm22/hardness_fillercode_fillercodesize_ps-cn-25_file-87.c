...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch87PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_39) {
		...
		if ((var_1_45 & var_1_44) <= (min (var_1_34 , (~ var_1_35)))) {
			var_1_46 = var_1_45;
		} else {
			var_1_46 = -16;
		}
