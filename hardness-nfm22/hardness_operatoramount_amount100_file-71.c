...
void step(void) {
	...
	// From: Req13Batch71Amount100
	var_1_33 = var_1_12;


	// From: Req1Batch71Amount100
	if (var_1_20 == var_1_6) {
		var_1_1 = (min (var_1_5 , 0));
	}


	// From: Req10Batch71Amount100
	if (var_1_22) {
		if (var_1_20 <= var_1_7) {
