...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch6325_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_4 <= ((min (var_1_2 , var_1_3)) * var_1_8)) {
		var_1_7 = (max (-200 , last_1_var_1_10));
	} else {
...
int property() {
	return ((((min (1.1f , var_1_2)) > (var_1_3 * var_1_4)) ? (var_1_1 == ((unsigned char) (var_1_5 && var_1_6))) : 1) && ((var_1_4 <= ((min (var_1_2 , var_1_3)) * var_1_8)) ? (var_1_7 == ((signed long int) (max (-200 , last_1_var_1_10)))) : (var_1_7 == ((signed long int) last_1_var_1_10)))) && ((var_1_8 > var_1_4) ? ((! var_1_6) ? (((var_1_9 / (max (var_1_11 , -64))) < (var_1_7 / var_1_12)) ? (var_1_10 == ((unsigned short int) var_1_13)) : (var_1_10 == ((unsigned short int) var_1_13))) : (var_1_10 == ((unsigned short int) var_1_14))) : 1)
;
}
int main(void) {
	isInitial = 1;
