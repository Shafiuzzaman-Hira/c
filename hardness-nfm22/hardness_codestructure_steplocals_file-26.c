...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch26stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch26stepLocals
	unsigned long int stepLocal_2 = var_1_17;
	unsigned char stepLocal_1 = var_1_10;
	if (((var_1_13 - var_1_14) != (min (var_1_15 , var_1_16))) || stepLocal_1) {
	...
	// From: Req4Batch26stepLocals
	if (var_1_11 > (var_1_12 * (var_1_2 + var_1_7))) {
		var_1_20 = var_1_21;
	}


	// From: Req5Batch26stepLocals
	signed long int stepLocal_5 = var_1_4 + var_1_3;
	signed long int stepLocal_4 = var_1_23 - 8;
