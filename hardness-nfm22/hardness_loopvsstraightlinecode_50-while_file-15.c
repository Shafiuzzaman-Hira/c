...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch1550_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch1550_while
	var_1_10 = var_1_11;


	// From: Req3Batch1550_while
