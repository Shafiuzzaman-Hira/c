...
void step(void) {
	...
	// From: Req3Batch42100_1loop
	var_1_10 = var_1_11;


	// From: Req4Batch42100_1loop
	var_1_12 = (var_1_3 + (min (1000000.75 , var_1_5)));


	// From: Req10Batch42100_1loop
	var_1_23 = var_1_5;


	// From: Req11Batch42100_1loop
	if (7.75 > (- var_1_12)) {
	...
	// From: Req14Batch42100_1loop
	var_1_30 = var_1_11;


	// From: Req9Batch42100_1loop
	if ((min (var_1_23 , 24.4f)) != var_1_5) {
		var_1_21 = (min (var_1_22 , 5));
	}


	// From: Req8Batch42100_1loop
