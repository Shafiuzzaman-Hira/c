...
void step(void) {
	...
	// From: Req6Batch37Filler_PE_CI
	var_1_17 = (var_1_18 - var_1_3);


	// From: Req3Batch37Filler_PE_CI
	if ((var_1_17 >= var_1_17) || (var_1_9 > last_1_var_1_10)) {
		var_1_10 = var_1_9;
	}


	// From: Req4Batch37Filler_PE_CI
	...
	// From: CodeObject2
	if (var_1_8 > var_1_19) {
		var_1_27 = (max (var_1_8 , var_1_22));
	}


	// From: CodeObject3
	if (var_1_17 <= (abs (abs (var_1_2)))) {
		var_1_28 = 4;
	}
	...
	// From: CodeObject5
	if (var_1_11 >= var_1_1) {
		var_1_32 = (min (4 , (min (var_1_22 , (var_1_31 - var_1_33)))));
	} else {
		var_1_32 = var_1_22;
	}
	...
	if ((var_1_3 & (~ var_1_17)) <= var_1_3) {
		if (var_1_14) {
			var_1_36 = (max (var_1_17 , (min (var_1_19 , (abs (var_1_3))))));
		}
	} else {
		if (var_1_14) {
			var_1_36 = -128;
