...
void step(void) {
	// From: Req3Batch61Wrapper_AP
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
		(*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var4_Pointer)) = ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var3_Pointer)) + (max ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)) , (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)))));
	} else {
	...
	// From: Req2Batch61Wrapper_AP
	if ((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) < (max ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) , (*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer))))) {
