...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch25stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_3 && var_1_6) {
  var_1_5 = ((((var_1_4) < (-100)) ? (var_1_4) : (-100)));
 } else {
 ...
 if (! (var_1_9 <= var_1_7)) {
  ...
  if ((((((var_1_1) > (var_1_5)) ? (var_1_1) : (var_1_5))) / var_1_15) < var_1_4) {
   var_1_12 = var_1_13;
  } else {
 ...
 unsigned char stepLocal_4 = var_1_20 || var_1_10;
...
int property() {
 return (((((((((var_1_2 && (var_1_3 >= var_1_4)) ? ((256 != var_1_3) ? (var_1_1 == ((signed long int) (var_1_4 + var_1_3))) : 1) : ((var_1_4 >= var_1_3) ? (var_1_1 == ((signed long int) var_1_3)) : (var_1_1 == ((signed long int) var_1_4)))) && ((var_1_2 && var_1_6) ? (var_1_5 == ((signed short int) ((((var_1_4) < (-100)) ? (var_1_4) : (-100))))) : (((var_1_7 - var_1_8) > var_1_9) ? (var_1_5 == ((signed short int) var_1_3)) : (var_1_5 == ((signed short int) var_1_4))))) && (var_1_10 == ((unsigned char) (var_1_6 && var_1_11)))) && ((! (var_1_9 <= var_1_7)) ? (var_1_12 == ((float) ((((var_1_13) < (var_1_14)) ? (var_1_13) : (var_1_14))))) : (((((((var_1_1) > (var_1_5)) ? (var_1_1) : (var_1_5))) / var_1_15) < var_1_4) ? (var_1_12 == ((float) var_1_13)) : (var_1_12 == ((float) (var_1_16 + 49.6f)))))) && ((var_1_8 != ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)))) ? (var_1_2 ? (var_1_17 == ((unsigned char) var_1_18)) : 1) : 1)) && ((var_1_4 < var_1_18) ? (var_1_19 == ((unsigned short int) var_1_3)) : (((var_1_20 || var_1_10) || var_1_6) ? (var_1_19 == ((unsigned short int) var_1_3)) : (var_1_19 == ((unsigned short int) var_1_4))))) && (var_1_21 == ((signed long int) var_1_4))) && (var_1_22 == ((signed short int) var_1_17))) && (var_1_23 == ((double) var_1_14))
;
}
int main(void) {
 isInitial = 1;
