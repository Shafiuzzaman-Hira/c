...
void step(void) {
 ...
 if ((*(var_1_19_Pointer)) > (*(var_1_9_Pointer))) {
  if ((*(var_1_6_Pointer))) {
   (*(var_1_12_Pointer)) = ((*(var_1_13_Pointer)) - ((((99999.25f) < 0 ) ? -(99999.25f) : (99999.25f))));
  } else {
 ...
 signed long int stepLocal_0 = ((((*(var_1_8_Pointer))) > (((*(var_1_8_Pointer)) + (*(var_1_19_Pointer))))) ? ((*(var_1_8_Pointer))) : (((*(var_1_8_Pointer)) + (*(var_1_19_Pointer)))));
