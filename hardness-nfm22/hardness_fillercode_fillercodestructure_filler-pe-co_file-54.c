...
void step(void) {
	...
	if (var_1_6 >= var_1_6) {
		...
		if (var_1_30 <= (abs (var_1_42 * var_1_18))) {
			var_1_40 = ((abs (abs (var_1_1))) + (abs (var_1_1)));
		}
	}
