...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch18dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch18dependencies
	if (! (last_1_var_1_1 > last_1_var_1_10)) {
		var_1_19 = (max (var_1_13 , (min ((0.05 + var_1_15) , var_1_14))));
	} else {
		if (last_1_var_1_10 > var_1_9) {
			var_1_19 = var_1_15;
		}
	}


	// From: Req3Batch18dependencies
	...
	// From: Req5Batch18dependencies
	if (var_1_1 >= (var_1_16 + var_1_10)) {
		if (var_1_5 < 999.5f) {
			if (var_1_7) {
