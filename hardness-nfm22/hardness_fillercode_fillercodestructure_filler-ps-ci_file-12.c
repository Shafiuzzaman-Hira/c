...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch12Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject2
	if ((var_1_18 * var_1_7) < (abs (var_1_6))) {
		if (var_1_18 <= var_1_6) {
			var_1_29 = var_1_7;
		} else {
			var_1_29 = var_1_18;
	...
	// From: CodeObject3
	if (var_1_7 < (max (var_1_5 , var_1_6))) {
		if (var_1_27) {
			var_1_35 = var_1_7;
		}
	}
	...
	// From: CodeObject4
	if (var_1_18 < (var_1_8 / var_1_5)) {
		var_1_36 = var_1_9;
	} else {
		if (((abs (var_1_18)) / var_1_5) < var_1_21) {
			var_1_36 = var_1_9;
		}
	}
	...
	if (var_1_6 > var_1_7) {
		if (var_1_28 && var_1_27) {
			var_1_40 = (min (var_1_7 , var_1_6));
		}
	} else {
		var_1_40 = (var_1_43 - (var_1_44 - (var_1_45 - var_1_5)));
	}


	// From: CodeObject6
	if (var_1_6 >= (~ (max (var_1_6 , var_1_44)))) {
		if (var_1_23 >= (~ var_1_5)) {
	...
	// From: Req6Batch12Filler_PS_CI
	var_1_21 = (abs (var_1_7));


	// From: Req2Batch12Filler_PS_CI
