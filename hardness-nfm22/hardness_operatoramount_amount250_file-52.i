...
void step(void) {
 ...
 if (! (last_1_var_1_8 || last_1_var_1_51)) {
  if (! (var_1_14 <= last_1_var_1_43)) {
   var_1_57 = ((((var_1_7) > (((((9.3f) < 0 ) ? -(9.3f) : (9.3f))))) ? (var_1_7) : (((((9.3f) < 0 ) ? -(9.3f) : (9.3f))))));
  } else {
  ...
  if (last_1_var_1_29 == var_1_7) {
   ...
   if (var_1_28 > last_1_var_1_60) {
    var_1_57 = ((((var_1_33) < (var_1_5)) ? (var_1_33) : (var_1_5)));
   } else {
    var_1_57 = 255.5f;
   }
  }
 ...
 if (! last_1_var_1_8) {
  if (stepLocal_3 <= (-256 / var_1_13)) {
   if ((var_1_19 - (var_1_14 + last_1_var_1_41)) < stepLocal_2) {
    ...
    var_1_18 = (128 - ((((var_1_3) < (var_1_21)) ? (var_1_3) : (var_1_21))));
   }
  } else {
   var_1_18 = (((((var_1_21 + (var_1_3 + 32))) < (var_1_20)) ? ((var_1_21 + (var_1_3 + 32))) : (var_1_20)));
  }
 } else {
  var_1_18 = (var_1_20 - var_1_3);
 }
 ...
 if (stepLocal_8 >= last_1_var_1_41) {
  var_1_38 = ((((((((((((2) < (var_1_3)) ? (2) : (var_1_3)))) < (var_1_20)) ? (((((2) < (var_1_3)) ? (2) : (var_1_3)))) : (var_1_20)))) < (((((var_1_36) < ((var_1_13 - 1))) ? (var_1_36) : ((var_1_13 - 1)))))) ? (((((((((2) < (var_1_3)) ? (2) : (var_1_3)))) < (var_1_20)) ? (((((2) < (var_1_3)) ? (2) : (var_1_3)))) : (var_1_20)))) : (((((var_1_36) < ((var_1_13 - 1))) ? (var_1_36) : ((var_1_13 - 1)))))));
 } else {
 ...
 if ((last_1_var_1_1 >= last_1_var_1_31) && ((last_1_var_1_60 / var_1_37) > var_1_36)) {
  var_1_41 = (((((var_1_36) < (var_1_3)) ? (var_1_36) : (var_1_3))) - 1);
 } else {
 ...
 if (var_1_10) {
  var_1_35 = (((((((((var_1_3 + var_1_21)) > (var_1_20)) ? ((var_1_3 + var_1_21)) : (var_1_20)))) < (var_1_36)) ? ((((((var_1_3 + var_1_21)) > (var_1_20)) ? ((var_1_3 + var_1_21)) : (var_1_20)))) : (var_1_36)));
 } else {
  if (stepLocal_6 && last_1_var_1_8) {
   if (stepLocal_7 != (var_1_19 * var_1_3)) {
    var_1_35 = ((((var_1_20) < (((var_1_37 - 1) + var_1_3))) ? (var_1_20) : (((var_1_37 - 1) + var_1_3))));
   } else {
    var_1_35 = ((((((((var_1_37) > (var_1_36)) ? (var_1_37) : (var_1_36)))) > (var_1_21)) ? (((((var_1_37) > (var_1_36)) ? (var_1_37) : (var_1_36)))) : (var_1_21)));
   }
  } else {
 ...
 if (last_1_var_1_35 >= stepLocal_9) {
  ...
  if ((var_1_37 <= (last_1_var_1_44 * last_1_var_1_35)) && stepLocal_10) {
   if (! last_1_var_1_48) {
    var_1_44 = (((((((var_1_3) < ((var_1_20 - var_1_21))) ? (var_1_3) : ((var_1_20 - var_1_21)))) < 0 ) ? -((((var_1_3) < ((var_1_20 - var_1_21))) ? (var_1_3) : ((var_1_20 - var_1_21)))) : ((((var_1_3) < ((var_1_20 - var_1_21))) ? (var_1_3) : ((var_1_20 - var_1_21))))));
   }
  } else {
 ...
 if (! (! var_1_48)) {
  ...
  var_1_11 = ((((((var_1_13) < (var_1_14)) ? (var_1_13) : (var_1_14))) - var_1_3) - var_1_18);
 }
 var_1_43 = ((((var_1_13) > ((var_1_11 - var_1_14))) ? (var_1_13) : ((var_1_11 - var_1_14))));
 ...
 if ((((((var_1_3 >> var_1_41)) > (-1)) ? ((var_1_3 >> var_1_41)) : (-1))) < stepLocal_5) {
  var_1_27 = (2510364339u - ((var_1_28 - var_1_21) - var_1_13));
 }
 unsigned long int stepLocal_4 = ~ var_1_59;
 if ((var_1_20 - ((((var_1_3) < (var_1_21)) ? (var_1_3) : (var_1_21)))) > stepLocal_4) {
 ...
 if (var_1_35 != (- var_1_38)) {
  ...
  if (last_1_var_1_50 > ((((var_1_38) < (var_1_44)) ? (var_1_38) : (var_1_44)))) {
   var_1_50 = ((((var_1_44) < (var_1_35)) ? (var_1_44) : (var_1_35)));
  } else {
   if (((0 & var_1_44) * var_1_19) <= var_1_38) {
    var_1_50 = (((var_1_14 + var_1_20) + (var_1_47 - var_1_35)) + (var_1_36 - var_1_3));
   } else {
    var_1_50 = (((((-1 - (var_1_38 + last_1_var_1_50))) > (var_1_27)) ? ((-1 - (var_1_38 + last_1_var_1_50))) : (var_1_27)));
   }
  }
 }
 if ((- var_1_1) <= var_1_22) {
  var_1_31 = ((((var_1_6) > ((var_1_5 + var_1_7))) ? (var_1_6) : ((var_1_5 + var_1_7))));
 } else {
  if (var_1_14 > (256 / var_1_20)) {
   var_1_31 = ((((var_1_7) < (var_1_5)) ? (var_1_7) : (var_1_5)));
  } else {
   var_1_31 = ((((((var_1_32) < (var_1_33)) ? (var_1_32) : (var_1_33))) + var_1_34) - 99.25f);
  }
 }
 if (var_1_8) {
  var_1_58 = var_1_34;
 ...
 if (var_1_24 > var_1_6) {
  if (var_1_51 && (var_1_21 >= (- 1))) {
   ...
   var_1_42 = (var_1_3 + (((((((var_1_44) < 0 ) ? -(var_1_44) : (var_1_44))) < 0 ) ? -((((var_1_44) < 0 ) ? -(var_1_44) : (var_1_44))) : ((((var_1_44) < 0 ) ? -(var_1_44) : (var_1_44))))));
  }
 }
 ...
 if (var_1_48) {
  var_1_26 = ((((((var_1_42) < (var_1_21)) ? (var_1_42) : (var_1_21))) + var_1_20) - var_1_3);
 }
 signed long int stepLocal_11 = (- var_1_41) * ((((var_1_46) < 0 ) ? -(var_1_46) : (var_1_46)));
