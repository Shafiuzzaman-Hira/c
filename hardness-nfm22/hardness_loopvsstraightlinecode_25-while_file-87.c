...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch8725_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch8725_while
	if (var_1_2) {
		var_1_1 = (abs (var_1_3 - var_1_4));
	}


	// From: Req2Batch8725_while
