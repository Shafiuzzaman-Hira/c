...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch35Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch35Amount25
	var_1_11 = (-32 + (var_1_12 + (min (10 , var_1_13))));


	// From: Req4Batch35Amount25
	...
	// From: Req5Batch35Amount25
	var_1_19 = var_1_5;


	// From: Req2Batch35Amount25
	if (var_1_7) {
		if (var_1_8) {
...
int property() {
	return (((((var_1_2 >= (~ var_1_3)) ? (var_1_1 == ((float) (var_1_4 + var_1_5))) : 1) && (var_1_7 ? (var_1_8 ? (var_1_6 == ((signed short int) (var_1_11 + var_1_11))) : (var_1_6 == ((signed short int) (var_1_11 + var_1_11)))) : (var_1_6 == ((signed short int) var_1_11)))) && (var_1_11 == ((signed char) (-32 + (var_1_12 + (min (10 , var_1_13))))))) && ((var_1_12 != var_1_3) ? (var_1_7 ? (var_1_14 == ((float) ((var_1_15 - var_1_16) - (var_1_17 - var_1_18)))) : 1) : (var_1_14 == ((float) var_1_18)))) && (var_1_19 == ((float) var_1_5))
;
}
int main(void) {
	isInitial = 1;
