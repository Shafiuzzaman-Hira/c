...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch1PS_CN_25.c", 13, "reach_error"); }
...
float var_1_41 = 8.78;
unsigned long int var_1_42 = 1877460848;
unsigned long int var_1_43 = 1831388024;
unsigned long int var_1_44 = 1967003719;
...
void step(void) {
	...
	// From: CodeObject6
	if (63.75f <= var_1_41) {
		var_1_40 = ((var_1_42 + (max (var_1_43 , var_1_44))) - var_1_28);
	}


	// From: Req5Batch1PS_CN_25
	var_1_15 = (var_1_16 - var_1_17);


	// From: Req8Batch1PS_CN_25
	var_1_27 = var_1_21;


	// From: Req1Batch1PS_CN_25
	...
	// From: Req2Batch1PS_CN_25
	if (var_1_27 < (var_1_27 - var_1_27)) {
		var_1_6 = var_1_9;
	}


	// From: Req3Batch1PS_CN_25
