...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch24Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch24Wrapper_P
	if ((max (((*(var_1_17_Pointer)) * 127.75) , ((*(var_1_17_Pointer)) / 3.4))) >= (*(var_1_17_Pointer))) {
		(*(var_1_7_Pointer)) = (min (((*(var_1_10_Pointer)) - (22925 - (*(var_1_5_Pointer)))) , (*(var_1_16_Pointer))));
	}
}
...
int property() {
	return (((((((*(var_1_12_Pointer)) || (64.75f < (*(var_1_17_Pointer)))) ? ((*(var_1_12_Pointer)) ? ((*(var_1_1_Pointer)) == ((signed char) ((*(var_1_4_Pointer)) - (*(var_1_5_Pointer))))) : ((*(var_1_1_Pointer)) == ((signed char) (min ((max ((*(var_1_4_Pointer)) , (*(var_1_5_Pointer)))) , (*(var_1_6_Pointer))))))) : ((*(var_1_1_Pointer)) == ((signed char) (*(var_1_4_Pointer))))) && (((max (((*(var_1_17_Pointer)) * 127.75) , ((*(var_1_17_Pointer)) / 3.4))) >= (*(var_1_17_Pointer))) ? ((*(var_1_7_Pointer)) == ((unsigned short int) (min (((*(var_1_10_Pointer)) - (22925 - (*(var_1_5_Pointer)))) , (*(var_1_16_Pointer)))))) : 1)) && ((! (*(var_1_2_Pointer))) ? ((*(var_1_12_Pointer)) == ((unsigned char) (*(var_1_14_Pointer)))) : ((*(var_1_12_Pointer)) == ((unsigned char) ((! (*(var_1_15_Pointer))) || (! (! 0))))))) && ((*(var_1_16_Pointer)) == ((unsigned char) (*(var_1_5_Pointer))))) && ((*(var_1_17_Pointer)) == ((float) (*(var_1_18_Pointer))))) && ((*(var_1_19_Pointer)) == ((signed char) (*(var_1_4_Pointer))))
;
}
int main(void) {
	isInitial = 1;
