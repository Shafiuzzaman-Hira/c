...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch0PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_20 > var_1_19) {
		var_1_21 = (max ((abs (var_1_22)) , var_1_23));
	}
