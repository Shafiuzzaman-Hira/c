...
void step(void) {
	...
	if ((abs (var_1_3)) == (~ 16u)) {
		if (var_1_15 || var_1_15) {
			var_1_23 = (max (10 , (min (var_1_3 , var_1_11))));
		}
	}
	...
	// From: Req6Batch9Filler_PR_CI
	var_1_18 = var_1_3;


	// From: CodeObject3
	if (var_1_10 <= var_1_6) {
		if (var_1_10 <= ((min (var_1_6 , var_1_3)) / var_1_6)) {
			var_1_26 = (abs (var_1_13));
		}
	} else {
		if (var_1_6 > (2 ^ (max (var_1_10 , var_1_6)))) {
	...
	// From: CodeObject4
	if ((var_1_8 / var_1_30) > (abs (var_1_8 / var_1_32))) {
		if (var_1_16 > var_1_6) {
			var_1_28 = var_1_16;
		}
	}
