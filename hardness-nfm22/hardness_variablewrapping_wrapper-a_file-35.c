...
void step(void) {
	...
	if (BOOL_unsigned_char_Array_0[1][1]) {
		signed_char_Array_0[0][1] = ((signed_char_Array_0[0][0] + (min (10 , signed_char_Array_0[1][0]))) + signed_char_Array_0[1][1]);
	}
