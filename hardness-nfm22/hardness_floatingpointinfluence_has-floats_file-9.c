...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch9has_floats.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req5Batch9has_floats
	unsigned char stepLocal_0 = last_1_var_1_10 > last_1_var_1_10;
	if (((last_1_var_1_12 + last_1_var_1_1) < 10) || stepLocal_0) {
		var_1_12 = (max (((var_1_3 + last_1_var_1_12) - (max (last_1_var_1_14 , last_1_var_1_12))) , last_1_var_1_1));
	} else {
		var_1_12 = last_1_var_1_12;
	}


	// From: Req6Batch9has_floats
	var_1_14 = var_1_12;
