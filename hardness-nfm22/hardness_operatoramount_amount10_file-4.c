...
void step(void) {
	// From: Req1Batch4Amount10
	if (var_1_2 <= var_1_3) {
		var_1_1 = (min (var_1_2 , (var_1_3 + -50)));
	} else {
		var_1_1 = (max (var_1_4 , (min (var_1_3 , var_1_2))));
	}


	// From: Req2Batch4Amount10
	var_1_5 = 0;


	// From: Req3Batch4Amount10
	var_1_6 = var_1_7;
}
...
int property() {
	return (((var_1_2 <= var_1_3) ? (var_1_1 == ((signed long int) (min (var_1_2 , (var_1_3 + -50))))) : (var_1_1 == ((signed long int) (max (var_1_4 , (min (var_1_3 , var_1_2))))))) && (var_1_5 == ((unsigned char) 0))) && (var_1_6 == ((float) var_1_7))
;
}
int main(void) {
	isInitial = 1;
