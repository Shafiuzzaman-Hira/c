...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch70has_floats.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req5Batch70has_floats
	var_1_13 = var_1_14;


	// From: Req6Batch70has_floats
	var_1_15 = var_1_16;


	// From: Req1Batch70has_floats
	if (var_1_2) {
		var_1_1 = ((17222 - var_1_13) + ((min (29916 , var_1_4)) - var_1_13));
	}


	// From: Req2Batch70has_floats
	if (var_1_2 && (var_1_4 >= (var_1_13 + var_1_1))) {
		var_1_6 = 8;
	}


	// From: Req3Batch70has_floats
	unsigned short int stepLocal_0 = var_1_4;
	if (stepLocal_0 <= (max (var_1_13 , (var_1_13 << var_1_13)))) {
		var_1_7 = (min ((var_1_13 - var_1_13) , var_1_4));
	} else {
		var_1_7 = (var_1_13 + (var_1_1 + var_1_4));
	}


	// From: Req4Batch70has_floats
...
int property() {
	return (((((var_1_2 ? (var_1_1 == ((unsigned short int) ((17222 - var_1_13) + ((min (29916 , var_1_4)) - var_1_13)))) : 1) && ((var_1_2 && (var_1_4 >= (var_1_13 + var_1_1))) ? (var_1_6 == ((signed char) 8)) : 1)) && ((var_1_4 <= (max (var_1_13 , (var_1_13 << var_1_13)))) ? (var_1_7 == ((signed long int) (min ((var_1_13 - var_1_13) , var_1_4)))) : (var_1_7 == ((signed long int) (var_1_13 + (var_1_1 + var_1_4)))))) && ((var_1_13 < var_1_13) ? (var_1_8 == ((double) (var_1_9 - var_1_10))) : (var_1_8 == ((double) ((var_1_11 - var_1_12) - var_1_9))))) && (var_1_13 == ((unsigned char) var_1_14))) && (var_1_15 == ((signed char) var_1_16))
;
}
int main(void) {
	isInitial = 1;
