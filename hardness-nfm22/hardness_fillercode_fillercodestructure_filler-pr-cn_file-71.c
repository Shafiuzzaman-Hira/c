...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch71Filler_PR_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch71Filler_PR_CN
	var_1_10 = var_1_11;


	// From: Req3Batch71Filler_PR_CN
