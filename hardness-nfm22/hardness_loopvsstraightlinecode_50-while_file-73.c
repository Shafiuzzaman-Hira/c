...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch7350_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch7350_while
	if (var_1_3 >= (last_1_var_1_12 * var_1_4)) {
		var_1_16 = var_1_18;
	}


	// From: Req7Batch7350_while
	var_1_22 = (abs (var_1_18));


	// From: Req8Batch7350_while
	if (var_1_1 > var_1_5) {
	...
	// From: Req9Batch7350_while
	var_1_26 = var_1_25;


	// From: Req4Batch7350_while
