...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch28normal.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch28normal
	var_1_11 = (max (var_1_9 , var_1_10));


	// From: Req5Batch28normal
	var_1_18 = var_1_5;


	// From: Req6Batch28normal
	var_1_19 = var_1_6;


	// From: Req1Batch28normal
