...
void step(void) {
	...
	// From: CodeObject2
	if (var_1_7) {
		var_1_31 = (max (var_1_20 , var_1_28));
	} else {
		if ((max (var_1_20 , var_1_28)) > var_1_17) {
			if (var_1_24 > (abs (var_1_24 / var_1_36))) {
	...
	// From: CodeObject5
	if (! var_1_10) {
		var_1_42 = (min (((max (var_1_15 , var_1_40)) + (var_1_39 + var_1_15)) , -128));
	}


	// From: Req2Batch14Filler_PR_CI
	...
	// From: CodeObject4
	if ((var_1_39 - (min (32 , var_1_40))) > var_1_28) {
		var_1_38 = ((32.5f >= var_1_21) || (var_1_10 || var_1_9));
	}


	// From: CodeObject6
	if ((var_1_21 + (max (var_1_24 , var_1_21))) < (max (var_1_36 , (var_1_24 + var_1_24)))) {
		if ((var_1_24 + (var_1_36 + var_1_24)) >= (max (25.5 , var_1_21))) {
			if (var_1_28 < (var_1_17 >> 31u)) {
				var_1_44 = (abs (max (var_1_24 , var_1_25)));
			}
		}
	}


	// From: Req5Batch14Filler_PR_CI
