...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch88PS_CN_25.c", 13, "reach_error"); }
...
double var_1_40 = 4.2;
double var_1_41 = 1000.5;
double var_1_42 = 10000000000000.8;
double var_1_43 = 99.6;
double var_1_44 = 64.222;
double var_1_45 = 255.5;
...
void step(void) {
	...
	if (var_1_26 >= var_1_39) {
		var_1_40 = (max (var_1_41 , (abs (var_1_42))));
	} else {
		var_1_40 = (var_1_43 - (max (var_1_44 , var_1_45)));
	}
