...
void step(void) {
 ...
 if (var_1_32 >= (var_1_31 >> var_1_29)) {
  if (var_1_34 || (var_1_30 < var_1_32)) {
   var_1_33 = ((((var_1_35 - (var_1_28 + 5u)) < 0 ) ? -(var_1_35 - (var_1_28 + 5u)) : (var_1_35 - (var_1_28 + 5u))));
  }
 }
 if (var_1_29 >= var_1_35) {
  var_1_36 = ((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37)));
 }
 if (((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37))) <= var_1_39) {
  if ((~ (var_1_35 | var_1_30)) >= (64u + var_1_32)) {
   var_1_38 = (((((((100) > (var_1_40)) ? (100) : (var_1_40))) < 0 ) ? -((((100) > (var_1_40)) ? (100) : (var_1_40))) : ((((100) > (var_1_40)) ? (100) : (var_1_40)))));
  } else {
   var_1_38 = ((((0) > (((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28))))) ? (0) : (((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28))))));
  }
 } else {
  var_1_38 = (-16 + var_1_28);
 }
 if (-50 != (var_1_32 % ((((-32) < 0 ) ? -(-32) : (-32))))) {
  var_1_41 = (((((var_1_42) > (var_1_43)) ? (var_1_42) : (var_1_43))) + var_1_44);
 } else {
  var_1_41 = var_1_37;
 }
 ...
 if (var_1_33 <= ((((var_1_32) < ((var_1_49 * var_1_28))) ? (var_1_32) : ((var_1_49 * var_1_28))))) {
  if (var_1_49 <= ((((1u) > (var_1_30)) ? (1u) : (var_1_30)))) {
   if ((var_1_35 * var_1_32) > var_1_30) {
    var_1_48 = ((((var_1_42) < 0 ) ? -(var_1_42) : (var_1_42)));
   } else {
    var_1_48 = var_1_43;
   }
  }
 ...
 if ((((((var_1_42) < 0 ) ? -(var_1_42) : (var_1_42))) - ((((var_1_48) < 0 ) ? -(var_1_48) : (var_1_48)))) < var_1_44) {
  if (1u >= ((((var_1_33 % var_1_52) < 0 ) ? -(var_1_33 % var_1_52) : (var_1_33 % var_1_52)))) {
   var_1_51 = (((((((var_1_44) < 0 ) ? -(var_1_44) : (var_1_44))) < 0 ) ? -((((var_1_44) < 0 ) ? -(var_1_44) : (var_1_44))) : ((((var_1_44) < 0 ) ? -(var_1_44) : (var_1_44)))));
  } else {
   var_1_51 = (((((var_1_47) < 0 ) ? -(var_1_47) : (var_1_47))) - var_1_53);
  }
 } else {
  var_1_51 = ((((var_1_44) > (((((var_1_53) < (var_1_43)) ? (var_1_53) : (var_1_43))))) ? (var_1_44) : (((((var_1_53) < (var_1_43)) ? (var_1_53) : (var_1_43))))));
 }
 ...
 if (var_1_55) {
  var_1_57 = ((((var_1_35) < ((var_1_58 - var_1_59))) ? (var_1_35) : ((var_1_58 - var_1_59))));
 } else {
  var_1_57 = (((((var_1_59) < 0 ) ? -(var_1_59) : (var_1_59))) + var_1_50);
 }
 if (var_1_33 <= ((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32)))) {
  var_1_60 = (var_1_61 - (((((var_1_62) > (var_1_63)) ? (var_1_62) : (var_1_63))) - var_1_28));
 } else {
  var_1_60 = (var_1_61 - ((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28))));
 }
 if (var_1_46) {
  var_1_64 = (var_1_44 + ((var_1_65 + var_1_66) - ((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43)))));
 }
 if (var_1_29 > var_1_59) {
  var_1_67 = (var_1_56 || var_1_68);
 } else {
  var_1_67 = ((((((var_1_38) < 0 ) ? -(var_1_38) : (var_1_38))) > (~ var_1_50)) || (var_1_69 && (var_1_70 && var_1_71)));
 }
 if ((var_1_30 & var_1_54) < var_1_28) {
  if ((var_1_49 + ((((var_1_73) < 0 ) ? -(var_1_73) : (var_1_73)))) < (var_1_62 * var_1_57)) {
   var_1_72 = var_1_35;
  }
 }
 if ((((((4.6f) < 0 ) ? -(4.6f) : (4.6f))) * -0.25f) >= ((((var_1_44) > (var_1_41)) ? (var_1_44) : (var_1_41)))) {
  var_1_74 = (var_1_75 - var_1_76);
 }
 if ((- var_1_66) >= ((((var_1_47) < (var_1_44)) ? (var_1_47) : (var_1_44)))) {
  if (((((var_1_33) > ((16u ^ var_1_58))) ? (var_1_33) : ((16u ^ var_1_58)))) <= (((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28))) << var_1_52)) {
 ...
 if ((var_1_74 >> var_1_62) > var_1_63) {
  var_1_81 = ((((var_1_82) < 0 ) ? -(var_1_82) : (var_1_82)));
 }
 if (var_1_34) {
  var_1_83 = ((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28)));
 } else {
  if (var_1_70 || (var_1_42 != var_1_48)) {
   var_1_83 = (((((((var_1_75) < 0 ) ? -(var_1_75) : (var_1_75))) < 0 ) ? -((((var_1_75) < 0 ) ? -(var_1_75) : (var_1_75))) : ((((var_1_75) < 0 ) ? -(var_1_75) : (var_1_75)))));
  }
 }
 if (var_1_32 > var_1_62) {
  var_1_84 = ((((var_1_80) < 0 ) ? -(var_1_80) : (var_1_80)));
 }
 if (var_1_68) {
  if ((var_1_66 - var_1_65) > var_1_39) {
   var_1_85 = ((((var_1_28 + var_1_83) < 0 ) ? -(var_1_28 + var_1_83) : (var_1_28 + var_1_83)));
  }
 }
 ...
 if ((- 256.8) >= var_1_65) {
  if (((var_1_30 >> var_1_28) + var_1_58) > var_1_86) {
   ...
   if (var_1_36 >= ((((var_1_66) < 0 ) ? -(var_1_66) : (var_1_66)))) {
 ...
 if ((var_1_58 / var_1_92) <= var_1_31) {
  var_1_91 = (((((1.8) < 0 ) ? -(1.8) : (1.8))) + var_1_43);
 }
