...
void step(void) {
	...
	if (var_1_30) {
		if (var_1_31) {
			if ((var_1_27 % var_1_32) != var_1_28) {
				...
				var_1_29 = (min (var_1_28 , var_1_27));
			}
		} else {
	...
	// From: CodeObject4
	if (var_1_26 >= ((abs (var_1_25)) + var_1_35)) {
		var_1_34 = var_1_27;
	}


	// From: CodeObject5
	if ((max (var_1_25 , var_1_26)) >= (var_1_35 * var_1_37)) {
	...
	// From: Req2Batch13PS_CN_25
	if (var_1_9) {
		var_1_8 = (var_1_10 - (var_1_11 - var_1_4));
	}


	// From: Req4Batch13PS_CN_25
