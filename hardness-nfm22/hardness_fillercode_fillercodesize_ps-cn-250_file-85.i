...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch85PS_CN_250.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24))) << 2) < var_1_25) {
  if (var_1_22 && var_1_39) {
   var_1_45 = ((((var_1_44) < 0 ) ? -(var_1_44) : (var_1_44)));
  }
 }
 if (var_1_35 < ((var_1_32 + var_1_25) & var_1_30)) {
  if (var_1_39) {
   var_1_46 = ((((((((var_1_40) < (var_1_41)) ? (var_1_40) : (var_1_41))) < 0 ) ? -((((var_1_40) < (var_1_41)) ? (var_1_40) : (var_1_41))) : ((((var_1_40) < (var_1_41)) ? (var_1_40) : (var_1_41))))) + (((((((var_1_47) < 0 ) ? -(var_1_47) : (var_1_47))) < 0 ) ? -((((var_1_47) < 0 ) ? -(var_1_47) : (var_1_47))) : ((((var_1_47) < 0 ) ? -(var_1_47) : (var_1_47))))));
  }
 } else {
  var_1_46 = (((((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29))) < 0 ) ? -((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29))) : ((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29)))));
 }
 if (var_1_30 >= (var_1_26 / var_1_49)) {
  if (var_1_25 <= (var_1_42 + var_1_43)) {
   var_1_48 = ((((((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36)))) < (((((var_1_42) < 0 ) ? -(var_1_42) : (var_1_42))))) ? (((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36)))) : (((((var_1_42) < 0 ) ? -(var_1_42) : (var_1_42))))));
  }
 } else {
  var_1_48 = ((((var_1_44) > (var_1_50)) ? (var_1_44) : (var_1_50)));
 }
 if (500.5f < (2.5f - (var_1_52 - var_1_53))) {
  if (var_1_39) {
   var_1_51 = (((((var_1_35 - var_1_34)) > (var_1_36)) ? ((var_1_35 - var_1_34)) : (var_1_36)));
  } else {
   var_1_51 = var_1_32;
  }
 } else {
  if (var_1_22) {
   var_1_51 = (((((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))) < 0 ) ? -((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))) : ((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32)))));
  }
 }
 if (var_1_42 >= var_1_26) {
  if (var_1_22 && var_1_39) {
   var_1_54 = (((((var_1_55 - var_1_56)) > (var_1_34)) ? ((var_1_55 - var_1_56)) : (var_1_34)));
  }
 } else {
  if ((~ ((((var_1_57) < 0 ) ? -(var_1_57) : (var_1_57)))) > var_1_44) {
   var_1_54 = (var_1_55 - var_1_34);
  } else {
   var_1_54 = (((((var_1_55) < (var_1_58)) ? (var_1_55) : (var_1_58))) - ((((8u) > (var_1_24)) ? (8u) : (var_1_24))));
  }
 }
 if (var_1_22 || var_1_39) {
  if ((((((var_1_52) < (var_1_53)) ? (var_1_52) : (var_1_53))) - ((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40)))) > ((((var_1_47) < (((((var_1_46) > (-0.5f)) ? (var_1_46) : (-0.5f))))) ? (var_1_47) : (((((var_1_46) > (-0.5f)) ? (var_1_46) : (-0.5f))))))) {
   var_1_59 = ((((((var_1_60) < 0 ) ? -(var_1_60) : (var_1_60))) - var_1_44) - ((((64) > (var_1_34)) ? (64) : (var_1_34))));
  }
 } else {
  var_1_59 = var_1_44;
 }
 if (var_1_60 <= var_1_35) {
  var_1_61 = (((((((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36))) - var_1_25)) > ((((((var_1_57 + var_1_35)) > (var_1_43)) ? ((var_1_57 + var_1_35)) : (var_1_43))))) ? ((((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36))) - var_1_25)) : ((((((var_1_57 + var_1_35)) > (var_1_43)) ? ((var_1_57 + var_1_35)) : (var_1_43))))));
 }
 if ((var_1_63 >> var_1_50) < var_1_54) {
  var_1_62 = ((((((((var_1_53) < 0 ) ? -(var_1_53) : (var_1_53)))) > (((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29))))) ? (((((var_1_53) < 0 ) ? -(var_1_53) : (var_1_53)))) : (((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29))))));
 }
 if (3.875f == ((((var_1_46) < 0 ) ? -(var_1_46) : (var_1_46)))) {
  if (var_1_60 < var_1_25) {
   var_1_64 = ((var_1_22 && var_1_65) || (var_1_66 || (! var_1_67)));
  } else {
   var_1_64 = (! var_1_65);
  }
 }
 if (var_1_51 > var_1_21) {
  var_1_68 = ((((var_1_47) < 0 ) ? -(var_1_47) : (var_1_47)));
 } else {
  if (var_1_45 < var_1_59) {
   var_1_68 = (((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))) - var_1_53);
  }
 }
 if (4.6f <= var_1_53) {
  var_1_69 = ((((((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31)))) > (var_1_27)) ? (((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31)))) : (var_1_27)));
 } else {
  var_1_69 = ((((var_1_49) < 0 ) ? -(var_1_49) : (var_1_49)));
 }
 if (var_1_39 || var_1_64) {
  if (((((((((var_1_24) < (var_1_36)) ? (var_1_24) : (var_1_36)))) > (var_1_31)) ? (((((var_1_24) < (var_1_36)) ? (var_1_24) : (var_1_36)))) : (var_1_31))) >= var_1_57) {
   var_1_70 = (var_1_60 - (var_1_43 - var_1_44));
  } else {
   if (var_1_59 < ((((var_1_69) > (var_1_60)) ? (var_1_69) : (var_1_60)))) {
    var_1_70 = ((var_1_71 - ((((var_1_34) > (var_1_63)) ? (var_1_34) : (var_1_63)))) - (var_1_44 + (var_1_36 + var_1_35)));
   } else {
    var_1_70 = var_1_43;
   }
  }
 ...
 if (var_1_66) {
  if (((((((((var_1_60) < (var_1_34)) ? (var_1_60) : (var_1_34)))) > (((((var_1_35) > (var_1_30)) ? (var_1_35) : (var_1_30))))) ? (((((var_1_60) < (var_1_34)) ? (var_1_60) : (var_1_34)))) : (((((var_1_35) > (var_1_30)) ? (var_1_35) : (var_1_30)))))) > (((((((var_1_71) < 0 ) ? -(var_1_71) : (var_1_71))) < 0 ) ? -((((var_1_71) < 0 ) ? -(var_1_71) : (var_1_71))) : ((((var_1_71) < 0 ) ? -(var_1_71) : (var_1_71)))))) {
   if ((((((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))) < 0 ) ? -((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))) : ((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))))) >= (((((((var_1_44) > (var_1_56)) ? (var_1_44) : (var_1_56))) < 0 ) ? -((((var_1_44) > (var_1_56)) ? (var_1_44) : (var_1_56))) : ((((var_1_44) > (var_1_56)) ? (var_1_44) : (var_1_56)))))) {
    var_1_72 = (var_1_53 - (var_1_73 + var_1_74));
   }
  } else {
   var_1_72 = var_1_53;
  }
 } else {
  if (((var_1_43 << var_1_51) % ((((var_1_75) < 0 ) ? -(var_1_75) : (var_1_75)))) > var_1_30) {
   var_1_72 = ((((((((var_1_53) < 0 ) ? -(var_1_53) : (var_1_53)))) < ((var_1_47 + (99.5f - var_1_74)))) ? (((((var_1_53) < 0 ) ? -(var_1_53) : (var_1_53)))) : ((var_1_47 + (99.5f - var_1_74)))));
  } else {
   var_1_72 = ((var_1_76 - var_1_73) - ((((var_1_53) < (((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29))))) ? (var_1_53) : (((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29)))))));
  }
 }
 if (var_1_22) {
  if (var_1_66) {
 ...
 if (var_1_83 >= (var_1_55 + ((((var_1_59) < 0 ) ? -(var_1_59) : (var_1_59))))) {
  var_1_84 = ((((var_1_34) > (var_1_56)) ? (var_1_34) : (var_1_56)));
 } else {
  if (var_1_64) {
   var_1_84 = ((((var_1_36) < (var_1_71)) ? (var_1_36) : (var_1_71)));
  }
 }
 var_1_85 = var_1_36;
...
void updateVariables() {
 ...
 assume_abort_if_not((var_1_52 >= 4611686.018427387900e+12F && var_1_52 <= -1.0e-20F) || (var_1_52 <= 9223372.036854776000e+12F && var_1_52 >= 1.0e-20F ));
 var_1_53 = __VERIFIER_nondet_float();
 assume_abort_if_not((var_1_53 >= 0.0F && var_1_53 <= -1.0e-20F) || (var_1_53 <= 4611686.018427387900e+12F && var_1_53 >= 1.0e-20F ));
 ...
 assume_abort_if_not(var_1_60 >= 49150);
 ...
 assume_abort_if_not((var_1_76 >= 4611686.018427382800e+12F && var_1_76 <= -1.0e-20F) || (var_1_76 <= 9223372.036854765600e+12F && var_1_76 >= 1.0e-20F ));
}
