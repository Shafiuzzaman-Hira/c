...
void step(void) {
	// From: CodeObject1
	if (var_1_14 >= (abs (max (var_1_14 , var_1_14)))) {
	...
	// From: CodeObject2
	if (var_1_14 >= (min (var_1_14 , var_1_14))) {
	...
	// From: CodeObject5
	if (-2 > ((abs (var_1_25)) | (-10 * var_1_21))) {
		var_1_37 = (max ((min (25 , var_1_25)) , (abs (var_1_32 + var_1_21))));
	} else {
		if ((abs (var_1_21)) <= (abs (var_1_25))) {
			if ((var_1_21 * (max (var_1_8 , var_1_21))) <= var_1_25) {
