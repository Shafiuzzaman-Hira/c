...
void step(void) {
	...
	// From: CodeObject2
	if (var_1_11) {
		var_1_33 = (max (var_1_26 , var_1_23));
	}
	...
	if (var_1_20 <= var_1_13) {
		if (var_1_5 < 255.2f) {
			if ((16 <= var_1_22) && (var_1_20 >= var_1_15)) {
				var_1_40 = (max (var_1_15 , var_1_19));
			}
		}
	}
	...
	// From: CodeObject6
	if (var_1_26 < (max ((max (var_1_22 , var_1_26)) , var_1_22))) {
		var_1_42 = var_1_6;
	} else {
		if (var_1_6 <= var_1_6) {
			...
			if (var_1_6 <= var_1_6) {
				var_1_42 = (max ((var_1_5 - var_1_6) , var_1_6));
			}
		}
	}
