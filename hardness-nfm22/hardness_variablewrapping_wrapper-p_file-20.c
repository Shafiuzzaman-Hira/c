...
void step(void) {
	...
	if (stepLocal_1 >= (*(var_1_11_Pointer))) {
		if ((*(var_1_1_Pointer)) >= (*(var_1_8_Pointer))) {
			...
			if (stepLocal_2 >= (abs ((*(var_1_12_Pointer))))) {
	...
	if ((*(var_1_10_Pointer)) || stepLocal_0) {
		...
		(*(var_1_9_Pointer)) = ((*(var_1_14_Pointer)) + (abs ((*(var_1_14_Pointer)))));
	}
}
...
int property() {
	return ((((*(var_1_2_Pointer)) ? ((*(var_1_1_Pointer)) == ((float) (((*(var_1_3_Pointer)) - (*(var_1_4_Pointer))) - (*(var_1_5_Pointer))))) : ((*(var_1_1_Pointer)) == ((float) ((*(var_1_4_Pointer)) + (*(var_1_6_Pointer)))))) && ((*(var_1_7_Pointer)) == ((double) ((15.5 + (*(var_1_4_Pointer))) - ((*(var_1_3_Pointer)) - (*(var_1_8_Pointer))))))) && (((*(var_1_10_Pointer)) || (*(var_1_2_Pointer))) ? ((*(var_1_9_Pointer)) == ((unsigned long int) (((*(var_1_11_Pointer)) - (*(var_1_14_Pointer))) - (*(var_1_14_Pointer))))) : ((*(var_1_9_Pointer)) == ((unsigned long int) ((*(var_1_14_Pointer)) + (abs ((*(var_1_14_Pointer))))))))) && ((5 >= (*(var_1_11_Pointer))) ? (((*(var_1_1_Pointer)) >= (*(var_1_8_Pointer))) ? ((*(var_1_14_Pointer)) == ((unsigned char) (128 - 16))) : (((*(var_1_13_Pointer)) >= (abs ((*(var_1_12_Pointer))))) ? ((*(var_1_14_Pointer)) == ((unsigned char) ((*(var_1_15_Pointer)) - (*(var_1_16_Pointer))))) : ((*(var_1_14_Pointer)) == ((unsigned char) (*(var_1_16_Pointer)))))) : 1)
;
}
int main(void) {
	isInitial = 1;
