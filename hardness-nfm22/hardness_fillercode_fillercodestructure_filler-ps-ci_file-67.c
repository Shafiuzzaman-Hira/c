...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch67Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_17 < (var_1_14 + var_1_17)) {
		...
		var_1_23 = (max (var_1_9 , var_1_11));
	}


	// From: CodeObject2
	if (var_1_6) {
		if ((abs (var_1_16)) > ((-10 + var_1_12) & var_1_4)) {
			var_1_29 = ((abs (var_1_31 - 64u)) - var_1_20);
		} else {
			var_1_29 = var_1_20;
		}
	}
	...
	// From: CodeObject5
	var_1_36 = (abs (var_1_13));


	// From: CodeObject6
	if (var_1_15 > (var_1_39 - var_1_40)) {
		if (var_1_21 <= var_1_21) {
			var_1_38 = (var_1_21 + (abs (var_1_17)));
		} else {
			if ((max ((abs (var_1_11)) , var_1_11)) != var_1_10) {
				var_1_38 = (abs (var_1_31));
			}
		}
	} else {
		var_1_38 = ((max (var_1_31 , var_1_42)) - (abs (1795211791u - var_1_17)));
	}


	// From: CodeObject7
	if (var_1_3 || var_1_6) {
		if (var_1_16 <= (var_1_13 - 64)) {
			if (var_1_31 < (abs (var_1_14))) {
				var_1_44 = var_1_16;
			} else {
				var_1_44 = 16;
			}
