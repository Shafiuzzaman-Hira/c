...
void step(void) {
	...
	// From: CodeObject2
	if (var_1_32 < (max (var_1_30 , (abs (var_1_22))))) {
	...
	// From: CodeObject6
	var_1_44 = ((abs (var_1_37)) + (abs (max (var_1_7 , var_1_7))));


	// From: Req2Batch51Filler_PR_CI
	if (! (var_1_17 > var_1_5)) {
	...
	// From: CodeObject7
	if (var_1_21) {
		var_1_45 = (max ((max (var_1_11 , var_1_7)) , var_1_37));
	} else {
		if (var_1_15 > (abs (var_1_11))) {
			var_1_45 = var_1_11;
		} else {
			var_1_45 = 10;
		}
	...
	// From: CodeObject1
	if ((var_1_15 % (max (var_1_27 , var_1_28))) > var_1_15) {
