...
void step(void) {
	...
	// From: Req11Batch29Amount250
	if ((last_1_var_1_42 / (abs (var_1_38))) >= last_1_var_1_36) {
		var_1_39 = (max (var_1_29 , var_1_41));
	}


	// From: Req9Batch29Amount250
	if (! var_1_12) {
		if (! last_1_var_1_1) {
			var_1_36 = var_1_25;
		}
	...
	// From: Req5Batch29Amount250
	if (var_1_12 && var_1_10) {
		var_1_21 = (var_1_22 - (16 + (max (16 , var_1_23))));
	} else {
		var_1_21 = ((max (var_1_22 , var_1_23)) - ((var_1_24 + var_1_25) + var_1_26));
	}


	// From: Req13Batch29Amount250
	var_1_47 = (var_1_30 + (abs (var_1_48)));


	// From: Req6Batch29Amount250
	if (var_1_39 == var_1_17) {
		if (var_1_5) {
			var_1_27 = (((max (var_1_28 , var_1_29)) - (max (var_1_30 , 4.8))) - var_1_31);
		} else {
			var_1_27 = var_1_32;
		}
	} else {
		if (var_1_26 < (min (var_1_33 , var_1_35))) {
			if (-256 <= var_1_24) {
	...
	// From: Req22Batch29Amount250
	if ((max (var_1_39 , var_1_27)) == var_1_39) {
		var_1_65 = 128.5f;
	}


	// From: Req21Batch29Amount250
	...
	if (var_1_39 < var_1_32) {
		if (stepLocal_15 > var_1_64) {
			if (var_1_11 && stepLocal_17) {
				var_1_58 = ((min (var_1_46 , var_1_45)) - last_1_var_1_58);
			} else {
				var_1_58 = ((abs (var_1_36)) + var_1_54);
			}
		}
	} else {
	...
	// From: Req10Batch29Amount250
	if (var_1_23 <= var_1_36) {
		if ((var_1_32 == (var_1_28 + var_1_31)) || var_1_50) {
			if (var_1_28 > 8.6) {
				var_1_37 = (abs (var_1_24 + (var_1_25 - var_1_23)));
			}
		} else {
			var_1_37 = ((abs (var_1_22)) - (var_1_38 - (min (var_1_26 , var_1_24))));
		}
	} else {
		var_1_37 = (var_1_26 - (max (var_1_38 , (var_1_24 + var_1_25))));
	}


	// From: Req17Batch29Amount250
	if (var_1_5 || var_1_50) {
		var_1_53 = (min ((min (var_1_24 , var_1_18)) , ((abs (var_1_22)) - 5)));
	} else {
		var_1_53 = (var_1_26 + ((var_1_24 + var_1_25) - var_1_23));
	}


	// From: Req24Batch29Amount250
	...
	// From: Req12Batch29Amount250
	if (var_1_50) {
		var_1_42 = ((max ((var_1_43 + var_1_44) , (var_1_45 - var_1_24))) - var_1_21);
	} else {
		var_1_42 = ((max (var_1_45 , (var_1_46 - 5))) - var_1_23);
	}


	// From: Req1Batch29Amount250
	...
	// From: Req3Batch29Amount250
	unsigned char stepLocal_3 = var_1_54;
	if (var_1_27 >= (var_1_39 / (abs (var_1_17)))) {
		if (stepLocal_3 < var_1_42) {
			var_1_16 = var_1_18;
		} else {
			var_1_16 = (min (-64 , var_1_18));
		}
	}


	// From: Req19Batch29Amount250
	...
	if (var_1_44 != stepLocal_13) {
		if (stepLocal_14 >= var_1_66) {
			var_1_56 = (max (var_1_22 , (min ((var_1_23 + var_1_25) , var_1_18))));
		}
	}


	// From: Req4Batch29Amount250
	unsigned char stepLocal_4 = var_1_54;
	if (var_1_17 <= var_1_65) {
		var_1_19 = ((max (var_1_54 , var_1_42)) + var_1_36);
	} else {
		if (var_1_39 == var_1_65) {
			if (stepLocal_4 != last_1_var_1_19) {
				var_1_19 = (var_1_42 + (min (last_1_var_1_19 , var_1_42)));
			} else {
				var_1_19 = (abs (var_1_54));
			}
		} else {
	...
	// From: Req14Batch29Amount250
	unsigned char stepLocal_8 = (var_1_46 + var_1_33) >= (min (1000 , var_1_64));
	signed long int stepLocal_7 = - var_1_64;
	if (var_1_10 && stepLocal_8) {
		if (var_1_42 != stepLocal_7) {
			var_1_49 = (abs (max (var_1_30 , var_1_32)));
		} else {
			var_1_49 = var_1_30;
		}
	}
...
int property() {
	return ((((((((((((((((((((((((var_1_42 != var_1_42) ? ((var_1_42 >= (var_1_42 + var_1_52)) ? (var_1_1 == ((unsigned char) var_1_5)) : ((((4.6 * var_1_65) * 1.000000002E8) >= ((var_1_65 + var_1_65) + (3.75 + var_1_47))) ? (var_1_1 == ((unsigned char) (! (var_1_10 || var_1_11)))) : 1)) : (var_1_1 == ((unsigned char) var_1_12))) && ((var_1_66 >= var_1_58) ? (var_1_13 == ((unsigned short int) (var_1_36 + var_1_54))) : 1)) && ((var_1_27 >= (var_1_39 / (abs (var_1_17)))) ? ((var_1_54 < var_1_42) ? (var_1_16 == ((signed char) var_1_18)) : (var_1_16 == ((signed char) (min (-64 , var_1_18))))) : 1)) && ((var_1_17 <= var_1_65) ? (var_1_19 == ((unsigned long int) ((max (var_1_54 , var_1_42)) + var_1_36))) : ((var_1_39 == var_1_65) ? ((var_1_54 != last_1_var_1_19) ? (var_1_19 == ((unsigned long int) (var_1_42 + (min (last_1_var_1_19 , var_1_42))))) : (var_1_19 == ((unsigned long int) (abs (var_1_54))))) : (var_1_19 == ((unsigned long int) (last_1_var_1_19 + (var_1_20 - var_1_54))))))) && ((var_1_12 && var_1_10) ? (var_1_21 == ((signed char) (var_1_22 - (16 + (max (16 , var_1_23)))))) : (var_1_21 == ((signed char) ((max (var_1_22 , var_1_23)) - ((var_1_24 + var_1_25) + var_1_26)))))) && ((var_1_39 == var_1_17) ? (var_1_5 ? (var_1_27 == ((double) (((max (var_1_28 , var_1_29)) - (max (var_1_30 , 4.8))) - var_1_31))) : (var_1_27 == ((double) var_1_32))) : ((var_1_26 < (min (var_1_33 , var_1_35))) ? ((-256 <= var_1_24) ? (var_1_27 == ((double) (var_1_31 - var_1_29))) : (var_1_27 == ((double) var_1_31))) : 1))) && ((((last_1_var_1_49 + var_1_28) / var_1_17) <= (- var_1_30)) ? (var_1_33 == ((signed long int) ((var_1_26 - (var_1_34 - var_1_25)) + (var_1_23 + last_1_var_1_19)))) : (((last_1_var_1_47 <= var_1_30) || var_1_11) ? (var_1_33 == ((signed long int) last_1_var_1_33)) : (var_1_33 == ((signed long int) last_1_var_1_52))))) && ((var_1_31 > (last_1_var_1_27 * var_1_28)) ? (((last_1_var_1_19 <= last_1_var_1_36) && var_1_12) ? (var_1_35 == ((signed short int) (min ((max (var_1_24 , var_1_23)) , var_1_25)))) : 1) : 1)) && ((! var_1_12) ? ((! last_1_var_1_1) ? (var_1_36 == ((unsigned char) var_1_25)) : 1) : 1)) && ((var_1_23 <= var_1_36) ? (((var_1_32 == (var_1_28 + var_1_31)) || var_1_50) ? ((var_1_28 > 8.6) ? (var_1_37 == ((signed char) (abs (var_1_24 + (var_1_25 - var_1_23))))) : 1) : (var_1_37 == ((signed char) ((abs (var_1_22)) - (var_1_38 - (min (var_1_26 , var_1_24))))))) : (var_1_37 == ((signed char) (var_1_26 - (max (var_1_38 , (var_1_24 + var_1_25)))))))) && (((last_1_var_1_42 / (abs (var_1_38))) >= last_1_var_1_36) ? (var_1_39 == ((double) (max (var_1_29 , var_1_41)))) : 1)) && (var_1_50 ? (var_1_42 == ((unsigned short int) ((max ((var_1_43 + var_1_44) , (var_1_45 - var_1_24))) - var_1_21))) : (var_1_42 == ((unsigned short int) ((max (var_1_45 , (var_1_46 - 5))) - var_1_23))))) && (var_1_47 == ((double) (var_1_30 + (abs (var_1_48)))))) && ((var_1_10 && ((var_1_46 + var_1_33) >= (min (1000 , var_1_64)))) ? ((var_1_42 != (- var_1_64)) ? (var_1_49 == ((double) (abs (max (var_1_30 , var_1_32))))) : (var_1_49 == ((double) var_1_30))) : 1)) && ((var_1_52 <= (var_1_23 << var_1_54)) ? (var_1_50 == ((unsigned char) ((var_1_46 < var_1_25) || var_1_51))) : (var_1_50 == ((unsigned char) (! var_1_51))))) && ((((var_1_23 / var_1_45) >= var_1_13) || var_1_10) ? ((var_1_43 <= var_1_64) ? (var_1_52 == ((signed long int) (var_1_13 + var_1_24))) : 1) : 1)) && ((var_1_5 || var_1_50) ? (var_1_53 == ((signed char) (min ((min (var_1_24 , var_1_18)) , ((abs (var_1_22)) - 5))))) : (var_1_53 == ((signed char) (var_1_26 + ((var_1_24 + var_1_25) - var_1_23)))))) && ((last_1_var_1_49 <= var_1_48) ? (var_1_54 == ((unsigned char) (var_1_24 + var_1_38))) : (((var_1_55 - (max (var_1_44 , var_1_46))) > var_1_20) ? (var_1_54 == ((unsigned char) var_1_24)) : (var_1_54 == ((unsigned char) var_1_23))))) && ((var_1_44 != (var_1_66 | var_1_36)) ? (((var_1_42 * var_1_66) >= var_1_66) ? (var_1_56 == ((signed char) (max (var_1_22 , (min ((var_1_23 + var_1_25) , var_1_18)))))) : 1) : 1)) && ((var_1_39 < var_1_32) ? ((var_1_66 > var_1_64) ? ((var_1_11 && (! (10 <= var_1_25))) ? (var_1_58 == ((unsigned short int) ((min (var_1_46 , var_1_45)) - last_1_var_1_58))) : (var_1_58 == ((unsigned short int) ((abs (var_1_36)) + var_1_54)))) : 1) : ((((var_1_62 - var_1_23) - var_1_26) >= var_1_35) ? (var_1_58 == ((unsigned short int) (((10000 - var_1_26) + (var_1_63 - var_1_25)) + var_1_43))) : (var_1_58 == ((unsigned short int) (var_1_45 - var_1_35)))))) && ((var_1_36 <= (- var_1_35)) ? (var_1_64 == ((signed short int) (abs (var_1_35)))) : (var_1_64 == ((signed short int) (var_1_35 + var_1_66))))) && (((max (var_1_39 , var_1_27)) == var_1_39) ? (var_1_65 == ((float) 128.5f)) : 1)) && ((last_1_var_1_58 >= var_1_23) ? (var_1_66 == ((unsigned long int) (var_1_67 - var_1_44))) : (var_1_66 == ((unsigned long int) ((var_1_20 + var_1_68) - last_1_var_1_36))))) && ((var_1_21 < (var_1_20 * var_1_66)) ? (var_1_50 ? (var_1_69 == ((signed char) var_1_18)) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
