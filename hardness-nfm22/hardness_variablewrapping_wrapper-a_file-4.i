...
void step(void) {
 ...
 if (stepLocal_2 != (last_1_unsigned_char_Array_0_1__1_ - 64)) {
  unsigned_char_Array_0[0][0] = ((((unsigned_char_Array_0[1][0]) > (unsigned_char_Array_0[0][1])) ? (unsigned_char_Array_0[1][0]) : (unsigned_char_Array_0[0][1])));
 } else {
  unsigned_char_Array_0[0][0] = ((((unsigned_char_Array_0[0][1]) < (unsigned_char_Array_0[1][0])) ? (unsigned_char_Array_0[0][1]) : (unsigned_char_Array_0[1][0])));
 }
 if ((- (float_Array_0[0][0] / 0.6f)) > ((float_Array_0[0][1] + 3.25f) / ((((float_Array_0[1][1]) < (float_Array_0[1][0])) ? (float_Array_0[1][1]) : (float_Array_0[1][0]))))) {
  unsigned_long_int_Array_0[0] = (500u + ((((unsigned_char_Array_0[1][0]) < (unsigned_char_Array_0[0][0])) ? (unsigned_char_Array_0[1][0]) : (unsigned_char_Array_0[0][0]))));
 } else {
 ...
 if (stepLocal_0 >= unsigned_short_int_Array_0[0]) {
  if (stepLocal_1 > unsigned_short_int_Array_0[0]) {
   unsigned_short_int_Array_0[1] = ((((unsigned_char_Array_0[0][0]) < (unsigned_char_Array_0[1][1])) ? (unsigned_char_Array_0[0][0]) : (unsigned_char_Array_0[1][1])));
  }
 }
}
