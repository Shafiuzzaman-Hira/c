...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch4125_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch4125_while
	if (var_1_5) {
		var_1_8 = (! (! var_1_9));
	}


	// From: Req3Batch4125_while
