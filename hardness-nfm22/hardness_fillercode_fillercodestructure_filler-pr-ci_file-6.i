...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch6Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (((((var_1_23) < ((8 ^ var_1_10))) ? (var_1_23) : ((8 ^ var_1_10)))) >= ((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11)))) {
  var_1_25 = 8;
 }
 var_1_32 = var_1_8;
 if (var_1_11 > (var_1_8 + var_1_11)) {
 ...
 if (var_1_19) {
  var_1_33 = ((((10000000u) < 0 ) ? -(10000000u) : (10000000u)));
 } else {
  var_1_33 = ((((((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10)))) > (var_1_29)) ? (((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10)))) : (var_1_29)));
 }
 if (var_1_11 > ((((var_1_11) < (((((var_1_29) > (var_1_16)) ? (var_1_29) : (var_1_16))))) ? (var_1_11) : (((((var_1_29) > (var_1_16)) ? (var_1_29) : (var_1_16))))))) {
  if (-256 != var_1_35) {
   var_1_37 = (((((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))) < 0 ) ? -((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))) : ((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35)))));
  }
 }
 var_1_40 = var_1_5;
 ...
 if (500 != var_1_28) {
  if (var_1_9 != var_1_11) {
   var_1_38 = ((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9)));
  }
 }
