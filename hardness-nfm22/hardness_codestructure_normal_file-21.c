...
void step(void) {
	...
	// From: Req4Batch21normal
	if (var_1_14) {
		if (((var_1_10 + var_1_9) << var_1_5) < var_1_15) {
			var_1_13 = (min (var_1_7 , (max (var_1_12 , (min (var_1_9 , var_1_6))))));
		} else {
	...
	// From: Req5Batch21normal
	if ((min ((max (var_1_11 , var_1_6)) , var_1_8)) > (var_1_3 * var_1_12)) {
		var_1_17 = var_1_18;
	}


	// From: Req6Batch21normal
	if (var_1_1 >= (var_1_5 - var_1_20)) {
		var_1_19 = ((min (var_1_21 , (var_1_22 - var_1_23))) - var_1_24);
	}


	// From: Req7Batch21normal
