...
void step(void) {
 if (((((var_1_9) < (var_1_18)) ? (var_1_9) : (var_1_18))) > var_1_9) {
  var_1_21 = (((((((((var_1_14) < (0)) ? (var_1_14) : (0))) + var_1_14)) < (16)) ? ((((((var_1_14) < (0)) ? (var_1_14) : (0))) + var_1_14)) : (16)));
 }
 if ((var_1_9 <= var_1_14) && var_1_20) {
  if (! (((((var_1_14) > (var_1_9)) ? (var_1_14) : (var_1_9))) < (var_1_14 & var_1_9))) {
   var_1_27 = var_1_30;
  } else {
   if ((~ var_1_9) >= (var_1_14 & ((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9))))) {
    var_1_27 = var_1_30;
   } else {
    var_1_27 = var_1_30;
   }
