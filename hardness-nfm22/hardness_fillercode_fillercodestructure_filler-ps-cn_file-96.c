...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch96Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_39 <= var_1_45) {
		var_1_44 = (var_1_38 + (abs (max (var_1_42 , -1))));
	}


	// From: CodeObject4
	if (((~ var_1_41) >> (max (var_1_47 , var_1_48))) >= var_1_32) {
	...
	if ((~ var_1_41) > var_1_44) {
		var_1_52 = (min (((var_1_47 + var_1_45) - (abs (var_1_39))) , var_1_38));
	} else {
		var_1_52 = (min (var_1_39 , var_1_35));
	}
	...
	// From: Req7Batch96Filler_PS_CN
	var_1_31 = var_1_30;


	// From: Req1Batch96Filler_PS_CN
