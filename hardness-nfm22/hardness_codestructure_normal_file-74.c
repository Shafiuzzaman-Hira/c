...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch74normal.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch74normal
	if ((~ var_1_3) <= (var_1_12 - var_1_11)) {
		var_1_24 = var_1_22;
	}
}
