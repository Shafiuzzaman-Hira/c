...
void step(void) {
	...
	if (var_1_40 && (var_1_27 < var_1_26)) {
		...
		if ((max ((var_1_33 / var_1_42) , var_1_38)) >= (- var_1_41)) {
			if ((~ var_1_51) == (min (var_1_47 , var_1_48))) {
				var_1_53 = var_1_54;
			}
		} else {
			var_1_53 = var_1_42;
	...
	// From: Req3Batch7PS_CN_100
	var_1_9 = (max (var_1_5 , var_1_6));


	// From: Req4Batch7PS_CN_100
	...
	// From: Req6Batch7PS_CN_100
	var_1_15 = (var_1_14 - (max ((var_1_16 + var_1_17) , 4)));


	// From: Req7Batch7PS_CN_100
	if (var_1_4 > var_1_2) {
	...
	// From: Req8Batch7PS_CN_100
	var_1_24 = 16;


	// From: Req1Batch7PS_CN_100
