...
void step(void) {
 ...
 if ((var_1_25 | var_1_24) <= var_1_29) {
  var_1_36 = ((((var_1_25) > (((var_1_29 - 2) + var_1_30))) ? (var_1_25) : (((var_1_29 - 2) + var_1_30))));
 }
 if ((25u % var_1_38) < var_1_27) {
  var_1_37 = (((((var_1_30) < (((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36))))) ? (var_1_30) : (((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36)))))) + var_1_39);
 } else {
  if ((((((var_1_33) > (var_1_40)) ? (var_1_33) : (var_1_40))) >= var_1_31) && (var_1_39 <= var_1_25)) {
   var_1_37 = var_1_36;
  } else {
