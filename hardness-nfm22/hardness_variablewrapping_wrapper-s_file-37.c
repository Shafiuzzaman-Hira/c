...
void step(void) {
	...
	// From: Req6Batch37Wrapper_S
	WrapperStruct00.var_1_16 = WrapperStruct00.var_1_14;


	// From: Req2Batch37Wrapper_S
	signed long int stepLocal_0 = abs (WrapperStruct00.var_1_14);
	...
	if (2.75f > WrapperStruct00.var_1_12) {
		...
		if ((WrapperStruct00.var_1_13 - (max (WrapperStruct00.var_1_14 , WrapperStruct00.var_1_8))) > stepLocal_1) {
			WrapperStruct00.var_1_11 = (min ((min (WrapperStruct00.var_1_8 , (1 + 5))) , WrapperStruct00.var_1_10));
		}
	}
}
...
int property() {
	return ((((((((WrapperStruct00.var_1_2 - WrapperStruct00.var_1_3) ^ (WrapperStruct00.var_1_15 * WrapperStruct00.var_1_16)) <= -64) ? (WrapperStruct00.var_1_1 == ((unsigned char) WrapperStruct00.var_1_6)) : (WrapperStruct00.var_1_1 == ((unsigned char) WrapperStruct00.var_1_6))) && ((WrapperStruct00.var_1_2 <= (abs (WrapperStruct00.var_1_14))) ? (WrapperStruct00.var_1_7 == ((signed char) ((WrapperStruct00.var_1_8 - (1 + WrapperStruct00.var_1_9)) + WrapperStruct00.var_1_10))) : (WrapperStruct00.var_1_7 == ((signed char) WrapperStruct00.var_1_10)))) && ((2.75f > WrapperStruct00.var_1_12) ? (WrapperStruct00.var_1_11 == ((signed char) (WrapperStruct00.var_1_10 + WrapperStruct00.var_1_8))) : (((WrapperStruct00.var_1_13 - (max (WrapperStruct00.var_1_14 , WrapperStruct00.var_1_8))) > WrapperStruct00.var_1_1) ? (WrapperStruct00.var_1_11 == ((signed char) (min ((min (WrapperStruct00.var_1_8 , (1 + 5))) , WrapperStruct00.var_1_10)))) : 1))) && (WrapperStruct00.var_1_14 == ((signed long int) WrapperStruct00.var_1_8))) && (WrapperStruct00.var_1_15 == ((signed long int) WrapperStruct00.var_1_16))) && (WrapperStruct00.var_1_16 == ((signed short int) WrapperStruct00.var_1_14))
;
}
int main(void) {
	isInitial = 1;
