...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch18Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (last_1_unsigned_long_int_Array_0_0_ > stepLocal_3) {
		if (((last_1_unsigned_char_Array_0_2_ - (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))) + (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer))) > stepLocal_2) {
	...
	unsigned long int stepLocal_0 = (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer)) ^ (max ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer)) , (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer))));
	if (stepLocal_0 != (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer))) {
		if (stepLocal_1 == ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer)) - ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)) - (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer))))) {
