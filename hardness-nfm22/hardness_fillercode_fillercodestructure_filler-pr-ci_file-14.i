...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch14Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_7) {
  var_1_31 = ((((var_1_20) > (var_1_28)) ? (var_1_20) : (var_1_28)));
 } else {
  if (((((var_1_20) > (var_1_28)) ? (var_1_20) : (var_1_28))) > var_1_17) {
   if (var_1_24 > ((((var_1_24 / var_1_36) < 0 ) ? -(var_1_24 / var_1_36) : (var_1_24 / var_1_36)))) {
    if ((var_1_24 / var_1_36) > var_1_24) {
     var_1_31 = var_1_20;
    }
   }
  } else {
 ...
 var_1_29 = var_1_25;
 if (! var_1_10) {
  var_1_42 = (((((((((var_1_15) > (var_1_40)) ? (var_1_15) : (var_1_40))) + (var_1_39 + var_1_15))) < (-128)) ? ((((((var_1_15) > (var_1_40)) ? (var_1_15) : (var_1_40))) + (var_1_39 + var_1_15))) : (-128)));
 }
 ...
 if ((var_1_39 - ((((32) < (var_1_40)) ? (32) : (var_1_40)))) > var_1_28) {
  var_1_38 = ((32.5f >= var_1_21) || (var_1_10 || var_1_9));
 }
 if ((var_1_21 + ((((var_1_24) > (var_1_21)) ? (var_1_24) : (var_1_21)))) < ((((var_1_36) > ((var_1_24 + var_1_24))) ? (var_1_36) : ((var_1_24 + var_1_24))))) {
  if ((var_1_24 + (var_1_36 + var_1_24)) >= ((((25.5) > (var_1_21)) ? (25.5) : (var_1_21)))) {
   if (var_1_28 < (var_1_17 >> 31u)) {
    var_1_44 = (((((((var_1_24) > (var_1_25)) ? (var_1_24) : (var_1_25))) < 0 ) ? -((((var_1_24) > (var_1_25)) ? (var_1_24) : (var_1_25))) : ((((var_1_24) > (var_1_25)) ? (var_1_24) : (var_1_25)))));
   }
  }
 }
