...
void step(void) {
	...
	// From: CodeObject4
	if ((min (var_1_8 , var_1_17)) >= var_1_20) {
		var_1_37 = var_1_15;
	}


	// From: Req7Batch97Filler_PR_CO
	var_1_20 = var_1_8;


	// From: Req8Batch97Filler_PR_CO
	var_1_22 = var_1_23;
	...
	if ((var_1_15 / var_1_30) < var_1_27) {
		...
		var_1_29 = (max ((max ((min (var_1_30 , var_1_8)) , var_1_8)) , (var_1_33 - var_1_8)));
	}


	// From: CodeObject5
	if ((var_1_39 * (var_1_40 - var_1_41)) >= var_1_42) {
		if ((~ var_1_36) <= (abs (min (var_1_8 , var_1_20)))) {
			var_1_38 = var_1_36;
		} else {
			var_1_38 = var_1_36;
		}
	...
	if (var_1_22) {
		if (var_1_27 <= var_1_15) {
			var_1_24 = ((max (var_1_27 , (min (-128 , var_1_15)))) + var_1_8);
		}
	} else {
		var_1_24 = (abs (var_1_15));
	}
	...
	// From: Req5Batch97Filler_PR_CO
	var_1_16 = ((min (var_1_15 , (max (var_1_13 , var_1_12)))) - var_1_11);


	// From: Req6Batch97Filler_PR_CO
	if (var_1_22) {
	...
	if ((max (var_1_39 , 64.75f)) <= var_1_40) {
		if ((var_1_8 & var_1_8) > var_1_15) {
			if (var_1_1 <= ((min (var_1_17 , var_1_8)) ^ (128 - 16))) {
