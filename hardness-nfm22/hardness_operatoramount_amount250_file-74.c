...
void step(void) {
	...
	// From: Req13Batch74Amount250
	unsigned long int stepLocal_7 = ~ var_1_18;
	if (var_1_13 <= stepLocal_7) {
		var_1_43 = (max (var_1_16 , var_1_15));
	}


	// From: Req9Batch74Amount250
	if ((- var_1_4) > (var_1_21 / var_1_36)) {
		var_1_35 = (var_1_29 && var_1_32);
	}


	// From: Req10Batch74Amount250
	var_1_37 = (max (var_1_19 , var_1_3));


	// From: Req12Batch74Amount250
	var_1_42 = (var_1_15 + ((abs (64)) + var_1_20));


	// From: Req19Batch74Amount250
	if ((last_1_var_1_53 * var_1_15) >= var_1_13) {
		var_1_53 = (5 + last_1_var_1_53);
	} else {
		var_1_53 = (min (10 , var_1_3));
	}


	// From: Req26Batch74Amount250
	var_1_63 = var_1_13;


	// From: Req21Batch74Amount250
	if (var_1_35) {
	...
	// From: Req6Batch74Amount250
	signed short int stepLocal_2 = var_1_16;
	signed long int stepLocal_1 = var_1_15 * var_1_42;
	if (stepLocal_2 > (max (var_1_19 , 4))) {
		if (! var_1_56) {
			var_1_26 = var_1_16;
		}
	} else {
		if (((max (var_1_18 , 3968627268u)) - var_1_13) > stepLocal_1) {
			if (var_1_56) {
				var_1_26 = var_1_16;
			} else {
				var_1_26 = var_1_13;
	...
	if (stepLocal_0 < (5u >> (var_1_19 + var_1_20))) {
		...
		var_1_17 = (min (var_1_7 , (var_1_22 - var_1_23)));
	}


	// From: Req8Batch74Amount250
	...
	if (var_1_9 < stepLocal_6) {
		if (var_1_21 >= var_1_17) {
			var_1_33 = (min (((7.6955603716244398E18f - var_1_22) - var_1_23) , var_1_21));
		} else {
			if (var_1_29) {
	...
	// From: Req15Batch74Amount250
	if (63.5f <= ((- var_1_23) * var_1_33)) {
		var_1_46 = ((var_1_22 + var_1_47) - var_1_23);
	}


	// From: Req11Batch74Amount250
	var_1_38 = ((min ((max (var_1_39 , var_1_40)) , var_1_41)) - var_1_48);


	// From: Req23Batch74Amount250
	if ((var_1_9 < (var_1_45 * var_1_41)) && var_1_30) {
		if ((max (var_1_36 , var_1_22)) > var_1_17) {
			var_1_59 = (var_1_41 - (4 + var_1_3));
		} else {
			if (var_1_26 >= (var_1_16 + var_1_37)) {
				if (var_1_37 >= 100) {
					var_1_59 = (abs (var_1_16));
				} else {
					var_1_59 = var_1_39;
				}
			} else {
				var_1_59 = ((abs (var_1_12)) + var_1_50);
			}
		}
	} else {
		if (var_1_37 != (var_1_12 * var_1_37)) {
			var_1_59 = (abs (var_1_42));
		} else {
	...
	// From: Req25Batch74Amount250
	unsigned long int stepLocal_16 = var_1_18 * (min (var_1_26 , var_1_12));
	if (var_1_53 == stepLocal_16) {
		var_1_62 = (max (var_1_63 , (var_1_50 - (var_1_59 + var_1_45))));
	} else {
		var_1_62 = var_1_43;
	}


	// From: Req17Batch74Amount250
	...
	if ((var_1_37 - (var_1_50 - var_1_13)) != stepLocal_12) {
		var_1_49 = (min (var_1_13 , var_1_19));
	} else {
	...
	// From: Req20Batch74Amount250
	if (var_1_16 > var_1_62) {
		var_1_54 = (var_1_56 || var_1_30);
	}


	// From: Req5Batch74Amount250
	if (var_1_54) {
	...
	// From: Req18Batch74Amount250
	unsigned char stepLocal_13 = var_1_30;
	if (var_1_54) {
		if (var_1_23 == var_1_8) {
			if (((var_1_15 >= var_1_19) || (! var_1_28)) || stepLocal_13) {
				var_1_51 = (min (var_1_22 , var_1_34));
			} else {
				var_1_51 = ((max (var_1_8 , (var_1_22 - var_1_47))) + 4.75f);
			}
		} else {
			var_1_51 = (min ((max ((var_1_22 + var_1_47) , (max (var_1_21 , var_1_8)))) , (var_1_7 + var_1_52)));
		}
	}


	// From: Req22Batch74Amount250
...
int property() {
	return ((((((((((((((((((((((((((var_1_49 <= (128 - var_1_3)) ? (var_1_1 == ((double) var_1_4)) : ((var_1_28 || var_1_35) ? (var_1_1 == ((double) (var_1_7 + var_1_8))) : 1)) && (last_1_var_1_28 ? ((255.5f != (var_1_10 - var_1_11)) ? (var_1_9 == ((unsigned char) ((abs (var_1_3)) + ((max (var_1_12 , var_1_13)) + (max (var_1_14 , var_1_15)))))) : 1) : (var_1_9 == ((unsigned char) var_1_14)))) && (((32 & last_1_var_1_38) >= var_1_13) ? (var_1_16 == ((signed short int) (var_1_3 + var_1_14))) : (last_1_var_1_28 ? (var_1_16 == ((signed short int) (last_1_var_1_43 - var_1_14))) : (var_1_16 == ((signed short int) var_1_15))))) && ((((var_1_18 - var_1_37) * var_1_13) < (5u >> (var_1_19 + var_1_20))) ? (var_1_17 == ((float) ((var_1_21 + (var_1_22 - 4.3f)) + var_1_7))) : (var_1_17 == ((float) (min (var_1_7 , (var_1_22 - var_1_23))))))) && (var_1_54 ? ((var_1_35 || var_1_56) ? (var_1_24 == ((unsigned char) var_1_15)) : 1) : 1)) && ((var_1_16 > (max (var_1_19 , 4))) ? ((! var_1_56) ? (var_1_26 == ((unsigned long int) var_1_16)) : 1) : ((((max (var_1_18 , 3968627268u)) - var_1_13) > (var_1_15 * var_1_42)) ? (var_1_56 ? (var_1_26 == ((unsigned long int) var_1_16)) : (var_1_26 == ((unsigned long int) var_1_13))) : 1))) && ((var_1_56 || (var_1_54 && var_1_35)) ? (var_1_28 == ((unsigned char) (var_1_29 && var_1_30))) : (((var_1_38 * var_1_19) == (abs (var_1_12))) ? (var_1_28 == ((unsigned char) var_1_30)) : ((! var_1_30) ? (var_1_28 == ((unsigned char) (! var_1_32))) : (var_1_28 == ((unsigned char) ((var_1_59 <= var_1_3) || (var_1_56 || (var_1_35 || var_1_30))))))))) && ((var_1_9 < ((var_1_15 + var_1_12) - var_1_26)) ? ((var_1_21 >= var_1_17) ? (var_1_33 == ((float) (min (((7.6955603716244398E18f - var_1_22) - var_1_23) , var_1_21)))) : (var_1_29 ? (((var_1_18 & 10) == var_1_9) ? (var_1_33 == ((float) var_1_34)) : (var_1_33 == ((float) var_1_8))) : (var_1_33 == ((float) var_1_23)))) : 1)) && (((- var_1_4) > (var_1_21 / var_1_36)) ? (var_1_35 == ((unsigned char) (var_1_29 && var_1_32))) : 1)) && (var_1_37 == ((unsigned short int) (max (var_1_19 , var_1_3))))) && (var_1_38 == ((unsigned short int) ((min ((max (var_1_39 , var_1_40)) , var_1_41)) - var_1_48)))) && (var_1_42 == ((unsigned char) (var_1_15 + ((abs (64)) + var_1_20))))) && ((var_1_13 <= (~ var_1_18)) ? (var_1_43 == ((signed long int) (max (var_1_16 , var_1_15)))) : 1)) && ((var_1_56 || var_1_28) ? ((var_1_37 <= (min (var_1_20 , (50 + 8)))) ? (var_1_44 == ((unsigned short int) ((var_1_45 - (32 + var_1_61)) - var_1_15))) : 1) : (var_1_44 == ((unsigned short int) (var_1_39 - (var_1_12 + var_1_61)))))) && ((63.5f <= ((- var_1_23) * var_1_33)) ? (var_1_46 == ((float) ((var_1_22 + var_1_47) - var_1_23))) : 1)) && ((var_1_53 <= var_1_19) ? (var_1_48 == ((unsigned short int) (var_1_45 - var_1_9))) : (var_1_48 == ((unsigned short int) ((last_1_var_1_48 + var_1_9) + var_1_14))))) && (((var_1_37 - (var_1_50 - var_1_13)) != ((var_1_40 - var_1_14) * (var_1_59 / var_1_41))) ? (var_1_49 == ((signed char) (min (var_1_13 , var_1_19)))) : ((var_1_45 > var_1_37) ? (var_1_49 == ((signed char) (8 - var_1_19))) : (var_1_49 == ((signed char) (var_1_14 - (var_1_15 + var_1_20))))))) && (var_1_54 ? ((var_1_23 == var_1_8) ? ((((var_1_15 >= var_1_19) || (! var_1_28)) || var_1_30) ? (var_1_51 == ((float) (min (var_1_22 , var_1_34)))) : (var_1_51 == ((float) ((max (var_1_8 , (var_1_22 - var_1_47))) + 4.75f)))) : (var_1_51 == ((float) (min ((max ((var_1_22 + var_1_47) , (max (var_1_21 , var_1_8)))) , (var_1_7 + var_1_52)))))) : 1)) && (((last_1_var_1_53 * var_1_15) >= var_1_13) ? (var_1_53 == ((unsigned short int) (5 + last_1_var_1_53))) : (var_1_53 == ((unsigned short int) (min (10 , var_1_3)))))) && ((var_1_16 > var_1_62) ? (var_1_54 == ((unsigned char) (var_1_56 || var_1_30))) : 1)) && (var_1_35 ? ((var_1_9 != (var_1_9 | var_1_12)) ? (var_1_56 == ((unsigned char) (((32 / var_1_39) > (var_1_9 % var_1_40)) || (var_1_35 || var_1_30)))) : 1) : 1)) && (((var_1_35 && (var_1_54 && var_1_28)) && var_1_56) ? ((var_1_26 > var_1_19) ? (var_1_58 == ((double) (var_1_7 + var_1_22))) : 1) : 1)) && (((var_1_9 < (var_1_45 * var_1_41)) && var_1_30) ? (((max (var_1_36 , var_1_22)) > var_1_17) ? (var_1_59 == ((unsigned short int) (var_1_41 - (4 + var_1_3)))) : ((var_1_26 >= (var_1_16 + var_1_37)) ? ((var_1_37 >= 100) ? (var_1_59 == ((unsigned short int) (abs (var_1_16)))) : (var_1_59 == ((unsigned short int) var_1_39))) : (var_1_59 == ((unsigned short int) ((abs (var_1_12)) + var_1_50))))) : ((var_1_37 != (var_1_12 * var_1_37)) ? (var_1_59 == ((unsigned short int) (abs (var_1_42)))) : (var_1_59 == ((unsigned short int) (var_1_45 - (var_1_38 + var_1_13))))))) && (var_1_54 ? (var_1_61 == ((signed short int) var_1_42)) : (var_1_61 == ((signed short int) var_1_16)))) && ((var_1_53 == (var_1_18 * (min (var_1_26 , var_1_12)))) ? (var_1_62 == ((signed long int) (max (var_1_63 , (var_1_50 - (var_1_59 + var_1_45)))))) : (var_1_62 == ((signed long int) var_1_43)))) && (var_1_63 == ((signed short int) var_1_13))
;
}
int main(void) {
	isInitial = 1;
