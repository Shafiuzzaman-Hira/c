...
void step(void) {
	...
	if (var_1_20 > var_1_21) {
		var_1_22 = (abs (var_1_23 - (abs (var_1_24))));
	}
	...
	// From: CodeObject6
	if ((min ((100 / var_1_31) , var_1_21)) <= var_1_26) {
		var_1_30 = (min ((abs (min (var_1_21 , var_1_27))) , var_1_26));
	} else {
	...
	// From: Req2Batch77PS_CN_25
	if ((- var_1_7) < (var_1_1 * var_1_4)) {
		var_1_8 = var_1_9;
	}


	// From: Req4Batch77PS_CN_25
	...
	// From: Req3Batch77PS_CN_25
	var_1_10 = (50 + ((var_1_11 + 10000) - var_1_12));


	// From: Req6Batch77PS_CN_25
