...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch72Amount10.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch72Amount10
	var_1_9 = var_1_7;


	// From: Req3Batch72Amount10
	var_1_10 = var_1_11;


	// From: Req1Batch72Amount10
	unsigned long int stepLocal_0 = var_1_9;
	if (stepLocal_0 >= (var_1_3 - (min (var_1_4 , var_1_5)))) {
...
int property() {
	return (((var_1_9 >= (var_1_3 - (min (var_1_4 , var_1_5)))) ? (var_1_1 == ((unsigned long int) (var_1_4 + (var_1_6 - (var_1_7 - var_1_8))))) : 1) && (var_1_9 == ((unsigned long int) var_1_7))) && (var_1_10 == ((double) var_1_11))
;
}
int main(void) {
	isInitial = 1;
