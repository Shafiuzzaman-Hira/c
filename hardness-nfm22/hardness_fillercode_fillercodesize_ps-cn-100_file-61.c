...
void step(void) {
	...
	// From: CodeObject8
	if (var_1_24 > (min ((var_1_45 - var_1_30) , var_1_28))) {
		var_1_43 = var_1_46;
	} else {
		var_1_43 = (abs (var_1_47));
	}


	// From: CodeObject9
	if (-128 > var_1_30) {
		var_1_48 = (var_1_49 - (min (25 , var_1_50)));
	}


	// From: CodeObject10
	if (var_1_39) {
		var_1_51 = (abs ((4 + var_1_47) + var_1_43));
	}


	// From: CodeObject11
	if ((var_1_53 - (var_1_54 - var_1_55)) == var_1_37) {
		var_1_52 = ((max (var_1_56 , var_1_57)) - var_1_55);
	}


	// From: CodeObject12
	if ((abs (32)) < (var_1_46 ^ var_1_30)) {
		var_1_58 = var_1_52;
	} else {
		var_1_58 = (min (((var_1_59 - var_1_55) - var_1_56) , (128 + var_1_52)));
	}


	// From: CodeObject13
	if (var_1_45 <= var_1_42) {
		var_1_60 = (max ((var_1_61 + (max (32.8f , var_1_62))) , var_1_41));
	}
	...
	if (var_1_33 > var_1_36) {
		...
		if ((! var_1_34) || var_1_38) {
			var_1_63 = (min ((max (var_1_41 , var_1_36)) , var_1_62));
		}
	}


	// From: CodeObject15
	var_1_64 = (64 - (abs (var_1_55 - var_1_65)));


	// From: Req2Batch61PS_CN_100
	...
	// From: Req7Batch61PS_CN_100
	var_1_21 = var_1_6;


	// From: Req8Batch61PS_CN_100
	var_1_22 = var_1_23;


	// From: Req1Batch61PS_CN_100
	if ((var_1_21 / (abs (64u))) == var_1_4) {
		var_1_1 = (8.8 - 255.2);
	}


	// From: Req4Batch61PS_CN_100
