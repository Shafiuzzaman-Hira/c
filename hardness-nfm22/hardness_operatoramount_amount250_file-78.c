...
void step(void) {
	...
	if (var_1_15 > stepLocal_8) {
		var_1_49 = ((abs (var_1_50)) - (abs (var_1_33 - var_1_26)));
	} else {
	...
	var_1_46 = (min (var_1_14 , var_1_28));
	...
	if ((var_1_44 / (min (3.2 , var_1_59))) <= var_1_45) {
		var_1_58 = ((var_1_15 + (min (last_1_var_1_58 , var_1_3))) - var_1_26);
	} else {
		if (stepLocal_12 && var_1_54) {
			...
			var_1_58 = (((max (var_1_17 , var_1_27)) - var_1_29) + var_1_46);
		}
	}
	...
	if (! var_1_53) {
		var_1_1 = ((max (var_1_3 , var_1_4)) - ((min (var_1_26 , var_1_26)) + var_1_26));
	} else {
		if (stepLocal_0 <= (var_1_4 - (abs (var_1_26)))) {
			if (var_1_4 <= stepLocal_1) {
				var_1_1 = (var_1_4 - var_1_26);
			}
		} else {
			if (var_1_53) {
				var_1_1 = (abs (abs (var_1_26)));
			} else {
	...
	if (stepLocal_4 < (var_1_49 / var_1_3)) {
		var_1_18 = ((abs (var_1_26)) + (var_1_4 + (var_1_17 + var_1_15)));
	} else {
	...
	if (var_1_52 >= 31.5f) {
		...
		if (((min (var_1_58 , var_1_4)) == var_1_32) || (var_1_14 > var_1_16)) {
	...
	if (((var_1_31 ^ var_1_49) / (min (var_1_4 , 2))) != var_1_27) {
		if (((var_1_15 - var_1_26) / var_1_19) == var_1_51) {
			if (var_1_15 != last_1_var_1_60) {
				var_1_60 = (max ((var_1_29 - var_1_15) , (abs (var_1_27 - var_1_26))));
			} else {
				if (var_1_4 == var_1_38) {
	...
	if (! ((~ 128u) > var_1_18)) {
		var_1_40 = (abs (var_1_26 + var_1_13));
	} else {
		if (var_1_41) {
			var_1_40 = (max (var_1_13 , var_1_26));
		}
	}
	...
	signed long int stepLocal_6 = abs (var_1_26);
	if ((- var_1_43) == ((3.5f - var_1_37) * var_1_30)) {
		...
		if ((var_1_1 | var_1_27) < stepLocal_6) {
			...
			var_1_47 = (max ((min (1 , (max (-256 , var_1_26)))) , var_1_14));
		}
	}
	...
	if (var_1_24 >= var_1_45) {
		var_1_57 = (min (var_1_15 , var_1_13));
	} else {
		var_1_57 = (min (var_1_28 , var_1_60));
	}
...
int property() {
	return ((((((((((((((((((((((((! var_1_53) ? (var_1_1 == ((unsigned short int) ((max (var_1_3 , var_1_4)) - ((min (var_1_26 , var_1_26)) + var_1_26)))) : ((var_1_26 <= (var_1_4 - (abs (var_1_26)))) ? ((var_1_4 <= 10) ? (var_1_1 == ((unsigned short int) (var_1_4 - var_1_26))) : 1) : (var_1_53 ? (var_1_1 == ((unsigned short int) (abs (abs (var_1_26))))) : (var_1_1 == ((unsigned short int) (1 + (27338 - var_1_26))))))) && ((var_1_26 >= var_1_40) ? (var_1_8 == ((double) (max ((var_1_9 + 32.9) , 100000.5)))) : (var_1_8 == ((double) var_1_10)))) && ((var_1_52 > var_1_9) ? (var_1_41 ? (var_1_53 ? (var_1_11 == ((signed char) var_1_13)) : (var_1_11 == ((signed char) (var_1_14 - var_1_15)))) : (var_1_11 == ((signed char) (min (var_1_15 , ((min (var_1_16 , var_1_14)) - var_1_17)))))) : 1)) && ((((var_1_4 / var_1_19) ^ (var_1_16 / var_1_20)) < (var_1_49 / var_1_3)) ? (var_1_18 == ((unsigned long int) ((abs (var_1_26)) + (var_1_4 + (var_1_17 + var_1_15))))) : (((- var_1_26) >= var_1_17) ? (var_1_18 == ((unsigned long int) var_1_4)) : (var_1_18 == ((unsigned long int) var_1_26))))) && (((var_1_14 < var_1_26) || var_1_53) ? ((var_1_18 <= var_1_26) ? (var_1_53 ? (var_1_21 == ((float) (var_1_22 - var_1_23))) : (var_1_21 == ((float) 4.3f))) : (var_1_21 == ((float) (max (var_1_22 , ((var_1_24 + var_1_25) - var_1_23)))))) : (var_1_21 == ((float) (var_1_9 + var_1_24))))) && ((var_1_25 <= (- var_1_10)) ? (last_1_var_1_41 ? (var_1_26 == ((unsigned char) (max (((var_1_27 - var_1_28) + var_1_29) , var_1_17)))) : 1) : (var_1_26 == ((unsigned char) (max (var_1_17 , var_1_27)))))) && (((var_1_1 > (var_1_26 << var_1_4)) && var_1_41) ? (var_1_30 == ((float) (min ((max (var_1_23 , (var_1_24 - var_1_25))) , var_1_22)))) : (var_1_53 ? (var_1_30 == ((float) (var_1_24 - var_1_22))) : (var_1_30 == ((float) var_1_24))))) && (var_1_41 ? (var_1_31 == ((signed long int) (var_1_3 - var_1_26))) : 1)) && (var_1_53 ? (var_1_32 == ((unsigned long int) ((var_1_33 + var_1_34) - (max (var_1_4 , var_1_29))))) : (var_1_32 == ((unsigned long int) var_1_29)))) && (var_1_53 ? (var_1_35 == ((double) var_1_36)) : (var_1_35 == ((double) (var_1_25 + (var_1_24 - var_1_37)))))) && ((! ((var_1_19 * var_1_27) < var_1_26)) ? ((var_1_22 <= var_1_52) ? (var_1_38 == ((signed char) (max ((var_1_28 + var_1_39) , var_1_17)))) : 1) : (var_1_38 == ((signed char) (var_1_39 + var_1_28))))) && ((! ((~ 128u) > var_1_18)) ? (var_1_40 == ((signed short int) (abs (var_1_26 + var_1_13)))) : (var_1_41 ? (var_1_40 == ((signed short int) (max (var_1_13 , var_1_26)))) : 1))) && (((var_1_9 * last_1_var_1_8) >= (var_1_10 * (- 255.25))) ? (var_1_41 == ((unsigned char) (! var_1_42))) : 1)) && ((var_1_52 >= 31.5f) ? (var_1_43 == ((float) (var_1_37 + var_1_25))) : ((((min (var_1_58 , var_1_4)) == var_1_32) || (var_1_14 > var_1_16)) ? (var_1_43 == ((float) (var_1_24 + (var_1_44 + var_1_45)))) : 1))) && (var_1_46 == ((signed char) (min (var_1_14 , var_1_28))))) && (((- var_1_43) == ((3.5f - var_1_37) * var_1_30)) ? ((var_1_14 == var_1_60) ? (var_1_47 == ((signed short int) 0)) : 1) : (((var_1_1 | var_1_27) < (abs (var_1_26))) ? (var_1_47 == ((signed short int) (var_1_15 - var_1_26))) : (var_1_47 == ((signed short int) (max ((min (1 , (max (-256 , var_1_26)))) , var_1_14))))))) && ((var_1_15 > var_1_27) ? (var_1_49 == ((unsigned long int) ((abs (var_1_50)) - (abs (var_1_33 - var_1_26))))) : (var_1_49 == ((unsigned long int) (var_1_50 - ((var_1_51 - var_1_29) - var_1_4)))))) && ((var_1_51 >= var_1_27) ? (var_1_52 == ((float) var_1_36)) : 1)) && (var_1_42 ? (((last_1_var_1_26 % var_1_34) > 25u) ? (var_1_53 == ((unsigned char) (last_1_var_1_53 && var_1_54))) : ((var_1_54 || last_1_var_1_63) ? (var_1_53 == ((unsigned char) (var_1_54 && var_1_55))) : (var_1_53 == ((unsigned char) (! (last_1_var_1_41 || var_1_56)))))) : 1)) && ((var_1_24 >= var_1_45) ? (var_1_57 == ((signed short int) (min (var_1_15 , var_1_13)))) : (var_1_57 == ((signed short int) (min (var_1_28 , var_1_60)))))) && (((var_1_44 / (min (3.2 , var_1_59))) <= var_1_45) ? (var_1_58 == ((signed long int) ((var_1_15 + (min (last_1_var_1_58 , var_1_3))) - var_1_26))) : ((var_1_56 && var_1_54) ? (var_1_53 ? (var_1_58 == ((signed long int) var_1_19)) : (var_1_58 == ((signed long int) (var_1_28 + var_1_13)))) : (var_1_58 == ((signed long int) (((max (var_1_17 , var_1_27)) - var_1_29) + var_1_46)))))) && ((((var_1_31 ^ var_1_49) / (min (var_1_4 , 2))) != var_1_27) ? ((((var_1_15 - var_1_26) / var_1_19) == var_1_51) ? ((var_1_15 != last_1_var_1_60) ? (var_1_60 == ((signed short int) (max ((var_1_29 - var_1_15) , (abs (var_1_27 - var_1_26)))))) : ((var_1_4 == var_1_38) ? (var_1_60 == ((signed short int) (var_1_15 - var_1_17))) : 1)) : (var_1_60 == ((signed short int) var_1_27))) : (var_1_60 == ((signed short int) var_1_15)))) && (var_1_53 ? (var_1_61 == ((signed short int) var_1_13)) : (var_1_61 == ((signed short int) var_1_11)))) && ((! var_1_54) ? ((var_1_30 >= var_1_30) ? (var_1_63 == ((unsigned char) var_1_56)) : (var_1_63 == ((unsigned char) (var_1_53 && (var_1_42 && var_1_54))))) : 1)
;
}
int main(void) {
	isInitial = 1;
