...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch79Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject3
	var_1_36 = ((max (var_1_7 , (abs (var_1_7)))) + var_1_1);


	// From: CodeObject7
	if (0.83f > var_1_35) {
		if ((var_1_20 + (abs (var_1_7))) <= var_1_20) {
			var_1_49 = var_1_35;
		}
	} else {
		var_1_49 = var_1_35;
	...
	// From: Req7Batch79Filler_PR_CO
	var_1_26 = var_1_16;


	// From: CodeObject1
	if ((var_1_7 - var_1_7) <= var_1_20) {
		var_1_28 = var_1_7;
	}
	...
	// From: Req8Batch79Filler_PR_CO
	var_1_27 = 10u;


	// From: CodeObject6
	if (((var_1_27 * var_1_27) | var_1_20) <= (var_1_20 + 8u)) {
