...
int property() {
	return ((var_1_2 < (- var_1_3)) ? (var_1_1 == ((unsigned short int) (abs (var_1_4 - var_1_5)))) : (var_1_1 == ((unsigned short int) ((58941 - var_1_6) - var_1_5)))) && (var_1_7 == ((unsigned char) var_1_8))
;
}
int main(void) {
	isInitial = 1;
