...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch65Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch65Wrapper_P
	(*(var_1_16_Pointer)) = (*(var_1_17_Pointer));


	// From: Req5Batch65Wrapper_P
	(*(var_1_18_Pointer)) = (*(var_1_19_Pointer));


	// From: Req6Batch65Wrapper_P
	(*(var_1_20_Pointer)) = (*(var_1_19_Pointer));


	// From: Req3Batch65Wrapper_P
	if ((*(var_1_3_Pointer))) {
		if ((*(var_1_20_Pointer)) >= (((*(var_1_18_Pointer)) - (*(var_1_20_Pointer))) * 64)) {
			(*(var_1_9_Pointer)) = ((min ((*(var_1_12_Pointer)) , 50.5)) - (*(var_1_13_Pointer)));
		}
	} else {
		if ((*(var_1_1_Pointer)) <= (*(var_1_1_Pointer))) {
			(*(var_1_9_Pointer)) = ((*(var_1_13_Pointer)) - ((*(var_1_14_Pointer)) - (*(var_1_15_Pointer))));
		}
	}


	// From: Req2Batch65Wrapper_P
	if ((*(var_1_4_Pointer)) > (*(var_1_9_Pointer))) {
		(*(var_1_5_Pointer)) = ((max ((*(var_1_20_Pointer)) , -64)) + (((*(var_1_20_Pointer)) + -2) + (*(var_1_18_Pointer))));
	}
}
...
int property() {
	return ((((((0.625f > last_1_var_1_9) ? ((*(var_1_3_Pointer)) ? ((*(var_1_1_Pointer)) == ((float) (abs ((*(var_1_4_Pointer)))))) : 1) : ((*(var_1_1_Pointer)) == ((float) (abs ((*(var_1_4_Pointer))))))) && (((*(var_1_4_Pointer)) > (*(var_1_9_Pointer))) ? ((*(var_1_5_Pointer)) == ((signed long int) ((max ((*(var_1_20_Pointer)) , -64)) + (((*(var_1_20_Pointer)) + -2) + (*(var_1_18_Pointer)))))) : 1)) && ((*(var_1_3_Pointer)) ? (((*(var_1_20_Pointer)) >= (((*(var_1_18_Pointer)) - (*(var_1_20_Pointer))) * 64)) ? ((*(var_1_9_Pointer)) == ((double) ((min ((*(var_1_12_Pointer)) , 50.5)) - (*(var_1_13_Pointer))))) : 1) : (((*(var_1_1_Pointer)) <= (*(var_1_1_Pointer))) ? ((*(var_1_9_Pointer)) == ((double) ((*(var_1_13_Pointer)) - ((*(var_1_14_Pointer)) - (*(var_1_15_Pointer)))))) : 1))) && ((*(var_1_16_Pointer)) == ((signed char) (*(var_1_17_Pointer))))) && ((*(var_1_18_Pointer)) == ((unsigned short int) (*(var_1_19_Pointer))))) && ((*(var_1_20_Pointer)) == ((unsigned short int) (*(var_1_19_Pointer))))
;
}
int main(void) {
	isInitial = 1;
