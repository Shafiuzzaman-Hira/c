...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch84100_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch84100_while
	unsigned long int stepLocal_1 = last_1_var_1_31;
	if (var_1_4 < (last_1_var_1_29 + (abs (var_1_6)))) {
	...
	// From: Req8Batch84100_while
	signed long int stepLocal_6 = min (var_1_24 , var_1_24);
	unsigned char stepLocal_5 = var_1_28;
	if (stepLocal_6 < var_1_25) {
		if ((var_1_20 || var_1_17) && stepLocal_5) {
			var_1_27 = (min (((max (var_1_24 , var_1_24)) + last_1_var_1_27) , (max (var_1_25 , var_1_26))));
		}
	}


	// From: Req1Batch84100_while
	...
	if (stepLocal_8 > var_1_31) {
		if (stepLocal_7 >= var_1_26) {
			var_1_34 = (((abs (-5.2001036938992108E18)) - 50.25) - var_1_4);
		} else {
			var_1_34 = var_1_7;
		}
	}
...
int property() {
	return ((((((((((((~ var_1_24) <= var_1_24) ? (var_1_1 == ((float) (var_1_4 - (var_1_5 - (min (var_1_6 , var_1_7)))))) : 1) && ((var_1_4 < (last_1_var_1_29 + (abs (var_1_6)))) ? ((last_1_var_1_19 < last_1_var_1_31) ? (var_1_8 == ((double) ((abs (var_1_6)) + var_1_7))) : (var_1_8 == ((double) var_1_4))) : (var_1_8 == ((double) var_1_7)))) && (((var_1_19 - var_1_16) < ((var_1_11 - var_1_24) - var_1_24)) ? (var_1_9 == ((double) (var_1_7 + (max (var_1_6 , (var_1_14 + var_1_15)))))) : (var_1_9 == ((double) (var_1_7 - var_1_5))))) && (var_1_17 ? ((var_1_11 <= var_1_24) ? ((var_1_24 <= var_1_31) ? (var_1_16 == ((unsigned short int) var_1_27)) : 1) : 1) : (var_1_16 == ((unsigned short int) var_1_27)))) && ((var_1_19 <= var_1_16) ? (var_1_18 == ((float) (var_1_15 + 64.4f))) : 1)) && ((var_1_17 && var_1_20) ? (var_1_17 ? (var_1_19 == ((signed short int) ((var_1_16 - var_1_24) + 50))) : (var_1_19 == ((signed short int) (max (var_1_24 , var_1_16))))) : (((var_1_1 * (- var_1_5)) < (var_1_6 - var_1_7)) ? ((var_1_14 == var_1_8) ? (var_1_19 == ((signed short int) var_1_16)) : (var_1_19 == ((signed short int) (var_1_16 + var_1_24)))) : (var_1_19 == ((signed short int) ((var_1_16 + var_1_24) + 16)))))) && ((! var_1_20) ? ((last_1_var_1_16 <= last_1_var_1_16) ? (var_1_24 == ((unsigned char) ((var_1_25 + 1) + var_1_26))) : (var_1_24 == ((unsigned char) var_1_26))) : (var_1_24 == ((unsigned char) var_1_26)))) && (((min (var_1_24 , var_1_24)) < var_1_25) ? (((var_1_20 || var_1_17) && var_1_28) ? (var_1_27 == ((signed short int) (min (((max (var_1_24 , var_1_24)) + last_1_var_1_27) , (max (var_1_25 , var_1_26)))))) : 1) : 1)) && (var_1_29 == ((float) (var_1_6 + ((var_1_30 - 7.6f) - var_1_7))))) && (var_1_31 == ((unsigned long int) ((max ((var_1_11 + var_1_32) , var_1_33)) - var_1_26)))) && (((~ var_1_16) > var_1_31) ? (((var_1_24 / var_1_11) >= var_1_26) ? (var_1_34 == ((double) (((abs (-5.2001036938992108E18)) - 50.25) - var_1_4))) : (var_1_34 == ((double) var_1_7))) : 1)
;
}
int main(void) {
	isInitial = 1;
