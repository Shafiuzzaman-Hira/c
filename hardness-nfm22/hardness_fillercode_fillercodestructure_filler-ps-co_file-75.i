...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch75Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
 if ((var_1_21 % var_1_28) >= var_1_21) {
  var_1_26 = (var_1_7 || var_1_31);
 } else {
  var_1_26 = (var_1_7 && (var_1_31 && var_1_32));
 }
 if ((var_1_25 ^ (var_1_28 + var_1_25)) <= (((((((var_1_21) < (var_1_21)) ? (var_1_21) : (var_1_21))) < 0 ) ? -((((var_1_21) < (var_1_21)) ? (var_1_21) : (var_1_21))) : ((((var_1_21) < (var_1_21)) ? (var_1_21) : (var_1_21)))))) {
  ...
  if (var_1_38 >= ((((var_1_37) > ((var_1_36 * var_1_1))) ? (var_1_37) : ((var_1_36 * var_1_1))))) {
   if (var_1_31) {
    var_1_33 = var_1_40;
   }
  }
 ...
 if (var_1_32) {
  if (var_1_7) {
   if (! (((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))) > (4.5f + var_1_16))) {
    var_1_47 = var_1_48;
   }
  } else {
   var_1_47 = var_1_48;
