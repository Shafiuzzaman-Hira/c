...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch60Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject1
	if (var_1_1 <= (var_1_7 + var_1_10)) {
		if (var_1_21 < var_1_10) {
			var_1_23 = ((var_1_7 <= (~ var_1_10)) || var_1_29);
		} else {
			var_1_23 = var_1_30;
		}
	}
	...
	// From: CodeObject2
	if (var_1_9 != var_1_1) {
		var_1_31 = (((max (var_1_10 , var_1_7)) + var_1_9) - var_1_9);
	}
	...
	// From: CodeObject6
	if ((abs (var_1_10)) <= (2 / (abs (var_1_44)))) {
		var_1_43 = (max (var_1_9 , var_1_9));
	}
}
