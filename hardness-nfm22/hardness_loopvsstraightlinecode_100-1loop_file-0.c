...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch0100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req12Batch0100_1loop
	var_1_38 = var_1_31;


	// From: Req13Batch0100_1loop
	var_1_39 = var_1_31;


	// From: Req14Batch0100_1loop
	var_1_40 = var_1_41;


	// From: Req9Batch0100_1loop
	...
	// From: Req2Batch0100_1loop
	var_1_6 = (var_1_15 - (min ((var_1_8 - var_1_15) , var_1_38)));


	// From: Req3Batch0100_1loop
