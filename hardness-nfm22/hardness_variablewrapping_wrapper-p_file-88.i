...
void step(void) {
 ...
 if ((*(var_1_5_Pointer))) {
  (*(var_1_8_Pointer)) = (((((*(var_1_7_Pointer))) > ((*(var_1_9_Pointer)))) ? ((*(var_1_7_Pointer))) : ((*(var_1_9_Pointer)))));
 }
 if ((*(var_1_12_Pointer)) <= (*(var_1_8_Pointer))) {
  (*(var_1_14_Pointer)) = (((((*(var_1_8_Pointer))) < 0 ) ? -((*(var_1_8_Pointer))) : ((*(var_1_8_Pointer)))));
 }
 (*(var_1_15_Pointer)) = 2;
 ...
 if (stepLocal_0 && ((((((*(var_1_9_Pointer))) > ((*(var_1_8_Pointer)))) ? ((*(var_1_9_Pointer))) : ((*(var_1_8_Pointer))))) == (*(var_1_7_Pointer)))) {
  (*(var_1_10_Pointer)) = ((*(var_1_11_Pointer)) - ((((((*(var_1_12_Pointer))) > ((*(var_1_13_Pointer)))) ? ((*(var_1_12_Pointer))) : ((*(var_1_13_Pointer))))) - 1u));
 } else {
