...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch6650_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch6650_1loop
	if (var_1_12) {
		var_1_1 = (var_1_3 + var_1_4);
	}


	// From: Req2Batch6650_1loop
	...
	// From: Req8Batch6650_1loop
	if (var_1_12) {
		var_1_19 = ((var_1_7 - (min (var_1_20 , var_1_21))) + var_1_6);
	}


	// From: Req5Batch6650_1loop
