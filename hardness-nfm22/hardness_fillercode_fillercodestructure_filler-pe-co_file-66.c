...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch66Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch66Filler_PE_CO
	if (var_1_12) {
		var_1_1 = (var_1_3 + var_1_4);
	}


	// From: Req2Batch66Filler_PE_CO
	...
	// From: Req8Batch66Filler_PE_CO
	if (var_1_12) {
		var_1_19 = ((var_1_7 - (min (var_1_20 , var_1_21))) + var_1_6);
	}


	// From: Req5Batch66Filler_PE_CO
	...
	// From: CodeObject5
	if ((max ((max (var_1_8 , var_1_15)) , var_1_1)) > var_1_8) {
		if (! (var_1_18 >= 128)) {
			var_1_36 = (abs (8));
		}
	} else {
