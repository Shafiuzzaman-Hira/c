...
void step(void) {
	...
	// From: CodeObject7
	if (var_1_38 >= (abs (var_1_41))) {
		if (var_1_34 < (min (var_1_33 , var_1_40))) {
			if (((var_1_30 % var_1_43) + -100) < var_1_48) {
				if (var_1_43 < var_1_42) {
					var_1_52 = var_1_53;
				} else {
					var_1_52 = (abs (var_1_54));
				}
			}
		} else {
			var_1_52 = (abs (var_1_54));
	...
	// From: CodeObject8
	if (-10 < var_1_52) {
		var_1_55 = ((abs (var_1_56)) + var_1_57);
	}


	// From: CodeObject9
	if (var_1_45 >= var_1_44) {
		var_1_58 = (var_1_59 - ((min (var_1_50 , var_1_56)) + var_1_57));
	}
	...
	// From: Req3Batch94PS_CN_100
	var_1_9 = ((min (var_1_10 , var_1_11)) + (var_1_12 + (var_1_13 - var_1_14)));


	// From: Req4Batch94PS_CN_100
	if (var_1_10 >= var_1_11) {
		var_1_15 = (max ((max ((abs (var_1_16)) , var_1_17)) , var_1_18));
	}


	// From: Req7Batch94PS_CN_100
	var_1_25 = -256;


	// From: Req8Batch94PS_CN_100
	var_1_26 = var_1_17;


	// From: Req9Batch94PS_CN_100
	var_1_27 = var_1_6;


	// From: Req2Batch94PS_CN_100
	if (var_1_7 || var_1_1) {
