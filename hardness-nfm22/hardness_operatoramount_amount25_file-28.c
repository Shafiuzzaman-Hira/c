...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch28Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch28Amount25
	var_1_11 = (max (var_1_9 , var_1_10));


	// From: Req4Batch28Amount25
	signed long int stepLocal_1 = max (var_1_5 , var_1_7);
	if ((var_1_6 | 5) <= stepLocal_1) {
		var_1_12 = ((min (var_1_6 , (var_1_13 - var_1_14))) - (var_1_15 - (abs (var_1_5))));
	} else {
		var_1_12 = 4;
	}


	// From: Req1Batch28Amount25
...
int property() {
	return (((((var_1_2 - var_1_3) <= (- var_1_11)) ? (var_1_1 == ((signed char) (min ((var_1_5 - var_1_6) , var_1_7)))) : (var_1_1 == ((signed char) var_1_5))) && ((-4 < var_1_6) ? (var_1_8 == ((float) (min (var_1_9 , var_1_10)))) : 1)) && (var_1_11 == ((float) (max (var_1_9 , var_1_10))))) && (((var_1_6 | 5) <= (max (var_1_5 , var_1_7))) ? (var_1_12 == ((signed long int) ((min (var_1_6 , (var_1_13 - var_1_14))) - (var_1_15 - (abs (var_1_5)))))) : (var_1_12 == ((signed long int) 4)))
;
}
int main(void) {
	isInitial = 1;
