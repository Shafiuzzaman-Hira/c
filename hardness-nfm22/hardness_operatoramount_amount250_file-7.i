...
void step(void) {
 signed long int stepLocal_15 = (((last_1_var_1_1) > (-10)) ? (last_1_var_1_1) : (-10));
 ...
 if (-16 != (4 - var_1_7)) {
  if (last_1_var_1_13 != last_1_var_1_34) {
   ...
   var_1_59 = (((((var_1_6 + last_1_var_1_32)) < (((var_1_60 - var_1_15) - var_1_35))) ? ((var_1_6 + last_1_var_1_32)) : (((var_1_60 - var_1_15) - var_1_35))));
  }
 } else {
  var_1_59 = ((((((var_1_47 - last_1_var_1_32)) > (last_1_var_1_61)) ? ((var_1_47 - last_1_var_1_32)) : (last_1_var_1_61))) + last_1_var_1_13);
 }
 unsigned long int stepLocal_11 = last_1_var_1_10 / ((((var_1_35) > (var_1_44)) ? (var_1_35) : (var_1_44)));
 ...
 if (! last_1_var_1_19) {
  if ((last_1_var_1_42 % var_1_15) > stepLocal_11) {
   ...
   if (var_1_47 != stepLocal_10) {
    var_1_42 = (var_1_48 - (var_1_35 + ((((var_1_9) < (var_1_31)) ? (var_1_9) : (var_1_31)))));
   } else {
    var_1_42 = ((var_1_47 - (10000 - var_1_31)) + var_1_16);
   }
  }
 } else {
  var_1_42 = ((((var_1_47) < 0 ) ? -(var_1_47) : (var_1_47)));
 }
 ...
 var_1_51 = ((((var_1_9) > ((var_1_6 - var_1_31))) ? (var_1_9) : ((var_1_6 - var_1_31))));
 ...
 if (var_1_9 != stepLocal_12) {
  if ((var_1_50 + -16) > stepLocal_13) {
   var_1_52 = ((((var_1_53) < 0 ) ? -(var_1_53) : (var_1_53)));
  }
 } else {
  var_1_52 = var_1_53;
 }
 if ((256.4f / ((((var_1_55) > (var_1_57)) ? (var_1_55) : (var_1_57)))) != last_1_var_1_63) {
  var_1_63 = var_1_56;
 } else {
  var_1_63 = 15.44;
 }
 signed char stepLocal_9 = var_1_34;
 unsigned long int stepLocal_8 = ((((var_1_39) < (var_1_40)) ? (var_1_39) : (var_1_40))) - var_1_35;
 signed long int stepLocal_7 = var_1_59;
 if (((16u >> 5u) / ((((var_1_15) < (var_1_24)) ? (var_1_15) : (var_1_24)))) <= stepLocal_8) {
  var_1_38 = ((var_1_6 - ((((var_1_17) < (var_1_16)) ? (var_1_17) : (var_1_16)))) + (var_1_30 + ((((var_1_31) > (-10)) ? (var_1_31) : (-10)))));
 } else {
  if (var_1_17 > stepLocal_9) {
   if (stepLocal_7 >= (((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))) - (var_1_17 + var_1_15))) {
    var_1_38 = var_1_8;
   } else {
    var_1_38 = var_1_6;
   }
 ...
 if ((var_1_28 - (var_1_55 - var_1_56)) > (var_1_63 / ((((var_1_57) > (var_1_58)) ? (var_1_57) : (var_1_58))))) {
  var_1_54 = (var_1_21 || (! var_1_20));
 }
 if (! var_1_54) {
  var_1_10 = ((((32u) < 0 ) ? -(32u) : (32u)));
 } else {
  var_1_10 = ((((((((((((var_1_6) > (var_1_9)) ? (var_1_6) : (var_1_9)))) < (var_1_7)) ? (((((var_1_6) > (var_1_9)) ? (var_1_6) : (var_1_9)))) : (var_1_7)))) > (var_1_42)) ? (((((((((var_1_6) > (var_1_9)) ? (var_1_6) : (var_1_9)))) < (var_1_7)) ? (((((var_1_6) > (var_1_9)) ? (var_1_6) : (var_1_9)))) : (var_1_7)))) : (var_1_42)));
 }
 ...
 if (var_1_36) {
  var_1_41 = ((((var_1_14) < (((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16))))) ? (var_1_14) : (((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16))))));
 } else {
  var_1_41 = (((((var_1_35 + var_1_64)) < (var_1_30)) ? ((var_1_35 + var_1_64)) : (var_1_30)));
 }
 signed long int stepLocal_6 = var_1_14 << ((((0) < (var_1_31)) ? (0) : (var_1_31)));
 unsigned short int stepLocal_5 = var_1_42;
 signed long int stepLocal_4 = (((var_1_59) > ((- var_1_64))) ? (var_1_59) : ((- var_1_64)));
 if (stepLocal_4 <= (var_1_6 + (- var_1_15))) {
  if (var_1_27 >= var_1_63) {
   if ((var_1_7 % var_1_15) < stepLocal_6) {
    var_1_32 = ((((var_1_51) > (var_1_8)) ? (var_1_51) : (var_1_8)));
   } else {
    if (stepLocal_5 < (var_1_15 ^ var_1_42)) {
     var_1_32 = (var_1_15 - ((((var_1_17) > (var_1_7)) ? (var_1_17) : (var_1_7))));
    }
   }
  } else {
   var_1_32 = (((((((var_1_41) < (var_1_14)) ? (var_1_41) : (var_1_14))) < 0 ) ? -((((var_1_41) < (var_1_14)) ? (var_1_41) : (var_1_14))) : ((((var_1_41) < (var_1_14)) ? (var_1_41) : (var_1_14)))));
  }
 }
 ...
 if (! (var_1_26 <= var_1_14)) {
  ...
  if (var_1_54) {
   var_1_23 = (((((var_1_16 + var_1_17)) < (var_1_42)) ? ((var_1_16 + var_1_17)) : (var_1_42)));
  } else {
   var_1_23 = var_1_9;
  }
 }
 ...
 if (var_1_64 > stepLocal_0) {
  if (((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52))) < var_1_63) {
 ...
 if (var_1_27 > var_1_63) {
  ...
  if (var_1_59 >= var_1_23) {
   ...
   if (var_1_46 < var_1_35) {
    var_1_49 = (var_1_30 + ((((-4) < (var_1_31)) ? (-4) : (var_1_31))));
   }
  }
 }
 if (var_1_19) {
  ...
  var_1_61 = (((((var_1_38) > (((((-1000) < (var_1_8)) ? (-1000) : (var_1_8))))) ? (var_1_38) : (((((-1000) < (var_1_8)) ? (-1000) : (var_1_8)))))) + var_1_49);
 }
}
