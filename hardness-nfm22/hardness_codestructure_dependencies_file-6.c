...
void step(void) {
	...
	// From: Req3Batch6dependencies
	if ((min (var_1_16 , var_1_9)) >= (var_1_16 - var_1_11)) {
		var_1_12 = var_1_7;
	}


	// From: Req2Batch6dependencies
	var_1_8 = (((var_1_9 + var_1_10) - last_1_var_1_16) - (var_1_11 - (abs (last_1_var_1_16))));


	// From: Req4Batch6dependencies
