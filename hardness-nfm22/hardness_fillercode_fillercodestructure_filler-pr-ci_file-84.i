...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch84Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_37 = ((((((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11)))) < (var_1_1)) ? (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11)))) : (var_1_1)));
 if (var_1_7 == var_1_11) {
 ...
 var_1_18 = var_1_17;
 if (var_1_5 != ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4)))) {
  var_1_33 = (5 + var_1_11);
 }
 if (! var_1_19) {
  if (((var_1_4 + -128) % var_1_17) >= var_1_4) {
   var_1_43 = var_1_3;
  }
 } else {
  var_1_43 = var_1_3;
 ...
 var_1_19 = 0;
 if ((~ var_1_4) > (var_1_11 / var_1_17)) {
  var_1_35 = (((((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))) < 0 ) ? -((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))) : ((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)))));
 }
 var_1_20 = var_1_21;
 if (var_1_19) {
