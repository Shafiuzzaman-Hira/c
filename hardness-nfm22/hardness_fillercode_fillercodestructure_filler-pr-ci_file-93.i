...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch93Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_20 + ((((var_1_24) < (var_1_20)) ? (var_1_24) : (var_1_20)))) <= var_1_17) {
  if (var_1_7 == ((((((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)))) > (var_1_6)) ? (((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)))) : (var_1_6)))) {
   var_1_40 = ((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22)));
  }
 }
 var_1_47 = var_1_12;
 if (var_1_8 > var_1_5) {
  if (var_1_25 <= var_1_19) {
   if (((var_1_7 - var_1_7) / var_1_11) > var_1_7) {
    var_1_51 = var_1_49;
   } else {
    var_1_51 = var_1_49;
   }
 ...
 if (var_1_8 >= var_1_5) {
  var_1_48 = (var_1_49 - ((((var_1_50) > (((((5) < 0 ) ? -(5) : (5))))) ? (var_1_50) : (((((5) < 0 ) ? -(5) : (5)))))));
 }
 ...
 if (((((- var_1_5) < 0 ) ? -(- var_1_5) : (- var_1_5))) <= var_1_8) {
  if ((((((((var_1_8) < (25.6)) ? (var_1_8) : (25.6))) < 0 ) ? -((((var_1_8) < (25.6)) ? (var_1_8) : (25.6))) : ((((var_1_8) < (25.6)) ? (var_1_8) : (25.6))))) >= ((((- var_1_5) < 0 ) ? -(- var_1_5) : (- var_1_5)))) {
   var_1_26 = (((((var_1_6 - var_1_6)) > (((((var_1_8) > (var_1_5)) ? (var_1_8) : (var_1_5))))) ? ((var_1_6 - var_1_6)) : (((((var_1_8) > (var_1_5)) ? (var_1_8) : (var_1_5))))));
  }
 } else {
  var_1_26 = (8.25f - var_1_6);
 }
 if (var_1_16) {
  var_1_20 = (var_1_9 - 50);
 }
