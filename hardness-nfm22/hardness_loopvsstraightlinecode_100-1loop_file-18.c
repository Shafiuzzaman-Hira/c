...
void step(void) {
	...
	// From: Req13Batch18100_1loop
	var_1_38 = var_1_31;


	// From: Req12Batch18100_1loop
	...
	// From: Req2Batch18100_1loop
	if (var_1_34) {
		var_1_6 = var_1_7;
	}


	// From: Req7Batch18100_1loop
	if (var_1_34 || var_1_34) {
		var_1_20 = (var_1_16 + (var_1_12 + var_1_31));
	}


	// From: Req3Batch18100_1loop
