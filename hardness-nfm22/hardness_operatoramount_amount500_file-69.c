...
void step(void) {
	// From: Req33Batch69Amount500
	if (last_1_var_1_95) {
		var_1_85 = (! (var_1_70 && (var_1_71 && var_1_72)));
	}


	// From: Req42Batch69Amount500
	if (var_1_85) {
		var_1_95 = var_1_70;
	} else {
		var_1_95 = var_1_63;
	...
	// From: Req38Batch69Amount500
	if (last_1_var_1_60) {
		var_1_91 = var_1_71;
	}


	// From: Req43Batch69Amount500
	if (var_1_91) {
		var_1_96 = var_1_26;
	} else {
		var_1_96 = var_1_39;
	...
	// From: Req7Batch69Amount500
	var_1_29 = ((min (var_1_24 , var_1_30)) - (var_1_25 - var_1_18));


	// From: Req10Batch69Amount500
	var_1_40 = (abs ((var_1_18 + var_1_41) - var_1_17));


	// From: Req29Batch69Amount500
	var_1_79 = (((var_1_36 - var_1_13) + (64.25 + var_1_37)) - (var_1_14 + var_1_74));


	// From: Req30Batch69Amount500
	var_1_80 = (var_1_24 - var_1_39);


	// From: Req34Batch69Amount500
	var_1_86 = (abs (var_1_50));


	// From: Req39Batch69Amount500
	var_1_92 = var_1_57;


	// From: Req40Batch69Amount500
	var_1_93 = var_1_57;


	// From: Req41Batch69Amount500
	var_1_94 = var_1_36;


	// From: Req4Batch69Amount500
	if ((60969 - var_1_19) < var_1_3) {
		...
		if (((var_1_93 / var_1_17) << var_1_6) < var_1_38) {
			...
			if (var_1_60) {
				var_1_21 = (var_1_16 - (var_1_17 + (min (var_1_18 , 10))));
			}
		}
	}


	// From: Req46Batch69Amount500
	...
	// From: Req23Batch69Amount500
	unsigned char stepLocal_16 = var_1_63;
	if (var_1_95) {
		if (var_1_69 || stepLocal_16) {
			var_1_66 = (var_1_26 + ((abs (var_1_45)) - var_1_19));
		} else {
			var_1_66 = (min ((max ((var_1_25 + var_1_17) , var_1_38)) , ((var_1_49 + var_1_39) + var_1_45)));
		}
	} else {
		var_1_66 = (var_1_30 - (abs (var_1_45 - var_1_41)));
	}


	// From: Req45Batch69Amount500
	if (var_1_69) {
		var_1_98 = var_1_86;
	} else {
		var_1_98 = var_1_19;
	...
	// From: Req12Batch69Amount500
	var_1_43 = var_1_93;


	// From: Req14Batch69Amount500
	unsigned char stepLocal_9 = var_1_33 >= var_1_79;
	if (var_1_85 || stepLocal_9) {
		var_1_47 = (var_1_19 - (abs (abs (var_1_39))));
	} else {
		var_1_47 = (abs (var_1_41));
	}


	// From: Req16Batch69Amount500
	...
	// From: Req20Batch69Amount500
	unsigned long int stepLocal_12 = var_1_53 - var_1_23;
	if ((var_1_80 % var_1_17) < stepLocal_12) {
		var_1_58 = (((max (var_1_35 , var_1_59)) - (var_1_13 + var_1_37)) - var_1_14);
	} else {
		var_1_58 = (var_1_14 + var_1_36);
	}


	// From: Req22Batch69Amount500
	...
	// From: Req35Batch69Amount500
	signed long int stepLocal_27 = (max (var_1_39 , var_1_43)) & var_1_21;
	if (stepLocal_27 < (var_1_43 * var_1_3)) {
		var_1_87 = (min (var_1_11 , var_1_32));
	}


	// From: Req32Batch69Amount500
	if (var_1_93 > var_1_23) {
		if (16u > (max (var_1_80 , var_1_38))) {
			var_1_82 = var_1_38;
		} else {
			var_1_82 = (var_1_41 + var_1_39);
		}
	} else {
		var_1_82 = (max ((max (var_1_19 , var_1_66)) , (var_1_24 - var_1_26)));
	}


	// From: Req6Batch69Amount500
	signed char stepLocal_3 = var_1_20;
	unsigned char stepLocal_2 = var_1_38;
	unsigned short int stepLocal_1 = var_1_23;
	unsigned char stepLocal_0 = (abs (var_1_24)) <= var_1_16;
	if (var_1_60) {
		if (stepLocal_2 <= var_1_23) {
			var_1_27 = (var_1_24 + var_1_97);
		} else {
			if (var_1_79 > (abs (var_1_79 + var_1_13))) {
				var_1_27 = var_1_97;
			} else {
				if (stepLocal_1 <= (- (abs (var_1_26)))) {
					if (stepLocal_0 && (var_1_3 <= var_1_82)) {
						if (stepLocal_3 > var_1_6) {
							var_1_27 = ((abs (var_1_19)) - (min (var_1_82 , var_1_38)));
						} else {
							var_1_27 = (var_1_16 - 16);
						}
					} else {
						var_1_27 = (min (-64 , var_1_24));
					}
				} else {
					var_1_27 = (var_1_26 + (max ((max (var_1_24 , var_1_18)) , var_1_16)));
				}
			}
		}
	}
	...
	// From: Req2Batch69Amount500
	if (var_1_15 <= (var_1_6 | (min (10 , var_1_82)))) {
		var_1_9 = (min (var_1_10 , var_1_11));
	} else {
		if (var_1_85) {
			if (var_1_6 < ((var_1_38 << var_1_98) + var_1_38)) {
				var_1_9 = (max (2.75f , var_1_10));
			} else {
				var_1_9 = var_1_11;
			}
		} else {
	...
	// From: Req19Batch69Amount500
	signed long int stepLocal_11 = min (var_1_15 , (abs (var_1_19)));
	if (stepLocal_11 < ((var_1_27 * var_1_96) << (var_1_56 + var_1_57))) {
		var_1_55 = var_1_16;
	}


	// From: Req37Batch69Amount500
	if (((max (var_1_12 , var_1_59)) - var_1_74) >= var_1_94) {
		if ((abs (abs (var_1_18))) <= (min (var_1_3 , var_1_97))) {
			if (var_1_56 < (min (var_1_45 , (2 * var_1_6)))) {
				if ((min (var_1_38 , var_1_3)) <= (var_1_29 | var_1_23)) {
					if (var_1_95 && (var_1_98 > var_1_20)) {
						if (var_1_50 <= (var_1_97 / var_1_17)) {
							var_1_89 = (min ((max (var_1_74 , (var_1_37 - 0.8))) , var_1_13));
						} else {
							var_1_89 = var_1_13;
						}
					}
	...
	if (stepLocal_6 == (var_1_29 % var_1_3)) {
		if (var_1_91) {
			if (stepLocal_5 == var_1_17) {
				var_1_44 = (((max (var_1_25 , var_1_45)) - (var_1_18 + var_1_39)) + var_1_17);
			}
		}
	} else {
		if (stepLocal_8 && (var_1_45 < (var_1_54 + var_1_41))) {
			...
			if (stepLocal_7 >= var_1_29) {
				...
				var_1_44 = ((25320 - (max (var_1_18 , var_1_41))) + ((var_1_39 + var_1_19) + var_1_17));
			}
		}
	}


	// From: Req1Batch69Amount500
	if (var_1_85 && ((var_1_3 - var_1_38) <= var_1_93)) {
		var_1_1 = ((max ((var_1_3 + var_1_38) , (var_1_6 - var_1_82))) + var_1_44);
	} else {
		var_1_1 = (max (var_1_3 , 100u));
	}


	// From: Req24Batch69Amount500
		...
		if (var_1_11 >= var_1_33) {
			if (stepLocal_17 || (var_1_51 <= 64)) {
				if (stepLocal_18 && var_1_85) {
					if (var_1_91) {
						var_1_67 = (var_1_14 + (max (var_1_13 , var_1_32)));
					}
				}
			} else {
				var_1_67 = (var_1_36 - (max (var_1_37 , (max (var_1_13 , var_1_35)))));
			}
		}
	} else {
		var_1_67 = (min (var_1_10 , 4.5));
	}


	// From: Req28Batch69Amount500
	...
	if (var_1_35 >= var_1_88) {
		...
		if (stepLocal_25 >= var_1_3) {
			if (var_1_70) {
				...
				var_1_77 = (max (var_1_78 , var_1_41));
			}
		} else {
			var_1_77 = (abs (var_1_41));
		}
	}


	// From: Req8Batch69Amount500
	unsigned char stepLocal_4 = var_1_38;
	if (var_1_69) {
		if (var_1_26 >= stepLocal_4) {
			var_1_31 = (min (var_1_14 , (var_1_32 + var_1_13)));
		} else {
			if ((var_1_14 / (min (var_1_33 , var_1_34))) > (7.5f * (var_1_11 * var_1_67))) {
				var_1_31 = 7.5f;
			} else {
		...
		if (var_1_91) {
			var_1_31 = ((max (var_1_12 , var_1_13)) - (var_1_14 + (var_1_36 - var_1_37)));
		} else {
			var_1_31 = (min ((var_1_36 - var_1_37) , var_1_11));
		}
	}


	// From: Req17Batch69Amount500
	if (var_1_13 < (- var_1_11)) {
		if ((var_1_39 | var_1_18) > var_1_20) {
			var_1_52 = ((var_1_53 - var_1_38) - (max (var_1_50 , (min (var_1_19 , var_1_49)))));
		}
	} else {
	...
	// From: Req15Batch69Amount500
	if ((last_1_var_1_48 / (abs (var_1_17))) >= (abs (var_1_52))) {
		if (var_1_85) {
			var_1_48 = (min (-2 , var_1_16));
		} else {
	...
	// From: Req11Batch69Amount500
	if ((var_1_36 - var_1_14) >= var_1_67) {
		if (var_1_3 >= ((64 * var_1_93) / var_1_24)) {
			var_1_42 = ((max ((var_1_41 - var_1_26) , (var_1_48 + var_1_19))) + var_1_44);
		}
	}


	// From: Req27Batch69Amount500
	if (var_1_48 <= (-16 >> var_1_52)) {
		var_1_75 = (abs (max (var_1_25 , var_1_56)));
	} else {
...
int property() {
	return ((((((((((((((((((((((((((((((((((((((((((((((var_1_85 && ((var_1_3 - var_1_38) <= var_1_93)) ? (var_1_1 == ((unsigned long int) ((max ((var_1_3 + var_1_38) , (var_1_6 - var_1_82))) + var_1_44))) : (var_1_1 == ((unsigned long int) (max (var_1_3 , 100u))))) && ((var_1_15 <= (var_1_6 | (min (10 , var_1_82)))) ? (var_1_9 == ((float) (min (var_1_10 , var_1_11)))) : (var_1_85 ? ((var_1_6 < ((var_1_38 << var_1_98) + var_1_38)) ? (var_1_9 == ((float) (max (2.75f , var_1_10)))) : (var_1_9 == ((float) var_1_11))) : (var_1_9 == ((float) (var_1_12 - ((24.625f + var_1_13) + var_1_14))))))) && ((var_1_10 != (- var_1_12)) ? (var_1_15 == ((signed char) ((max (var_1_16 , (var_1_17 - var_1_18))) - var_1_19))) : (var_1_15 == ((signed char) (var_1_18 + var_1_20))))) && (((60969 - var_1_19) < var_1_3) ? (var_1_91 ? (var_1_21 == ((signed short int) (abs (var_1_20)))) : (var_1_21 == ((signed short int) var_1_19))) : ((((var_1_93 / var_1_17) << var_1_6) < var_1_38) ? (var_1_21 == ((signed short int) var_1_20)) : (var_1_60 ? (var_1_21 == ((signed short int) (var_1_16 - (var_1_17 + (min (var_1_18 , 10)))))) : 1)))) && ((var_1_10 >= var_1_13) ? ((16.6 > var_1_14) ? (var_1_23 == ((unsigned short int) (var_1_24 - (var_1_25 - (var_1_26 - var_1_18))))) : 1) : 1)) && (var_1_60 ? ((var_1_38 <= var_1_23) ? (var_1_27 == ((signed long int) (var_1_24 + var_1_97))) : ((var_1_79 > (abs (var_1_79 + var_1_13))) ? (var_1_27 == ((signed long int) var_1_97)) : ((var_1_23 <= (- (abs (var_1_26)))) ? ((((abs (var_1_24)) <= var_1_16) && (var_1_3 <= var_1_82)) ? ((var_1_20 > var_1_6) ? (var_1_27 == ((signed long int) ((abs (var_1_19)) - (min (var_1_82 , var_1_38))))) : (var_1_27 == ((signed long int) (var_1_16 - 16)))) : (var_1_27 == ((signed long int) (min (-64 , var_1_24))))) : (var_1_27 == ((signed long int) (var_1_26 + (max ((max (var_1_24 , var_1_18)) , var_1_16)))))))) : 1)) && (var_1_29 == ((unsigned short int) ((min (var_1_24 , var_1_30)) - (var_1_25 - var_1_18))))) && (var_1_69 ? ((var_1_26 >= var_1_38) ? (var_1_31 == ((float) (min (var_1_14 , (var_1_32 + var_1_13))))) : (((var_1_14 / (min (var_1_33 , var_1_34))) > (7.5f * (var_1_11 * var_1_67))) ? (var_1_31 == ((float) 7.5f)) : (var_1_31 == ((float) (var_1_12 - (var_1_35 - var_1_14)))))) : (var_1_91 ? (var_1_31 == ((float) ((max (var_1_12 , var_1_13)) - (var_1_14 + (var_1_36 - var_1_37))))) : (var_1_31 == ((float) (min ((var_1_36 - var_1_37) , var_1_11))))))) && ((var_1_19 > (-100 * (var_1_20 / var_1_17))) ? ((last_1_var_1_69 || last_1_var_1_95) ? (var_1_38 == ((unsigned char) (abs (var_1_17)))) : (var_1_38 == ((unsigned char) (var_1_39 - var_1_17)))) : 1)) && (var_1_40 == ((signed char) (abs ((var_1_18 + var_1_41) - var_1_17))))) && (((var_1_36 - var_1_14) >= var_1_67) ? ((var_1_3 >= ((64 * var_1_93) / var_1_24)) ? (var_1_42 == ((signed short int) ((max ((var_1_41 - var_1_26) , (var_1_48 + var_1_19))) + var_1_44))) : 1) : 1)) && (var_1_43 == ((signed short int) var_1_93))) && ((var_1_26 == (var_1_29 % var_1_3)) ? (var_1_91 ? ((var_1_82 == var_1_17) ? (var_1_44 == ((unsigned short int) (((max (var_1_25 , var_1_45)) - (var_1_18 + var_1_39)) + var_1_17))) : 1) : 1) : (((var_1_13 > (var_1_58 * var_1_36)) && (var_1_45 < (var_1_54 + var_1_41))) ? ((var_1_37 <= var_1_10) ? (var_1_44 == ((unsigned short int) (var_1_24 - 256))) : 1) : ((var_1_24 >= var_1_29) ? (var_1_44 == ((unsigned short int) (var_1_30 - var_1_19))) : (var_1_44 == ((unsigned short int) ((25320 - (max (var_1_18 , var_1_41))) + ((var_1_39 + var_1_19) + var_1_17)))))))) && ((var_1_85 || (var_1_33 >= var_1_79)) ? (var_1_47 == ((signed short int) (var_1_19 - (abs (abs (var_1_39)))))) : (var_1_47 == ((signed short int) (abs (var_1_41)))))) && (((last_1_var_1_48 / (abs (var_1_17))) >= (abs (var_1_52))) ? (var_1_85 ? (var_1_48 == ((signed char) (min (-2 , var_1_16)))) : (var_1_48 == ((signed char) ((var_1_41 - var_1_18) + var_1_20)))) : ((var_1_12 >= var_1_10) ? (var_1_48 == ((signed char) (((var_1_49 + 10) - (var_1_50 + 25)) + var_1_18))) : 1))) && (((var_1_92 / 50) == var_1_20) ? (var_1_51 == ((signed char) var_1_50)) : 1)) && ((var_1_13 < (- var_1_11)) ? (((var_1_39 | var_1_18) > var_1_20) ? (var_1_52 == ((unsigned long int) ((var_1_53 - var_1_38) - (max (var_1_50 , (min (var_1_19 , var_1_49))))))) : 1) : ((var_1_23 >= var_1_29) ? ((var_1_53 <= var_1_77) ? (var_1_52 == ((unsigned long int) (var_1_23 + (last_1_var_1_52 + var_1_38)))) : (var_1_52 == ((unsigned long int) ((var_1_53 - (var_1_18 + var_1_39)) - (var_1_26 + last_1_var_1_52))))) : 1))) && ((last_1_var_1_87 == (var_1_34 / 999999.2f)) ? (var_1_54 == ((unsigned long int) ((var_1_25 + 64u) + var_1_6))) : 1)) && (((min (var_1_15 , (abs (var_1_19)))) < ((var_1_27 * var_1_96) << (var_1_56 + var_1_57))) ? (var_1_55 == ((signed short int) var_1_16)) : 1)) && (((var_1_80 % var_1_17) < (var_1_53 - var_1_23)) ? (var_1_58 == ((float) (((max (var_1_35 , var_1_59)) - (var_1_13 + var_1_37)) - var_1_14))) : (var_1_58 == ((float) (var_1_14 + var_1_36))))) && (((var_1_13 != var_1_59) || last_1_var_1_69) ? (last_1_var_1_69 ? (last_1_var_1_69 ? (var_1_60 == ((unsigned char) (last_1_var_1_60 && var_1_62))) : ((var_1_19 <= last_1_var_1_48) ? (var_1_60 == ((unsigned char) (var_1_62 || var_1_63))) : (var_1_60 == ((unsigned char) (last_1_var_1_60 && (var_1_62 && var_1_63)))))) : 1) : 1)) && (((var_1_98 > var_1_98) && (var_1_37 != 128.5f)) ? (var_1_64 == ((signed char) (var_1_19 - var_1_18))) : 1)) && (var_1_95 ? ((var_1_69 || var_1_63) ? (var_1_66 == ((unsigned short int) (var_1_26 + ((abs (var_1_45)) - var_1_19)))) : (var_1_66 == ((unsigned short int) (min ((max ((var_1_25 + var_1_17) , var_1_38)) , ((var_1_49 + var_1_39) + var_1_45)))))) : (var_1_66 == ((unsigned short int) (var_1_30 - (abs (var_1_45 - var_1_41))))))) && ((var_1_26 < var_1_1) ? ((var_1_11 >= var_1_33) ? (((var_1_18 < (var_1_49 - var_1_50)) || (var_1_51 <= 64)) ? (((var_1_13 < var_1_34) && var_1_85) ? (var_1_91 ? (var_1_67 == ((double) (var_1_14 + (max (var_1_13 , var_1_32))))) : 1) : 1) : (var_1_67 == ((double) (var_1_36 - (max (var_1_37 , (max (var_1_13 , var_1_35)))))))) : 1) : (var_1_67 == ((double) (min (var_1_10 , 4.5)))))) && ((last_1_var_1_93 == last_1_var_1_93) ? (var_1_69 == ((unsigned char) (! var_1_70))) : ((last_1_var_1_31 > var_1_35) ? ((last_1_var_1_27 >= -4) ? (var_1_69 == ((unsigned char) (((last_1_var_1_93 + var_1_53) != var_1_3) && var_1_62))) : ((var_1_25 > (var_1_56 / var_1_39)) ? (((var_1_19 == var_1_25) && (var_1_57 > (last_1_var_1_93 + last_1_var_1_27))) ? (var_1_69 == ((unsigned char) (var_1_70 && var_1_71))) : (var_1_69 == ((unsigned char) (! var_1_71)))) : (var_1_69 == ((unsigned char) (var_1_71 && (var_1_70 || var_1_72)))))) : 1))) && ((var_1_93 >= var_1_57) ? (var_1_73 == ((float) (max (var_1_14 , ((var_1_13 - var_1_36) + var_1_37))))) : (var_1_73 == ((float) (((var_1_36 + var_1_74) - var_1_37) - var_1_14))))) && ((var_1_48 <= (-16 >> var_1_52)) ? (var_1_75 == ((unsigned short int) (abs (max (var_1_25 , var_1_56))))) : (var_1_75 == ((unsigned short int) ((var_1_25 + var_1_76) - 128))))) && ((var_1_35 >= var_1_88) ? (var_1_77 == ((signed char) (abs (16)))) : ((var_1_44 >= var_1_3) ? (var_1_70 ? ((var_1_54 < (var_1_19 * var_1_17)) ? (var_1_77 == ((signed char) ((var_1_57 + 16) + var_1_56))) : ((var_1_79 < var_1_37) ? (var_1_77 == ((signed char) (-2 + (var_1_78 + (var_1_56 + var_1_57))))) : 1)) : (var_1_77 == ((signed char) (max (var_1_78 , var_1_41))))) : (var_1_77 == ((signed char) (abs (var_1_41))))))) && (var_1_79 == ((double) (((var_1_36 - var_1_13) + (64.25 + var_1_37)) - (var_1_14 + var_1_74))))) && (var_1_80 == ((unsigned short int) (var_1_24 - var_1_39)))) && (((var_1_10 * var_1_94) < var_1_34) ? (var_1_81 == ((signed char) (var_1_17 - var_1_50))) : (var_1_81 == ((signed char) (abs (var_1_50)))))) && ((var_1_93 > var_1_23) ? ((16u > (max (var_1_80 , var_1_38))) ? (var_1_82 == ((unsigned short int) var_1_38)) : (var_1_82 == ((unsigned short int) (var_1_41 + var_1_39)))) : (var_1_82 == ((unsigned short int) (max ((max (var_1_19 , var_1_66)) , (var_1_24 - var_1_26))))))) && (last_1_var_1_95 ? (var_1_85 == ((unsigned char) (! (var_1_70 && (var_1_71 && var_1_72))))) : 1)) && (var_1_86 == ((signed short int) (abs (var_1_50))))) && ((((max (var_1_39 , var_1_43)) & var_1_21) < (var_1_43 * var_1_3)) ? (var_1_87 == ((float) (min (var_1_11 , var_1_32)))) : 1)) && ((var_1_25 < var_1_98) ? (((- var_1_47) <= var_1_29) ? ((var_1_96 >= var_1_97) ? (var_1_88 == ((double) (max (var_1_13 , var_1_32)))) : 1) : (var_1_88 == ((double) var_1_36))) : (var_1_88 == ((double) (var_1_37 + var_1_36))))) && ((((max (var_1_12 , var_1_59)) - var_1_74) >= var_1_94) ? (((abs (abs (var_1_18))) <= (min (var_1_3 , var_1_97))) ? ((var_1_56 < (min (var_1_45 , (2 * var_1_6)))) ? (((min (var_1_38 , var_1_3)) <= (var_1_29 | var_1_23)) ? ((var_1_95 && (var_1_98 > var_1_20)) ? ((var_1_50 <= (var_1_97 / var_1_17)) ? (var_1_89 == ((double) (min ((max (var_1_74 , (var_1_37 - 0.8))) , var_1_13)))) : (var_1_89 == ((double) var_1_13))) : 1) : (var_1_89 == ((double) var_1_37))) : (var_1_89 == ((double) var_1_59))) : 1) : (var_1_89 == ((double) var_1_10)))) && (last_1_var_1_60 ? (var_1_91 == ((unsigned char) var_1_71)) : 1)) && (var_1_92 == ((signed char) var_1_57))) && (var_1_93 == ((unsigned short int) var_1_57))) && (var_1_94 == ((double) var_1_36))) && (var_1_85 ? (var_1_95 == ((unsigned char) var_1_70)) : (var_1_95 == ((unsigned char) var_1_63)))) && (var_1_91 ? (var_1_96 == ((unsigned long int) var_1_26)) : (var_1_96 == ((unsigned long int) var_1_39)))) && (var_1_60 ? (var_1_97 == ((unsigned long int) var_1_30)) : (var_1_97 == ((unsigned long int) var_1_99)))) && (var_1_69 ? (var_1_98 == ((unsigned long int) var_1_86)) : (var_1_98 == ((unsigned long int) var_1_19)))) && ((((var_1_49 >= var_1_80) || var_1_71) && var_1_91) ? (var_1_91 ? (((var_1_18 & (var_1_54 & var_1_80)) <= var_1_26) ? (var_1_99 == ((signed long int) var_1_57)) : 1) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
