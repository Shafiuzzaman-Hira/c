...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch37dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req5Batch37dependencies
	if (var_1_14) {
		if (last_1_var_1_13 <= var_1_9) {
			var_1_13 = var_1_9;
		} else {
			if ((min (last_1_var_1_17 , (var_1_2 * last_1_var_1_17))) == (var_1_3 + last_1_var_1_19)) {
				var_1_13 = 8.75;
			} else {
	...
	// From: Req6Batch37dependencies
	var_1_17 = (var_1_18 - var_1_3);


	// From: Req3Batch37dependencies
	if ((var_1_17 >= var_1_17) || (var_1_9 > last_1_var_1_10)) {
		var_1_10 = var_1_9;
	}


	// From: Req4Batch37dependencies
	...
	// From: Req2Batch37dependencies
	if ((var_1_19 / var_1_8) < (var_1_1 / (min (2 , var_1_2)))) {
		if (var_1_1 >= var_1_3) {
			var_1_7 = 0.75f;
		} else {
			var_1_7 = var_1_9;
