...
void step(void) {
	...
	// From: Req1Batch70dependencies
	if (var_1_18 >= (- (min (var_1_9 , var_1_9)))) {
	...
	// From: Req7Batch70dependencies
	if ((var_1_14 / var_1_19) <= (min (var_1_18 , var_1_14))) {
		var_1_20 = var_1_13;
	}


	// From: Req4Batch70dependencies
	if (var_1_20) {
		var_1_12 = var_1_13;
	}


	// From: Req3Batch70dependencies
