...
void step(void) {
	// From: Req3Batch97Filler_PE_CN
	if (var_1_9 > var_1_10) {
		var_1_8 = (min ((var_1_11 + (var_1_12 - var_1_13)) , (5 + var_1_14)));
	}


	// From: Req7Batch97Filler_PE_CN
	var_1_20 = var_1_8;


	// From: Req8Batch97Filler_PE_CN
	var_1_22 = var_1_23;


	// From: Req4Batch97Filler_PE_CN
	if (var_1_22) {
		var_1_15 = var_1_8;
	}


	// From: Req5Batch97Filler_PE_CN
	var_1_16 = ((min (var_1_15 , (max (var_1_13 , var_1_12)))) - var_1_11);


	// From: Req6Batch97Filler_PE_CN
	if (var_1_22) {
