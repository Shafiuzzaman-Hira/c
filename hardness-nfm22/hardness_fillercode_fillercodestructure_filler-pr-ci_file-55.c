...
void step(void) {
	...
	// From: CodeObject1
	if (var_1_1 > var_1_1) {
		if ((var_1_1 * (max (var_1_1 , var_1_8))) < (min (var_1_8 , 32.55f))) {
			if (var_1_8 > 24.443f) {
				var_1_32 = var_1_14;
			}
		}
	...
	// From: CodeObject3
	if (var_1_1 >= 127.5f) {
		if ((var_1_14 >> var_1_18) < (abs (-1))) {
			var_1_41 = ((abs (var_1_19)) + (var_1_28 - (2 + var_1_20)));
		} else {
			var_1_41 = var_1_19;
		}
	} else {
	...
	// From: CodeObject6
	if (var_1_1 < (max ((var_1_7 / 15.175f) , (- var_1_8)))) {
		var_1_49 = (! var_1_25);
	} else {
		if (var_1_25) {
	...
	// From: CodeObject5
	if (var_1_24) {
		var_1_47 = (var_1_18 + (max (var_1_12 , var_1_19)));
	}
