...
void step(void) {
	// From: Req3Batch17has_floats
	var_1_12 = last_1_var_1_15;


	// From: Req5Batch17has_floats
	...
	// From: Req1Batch17has_floats
	if (var_1_2) {
		var_1_1 = (var_1_3 + (min (var_1_4 , (49.5 + var_1_5))));
	}


	// From: Req2Batch17has_floats
