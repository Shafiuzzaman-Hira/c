...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch53Amount25.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_15 = ((((var_1_13) > (((((var_1_14) < (var_1_16)) ? (var_1_14) : (var_1_16))))) ? (var_1_13) : (((((var_1_14) < (var_1_16)) ? (var_1_14) : (var_1_16))))));
 if (var_1_2 >= var_1_1) {
  var_1_17 = (var_1_14 - ((((var_1_13) > (var_1_18)) ? (var_1_13) : (var_1_18))));
 }
 unsigned long int stepLocal_0 = (((var_1_4) < (var_1_3)) ? (var_1_4) : (var_1_3));
 if (((((var_1_1) < (var_1_5)) ? (var_1_1) : (var_1_5))) != stepLocal_0) {
