...
void step(void) {
 ...
 if (unsigned_long_int_Array_0[0] <= stepLocal_0) {
  unsigned_char_Array_0[1][2] = ((((unsigned_char_Array_0[0][2]) < (((unsigned_char_Array_0[1][1] - 8) + 5))) ? (unsigned_char_Array_0[0][2]) : (((unsigned_char_Array_0[1][1] - 8) + 5))));
 } else {
 ...
 if (unsigned_long_int_Array_0[0] < stepLocal_3) {
  if (BOOL_unsigned_char_Array_0[0] && stepLocal_2) {
   signed_short_int_Array_0[0] = (unsigned_char_Array_0[1][1] + (((((((unsigned_long_int_Array_0[0]) > (unsigned_char_Array_0[0][2])) ? (unsigned_long_int_Array_0[0]) : (unsigned_char_Array_0[0][2]))) < 0 ) ? -((((unsigned_long_int_Array_0[0]) > (unsigned_char_Array_0[0][2])) ? (unsigned_long_int_Array_0[0]) : (unsigned_char_Array_0[0][2]))) : ((((unsigned_long_int_Array_0[0]) > (unsigned_char_Array_0[0][2])) ? (unsigned_long_int_Array_0[0]) : (unsigned_char_Array_0[0][2]))))));
  } else {
