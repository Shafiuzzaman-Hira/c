...
void step(void) {
 ...
 if ((var_1_50 / var_1_28) < var_1_37) {
  ...
  if (var_1_29 > var_1_26) {
   ...
   var_1_52 = ((((var_1_27) < (((((((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28)))) > (((((var_1_42) > (var_1_38)) ? (var_1_42) : (var_1_38))))) ? (((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28)))) : (((((var_1_42) > (var_1_38)) ? (var_1_42) : (var_1_38)))))))) ? (var_1_27) : (((((((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28)))) > (((((var_1_42) > (var_1_38)) ? (var_1_42) : (var_1_38))))) ? (((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28)))) : (((((var_1_42) > (var_1_38)) ? (var_1_42) : (var_1_38)))))))));
  }
 }
 ...
 if (var_1_30 < 127.5f) {
  if ((- (var_1_31 + var_1_47)) > (var_1_30 + var_1_51)) {
   var_1_55 = ((((((((var_1_56 + 4.75f) < 0 ) ? -(var_1_56 + 4.75f) : (var_1_56 + 4.75f)))) > (var_1_32)) ? (((((var_1_56 + 4.75f) < 0 ) ? -(var_1_56 + 4.75f) : (var_1_56 + 4.75f)))) : (var_1_32)));
  }
 }
 if (var_1_43) {
  var_1_57 = var_1_34;
 }
 if ((var_1_42 % ((((var_1_27) > (var_1_37)) ? (var_1_27) : (var_1_37)))) < -4) {
  var_1_58 = (var_1_53 - (((((var_1_34) < (var_1_35)) ? (var_1_34) : (var_1_35))) + var_1_42));
 }
 if (((((((((var_1_49) < 0 ) ? -(var_1_49) : (var_1_49)))) < (var_1_60)) ? (((((var_1_49) < 0 ) ? -(var_1_49) : (var_1_49)))) : (var_1_60))) >= ((((var_1_41) > ((100.5 * var_1_31))) ? (var_1_41) : ((100.5 * var_1_31))))) {
  if (var_1_54 || (var_1_40 > 0.65f)) {
   var_1_59 = (((((((15.375) > (var_1_32)) ? (15.375) : (var_1_32))) < 0 ) ? -((((15.375) > (var_1_32)) ? (15.375) : (var_1_32))) : ((((15.375) > (var_1_32)) ? (15.375) : (var_1_32)))));
  } else {
   if ((var_1_28 != ((((-2) < 0 ) ? -(-2) : (-2)))) || (var_1_56 == var_1_49)) {
    var_1_59 = ((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30)));
   }
  }
 } else {
  var_1_59 = ((((((((var_1_31 - var_1_32)) > (var_1_30)) ? ((var_1_31 - var_1_32)) : (var_1_30))) < 0 ) ? -(((((var_1_31 - var_1_32)) > (var_1_30)) ? ((var_1_31 - var_1_32)) : (var_1_30))) : (((((var_1_31 - var_1_32)) > (var_1_30)) ? ((var_1_31 - var_1_32)) : (var_1_30)))));
 }
 if (var_1_36) {
  var_1_61 = var_1_31;
 } else {
  var_1_61 = (((((((var_1_32) > (var_1_30)) ? (var_1_32) : (var_1_30))) < 0 ) ? -((((var_1_32) > (var_1_30)) ? (var_1_32) : (var_1_30))) : ((((var_1_32) > (var_1_30)) ? (var_1_32) : (var_1_30)))));
 }
 var_1_62 = (! (var_1_44 || var_1_63));
 if ((((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) & -5) >= var_1_37) {
  if (1.000000000005E11f <= (var_1_25 * var_1_48)) {
   var_1_64 = -16;
  }
 }
 if (var_1_52 < (var_1_50 ^ var_1_57)) {
  if (var_1_56 > (((((var_1_49 * var_1_48)) < (var_1_55)) ? ((var_1_49 * var_1_48)) : (var_1_55)))) {
   var_1_65 = ((((((((var_1_35) > (var_1_33)) ? (var_1_35) : (var_1_33)))) < (var_1_57)) ? (((((var_1_35) > (var_1_33)) ? (var_1_35) : (var_1_33)))) : (var_1_57)));
  }
 } else {
  var_1_65 = ((((((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37)))) < ((var_1_66 - var_1_33))) ? (((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37)))) : ((var_1_66 - var_1_33))));
 }
 if (var_1_57 >= (var_1_68 - var_1_37)) {
  var_1_67 = (var_1_68 + 10000u);
 }
 if ((~ var_1_29) <= var_1_58) {
  if (((((((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32)))) < (9.875f)) ? (((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32)))) : (9.875f))) >= ((((var_1_60) > (((((var_1_61) < (var_1_56)) ? (var_1_61) : (var_1_56))))) ? (var_1_60) : (((((var_1_61) < (var_1_56)) ? (var_1_61) : (var_1_56))))))) {
   var_1_69 = ((var_1_70 + var_1_71) - ((((2) > ((5 + var_1_53))) ? (2) : ((5 + var_1_53)))));
  } else {
   if (var_1_30 <= var_1_49) {
    var_1_69 = (((((var_1_72 - 64) < 0 ) ? -(var_1_72 - 64) : (var_1_72 - 64))) - (var_1_71 - (var_1_73 - 64)));
   }
  }
 }
 if (var_1_28 >= ((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39)))) {
  if (var_1_41 <= var_1_75) {
   var_1_74 = ((((((26728) < (var_1_76)) ? (26728) : (var_1_76))) - var_1_37) - 256);
  } else {
   var_1_74 = var_1_57;
  }
 }
 if ((var_1_70 >> ((((var_1_79) < (16)) ? (var_1_79) : (16)))) != var_1_76) {
  var_1_77 = ((((var_1_38) < 0 ) ? -(var_1_38) : (var_1_38)));
 }
 ...
 if ((var_1_84 < ((((var_1_77) < 0 ) ? -(var_1_77) : (var_1_77)))) || var_1_43) {
  if (2.5 < var_1_59) {
   var_1_83 = (((((((var_1_53) < 0 ) ? -(var_1_53) : (var_1_53))) < 0 ) ? -((((var_1_53) < 0 ) ? -(var_1_53) : (var_1_53))) : ((((var_1_53) < 0 ) ? -(var_1_53) : (var_1_53)))));
  }
 } else {
  if (var_1_54) {
   var_1_83 = var_1_57;
