...
void step(void) {
	...
	// From: Req5Batch13Amount100
	if ((var_1_9 * (var_1_8 - 128)) < var_1_10) {
		var_1_20 = var_1_15;
	}


	// From: Req1Batch13Amount100
	if ((var_1_9 <= var_1_29) || var_1_22) {
		var_1_1 = 0;
	}


	// From: Req11Batch13Amount100
