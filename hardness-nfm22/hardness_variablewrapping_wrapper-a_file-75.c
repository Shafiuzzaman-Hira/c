...
void step(void) {
	...
	if (stepLocal_0 < (max (signed_char_Array_0[0] , signed_long_int_Array_0[0]))) {
	...
	if ((unsigned_char_Array_0[6] == (unsigned_char_Array_0[1] - unsigned_char_Array_0[5])) && BOOL_unsigned_char_Array_0[0]) {
		if (BOOL_unsigned_char_Array_0[0]) {
			unsigned_char_Array_0[0] = (max ((unsigned_char_Array_0[3] - unsigned_char_Array_0[5]) , unsigned_char_Array_0[2]));
		}
	} else {
