...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch32Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
 if (var_1_20 < ((((var_1_20) < ((var_1_23 >> var_1_29))) ? (var_1_20) : ((var_1_23 >> var_1_29))))) {
  if (var_1_20 > var_1_20) {
   var_1_25 = var_1_1;
  } else {
   if (((var_1_29 ^ var_1_23) >> var_1_20) > ((((var_1_20) < 0 ) ? -(var_1_20) : (var_1_20)))) {
    var_1_25 = ((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)));
   }
  }
 } else {
  if ((var_1_29 - var_1_1) <= (~ (var_1_32 - var_1_1))) {
   var_1_25 = ((((var_1_1) > (var_1_1)) ? (var_1_1) : (var_1_1)));
  } else {
   var_1_25 = -32;
  }
 }
 ...
 if ((((((var_1_22) < (var_1_37)) ? (var_1_22) : (var_1_37))) >= (var_1_38 / var_1_42)) || var_1_35) {
