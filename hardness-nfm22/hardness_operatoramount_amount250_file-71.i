...
void step(void) {
 if ((last_1_var_1_1 * var_1_34) >= var_1_51) {
  if (! (((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12))) >= (last_1_var_1_10 | last_1_var_1_1))) {
   if (var_1_8 < last_1_var_1_28) {
    if ((- (last_1_var_1_37 + last_1_var_1_43)) > (var_1_59 - var_1_56)) {
     var_1_58 = (last_1_var_1_1 + var_1_52);
    } else {
     var_1_58 = (((((var_1_52 - ((((var_1_47) > (var_1_44)) ? (var_1_47) : (var_1_44))))) < (((((var_1_25) > (last_1_var_1_10)) ? (var_1_25) : (last_1_var_1_10))))) ? ((var_1_52 - ((((var_1_47) > (var_1_44)) ? (var_1_47) : (var_1_44))))) : (((((var_1_25) > (last_1_var_1_10)) ? (var_1_25) : (last_1_var_1_10))))));
    }
   } else {
    if (var_1_55 > 2u) {
 ...
 if (stepLocal_7 <= (var_1_34 - var_1_14)) {
  if ((((((var_1_14 * var_1_15)) < ((var_1_10 - var_1_5))) ? ((var_1_14 * var_1_15)) : ((var_1_10 - var_1_5)))) <= stepLocal_6) {
   var_1_33 = var_1_8;
  } else {
   var_1_33 = (((((var_1_7 + var_1_32)) > ((var_1_35 - var_1_31))) ? ((var_1_7 + var_1_32)) : ((var_1_35 - var_1_31))));
  }
 }
 ...
 signed long int stepLocal_5 = ((((((var_1_15) < (var_1_12)) ? (var_1_15) : (var_1_12))) < 0 ) ? -((((var_1_15) < (var_1_12)) ? (var_1_15) : (var_1_12))) : ((((var_1_15) < (var_1_12)) ? (var_1_15) : (var_1_12))));
 if (stepLocal_5 <= var_1_23) {
  var_1_28 = var_1_8;
 }
 var_1_37 = (((var_1_15 + 4) + var_1_14) - var_1_13);
 if (var_1_20) {
  var_1_38 = ((((99.25f) < 0 ) ? -(99.25f) : (99.25f)));
 } else {
 ...
 if (! var_1_18) {
  if (var_1_19) {
   ...
   var_1_39 = ((((var_1_15) > (var_1_13)) ? (var_1_15) : (var_1_13)));
  }
 } else {
  var_1_39 = 8;
 }
 if ((var_1_38 != 49.5) || var_1_16) {
  var_1_26 = (((((var_1_7 - var_1_27)) > (var_1_9)) ? ((var_1_7 - var_1_27)) : (var_1_9)));
 }
 if (var_1_6 <= (((((var_1_9) < (var_1_7)) ? (var_1_9) : (var_1_7))) * (- var_1_38))) {
  var_1_29 = ((((((var_1_30 - var_1_7) - (var_1_31 + var_1_32))) < (var_1_27)) ? (((var_1_30 - var_1_7) - (var_1_31 + var_1_32))) : (var_1_27)));
 } else {
  var_1_29 = (var_1_7 + (var_1_32 - var_1_31));
 }
 unsigned char stepLocal_8 = var_1_30 >= var_1_35;
 if ((var_1_38 + var_1_29) <= var_1_6) {
  var_1_43 = ((((((var_1_44) < (var_1_45)) ? (var_1_44) : (var_1_45))) - var_1_13) - var_1_15);
 } else {
 ...
 if ((var_1_16 || (var_1_1 > var_1_52)) && stepLocal_13) {
  var_1_60 = (var_1_47 + ((((var_1_37) < (var_1_49)) ? (var_1_37) : (var_1_49))));
 } else {
  if (var_1_16) {
   var_1_60 = var_1_13;
  }
 ...
 if (var_1_30 >= (var_1_27 / 15.4)) {
  ...
  if (stepLocal_12 < ((var_1_54 - var_1_60) - var_1_5)) {
   if (var_1_16) {
    ...
    var_1_53 = (((((var_1_15 + (var_1_58 + var_1_5))) > (2u)) ? ((var_1_15 + (var_1_58 + var_1_5))) : (2u)));
   }
  } else {
   var_1_53 = (((((var_1_49 + (var_1_52 + var_1_44))) > (var_1_39)) ? ((var_1_49 + (var_1_52 + var_1_44))) : (var_1_39)));
  }
 }
 ...
 if ((var_1_13 / var_1_14) >= var_1_58) {
  var_1_40 = ((var_1_15 - var_1_13) + ((((var_1_25 + var_1_41) < 0 ) ? -(var_1_25 + var_1_41) : (var_1_25 + var_1_41))));
 } else {
 ...
 signed long int stepLocal_9 = var_1_41 / ((((var_1_23) > (32)) ? (var_1_23) : (32)));
