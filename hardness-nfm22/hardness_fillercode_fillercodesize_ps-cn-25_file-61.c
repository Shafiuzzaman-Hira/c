...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch61PS_CN_25.c", 13, "reach_error"); }
...
float var_1_35 = 127.432;
float var_1_36 = 16.7;
float var_1_37 = 99.75;
float var_1_38 = 10.6;
float var_1_39 = 255.6;
float var_1_40 = 4.25;
float var_1_41 = 1.75;
...
void step(void) {
	...
	// From: CodeObject5
	if (var_1_34) {
		var_1_33 = (var_1_35 + (max (var_1_36 , (abs (var_1_37)))));
	} else {
		var_1_33 = (abs ((min (var_1_38 , var_1_39)) - var_1_40));
	}


	// From: CodeObject6
	if ((var_1_27 + (var_1_26 + var_1_25)) > (min (256u , var_1_32))) {
		var_1_41 = var_1_35;
	} else {
		var_1_41 = var_1_36;
	}
	...
	// From: Req7Batch61PS_CN_25
	var_1_21 = var_1_6;


	// From: Req8Batch61PS_CN_25
	var_1_22 = var_1_23;


	// From: Req1Batch61PS_CN_25
	if ((var_1_21 / (abs (64u))) == var_1_4) {
		var_1_1 = (8.8 - 255.2);
	}


	// From: Req4Batch61PS_CN_25
