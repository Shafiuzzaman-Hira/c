...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch74Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((~ (var_1_11 % 200u)) < 32u) {
  var_1_25 = (64 - var_1_27);
 }
 if (var_1_1 > var_1_11) {
  var_1_28 = ((((4.2f) < (1.25f)) ? (4.2f) : (1.25f)));
 }
 if ((~ (5 + var_1_11)) >= 10000u) {
  var_1_29 = (((((var_1_11 + var_1_27)) > (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))))) ? ((var_1_11 + var_1_27)) : (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))))));
 } else {
  var_1_29 = ((((((((((var_1_11) > (var_1_11)) ? (var_1_11) : (var_1_11))) < 0 ) ? -((((var_1_11) > (var_1_11)) ? (var_1_11) : (var_1_11))) : ((((var_1_11) > (var_1_11)) ? (var_1_11) : (var_1_11))))) < 0 ) ? -(((((((var_1_11) > (var_1_11)) ? (var_1_11) : (var_1_11))) < 0 ) ? -((((var_1_11) > (var_1_11)) ? (var_1_11) : (var_1_11))) : ((((var_1_11) > (var_1_11)) ? (var_1_11) : (var_1_11))))) : (((((((var_1_11) > (var_1_11)) ? (var_1_11) : (var_1_11))) < 0 ) ? -((((var_1_11) > (var_1_11)) ? (var_1_11) : (var_1_11))) : ((((var_1_11) > (var_1_11)) ? (var_1_11) : (var_1_11)))))));
 }
 var_1_31 = var_1_27;
 if (var_1_11 <= ((((var_1_27) < ((var_1_11 | -5))) ? (var_1_27) : ((var_1_11 | -5))))) {
  if (var_1_8) {
   var_1_32 = var_1_27;
  }
 }
 if (((((var_1_11) < (var_1_27)) ? (var_1_11) : (var_1_27))) <= var_1_11) {
  if (var_1_8) {
   if (var_1_8 || var_1_8) {
    if (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))) > var_1_27) {
     var_1_34 = var_1_11;
    }
   }
  }
 } else {
  if (((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))) > var_1_11) {
   if (var_1_24 > 49.75f) {
    var_1_34 = (((((((((((var_1_1) < (var_1_1)) ? (var_1_1) : (var_1_1)))) < (-25)) ? (((((var_1_1) < (var_1_1)) ? (var_1_1) : (var_1_1)))) : (-25))) < 0 ) ? -((((((((var_1_1) < (var_1_1)) ? (var_1_1) : (var_1_1)))) < (-25)) ? (((((var_1_1) < (var_1_1)) ? (var_1_1) : (var_1_1)))) : (-25))) : ((((((((var_1_1) < (var_1_1)) ? (var_1_1) : (var_1_1)))) < (-25)) ? (((((var_1_1) < (var_1_1)) ? (var_1_1) : (var_1_1)))) : (-25)))));
   }
  } else {
   var_1_34 = var_1_11;
  }
