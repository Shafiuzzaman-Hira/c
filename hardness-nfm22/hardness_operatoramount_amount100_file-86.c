...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch86Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req11Batch86Amount100
	var_1_31 = var_1_8;


	// From: Req12Batch86Amount100
	var_1_32 = 0;


	// From: Req5Batch86Amount100
	if (var_1_13) {
		if (var_1_32) {
