...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch48dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch48dependencies
	if (var_1_10 == (max ((var_1_15 - var_1_16) , var_1_12))) {
	...
	// From: Req4Batch48dependencies
	if (var_1_2) {
		var_1_13 = var_1_11;
	}


	// From: Req6Batch48dependencies
	if (var_1_8 == var_1_13) {
