...
void step(void) {
	...
	if (var_1_27 <= var_1_16) {
		if ((var_1_13 | (abs (var_1_31))) >= (var_1_12 + var_1_12)) {
			var_1_30 = (abs (abs (var_1_33)));
		}
	} else {
	...
	// From: CodeObject5
	if (32u >= ((max (var_1_13 , var_1_6)) % 16u)) {
		if ((-5 > var_1_31) && (var_1_23 <= (max (var_1_34 , var_1_13)))) {
			var_1_39 = var_1_27;
		} else {
		...
		if (! var_1_21) {
			var_1_39 = (max (var_1_27 , (abs (var_1_40))));
		}
	}


	// From: CodeObject6
	var_1_41 = (min ((abs (var_1_27)) , var_1_40));
	...
	// From: Req6Batch35Filler_PS_CO
	var_1_16 = (abs ((var_1_17 + var_1_18) + (min (var_1_19 , var_1_20))));


	// From: Req7Batch35Filler_PS_CO
