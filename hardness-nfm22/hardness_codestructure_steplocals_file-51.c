...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch51stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch51stepLocals
	if ((min ((~ var_1_1) , 8)) > var_1_11) {
		var_1_17 = var_1_18;
	}


	// From: Req5Batch51stepLocals
	unsigned char stepLocal_3 = (max (var_1_4 , var_1_6)) > var_1_18;
