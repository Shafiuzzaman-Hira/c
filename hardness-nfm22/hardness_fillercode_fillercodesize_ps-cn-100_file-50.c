...
void step(void) {
	...
	// From: CodeObject2
	if (var_1_35 >= (abs (var_1_32 % var_1_37))) {
		var_1_36 = var_1_33;
	}


	// From: CodeObject3
	if ((abs (var_1_31)) == (var_1_33 * (var_1_36 >> var_1_32))) {
		var_1_38 = (max ((min (var_1_31 , var_1_32)) , 32));
	}
	...
	// From: CodeObject5
	if (((var_1_36 * var_1_37) / (abs (5))) < (~ var_1_33)) {
	...
	// From: CodeObject7
	if ((- var_1_39) >= 24.875) {
		var_1_47 = (abs (min (var_1_35 , var_1_34)));
	}


	// From: CodeObject8
	if ((var_1_43 < var_1_42) && (var_1_32 < (var_1_31 % var_1_37))) {
		var_1_48 = (max ((abs (var_1_41)) , (var_1_49 + var_1_50)));
	}


	// From: CodeObject9
	if ((abs (var_1_49)) < var_1_48) {
		if (var_1_38 > (var_1_33 ^ var_1_35)) {
			if (! var_1_40) {
				if (var_1_44) {
					if (var_1_47 <= (var_1_52 - var_1_53)) {
						var_1_51 = (((min (var_1_54 , var_1_55)) + var_1_56) - var_1_57);
					} else {
						var_1_51 = var_1_55;
					}
				} else {
					if ((var_1_55 & var_1_38) < var_1_56) {
						var_1_51 = (max (var_1_47 , var_1_37));
					} else {
	...
	// From: Req3Batch50PS_CN_100
	if (var_1_8) {
		var_1_13 = (min ((var_1_14 + var_1_15) , (min (-0.2f , var_1_16))));
	}


	// From: Req6Batch50PS_CN_100
	if (var_1_8) {
		var_1_25 = (var_1_26 + var_1_27);
	}


	// From: Req8Batch50PS_CN_100
	var_1_29 = var_1_27;


	// From: Req9Batch50PS_CN_100
	var_1_30 = var_1_8;


	// From: Req2Batch50PS_CN_100
	...
	// From: Req4Batch50PS_CN_100
	var_1_17 = ((var_1_18 - 25) - var_1_25);


	// From: Req5Batch50PS_CN_100
