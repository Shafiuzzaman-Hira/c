...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch74dependencies.c", 13, "reach_error"); }
...
void step(void) {
 if (last_1_var_1_11 < last_1_var_1_1) {
  if (last_1_var_1_1 <= last_1_var_1_11) {
