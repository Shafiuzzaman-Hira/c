...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch16Amount500.c", 13, "reach_error"); }
...
signed char var_1_108 = -16;
unsigned short int var_1_109 = 4;
signed char var_1_110 = 10;
signed char var_1_111 = 1;
signed char var_1_112 = -25;
float var_1_113 = 32.2;
float var_1_114 = 4.8;
unsigned short int var_1_115 = 128;
float var_1_116 = 255.125;
unsigned char var_1_117 = 0;
unsigned char var_1_118 = 0;
unsigned long int var_1_119 = 256;
signed long int var_1_120 = 10;
signed long int var_1_121 = -16;
unsigned short int var_1_122 = 5;
unsigned long int var_1_123 = 500;
unsigned short int var_1_124 = 32;
unsigned char var_1_125 = 64;
unsigned char var_1_126 = 1;
signed char var_1_127 = -16;
unsigned char var_1_128 = 1;

// Calibration values

// Last'ed variables
unsigned short int last_1_var_1_14 = 10;
...
float last_1_var_1_51 = 10.25;
unsigned char last_1_var_1_52 = 4;
signed char last_1_var_1_56 = 4;
double last_1_var_1_58 = 10.5;
signed char last_1_var_1_61 = 0;
double last_1_var_1_64 = 5.5;
float last_1_var_1_67 = 32.8;
unsigned char last_1_var_1_72 = 0;
unsigned short int last_1_var_1_77 = 1;
...
unsigned short int last_1_var_1_94 = 10;
unsigned char last_1_var_1_98 = 0;
signed short int last_1_var_1_106 = 25;
unsigned short int last_1_var_1_109 = 4;
float last_1_var_1_114 = 4.8;
unsigned short int last_1_var_1_115 = 128;
unsigned long int last_1_var_1_119 = 256;
signed long int last_1_var_1_121 = -16;
unsigned char last_1_var_1_125 = 64;
unsigned char last_1_var_1_126 = 1;
signed char last_1_var_1_127 = -16;
...
void step(void) {
	...
	if (var_1_66) {
		if ((last_1_var_1_119 * (last_1_var_1_106 | -10)) > last_1_var_1_29) {
			var_1_113 = (max (var_1_38 , var_1_23));
		} else {
			var_1_113 = ((max (var_1_45 , var_1_44)) + var_1_38);
		}
	} else {
		if ((var_1_43 * (- last_1_var_1_58)) == (last_1_var_1_67 / (abs (15.25)))) {
			var_1_113 = (var_1_37 - var_1_45);
		}
	}


	// From: Req13Batch16Amount500
	if ((last_1_var_1_114 / var_1_43) >= last_1_var_1_58) {
		if ((var_1_20 >= last_1_var_1_47) || last_1_var_1_83) {
	...
	signed long int stepLocal_21 = last_1_var_1_32;
	if ((last_1_var_1_80 * (last_1_var_1_121 / var_1_15)) >= stepLocal_21) {
		if (! last_1_var_1_91) {
			var_1_128 = (var_1_66 || (var_1_88 || var_1_92));
		} else {
			var_1_128 = 0;
		}
	} else {
	...
	if (var_1_85) {
		if (last_1_var_1_127 == var_1_54) {
			var_1_89 = (! var_1_86);
		}
	} else {
		if ((max ((last_1_var_1_115 & var_1_53) , last_1_var_1_125)) >= last_1_var_1_98) {
			var_1_89 = (var_1_84 && var_1_86);
		}
	}
	...
	if (last_1_var_1_51 >= (last_1_var_1_64 + last_1_var_1_58)) {
		var_1_58 = var_1_24;
	} else {
		if ((max (var_1_15 , last_1_var_1_52)) > (min (var_1_31 , (max (last_1_var_1_14 , 100))))) {
	...
	signed long int stepLocal_3 = last_1_var_1_47;
	signed long int stepLocal_2 = last_1_var_1_126 / var_1_15;
	if (stepLocal_3 == ((last_1_var_1_56 & last_1_var_1_32) + last_1_var_1_32)) {
		if (stepLocal_2 < var_1_16) {
			var_1_32 = (((max (var_1_28 , var_1_34)) - var_1_20) - last_1_var_1_47);
		}
	}
	...
	var_1_78 = (var_1_49 - (min (var_1_53 , var_1_55)));


	// From: Req35Batch16Amount500
	var_1_97 = (var_1_23 - (var_1_38 + (abs (var_1_44))));


	// From: Req40Batch16Amount500
	var_1_108 = ((max ((25 - var_1_55) , -50)) + (10 - var_1_103));


	// From: Req41Batch16Amount500
	if ((var_1_49 - (min (var_1_53 , var_1_105))) >= last_1_var_1_109) {
		var_1_109 = var_1_20;
	}
	...
	signed long int stepLocal_16 = var_1_53 - var_1_54;
	if (var_1_51 > ((var_1_102 - var_1_23) - var_1_43)) {
		var_1_101 = (min (var_1_57 , ((var_1_55 - var_1_103) + var_1_104)));
	} else {
		if ((var_1_68 + var_1_43) > var_1_113) {
			if (stepLocal_16 <= (var_1_108 - (var_1_124 + var_1_125))) {
				var_1_101 = ((var_1_105 - var_1_103) - var_1_63);
			}
		}
	}
	...
	unsigned char stepLocal_10 = var_1_128;
	if (var_1_128 || stepLocal_10) {
		var_1_72 = var_1_66;
	} else {
		var_1_72 = (var_1_117 && var_1_66);
	}
	...
	if (var_1_65) {
		var_1_46 = (max (var_1_47 , var_1_20));
	}


	// From: Req20Batch16Amount500
	unsigned char stepLocal_8 = var_1_54;
	if ((99.2f / var_1_43) > last_1_var_1_67) {
		if ((var_1_46 >> var_1_124) >= stepLocal_8) {
			var_1_67 = (min (var_1_68 , var_1_12));
		} else {
			var_1_67 = (abs (max (var_1_23 , var_1_44)));
		}
	}
	...
	if ((var_1_45 / var_1_43) == var_1_58) {
		if (var_1_127 > stepLocal_20) {
			var_1_114 = (min ((var_1_45 + var_1_39) , var_1_24));
		} else {
			if (var_1_72) {
				var_1_114 = (max ((max (var_1_68 , var_1_44)) , 2.625f));
			}
		}
	}
	...
	if (var_1_117) {
		var_1_35 = (max (var_1_118 , var_1_20));
	} else {
		var_1_35 = var_1_20;
	}
	...
	if (var_1_108 <= ((min (var_1_118 , 16)) - var_1_118)) {
	...
	if ((var_1_32 + (var_1_15 - var_1_125)) >= ((var_1_16 + var_1_17) - (max (var_1_78 , var_1_46)))) {
		var_1_14 = var_1_125;
	} else {
	...
	signed long int stepLocal_9 = var_1_28;
	if (stepLocal_9 >= (min (var_1_46 , var_1_125))) {
		var_1_70 = (max (var_1_49 , var_1_53));
	}


	// From: Req36Batch16Amount500
	if (var_1_123 <= var_1_32) {
		var_1_98 = var_1_50;
	}


	// From: Req18Batch16Amount500
	unsigned short int stepLocal_7 = var_1_109;
	...
	if (var_1_36 <= var_1_67) {
		var_1_91 = (! ((var_1_88 || var_1_66) || var_1_92));
	} else {
		if (var_1_89) {
			var_1_91 = ((var_1_76 <= var_1_28) && var_1_92);
		}
	}
	...
	if (var_1_109 == var_1_124) {
		if (var_1_63 >= (var_1_56 * (var_1_54 - 1))) {
			if (var_1_123 <= var_1_35) {
				var_1_79 = (max (last_1_var_1_79 , 10000));
			} else {
				var_1_79 = (var_1_122 - 256);
			}
		} else {
			var_1_79 = (var_1_126 - var_1_109);
		}
	} else {
		var_1_79 = ((var_1_50 + var_1_20) + last_1_var_1_79);
	}


	// From: Req37Batch16Amount500
	unsigned long int stepLocal_15 = (var_1_120 % var_1_34) * (min (4u , var_1_115));
	signed long int stepLocal_14 = -64;
	if (stepLocal_14 > var_1_127) {
		if (! var_1_117) {
			if (((min (var_1_125 , var_1_32)) * var_1_35) > stepLocal_15) {
				var_1_99 = (max (var_1_78 , var_1_79));
			}
		} else {
			var_1_99 = (var_1_54 + var_1_127);
		}
	} else {
		var_1_99 = (max (var_1_53 , (var_1_98 - var_1_125)));
	}


	// From: Req14Batch16Amount500
	if (var_1_113 >= (31.5 / var_1_43)) {
		if (var_1_91) {
	...
	if (var_1_56 < var_1_98) {
		if (var_1_72 && var_1_91) {
			var_1_80 = (min ((var_1_82 - var_1_28) , var_1_54));
		} else {
			var_1_80 = (var_1_98 + var_1_34);
		}
	} else {
		var_1_80 = (var_1_82 - var_1_20);
	}


	// From: Req1Batch16Amount500
	unsigned long int stepLocal_0 = var_1_78 * (10u * var_1_69);
	if (var_1_99 >= stepLocal_0) {
		var_1_1 = ((var_1_127 + -25) + (min (var_1_125 , var_1_78)));
	} else {
		var_1_1 = (var_1_127 + (var_1_118 + -2));
	}


	// From: Req6Batch16Amount500
	if (var_1_70 <= ((-16 / var_1_31) & var_1_125)) {
		if (var_1_80 < var_1_125) {
			var_1_29 = (max ((var_1_47 + (1u + var_1_15)) , (min (10000u , (var_1_32 + var_1_17)))));
		}
	}
	...
	if ((var_1_12 - (9.3 + var_1_22)) < (var_1_13 - (var_1_23 + var_1_24))) {
		if (var_1_65) {
			var_1_21 = (min ((var_1_20 - var_1_120) , var_1_69));
		}
	} else {
		var_1_21 = ((abs (var_1_52)) + var_1_108);
	}


	// From: Req25Batch16Amount500
	if (var_1_117) {
		var_1_75 = (var_1_20 - (min (var_1_1 , (var_1_76 - var_1_55))));
	} else {
		var_1_75 = (var_1_20 - ((min (var_1_119 , 5)) + var_1_121));
	}


	// From: Req39Batch16Amount500
	signed char stepLocal_18 = var_1_103;
	signed long int stepLocal_17 = var_1_53 + var_1_50;
	if (var_1_24 >= (var_1_12 / (min (2.75 , var_1_43)))) {
		if (var_1_75 != stepLocal_17) {
			var_1_106 = ((min (var_1_75 , (var_1_55 + var_1_50))) + (var_1_101 - var_1_105));
		} else {
			var_1_106 = (var_1_69 - var_1_55);
		}
	} else {
		if (stepLocal_18 > var_1_105) {
			var_1_106 = (min (var_1_101 , var_1_69));
		} else {
			var_1_106 = (var_1_54 - (var_1_103 + var_1_105));
		}
	}


	// From: Req24Batch16Amount500
	if ((var_1_51 + var_1_45) > (- (var_1_9 * var_1_58))) {
		if ((max (var_1_56 , var_1_120)) <= var_1_75) {
			var_1_73 = (max ((var_1_49 + var_1_1) , var_1_56));
		} else {
			var_1_73 = (max ((4 + (max (var_1_62 , var_1_69))) , (var_1_115 + (max (var_1_125 , var_1_54)))));
		}
	} else {
		var_1_73 = (abs (var_1_47 + var_1_125));
	}


	// From: Req34Batch16Amount500
	signed long int stepLocal_13 = var_1_75 | var_1_121;
	if ((var_1_52 | last_1_var_1_94) <= stepLocal_13) {
		var_1_94 = (var_1_52 + (var_1_73 + var_1_63));
	} else {
		if (((var_1_49 ^ last_1_var_1_94) % (var_1_82 - var_1_76)) < last_1_var_1_94) {
			var_1_94 = (var_1_52 + (var_1_55 + var_1_79));
		} else {
			var_1_94 = (var_1_20 - (min ((var_1_76 - 10) , var_1_49)));
		}
	}


	// From: Req42Batch16Amount500
	signed short int stepLocal_19 = var_1_106;
	if (var_1_128) {
		var_1_110 = ((min (var_1_103 , var_1_55)) + (max (var_1_104 , (max (var_1_111 , -4)))));
	} else {
		if (stepLocal_19 >= var_1_108) {
			var_1_110 = ((var_1_55 + var_1_112) + -8);
		}
	}


	// From: Req17Batch16Amount500
	unsigned short int stepLocal_6 = var_1_94;
	if (last_1_var_1_61 <= stepLocal_6) {
		var_1_61 = ((max (var_1_55 , (abs (var_1_62)))) - var_1_63);
	}


	// From: Req5Batch16Amount500
	unsigned char stepLocal_1 = var_1_125 == var_1_125;
	if (var_1_128) {
		if (stepLocal_1 && var_1_117) {
			var_1_26 = ((min ((max (var_1_61 , var_1_110)) , var_1_52)) + var_1_20);
		} else {
			var_1_26 = (var_1_20 - ((var_1_28 - var_1_80) - var_1_125));
		}
	} else {
		var_1_26 = var_1_61;
	}
	...
	if (var_1_65) {
		if (var_1_110 > last_1_var_1_77) {
			var_1_77 = (var_1_20 - var_1_55);
		} else {
			var_1_77 = (var_1_110 + var_1_48);
		}
	} else {
		if ((32 % var_1_42) <= var_1_125) {
			var_1_77 = (var_1_20 - var_1_55);
		} else {
	...
	if (var_1_26 >= ((- var_1_15) + var_1_14)) {
		var_1_87 = ((! (var_1_66 || var_1_86)) || var_1_88);
	} else {
		var_1_87 = var_1_85;
	}
	...
	signed long int stepLocal_12 = var_1_127 + var_1_61;
	unsigned char stepLocal_11 = var_1_31 > (var_1_125 / var_1_42);
	if ((-2 / -50) != stepLocal_12) {
		if (var_1_65) {
			var_1_83 = ((var_1_91 || var_1_84) && var_1_85);
		} else {
			var_1_83 = (var_1_89 || var_1_84);
		}
	} else {
		if (stepLocal_11 || ((min (var_1_121 , var_1_73)) > var_1_79)) {
			var_1_83 = ((var_1_84 || var_1_85) && var_1_86);
		}
	}


	// From: Req10Batch16Amount500
	unsigned char stepLocal_5 = var_1_83;
	signed long int stepLocal_4 = (var_1_78 - var_1_47) % var_1_42;
	if (((last_1_var_1_40 < var_1_13) || var_1_72) || stepLocal_5) {
...
void updateVariables() {
	...
	assume_abort_if_not((var_1_44 >= 0.0F && var_1_44 <= -1.0e-20F) || (var_1_44 <= 2305843.009213691390e+12F && var_1_44 >= 1.0e-20F ));
	...
	assume_abort_if_not((var_1_102 >= 4611686.018427387900e+12F && var_1_102 <= -1.0e-20F) || (var_1_102 <= 9223372.036854776000e+12F && var_1_102 >= 1.0e-20F ));
	...
	assume_abort_if_not(var_1_105 >= 62);
	...
	assume_abort_if_not(var_1_112 >= -31);
	assume_abort_if_not(var_1_112 <= 31);
}
