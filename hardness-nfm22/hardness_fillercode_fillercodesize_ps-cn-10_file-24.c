...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch24PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject5
	if (-8 > (max ((var_1_35 - var_1_36) , var_1_29))) {
		var_1_33 = var_1_32;
	}


	// From: Req2Batch24PS_CN_10
	...
	// From: Req6Batch24PS_CN_10
	var_1_23 = var_1_24;


	// From: Req3Batch24PS_CN_10
	if (128u >= var_1_8) {
		if (! var_1_23) {
