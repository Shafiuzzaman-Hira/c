...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch64PS_CN_25.c", 13, "reach_error"); }
...
signed long int var_1_41 = -1629823998;
...
void step(void) {
	...
	// From: CodeObject5
	var_1_40 = ((abs (var_1_32)) - ((abs (var_1_41)) - var_1_42));


	// From: CodeObject6
	if ((var_1_41 | 25) > var_1_31) {
		var_1_43 = var_1_37;
	}


	// From: Req4Batch64PS_CN_25
	var_1_19 = ((var_1_20 - var_1_21) - var_1_22);


	// From: Req6Batch64PS_CN_25
