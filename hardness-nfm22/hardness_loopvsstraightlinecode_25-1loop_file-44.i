...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch4425_1loop.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_2 != ((var_1_1 * var_1_8) / ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14))))) {
  var_1_17 = var_1_11;
 } else {
  var_1_17 = var_1_7;
 }
