...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch9625_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch9625_1loop
	var_1_14 = var_1_12;


	// From: Req5Batch9625_1loop
	var_1_15 = var_1_16;


	// From: Req1Batch9625_1loop
	if (! var_1_5) {
