...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch80Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch80Wrapper_AP
	(*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)) = (*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer));


	// From: Req2Batch80Wrapper_AP
	unsigned char stepLocal_0 = (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) <= (*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer));
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer)) || stepLocal_0) {
		(*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) = (abs (1 - (*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer))));
	} else {
		(*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) = (*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer));
	}


	// From: Req3Batch80Wrapper_AP
	signed short int stepLocal_1 = (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer));
	if (stepLocal_1 <= ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) / (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)))) {
		(*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer)) = (min ((max ((min ((*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)) , (*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer)))) , (*(double_Array_0_arraydouble_Array_0arrayVar6_Pointer)))) , (max (3.6 , (*(double_Array_0_arraydouble_Array_0arrayVar7_Pointer))))));
	} else {
		(*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer)) = ((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) - (*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)));
	}


	// From: Req1Batch80Wrapper_AP
	if ((max (((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) - (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer))) , (*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)))) <= (min (((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) - (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer))) , ((*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)) % (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)))))) {
		(*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)) = (min (((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) - (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer))) , (*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer))));
	}
}
