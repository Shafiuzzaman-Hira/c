...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch7550_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch7550_while
	if (! (var_1_4 < 16.8f)) {
		var_1_15 = var_1_6;
	}


	// From: Req7Batch7550_while
	var_1_25 = var_1_23;


	// From: Req2Batch7550_while
