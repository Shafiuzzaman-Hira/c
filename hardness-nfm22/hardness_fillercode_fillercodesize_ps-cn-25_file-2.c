...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch2PS_CN_25.c", 13, "reach_error"); }
...
float var_1_30 = 49.875;
double var_1_31 = 2.4;
double var_1_32 = 255.2;
double var_1_33 = 10.125;
double var_1_34 = 32.25;
...
void step(void) {
	...
	// From: CodeObject5
	var_1_31 = ((max (var_1_32 , var_1_33)) - var_1_34);


	// From: CodeObject6
	if (var_1_23 > var_1_28) {
		if (var_1_25 <= var_1_32) {
			if (((max (var_1_24 , var_1_23)) | var_1_36) <= var_1_28) {
				var_1_35 = var_1_37;
			} else {
				var_1_35 = var_1_37;
			}
	...
	// From: Req4Batch2PS_CN_25
	if ((var_1_15 - (min (0 , var_1_16))) > last_1_var_1_6) {
		var_1_14 = var_1_12;
	}


	// From: Req3Batch2PS_CN_25
	...
	// From: Req7Batch2PS_CN_25
	var_1_20 = var_1_16;


	// From: Req8Batch2PS_CN_25
	var_1_21 = var_1_16;


	// From: Req5Batch2PS_CN_25
