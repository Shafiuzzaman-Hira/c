...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch18PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_23 < var_1_22) {
		var_1_26 = ((var_1_20 && var_1_21) || var_1_27);
	}


	// From: CodeObject5
	if ((~ var_1_23) > var_1_22) {
		var_1_28 = (max (var_1_29 , (abs (200 - 8))));
	}
	...
	// From: CodeObject7
	if (var_1_29 < ((var_1_32 % var_1_34) ^ var_1_30)) {
		var_1_33 = var_1_35;
	}


	// From: Req2Batch18PS_CN_25
