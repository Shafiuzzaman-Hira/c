...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch61has_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch61has_floats
	var_1_20 = var_1_21;


	// From: Req6Batch61has_floats
	var_1_22 = var_1_18;


	// From: Req7Batch61has_floats
