...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch63PS_CN_50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req9Batch63PS_CN_50
	var_1_31 = var_1_13;


	// From: Req4Batch63PS_CN_50
	if (var_1_7) {
	...
	// From: Req7Batch63PS_CN_50
	if (var_1_7) {
		var_1_29 = var_1_20;
	}


	// From: Req10Batch63PS_CN_50
	var_1_32 = var_1_16;


	// From: Req8Batch63PS_CN_50
	var_1_30 = var_1_32;


	// From: Req2Batch63PS_CN_50
	...
	// From: Req6Batch63PS_CN_50
	if (var_1_11 >= var_1_30) {
		var_1_26 = (var_1_27 + var_1_28);
	}


	// From: Req1Batch63PS_CN_50
