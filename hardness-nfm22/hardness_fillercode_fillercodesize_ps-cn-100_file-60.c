...
void step(void) {
	...
	// From: CodeObject6
	if ((max ((var_1_42 | var_1_26) , (var_1_41 | var_1_25))) > (abs (var_1_33))) {
		var_1_43 = (abs (-2));
	} else {
		if (var_1_23) {
			var_1_43 = (max (var_1_31 , ((var_1_41 + var_1_32) - var_1_42)));
		} else {
	...
	// From: CodeObject7
	if (((abs (var_1_38)) * var_1_39) > var_1_45) {
	...
	if (var_1_45 < var_1_39) {
		if (! (var_1_25 > -500)) {
			if ((abs (var_1_31)) <= (var_1_42 - var_1_32)) {
				var_1_46 = (max (3.5f , ((max (var_1_47 , var_1_48)) - (var_1_49 - var_1_50))));
			} else {
				var_1_46 = (abs (var_1_48));
			}
		}
	} else {
		if ((abs (var_1_39)) < var_1_48) {
			var_1_46 = var_1_50;
		}
	}
	...
	// From: CodeObject9
	if (var_1_27 < ((abs (var_1_24)) >> var_1_26)) {
		var_1_51 = var_1_30;
	} else {
		if ((min (var_1_32 , var_1_31)) > 2) {
			if (-10 < var_1_43) {
				var_1_51 = var_1_42;
			}
		}
