...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch55has_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_2) {
		if (stepLocal_1 && var_1_5) {
			if (last_1_var_1_12 >= stepLocal_0) {
				...
				var_1_1 = (min (25 , last_1_var_1_17));
			}
		}
	} else {
	...
	// From: Req2Batch55has_floats
	if (var_1_2) {
		var_1_7 = (((var_1_8 + var_1_9) + var_1_10) - var_1_11);
	}


	// From: Req4Batch55has_floats
	var_1_15 = var_1_8;


	// From: Req5Batch55has_floats
	var_1_16 = var_1_14;


	// From: Req6Batch55has_floats
	var_1_17 = var_1_18;


	// From: Req3Batch55has_floats
	signed long int stepLocal_3 = min ((-4 >> var_1_1) , var_1_1);
...
int property() {
	return (((((var_1_2 ? (((last_1_var_1_12 >= last_1_var_1_17) && var_1_5) ? ((last_1_var_1_12 >= last_1_var_1_17) ? (var_1_1 == ((unsigned short int) 5)) : (var_1_1 == ((unsigned short int) (min (25 , last_1_var_1_17))))) : 1) : (var_1_1 == ((unsigned short int) last_1_var_1_17))) && (var_1_2 ? (var_1_7 == ((double) (((var_1_8 + var_1_9) + var_1_10) - var_1_11))) : 1)) && (((~ var_1_17) <= (min ((-4 >> var_1_1) , var_1_1))) ? (((var_1_14 - 64) < (var_1_1 / -8)) ? (var_1_12 == ((signed long int) var_1_1)) : 1) : (var_1_12 == ((signed long int) (var_1_17 - var_1_14))))) && (var_1_15 == ((float) var_1_8))) && (var_1_16 == ((unsigned long int) var_1_14))) && (var_1_17 == ((unsigned char) var_1_18))
;
}
int main(void) {
	isInitial = 1;
