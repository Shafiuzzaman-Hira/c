...
void step(void) {
	...
	if (BOOL_unsigned_char_Array_0[0]) {
		...
		if (stepLocal_0 >= (min ((last_1_unsigned_short_int_Array_0_1_ * signed_char_Array_0[1]) , (~ last_1_unsigned_short_int_Array_0_1_)))) {
	...
	if (signed_char_Array_0[1] <= stepLocal_2) {
		if (unsigned_short_int_Array_0[1] == stepLocal_1) {
			double_Array_0[2] = ((abs (double_Array_0[1])) + double_Array_0[3]);
		} else {
	...
	if (signed_char_Array_0[1] > signed_char_Array_0[1]) {
		double_Array_0[0] = (min (double_Array_0[3] , double_Array_0[1]));
	}
}
...
int property() {
	return (((((BOOL_unsigned_char_Array_0[0] ? (unsigned_short_int_Array_0[1] == ((unsigned short int) (abs (abs (unsigned_short_int_Array_0[0]))))) : (((unsigned_short_int_Array_0[0] / unsigned_char_Array_0[0]) >= (min ((last_1_unsigned_short_int_Array_0_1_ * signed_char_Array_0[1]) , (~ last_1_unsigned_short_int_Array_0_1_)))) ? (unsigned_short_int_Array_0[1] == ((unsigned short int) unsigned_char_Array_0[0])) : (unsigned_short_int_Array_0[1] == ((unsigned short int) unsigned_short_int_Array_0[0])))) && ((signed_char_Array_0[1] <= (unsigned_short_int_Array_0[0] + unsigned_short_int_Array_0[1])) ? ((unsigned_short_int_Array_0[1] == (signed_short_int_Array_0[0] ^ signed_char_Array_0[1])) ? (double_Array_0[2] == ((double) ((abs (double_Array_0[1])) + double_Array_0[3]))) : (double_Array_0[2] == ((double) double_Array_0[3]))) : (double_Array_0[2] == ((double) double_Array_0[1])))) && ((signed_char_Array_0[1] > signed_char_Array_0[1]) ? (double_Array_0[0] == ((double) (min (double_Array_0[3] , double_Array_0[1])))) : 1)) && (signed_short_int_Array_0[0] == ((signed short int) 200))) && (signed_char_Array_0[1] == ((signed char) signed_char_Array_0[0]))) && (double_Array_0[4] == ((double) double_Array_0[1]))
;
}
int main(void) {
	isInitial = 1;
