...
void step(void) {
	...
	// From: CodeObject4
	if (var_1_8 >= var_1_8) {
		var_1_31 = (max (var_1_8 , (abs (var_1_12))));
	}
	...
	// From: CodeObject7
	if ((min (var_1_22 , var_1_33)) < (var_1_39 + var_1_8)) {
	...
	// From: Req4Batch27Filler_PS_CO
	if (var_1_6 == (var_1_4 / var_1_13)) {
		var_1_12 = var_1_11;
	}


	// From: Req6Batch27Filler_PS_CO
	var_1_20 = var_1_11;


	// From: Req7Batch27Filler_PS_CO
	var_1_21 = 8;


	// From: Req3Batch27Filler_PS_CO
