...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch10has_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch10has_floats
	var_1_18 = var_1_8;


	// From: Req6Batch10has_floats
	var_1_19 = var_1_12;


	// From: Req7Batch10has_floats
	var_1_20 = var_1_21;
