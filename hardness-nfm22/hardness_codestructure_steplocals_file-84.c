...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch84stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch84stepLocals
	if (var_1_2) {
		var_1_1 = (min ((var_1_3 + (1 - var_1_4)) , var_1_5));
	}


	// From: Req2Batch84stepLocals
	signed long int stepLocal_1 = -16;
	signed long int stepLocal_0 = var_1_5 / (max (var_1_7 , var_1_8));
	if (-4 > stepLocal_0) {
	...
	// From: Req6Batch84stepLocals
	signed long int stepLocal_3 = var_1_10 - (min (var_1_11 , var_1_16));
	if (((var_1_4 + var_1_14) & var_1_7) <= stepLocal_3) {
	...
	// From: Req7Batch84stepLocals
	var_1_18 = var_1_17;


	// From: Req8Batch84stepLocals
	var_1_19 = 0;


	// From: Req9Batch84stepLocals
	var_1_20 = var_1_21;
}
