...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch8450_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch8450_1loop
	var_1_18 = var_1_17;


	// From: Req8Batch8450_1loop
	var_1_19 = 0;


	// From: Req9Batch8450_1loop
	var_1_20 = var_1_21;


	// From: Req1Batch8450_1loop
	if (var_1_19) {
		var_1_1 = (min ((var_1_3 + (1 - var_1_4)) , var_1_5));
	}


	// From: Req4Batch8450_1loop
	if (var_1_3 <= var_1_1) {
		var_1_12 = var_1_4;
	} else {
