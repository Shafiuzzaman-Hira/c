...
void step(void) {
	...
	// From: Req3Batch94Wrapper_S
	if (WrapperStruct00.var_1_10 || WrapperStruct00.var_1_9) {
		WrapperStruct00.var_1_11 = WrapperStruct00.var_1_12;
	} else {
		WrapperStruct00.var_1_11 = ((max (WrapperStruct00.var_1_13 , WrapperStruct00.var_1_14)) + (WrapperStruct00.var_1_15 + WrapperStruct00.var_1_16));
	}


	// From: Req4Batch94Wrapper_S
