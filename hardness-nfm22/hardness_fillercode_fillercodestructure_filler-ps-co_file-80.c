...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch80Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch80Filler_PS_CO
	if ((var_1_17 <= (- var_1_16)) && var_1_19) {
		var_1_18 = var_1_10;
	}


	// From: Req7Batch80Filler_PS_CO
	if (var_1_19) {
