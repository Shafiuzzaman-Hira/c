...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch49Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject3
	if ((var_1_26 % (min (var_1_29 , var_1_30))) < var_1_19) {
	...
	// From: CodeObject4
	if ((var_1_26 <= (max (100 , var_1_1))) || ((- var_1_30) <= var_1_29)) {
		var_1_31 = var_1_26;
	} else {
		var_1_31 = var_1_30;
	}
