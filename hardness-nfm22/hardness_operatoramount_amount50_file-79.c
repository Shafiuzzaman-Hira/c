...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch79Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch79Amount50
	var_1_26 = var_1_16;


	// From: Req8Batch79Amount50
	var_1_27 = 10u;


	// From: Req6Batch79Amount50
	if (var_1_8 >= var_1_7) {
