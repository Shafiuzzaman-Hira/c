...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch51100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch51100_while
	var_1_18 = var_1_19;


	// From: Req8Batch51100_while
	if (var_1_18 > ((32u / var_1_16) + 32u)) {
		var_1_22 = var_1_21;
	}


	// From: Req9Batch51100_while
	if (var_1_21) {
