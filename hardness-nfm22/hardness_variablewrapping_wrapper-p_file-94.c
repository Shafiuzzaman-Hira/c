...
void step(void) {
	...
	// From: Req3Batch94Wrapper_P
	if ((*(var_1_10_Pointer)) || (*(var_1_9_Pointer))) {
		(*(var_1_11_Pointer)) = (*(var_1_12_Pointer));
	} else {
		(*(var_1_11_Pointer)) = ((max ((*(var_1_13_Pointer)) , (*(var_1_14_Pointer)))) + ((*(var_1_15_Pointer)) + (*(var_1_16_Pointer))));
	}


	// From: Req4Batch94Wrapper_P
