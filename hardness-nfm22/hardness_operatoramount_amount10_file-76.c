...
void step(void) {
	// From: Req1Batch76Amount10
	if (last_1_var_1_1 < ((min (var_1_3 , var_1_4)) - 199.2f)) {
		var_1_1 = var_1_5;
	}


	// From: Req2Batch76Amount10
	if (last_1_var_1_6) {
		var_1_6 = (! (var_1_8 || var_1_9));
	}


	// From: Req3Batch76Amount10
	var_1_10 = -50;
}
...
int property() {
	return (((last_1_var_1_1 < ((min (var_1_3 , var_1_4)) - 199.2f)) ? (var_1_1 == ((double) var_1_5)) : 1) && (last_1_var_1_6 ? (var_1_6 == ((unsigned char) (! (var_1_8 || var_1_9)))) : 1)) && (var_1_10 == ((signed char) -50))
;
}
int main(void) {
	isInitial = 1;
