...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch94Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
 if ((var_1_19 * var_1_15) == var_1_8) {
  ...
  if (5 <= ((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15)))) {
 ...
 if (var_1_36) {
  ...
  if (var_1_9 >= (var_1_38 - var_1_39)) {
   var_1_37 = ((((var_1_15) > (var_1_25)) ? (var_1_15) : (var_1_25)));
  } else {
