...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch71PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject3
	if ((var_1_24 >> var_1_25) <= (abs (var_1_28 + var_1_29))) {
	...
	// From: Req2Batch71PS_CN_10
	var_1_10 = var_1_11;


	// From: Req3Batch71PS_CN_10
	...
	// From: Req5Batch71PS_CN_10
	var_1_18 = (max ((max (255.5f , var_1_11)) , 5.5f));


	// From: Req7Batch71PS_CN_10
	var_1_20 = var_1_15;


	// From: Req8Batch71PS_CN_10
	var_1_21 = var_1_5;


	// From: Req9Batch71PS_CN_10
	var_1_22 = var_1_23;


	// From: Req6Batch71PS_CN_10
	if (var_1_3) {
