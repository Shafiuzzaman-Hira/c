...
void step(void) {
	...
	// From: CodeObject6
	var_1_37 = (min ((abs (var_1_34)) , var_1_15));
	...
	// From: Req7Batch84Filler_PR_CO
	var_1_18 = var_1_17;


	// From: CodeObject4
	if (var_1_13 != (abs (var_1_9))) {
		var_1_33 = (5 + var_1_34);
	}
	...
	// From: Req8Batch84Filler_PR_CO
	var_1_19 = 0;


	// From: CodeObject5
	if ((~ var_1_34) > (var_1_9 / var_1_36)) {
		var_1_35 = (abs (abs (var_1_12)));
	}


	// From: Req9Batch84Filler_PR_CO
	var_1_20 = var_1_21;


	// From: Req1Batch84Filler_PR_CO
	if (var_1_19) {
		var_1_1 = (min ((var_1_3 + (1 - var_1_4)) , var_1_5));
	}


	// From: Req4Batch84Filler_PR_CO
	if (var_1_3 <= var_1_1) {
		var_1_12 = var_1_4;
	} else {
