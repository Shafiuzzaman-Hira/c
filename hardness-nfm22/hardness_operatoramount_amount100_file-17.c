...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch17Amount100.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch17Amount100
	if ((-16 * last_1_var_1_23) > ((min (last_1_var_1_23 , last_1_var_1_23)) / var_1_11)) {
		var_1_10 = (min (last_1_var_1_14 , last_1_var_1_23));
	} else {
		var_1_10 = (last_1_var_1_31 - last_1_var_1_31);
	}


	// From: Req11Batch17Amount100
	...
	if (stepLocal_7 && last_1_var_1_1) {
		if (last_1_var_1_31 <= stepLocal_8) {
			if ((- var_1_19) >= var_1_17) {
				var_1_31 = (128 - (min (100 , (var_1_33 + var_1_34))));
			} else {
				var_1_31 = (var_1_35 - 5);
			}
		} else {
	...
	// From: Req3Batch17Amount100
	var_1_14 = (-2 + (last_1_var_1_31 + last_1_var_1_31));


	// From: Req4Batch17Amount100
	...
	// From: Req10Batch17Amount100
	if (var_1_8) {
		var_1_26 = (var_1_19 + ((var_1_27 + var_1_28) + var_1_17));
	} else {
		var_1_26 = (min (var_1_17 , (var_1_29 - var_1_30)));
	}


	// From: Req9Batch17Amount100
	signed short int stepLocal_6 = var_1_10;
	if (stepLocal_6 >= (min (var_1_11 , (var_1_31 * var_1_14)))) {
		var_1_24 = (min (var_1_31 , var_1_31));
	} else {
		var_1_24 = var_1_31;
	}


	// From: Req8Batch17Amount100
	signed long int stepLocal_5 = 25 * var_1_14;
	if (! (var_1_31 <= var_1_10)) {
		if (var_1_10 >= stepLocal_5) {
			var_1_23 = (min (var_1_24 , var_1_10));
		} else {
	...
	// From: Req1Batch17Amount100
	unsigned char stepLocal_0 = (min (var_1_24 , var_1_14)) > var_1_31;
...
int property() {
	return (((((((((((((var_1_31 | var_1_24) <= var_1_31) || ((min (var_1_24 , var_1_14)) > var_1_31)) ? (var_1_1 == ((unsigned char) ((! 1) && var_1_8))) : (var_1_1 == ((unsigned char) var_1_9))) && (((-16 * last_1_var_1_23) > ((min (last_1_var_1_23 , last_1_var_1_23)) / var_1_11)) ? (var_1_10 == ((signed short int) (min (last_1_var_1_14 , last_1_var_1_23)))) : (var_1_10 == ((signed short int) (last_1_var_1_31 - last_1_var_1_31))))) && (var_1_14 == ((signed short int) (-2 + (last_1_var_1_31 + last_1_var_1_31))))) && ((var_1_31 == (-128 * var_1_31)) ? (var_1_16 == ((double) (max ((0.875 + (var_1_17 + 64.4)) , 1.0000000000000005E15)))) : (var_1_16 == ((double) var_1_17)))) && ((((var_1_24 + -16) * var_1_23) >= var_1_31) ? (var_1_18 == ((float) (64.9f + var_1_19))) : (var_1_18 == ((float) var_1_17)))) && (((var_1_14 % var_1_21) >= (var_1_31 & var_1_24)) ? (var_1_20 == ((float) (min ((abs (63.5f + var_1_17)) , var_1_19)))) : (var_1_20 == ((float) var_1_19)))) && ((! (var_1_10 <= var_1_23)) ? (var_1_1 ? (((~ (var_1_31 * 128u)) == var_1_23) ? (var_1_22 == ((unsigned char) (! var_1_9))) : 1) : (var_1_22 == ((unsigned char) var_1_9))) : (var_1_22 == ((unsigned char) var_1_9)))) && ((! (var_1_31 <= var_1_10)) ? ((var_1_10 >= (25 * var_1_14)) ? (var_1_23 == ((signed long int) (min (var_1_24 , var_1_10)))) : (var_1_23 == ((signed long int) ((var_1_10 + var_1_14) + var_1_24)))) : 1)) && ((var_1_10 >= (min (var_1_11 , (var_1_31 * var_1_14)))) ? (var_1_24 == ((unsigned short int) (min (var_1_31 , var_1_31)))) : (var_1_24 == ((unsigned short int) var_1_31)))) && (var_1_8 ? (var_1_26 == ((float) (var_1_19 + ((var_1_27 + var_1_28) + var_1_17)))) : (var_1_26 == ((float) (min (var_1_17 , (var_1_29 - var_1_30))))))) && (((last_1_var_1_14 <= (last_1_var_1_14 * var_1_12)) && last_1_var_1_1) ? ((last_1_var_1_31 <= last_1_var_1_14) ? (((- var_1_19) >= var_1_17) ? (var_1_31 == ((unsigned char) (128 - (min (100 , (var_1_33 + var_1_34)))))) : (var_1_31 == ((unsigned char) (var_1_35 - 5)))) : (var_1_31 == ((unsigned char) var_1_33))) : (var_1_31 == ((unsigned char) var_1_33)))
;
}
int main(void) {
	isInitial = 1;
