...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch69Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
 if (unsigned_long_int_Array_0[1][1] < (((((unsigned_long_int_Array_0[1][0] * unsigned_long_int_Array_0[0][0])) > (unsigned_long_int_Array_0[0][1])) ? ((unsigned_long_int_Array_0[1][0] * unsigned_long_int_Array_0[0][0])) : (unsigned_long_int_Array_0[0][1])))) {
  signed_char_Array_0[1] = signed_char_Array_0[0];
 } else {
  if (BOOL_unsigned_char_Array_0[0] || BOOL_unsigned_char_Array_0[1]) {
   signed_char_Array_0[1] = signed_char_Array_0[0];
  } else {
   if (unsigned_long_int_Array_0[0][1] < unsigned_long_int_Array_0[1][0]) {
    signed_char_Array_0[1] = signed_char_Array_0[0];
   } else {
    signed_char_Array_0[1] = -4;
   }
  }
 }
 unsigned long int stepLocal_1 = unsigned_long_int_Array_0[0][0];
 unsigned long int stepLocal_0 = unsigned_long_int_Array_0[1][1] * ((((unsigned_long_int_Array_0[0][1]) < (unsigned_long_int_Array_0[1][0])) ? (unsigned_long_int_Array_0[0][1]) : (unsigned_long_int_Array_0[1][0])));
 if (stepLocal_0 < unsigned_long_int_Array_0[0][0]) {
 ...
 unsigned char stepLocal_3 = BOOL_unsigned_char_Array_0[0];
 signed long int stepLocal_2 = signed_short_int_Array_0[0] + signed_char_Array_0[1];
 if (((signed_char_Array_0[1] + signed_char_Array_0[0]) == unsigned_long_int_Array_0[1][0]) && stepLocal_3) {
  if (! BOOL_unsigned_char_Array_0[1]) {
   if (stepLocal_2 != signed_char_Array_0[0]) {
...
int property() {
 return ((((unsigned_long_int_Array_0[1][1] * ((((unsigned_long_int_Array_0[0][1]) < (unsigned_long_int_Array_0[1][0])) ? (unsigned_long_int_Array_0[0][1]) : (unsigned_long_int_Array_0[1][0])))) < unsigned_long_int_Array_0[0][0]) ? ((unsigned_long_int_Array_0[0][0] > unsigned_long_int_Array_0[1][1]) ? (signed_short_int_Array_0[0] == ((signed short int) signed_char_Array_0[1])) : (signed_short_int_Array_0[0] == ((signed short int) signed_char_Array_0[1]))) : 1) && ((unsigned_long_int_Array_0[1][1] < (((((unsigned_long_int_Array_0[1][0] * unsigned_long_int_Array_0[0][0])) > (unsigned_long_int_Array_0[0][1])) ? ((unsigned_long_int_Array_0[1][0] * unsigned_long_int_Array_0[0][0])) : (unsigned_long_int_Array_0[0][1])))) ? (signed_char_Array_0[1] == ((signed char) signed_char_Array_0[0])) : ((BOOL_unsigned_char_Array_0[0] || BOOL_unsigned_char_Array_0[1]) ? (signed_char_Array_0[1] == ((signed char) signed_char_Array_0[0])) : ((unsigned_long_int_Array_0[0][1] < unsigned_long_int_Array_0[1][0]) ? (signed_char_Array_0[1] == ((signed char) signed_char_Array_0[0])) : (signed_char_Array_0[1] == ((signed char) -4)))))) && ((((signed_char_Array_0[1] + signed_char_Array_0[0]) == unsigned_long_int_Array_0[1][0]) && BOOL_unsigned_char_Array_0[0]) ? ((! BOOL_unsigned_char_Array_0[1]) ? (((signed_short_int_Array_0[0] + signed_char_Array_0[1]) != signed_char_Array_0[0]) ? (double_Array_0[1] == ((double) double_Array_0[0])) : (double_Array_0[1] == ((double) double_Array_0[0]))) : (double_Array_0[1] == ((double) double_Array_0[0]))) : (double_Array_0[1] == ((double) double_Array_0[0])))
;
}
int main(void) {
 isInitial = 1;
