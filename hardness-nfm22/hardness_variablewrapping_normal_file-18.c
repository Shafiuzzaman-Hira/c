...
void step(void) {
	...
	if (last_1_var_1_14 > stepLocal_3) {
		if (((last_1_var_1_11 - var_1_8) + var_1_7) > stepLocal_2) {
			var_1_11 = (min (var_1_12 , var_1_13));
		} else {
			var_1_11 = var_1_12;
		}
	}
	...
	unsigned long int stepLocal_0 = var_1_11 ^ (max (var_1_11 , var_1_14));
	if (stepLocal_0 != var_1_11) {
		if (stepLocal_1 == (var_1_11 - (var_1_7 - var_1_11))) {
			var_1_1 = (min (var_1_9 , var_1_10));
		}
	} else {
		var_1_1 = 10.5f;
	}
...
int property() {
	return ((((var_1_11 ^ (max (var_1_11 , var_1_14))) != var_1_11) ? ((var_1_11 == (var_1_11 - (var_1_7 - var_1_11))) ? (var_1_1 == ((float) (min (var_1_9 , var_1_10)))) : 1) : (var_1_1 == ((float) 10.5f))) && ((last_1_var_1_14 > var_1_8) ? ((((last_1_var_1_11 - var_1_8) + var_1_7) > last_1_var_1_14) ? (var_1_11 == ((unsigned char) (min (var_1_12 , var_1_13)))) : (var_1_11 == ((unsigned char) var_1_12))) : 1)) && (((var_1_11 & var_1_7) > ((var_1_12 * last_1_var_1_14) * (var_1_11 + var_1_11))) ? ((var_1_15 && (var_1_9 > var_1_10)) ? (var_1_14 == ((unsigned long int) var_1_7)) : 1) : (var_1_14 == ((unsigned long int) var_1_7)))
;
}
int main(void) {
	isInitial = 1;
