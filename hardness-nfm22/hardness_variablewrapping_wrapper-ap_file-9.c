...
void step(void) {
	...
	if (((last_1_signed_short_int_Array_0_0_ + last_1_unsigned_char_Array_0_2_) < 10) || stepLocal_0) {
		(*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) = (max ((((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) + last_1_signed_short_int_Array_0_0_) - (max (last_1_signed_long_int_Array_0_0_ , last_1_signed_short_int_Array_0_0_))) , last_1_unsigned_char_Array_0_2_));
	} else {
		(*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) = last_1_signed_short_int_Array_0_0_;
	}


	// From: Req6Batch9Wrapper_AP
	...
	if ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) <= 16) {
		...
		if ((max ((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) , (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)))) < (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))) {
