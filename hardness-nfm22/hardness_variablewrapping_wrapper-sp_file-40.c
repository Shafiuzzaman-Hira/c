...
void step(void) {
	// From: Req4Batch40Wrapper_SP
	if ((*(WrapperStruct00_var_1_3_Pointer))) {
		(*(WrapperStruct00_var_1_16_Pointer)) = (max ((*(WrapperStruct00_var_1_17_Pointer)) , (-2 + (*(WrapperStruct00_var_1_18_Pointer)))));
	}


	// From: Req5Batch40Wrapper_SP
	(*(WrapperStruct00_var_1_19_Pointer)) = (*(WrapperStruct00_var_1_15_Pointer));


	// From: Req6Batch40Wrapper_SP
	(*(WrapperStruct00_var_1_20_Pointer)) = (*(WrapperStruct00_var_1_16_Pointer));


	// From: Req7Batch40Wrapper_SP
	(*(WrapperStruct00_var_1_21_Pointer)) = (*(WrapperStruct00_var_1_18_Pointer));


	// From: Req1Batch40Wrapper_SP
	...
	// From: Req3Batch40Wrapper_SP
	if ((*(WrapperStruct00_var_1_19_Pointer)) != (min (last_1_WrapperStruct00_var_1_13 , (*(WrapperStruct00_var_1_19_Pointer))))) {
