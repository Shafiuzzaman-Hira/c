...
void step(void) {
	...
	// From: Req1Batch74Wrapper_AP
	if ((min ((max ((*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer)) , (*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)))) , (*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)))) < (*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer))) {
		(*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var4_Pointer)) = (max ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var3_Pointer)) , ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var2_Pointer)) - (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)))));
	} else {
