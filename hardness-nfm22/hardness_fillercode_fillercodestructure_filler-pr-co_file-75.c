...
void step(void) {
	...
	// From: CodeObject2
	if ((var_1_25 ^ (var_1_28 + var_1_21)) <= (abs (min (var_1_21 , var_1_21)))) {
		var_1_33 = (abs (min ((min (var_1_36 , var_1_37)) , var_1_38)));
	} else {
		if (var_1_38 >= (max (var_1_37 , (var_1_36 * var_1_15)))) {
			if (var_1_31) {
				var_1_33 = var_1_40;
			}
		}
