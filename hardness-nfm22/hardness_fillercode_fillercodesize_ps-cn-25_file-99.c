...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch99PS_CN_25.c", 13, "reach_error"); }
...
double var_1_42 = 199.125;
double var_1_43 = 99999999.4;
...
void step(void) {
	...
	if (var_1_29 <= var_1_30) {
		var_1_31 = (max (var_1_32 , var_1_33));
	}


	// From: CodeObject3
	if (8.02 < var_1_35) {
		var_1_34 = (max (var_1_32 , var_1_33));
	}
	...
	// From: CodeObject5
	if ((min ((var_1_29 & var_1_31) , (min (var_1_30 , var_1_34)))) == (abs (var_1_33))) {
		var_1_38 = (var_1_37 && (var_1_39 && (! var_1_40)));
	}


	// From: CodeObject6
	if (((var_1_33 != var_1_30) || var_1_36) || (var_1_35 > var_1_42)) {
		var_1_41 = var_1_43;
	}


	// From: Req1Batch99PS_CN_25
	if (var_1_2) {
