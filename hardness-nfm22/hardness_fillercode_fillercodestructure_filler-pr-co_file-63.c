...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch63Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch63Filler_PR_CO
	var_1_30 = var_1_32;


	// From: Req2Batch63Filler_PR_CO
	...
	// From: CodeObject1
	if ((var_1_11 ^ var_1_24) < (var_1_13 | var_1_30)) {
