...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch3Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject1
	if (var_1_20 >= (max (var_1_14 , var_1_23))) {
		var_1_24 = (min ((max (var_1_23 , var_1_20)) , var_1_14));
	} else {
		var_1_24 = ((abs (var_1_20)) + (abs (var_1_23)));
	}
	...
	// From: CodeObject3
	if (((var_1_6 ^ var_1_20) % var_1_21) > -10) {
		var_1_30 = (abs (var_1_20));
	}


	// From: CodeObject4
	if ((~ var_1_5) <= ((max (var_1_22 , -16)) & 16)) {
		var_1_32 = var_1_16;
	} else {
		if (var_1_14 <= ((min (var_1_34 , var_1_35)) - (abs (var_1_22)))) {
			var_1_32 = var_1_16;
		} else {
			var_1_32 = var_1_16;
		}
	...
	// From: CodeObject5
	if (var_1_20 >= ((var_1_35 & var_1_14) >> var_1_22)) {
