...
void step(void) {
	...
	if ((var_1_27 >> var_1_28) >= var_1_23) {
		var_1_31 = (max (var_1_20 , (4 - (var_1_34 - 25))));
	} else {
		var_1_31 = var_1_20;
	}
	...
	if (var_1_3) {
		...
		var_1_37 = (min (var_1_34 , var_1_21));
	}
	...
	if (var_1_28 > var_1_14) {
		var_1_42 = (max ((min (var_1_34 , var_1_27)) , (abs (32))));
	} else {
		var_1_42 = (max ((abs (min (16 , var_1_27))) , var_1_34));
	}


	// From: CodeObject9
	if (var_1_20 <= var_1_34) {
		var_1_44 = (abs (abs (var_1_45 - var_1_34)));
	}


	// From: CodeObject10
	if (var_1_16 < var_1_28) {
		var_1_46 = (min (var_1_27 , (max (256u , var_1_34))));
	}
