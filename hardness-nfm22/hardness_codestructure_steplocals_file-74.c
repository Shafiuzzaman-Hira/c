...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch74stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch74stepLocals
	unsigned long int stepLocal_3 = 5u << (var_1_12 - var_1_13);
	unsigned long int stepLocal_2 = var_1_7;
	if (! ((var_1_5 > var_1_7) || var_1_4)) {
		if (stepLocal_3 > (var_1_5 / 25u)) {
			if ((-64 * var_1_5) != stepLocal_2) {
	...
	// From: Req4Batch74stepLocals
	if (var_1_10) {
		if (var_1_11 > (var_1_6 / (var_1_12 + var_1_16))) {
			var_1_15 = var_1_17;
		}
	}


	// From: Req5Batch74stepLocals
	if (var_1_10) {
	...
	// From: Req6Batch74stepLocals
	signed long int stepLocal_4 = var_1_12 - var_1_11;
...
int property() {
	return ((((((! (var_1_2 >= var_1_3)) ? (var_1_4 ? (var_1_1 == ((unsigned long int) ((var_1_5 - var_1_6) - var_1_7))) : (var_1_1 == ((unsigned long int) var_1_5))) : (var_1_1 == ((unsigned long int) var_1_7))) && ((var_1_6 < var_1_3) ? ((var_1_3 <= var_1_6) ? (var_1_8 == ((unsigned char) ((var_1_4 && var_1_9) || var_1_10))) : 1) : 1)) && ((! ((var_1_5 > var_1_7) || var_1_4)) ? (((5u << (var_1_12 - var_1_13)) > (var_1_5 / 25u)) ? (((-64 * var_1_5) != var_1_7) ? (var_1_11 == ((unsigned char) (min (var_1_13 , var_1_12)))) : (var_1_11 == ((unsigned char) var_1_12))) : (var_1_11 == ((unsigned char) var_1_12))) : (var_1_11 == ((unsigned char) var_1_12)))) && (var_1_10 ? ((var_1_11 > (var_1_6 / (var_1_12 + var_1_16))) ? (var_1_15 == ((float) var_1_17)) : 1) : 1)) && (var_1_10 ? (var_1_18 == ((float) (var_1_19 + var_1_20))) : (var_1_18 == ((float) (((var_1_21 - var_1_22) - var_1_23) + var_1_20))))) && (((~ var_1_3) <= (var_1_12 - var_1_11)) ? (var_1_24 == ((double) var_1_22)) : 1)
;
}
int main(void) {
	isInitial = 1;
