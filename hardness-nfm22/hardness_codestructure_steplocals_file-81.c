...
void step(void) {
	...
	// From: Req2Batch81stepLocals
	unsigned char stepLocal_2 = var_1_8;
	unsigned char stepLocal_1 = (var_1_6 / var_1_5) != (min (var_1_2 , var_1_3));
	...
	// From: Req3Batch81stepLocals
	if (! var_1_9) {
		var_1_10 = (min (var_1_1 , var_1_5));
	}


	// From: Req4Batch81stepLocals
	if (var_1_8) {
		var_1_11 = ((max (var_1_12 , var_1_13)) - ((var_1_14 + var_1_15) - var_1_1));
	}


	// From: Req5Batch81stepLocals
	var_1_16 = (var_1_7 - 1);


	// From: Req6Batch81stepLocals
