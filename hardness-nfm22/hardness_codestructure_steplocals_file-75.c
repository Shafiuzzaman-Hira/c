...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch75stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch75stepLocals
	if (! (var_1_4 < 16.8f)) {
		var_1_15 = var_1_6;
	}


	// From: Req4Batch75stepLocals
	if (var_1_8 > var_1_3) {
	...
	// From: Req5Batch75stepLocals
	if ((- (var_1_17 + var_1_15)) >= var_1_1) {
		var_1_21 = (abs (-50));
	}


	// From: Req6Batch75stepLocals
