...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch2Amount25.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch2Amount25
	var_1_11 = var_1_7;


	// From: Req5Batch2Amount25
	var_1_12 = var_1_5;


	// From: Req1Batch2Amount25
	if (var_1_11 <= (var_1_11 * var_1_12)) {
		var_1_1 = (max (var_1_5 , (max (var_1_6 , var_1_7))));
	}


	// From: Req2Batch2Amount25
