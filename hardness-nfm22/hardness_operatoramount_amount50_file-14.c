...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch14Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch14Amount50
	var_1_1 = (var_1_15 + var_1_15);


	// From: Req8Batch14Amount50
	var_1_28 = var_1_17;


	// From: Req7Batch14Amount50
