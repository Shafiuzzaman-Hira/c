...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch51Amount100.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req10Batch51Amount100
	if (last_1_var_1_13 > (max (last_1_var_1_31 , var_1_16))) {
		var_1_28 = ((max (var_1_29 , var_1_30)) - last_1_var_1_33);
	} else {
		var_1_28 = (var_1_25 + var_1_19);
	}


	// From: Req1Batch51Amount100
	...
	// From: Req6Batch51Amount100
	var_1_18 = var_1_19;


	// From: Req8Batch51Amount100
	if (var_1_18 > ((32u / var_1_16) + 32u)) {
		var_1_22 = var_1_21;
	}


	// From: Req9Batch51Amount100
	if (var_1_21) {
	...
	// From: Req11Batch51Amount100
	if (var_1_5 <= (- (min (var_1_4 , var_1_3)))) {
		var_1_31 = ((25454 + var_1_32) - var_1_1);
	} else {
		var_1_31 = (max ((min (var_1_19 , var_1_23)) , var_1_29));
	}


	// From: Req5Batch51Amount100
	signed long int stepLocal_4 = (var_1_6 * var_1_1) / -64;
	unsigned short int stepLocal_3 = var_1_28;
	if (stepLocal_4 >= var_1_28) {
		var_1_13 = (min (var_1_28 , var_1_31));
	} else {
		if (50u >= stepLocal_3) {
...
int property() {
	return (((((((((((((- var_1_3) <= (var_1_4 - var_1_5)) ? ((var_1_3 >= (var_1_5 / 255.75f)) ? (var_1_1 == ((signed char) var_1_6)) : (var_1_1 == ((signed char) var_1_6))) : 1) && ((var_1_4 != var_1_5) ? (var_1_7 == ((signed char) var_1_6)) : (var_1_7 == ((signed char) var_1_8)))) && ((var_1_22 || var_1_20) ? (var_1_9 == ((signed char) (max ((max ((abs (var_1_11)) , (abs (-2)))) , var_1_6)))) : ((var_1_20 && var_1_22) ? (var_1_9 == ((signed char) (min (var_1_11 , var_1_8)))) : 1))) && ((var_1_31 == var_1_11) ? ((! var_1_22) ? (var_1_22 ? (var_1_12 == ((signed long int) var_1_18)) : 1) : 1) : 1)) && ((((var_1_6 * var_1_1) / -64) >= var_1_28) ? (var_1_13 == ((unsigned long int) (min (var_1_28 , var_1_31)))) : ((50u >= var_1_28) ? (var_1_13 == ((unsigned long int) (var_1_16 - var_1_18))) : 1))) && (var_1_18 == ((unsigned char) var_1_19))) && (((var_1_31 / var_1_16) <= var_1_28) ? ((var_1_28 <= var_1_18) ? (var_1_20 == ((unsigned char) var_1_21)) : 1) : 1)) && ((var_1_18 > ((32u / var_1_16) + 32u)) ? (var_1_22 == ((unsigned char) var_1_21)) : 1)) && (var_1_21 ? (var_1_23 == ((unsigned char) ((var_1_24 + var_1_25) + ((var_1_26 + 32) - var_1_27)))) : (var_1_23 == ((unsigned char) var_1_27)))) && ((last_1_var_1_13 > (max (last_1_var_1_31 , var_1_16))) ? (var_1_28 == ((unsigned short int) ((max (var_1_29 , var_1_30)) - last_1_var_1_33))) : (var_1_28 == ((unsigned short int) (var_1_25 + var_1_19))))) && ((var_1_5 <= (- (min (var_1_4 , var_1_3)))) ? (var_1_31 == ((unsigned short int) ((25454 + var_1_32) - var_1_1))) : (var_1_31 == ((unsigned short int) (max ((min (var_1_19 , var_1_23)) , var_1_29)))))) && ((var_1_34 < (var_1_5 / var_1_35)) ? ((var_1_16 > (min (64u , var_1_28))) ? (((var_1_4 - var_1_5) <= var_1_3) ? (var_1_33 == ((unsigned long int) ((abs (8u)) + 25u))) : (var_1_33 == ((unsigned long int) (max (var_1_27 , (var_1_29 + (min (16u , var_1_18)))))))) : ((((- var_1_18) / var_1_26) < var_1_25) ? (var_1_33 == ((unsigned long int) var_1_30)) : (var_1_33 == ((unsigned long int) var_1_7)))) : (var_1_33 == ((unsigned long int) var_1_30)))
;
}
int main(void) {
	isInitial = 1;
