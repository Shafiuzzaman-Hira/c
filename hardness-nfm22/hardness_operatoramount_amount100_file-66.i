...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch66Amount100.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (last_1_var_1_29) {
  if (last_1_var_1_29) {
   ...
   var_1_9 = (((((var_1_5 + last_1_var_1_24)) > (last_1_var_1_9)) ? ((var_1_5 + last_1_var_1_24)) : (last_1_var_1_9)));
  }
 } else {
 ...
 if (var_1_32 || stepLocal_12) {
  var_1_33 = (((((var_1_20 + ((((var_1_17) > (var_1_34)) ? (var_1_17) : (var_1_34))))) < (var_1_16)) ? ((var_1_20 + ((((var_1_17) > (var_1_34)) ? (var_1_17) : (var_1_34))))) : (var_1_16)));
 } else {
  var_1_33 = var_1_16;
 }
 ...
 if (stepLocal_6 >= ((((var_1_6) > (var_1_6)) ? (var_1_6) : (var_1_6)))) {
  if (var_1_27) {
   var_1_25 = (((((var_1_5 - var_1_9)) > ((var_1_12 + var_1_24))) ? ((var_1_5 - var_1_9)) : ((var_1_12 + var_1_24))));
  }
 } else {
 ...
 signed long int stepLocal_11 = (((var_1_12) < (var_1_14)) ? (var_1_12) : (var_1_14));
 ...
 if (var_1_28 && stepLocal_10) {
  ...
  if (stepLocal_11 > (-25 << var_1_9)) {
   ...
   var_1_29 = ((var_1_23 <= ((((var_1_21) < (var_1_17)) ? (var_1_21) : (var_1_17)))) && var_1_32);
  }
 }
}
