...
void step(void) {
 ...
 signed long int stepLocal_1 = ((((*(var_1_4_Pointer))) < ((*(var_1_13_Pointer)))) ? ((*(var_1_4_Pointer))) : ((*(var_1_13_Pointer))));
