...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch37PS_CN_50.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((var_1_28 & (~ var_1_29)) <= var_1_34) {
		if (var_1_35) {
			var_1_36 = (max (var_1_29 , (min (var_1_32 , (abs (var_1_34))))));
		}
	} else {
		if (var_1_37) {
			var_1_36 = -128;
	...
	// From: Req6Batch37PS_CN_50
	var_1_17 = (var_1_18 - var_1_3);


	// From: Req3Batch37PS_CN_50
	if ((var_1_17 >= var_1_17) || (var_1_9 > last_1_var_1_10)) {
		var_1_10 = var_1_9;
	}


	// From: Req4Batch37PS_CN_50
