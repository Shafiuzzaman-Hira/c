...
void step(void) {
 ...
 if ((*(var_1_5_Pointer)) || stepLocal_0) {
  (*(var_1_6_Pointer)) = (((((*(var_1_16_Pointer))) > ((*(var_1_16_Pointer)))) ? ((*(var_1_16_Pointer))) : ((*(var_1_16_Pointer)))));
 } else {
