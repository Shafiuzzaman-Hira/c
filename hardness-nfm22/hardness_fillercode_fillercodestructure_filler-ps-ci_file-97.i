...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch97Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
 if (var_1_23) {
  if (var_1_11 <= var_1_11) {
   var_1_24 = (((((var_1_11) > (((((-128) < (var_1_11)) ? (-128) : (var_1_11))))) ? (var_1_11) : (((((-128) < (var_1_11)) ? (-128) : (var_1_11)))))) + var_1_8);
  }
 } else {
 ...
 if ((var_1_20 / var_1_12) < var_1_11) {
  ...
  var_1_29 = ((((((((((((var_1_12) < (var_1_8)) ? (var_1_12) : (var_1_8)))) > (var_1_12)) ? (((((var_1_12) < (var_1_8)) ? (var_1_12) : (var_1_8)))) : (var_1_12)))) > ((var_1_33 - var_1_11))) ? (((((((((var_1_12) < (var_1_8)) ? (var_1_12) : (var_1_8)))) > (var_1_12)) ? (((((var_1_12) < (var_1_8)) ? (var_1_12) : (var_1_8)))) : (var_1_12)))) : ((var_1_33 - var_1_11))));
 }
 if (var_1_22) {
  var_1_35 = var_1_11;
 }
 if (((((var_1_8) < (var_1_12)) ? (var_1_8) : (var_1_12))) >= var_1_20) {
  var_1_37 = var_1_8;
 }
 if ((var_1_9 * (var_1_40 - var_1_41)) >= var_1_9) {
  if ((~ var_1_14) <= (((((((var_1_13) < (var_1_14)) ? (var_1_13) : (var_1_14))) < 0 ) ? -((((var_1_13) < (var_1_14)) ? (var_1_13) : (var_1_14))) : ((((var_1_13) < (var_1_14)) ? (var_1_13) : (var_1_14)))))) {
   var_1_38 = var_1_14;
  } else {
   var_1_38 = var_1_14;
  }
 ...
 if (((((var_1_10) > (64.75f)) ? (var_1_10) : (64.75f))) <= var_1_40) {
  if ((var_1_13 & var_1_11) > var_1_11) {
   if (var_1_13 <= (((((var_1_13) < (var_1_11)) ? (var_1_13) : (var_1_11))) ^ (128 - 16))) {
