...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch4Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_14 != ((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35)))) {
  var_1_36 = (((((var_1_14 - var_1_20)) < ((((((var_1_24 + var_1_6)) < (var_1_6)) ? ((var_1_24 + var_1_6)) : (var_1_6))))) ? ((var_1_14 - var_1_20)) : ((((((var_1_24 + var_1_6)) < (var_1_6)) ? ((var_1_24 + var_1_6)) : (var_1_6))))));
 }
 if ((var_1_21 * (var_1_38 - var_1_16)) <= var_1_21) {
  var_1_37 = ((var_1_39 - var_1_35) + var_1_16);
 } else {
  if (var_1_16 <= (var_1_38 * 64)) {
   var_1_37 = ((((var_1_16) > (((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))))) ? (var_1_16) : (((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))))));
  }
 }
