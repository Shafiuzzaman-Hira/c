...
void step(void) {
	...
	// From: CodeObject4
	var_1_36 = (max (var_1_29 , var_1_32));


	// From: CodeObject5
	if (var_1_28 < var_1_26) {
		if (! ((min (var_1_38 , var_1_30)) > var_1_29)) {
			if ((var_1_35 - (abs (var_1_29))) < (var_1_28 ^ var_1_38)) {
				var_1_37 = (min ((max (var_1_35 , var_1_34)) , var_1_39));
			}
		}
	}
	...
	// From: CodeObject6
	if (var_1_28 <= (max ((abs (var_1_34)) , var_1_39))) {
		if ((~ var_1_37) >= (var_1_26 + var_1_36)) {
			if ((var_1_39 & var_1_37) < (100u | var_1_34)) {
				var_1_40 = (min ((abs (var_1_41 + var_1_42)) , var_1_35));
			}
		}
	}
	...
	if ((var_1_29 / var_1_30) <= var_1_38) {
		var_1_43 = (min (var_1_34 , var_1_42));
	}
	...
	if (var_1_28 > var_1_38) {
		var_1_48 = ((min (var_1_49 , (abs (var_1_50)))) - (abs (max (var_1_42 , var_1_41))));
	}


	// From: CodeObject10
	if (var_1_31 > var_1_33) {
		var_1_51 = (abs (var_1_41 - var_1_49));
	} else {
	...
	if (var_1_38 == var_1_48) {
		if (var_1_31 >= var_1_33) {
			var_1_52 = (abs (abs (abs (var_1_34))));
		}
	} else {
		if ((abs (min (var_1_31 , 9.8))) <= 64.3) {
			if (var_1_47) {
				var_1_52 = ((abs (256)) + var_1_34);
			} else {
				var_1_52 = var_1_42;
			}
		} else {
	...
	// From: Req2Batch21PS_CN_100
	var_1_8 = (((var_1_7 + var_1_6) + var_1_12) + (var_1_10 - var_1_12));


	// From: Req1Batch21PS_CN_100
