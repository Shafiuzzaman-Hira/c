...
void step(void) {
 ...
 if (! (*(var_1_2_Pointer))) {
  ...
  (*(var_1_1_Pointer)) = ((((16.2) < ((*(var_1_3_Pointer)))) ? (16.2) : ((*(var_1_3_Pointer)))));
 }
