...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch89dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch89dependencies
	if (last_1_var_1_18 >= (last_1_var_1_18 / var_1_9)) {
		if (last_1_var_1_18 < (last_1_var_1_1 * 256)) {
	...
	// From: Req6Batch89dependencies
	var_1_18 = var_1_8;


	// From: Req3Batch89dependencies
	...
	// From: Req4Batch89dependencies
	if (var_1_8 > ((min (var_1_8 , var_1_8)) + var_1_12)) {
		if (! (var_1_8 >= var_1_12)) {
			if (var_1_4) {
				var_1_14 = 0;
			} else {
