...
void step(void) {
	// From: Req1Batch39Wrapper_SP
	(*(WrapperStruct00_var_1_1_Pointer)) = (((max (16 , 4)) + (*(WrapperStruct00_var_1_2_Pointer))) - ((*(WrapperStruct00_var_1_3_Pointer)) + (min ((*(WrapperStruct00_var_1_4_Pointer)) , (*(WrapperStruct00_var_1_5_Pointer))))));


	// From: Req2Batch39Wrapper_SP
	if ((*(WrapperStruct00_var_1_2_Pointer)) >= (*(WrapperStruct00_var_1_1_Pointer))) {
		if ((abs ((*(WrapperStruct00_var_1_7_Pointer)) + (*(WrapperStruct00_var_1_8_Pointer)))) < (*(WrapperStruct00_var_1_9_Pointer))) {
	...
	if (stepLocal_1 != (*(WrapperStruct00_var_1_5_Pointer))) {
		if (((*(WrapperStruct00_var_1_3_Pointer)) / (*(WrapperStruct00_var_1_11_Pointer))) < stepLocal_0) {
			(*(WrapperStruct00_var_1_10_Pointer)) = (min (-256 , (min ((*(WrapperStruct00_var_1_4_Pointer)) , (max ((*(WrapperStruct00_var_1_5_Pointer)) , (*(WrapperStruct00_var_1_2_Pointer))))))));
		} else {
