...
void step(void) {
 unsigned char stepLocal_15 = (last_1_var_1_15 - 2) <= ((((var_1_31) < (256)) ? (var_1_31) : (256)));
 signed long int stepLocal_14 = last_1_var_1_40;
 if (((var_1_42 - var_1_21) / var_1_48) < (var_1_22 * var_1_10)) {
  var_1_50 = ((((((var_1_44) > (var_1_18)) ? (var_1_44) : (var_1_18))) + var_1_51) - 2);
 } else {
  if ((var_1_22 - 15.8f) < last_1_var_1_20) {
   var_1_50 = ((((var_1_44) > ((((((var_1_18 + var_1_51)) < (((((var_1_45) < 0 ) ? -(var_1_45) : (var_1_45))))) ? ((var_1_18 + var_1_51)) : (((((var_1_45) < 0 ) ? -(var_1_45) : (var_1_45)))))))) ? (var_1_44) : ((((((var_1_18 + var_1_51)) < (((((var_1_45) < 0 ) ? -(var_1_45) : (var_1_45))))) ? ((var_1_18 + var_1_51)) : (((((var_1_45) < 0 ) ? -(var_1_45) : (var_1_45)))))))));
  } else {
   if ((((((last_1_var_1_50 | last_1_var_1_40)) > (last_1_var_1_38)) ? ((last_1_var_1_50 | last_1_var_1_40)) : (last_1_var_1_38))) >= stepLocal_14) {
    if (stepLocal_15 || (var_1_16 != var_1_39)) {
     var_1_50 = ((((var_1_46) < (var_1_51)) ? (var_1_46) : (var_1_51)));
    } else {
 ...
 signed long int stepLocal_11 = (((last_1_var_1_40) < 0 ) ? -(last_1_var_1_40) : (last_1_var_1_40));
 signed long int stepLocal_10 = last_1_var_1_47;
 if (stepLocal_11 >= var_1_17) {
  if (stepLocal_10 < var_1_17) {
   var_1_30 = ((var_1_31 + (var_1_32 - last_1_var_1_28)) - (((((var_1_33 - var_1_19)) > (last_1_var_1_28)) ? ((var_1_33 - var_1_19)) : (last_1_var_1_28))));
  } else {
 ...
 signed long int stepLocal_12 = (((var_1_16) > (var_1_15)) ? (var_1_16) : (var_1_15));
 if (stepLocal_12 >= var_1_15) {
  var_1_43 = ((((((var_1_18 + var_1_44) - ((((var_1_17) < (var_1_45)) ? (var_1_17) : (var_1_45))))) < (var_1_46)) ? (((var_1_18 + var_1_44) - ((((var_1_17) < (var_1_45)) ? (var_1_17) : (var_1_45))))) : (var_1_46)));
 }
 if (var_1_27) {
 ...
 var_1_40 = ((((var_1_19) < ((((((var_1_16 - var_1_18)) < (var_1_37)) ? ((var_1_16 - var_1_18)) : (var_1_37))))) ? (var_1_19) : ((((((var_1_16 - var_1_18)) < (var_1_37)) ? ((var_1_16 - var_1_18)) : (var_1_37))))));
 if (var_1_12 >= var_1_52) {
  var_1_41 = (((((((((((var_1_9) > (var_1_11)) ? (var_1_9) : (var_1_11))) < 0 ) ? -((((var_1_9) > (var_1_11)) ? (var_1_9) : (var_1_11))) : ((((var_1_9) > (var_1_11)) ? (var_1_9) : (var_1_11)))))) > ((64.6f + var_1_21))) ? ((((((((var_1_9) > (var_1_11)) ? (var_1_9) : (var_1_11))) < 0 ) ? -((((var_1_9) > (var_1_11)) ? (var_1_9) : (var_1_11))) : ((((var_1_9) > (var_1_11)) ? (var_1_9) : (var_1_11)))))) : ((64.6f + var_1_21))));
 } else {
  var_1_41 = (((((var_1_11) > (var_1_22)) ? (var_1_11) : (var_1_22))) + ((var_1_21 - var_1_42) + var_1_12));
 }
 if (((((var_1_41) > (var_1_14)) ? (var_1_41) : (var_1_14))) < ((((var_1_20) > (var_1_20)) ? (var_1_20) : (var_1_20)))) {
  var_1_57 = ((((((((7.4f) < ((var_1_21 - 63.6f))) ? (7.4f) : ((var_1_21 - 63.6f))))) > (((((var_1_11) > (var_1_22)) ? (var_1_11) : (var_1_22))))) ? (((((7.4f) < ((var_1_21 - 63.6f))) ? (7.4f) : ((var_1_21 - 63.6f))))) : (((((var_1_11) > (var_1_22)) ? (var_1_11) : (var_1_22))))));
 }
 ...
 if (((last_1_var_1_1 * var_1_35) >= var_1_50) && stepLocal_2) {
  var_1_1 = (var_1_35 - ((((last_1_var_1_1) > (var_1_40)) ? (last_1_var_1_1) : (var_1_40))));
 } else {
  if ((65169 - last_1_var_1_1) < stepLocal_1) {
   var_1_1 = (((((last_1_var_1_1) < (var_1_35)) ? (last_1_var_1_1) : (var_1_35))) - var_1_40);
  } else {
 ...
 if (var_1_35 <= -32) {
  if (var_1_35 >= var_1_16) {
   if ((((((var_1_35) > (var_1_15)) ? (var_1_35) : (var_1_15))) / var_1_36) != (((((-64 >> var_1_35)) < (var_1_15)) ? ((-64 >> var_1_35)) : (var_1_15)))) {
    var_1_38 = var_1_50;
   } else {
    if (((((var_1_35) < (var_1_17)) ? (var_1_35) : (var_1_17))) < (var_1_1 & -128)) {
     var_1_38 = ((var_1_32 + var_1_39) - var_1_35);
    } else {
     var_1_38 = (((((var_1_35 + var_1_32)) < (var_1_37)) ? ((var_1_35 + var_1_32)) : (var_1_37)));
    }
   }
  } else {
 ...
 if (stepLocal_9 || var_1_25) {
  if ((var_1_18 / var_1_16) >= stepLocal_8) {
   var_1_28 = (((((var_1_40 + var_1_19)) < ((var_1_30 + (var_1_16 + var_1_40)))) ? ((var_1_40 + var_1_19)) : ((var_1_30 + (var_1_16 + var_1_40)))));
  } else {
 ...
 if ((var_1_48 * var_1_9) != ((((var_1_12) < (var_1_52)) ? (var_1_12) : (var_1_52)))) {
 ...
 signed long int stepLocal_6 = (((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19));
 unsigned char stepLocal_5 = ((((var_1_21) < (var_1_20)) ? (var_1_21) : (var_1_20))) != var_1_10;
 ...
 if (((((var_1_35) < (var_1_36)) ? (var_1_35) : (var_1_36))) < stepLocal_17) {
  var_1_53 = var_1_49;
 } else {
  if (var_1_25) {
   if ((var_1_52 >= var_1_21) && stepLocal_18) {
    ...
    if (! var_1_23) {
     var_1_53 = ((((var_1_40) < ((var_1_33 + var_1_1))) ? (var_1_40) : ((var_1_33 + var_1_1))));
    } else {
     var_1_53 = ((((var_1_33) < 0 ) ? -(var_1_33) : (var_1_33)));
    }
   }
  } else {
