...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch48Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_20 = var_1_11;
 if (var_1_2 || (2.65f > var_1_3)) {
  var_1_22 = (! (! var_1_25));
 }
 if (var_1_2) {
  var_1_26 = (! ((var_1_9 >= var_1_5) && var_1_28));
 }
 if (var_1_2) {
  var_1_29 = ((((var_1_4) < (var_1_4)) ? (var_1_4) : (var_1_4)));
 }
 if ((((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15))) - ((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16)))) <= var_1_11) {
  var_1_32 = ((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17)));
 }
 if ((var_1_16 & var_1_15) <= ((var_1_15 - var_1_16) + -16)) {
  var_1_36 = var_1_25;
 } else {
  if (var_1_28) {
   var_1_36 = (! (! var_1_37));
 ...
 if (((var_1_11 | 1) % var_1_15) >= (var_1_11 >> var_1_16)) {
  var_1_38 = (((((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15))) < 0 ) ? -((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15))) : ((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15)))));
 }
 if (var_1_37) {
  var_1_40 = (((((var_1_41) > (var_1_42)) ? (var_1_41) : (var_1_42))) + ((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))));
 }
 if (var_1_2) {
  var_1_44 = (-5 + var_1_16);
 }
