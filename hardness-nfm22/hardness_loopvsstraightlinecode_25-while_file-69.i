...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch6925_while.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_17 = var_1_11;
 var_1_18 = var_1_13;
 signed long int stepLocal_0 = var_1_17 * ((((var_1_17) < (var_1_17)) ? (var_1_17) : (var_1_17)));
