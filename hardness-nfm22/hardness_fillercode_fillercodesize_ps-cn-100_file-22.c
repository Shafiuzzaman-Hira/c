...
void step(void) {
	...
	// From: CodeObject3
	if ((~ var_1_33) > (abs (200))) {
		var_1_35 = (abs (var_1_36));
	} else {
		var_1_35 = ((min ((abs (var_1_37)) , var_1_38)) - (abs (var_1_39)));
	}


	// From: CodeObject4
	if ((abs (var_1_41)) < (var_1_34 << (abs (1)))) {
		if (var_1_42) {
			var_1_40 = (abs (-16));
		}
	} else {
	...
	if (var_1_42) {
		if (var_1_47 || (var_1_45 > var_1_30)) {
			var_1_46 = (abs (var_1_43 - var_1_45));
		} else {
			if (var_1_34 >= ((abs (var_1_43)) - var_1_45)) {
				var_1_46 = (abs (var_1_44 + (min (var_1_43 , var_1_48))));
			} else {
				var_1_46 = ((var_1_44 - var_1_43) + var_1_48);
			}
		}
	} else {
		if ((min (var_1_49 , var_1_50)) <= (var_1_51 - 127.375f)) {
			var_1_46 = var_1_48;
		}
	}
	...
	// From: CodeObject6
	var_1_52 = (abs (min (var_1_43 , var_1_53)));


	// From: CodeObject7
	if (((min (var_1_43 , var_1_29)) >> (abs (var_1_55))) >= var_1_35) {
		if (var_1_39 <= var_1_44) {
			if ((var_1_52 ^ 4) < var_1_29) {
				var_1_54 = (max (var_1_43 , (3462168556u - 64u)));
			} else {
				var_1_54 = (var_1_44 + var_1_45);
			}
		} else {
			var_1_54 = (min (var_1_45 , (abs (min (var_1_36 , var_1_39)))));
		}
	} else {
		var_1_54 = (min (var_1_45 , (max ((abs (2u)) , var_1_36))));
	}


	// From: CodeObject8
	if (var_1_49 > var_1_51) {
		var_1_56 = (abs (min (var_1_48 , var_1_57)));
	} else {
		var_1_56 = (max (var_1_44 , (16 + var_1_46)));
	}
	...
	// From: Req8Batch22PS_CN_100
	if ((- 3.75) < (min (var_1_20 , var_1_22))) {
		var_1_27 = 0;
	}


	// From: Req2Batch22PS_CN_100
