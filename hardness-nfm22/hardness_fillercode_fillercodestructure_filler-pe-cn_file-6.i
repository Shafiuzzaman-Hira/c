...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch6Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_21) {
  ...
  var_1_33 = ((((((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25)))) > (var_1_29)) ? (((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25)))) : (var_1_29)));
 }
