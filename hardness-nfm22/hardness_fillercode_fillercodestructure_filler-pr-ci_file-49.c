...
void step(void) {
	...
	// From: CodeObject6
	if ((abs (var_1_23)) > var_1_1) {
		var_1_36 = (max (var_1_17 , var_1_33));
	}
	...
	// From: CodeObject3
	if ((var_1_20 % (min (var_1_23 , var_1_23))) < var_1_8) {
	...
	// From: CodeObject4
	if ((var_1_20 <= (max (100 , var_1_19))) || ((- var_1_23) <= var_1_23)) {
		var_1_31 = var_1_20;
	} else {
		var_1_31 = var_1_23;
	}
	...
	// From: CodeObject5
	if (var_1_5 >= var_1_20) {
		var_1_32 = ((max (var_1_33 , var_1_34)) - (abs (var_1_18)));
	} else {
