...
void step(void) {
	...
	// From: CodeObject6
	if (var_1_7 >= (~ (max (var_1_5 , var_1_44)))) {
		if (var_1_1 >= (~ var_1_22)) {
	...
	// From: CodeObject2
	if ((var_1_7 * var_1_21) < (abs (var_1_5))) {
		if (var_1_7 <= var_1_5) {
			var_1_29 = var_1_21;
		} else {
			var_1_29 = var_1_7;
	...
	if (var_1_7 < (var_1_18 / var_1_9)) {
		...
		if (((abs (var_1_23)) / var_1_9) < var_1_18) {
			var_1_36 = var_1_6;
		}
	}
	...
	// From: CodeObject3
	if (var_1_6 < (max (var_1_8 , var_1_7))) {
		if (var_1_27) {
			var_1_35 = var_1_6;
		}
	}
