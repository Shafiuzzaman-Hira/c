...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch85Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_17) {
  if ((var_1_14 - ((((var_1_14) < (var_1_14)) ? (var_1_14) : (var_1_14)))) <= var_1_15) {
   var_1_21 = var_1_27;
  }
 }
 if (! var_1_6) {
  if ((var_1_9 + var_1_13) >= ((var_1_15 + var_1_14) << ((((5) < (var_1_39)) ? (5) : (var_1_39))))) {
   if (var_1_5 && (4.166 >= var_1_11)) {
 ...
 if ((((((var_1_20 - var_1_20)) < (var_1_20)) ? ((var_1_20 - var_1_20)) : (var_1_20))) > (var_1_11 * 31.3)) {
  if (var_1_5) {
   var_1_31 = var_1_35;
  }
 } else {
