...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch11Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject3
	if (var_1_9 <= (min (var_1_18 , (var_1_9 >> var_1_7)))) {
	...
	if (var_1_16 >= var_1_16) {
		if ((var_1_27 >> (var_1_34 + var_1_35)) <= var_1_9) {
