...
void step(void) {
	...
	// From: Req5Batch91stepLocals
	if (var_1_11 < 5) {
		var_1_17 = (max (var_1_18 , (var_1_19 - var_1_20)));
	}


	// From: Req6Batch91stepLocals
	if (var_1_10) {
	...
	// From: Req7Batch91stepLocals
	var_1_24 = var_1_25;


	// From: Req8Batch91stepLocals
	var_1_26 = var_1_11;
}
