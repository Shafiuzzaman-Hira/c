...
void step(void) {
	...
	if ((var_1_23 / var_1_26) <= var_1_32) {
		...
		var_1_33 = (abs (abs (51173 - var_1_32)));
	}


	// From: CodeObject5
	if (var_1_24) {
		if ((abs (var_1_30 + var_1_31)) > var_1_23) {
	...
	if (var_1_28 > var_1_33) {
		var_1_38 = (max ((min (var_1_29 , var_1_32)) , var_1_39));
	} else {
		var_1_38 = var_1_32;
	}
	...
	if (var_1_36 < var_1_35) {
		...
		if (var_1_24 || var_1_22) {
			if (var_1_34 >= ((min (var_1_36 , var_1_35)) * var_1_41)) {
				var_1_40 = (var_1_42 + (var_1_33 + (abs (var_1_29))));
			} else {
				var_1_40 = (abs (var_1_38 + var_1_42));
			}
		}
	}
	...
	// From: CodeObject9
	var_1_43 = (54195 - (abs (max (var_1_32 , var_1_29))));


	// From: CodeObject10
	if (var_1_36 >= var_1_35) {
		var_1_44 = (abs (var_1_45 - var_1_32));
	} else {
		var_1_44 = var_1_32;
	}
	...
	// From: CodeObject11
	if ((var_1_27 / (abs (var_1_26))) <= var_1_38) {
		if (var_1_39 < (abs (var_1_27))) {
			var_1_46 = var_1_39;
		} else {
			var_1_46 = (abs (var_1_45));
		}
	} else {
		var_1_46 = (max (100 , (min (var_1_45 , 4))));
	}
	...
	if (var_1_23 <= var_1_26) {
		var_1_48 = ((max (var_1_32 , (var_1_29 + var_1_31))) + var_1_30);
	} else {
		var_1_48 = -32;
	}


	// From: Req1Batch58PS_CN_100
	...
	// From: Req4Batch58PS_CN_100
	var_1_12 = (min (var_1_13 , var_1_14));


	// From: Req5Batch58PS_CN_100
	if (var_1_7) {
		var_1_15 = ((min (32 , (16 + var_1_16))) - var_1_17);
	}


	// From: Req6Batch58PS_CN_100
