...
void step(void) {
	// From: Req4Batch2Filler_PE_CI
	if ((var_1_15 - (min (0 , var_1_16))) > last_1_var_1_6) {
		var_1_14 = var_1_12;
	}


	// From: Req3Batch2Filler_PE_CI
	...
	// From: Req7Batch2Filler_PE_CI
	var_1_20 = var_1_16;


	// From: Req8Batch2Filler_PE_CI
	var_1_21 = var_1_16;


	// From: Req5Batch2Filler_PE_CI
	...
	if (((var_1_4 + 127.75f) * var_1_13) < var_1_13) {
		if ((abs (var_1_16)) <= ((min (var_1_20 , var_1_15)) & var_1_16)) {
			var_1_27 = var_1_30;
		}
	}
	...
	if (var_1_13 == var_1_13) {
		if (var_1_13 >= var_1_13) {
			if (! var_1_18) {
				var_1_32 = (var_1_12 - (max (var_1_12 , var_1_36)));
			}
		}
	} else {
	...
	if (128 != ((var_1_16 >> 4) & var_1_16)) {
		var_1_40 = (max (var_1_36 , var_1_4));
	}


	// From: CodeObject7
	if ((var_1_16 / var_1_42) < var_1_20) {
		var_1_41 = (abs (abs (max (var_1_30 , var_1_6))));
	} else {
		var_1_41 = -256;
	}
}
