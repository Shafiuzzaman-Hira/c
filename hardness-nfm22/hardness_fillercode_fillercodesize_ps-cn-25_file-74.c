...
void step(void) {
	...
	if (var_1_33) {
		if (var_1_28 <= var_1_31) {
			var_1_34 = (max (var_1_26 , (min (25 , (abs (var_1_35))))));
		}
	} else {
		var_1_34 = (min (var_1_36 , var_1_35));
	}
