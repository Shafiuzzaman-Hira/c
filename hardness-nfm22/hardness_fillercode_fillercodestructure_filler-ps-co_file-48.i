...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch48Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((((((var_1_33) < 0 ) ? -(var_1_33) : (var_1_33))) - ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34)))) <= var_1_8) {
  var_1_32 = ((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35)));
 }
 if ((var_1_34 & var_1_18) <= ((var_1_33 - var_1_8) + -16)) {
  var_1_36 = var_1_25;
 } else {
  if (var_1_28) {
   var_1_36 = (! (! var_1_37));
 ...
 if (((var_1_12 | 1) % var_1_33) >= (var_1_8 >> var_1_34)) {
