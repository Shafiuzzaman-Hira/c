...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch41PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch41PS_CN_10
	if (var_1_1) {
		var_1_15 = var_1_16;
	}


	// From: Req8Batch41PS_CN_10
	var_1_22 = 1;


	// From: Req9Batch41PS_CN_10
	var_1_23 = var_1_22;


	// From: Req3Batch41PS_CN_10
