...
void step(void) {
	...
	// From: CodeObject2
	if (8.4 <= var_1_15) {
		var_1_28 = (abs (min (var_1_5 , var_1_1)));
	} else {
		var_1_28 = (abs (var_1_5));
	}
	...
	// From: CodeObject1
	if (var_1_4 <= ((min (var_1_6 , var_1_4)) >> (var_1_26 - var_1_27))) {
		var_1_22 = (max (var_1_4 , var_1_6));
	} else {
		var_1_22 = var_1_4;
	}
	...
	if (var_1_20) {
		if (var_1_20) {
			...
			var_1_34 = (min ((abs (min (var_1_18 , var_1_18))) , var_1_16));
		}
	}
}
