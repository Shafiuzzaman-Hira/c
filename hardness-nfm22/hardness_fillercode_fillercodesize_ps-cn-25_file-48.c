...
void step(void) {
	...
	if (var_1_20 < var_1_21) {
		var_1_22 = (min (var_1_21 , var_1_23));
	}


	// From: CodeObject3
	if ((~ var_1_20) != (abs (var_1_23))) {
		var_1_24 = var_1_25;
	}
	...
	// From: CodeObject5
	if (var_1_23 > (var_1_25 | (max (-16 , var_1_20)))) {
	...
	// From: Req4Batch48PS_CN_25
	if (var_1_2) {
		var_1_13 = var_1_11;
	}


	// From: Req6Batch48PS_CN_25
	if (var_1_8 == var_1_13) {
