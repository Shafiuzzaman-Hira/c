...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch64Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_40 <= 100u) {
  if ((var_1_43 - ((((-2) < 0 ) ? -(-2) : (-2)))) == (var_1_31 + -4)) {
   var_1_42 = var_1_44;
  }
 } else {
  var_1_42 = 16;
 ...
 if (var_1_35 > var_1_34) {
  var_1_46 = (((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))) - ((((var_1_44) < (((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39))))) ? (var_1_44) : (((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39)))))));
 } else {
  if (var_1_35 <= var_1_30) {
   var_1_46 = (var_1_45 - var_1_42);
  } else {
   var_1_46 = var_1_31;
  }
 }
