...
void step(void) {
	...
	// From: Req4Batch20100_1loop
	var_1_10 = (var_1_11 - last_1_var_1_20);


	// From: Req5Batch20100_1loop
	...
	// From: Req8Batch20100_1loop
	if (! (var_1_2 && var_1_3)) {
		var_1_22 = ((var_1_21 > var_1_11) && (! 1));
	}


	// From: Req12Batch20100_1loop
	var_1_32 = var_1_5;


	// From: Req13Batch20100_1loop
	var_1_33 = var_1_15;


	// From: Req1Batch20100_1loop
