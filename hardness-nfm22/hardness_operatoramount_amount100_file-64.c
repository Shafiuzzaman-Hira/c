...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch64Amount100.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req10Batch64Amount100
	signed long int stepLocal_4 = last_1_var_1_32;
	unsigned long int stepLocal_3 = 128u;
	if ((last_1_var_1_8 * (max (var_1_21 , last_1_var_1_29))) >= stepLocal_4) {
		if (var_1_18 <= stepLocal_3) {
			if (var_1_4 == (min (var_1_5 , last_1_var_1_1))) {
				var_1_28 = var_1_22;
			} else {
				var_1_28 = var_1_22;
			}
	...
	// From: Req6Batch64Amount100
	var_1_17 = (var_1_18 - var_1_28);


	// From: Req12Batch64Amount100
	signed long int stepLocal_7 = min (var_1_30 , var_1_31);
	signed long int stepLocal_6 = last_1_var_1_8 / var_1_24;
	if (128 >= stepLocal_7) {
		if (stepLocal_6 < (max ((last_1_var_1_17 | var_1_20) , last_1_var_1_16))) {
			var_1_32 = (((var_1_33 + var_1_34) + var_1_22) - (min (var_1_21 , var_1_35)));
		} else {
			var_1_32 = var_1_34;
		}
	} else {
	...
	// From: Req11Batch64Amount100
	unsigned long int stepLocal_5 = var_1_20 + last_1_var_1_23;
	if (stepLocal_5 <= var_1_21) {
		var_1_29 = (max ((min ((var_1_30 - var_1_21) , var_1_22)) , (1 + var_1_31)));
	}


	// From: Req3Batch64Amount100
	if (var_1_5 > var_1_4) {
		var_1_11 = (var_1_5 - (var_1_6 + (max (var_1_12 , var_1_13))));
	}


	// From: Req7Batch64Amount100
	var_1_19 = (var_1_20 - (var_1_21 - var_1_22));


	// From: Req2Batch64Amount100
	unsigned char stepLocal_0 = var_1_29;
	if (var_1_11 <= (max (49.4f , var_1_5))) {
		if (var_1_6 <= var_1_11) {
			if (((max (var_1_32 , var_1_19)) * var_1_19) <= stepLocal_0) {
				var_1_8 = var_1_32;
			} else {
				var_1_8 = var_1_19;
			}
	...
	// From: Req8Batch64Amount100
	if ((max (7.2 , 10.86)) >= (var_1_12 - var_1_5)) {
		var_1_23 = (min (var_1_21 , var_1_22));
	} else {
		if (var_1_19 >= ((var_1_24 - var_1_8) - (abs (var_1_17)))) {
			var_1_23 = var_1_22;
		} else {
			var_1_23 = var_1_29;
		}
	...
	// From: Req4Batch64Amount100
	unsigned long int stepLocal_1 = min (var_1_16 , (var_1_29 - var_1_23));
	if (stepLocal_1 >= var_1_32) {
		var_1_14 = var_1_15;
	}


	// From: Req1Batch64Amount100
...
int property() {
	return ((((((((((((var_1_28 <= var_1_19) ? (var_1_1 == ((float) (abs (var_1_4 + (var_1_5 - var_1_6))))) : (var_1_14 ? (var_1_1 == ((float) (max (var_1_6 , var_1_5)))) : 1)) && ((var_1_11 <= (max (49.4f , var_1_5))) ? ((var_1_6 <= var_1_11) ? ((((max (var_1_32 , var_1_19)) * var_1_19) <= var_1_29) ? (var_1_8 == ((signed long int) var_1_32)) : (var_1_8 == ((signed long int) var_1_19))) : (var_1_8 == ((signed long int) var_1_32))) : (var_1_8 == ((signed long int) var_1_19)))) && ((var_1_5 > var_1_4) ? (var_1_11 == ((double) (var_1_5 - (var_1_6 + (max (var_1_12 , var_1_13)))))) : 1)) && (((min (var_1_16 , (var_1_29 - var_1_23))) >= var_1_32) ? (var_1_14 == ((unsigned char) var_1_15)) : 1)) && ((var_1_5 <= var_1_13) ? (var_1_16 == ((signed short int) var_1_32)) : (var_1_16 == ((signed short int) (var_1_32 - 4))))) && (var_1_17 == ((unsigned long int) (var_1_18 - var_1_28)))) && (var_1_19 == ((signed char) (var_1_20 - (var_1_21 - var_1_22))))) && (((max (7.2 , 10.86)) >= (var_1_12 - var_1_5)) ? (var_1_23 == ((unsigned long int) (min (var_1_21 , var_1_22)))) : ((var_1_19 >= ((var_1_24 - var_1_8) - (abs (var_1_17)))) ? (var_1_23 == ((unsigned long int) var_1_22)) : (var_1_23 == ((unsigned long int) var_1_29))))) && ((var_1_28 >= var_1_32) ? (var_1_25 == ((double) ((var_1_26 + var_1_27) + var_1_13))) : ((var_1_1 >= var_1_11) ? (var_1_25 == ((double) var_1_4)) : 1))) && (((last_1_var_1_8 * (max (var_1_21 , last_1_var_1_29))) >= last_1_var_1_32) ? ((var_1_18 <= 128u) ? ((var_1_4 == (min (var_1_5 , last_1_var_1_1))) ? (var_1_28 == ((unsigned char) var_1_22)) : (var_1_28 == ((unsigned char) var_1_22))) : (var_1_28 == ((unsigned char) var_1_21))) : (var_1_28 == ((unsigned char) var_1_22)))) && (((var_1_20 + last_1_var_1_23) <= var_1_21) ? (var_1_29 == ((unsigned char) (max ((min ((var_1_30 - var_1_21) , var_1_22)) , (1 + var_1_31))))) : 1)) && ((128 >= (min (var_1_30 , var_1_31))) ? (((last_1_var_1_8 / var_1_24) < (max ((last_1_var_1_17 | var_1_20) , last_1_var_1_16))) ? (var_1_32 == ((signed char) (((var_1_33 + var_1_34) + var_1_22) - (min (var_1_21 , var_1_35))))) : (var_1_32 == ((signed char) var_1_34))) : (var_1_32 == ((signed char) var_1_21)))
;
}
int main(void) {
	isInitial = 1;
