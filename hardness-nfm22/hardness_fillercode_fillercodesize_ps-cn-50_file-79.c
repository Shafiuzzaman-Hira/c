...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch79PS_CN_50.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (((var_1_36 * var_1_28) | var_1_30) <= (var_1_31 + 8u)) {
		if ((min (16u , var_1_31)) < var_1_28) {
			...
			var_1_45 = ((var_1_28 != (var_1_31 % var_1_47)) || var_1_48);
		}
	}
	...
	// From: CodeObject7
	if (0.83f > var_1_35) {
		if ((var_1_44 + (abs (var_1_42))) <= var_1_43) {
			var_1_49 = var_1_35;
		}
	} else {
		var_1_49 = var_1_35;
	...
	// From: Req7Batch79PS_CN_50
	var_1_26 = var_1_16;


	// From: Req8Batch79PS_CN_50
	var_1_27 = 10u;


	// From: Req3Batch79PS_CN_50
