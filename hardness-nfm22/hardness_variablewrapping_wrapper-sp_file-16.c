...
void step(void) {
	// From: Req1Batch16Wrapper_SP
	if ((last_1_WrapperStruct00_var_1_9 % (max ((*(WrapperStruct00_var_1_3_Pointer)) , (*(WrapperStruct00_var_1_4_Pointer))))) <= -1000000) {
		(*(WrapperStruct00_var_1_1_Pointer)) = ((*(WrapperStruct00_var_1_5_Pointer)) || (*(WrapperStruct00_var_1_6_Pointer)));
	}


	// From: Req2Batch16Wrapper_SP
	(*(WrapperStruct00_var_1_7_Pointer)) = (*(WrapperStruct00_var_1_8_Pointer));


	// From: Req4Batch16Wrapper_SP
	...
	if ((*(WrapperStruct00_var_1_8_Pointer)) < ((*(WrapperStruct00_var_1_7_Pointer)) / (*(WrapperStruct00_var_1_10_Pointer)))) {
		if ((*(WrapperStruct00_var_1_1_Pointer)) || stepLocal_0) {
			(*(WrapperStruct00_var_1_9_Pointer)) = (((max ((*(WrapperStruct00_var_1_11_Pointer)) , 5)) + ((*(WrapperStruct00_var_1_12_Pointer)) - (*(WrapperStruct00_var_1_13_Pointer)))) - (*(WrapperStruct00_var_1_14_Pointer)));
		} else {
