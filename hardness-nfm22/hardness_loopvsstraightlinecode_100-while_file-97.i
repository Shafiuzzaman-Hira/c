...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch97100_while.c", 13, "reach_error"); }
...
void step(void) {
 if (var_1_21 < (256.8 - var_1_20)) {
  var_1_22 = ((((var_1_18) < (var_1_17)) ? (var_1_18) : (var_1_17)));
 } else {
  var_1_22 = (var_1_17 + ((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18))));
 }
 if (((((4.8f) < 0 ) ? -(4.8f) : (4.8f))) == var_1_18) {
 ...
 if (stepLocal_5 < var_1_11) {
  if (var_1_24) {
   var_1_28 = ((((((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15)))) > (var_1_14)) ? (((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15)))) : (var_1_14)));
  } else {
 ...
 if (last_1_var_1_29 > 1.9) {
  ...
  var_1_29 = ((((var_1_21 - var_1_20) < 0 ) ? -(var_1_21 - var_1_20) : (var_1_21 - var_1_20)));
 }
 unsigned char stepLocal_6 = var_1_14;
 if (var_1_28 >= stepLocal_6) {
  var_1_30 = ((((var_1_14) < (var_1_15)) ? (var_1_14) : (var_1_15)));
 } else {
  if (! var_1_23) {
   var_1_30 = ((((-1) < 0 ) ? -(-1) : (-1)));
  }
 ...
 signed long int stepLocal_4 = (((var_1_16 - var_1_14) < 0 ) ? -(var_1_16 - var_1_14) : (var_1_16 - var_1_14));
 ...
 if (var_1_16 >= stepLocal_3) {
  ...
  if (var_1_25 > stepLocal_4) {
   var_1_19 = (((((((((499.698) > (var_1_20)) ? (499.698) : (var_1_20))) - var_1_21)) < (var_1_17)) ? ((((((499.698) > (var_1_20)) ? (499.698) : (var_1_20))) - var_1_21)) : (var_1_17)));
  } else {
   var_1_19 = 9.2;
  }
 }
 ...
 if (stepLocal_1 && var_1_23) {
  ...
  if (stepLocal_0 <= ((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28)))) {
