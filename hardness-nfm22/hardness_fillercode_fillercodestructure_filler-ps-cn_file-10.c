...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch10Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject6
	if (var_1_31 >= ((~ 128u) % (min (var_1_39 , var_1_40)))) {
		if (var_1_27) {
			var_1_38 = (max ((64 + var_1_37) , var_1_23));
		} else {
			if ((max ((var_1_36 | var_1_23) , (var_1_30 & var_1_41))) < var_1_29) {
