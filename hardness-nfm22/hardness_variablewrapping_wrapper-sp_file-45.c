...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch45Wrapper_SP.c", 13, "reach_error"); }
...
// Last'ed variables
unsigned char last_1_WrapperStruct00_var_1_18 = 64;
...
void step(void) {
	// From: Req4Batch45Wrapper_SP
	if ((((*(WrapperStruct00_var_1_2_Pointer)) + (*(WrapperStruct00_var_1_4_Pointer))) / (*(WrapperStruct00_var_1_19_Pointer))) != last_1_WrapperStruct00_var_1_18) {
		(*(WrapperStruct00_var_1_18_Pointer)) = (*(WrapperStruct00_var_1_20_Pointer));
	}


	// From: Req1Batch45Wrapper_SP
	if (((*(WrapperStruct00_var_1_18_Pointer)) / 32) < (min (((*(WrapperStruct00_var_1_18_Pointer)) + (*(WrapperStruct00_var_1_18_Pointer))) , (*(WrapperStruct00_var_1_18_Pointer))))) {
		(*(WrapperStruct00_var_1_1_Pointer)) = (((*(WrapperStruct00_var_1_6_Pointer)) - (*(WrapperStruct00_var_1_7_Pointer))) - (*(WrapperStruct00_var_1_8_Pointer)));
	} else {
		(*(WrapperStruct00_var_1_1_Pointer)) = ((*(WrapperStruct00_var_1_8_Pointer)) - (*(WrapperStruct00_var_1_7_Pointer)));
	}


	// From: Req3Batch45Wrapper_SP
	if ((*(WrapperStruct00_var_1_18_Pointer)) == (*(WrapperStruct00_var_1_18_Pointer))) {
		if ((*(WrapperStruct00_var_1_10_Pointer))) {
			...
			(*(WrapperStruct00_var_1_12_Pointer)) = ((((*(WrapperStruct00_var_1_8_Pointer)) >= (*(WrapperStruct00_var_1_1_Pointer))) || (*(WrapperStruct00_var_1_15_Pointer))) && (((*(WrapperStruct00_var_1_13_Pointer)) || (*(WrapperStruct00_var_1_16_Pointer))) && (*(WrapperStruct00_var_1_17_Pointer))));
		}
	}


	// From: Req2Batch45Wrapper_SP
	if ((*(WrapperStruct00_var_1_12_Pointer))) {
		(*(WrapperStruct00_var_1_9_Pointer)) = ((min ((*(WrapperStruct00_var_1_8_Pointer)) , (*(WrapperStruct00_var_1_6_Pointer)))) - ((*(WrapperStruct00_var_1_11_Pointer)) - 0.8f));
	}
}
...
void updateVariables() {
	...
	assume_abort_if_not((WrapperStruct00.var_1_6 >= 4611686.018427382800e+12F && WrapperStruct00.var_1_6 <= -1.0e-20F) || (WrapperStruct00.var_1_6 <= 9223372.036854765600e+12F && WrapperStruct00.var_1_6 >= 1.0e-20F ));
	WrapperStruct00.var_1_7 = __VERIFIER_nondet_double();
	assume_abort_if_not((WrapperStruct00.var_1_7 >= 0.0F && WrapperStruct00.var_1_7 <= -1.0e-20F) || (WrapperStruct00.var_1_7 <= 4611686.018427382800e+12F && WrapperStruct00.var_1_7 >= 1.0e-20F ));
	WrapperStruct00.var_1_8 = __VERIFIER_nondet_double();
	assume_abort_if_not((WrapperStruct00.var_1_8 >= 0.0F && WrapperStruct00.var_1_8 <= -1.0e-20F) || (WrapperStruct00.var_1_8 <= 9223372.036854765600e+12F && WrapperStruct00.var_1_8 >= 1.0e-20F ));
