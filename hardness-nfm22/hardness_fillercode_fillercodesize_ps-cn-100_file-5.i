...
void step(void) {
 ...
 if (-256 < (var_1_24 * 10)) {
  ...
  var_1_39 = ((((9.75) < (((((((((var_1_42) < 0 ) ? -(var_1_42) : (var_1_42)))) > (((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))))) ? (((((var_1_42) < 0 ) ? -(var_1_42) : (var_1_42)))) : (((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41)))))))) ? (9.75) : (((((((((var_1_42) < 0 ) ? -(var_1_42) : (var_1_42)))) > (((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))))) ? (((((var_1_42) < 0 ) ? -(var_1_42) : (var_1_42)))) : (((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41)))))))));
 }
 ...
 if (var_1_25 > var_1_27) {
  ...
  if (var_1_39 < var_1_31) {
   if (var_1_45) {
    ...
    var_1_46 = ((((var_1_23) < ((((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30))) + var_1_27))) ? (var_1_23) : ((((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30))) + var_1_27))));
   }
  } else {
   var_1_46 = (var_1_26 - var_1_23);
  }
 }
 if ((var_1_24 & 2) > ((((var_1_28) > (var_1_48)) ? (var_1_28) : (var_1_48)))) {
  if (var_1_37 < var_1_36) {
   var_1_47 = (var_1_33 || var_1_45);
  }
 }
 if (var_1_45) {
  if (var_1_47 || (var_1_40 > ((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))))) {
   var_1_49 = (var_1_50 - ((((var_1_27) < (var_1_23)) ? (var_1_27) : (var_1_23))));
  }
 } else {
  var_1_49 = ((((var_1_26) > (((var_1_51 + var_1_52) - ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)))))) ? (var_1_26) : (((var_1_51 + var_1_52) - ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)))))));
 }
 if ((var_1_48 >> var_1_52) >= (var_1_27 - var_1_25)) {
  var_1_53 = ((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36)));
 }
