...
void step(void) {
	...
	// From: CodeObject8
	if ((var_1_8 + (min (var_1_1 , var_1_38))) <= var_1_6) {
		if (var_1_37) {
			var_1_41 = var_1_38;
		}
	}
	...
	if (var_1_27 || (var_1_18 <= var_1_18)) {
		if ((var_1_1 | (var_1_6 * var_1_6)) == (min (var_1_17 , -32))) {
			var_1_29 = (max ((abs (var_1_1)) , var_1_1));
		} else {
			var_1_29 = (abs (min (var_1_1 , (abs (var_1_1)))));
		}
	} else {
	...
	// From: CodeObject4
	if (var_1_24) {
		if (var_1_15 > (var_1_20 / (abs (var_1_25)))) {
			var_1_23 = 100;
		} else {
			var_1_23 = 10;
		}
