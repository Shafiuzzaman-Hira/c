...
void step(void) {
	...
	// From: CodeObject4
	if ((min (var_1_30 , (abs (var_1_45)))) > (var_1_41 | (abs (var_1_34)))) {
	...
	if (var_1_42) {
		...
		if (var_1_44) {
			if ((min (32 , var_1_35)) > (var_1_33 | (abs (var_1_41)))) {
	...
	// From: CodeObject6
	if ((max (var_1_48 , (var_1_28 ^ var_1_49))) > (var_1_31 * 128u)) {
		var_1_53 = (var_1_54 - (abs (-16)));
	} else {
		var_1_53 = var_1_54;
	}
	...
	if (var_1_40) {
		if (! var_1_32) {
			var_1_55 = (abs (min ((var_1_56 + var_1_57) , (abs (var_1_58)))));
		}
	}
	...
	// From: CodeObject10
	if (((var_1_53 / var_1_62) << (max (8 , var_1_63))) < var_1_58) {
		if (((max (var_1_64 , var_1_65)) - var_1_66) > var_1_37) {
			var_1_61 = var_1_54;
		}
	}
	...
	if (var_1_34 <= var_1_58) {
		if (var_1_66 == ((abs (var_1_65)) - var_1_64)) {
			var_1_67 = (abs (var_1_63));
		} else {
			var_1_67 = (abs (var_1_63 - (var_1_68 - var_1_69)));
		}
	} else {
	...
	if (-8 < var_1_41) {
		...
		var_1_70 = (abs ((var_1_69 + var_1_63) - (abs (var_1_54))));
	}


	// From: CodeObject13
	if ((var_1_65 - var_1_64) <= var_1_36) {
		var_1_71 = (min (var_1_68 , (abs (var_1_56))));
	} else {
		var_1_71 = (min (0 , var_1_63));
	}


	// From: CodeObject14
	if (var_1_30 >= (abs (var_1_56))) {
		var_1_72 = (max ((min (var_1_51 , (max (var_1_61 , var_1_57)))) , var_1_71));
	}


	// From: CodeObject15
	if (var_1_65 > (max ((var_1_64 - var_1_66) , var_1_38))) {
		var_1_73 = (var_1_74 + var_1_75);
	} else {
		var_1_73 = (abs (var_1_37));
	}


	// From: CodeObject16
	if (var_1_71 > var_1_77) {
		var_1_76 = (var_1_56 + (min (var_1_63 , var_1_57)));
	}


	// From: CodeObject17
	if (((var_1_31 >> var_1_63) <= var_1_57) || (var_1_69 != var_1_71)) {
		var_1_78 = (abs (abs (max (var_1_51 , var_1_34))));
	}


	// From: CodeObject18
	if (var_1_67 < var_1_45) {
		var_1_79 = (min (var_1_75 , var_1_37));
	}


	// From: CodeObject19
	if (32 <= var_1_56) {
		var_1_80 = (abs (abs (var_1_75)));
	} else {
		if (var_1_73 > var_1_64) {
			var_1_80 = (min (var_1_37 , (max ((min (var_1_75 , var_1_74)) , (var_1_81 + var_1_82)))));
		}
	}
	...
	if (var_1_65 < var_1_81) {
		var_1_83 = (abs (var_1_63 - var_1_68));
	}
	...
	if (var_1_28 > var_1_77) {
		...
		var_1_84 = (max ((abs (var_1_34 + var_1_69)) , var_1_55));
	}


	// From: CodeObject22
	if (var_1_58 >= (var_1_77 | (64 | var_1_60))) {
		var_1_85 = (min (var_1_45 , (var_1_57 - (var_1_69 + var_1_76))));
	} else {
		if (var_1_35 > (var_1_31 | 2u)) {
			if (var_1_75 > (abs (var_1_82))) {
				var_1_85 = var_1_68;
			}
		}
	}
	...
	// From: CodeObject23
	var_1_86 = (max (var_1_63 , (var_1_87 - var_1_56)));


	// From: CodeObject24
	if ((min (var_1_83 , var_1_69)) >= -16) {
		if ((max (var_1_53 , var_1_86)) <= var_1_52) {
			var_1_88 = (max (var_1_58 , (var_1_89 - var_1_87)));
		} else {
			if (var_1_90) {
	...
	if (var_1_40 && var_1_39) {
		var_1_91 = (abs (max ((abs (var_1_92)) , var_1_82)));
	} else {
		if (var_1_74 < (min (var_1_38 , (var_1_73 / var_1_93)))) {
			var_1_91 = (var_1_94 - (min (var_1_95 , var_1_96)));
		}
	}
	...
	if ((var_1_61 <= 64) || var_1_98) {
		var_1_103 = (max ((abs (var_1_45)) , var_1_55));
	} else {
	...
	// From: Req7Batch79PS_CN_250
	var_1_26 = var_1_16;


	// From: Req8Batch79PS_CN_250
	var_1_27 = 10u;


	// From: Req3Batch79PS_CN_250
