...
void step(void) {
	...
	// From: CodeObject3
	if (var_1_21 <= var_1_9) {
		var_1_44 = (var_1_21 + (abs (max (var_1_21 , -1))));
	}
	...
	if ((var_1_13 <= var_1_12) || var_1_25) {
		if ((abs (5)) < var_1_13) {
			if (var_1_25) {
				var_1_32 = (max ((min (var_1_21 , var_1_20)) , var_1_20));
			}
		}
	}
	...
	// From: CodeObject4
	if (((~ var_1_21) >> (max (var_1_22 , var_1_22))) >= var_1_12) {
	...
	if ((~ var_1_18) > var_1_13) {
		var_1_52 = (min (((var_1_22 + var_1_9) - (abs (var_1_10))) , var_1_23));
	} else {
		var_1_52 = (min (var_1_10 , var_1_21));
	}
	...
	// From: CodeObject2
	if ((abs (4)) >= var_1_21) {
		if (((abs (var_1_8)) % (min (var_1_21 , var_1_21))) <= (var_1_23 ^ var_1_21)) {
			if ((min ((abs (var_1_8)) , var_1_21)) < var_1_21) {
				var_1_40 = var_1_43;
			} else {
				var_1_40 = var_1_43;
			}
