...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch67PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject5
	if (var_1_28) {
		if (var_1_26 > (var_1_32 - (abs (var_1_33)))) {
			var_1_31 = 1;
		}
	}
