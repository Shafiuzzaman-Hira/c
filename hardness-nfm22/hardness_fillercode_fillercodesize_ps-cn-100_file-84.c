...
void step(void) {
	...
	if (! (var_1_34 != 0)) {
		if (var_1_30 < (-256 / 32)) {
			var_1_53 = (max (var_1_44 , (min (var_1_46 , var_1_45))));
		}
	} else {
		var_1_53 = (max ((abs (var_1_46)) , (max (var_1_44 , var_1_45))));
	}


	// From: CodeObject10
	var_1_54 = (16.925 - (min (var_1_55 , var_1_56)));


	// From: CodeObject11
	if (((min (var_1_28 , var_1_24)) + var_1_54) < (var_1_56 - (abs (var_1_52)))) {
		if (var_1_49) {
			var_1_57 = (abs (abs (64)));
		}
	}
	...
	// From: CodeObject12
	if (var_1_22 >= (abs (var_1_39))) {
		if (var_1_23 > (abs (- var_1_52))) {
			if (1 <= var_1_47) {
				var_1_58 = var_1_56;
			} else {
				var_1_58 = var_1_28;
	...
	// From: Req7Batch84PS_CN_100
	var_1_18 = var_1_17;


	// From: Req8Batch84PS_CN_100
	var_1_19 = 0;


	// From: Req9Batch84PS_CN_100
	var_1_20 = var_1_21;


	// From: Req1Batch84PS_CN_100
	if (var_1_19) {
		var_1_1 = (min ((var_1_3 + (1 - var_1_4)) , var_1_5));
	}


	// From: Req4Batch84PS_CN_100
	if (var_1_3 <= var_1_1) {
		var_1_12 = var_1_4;
	} else {
