...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch56Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_16 ^ var_1_13) >= var_1_13) {
  var_1_24 = ((((((((var_1_13 + var_1_21) < 0 ) ? -(var_1_13 + var_1_21) : (var_1_13 + var_1_21)))) > (var_1_14)) ? (((((var_1_13 + var_1_21) < 0 ) ? -(var_1_13 + var_1_21) : (var_1_13 + var_1_21)))) : (var_1_14)));
 }
 if (1000000u > var_1_18) {
  var_1_31 = ((1831787952u + var_1_32) - var_1_20);
 } else {
 ...
 var_1_34 = var_1_35;
 if (var_1_16 >= ((var_1_10 + var_1_20) % (32u + var_1_32))) {
  var_1_36 = ((((((((((((var_1_32) < (var_1_20)) ? (var_1_32) : (var_1_20)))) < (((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21))))) ? (((((var_1_32) < (var_1_20)) ? (var_1_32) : (var_1_20)))) : (((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21))))))) > (var_1_13)) ? (((((((((var_1_32) < (var_1_20)) ? (var_1_32) : (var_1_20)))) < (((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21))))) ? (((((var_1_32) < (var_1_20)) ? (var_1_32) : (var_1_20)))) : (((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21))))))) : (var_1_13)));
 } else {
  var_1_36 = var_1_20;
 }
 if (var_1_22 < (var_1_18 * var_1_13)) {
  if ((var_1_16 + var_1_18) > var_1_22) {
   var_1_39 = (var_1_21 + var_1_21);
  } else {
   var_1_39 = var_1_21;
  }
 }
