...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch42dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req5Batch42dependencies
	if (((min (last_1_var_1_1 , 8)) <= var_1_5) || last_1_var_1_8) {
		if (last_1_var_1_1 <= last_1_var_1_6) {
	...
	// From: Req7Batch42dependencies
	if (var_1_14 <= var_1_15) {
		var_1_19 = (var_1_12 || var_1_20);
	}


	// From: Req2Batch42dependencies
	if (var_1_5 >= -2) {
		var_1_6 = (var_1_7 - 100);
	}


	// From: Req4Batch42dependencies
	if (last_1_var_1_13 >= (var_1_6 / var_1_7)) {
		if (var_1_6 != (max ((max (var_1_6 , last_1_var_1_13)) , var_1_5))) {
			var_1_13 = var_1_7;
		} else {
	...
	// From: Req6Batch42dependencies
	if (var_1_6 > var_1_6) {
		var_1_17 = (max (25 , (var_1_13 + var_1_6)));
	}


	// From: Req1Batch42dependencies
	if (var_1_19) {
		var_1_1 = (max (var_1_6 , var_1_6));
	} else {
		if ((abs (var_1_5)) >= var_1_6) {
			var_1_1 = var_1_5;
		}
	}


	// From: Req3Batch42dependencies
	if ((49.5f <= var_1_14) && (var_1_19 && var_1_19)) {
		if (var_1_13 < var_1_7) {
