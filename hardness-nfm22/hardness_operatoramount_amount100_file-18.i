...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch18Amount100.c", 13, "reach_error"); }
...
void step(void) {
 var_1_30 = ((((last_1_var_1_18) > ((var_1_12 + (1781986326u - var_1_16)))) ? (last_1_var_1_18) : ((var_1_12 + (1781986326u - var_1_16)))));
 unsigned long int stepLocal_1 = (((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30));
 ...
 signed long int stepLocal_3 = (((var_1_10) < ((var_1_12 + var_1_11))) ? (var_1_10) : ((var_1_12 + var_1_11)));
 if (last_1_var_1_21 <= ((((var_1_22) > (var_1_7)) ? (var_1_22) : (var_1_7)))) {
  ...
  if (last_1_var_1_38 <= stepLocal_3) {
   if (var_1_10 <= stepLocal_4) {
    ...
    var_1_34 = ((var_1_28 != ((((var_1_7) > (last_1_var_1_21)) ? (var_1_7) : (last_1_var_1_21)))) && (! (var_1_35 || var_1_36)));
   }
  } else {
   var_1_34 = var_1_37;
  }
 }
 if (((((var_1_14) > (256)) ? (var_1_14) : (256))) >= var_1_10) {
  var_1_25 = ((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)));
 } else {
  if (var_1_34) {
 ...
 if (var_1_25 <= ((var_1_7 / var_1_22) + var_1_25)) {
  var_1_21 = (((((9.8f) < (24.8f)) ? (9.8f) : (24.8f))) - var_1_24);
 } else {
  var_1_21 = var_1_24;
 }
 if (var_1_34) {
