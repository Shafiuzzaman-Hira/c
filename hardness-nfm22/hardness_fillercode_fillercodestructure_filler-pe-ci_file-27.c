...
void step(void) {
	// From: Req4Batch27Filler_PE_CI
	if (var_1_6 == (var_1_4 / var_1_13)) {
		var_1_12 = var_1_11;
	}


	// From: Req6Batch27Filler_PE_CI
	var_1_20 = var_1_11;


	// From: Req7Batch27Filler_PE_CI
	var_1_21 = 8;


	// From: Req3Batch27Filler_PE_CI
	...
	if (var_1_11 >= var_1_11) {
		var_1_31 = (max (var_1_11 , (abs (var_1_11))));
	}
	...
	if (var_1_19) {
		if ((~ (var_1_33 % var_1_39)) <= var_1_12) {
			var_1_38 = (max (var_1_11 , (max (var_1_11 , (abs (var_1_11))))));
		}
	}


	// From: CodeObject7
	if ((min (var_1_11 , var_1_33)) < (var_1_39 + var_1_12)) {
		var_1_43 = (min (var_1_11 , (max ((100 + var_1_11) , (abs (var_1_11))))));
	}
