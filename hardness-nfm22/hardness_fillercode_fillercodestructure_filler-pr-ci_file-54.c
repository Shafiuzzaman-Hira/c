...
void step(void) {
	...
	// From: CodeObject2
	if (var_1_8 >= var_1_8) {
		var_1_25 = (max ((abs (min (9.999999999999962E13f , var_1_19))) , (abs (var_1_22))));
	} else {
		var_1_25 = ((var_1_21 + 4.1f) + (var_1_21 + (max (var_1_21 , var_1_22))));
	}
	...
	if (var_1_5 >= var_1_5) {
		...
		if (var_1_21 <= (abs (var_1_15 * var_1_16))) {
			var_1_40 = ((abs (abs (var_1_8))) + (abs (var_1_10)));
		}
	}
