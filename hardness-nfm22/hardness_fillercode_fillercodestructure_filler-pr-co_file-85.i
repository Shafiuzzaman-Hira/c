...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch85Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_5) {
  if ((var_1_13 - ((((var_1_13) < (var_1_13)) ? (var_1_13) : (var_1_13)))) <= var_1_13) {
   var_1_21 = var_1_27;
  }
 }
 if (! var_1_16) {
  if ((var_1_1 + var_1_13) >= ((var_1_12 + var_1_13) << ((((5) < (var_1_39)) ? (5) : (var_1_39))))) {
   if (var_1_5 && (4.166 >= var_1_29)) {
 ...
 var_1_30 = ((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12)));
 ...
 if ((((((var_1_32 - var_1_33)) < (var_1_29)) ? ((var_1_32 - var_1_33)) : (var_1_29))) > (var_1_7 * 31.3)) {
  if (var_1_5) {
   var_1_31 = var_1_35;
  }
 } else {
 ...
 var_1_28 = var_1_29;
 if ((var_1_18 / 25.4f) >= ((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18)))) {
