...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch66PS_CN_50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch66PS_CN_50
	if (var_1_12) {
		var_1_1 = (var_1_3 + var_1_4);
	}


	// From: Req2Batch66PS_CN_50
	...
	// From: Req8Batch66PS_CN_50
	if (var_1_12) {
		var_1_19 = ((var_1_7 - (min (var_1_20 , var_1_21))) + var_1_6);
	}


	// From: Req5Batch66PS_CN_50
