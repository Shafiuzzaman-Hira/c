...
void step(void) {
	...
	// From: Req4Batch51Filler_PS_CN
	if ((min ((~ var_1_1) , 8)) > var_1_11) {
		var_1_17 = var_1_18;
	}


	// From: Req2Batch51Filler_PS_CN
	if (! (var_1_17 > var_1_5)) {
