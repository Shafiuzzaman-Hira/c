...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch38dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch38dependencies
	if ((last_1_var_1_21 * last_1_var_1_21) < ((max (-1 , var_1_11)) - var_1_12)) {
		if ((last_1_var_1_21 + last_1_var_1_21) < var_1_12) {
			var_1_8 = var_1_13;
		}
	} else {
		var_1_8 = var_1_13;
