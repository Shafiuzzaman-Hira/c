...
void step(void) {
	...
	// From: CodeObject12
	if ((max (var_1_26 , var_1_28)) > (abs (var_1_29))) {
		var_1_56 = var_1_42;
	} else {
		var_1_56 = var_1_47;
	}
	...
	if (var_1_41 <= var_1_39) {
		var_1_57 = (abs ((min (var_1_40 , var_1_49)) - (var_1_58 - var_1_48)));
	} else {
		if ((var_1_43 % var_1_45) >= ((abs (var_1_44)) % var_1_38)) {
			var_1_57 = (var_1_41 + var_1_42);
		} else {
			if (((var_1_59 + 4.5f) - var_1_54) != var_1_60) {
				var_1_57 = ((max (var_1_41 , (abs (var_1_42)))) + var_1_40);
			}
		}
	}
	...
	// From: CodeObject14
	if (var_1_21) {
		var_1_61 = (min (var_1_54 , var_1_28));
	}
	...
	if (var_1_29 <= var_1_53) {
		var_1_63 = (abs ((min (var_1_54 , var_1_59)) - var_1_64));
	} else {
	...
	if (var_1_54 > var_1_61) {
		...
		var_1_66 = (min (var_1_67 , var_1_68));
	}


	// From: CodeObject19
	if (var_1_47 < var_1_40) {
		if (var_1_48 > (abs (var_1_34 >> var_1_58))) {
			if ((var_1_67 > var_1_32) || var_1_22) {
				var_1_69 = (abs (abs (abs (var_1_42))));
			}
		}
	} else {
		var_1_69 = (abs (var_1_42 + (var_1_70 + var_1_71)));
	}
	...
	if (var_1_28 < (var_1_64 - var_1_59)) {
		if ((var_1_29 <= var_1_51) || var_1_21) {
			if (var_1_29 > (- (- var_1_59))) {
				var_1_72 = (max (var_1_68 , (16 + (abs (var_1_71)))));
			}
		} else {
			if (var_1_52 < (max (var_1_63 , var_1_62))) {
				var_1_72 = ((var_1_71 - (8 + var_1_73)) + ((min (var_1_74 , var_1_75)) - var_1_76));
			}
		}
	} else {
		if ((var_1_32 & var_1_76) > (var_1_38 * var_1_33)) {
			var_1_72 = (min (-2 , var_1_71));
		}
	}


	// From: CodeObject21
	var_1_77 = (max (var_1_68 , 10));


	// From: CodeObject22
	if ((var_1_28 * var_1_53) <= (min ((abs (var_1_46)) , var_1_54))) {
		if (((var_1_44 + var_1_57) << var_1_74) > var_1_38) {
			if ((~ var_1_66) <= (abs (var_1_72))) {
				var_1_78 = (min (var_1_75 , 32));
			}
		} else {
			var_1_78 = (abs (var_1_68));
		}
	}
	...
	// From: CodeObject24
	if (var_1_60 < ((min (5.8 , var_1_26)) * (var_1_81 - var_1_64))) {
		var_1_80 = var_1_48;
	}
	...
	// From: Req7Batch42PS_CN_250
	if (var_1_14 <= var_1_15) {
		var_1_19 = (var_1_12 || var_1_20);
	}


	// From: Req2Batch42PS_CN_250
	if (var_1_5 >= -2) {
		var_1_6 = (var_1_7 - 100);
	}


	// From: Req4Batch42PS_CN_250
