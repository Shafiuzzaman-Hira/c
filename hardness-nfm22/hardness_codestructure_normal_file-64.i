...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch64normal.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_4 >> var_1_2) < (var_1_11 - (var_1_12 - var_1_13))) {
 ...
 if (((var_1_26 - var_1_27) + var_1_5) > var_1_22) {
