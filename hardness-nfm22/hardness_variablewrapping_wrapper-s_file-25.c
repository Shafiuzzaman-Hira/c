...
void step(void) {
	...
	// From: Req1Batch25Wrapper_S
	unsigned short int stepLocal_0 = WrapperStruct00.var_1_3;
	if (WrapperStruct00.var_1_12) {
		if (stepLocal_0 <= WrapperStruct00.var_1_4) {
			WrapperStruct00.var_1_1 = ((max (WrapperStruct00.var_1_3 , (WrapperStruct00.var_1_4 + WrapperStruct00.var_1_5))) + (WrapperStruct00.var_1_6 - WrapperStruct00.var_1_7));
		}
	} else {
	...
	// From: Req2Batch25Wrapper_S
	unsigned long int stepLocal_1 = WrapperStruct00.var_1_1;
	if (WrapperStruct00.var_1_7 >= stepLocal_1) {
		WrapperStruct00.var_1_8 = (min (0.5f , WrapperStruct00.var_1_9));
	} else {
		WrapperStruct00.var_1_8 = (min (WrapperStruct00.var_1_9 , WrapperStruct00.var_1_10));
	}


	// From: Req3Batch25Wrapper_S
	if (WrapperStruct00.var_1_10 >= (min ((max (128.175f , WrapperStruct00.var_1_9)) , WrapperStruct00.var_1_8))) {
