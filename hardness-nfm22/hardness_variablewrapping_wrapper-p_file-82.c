...
void step(void) {
	...
	if (((*(var_1_5_Pointer)) + (*(var_1_11_Pointer))) >= stepLocal_1) {
		if ((max ((*(var_1_4_Pointer)) , ((*(var_1_1_Pointer)) * (*(var_1_3_Pointer))))) <= (*(var_1_1_Pointer))) {
...
int property() {
	return ((((((! (*(var_1_2_Pointer))) ? ((*(var_1_2_Pointer)) ? ((*(var_1_1_Pointer)) == ((float) (max ((*(var_1_3_Pointer)) , (*(var_1_4_Pointer)))))) : 1) : 1) && (((last_1_var_1_5 / -2) >= (last_1_var_1_17 | last_1_var_1_12)) ? ((*(var_1_5_Pointer)) == ((unsigned char) (abs ((*(var_1_9_Pointer)))))) : ((*(var_1_5_Pointer)) == ((unsigned char) ((*(var_1_10_Pointer)) - (abs ((*(var_1_11_Pointer))))))))) && ((((*(var_1_5_Pointer)) + (*(var_1_11_Pointer))) >= (*(var_1_9_Pointer))) ? (((max ((*(var_1_4_Pointer)) , ((*(var_1_1_Pointer)) * (*(var_1_3_Pointer))))) <= (*(var_1_1_Pointer))) ? ((*(var_1_12_Pointer)) == ((unsigned char) (max ((*(var_1_11_Pointer)) , (*(var_1_14_Pointer)))))) : ((*(var_1_2_Pointer)) ? ((*(var_1_12_Pointer)) == ((unsigned char) ((*(var_1_11_Pointer)) + (*(var_1_15_Pointer))))) : 1)) : ((*(var_1_12_Pointer)) == ((unsigned char) (*(var_1_9_Pointer)))))) && ((*(var_1_16_Pointer)) == ((double) (*(var_1_4_Pointer))))) && ((*(var_1_17_Pointer)) == ((unsigned char) (*(var_1_9_Pointer))))) && ((*(var_1_18_Pointer)) == ((double) (*(var_1_3_Pointer))))
;
}
int main(void) {
	isInitial = 1;
