...
void step(void) {
 if (0.625f > last_1_double_Array_0_1_) {
  if (BOOL_unsigned_char_Array_0[0]) {
   float_Array_0[1] = ((((float_Array_0[0]) < 0 ) ? -(float_Array_0[0]) : (float_Array_0[0])));
  }
 } else {
  float_Array_0[1] = ((((float_Array_0[0]) < 0 ) ? -(float_Array_0[0]) : (float_Array_0[0])));
 }
 ...
 if (BOOL_unsigned_char_Array_0[0]) {
  if (unsigned_short_int_Array_0[0] >= ((unsigned_short_int_Array_0[1] - unsigned_short_int_Array_0[0]) * 64)) {
   double_Array_0[1] = (((((double_Array_0[0]) < (50.5)) ? (double_Array_0[0]) : (50.5))) - double_Array_0[2]);
  }
 } else {
 ...
 if (float_Array_0[0] > double_Array_0[1]) {
  signed_long_int_Array_0[0] = (((((unsigned_short_int_Array_0[0]) > (-64)) ? (unsigned_short_int_Array_0[0]) : (-64))) + ((unsigned_short_int_Array_0[0] + -2) + unsigned_short_int_Array_0[1]));
 }
}
