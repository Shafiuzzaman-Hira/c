...
void step(void) {
 ...
 if ((*(WrapperStruct00_var_1_20_Pointer)) < ((((((*(WrapperStruct00_var_1_15_Pointer))) < ((*(WrapperStruct00_var_1_15_Pointer)))) ? ((*(WrapperStruct00_var_1_15_Pointer))) : ((*(WrapperStruct00_var_1_15_Pointer))))) * (*(WrapperStruct00_var_1_15_Pointer)))) {
