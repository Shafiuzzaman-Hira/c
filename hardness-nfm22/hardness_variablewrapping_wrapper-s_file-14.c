...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch14Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((WrapperStruct00.var_1_13 / WrapperStruct00.var_1_14) <= WrapperStruct00.var_1_15) {
		if ((WrapperStruct00.var_1_16 - 2.3) > WrapperStruct00.var_1_14) {
			...
			WrapperStruct00.var_1_12 = (max (WrapperStruct00.var_1_7 , (abs (WrapperStruct00.var_1_17 - WrapperStruct00.var_1_8))));
		}
	} else {
	...
	// From: Req3Batch14Wrapper_S
	if (((WrapperStruct00.var_1_5 >= WrapperStruct00.var_1_12) && WrapperStruct00.var_1_2) && WrapperStruct00.var_1_3) {
	...
	// From: Req1Batch14Wrapper_S
	unsigned char stepLocal_0 = WrapperStruct00.var_1_9;
	if (stepLocal_0 && WrapperStruct00.var_1_9) {
