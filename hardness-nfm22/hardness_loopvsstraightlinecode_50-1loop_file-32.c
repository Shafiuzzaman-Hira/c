...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch3250_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch3250_1loop
	var_1_22 = var_1_12;


	// From: Req8Batch3250_1loop
	var_1_23 = var_1_8;


	// From: Req9Batch3250_1loop
	var_1_24 = var_1_6;
}
