...
void step(void) {
	...
	// From: Req2Batch65Wrapper_S
	if (WrapperStruct00.var_1_4 > WrapperStruct00.var_1_9) {
		WrapperStruct00.var_1_5 = ((max (WrapperStruct00.var_1_20 , -64)) + ((WrapperStruct00.var_1_20 + -2) + WrapperStruct00.var_1_18));
	}
}
