...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch84has_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch84has_floats
	if (var_1_9) {
		var_1_8 = ((var_1_10 + 23103) - (32 + var_1_6));
	}


	// From: Req4Batch84has_floats
	if (! (var_1_5 > var_1_10)) {
		var_1_16 = (32 - 8);
	} else {
	...
	// From: Req5Batch84has_floats
	var_1_17 = var_1_18;


	// From: Req3Batch84has_floats
	if (var_1_1 < var_1_16) {
