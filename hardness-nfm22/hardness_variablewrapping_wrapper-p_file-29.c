...
void step(void) {
	// From: Req5Batch29Wrapper_P
	(*(var_1_12_Pointer)) = (*(var_1_13_Pointer));


	// From: Req6Batch29Wrapper_P
	(*(var_1_14_Pointer)) = (*(var_1_11_Pointer));


	// From: Req1Batch29Wrapper_P
	if ((*(var_1_12_Pointer))) {
	...
	// From: Req2Batch29Wrapper_P
	if (((*(var_1_1_Pointer)) + 8.125) > ((*(var_1_1_Pointer)) * (*(var_1_3_Pointer)))) {
		(*(var_1_5_Pointer)) = (max (((*(var_1_14_Pointer)) + (*(var_1_14_Pointer))) , (*(var_1_14_Pointer))));
	} else {
		(*(var_1_5_Pointer)) = (*(var_1_14_Pointer));
	}


	// From: Req3Batch29Wrapper_P
	signed long int stepLocal_0 = 5 * (*(var_1_14_Pointer));
	if ((min ((*(var_1_3_Pointer)) , (*(var_1_1_Pointer)))) == (*(var_1_1_Pointer))) {
...
int property() {
	return ((((((*(var_1_12_Pointer)) ? ((*(var_1_1_Pointer)) == ((float) (*(var_1_3_Pointer)))) : ((! ((*(var_1_3_Pointer)) < (*(var_1_4_Pointer)))) ? ((*(var_1_1_Pointer)) == ((float) (abs ((*(var_1_3_Pointer)))))) : 1)) && ((((*(var_1_1_Pointer)) + 8.125) > ((*(var_1_1_Pointer)) * (*(var_1_3_Pointer)))) ? ((*(var_1_5_Pointer)) == ((unsigned short int) (max (((*(var_1_14_Pointer)) + (*(var_1_14_Pointer))) , (*(var_1_14_Pointer)))))) : ((*(var_1_5_Pointer)) == ((unsigned short int) (*(var_1_14_Pointer)))))) && (((min ((*(var_1_3_Pointer)) , (*(var_1_1_Pointer)))) == (*(var_1_1_Pointer))) ? (((*(var_1_14_Pointer)) > (5 * (*(var_1_14_Pointer)))) ? (((*(var_1_1_Pointer)) < ((*(var_1_1_Pointer)) * 256.5f)) ? ((*(var_1_9_Pointer)) == ((unsigned short int) (*(var_1_14_Pointer)))) : 1) : 1) : 1)) && (((*(var_1_1_Pointer)) < (*(var_1_3_Pointer))) ? ((*(var_1_10_Pointer)) == ((unsigned char) (*(var_1_11_Pointer)))) : 1)) && ((*(var_1_12_Pointer)) == ((unsigned char) (*(var_1_13_Pointer))))) && ((*(var_1_14_Pointer)) == ((unsigned char) (*(var_1_11_Pointer))))
;
}
int main(void) {
	isInitial = 1;
