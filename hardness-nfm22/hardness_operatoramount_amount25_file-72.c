...
void step(void) {
	// From: Req2Batch72Amount25
	if (var_1_9) {
		var_1_10 = 2u;
	}


	// From: Req3Batch72Amount25
	var_1_11 = (min ((var_1_12 + var_1_13) , (10 - var_1_14)));


	// From: Req4Batch72Amount25
	...
	// From: Req1Batch72Amount25
	if (var_1_15 < ((min (var_1_15 , var_1_15)) * var_1_15)) {
