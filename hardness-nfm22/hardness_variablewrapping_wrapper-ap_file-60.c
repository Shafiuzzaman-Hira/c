...
void step(void) {
	...
	if ((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)) > last_1_float_Array_0_5_) {
		if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
			if ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) <= (min (last_1_float_Array_0_5_ , (*(float_Array_0_arrayfloat_Array_0arrayVar4_Pointer))))) {
