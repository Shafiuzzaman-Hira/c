...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch59Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch59Filler_PE_CN
	var_1_17 = var_1_4;


	// From: Req7Batch59Filler_PE_CN
	var_1_18 = var_1_16;


	// From: Req8Batch59Filler_PE_CN
	var_1_19 = var_1_4;


	// From: Req1Batch59Filler_PE_CN
	...
	if (var_1_21 == var_1_22) {
		var_1_20 = (abs (var_1_23));
	}


	// From: CodeObject2
	if ((abs (var_1_21)) > (min (128.5f , (abs (var_1_22))))) {
		var_1_24 = (max (var_1_20 , var_1_23));
	}


	// From: CodeObject3
	if ((var_1_20 / var_1_26) < (var_1_23 | var_1_24)) {
		if ((- var_1_22) >= 256.75f) {
			var_1_25 = var_1_27;
		}
	} else {
		var_1_25 = (min (var_1_27 , 0));
	}


	// From: CodeObject4
	if ((var_1_20 ^ (~ var_1_25)) >= var_1_24) {
		var_1_28 = ((var_1_21 <= var_1_22) || var_1_29);
	}
	...
	// From: CodeObject6
	if (var_1_26 < (abs (var_1_23))) {
		if ((max (var_1_22 , var_1_21)) == (abs (var_1_32))) {
			if (-50 <= var_1_23) {
				var_1_31 = (var_1_33 - (abs (var_1_34 - var_1_35)));
			} else {
				var_1_31 = (max (var_1_33 , 25));
			}
		} else {
			if (var_1_28) {
				var_1_31 = var_1_34;
