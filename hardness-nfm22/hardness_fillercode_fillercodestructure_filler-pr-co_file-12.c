...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch12Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject6
	if (var_1_22 >= (~ (max (var_1_1 , var_1_44)))) {
		if (var_1_22 >= (~ var_1_21)) {
			var_1_47 = (var_1_44 + var_1_1);
		}
	}


	// From: Req6Batch12Filler_PR_CO
	var_1_21 = (abs (var_1_7));


	// From: CodeObject2
	if ((var_1_21 * var_1_21) < (abs (var_1_22))) {
	...
	if (var_1_21 > var_1_21) {
		if (var_1_28 && var_1_27) {
			var_1_40 = (min (var_1_1 , var_1_1));
		}
	} else {
		var_1_40 = (var_1_43 - (var_1_44 - (var_1_45 - var_1_1)));
	}
	...
	// From: CodeObject4
	if (var_1_21 < (var_1_18 / var_1_38)) {
		var_1_36 = var_1_1;
	} else {
		if (((abs (var_1_1)) / var_1_38) < var_1_1) {
			var_1_36 = var_1_1;
		}
	}
	...
	// From: CodeObject3
	if (var_1_21 < (max (var_1_22 , var_1_21))) {
		if (var_1_27) {
			var_1_35 = var_1_21;
		}
	}
