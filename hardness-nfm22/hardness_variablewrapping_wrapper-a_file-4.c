...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch4Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
	...
	unsigned long int stepLocal_2 = last_1_unsigned_long_int_Array_0_0_ / signed_short_int_Array_0[0];
	if (stepLocal_2 != (last_1_unsigned_char_Array_0_1__1_ - 64)) {
		unsigned_char_Array_0[0][0] = (max (unsigned_char_Array_0[1][0] , unsigned_char_Array_0[0][1]));
	} else {
		unsigned_char_Array_0[0][0] = (min (unsigned_char_Array_0[0][1] , unsigned_char_Array_0[1][0]));
	}


	// From: Req4Batch4Wrapper_A
	if ((- (float_Array_0[0][0] / 0.6f)) > ((float_Array_0[0][1] + 3.25f) / (min (float_Array_0[1][1] , float_Array_0[1][0])))) {
		unsigned_long_int_Array_0[0] = (500u + (min (unsigned_char_Array_0[1][0] , unsigned_char_Array_0[0][0])));
	} else {
		unsigned_long_int_Array_0[0] = (unsigned_long_int_Array_0[1] - unsigned_char_Array_0[1][0]);
	}
	...
	unsigned_short_int_Array_0[0] = unsigned_char_Array_0[1][1];


	// From: Req1Batch4Wrapper_A
	signed long int stepLocal_1 = - signed_short_int_Array_0[0];
	signed long int stepLocal_0 = unsigned_short_int_Array_0[0] / signed_short_int_Array_0[0];
	if (stepLocal_0 >= unsigned_short_int_Array_0[0]) {
		if (stepLocal_1 > unsigned_short_int_Array_0[0]) {
			unsigned_short_int_Array_0[1] = (min (unsigned_char_Array_0[0][0] , unsigned_char_Array_0[1][1]));
		}
	}
}
...
int property() {
	return ((((((unsigned_short_int_Array_0[0] / signed_short_int_Array_0[0]) >= unsigned_short_int_Array_0[0]) ? (((- signed_short_int_Array_0[0]) > unsigned_short_int_Array_0[0]) ? (unsigned_short_int_Array_0[1] == ((unsigned short int) (min (unsigned_char_Array_0[0][0] , unsigned_char_Array_0[1][1])))) : 1) : 1) && (unsigned_short_int_Array_0[0] == ((unsigned short int) unsigned_char_Array_0[1][1]))) && (((last_1_unsigned_long_int_Array_0_0_ / signed_short_int_Array_0[0]) != (last_1_unsigned_char_Array_0_1__1_ - 64)) ? (unsigned_char_Array_0[0][0] == ((unsigned char) (max (unsigned_char_Array_0[1][0] , unsigned_char_Array_0[0][1])))) : (unsigned_char_Array_0[0][0] == ((unsigned char) (min (unsigned_char_Array_0[0][1] , unsigned_char_Array_0[1][0])))))) && (((- (float_Array_0[0][0] / 0.6f)) > ((float_Array_0[0][1] + 3.25f) / (min (float_Array_0[1][1] , float_Array_0[1][0])))) ? (unsigned_long_int_Array_0[0] == ((unsigned long int) (500u + (min (unsigned_char_Array_0[1][0] , unsigned_char_Array_0[0][0]))))) : (unsigned_long_int_Array_0[0] == ((unsigned long int) (unsigned_long_int_Array_0[1] - unsigned_char_Array_0[1][0]))))) && (unsigned_char_Array_0[1][1] == ((unsigned char) unsigned_char_Array_0[0][1]))
;
}
int main(void) {
	isInitial = 1;
