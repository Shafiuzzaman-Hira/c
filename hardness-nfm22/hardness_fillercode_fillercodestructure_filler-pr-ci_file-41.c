...
void step(void) {
	...
	// From: CodeObject3
	if (var_1_14 <= (min (var_1_13 , var_1_13))) {
	...
	// From: CodeObject4
	if (var_1_14 > ((min (var_1_34 , var_1_35)) - var_1_36)) {
		if (((min (var_1_18 , var_1_16)) - var_1_18) > var_1_15) {
	...
	// From: Req8Batch41Filler_PR_CI
	var_1_22 = 1;


	// From: Req9Batch41Filler_PR_CI
	var_1_23 = var_1_22;
	...
	// From: CodeObject6
	if (((var_1_14 + var_1_14) * (abs (var_1_42))) >= var_1_35) {
		var_1_44 = (max ((abs (var_1_15)) , (abs (var_1_15))));
	}
}
