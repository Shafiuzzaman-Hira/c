...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch42no_floats.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch42no_floats
	var_1_8 = (var_1_9 + 100);


	// From: Req3Batch42no_floats
	var_1_10 = (min (var_1_11 , 64.15f));


	// From: Req1Batch42no_floats
	if (var_1_8 > var_1_8) {
		var_1_1 = ((min (var_1_8 , var_1_8)) - 10);
	} else {
		var_1_1 = (max ((var_1_8 - var_1_8) , (var_1_8 - var_1_8)));
	}


	// From: Req5Batch42no_floats
...
int property() {
	return (((((var_1_8 > var_1_8) ? (var_1_1 == ((signed long int) ((min (var_1_8 , var_1_8)) - 10))) : (var_1_1 == ((signed long int) (max ((var_1_8 - var_1_8) , (var_1_8 - var_1_8)))))) && (var_1_8 == ((unsigned char) (var_1_9 + 100)))) && (var_1_10 == ((signed long int) (min (var_1_11 , 64.15f))))) && (((- var_1_10) > var_1_11) ? (var_1_12 == ((unsigned char) (var_1_13 || (var_1_17 && (var_1_15 || var_1_16))))) : (var_1_12 == ((unsigned char) ((var_1_1 <= var_1_9) && var_1_16))))) && ((var_1_11 <= var_1_10) ? ((var_1_1 != var_1_8) ? (var_1_17 == ((unsigned char) var_1_18)) : 1) : ((var_1_8 <= 1000000) ? (var_1_17 == ((unsigned char) 0)) : (var_1_17 == ((unsigned char) 0))))
;
}
int main(void) {
	isInitial = 1;
