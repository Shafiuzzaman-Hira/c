...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch87PS_CN_10.c", 13, "reach_error"); }
...
unsigned long int var_1_43 = 200;
...
void step(void) {
	...
	// From: CodeObject5
	if (var_1_36 == ((abs (var_1_41)) - var_1_40)) {
		var_1_43 = var_1_41;
	}


	// From: Req1Batch87PS_CN_10
