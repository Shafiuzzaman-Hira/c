...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch77100_1loop.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_5 <= (last_1_var_1_18 * var_1_27)) {
  if (((((last_1_var_1_18) < (last_1_var_1_16)) ? (last_1_var_1_18) : (last_1_var_1_16))) == stepLocal_4) {
 ...
 if (var_1_35 <= var_1_27) {
  ...
  var_1_38 = (((((((var_1_13 - var_1_9) < 0 ) ? -(var_1_13 - var_1_9) : (var_1_13 - var_1_9))) < 0 ) ? -((((var_1_13 - var_1_9) < 0 ) ? -(var_1_13 - var_1_9) : (var_1_13 - var_1_9))) : ((((var_1_13 - var_1_9) < 0 ) ? -(var_1_13 - var_1_9) : (var_1_13 - var_1_9)))));
 }
 ...
 if (var_1_28 || stepLocal_1) {
  var_1_19 = (((((var_1_31 + var_1_24)) > ((-8 + var_1_18))) ? ((var_1_31 + var_1_24)) : ((-8 + var_1_18))));
 }
 signed long int stepLocal_3 = var_1_24 * (var_1_31 * var_1_16);
 if (-50 == stepLocal_3) {
  var_1_29 = ((((-500) < (var_1_18)) ? (-500) : (var_1_18)));
 } else {
  if (var_1_23) {
   var_1_29 = var_1_1;
  } else {
