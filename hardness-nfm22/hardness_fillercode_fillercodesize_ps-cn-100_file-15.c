...
void step(void) {
	...
	if ((var_1_33 / var_1_38) <= var_1_34) {
		if (var_1_36 <= (~ (max (var_1_29 , var_1_38)))) {
			var_1_37 = ((min (var_1_39 , var_1_40)) + (abs (var_1_41)));
		}
	} else {
		var_1_37 = ((abs (25 + var_1_42)) + (var_1_43 + var_1_44));
	}


	// From: CodeObject4
	if ((min ((var_1_43 >> var_1_28) , (var_1_44 - var_1_33))) <= var_1_40) {
		var_1_45 = var_1_42;
	}


	// From: CodeObject5
	if (var_1_35 < (max (-0.275 , var_1_47))) {
		var_1_46 = var_1_42;
	} else {
	...
	if (var_1_46 > (var_1_45 + var_1_50)) {
		var_1_49 = (max ((max (var_1_42 , var_1_44)) , var_1_36));
	} else {
	...
	// From: CodeObject7
	if ((min (var_1_43 , var_1_50)) < (abs (abs (8)))) {
		var_1_51 = (abs (max (var_1_44 , (abs (var_1_40)))));
	}


	// From: CodeObject8
	if ((~ (var_1_37 & 10)) == ((var_1_48 & var_1_46) + var_1_32)) {
		if (((max (var_1_35 , var_1_47)) * var_1_53) >= 8.4) {
			if (var_1_30) {
	...
	// From: Req2Batch15PS_CN_100
	var_1_10 = var_1_11;


	// From: Req3Batch15PS_CN_100
