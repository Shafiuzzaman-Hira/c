...
void step(void) {
	...
	if (stepLocal_1 <= ((*(WrapperStruct00_var_1_3_Pointer)) - last_1_WrapperStruct00_var_1_16)) {
		if (stepLocal_0 < (max ((last_1_WrapperStruct00_var_1_16 / (*(WrapperStruct00_var_1_5_Pointer))) , last_1_WrapperStruct00_var_1_16))) {
