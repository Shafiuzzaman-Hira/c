...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch9125_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req5Batch9125_while
	var_1_15 = var_1_16;


	// From: Req4Batch9125_while
	var_1_14 = var_1_15;


	// From: Req3Batch9125_while
	if (var_1_11) {
		if (var_1_12) {
	...
	// From: Req1Batch9125_while
	if (var_1_10 >= 50.4f) {
		var_1_1 = (max (var_1_15 , var_1_15));
	}


	// From: Req2Batch9125_while
	if (var_1_15 == (var_1_14 * var_1_15)) {
