...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch4925_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch4925_1loop
	var_1_13 = var_1_14;


	// From: Req5Batch4925_1loop
	var_1_15 = var_1_16;


	// From: Req1Batch4925_1loop
	if (var_1_2 >= 64.5f) {
		if (var_1_2 >= var_1_3) {
	...
	// From: Req2Batch4925_1loop
	var_1_8 = (abs (var_1_15));


	// From: Req3Batch4925_1loop
