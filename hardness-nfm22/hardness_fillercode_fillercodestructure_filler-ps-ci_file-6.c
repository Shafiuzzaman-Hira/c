...
void step(void) {
	...
	// From: CodeObject2
	if ((min (var_1_23 , (8 ^ var_1_9))) >= (abs (var_1_9))) {
		var_1_25 = 8;
	}
	...
	if (var_1_19) {
		...
		var_1_33 = (max ((abs (var_1_9)) , var_1_29));
	}
	...
	// From: CodeObject7
	if (var_1_9 > (min (var_1_11 , (max (var_1_29 , var_1_10))))) {
		if (-256 != var_1_35) {
