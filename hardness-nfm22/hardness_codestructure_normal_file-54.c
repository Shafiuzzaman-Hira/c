...
void step(void) {
	...
	// From: Req3Batch54normal
	if (((var_1_8 % var_1_10) * (8 + var_1_1)) >= var_1_6) {
	...
	// From: Req4Batch54normal
	if (((var_1_8 * var_1_1) + var_1_4) >= (min (var_1_6 , var_1_5))) {
		var_1_13 = var_1_12;
	}


	// From: Req5Batch54normal
	if (var_1_2 < (max (var_1_3 , (var_1_15 - var_1_16)))) {
		var_1_14 = (var_1_17 - (var_1_8 + var_1_4));
	}


	// From: Req6Batch54normal
