...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch24stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (((((var_1_12) < (var_1_18)) ? (var_1_12) : (var_1_18))) <= (var_1_11 + var_1_3)) {
...
int property() {
 return ((((((var_1_2 >= var_1_3) ? (var_1_1 == ((double) (var_1_4 - ((((var_1_5) < 0 ) ? -(var_1_5) : (var_1_5)))))) : ((var_1_6 || var_1_7) ? (var_1_1 == ((double) 128.75)) : 1)) && ((var_1_3 <= ((((var_1_2) < (var_1_9)) ? (var_1_2) : (var_1_9)))) ? (var_1_7 ? (var_1_8 == ((signed char) (-16 + ((((var_1_10) < ((var_1_11 + var_1_12))) ? (var_1_10) : ((var_1_11 + var_1_12))))))) : 1) : (var_1_8 == ((signed char) var_1_12)))) && ((128u >= var_1_9) ? ((! var_1_6) ? (var_1_13 == ((double) ((var_1_14 - var_1_15) + 0.25))) : (var_1_13 == ((double) var_1_14))) : (var_1_6 ? (var_1_13 == ((double) var_1_5)) : 1))) && ((var_1_2 >= ((1329162249 - var_1_17) - var_1_18)) ? (var_1_16 == ((unsigned long int) (((((((((var_1_17) > (var_1_18)) ? (var_1_17) : (var_1_18)))) < (var_1_19)) ? (((((var_1_17) > (var_1_18)) ? (var_1_17) : (var_1_18)))) : (var_1_19))) + var_1_20))) : (var_1_7 ? (var_1_16 == ((unsigned long int) var_1_18)) : (var_1_16 == ((unsigned long int) var_1_19))))) && ((((((var_1_12) < (var_1_18)) ? (var_1_12) : (var_1_18))) <= (var_1_11 + var_1_3)) ? ((var_1_11 >= (var_1_18 & var_1_22)) ? (var_1_21 == ((signed short int) 8)) : ((var_1_19 < var_1_9) ? (var_1_21 == ((signed short int) 64)) : 1)) : 1)) && (var_1_23 == ((unsigned char) var_1_24))
;
}
int main(void) {
 isInitial = 1;
