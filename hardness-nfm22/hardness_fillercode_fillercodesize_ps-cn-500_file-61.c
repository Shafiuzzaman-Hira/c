...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch61PS_CN_500.c", 13, "reach_error"); }
...
double var_1_82 = 10000000000000.2;
signed short int var_1_83 = 64;
signed short int var_1_84 = -1000;
...
unsigned long int var_1_94 = 2486296263;
...
double var_1_103 = -0.2;
unsigned short int var_1_104 = 500;
signed short int var_1_105 = -16;
signed short int var_1_107 = 16;
double var_1_108 = 128.8;
...
unsigned long int var_1_114 = 3900591810;
unsigned long int var_1_115 = 3800740862;
unsigned char var_1_116 = 1;
signed short int var_1_117 = 2;
signed short int var_1_118 = 256;
float var_1_119 = 9.6;
signed char var_1_120 = 4;
unsigned short int var_1_121 = 0;
double var_1_122 = 499.875;
signed char var_1_123 = 2;
unsigned char var_1_124 = 4;
signed char var_1_125 = -2;
unsigned long int var_1_126 = 128;
double var_1_127 = 127.375;
unsigned long int var_1_128 = 100000;
...
void step(void) {
	...
	// From: CodeObject26
	if ((var_1_72 > var_1_35) && var_1_78) {
		if (((var_1_30 ^ 5u) & var_1_79) >= (var_1_29 % var_1_66)) {
			var_1_77 = (var_1_46 - (abs (var_1_80)));
		}
	} else {
		var_1_77 = (var_1_76 - var_1_74);
	}


	// From: CodeObject27
	if (var_1_73 == (abs (var_1_33))) {
		var_1_81 = var_1_48;
	} else {
		var_1_81 = (var_1_50 + (128 - var_1_33));
	}


	// From: CodeObject28
	if (var_1_54 <= (max ((var_1_74 - var_1_45) , (abs (var_1_76))))) {
		if (((1 << var_1_33) + 1) <= var_1_30) {
			var_1_82 = (min ((abs (var_1_37)) , (var_1_40 - var_1_42)));
		}
	}


	// From: CodeObject29
	if ((var_1_71 ^ (- var_1_24)) > (max (var_1_64 , (var_1_66 | var_1_61)))) {
		var_1_83 = (abs (var_1_84));
	}


	// From: CodeObject30
	if ((var_1_72 + var_1_35) <= var_1_37) {
		if (var_1_52 >= (var_1_84 | var_1_60)) {
			var_1_85 = (var_1_86 || (var_1_87 || (var_1_78 && var_1_88)));
		} else {
			var_1_85 = (! (var_1_86 || (var_1_89 && var_1_90)));
		}
	} else {
		var_1_85 = (var_1_86 && var_1_87);
	}


	// From: CodeObject31
	var_1_91 = ((var_1_86 || var_1_87) || (! var_1_90));


	// From: CodeObject32
	var_1_92 = (abs (var_1_66));


	// From: CodeObject33
	if (! ((3.8f - var_1_40) >= (var_1_38 * var_1_82))) {
		if ((max (var_1_37 , var_1_35)) >= var_1_40) {
			if (((abs (var_1_94)) - var_1_95) <= var_1_32) {
				var_1_93 = (! (! var_1_87));
			}
		}
	} else {
		if (var_1_39 < (var_1_42 - var_1_40)) {
			var_1_93 = (((var_1_81 < 10) || var_1_90) && var_1_89);
		}
	}
	...
	// From: CodeObject34
	if (var_1_93) {
		if (((var_1_74 % var_1_27) ^ var_1_67) <= (abs (var_1_75))) {
			var_1_96 = (abs (var_1_43));
		}
	}


	// From: CodeObject35
	if (((- var_1_33) != var_1_68) && var_1_87) {
		if (var_1_98 >= (~ 0)) {
			var_1_97 = (abs (abs (var_1_60)));
		} else {
			var_1_97 = ((var_1_99 + var_1_100) - var_1_101);
		}
	}
	...
	if (var_1_65 <= var_1_53) {
		var_1_103 = (var_1_39 - var_1_41);
	}


	// From: CodeObject38
	if (var_1_71 > ((abs (var_1_100)) + (max (5 , var_1_26)))) {
		if (var_1_51 > (var_1_27 / var_1_28)) {
			var_1_104 = var_1_33;
		}
	} else {
		var_1_104 = (abs ((abs (var_1_67)) - var_1_33));
	}


	// From: CodeObject39
	if (var_1_53 >= var_1_99) {
		if ((- var_1_58) > var_1_59) {
			var_1_105 = (abs (min (var_1_107 , var_1_60)));
		}
	}


	// From: CodeObject40
	if ((max (var_1_28 , var_1_57)) > var_1_55) {
		if (var_1_56 < ((~ var_1_31) ^ (max (var_1_28 , var_1_92)))) {
			var_1_108 = (max (var_1_39 , (var_1_42 - var_1_40)));
		}
	}


	// From: CodeObject41
	if (var_1_45 > (var_1_77 | (abs (var_1_58)))) {
		if (var_1_54 >= (var_1_75 % var_1_67)) {
			var_1_109 = (abs (min ((min (-10 , var_1_100)) , var_1_60)));
		} else {
			if ((var_1_33 | var_1_24) > (~ (abs (var_1_98)))) {
				var_1_109 = (min (var_1_60 , (max (var_1_100 , var_1_101))));
			}
		}
	}
	...
	if (var_1_33 > var_1_26) {
		var_1_110 = (min ((min ((var_1_97 + var_1_51) , var_1_59)) , var_1_107));
	}


	// From: CodeObject43
	if (var_1_98 <= var_1_57) {
		if (var_1_89) {
			var_1_111 = var_1_87;
		}
	}
	...
	// From: CodeObject44
	if ((var_1_33 >> (abs (var_1_113))) > (abs (var_1_76 - var_1_69))) {
		if (var_1_43 >= (max (var_1_72 , (- var_1_41)))) {
			var_1_112 = (max ((max ((abs (var_1_65)) , var_1_25)) , var_1_55));
		} else {
			var_1_112 = ((max (var_1_114 , (var_1_115 - var_1_67))) - (var_1_74 - var_1_65));
		}
	} else {
		if (var_1_24 > var_1_92) {
			var_1_112 = (var_1_115 - (min (var_1_55 , var_1_100)));
		}
	}
	...
	// From: CodeObject45
	if ((abs (- 25)) <= var_1_57) {
		var_1_116 = (var_1_85 || (var_1_34 || var_1_89));
	} else {
		if (var_1_60 <= ((abs (var_1_51)) - var_1_100)) {
			if (var_1_105 > var_1_74) {
				var_1_116 = ((var_1_63 > -25) || ((var_1_76 >= var_1_83) || (var_1_34 || var_1_90)));
			}
		} else {
			var_1_116 = var_1_86;
		}
	...
	// From: CodeObject60
	if (var_1_84 >= var_1_68) {
		var_1_131 = (min ((abs (var_1_55)) , ((max (var_1_95 , var_1_101)) + (max (var_1_29 , 128u)))));
	} else {
		if (-64 <= var_1_46) {
			if (var_1_89) {
				var_1_131 = var_1_104;
	...
	// From: Req7Batch61PS_CN_500
	var_1_21 = var_1_6;


	// From: Req8Batch61PS_CN_500
	var_1_22 = var_1_23;


	// From: Req1Batch61PS_CN_500
	if ((var_1_21 / (abs (64u))) == var_1_4) {
		var_1_1 = (8.8 - 255.2);
	}


	// From: Req4Batch61PS_CN_500
...
void updateVariables() {
	...
	assume_abort_if_not(var_1_94 <= 4294967295);
	...
	assume_abort_if_not(var_1_113 <= 9);
	...
	assume_abort_if_not(var_1_115 >= 3221225470);
