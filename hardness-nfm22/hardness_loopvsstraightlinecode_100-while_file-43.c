...
void step(void) {
	...
	// From: Req10Batch43100_while
	if (last_1_var_1_33 > last_1_var_1_33) {
		var_1_28 = (! ((var_1_4 != last_1_var_1_24) || var_1_29));
	}


	// From: Req11Batch43100_while
	var_1_30 = ((min ((var_1_31 + var_1_32) , (3305479224u - var_1_5))) - (abs (var_1_4)));


	// From: Req12Batch43100_while
	var_1_33 = var_1_20;


	// From: Req13Batch43100_while
	var_1_34 = var_1_22;


	// From: Req14Batch43100_while
	var_1_35 = var_1_30;


	// From: Req2Batch43100_while
