...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch8Amount100.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_22 + (var_1_20 / var_1_24)) <= var_1_20) {
  var_1_27 = (10000.2 + (((((((var_1_17) > (var_1_18)) ? (var_1_17) : (var_1_18))) < 0 ) ? -((((var_1_17) > (var_1_18)) ? (var_1_17) : (var_1_18))) : ((((var_1_17) > (var_1_18)) ? (var_1_17) : (var_1_18))))));
 } else {
 ...
 if ((var_1_5 - var_1_6) >= var_1_27) {
  if (stepLocal_5 > var_1_11) {
   var_1_30 = (((((var_1_31 + var_1_32)) > (var_1_33)) ? ((var_1_31 + var_1_32)) : (var_1_33)));
  } else {
   var_1_30 = var_1_34;
  }
 }
 ...
 if (((var_1_30 + var_1_20) / var_1_4) > stepLocal_4) {
  var_1_28 = ((((var_1_22) < (var_1_29)) ? (var_1_22) : (var_1_29)));
 }
 var_1_19 = (var_1_28 + (var_1_30 + var_1_11));
 if (var_1_20 < ((8 << var_1_19) / ((((var_1_4) < (var_1_24)) ? (var_1_4) : (var_1_24))))) {
  if ((256 - (var_1_25 - var_1_22)) >= var_1_11) {
   var_1_23 = (((((var_1_5 - var_1_6)) < (var_1_17)) ? ((var_1_5 - var_1_6)) : (var_1_17)));
  }
 }
 ...
 if (stepLocal_2 < (var_1_26 ^ var_1_30)) {
  if ((! var_1_12) || stepLocal_3) {
   var_1_15 = ((((var_1_6) < ((var_1_17 + var_1_18))) ? (var_1_6) : ((var_1_17 + var_1_18))));
  } else {
   var_1_15 = var_1_17;
  }
 } else {
