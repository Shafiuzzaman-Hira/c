...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch31Filler_PR_CN.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_33 > (var_1_31 | ((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))))) {
 ...
 if ((var_1_23 < var_1_34) || var_1_25) {
  if ((var_1_32 / ((((-10) < (var_1_35)) ? (-10) : (var_1_35)))) >= ((((var_1_31) < (var_1_30)) ? (var_1_31) : (var_1_30)))) {
   var_1_33 = var_1_30;
  } else {
   var_1_33 = var_1_30;
  }
