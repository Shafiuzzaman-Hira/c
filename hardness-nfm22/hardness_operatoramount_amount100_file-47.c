...
void step(void) {
	...
	// From: Req4Batch47Amount100
	var_1_14 = var_1_13;


	// From: Req6Batch47Amount100
	var_1_18 = (max (var_1_19 , (abs (max (var_1_20 , var_1_21)))));


	// From: Req7Batch47Amount100
