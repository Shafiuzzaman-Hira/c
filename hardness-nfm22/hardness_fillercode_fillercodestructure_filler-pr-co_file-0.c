...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch0Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject6
	if (((abs (var_1_6)) - (var_1_20 + var_1_38)) <= var_1_17) {
		var_1_37 = (max (var_1_30 , (min (var_1_38 , (var_1_39 - var_1_31)))));
	}


	// From: Req4Batch0Filler_PR_CO
