...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch32Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch32Filler_PE_CN
	var_1_22 = var_1_12;


	// From: Req8Batch32Filler_PE_CN
	var_1_23 = var_1_8;


	// From: Req9Batch32Filler_PE_CN
	var_1_24 = var_1_6;
	...
	if (var_1_26 < (min (var_1_27 , (var_1_28 >> var_1_29)))) {
		...
		if ((var_1_29 - var_1_31) <= (~ (var_1_32 - var_1_33))) {
			var_1_25 = (max (var_1_30 , var_1_31));
		} else {
			var_1_25 = -32;
		}
	}
	...
	// From: CodeObject5
	if (((min (var_1_44 , var_1_37)) >= (var_1_38 / var_1_42)) || var_1_35) {
