...
void step(void) {
	...
	if (var_1_30) {
		if ((abs (var_1_25)) > ((-10 + var_1_26) & var_1_24)) {
			...
			var_1_29 = ((abs (var_1_32)) + var_1_33);
		}
	}
	...
	// From: CodeObject4
	if (var_1_30) {
		var_1_35 = (max (var_1_28 , var_1_36));
	}
	...
	if (var_1_27 > var_1_23) {
		if (! var_1_30) {
			var_1_37 = (min (var_1_28 , var_1_36));
		}
	} else {
		var_1_37 = (var_1_38 - (max ((abs (var_1_36)) , var_1_39)));
	}


	// From: CodeObject6
	if (var_1_23 > 64.15) {
		var_1_40 = (max (var_1_33 , (var_1_31 - 5u)));
	} else {
		if (var_1_41 <= (var_1_25 % (abs (var_1_42)))) {
			var_1_40 = (var_1_32 + (max (var_1_33 , 10u)));
		} else {
			var_1_40 = var_1_32;
		}
	}
	...
	// From: CodeObject7
	if (var_1_39 == (- (abs (var_1_36)))) {
		var_1_43 = (max ((var_1_44 - var_1_45) , (min (var_1_46 , var_1_47))));
	}
	...
	if (((var_1_34 * var_1_44) * var_1_26) > var_1_46) {
		if (var_1_32 <= var_1_46) {
			var_1_48 = (max ((abs (127.9f)) , (max (var_1_38 , var_1_28))));
		} else {
			if (var_1_32 != var_1_29) {
				var_1_48 = (abs (max (var_1_39 , 0.75f)));
			}
		}
	} else {
		var_1_48 = (max ((min (-0.5f , var_1_36)) , var_1_38));
	}


	// From: CodeObject9
	if (var_1_38 <= var_1_28) {
		var_1_49 = (var_1_44 - ((abs (var_1_25)) + (var_1_43 + var_1_46)));
	} else {
		var_1_49 = (abs (var_1_34));
	}


	// From: CodeObject10
	if (var_1_30) {
		var_1_50 = (128 + (abs (var_1_51 - var_1_52)));
	} else {
		var_1_50 = (min (var_1_44 , var_1_51));
	}


	// From: CodeObject11
	if ((abs (49.5)) >= (var_1_38 - var_1_39)) {
		var_1_53 = (min (var_1_47 , var_1_43));
	} else {
		var_1_53 = (min ((abs (var_1_44)) , var_1_34));
	}
