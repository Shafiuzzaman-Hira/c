...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch39Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
 if (var_1_28) {
  if ((((((((127.5f) < (var_1_19)) ? (127.5f) : (var_1_19))) < 0 ) ? -((((127.5f) < (var_1_19)) ? (127.5f) : (var_1_19))) : ((((127.5f) < (var_1_19)) ? (127.5f) : (var_1_19))))) > 10.5f) {
   var_1_27 = var_1_26;
  }
 }
 var_1_31 = var_1_32;
 ...
 if ((var_1_37 % ((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41)))) >= (var_1_24 * var_1_39)) {
  var_1_40 = ((((((((var_1_38 + var_1_39) < 0 ) ? -(var_1_38 + var_1_39) : (var_1_38 + var_1_39)))) > (var_1_1)) ? (((((var_1_38 + var_1_39) < 0 ) ? -(var_1_38 + var_1_39) : (var_1_38 + var_1_39)))) : (var_1_1)));
 }
 if (var_1_26 <= (var_1_37 & var_1_41)) {
  if ((var_1_19 * var_1_32) >= var_1_19) {
   if (! var_1_34) {
    var_1_43 = (3151323843u - (var_1_38 + ((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26)))));
   } else {
    var_1_43 = var_1_26;
   }
  } else {
