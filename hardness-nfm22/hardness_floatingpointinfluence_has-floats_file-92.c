...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch92has_floats.c", 13, "reach_error"); }
...
int property() {
	return (((((var_1_1 == ((signed char) ((var_1_2 + var_1_3) - (max (var_1_4 , (var_1_5 + var_1_6)))))) && ((((~ var_1_5) * (var_1_6 & var_1_3)) >= var_1_4) ? (var_1_7 == ((double) var_1_8)) : (var_1_7 == ((double) var_1_9)))) && (var_1_10 == ((signed short int) (abs (var_1_2))))) && ((! var_1_13) ? (var_1_11 == ((unsigned short int) (var_1_5 + ((max (var_1_6 , 1)) + 64)))) : 1)) && (((var_1_6 / var_1_14) < -100) ? (var_1_13 == ((unsigned char) (! (! (! var_1_15))))) : (var_1_13 == ((unsigned char) (var_1_15 && var_1_16))))) && (var_1_17 == ((float) var_1_8))
;
}
int main(void) {
	isInitial = 1;
