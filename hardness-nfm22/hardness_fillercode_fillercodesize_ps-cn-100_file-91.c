...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch91PS_CN_100.c", 13, "reach_error"); }
...
float var_1_42 = 255.75;
unsigned long int var_1_43 = 8;
unsigned long int var_1_44 = 5;
double var_1_45 = 1.5;
double var_1_46 = 999999.7;
double var_1_47 = 15.5;
...
void step(void) {
	...
	// From: CodeObject2
	if (var_1_39 < (var_1_35 / (abs (var_1_42)))) {
		if (var_1_40 != (- var_1_39)) {
			var_1_41 = ((abs (1u)) + var_1_43);
		} else {
	...
	// From: CodeObject4
	if ((var_1_40 - var_1_39) >= 63.5f) {
		if (var_1_47 == var_1_46) {
			var_1_48 = (abs (max (var_1_43 , var_1_44)));
		} else {
	...
	if (var_1_32 && var_1_30) {
		if (var_1_32) {
			var_1_49 = (min (var_1_50 , var_1_51));
		}
	}
	...
	// From: CodeObject6
	if (! (-0.5f <= var_1_39)) {
		var_1_52 = (max (var_1_53 , var_1_54));
	} else {
	...
	// From: CodeObject7
	if ((var_1_50 * var_1_52) > var_1_51) {
		var_1_56 = (abs (var_1_57));
	}


	// From: CodeObject8
	if (var_1_27) {
		if (var_1_54 <= (var_1_44 & var_1_53)) {
	...
	// From: CodeObject9
	if ((var_1_42 > 100000.1f) || var_1_29) {
	...
	if (var_1_39 > 4.7f) {
		if (var_1_51 <= var_1_60) {
			if (var_1_36 || ((abs (var_1_57)) > var_1_34)) {
				var_1_61 = (! var_1_62);
			} else {
				var_1_61 = (var_1_36 || (var_1_62 || var_1_37));
			}
		} else {
			var_1_61 = var_1_33;
		}
	...
	// From: CodeObject11
	if (((50 | var_1_41) | var_1_54) < var_1_59) {
		var_1_63 = var_1_60;
	}


	// From: Req1Batch91PS_CN_100
	...
	// From: Req5Batch91PS_CN_100
	if (var_1_11 < 5) {
		var_1_17 = (max (var_1_18 , (var_1_19 - var_1_20)));
	}


	// From: Req7Batch91PS_CN_100
	var_1_24 = var_1_25;


	// From: Req8Batch91PS_CN_100
	var_1_26 = var_1_11;


	// From: Req6Batch91PS_CN_100
	if (var_1_24) {
