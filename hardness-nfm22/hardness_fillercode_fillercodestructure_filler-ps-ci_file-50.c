...
void step(void) {
	...
	// From: Req3Batch50Filler_PS_CI
	if (var_1_8) {
		var_1_13 = (min ((var_1_14 + var_1_15) , (min (-0.2f , var_1_16))));
	}


	// From: Req6Batch50Filler_PS_CI
	if (var_1_8) {
		var_1_25 = (var_1_26 + var_1_27);
	}


	// From: Req8Batch50Filler_PS_CI
	var_1_29 = var_1_27;


	// From: Req9Batch50Filler_PS_CI
	var_1_30 = var_1_8;


	// From: Req2Batch50Filler_PS_CI
	...
	// From: Req4Batch50Filler_PS_CI
	var_1_17 = ((var_1_18 - 25) - var_1_25);


	// From: Req5Batch50Filler_PS_CI
