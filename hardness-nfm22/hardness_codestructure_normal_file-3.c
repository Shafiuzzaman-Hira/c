...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch3normal.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_1 <= ((var_1_7 ^ var_1_9) + var_1_8)) {
		if (var_1_11 == var_1_4) {
			var_1_10 = 0u;
		}
	}
