...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch79stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch79stepLocals
	unsigned char stepLocal_2 = var_1_7;
	if (stepLocal_2 != (var_1_8 + var_1_4)) {
	...
	// From: Req4Batch79stepLocals
	if ((var_1_13 - var_1_14) >= (var_1_15 - (var_1_16 + var_1_17))) {
		var_1_12 = (var_1_6 + var_1_7);
	}


	// From: Req5Batch79stepLocals
	if (var_1_3) {
		if (var_1_2) {
			var_1_18 = (! var_1_19);
		}
	...
	// From: Req7Batch79stepLocals
	var_1_26 = var_1_16;


	// From: Req8Batch79stepLocals
	var_1_27 = 10u;
}
...
int property() {
	return (((((((var_1_2 ? ((! var_1_3) ? (var_1_1 == ((signed short int) (var_1_4 + 5))) : (var_1_1 == ((signed short int) (var_1_5 - var_1_6)))) : (var_1_1 == ((signed short int) var_1_5))) && ((var_1_3 && var_1_2) ? (((min (var_1_5 , (var_1_6 * var_1_4))) > var_1_1) ? (var_1_7 == ((unsigned char) var_1_8)) : (var_1_7 == ((unsigned char) var_1_8))) : (var_1_7 == ((unsigned char) var_1_8)))) && ((var_1_7 != (var_1_8 + var_1_4)) ? (var_1_9 == ((double) (min (var_1_10 , (min (var_1_11 , 32.6)))))) : (var_1_9 == ((double) (min (var_1_11 , (abs (var_1_10)))))))) && (((var_1_13 - var_1_14) >= (var_1_15 - (var_1_16 + var_1_17))) ? (var_1_12 == ((signed long int) (var_1_6 + var_1_7))) : 1)) && (var_1_3 ? (var_1_2 ? (var_1_18 == ((unsigned char) (! var_1_19))) : 1) : 1)) && ((var_1_8 >= var_1_12) ? ((var_1_15 >= var_1_9) ? (var_1_20 == ((unsigned char) (var_1_21 - (max ((min (var_1_22 , var_1_23)) , (min (var_1_24 , var_1_25))))))) : (var_1_20 == ((unsigned char) var_1_24))) : (var_1_20 == ((unsigned char) var_1_22)))) && (var_1_26 == ((float) var_1_16))) && (var_1_27 == ((unsigned long int) 10u))
;
}
int main(void) {
	isInitial = 1;
