...
void step(void) {
	...
	if ((var_1_16 * (var_1_46 - var_1_47)) < var_1_15) {
		if ((abs (max (var_1_26 , var_1_29))) > (min (var_1_27 , (256 + var_1_26)))) {
			var_1_45 = (min (var_1_37 , var_1_15));
		}
	} else {
		var_1_45 = (abs (min ((max (var_1_15 , var_1_36)) , var_1_37)));
	}
	...
	// From: CodeObject3
	var_1_38 = (max (var_1_26 , var_1_27));
	...
	// From: CodeObject2
	if (! var_1_8) {
		var_1_33 = (max (var_1_16 , (var_1_36 - var_1_37)));
	}
