...
void step(void) {
	// From: Req1Batch61stepLocals
	if ((var_1_2 / (abs (64u))) == var_1_3) {
		var_1_1 = (8.8 - 255.2);
	}


	// From: Req2Batch61stepLocals
	...
	// From: Req3Batch61stepLocals
	unsigned long int stepLocal_3 = var_1_4;
	unsigned long int stepLocal_2 = var_1_5;
	unsigned long int stepLocal_1 = max (var_1_3 , var_1_5);
	...
	// From: Req5Batch61stepLocals
	if (var_1_2 >= (var_1_14 - (min (var_1_15 , var_1_16)))) {
		if (var_1_16 < var_1_9) {
			var_1_13 = var_1_17;
		} else {
			var_1_13 = var_1_17;
	...
	// From: Req7Batch61stepLocals
	var_1_21 = var_1_6;


	// From: Req8Batch61stepLocals
	var_1_22 = var_1_23;
}
...
int property() {
	return (((((((((var_1_2 / (abs (64u))) == var_1_3) ? (var_1_1 == ((double) (8.8 - 255.2))) : 1) && ((var_1_3 < var_1_2) ? (var_1_4 == ((unsigned long int) (max (var_1_5 , var_1_6)))) : 1)) && ((var_1_4 <= (max (var_1_3 , var_1_5))) ? ((var_1_4 < var_1_5) ? ((var_1_4 >= (var_1_3 ^ 4u)) ? (var_1_7 == ((float) var_1_8)) : 1) : (var_1_7 == ((float) var_1_8))) : (var_1_7 == ((float) var_1_8)))) && ((var_1_4 >= (4256310412u - 128u)) ? (var_1_9 == ((signed long int) ((abs (var_1_10 + var_1_11)) + var_1_12))) : 1)) && ((var_1_2 >= (var_1_14 - (min (var_1_15 , var_1_16)))) ? ((var_1_16 < var_1_9) ? (var_1_13 == ((unsigned char) var_1_17)) : (var_1_13 == ((unsigned char) var_1_17))) : (var_1_13 == ((unsigned char) var_1_18)))) && ((((var_1_12 / 2) / var_1_20) >= (~ 100)) ? (var_1_13 ? (var_1_19 == ((unsigned char) (var_1_17 && var_1_18))) : 1) : (var_1_17 ? (var_1_19 == ((unsigned char) var_1_18)) : (var_1_19 == ((unsigned char) var_1_18))))) && (var_1_21 == ((unsigned long int) var_1_6))) && (var_1_22 == ((signed char) var_1_23))
;
}
int main(void) {
	isInitial = 1;
