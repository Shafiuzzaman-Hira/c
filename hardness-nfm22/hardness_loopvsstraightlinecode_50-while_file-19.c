...
void step(void) {
	// From: Req3Batch1950_while
	if (last_1_var_1_15) {
		var_1_10 = (var_1_12 || var_1_13);
	}


	// From: Req7Batch1950_while
	if (var_1_10) {
	...
	// From: Req5Batch1950_while
	if ((- var_1_24) == (var_1_24 + var_1_24)) {
		var_1_15 = var_1_12;
	}


	// From: Req6Batch1950_while
	...
	// From: Req8Batch1950_while
	if (var_1_24 != var_1_24) {
		var_1_29 = (max (var_1_2 , var_1_3));
	}


	// From: Req2Batch1950_while
	...
	// From: Req4Batch1950_while
	if (var_1_15) {
		var_1_14 = (min ((abs (max (var_1_3 , var_1_2))) , var_1_9));
	}


	// From: Req1Batch1950_while
