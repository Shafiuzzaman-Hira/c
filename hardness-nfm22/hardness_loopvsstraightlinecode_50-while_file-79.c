...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch7950_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch7950_while
	var_1_26 = var_1_16;


	// From: Req8Batch7950_while
	var_1_27 = 10u;


	// From: Req3Batch7950_while
