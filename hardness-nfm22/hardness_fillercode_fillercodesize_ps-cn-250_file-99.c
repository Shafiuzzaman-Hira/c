...
void step(void) {
	...
	if (var_1_72 < var_1_46) {
		if (var_1_65 < (var_1_64 ^ (var_1_52 - var_1_57))) {
			var_1_71 = (var_1_57 - (abs (-5)));
		} else {
			var_1_71 = (min (var_1_50 , var_1_49));
		}
	}
	...
	if (var_1_29 >= var_1_60) {
		if (var_1_39 || var_1_43) {
			if (! (var_1_49 > (var_1_70 + -32))) {
				var_1_75 = (max (var_1_49 , var_1_60));
			} else {
				var_1_75 = (max ((max (var_1_50 , var_1_56)) , var_1_49));
			}
		}
	}
	...
	// From: CodeObject21
	if ((min (1000u , (var_1_70 % var_1_63))) > ((~ var_1_31) + var_1_65)) {
		var_1_76 = ((max (var_1_55 , var_1_52)) + (abs (min (var_1_75 , var_1_51))));
	} else {
	...
	// From: CodeObject22
	if (var_1_40) {
		var_1_77 = (max (var_1_45 , var_1_46));
	}


	// From: CodeObject23
	if (var_1_44 >= var_1_45) {
		var_1_78 = (max (var_1_42 , var_1_47));
	} else {
		var_1_78 = (abs (max ((abs (var_1_42)) , var_1_44)));
	}


	// From: CodeObject24
	if (var_1_40) {
		var_1_79 = (abs (var_1_80));
	} else {
		var_1_79 = (max (var_1_57 , var_1_52));
	}
	...
	if (var_1_59 <= var_1_75) {
		if (var_1_39 || var_1_40) {
			var_1_81 = (max (((max (var_1_44 , 99.8f)) + var_1_46) , var_1_41));
		} else {
			if (var_1_40) {
				var_1_81 = (var_1_44 + var_1_46);
			} else {
				var_1_81 = (abs (var_1_44));
			}
		}
	}
	...
	if (var_1_43) {
		...
		if ((- (var_1_53 >> var_1_59)) < var_1_61) {
			var_1_84 = ((min ((abs (var_1_44)) , var_1_41)) - (min (2.5 , (abs (var_1_47)))));
		}
	}
	...
	// From: CodeObject29
	if (var_1_46 > (min (var_1_38 , var_1_77))) {
		if (var_1_85 >= var_1_79) {
			var_1_86 = (abs (var_1_57));
		}
	} else {
		var_1_86 = var_1_53;
	}
