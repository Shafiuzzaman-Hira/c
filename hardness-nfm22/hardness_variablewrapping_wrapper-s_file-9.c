...
void step(void) {
	...
	if (((last_1_WrapperStruct0_var_1_12 + last_1_WrapperStruct0_var_1_1) < 10) || stepLocal_0) {
		WrapperStruct0.var_1_12 = (max (((WrapperStruct0.var_1_3 + last_1_WrapperStruct0_var_1_12) - (max (last_1_WrapperStruct0_var_1_14 , last_1_WrapperStruct0_var_1_12))) , last_1_WrapperStruct0_var_1_1));
	} else {
		WrapperStruct0.var_1_12 = last_1_WrapperStruct0_var_1_12;
	}


	// From: Req6Batch9Wrapper_S
	...
	if (WrapperStruct0.var_1_12 <= 16) {
		...
		if ((max (WrapperStruct0.var_1_10 , WrapperStruct0.var_1_10)) < WrapperStruct0.var_1_10) {
...
int property() {
	return ((((((WrapperStruct0.var_1_12 <= 16) ? (WrapperStruct0.var_1_1 == ((unsigned char) WrapperStruct0.var_1_3)) : (((max (WrapperStruct0.var_1_10 , WrapperStruct0.var_1_10)) < WrapperStruct0.var_1_10) ? (WrapperStruct0.var_1_7 ? (WrapperStruct0.var_1_1 == ((unsigned char) WrapperStruct0.var_1_3)) : (WrapperStruct0.var_1_1 == ((unsigned char) WrapperStruct0.var_1_3))) : (WrapperStruct0.var_1_1 == ((unsigned char) WrapperStruct0.var_1_3)))) && (((10 << WrapperStruct0.var_1_12) < (WrapperStruct0.var_1_3 * WrapperStruct0.var_1_14)) ? (WrapperStruct0.var_1_8 == ((signed short int) (WrapperStruct0.var_1_12 + WrapperStruct0.var_1_14))) : 1)) && (WrapperStruct0.var_1_9 == ((unsigned char) 64))) && (WrapperStruct0.var_1_10 == ((double) WrapperStruct0.var_1_11))) && ((((last_1_WrapperStruct0_var_1_12 + last_1_WrapperStruct0_var_1_1) < 10) || (last_1_WrapperStruct0_var_1_10 > last_1_WrapperStruct0_var_1_10)) ? (WrapperStruct0.var_1_12 == ((signed short int) (max (((WrapperStruct0.var_1_3 + last_1_WrapperStruct0_var_1_12) - (max (last_1_WrapperStruct0_var_1_14 , last_1_WrapperStruct0_var_1_12))) , last_1_WrapperStruct0_var_1_1)))) : (WrapperStruct0.var_1_12 == ((signed short int) last_1_WrapperStruct0_var_1_12)))) && (WrapperStruct0.var_1_14 == ((signed long int) WrapperStruct0.var_1_12))
;
}
int main(void) {
	isInitial = 1;
