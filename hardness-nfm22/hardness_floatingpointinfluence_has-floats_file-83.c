...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch83has_floats.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch83has_floats
	var_1_14 = 200;


	// From: Req5Batch83has_floats
	var_1_15 = var_1_16;


	// From: Req6Batch83has_floats
	var_1_17 = var_1_10;


	// From: Req1Batch83has_floats
