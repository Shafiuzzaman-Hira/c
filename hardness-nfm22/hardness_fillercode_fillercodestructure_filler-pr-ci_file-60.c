...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch60Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject1
	if (var_1_1 <= (var_1_9 + var_1_9)) {
		if (var_1_9 < var_1_9) {
			var_1_23 = ((var_1_9 <= (~ var_1_20)) || var_1_29);
		} else {
			var_1_23 = var_1_30;
		}
	}
	...
	// From: CodeObject2
	if (var_1_6 != var_1_10) {
		var_1_31 = (((max (var_1_9 , var_1_9)) + var_1_9) - var_1_9);
	}


	// From: CodeObject6
	if ((abs (var_1_9)) <= (2 / (abs (var_1_44)))) {
		var_1_43 = (max (var_1_10 , var_1_10));
	}


	// From: Req6Batch60Filler_PR_CI
	if (var_1_13) {
	...
	// From: CodeObject3
	if (var_1_2 && var_1_29) {
		var_1_35 = ((var_1_19 + var_1_19) - 2.75f);
	} else {
		var_1_35 = (var_1_19 + var_1_19);
	}


	// From: Req2Batch60Filler_PR_CI
	if ((- var_1_16) <= var_1_4) {
	...
	// From: CodeObject5
	if (var_1_30) {
		if (var_1_19 > (min (var_1_8 , var_1_19))) {
			var_1_40 = ((max ((var_1_19 + var_1_19) , var_1_19)) - (6.6634825448069233E18f - (max (50.9f , var_1_19))));
		} else {
			var_1_40 = (min (var_1_19 , var_1_19));
		}
	} else {
		if ((var_1_10 * var_1_7) > (~ var_1_20)) {
			if (var_1_19 == 0.25f) {
				var_1_40 = var_1_19;
			}
		}
