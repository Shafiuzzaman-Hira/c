...
void step(void) {
	// From: Req5Batch70no_floats
	var_1_13 = var_1_14;


	// From: Req6Batch70no_floats
	var_1_15 = var_1_16;


	// From: Req1Batch70no_floats
	if (var_1_2) {
		var_1_1 = ((17222 - var_1_13) + ((min (29916 , var_1_4)) - var_1_13));
	}


	// From: Req2Batch70no_floats
	if (var_1_2 && (var_1_4 >= (var_1_13 + var_1_1))) {
		var_1_6 = 8;
	}


	// From: Req3Batch70no_floats
