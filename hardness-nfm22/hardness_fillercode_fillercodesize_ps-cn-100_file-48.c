...
void step(void) {
	...
	if (var_1_24 >= var_1_27) {
		if (var_1_36) {
			if (var_1_34 <= var_1_35) {
				var_1_41 = (max (var_1_39 , var_1_40));
			}
		}
	} else {
		if (var_1_25) {
	...
	if (var_1_25) {
		...
		var_1_42 = (max (var_1_39 , var_1_40));
	}


	// From: CodeObject11
	if ((min (var_1_20 , var_1_35)) <= 16) {
		var_1_43 = (var_1_39 - ((abs (var_1_44)) - var_1_40));
	} else {
		if (var_1_34 <= var_1_35) {
			var_1_43 = (max (((abs (-64)) + var_1_39) , var_1_34));
		} else {
			if ((var_1_40 >> var_1_39) <= var_1_33) {
				if (var_1_36) {
					var_1_43 = (min (var_1_34 , (abs (var_1_44))));
				}
			} else {
				var_1_43 = (max (var_1_33 , var_1_34));
			}
		}
	}
	...
	// From: CodeObject12
	if ((min ((~ var_1_35) , var_1_46)) <= var_1_44) {
		if (var_1_25) {
			var_1_45 = var_1_39;
		} else {
			var_1_45 = var_1_39;
	...
	// From: Req4Batch48PS_CN_100
	if (var_1_2) {
		var_1_13 = var_1_11;
	}


	// From: Req6Batch48PS_CN_100
	if (var_1_8 == var_1_13) {
