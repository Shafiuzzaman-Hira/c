...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch1325_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req6Batch1325_while
	var_1_18 = 0;


	// From: Req8Batch1325_while
	var_1_20 = var_1_15;


	// From: Req5Batch1325_while
	if (! var_1_18) {
	...
	// From: Req1Batch1325_while
	if (var_1_18) {
		var_1_1 = (max (var_1_11 , var_1_11));
	}


	// From: Req2Batch1325_while
	if ((var_1_1 == 16) || (var_1_11 < var_1_11)) {
		var_1_5 = var_1_6;
	}


	// From: Req3Batch1325_while
	var_1_7 = (var_1_8 - var_1_11);


	// From: Req4Batch1325_while
	var_1_10 = (min (var_1_11 , var_1_6));


	// From: Req7Batch1325_while
	var_1_19 = var_1_1;
}
