...
void step(void) {
	...
	if (stepLocal_5 || last_1_var_1_40) {
		...
		var_1_34 = ((var_1_35 - last_1_var_1_36) - (max (var_1_26 , last_1_var_1_25)));
	}
	...
	if ((last_1_var_1_15 > last_1_var_1_12) && stepLocal_14) {
		var_1_49 = (max (var_1_23 , var_1_44));
	} else {
	...
	signed long int stepLocal_15 = (abs (var_1_39)) | var_1_15;
	if (var_1_31) {
		if ((var_1_15 % (max (var_1_26 , var_1_27))) > stepLocal_15) {
			var_1_54 = (min (var_1_24 , var_1_44));
		} else {
			var_1_54 = var_1_44;
		}
	} else {
	...
	if (((max (-1 , var_1_25)) < (~ var_1_15)) && stepLocal_11) {
		var_1_42 = (abs (var_1_26));
	}
	...
	if (var_1_32) {
		if (! var_1_41) {
			var_1_43 = ((min ((max (var_1_23 , var_1_22)) , (var_1_24 - var_1_44))) + (var_1_45 - var_1_46));
		} else {
			if ((- var_1_12) < (var_1_25 - var_1_26)) {
				if (var_1_42 == (min (var_1_27 , var_1_12))) {
					var_1_43 = (min ((var_1_45 + var_1_21) , (min ((abs (var_1_24)) , var_1_22))));
				} else {
					if (var_1_29 || var_1_40) {
						var_1_43 = (abs (var_1_20 - var_1_44));
					}
				}
			}
		}
		...
		if (var_1_45 <= (var_1_54 + var_1_24)) {
			...
			var_1_43 = (max ((var_1_46 + var_1_21) , var_1_20));
		}
	}
	...
	signed long int stepLocal_6 = var_1_15 / (max (-50 , var_1_27));
	if (stepLocal_7 || var_1_29) {
		if (var_1_3 > (abs (var_1_20))) {
			var_1_36 = (min (((max (var_1_18 , var_1_42)) + (var_1_26 + var_1_27)) , var_1_28));
		}
	} else {
		if ((min (var_1_47 , var_1_35)) <= stepLocal_6) {
			var_1_36 = var_1_26;
		}
	}
	...
	if (var_1_24 <= (1.6 + var_1_22)) {
		var_1_38 = ((max (var_1_26 , var_1_39)) + (min (var_1_36 , (max (var_1_18 , var_1_28)))));
	}
	...
	if (var_1_49 > (var_1_3 - var_1_4)) {
		if ((var_1_3 < var_1_4) && stepLocal_0) {
			if (-256 >= stepLocal_1) {
				var_1_1 = (min (var_1_12 , var_1_15));
			} else {
				var_1_1 = (((1000000000 - var_1_36) + (1000000000 - var_1_25)) - var_1_25);
			}
		} else {
			var_1_1 = (min ((var_1_36 - var_1_25) , ((64 - var_1_25) + -100)));
		}
	} else {
	...
	if (var_1_44 == (- var_1_49)) {
		if (var_1_18 < var_1_1) {
			if (var_1_49 > var_1_22) {
				...
				var_1_52 = (min (var_1_28 , var_1_27));
			}
		} else {
			if (var_1_40) {
...
int property() {
	return ((((((((((((((((((var_1_49 > (var_1_3 - var_1_4)) ? (((var_1_3 < var_1_4) && var_1_29) ? ((-256 >= var_1_15) ? (var_1_1 == ((signed long int) (min (var_1_12 , var_1_15)))) : (var_1_1 == ((signed long int) (((1000000000 - var_1_36) + (1000000000 - var_1_25)) - var_1_25)))) : (var_1_1 == ((signed long int) (min ((var_1_36 - var_1_25) , ((64 - var_1_25) + -100)))))) : ((var_1_15 >= var_1_25) ? (var_1_1 == ((signed long int) var_1_25)) : 1)) && ((! last_1_var_1_29) ? (var_1_12 == ((signed short int) (last_1_var_1_52 + last_1_var_1_39))) : 1)) && ((((var_1_16 - 1.58f) - var_1_4) >= last_1_var_1_49) ? (((- var_1_3) <= (last_1_var_1_49 / var_1_17)) ? (var_1_15 == ((unsigned char) (min (var_1_18 , 10)))) : (var_1_15 == ((unsigned char) (abs (100))))) : 1)) && (var_1_40 ? (var_1_19 == ((double) (15.6 - (var_1_20 - (abs (32.5)))))) : (var_1_19 == ((double) (var_1_21 + ((var_1_22 - var_1_23) - var_1_24)))))) && (((var_1_16 / (max (var_1_22 , 10000.5))) < var_1_3) ? (var_1_25 == ((unsigned char) ((64 + var_1_26) - ((var_1_27 + 32) - var_1_28)))) : 1)) && ((last_1_var_1_52 > last_1_var_1_12) ? (last_1_var_1_40 ? (var_1_29 == ((unsigned char) (last_1_var_1_40 && var_1_31))) : (var_1_29 == ((unsigned char) (! var_1_31)))) : (((~ -50) > (last_1_var_1_15 / var_1_26)) ? ((last_1_var_1_49 > (- var_1_16)) ? (var_1_29 == ((unsigned char) (last_1_var_1_40 || var_1_32))) : (var_1_29 == ((unsigned char) var_1_33))) : (var_1_29 == ((unsigned char) var_1_31))))) && ((var_1_32 || last_1_var_1_40) ? (var_1_34 == ((unsigned short int) ((20935 - last_1_var_1_36) + var_1_18))) : (var_1_34 == ((unsigned short int) ((var_1_35 - last_1_var_1_36) - (max (var_1_26 , last_1_var_1_25))))))) && (((var_1_40 && var_1_33) || var_1_29) ? ((var_1_3 > (abs (var_1_20))) ? (var_1_36 == ((unsigned short int) (min (((max (var_1_18 , var_1_42)) + (var_1_26 + var_1_27)) , var_1_28)))) : 1) : (((min (var_1_47 , var_1_35)) <= (var_1_15 / (max (-50 , var_1_27)))) ? (var_1_36 == ((unsigned short int) var_1_26)) : 1))) && ((var_1_24 <= (1.6 + var_1_22)) ? (var_1_38 == ((unsigned long int) ((max (var_1_26 , var_1_39)) + (min (var_1_36 , (max (var_1_18 , var_1_28))))))) : 1)) && ((var_1_26 > last_1_var_1_38) ? ((var_1_26 <= last_1_var_1_25) ? (((abs (0.6f)) <= ((var_1_16 + var_1_22) + var_1_4)) ? (var_1_39 == ((unsigned char) (var_1_27 + var_1_28))) : (var_1_39 == ((unsigned char) (var_1_27 + var_1_28)))) : (var_1_31 ? (var_1_39 == ((unsigned char) var_1_18)) : ((last_1_var_1_15 <= var_1_26) ? (var_1_39 == ((unsigned char) (var_1_26 + var_1_28))) : (var_1_39 == ((unsigned char) (min ((var_1_27 + var_1_28) , var_1_18))))))) : (var_1_39 == ((unsigned char) var_1_28)))) && ((var_1_16 < var_1_24) ? (var_1_40 == ((unsigned char) (var_1_31 || ((! var_1_33) || var_1_41)))) : (var_1_40 == ((unsigned char) (((last_1_var_1_52 % var_1_27) < (last_1_var_1_34 * var_1_18)) || var_1_32))))) && ((((max (-1 , var_1_25)) < (~ var_1_15)) && (var_1_47 != var_1_34)) ? (var_1_42 == ((signed short int) (abs (var_1_26)))) : 1)) && (var_1_32 ? ((! var_1_41) ? (var_1_43 == ((float) ((min ((max (var_1_23 , var_1_22)) , (var_1_24 - var_1_44))) + (var_1_45 - var_1_46)))) : (((- var_1_12) < (var_1_25 - var_1_26)) ? ((var_1_42 == (min (var_1_27 , var_1_12))) ? (var_1_43 == ((float) (min ((var_1_45 + var_1_21) , (min ((abs (var_1_24)) , var_1_22)))))) : ((var_1_29 || var_1_40) ? (var_1_43 == ((float) (abs (var_1_20 - var_1_44)))) : 1)) : 1)) : ((var_1_45 <= (var_1_54 + var_1_24)) ? (var_1_43 == ((float) var_1_22)) : (var_1_43 == ((float) (max ((var_1_46 + var_1_21) , var_1_20))))))) && ((! (var_1_28 < var_1_27)) ? (((var_1_25 | var_1_34) >= var_1_34) ? (var_1_47 == ((signed char) (abs (var_1_27)))) : 1) : 1)) && ((((var_1_39 * var_1_36) | last_1_var_1_48) == ((var_1_39 & var_1_28) + var_1_39)) ? (var_1_48 == ((signed short int) var_1_18)) : (var_1_29 ? (var_1_48 == ((signed short int) (abs (var_1_18)))) : (var_1_48 == ((signed short int) (var_1_18 + var_1_15)))))) && (((last_1_var_1_15 > last_1_var_1_12) && last_1_var_1_40) ? (var_1_49 == ((double) (max (var_1_23 , var_1_44)))) : (((var_1_44 + var_1_21) <= (- var_1_16)) ? (var_1_49 == ((double) (((var_1_50 + var_1_51) + 25.5) + var_1_24))) : (var_1_49 == ((double) (var_1_44 + var_1_45)))))) && ((var_1_44 == (- var_1_49)) ? ((var_1_18 < var_1_1) ? ((var_1_49 > var_1_22) ? (var_1_52 == ((signed char) (var_1_28 - var_1_27))) : (var_1_52 == ((signed char) (min (var_1_28 , var_1_27))))) : (var_1_40 ? (var_1_52 == ((signed char) (var_1_28 + var_1_53))) : (var_1_52 == ((signed char) (16 - var_1_28))))) : (var_1_29 ? (var_1_52 == ((signed char) (var_1_28 - var_1_27))) : (var_1_41 ? (var_1_52 == ((signed char) var_1_27)) : (var_1_52 == ((signed char) var_1_53)))))) && (var_1_31 ? (((var_1_15 % (max (var_1_26 , var_1_27))) > ((abs (var_1_39)) | var_1_15)) ? (var_1_54 == ((float) (min (var_1_24 , var_1_44)))) : (var_1_54 == ((float) var_1_44))) : (var_1_54 == ((float) var_1_51)))
;
}
int main(void) {
	isInitial = 1;
