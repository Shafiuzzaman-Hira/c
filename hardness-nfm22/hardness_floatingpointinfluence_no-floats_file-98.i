...
void step(void) {
 ...
 if (((((-128) < (last_1_var_1_15)) ? (-128) : (last_1_var_1_15))) < var_1_13) {
 ...
 if (8 < stepLocal_0) {
  var_1_4 = (((var_1_8 + var_1_9) + ((((var_1_10) < (1.9)) ? (var_1_10) : (1.9)))) + (99.125 + var_1_11));
 }
 if (var_1_2 < var_1_8) {
  if (((- var_1_15) <= var_1_6) || (var_1_4 < var_1_10)) {
   var_1_12 = ((((var_1_6) < (var_1_13)) ? (var_1_6) : (var_1_13)));
  } else {
