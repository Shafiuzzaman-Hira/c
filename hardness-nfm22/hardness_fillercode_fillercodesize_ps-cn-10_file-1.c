...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch1PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch1PS_CN_10
	var_1_15 = (var_1_16 - var_1_17);


	// From: Req8Batch1PS_CN_10
	var_1_27 = var_1_21;


	// From: Req1Batch1PS_CN_10
	...
	// From: Req2Batch1PS_CN_10
	if (var_1_27 < (var_1_27 - var_1_27)) {
		var_1_6 = var_1_9;
	}


	// From: Req3Batch1PS_CN_10
