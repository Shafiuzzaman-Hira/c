...
void step(void) {
	...
	// From: Req2Batch28Amount10
	var_1_8 = var_1_9;


	// From: Req3Batch28Amount10
	var_1_10 = var_1_9;


	// From: Req4Batch28Amount10
	var_1_11 = 10;
}
...
int property() {
	return ((((var_1_2 > ((var_1_3 * var_1_4) / var_1_5)) ? (var_1_1 == ((signed char) (min (var_1_6 , var_1_7)))) : (var_1_1 == ((signed char) var_1_7))) && (var_1_8 == ((unsigned char) var_1_9))) && (var_1_10 == ((unsigned char) var_1_9))) && (var_1_11 == ((unsigned char) 10))
;
}
int main(void) {
	isInitial = 1;
