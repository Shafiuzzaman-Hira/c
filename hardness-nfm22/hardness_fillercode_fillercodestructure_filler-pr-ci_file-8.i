...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch8Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_11) {
  var_1_33 = ((((var_1_26) > (var_1_23)) ? (var_1_26) : (var_1_23)));
 }
 if (var_1_10 == var_1_1) {
  if (var_1_11) {
 ...
 if (var_1_21 != (var_1_22 + var_1_19)) {
  if (var_1_11) {
   var_1_27 = ((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24)));
  }
 } else {
  var_1_27 = var_1_24;
 }
 ...
 if (var_1_20 <= var_1_13) {
  if (var_1_5 < 255.2f) {
   if ((16 <= var_1_22) && (var_1_20 >= var_1_15)) {
    var_1_40 = ((((var_1_15) > (var_1_19)) ? (var_1_15) : (var_1_19)));
   }
  }
 }
 ...
 if (var_1_26 < ((((((((var_1_22) > (var_1_26)) ? (var_1_22) : (var_1_26)))) > (var_1_22)) ? (((((var_1_22) > (var_1_26)) ? (var_1_22) : (var_1_26)))) : (var_1_22)))) {
  var_1_42 = var_1_6;
 } else {
  if (var_1_6 <= var_1_6) {
   var_1_42 = (((((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6))) < 0 ) ? -((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6))) : ((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6)))));
  } else {
   if (var_1_6 <= var_1_6) {
    var_1_42 = (((((var_1_5 - var_1_6)) > (var_1_6)) ? ((var_1_5 - var_1_6)) : (var_1_6)));
   }
  }
 }
 if (var_1_7 < var_1_9) {
 ...
 var_1_38 = var_1_5;
 if ((var_1_22 % var_1_15) < var_1_20) {
  var_1_45 = ((var_1_23 - var_1_23) + var_1_20);
 } else {
  var_1_45 = var_1_20;
 }
