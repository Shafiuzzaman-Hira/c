...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch55Amount25.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch55Amount25
	var_1_13 = ((var_1_14 - var_1_15) - var_1_16);


	// From: Req4Batch55Amount25
	var_1_17 = var_1_6;


	// From: Req5Batch55Amount25
	var_1_18 = var_1_9;


	// From: Req2Batch55Amount25
