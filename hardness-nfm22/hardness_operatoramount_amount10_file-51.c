...
void step(void) {
	// From: Req2Batch51Amount10
	var_1_7 = 25;


	// From: Req1Batch51Amount10
	signed long int stepLocal_0 = -8;
	if (var_1_7 < stepLocal_0) {
		var_1_1 = (var_1_3 - var_1_4);
	} else {
		var_1_1 = (min ((max ((max (var_1_3 , var_1_4)) , (var_1_7 + var_1_7))) , var_1_7));
	}
}
...
int property() {
	return ((var_1_7 < -8) ? (var_1_1 == ((signed short int) (var_1_3 - var_1_4))) : (var_1_1 == ((signed short int) (min ((max ((max (var_1_3 , var_1_4)) , (var_1_7 + var_1_7))) , var_1_7))))) && (var_1_7 == ((signed char) 25))
;
}
int main(void) {
	isInitial = 1;
