...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch34PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch34PS_CN_10
	if (var_1_15 > var_1_12) {
		var_1_18 = (! var_1_19);
	}


	// From: Req4Batch34PS_CN_10
	if (var_1_18) {
		var_1_14 = var_1_12;
	} else {
		var_1_14 = 64;
	...
	// From: Req8Batch34PS_CN_10
	var_1_20 = last_1_var_1_17;


	// From: Req6Batch34PS_CN_10
