...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch82PS_CN_500.c", 13, "reach_error"); }
...
double var_1_46 = 0.19999999999999996;
unsigned char var_1_47 = 0;
unsigned char var_1_48 = 0;
unsigned long int var_1_49 = 50;
unsigned long int var_1_50 = 256;
unsigned long int var_1_51 = 2206674148;
double var_1_52 = 4.45;
double var_1_53 = 1.825;
unsigned short int var_1_54 = 0;
float var_1_55 = 99999.625;
unsigned short int var_1_56 = 5;
signed short int var_1_57 = -500;
...
double var_1_78 = 31.6;
double var_1_79 = 64.5;
double var_1_80 = 9.25;
unsigned char var_1_81 = 1;
unsigned char var_1_82 = 4;
unsigned long int var_1_83 = 128;
double var_1_84 = 4.1;
float var_1_85 = 1.875;
float var_1_86 = 10.4;
float var_1_87 = 15.925;
...
unsigned long int var_1_96 = 8;
double var_1_97 = 1.25;
double var_1_98 = 0.0;
float var_1_99 = 99.5;
float var_1_100 = 8.4;
float var_1_101 = 128.25;
double var_1_102 = 128.6;
float var_1_103 = 1000000000000000.5;
signed long int var_1_104 = 64;
signed short int var_1_105 = -50;
double var_1_106 = 1.8;
float var_1_107 = 63.875;
unsigned long int var_1_108 = 100;
unsigned char var_1_109 = 2;
unsigned short int var_1_110 = 0;
double var_1_111 = 49.5;
unsigned short int var_1_112 = 0;
signed char var_1_113 = 25;
unsigned long int var_1_114 = 500;
unsigned char var_1_115 = 64;
unsigned char var_1_116 = 1;
unsigned long int var_1_117 = 10;
double var_1_118 = 25.5;
double var_1_119 = 5.5;
unsigned short int var_1_120 = 0;
float var_1_121 = 4.75;
...
void step(void) {
	...
	if (var_1_32 > var_1_29) {
		...
		if ((var_1_41 - (abs (var_1_42))) > ((var_1_37 | var_1_43) | var_1_35)) {
			if (var_1_34) {
				var_1_38 = (7.075 + (var_1_44 - (var_1_45 + var_1_46)));
			}
		} else {
			var_1_38 = var_1_40;
		}
		...
		if (var_1_36 < var_1_33) {
			if (var_1_37 < var_1_26) {
				if (var_1_31 >= var_1_32) {
					var_1_49 = (max (var_1_26 , (abs (var_1_32))));
				}
			} else {
				var_1_49 = (abs (var_1_29));
			}
		}
	}
	...
	if (var_1_36 != var_1_31) {
		if ((- var_1_49) < (var_1_32 ^ var_1_42)) {
			var_1_50 = (var_1_51 - (abs (var_1_27)));
		} else {
			var_1_50 = (abs (var_1_28));
		}
	}


	// From: CodeObject9
	var_1_52 = (var_1_45 + (abs (var_1_46 + var_1_53)));
	...
	// From: CodeObject11
	if ((max ((abs (var_1_24)) , var_1_52)) <= (abs (var_1_39))) {
		if (var_1_46 <= var_1_25) {
			var_1_55 = (abs (var_1_53));
		} else {
			var_1_55 = (abs (var_1_25));
		}
	}
	...
	// From: CodeObject13
	if (4 < var_1_32) {
		var_1_57 = (max (var_1_29 , (abs (var_1_27))));
	}


	// From: CodeObject14
	var_1_58 = (min (0 , var_1_29));
	...
	// From: CodeObject16
	if (var_1_36 >= (var_1_49 & var_1_35)) {
		var_1_60 = (! (var_1_48 && (var_1_34 || var_1_61)));
	}


	// From: CodeObject17
	if (var_1_49 < (var_1_26 ^ var_1_29)) {
		if ((- (max (var_1_51 , var_1_49))) <= (var_1_63 / var_1_41)) {
			var_1_62 = ((min ((abs (var_1_64)) , (min (var_1_65 , var_1_66)))) - var_1_42);
		} else {
			var_1_62 = (var_1_42 + var_1_67);
		}
	}


	// From: CodeObject18
	if ((~ var_1_63) >= (var_1_32 / var_1_51)) {
		var_1_68 = var_1_69;
	}


	// From: CodeObject19
	if ((var_1_40 - var_1_44) < (abs (var_1_46))) {
		var_1_70 = (abs (var_1_33));
	} else {
		if (-5 < (abs (var_1_33))) {
			if ((5.25f * (-0.6f + var_1_53)) >= var_1_45) {
				var_1_70 = var_1_28;
			}
		} else {
			if ((64u / var_1_41) < ((var_1_31 - var_1_66) >> var_1_58)) {
				if (var_1_41 > (abs (var_1_54))) {
					var_1_70 = (abs (var_1_41));
				}
			} else {
				var_1_70 = (min (var_1_58 , var_1_28));
			}
		}
	}
	...
	// From: CodeObject20
	if ((var_1_72 % 1) < (var_1_29 % var_1_65)) {
		var_1_71 = (abs (var_1_29 + var_1_42));
	}


	// From: CodeObject21
	if (((var_1_56 / 16) * var_1_50) >= var_1_51) {
		if (var_1_74) {
			if ((min (var_1_43 , var_1_42)) > (var_1_65 ^ var_1_27)) {
				if (var_1_61) {
					if (var_1_70 <= var_1_32) {
						var_1_73 = var_1_28;
					}
				}
			}
		...
		if (var_1_30 < var_1_66) {
			if (var_1_75 && var_1_47) {
				var_1_73 = var_1_41;
			}
		} else {
			if (((var_1_29 & var_1_57) & var_1_49) <= var_1_66) {
				var_1_73 = (max (5 , 256));
			}
		}
	}
	...
	if (var_1_63 < var_1_41) {
		if (var_1_66 < var_1_73) {
			var_1_76 = (abs (var_1_65 - 5));
		} else {
			if (var_1_55 >= (var_1_59 + var_1_39)) {
				var_1_76 = ((max (var_1_67 , var_1_42)) + var_1_77);
			}
		}
	} else {
		var_1_76 = (max (var_1_64 , var_1_29));
	}


	// From: CodeObject23
	if (var_1_47) {
		if (! ((min (var_1_26 , var_1_66)) == var_1_54)) {
			var_1_78 = (min (var_1_25 , 3.2));
		}
	}
	...
	if (var_1_53 > var_1_59) {
		var_1_79 = (max (500.125 , var_1_46));
	}


	// From: CodeObject25
	if (var_1_26 > (min (var_1_28 , 10))) {
		if (var_1_78 > var_1_55) {
			var_1_80 = (abs (abs (99.25)));
		}
	}


	// From: CodeObject26
	if (var_1_29 <= (min (var_1_35 , var_1_82))) {
		if (var_1_60) {
			var_1_81 = (var_1_48 || var_1_61);
		} else {
			var_1_81 = 1;
		}
	}
	...
	// From: CodeObject27
	if ((~ var_1_58) > ((var_1_54 >> var_1_30) % (min (var_1_32 , var_1_41)))) {
		var_1_83 = ((var_1_32 - var_1_54) + var_1_67);
	}


	// From: CodeObject28
	if (var_1_82 > var_1_29) {
		if ((max ((- 2.875) , var_1_39)) > (- var_1_24)) {
			var_1_84 = (24.6 - ((abs (var_1_39)) - var_1_46));
		}
	} else {
		var_1_84 = (min (var_1_39 , var_1_40));
	}


	// From: CodeObject29
	if ((var_1_40 * (var_1_86 / var_1_39)) < var_1_53) {
		if ((var_1_59 * var_1_46) <= var_1_55) {
			var_1_85 = (var_1_44 - var_1_46);
		}
	} else {
		var_1_85 = (max ((max (-0.8f , var_1_87)) , (var_1_46 - var_1_45)));
	}
	...
	if (256 >= var_1_76) {
		if (var_1_47) {
			var_1_88 = ((abs (var_1_51)) - (var_1_32 - (var_1_89 - var_1_58)));
		} else {
			var_1_88 = var_1_54;
		}
	}
	...
	// From: CodeObject31
	if (var_1_63 > (~ (abs (var_1_27)))) {
		var_1_90 = (abs (2));
	}


	// From: CodeObject32
	var_1_91 = ((! var_1_69) && var_1_61);


	// From: CodeObject33
	if ((min ((var_1_33 >> var_1_26) , -16)) > var_1_89) {
		var_1_92 = (var_1_65 - var_1_41);
	}


	// From: CodeObject34
	if (var_1_91) {
		if (((var_1_49 % 64) | var_1_89) >= var_1_83) {
			if (var_1_80 != 9.99999996E7) {
				var_1_93 = (max ((var_1_41 + (max (var_1_27 , -8))) , (var_1_28 - var_1_62)));
			} else {
				if (var_1_65 == var_1_43) {
					var_1_93 = (var_1_62 + (min ((max (var_1_67 , var_1_27)) , var_1_66)));
				}
			}
		}
	}
	...
	// From: CodeObject35
	if ((max (var_1_46 , 0.30000000000000004f)) > (var_1_86 * var_1_25)) {
		if ((var_1_89 / var_1_64) < var_1_26) {
			if (var_1_81) {
				if (var_1_44 < var_1_85) {
					var_1_94 = (abs (var_1_29));
				} else {
					var_1_94 = 500;
				}
			} else {
				var_1_94 = (min (var_1_26 , var_1_28));
			}
		} else {
			var_1_94 = (abs (var_1_27));
		}
	} else {
	...
	// From: CodeObject36
	if (var_1_51 < var_1_42) {
		if (var_1_47) {
			var_1_95 = (abs (max ((abs (var_1_64)) , (abs (var_1_96)))));
		}
	} else {
		var_1_95 = (abs (var_1_65));
	}


	// From: CodeObject37
	if (var_1_39 > var_1_78) {
		var_1_97 = (abs (abs (var_1_25)));
	} else {
		if (var_1_44 < ((var_1_98 - var_1_46) - var_1_40)) {
			var_1_97 = (abs (var_1_44));
		}
	}


	// From: CodeObject38
	if (var_1_92 < (abs (var_1_27))) {
		var_1_99 = (min (var_1_44 , ((min (var_1_45 , 31.5f)) - (var_1_46 + var_1_100))));
	} else {
		var_1_99 = (abs (abs (min (var_1_39 , var_1_45))));
	}


	// From: CodeObject39
	if (var_1_88 <= (25u * var_1_94)) {
		var_1_101 = (abs (var_1_100 + var_1_46));
	} else {
		if (((var_1_62 ^ var_1_70) <= var_1_36) || (var_1_100 >= (max (var_1_59 , 1.000000000875E9f)))) {
			var_1_101 = (abs (var_1_45));
		}
	}


	// From: CodeObject40
	if (var_1_100 > (var_1_98 - var_1_46)) {
		var_1_102 = (var_1_100 + var_1_53);
	} else {
		if (var_1_75) {
			var_1_102 = (var_1_46 - (max (var_1_100 , var_1_45)));
		}
	}
	...
	// From: CodeObject41
	if (var_1_34) {
		if (var_1_104 > var_1_43) {
			var_1_103 = var_1_87;
		} else {
			var_1_103 = ((abs (var_1_100)) + (min ((abs (var_1_53)) , var_1_46)));
		}
	} else {
		var_1_103 = (abs (var_1_45 - var_1_100));
	}


	// From: CodeObject42
	if (var_1_26 < 16) {
		var_1_105 = (var_1_41 + (16 - var_1_26));
	}


	// From: CodeObject43
	if (var_1_81 && (var_1_57 <= var_1_27)) {
		var_1_106 = (min (var_1_39 , var_1_45));
	}


	// From: CodeObject44
	if (var_1_81) {
		if (var_1_27 == ((abs (var_1_28)) | var_1_93)) {
			if (! var_1_47) {
				var_1_107 = (min (var_1_46 , var_1_53));
			} else {
				var_1_107 = (min ((var_1_45 - (31.3f + var_1_46)) , var_1_53));
			}
		}
	}
	...
	// From: CodeObject45
	if ((min (var_1_52 , var_1_97)) < var_1_107) {
		var_1_108 = (max (var_1_32 , (abs (var_1_89))));
	} else {
		if (var_1_81) {
			var_1_108 = (max (var_1_65 , var_1_56));
		}
	}
	...
	// From: CodeObject46
	if (var_1_75) {
		if ((var_1_72 + var_1_67) <= (16 + (var_1_56 + var_1_105))) {
			var_1_109 = (abs (abs (var_1_29)));
		}
	} else {
		if (var_1_95 >= var_1_54) {
	...
	// From: CodeObject61
	if (var_1_109 == ((var_1_41 - var_1_77) / (abs (var_1_64)))) {
		var_1_125 = (var_1_48 || var_1_61);
	} else {
		if (var_1_126 >= var_1_71) {
			var_1_125 = var_1_69;
		}
	}


	// From: Req7Batch82PS_CN_500
	var_1_23 = last_1_var_1_14;


	// From: Req2Batch82PS_CN_500
	var_1_7 = (var_1_4 - (var_1_8 + var_1_9));


	// From: Req5Batch82PS_CN_500
	...
	// From: Req3Batch82PS_CN_500
	var_1_10 = (var_1_11 && (var_1_21 || var_1_13));


	// From: Req4Batch82PS_CN_500
...
void updateVariables() {
	...
	assume_abort_if_not((var_1_98 >= 4611686.018427387900e+12F && var_1_98 <= -1.0e-20F) || (var_1_98 <= 9223372.036854776000e+12F && var_1_98 >= 1.0e-20F ));
	var_1_100 = __VERIFIER_nondet_float();
	assume_abort_if_not((var_1_100 >= 0.0F && var_1_100 <= -1.0e-20F) || (var_1_100 <= 4611686.018427382800e+12F && var_1_100 >= 1.0e-20F ));
