...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch54Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_4 >= var_1_8) {
  ...
  var_1_25 = ((var_1_22 + 4.1f) + (var_1_22 + ((((var_1_22) > (var_1_22)) ? (var_1_22) : (var_1_22)))));
 }
 var_1_33 = var_1_8;
 if ((var_1_5 ^ (var_1_14 >> var_1_8)) < var_1_14) {
  var_1_35 = var_1_14;
 }
 if (! var_1_11) {
 ...
 if (var_1_14 >= var_1_5) {
  if (var_1_22 >= (var_1_16 - var_1_15)) {
   var_1_40 = ((((((((((-4) < 0 ) ? -(-4) : (-4))) < 0 ) ? -((((-4) < 0 ) ? -(-4) : (-4))) : ((((-4) < 0 ) ? -(-4) : (-4))))) < 0 ) ? -(((((((-4) < 0 ) ? -(-4) : (-4))) < 0 ) ? -((((-4) < 0 ) ? -(-4) : (-4))) : ((((-4) < 0 ) ? -(-4) : (-4))))) : (((((((-4) < 0 ) ? -(-4) : (-4))) < 0 ) ? -((((-4) < 0 ) ? -(-4) : (-4))) : ((((-4) < 0 ) ? -(-4) : (-4)))))));
  }
 } else {
  if (var_1_22 <= ((((var_1_15 * var_1_18) < 0 ) ? -(var_1_15 * var_1_18) : (var_1_15 * var_1_18)))) {
   var_1_40 = ((((((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8))) < 0 ) ? -((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8))) : ((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8))))) + ((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8))));
  }
 }
 if ((var_1_38 < var_1_8) && (var_1_21 != var_1_16)) {
  if (var_1_8 > var_1_5) {
   var_1_43 = 8;
  } else {
   var_1_43 = var_1_38;
