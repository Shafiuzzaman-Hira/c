...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch53Amount10.c", 13, "reach_error"); }
...
signed long int var_1_8 = -10000000;
...
int property() {
	return ((var_1_2 / (min (var_1_3 , var_1_4))) > (var_1_5 * var_1_6)) ? ((var_1_3 == var_1_6) ? (var_1_1 == ((signed long int) (var_1_7 + var_1_8))) : (var_1_1 == ((signed long int) var_1_8))) : 1
;
}
int main(void) {
	isInitial = 1;
