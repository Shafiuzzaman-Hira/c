...
void step(void) {
	...
	// From: CodeObject5
	if (var_1_12 > 32.8) {
		var_1_34 = (max ((var_1_35 - var_1_20) , var_1_1));
	}
	...
	// From: CodeObject9
	if (((abs (var_1_20)) / var_1_37) > (var_1_1 * 10)) {
		if (! var_1_19) {
			var_1_43 = var_1_33;
		} else {
			var_1_43 = var_1_33;
