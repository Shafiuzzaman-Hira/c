...
void step(void) {
	// From: Req4Batch37Wrapper_A
	signed_long_int_Array_0[0] = signed_char_Array_0[1];


	// From: Req6Batch37Wrapper_A
	signed_short_int_Array_0[0] = signed_long_int_Array_0[0];


	// From: Req2Batch37Wrapper_A
	signed long int stepLocal_0 = abs (signed_long_int_Array_0[0]);
	...
	if (2.75f > float_Array_0[0]) {
		...
		if ((unsigned_long_int_Array_0[0] - (max (signed_long_int_Array_0[0] , signed_char_Array_0[1]))) > stepLocal_1) {
			signed_char_Array_0[4] = (min ((min (signed_char_Array_0[1] , (1 + 5))) , signed_char_Array_0[2]));
		}
	}
}
...
int property() {
	return ((((((((unsigned_short_int_Array_0[1] - unsigned_short_int_Array_0[0]) ^ (signed_long_int_Array_0[1] * signed_short_int_Array_0[0])) <= -64) ? (unsigned_char_Array_0[1] == ((unsigned char) unsigned_char_Array_0[0])) : (unsigned_char_Array_0[1] == ((unsigned char) unsigned_char_Array_0[0]))) && ((unsigned_short_int_Array_0[1] <= (abs (signed_long_int_Array_0[0]))) ? (signed_char_Array_0[3] == ((signed char) ((signed_char_Array_0[1] - (1 + signed_char_Array_0[0])) + signed_char_Array_0[2]))) : (signed_char_Array_0[3] == ((signed char) signed_char_Array_0[2])))) && ((2.75f > float_Array_0[0]) ? (signed_char_Array_0[4] == ((signed char) (signed_char_Array_0[2] + signed_char_Array_0[1]))) : (((unsigned_long_int_Array_0[0] - (max (signed_long_int_Array_0[0] , signed_char_Array_0[1]))) > unsigned_char_Array_0[1]) ? (signed_char_Array_0[4] == ((signed char) (min ((min (signed_char_Array_0[1] , (1 + 5))) , signed_char_Array_0[2])))) : 1))) && (signed_long_int_Array_0[0] == ((signed long int) signed_char_Array_0[1]))) && (signed_long_int_Array_0[1] == ((signed long int) signed_short_int_Array_0[0]))) && (signed_short_int_Array_0[0] == ((signed short int) signed_long_int_Array_0[0]))
;
}
int main(void) {
	isInitial = 1;
