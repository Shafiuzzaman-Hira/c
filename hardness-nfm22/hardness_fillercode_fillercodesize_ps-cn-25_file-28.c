...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch28PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject5
	if (var_1_28) {
		if ((max ((var_1_27 + var_1_29) , var_1_33)) > var_1_32) {
	...
	// From: CodeObject6
	if (5 >= var_1_36) {
		var_1_39 = (max ((var_1_40 - var_1_41) , var_1_31));
	}


	// From: Req3Batch28PS_CN_25
