...
void step(void) {
	...
	signed long int stepLocal_1 = min ((*(WrapperStruct00_var_1_12_Pointer)) , (*(WrapperStruct00_var_1_12_Pointer)));
	unsigned long int stepLocal_0 = (*(WrapperStruct00_var_1_3_Pointer));
	if (stepLocal_1 != (min ((*(WrapperStruct00_var_1_4_Pointer)) , (*(WrapperStruct00_var_1_3_Pointer))))) {
