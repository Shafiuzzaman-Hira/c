...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch20PS_CN_50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch20PS_CN_50
	var_1_15 = (var_1_14 + var_1_16);


	// From: Req6Batch20PS_CN_50
	if (var_1_2) {
