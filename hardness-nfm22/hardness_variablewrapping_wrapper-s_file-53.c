...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch53Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	...
	WrapperStruct00.var_1_1 = (WrapperStruct00.var_1_12 + (WrapperStruct00.var_1_3 - (WrapperStruct00.var_1_4 - WrapperStruct00.var_1_12)));


	// From: Req3Batch53Wrapper_S
	signed long int stepLocal_1 = min (WrapperStruct00.var_1_12 , WrapperStruct00.var_1_12);
	unsigned long int stepLocal_0 = WrapperStruct00.var_1_3;
	if (stepLocal_1 != (min (WrapperStruct00.var_1_4 , WrapperStruct00.var_1_3))) {
