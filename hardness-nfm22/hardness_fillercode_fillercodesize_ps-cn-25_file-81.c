...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch81PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((var_1_34 ^ (~ var_1_33)) > var_1_32) {
		var_1_36 = ((max (var_1_25 , (abs (var_1_35)))) - ((abs (-1395864830)) - (var_1_32 + var_1_34)));
	}
	...
	// From: Req5Batch81PS_CN_25
	var_1_16 = (last_1_var_1_17 - 1);


	// From: Req2Batch81PS_CN_25
	...
	// From: Req3Batch81PS_CN_25
	if (! var_1_9) {
		var_1_10 = (min (var_1_1 , var_1_5));
	}


	// From: Req4Batch81PS_CN_25
	if (var_1_8) {
		var_1_11 = ((max (var_1_12 , var_1_13)) - ((var_1_14 + var_1_15) - last_1_var_1_11));
	}


	// From: Req8Batch81PS_CN_25
	var_1_24 = var_1_12;


	// From: Req7Batch81PS_CN_25
