...
void step(void) {
	...
	if (var_1_32 > var_1_36) {
		var_1_41 = (min (var_1_36 , (abs (var_1_42))));
	}
	...
	if (var_1_43 < (var_1_29 + 127.5)) {
		...
		var_1_47 = (abs (var_1_41 - (var_1_38 + var_1_42)));
	}
	...
	if (var_1_40) {
		...
		if (var_1_48) {
			...
			var_1_52 = (var_1_55 - (var_1_54 + (abs (var_1_53))));
		}
	}
	...
	if ((var_1_57 - 2u) >= var_1_36) {
		var_1_56 = (abs (min (var_1_42 , (abs (128u)))));
	} else {
		if (var_1_46) {
			var_1_56 = var_1_52;
		} else {
	...
	// From: Req2Batch71PS_CN_100
	var_1_10 = var_1_11;


	// From: Req3Batch71PS_CN_100
	...
	// From: Req5Batch71PS_CN_100
	var_1_18 = (max ((max (255.5f , var_1_11)) , 5.5f));


	// From: Req7Batch71PS_CN_100
	var_1_20 = var_1_15;


	// From: Req8Batch71PS_CN_100
	var_1_21 = var_1_5;


	// From: Req9Batch71PS_CN_100
	var_1_22 = var_1_23;


	// From: Req6Batch71PS_CN_100
	if (var_1_3) {
