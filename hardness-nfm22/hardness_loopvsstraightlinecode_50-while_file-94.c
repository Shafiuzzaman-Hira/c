...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch9450_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch9450_while
	var_1_9 = ((min (var_1_10 , var_1_11)) + (var_1_12 + (var_1_13 - var_1_14)));


	// From: Req4Batch9450_while
	if (var_1_10 >= var_1_11) {
		var_1_15 = (max ((max ((abs (var_1_16)) , var_1_17)) , var_1_18));
	}


	// From: Req7Batch9450_while
	var_1_25 = -256;


	// From: Req8Batch9450_while
	var_1_26 = var_1_17;


	// From: Req9Batch9450_while
	var_1_27 = var_1_6;


	// From: Req2Batch9450_while
	if (var_1_7 || var_1_1) {
