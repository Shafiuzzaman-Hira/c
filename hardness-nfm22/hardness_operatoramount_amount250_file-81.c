...
void step(void) {
	...
	if (last_1_var_1_44 && last_1_var_1_44) {
		var_1_14 = (max (var_1_15 , (var_1_16 + (var_1_17 - var_1_18))));
	}
	...
	signed long int stepLocal_20 = abs (last_1_var_1_57);
	...
	if (stepLocal_20 > var_1_43) {
		if (((var_1_17 - last_1_var_1_62) * last_1_var_1_25) == stepLocal_19) {
			...
			var_1_51 = (min ((abs (last_1_var_1_25)) , (var_1_52 - var_1_43)));
		}
	}
	...
	if (stepLocal_7 || (var_1_15 < (last_1_var_1_24 / var_1_10))) {
		if (last_1_var_1_21 <= stepLocal_6) {
			if ((max (1 , last_1_var_1_42)) < stepLocal_5) {
				var_1_21 = (min (var_1_17 , var_1_18));
			} else {
	...
	if (var_1_44) {
		if (((abs (var_1_17)) / var_1_23) > stepLocal_13) {
			var_1_36 = ((max (var_1_34 , (var_1_35 + var_1_38))) - var_1_28);
		}
	} else {
		var_1_36 = (min (var_1_28 , (var_1_38 - (var_1_34 + var_1_35))));
	}
	...
	if (var_1_13 < (- (last_1_var_1_53 * last_1_var_1_53))) {
		var_1_42 = (max (var_1_18 , (var_1_17 + var_1_43)));
	} else {
		var_1_42 = (max ((min (var_1_41 , (max (var_1_43 , var_1_17)))) , var_1_18));
	}


	// From: Req8Batch81Amount250
	signed long int stepLocal_9 = last_1_var_1_42;
	if (128.8 <= (min ((last_1_var_1_36 / var_1_26) , var_1_12))) {
		if (stepLocal_9 <= var_1_23) {
			var_1_25 = (61453 - last_1_var_1_54);
		} else {
			var_1_25 = (abs (var_1_17));
		}
	} else {
		var_1_25 = (min (var_1_18 , last_1_var_1_51));
	}
	...
	if ((var_1_32 <= var_1_28) && var_1_48) {
		...
		var_1_54 = (var_1_17 - ((min (var_1_18 , var_1_25)) + 8));
	}
	...
	signed long int stepLocal_17 = min (var_1_16 , var_1_25);
	unsigned char stepLocal_16 = var_1_44;
	if ((var_1_17 + var_1_41) >= stepLocal_17) {
		if (stepLocal_18 <= var_1_25) {
			var_1_50 = ((var_1_31 + 500.8f) + (max (var_1_34 , var_1_38)));
		} else {
			if (stepLocal_16 && var_1_49) {
				var_1_50 = (min ((max ((var_1_35 - var_1_38) , var_1_28)) , (min ((abs (var_1_34)) , var_1_30))));
			}
		}
	}
	...
	if (! var_1_45) {
		if (var_1_29 <= (- (abs (var_1_29)))) {
			var_1_55 = (max (16.125 , var_1_12));
		} else {
			var_1_55 = 9.99999999995E10;
		}
	} else {
		var_1_55 = (var_1_34 - (abs (var_1_13)));
	}


	// From: Req22Batch81Amount250
	var_1_59 = var_1_38;


	// From: Req23Batch81Amount250
	if (var_1_45) {
		var_1_60 = var_1_15;
	}


	// From: Req24Batch81Amount250
	if (var_1_49) {
		var_1_61 = var_1_12;
	} else {
		var_1_61 = var_1_31;
	...
	// From: Req21Batch81Amount250
	if ((- (var_1_38 * var_1_50)) >= 8.5) {
		var_1_57 = (max (var_1_41 , (var_1_58 - var_1_20)));
	} else {
		var_1_57 = var_1_17;
	}
	...
	if ((- var_1_9) > var_1_29) {
		var_1_27 = ((abs (abs (var_1_13))) - var_1_28);
	}
	...
	if (! (var_1_9 > var_1_27)) {
		if (stepLocal_0 >= (var_1_20 ^ (abs (var_1_42)))) {
			if (var_1_42 <= stepLocal_1) {
				var_1_1 = var_1_20;
			}
		} else {
			var_1_1 = (max (var_1_20 , var_1_60));
		}
	}
...
int property() {
	return (((((((((((((((((((((((((! (var_1_9 > var_1_27)) ? (((~ (abs (4))) >= (var_1_20 ^ (abs (var_1_42)))) ? ((var_1_42 <= var_1_20) ? (var_1_1 == ((signed long int) var_1_20)) : 1) : (var_1_1 == ((signed long int) (max (var_1_20 , var_1_60))))) : 1) && ((var_1_62 == (var_1_57 / var_1_10)) ? ((! (var_1_25 <= var_1_57)) ? ((var_1_44 && var_1_44) ? ((var_1_24 > (var_1_42 + (var_1_62 + var_1_10))) ? (var_1_9 == ((float) var_1_12)) : (var_1_9 == ((float) var_1_12))) : (var_1_9 == ((float) var_1_12))) : (var_1_9 == ((float) var_1_13))) : (var_1_9 == ((float) var_1_13)))) && ((last_1_var_1_44 && last_1_var_1_44) ? (var_1_14 == ((signed char) (max (var_1_15 , (var_1_16 + (var_1_17 - var_1_18)))))) : 1)) && (var_1_19 == ((double) (abs (max (var_1_12 , 8.4)))))) && (((var_1_12 * var_1_13) > var_1_19) ? (var_1_20 == ((signed short int) var_1_16)) : 1)) && (((var_1_12 < (9.5f - var_1_22)) || (var_1_15 < (last_1_var_1_24 / var_1_10))) ? ((last_1_var_1_21 <= last_1_var_1_1) ? (((max (1 , last_1_var_1_42)) < (var_1_10 / var_1_23)) ? (var_1_21 == ((unsigned char) (min (var_1_17 , var_1_18)))) : (var_1_21 == ((unsigned char) (var_1_17 + var_1_18)))) : 1) : 1)) && ((! var_1_44) ? (var_1_44 ? (var_1_24 == ((unsigned char) var_1_17)) : (var_1_24 == ((unsigned char) (200 - (var_1_17 + var_1_18))))) : ((var_1_21 < -10000) ? (var_1_24 == ((unsigned char) var_1_18)) : (var_1_24 == ((unsigned char) 50))))) && ((128.8 <= (min ((last_1_var_1_36 / var_1_26) , var_1_12))) ? ((last_1_var_1_42 <= var_1_23) ? (var_1_25 == ((unsigned short int) (61453 - last_1_var_1_54))) : (var_1_25 == ((unsigned short int) (abs (var_1_17))))) : (var_1_25 == ((unsigned short int) (min (var_1_18 , last_1_var_1_51)))))) && (((- var_1_9) > var_1_29) ? (var_1_27 == ((double) ((abs (abs (var_1_13))) - var_1_28))) : 1)) && ((var_1_44 && (var_1_44 && (var_1_24 != var_1_16))) ? (var_1_29 == ((double) (var_1_30 + (var_1_31 + var_1_32)))) : (var_1_29 == ((double) var_1_13)))) && (((- var_1_18) > var_1_10) ? (((var_1_10 + var_1_25) != var_1_15) ? (var_1_33 == ((double) ((var_1_34 + var_1_35) - var_1_28))) : (var_1_33 == ((double) var_1_12))) : 1)) && (var_1_44 ? ((((abs (var_1_17)) / var_1_23) > var_1_21) ? (var_1_36 == ((double) ((max (var_1_34 , (var_1_35 + var_1_38))) - var_1_28))) : 1) : (var_1_36 == ((double) (min (var_1_28 , (var_1_38 - (var_1_34 + var_1_35)))))))) && ((1.2 >= (var_1_26 * var_1_36)) ? (var_1_39 == ((unsigned char) (max (var_1_18 , 10)))) : ((var_1_15 <= ((last_1_var_1_39 / var_1_40) + last_1_var_1_39)) ? ((var_1_18 >= var_1_51) ? (var_1_39 == ((unsigned char) (var_1_41 - var_1_18))) : (((var_1_33 / var_1_26) < (var_1_32 + var_1_28)) ? (var_1_39 == ((unsigned char) (var_1_17 + var_1_18))) : (var_1_39 == ((unsigned char) (var_1_17 + 4))))) : (var_1_39 == ((unsigned char) (16 + var_1_18)))))) && ((var_1_13 < (- (last_1_var_1_53 * last_1_var_1_53))) ? (var_1_42 == ((unsigned char) (max (var_1_18 , (var_1_17 + var_1_43))))) : (var_1_42 == ((unsigned char) (max ((min (var_1_41 , (max (var_1_43 , var_1_17)))) , var_1_18)))))) && ((var_1_14 >= (var_1_41 - (64 - var_1_17))) ? (var_1_44 == ((unsigned char) (! (var_1_45 && var_1_46)))) : (var_1_44 == ((unsigned char) ((var_1_47 || var_1_48) || var_1_49))))) && (((var_1_17 + var_1_41) >= (min (var_1_16 , var_1_25))) ? ((var_1_18 <= var_1_25) ? (var_1_50 == ((float) ((var_1_31 + 500.8f) + (max (var_1_34 , var_1_38))))) : ((var_1_44 && var_1_49) ? (var_1_50 == ((float) (min ((max ((var_1_35 - var_1_38) , var_1_28)) , (min ((abs (var_1_34)) , var_1_30)))))) : 1)) : 1)) && (((abs (last_1_var_1_57)) > var_1_43) ? ((((var_1_17 - last_1_var_1_62) * last_1_var_1_25) == var_1_18) ? (var_1_51 == ((unsigned long int) (last_1_var_1_62 + last_1_var_1_39))) : (var_1_51 == ((unsigned long int) (min ((abs (last_1_var_1_25)) , (var_1_52 - var_1_43)))))) : 1)) && (((var_1_18 * var_1_54) < (var_1_54 * (var_1_41 / var_1_40))) ? ((var_1_27 > var_1_32) ? (var_1_53 == ((double) (127.4 + var_1_32))) : 1) : 1)) && (((var_1_32 <= var_1_28) && var_1_48) ? (var_1_54 == ((signed long int) (var_1_17 - var_1_25))) : (var_1_54 == ((signed long int) (var_1_17 - ((min (var_1_18 , var_1_25)) + 8)))))) && ((! var_1_45) ? ((var_1_29 <= (- (abs (var_1_29)))) ? (var_1_55 == ((double) (max (16.125 , var_1_12)))) : (var_1_55 == ((double) 9.99999999995E10))) : (var_1_55 == ((double) (var_1_34 - (abs (var_1_13))))))) && (((- (var_1_38 * var_1_50)) >= 8.5) ? (var_1_57 == ((unsigned short int) (max (var_1_41 , (var_1_58 - var_1_20))))) : (var_1_57 == ((unsigned short int) var_1_17)))) && (var_1_59 == ((float) var_1_38))) && (var_1_45 ? (var_1_60 == ((signed char) var_1_15)) : 1)) && (var_1_49 ? (var_1_61 == ((double) var_1_12)) : (var_1_61 == ((double) var_1_31)))) && ((last_1_var_1_21 < last_1_var_1_54) ? (((abs (var_1_28)) >= (last_1_var_1_27 + var_1_31)) ? (var_1_62 == ((unsigned long int) (var_1_18 + last_1_var_1_62))) : (var_1_46 ? (var_1_62 == ((unsigned long int) last_1_var_1_51)) : 1)) : (var_1_62 == ((unsigned long int) var_1_58)))
;
}
int main(void) {
	isInitial = 1;
