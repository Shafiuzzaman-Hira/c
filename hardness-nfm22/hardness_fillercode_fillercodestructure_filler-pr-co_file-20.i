...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch20Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_24 || (var_1_6 <= (var_1_17 / var_1_38))) {
  var_1_37 = (var_1_39 || var_1_40);
 }
 if ((var_1_8 + ((((var_1_1) < (var_1_38)) ? (var_1_1) : (var_1_38)))) <= var_1_6) {
  if (var_1_37) {
   var_1_41 = var_1_38;
  }
 }
 ...
 if (var_1_27 || (var_1_18 <= var_1_18)) {
  if ((var_1_1 | (var_1_6 * var_1_6)) == ((((var_1_17) < (-32)) ? (var_1_17) : (-32)))) {
   var_1_29 = ((((((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))) > (var_1_1)) ? (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))) : (var_1_1)));
  } else {
   var_1_29 = (((((((var_1_1) < (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))))) ? (var_1_1) : (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))))) < 0 ) ? -((((var_1_1) < (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))))) ? (var_1_1) : (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))))) : ((((var_1_1) < (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))))) ? (var_1_1) : (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))))))));
  }
 } else {
  var_1_29 = (var_1_1 + (((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6))) + var_1_6));
 }
 ...
 if (var_1_24) {
  if (var_1_15 > (var_1_20 / ((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))))) {
   var_1_23 = 100;
  } else {
   var_1_23 = 10;
  }
