...
void step(void) {
	...
	if (! var_1_20) {
		...
		if (var_1_22 <= var_1_23) {
			if (((abs (var_1_8)) - var_1_3) < var_1_8) {
				if (var_1_8 < var_1_3) {
					var_1_27 = var_1_28;
				}
			} else {
	...
	if ((var_1_23 < var_1_34) || var_1_20) {
		if ((var_1_6 / (min (-10 , var_1_6))) >= (min (var_1_11 , var_1_7))) {
			var_1_33 = var_1_7;
		} else {
			var_1_33 = var_1_7;
		}
	...
	// From: CodeObject5
	if (var_1_12 > (var_1_8 | (abs (var_1_5)))) {
		var_1_36 = (max (8 , (max ((max (var_1_5 , var_1_4)) , var_1_3))));
	}
	...
	// From: Req2Batch31Filler_PS_CI
	var_1_8 = (min ((var_1_5 + (64 - 16)) , 64));


	// From: Req4Batch31Filler_PS_CI
	...
	// From: Req6Batch31Filler_PS_CI
	var_1_17 = var_1_13;


	// From: Req7Batch31Filler_PS_CI
