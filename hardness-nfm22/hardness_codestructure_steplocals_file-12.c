...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch12stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch12stepLocals
	if ((var_1_12 / var_1_16) >= var_1_10) {
		var_1_15 = (var_1_17 + 255.5);
	}


	// From: Req5Batch12stepLocals
	...
	if (var_1_3 > stepLocal_1) {
		...
		if (stepLocal_2 || (var_1_9 >= var_1_8)) {
			var_1_18 = var_1_6;
		} else {
			var_1_18 = var_1_7;
		}
	...
	// From: Req6Batch12stepLocals
	var_1_21 = (abs (var_1_7));


	// From: Req7Batch12stepLocals
