...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch78PS_CN_50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch78PS_CN_50
	var_1_20 = (max ((var_1_5 + var_1_6) , var_1_4));


	// From: Req4Batch78PS_CN_50
	...
	// From: Req6Batch78PS_CN_50
	var_1_16 = (var_1_17 + (var_1_18 + (abs (var_1_19))));


	// From: Req1Batch78PS_CN_50
	var_1_1 = (abs (var_1_16));


	// From: Req8Batch78PS_CN_50
