...
void step(void) {
	...
	if (var_1_1) {
		...
		var_1_37 = (min (var_1_34 , var_1_33));
	}
	...
	if (var_1_26 > var_1_18) {
		var_1_42 = (max ((min (var_1_34 , var_1_15)) , (abs (32))));
	} else {
		var_1_42 = (max ((abs (min (16 , var_1_15))) , var_1_34));
	}
	...
	if (var_1_13 < var_1_13) {
		var_1_46 = (min (var_1_15 , (max (256u , var_1_34))));
	}
