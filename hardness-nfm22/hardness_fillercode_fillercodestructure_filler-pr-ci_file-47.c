...
void step(void) {
	...
	// From: CodeObject9
	if (((abs (var_1_8)) / var_1_4) > (var_1_6 * 10)) {
		if (! var_1_19) {
			var_1_43 = var_1_11;
		} else {
			var_1_43 = var_1_11;
	...
	// From: CodeObject5
	if (var_1_12 > 32.8) {
		var_1_34 = (max ((var_1_35 - var_1_8) , var_1_1));
	}
