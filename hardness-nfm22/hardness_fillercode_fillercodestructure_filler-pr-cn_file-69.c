...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch69Filler_PR_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_25) {
		if (var_1_28 <= var_1_26) {
			...
			var_1_32 = (min (var_1_33 , 0));
		}
	} else {
		if ((var_1_28 % var_1_34) != (var_1_24 + var_1_30)) {
			if ((min (8.4f , var_1_35)) < 127.2f) {
				var_1_32 = (abs (var_1_36));
			} else {
				var_1_32 = (abs (var_1_36));
			}
		} else {
			if (((abs (var_1_27)) << var_1_28) > var_1_34) {
				if ((-100 | var_1_31) >= var_1_28) {
					var_1_32 = var_1_33;
				}
			} else {
				var_1_32 = var_1_37;
	...
	// From: CodeObject1
	if (var_1_25) {
		var_1_24 = (((max (var_1_26 , var_1_27)) + var_1_28) + 1);
	}
