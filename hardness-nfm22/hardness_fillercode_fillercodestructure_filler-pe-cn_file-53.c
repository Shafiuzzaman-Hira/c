...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch53Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch53Filler_PE_CN
	var_1_20 = var_1_21;


	// From: Req7Batch53Filler_PE_CN
	var_1_22 = var_1_12;


	// From: Req8Batch53Filler_PE_CN
	var_1_23 = var_1_21;


	// From: Req4Batch53Filler_PE_CN
	if (var_1_1) {
	...
	// From: CodeObject7
	if (var_1_27 <= (abs (var_1_38))) {
		var_1_42 = (abs (abs (var_1_43 + var_1_44)));
	}


	// From: CodeObject8
	if ((var_1_46 / var_1_32) >= var_1_29) {
		if (var_1_34) {
			var_1_45 = ((min (var_1_46 , var_1_43)) - var_1_44);
		}
	} else {
		if ((abs (var_1_37)) < (var_1_47 * var_1_28)) {
			var_1_45 = 4;
		}
	}
}
