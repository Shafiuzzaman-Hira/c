...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch0PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	// From: CodeObject1
	if ((32 / var_1_20) > -500) {
		var_1_19 = (abs (var_1_21));
	}


	// From: CodeObject2
	if ((~ var_1_20) >= var_1_23) {
		if ((min (var_1_23 , var_1_20)) >= -5) {
			var_1_22 = var_1_24;
		} else {
			var_1_22 = var_1_24;
		}
	...
	// From: CodeObject3
	if (var_1_21 <= (max (var_1_19 , var_1_26))) {
		var_1_25 = (var_1_27 + 1);
	}
