...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch75dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch75dependencies
	if (! (var_1_4 < 16.8f)) {
		var_1_15 = var_1_6;
	}


	// From: Req7Batch75dependencies
	var_1_25 = var_1_23;


	// From: Req2Batch75dependencies
	...
	// From: Req1Batch75dependencies
	if ((-1 <= var_1_25) || var_1_7) {
		var_1_1 = (var_1_4 + (var_1_5 + var_1_6));
	}


	// From: Req5Batch75dependencies
