...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch73stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch73stepLocals
	if (var_1_2 < (var_1_4 - var_1_3)) {
		var_1_9 = (var_1_10 - var_1_11);
	}


	// From: Req3Batch73stepLocals
	if ((max ((var_1_9 / 2) , (~ var_1_11))) <= var_1_10) {
		var_1_12 = var_1_8;
	}


	// From: Req4Batch73stepLocals
	unsigned long int stepLocal_0 = var_1_9;
	if ((var_1_14 >> var_1_10) < stepLocal_0) {
		var_1_13 = (min (var_1_14 , var_1_15));
	}


	// From: Req5Batch73stepLocals
	if (var_1_3 >= (var_1_17 * var_1_4)) {
		var_1_16 = var_1_18;
	}


	// From: Req6Batch73stepLocals
	if (var_1_7 && var_1_20) {
	...
	// From: Req7Batch73stepLocals
	var_1_22 = (abs (var_1_18));


	// From: Req8Batch73stepLocals
	if (var_1_2 > var_1_5) {
...
int property() {
	return (((((((((var_1_2 > ((var_1_3 - var_1_4) / (max (var_1_5 , var_1_6)))) ? (var_1_7 ? (var_1_1 == ((double) var_1_8)) : (var_1_1 == ((double) var_1_8))) : (var_1_1 == ((double) var_1_8))) && ((var_1_2 < (var_1_4 - var_1_3)) ? (var_1_9 == ((unsigned long int) (var_1_10 - var_1_11))) : 1)) && (((max ((var_1_9 / 2) , (~ var_1_11))) <= var_1_10) ? (var_1_12 == ((float) var_1_8)) : 1)) && (((var_1_14 >> var_1_10) < var_1_9) ? (var_1_13 == ((signed long int) (min (var_1_14 , var_1_15)))) : 1)) && ((var_1_3 >= (var_1_17 * var_1_4)) ? (var_1_16 == ((unsigned char) var_1_18)) : 1)) && ((var_1_7 && var_1_20) ? (var_1_19 == ((signed long int) ((1827081742 - var_1_16) - (var_1_21 - (var_1_18 + var_1_14))))) : ((2u >= (max (var_1_21 , var_1_9))) ? (var_1_19 == ((signed long int) var_1_15)) : (var_1_19 == ((signed long int) var_1_15))))) && (var_1_22 == ((unsigned char) (abs (var_1_18))))) && ((var_1_2 > var_1_5) ? (var_1_23 == ((signed char) (abs (min (var_1_24 , var_1_25))))) : (var_1_23 == ((signed char) var_1_24)))) && (var_1_26 == ((signed long int) var_1_25))
;
}
int main(void) {
	isInitial = 1;
