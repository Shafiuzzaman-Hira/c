...
void step(void) {
	...
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer))) {
		if (stepLocal_1 && (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
			if (last_1_signed_long_int_Array_0_0_ >= stepLocal_0) {
				...
				(*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) = (min (25 , last_1_unsigned_char_Array_0_0_));
			}
		}
	} else {
	...
	signed long int stepLocal_3 = min ((-4 >> (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer))) , (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)));
