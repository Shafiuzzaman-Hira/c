...
void step(void) {
	...
	signed long int stepLocal_1 = min ((*(var_1_12_Pointer)) , (*(var_1_12_Pointer)));
	unsigned long int stepLocal_0 = (*(var_1_3_Pointer));
	if (stepLocal_1 != (min ((*(var_1_4_Pointer)) , (*(var_1_3_Pointer))))) {
