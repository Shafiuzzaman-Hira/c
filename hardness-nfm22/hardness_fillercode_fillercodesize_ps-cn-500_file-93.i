...
void step(void) {
 ...
 if (var_1_89 || ((var_1_59 % 16) >= var_1_45)) {
  ...
  if (! var_1_35) {
   ...
   var_1_88 = ((((var_1_63) < 0 ) ? -(var_1_63) : (var_1_63)));
  }
 }
 if ((((((((var_1_28) > (var_1_31)) ? (var_1_28) : (var_1_31))) < 0 ) ? -((((var_1_28) > (var_1_31)) ? (var_1_28) : (var_1_31))) : ((((var_1_28) > (var_1_31)) ? (var_1_28) : (var_1_31))))) > ((((var_1_26) < (var_1_56)) ? (var_1_26) : (var_1_56)))) {
  var_1_92 = ((var_1_69 || var_1_36) || (var_1_89 && var_1_39));
 } else {
  if ((var_1_59 % var_1_75) < ((((var_1_52) > ((var_1_50 * var_1_93))) ? (var_1_52) : ((var_1_50 * var_1_93))))) {
   var_1_92 = (! (! (! var_1_39)));
  } else {
   var_1_92 = (var_1_39 && var_1_69);
  }
 }
 if (-25 > ((((var_1_73) < 0 ) ? -(var_1_73) : (var_1_73)))) {
  var_1_94 = (var_1_95 - (((((((var_1_63) < 0 ) ? -(var_1_63) : (var_1_63))) < 0 ) ? -((((var_1_63) < 0 ) ? -(var_1_63) : (var_1_63))) : ((((var_1_63) < 0 ) ? -(var_1_63) : (var_1_63))))));
 }
 if (var_1_27 > var_1_31) {
  if (var_1_59 <= ((((var_1_82) < 0 ) ? -(var_1_82) : (var_1_82)))) {
   if (var_1_50 >= (var_1_40 / var_1_75)) {
    var_1_96 = (var_1_95 - (16 + var_1_97));
   } else {
    var_1_96 = ((((((var_1_98 - 5)) > (((((var_1_91) > (var_1_90)) ? (var_1_91) : (var_1_90))))) ? ((var_1_98 - 5)) : (((((var_1_91) > (var_1_90)) ? (var_1_91) : (var_1_90)))))) + var_1_97);
   }
  }
 } else {
 ...
 if (var_1_60 < var_1_85) {
  if ((var_1_44 + var_1_67) == var_1_80) {
   var_1_99 = ((((var_1_87) < 0 ) ? -(var_1_87) : (var_1_87)));
  } else {
   var_1_99 = ((var_1_97 + var_1_100) - var_1_101);
  }
 }
 if (var_1_77 > (var_1_31 * var_1_30)) {
  var_1_102 = (((((((((var_1_67) < (var_1_103)) ? (var_1_67) : (var_1_103))) - ((((var_1_96) < 0 ) ? -(var_1_96) : (var_1_96))))) < ((var_1_104 - (var_1_81 - 5u)))) ? ((((((var_1_67) < (var_1_103)) ? (var_1_67) : (var_1_103))) - ((((var_1_96) < 0 ) ? -(var_1_96) : (var_1_96))))) : ((var_1_104 - (var_1_81 - 5u)))));
 } else {
  if (var_1_60 < var_1_42) {
   var_1_102 = var_1_94;
  } else {
   var_1_102 = ((((10u) < (var_1_100)) ? (10u) : (var_1_100)));
  }
 }
 if (var_1_57 > var_1_27) {
  var_1_105 = (((((var_1_62) > (var_1_97)) ? (var_1_62) : (var_1_97))) - var_1_40);
 }
 if ((- ((((var_1_53) < 0 ) ? -(var_1_53) : (var_1_53)))) > 255.75f) {
  if (var_1_38) {
   if (var_1_69) {
    var_1_106 = ((((((((var_1_77) < 0 ) ? -(var_1_77) : (var_1_77)))) < (((((var_1_76 + var_1_54) < 0 ) ? -(var_1_76 + var_1_54) : (var_1_76 + var_1_54))))) ? (((((var_1_77) < 0 ) ? -(var_1_77) : (var_1_77)))) : (((((var_1_76 + var_1_54) < 0 ) ? -(var_1_76 + var_1_54) : (var_1_76 + var_1_54))))));
   }
  }
 } else {
  var_1_106 = ((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31)));
 }
 if ((((((var_1_91) < (var_1_40)) ? (var_1_91) : (var_1_40))) - 100) > var_1_62) {
  var_1_107 = (var_1_108 - ((((var_1_55) < 0 ) ? -(var_1_55) : (var_1_55))));
 }
 if (var_1_37) {
  var_1_109 = ((((var_1_67) > (var_1_45)) ? (var_1_67) : (var_1_45)));
 } else {
  var_1_109 = ((((var_1_88) < 0 ) ? -(var_1_88) : (var_1_88)));
 }
 if (var_1_32 < var_1_72) {
  if (var_1_67 >= 5u) {
   var_1_110 = ((((var_1_85) < 0 ) ? -(var_1_85) : (var_1_85)));
  }
 } else {
  var_1_110 = (var_1_88 - ((((var_1_100 + var_1_41) < 0 ) ? -(var_1_100 + var_1_41) : (var_1_100 + var_1_41))));
 }
 if (var_1_38) {
  var_1_111 = ((((((((var_1_108) > (((((var_1_112) > (8.6)) ? (var_1_112) : (8.6))))) ? (var_1_108) : (((((var_1_112) > (8.6)) ? (var_1_112) : (8.6))))))) > (var_1_54)) ? (((((var_1_108) > (((((var_1_112) > (8.6)) ? (var_1_112) : (8.6))))) ? (var_1_108) : (((((var_1_112) > (8.6)) ? (var_1_112) : (8.6))))))) : (var_1_54)));
 } else {
  if ((var_1_96 + ((((var_1_49) < (var_1_113)) ? (var_1_49) : (var_1_113)))) >= var_1_105) {
   if (var_1_107 <= (((((var_1_54) < 0 ) ? -(var_1_54) : (var_1_54))) / ((((var_1_78) < (var_1_51)) ? (var_1_78) : (var_1_51))))) {
    var_1_111 = ((var_1_77 + ((((var_1_76) < 0 ) ? -(var_1_76) : (var_1_76)))) + (var_1_79 - var_1_114));
   }
  } else {
   var_1_111 = ((((var_1_31) < (var_1_29)) ? (var_1_31) : (var_1_29)));
  }
 }
 if (var_1_46 <= var_1_85) {
  if (((((var_1_108) < 0 ) ? -(var_1_108) : (var_1_108))) <= var_1_57) {
 ...
 if ((0 & var_1_87) != var_1_105) {
  var_1_117 = (((((((var_1_100) < 0 ) ? -(var_1_100) : (var_1_100))) < 0 ) ? -((((var_1_100) < 0 ) ? -(var_1_100) : (var_1_100))) : ((((var_1_100) < 0 ) ? -(var_1_100) : (var_1_100)))));
 } else {
  var_1_117 = (((((var_1_100 - var_1_97) < 0 ) ? -(var_1_100 - var_1_97) : (var_1_100 - var_1_97))) + var_1_87);
 }
 if (var_1_83 < var_1_86) {
  if (! var_1_116) {
   var_1_118 = (25 + ((((((((var_1_83) > (var_1_96)) ? (var_1_83) : (var_1_96)))) < (-64)) ? (((((var_1_83) > (var_1_96)) ? (var_1_83) : (var_1_96)))) : (-64))));
  } else {
   if (var_1_69) {
    var_1_118 = ((((var_1_59) < 0 ) ? -(var_1_59) : (var_1_59)));
   }
  }
 } else {
  var_1_118 = (((((var_1_47) < 0 ) ? -(var_1_47) : (var_1_47))) - ((((var_1_48) < 0 ) ? -(var_1_48) : (var_1_48))));
 }
 if (-32 >= var_1_50) {
  if (var_1_120 > var_1_103) {
   var_1_119 = var_1_76;
  } else {
   var_1_119 = ((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30)));
  }
 }
 if (var_1_92) {
  var_1_121 = ((((-1) > (var_1_58)) ? (-1) : (var_1_58)));
 }
 if (var_1_39) {
  if ((- var_1_63) >= 64) {
   if (var_1_33) {
    var_1_122 = (var_1_41 + ((((var_1_45) > (var_1_117)) ? (var_1_45) : (var_1_117))));
   } else {
    if (var_1_68 || var_1_36) {
     var_1_122 = (((((var_1_91) < 0 ) ? -(var_1_91) : (var_1_91))) + (((((var_1_98 - var_1_97)) < (var_1_85)) ? ((var_1_98 - var_1_97)) : (var_1_85))));
    } else {
     var_1_122 = ((((var_1_63 - var_1_97) < 0 ) ? -(var_1_63 - var_1_97) : (var_1_63 - var_1_97)));
    }
   }
  }
 }
 var_1_123 = (((((((((((var_1_63) > (var_1_91)) ? (var_1_63) : (var_1_91))) < 0 ) ? -((((var_1_63) > (var_1_91)) ? (var_1_63) : (var_1_91))) : ((((var_1_63) > (var_1_91)) ? (var_1_63) : (var_1_91)))))) > (var_1_101)) ? ((((((((var_1_63) > (var_1_91)) ? (var_1_63) : (var_1_91))) < 0 ) ? -((((var_1_63) > (var_1_91)) ? (var_1_63) : (var_1_91))) : ((((var_1_63) > (var_1_91)) ? (var_1_63) : (var_1_91)))))) : (var_1_101)));
 if (var_1_32 < var_1_106) {
  var_1_124 = (var_1_114 + (var_1_79 - var_1_125));
 } else {
  if (var_1_41 < var_1_118) {
   var_1_124 = ((((((((((((var_1_114) < 0 ) ? -(var_1_114) : (var_1_114)))) > (var_1_30)) ? (((((var_1_114) < 0 ) ? -(var_1_114) : (var_1_114)))) : (var_1_30)))) > (var_1_31)) ? (((((((((var_1_114) < 0 ) ? -(var_1_114) : (var_1_114)))) > (var_1_30)) ? (((((var_1_114) < 0 ) ? -(var_1_114) : (var_1_114)))) : (var_1_30)))) : (var_1_31)));
  }
 }
 var_1_126 = var_1_88;
 var_1_127 = var_1_128;
 ...
 if (((16 ^ var_1_62) / 200) > var_1_120) {
  var_1_147 = (((((((var_1_98) < 0 ) ? -(var_1_98) : (var_1_98))) < 0 ) ? -((((var_1_98) < 0 ) ? -(var_1_98) : (var_1_98))) : ((((var_1_98) < 0 ) ? -(var_1_98) : (var_1_98)))));
 } else {
