...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch7Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_11 >> var_1_27) > ((var_1_5 ^ var_1_5) + ((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))))) {
  var_1_25 = ((((((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)))) > (0)) ? (((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)))) : (0)));
 } else {
  if (((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18))) >= (var_1_4 - var_1_21)) {
   var_1_25 = var_1_27;
  }
 }
 if (var_1_4 > var_1_2) {
 ...
 if (var_1_5 >= ((((var_1_10 | var_1_27) < 0 ) ? -(var_1_10 | var_1_27) : (var_1_10 | var_1_27)))) {
  var_1_34 = (((((((((var_1_5) < 0 ) ? -(var_1_5) : (var_1_5)))) > (var_1_5)) ? (((((var_1_5) < 0 ) ? -(var_1_5) : (var_1_5)))) : (var_1_5))) - ((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6))));
 } else {
  if (var_1_5 >= var_1_27) {
   if (var_1_4 > var_1_4) {
    var_1_34 = ((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6)));
   }
  }
 }
 var_1_38 = var_1_37;
 if (var_1_27 == (var_1_6 ^ var_1_16)) {
  var_1_39 = (((((var_1_21) < (((((var_1_21) < (var_1_22)) ? (var_1_21) : (var_1_22))))) ? (var_1_21) : (((((var_1_21) < (var_1_22)) ? (var_1_21) : (var_1_22)))))) - (var_1_43 - var_1_44));
 } else {
  var_1_39 = (((((((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22)))) < (var_1_43)) ? (((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22)))) : (var_1_43))) - 255.4f);
 }
 var_1_45 = var_1_27;
 var_1_46 = var_1_27;
}
