...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch41stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch41stepLocals
	unsigned char stepLocal_1 = var_1_12 < var_1_8;
	...
	// From: Req5Batch41stepLocals
	if (var_1_3) {
		var_1_15 = var_1_16;
	}


	// From: Req6Batch41stepLocals
	unsigned char stepLocal_2 = var_1_9 < var_1_15;
	...
	// From: Req7Batch41stepLocals
	signed long int stepLocal_3 = -10;
	if (((var_1_17 / var_1_18) * var_1_19) < stepLocal_3) {
	...
	// From: Req8Batch41stepLocals
	var_1_22 = 1;


	// From: Req9Batch41stepLocals
	var_1_23 = var_1_15;
}
