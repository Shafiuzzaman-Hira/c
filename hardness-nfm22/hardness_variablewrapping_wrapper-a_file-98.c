...
void step(void) {
	// From: Req1Batch98Wrapper_A
	double_Array_0[1][1][1] = (double_Array_0[0][1][1] - double_Array_0[1][0][1]);


	// From: Req4Batch98Wrapper_A
	if ((min (-128 , last_1_unsigned_long_int_Array_0_4_)) < unsigned_long_int_Array_0[1]) {
	...
	// From: Req2Batch98Wrapper_A
	unsigned long int stepLocal_0 = (unsigned_long_int_Array_0[4] >> signed_short_int_Array_0[0]) / signed_long_int_Array_0[0];
	if (8 < stepLocal_0) {
		double_Array_0[0][0][1] = (((double_Array_0[1][0][0] + double_Array_0[0][0][0]) + (min (double_Array_0[0][1][0] , 1.9))) + (99.125 + double_Array_0[1][1][0]));
	}


	// From: Req3Batch98Wrapper_A
	if (double_Array_0[0][1][1] < double_Array_0[1][0][0]) {
		if (((- unsigned_long_int_Array_0[4]) <= signed_short_int_Array_0[0]) || (double_Array_0[0][0][1] < double_Array_0[0][1][0])) {
			unsigned_long_int_Array_0[0] = (min (signed_short_int_Array_0[0] , unsigned_long_int_Array_0[1]));
		} else {
...
int property() {
	return (((double_Array_0[1][1][1] == ((double) (double_Array_0[0][1][1] - double_Array_0[1][0][1]))) && ((8 < ((unsigned_long_int_Array_0[4] >> signed_short_int_Array_0[0]) / signed_long_int_Array_0[0])) ? (double_Array_0[0][0][1] == ((double) (((double_Array_0[1][0][0] + double_Array_0[0][0][0]) + (min (double_Array_0[0][1][0] , 1.9))) + (99.125 + double_Array_0[1][1][0])))) : 1)) && ((double_Array_0[0][1][1] < double_Array_0[1][0][0]) ? ((((- unsigned_long_int_Array_0[4]) <= signed_short_int_Array_0[0]) || (double_Array_0[0][0][1] < double_Array_0[0][1][0])) ? (unsigned_long_int_Array_0[0] == ((unsigned long int) (min (signed_short_int_Array_0[0] , unsigned_long_int_Array_0[1])))) : (unsigned_long_int_Array_0[0] == ((unsigned long int) (unsigned_long_int_Array_0[3] - signed_short_int_Array_0[0])))) : 1)) && (((min (-128 , last_1_unsigned_long_int_Array_0_4_)) < unsigned_long_int_Array_0[1]) ? ((last_1_unsigned_long_int_Array_0_4_ > signed_long_int_Array_0[0]) ? (unsigned_long_int_Array_0[4] == ((unsigned long int) (signed_short_int_Array_0[0] + unsigned_long_int_Array_0[2]))) : (unsigned_long_int_Array_0[4] == ((unsigned long int) unsigned_long_int_Array_0[3]))) : (unsigned_long_int_Array_0[4] == ((unsigned long int) unsigned_long_int_Array_0[2])))
;
}
int main(void) {
	isInitial = 1;
