...
void step(void) {
	// From: Req2Batch40Amount10
	var_1_7 = var_1_8;


	// From: Req3Batch40Amount10
	var_1_9 = (min ((var_1_10 + var_1_11) , var_1_12));


	// From: Req4Batch40Amount10
	var_1_13 = var_1_14;


	// From: Req1Batch40Amount10
...
int property() {
	return ((((((var_1_2 / var_1_3) > var_1_4) && var_1_7) ? (var_1_1 == ((unsigned short int) var_1_9)) : 1) && (var_1_7 == ((unsigned char) var_1_8))) && (var_1_9 == ((unsigned char) (min ((var_1_10 + var_1_11) , var_1_12))))) && (var_1_13 == ((signed char) var_1_14))
;
}
int main(void) {
	isInitial = 1;
