...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch12Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch12Amount25
	if (var_1_13) {
		var_1_6 = (max (((min (var_1_7 , var_1_8)) - var_1_9) , var_1_10));
	}


	// From: Req3Batch12Amount25
	var_1_11 = ((min (2.5f , (max (31.75f , var_1_12)))) + 0.125f);
}
...
int property() {
	return ((((! (-50 < var_1_2)) ? ((var_1_2 != var_1_3) ? ((var_1_3 <= var_1_2) ? (var_1_1 == ((unsigned char) (last_1_var_1_13 && var_1_5))) : 1) : (var_1_1 == ((unsigned char) var_1_5))) : 1) && (var_1_13 ? (var_1_6 == ((float) (max (((min (var_1_7 , var_1_8)) - var_1_9) , var_1_10)))) : 1)) && (var_1_11 == ((float) ((min (2.5f , (max (31.75f , var_1_12)))) + 0.125f)))) && ((var_1_2 > (var_1_3 / var_1_14)) ? (var_1_1 ? (var_1_13 == ((unsigned char) (! var_1_15))) : (var_1_13 == ((unsigned char) 0))) : (var_1_13 == ((unsigned char) var_1_5)))
;
}
int main(void) {
	isInitial = 1;
