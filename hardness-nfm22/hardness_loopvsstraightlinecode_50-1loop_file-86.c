...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch8650_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch8650_1loop
	if (var_1_19) {
		var_1_6 = (last_1_var_1_6 || var_1_9);
	}


	// From: Req4Batch8650_1loop
	...
	// From: Req7Batch8650_1loop
	var_1_22 = var_1_15;


	// From: Req5Batch8650_1loop
