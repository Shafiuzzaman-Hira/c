...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch62no_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch62no_floats
	var_1_10 = var_1_7;


	// From: Req1Batch62no_floats
	var_1_1 = (16 - 2);


	// From: Req2Batch62no_floats
	if (var_1_3) {
		var_1_2 = (abs (-4));
	} else {
		var_1_2 = (abs (var_1_4));
	...
	// From: Req5Batch62no_floats
	var_1_9 = var_1_8;


	// From: Req3Batch62no_floats
	if (var_1_4 < var_1_9) {
		if (var_1_3) {
			if (var_1_1 != var_1_4) {
				var_1_5 = var_1_6;
