...
void step(void) {
	...
	signed long int stepLocal_0 = max ((*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) , last_1_unsigned_short_int_Array_0_0_);
