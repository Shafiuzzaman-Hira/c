...
void step(void) {
	...
	if (var_1_26 < var_1_31) {
		var_1_30 = (min (var_1_32 , var_1_33));
	}
	...
	// From: Req1Batch23PS_CN_10
	if (var_1_2) {
		var_1_1 = var_1_3;
	}


	// From: Req6Batch23PS_CN_10
	...
	// From: Req7Batch23PS_CN_10
	var_1_23 = var_1_10;


	// From: Req8Batch23PS_CN_10
	var_1_24 = 31.75f;


	// From: Req9Batch23PS_CN_10
	var_1_25 = -5;


	// From: Req2Batch23PS_CN_10
	...
	// From: Req4Batch23PS_CN_10
	if ((- (var_1_13 / var_1_17)) > var_1_25) {
		var_1_18 = var_1_13;
	}


	// From: Req5Batch23PS_CN_10
