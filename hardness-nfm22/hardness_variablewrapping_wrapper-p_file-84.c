...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch84Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch84Wrapper_P
	signed long int stepLocal_0 = last_1_var_1_11;
	if (stepLocal_0 != last_1_var_1_8) {
		(*(var_1_1_Pointer)) = ((*(var_1_4_Pointer)) + (max ((min ((*(var_1_5_Pointer)) , (*(var_1_6_Pointer)))) , (*(var_1_7_Pointer)))));
	} else {
		(*(var_1_1_Pointer)) = (*(var_1_4_Pointer));
	}


	// From: Req2Batch84Wrapper_P
	if ((*(var_1_9_Pointer))) {
		(*(var_1_8_Pointer)) = (((*(var_1_10_Pointer)) + 23103) - (32 + (*(var_1_6_Pointer))));
	}


	// From: Req4Batch84Wrapper_P
	...
	// From: Req5Batch84Wrapper_P
	(*(var_1_17_Pointer)) = (*(var_1_18_Pointer));


	// From: Req3Batch84Wrapper_P
	if ((*(var_1_1_Pointer)) < (*(var_1_16_Pointer))) {
		if (((- 8) / ((*(var_1_13_Pointer)) - (*(var_1_14_Pointer)))) >= (*(var_1_6_Pointer))) {
			(*(var_1_11_Pointer)) = ((*(var_1_16_Pointer)) - ((*(var_1_15_Pointer)) - (*(var_1_14_Pointer))));
		}
	}
}
