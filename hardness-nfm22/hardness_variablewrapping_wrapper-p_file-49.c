...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch49Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((50 >> (*(var_1_4_Pointer))) <= (*(var_1_8_Pointer))) {
	...
	if (! (*(var_1_12_Pointer))) {
		if ((*(var_1_4_Pointer)) >= (min ((*(var_1_6_Pointer)) , (*(var_1_8_Pointer))))) {
			(*(var_1_13_Pointer)) = ((*(var_1_10_Pointer)) && (*(var_1_11_Pointer)));
		} else {
...
int property() {
	return (((((*(var_1_2_Pointer)) >= 64.5f) ? (((*(var_1_2_Pointer)) >= (*(var_1_3_Pointer))) ? ((*(var_1_1_Pointer)) == ((unsigned short int) (abs (max ((*(var_1_4_Pointer)) , (max ((*(var_1_5_Pointer)) , (*(var_1_6_Pointer))))))))) : ((*(var_1_13_Pointer)) ? ((*(var_1_1_Pointer)) == ((unsigned short int) (*(var_1_5_Pointer)))) : ((*(var_1_1_Pointer)) == ((unsigned short int) (*(var_1_6_Pointer)))))) : ((*(var_1_1_Pointer)) == ((unsigned short int) 50))) && ((*(var_1_8_Pointer)) == ((signed short int) (abs ((*(var_1_9_Pointer))))))) && (((50 >> (*(var_1_4_Pointer))) <= (*(var_1_8_Pointer))) ? ((*(var_1_10_Pointer)) == ((unsigned char) ((! (! (*(var_1_11_Pointer)))) || (*(var_1_12_Pointer))))) : ((*(var_1_10_Pointer)) == ((unsigned char) (! (*(var_1_11_Pointer))))))) && ((! (*(var_1_12_Pointer))) ? (((*(var_1_4_Pointer)) >= (min ((*(var_1_6_Pointer)) , (*(var_1_8_Pointer))))) ? ((*(var_1_13_Pointer)) == ((unsigned char) ((*(var_1_10_Pointer)) && (*(var_1_11_Pointer))))) : ((*(var_1_13_Pointer)) == ((unsigned char) (*(var_1_11_Pointer))))) : 1)
;
}
int main(void) {
	isInitial = 1;
