...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch59Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
	// From: CodeObject1
	if (var_1_8 == var_1_8) {
		var_1_20 = (abs (var_1_13));
	}


	// From: CodeObject2
	if ((abs (var_1_8)) > (min (128.5f , (abs (var_1_8))))) {
		var_1_24 = (max (var_1_13 , var_1_13));
	}


	// From: CodeObject3
	if ((var_1_1 / var_1_26) < (var_1_13 | var_1_1)) {
		if ((- var_1_8) >= 256.75f) {
			var_1_25 = var_1_13;
		}
	} else {
		var_1_25 = (min (var_1_13 , 0));
	}


	// From: CodeObject4
	if ((var_1_19 ^ (~ var_1_1)) >= var_1_17) {
		var_1_28 = ((var_1_8 <= var_1_8) || var_1_29);
	}
	...
	// From: CodeObject6
	if (var_1_26 < (abs (var_1_13))) {
		if ((max (var_1_8 , var_1_8)) == (abs (var_1_8))) {
			if (-50 <= var_1_13) {
	...
	// From: Req6Batch59Filler_PS_CO
	var_1_17 = var_1_4;


	// From: Req7Batch59Filler_PS_CO
	var_1_18 = var_1_16;


	// From: Req8Batch59Filler_PS_CO
	var_1_19 = var_1_4;


	// From: Req1Batch59Filler_PS_CO
