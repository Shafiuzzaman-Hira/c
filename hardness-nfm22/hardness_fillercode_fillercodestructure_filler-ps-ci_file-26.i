...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch26Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
 if (var_1_25 < (var_1_18 - ((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22))))) {
  if (var_1_10) {
   var_1_27 = var_1_22;
  }
 }
 ...
 if (var_1_10) {
  var_1_35 = ((((var_1_22) > (var_1_25)) ? (var_1_22) : (var_1_25)));
 } else {
  if (var_1_10) {
   if (-8 < var_1_22) {
    var_1_35 = ((((var_1_37 - var_1_25) < 0 ) ? -(var_1_37 - var_1_25) : (var_1_37 - var_1_25)));
   }
  }
 }
 if (var_1_13 >= (- 255.45f)) {
 ...
 if (((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24))) < (var_1_12 % var_1_4)) {
  var_1_41 = ((! (var_1_40 && var_1_44)) || (var_1_39 && var_1_45));
 } else {
  var_1_41 = var_1_44;
 }
 if (var_1_10) {
  var_1_46 = (var_1_23 + ((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22))));
 } else {
  var_1_46 = (((((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22))) < 0 ) ? -((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22))) : ((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22)))));
 }
 if (var_1_44) {
  if (var_1_45) {
   if (var_1_10) {
    var_1_47 = (((((((var_1_23) < 0 ) ? -(var_1_23) : (var_1_23))) < 0 ) ? -((((var_1_23) < 0 ) ? -(var_1_23) : (var_1_23))) : ((((var_1_23) < 0 ) ? -(var_1_23) : (var_1_23)))));
   }
  } else {
   var_1_47 = var_1_24;
  }
