...
void step(void) {
	...
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
		if (stepLocal_2 > (*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer))) {
			(*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)) = (max ((max ((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) , 16.5)) , (*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer))));
		} else {
	...
	// From: Req2Batch54Wrapper_AP
	signed long int stepLocal_1 = max (10 , (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)));
	if ((8 * (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer))) == stepLocal_1) {
		if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var2_Pointer))) {
			...
			if ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) >= (abs ((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer))))) {
