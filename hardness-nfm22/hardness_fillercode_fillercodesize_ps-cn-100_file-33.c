...
void step(void) {
	...
	if (var_1_24 > var_1_25) {
		var_1_29 = (max (-2 , var_1_30));
	}


	// From: CodeObject4
	if (0 <= (var_1_23 - (min (var_1_24 , var_1_26)))) {
		var_1_31 = (abs (var_1_26));
	}


	// From: CodeObject5
	if (var_1_23 <= (var_1_24 / (var_1_33 - var_1_34))) {
		if (-64 >= (abs (abs (var_1_22)))) {
			if (-8 > var_1_25) {
				if (var_1_27 >= var_1_28) {
					var_1_32 = (min ((var_1_35 + var_1_36) , 1));
				}
			} else {
				var_1_32 = (abs (abs (var_1_35)));
			}
		} else {
	...
	if (var_1_33 < var_1_32) {
		var_1_38 = (abs (var_1_29));
	} else {
		if (var_1_34 <= var_1_22) {
			var_1_38 = (min (var_1_37 , (max (var_1_39 , var_1_32))));
		}
	}


	// From: CodeObject7
	if ((var_1_38 >> var_1_36) < (var_1_30 + (abs (var_1_31)))) {
		if (var_1_26 >= var_1_23) {
			var_1_40 = (var_1_24 - var_1_31);
		}
	} else {
		if ((abs (var_1_26)) > var_1_36) {
			var_1_40 = (max ((var_1_32 - 1) , 0));
		}
	}
	...
	if ((var_1_24 / var_1_33) >= (var_1_40 % var_1_37)) {
		if (var_1_42) {
			var_1_41 = (min ((abs (var_1_43)) , (abs (var_1_44))));
		}
	} else {
		if (-64 <= (var_1_33 & (abs (var_1_36)))) {
			if (var_1_30 > var_1_34) {
				var_1_41 = (var_1_45 + (max (2 , (max (var_1_46 , var_1_47)))));
			} else {
	...
	// From: CodeObject9
	if ((abs (var_1_36)) > var_1_22) {
		if ((abs (var_1_22)) > var_1_44) {
			if ((abs (var_1_37)) != var_1_32) {
				var_1_50 = -50;
			}
		}
	} else {
	...
	// From: Req2Batch33PS_CN_100
	var_1_5 = (max (var_1_1 , var_1_14));


	// From: Req7Batch33PS_CN_100
