...
void step(void) {
	...
	if (stepLocal_16 >= (min (var_1_23 , var_1_1))) {
		if (15.375f > var_1_30) {
			var_1_66 = var_1_26;
		}
	}
	...
	if (var_1_39 >= var_1_52) {
		var_1_56 = (var_1_36 - (max ((min (var_1_37 , var_1_35)) , var_1_34)));
	} else {
		var_1_56 = (abs (var_1_36));
	}


	// From: Req24Batch43Amount250
	if ((- (var_1_37 / var_1_39)) < (var_1_34 % (min (var_1_64 , var_1_32)))) {
		var_1_63 = (var_1_34 - (var_1_37 + (var_1_24 + var_1_32)));
	}


	// From: Req25Batch43Amount250
	if (var_1_43 <= (max (var_1_36 , var_1_20))) {
		var_1_65 = ((var_1_21 + -4) + (max (var_1_35 , var_1_36)));
	}
	...
	// From: Req30Batch43Amount250
	var_1_70 = var_1_40;


	// From: Req31Batch43Amount250
	var_1_71 = var_1_50;
	...
	if (var_1_35 > var_1_24) {
		...
		var_1_42 = (((var_1_43 - var_1_35) - (min (var_1_63 , var_1_4))) - var_1_32);
	}
	...
	if (stepLocal_15 >= (min (var_1_47 , var_1_4))) {
		var_1_61 = (var_1_18 + (min ((var_1_35 - var_1_33) , var_1_36)));
	} else {
		if (stepLocal_14 > var_1_43) {
			var_1_61 = (min (var_1_20 , var_1_34));
		} else {
			var_1_61 = (min (16 , var_1_62));
		}
	}
	...
	if (var_1_49 < 16.25f) {
		...
		if ((var_1_36 << var_1_20) < stepLocal_10) {
			if (var_1_67 <= (- (var_1_49 / var_1_29))) {
				var_1_53 = (min (var_1_1 , var_1_54));
			} else {
				if (((var_1_35 - var_1_65) << var_1_17) < stepLocal_11) {
					var_1_53 = (var_1_33 + var_1_39);
				} else {
					var_1_53 = (min ((min (var_1_54 , (abs (var_1_40)))) , 200));
				}
			}
		} else {
	...
	if ((50 | last_1_var_1_59) >= stepLocal_13) {
		...
		if ((- var_1_36) > stepLocal_12) {
			var_1_59 = (min (var_1_52 , var_1_1));
		} else {
			var_1_59 = (min (var_1_38 , var_1_15));
		}
	}
	...
	if (var_1_8 >= (max (var_1_44 , var_1_7))) {
		var_1_27 = (var_1_24 + 32u);
	}


	// From: Req21Batch43Amount250
	var_1_58 = (((min (var_1_47 , var_1_35)) + (var_1_24 + var_1_33)) - (var_1_36 + var_1_27));


	// From: Req29Batch43Amount250
	if ((var_1_29 + (var_1_7 - var_1_30)) == (max (5.62f , (var_1_44 + var_1_71)))) {
		var_1_69 = var_1_56;
	} else {
		var_1_69 = var_1_37;
	}
	...
	signed long int stepLocal_9 = var_1_58 - (max (var_1_34 , var_1_33));
	...
	if (var_1_17 < (var_1_32 * (~ var_1_69))) {
		if (var_1_13 || ((var_1_31 / 2u) == var_1_58)) {
			if (var_1_7 >= (var_1_30 - (min (var_1_29 , var_1_8)))) {
				var_1_57 = (max ((var_1_50 + var_1_30) , var_1_49));
			}
		} else {
...
int property() {
	return (((((((((((((((((((((((((((((((last_1_var_1_66 && last_1_var_1_6) ? (var_1_1 == ((unsigned char) (var_1_4 + 5))) : (var_1_1 == ((unsigned char) (abs (var_1_5))))) && ((((var_1_7 + 100000.5f) - var_1_8) > (var_1_45 + var_1_57)) ? ((var_1_8 > var_1_45) ? (var_1_6 == ((unsigned char) (var_1_11 || (var_1_66 && var_1_12)))) : ((var_1_8 != var_1_57) ? (var_1_6 == ((unsigned char) 1)) : (var_1_6 == ((unsigned char) var_1_11)))) : (var_1_6 == ((unsigned char) var_1_13)))) && ((var_1_68 < var_1_8) ? (var_1_14 == ((signed short int) (var_1_4 - var_1_70))) : 1)) && (((- var_1_31) > (var_1_4 + var_1_63)) ? (var_1_15 == ((signed char) (abs (var_1_16)))) : (var_1_15 == ((signed char) (var_1_17 + (max ((min (var_1_18 , var_1_19)) , (var_1_20 + var_1_21)))))))) && ((var_1_21 <= ((last_1_var_1_38 * var_1_19) + (last_1_var_1_65 / var_1_23))) ? (var_1_22 == ((unsigned char) (var_1_24 - var_1_4))) : 1)) && (((var_1_16 >= var_1_14) || var_1_13) ? (var_1_25 == ((unsigned char) (var_1_13 && (! var_1_12)))) : (var_1_12 ? (var_1_25 == ((unsigned char) (var_1_13 && var_1_26))) : 1))) && ((var_1_8 >= (max (var_1_44 , var_1_7))) ? (var_1_27 == ((unsigned long int) (var_1_24 + 32u))) : 1)) && ((var_1_66 && ((var_1_22 ^ var_1_59) <= var_1_5)) ? ((256 >= var_1_22) ? (var_1_28 == ((float) ((var_1_29 - var_1_30) - var_1_7))) : ((var_1_24 < var_1_22) ? (var_1_28 == ((float) var_1_7)) : 1)) : (var_1_28 == ((float) var_1_7)))) && ((var_1_68 <= var_1_30) ? (var_1_31 == ((unsigned char) ((var_1_32 - var_1_33) - (var_1_34 + var_1_35)))) : (var_1_31 == ((unsigned char) ((var_1_34 + var_1_33) + (var_1_35 + (max (var_1_36 , var_1_37)))))))) && ((var_1_35 < (abs (var_1_22))) ? (var_1_38 == ((unsigned short int) ((var_1_39 + (var_1_40 + var_1_41)) - var_1_33))) : 1)) && ((var_1_35 > var_1_24) ? (var_1_42 == ((signed short int) (var_1_40 - var_1_5))) : (var_1_42 == ((signed short int) (((var_1_43 - var_1_35) - (min (var_1_63 , var_1_4))) - var_1_32))))) && ((var_1_53 >= ((var_1_35 * var_1_22) % var_1_32)) ? ((var_1_71 >= var_1_8) ? (var_1_44 == ((double) (max (var_1_29 , var_1_30)))) : 1) : 1)) && (((var_1_24 + var_1_1) != (var_1_4 - var_1_37)) ? (var_1_45 == ((double) (max (var_1_30 , var_1_7)))) : 1)) && (var_1_46 == ((signed short int) (max (-10000 , -32))))) && ((var_1_43 != (var_1_63 + (var_1_65 ^ var_1_5))) ? (var_1_47 == ((unsigned short int) (var_1_32 + var_1_36))) : 1)) && (((var_1_58 - (max (var_1_34 , var_1_33))) <= (var_1_18 + var_1_1)) ? (var_1_48 == ((float) (min (var_1_30 , ((max (var_1_49 , var_1_50)) + var_1_51))))) : 1)) && (var_1_26 ? (var_1_52 == ((signed short int) (var_1_40 - var_1_32))) : 1)) && ((var_1_49 < 16.25f) ? (var_1_53 == ((unsigned short int) (var_1_54 - 4))) : (((var_1_36 << var_1_20) < var_1_15) ? ((var_1_67 <= (- (var_1_49 / var_1_29))) ? (var_1_53 == ((unsigned short int) (min (var_1_1 , var_1_54)))) : ((((var_1_35 - var_1_65) << var_1_17) < var_1_31) ? (var_1_53 == ((unsigned short int) (var_1_33 + var_1_39))) : (var_1_53 == ((unsigned short int) (min ((min (var_1_54 , (abs (var_1_40)))) , 200)))))) : (var_1_53 == ((unsigned short int) ((var_1_43 - var_1_35) + var_1_36)))))) && ((var_1_39 >= var_1_52) ? (var_1_56 == ((signed char) (var_1_36 - (max ((min (var_1_37 , var_1_35)) , var_1_34))))) : (var_1_56 == ((signed char) (abs (var_1_36)))))) && ((var_1_17 < (var_1_32 * (~ var_1_69))) ? ((var_1_13 || ((var_1_31 / 2u) == var_1_58)) ? ((var_1_7 >= (var_1_30 - (min (var_1_29 , var_1_8)))) ? (var_1_57 == ((float) (max ((var_1_50 + var_1_30) , var_1_49)))) : 1) : (var_1_57 == ((float) (abs (var_1_29))))) : 1)) && (var_1_58 == ((signed short int) (((min (var_1_47 , var_1_35)) + (var_1_24 + var_1_33)) - (var_1_36 + var_1_27))))) && (((50 | last_1_var_1_59) >= var_1_31) ? (var_1_59 == ((signed long int) var_1_53)) : (((- var_1_36) > var_1_32) ? (var_1_59 == ((signed long int) (min (var_1_52 , var_1_1)))) : (var_1_59 == ((signed long int) (min (var_1_38 , var_1_15))))))) && (((var_1_35 * var_1_63) >= (min (var_1_47 , var_1_4))) ? (var_1_61 == ((signed char) (var_1_18 + (min ((var_1_35 - var_1_33) , var_1_36))))) : ((var_1_39 > var_1_43) ? (var_1_61 == ((signed char) (min (var_1_20 , var_1_34)))) : (var_1_61 == ((signed char) (min (16 , var_1_62))))))) && (((- (var_1_37 / var_1_39)) < (var_1_34 % (min (var_1_64 , var_1_32)))) ? (var_1_63 == ((signed short int) (var_1_34 - (var_1_37 + (var_1_24 + var_1_32))))) : 1)) && ((var_1_43 <= (max (var_1_36 , var_1_20))) ? (var_1_65 == ((signed char) ((var_1_21 + -4) + (max (var_1_35 , var_1_36))))) : 1)) && ((-16 >= (min (var_1_23 , var_1_1))) ? ((15.375f > var_1_30) ? (var_1_66 == ((unsigned char) var_1_26)) : 1) : 1)) && (var_1_12 ? (var_1_67 == ((float) var_1_51)) : 1)) && (var_1_26 ? (var_1_68 == ((float) var_1_51)) : 1)) && (((var_1_29 + (var_1_7 - var_1_30)) == (max (5.62f , (var_1_44 + var_1_71)))) ? (var_1_69 == ((unsigned long int) var_1_56)) : (var_1_69 == ((unsigned long int) var_1_37)))) && (var_1_70 == ((signed long int) var_1_40))) && (var_1_71 == ((float) var_1_50))
;
}
int main(void) {
	isInitial = 1;
