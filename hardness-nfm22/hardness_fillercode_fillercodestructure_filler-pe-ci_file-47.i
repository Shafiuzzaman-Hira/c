...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch47Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_32 = var_1_11;
 if (var_1_15 > 32.8) {
  var_1_34 = (((((var_1_35 - var_1_8)) > (var_1_21)) ? ((var_1_35 - var_1_8)) : (var_1_21)));
 }
 if ((var_1_8 & var_1_11) <= var_1_8) {
  var_1_36 = 10;
 } else {
  if (var_1_13 > var_1_14) {
   if ((~ var_1_8) > (var_1_8 & var_1_11)) {
    var_1_36 = (((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8))) + var_1_8);
   } else {
    var_1_36 = (var_1_4 - var_1_11);
   }
  }
 }
 if (var_1_11 == (var_1_6 | (var_1_5 + var_1_8))) {
  var_1_38 = var_1_13;
 }
 if (var_1_14 >= var_1_3) {
 ...
 if ((((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))) / var_1_4) > (var_1_6 * 10)) {
  if (! var_1_17) {
   var_1_43 = var_1_11;
  } else {
   var_1_43 = var_1_11;
