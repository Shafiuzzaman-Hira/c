...
void step(void) {
	...
	if (var_1_23 >= var_1_27) {
		var_1_32 = (min (4 , (min (var_1_26 , (var_1_31 - var_1_33)))));
	} else {
		var_1_32 = var_1_26;
	}
	...
	if (((var_1_28 & var_1_32) ^ var_1_23) < (var_1_29 & var_1_33)) {
		if (var_1_29 > var_1_33) {
			var_1_34 = ((abs (abs (55383))) - (10 + var_1_28));
		}
	}
	...
	if (var_1_35 || var_1_37) {
		var_1_36 = ((max (var_1_38 , 1.15)) - (min (var_1_39 , var_1_40)));
	}
	...
	// From: CodeObject9
	if ((abs (var_1_30)) >= var_1_33) {
		var_1_42 = (abs (var_1_31));
	} else {
		var_1_42 = (abs (abs (abs (var_1_31))));
	}


	// From: CodeObject10
	var_1_43 = (abs (abs (var_1_39)));


	// From: CodeObject11
	if ((min ((var_1_24 / var_1_45) , var_1_42)) < (var_1_32 ^ var_1_28)) {
		if (var_1_25 < var_1_34) {
			var_1_44 = (max (var_1_26 , var_1_31));
		} else {
			var_1_44 = (max (64 , var_1_30));
		}
	} else {
	...
	// From: CodeObject12
	if (var_1_35) {
		if ((max ((var_1_27 | var_1_33) , var_1_26)) < (var_1_31 / var_1_45)) {
			if (var_1_37) {
				var_1_46 = var_1_38;
			} else {
				var_1_46 = var_1_40;
	...
	// From: Req6Batch37PS_CN_100
	var_1_17 = (var_1_18 - var_1_3);


	// From: Req3Batch37PS_CN_100
	if ((var_1_17 >= var_1_17) || (var_1_9 > last_1_var_1_10)) {
		var_1_10 = var_1_9;
	}


	// From: Req4Batch37PS_CN_100
