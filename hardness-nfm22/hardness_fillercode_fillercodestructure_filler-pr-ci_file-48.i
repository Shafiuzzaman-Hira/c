...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch48Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (((var_1_10 | 1) % var_1_15) >= (var_1_10 >> var_1_16)) {
 ...
 if ((((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15))) - ((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16)))) <= var_1_15) {
 ...
 if (var_1_2) {
  var_1_26 = (! ((var_1_3 >= var_1_3) && var_1_28));
 }
 if ((var_1_16 & var_1_8) <= ((var_1_15 - var_1_15) + -16)) {
  var_1_36 = var_1_25;
 } else {
  if (var_1_28) {
   var_1_36 = (! (! var_1_37));
