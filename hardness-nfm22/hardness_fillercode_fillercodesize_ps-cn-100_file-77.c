...
void step(void) {
	...
	if (var_1_27 < var_1_28) {
		var_1_38 = ((var_1_35 - (max (var_1_36 , var_1_39))) + var_1_34);
	} else {
		var_1_38 = (min ((abs (var_1_22)) , var_1_36));
	}
	...
	if (var_1_35 > (var_1_30 ^ var_1_22)) {
		var_1_41 = ((abs (var_1_38)) + var_1_23);
	}
	...
	if (var_1_26 < var_1_27) {
		if (var_1_38 >= var_1_25) {
			if (var_1_37 >= (var_1_21 | var_1_30)) {
				if (((min (var_1_25 , -100)) * (var_1_22 / var_1_35)) < var_1_39) {
					var_1_42 = var_1_20;
				}
			}
		}
	} else {
		var_1_42 = ((min (var_1_44 , var_1_37)) + (min (var_1_33 , var_1_39)));
	}


	// From: CodeObject11
	if (var_1_36 < (min (8 , var_1_35))) {
		if (var_1_31) {
	...
	// From: Req2Batch77PS_CN_100
	if ((- var_1_7) < (var_1_1 * var_1_4)) {
		var_1_8 = var_1_9;
	}


	// From: Req4Batch77PS_CN_100
	...
	// From: Req3Batch77PS_CN_100
	var_1_10 = (50 + ((var_1_11 + 10000) - var_1_12));


	// From: Req6Batch77PS_CN_100
