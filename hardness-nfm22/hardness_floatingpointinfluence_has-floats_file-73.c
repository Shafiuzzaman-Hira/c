...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch73has_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch73has_floats
	var_1_19 = var_1_8;


	// From: Req3Batch73has_floats
	if (var_1_19 > var_1_9) {
		if (var_1_6) {
