...
void step(void) {
 signed long int stepLocal_0 = ((((*(var_1_5_Pointer))) > (last_1_var_1_10)) ? ((*(var_1_5_Pointer))) : (last_1_var_1_10));
 ...
 if (! (*(var_1_12_Pointer))) {
  if (! (*(var_1_12_Pointer))) {
   ...
   (*(var_1_1_Pointer)) = ((*(var_1_4_Pointer)) - (((((*(var_1_5_Pointer))) < (16)) ? ((*(var_1_5_Pointer))) : (16))));
  }
 }
}
