...
void step(void) {
 ...
 if (var_1_19 <= var_1_22) {
  if (var_1_24) {
   var_1_34 = ((((var_1_33) < (var_1_20)) ? (var_1_33) : (var_1_20)));
  }
 }
 if (var_1_20 <= var_1_34) {
  var_1_35 = (((((((var_1_33) < (var_1_31)) ? (var_1_33) : (var_1_31))) < 0 ) ? -((((var_1_33) < (var_1_31)) ? (var_1_33) : (var_1_31))) : ((((var_1_33) < (var_1_31)) ? (var_1_33) : (var_1_31)))));
 } else {
  if (var_1_19 > var_1_22) {
   var_1_35 = ((((-2) > (var_1_33)) ? (-2) : (var_1_33)));
  }
 }
 if (var_1_34 > var_1_31) {
  var_1_36 = (var_1_31 + ((((var_1_29) > (var_1_30)) ? (var_1_29) : (var_1_30))));
 }
 ...
 if (var_1_39 != var_1_22) {
  ...
  if (var_1_25 || (((((var_1_33) > (var_1_40)) ? (var_1_33) : (var_1_40))) > var_1_30)) {
   if (var_1_23) {
 ...
 if (((100 | var_1_38) >= var_1_45) || (var_1_32 > (var_1_22 + var_1_39))) {
  var_1_44 = ((((var_1_42 + var_1_41) < 0 ) ? -(var_1_42 + var_1_41) : (var_1_42 + var_1_41)));
 }
 if ((var_1_27 || var_1_26) && var_1_23) {
  var_1_46 = (var_1_41 + var_1_43);
 }
 if (var_1_38 <= 100) {
  var_1_47 = (((((100) < 0 ) ? -(100) : (100))) + ((var_1_44 + var_1_41) - var_1_37));
 }
 if (var_1_23) {
  if ((((((var_1_22) < (var_1_21)) ? (var_1_22) : (var_1_21))) - ((((var_1_32) > (var_1_49)) ? (var_1_32) : (var_1_49)))) <= (var_1_39 / var_1_50)) {
