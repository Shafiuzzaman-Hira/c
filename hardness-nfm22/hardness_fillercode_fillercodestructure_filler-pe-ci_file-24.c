...
void step(void) {
	...
	// From: Req6Batch24Filler_PE_CI
	var_1_23 = var_1_24;


	// From: Req3Batch24Filler_PE_CI
	if (128u >= var_1_8) {
		if (! var_1_23) {
	...
	// From: CodeObject2
	if (var_1_19 > (max ((16u | var_1_8) , var_1_18))) {
		if (var_1_29) {
			var_1_31 = var_1_17;
		}
	}
	...
	if ((var_1_17 & -10) < var_1_19) {
		if ((~ (min (var_1_17 , var_1_19))) > var_1_18) {
			if ((min (var_1_19 , (var_1_17 * var_1_19))) < (var_1_18 ^ var_1_18)) {
				if (var_1_30) {
					var_1_35 = var_1_36;
				}
			}
	...
	if (! var_1_30) {
		...
		var_1_39 = (var_1_16 + (max (var_1_36 , (var_1_8 + var_1_12))));
	}
