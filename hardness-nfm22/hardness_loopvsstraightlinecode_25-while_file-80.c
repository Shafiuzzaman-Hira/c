...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch8025_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch8025_while
	if ((max ((var_1_3 - var_1_4) , var_1_2)) <= (min ((var_1_5 - var_1_6) , (var_1_7 % var_1_8)))) {
		var_1_1 = var_1_9;
	}


	// From: Req2Batch8025_while
	if (var_1_8 > var_1_1) {
		if (var_1_1 == var_1_4) {
			var_1_10 = var_1_11;
		}
...
int property() {
	return ((((max ((var_1_3 - var_1_4) , var_1_2)) <= (min ((var_1_5 - var_1_6) , (var_1_7 % var_1_8)))) ? (var_1_1 == ((signed short int) var_1_9)) : 1) && ((var_1_8 > var_1_1) ? ((var_1_1 == var_1_4) ? (var_1_10 == ((float) var_1_11)) : 1) : 1)) && ((var_1_1 <= var_1_8) ? ((var_1_5 != -64) ? (var_1_13 ? (var_1_12 == ((double) (abs (var_1_14 - var_1_15)))) : (var_1_12 == ((double) (var_1_15 - var_1_14)))) : (var_1_12 == ((double) 32.8))) : (var_1_12 == ((double) var_1_11)))
;
}
int main(void) {
	isInitial = 1;
