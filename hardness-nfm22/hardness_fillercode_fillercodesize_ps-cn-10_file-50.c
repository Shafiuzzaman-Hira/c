...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch50PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch50PS_CN_10
	if (var_1_8) {
		var_1_13 = (min ((var_1_14 + var_1_15) , (min (-0.2f , var_1_16))));
	}


	// From: Req6Batch50PS_CN_10
	if (var_1_8) {
		var_1_25 = (var_1_26 + var_1_27);
	}


	// From: Req8Batch50PS_CN_10
	var_1_29 = var_1_27;


	// From: Req9Batch50PS_CN_10
	var_1_30 = var_1_8;


	// From: Req2Batch50PS_CN_10
	...
	// From: Req4Batch50PS_CN_10
	var_1_17 = ((var_1_18 - 25) - var_1_25);


	// From: Req5Batch50PS_CN_10
