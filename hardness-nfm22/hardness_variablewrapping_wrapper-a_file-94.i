...
void step(void) {
 ...
 if (BOOL_unsigned_char_Array_0[1] || BOOL_unsigned_char_Array_0[0]) {
  ...
  signed_char_Array_0[0][1] = (((((signed_char_Array_0[1][0]) > (signed_char_Array_0[0][2])) ? (signed_char_Array_0[1][0]) : (signed_char_Array_0[0][2]))) + (signed_char_Array_0[1][2] + signed_char_Array_0[1][1]));
 }
