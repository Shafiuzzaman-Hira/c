...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch82PS_CN_100.c", 13, "reach_error"); }
...
double var_1_35 = 4.75;
double var_1_36 = 7.2;
float var_1_37 = 7.8;
float var_1_38 = 0.0;
float var_1_39 = 0.0;
float var_1_40 = 127.8;
unsigned short int var_1_41 = 64;
signed short int var_1_42 = -25;
float var_1_43 = 5.75;
float var_1_44 = 10000000000000.5;
...
void step(void) {
 ...
 if (var_1_29) {
  if (((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))) <= var_1_24) {
   if ((((((var_1_27 % var_1_30)) < (var_1_26)) ? ((var_1_27 % var_1_30)) : (var_1_26))) < (var_1_31 * (var_1_32 | var_1_33))) {
    if (((((var_1_25) > (var_1_24)) ? (var_1_25) : (var_1_24))) >= (var_1_34 * (var_1_35 - var_1_36))) {
     var_1_28 = ((((((((var_1_25) < (var_1_37)) ? (var_1_25) : (var_1_37))) < 0 ) ? -((((var_1_25) < (var_1_37)) ? (var_1_25) : (var_1_37))) : ((((var_1_25) < (var_1_37)) ? (var_1_25) : (var_1_37))))) - (var_1_38 - (var_1_39 - 100.5f)));
    }
   }
  } else {
   if (var_1_35 > var_1_38) {
    var_1_28 = (var_1_39 + var_1_40);
   } else {
    if (var_1_41 <= var_1_26) {
     var_1_28 = 9.99999999125E8f;
    }
   }
  }
 }
 var_1_42 = ((((var_1_26 + var_1_27) < 0 ) ? -(var_1_26 + var_1_27) : (var_1_26 + var_1_27)));
 var_1_43 = (((((var_1_40) > (var_1_39)) ? (var_1_40) : (var_1_39))) + ((((var_1_44) < 0 ) ? -(var_1_44) : (var_1_44))));
 if (var_1_28 >= (var_1_44 + var_1_35)) {
  var_1_45 = (var_1_39 + var_1_44);
 } else {
  var_1_45 = var_1_38;
 }
 if (var_1_45 >= var_1_34) {
  var_1_46 = ((((var_1_27) < (var_1_47)) ? (var_1_27) : (var_1_47)));
 }
 if (var_1_40 <= var_1_43) {
  if (((((var_1_47) < 0 ) ? -(var_1_47) : (var_1_47))) <= (var_1_27 * ((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26))))) {
  ...
  var_1_48 = ((((var_1_50) < 0 ) ? -(var_1_50) : (var_1_50)));
 }
 if (var_1_29) {
  if (((((-50) > (var_1_46)) ? (-50) : (var_1_46))) < var_1_27) {
   var_1_51 = (((((((var_1_46) < 0 ) ? -(var_1_46) : (var_1_46))) < 0 ) ? -((((var_1_46) < 0 ) ? -(var_1_46) : (var_1_46))) : ((((var_1_46) < 0 ) ? -(var_1_46) : (var_1_46)))));
  }
 } else {
  if (var_1_42 == ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)))) {
   var_1_51 = 0u;
  }
 }
 if (var_1_37 <= ((((- var_1_40) < 0 ) ? -(- var_1_40) : (- var_1_40)))) {
  if (2 > var_1_47) {
   var_1_52 = (((var_1_29 || var_1_53) && var_1_54) && var_1_55);
  } else {
   var_1_52 = ((! 0) && var_1_55);
  }
 }
 if (var_1_29 || (var_1_41 >= var_1_27)) {
  var_1_56 = (((((128) < (((((var_1_57) < 0 ) ? -(var_1_57) : (var_1_57))))) ? (128) : (((((var_1_57) < 0 ) ? -(var_1_57) : (var_1_57)))))) - var_1_58);
 }
 var_1_59 = var_1_25;
 var_1_60 = var_1_57;
 var_1_61 = var_1_38;
