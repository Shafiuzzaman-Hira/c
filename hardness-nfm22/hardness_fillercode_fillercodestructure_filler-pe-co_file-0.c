...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch0Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject5
	if ((var_1_20 & -100) <= var_1_7) {
		var_1_35 = (! var_1_36);
	}


	// From: CodeObject6
	if (((abs (var_1_6)) - (var_1_20 + var_1_38)) <= var_1_6) {
