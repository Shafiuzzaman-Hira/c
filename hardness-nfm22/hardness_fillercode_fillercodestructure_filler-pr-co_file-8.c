...
void step(void) {
	...
	// From: CodeObject6
	if (var_1_13 < (max ((max (var_1_26 , var_1_7)) , var_1_26))) {
		var_1_42 = var_1_39;
	} else {
		if (var_1_1 <= var_1_39) {
