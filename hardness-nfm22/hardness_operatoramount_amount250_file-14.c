...
void step(void) {
	...
	if (((max (last_1_var_1_47 , last_1_var_1_56)) >= 256u) && var_1_59) {
		if ((var_1_25 - (var_1_54 + 9.25)) <= var_1_23) {
			if (var_1_58) {
				var_1_60 = (min (10 , var_1_48));
			} else {
				var_1_60 = (min (var_1_49 , var_1_18));
			}
		}
	} else {
		var_1_60 = ((max (last_1_var_1_40 , var_1_48)) + last_1_var_1_47);
	}
	...
	if (last_1_var_1_57) {
		if (last_1_var_1_16 != (var_1_15 | 5u)) {
			if (last_1_var_1_16 > (256u * last_1_var_1_64)) {
				...
				var_1_16 = ((max (var_1_18 , var_1_19)) - var_1_15);
			}
		} else {
			if ((last_1_var_1_22 / (max (var_1_6 , var_1_21))) >= var_1_13) {
				var_1_16 = 5;
			}
		}
	}
	...
	signed long int stepLocal_12 = max ((var_1_10 * last_1_var_1_43) , last_1_var_1_40);
	unsigned long int stepLocal_11 = (var_1_13 + last_1_var_1_30) + (max (last_1_var_1_29 , var_1_11));
	...
	if (var_1_21 > stepLocal_11) {
		if ((var_1_15 != last_1_var_1_29) && stepLocal_10) {
			...
			if (var_1_35 <= 0.5) {
				var_1_47 = (max (var_1_13 , var_1_11));
			} else {
				if (stepLocal_12 > (last_1_var_1_43 / (abs (var_1_28)))) {
					var_1_47 = (((var_1_48 + var_1_49) - var_1_15) + (var_1_13 + (var_1_50 - var_1_51)));
				} else {
					var_1_47 = ((abs (var_1_48)) + var_1_15);
				}
			}
		}
	} else {
	...
	if (var_1_36 >= (max (var_1_24 , (max (-0.4 , var_1_33))))) {
		var_1_53 = (var_1_35 - (min ((var_1_54 + var_1_55) , var_1_36)));
	}
	...
	if ((var_1_18 / (max (var_1_21 , var_1_6))) <= stepLocal_6) {
		var_1_34 = (max ((var_1_35 - var_1_36) , ((abs (var_1_33)) - 2.8)));
	} else {
		if ((var_1_32 + (var_1_25 * 15.4f)) <= ((- var_1_36) * (var_1_24 - var_1_35))) {
			if (var_1_4 != stepLocal_5) {
				var_1_34 = (abs (var_1_36 - var_1_35));
			} else {
	...
	if (stepLocal_8 < (abs (var_1_13 * var_1_61))) {
	...
	if ((var_1_23 - (max (var_1_24 , var_1_25))) <= var_1_53) {
		var_1_22 = (max ((4 + var_1_13) , (var_1_47 + (var_1_11 + var_1_12))));
	} else {
		var_1_22 = ((max (var_1_19 , (var_1_28 - 25))) - (var_1_13 + var_1_12));
	}
	...
	if (var_1_57) {
		if (stepLocal_7 < 50) {
			...
			var_1_37 = (max ((abs (var_1_32)) , var_1_36));
		}
	}
	...
	if (var_1_57) {
		...
		var_1_39 = (var_1_32 + (abs (var_1_33)));
	}
	...
	if (var_1_57 || stepLocal_13) {
		...
		var_1_52 = (abs (var_1_32));
	}


	// From: Req7Batch14Amount250
	if (var_1_34 != 5.6) {
		var_1_30 = (min (var_1_47 , var_1_28));
	} else {
		var_1_30 = var_1_28;
	}
	...
	if (var_1_47 >= var_1_10) {
		...
		if ((var_1_15 & var_1_22) >= (var_1_18 + var_1_44)) {
			var_1_29 = (((2005264091 - 1) - (max (var_1_12 , var_1_13))) - var_1_19);
		} else {
	...
	if ((max (var_1_16 , 8)) <= stepLocal_3) {
		var_1_31 = ((abs (var_1_32)) + var_1_33);
	}


	// From: Req12Batch14Amount250
	if ((- var_1_19) >= var_1_62) {
		var_1_40 = (min ((var_1_47 - var_1_22) , (abs (var_1_21))));
	} else {
		if (32u >= var_1_43) {
			var_1_40 = (max (var_1_28 , (max (var_1_10 , 32))));
		} else {
			if ((var_1_8 + var_1_61) == var_1_60) {
				var_1_40 = ((var_1_15 + (abs (var_1_11))) - ((var_1_61 + var_1_12) + var_1_13));
			}
		}
	}
}
...
int property() {
	return (((((((((((((((((((((((var_1_61 >= var_1_30) ? (var_1_1 == ((unsigned long int) (var_1_4 - var_1_16))) : ((((var_1_61 * var_1_16) / var_1_6) <= (var_1_4 / 5u)) ? (var_1_1 == ((unsigned long int) (var_1_16 + var_1_16))) : (var_1_1 == ((unsigned long int) (min (var_1_4 , var_1_16)))))) && ((var_1_22 != var_1_29) ? (var_1_8 == ((signed char) (var_1_10 - (max (var_1_11 , var_1_12))))) : (var_1_8 == ((signed char) (var_1_11 - ((var_1_13 + 5) + 10)))))) && ((var_1_12 < ((var_1_13 + var_1_15) - var_1_11)) ? ((var_1_4 <= ((abs (var_1_1)) / var_1_6)) ? (var_1_14 == ((signed long int) (min (var_1_15 , var_1_43)))) : 1) : (var_1_14 == ((signed long int) (-1 - var_1_13))))) && (last_1_var_1_57 ? ((last_1_var_1_16 != (var_1_15 | 5u)) ? ((last_1_var_1_16 > (256u * last_1_var_1_64)) ? (var_1_16 == ((unsigned short int) var_1_13)) : (var_1_16 == ((unsigned short int) ((max (var_1_18 , var_1_19)) - var_1_15)))) : (((last_1_var_1_22 / (max (var_1_6 , var_1_21))) >= var_1_13) ? (var_1_16 == ((unsigned short int) 5)) : 1)) : 1)) && (((var_1_23 - (max (var_1_24 , var_1_25))) <= var_1_53) ? (var_1_22 == ((unsigned short int) (max ((4 + var_1_13) , (var_1_47 + (var_1_11 + var_1_12)))))) : (var_1_22 == ((unsigned short int) ((max (var_1_19 , (var_1_28 - 25))) - (var_1_13 + var_1_12)))))) && ((var_1_47 >= var_1_10) ? ((16.5f <= var_1_24) ? (var_1_29 == ((signed long int) (var_1_11 - var_1_19))) : 1) : (((var_1_15 & var_1_22) >= (var_1_18 + var_1_44)) ? (var_1_29 == ((signed long int) (((2005264091 - 1) - (max (var_1_12 , var_1_13))) - var_1_19))) : (var_1_29 == ((signed long int) ((var_1_47 - var_1_11) + var_1_13)))))) && ((var_1_34 != 5.6) ? (var_1_30 == ((unsigned long int) (min (var_1_47 , var_1_28)))) : (var_1_30 == ((unsigned long int) var_1_28)))) && (((max (var_1_16 , 8)) <= var_1_1) ? (var_1_31 == ((double) ((abs (var_1_32)) + var_1_33))) : 1)) && (((var_1_18 / (max (var_1_21 , var_1_6))) <= var_1_60) ? (var_1_34 == ((double) (max ((var_1_35 - var_1_36) , ((abs (var_1_33)) - 2.8))))) : (((var_1_32 + (var_1_25 * 15.4f)) <= ((- var_1_36) * (var_1_24 - var_1_35))) ? ((var_1_4 != var_1_16) ? (var_1_34 == ((double) (abs (var_1_36 - var_1_35)))) : (var_1_34 == ((double) (var_1_35 - var_1_36)))) : ((var_1_60 < var_1_28) ? (var_1_34 == ((double) var_1_32)) : 1)))) && (var_1_57 ? ((var_1_12 < 50) ? (var_1_37 == ((double) (var_1_32 + var_1_33))) : (var_1_37 == ((double) (max ((abs (var_1_32)) , var_1_36))))) : 1)) && (var_1_57 ? (var_1_39 == ((double) (abs (var_1_33)))) : (var_1_39 == ((double) (var_1_32 + (abs (var_1_33))))))) && (((- var_1_19) >= var_1_62) ? (var_1_40 == ((signed long int) (min ((var_1_47 - var_1_22) , (abs (var_1_21)))))) : ((32u >= var_1_43) ? (var_1_40 == ((signed long int) (max (var_1_28 , (max (var_1_10 , 32)))))) : (((var_1_8 + var_1_61) == var_1_60) ? (var_1_40 == ((signed long int) ((var_1_15 + (abs (var_1_11))) - ((var_1_61 + var_1_12) + var_1_13)))) : 1)))) && ((var_1_16 < (abs (var_1_13 * var_1_61))) ? (var_1_43 == ((unsigned short int) (var_1_12 + (27324 - var_1_15)))) : (var_1_43 == ((unsigned short int) (var_1_12 + var_1_47))))) && (((var_1_1 >= var_1_1) && var_1_57) ? (var_1_44 == ((signed char) (var_1_13 + (var_1_45 + var_1_46)))) : 1)) && ((var_1_21 > ((var_1_13 + last_1_var_1_30) + (max (last_1_var_1_29 , var_1_11)))) ? (((var_1_15 != last_1_var_1_29) && last_1_var_1_57) ? (var_1_47 == ((unsigned char) 128)) : ((var_1_35 <= 0.5) ? (var_1_47 == ((unsigned char) (max (var_1_13 , var_1_11)))) : (((max ((var_1_10 * last_1_var_1_43) , last_1_var_1_40)) > (last_1_var_1_43 / (abs (var_1_28)))) ? (var_1_47 == ((unsigned char) (((var_1_48 + var_1_49) - var_1_15) + (var_1_13 + (var_1_50 - var_1_51))))) : (var_1_47 == ((unsigned char) ((abs (var_1_48)) + var_1_15)))))) : (var_1_47 == ((unsigned char) (1 + var_1_15))))) && ((var_1_57 || var_1_57) ? (var_1_52 == ((float) (var_1_35 - 100.5f))) : (var_1_52 == ((float) (abs (var_1_32)))))) && ((var_1_36 >= (max (var_1_24 , (max (-0.4 , var_1_33))))) ? (var_1_53 == ((float) (var_1_35 - (min ((var_1_54 + var_1_55) , var_1_36))))) : 1)) && (var_1_56 == ((unsigned long int) ((var_1_13 + var_1_18) + var_1_19)))) && (var_1_57 == ((unsigned char) ((! var_1_58) && var_1_59)))) && ((((max (last_1_var_1_47 , last_1_var_1_56)) >= 256u) && var_1_59) ? (((var_1_25 - (var_1_54 + 9.25)) <= var_1_23) ? (var_1_58 ? (var_1_60 == ((unsigned short int) (min (10 , var_1_48)))) : (var_1_60 == ((unsigned short int) (min (var_1_49 , var_1_18))))) : 1) : (var_1_60 == ((unsigned short int) ((max (last_1_var_1_40 , var_1_48)) + last_1_var_1_47))))) && ((((var_1_50 / var_1_49) >> var_1_13) >= last_1_var_1_40) ? (var_1_61 == ((signed long int) last_1_var_1_40)) : (var_1_61 == ((signed long int) var_1_11)))) && (var_1_62 == ((signed long int) (var_1_12 - ((var_1_63 + 1000000000) - var_1_18))))) && ((var_1_60 <= var_1_1) ? (var_1_64 == ((unsigned short int) (5 + (var_1_65 - var_1_44)))) : 1)
;
}
int main(void) {
	isInitial = 1;
