...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch13stepLocals.c", 13, "reach_error"); }
...
unsigned long int var_1_16 = 1000000;
...
void step(void) {
	...
	// From: Req2Batch13stepLocals
	if (var_1_9) {
		var_1_8 = (var_1_10 - (var_1_11 - var_1_4));
	}


	// From: Req3Batch13stepLocals
	...
	// From: Req5Batch13stepLocals
	if (var_1_6 || var_1_9) {
		if ((var_1_8 % var_1_10) > var_1_16) {
			var_1_21 = ((abs (var_1_11)) + var_1_14);
		}
	}


	// From: Req6Batch13stepLocals
	if (((- var_1_11) < 8) || var_1_9) {
		var_1_22 = (var_1_4 + (abs (var_1_11)));
	}


	// From: Req7Batch13stepLocals
	var_1_23 = (var_1_11 + var_1_4);


	// From: Req8Batch13stepLocals
	if (var_1_18 <= var_1_20) {
		var_1_24 = (min (var_1_8 , (var_1_7 + var_1_11)));
	} else {
...
int property() {
	return (((((((((~ var_1_2) != (var_1_3 >> var_1_4)) ? ((var_1_5 || var_1_6) ? (var_1_1 == ((unsigned short int) var_1_4)) : (var_1_1 == ((unsigned short int) var_1_7))) : (var_1_1 == ((unsigned short int) 100))) && (var_1_9 ? (var_1_8 == ((unsigned char) (var_1_10 - (var_1_11 - var_1_4)))) : 1)) && ((var_1_10 > var_1_8) ? (var_1_12 == ((signed char) ((var_1_4 + var_1_13) + var_1_14))) : 1)) && ((var_1_4 > var_1_1) ? (var_1_15 == ((double) ((var_1_17 - var_1_18) + ((max (var_1_19 , 499.25)) + var_1_20)))) : (var_1_15 == ((double) var_1_17)))) && ((var_1_6 || var_1_9) ? (((var_1_8 % var_1_10) > var_1_16) ? (var_1_21 == ((signed short int) ((abs (var_1_11)) + var_1_14))) : 1) : 1)) && ((((- var_1_11) < 8) || var_1_9) ? (var_1_22 == ((unsigned char) (var_1_4 + (abs (var_1_11))))) : 1)) && (var_1_23 == ((unsigned char) (var_1_11 + var_1_4)))) && ((var_1_18 <= var_1_20) ? (var_1_24 == ((unsigned long int) (min (var_1_8 , (var_1_7 + var_1_11))))) : ((9.99999999999998E13 < var_1_20) ? (var_1_24 == ((unsigned long int) var_1_23)) : 1))
;
}
int main(void) {
	isInitial = 1;
