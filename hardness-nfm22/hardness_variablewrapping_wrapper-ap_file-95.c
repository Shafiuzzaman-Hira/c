...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch95Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	...
	(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) = (abs (last_1_unsigned_char_Array_0_0__1_));
	...
	signed long int stepLocal_0 = (*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) & (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer));
	if ((- (3351680781u - (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)))) > stepLocal_0) {
	...
	if (((*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) / (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer))) < ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer)) >> (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer)))) {
		(*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) = (abs (4 - (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var3_Pointer))));
	} else {
		if ((*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) >= (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))) {
			(*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) = (-5 + ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)) - (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var3_Pointer))));
		} else {
			(*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) = 256;
		}
	}
}
