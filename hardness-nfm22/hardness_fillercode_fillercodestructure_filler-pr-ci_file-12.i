...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch12Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_7 >= (~ ((((var_1_5) > (var_1_44)) ? (var_1_5) : (var_1_44))))) {
  if (var_1_1 >= (~ var_1_22)) {
   var_1_47 = (var_1_44 + var_1_6);
  }
 }
 var_1_21 = ((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)));
 if ((var_1_7 * var_1_21) < ((((var_1_5) < 0 ) ? -(var_1_5) : (var_1_5)))) {
  if (var_1_7 <= var_1_5) {
   var_1_29 = var_1_21;
  } else {
   var_1_29 = var_1_7;
 ...
 if (var_1_6 > var_1_7) {
  if (var_1_28 && var_1_27) {
   var_1_40 = ((((var_1_6) < (var_1_7)) ? (var_1_6) : (var_1_7)));
  }
 } else {
  var_1_40 = (var_1_43 - (var_1_44 - (var_1_45 - var_1_6)));
 }
 var_1_50 = var_1_6;
 ...
 if (var_1_7 < (var_1_18 / var_1_9)) {
  var_1_36 = var_1_6;
 } else {
  if ((((((var_1_23) < 0 ) ? -(var_1_23) : (var_1_23))) / var_1_9) < var_1_18) {
   var_1_36 = var_1_6;
  }
 }
 var_1_48 = var_1_23;
