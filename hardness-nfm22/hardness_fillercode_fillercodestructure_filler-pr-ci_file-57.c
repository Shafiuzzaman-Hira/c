...
void step(void) {
	...
	if ((-1 - var_1_15) < ((var_1_1 / var_1_14) & var_1_16)) {
		if ((- (abs (var_1_16))) < (var_1_14 >> var_1_15)) {
			var_1_32 = var_1_15;
		} else {
			var_1_32 = var_1_15;
		}
	...
	if (var_1_9 < ((var_1_12 / var_1_37) + var_1_9)) {
		if (((var_1_9 >= var_1_12) && var_1_25) && (var_1_11 <= (abs (var_1_9)))) {
			var_1_36 = (abs (var_1_18));
		}
	} else {
		var_1_36 = (max (var_1_18 , (var_1_15 - var_1_18)));
	}
	...
	if (var_1_10 < var_1_10) {
		var_1_30 = (max (var_1_10 , var_1_12));
	}
