...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch73PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch73PS_CN_10
	if (var_1_3 >= (last_1_var_1_12 * var_1_4)) {
		var_1_16 = var_1_18;
	}


	// From: Req7Batch73PS_CN_10
	var_1_22 = (abs (var_1_18));


	// From: Req8Batch73PS_CN_10
	if (var_1_1 > var_1_5) {
	...
	// From: Req9Batch73PS_CN_10
	var_1_26 = var_1_25;


	// From: Req4Batch73PS_CN_10
