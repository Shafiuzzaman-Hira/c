...
void step(void) {
	...
	if (var_1_34 == ((var_1_30 >> 5) & (2341109546u - var_1_36))) {
		if ((var_1_39 < (128.25f * var_1_38)) || ((min (50 , var_1_54)) <= var_1_49)) {
			var_1_55 = (max (var_1_54 , var_1_29));
		} else {
			if (var_1_42) {
				var_1_55 = (abs (abs (var_1_36)));
			}
		}
	}
	...
	if (var_1_39 < ((var_1_41 / var_1_57) + var_1_38)) {
		var_1_56 = ((abs (var_1_58)) + var_1_59);
	} else {
		if (var_1_51) {
			var_1_56 = (var_1_60 - (abs (var_1_59)));
		}
	}


	// From: CodeObject14
	if (((max (var_1_36 , var_1_29)) - (var_1_62 - 1)) != (var_1_63 + (var_1_34 / var_1_64))) {
		var_1_61 = var_1_29;
	} else {
		var_1_61 = (abs (min (var_1_30 , (abs (var_1_62)))));
	}


	// From: CodeObject15
	if (var_1_51) {
		var_1_65 = (min ((var_1_50 + var_1_35) , var_1_30));
	}
	...
	if (var_1_43 < var_1_38) {
		var_1_73 = (min ((min (var_1_54 , var_1_68)) , var_1_45));
	}


	// From: CodeObject21
	if (((abs (31.9f)) / (abs (var_1_57))) > var_1_56) {
		var_1_74 = var_1_60;
	}
	...
	if (var_1_52) {
		...
		if ((- var_1_59) > (min ((- var_1_40) , (abs (var_1_39))))) {
			var_1_79 = ((abs (var_1_29)) - var_1_36);
		} else {
			if (var_1_72) {
				var_1_79 = (-2 + var_1_80);
			}
	...
	if (var_1_50 >= var_1_37) {
		if (var_1_42) {
			var_1_82 = ((abs (var_1_67)) - var_1_60);
		}
	}
	...
	if (var_1_60 > var_1_39) {
		var_1_84 = (((abs (var_1_85)) - (max (var_1_86 , var_1_87))) - (var_1_88 - var_1_89));
	}


	// From: CodeObject28
	if ((var_1_91 - var_1_68) <= var_1_55) {
		if (((var_1_76 - var_1_91) + 128u) <= (abs (var_1_61 / var_1_62))) {
			var_1_90 = (max (var_1_28 , var_1_80));
		}
	}
	...
	if (! var_1_71) {
		if (var_1_46) {
			if (var_1_63 >= var_1_45) {
				if (var_1_82 >= ((abs (var_1_99)) * var_1_84)) {
					var_1_98 = var_1_62;
				}
			} else {
				var_1_98 = var_1_93;
	...
	// From: Req9Batch40PS_CN_250
	var_1_26 = var_1_12;


	// From: Req6Batch40PS_CN_250
	...
	// From: Req4Batch40PS_CN_250
	var_1_16 = (min (((max (256 , var_1_12)) + var_1_12) , var_1_15));


	// From: Req8Batch40PS_CN_250
	var_1_25 = var_1_20;


	// From: Req1Batch40PS_CN_250
