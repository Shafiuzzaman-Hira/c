...
void step(void) {
	...
	// From: Req9Batch52Filler_PR_CI
	var_1_21 = var_1_8;


	// From: Req10Batch52Filler_PR_CI
	var_1_22 = -256;


	// From: CodeObject1
	if ((var_1_22 | (max (var_1_10 , var_1_7))) < ((abs (-5)) >> var_1_17)) {
		var_1_23 = var_1_28;
	}
	...
	if ((25u % var_1_9) < var_1_17) {
		var_1_37 = ((min (var_1_10 , (abs (var_1_8)))) + var_1_21);
	} else {
		if (((max (var_1_33 , var_1_40)) >= var_1_31) && (var_1_21 <= var_1_17)) {
			var_1_37 = var_1_8;
		} else {
	...
	if ((var_1_1 | var_1_17) <= var_1_10) {
		var_1_36 = (max (var_1_1 , ((var_1_10 - 2) + var_1_10)));
	}
