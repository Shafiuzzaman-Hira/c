...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch11dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch11dependencies
	if (last_1_var_1_16 != last_1_var_1_10) {
	...
	// From: Req8Batch11dependencies
	if ((var_1_16 == (var_1_8 - var_1_9)) && var_1_1) {
		var_1_21 = var_1_9;
	}
}
