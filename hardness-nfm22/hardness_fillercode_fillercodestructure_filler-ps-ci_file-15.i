...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch15Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
 if (! var_1_20) {
  if (var_1_20) {
   var_1_26 = (((((((var_1_23) < (var_1_11)) ? (var_1_23) : (var_1_11))) < 0 ) ? -((((var_1_23) < (var_1_11)) ? (var_1_23) : (var_1_11))) : ((((var_1_23) < (var_1_11)) ? (var_1_23) : (var_1_11)))));
  } else {
   if (var_1_11 >= 25) {
    if ((0 > var_1_11) || var_1_19) {
     var_1_26 = (((((((-50) < 0 ) ? -(-50) : (-50))) < 0 ) ? -((((-50) < 0 ) ? -(-50) : (-50))) : ((((-50) < 0 ) ? -(-50) : (-50)))));
    } else {
     if (var_1_19) {
      var_1_26 = (var_1_8 - var_1_23);
     } else {
      var_1_26 = var_1_8;
     }
    }
 ...
 var_1_34 = ((((128) < (((((var_1_22) > ((-5 + var_1_10))) ? (var_1_22) : ((-5 + var_1_10)))))) ? (128) : (((((var_1_22) > ((-5 + var_1_10))) ? (var_1_22) : ((-5 + var_1_10)))))));
 if (var_1_20) {
  var_1_36 = (((((4.2) < (var_1_16)) ? (4.2) : (var_1_16))) - ((8.021944736140885E18 - var_1_38) - 16.75));
 } else {
  var_1_36 = ((((var_1_16) > (var_1_38)) ? (var_1_16) : (var_1_38)));
 }
 var_1_39 = var_1_11;
 if (var_1_19) {
  var_1_41 = ((((((((var_1_11) < (var_1_9)) ? (var_1_11) : (var_1_9)))) > (var_1_7)) ? (((((var_1_11) < (var_1_9)) ? (var_1_11) : (var_1_9)))) : (var_1_7)));
 }
