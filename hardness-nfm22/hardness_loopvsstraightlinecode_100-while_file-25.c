...
void step(void) {
	...
	// From: Req13Batch25100_while
	if ((~ var_1_11) >= (~ var_1_20)) {
		var_1_32 = var_1_17;
	}


	// From: Req4Batch25100_while
	if (var_1_6) {
	...
	// From: Req3Batch25100_while
	var_1_13 = (var_1_14 + var_1_12);


	// From: Req9Batch25100_while
	if (var_1_5) {
	...
	// From: Req11Batch25100_while
	var_1_29 = (var_1_1 + 4u);


	// From: Req5Batch25100_while
	if ((var_1_28 + (var_1_29 + var_1_26)) < var_1_4) {
		var_1_16 = (min (var_1_17 , var_1_18));
	}


	// From: Req12Batch25100_while
