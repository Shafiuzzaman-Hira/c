...
void step(void) {
 ...
 if (var_1_10) {
  if (((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))) <= var_1_7) {
   if ((((((var_1_27 % var_1_30)) < (var_1_14)) ? ((var_1_27 % var_1_30)) : (var_1_14))) < (var_1_23 * (var_1_16 | var_1_23))) {
    if (((((var_1_25) > (var_1_7)) ? (var_1_25) : (var_1_7))) >= (var_1_1 * var_1_7)) {
     var_1_28 = var_1_25;
    }
   }
  } else {
 ...
 if (var_1_27 != var_1_30) {
  var_1_37 = (((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))) - ((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16))));
 } else {
  var_1_37 = (((((((var_1_16) > (var_1_27)) ? (var_1_16) : (var_1_27))) < 0 ) ? -((((var_1_16) > (var_1_27)) ? (var_1_16) : (var_1_27))) : ((((var_1_16) > (var_1_27)) ? (var_1_16) : (var_1_27)))));
 }
 ...
 if (var_1_1 != ((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))) {
  if (((((127.4) < 0 ) ? -(127.4) : (127.4))) < var_1_1) {
   if (var_1_10) {
    var_1_41 = var_1_16;
   }
  } else {
