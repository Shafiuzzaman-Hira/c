...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch5350_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch5350_while
	var_1_20 = var_1_21;


	// From: Req7Batch5350_while
	var_1_22 = var_1_12;


	// From: Req8Batch5350_while
	var_1_23 = var_1_21;


	// From: Req4Batch5350_while
	if (var_1_1) {
