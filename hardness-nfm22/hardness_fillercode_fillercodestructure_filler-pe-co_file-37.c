...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch37Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch37Filler_PE_CO
	var_1_17 = (var_1_18 - var_1_3);


	// From: Req3Batch37Filler_PE_CO
	if ((var_1_17 >= var_1_17) || (var_1_9 > last_1_var_1_10)) {
		var_1_10 = var_1_9;
	}


	// From: Req4Batch37Filler_PE_CO
	...
	if (var_1_17 > var_1_11) {
		var_1_27 = (max (var_1_17 , var_1_1));
	}


	// From: CodeObject3
	if (var_1_17 <= (abs (abs (var_1_17)))) {
		var_1_28 = 4;
	}
	...
	// From: CodeObject6
	if (((var_1_11 & var_1_19) ^ var_1_11) < (var_1_11 & var_1_33)) {
		if (var_1_11 > var_1_33) {
			var_1_34 = ((abs (abs (55383))) - var_1_33);
		}
	}


	// From: CodeObject7
	if ((var_1_17 & (~ var_1_11)) <= var_1_1) {
		if (var_1_35) {
			var_1_36 = (max (var_1_11 , (min (var_1_1 , (abs (var_1_1))))));
		}
	} else {
		if (var_1_37) {
			var_1_36 = -128;
