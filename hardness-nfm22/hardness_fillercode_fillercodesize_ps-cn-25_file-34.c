...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch34PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject3
	if ((min (var_1_25 , var_1_24)) < var_1_27) {
		if (var_1_28) {
	...
	// From: CodeObject5
	if (var_1_30 <= 2) {
		var_1_32 = (var_1_28 || (! var_1_33));
	}


	// From: CodeObject6
	if (var_1_22 < (abs (var_1_23 + var_1_35))) {
		var_1_34 = (var_1_28 && var_1_33);
	}
	...
	// From: Req7Batch34PS_CN_25
	if (var_1_15 > var_1_12) {
		var_1_18 = (! var_1_19);
	}


	// From: Req4Batch34PS_CN_25
	if (var_1_18) {
		var_1_14 = var_1_12;
	} else {
		var_1_14 = 64;
	...
	// From: Req8Batch34PS_CN_25
	var_1_20 = last_1_var_1_17;


	// From: Req6Batch34PS_CN_25
