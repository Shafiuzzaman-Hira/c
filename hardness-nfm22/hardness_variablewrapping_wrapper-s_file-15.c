...
void step(void) {
	// From: Req2Batch15Wrapper_S
	if (WrapperStruct00.var_1_2) {
		WrapperStruct00.var_1_8 = ((1514707036u + (abs (WrapperStruct00.var_1_9))) - last_1_WrapperStruct00_var_1_10);
	} else {
		WrapperStruct00.var_1_8 = (max (last_1_WrapperStruct00_var_1_10 , WrapperStruct00.var_1_9));
	}


	// From: Req3Batch15Wrapper_S
	if (WrapperStruct00.var_1_2) {
		WrapperStruct00.var_1_10 = (WrapperStruct00.var_1_8 + (abs (WrapperStruct00.var_1_7)));
	}


	// From: Req1Batch15Wrapper_S
	...
	// From: Req4Batch15Wrapper_S
	if (WrapperStruct00.var_1_1 >= WrapperStruct00.var_1_1) {
		WrapperStruct00.var_1_11 = (WrapperStruct00.var_1_12 - (max ((WrapperStruct00.var_1_13 + WrapperStruct00.var_1_14) , WrapperStruct00.var_1_15)));
	} else {
		WrapperStruct00.var_1_11 = (max (WrapperStruct00.var_1_14 , WrapperStruct00.var_1_13));
	}
}
...
int property() {
	return ((((WrapperStruct00.var_1_2 || ((~ WrapperStruct00.var_1_10) >= WrapperStruct00.var_1_10)) ? ((WrapperStruct00.var_1_10 < WrapperStruct00.var_1_8) ? ((! WrapperStruct00.var_1_6) ? (WrapperStruct00.var_1_1 == ((signed char) WrapperStruct00.var_1_7)) : 1) : (WrapperStruct00.var_1_1 == ((signed char) 2))) : (WrapperStruct00.var_1_1 == ((signed char) WrapperStruct00.var_1_7))) && (WrapperStruct00.var_1_2 ? (WrapperStruct00.var_1_8 == ((unsigned long int) ((1514707036u + (abs (WrapperStruct00.var_1_9))) - last_1_WrapperStruct00_var_1_10))) : (WrapperStruct00.var_1_8 == ((unsigned long int) (max (last_1_WrapperStruct00_var_1_10 , WrapperStruct00.var_1_9)))))) && (WrapperStruct00.var_1_2 ? (WrapperStruct00.var_1_10 == ((signed long int) (WrapperStruct00.var_1_8 + (abs (WrapperStruct00.var_1_7))))) : 1)) && ((WrapperStruct00.var_1_1 >= WrapperStruct00.var_1_1) ? (WrapperStruct00.var_1_11 == ((double) (WrapperStruct00.var_1_12 - (max ((WrapperStruct00.var_1_13 + WrapperStruct00.var_1_14) , WrapperStruct00.var_1_15))))) : (WrapperStruct00.var_1_11 == ((double) (max (WrapperStruct00.var_1_14 , WrapperStruct00.var_1_13)))))
;
}
int main(void) {
	isInitial = 1;
