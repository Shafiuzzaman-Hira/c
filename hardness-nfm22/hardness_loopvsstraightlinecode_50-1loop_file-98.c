...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch9850_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch9850_1loop
	var_1_17 = var_1_18;


	// From: Req7Batch9850_1loop
	...
	// From: Req8Batch9850_1loop
	var_1_22 = var_1_18;


	// From: Req2Batch9850_1loop
	if (var_1_19 <= var_1_1) {
