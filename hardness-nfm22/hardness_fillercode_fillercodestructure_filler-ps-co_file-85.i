...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch85Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
 if (var_1_5) {
  if ((var_1_13 - ((((var_1_13) < (var_1_13)) ? (var_1_13) : (var_1_13)))) <= var_1_15) {
   var_1_21 = var_1_27;
  }
 }
 var_1_28 = var_1_29;
 ...
 if ((var_1_7 / 25.4f) >= ((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18)))) {
  var_1_37 = (! (var_1_36 || var_1_35));
 }
 if (! var_1_5) {
  if ((var_1_13 + var_1_13) >= ((var_1_15 + var_1_13) << ((((5) < (var_1_39)) ? (5) : (var_1_39))))) {
