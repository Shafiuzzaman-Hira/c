...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch73Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch73Filler_PR_CI
	if ((max ((last_1_var_1_19 / 2) , (~ last_1_var_1_16))) <= var_1_10) {
		var_1_12 = var_1_8;
	}


	// From: Req1Batch73Filler_PR_CI
	...
	// From: CodeObject8
	if (var_1_7) {
		if (var_1_10 > var_1_16) {
			var_1_43 = (abs (abs (var_1_25)));
		} else {
	...
	// From: CodeObject1
	if (var_1_7 && (var_1_16 > var_1_25)) {
		var_1_27 = var_1_8;
	} else {
		if (var_1_16 == var_1_25) {
			if (var_1_25 >= var_1_16) {
				var_1_27 = var_1_8;
			}
		}
	}
	...
	// From: Req9Batch73Filler_PR_CI
	var_1_26 = var_1_25;


	// From: Req4Batch73Filler_PR_CI
	...
	// From: CodeObject7
	if ((- var_1_8) < var_1_1) {
		var_1_42 = (var_1_25 + (max (var_1_37 , (max (var_1_36 , var_1_18)))));
	}


	// From: Req2Batch73Filler_PR_CI
	...
	// From: CodeObject5
	if (var_1_7) {
		if (var_1_7 || (var_1_22 < var_1_25)) {
			var_1_38 = (min (var_1_36 , var_1_22));
		}
	} else {
