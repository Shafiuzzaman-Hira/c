...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_2_Pointer))) {
		if (last_1_WrapperStruct00_var_1_10 > stepLocal_0) {
			(*(WrapperStruct00_var_1_1_Pointer)) = (max ((min ((*(WrapperStruct00_var_1_7_Pointer)) , (*(WrapperStruct00_var_1_8_Pointer)))) , (*(WrapperStruct00_var_1_9_Pointer))));
		}
	} else {
	...
	if (stepLocal_4 > (*(WrapperStruct00_var_1_10_Pointer))) {
		...
		(*(WrapperStruct00_var_1_11_Pointer)) = ((abs ((*(WrapperStruct00_var_1_13_Pointer)))) - (*(WrapperStruct00_var_1_15_Pointer)));
	}


	// From: Req4Batch30Wrapper_SP
