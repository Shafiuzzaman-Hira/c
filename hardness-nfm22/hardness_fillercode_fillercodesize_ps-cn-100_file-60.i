...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch60PS_CN_100.c", 13, "reach_error"); }
...
float var_1_48 = 10.75;
float var_1_49 = 0.0;
float var_1_50 = 200.4;
unsigned long int var_1_51 = 32;
unsigned short int var_1_52 = 1;
double var_1_53 = 15.4;
...
void step(void) {
 ...
 if (var_1_23) {
  var_1_37 = (((var_1_38 / 64.7f) > var_1_39) && (! (var_1_29 && var_1_40)));
 }
 if ((var_1_30 >> var_1_26) != (var_1_33 - var_1_32)) {
  var_1_41 = 16;
 } else {
  var_1_41 = (var_1_42 - var_1_32);
 }
 if ((((((var_1_42 | var_1_26)) > ((var_1_41 | var_1_25))) ? ((var_1_42 | var_1_26)) : ((var_1_41 | var_1_25)))) > ((((var_1_33) < 0 ) ? -(var_1_33) : (var_1_33)))) {
  var_1_43 = ((((-2) < 0 ) ? -(-2) : (-2)));
 } else {
  if (var_1_23) {
   var_1_43 = ((((var_1_31) > (((var_1_41 + var_1_32) - var_1_42))) ? (var_1_31) : (((var_1_41 + var_1_32) - var_1_42))));
  } else {
   var_1_43 = ((((var_1_34) < (var_1_42)) ? (var_1_34) : (var_1_42)));
  }
 }
 if ((((((var_1_38) < 0 ) ? -(var_1_38) : (var_1_38))) * var_1_39) > var_1_45) {
  var_1_44 = ((var_1_33 + var_1_27) + var_1_41);
 }
 if (var_1_45 < var_1_39) {
  if (! (var_1_25 > -500)) {
   if (((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31))) <= (var_1_42 - var_1_32)) {
    var_1_46 = ((((3.5f) > ((((((var_1_47) > (var_1_48)) ? (var_1_47) : (var_1_48))) - (var_1_49 - var_1_50)))) ? (3.5f) : ((((((var_1_47) > (var_1_48)) ? (var_1_47) : (var_1_48))) - (var_1_49 - var_1_50)))));
   } else {
    var_1_46 = ((((var_1_48) < 0 ) ? -(var_1_48) : (var_1_48)));
   }
  }
 } else {
  if (((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39))) < var_1_48) {
   var_1_46 = var_1_50;
  }
 }
 if (var_1_27 < (((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24))) >> var_1_26)) {
  var_1_51 = var_1_30;
 } else {
  if (((((var_1_32) < (var_1_31)) ? (var_1_32) : (var_1_31))) > 2) {
   if (-10 < var_1_43) {
    var_1_51 = var_1_42;
   }
  }
