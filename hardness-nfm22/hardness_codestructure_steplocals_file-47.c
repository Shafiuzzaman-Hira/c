...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch47stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch47stepLocals
	signed long int stepLocal_0 = 32796 - (min (var_1_6 , var_1_9));
	...
	// From: Req4Batch47stepLocals
	if ((var_1_6 + var_1_8) > ((abs (var_1_7)) + var_1_1)) {
	...
	// From: Req7Batch47stepLocals
	if (var_1_8 >= (max ((var_1_4 * var_1_6) , (2 ^ var_1_1)))) {
		var_1_22 = var_1_8;
	}
}
