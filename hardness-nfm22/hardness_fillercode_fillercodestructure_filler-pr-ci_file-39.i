...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch39Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_50 = var_1_51;
 var_1_24 = var_1_25;
 if ((var_1_37 % ((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41)))) >= (var_1_26 * var_1_39)) {
  var_1_40 = ((((((((var_1_38 + var_1_39) < 0 ) ? -(var_1_38 + var_1_39) : (var_1_38 + var_1_39)))) > (var_1_7)) ? (((((var_1_38 + var_1_39) < 0 ) ? -(var_1_38 + var_1_39) : (var_1_38 + var_1_39)))) : (var_1_7)));
 }
 if (var_1_10 > var_1_39) {
  var_1_45 = ((((var_1_22) > ((var_1_46 - ((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21)))))) ? (var_1_22) : ((var_1_46 - ((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21)))))));
 } else {
  if (-32 < var_1_8) {
   var_1_45 = ((((((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21)))) > (var_1_22)) ? (((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21)))) : (var_1_22)));
  }
 }
 var_1_49 = var_1_8;
 var_1_26 = var_1_8;
 ...
 if (var_1_8 <= (var_1_37 & var_1_41)) {
  if ((var_1_23 * var_1_21) >= var_1_21) {
   if (! var_1_6) {
    var_1_43 = (3151323843u - (var_1_38 + ((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8)))));
   } else {
    var_1_43 = var_1_8;
   }
  } else {
 ...
 if (var_1_16) {
  if ((((((((127.5f) < (var_1_20)) ? (127.5f) : (var_1_20))) < 0 ) ? -((((127.5f) < (var_1_20)) ? (127.5f) : (var_1_20))) : ((((127.5f) < (var_1_20)) ? (127.5f) : (var_1_20))))) > 10.5f) {
   var_1_27 = var_1_1;
  }
 }
 ...
 if (var_1_6 && ((var_1_16 && var_1_6) || var_1_6)) {
