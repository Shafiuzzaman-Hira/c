...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch96Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req15Batch96Amount100
	var_1_42 = var_1_39;


	// From: Req9Batch96Amount100
	...
	// From: Req3Batch96Amount100
	var_1_11 = (min (var_1_30 , 2));


	// From: Req5Batch96Amount100
	if (! (var_1_10 > var_1_9)) {
		var_1_16 = (max ((max (var_1_9 , (var_1_17 - var_1_18))) , var_1_10));
	}


	// From: Req6Batch96Amount100
	if (var_1_18 <= (- var_1_10)) {
		var_1_19 = (min (var_1_9 , var_1_10));
	}


	// From: Req14Batch96Amount100
	var_1_41 = var_1_9;


	// From: Req4Batch96Amount100
