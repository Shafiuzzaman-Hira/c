...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch3stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch3stepLocals
	signed char stepLocal_0 = var_1_1;
	if (stepLocal_0 <= ((var_1_7 ^ var_1_9) + var_1_8)) {
		if (var_1_11 == var_1_4) {
			var_1_10 = 0u;
		}
	}
	...
	// From: Req4Batch3stepLocals
	unsigned char stepLocal_1 = var_1_3;
	if ((var_1_2 <= var_1_11) || stepLocal_1) {
	...
	// From: Req5Batch3stepLocals
	if ((min ((var_1_14 - var_1_18) , var_1_5)) < var_1_19) {
		if (var_1_3) {
			var_1_17 = 128.1;
		}
	}
