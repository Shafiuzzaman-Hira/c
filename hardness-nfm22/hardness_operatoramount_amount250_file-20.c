...
void step(void) {
	...
	if (var_1_3) {
		...
		var_1_18 = (max (var_1_8 , (abs (last_1_var_1_59))));
	}
	...
	var_1_47 = (min (last_1_var_1_52 , var_1_40));


	// From: Req14Batch20Amount250
	if (256u <= last_1_var_1_52) {
		if (var_1_40 > ((abs (var_1_11)) * var_1_26)) {
			var_1_42 = (max ((min (var_1_6 , (var_1_5 + var_1_43))) , var_1_44));
		}
	}
	...
	if (var_1_29 >= var_1_40) {
		if ((var_1_37 - var_1_16) <= (max (255.5f , var_1_34))) {
			var_1_55 = (var_1_6 - (min (var_1_54 , (min (var_1_56 , var_1_57)))));
		} else {
			if (var_1_2) {
				var_1_55 = var_1_6;
			} else {
	...
	if (stepLocal_10 <= (45332 - (max (var_1_27 , var_1_6)))) {
		if (((var_1_8 + 28549) - var_1_47) > stepLocal_9) {
			if ((abs (var_1_19)) > stepLocal_8) {
				var_1_30 = var_1_21;
			} else {
				var_1_30 = var_1_47;
			}
	...
	if (stepLocal_18 < var_1_60) {
		if (var_1_32 > (- (max (var_1_36 , var_1_17)))) {
			var_1_52 = (min (100 , var_1_5));
		} else {
			if (var_1_40 <= stepLocal_17) {
				var_1_52 = ((max (var_1_6 , var_1_43)) + var_1_5);
			} else {
	...
	if (var_1_2) {
		var_1_22 = ((var_1_8 - (var_1_23 - var_1_6)) + (max (128 , var_1_27)));
	} else {
		var_1_22 = (min ((max (var_1_6 , var_1_30)) , ((57988 - var_1_9) - var_1_5)));
	}
	...
	signed long int stepLocal_12 = abs (var_1_8);
	unsigned char stepLocal_11 = var_1_5;
	if (var_1_52 == stepLocal_13) {
		if (var_1_26 > stepLocal_12) {
			if (var_1_2) {
				var_1_31 = (abs (min ((var_1_16 - var_1_17) , (var_1_32 + var_1_33))));
			} else {
				var_1_31 = (min (var_1_32 , var_1_33));
			}
		} else {
			var_1_31 = (((var_1_34 - var_1_35) + var_1_36) - (var_1_37 - (max (var_1_38 , var_1_39))));
		}
	} else {
		if (var_1_38 < (9.999999999998E11f - var_1_35)) {
			if (var_1_51 < (var_1_15 + var_1_35)) {
				var_1_31 = ((max (var_1_32 , var_1_39)) + (min (var_1_35 , (var_1_38 - var_1_36))));
			}
		} else {
			if (stepLocal_11 >= (var_1_23 / var_1_40)) {
				var_1_31 = (min (10.875f , var_1_41));
			}
		}
	}
	...
	if (((3.5f + var_1_51) / (max (var_1_37 , var_1_34))) < var_1_38) {
		if (var_1_3 && var_1_2) {
			var_1_45 = (max ((var_1_40 - var_1_18) , -1));
		} else {
			var_1_45 = (var_1_5 + (min (var_1_47 , var_1_43)));
		}
	} else {
	...
	if (var_1_55 < stepLocal_6) {
		var_1_20 = ((var_1_5 + (max (var_1_1 , var_1_6))) + 16);
	} else {
		if (var_1_2) {
			if (4 >= stepLocal_7) {
	...
	if ((min (var_1_17 , var_1_31)) > var_1_15) {
		var_1_28 = ((var_1_6 + var_1_61) + var_1_23);
	} else {
		var_1_28 = ((max ((var_1_19 - var_1_21) , var_1_23)) + ((var_1_29 - var_1_47) - var_1_9));
	}
	...
	if (var_1_2) {
		if ((var_1_11 % (abs (var_1_5))) != stepLocal_14) {
			var_1_48 = (max ((max (var_1_6 , (abs (var_1_8)))) , var_1_52));
		} else {
			if (var_1_27 < stepLocal_15) {
				var_1_48 = ((min ((var_1_8 - var_1_40) , var_1_58)) + var_1_6);
			}
		}
	} else {
...
int property() {
	return (((((((((((((((((((((((((var_1_2 || var_1_3) ? ((var_1_49 == ((64 + var_1_5) - (var_1_6 + 10))) ? (var_1_1 == ((signed short int) var_1_49)) : 1) : 1) && (((var_1_6 / var_1_5) > var_1_20) ? (var_1_7 == ((unsigned short int) ((var_1_8 - var_1_5) + var_1_6))) : 1)) && ((last_1_var_1_45 <= last_1_var_1_10) ? (var_1_9 == ((signed long int) last_1_var_1_45)) : 1)) && (var_1_10 == ((unsigned long int) (var_1_11 - var_1_42)))) && ((var_1_6 >= (var_1_20 ^ var_1_59)) ? (var_1_13 == ((float) (max (var_1_15 , (var_1_16 - var_1_17))))) : 1)) && (var_1_3 ? ((last_1_var_1_42 != ((3451179663u - var_1_6) * var_1_8)) ? (var_1_18 == ((signed long int) (last_1_var_1_59 - ((var_1_19 - last_1_var_1_28) - var_1_6)))) : 1) : (var_1_18 == ((signed long int) (max (var_1_8 , (abs (last_1_var_1_59)))))))) && ((var_1_55 < var_1_22) ? (var_1_20 == ((unsigned short int) ((var_1_5 + (max (var_1_1 , var_1_6))) + 16))) : (var_1_2 ? ((4 >= var_1_45) ? (var_1_20 == ((unsigned short int) (abs (var_1_21 - (var_1_8 - 16))))) : (var_1_20 == ((unsigned short int) (abs (var_1_6))))) : (var_1_20 == ((unsigned short int) var_1_8))))) && (var_1_2 ? (var_1_22 == ((unsigned short int) ((var_1_8 - (var_1_23 - var_1_6)) + (max (128 , var_1_27))))) : (var_1_22 == ((unsigned short int) (min ((max (var_1_6 , var_1_30)) , ((57988 - var_1_9) - var_1_5))))))) && ((var_1_2 || (var_1_20 == (var_1_60 >> var_1_60))) ? (var_1_3 ? ((var_1_15 <= var_1_17) ? (var_1_25 == ((unsigned long int) ((var_1_26 - var_1_21) - var_1_23))) : (var_1_25 == ((unsigned long int) (var_1_26 - var_1_60)))) : ((var_1_9 > (var_1_60 / var_1_5)) ? (var_1_25 == ((unsigned long int) var_1_42)) : 1)) : (var_1_25 == ((unsigned long int) var_1_11)))) && (var_1_27 == ((unsigned char) (var_1_6 + var_1_5)))) && (((min (var_1_17 , var_1_31)) > var_1_15) ? (var_1_28 == ((unsigned long int) ((var_1_6 + var_1_61) + var_1_23))) : (var_1_28 == ((unsigned long int) ((max ((var_1_19 - var_1_21) , var_1_23)) + ((var_1_29 - var_1_47) - var_1_9)))))) && ((var_1_8 <= (45332 - (max (var_1_27 , var_1_6)))) ? ((((var_1_8 + 28549) - var_1_47) > (var_1_6 * var_1_23)) ? (((abs (var_1_19)) > var_1_29) ? (var_1_30 == ((unsigned short int) var_1_21)) : (var_1_30 == ((unsigned short int) var_1_47))) : 1) : (var_1_30 == ((unsigned short int) var_1_8)))) && ((var_1_52 == var_1_22) ? ((var_1_26 > (abs (var_1_8))) ? (var_1_2 ? (var_1_31 == ((float) (abs (min ((var_1_16 - var_1_17) , (var_1_32 + var_1_33)))))) : (var_1_31 == ((float) (min (var_1_32 , var_1_33))))) : (var_1_31 == ((float) (((var_1_34 - var_1_35) + var_1_36) - (var_1_37 - (max (var_1_38 , var_1_39))))))) : ((var_1_38 < (9.999999999998E11f - var_1_35)) ? ((var_1_51 < (var_1_15 + var_1_35)) ? (var_1_31 == ((float) ((max (var_1_32 , var_1_39)) + (min (var_1_35 , (var_1_38 - var_1_36)))))) : 1) : ((var_1_5 >= (var_1_23 / var_1_40)) ? (var_1_31 == ((float) (min (10.875f , var_1_41)))) : 1)))) && ((256u <= last_1_var_1_52) ? ((var_1_40 > ((abs (var_1_11)) * var_1_26)) ? (var_1_42 == ((unsigned char) (max ((min (var_1_6 , (var_1_5 + var_1_43))) , var_1_44)))) : 1) : 1)) && ((((3.5f + var_1_51) / (max (var_1_37 , var_1_34))) < var_1_38) ? ((var_1_3 && var_1_2) ? (var_1_45 == ((signed short int) (max ((var_1_40 - var_1_18) , -1)))) : (var_1_45 == ((signed short int) (var_1_5 + (min (var_1_47 , var_1_43)))))) : ((var_1_31 >= ((var_1_31 + var_1_39) * var_1_38)) ? (var_1_45 == ((signed short int) (var_1_5 + var_1_47))) : 1))) && (var_1_47 == ((unsigned long int) (min (last_1_var_1_52 , var_1_40))))) && (var_1_2 ? (((var_1_11 % (abs (var_1_5))) != (var_1_23 & var_1_21)) ? (var_1_48 == ((unsigned short int) (max ((max (var_1_6 , (abs (var_1_8)))) , var_1_52)))) : ((var_1_27 < var_1_42) ? (var_1_48 == ((unsigned short int) ((min ((var_1_8 - var_1_40) , var_1_58)) + var_1_6))) : 1)) : ((var_1_33 <= var_1_32) ? ((var_1_27 >= (var_1_26 / 4)) ? (var_1_48 == ((unsigned short int) var_1_6)) : 1) : 1))) && (var_1_49 == ((unsigned long int) ((var_1_19 - var_1_42) + var_1_8)))) && (((var_1_17 - var_1_36) > (var_1_38 / var_1_37)) ? (var_1_51 == ((float) var_1_37)) : (var_1_51 == ((float) var_1_35)))) && ((var_1_1 < var_1_60) ? ((var_1_32 > (- (max (var_1_36 , var_1_17)))) ? (var_1_52 == ((unsigned char) (min (100 , var_1_5)))) : ((var_1_40 <= var_1_8) ? (var_1_52 == ((unsigned char) ((max (var_1_6 , var_1_43)) + var_1_5))) : (var_1_52 == ((unsigned char) (128 - (var_1_53 - var_1_54)))))) : 1)) && ((var_1_29 >= var_1_40) ? (((var_1_37 - var_1_16) <= (max (255.5f , var_1_34))) ? (var_1_55 == ((signed char) (var_1_6 - (min (var_1_54 , (min (var_1_56 , var_1_57))))))) : (var_1_2 ? (var_1_55 == ((signed char) var_1_6)) : (var_1_55 == ((signed char) var_1_57)))) : (var_1_55 == ((signed char) var_1_57)))) && (var_1_58 == ((signed long int) var_1_52))) && (var_1_59 == ((unsigned long int) var_1_18))) && (var_1_3 ? (var_1_60 == ((signed long int) (last_1_var_1_30 + (last_1_var_1_25 - var_1_43)))) : 1)) && ((var_1_35 < (var_1_16 - var_1_39)) ? (((var_1_47 / var_1_5) < (~ var_1_53)) ? (var_1_61 == ((signed long int) var_1_26)) : (var_1_61 == ((signed long int) var_1_27))) : (var_1_61 == ((signed long int) var_1_56)))
;
}
int main(void) {
	isInitial = 1;
