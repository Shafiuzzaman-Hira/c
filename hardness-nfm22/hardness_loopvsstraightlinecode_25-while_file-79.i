...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch7925_while.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_2) {
  if ((var_1_7 - ((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10)))) <= var_1_10) {
   var_1_6 = ((((256) < 0 ) ? -(256) : (256)));
  } else {
   var_1_6 = var_1_5;
  }
 } else {
