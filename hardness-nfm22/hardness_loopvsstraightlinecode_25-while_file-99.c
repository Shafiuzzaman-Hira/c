...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch9925_while.c", 13, "reach_error"); }
...
int property() {
	return ((((((min (200 , 128)) - var_1_2) > (abs (8))) ? (var_1_1 == ((float) ((min (var_1_4 , var_1_5)) - var_1_6))) : (var_1_1 == ((float) var_1_6))) && ((var_1_5 >= (var_1_4 + var_1_6)) ? (var_1_7 == ((double) (abs (var_1_8 + var_1_9)))) : 1)) && ((((var_1_2 + var_1_15) + var_1_15) >= var_1_15) ? (var_1_10 == ((signed short int) var_1_2)) : 1)) && ((((var_1_6 - var_1_4) + var_1_7) >= var_1_5) ? (var_1_11 ? (var_1_15 == ((signed long int) 100)) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
