...
void step(void) {
		...
		if (stepLocal_20 < last_1_var_1_46) {
			...
			if (last_1_var_1_35) {
				if (stepLocal_18 > last_1_var_1_47) {
					...
					var_1_55 = (max (last_1_var_1_61 , var_1_43));
				}
			} else {
				var_1_55 = (max (var_1_48 , last_1_var_1_32));
			}
		}
	} else {
		var_1_55 = (abs (var_1_21 + (var_1_48 + var_1_50)));
	}


	// From: Req8Batch48Amount250
	unsigned char stepLocal_6 = var_1_21;
	if (stepLocal_6 < (min (var_1_33 , var_1_20))) {
		if (! last_1_var_1_35) {
	...
	// From: Req19Batch48Amount250
	var_1_56 = (var_1_35 || var_1_36);


	// From: Req23Batch48Amount250
	if (var_1_56) {
		var_1_60 = var_1_17;
	} else {
		var_1_60 = var_1_20;
	...
	// From: Req7Batch48Amount250
	if (((var_1_33 - var_1_20) / var_1_16) <= last_1_var_1_37) {
		var_1_32 = last_1_var_1_37;
	} else {
		var_1_32 = (min (last_1_var_1_57 , ((min (var_1_21 , var_1_20)) + (last_1_var_1_18 + var_1_16))));
	}


	// From: Req15Batch48Amount250
	signed long int stepLocal_17 = last_1_var_1_53;
	unsigned long int stepLocal_16 = min (var_1_17 , last_1_var_1_61);
	if (stepLocal_16 >= (var_1_20 | last_1_var_1_55)) {
		if (last_1_var_1_37 >= stepLocal_17) {
			var_1_47 = (64 + var_1_19);
		} else {
			var_1_47 = (max ((max ((var_1_48 - var_1_21) , (max (4 , var_1_38)))) , last_1_var_1_61));
		}
	} else {
		var_1_47 = (((max (var_1_49 , var_1_50)) - (min (var_1_19 , var_1_17))) + 1);
	}


	// From: Req17Batch48Amount250
	var_1_53 = ((var_1_47 - 10) + (var_1_38 - var_1_60));


	// From: Req4Batch48Amount250
	var_1_18 = (var_1_16 - (var_1_19 + (var_1_20 - var_1_21)));


	// From: Req5Batch48Amount250
	if (var_1_16 != (abs (var_1_20))) {
		var_1_22 = (((max (var_1_23 , var_1_24)) - var_1_25) - var_1_26);
	}


	// From: Req6Batch48Amount250
	var_1_27 = (((min (var_1_25 , var_1_28)) - (var_1_29 + var_1_30)) + var_1_31);


	// From: Req11Batch48Amount250
	if (9999.45 > var_1_25) {
		if (var_1_35) {
	...
	// From: Req16Batch48Amount250
	var_1_51 = (var_1_20 - (var_1_52 - (max (var_1_21 , var_1_38))));


	// From: Req25Batch48Amount250
	var_1_62 = var_1_36;


	// From: Req21Batch48Amount250
	if ((var_1_60 >= (var_1_43 - var_1_16)) || var_1_35) {
		var_1_58 = (var_1_20 - (min (var_1_16 , (max (var_1_21 , 100)))));
	}


	// From: Req14Batch48Amount250
		...
		if (var_1_23 < var_1_29) {
			if (stepLocal_15 && (-5 < 10)) {
				if (stepLocal_14 && var_1_62) {
					var_1_46 = (min (var_1_19 , var_1_20));
				}
			} else {
				var_1_46 = (max (var_1_17 , (var_1_16 - var_1_20)));
			}
		}
	} else {
		var_1_46 = (abs (64));
	...
	// From: Req24Batch48Amount250
	if (255.4 > (abs (var_1_26))) {
		var_1_61 = ((var_1_60 + var_1_52) + var_1_50);
	} else {
		var_1_61 = ((max (var_1_32 , var_1_55)) + var_1_58);
	}


	// From: Req10Batch48Amount250
	signed long int stepLocal_8 = var_1_53;
	signed long int stepLocal_7 = abs (min (-2 , var_1_17));
	if (var_1_32 <= stepLocal_8) {
		if ((var_1_46 / var_1_10) >= stepLocal_7) {
			var_1_39 = var_1_17;
		} else {
			var_1_39 = (64 - (min (var_1_17 , var_1_19)));
		}
	} else {
		var_1_39 = var_1_19;
	}
	...
	// From: Req3Batch48Amount250
	if ((var_1_46 >> var_1_47) >= var_1_47) {
		var_1_15 = (var_1_16 - var_1_17);
	}


	// From: Req22Batch48Amount250
	var_1_59 = var_1_15;


	// From: Req2Batch48Amount250
	unsigned char stepLocal_5 = var_1_35;
	signed long int stepLocal_4 = var_1_10 + var_1_18;
	if (256 <= stepLocal_4) {
		if (stepLocal_5 || var_1_56) {
			var_1_11 = (max ((var_1_60 + 64u) , (min (var_1_15 , 16u))));
		}
	} else {
		var_1_11 = (var_1_60 + (min (32u , (1806311775u - var_1_15))));
	}


	// From: Req13Batch48Amount250
	...
	if (var_1_29 > var_1_23) {
		if (stepLocal_13 < (var_1_16 - var_1_59)) {
			if (stepLocal_12 > (var_1_32 + var_1_43)) {
				var_1_44 = (var_1_24 - (min (var_1_28 , (var_1_25 + var_1_41))));
			} else {
				var_1_44 = (min (var_1_30 , var_1_23));
			}
		} else {
			var_1_44 = ((max (var_1_30 , var_1_25)) - var_1_29);
		}
	} else {
	...
	if (var_1_60 >= stepLocal_21) {
		if (stepLocal_22 >= var_1_39) {
			var_1_57 = ((var_1_19 + var_1_39) + (max (var_1_49 , var_1_38)));
		} else {
			var_1_57 = (max ((var_1_37 + var_1_49) , var_1_16));
		}
	} else {
		var_1_57 = (min (var_1_47 , var_1_19));
	}


	// From: Req12Batch48Amount250
	...
	if (stepLocal_10 != (abs (var_1_57))) {
		if (var_1_37 != stepLocal_9) {
			var_1_42 = (var_1_43 - (var_1_20 + var_1_16));
		} else {
			var_1_42 = (max (var_1_46 , (max (var_1_43 , var_1_47))));
		}
	} else {
...
int property() {
	return (((((((((((((((((((((((((var_1_35 || var_1_35) ? ((var_1_60 >= var_1_51) ? (var_1_1 == ((signed short int) ((max (50 , var_1_51)) + (var_1_37 + var_1_46)))) : (var_1_1 == ((signed short int) (var_1_46 + var_1_51)))) : ((var_1_46 != (var_1_51 % (max (var_1_9 , var_1_10)))) ? ((! var_1_35) ? ((var_1_9 != var_1_60) ? (var_1_1 == ((signed short int) var_1_37)) : (var_1_1 == ((signed short int) var_1_46))) : (var_1_1 == ((signed short int) var_1_51))) : (var_1_1 == ((signed short int) var_1_37)))) && ((256 <= (var_1_10 + var_1_18)) ? ((var_1_35 || var_1_56) ? (var_1_11 == ((unsigned long int) (max ((var_1_60 + 64u) , (min (var_1_15 , 16u)))))) : 1) : (var_1_11 == ((unsigned long int) (var_1_60 + (min (32u , (1806311775u - var_1_15)))))))) && (((var_1_46 >> var_1_47) >= var_1_47) ? (var_1_15 == ((unsigned char) (var_1_16 - var_1_17))) : 1)) && (var_1_18 == ((unsigned char) (var_1_16 - (var_1_19 + (var_1_20 - var_1_21)))))) && ((var_1_16 != (abs (var_1_20))) ? (var_1_22 == ((float) (((max (var_1_23 , var_1_24)) - var_1_25) - var_1_26))) : 1)) && (var_1_27 == ((double) (((min (var_1_25 , var_1_28)) - (var_1_29 + var_1_30)) + var_1_31)))) && ((((var_1_33 - var_1_20) / var_1_16) <= last_1_var_1_37) ? (var_1_32 == ((unsigned long int) last_1_var_1_37)) : (var_1_32 == ((unsigned long int) (min (last_1_var_1_57 , ((min (var_1_21 , var_1_20)) + (last_1_var_1_18 + var_1_16)))))))) && ((var_1_21 < (min (var_1_33 , var_1_20))) ? ((! last_1_var_1_35) ? (var_1_35 == ((unsigned char) (((var_1_17 * 4) < last_1_var_1_58) || var_1_36))) : (var_1_35 == ((unsigned char) var_1_36))) : 1)) && (((var_1_59 < var_1_15) && var_1_35) ? ((var_1_24 >= (var_1_25 - var_1_23)) ? (var_1_37 == ((signed char) var_1_19)) : (((var_1_59 >> var_1_17) <= var_1_15) ? (var_1_37 == ((signed char) (min (var_1_20 , var_1_21)))) : (var_1_37 == ((signed char) ((var_1_20 + var_1_21) - (16 + var_1_38)))))) : 1)) && ((var_1_32 <= var_1_53) ? (((var_1_46 / var_1_10) >= (abs (min (-2 , var_1_17)))) ? (var_1_39 == ((signed short int) var_1_17)) : (var_1_39 == ((signed short int) (64 - (min (var_1_17 , var_1_19)))))) : (var_1_39 == ((signed short int) var_1_19)))) && ((9999.45 > var_1_25) ? (var_1_35 ? (var_1_40 == ((double) (var_1_23 - (var_1_29 + (var_1_30 + var_1_41))))) : 1) : 1)) && ((var_1_33 != (abs (var_1_57))) ? ((var_1_37 != var_1_9) ? (var_1_42 == ((unsigned long int) (var_1_43 - (var_1_20 + var_1_16)))) : (var_1_42 == ((unsigned long int) (max (var_1_46 , (max (var_1_43 , var_1_47))))))) : ((((var_1_37 % var_1_20) < var_1_16) || (! var_1_56)) ? (var_1_42 == ((unsigned long int) (abs (2u)))) : 1))) && ((var_1_29 > var_1_23) ? ((var_1_10 < (var_1_16 - var_1_59)) ? (((var_1_47 + var_1_21) > (var_1_32 + var_1_43)) ? (var_1_44 == ((float) (var_1_24 - (min (var_1_28 , (var_1_25 + var_1_41)))))) : (var_1_44 == ((float) (min (var_1_30 , var_1_23))))) : (var_1_44 == ((float) ((max (var_1_30 , var_1_25)) - var_1_29)))) : (var_1_44 == ((float) (var_1_25 + var_1_30))))) && ((! var_1_36) ? ((var_1_23 < var_1_29) ? ((var_1_36 && (-5 < 10)) ? ((var_1_35 && var_1_62) ? (var_1_46 == ((unsigned char) (min (var_1_19 , var_1_20)))) : 1) : (var_1_46 == ((unsigned char) (max (var_1_17 , (var_1_16 - var_1_20)))))) : 1) : (var_1_46 == ((unsigned char) (abs (64)))))) && (((min (var_1_17 , last_1_var_1_61)) >= (var_1_20 | last_1_var_1_55)) ? ((last_1_var_1_37 >= last_1_var_1_53) ? (var_1_47 == ((unsigned short int) (64 + var_1_19))) : (var_1_47 == ((unsigned short int) (max ((max ((var_1_48 - var_1_21) , (max (4 , var_1_38)))) , last_1_var_1_61))))) : (var_1_47 == ((unsigned short int) (((max (var_1_49 , var_1_50)) - (min (var_1_19 , var_1_17))) + 1))))) && (var_1_51 == ((signed char) (var_1_20 - (var_1_52 - (max (var_1_21 , var_1_38))))))) && (var_1_53 == ((signed long int) ((var_1_47 - 10) + (var_1_38 - var_1_60))))) && ((var_1_9 >= (var_1_19 - var_1_50)) ? (((last_1_var_1_46 * var_1_21) < last_1_var_1_46) ? (var_1_55 == ((unsigned long int) (last_1_var_1_47 + var_1_16))) : (last_1_var_1_35 ? ((((min (61832 , var_1_48)) - var_1_17) > last_1_var_1_47) ? (var_1_55 == ((unsigned long int) var_1_52)) : (var_1_55 == ((unsigned long int) (max (last_1_var_1_61 , var_1_43))))) : (var_1_55 == ((unsigned long int) (max (var_1_48 , last_1_var_1_32)))))) : (var_1_55 == ((unsigned long int) (abs (var_1_21 + (var_1_48 + var_1_50))))))) && (var_1_56 == ((unsigned char) (var_1_35 || var_1_36)))) && ((var_1_60 >= var_1_55) ? ((var_1_61 >= var_1_39) ? (var_1_57 == ((unsigned short int) ((var_1_19 + var_1_39) + (max (var_1_49 , var_1_38))))) : (var_1_57 == ((unsigned short int) (max ((var_1_37 + var_1_49) , var_1_16))))) : (var_1_57 == ((unsigned short int) (min (var_1_47 , var_1_19)))))) && (((var_1_60 >= (var_1_43 - var_1_16)) || var_1_35) ? (var_1_58 == ((signed short int) (var_1_20 - (min (var_1_16 , (max (var_1_21 , 100))))))) : 1)) && (var_1_59 == ((signed short int) var_1_15))) && (var_1_56 ? (var_1_60 == ((unsigned short int) var_1_17)) : (var_1_60 == ((unsigned short int) var_1_20)))) && ((255.4 > (abs (var_1_26))) ? (var_1_61 == ((unsigned long int) ((var_1_60 + var_1_52) + var_1_50))) : (var_1_61 == ((unsigned long int) ((max (var_1_32 , var_1_55)) + var_1_58))))) && (var_1_62 == ((unsigned char) var_1_36))
;
}
int main(void) {
	isInitial = 1;
