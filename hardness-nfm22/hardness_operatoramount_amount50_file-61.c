...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch61Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch61Amount50
	var_1_21 = var_1_6;


	// From: Req8Batch61Amount50
	var_1_22 = var_1_23;


	// From: Req4Batch61Amount50
	...
	// From: Req1Batch61Amount50
	if ((var_1_21 / (abs (64u))) == var_1_4) {
		var_1_1 = (8.8 - 255.2);
	}


	// From: Req3Batch61Amount50
