...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch24Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_19 > (((((16u | var_1_8)) > (var_1_18)) ? ((16u | var_1_8)) : (var_1_18)))) {
  if (var_1_29) {
   var_1_31 = var_1_17;
  }
 }
 if ((var_1_17 & -10) < var_1_19) {
  if ((~ ((((var_1_17) < (var_1_19)) ? (var_1_17) : (var_1_19)))) > var_1_18) {
   if (((((var_1_19) < ((var_1_17 * var_1_19))) ? (var_1_19) : ((var_1_17 * var_1_19)))) < (var_1_18 ^ var_1_18)) {
    if (var_1_30) {
     var_1_35 = var_1_36;
    }
   }
 ...
 if (! var_1_30) {
  ...
  var_1_39 = (var_1_16 + ((((var_1_36) > ((var_1_8 + var_1_12))) ? (var_1_36) : ((var_1_8 + var_1_12)))));
 }
