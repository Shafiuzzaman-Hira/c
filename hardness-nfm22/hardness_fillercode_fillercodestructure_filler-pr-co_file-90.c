...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch90Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject7
	if (var_1_35) {
		var_1_47 = ((var_1_42 + var_1_24) + (min (var_1_39 , (var_1_48 - var_1_41))));
	}


	// From: CodeObject8
	if (var_1_32 >= (-1000 << var_1_24)) {
		if (var_1_14 > (var_1_39 | var_1_48)) {
	...
	// From: CodeObject2
	if (var_1_29) {
		if (var_1_27 < (max ((min (var_1_1 , var_1_1)) , (var_1_24 / var_1_32)))) {
