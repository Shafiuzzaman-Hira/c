...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch17Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch17Wrapper_S
	WrapperStruct00.var_1_12 = last_1_WrapperStruct00_var_1_15;


	// From: Req5Batch17Wrapper_S
	unsigned long int stepLocal_1 = WrapperStruct00.var_1_12;
	signed short int stepLocal_0 = WrapperStruct00.var_1_9;
	if (stepLocal_0 >= WrapperStruct00.var_1_10) {
		if ((WrapperStruct00.var_1_9 + last_1_WrapperStruct00_var_1_15) >= stepLocal_1) {
	...
	// From: Req1Batch17Wrapper_S
	if (WrapperStruct00.var_1_2) {
		WrapperStruct00.var_1_1 = (WrapperStruct00.var_1_3 + (min (WrapperStruct00.var_1_4 , (49.5 + WrapperStruct00.var_1_5))));
	}


	// From: Req2Batch17Wrapper_S
	if ((- (WrapperStruct00.var_1_7 - WrapperStruct00.var_1_8)) <= WrapperStruct00.var_1_3) {
		WrapperStruct00.var_1_6 = ((8 + WrapperStruct00.var_1_15) - WrapperStruct00.var_1_15);
	} else {
		if (WrapperStruct00.var_1_2) {
			if (WrapperStruct00.var_1_11) {
				WrapperStruct00.var_1_6 = WrapperStruct00.var_1_15;
			}
		} else {
			WrapperStruct00.var_1_6 = WrapperStruct00.var_1_15;
		}
	...
	// From: Req4Batch17Wrapper_S
	if (WrapperStruct00.var_1_7 < (WrapperStruct00.var_1_8 - WrapperStruct00.var_1_14)) {
		WrapperStruct00.var_1_13 = (max (WrapperStruct00.var_1_4 , (max ((max (127.4f , WrapperStruct00.var_1_5)) , WrapperStruct00.var_1_3))));
	}
}
...
int property() {
	return ((((WrapperStruct00.var_1_2 ? (WrapperStruct00.var_1_1 == ((double) (WrapperStruct00.var_1_3 + (min (WrapperStruct00.var_1_4 , (49.5 + WrapperStruct00.var_1_5)))))) : 1) && (((- (WrapperStruct00.var_1_7 - WrapperStruct00.var_1_8)) <= WrapperStruct00.var_1_3) ? (WrapperStruct00.var_1_6 == ((signed short int) ((8 + WrapperStruct00.var_1_15) - WrapperStruct00.var_1_15))) : (WrapperStruct00.var_1_2 ? (WrapperStruct00.var_1_11 ? (WrapperStruct00.var_1_6 == ((signed short int) WrapperStruct00.var_1_15)) : 1) : (WrapperStruct00.var_1_6 == ((signed short int) WrapperStruct00.var_1_15))))) && (WrapperStruct00.var_1_12 == ((unsigned long int) last_1_WrapperStruct00_var_1_15))) && ((WrapperStruct00.var_1_7 < (WrapperStruct00.var_1_8 - WrapperStruct00.var_1_14)) ? (WrapperStruct00.var_1_13 == ((float) (max (WrapperStruct00.var_1_4 , (max ((max (127.4f , WrapperStruct00.var_1_5)) , WrapperStruct00.var_1_3)))))) : 1)) && ((WrapperStruct00.var_1_9 >= WrapperStruct00.var_1_10) ? (((WrapperStruct00.var_1_9 + last_1_WrapperStruct00_var_1_15) >= WrapperStruct00.var_1_12) ? (WrapperStruct00.var_1_15 == ((unsigned char) WrapperStruct00.var_1_16)) : (WrapperStruct00.var_1_15 == ((unsigned char) WrapperStruct00.var_1_16))) : 1)
;
}
int main(void) {
	isInitial = 1;
