...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch37Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch37Amount25
	var_1_11 = var_1_1;


	// From: Req2Batch37Amount25
	if (var_1_1 >= (abs (var_1_11 / var_1_2))) {
		var_1_8 = var_1_6;
	} else {
		if (var_1_7) {
			var_1_8 = var_1_6;
