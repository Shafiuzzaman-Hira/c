...
void step(void) {
 ...
 if (var_1_6 != (var_1_6 + var_1_28)) {
  var_1_29 = ((((var_1_28) > (((((((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6)))) < (var_1_1)) ? (((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6)))) : (var_1_1))))) ? (var_1_28) : (((((((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6)))) < (var_1_1)) ? (((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6)))) : (var_1_1))))));
 } else {
  var_1_29 = var_1_6;
 }
 if ((-25 + (var_1_9 + var_1_9)) <= var_1_9) {
  if ((16 >> ((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32)))) > (var_1_9 >> var_1_9)) {
   var_1_31 = var_1_28;
  } else {
