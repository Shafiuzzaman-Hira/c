...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch3350_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch3350_1loop
	var_1_5 = (max (var_1_1 , var_1_14));


	// From: Req7Batch3350_1loop
