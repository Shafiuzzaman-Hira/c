...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch14Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_37 = var_1_30;
 if ((var_1_39 - ((((32) < (var_1_40)) ? (32) : (var_1_40)))) > var_1_34) {
  var_1_38 = ((32.5f >= var_1_29) || (var_1_32 || var_1_41));
 }
 if (! var_1_32) {
  var_1_42 = (((((((((var_1_43) > (var_1_40)) ? (var_1_43) : (var_1_40))) + (var_1_39 + var_1_31))) < (-128)) ? ((((((var_1_43) > (var_1_40)) ? (var_1_43) : (var_1_40))) + (var_1_39 + var_1_31))) : (-128)));
 }
 if ((var_1_29 + ((((var_1_30) > (var_1_37)) ? (var_1_30) : (var_1_37)))) < ((((var_1_36) > ((var_1_45 + var_1_46))) ? (var_1_36) : ((var_1_45 + var_1_46))))) {
  if ((var_1_46 + (var_1_36 + var_1_45)) >= ((((25.5) > (var_1_29)) ? (25.5) : (var_1_29)))) {
