...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch1450_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch1450_1loop
	var_1_1 = (var_1_15 + var_1_15);


	// From: Req8Batch1450_1loop
	var_1_28 = var_1_17;


	// From: Req7Batch1450_1loop
