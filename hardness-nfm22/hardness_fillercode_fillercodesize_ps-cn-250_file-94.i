...
void step(void) {
 ...
 if (var_1_44 < (var_1_42 >> var_1_45)) {
  if (var_1_32 > ((var_1_41 * var_1_38) + (var_1_40 / var_1_34))) {
   var_1_51 = ((((-0.75) < (((((var_1_41) < (var_1_52)) ? (var_1_41) : (var_1_52))))) ? (-0.75) : (((((var_1_41) < (var_1_52)) ? (var_1_41) : (var_1_52))))));
  }
 } else {
  var_1_51 = ((((var_1_52) < (var_1_41)) ? (var_1_52) : (var_1_41)));
 }
 ...
 if (((((var_1_42) < 0 ) ? -(var_1_42) : (var_1_42))) > ((((var_1_48) > (var_1_54)) ? (var_1_48) : (var_1_54)))) {
  if (var_1_53 <= (- 128)) {
   var_1_58 = ((((var_1_53) < 0 ) ? -(var_1_53) : (var_1_53)));
  } else {
   var_1_58 = var_1_55;
  }
 }
 if (((~ var_1_43) | ((((var_1_55) < 0 ) ? -(var_1_55) : (var_1_55)))) != (((((var_1_57 & var_1_53)) < (var_1_48)) ? ((var_1_57 & var_1_53)) : (var_1_48)))) {
  if ((var_1_53 | var_1_43) >= var_1_46) {
   var_1_59 = var_1_41;
  }
 } else {
  if (var_1_29 < var_1_55) {
   if (var_1_57 >= ((((var_1_46) < 0 ) ? -(var_1_46) : (var_1_46)))) {
    if (var_1_35) {
     var_1_59 = ((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41)));
    }
   }
  }
 }
 if (((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))) > var_1_57) {
  if ((25 ^ var_1_37) >= var_1_30) {
   var_1_60 = (((((var_1_61) < 0 ) ? -(var_1_61) : (var_1_61))) - ((((var_1_62) < 0 ) ? -(var_1_62) : (var_1_62))));
  } else {
   var_1_60 = (((((((var_1_61) < 0 ) ? -(var_1_61) : (var_1_61))) < 0 ) ? -((((var_1_61) < 0 ) ? -(var_1_61) : (var_1_61))) : ((((var_1_61) < 0 ) ? -(var_1_61) : (var_1_61)))));
  }
 }
 if (7.375f >= var_1_33) {
 ...
 if (var_1_58 != var_1_60) {
  if (var_1_41 != ((((10000.5) > (var_1_52)) ? (10000.5) : (var_1_52)))) {
   if (var_1_31 > -10000) {
    var_1_64 = var_1_50;
   }
  }
  ...
  if ((var_1_37 * var_1_43) > var_1_31) {
   if (var_1_63 && (var_1_46 <= var_1_54)) {
    var_1_64 = ((((var_1_54) < 0 ) ? -(var_1_54) : (var_1_54)));
   }
  } else {
   var_1_64 = ((((((((var_1_54) > (var_1_60)) ? (var_1_54) : (var_1_60)))) < ((var_1_65 - var_1_50))) ? (((((var_1_54) > (var_1_60)) ? (var_1_54) : (var_1_60)))) : ((var_1_65 - var_1_50))));
  }
 }
 if ((var_1_35 || (var_1_53 > var_1_49)) && (var_1_61 >= ((((var_1_60) < 0 ) ? -(var_1_60) : (var_1_60))))) {
  var_1_66 = (((((var_1_67 - (var_1_54 + var_1_53))) > (var_1_62)) ? ((var_1_67 - (var_1_54 + var_1_53))) : (var_1_62)));
 } else {
  var_1_66 = (var_1_61 + (((((var_1_60) < 0 ) ? -(var_1_60) : (var_1_60))) + var_1_57));
 }
 if (var_1_67 > var_1_58) {
  var_1_68 = ((((var_1_69) < 0 ) ? -(var_1_69) : (var_1_69)));
 }
 if ((var_1_40 + var_1_59) <= ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34)))) {
  if (var_1_36 && var_1_35) {
   var_1_70 = (((var_1_71 - 256.2f) - ((((var_1_72) < (var_1_73)) ? (var_1_72) : (var_1_73)))) - ((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52))));
  }
 } else {
  if (((((var_1_53) < 0 ) ? -(var_1_53) : (var_1_53))) != ((((var_1_66) > (var_1_31)) ? (var_1_66) : (var_1_31)))) {
   if (var_1_30 > (((((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))) < 0 ) ? -((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))) : ((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43)))))) {
    var_1_70 = ((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52)));
   } else {
    var_1_70 = ((((((((var_1_72 + var_1_73) < 0 ) ? -(var_1_72 + var_1_73) : (var_1_72 + var_1_73)))) < ((((((((var_1_71) < (var_1_52)) ? (var_1_71) : (var_1_52))) < 0 ) ? -((((var_1_71) < (var_1_52)) ? (var_1_71) : (var_1_52))) : ((((var_1_71) < (var_1_52)) ? (var_1_71) : (var_1_52))))))) ? (((((var_1_72 + var_1_73) < 0 ) ? -(var_1_72 + var_1_73) : (var_1_72 + var_1_73)))) : ((((((((var_1_71) < (var_1_52)) ? (var_1_71) : (var_1_52))) < 0 ) ? -((((var_1_71) < (var_1_52)) ? (var_1_71) : (var_1_52))) : ((((var_1_71) < (var_1_52)) ? (var_1_71) : (var_1_52))))))));
   }
  } else {
   var_1_70 = (var_1_73 - ((((((((var_1_71) > (var_1_72)) ? (var_1_71) : (var_1_72)))) < (var_1_74)) ? (((((var_1_71) > (var_1_72)) ? (var_1_71) : (var_1_72)))) : (var_1_74))));
  }
 }
 if (var_1_63 || (! var_1_28)) {
  ...
  var_1_75 = ((((var_1_61) > ((((((((var_1_62) < (var_1_54)) ? (var_1_62) : (var_1_54))) < 0 ) ? -((((var_1_62) < (var_1_54)) ? (var_1_62) : (var_1_54))) : ((((var_1_62) < (var_1_54)) ? (var_1_62) : (var_1_54))))))) ? (var_1_61) : ((((((((var_1_62) < (var_1_54)) ? (var_1_62) : (var_1_54))) < 0 ) ? -((((var_1_62) < (var_1_54)) ? (var_1_62) : (var_1_54))) : ((((var_1_62) < (var_1_54)) ? (var_1_62) : (var_1_54))))))));
 }
 if (((8.5f / var_1_34) <= var_1_78) && var_1_28) {
  if (var_1_63) {
   var_1_77 = ((((var_1_69) < 0 ) ? -(var_1_69) : (var_1_69)));
  }
 } else {
  var_1_77 = (((((var_1_69) < 0 ) ? -(var_1_69) : (var_1_69))) - var_1_79);
 }
 ...
 if (var_1_46 > var_1_45) {
  var_1_85 = (((((((((var_1_62) < (var_1_86)) ? (var_1_62) : (var_1_86))) + var_1_79)) < (var_1_61)) ? ((((((var_1_62) < (var_1_86)) ? (var_1_62) : (var_1_86))) + var_1_79)) : (var_1_61)));
 }
 var_1_87 = var_1_86;
 var_1_88 = var_1_62;
 var_1_89 = var_1_55;
