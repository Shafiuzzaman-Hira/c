...
void step(void) {
 ...
 if (var_1_8 > var_1_7) {
  if ((var_1_7 * ((((var_1_8) > (var_1_7)) ? (var_1_8) : (var_1_7)))) < ((((var_1_6) < (32.55f)) ? (var_1_6) : (32.55f)))) {
   if (var_1_6 > 24.443f) {
    var_1_32 = var_1_22;
   }
  }
 ...
 if (var_1_8 >= 127.5f) {
  if ((var_1_12 >> var_1_29) < ((((-1) < 0 ) ? -(-1) : (-1)))) {
   var_1_41 = (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))) + (var_1_28 - (2 + var_1_19)));
  } else {
   var_1_41 = var_1_11;
  }
 } else {
 ...
 var_1_45 = var_1_20;
 if (var_1_31) {
  var_1_47 = (var_1_30 + ((((var_1_30) > (var_1_20)) ? (var_1_30) : (var_1_20))));
 }
 if (var_1_1 < (((((var_1_8 / 15.175f)) > ((- var_1_1))) ? ((var_1_8 / 15.175f)) : ((- var_1_1))))) {
  var_1_49 = (! var_1_24);
 } else {
  if (var_1_24) {
 ...
 if (var_1_7 <= var_1_1) {
  var_1_53 = (var_1_54 - ((((var_1_20) < 0 ) ? -(var_1_20) : (var_1_20))));
 }
}
