...
void step(void) {
	...
	var_1_27 = ((abs (last_1_var_1_57)) + last_1_var_1_45);
		...
		if (last_1_var_1_13 > last_1_var_1_60) {
			if ((last_1_var_1_52 <= (last_1_var_1_45 / var_1_47)) || (100u >= last_1_var_1_52)) {
				if (last_1_var_1_52 != stepLocal_8) {
					var_1_52 = (max ((min (var_1_47 , (var_1_53 - 25))) , var_1_21));
				} else {
					var_1_52 = (min (var_1_39 , (var_1_46 + 50)));
				}
			} else {
				var_1_52 = var_1_42;
			}
		} else {
			var_1_52 = ((var_1_54 - var_1_40) + (max ((abs (var_1_41)) , var_1_42)));
		}
	} else {
		var_1_52 = (var_1_21 + (max (var_1_46 , (min (var_1_54 , 4)))));
	}
	...
	if (var_1_16 >= ((max (var_1_17 , var_1_18)) - var_1_49)) {
		var_1_48 = (! (! var_1_34));
	} else {
	...
	if (var_1_48) {
		...
		var_1_59 = (abs ((min (24.8 , var_1_17)) - 128.25));
	}
	...
	if (var_1_27 <= stepLocal_2) {
		...
		var_1_13 = (min (var_1_16 , (var_1_17 - (7.3956616659376937E18f - var_1_18))));
	}
	...
	if (var_1_48) {
		...
		if (stepLocal_9 >= var_1_41) {
			var_1_55 = ((min (var_1_5 , (var_1_56 - var_1_39))) - (min ((min (var_1_27 , var_1_40)) , var_1_47)));
		} else {
	...
	if (var_1_33) {
		var_1_1 = (min ((var_1_52 + var_1_52) , (var_1_5 - (abs (var_1_45)))));
	} else {
		var_1_1 = (min ((var_1_5 - var_1_45) , (var_1_52 + (256 + 1))));
	}
	...
	if (stepLocal_6 >= var_1_45) {
		if (var_1_13 <= var_1_16) {
			var_1_37 = (min ((var_1_21 - var_1_38) , ((var_1_39 - var_1_40) - (var_1_41 + var_1_42))));
		}
	}
	...
	if (var_1_59 > (64.8f * (max (var_1_20 , var_1_17)))) {
		if (! (var_1_43 || var_1_43)) {
			var_1_29 = (min ((var_1_45 + 1) , (min (var_1_52 , var_1_45))));
		}
	} else {
		if (var_1_43) {
	...
	if ((min ((var_1_59 * var_1_17) , var_1_9)) <= ((8.7 / var_1_20) * var_1_13)) {
		if (stepLocal_3 && (var_1_21 >= (min (var_1_1 , var_1_28)))) {
			var_1_22 = (min (((min (var_1_21 , var_1_51)) + var_1_45) , (var_1_52 - (64 + var_1_45))));
		} else {
	...
	if ((var_1_22 * var_1_5) <= var_1_45) {
		...
		if (var_1_52 >= var_1_52) {
			var_1_11 = (min ((var_1_5 - var_1_28) , var_1_22));
		}
	}


	// From: Req21Batch38Amount250
	var_1_57 = (min (var_1_11 , (max (var_1_42 , var_1_55))));


	// From: Req22Batch38Amount250
	if (var_1_37 > (var_1_27 * var_1_22)) {
		if (var_1_21 >= (var_1_41 - (var_1_42 + 32))) {
			var_1_58 = (max (var_1_46 , (max ((var_1_55 - 2) , (var_1_40 + var_1_45)))));
		} else {
			var_1_58 = (max (-64 , var_1_21));
		}
	}


	// From: Req25Batch38Amount250
	signed long int stepLocal_12 = var_1_45 + var_1_45;
	if (! var_1_48) {
		if (stepLocal_12 <= 5) {
			var_1_61 = (min (var_1_58 , var_1_56));
		}
	}
	...
	if ((var_1_42 == var_1_61) || stepLocal_11) {
		if (stepLocal_10 != var_1_45) {
			var_1_60 = (min (var_1_18 , var_1_17));
		} else {
			if (var_1_48) {
				var_1_60 = var_1_18;
			} else {
	...
	if (var_1_39 <= var_1_11) {
		if (! var_1_43) {
			if ((var_1_41 * (max (var_1_45 , var_1_7))) < var_1_45) {
				var_1_44 = (((abs (var_1_42)) + (min (var_1_40 , var_1_41))) - var_1_38);
			}
		} else {
...
int property() {
	return ((((((((((((((((((((((((var_1_33 ? (var_1_1 == ((unsigned short int) (min ((var_1_52 + var_1_52) , (var_1_5 - (abs (var_1_45))))))) : (var_1_1 == ((unsigned short int) (min ((var_1_5 - var_1_45) , (var_1_52 + (256 + 1))))))) && (((var_1_60 / var_1_9) != var_1_59) ? ((var_1_9 >= var_1_59) ? (var_1_7 == ((unsigned short int) var_1_45)) : ((var_1_5 <= var_1_45) ? ((var_1_52 < (var_1_45 + var_1_57)) ? (var_1_7 == ((unsigned short int) var_1_45)) : (var_1_7 == ((unsigned short int) var_1_5))) : (var_1_7 == ((unsigned short int) var_1_45)))) : (var_1_7 == ((unsigned short int) var_1_45)))) && (((var_1_22 * var_1_5) <= var_1_45) ? (var_1_11 == ((signed long int) (var_1_22 - var_1_28))) : ((var_1_52 >= var_1_52) ? (var_1_11 == ((signed long int) (min ((var_1_5 - var_1_28) , var_1_22)))) : 1))) && ((var_1_27 <= var_1_52) ? (var_1_13 == ((float) var_1_16)) : (var_1_13 == ((float) (min (var_1_16 , (var_1_17 - (7.3956616659376937E18f - var_1_18)))))))) && ((var_1_60 > (var_1_9 / var_1_20)) ? ((! var_1_33) ? (var_1_43 ? (var_1_19 == ((signed char) (5 - var_1_21))) : (var_1_19 == ((signed char) (var_1_21 - 16)))) : 1) : 1)) && (((min ((var_1_59 * var_1_17) , var_1_9)) <= ((8.7 / var_1_20) * var_1_13)) ? (((var_1_13 > var_1_16) && (var_1_21 >= (min (var_1_1 , var_1_28)))) ? (var_1_22 == ((signed short int) (min (((min (var_1_21 , var_1_51)) + var_1_45) , (var_1_52 - (64 + var_1_45)))))) : (var_1_22 == ((signed short int) ((var_1_45 + var_1_21) - var_1_52)))) : (var_1_22 == ((signed short int) (var_1_52 - var_1_21))))) && (var_1_27 == ((signed long int) ((abs (last_1_var_1_57)) + last_1_var_1_45)))) && (var_1_48 ? (((var_1_52 * var_1_32) <= var_1_52) ? (var_1_28 == ((unsigned short int) var_1_45)) : (var_1_28 == ((unsigned short int) (var_1_45 + var_1_45)))) : 1)) && ((var_1_59 > (64.8f * (max (var_1_20 , var_1_17)))) ? ((! (var_1_43 || var_1_43)) ? (var_1_29 == ((unsigned short int) (min ((var_1_45 + 1) , (min (var_1_52 , var_1_45)))))) : 1) : (var_1_43 ? (var_1_29 == ((unsigned short int) (var_1_52 + var_1_21))) : ((var_1_43 && var_1_33) ? (var_1_43 ? (var_1_29 == ((unsigned short int) var_1_5)) : (var_1_29 == ((unsigned short int) var_1_52))) : (var_1_29 == ((unsigned short int) var_1_52)))))) && (var_1_48 ? (var_1_32 == ((signed long int) (var_1_52 - var_1_45))) : 1)) && (var_1_33 == ((unsigned char) var_1_34))) && (var_1_35 == ((signed char) (var_1_36 + 50)))) && (((~ (var_1_52 >> var_1_32)) >= var_1_45) ? ((var_1_13 <= var_1_16) ? (var_1_37 == ((signed char) (min ((var_1_21 - var_1_38) , ((var_1_39 - var_1_40) - (var_1_41 + var_1_42)))))) : 1) : 1)) && ((var_1_59 < var_1_9) ? (var_1_43 == ((unsigned char) (var_1_33 || (! 0)))) : 1)) && ((var_1_39 <= var_1_11) ? ((! var_1_43) ? (((var_1_41 * (max (var_1_45 , var_1_7))) < var_1_45) ? (var_1_44 == ((signed char) (((abs (var_1_42)) + (min (var_1_40 , var_1_41))) - var_1_38))) : 1) : (var_1_44 == ((signed char) (var_1_40 + var_1_41)))) : 1)) && (var_1_45 == ((unsigned char) ((var_1_46 - var_1_40) + (var_1_47 - var_1_42))))) && ((var_1_16 >= ((max (var_1_17 , var_1_18)) - var_1_49)) ? (var_1_48 == ((unsigned char) (! (! var_1_34)))) : (var_1_48 == ((unsigned char) ((! var_1_34) || (! var_1_50)))))) && ((! var_1_50) ? (var_1_51 == ((unsigned short int) (abs (var_1_47)))) : 1)) && (((last_1_var_1_27 < var_1_46) && (last_1_var_1_45 > last_1_var_1_28)) ? ((last_1_var_1_13 > last_1_var_1_60) ? (((last_1_var_1_52 <= (last_1_var_1_45 / var_1_47)) || (100u >= last_1_var_1_52)) ? ((last_1_var_1_52 != ((-128 * last_1_var_1_61) / var_1_39)) ? (var_1_52 == ((unsigned char) (max ((min (var_1_47 , (var_1_53 - 25))) , var_1_21)))) : (var_1_52 == ((unsigned char) (min (var_1_39 , (var_1_46 + 50)))))) : (var_1_52 == ((unsigned char) var_1_42))) : (var_1_52 == ((unsigned char) ((var_1_54 - var_1_40) + (max ((abs (var_1_41)) , var_1_42)))))) : (var_1_52 == ((unsigned char) (var_1_21 + (max (var_1_46 , (min (var_1_54 , 4))))))))) && (var_1_48 ? (var_1_55 == ((unsigned short int) (abs (var_1_52)))) : ((var_1_21 >= var_1_41) ? (var_1_55 == ((unsigned short int) ((min (var_1_5 , (var_1_56 - var_1_39))) - (min ((min (var_1_27 , var_1_40)) , var_1_47))))) : (var_1_55 == ((unsigned short int) (var_1_45 + var_1_53)))))) && (var_1_57 == ((unsigned long int) (min (var_1_11 , (max (var_1_42 , var_1_55))))))) && ((var_1_37 > (var_1_27 * var_1_22)) ? ((var_1_21 >= (var_1_41 - (var_1_42 + 32))) ? (var_1_58 == ((signed short int) (max (var_1_46 , (max ((var_1_55 - 2) , (var_1_40 + var_1_45))))))) : (var_1_58 == ((signed short int) (max (-64 , var_1_21))))) : 1)) && (var_1_48 ? (var_1_59 == ((double) var_1_17)) : (var_1_59 == ((double) (abs ((min (24.8 , var_1_17)) - 128.25)))))) && (((var_1_42 == var_1_61) || ((var_1_52 / var_1_53) <= var_1_5)) ? ((var_1_45 != var_1_45) ? (var_1_60 == ((float) (min (var_1_18 , var_1_17)))) : (var_1_48 ? (var_1_60 == ((float) var_1_18)) : (var_1_60 == ((float) var_1_16)))) : (var_1_60 == ((float) var_1_17)))) && ((! var_1_48) ? (((var_1_45 + var_1_45) <= 5) ? (var_1_61 == ((signed short int) (min (var_1_58 , var_1_56)))) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
