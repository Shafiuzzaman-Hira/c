...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch43Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch43Filler_PE_CN
	if (var_1_13) {
		var_1_12 = (var_1_14 - var_1_15);
	}


	// From: Req5Batch43Filler_PE_CN
	...
	// From: CodeObject4
	if ((var_1_27 | (abs (var_1_33))) > var_1_28) {
		if (var_1_34) {
	...
	if ((- var_1_32) < var_1_36) {
		if (var_1_29 > var_1_36) {
			if (((var_1_27 % var_1_40) % (abs (var_1_41))) == (var_1_31 / var_1_42)) {
				var_1_39 = ((max (var_1_43 , var_1_44)) - var_1_37);
			}
		}
	} else {
