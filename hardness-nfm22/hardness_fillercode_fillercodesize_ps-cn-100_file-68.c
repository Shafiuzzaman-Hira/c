...
void step(void) {
	...
	if (var_1_23 >= var_1_30) {
		if ((99.2 - (max (var_1_24 , var_1_23))) >= var_1_21) {
			var_1_31 = var_1_24;
		}
	}
	...
	// From: CodeObject7
	if (var_1_27 < (abs (1 << var_1_33))) {
		if (((var_1_26 * var_1_33) + var_1_27) != 4u) {
			var_1_32 = (max ((var_1_33 + (var_1_34 + var_1_35)) , var_1_27));
		} else {
			var_1_32 = (abs (abs (var_1_27)));
		}
	} else {
		var_1_32 = (abs (var_1_26));
	}


	// From: CodeObject8
	if ((var_1_27 % var_1_37) > var_1_35) {
		var_1_36 = (abs (var_1_23));
	} else {
		var_1_36 = (200.5f + (max (var_1_38 , var_1_39)));
	}


	// From: CodeObject9
	if (32.25 > (max (var_1_30 , var_1_36))) {
		if (var_1_21 > (- (min (var_1_24 , var_1_39)))) {
	...
	if (var_1_32 == var_1_26) {
		var_1_43 = (max (var_1_34 , (min (var_1_33 , var_1_41))));
	}


	// From: CodeObject12
	if ((var_1_41 % (abs (var_1_37))) < (min (var_1_42 , var_1_40))) {
		if ((var_1_25 & var_1_40) < (var_1_33 * (var_1_27 % var_1_37))) {
			var_1_44 = ((abs (var_1_41)) - var_1_33);
		} else {
			if ((var_1_43 % (abs (var_1_45))) <= ((abs (var_1_37)) - var_1_26)) {
				var_1_44 = (abs (var_1_33));
			} else {
				var_1_44 = (max ((var_1_34 - var_1_35) , var_1_41));
			}
		}
	} else {
	...
	// From: CodeObject13
	if (var_1_27 > 5) {
		var_1_46 = (max (var_1_45 , var_1_40));
	} else {
	...
	// From: Req8Batch68PS_CN_100
	var_1_16 = last_1_var_1_12;


	// From: Req6Batch68PS_CN_100
	...
	// From: Req7Batch68PS_CN_100
	var_1_15 = var_1_10;


	// From: Req3Batch68PS_CN_100
