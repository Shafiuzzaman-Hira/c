...
void step(void) {
 if ((last_1_var_1_9 % (((((*(var_1_3_Pointer))) > ((*(var_1_4_Pointer)))) ? ((*(var_1_3_Pointer))) : ((*(var_1_4_Pointer)))))) <= -1000000) {
 ...
 if ((*(var_1_8_Pointer)) < ((*(var_1_7_Pointer)) / (*(var_1_10_Pointer)))) {
  if ((*(var_1_1_Pointer)) || stepLocal_0) {
   (*(var_1_9_Pointer)) = (((((((*(var_1_11_Pointer))) > (5)) ? ((*(var_1_11_Pointer))) : (5))) + ((*(var_1_12_Pointer)) - (*(var_1_13_Pointer)))) - (*(var_1_14_Pointer)));
  } else {
