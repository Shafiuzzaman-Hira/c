...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch1has_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch1has_floats
	var_1_16 = var_1_13;


	// From: Req2Batch1has_floats
