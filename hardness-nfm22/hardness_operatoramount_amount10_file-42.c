...
int property() {
	return (((((var_1_10 * var_1_10) > var_1_10) ? (var_1_1 == ((signed long int) (var_1_7 + var_1_7))) : (var_1_1 == ((signed long int) (max (var_1_7 , 5))))) && (var_1_7 == ((signed char) var_1_8))) && (var_1_9 == ((signed char) var_1_8))) && (var_1_10 == ((float) var_1_11))
;
}
int main(void) {
	isInitial = 1;
