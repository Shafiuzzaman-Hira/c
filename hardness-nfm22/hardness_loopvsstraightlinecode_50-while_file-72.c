...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch7250_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch7250_while
	var_1_31 = var_1_26;


	// From: Req7Batch7250_while
	var_1_29 = var_1_1;
}
