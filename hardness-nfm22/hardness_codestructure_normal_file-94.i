...
void step(void) {
 if ((-1 << var_1_2) < var_1_3) {
  if ((var_1_4 / var_1_3) > (-1000000000 + var_1_2)) {
 ...
 if (var_1_7 || var_1_5) {
  if ((var_1_2 >= var_1_3) && var_1_1) {
   var_1_8 = ((((var_1_3) < (var_1_2)) ? (var_1_3) : (var_1_2)));
  } else {
   if (var_1_5) {
    var_1_8 = var_1_4;
   } else {
 ...
 if ((((((var_1_20) > (var_1_21)) ? (var_1_20) : (var_1_21))) - var_1_22) >= var_1_2) {
  var_1_19 = ((((var_1_17) > (var_1_18)) ? (var_1_17) : (var_1_18)));
 }
 if (var_1_6 || (var_1_16 <= (var_1_22 / var_1_24))) {
  var_1_23 = (((((var_1_2 + (var_1_21 + var_1_24))) < (((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4))))) ? ((var_1_2 + (var_1_21 + var_1_24))) : (((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4))))));
 }
 var_1_25 = -256;
 var_1_26 = var_1_17;
 var_1_27 = var_1_6;
...
int property() {
 return ((((((((((-1 << var_1_2) < var_1_3) ? (((var_1_4 / var_1_3) > (-1000000000 + var_1_2)) ? (var_1_1 == ((unsigned char) (var_1_5 || var_1_6))) : (var_1_1 == ((unsigned char) var_1_7))) : 1) && ((var_1_7 || var_1_5) ? (((var_1_2 >= var_1_3) && var_1_1) ? (var_1_8 == ((signed long int) ((((var_1_3) < (var_1_2)) ? (var_1_3) : (var_1_2))))) : (var_1_5 ? (var_1_8 == ((signed long int) var_1_4)) : (var_1_8 == ((signed long int) var_1_4)))) : (var_1_8 == ((signed long int) var_1_4)))) && (var_1_9 == ((double) (((((var_1_10) < (var_1_11)) ? (var_1_10) : (var_1_11))) + (var_1_12 + (var_1_13 - var_1_14)))))) && ((var_1_10 >= var_1_11) ? (var_1_15 == ((unsigned short int) ((((((((((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16)))) > (var_1_17)) ? (((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16)))) : (var_1_17)))) > (var_1_18)) ? (((((((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16)))) > (var_1_17)) ? (((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16)))) : (var_1_17)))) : (var_1_18))))) : 1)) && (((((((var_1_20) > (var_1_21)) ? (var_1_20) : (var_1_21))) - var_1_22) >= var_1_2) ? (var_1_19 == ((unsigned long int) ((((var_1_17) > (var_1_18)) ? (var_1_17) : (var_1_18))))) : 1)) && ((var_1_6 || (var_1_16 <= (var_1_22 / var_1_24))) ? (var_1_23 == ((signed long int) (((((var_1_2 + (var_1_21 + var_1_24))) < (((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4))))) ? ((var_1_2 + (var_1_21 + var_1_24))) : (((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4)))))))) : 1)) && (var_1_25 == ((signed long int) -256))) && (var_1_26 == ((unsigned short int) var_1_17))) && (var_1_27 == ((unsigned char) var_1_6))
;
}
int main(void) {
 isInitial = 1;
