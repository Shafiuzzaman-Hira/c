...
void step(void) {
	...
	if (var_1_41 >= var_1_31) {
		...
		var_1_49 = (max (var_1_43 , var_1_28));
	}
	...
	if (var_1_47 < (var_1_48 >> var_1_26)) {
		if ((2 >= var_1_49) && var_1_35) {
			var_1_51 = (min (var_1_37 , var_1_52));
		}
	} else {
		if (var_1_35 || (var_1_40 >= (max (var_1_37 , var_1_44)))) {
			if ((- var_1_37) >= (min (var_1_44 , (var_1_40 + var_1_52)))) {
				var_1_51 = (var_1_53 - var_1_54);
			} else {
				var_1_51 = (min ((abs (max (var_1_54 , var_1_37))) , (max (var_1_52 , var_1_53))));
			}
		} else {
	...
	// From: CodeObject12
	if ((max (var_1_31 , var_1_32)) >= var_1_27) {
		var_1_55 = (var_1_54 - (min (var_1_53 , var_1_56)));
	} else {
		var_1_55 = (abs (abs (var_1_53 - 9.999999999999999E14)));
	}


	// From: CodeObject13
	if ((min (var_1_47 , -50)) >= var_1_27) {
		...
		if (var_1_38 < (64 & var_1_43)) {
			if (var_1_35) {
				var_1_57 = (min ((var_1_59 - var_1_32) , (var_1_48 + var_1_33)));
			}
		}
	}
	...
	if (var_1_35) {
		if ((var_1_26 & var_1_34) > var_1_39) {
			if (var_1_26 <= (var_1_34 | var_1_38)) {
				...
				var_1_63 = (max ((abs (min (var_1_60 , var_1_47))) , var_1_64));
			}
		} else {
			var_1_63 = (min ((max (var_1_39 , (abs (var_1_42)))) , var_1_60));
		}
	} else {
		var_1_63 = (abs (abs (var_1_65)));
	}
	...
	if (var_1_69 > (var_1_27 & var_1_25)) {
		if ((var_1_40 + var_1_70) <= var_1_56) {
			if (var_1_56 >= (var_1_54 / (abs (var_1_58)))) {
				var_1_67 = ((max (var_1_71 , var_1_72)) + var_1_73);
			}
		} else {
			var_1_67 = (min (var_1_71 , var_1_54));
		}
	} else {
		var_1_67 = ((min (var_1_56 , var_1_54)) - ((min (var_1_74 , var_1_75)) - 4.5f));
	}


	// From: CodeObject19
	if (var_1_28 < (max (var_1_45 , var_1_25))) {
		var_1_76 = (abs (abs (var_1_61)));
	} else {
		var_1_76 = (abs (var_1_61));
	}
	...
	if (var_1_35) {
		if (16 != var_1_48) {
			var_1_77 = (abs (var_1_29));
		}
	} else {
		var_1_77 = (min (((var_1_61 - var_1_69) + var_1_62) , var_1_66));
	}


	// From: CodeObject21
	if (var_1_47 <= (min (var_1_39 , var_1_65))) {
		if (var_1_56 <= 999.5) {
			if ((var_1_77 >= var_1_28) && var_1_35) {
				var_1_78 = (max (var_1_30 , (max (var_1_29 , var_1_39))));
			} else {
				var_1_78 = (max (var_1_29 , var_1_60));
			}
		}
	}
	...
	if (var_1_65 >= var_1_49) {
		var_1_79 = (max (var_1_71 , (max (var_1_75 , (abs (var_1_73))))));
	} else {
		if (var_1_49 == (var_1_29 + var_1_27)) {
			var_1_79 = (abs (var_1_73));
		}
	}
	...
	if (var_1_54 > var_1_72) {
		var_1_80 = (abs (max (var_1_75 , var_1_73)));
	}


	// From: CodeObject24
	if (var_1_66 <= (min (100 , var_1_78))) {
	...
	// From: CodeObject29
	if ((min (var_1_44 , var_1_85)) < (abs (var_1_53 - var_1_56))) {
		var_1_88 = ((max (var_1_77 , 5)) + (abs (var_1_42)));
	} else {
		var_1_88 = var_1_39;
	}


	// From: Req1Batch56PS_CN_250
	...
	// From: Req4Batch56PS_CN_250
	var_1_12 = ((64 + var_1_13) - var_1_14);


	// From: Req5Batch56PS_CN_250
	var_1_15 = ((var_1_16 - var_1_17) - 10);


	// From: Req6Batch56PS_CN_250
	if (var_1_1) {
		var_1_18 = (var_1_16 - var_1_13);
	}


	// From: Req7Batch56PS_CN_250
	...
	// From: Req2Batch56PS_CN_250
	if (var_1_4) {
		var_1_6 = (var_1_15 + (min (var_1_15 , var_1_18)));
	}


	// From: Req3Batch56PS_CN_250
