...
void step(void) {
	...
	if ((- (min (var_1_1 , var_1_8))) >= -0.875) {
		...
		var_1_27 = (min (var_1_17 , var_1_28));
	}


	// From: Req8Batch55stepLocals
	var_1_29 = ((abs (var_1_30)) - var_1_20);


	// From: Req9Batch55stepLocals
	var_1_31 = var_1_26;
}
