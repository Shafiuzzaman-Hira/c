...
void step(void) {
	// From: Req1Batch16Wrapper_S
	if ((last_1_WrapperStruct00_var_1_9 % (max (WrapperStruct00.var_1_3 , WrapperStruct00.var_1_4))) <= -1000000) {
		WrapperStruct00.var_1_1 = (WrapperStruct00.var_1_5 || WrapperStruct00.var_1_6);
	}


	// From: Req2Batch16Wrapper_S
	WrapperStruct00.var_1_7 = WrapperStruct00.var_1_8;


	// From: Req4Batch16Wrapper_S
	...
	if (WrapperStruct00.var_1_8 < (WrapperStruct00.var_1_7 / WrapperStruct00.var_1_10)) {
		if (WrapperStruct00.var_1_1 || stepLocal_0) {
			WrapperStruct00.var_1_9 = (((max (WrapperStruct00.var_1_11 , 5)) + (WrapperStruct00.var_1_12 - WrapperStruct00.var_1_13)) - WrapperStruct00.var_1_14);
		} else {
