...
void step(void) {
	...
	// From: CodeObject3
	if ((var_1_25 % (min (var_1_34 , var_1_35))) > var_1_24) {
		var_1_33 = (! (! var_1_36));
	}


	// From: CodeObject4
	if (var_1_28 < (var_1_38 - (abs (var_1_30)))) {
	...
	// From: Req4Batch56PS_CN_25
	var_1_12 = ((64 + var_1_13) - var_1_14);


	// From: Req5Batch56PS_CN_25
	var_1_15 = ((var_1_16 - var_1_17) - 10);


	// From: Req6Batch56PS_CN_25
	if (var_1_1) {
		var_1_18 = (var_1_16 - var_1_13);
	}


	// From: Req7Batch56PS_CN_25
	...
	// From: Req2Batch56PS_CN_25
	if (var_1_4) {
		var_1_6 = (var_1_15 + (min (var_1_15 , var_1_18)));
	}


	// From: Req3Batch56PS_CN_25
