...
void step(void) {
	// From: Req3Batch19Filler_PE_CI
	if (last_1_var_1_15) {
		var_1_10 = (var_1_12 || var_1_13);
	}


	// From: Req7Batch19Filler_PE_CI
	if (var_1_10) {
	...
	// From: Req5Batch19Filler_PE_CI
	if ((- var_1_24) == (var_1_24 + var_1_24)) {
		var_1_15 = var_1_12;
	}


	// From: Req6Batch19Filler_PE_CI
	...
	// From: Req8Batch19Filler_PE_CI
	if (var_1_24 != var_1_24) {
		var_1_29 = (max (var_1_2 , var_1_3));
	}


	// From: Req2Batch19Filler_PE_CI
	...
	// From: Req4Batch19Filler_PE_CI
	if (var_1_15) {
		var_1_14 = (min ((abs (max (var_1_3 , var_1_2))) , var_1_9));
	}


	// From: Req1Batch19Filler_PE_CI
	...
	// From: CodeObject3
	var_1_35 = (max (var_1_27 , (max (8.9f , (var_1_27 - var_1_27)))));
	...
	if ((~ var_1_3) < (var_1_3 * var_1_2)) {
		if (var_1_10) {
			var_1_39 = (min ((var_1_27 - (abs (var_1_27))) , (min (var_1_26 , var_1_26))));
		} else {
	...
	// From: CodeObject6
	if (var_1_10) {
		if (((~ var_1_3) ^ var_1_3) < ((var_1_3 | var_1_9) % (min (var_1_9 , var_1_8)))) {
