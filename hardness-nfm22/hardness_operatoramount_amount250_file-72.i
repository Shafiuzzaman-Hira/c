...
void step(void) {
 if ((- (var_1_19 * last_1_var_1_57)) <= var_1_18) {
  ...
  if ((16 | last_1_var_1_21) > last_1_var_1_59) {
   var_1_22 = ((((last_1_var_1_59) < 0 ) ? -(last_1_var_1_59) : (last_1_var_1_59)));
  } else {
   var_1_22 = var_1_16;
  }
 }
 if ((var_1_37 - var_1_15) > var_1_38) {
  ...
  if (((last_1_var_1_59 >> last_1_var_1_50) % var_1_39) > (((((last_1_var_1_64) > (var_1_15)) ? (last_1_var_1_64) : (var_1_15))) / var_1_23)) {
 ...
 if (var_1_41) {
  if (var_1_27 <= var_1_20) {
   var_1_50 = (((((0) < (var_1_51)) ? (0) : (var_1_51))) - var_1_52);
  } else {
 ...
 var_1_64 = ((((((var_1_65 - var_1_53)) < (var_1_54)) ? ((var_1_65 - var_1_53)) : (var_1_54))) - var_1_52);
 unsigned short int stepLocal_10 = var_1_37;
 if ((((((var_1_64) < (64)) ? (var_1_64) : (64))) << var_1_50) <= stepLocal_10) {
  if (var_1_6) {
   var_1_59 = var_1_60;
  } else {
   var_1_59 = var_1_38;
 ...
 if (var_1_56 <= (~ -256)) {
  ...
  if (2 <= var_1_64) {
   var_1_21 = ((((var_1_56) < ((var_1_14 + -5))) ? (var_1_56) : ((var_1_14 + -5))));
  } else {
   var_1_21 = var_1_15;
  }
 }
 ...
 if ((32u << var_1_16) < (~ ((((var_1_14) < (var_1_61)) ? (var_1_14) : (var_1_61))))) {
  var_1_34 = (-25 + var_1_56);
 }
 if ((var_1_15 / var_1_23) >= var_1_14) {
  var_1_36 = (var_1_37 - var_1_56);
 } else {
  if (((var_1_38 + var_1_39) - 5) != ((((var_1_56) > (var_1_59)) ? (var_1_56) : (var_1_59)))) {
 ...
 if (var_1_1 || var_1_6) {
  ...
  var_1_46 = (((((var_1_14) < (var_1_38)) ? (var_1_14) : (var_1_38))) - var_1_36);
 }
 if ((-10 == var_1_24) || var_1_4) {
  if ((var_1_56 / var_1_37) >= var_1_14) {
   if (((var_1_28 + var_1_32) - var_1_29) >= ((((var_1_20) > (var_1_30)) ? (var_1_20) : (var_1_30)))) {
    var_1_47 = var_1_18;
   }
  } else {
   if (var_1_41 && ((var_1_24 * var_1_16) > (-100 * var_1_15))) {
    var_1_47 = ((((var_1_20) < (var_1_30)) ? (var_1_20) : (var_1_30)));
   } else {
    var_1_47 = (var_1_19 - 31.125f);
   }
  }
 }
 if ((((((var_1_39) > (var_1_59)) ? (var_1_39) : (var_1_59))) - var_1_14) > ((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37)))) {
  if (var_1_5) {
   var_1_57 = (((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28))) - (var_1_31 - var_1_29));
  }
 } else {
  if (var_1_53 < var_1_14) {
   var_1_57 = ((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29)));
  } else {
   var_1_57 = (var_1_28 + (255.2f + ((((var_1_32) < (var_1_58)) ? (var_1_32) : (var_1_58)))));
  }
 }
 if (var_1_1) {
  var_1_8 = (((((-10000 + var_1_50)) < (((var_1_56 + 64) + var_1_14))) ? ((-10000 + var_1_50)) : (((var_1_56 + 64) + var_1_14))));
 } else {
  var_1_8 = (((((16) < (var_1_59)) ? (16) : (var_1_59))) - var_1_59);
 }
 ...
 if (stepLocal_5 && var_1_1) {
  if (stepLocal_7 < var_1_50) {
   if (stepLocal_6 >= var_1_59) {
    var_1_40 = ((((var_1_38) > (((((var_1_59) < (var_1_8)) ? (var_1_59) : (var_1_8))))) ? (var_1_38) : (((((var_1_59) < (var_1_8)) ? (var_1_59) : (var_1_8))))));
   }
  } else {
   var_1_40 = var_1_59;
  }
 ...
 if (var_1_47 >= (var_1_32 / var_1_44)) {
  var_1_43 = (var_1_32 + ((((var_1_27) < (var_1_28)) ? (var_1_27) : (var_1_28))));
 }
 unsigned long int stepLocal_8 = var_1_24 * (var_1_49 - var_1_37);
 if (stepLocal_8 != var_1_40) {
  if (var_1_27 < 1.25f) {
   var_1_48 = ((((1000) < 0 ) ? -(1000) : (1000)));
  } else {
   var_1_48 = (-50 + var_1_14);
  }
 } else {
  var_1_48 = ((((var_1_14) < (var_1_59)) ? (var_1_14) : (var_1_59)));
 }
 if (var_1_59 > var_1_59) {
  if (var_1_48 >= var_1_36) {
   var_1_45 = (var_1_39 - (((((var_1_48 + var_1_22)) > (var_1_15)) ? ((var_1_48 + var_1_22)) : (var_1_15))));
  } else {
   var_1_45 = (var_1_36 + (((((var_1_59) < (var_1_37)) ? (var_1_59) : (var_1_37))) + var_1_59));
  }
 } else {
  var_1_45 = (((((var_1_22 - var_1_39)) < (var_1_15)) ? ((var_1_22 - var_1_39)) : (var_1_15)));
 }
}
