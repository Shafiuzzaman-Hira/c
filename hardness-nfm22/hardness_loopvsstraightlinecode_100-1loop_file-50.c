...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch50100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch50100_1loop
	unsigned long int stepLocal_5 = last_1_var_1_27;
	if (stepLocal_5 > var_1_10) {
		var_1_18 = (max (var_1_19 , var_1_20));
	}


	// From: Req8Batch50100_1loop
	signed long int stepLocal_6 = abs (var_1_19 / var_1_9);
	if (var_1_18 < stepLocal_6) {
		var_1_24 = (((min (var_1_9 , var_1_25)) + var_1_26) - var_1_8);
	}


	// From: Req4Batch50100_1loop
	signed long int stepLocal_2 = var_1_24 * var_1_24;
	if (stepLocal_2 < (var_1_11 / (min (var_1_8 , var_1_9)))) {
		var_1_15 = (min (var_1_11 , var_1_18));
	} else {
		var_1_15 = var_1_8;
	}


	// From: Req1Batch50100_1loop
	...
	// From: Req7Batch50100_1loop
	var_1_21 = ((6.0518857180359721E18 - var_1_22) - var_1_23);


	// From: Req11Batch50100_1loop
	...
	// From: Req13Batch50100_1loop
	var_1_41 = var_1_36;


	// From: Req9Batch50100_1loop
	...
	// From: Req10Batch50100_1loop
	unsigned long int stepLocal_9 = var_1_27 % var_1_33;
	unsigned char stepLocal_8 = var_1_39;
	if (((min (var_1_18 , var_1_25)) * 4) < stepLocal_9) {
		if (stepLocal_8 && var_1_16) {
			var_1_32 = ((var_1_34 - var_1_22) - (max ((var_1_35 - var_1_36) , var_1_23)));
		} else {
...
int property() {
	return (((((((((((((var_1_24 > var_1_15) ? (var_1_1 == ((double) (abs (var_1_4)))) : (var_1_1 == ((double) var_1_4))) && (((var_1_4 * var_1_32) == var_1_32) ? (var_1_39 ? (var_1_5 == ((unsigned short int) (((10000 + var_1_8) + var_1_9) - var_1_18))) : (var_1_5 == ((unsigned short int) (var_1_11 - var_1_8)))) : (var_1_39 ? (var_1_5 == ((unsigned short int) var_1_18)) : (var_1_5 == ((unsigned short int) var_1_9))))) && ((var_1_9 <= (var_1_11 - var_1_8)) ? (last_1_var_1_16 ? (last_1_var_1_39 ? (var_1_14 == ((unsigned short int) var_1_8)) : 1) : 1) : 1)) && (((var_1_24 * var_1_24) < (var_1_11 / (min (var_1_8 , var_1_9)))) ? (var_1_15 == ((unsigned short int) (min (var_1_11 , var_1_18)))) : (var_1_15 == ((unsigned short int) var_1_8)))) && (((var_1_9 << var_1_18) != var_1_18) ? ((var_1_18 >= (var_1_9 * var_1_18)) ? (var_1_16 == ((unsigned char) var_1_17)) : (var_1_16 == ((unsigned char) var_1_17))) : (var_1_16 == ((unsigned char) var_1_17)))) && ((last_1_var_1_27 > var_1_10) ? (var_1_18 == ((unsigned char) (max (var_1_19 , var_1_20)))) : 1)) && (var_1_21 == ((double) ((6.0518857180359721E18 - var_1_22) - var_1_23)))) && ((var_1_18 < (abs (var_1_19 / var_1_9))) ? (var_1_24 == ((unsigned short int) (((min (var_1_9 , var_1_25)) + var_1_26) - var_1_8))) : 1)) && (((var_1_4 * var_1_1) != var_1_21) ? (((var_1_18 / var_1_25) > var_1_24) ? (var_1_27 == ((unsigned long int) (((var_1_28 + var_1_29) - (10000u + 256u)) - (var_1_30 - var_1_24)))) : (var_1_27 == ((unsigned long int) (var_1_31 - var_1_9)))) : (var_1_27 == ((unsigned long int) var_1_20)))) && ((((min (var_1_18 , var_1_25)) * 4) < (var_1_27 % var_1_33)) ? ((var_1_39 && var_1_16) ? (var_1_32 == ((double) ((var_1_34 - var_1_22) - (max ((var_1_35 - var_1_36) , var_1_23))))) : (var_1_32 == ((double) (var_1_34 - var_1_22)))) : 1)) && ((var_1_16 || (var_1_8 < (var_1_24 | var_1_28))) ? (var_1_37 == ((double) (var_1_23 - var_1_36))) : (var_1_37 == ((double) (var_1_35 - var_1_36))))) && ((last_1_var_1_39 && (var_1_14 == var_1_29)) ? (var_1_39 == ((unsigned char) (var_1_17 && (! var_1_40)))) : 1)) && (var_1_41 == ((float) var_1_36))
;
}
int main(void) {
	isInitial = 1;
