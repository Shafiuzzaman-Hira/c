...
void step(void) {
 ...
 if (! var_1_37) {
  if ((var_1_30 + var_1_24) >= ((var_1_21 + var_1_23) << ((((5) < (var_1_39)) ? (5) : (var_1_39))))) {
   ...
   if (! (var_1_26 >= var_1_41)) {
    if (var_1_25 != (((((50) > (var_1_21)) ? (50) : (var_1_21))) | (var_1_23 | var_1_39))) {
     var_1_38 = (((((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39))) < 0 ) ? -((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39))) : ((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39)))));
    }
   } else {
    if (var_1_40 >= var_1_21) {
     var_1_38 = ((((var_1_39) < (var_1_40)) ? (var_1_39) : (var_1_40)));
    }
   }
  }
 }
 ...
 if (! var_1_22) {
  var_1_45 = ((((var_1_29) > ((var_1_46 - ((((var_1_47) < 0 ) ? -(var_1_47) : (var_1_47)))))) ? (var_1_29) : ((var_1_46 - ((((var_1_47) < 0 ) ? -(var_1_47) : (var_1_47)))))));
 }
 if (var_1_21 <= var_1_41) {
  var_1_48 = ((var_1_49 - var_1_38) - ((((var_1_39) < (((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))))) ? (var_1_39) : (((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41)))))));
 } else {
  if (var_1_42 >= var_1_41) {
   if (4u > var_1_39) {
    var_1_48 = (((((var_1_39) < (var_1_27)) ? (var_1_39) : (var_1_27))) + var_1_40);
   }
  }
 }
 if (var_1_31) {
 ...
 if (var_1_50) {
  if (var_1_34 <= var_1_46) {
   var_1_51 = (((((((((var_1_40 + var_1_25)) > (var_1_38)) ? ((var_1_40 + var_1_25)) : (var_1_38)))) > (var_1_24)) ? ((((((var_1_40 + var_1_25)) > (var_1_38)) ? ((var_1_40 + var_1_25)) : (var_1_38)))) : (var_1_24)));
  } else {
   var_1_51 = var_1_24;
  }
 }
