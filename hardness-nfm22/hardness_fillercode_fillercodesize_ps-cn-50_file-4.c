...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch4PS_CN_50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject6
	if (var_1_34 != (abs (var_1_35))) {
		var_1_36 = (min ((var_1_34 - var_1_32) , (min ((var_1_24 + var_1_26) , var_1_25))));
	}


	// From: CodeObject7
	if ((var_1_25 * (var_1_38 - var_1_34)) <= var_1_23) {
		var_1_37 = ((var_1_39 - var_1_35) + var_1_34);
	} else {
		if (var_1_34 <= (var_1_38 * 64)) {
			var_1_37 = (max (var_1_34 , (abs (var_1_35))));
		}
	}


	// From: CodeObject8
	if (var_1_24 >= (var_1_23 ^ (var_1_32 % var_1_41))) {
