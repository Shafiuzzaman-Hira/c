...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch79dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch79dependencies
	if (last_1_var_1_18 && last_1_var_1_18) {
		if ((min (last_1_var_1_20 , (last_1_var_1_20 * last_1_var_1_20))) > last_1_var_1_20) {
			var_1_7 = var_1_8;
		} else {
			var_1_7 = var_1_8;
		}
	...
	// From: Req7Batch79dependencies
	var_1_26 = var_1_16;


	// From: Req8Batch79dependencies
	var_1_27 = 10u;


	// From: Req6Batch79dependencies
	if (var_1_8 >= var_1_7) {
	...
	// From: Req3Batch79dependencies
	if (var_1_27 != (var_1_8 + var_1_7)) {
