...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch150_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req5Batch150_while
	var_1_15 = (var_1_16 - var_1_17);


	// From: Req8Batch150_while
	var_1_27 = var_1_21;


	// From: Req1Batch150_while
	...
	// From: Req2Batch150_while
	if (var_1_27 < (var_1_27 - var_1_27)) {
		var_1_6 = var_1_9;
	}


	// From: Req3Batch150_while
