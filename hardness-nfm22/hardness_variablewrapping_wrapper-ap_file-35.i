...
void step(void) {
 ...
 if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var3_Pointer))) {
  (*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)) = (((*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) + ((((10) < ((*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)))) ? (10) : ((*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)))))) + (*(signed_char_Array_0_arraysigned_char_Array_0Var3_Pointer)));
 }
 if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var3_Pointer))) {
  if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var3_Pointer))) {
