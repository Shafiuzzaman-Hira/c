...
void step(void) {
	...
	// From: Req4Batch27Filler_PS_CI
	if (var_1_6 == (var_1_4 / var_1_13)) {
		var_1_12 = var_1_11;
	}


	// From: Req6Batch27Filler_PS_CI
	var_1_20 = var_1_11;


	// From: Req7Batch27Filler_PS_CI
	var_1_21 = 8;


	// From: Req3Batch27Filler_PS_CI
