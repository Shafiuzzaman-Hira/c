...
void step(void) {
 ...
 if (var_1_32) {
  ...
  if (((((var_1_33) > (var_1_34)) ? (var_1_33) : (var_1_34))) > var_1_35) {
   if (var_1_30 > ((((var_1_29 / var_1_36) < 0 ) ? -(var_1_29 / var_1_36) : (var_1_29 / var_1_36)))) {
 ...
 if (var_1_32 && ((var_1_33 & var_1_31) <= ((((var_1_34) > (var_1_35)) ? (var_1_34) : (var_1_35))))) {
  var_1_37 = var_1_30;
 }
 if (((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))) <= ((-2 >> var_1_31) % var_1_39)) {
  var_1_38 = var_1_30;
 } else {
  var_1_38 = (var_1_40 + ((((var_1_41) > (var_1_42)) ? (var_1_41) : (var_1_42))));
 }
 if (var_1_29 <= var_1_41) {
  var_1_43 = (((((var_1_42) < 0 ) ? -(var_1_42) : (var_1_42))) - var_1_44);
 }
 var_1_45 = var_1_46;
 if (var_1_37 > ((((var_1_44) > (var_1_41)) ? (var_1_44) : (var_1_41)))) {
  if (var_1_32) {
  ...
  if (var_1_48) {
   if (var_1_33 > 8) {
    if (var_1_29 > ((((((((var_1_40) < (var_1_37)) ? (var_1_40) : (var_1_37)))) < (var_1_36)) ? (((((var_1_40) < (var_1_37)) ? (var_1_40) : (var_1_37)))) : (var_1_36)))) {
 ...
 if ((~ var_1_31) <= var_1_34) {
  if (var_1_43 > var_1_54) {
   var_1_53 = ((((var_1_55) < 0 ) ? -(var_1_55) : (var_1_55)));
  }
 } else {
 ...
 if ((var_1_39 | 16) != var_1_35) {
  if ((~ var_1_56) <= (var_1_35 ^ var_1_45)) {
   if (! (((((var_1_55) > (var_1_56)) ? (var_1_55) : (var_1_56))) > var_1_53)) {
    if (var_1_50) {
     var_1_61 = (var_1_58 - ((((var_1_62) < 0 ) ? -(var_1_62) : (var_1_62))));
    } else {
     var_1_61 = ((((((((var_1_58) < (((((32) < (var_1_62)) ? (32) : (var_1_62))))) ? (var_1_58) : (((((32) < (var_1_62)) ? (32) : (var_1_62))))))) > (var_1_63)) ? (((((var_1_58) < (((((32) < (var_1_62)) ? (32) : (var_1_62))))) ? (var_1_58) : (((((32) < (var_1_62)) ? (32) : (var_1_62))))))) : (var_1_63)));
    }
   }
  } else {
   var_1_61 = ((((5) > (var_1_62)) ? (5) : (var_1_62)));
  }
 } else {
  var_1_61 = ((((var_1_63) > (var_1_62)) ? (var_1_63) : (var_1_62)));
 }
 if (var_1_31 >= var_1_62) {
  var_1_64 = (((((var_1_56 + var_1_57)) > (var_1_61)) ? ((var_1_56 + var_1_57)) : (var_1_61)));
 } else {
  var_1_64 = ((((var_1_62) < (var_1_61)) ? (var_1_62) : (var_1_61)));
 }
