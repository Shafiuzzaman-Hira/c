...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch20100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch20100_while
	var_1_10 = (var_1_11 - last_1_var_1_20);


	// From: Req5Batch20100_while
	...
	// From: Req8Batch20100_while
	if (! (var_1_2 && var_1_3)) {
		var_1_22 = ((var_1_21 > var_1_11) && (! 1));
	}


	// From: Req12Batch20100_while
	var_1_32 = var_1_5;


	// From: Req13Batch20100_while
	var_1_33 = var_1_15;


	// From: Req1Batch20100_while
	...
	if (var_1_22) {
		...
		var_1_18 = (max (var_1_8 , (abs (var_1_25))));
	}


	// From: Req2Batch20100_while
	...
	// From: Req9Batch20100_while
	if ((abs (var_1_25)) >= var_1_6) {
