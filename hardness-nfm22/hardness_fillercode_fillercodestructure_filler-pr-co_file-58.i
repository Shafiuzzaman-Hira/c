...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch58Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((~ (var_1_26 & 64)) <= var_1_12) {
  if (var_1_24) {
   var_1_34 = var_1_32;
  }
 }
 if (var_1_22) {
  var_1_35 = (((((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))) < 0 ) ? -((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))) : ((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32)))));
 } else {
  var_1_35 = (((((var_1_29) > (var_1_32)) ? (var_1_29) : (var_1_32))) - var_1_1);
 }
 ...
 if ((var_1_12 / var_1_26) <= var_1_32) {
  var_1_33 = 2;
 } else {
  var_1_33 = (((((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))) < 0 ) ? -((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))) : ((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32)))));
 }
}
