...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch3725_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch3725_while
	var_1_11 = var_1_1;


	// From: Req2Batch3725_while
