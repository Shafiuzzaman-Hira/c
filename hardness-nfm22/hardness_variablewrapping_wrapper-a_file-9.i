...
void step(void) {
 ...
 if (signed_short_int_Array_0[0] <= 16) {
  ...
  if (((((double_Array_0[0]) > (double_Array_0[0])) ? (double_Array_0[0]) : (double_Array_0[0]))) < double_Array_0[0]) {
