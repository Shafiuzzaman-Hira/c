...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch30dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch30dependencies
	if ((last_1_var_1_11 / (abs (-16))) >= last_1_var_1_11) {
		var_1_1 = var_1_4;
	}


	// From: Req2Batch30dependencies
	if (var_1_1) {
		if (var_1_11 >= var_1_11) {
			if (var_1_1 || (var_1_11 < var_1_11)) {
				var_1_5 = var_1_7;
			}
		} else {
			var_1_5 = var_1_7;
