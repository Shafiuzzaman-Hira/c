...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch49Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
 var_1_25 = var_1_26;
 var_1_27 = 64.5f;
 if ((var_1_26 % ((((var_1_29) < (var_1_30)) ? (var_1_29) : (var_1_30)))) < var_1_19) {
  var_1_28 = ((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29)));
 } else {
  var_1_28 = var_1_19;
 }
 if ((var_1_26 <= ((((100) > (var_1_1)) ? (100) : (var_1_1)))) || ((- var_1_30) <= var_1_29)) {
  var_1_31 = var_1_26;
 } else {
  var_1_31 = var_1_30;
 }
