...
void step(void) {
	...
	// From: CodeObject1
	if (var_1_23 < 256.5) {
		if (((max (var_1_17 , var_1_14)) > var_1_17) && (var_1_23 < var_1_9)) {
			var_1_26 = (max (var_1_17 , var_1_17));
		} else {
	...
	// From: CodeObject4
	if (((max (var_1_23 , var_1_10)) / var_1_9) > (min (var_1_8 , var_1_10))) {
	...
	// From: CodeObject6
	if (var_1_20 < (max (var_1_40 , var_1_17))) {
		if (var_1_2 || (128.5 <= var_1_11)) {
			var_1_47 = (var_1_22 - var_1_39);
		}
	} else {
		var_1_47 = (max ((max (var_1_17 , var_1_39)) , var_1_20));
	}
