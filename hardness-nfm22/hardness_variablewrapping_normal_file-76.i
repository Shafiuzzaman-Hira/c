...
void step(void) {
 ...
 if (stepLocal_1 <= var_1_8) {
  if (var_1_1) {
   var_1_6 = (3.17 - ((((127.2) > (var_1_7)) ? (127.2) : (var_1_7))));
  }
 }
 if (var_1_1) {
