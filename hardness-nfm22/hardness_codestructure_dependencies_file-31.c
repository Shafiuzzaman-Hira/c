...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch31dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch31dependencies
	var_1_8 = (min ((var_1_5 + (64 - 16)) , 64));


	// From: Req4Batch31dependencies
	...
	// From: Req6Batch31dependencies
	var_1_17 = var_1_13;


	// From: Req7Batch31dependencies
	if (var_1_12 <= (var_1_17 / 64)) {
		var_1_18 = (! var_1_19);
	} else {
		if (var_1_19) {
			var_1_18 = var_1_20;
	...
	// From: Req5Batch31dependencies
	if (((-128 | var_1_12) >= (abs (var_1_4))) || var_1_18) {
		if (var_1_3 <= 16) {
			var_1_16 = var_1_12;
		} else {
			var_1_16 = var_1_6;
