...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch77PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_20 > var_1_21) {
  var_1_22 = ((((var_1_23 - ((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24)))) < 0 ) ? -(var_1_23 - ((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24)))) : (var_1_23 - ((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24))))));
 }
 var_1_25 = var_1_24;
 var_1_26 = var_1_21;
 if (var_1_28 && var_1_29) {
  var_1_27 = (var_1_26 - var_1_21);
 }
 if ((((((100 / var_1_31)) < (var_1_21)) ? ((100 / var_1_31)) : (var_1_21))) <= var_1_26) {
  var_1_30 = (((((((((((var_1_21) < (var_1_27)) ? (var_1_21) : (var_1_27))) < 0 ) ? -((((var_1_21) < (var_1_27)) ? (var_1_21) : (var_1_27))) : ((((var_1_21) < (var_1_27)) ? (var_1_21) : (var_1_27)))))) < (var_1_26)) ? ((((((((var_1_21) < (var_1_27)) ? (var_1_21) : (var_1_27))) < 0 ) ? -((((var_1_21) < (var_1_27)) ? (var_1_21) : (var_1_27))) : ((((var_1_21) < (var_1_27)) ? (var_1_21) : (var_1_27)))))) : (var_1_26)));
 } else {
