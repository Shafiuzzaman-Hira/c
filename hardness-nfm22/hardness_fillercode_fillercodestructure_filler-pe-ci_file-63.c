...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch63Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req9Batch63Filler_PE_CI
	var_1_31 = var_1_13;


	// From: Req4Batch63Filler_PE_CI
	if (var_1_7) {
	...
	// From: Req7Batch63Filler_PE_CI
	if (var_1_7) {
		var_1_29 = var_1_20;
	}


	// From: Req10Batch63Filler_PE_CI
	var_1_32 = var_1_16;


	// From: Req8Batch63Filler_PE_CI
	var_1_30 = var_1_32;


	// From: Req2Batch63Filler_PE_CI
	...
	// From: Req6Batch63Filler_PE_CI
	if (var_1_11 >= var_1_30) {
		var_1_26 = (var_1_27 + var_1_28);
	}


	// From: Req1Batch63Filler_PE_CI
	...
	// From: CodeObject1
	if ((var_1_15 ^ var_1_1) < (var_1_13 | var_1_13)) {
		var_1_33 = (max (var_1_16 , var_1_16));
	} else {
		var_1_33 = (abs (min (var_1_16 , var_1_16)));
	}


	// From: CodeObject2
	if ((-32 & var_1_16) > var_1_32) {
		var_1_40 = (max (var_1_19 , var_1_21));
	} else {
		var_1_40 = (var_1_18 + var_1_18);
	}


	// From: CodeObject3
	if (var_1_21 >= (abs (var_1_19))) {
	...
	if (var_1_20 < var_1_22) {
		var_1_49 = ((var_1_50 - var_1_51) + var_1_27);
	} else {
		var_1_49 = (max ((min (var_1_50 , var_1_51)) , var_1_27));
	}
