...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch15Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch15Wrapper_AP
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer))) {
		(*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)) = ((1514707036u + (abs ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer))))) - last_1_signed_long_int_Array_0_0_);
	} else {
	...
	// From: Req3Batch15Wrapper_AP
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer))) {
		(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) = ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)) + (abs ((*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)))));
	}


	// From: Req1Batch15Wrapper_AP
	...
	// From: Req4Batch15Wrapper_AP
	if ((*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)) >= (*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer))) {
		(*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)) = ((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) - (max (((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) + (*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer))) , (*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer)))));
	} else {
		(*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)) = (max ((*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)) , (*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer))));
	}
}
