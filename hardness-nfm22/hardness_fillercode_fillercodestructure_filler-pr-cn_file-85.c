...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch85Filler_PR_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch85Filler_PR_CN
	var_1_16 = (var_1_6 && var_1_17);


	// From: Req6Batch85Filler_PR_CN
	if (var_1_5) {
