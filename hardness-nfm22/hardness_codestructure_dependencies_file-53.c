...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch53dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch53dependencies
	if ((last_1_var_1_20 * last_1_var_1_20) == last_1_var_1_14) {
		if ((last_1_var_1_14 > (last_1_var_1_16 - last_1_var_1_16)) && last_1_var_1_1) {
			var_1_1 = var_1_8;
		}
	}


	// From: Req5Batch53dependencies
	if (((max (var_1_15 , last_1_var_1_9)) / var_1_17) <= (256u << last_1_var_1_16)) {
		var_1_16 = (max (var_1_18 , var_1_19));
	}


	// From: Req3Batch53dependencies
	if ((! var_1_1) || var_1_8) {
		var_1_10 = (min ((var_1_11 + var_1_12) , (abs (var_1_13))));
	} else {
		if ((var_1_11 < var_1_12) || (var_1_16 != var_1_16)) {
			var_1_10 = var_1_13;
		} else {
			var_1_10 = var_1_12;
		}
	...
	// From: Req6Batch53dependencies
	var_1_20 = var_1_21;


	// From: Req7Batch53dependencies
	var_1_22 = var_1_12;


	// From: Req8Batch53dependencies
	var_1_23 = var_1_21;


	// From: Req4Batch53dependencies
	if (var_1_1) {
	...
	// From: Req2Batch53dependencies
	if ((var_1_1 || (var_1_16 <= var_1_14)) || (var_1_20 != var_1_14)) {
		if ((min (var_1_16 , 0)) <= (-5 + var_1_16)) {
			var_1_9 = var_1_16;
		}
	}
}
