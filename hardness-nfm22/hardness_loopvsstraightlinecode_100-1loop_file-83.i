...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch83100_1loop.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_6 != -16) || (var_1_7 < var_1_7)) {
  var_1_32 = (((((5) < 0 ) ? -(5) : (5))) - ((((var_1_11) < ((var_1_33 - var_1_10))) ? (var_1_11) : ((var_1_33 - var_1_10)))));
 } else {
  if (var_1_26) {
   var_1_32 = var_1_10;
  } else {
 ...
 if (var_1_24 == var_1_15) {
  if (var_1_26) {
   if (((var_1_20 + var_1_21) - var_1_8) < (((((var_1_7 / var_1_6)) < (-5)) ? ((var_1_7 / var_1_6)) : (-5)))) {
    var_1_19 = (var_1_9 + 8);
   } else {
    var_1_19 = var_1_8;
   }
 ...
 if (((var_1_7 / var_1_8) > -4) || stepLocal_1) {
  var_1_31 = (((((var_1_22 - (var_1_10 + var_1_11))) < (((((var_1_9) < (var_1_23)) ? (var_1_9) : (var_1_23))))) ? ((var_1_22 - (var_1_10 + var_1_11))) : (((((var_1_9) < (var_1_23)) ? (var_1_9) : (var_1_23))))));
 }
 if (var_1_18 <= var_1_15) {
  var_1_17 = ((((((((((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6)))) > (var_1_7)) ? (((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6)))) : (var_1_7)))) > ((var_1_3 + var_1_19))) ? (((((((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6)))) > (var_1_7)) ? (((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6)))) : (var_1_7)))) : ((var_1_3 + var_1_19))));
 }
 if (var_1_26) {
