...
void step(void) {
	// From: CodeObject1
	if (((abs (var_1_16)) - var_1_21) == (var_1_16 * var_1_7)) {
		var_1_19 = -4;
	}
	...
	if (var_1_7 > var_1_17) {
		...
		if (var_1_1) {
			var_1_31 = ((abs (min (var_1_7 , var_1_18))) - 256.35f);
		}
	}
