...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch78Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (((((var_1_16) < (var_1_23)) ? (var_1_16) : (var_1_23))) >= var_1_3) {
 ...
 var_1_35 = ((((var_1_26) > (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))))) ? (var_1_26) : (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))))));
 ...
 if (var_1_29 > var_1_30) {
  if ((var_1_21 ^ var_1_27) != (var_1_15 / 32)) {
