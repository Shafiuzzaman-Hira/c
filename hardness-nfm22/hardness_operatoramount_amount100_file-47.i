...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch47Amount100.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_14 = var_1_13;
 var_1_18 = ((((var_1_19) > ((((((((var_1_20) > (var_1_21)) ? (var_1_20) : (var_1_21))) < 0 ) ? -((((var_1_20) > (var_1_21)) ? (var_1_20) : (var_1_21))) : ((((var_1_20) > (var_1_21)) ? (var_1_20) : (var_1_21))))))) ? (var_1_19) : ((((((((var_1_20) > (var_1_21)) ? (var_1_20) : (var_1_21))) < 0 ) ? -((((var_1_20) > (var_1_21)) ? (var_1_20) : (var_1_21))) : ((((var_1_20) > (var_1_21)) ? (var_1_20) : (var_1_21))))))));
 ...
 if (stepLocal_6 < (((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))) - var_1_22)) {
 ...
 if (var_1_35) {
  var_1_6 = ((((8u) > (var_1_11)) ? (8u) : (var_1_11)));
 } else {
  if (var_1_11 > var_1_14) {
   var_1_6 = ((((var_1_14) > ((3173943110u - var_1_11))) ? (var_1_14) : ((3173943110u - var_1_11))));
  }
 }
 if (var_1_26) {
 ...
 if (var_1_35) {
  var_1_15 = (var_1_3 + (var_1_16 - ((((var_1_17) < (2)) ? (var_1_17) : (2)))));
 } else {
  var_1_15 = ((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17)));
 }
 unsigned short int stepLocal_10 = var_1_11;
 unsigned char stepLocal_9 = var_1_26;
 signed long int stepLocal_8 = ((((var_1_16) > (var_1_17)) ? (var_1_16) : (var_1_17))) - var_1_32;
 if (var_1_6 < stepLocal_10) {
  if (((((var_1_18) < (3.75f)) ? (var_1_18) : (3.75f))) >= var_1_20) {
   var_1_30 = ((((var_1_3) > (((((-16) < ((var_1_31 - var_1_32))) ? (-16) : ((var_1_31 - var_1_32)))))) ? (var_1_3) : (((((-16) < ((var_1_31 - var_1_32))) ? (-16) : ((var_1_31 - var_1_32)))))));
  } else {
   var_1_30 = ((((var_1_33 + var_1_34) < 0 ) ? -(var_1_33 + var_1_34) : (var_1_33 + var_1_34)));
  }
 } else {
  if (stepLocal_8 <= var_1_34) {
   if (stepLocal_9 && ((var_1_11 * var_1_22) <= var_1_6)) {
    var_1_30 = ((((var_1_34) > (var_1_31)) ? (var_1_34) : (var_1_31)));
   } else {
    var_1_30 = var_1_33;
   }
  }
 ...
 if (stepLocal_11 && var_1_28) {
  if (stepLocal_12 != var_1_27) {
   var_1_37 = ((((var_1_3) < (var_1_32)) ? (var_1_3) : (var_1_32)));
  } else {
   var_1_37 = var_1_31;
  }
 } else {
