...
void step(void) {
 (*(var_1_1_Pointer)) = ((((((*(var_1_2_Pointer))) > ((*(var_1_3_Pointer)))) ? ((*(var_1_2_Pointer))) : ((*(var_1_3_Pointer))))) - (*(var_1_4_Pointer)));
 ...
 if (! (*(var_1_13_Pointer))) {
  ...
  if ((*(var_1_13_Pointer))) {
   (*(var_1_12_Pointer)) = ((27636 + (*(var_1_16_Pointer))) - (((((16853 - 10)) > ((*(var_1_14_Pointer)))) ? ((16853 - 10)) : ((*(var_1_14_Pointer))))));
  } else {
