...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch37PS_CN_100.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (((var_1_28 & var_1_32) ^ var_1_23) < (var_1_29 & var_1_33)) {
  if (var_1_29 > var_1_33) {
   var_1_34 = ((((((((55383) < 0 ) ? -(55383) : (55383))) < 0 ) ? -((((55383) < 0 ) ? -(55383) : (55383))) : ((((55383) < 0 ) ? -(55383) : (55383))))) - (10 + var_1_28));
  }
 }
 if (var_1_35 || var_1_37) {
  var_1_36 = (((((var_1_38) > (1.15)) ? (var_1_38) : (1.15))) - ((((var_1_39) < (var_1_40)) ? (var_1_39) : (var_1_40))));
 }
 if (((var_1_40 * var_1_38) * var_1_36) > var_1_39) {
  var_1_41 = ((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40)));
 }
 if (((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30))) >= var_1_33) {
  var_1_42 = ((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31)));
 } else {
  var_1_42 = ((((((((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31))) < 0 ) ? -((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31))) : ((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31))))) < 0 ) ? -(((((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31))) < 0 ) ? -((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31))) : ((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31))))) : (((((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31))) < 0 ) ? -((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31))) : ((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31)))))));
 }
 var_1_43 = (((((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39))) < 0 ) ? -((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39))) : ((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39)))));
 if ((((((var_1_24 / var_1_45)) < (var_1_42)) ? ((var_1_24 / var_1_45)) : (var_1_42))) < (var_1_32 ^ var_1_28)) {
  if (var_1_25 < var_1_34) {
   var_1_44 = ((((var_1_26) > (var_1_31)) ? (var_1_26) : (var_1_31)));
  } else {
   var_1_44 = ((((64) > (var_1_30)) ? (64) : (var_1_30)));
  }
 } else {
  var_1_44 = ((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31)));
 }
 if (var_1_35) {
  if ((((((var_1_27 | var_1_33)) > (var_1_26)) ? ((var_1_27 | var_1_33)) : (var_1_26))) < (var_1_31 / var_1_45)) {
   if (var_1_37) {
    var_1_46 = var_1_38;
   } else {
    var_1_46 = var_1_40;
 ...
 if (var_1_27 <= var_1_29) {
  if (var_1_41 == (var_1_43 / var_1_48)) {
   var_1_47 = (var_1_31 - (var_1_49 - var_1_50));
  }
 }
 if ((var_1_28 >> var_1_33) < var_1_31) {
  var_1_51 = ((((2) < 0 ) ? -(2) : (2)));
 }
