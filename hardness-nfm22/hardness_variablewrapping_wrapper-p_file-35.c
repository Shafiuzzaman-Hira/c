...
void step(void) {
	...
	// From: Req3Batch35Wrapper_P
	if ((*(var_1_15_Pointer))) {
		(*(var_1_11_Pointer)) = (((*(var_1_12_Pointer)) + (min (10 , (*(var_1_13_Pointer))))) + (*(var_1_14_Pointer)));
	}


	// From: Req2Batch35Wrapper_P
	if ((*(var_1_15_Pointer))) {
		if ((*(var_1_15_Pointer))) {
...
int property() {
	return (((((last_1_var_1_18 >= (~ last_1_var_1_18)) ? ((*(var_1_1_Pointer)) == ((float) ((*(var_1_4_Pointer)) + (*(var_1_5_Pointer))))) : 1) && ((*(var_1_15_Pointer)) ? ((*(var_1_15_Pointer)) ? ((*(var_1_6_Pointer)) == ((signed short int) ((*(var_1_11_Pointer)) + (*(var_1_11_Pointer))))) : ((*(var_1_6_Pointer)) == ((signed short int) ((*(var_1_11_Pointer)) + (*(var_1_11_Pointer)))))) : ((*(var_1_6_Pointer)) == ((signed short int) (*(var_1_11_Pointer)))))) && ((*(var_1_15_Pointer)) ? ((*(var_1_11_Pointer)) == ((signed char) (((*(var_1_12_Pointer)) + (min (10 , (*(var_1_13_Pointer))))) + (*(var_1_14_Pointer))))) : 1)) && ((*(var_1_8_Pointer)) ? ((*(var_1_15_Pointer)) == ((unsigned char) (! (*(var_1_16_Pointer))))) : ((*(var_1_15_Pointer)) == ((unsigned char) (! (*(var_1_17_Pointer))))))) && (((*(var_1_17_Pointer)) && (((*(var_1_1_Pointer)) * (*(var_1_5_Pointer))) >= (*(var_1_4_Pointer)))) ? ((*(var_1_18_Pointer)) == ((unsigned char) (2 + (((*(var_1_19_Pointer)) - (*(var_1_20_Pointer))) + 32)))) : ((*(var_1_18_Pointer)) == ((unsigned char) (*(var_1_19_Pointer)))))
;
}
int main(void) {
	isInitial = 1;
