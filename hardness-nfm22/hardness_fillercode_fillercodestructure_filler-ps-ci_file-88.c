...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch88Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
	// From: CodeObject1
	if (var_1_8 && var_1_10) {
		if ((256 % var_1_24) >= (min (var_1_19 , var_1_16))) {
			var_1_25 = var_1_14;
		} else {
			var_1_25 = var_1_14;
		}
	...
	// From: CodeObject4
	if (((min (var_1_4 , var_1_6)) / 8.6f) <= (abs (var_1_5))) {
		if (var_1_11 || (var_1_24 <= var_1_20)) {
			var_1_36 = ((var_1_9 && var_1_10) || var_1_11);
		}
	}
	...
	if (var_1_24 != var_1_14) {
		...
		var_1_43 = (var_1_19 + (abs (var_1_20)));
	}
	...
	if (var_1_7 < 2.4f) {
		if (var_1_24 >= (var_1_16 >> 31)) {
			var_1_44 = (min ((abs (var_1_19)) , (abs (var_1_19))));
		}
	} else {
		var_1_44 = var_1_19;
	}
	...
	if (var_1_22 >= var_1_19) {
		var_1_48 = (var_1_49 - var_1_16);
	} else {
		if ((var_1_11 && var_1_10) || ((var_1_50 - var_1_51) < var_1_6)) {
			var_1_48 = var_1_49;
		}
	}
