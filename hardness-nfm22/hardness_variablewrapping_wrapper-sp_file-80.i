...
void step(void) {
 ...
 if (((((((*(WrapperStruct00_var_1_23_Pointer)) - (*(WrapperStruct00_var_1_23_Pointer)))) > ((*(WrapperStruct00_var_1_12_Pointer)))) ? (((*(WrapperStruct00_var_1_23_Pointer)) - (*(WrapperStruct00_var_1_23_Pointer)))) : ((*(WrapperStruct00_var_1_12_Pointer))))) <= ((((((*(WrapperStruct00_var_1_23_Pointer)) - (*(WrapperStruct00_var_1_23_Pointer)))) < (((*(WrapperStruct00_var_1_24_Pointer)) % (*(WrapperStruct00_var_1_8_Pointer))))) ? (((*(WrapperStruct00_var_1_23_Pointer)) - (*(WrapperStruct00_var_1_23_Pointer)))) : (((*(WrapperStruct00_var_1_24_Pointer)) % (*(WrapperStruct00_var_1_8_Pointer))))))) {
  (*(WrapperStruct00_var_1_1_Pointer)) = ((((((*(WrapperStruct00_var_1_9_Pointer)) - (*(WrapperStruct00_var_1_10_Pointer)))) < ((*(WrapperStruct00_var_1_12_Pointer)))) ? (((*(WrapperStruct00_var_1_9_Pointer)) - (*(WrapperStruct00_var_1_10_Pointer)))) : ((*(WrapperStruct00_var_1_12_Pointer)))));
 }
}
