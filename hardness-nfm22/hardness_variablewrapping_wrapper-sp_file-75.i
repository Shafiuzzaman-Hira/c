...
void step(void) {
 ...
 if (stepLocal_0 < (((((*(WrapperStruct00_var_1_20_Pointer))) > ((*(WrapperStruct00_var_1_8_Pointer)))) ? ((*(WrapperStruct00_var_1_20_Pointer))) : ((*(WrapperStruct00_var_1_8_Pointer)))))) {
 ...
 if (((*(WrapperStruct00_var_1_1_Pointer)) == ((*(WrapperStruct00_var_1_13_Pointer)) - (*(WrapperStruct00_var_1_14_Pointer)))) && (*(WrapperStruct00_var_1_15_Pointer))) {
  if ((*(WrapperStruct00_var_1_15_Pointer))) {
   (*(WrapperStruct00_var_1_12_Pointer)) = ((((((*(WrapperStruct00_var_1_16_Pointer)) - (*(WrapperStruct00_var_1_14_Pointer)))) > ((*(WrapperStruct00_var_1_7_Pointer)))) ? (((*(WrapperStruct00_var_1_16_Pointer)) - (*(WrapperStruct00_var_1_14_Pointer)))) : ((*(WrapperStruct00_var_1_7_Pointer)))));
  }
 } else {
