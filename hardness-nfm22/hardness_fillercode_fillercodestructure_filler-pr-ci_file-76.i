...
void step(void) {
 ...
 if (var_1_16 < var_1_11) {
  ...
  if ((- var_1_5) > var_1_1) {
   if (var_1_1 >= var_1_5) {
    var_1_34 = (((((((var_1_17 - var_1_20) < 0 ) ? -(var_1_17 - var_1_20) : (var_1_17 - var_1_20))) < 0 ) ? -((((var_1_17 - var_1_20) < 0 ) ? -(var_1_17 - var_1_20) : (var_1_17 - var_1_20))) : ((((var_1_17 - var_1_20) < 0 ) ? -(var_1_17 - var_1_20) : (var_1_17 - var_1_20)))));
   } else {
    var_1_34 = var_1_17;
   }
  }
 }
 if (((((var_1_17) > (var_1_18)) ? (var_1_17) : (var_1_18))) <= ((var_1_18 & var_1_17) & var_1_18)) {
