...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch60Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject2
	if (var_1_1 != var_1_9) {
		var_1_31 = (((max (var_1_20 , var_1_9)) + var_1_9) - var_1_9);
	}
	...
	// From: CodeObject5
	if (var_1_30) {
		if (var_1_37 > (min (var_1_11 , var_1_36))) {
			var_1_40 = ((max ((var_1_37 + var_1_36) , var_1_41)) - (6.6634825448069233E18f - (max (50.9f , var_1_42))));
		} else {
			var_1_40 = (min (var_1_37 , var_1_36));
		}
	} else {
		if ((var_1_20 * var_1_9) > (~ var_1_1)) {
			if (var_1_37 == 0.25f) {
				var_1_40 = var_1_42;
			}
		}
