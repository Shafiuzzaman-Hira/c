...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch73Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch73Wrapper_P
	if ((*(var_1_6_Pointer))) {
		(*(var_1_8_Pointer)) = (max ((*(var_1_9_Pointer)) , (*(var_1_10_Pointer))));
	} else {
		if (last_1_var_1_12 < (last_1_var_1_12 + (*(var_1_7_Pointer)))) {
			(*(var_1_8_Pointer)) = (min ((*(var_1_9_Pointer)) , (*(var_1_10_Pointer))));
		}
	}


	// From: Req5Batch73Wrapper_P
	(*(var_1_19_Pointer)) = (*(var_1_8_Pointer));


	// From: Req3Batch73Wrapper_P
	if ((*(var_1_19_Pointer)) > (*(var_1_9_Pointer))) {
		if ((*(var_1_6_Pointer))) {
			(*(var_1_12_Pointer)) = ((*(var_1_13_Pointer)) - (abs (99999.25f)));
		} else {
			if ((*(var_1_14_Pointer)) && (*(var_1_15_Pointer))) {
				(*(var_1_12_Pointer)) = ((*(var_1_13_Pointer)) - (*(var_1_16_Pointer)));
			} else {
	...
	// From: Req1Batch73Wrapper_P
	signed long int stepLocal_0 = max ((*(var_1_8_Pointer)) , ((*(var_1_8_Pointer)) + (*(var_1_19_Pointer))));
