...
void step(void) {
	// From: Req4Batch40Wrapper_S
	if (WrapperStruct00.var_1_3) {
		WrapperStruct00.var_1_16 = (max (WrapperStruct00.var_1_17 , (-2 + WrapperStruct00.var_1_18)));
	}


	// From: Req5Batch40Wrapper_S
	WrapperStruct00.var_1_19 = WrapperStruct00.var_1_15;


	// From: Req6Batch40Wrapper_S
	WrapperStruct00.var_1_20 = WrapperStruct00.var_1_16;


	// From: Req7Batch40Wrapper_S
	WrapperStruct00.var_1_21 = WrapperStruct00.var_1_18;


	// From: Req1Batch40Wrapper_S
	...
	// From: Req3Batch40Wrapper_S
	if (WrapperStruct00.var_1_19 != (min (last_1_WrapperStruct00_var_1_13 , WrapperStruct00.var_1_19))) {
...
int property() {
	return ((((((WrapperStruct00.var_1_2 ? ((WrapperStruct00.var_1_3 && (WrapperStruct00.var_1_19 <= (- 63.9f))) ? ((WrapperStruct00.var_1_19 >= WrapperStruct00.var_1_19) ? (WrapperStruct00.var_1_3 ? (WrapperStruct00.var_1_1 == ((signed long int) WrapperStruct00.var_1_21)) : 1) : 1) : 1) : 1) && ((((WrapperStruct00.var_1_16 / WrapperStruct00.var_1_8) / WrapperStruct00.var_1_9) >= (WrapperStruct00.var_1_21 | WrapperStruct00.var_1_16)) ? (WrapperStruct00.var_1_7 == ((unsigned char) (WrapperStruct00.var_1_11 - WrapperStruct00.var_1_12))) : (WrapperStruct00.var_1_7 == ((unsigned char) WrapperStruct00.var_1_12)))) && ((WrapperStruct00.var_1_19 != (min (last_1_WrapperStruct00_var_1_13 , WrapperStruct00.var_1_19))) ? (WrapperStruct00.var_1_13 == ((double) (WrapperStruct00.var_1_15 + (127.4 - 8.25)))) : 1)) && (WrapperStruct00.var_1_3 ? (WrapperStruct00.var_1_16 == ((signed char) (max (WrapperStruct00.var_1_17 , (-2 + WrapperStruct00.var_1_18))))) : 1)) && (WrapperStruct00.var_1_19 == ((float) WrapperStruct00.var_1_15))) && (WrapperStruct00.var_1_20 == ((signed short int) WrapperStruct00.var_1_16))) && (WrapperStruct00.var_1_21 == ((signed short int) WrapperStruct00.var_1_18))
;
}
int main(void) {
	isInitial = 1;
