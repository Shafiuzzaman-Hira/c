...
void step(void) {
	...
	if (last_1_var_1_15) {
		...
		if (var_1_31 == (max (var_1_22 , (last_1_var_1_60 + last_1_var_1_21)))) {
	...
	var_1_20 = (var_1_13 - ((var_1_11 + 50) + (max (last_1_var_1_20 , var_1_19))));
	...
	if (var_1_15) {
		var_1_46 = (32 + (max (var_1_8 , (var_1_47 - var_1_48))));
	}
	...
	if (var_1_15) {
		...
		var_1_58 = (min (var_1_31 , var_1_29));
	}
	...
	if (stepLocal_8 || var_1_15) {
		if (stepLocal_6 >= var_1_23) {
			if (-100 < stepLocal_7) {
				var_1_52 = (max ((max ((var_1_30 - var_1_45) , (var_1_29 - var_1_28))) , (var_1_44 + (var_1_55 + var_1_56))));
			} else {
	...
	signed long int stepLocal_3 = (var_1_35 + var_1_36) - (min (64 , var_1_62));
	if (stepLocal_3 <= ((var_1_10 + var_1_11) - (var_1_37 - var_1_26))) {
		...
		var_1_34 = (max (var_1_11 , var_1_62));
	}
	...
	if (var_1_60 <= (var_1_58 * var_1_30)) {
		...
		if (var_1_15) {
			var_1_40 = ((max (var_1_26 , (256 + var_1_62))) - var_1_11);
		} else {
	...
	if ((var_1_29 / (abs (var_1_39))) < ((var_1_27 + var_1_32) + var_1_22)) {
		if (var_1_15) {
			var_1_41 = -8;
		}
	} else {
	...
	if ((last_1_var_1_49 * var_1_62) <= var_1_41) {
		if (var_1_43 <= var_1_60) {
			var_1_49 = ((min (var_1_10 , var_1_36)) + var_1_8);
		} else {
			if ((last_1_var_1_49 * var_1_11) < var_1_19) {
				var_1_49 = ((max ((var_1_35 + var_1_47) , var_1_8)) + var_1_19);
			} else {
				var_1_49 = var_1_36;
			}
		}
		...
		if (var_1_28 <= var_1_58) {
			var_1_49 = (max (var_1_48 , var_1_8));
		} else {
			var_1_49 = (min (var_1_37 , (min (var_1_62 , (var_1_35 + var_1_62)))));
		}
	}
	...
	if ((max (var_1_28 , (var_1_32 + 63.125))) <= (var_1_22 / var_1_39)) {
		if ((var_1_29 / (min (var_1_39 , var_1_28))) >= (var_1_32 * var_1_33)) {
			var_1_38 = var_1_10;
		}
	} else {
		var_1_38 = var_1_36;
	...
	if ((4.5 / 9999.5) > (max (var_1_33 , var_1_27))) {
		var_1_21 = 4.6f;
	} else {
		if (var_1_15) {
			var_1_21 = var_1_22;
...
int property() {
	return (((((((((((((((((((((((var_1_21 > var_1_52) ? ((var_1_52 < var_1_21) ? ((((var_1_15 || var_1_15) && var_1_15) && var_1_15) ? (var_1_1 == ((signed char) (8 - (64 - var_1_8)))) : ((var_1_60 <= (var_1_52 / 15.8)) ? (var_1_1 == ((signed char) -4)) : (var_1_1 == ((signed char) (max (((var_1_10 - var_1_8) - var_1_11) , (min ((var_1_12 - var_1_13) , var_1_14)))))))) : 1) : 1) && ((last_1_var_1_52 > last_1_var_1_52) ? (var_1_15 == ((unsigned char) ((last_1_var_1_52 == 31.65) || var_1_16))) : 1)) && (((abs (var_1_11)) == (var_1_13 + var_1_10)) ? (((var_1_23 * 256) >= var_1_11) ? (var_1_17 == ((signed char) (max ((var_1_12 - var_1_10) , (min (var_1_14 , (min (var_1_8 , -5)))))))) : (var_1_17 == ((signed char) var_1_13))) : 1)) && (var_1_16 ? (var_1_18 == ((unsigned char) (abs (var_1_8)))) : (var_1_18 == ((unsigned char) (var_1_19 - 64))))) && (var_1_20 == ((signed short int) (var_1_13 - ((var_1_11 + 50) + (max (last_1_var_1_20 , var_1_19))))))) && (((4.5 / 9999.5) > (max (var_1_33 , var_1_27))) ? (var_1_21 == ((float) 4.6f)) : (var_1_15 ? (var_1_21 == ((float) var_1_22)) : (var_1_21 == ((float) (min (var_1_22 , 64.8f))))))) && ((! var_1_15) ? (var_1_23 == ((signed short int) (min (var_1_8 , var_1_20)))) : ((var_1_15 || (var_1_10 > var_1_13)) ? (var_1_23 == ((signed short int) ((var_1_19 + 2) - var_1_10))) : (var_1_23 == ((signed short int) var_1_19))))) && (var_1_24 == ((signed long int) -100))) && (var_1_16 ? (var_1_25 == ((unsigned char) (max (var_1_11 , (var_1_19 - (64 - var_1_8)))))) : (var_1_25 == ((unsigned char) (var_1_19 - (max (var_1_10 , var_1_26))))))) && (last_1_var_1_15 ? (var_1_27 == ((double) ((var_1_28 - var_1_29) - ((4.1406872328101468E18 - var_1_30) + var_1_31)))) : ((var_1_31 == (max (var_1_22 , (last_1_var_1_60 + last_1_var_1_21)))) ? (var_1_27 == ((double) (min ((var_1_30 + var_1_29) , (min ((var_1_31 + var_1_32) , var_1_28)))))) : (var_1_27 == ((double) (max ((min ((var_1_28 - var_1_30) , (var_1_31 - var_1_29))) , 2.75))))))) && (((var_1_15 || (var_1_23 > var_1_8)) && (var_1_27 > var_1_30)) ? (var_1_33 == ((double) (var_1_31 - var_1_29))) : (var_1_33 == ((double) (var_1_31 + var_1_30))))) && ((((var_1_35 + var_1_36) - (min (64 , var_1_62))) <= ((var_1_10 + var_1_11) - (var_1_37 - var_1_26))) ? (((var_1_11 / var_1_36) < (var_1_14 >> var_1_37)) ? (var_1_34 == ((unsigned short int) (min (var_1_11 , var_1_36)))) : (var_1_34 == ((unsigned short int) (max (var_1_8 , 32))))) : (var_1_34 == ((unsigned short int) (max (var_1_11 , var_1_62)))))) && (((max (var_1_28 , (var_1_32 + 63.125))) <= (var_1_22 / var_1_39)) ? (((var_1_29 / (min (var_1_39 , var_1_28))) >= (var_1_32 * var_1_33)) ? (var_1_38 == ((signed long int) var_1_10)) : 1) : (var_1_38 == ((signed long int) var_1_36)))) && ((var_1_60 <= (var_1_58 * var_1_30)) ? (var_1_40 == ((signed short int) (var_1_62 - var_1_11))) : (var_1_15 ? (var_1_40 == ((signed short int) ((max (var_1_26 , (256 + var_1_62))) - var_1_11))) : (var_1_40 == ((signed short int) (128 - var_1_11)))))) && (((var_1_29 / (abs (var_1_39))) < ((var_1_27 + var_1_32) + var_1_22)) ? (var_1_15 ? (var_1_41 == ((signed char) -8)) : 1) : (((- var_1_17) >= ((var_1_24 + var_1_20) * (var_1_13 + -100))) ? ((! ((var_1_19 - var_1_13) > var_1_36)) ? (var_1_41 == ((signed char) (var_1_8 + var_1_42))) : (var_1_41 == ((signed char) (var_1_8 - (32 + 8))))) : (var_1_41 == ((signed char) (var_1_42 + var_1_8)))))) && (var_1_15 ? (var_1_43 == ((double) ((var_1_31 + var_1_30) - ((var_1_44 + var_1_45) - var_1_29)))) : ((var_1_19 <= var_1_8) ? (var_1_15 ? (var_1_43 == ((double) (max ((abs (var_1_28)) , var_1_29)))) : (var_1_43 == ((double) ((abs (var_1_28 - var_1_30)) - (var_1_45 + var_1_29))))) : (var_1_43 == ((double) (max ((0.625 + (var_1_30 - var_1_44)) , var_1_29))))))) && (var_1_15 ? (var_1_46 == ((signed char) (32 + (max (var_1_8 , (var_1_47 - var_1_48)))))) : 1)) && (((last_1_var_1_49 * var_1_62) <= var_1_41) ? ((var_1_43 <= var_1_60) ? (var_1_49 == ((unsigned long int) ((min (var_1_10 , var_1_36)) + var_1_8))) : (((last_1_var_1_49 * var_1_11) < var_1_19) ? (var_1_49 == ((unsigned long int) ((max ((var_1_35 + var_1_47) , var_1_8)) + var_1_19))) : (var_1_49 == ((unsigned long int) var_1_36)))) : ((var_1_28 <= var_1_58) ? (var_1_49 == ((unsigned long int) (max (var_1_48 , var_1_8)))) : (var_1_49 == ((unsigned long int) (min (var_1_37 , (min (var_1_62 , (var_1_35 + var_1_62)))))))))) && ((var_1_15 || var_1_15) ? ((var_1_47 >= var_1_23) ? ((-100 < var_1_20) ? (var_1_52 == ((float) (max ((max ((var_1_30 - var_1_45) , (var_1_29 - var_1_28))) , (var_1_44 + (var_1_55 + var_1_56)))))) : (var_1_52 == ((float) (var_1_31 - 4.8f)))) : 1) : 1)) && (var_1_57 == ((signed long int) var_1_8))) && (var_1_15 ? (var_1_58 == ((float) (var_1_59 - 128.4f))) : (var_1_58 == ((float) (min (var_1_31 , var_1_29)))))) && (var_1_60 == ((float) (var_1_30 - ((var_1_44 - var_1_61) + 0.8f))))) && (var_1_62 == ((unsigned short int) var_1_13))
;
}
int main(void) {
	isInitial = 1;
