...
void step(void) {
	...
	// From: CodeObject5
	if (var_1_37) {
		var_1_43 = (max ((max (var_1_30 , var_1_44)) , (abs (10.9))));
	}
	...
	// From: Req1Batch14PS_CN_25
	var_1_1 = (var_1_15 + var_1_15);


	// From: Req8Batch14PS_CN_25
	var_1_28 = var_1_17;


	// From: Req7Batch14PS_CN_25
