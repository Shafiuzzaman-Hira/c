...
void step(void) {
	...
	// From: CodeObject4
	if ((min (var_1_13 , var_1_14)) >= var_1_12) {
		var_1_37 = var_1_14;
	}


	// From: Req7Batch97Filler_PR_CI
	var_1_20 = var_1_8;


	// From: Req8Batch97Filler_PR_CI
	var_1_22 = var_1_23;
	...
	if ((var_1_20 / var_1_12) < var_1_13) {
		...
		var_1_29 = (max ((max ((min (var_1_12 , var_1_12)) , var_1_14)) , (var_1_33 - var_1_8)));
	}


	// From: CodeObject5
	if ((var_1_9 * (var_1_40 - var_1_41)) >= var_1_9) {
		if ((~ var_1_13) <= (abs (min (var_1_12 , var_1_13)))) {
			var_1_38 = var_1_13;
		} else {
			var_1_38 = var_1_13;
		}
	...
	if (var_1_22) {
		if (var_1_11 <= var_1_12) {
			var_1_24 = ((max (var_1_11 , (min (-128 , var_1_12)))) + var_1_13);
		}
	} else {
		var_1_24 = (abs (var_1_12));
	}
	...
	// From: Req5Batch97Filler_PR_CI
	var_1_16 = ((min (var_1_15 , (max (var_1_13 , var_1_12)))) - var_1_11);


	// From: Req6Batch97Filler_PR_CI
	if (var_1_22) {
	...
	if ((max (var_1_10 , 64.75f)) <= var_1_40) {
		if ((var_1_8 & var_1_13) > var_1_11) {
			if (var_1_15 <= ((min (var_1_12 , var_1_15)) ^ (128 - 16))) {
