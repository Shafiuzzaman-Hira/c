...
void step(void) {
	...
	// From: Req3Batch91Wrapper_S
	if (! (WrapperStruct00.var_1_4 < WrapperStruct00.var_1_3)) {
		WrapperStruct00.var_1_9 = (min ((min (WrapperStruct00.var_1_3 , WrapperStruct00.var_1_4)) , (max (WrapperStruct00.var_1_10 , WrapperStruct00.var_1_11))));
	} else {
		WrapperStruct00.var_1_9 = (max (WrapperStruct00.var_1_11 , WrapperStruct00.var_1_10));
	}


	// From: Req4Batch91Wrapper_S
