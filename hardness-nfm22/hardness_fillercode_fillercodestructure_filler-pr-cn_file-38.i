...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch38Filler_PR_CN.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (-2 > (((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36))) | (-10 * var_1_38))) {
  var_1_37 = ((((((((25) < (var_1_36)) ? (25) : (var_1_36)))) > (((((var_1_32 + var_1_27) < 0 ) ? -(var_1_32 + var_1_27) : (var_1_32 + var_1_27))))) ? (((((25) < (var_1_36)) ? (25) : (var_1_36)))) : (((((var_1_32 + var_1_27) < 0 ) ? -(var_1_32 + var_1_27) : (var_1_32 + var_1_27))))));
 } else {
  if (((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))) <= ((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36)))) {
   if ((var_1_27 * ((((var_1_33) > (var_1_38)) ? (var_1_33) : (var_1_38)))) <= var_1_36) {
