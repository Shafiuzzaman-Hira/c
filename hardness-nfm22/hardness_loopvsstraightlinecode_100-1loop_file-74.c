...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch74100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch74100_1loop
	if (! var_1_28) {
		var_1_9 = (min (var_1_10 , var_1_11));
	}


	// From: Req5Batch74100_1loop
	if (var_1_22) {
	...
	// From: Req6Batch74100_1loop
	var_1_19 = (var_1_20 - var_1_21);


	// From: Req11Batch74100_1loop
	...
	// From: Req8Batch74100_1loop
	var_1_26 = ((var_1_27 - var_1_34) + var_1_10);


	// From: Req2Batch74100_1loop
