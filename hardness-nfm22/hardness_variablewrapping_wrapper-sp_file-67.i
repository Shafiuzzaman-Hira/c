...
void step(void) {
 ...
 if (((*(WrapperStruct00_var_1_1_Pointer)) >> (*(WrapperStruct00_var_1_5_Pointer))) > stepLocal_0) {
  (*(WrapperStruct00_var_1_6_Pointer)) = (((((42286 - (*(WrapperStruct00_var_1_7_Pointer)))) > (0)) ? ((42286 - (*(WrapperStruct00_var_1_7_Pointer)))) : (0)));
 } else {
 ...
 if ((*(WrapperStruct00_var_1_9_Pointer))) {
  (*(WrapperStruct00_var_1_8_Pointer)) = (((((*(WrapperStruct00_var_1_6_Pointer))) < (last_1_WrapperStruct00_var_1_8)) ? ((*(WrapperStruct00_var_1_6_Pointer))) : (last_1_WrapperStruct00_var_1_8)));
 } else {
  if ((*(WrapperStruct00_var_1_14_Pointer)) > stepLocal_2) {
   if (stepLocal_1 > (*(WrapperStruct00_var_1_6_Pointer))) {
    (*(WrapperStruct00_var_1_8_Pointer)) = (((((*(WrapperStruct00_var_1_4_Pointer))) < (100)) ? ((*(WrapperStruct00_var_1_4_Pointer))) : (100)));
   } else {
