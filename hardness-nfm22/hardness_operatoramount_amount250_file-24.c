...
void step(void) {
	...
	// From: Req15Batch24Amount250
	if (last_1_var_1_48 < 4) {
		if ((max (last_1_var_1_36 , last_1_var_1_54)) != var_1_10) {
			var_1_46 = ((max (last_1_var_1_8 , var_1_23)) + var_1_20);
		} else {
			if (last_1_var_1_8 < var_1_10) {
				var_1_46 = (max ((max (var_1_20 , last_1_var_1_24)) , var_1_21));
			} else {
				var_1_46 = (max (var_1_39 , (52246 - last_1_var_1_8)));
			}
		}
	}


	// From: Req12Batch24Amount250
	...
	// From: Req16Batch24Amount250
	if (var_1_38) {
		if (var_1_38) {
			if (var_1_38) {
				var_1_48 = (abs (var_1_22));
			} else {
		...
		if (last_1_var_1_48 > var_1_21) {
			var_1_48 = (((abs (-10)) + var_1_53) - var_1_50);
		} else {
	...
	// From: Req11Batch24Amount250
	if (var_1_38 || var_1_38) {
		if (var_1_38) {
			var_1_37 = (abs (var_1_54));
		}
	}


	// From: Req8Batch24Amount250
	if (var_1_27 <= var_1_5) {
		if ((abs (-0.5)) >= var_1_30) {
			var_1_31 = (abs (var_1_30));
		} else {
			if ((var_1_30 - (var_1_29 + var_1_32)) == var_1_28) {
				var_1_31 = (min ((max (var_1_32 , var_1_29)) , var_1_33));
			} else {
				if (var_1_38) {
					var_1_31 = (var_1_6 - var_1_32);
				} else {
					var_1_31 = (max (var_1_32 , (min (var_1_27 , (abs (var_1_28))))));
				}
			}
		}
	}
	...
	// From: Req6Batch24Amount250
	if (var_1_6 < ((256.625f * var_1_7) * var_1_5)) {
		if (var_1_38 || var_1_38) {
			var_1_24 = ((-256 + var_1_22) + (var_1_20 - (max (var_1_23 , var_1_54))));
		} else {
			if (! var_1_38) {
	...
	if (var_1_5 >= var_1_6) {
		...
		if (var_1_46 > stepLocal_2) {
			...
			var_1_8 = (var_1_46 + (abs (var_1_46)));
		}
	}


	// From: Req5Batch24Amount250
	...
	if (stepLocal_11 > var_1_46) {
		...
		if (var_1_38) {
			var_1_18 = (min (var_1_21 , (max ((10 + var_1_23) , 5))));
		} else {
			if (stepLocal_10 == (min (var_1_20 , -10))) {
	...
	// From: Req4Batch24Amount250
	unsigned short int stepLocal_6 = var_1_46;
	unsigned long int stepLocal_5 = ~ var_1_8;
	if (var_1_48 <= stepLocal_6) {
		var_1_16 = (min ((3682661553u - var_1_48) , var_1_46));
	} else {
		if (stepLocal_5 > (min (var_1_18 , (var_1_46 - var_1_46)))) {
			var_1_16 = var_1_48;
		} else {
			var_1_16 = (min (var_1_18 , var_1_46));
		}
	}


	// From: Req10Batch24Amount250
	signed long int stepLocal_16 = min (var_1_24 , (~ var_1_35));
	if (stepLocal_16 <= (var_1_21 / 128u)) {
		var_1_36 = (max (var_1_35 , (min ((min (var_1_23 , var_1_21)) , var_1_18))));
	}


	// From: Req1Batch24Amount250
	...
	// From: Req3Batch24Amount250
	unsigned long int stepLocal_4 = 10u / var_1_12;
	unsigned long int stepLocal_3 = min (var_1_36 , var_1_16);
	if (var_1_16 >= stepLocal_4) {
		...
		var_1_13 = (max ((var_1_6 - var_1_5) , var_1_7));
	}


	// From: Req7Batch24Amount250
	...
	if (var_1_12 <= stepLocal_14) {
		if (var_1_38) {
			if (stepLocal_13 < var_1_18) {
				...
				var_1_26 = (min (var_1_15 , ((max (var_1_7 , var_1_27)) + var_1_28)));
			}
		} else {
			var_1_26 = (min (var_1_6 , var_1_27));
		}
	} else {
	...
	// From: Req9Batch24Amount250
	signed char stepLocal_15 = var_1_21;
	if (stepLocal_15 > (max ((var_1_16 + var_1_48) , var_1_22))) {
		var_1_34 = var_1_6;
	}


	// From: Req13Batch24Amount250
	if (var_1_33 < var_1_6) {
		if (var_1_40) {
			var_1_41 = ((max (var_1_21 , var_1_23)) - (var_1_36 + (min (var_1_20 , var_1_54))));
		} else {
			if (var_1_29 <= var_1_34) {
				...
				if (var_1_30 <= var_1_34) {
					...
					var_1_41 = (max (((max (1 , var_1_23)) - var_1_20) , ((abs (var_1_21)) - var_1_36)));
				}
			}
		}
	}
...
int property() {
	return (((((((((((((((((var_1_16 <= var_1_16) ? (var_1_1 == ((float) (var_1_5 - var_1_6))) : (var_1_1 == ((float) (10.5f + var_1_7)))) && ((var_1_5 >= var_1_6) ? ((var_1_46 < var_1_54) ? (var_1_8 == ((unsigned long int) (max ((var_1_54 + (max (var_1_46 , var_1_46))) , (var_1_46 + var_1_46))))) : (var_1_8 == ((unsigned long int) (var_1_46 + var_1_46)))) : ((var_1_46 > (var_1_54 / var_1_12)) ? (var_1_8 == ((unsigned long int) var_1_46)) : (var_1_8 == ((unsigned long int) (var_1_46 + (abs (var_1_46)))))))) && ((var_1_16 >= (10u / var_1_12)) ? ((var_1_46 < (min (var_1_36 , var_1_16))) ? (var_1_13 == ((float) var_1_7)) : (var_1_13 == ((float) (var_1_7 + var_1_15)))) : (var_1_13 == ((float) (max ((var_1_6 - var_1_5) , var_1_7)))))) && ((var_1_48 <= var_1_46) ? (var_1_16 == ((unsigned long int) (min ((3682661553u - var_1_48) , var_1_46)))) : (((~ var_1_8) > (min (var_1_18 , (var_1_46 - var_1_46)))) ? (var_1_16 == ((unsigned long int) var_1_48)) : (var_1_16 == ((unsigned long int) (min (var_1_18 , var_1_46))))))) && ((var_1_12 > var_1_46) ? (((var_1_24 / var_1_12) >= (16u | var_1_46)) ? ((var_1_38 && var_1_38) ? (var_1_18 == ((signed char) ((var_1_20 - var_1_21) + (var_1_22 + (16 - var_1_23))))) : 1) : (var_1_18 == ((signed char) (var_1_23 - var_1_20)))) : (var_1_38 ? (var_1_18 == ((signed char) (min (var_1_21 , (max ((10 + var_1_23) , 5)))))) : ((64 == (min (var_1_20 , -10))) ? (var_1_18 == ((signed char) (var_1_22 + var_1_21))) : ((! var_1_38) ? ((var_1_24 < var_1_20) ? (var_1_18 == ((signed char) var_1_20)) : (var_1_18 == ((signed char) var_1_23))) : 1))))) && ((var_1_6 < ((256.625f * var_1_7) * var_1_5)) ? ((var_1_38 || var_1_38) ? (var_1_24 == ((signed long int) ((-256 + var_1_22) + (var_1_20 - (max (var_1_23 , var_1_54)))))) : ((! var_1_38) ? ((((var_1_6 / var_1_25) > var_1_5) || var_1_38) ? (var_1_24 == ((signed long int) var_1_22)) : 1) : 1)) : 1)) && ((var_1_12 <= var_1_46) ? (var_1_38 ? ((var_1_22 < var_1_18) ? (var_1_26 == ((double) (var_1_7 + var_1_15))) : (var_1_26 == ((double) (min (var_1_15 , ((max (var_1_7 , var_1_27)) + var_1_28)))))) : (var_1_26 == ((double) (min (var_1_6 , var_1_27))))) : ((var_1_24 < var_1_46) ? (var_1_26 == ((double) (var_1_5 - (var_1_29 + var_1_30)))) : (var_1_26 == ((double) 49.2))))) && ((var_1_27 <= var_1_5) ? (((abs (-0.5)) >= var_1_30) ? (var_1_31 == ((double) (abs (var_1_30)))) : (((var_1_30 - (var_1_29 + var_1_32)) == var_1_28) ? (var_1_31 == ((double) (min ((max (var_1_32 , var_1_29)) , var_1_33)))) : (var_1_38 ? (var_1_31 == ((double) (var_1_6 - var_1_32))) : (var_1_31 == ((double) (max (var_1_32 , (min (var_1_27 , (abs (var_1_28))))))))))) : 1)) && ((var_1_21 > (max ((var_1_16 + var_1_48) , var_1_22))) ? (var_1_34 == ((float) var_1_6)) : 1)) && (((min (var_1_24 , (~ var_1_35))) <= (var_1_21 / 128u)) ? (var_1_36 == ((signed long int) (max (var_1_35 , (min ((min (var_1_23 , var_1_21)) , var_1_18)))))) : 1)) && ((var_1_38 || var_1_38) ? (var_1_38 ? (var_1_37 == ((signed short int) (abs (var_1_54)))) : 1) : 1)) && ((last_1_var_1_37 == (last_1_var_1_46 - (var_1_39 - var_1_23))) ? (var_1_38 == ((unsigned char) (var_1_19 && var_1_40))) : (var_1_38 == ((unsigned char) var_1_40)))) && ((var_1_33 < var_1_6) ? (var_1_40 ? (var_1_41 == ((signed short int) ((max (var_1_21 , var_1_23)) - (var_1_36 + (min (var_1_20 , var_1_54)))))) : ((var_1_29 <= var_1_34) ? (var_1_41 == ((signed short int) (var_1_23 + (var_1_54 - var_1_36)))) : ((var_1_30 <= var_1_34) ? (var_1_41 == ((signed short int) var_1_36)) : (var_1_41 == ((signed short int) (max (((max (1 , var_1_23)) - var_1_20) , ((abs (var_1_21)) - var_1_36)))))))) : 1)) && (var_1_38 ? (((var_1_46 * 8) < ((var_1_46 / 50u) << var_1_18)) ? (var_1_42 == ((float) ((max ((var_1_44 + var_1_45) , var_1_29)) + var_1_15))) : 1) : ((var_1_22 < var_1_41) ? (var_1_42 == ((float) (var_1_28 + var_1_44))) : (var_1_42 == ((float) (var_1_29 + var_1_44)))))) && ((last_1_var_1_48 < 4) ? (((max (last_1_var_1_36 , last_1_var_1_54)) != var_1_10) ? (var_1_46 == ((unsigned short int) ((max (last_1_var_1_8 , var_1_23)) + var_1_20))) : ((last_1_var_1_8 < var_1_10) ? (var_1_46 == ((unsigned short int) (max ((max (var_1_20 , last_1_var_1_24)) , var_1_21)))) : (var_1_46 == ((unsigned short int) (max (var_1_39 , (52246 - last_1_var_1_8))))))) : 1)) && (var_1_38 ? (var_1_38 ? (var_1_38 ? (var_1_48 == ((signed char) (abs (var_1_22)))) : (var_1_48 == ((signed char) ((var_1_20 + var_1_21) - (var_1_50 - (var_1_23 + var_1_51)))))) : (var_1_48 == ((signed char) (((var_1_52 - var_1_23) - (var_1_51 + var_1_53)) + var_1_21)))) : ((last_1_var_1_48 > var_1_21) ? (var_1_48 == ((signed char) (((abs (-10)) + var_1_53) - var_1_50))) : (var_1_48 == ((signed char) (var_1_21 + var_1_52)))))) && ((last_1_var_1_38 || last_1_var_1_38) ? (((var_1_12 | (var_1_53 * var_1_20)) > (var_1_23 * (- last_1_var_1_16))) ? (var_1_40 ? (var_1_54 == ((signed short int) var_1_53)) : (var_1_54 == ((signed short int) last_1_var_1_16))) : (var_1_54 == ((signed short int) var_1_51))) : 1)
;
}
int main(void) {
	isInitial = 1;
