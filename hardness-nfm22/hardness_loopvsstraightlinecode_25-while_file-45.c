...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch4525_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch4525_while
	if (var_1_10) {
		var_1_9 = ((var_1_11 + var_1_12) - 5u);
	}


	// From: Req4Batch4525_while
	var_1_19 = var_1_16;


	// From: Req3Batch4525_while
	unsigned long int stepLocal_0 = min ((var_1_19 + var_1_9) , var_1_9);
	if (var_1_10) {
		var_1_13 = (var_1_14 - (min ((min (var_1_15 , var_1_16)) , 50)));
	} else {
	...
	// From: Req1Batch4525_while
	if ((var_1_9 / 32) < (min ((var_1_13 + var_1_9) , var_1_19))) {
...
int property() {
	return (((((var_1_9 / 32) < (min ((var_1_13 + var_1_9) , var_1_19))) ? (var_1_1 == ((double) ((var_1_6 - var_1_7) - var_1_8))) : (var_1_1 == ((double) var_1_6))) && (var_1_10 ? (var_1_9 == ((unsigned long int) ((var_1_11 + var_1_12) - 5u))) : 1)) && (var_1_10 ? (var_1_13 == ((signed char) (var_1_14 - (min ((min (var_1_15 , var_1_16)) , 50))))) : ((var_1_12 < (min ((var_1_19 + var_1_9) , var_1_9))) ? (var_1_13 == ((signed char) (var_1_17 + var_1_18))) : 1))) && (var_1_19 == ((unsigned char) var_1_16))
;
}
int main(void) {
	isInitial = 1;
