...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch92Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_11 || stepLocal_3) {
		if (stepLocal_2 || ((min (var_1_2 , var_1_3)) < 32)) {
...
int property() {
	return (((var_1_1 == ((signed char) ((var_1_2 + var_1_3) - (max (var_1_4 , (var_1_5 + var_1_6)))))) && ((((~ var_1_5) * (var_1_6 & var_1_3)) >= var_1_4) ? (var_1_7 == ((double) var_1_8)) : 1)) && ((var_1_10 && var_1_11) ? (var_1_9 == ((signed char) (var_1_3 - var_1_2))) : 1)) && ((var_1_11 || var_1_10) ? ((var_1_10 || ((min (var_1_2 , var_1_3)) < 32)) ? (((var_1_13 - var_1_5) < var_1_2) ? (var_1_12 == ((float) var_1_8)) : (var_1_12 == ((float) var_1_8))) : (var_1_12 == ((float) var_1_8))) : (var_1_12 == ((float) var_1_8)))
;
}
int main(void) {
	isInitial = 1;
