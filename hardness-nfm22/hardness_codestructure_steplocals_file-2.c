...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch2stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch2stepLocals
	if ((var_1_15 - (min (0 , var_1_16))) > var_1_6) {
		var_1_14 = var_1_12;
	}


	// From: Req5Batch2stepLocals
	if (var_1_6 <= (var_1_16 * var_1_2)) {
	...
	// From: Req6Batch2stepLocals
	if (var_1_14 < var_1_11) {
		var_1_19 = (var_1_13 - 256.4);
	}


	// From: Req7Batch2stepLocals
	var_1_20 = var_1_16;


	// From: Req8Batch2stepLocals
	var_1_21 = var_1_16;
}
