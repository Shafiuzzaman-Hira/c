...
void step(void) {
	...
	if (! (last_1_var_1_14 >= last_1_var_1_9)) {
		if (((*(var_1_4_Pointer)) || (*(var_1_5_Pointer))) && stepLocal_0) {
			(*(var_1_1_Pointer)) = (min (last_1_var_1_9 , last_1_var_1_14));
		} else {
	...
	signed long int stepLocal_3 = ((*(var_1_15_Pointer)) + (*(var_1_16_Pointer))) - (max (64 , (*(var_1_13_Pointer))));
	if ((*(var_1_12_Pointer)) < stepLocal_3) {
		(*(var_1_14_Pointer)) = ((64 - (*(var_1_16_Pointer))) - (*(var_1_13_Pointer)));
	} else {
		(*(var_1_14_Pointer)) = (min ((*(var_1_10_Pointer)) , (*(var_1_11_Pointer))));
	}


	// From: Req4Batch57Wrapper_P
...
int property() {
	return ((((! (last_1_var_1_14 >= last_1_var_1_9)) ? ((((*(var_1_4_Pointer)) || (*(var_1_5_Pointer))) && (*(var_1_6_Pointer))) ? ((*(var_1_1_Pointer)) == ((signed long int) (min (last_1_var_1_9 , last_1_var_1_14)))) : ((*(var_1_1_Pointer)) == ((signed long int) last_1_var_1_14))) : ((*(var_1_1_Pointer)) == ((signed long int) last_1_var_1_14))) && (((*(var_1_5_Pointer)) && (*(var_1_4_Pointer))) ? (((*(var_1_6_Pointer)) || ((*(var_1_14_Pointer)) == (*(var_1_1_Pointer)))) ? ((*(var_1_9_Pointer)) == ((signed char) (min ((*(var_1_10_Pointer)) , (*(var_1_11_Pointer)))))) : 1) : ((*(var_1_9_Pointer)) == ((signed char) ((*(var_1_12_Pointer)) - (*(var_1_13_Pointer))))))) && (((*(var_1_12_Pointer)) < (((*(var_1_15_Pointer)) + (*(var_1_16_Pointer))) - (max (64 , (*(var_1_13_Pointer)))))) ? ((*(var_1_14_Pointer)) == ((signed char) ((64 - (*(var_1_16_Pointer))) - (*(var_1_13_Pointer))))) : ((*(var_1_14_Pointer)) == ((signed char) (min ((*(var_1_10_Pointer)) , (*(var_1_11_Pointer)))))))) && ((*(var_1_17_Pointer)) == ((float) 128.91f))
;
}
int main(void) {
	isInitial = 1;
