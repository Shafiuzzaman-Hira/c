...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch1350_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch1350_while
	if (var_1_9) {
		var_1_8 = (var_1_10 - (var_1_11 - var_1_4));
	}


	// From: Req4Batch1350_while
