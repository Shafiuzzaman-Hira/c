...
void step(void) {
	...
	// From: CodeObject6
	if (var_1_9) {
		var_1_35 = (abs (abs (var_1_17)));
	} else {
		var_1_35 = ((max (var_1_17 , var_1_17)) - var_1_5);
	}
	...
	// From: Req4Batch58Filler_PS_CI
	var_1_12 = (min (var_1_13 , var_1_14));


	// From: Req5Batch58Filler_PS_CI
	if (var_1_7) {
		var_1_15 = ((min (32 , (16 + var_1_16))) - var_1_17);
	}


	// From: Req6Batch58Filler_PS_CI
