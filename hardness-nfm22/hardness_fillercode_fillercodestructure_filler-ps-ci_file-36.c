...
void step(void) {
	...
	if (((var_1_9 ^ 8) * var_1_10) <= var_1_8) {
		var_1_28 = (abs (min ((max (var_1_4 , var_1_6)) , var_1_5)));
	}
	...
	// From: CodeObject5
	if (var_1_9 < ((min (var_1_11 , var_1_8)) / var_1_9)) {
	...
	// From: CodeObject6
	if (((min (var_1_9 , var_1_9)) >> (var_1_44 - 4u)) >= var_1_10) {
		var_1_43 = ((var_1_45 - (10000 - var_1_44)) - (abs (var_1_35)));
	} else {
		if ((max ((abs (var_1_35)) , var_1_11)) > var_1_10) {
			var_1_43 = 5;
		}
	}
	...
	// From: Req1Batch36Filler_PS_CI
	if (var_1_2) {
		var_1_1 = (min ((max ((var_1_3 - var_1_4) , (min (var_1_5 , var_1_6)))) , var_1_7));
	}


	// From: Req2Batch36Filler_PS_CI
	var_1_8 = ((min (var_1_9 , var_1_10)) - var_1_11);


	// From: Req3Batch36Filler_PS_CI
	if (var_1_2) {
		var_1_12 = (min ((var_1_3 - (var_1_13 - 128.68)) , var_1_7));
	}


	// From: Req4Batch36Filler_PS_CI
	var_1_14 = var_1_6;


	// From: Req5Batch36Filler_PS_CI
	...
	// From: Req6Batch36Filler_PS_CI
	if (var_1_3 <= var_1_4) {
		var_1_16 = (min (var_1_6 , var_1_4));
	}


	// From: Req7Batch36Filler_PS_CI
