...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_6_Pointer)) > ((*(WrapperStruct00_var_1_13_Pointer)) * (max ((*(WrapperStruct00_var_1_5_Pointer)) , (*(WrapperStruct00_var_1_7_Pointer)))))) {
