...
void step(void) {
	...
	// From: CodeObject3
	if (var_1_24 > (max (var_1_27 , (var_1_29 >> var_1_30)))) {
		var_1_28 = var_1_30;
	}
	...
	if (var_1_27 > var_1_28) {
		var_1_31 = (max ((var_1_32 + (max (var_1_33 , var_1_34))) , var_1_35));
	} else {
		var_1_31 = var_1_33;
	}
	...
	// From: Req7Batch42PS_CN_25
	if (var_1_14 <= var_1_15) {
		var_1_19 = (var_1_12 || var_1_20);
	}


	// From: Req2Batch42PS_CN_25
	if (var_1_5 >= -2) {
		var_1_6 = (var_1_7 - 100);
	}


	// From: Req4Batch42PS_CN_25
