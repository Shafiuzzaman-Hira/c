...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch31Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (! var_1_25) {
  ...
  if (var_1_22 <= var_1_23) {
   if ((((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))) - var_1_1) < var_1_17) {
    if (var_1_17 < var_1_1) {
     var_1_27 = var_1_28;
    }
   } else {
 ...
 if ((var_1_23 < var_1_34) || var_1_25) {
  if ((var_1_8 / ((((-10) < (var_1_35)) ? (-10) : (var_1_35)))) >= ((((var_1_9) < (var_1_8)) ? (var_1_9) : (var_1_8)))) {
   var_1_33 = var_1_8;
  } else {
   var_1_33 = var_1_8;
  }
 }
 if (var_1_16 > (var_1_16 | ((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))))) {
