...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch41PS_CN_25.c", 13, "reach_error"); }
...
float var_1_28 = 100.25;
signed short int var_1_29 = 10;
float var_1_30 = 10.875;
float var_1_31 = 1.6;
float var_1_32 = 5.25;
...
void step(void) {
	...
	// From: CodeObject6
	var_1_33 = (var_1_27 + var_1_34);


	// From: CodeObject7
	if ((var_1_36 - var_1_37) <= var_1_26) {
		var_1_35 = (abs (var_1_38 - var_1_36));
	} else {
		var_1_35 = (abs (var_1_26));
	}


	// From: CodeObject8
	if (var_1_36 >= (var_1_29 + var_1_38)) {
		var_1_39 = var_1_27;
	} else {
		var_1_39 = ((abs (var_1_37)) + var_1_40);
	}


	// From: Req4Batch41PS_CN_25
	...
	// From: Req5Batch41PS_CN_25
	if (var_1_1) {
		var_1_15 = var_1_16;
	}


	// From: Req8Batch41PS_CN_25
	var_1_22 = 1;


	// From: Req9Batch41PS_CN_25
	var_1_23 = var_1_22;


	// From: Req3Batch41PS_CN_25
