...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch67Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject2
	if (var_1_3) {
		if ((abs (var_1_17)) > ((-10 + var_1_16) & var_1_17)) {
			var_1_29 = ((abs (var_1_31 - 64u)) - var_1_17);
		} else {
			var_1_29 = var_1_17;
		}
	}
	...
	// From: CodeObject5
	var_1_36 = (abs (var_1_16));


	// From: CodeObject6
	if (var_1_1 > (var_1_39 - var_1_40)) {
		if (var_1_17 <= var_1_17) {
			var_1_38 = (var_1_17 + (abs (var_1_17)));
		} else {
			if ((max ((abs (var_1_27)) , var_1_15)) != var_1_28) {
	...
	// From: CodeObject7
	if (var_1_3 || var_1_3) {
		if (var_1_12 <= (var_1_45 - 64)) {
			if (var_1_31 < (abs (var_1_17))) {
				var_1_44 = var_1_12;
			} else {
				var_1_44 = 16;
			}
