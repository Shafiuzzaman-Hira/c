...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch58100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch58100_while
	if (var_1_2) {
		var_1_11 = (var_1_4 + last_1_var_1_1);
	}


	// From: Req7Batch58100_while
	if (var_1_2) {
	...
	// From: Req9Batch58100_while
	if (var_1_2 && var_1_25) {
		var_1_30 = (max (var_1_21 , var_1_23));
	}


	// From: Req10Batch58100_while
	var_1_31 = (min ((min (var_1_24 , var_1_22)) , (var_1_23 - var_1_21)));


	// From: Req12Batch58100_while
	var_1_41 = var_1_22;


	// From: Req13Batch58100_while
	var_1_42 = 256;


	// From: Req1Batch58100_while
