...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch84PS_CN_10.c", 13, "reach_error"); }
...
float var_1_30 = 2.5;
float var_1_31 = 15.25;
unsigned long int var_1_32 = 256;
unsigned long int var_1_33 = 100;
...
void step(void) {
	...
	// From: Req7Batch84PS_CN_10
	var_1_18 = var_1_17;


	// From: Req8Batch84PS_CN_10
	var_1_19 = 0;


	// From: Req9Batch84PS_CN_10
	var_1_20 = var_1_21;


	// From: Req1Batch84PS_CN_10
	if (var_1_19) {
		var_1_1 = (min ((var_1_3 + (1 - var_1_4)) , var_1_5));
	}


	// From: Req4Batch84PS_CN_10
	if (var_1_3 <= var_1_1) {
		var_1_12 = var_1_4;
	} else {
