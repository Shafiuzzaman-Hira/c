...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch48PS_CN_100.c", 13, "reach_error"); }
...
signed short int var_1_44 = -18780;
signed char var_1_45 = -1;
unsigned short int var_1_46 = 16;
double var_1_47 = 256.4;
...
void step(void) {
 ...
 if ((16 * var_1_20) >= ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34)))) {
  if (1000u <= var_1_20) {
   var_1_37 = (! var_1_36);
  }
 }
 if ((var_1_35 >> (var_1_39 - var_1_40)) < -16) {
 ...
 if (var_1_25) {
  if (! (var_1_38 >= var_1_41)) {
   ...
   var_1_42 = (25 - var_1_40);
  }
 } else {
  var_1_42 = ((((var_1_39) > (var_1_40)) ? (var_1_39) : (var_1_40)));
 }
 if (((((var_1_20) < (var_1_35)) ? (var_1_20) : (var_1_35))) <= 16) {
  var_1_43 = (var_1_39 - (((((var_1_44) < 0 ) ? -(var_1_44) : (var_1_44))) - var_1_40));
 } else {
  if (var_1_34 <= var_1_35) {
   var_1_43 = (((((((((-64) < 0 ) ? -(-64) : (-64))) + var_1_39)) > (var_1_34)) ? ((((((-64) < 0 ) ? -(-64) : (-64))) + var_1_39)) : (var_1_34)));
  } else {
   if ((var_1_40 >> var_1_39) <= var_1_33) {
    if (var_1_36) {
     var_1_43 = ((((var_1_34) < (((((var_1_44) < 0 ) ? -(var_1_44) : (var_1_44))))) ? (var_1_34) : (((((var_1_44) < 0 ) ? -(var_1_44) : (var_1_44))))));
    }
   } else {
    var_1_43 = ((((var_1_33) > (var_1_34)) ? (var_1_33) : (var_1_34)));
   }
  }
 }
 if ((((((~ var_1_35)) < (var_1_46)) ? ((~ var_1_35)) : (var_1_46))) <= var_1_44) {
  if (var_1_25) {
   var_1_45 = var_1_39;
  } else {
   var_1_45 = var_1_39;
...
void updateVariables() {
 ...
 assume_abort_if_not(var_1_40 <= 16);
