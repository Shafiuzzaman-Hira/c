...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch28Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_25 = var_1_10;
 if ((var_1_9 < ((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16)))) || var_1_13) {
  var_1_27 = var_1_7;
 }
 if (! var_1_12) {
 ...
 if (var_1_22 <= 9.6) {
  var_1_38 = (((((var_1_34 + var_1_17)) > (var_1_16)) ? ((var_1_34 + var_1_17)) : (var_1_16)));
 } else {
  if (var_1_1 <= var_1_9) {
   if (var_1_16 > (var_1_1 >> var_1_1)) {
    var_1_38 = ((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16)));
   } else {
    var_1_38 = ((((var_1_34) < (((((var_1_17) < (var_1_7)) ? (var_1_17) : (var_1_7))))) ? (var_1_34) : (((((var_1_17) < (var_1_7)) ? (var_1_17) : (var_1_7))))));
   }
  }
 }
 var_1_39 = var_1_34;
