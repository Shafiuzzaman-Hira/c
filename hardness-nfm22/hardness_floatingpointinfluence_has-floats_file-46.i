...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch46has_floats.c", 13, "reach_error"); }
...
void step(void) {
 ...
 signed long int stepLocal_1 = (((var_1_4) < (var_1_13)) ? (var_1_4) : (var_1_13));
