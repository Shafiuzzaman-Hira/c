...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch85stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_1 < ((- var_1_3) * 64)) {
  if (var_1_4) {
   ...
   if (stepLocal_0 < var_1_2) {
    var_1_1 = (((((((var_1_3) > (5u)) ? (var_1_3) : (5u))) < 0 ) ? -((((var_1_3) > (5u)) ? (var_1_3) : (5u))) : ((((var_1_3) > (5u)) ? (var_1_3) : (5u)))));
   } else {
    var_1_1 = 50u;
   }
  }
 ...
 if (var_1_4) {
  var_1_15 = ((((var_1_3) > ((var_1_13 + ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)))))) ? (var_1_3) : ((var_1_13 + ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)))))));
 }
