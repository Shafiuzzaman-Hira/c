...
void step(void) {
	...
	if (var_1_35 > var_1_34) {
		var_1_46 = ((abs (var_1_27)) - (min (var_1_27 , (abs (var_1_25)))));
	} else {
	...
	if (var_1_34 > var_1_30) {
		if ((max (32 , var_1_16)) <= var_1_20) {
			var_1_40 = (abs (var_1_13));
		} else {
			var_1_40 = (abs (min (128u , (min (var_1_20 , var_1_13)))));
		}
	} else {
		var_1_40 = var_1_13;
	}
	...
	// From: CodeObject3
	if (var_1_34 < var_1_30) {
		var_1_38 = (abs (max (var_1_17 , (min (var_1_11 , var_1_26)))));
	}
