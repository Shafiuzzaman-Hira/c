...
void step(void) {
	...
	// From: CodeObject2
	if (var_1_14 >= (min (var_1_19 , var_1_17))) {
	...
	// From: CodeObject1
	if (var_1_14 >= (abs (max (var_1_19 , var_1_19)))) {
	...
	// From: CodeObject5
	if (-2 > ((abs (var_1_8)) | (-10 * var_1_8))) {
		var_1_37 = (max ((min (25 , var_1_8)) , (abs (var_1_32 + var_1_8))));
	} else {
		if ((abs (var_1_8)) <= (abs (var_1_8))) {
			if ((var_1_8 * (max (var_1_11 , var_1_8))) <= var_1_8) {
