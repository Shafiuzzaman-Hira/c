...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch9Wrapper_SP.c", 13, "reach_error"); }
...
unsigned char* WrapperStruct0_var_1_1_Pointer = &(WrapperStruct0.var_1_1);
unsigned char* WrapperStruct0_var_1_3_Pointer = &(WrapperStruct0.var_1_3);
unsigned char* WrapperStruct0_var_1_7_Pointer = &(WrapperStruct0.var_1_7);
signed short int* WrapperStruct0_var_1_8_Pointer = &(WrapperStruct0.var_1_8);
unsigned char* WrapperStruct0_var_1_9_Pointer = &(WrapperStruct0.var_1_9);
...
signed short int* WrapperStruct0_var_1_12_Pointer = &(WrapperStruct0.var_1_12);
signed long int* WrapperStruct0_var_1_14_Pointer = &(WrapperStruct0.var_1_14);
...
void step(void) {
	...
	if (((last_1_WrapperStruct0_var_1_12 + last_1_WrapperStruct0_var_1_1) < 10) || stepLocal_0) {
		(*(WrapperStruct0_var_1_12_Pointer)) = (max ((((*(WrapperStruct0_var_1_3_Pointer)) + last_1_WrapperStruct0_var_1_12) - (max (last_1_WrapperStruct0_var_1_14 , last_1_WrapperStruct0_var_1_12))) , last_1_WrapperStruct0_var_1_1));
	} else {
		(*(WrapperStruct0_var_1_12_Pointer)) = last_1_WrapperStruct0_var_1_12;
	}


	// From: Req6Batch9Wrapper_SP
	(*(WrapperStruct0_var_1_14_Pointer)) = (*(WrapperStruct0_var_1_12_Pointer));


	// From: Req2Batch9Wrapper_SP
	if ((10 << (*(WrapperStruct0_var_1_12_Pointer))) < ((*(WrapperStruct0_var_1_3_Pointer)) * (*(WrapperStruct0_var_1_14_Pointer)))) {
		(*(WrapperStruct0_var_1_8_Pointer)) = ((*(WrapperStruct0_var_1_12_Pointer)) + (*(WrapperStruct0_var_1_14_Pointer)));
	}


	// From: Req3Batch9Wrapper_SP
	(*(WrapperStruct0_var_1_9_Pointer)) = 64;


	// From: Req4Batch9Wrapper_SP
	(*(WrapperStruct0_var_1_10_Pointer)) = (*(WrapperStruct0_var_1_11_Pointer));


	// From: Req1Batch9Wrapper_SP
	if ((*(WrapperStruct0_var_1_12_Pointer)) <= 16) {
		(*(WrapperStruct0_var_1_1_Pointer)) = (*(WrapperStruct0_var_1_3_Pointer));
	} else {
		if ((max ((*(WrapperStruct0_var_1_10_Pointer)) , (*(WrapperStruct0_var_1_10_Pointer)))) < (*(WrapperStruct0_var_1_10_Pointer))) {
			if ((*(WrapperStruct0_var_1_7_Pointer))) {
				(*(WrapperStruct0_var_1_1_Pointer)) = (*(WrapperStruct0_var_1_3_Pointer));
			} else {
				(*(WrapperStruct0_var_1_1_Pointer)) = (*(WrapperStruct0_var_1_3_Pointer));
			}
...
int property() {
	return (((((((*(WrapperStruct0_var_1_12_Pointer)) <= 16) ? ((*(WrapperStruct0_var_1_1_Pointer)) == ((unsigned char) (*(WrapperStruct0_var_1_3_Pointer)))) : (((max ((*(WrapperStruct0_var_1_10_Pointer)) , (*(WrapperStruct0_var_1_10_Pointer)))) < (*(WrapperStruct0_var_1_10_Pointer))) ? ((*(WrapperStruct0_var_1_7_Pointer)) ? ((*(WrapperStruct0_var_1_1_Pointer)) == ((unsigned char) (*(WrapperStruct0_var_1_3_Pointer)))) : ((*(WrapperStruct0_var_1_1_Pointer)) == ((unsigned char) (*(WrapperStruct0_var_1_3_Pointer))))) : ((*(WrapperStruct0_var_1_1_Pointer)) == ((unsigned char) (*(WrapperStruct0_var_1_3_Pointer)))))) && (((10 << (*(WrapperStruct0_var_1_12_Pointer))) < ((*(WrapperStruct0_var_1_3_Pointer)) * (*(WrapperStruct0_var_1_14_Pointer)))) ? ((*(WrapperStruct0_var_1_8_Pointer)) == ((signed short int) ((*(WrapperStruct0_var_1_12_Pointer)) + (*(WrapperStruct0_var_1_14_Pointer))))) : 1)) && ((*(WrapperStruct0_var_1_9_Pointer)) == ((unsigned char) 64))) && ((*(WrapperStruct0_var_1_10_Pointer)) == ((double) (*(WrapperStruct0_var_1_11_Pointer))))) && ((((last_1_WrapperStruct0_var_1_12 + last_1_WrapperStruct0_var_1_1) < 10) || (last_1_WrapperStruct0_var_1_10 > last_1_WrapperStruct0_var_1_10)) ? ((*(WrapperStruct0_var_1_12_Pointer)) == ((signed short int) (max ((((*(WrapperStruct0_var_1_3_Pointer)) + last_1_WrapperStruct0_var_1_12) - (max (last_1_WrapperStruct0_var_1_14 , last_1_WrapperStruct0_var_1_12))) , last_1_WrapperStruct0_var_1_1)))) : ((*(WrapperStruct0_var_1_12_Pointer)) == ((signed short int) last_1_WrapperStruct0_var_1_12)))) && ((*(WrapperStruct0_var_1_14_Pointer)) == ((signed long int) (*(WrapperStruct0_var_1_12_Pointer))))
;
}
int main(void) {
	isInitial = 1;
