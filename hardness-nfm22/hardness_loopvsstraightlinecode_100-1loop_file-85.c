...
void step(void) {
	...
	// From: Req8Batch85100_1loop
	var_1_26 = (! (! var_1_13));


	// From: Req12Batch85100_1loop
	var_1_34 = var_1_35;


	// From: Req13Batch85100_1loop
	var_1_36 = var_1_17;


	// From: Req14Batch85100_1loop
	var_1_37 = var_1_8;


	// From: Req4Batch85100_1loop
	...
	// From: Req5Batch85100_1loop
	if (var_1_26) {
		var_1_21 = (var_1_25 + (var_1_22 - (var_1_10 + var_1_9)));
	}


	// From: Req9Batch85100_1loop
	if (var_1_26) {
		if (var_1_5 <= var_1_3) {
