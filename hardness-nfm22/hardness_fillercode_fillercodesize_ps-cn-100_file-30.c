...
void step(void) {
	// From: CodeObject1
	if (((abs (var_1_20)) - var_1_21) == (var_1_22 * var_1_23)) {
		var_1_19 = -4;
	}
	...
	if (var_1_21 != var_1_23) {
		...
		if ((var_1_19 | (var_1_24 + var_1_27)) != var_1_28) {
			var_1_25 = (abs (min ((var_1_29 - var_1_30) , var_1_31)));
		} else {
			var_1_25 = (max (var_1_31 , var_1_30));
		}
	}


	// From: CodeObject4
	if ((min (var_1_30 , var_1_24)) == var_1_29) {
	...
	if (var_1_20 < var_1_26) {
		var_1_37 = (((min (var_1_38 , var_1_39)) - var_1_40) - 3.3);
	}


	// From: CodeObject6
	if (((abs (var_1_28)) * (abs (var_1_24))) == (abs (var_1_27))) {
		var_1_41 = (min (var_1_31 , var_1_25));
	} else {
		var_1_41 = (abs (abs (var_1_31)));
	}
	...
	// From: CodeObject8
	if (((abs (var_1_41)) * var_1_24) > (var_1_25 + (var_1_28 >> 2))) {
		var_1_44 = (min (var_1_30 , (51928 - (abs (var_1_27)))));
	}


	// From: CodeObject9
	if (var_1_35 || (var_1_30 <= var_1_24)) {
		if (((min (var_1_40 , var_1_23)) + var_1_37) >= var_1_20) {
			var_1_45 = (max ((max (var_1_27 , (abs (var_1_29)))) , var_1_30));
		} else {
			var_1_45 = (min (var_1_30 , var_1_46));
		}
	} else {
		if ((var_1_46 ^ 2) >= var_1_29) {
			var_1_45 = (max ((max (var_1_46 , var_1_27)) , (abs (var_1_30))));
		} else {
			if ((var_1_25 + var_1_29) >= var_1_44) {
				var_1_45 = ((min ((var_1_27 + var_1_30) , (abs (var_1_29)))) + (min (var_1_47 , (max (64 , var_1_48)))));
			} else {
				var_1_45 = 16;
			}
		}
