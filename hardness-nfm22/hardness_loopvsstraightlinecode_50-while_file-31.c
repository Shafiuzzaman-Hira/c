...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch3150_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch3150_while
	var_1_8 = (min ((var_1_5 + (64 - 16)) , 64));


	// From: Req4Batch3150_while
	...
	// From: Req6Batch3150_while
	var_1_17 = var_1_13;


	// From: Req7Batch3150_while
