...
void step(void) {
	...
	if (var_1_58) {
		...
		if (var_1_60) {
			if (var_1_41 >= (var_1_61 + var_1_40)) {
				var_1_63 = (min (var_1_39 , ((var_1_33 + var_1_64) - (var_1_65 - 10))));
			} else {
				var_1_63 = (var_1_33 + var_1_39);
			}
		} else {
			var_1_63 = (abs (min (var_1_34 , (var_1_65 - var_1_64))));
		}
	}
	...
	if (var_1_44) {
		if (((var_1_50 * -16) >= var_1_39) || (var_1_35 > var_1_33)) {
			var_1_66 = (max (var_1_39 , var_1_67));
		}
	}
	...
	if (var_1_49 <= var_1_54) {
		if (var_1_39 > var_1_61) {
			if (var_1_41 < (-1 << (abs (var_1_70)))) {
				var_1_69 = (var_1_71 - 1);
			} else {
				var_1_69 = ((min ((var_1_72 - var_1_33) , (var_1_73 - var_1_70))) - (abs (abs (var_1_66))));
			}
		} else {
			if (var_1_68) {
				var_1_69 = (abs (var_1_72));
			}
		}
	} else {
		var_1_69 = var_1_65;
	...
	// From: CodeObject14
	if (var_1_55 >= 1.225f) {
		var_1_75 = (min (var_1_51 , var_1_56));
	} else {
		if ((min ((abs (var_1_47)) , var_1_56)) < (abs (var_1_52 / var_1_48))) {
			var_1_75 = ((abs (1.25f - var_1_55)) - var_1_76);
		} else {
			if (((- var_1_55) + var_1_43) >= var_1_51) {
				if (var_1_76 < var_1_52) {
					var_1_75 = (abs (var_1_56 + var_1_57));
				}
			}
		}
	}
	...
	if (var_1_53 > var_1_77) {
		...
		var_1_78 = (abs (min (var_1_70 , var_1_69)));
	}


	// From: CodeObject17
	if (var_1_41 > var_1_66) {
		var_1_79 = (max (var_1_70 , (max (var_1_80 , var_1_81))));
	}


	// From: CodeObject18
	if (((var_1_62 - var_1_66) / (min (var_1_65 , var_1_73))) <= (var_1_33 & var_1_69)) {
		if (var_1_60 && var_1_44) {
			var_1_82 = (var_1_70 - (64 - var_1_83));
		} else {
			if ((var_1_57 >= var_1_55) || (! var_1_60)) {
				var_1_82 = (var_1_70 + (min (-16 , var_1_83)));
			}
		}
	} else {
		if (var_1_60) {
			var_1_82 = ((abs (var_1_70)) - var_1_83);
		}
	}


	// From: CodeObject19
	var_1_84 = (var_1_83 + ((max (var_1_70 , var_1_85)) + var_1_86));
	...
	if (var_1_88 > var_1_78) {
		...
		var_1_87 = (abs (max (var_1_85 , var_1_65)));
	}


	// From: CodeObject21
	if (((~ var_1_33) ^ (var_1_41 | var_1_40)) < ((var_1_85 - var_1_84) / (abs (var_1_65)))) {
		var_1_89 = (abs (10));
	}
	...
	// From: CodeObject23
	if (var_1_63 <= (max (var_1_39 , var_1_41))) {
		var_1_91 = (abs (max (var_1_70 , var_1_85)));
	}
	...
	if ((var_1_41 ^ var_1_40) > var_1_72) {
		if (var_1_51 >= (max ((var_1_76 - var_1_55) , (var_1_94 - var_1_95)))) {
			var_1_93 = (abs ((abs (var_1_70)) + var_1_83));
		}
	}
	...
	// From: CodeObject28
	if (var_1_59) {
		var_1_100 = (abs (min ((abs (var_1_79)) , var_1_35)));
	} else {
	...
	if (var_1_34 < (var_1_66 / var_1_50)) {
		var_1_101 = (var_1_67 + (abs (abs (var_1_39))));
	} else {
		if (var_1_43 == (abs (199.2f))) {
	...
	if (var_1_79 < (var_1_35 * var_1_36)) {
		...
		if ((var_1_64 / var_1_71) < (min (var_1_33 , var_1_88))) {
			if (var_1_42) {
				var_1_102 = (max ((abs (var_1_103)) , (abs (max (var_1_55 , var_1_52)))));
			} else {
				var_1_102 = (abs (var_1_103));
			}
		}
	}
	...
	// From: CodeObject32
	if (50.3f < var_1_49) {
		var_1_105 = (abs (var_1_53));
	} else {
		if (! (! var_1_58)) {
			var_1_105 = (max (var_1_57 , var_1_76));
		} else {
	...
	if (var_1_48 < var_1_47) {
		if (var_1_91 > (32 % (abs (var_1_65)))) {
			var_1_122 = (max (var_1_85 , var_1_86));
		} else {
			if (-32 > var_1_40) {
				var_1_122 = (abs (abs (min (var_1_85 , var_1_83))));
			}
		}
	} else {
		if (64.6f > var_1_76) {
			var_1_122 = (min (var_1_70 , var_1_67));
		}
	}
	...
	if (var_1_97) {
		if (-10 < var_1_73) {
			if ((var_1_54 / (min (var_1_48 , var_1_125))) > var_1_76) {
				if (var_1_45) {
					var_1_124 = (max ((abs (var_1_64 + var_1_83)) , var_1_122));
				} else {
					var_1_124 = (((max (var_1_64 , var_1_115)) - (var_1_126 - var_1_83)) + var_1_86);
				}
			}
		}
	}
	...
	// From: CodeObject50
	if ((abs (var_1_115)) != (25 + (var_1_93 / var_1_72))) {
		if (((var_1_89 | var_1_71) % var_1_72) != var_1_35) {
			var_1_128 = (max (var_1_52 , var_1_76));
		}
	} else {
		if (((var_1_129 - var_1_70) - var_1_85) >= (min ((abs (var_1_65)) , (max (var_1_124 , var_1_82))))) {
			var_1_128 = (min (var_1_107 , (abs (var_1_57))));
		}
	}


	// From: CodeObject51
	var_1_130 = (max (var_1_86 , ((var_1_83 + var_1_70) - var_1_85)));
	...
	if ((var_1_64 * var_1_40) == var_1_124) {
		...
		if (var_1_96) {
			if (var_1_62 < var_1_84) {
				...
				var_1_131 = ((max ((abs (var_1_34)) , (abs (var_1_39)))) + (var_1_70 - (abs (var_1_93))));
			}
		}
	}
	...
	// From: CodeObject54
	if ((max (var_1_102 , var_1_43)) < var_1_103) {
		if ((max (var_1_134 , 50)) > var_1_71) {
			if (var_1_60) {
				var_1_133 = (abs (var_1_85));
			} else {
			...
			if (var_1_87 < (min (var_1_122 , (abs (var_1_65))))) {
	...
	// From: CodeObject56
	var_1_136 = (max (var_1_67 , (max (var_1_129 , (max (var_1_85 , var_1_83))))));


	// From: CodeObject57
	if ((var_1_125 / var_1_48) < (max ((- var_1_75) , var_1_53))) {
		var_1_137 = (var_1_83 + (var_1_136 + var_1_89));
	} else {
		var_1_137 = ((abs (var_1_138 - var_1_89)) - 8u);
	}


	// From: CodeObject58
	if (var_1_99 >= var_1_140) {
		var_1_139 = ((abs (var_1_138)) - var_1_62);
	}
	...
	if (var_1_61 >= (~ var_1_129)) {
		var_1_146 = (min (var_1_136 , var_1_111));
	} else {
	...
	// From: Req8Batch44PS_CN_500
	var_1_31 = var_1_26;


	// From: Req9Batch44PS_CN_500
	var_1_32 = var_1_21;


	// From: Req7Batch44PS_CN_500
	var_1_30 = (max (var_1_15 , var_1_32));


	// From: Req1Batch44PS_CN_500
