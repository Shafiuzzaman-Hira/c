...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch19has_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch19has_floats
	var_1_13 = var_1_7;


	// From: Req3Batch19has_floats
