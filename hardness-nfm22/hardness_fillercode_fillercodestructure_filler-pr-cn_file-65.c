...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch65Filler_PR_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch65Filler_PR_CN
	var_1_24 = ((var_1_1 <= (var_1_25 - var_1_26)) && var_1_27);


	// From: Req3Batch65Filler_PR_CN
