...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch77Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_11 >= (var_1_11 & (var_1_22 >> var_1_9))) {
  var_1_24 = (var_1_22 - ((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))));
 } else {
  if (var_1_11 > (var_1_11 ^ var_1_22)) {
   var_1_24 = ((((var_1_11) < (var_1_11)) ? (var_1_11) : (var_1_11)));
  }
 }
 ...
 var_1_23 = var_1_22;
 if (var_1_4 >= (-128 & var_1_7)) {
  if ((((((var_1_6) > (var_1_3)) ? (var_1_6) : (var_1_3))) <= var_1_3) && var_1_18) {
   var_1_25 = var_1_22;
  }
 } else {
  var_1_25 = var_1_22;
