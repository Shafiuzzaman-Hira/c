...
void step(void) {
 ...
 if (((((signed_short_int_Array_0[0]) > (1)) ? (signed_short_int_Array_0[0]) : (1))) <= (256 + last_1_signed_long_int_Array_0_2_)) {
