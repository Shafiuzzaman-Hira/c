...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch88PS_CN_10.c", 13, "reach_error"); }
...
double var_1_30 = 1.6;
double var_1_31 = 24.9;
double var_1_32 = 255.75;
