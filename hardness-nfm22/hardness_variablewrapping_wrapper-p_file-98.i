...
void step(void) {
 ...
 if (((((-128) < (last_1_var_1_15)) ? (-128) : (last_1_var_1_15))) < (*(var_1_13_Pointer))) {
 ...
 if ((*(var_1_2_Pointer)) < (*(var_1_8_Pointer))) {
  if (((- (*(var_1_15_Pointer))) <= (*(var_1_6_Pointer))) || ((*(var_1_4_Pointer)) < (*(var_1_10_Pointer)))) {
   (*(var_1_12_Pointer)) = (((((*(var_1_6_Pointer))) < ((*(var_1_13_Pointer)))) ? ((*(var_1_6_Pointer))) : ((*(var_1_13_Pointer)))));
  } else {
...
int property() {
 return ((((*(var_1_1_Pointer)) == ((double) ((*(var_1_2_Pointer)) - (*(var_1_3_Pointer))))) && ((8 < (((*(var_1_15_Pointer)) >> (*(var_1_6_Pointer))) / (*(var_1_7_Pointer)))) ? ((*(var_1_4_Pointer)) == ((double) ((((*(var_1_8_Pointer)) + (*(var_1_9_Pointer))) + (((((*(var_1_10_Pointer))) < (1.9)) ? ((*(var_1_10_Pointer))) : (1.9)))) + (99.125 + (*(var_1_11_Pointer)))))) : 1)) && (((*(var_1_2_Pointer)) < (*(var_1_8_Pointer))) ? ((((- (*(var_1_15_Pointer))) <= (*(var_1_6_Pointer))) || ((*(var_1_4_Pointer)) < (*(var_1_10_Pointer)))) ? ((*(var_1_12_Pointer)) == ((unsigned long int) (((((*(var_1_6_Pointer))) < ((*(var_1_13_Pointer)))) ? ((*(var_1_6_Pointer))) : ((*(var_1_13_Pointer))))))) : ((*(var_1_12_Pointer)) == ((unsigned long int) ((*(var_1_14_Pointer)) - (*(var_1_6_Pointer)))))) : 1)) && ((((((-128) < (last_1_var_1_15)) ? (-128) : (last_1_var_1_15))) < (*(var_1_13_Pointer))) ? ((last_1_var_1_15 > (*(var_1_7_Pointer))) ? ((*(var_1_15_Pointer)) == ((unsigned long int) ((*(var_1_6_Pointer)) + (*(var_1_16_Pointer))))) : ((*(var_1_15_Pointer)) == ((unsigned long int) (*(var_1_14_Pointer))))) : ((*(var_1_15_Pointer)) == ((unsigned long int) (*(var_1_16_Pointer)))))
;
}
int main(void) {
 isInitial = 1;
