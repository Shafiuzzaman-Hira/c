...
void step(void) {
 ...
 unsigned long int stepLocal_17 = (((var_1_26) > (var_1_1)) ? (var_1_26) : (var_1_1));
 if (var_1_46 != stepLocal_17) {
  if (var_1_37 < var_1_39) {
   var_1_48 = (((((var_1_46 - var_1_4)) < (var_1_1)) ? ((var_1_46 - var_1_4)) : (var_1_1)));
  } else {
   var_1_48 = var_1_1;
  }
 }
 ...
 if (var_1_10 < ((((var_1_8) < ((-0.25 * var_1_9))) ? (var_1_8) : ((-0.25 * var_1_9))))) {
  if (stepLocal_7 <= last_1_var_1_22) {
   var_1_22 = ((((var_1_4) < (((((var_1_19) > (var_1_3)) ? (var_1_19) : (var_1_3))))) ? (var_1_4) : (((((var_1_19) > (var_1_3)) ? (var_1_19) : (var_1_3))))));
  } else {
   var_1_22 = ((((var_1_19) < (var_1_4)) ? (var_1_19) : (var_1_4)));
  }
 }
 if (1.875f >= var_1_12) {
 ...
 if (var_1_10 < (var_1_9 - (var_1_36 + var_1_39))) {
  if (stepLocal_13 <= var_1_25) {
   ...
   if ((8.5f == (var_1_11 * var_1_37)) || stepLocal_14) {
    var_1_38 = (last_1_var_1_1 - ((var_1_40 + var_1_41) - ((((var_1_29) > (last_1_var_1_33)) ? (var_1_29) : (last_1_var_1_33)))));
   }
  }
 } else {
  if (var_1_9 <= var_1_39) {
   var_1_38 = ((((((var_1_41 - last_1_var_1_1) + var_1_40)) < (((last_1_var_1_45 + last_1_var_1_33) + var_1_4))) ? (((var_1_41 - last_1_var_1_1) + var_1_40)) : (((last_1_var_1_45 + last_1_var_1_33) + var_1_4))));
  } else {
   if ((((((var_1_36 + 1.15f)) > (var_1_37)) ? ((var_1_36 + 1.15f)) : (var_1_37))) == 63.5f) {
    ...
    var_1_38 = (((((((((((-5) < 0 ) ? -(-5) : (-5))) < 0 ) ? -((((-5) < 0 ) ? -(-5) : (-5))) : ((((-5) < 0 ) ? -(-5) : (-5)))))) > ((var_1_15 - (var_1_41 + last_1_var_1_45)))) ? ((((((((-5) < 0 ) ? -(-5) : (-5))) < 0 ) ? -((((-5) < 0 ) ? -(-5) : (-5))) : ((((-5) < 0 ) ? -(-5) : (-5)))))) : ((var_1_15 - (var_1_41 + last_1_var_1_45)))));
   }
  }
 }
 if (var_1_10 < (- (- var_1_8))) {
 ...
 if (stepLocal_15 < last_1_var_1_45) {
  if ((var_1_34 - (var_1_1 + var_1_3)) <= stepLocal_16) {
   ...
   var_1_45 = (((((var_1_46 - var_1_3)) > (var_1_1)) ? ((var_1_46 - var_1_3)) : (var_1_1)));
  }
 }
 unsigned char stepLocal_5 = var_1_31;
 signed long int stepLocal_4 = (var_1_22 / var_1_7) & ((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3)));
 ...
 if (stepLocal_9 < var_1_24) {
  if (var_1_26 != stepLocal_11) {
   if ((var_1_29 - ((((var_1_3) > (var_1_4)) ? (var_1_3) : (var_1_4)))) > stepLocal_10) {
 ...
 if (var_1_3 != stepLocal_8) {
  var_1_23 = ((((((((var_1_38) < 0 ) ? -(var_1_38) : (var_1_38)))) > (var_1_4)) ? (((((var_1_38) < 0 ) ? -(var_1_38) : (var_1_38)))) : (var_1_4)));
 } else {
  var_1_23 = ((((((var_1_24) > (var_1_25)) ? (var_1_24) : (var_1_25))) + var_1_26) - (var_1_4 + var_1_14));
 }
 if (var_1_16) {
 ...
 if (var_1_27) {
  if (stepLocal_1 == ((var_1_43 * var_1_4) % var_1_7)) {
   ...
   if (var_1_16) {
    if ((var_1_43 / ((((var_1_6) < (var_1_7)) ? (var_1_6) : (var_1_7)))) != stepLocal_0) {
 ...
 signed long int stepLocal_18 = ((((var_1_4 - var_1_45)) > (2)) ? ((var_1_4 - var_1_45)) : (2));
