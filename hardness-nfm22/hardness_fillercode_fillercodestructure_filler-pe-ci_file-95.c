...
void step(void) {
	...
	// From: CodeObject3
	if (var_1_20 >= (var_1_6 / (abs (var_1_19)))) {
		var_1_26 = var_1_14;
	}
	...
	// From: CodeObject5
	if (((var_1_31 - var_1_32) + (var_1_14 / var_1_13)) < (abs (var_1_2))) {
		if (var_1_11 >= 10u) {
			if (var_1_8) {
				var_1_30 = (abs (abs (var_1_5)));
			} else {
				var_1_30 = (min ((max (var_1_5 , var_1_4)) , (var_1_7 + 64)));
			}
		} else {
			var_1_30 = (abs (var_1_7));
		}
	}
	...
	// From: CodeObject6
	if (var_1_24) {
		var_1_36 = (max (var_1_14 , (max (var_1_14 , (min (var_1_14 , 1.25f))))));
	}
