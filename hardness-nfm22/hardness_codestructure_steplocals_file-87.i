...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch87stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (((((var_1_7) < (var_1_2)) ? (var_1_7) : (var_1_2))) > var_1_18) {
 ...
 signed long int stepLocal_1 = (var_1_18 * -50) + var_1_5;
 if (var_1_6 <= stepLocal_1) {
  var_1_29 = var_1_30;
 }
 signed long int stepLocal_2 = var_1_18;
 if (! (! var_1_8)) {
  if ((var_1_32 - var_1_33) != stepLocal_2) {
   var_1_31 = var_1_32;
  }
 } else {
  var_1_31 = var_1_33;
...
int property() {
 return (((((((((var_1_2 - var_1_3) >= (var_1_5 - ((((var_1_6) < (var_1_7)) ? (var_1_6) : (var_1_7))))) ? (var_1_1 == ((unsigned char) (((var_1_4 || var_1_8) && var_1_9) || var_1_10))) : 1) && (var_1_11 == ((double) ((((((((var_1_12) > (var_1_13)) ? (var_1_12) : (var_1_13)))) > ((var_1_14 - (5.8647808160282102E18 - var_1_15)))) ? (((((var_1_12) > (var_1_13)) ? (var_1_12) : (var_1_13)))) : ((var_1_14 - (5.8647808160282102E18 - var_1_15)))))))) && (((var_1_3 % var_1_17) >= var_1_2) ? (var_1_16 == ((signed long int) ((var_1_17 + var_1_18) + (var_1_19 - var_1_20)))) : (var_1_4 ? (var_1_16 == ((signed long int) var_1_17)) : (var_1_16 == ((signed long int) var_1_17))))) && (var_1_21 == ((double) (var_1_22 - var_1_15)))) && ((((((var_1_7) < (var_1_2)) ? (var_1_7) : (var_1_2))) > var_1_18) ? ((var_1_19 != var_1_20) ? (var_1_23 == ((double) ((((var_1_13) < (var_1_22)) ? (var_1_13) : (var_1_22))))) : 1) : (var_1_23 == ((double) var_1_15)))) && (var_1_24 == ((float) (((((((((var_1_15) > (var_1_25)) ? (var_1_15) : (var_1_25)))) > (var_1_26)) ? (((((var_1_15) > (var_1_25)) ? (var_1_15) : (var_1_25)))) : (var_1_26))) + (var_1_27 + var_1_28))))) && ((var_1_6 <= ((var_1_18 * -50) + var_1_5)) ? (var_1_29 == ((signed short int) var_1_30)) : 1)) && ((! (! var_1_8)) ? (((var_1_32 - var_1_33) != var_1_18) ? (var_1_31 == ((signed long int) var_1_32)) : 1) : (var_1_31 == ((signed long int) var_1_33)))
;
}
int main(void) {
 isInitial = 1;
