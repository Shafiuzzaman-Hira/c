...
void step(void) {
	...
	if (last_1_var_1_26) {
		if (var_1_32 <= last_1_var_1_103) {
			var_1_46 = (last_1_var_1_59 + (var_1_20 + (abs (var_1_24))));
		} else {
			var_1_46 = (abs (abs (var_1_20)));
		}
	} else {
		if (stepLocal_5 && var_1_28) {
			var_1_46 = (max ((var_1_48 - var_1_22) , (min (var_1_25 , last_1_var_1_37))));
		} else {
	...
	if ((last_1_var_1_77 * last_1_var_1_72) <= var_1_39) {
		if ((var_1_22 - var_1_70) < last_1_var_1_89) {
			if ((- last_1_var_1_37) >= (- 16u)) {
				...
				var_1_72 = ((min (last_1_var_1_41 , 16)) + var_1_22);
			}
		} else {
			if (var_1_27) {
		...
		if (last_1_var_1_19 < 1000) {
			var_1_72 = (33993 - (max (var_1_68 , var_1_24)));
		}
	}
	...
	if (var_1_23 > stepLocal_25) {
		var_1_115 = ((max (var_1_50 , 4)) - (var_1_24 + 8));
	}
	...
	if (var_1_33 < (- (24.5f + var_1_34))) {
		...
		if ((var_1_42 && var_1_27) || stepLocal_13) {
			var_1_59 = ((min (var_1_25 , var_1_24)) + var_1_23);
		} else {
			var_1_59 = (max (var_1_22 , var_1_25));
		}
	}
	...
	signed long int stepLocal_19 = min ((var_1_89 + var_1_101) , var_1_25);
	if (-100 < stepLocal_19) {
		if (var_1_36 >= (var_1_35 * var_1_14)) {
			var_1_77 = var_1_21;
		} else {
			var_1_77 = (min ((var_1_22 - (var_1_69 + var_1_25)) , var_1_21));
		}
	}
	...
	if (var_1_11) {
		if (! (var_1_107 != var_1_112)) {
			...
			var_1_1 = ((min ((var_1_6 + var_1_7) , var_1_8)) - var_1_96);
		}
	} else {
		if (var_1_42) {
			var_1_1 = (min (var_1_7 , var_1_77));
		} else {
			var_1_1 = var_1_7;
		}
	}
	...
	if (var_1_31 < var_1_114) {
		var_1_61 = ((var_1_36 + (var_1_35 + var_1_62)) - (min (var_1_16 , var_1_31)));
	} else {
		var_1_61 = (min (var_1_16 , var_1_33));
	}


	// From: Req23Batch18Amount500
	unsigned long int stepLocal_18 = (abs (var_1_8)) - var_1_25;
	...
	if (stepLocal_17 > 32) {
		...
		if (var_1_17 == var_1_33) {
			if (stepLocal_18 >= var_1_98) {
				...
				var_1_66 = (var_1_25 + (abs (-10)));
			}
		} else {
			var_1_66 = ((max (var_1_25 , (var_1_68 + var_1_69))) - (max (var_1_70 , var_1_71)));
		}
	}
	...
	if (! var_1_26) {
		var_1_81 = (max (var_1_89 , (abs (var_1_19))));
	} else {
		if (! var_1_42) {
			if (stepLocal_20 == var_1_107) {
				var_1_81 = ((16 + (10000 - var_1_99)) - 64);
			} else {
				var_1_81 = (var_1_23 + (max (var_1_19 , var_1_83)));
			}
		} else {
			var_1_81 = ((var_1_84 - var_1_21) - (min (8 , var_1_22)));
		}
	}
	...
	if (-4 > var_1_1) {
		...
		if (var_1_26) {
			var_1_87 = (max (var_1_69 , (var_1_67 + var_1_25)));
		}
	}
	...
	if (var_1_45 < var_1_108) {
		...
		if (stepLocal_21 <= (abs (var_1_59))) {
			if (var_1_33 < (min ((var_1_15 + var_1_34) , var_1_36))) {
				var_1_85 = ((var_1_52 + var_1_86) - (max (2 , var_1_84)));
			}
		} else {
			var_1_85 = ((var_1_50 + (max (var_1_21 , var_1_113))) + (min (var_1_25 , (max (var_1_51 , var_1_59)))));
		}
	}


	// From: Req28Batch18Amount500
	if ((min (var_1_61 , var_1_114)) > (var_1_15 - var_1_31)) {
		var_1_79 = (min ((var_1_89 + (max (var_1_24 , var_1_66))) , var_1_23));
	} else {
	...
	unsigned long int stepLocal_11 = max (var_1_6 , (~ -4));
	unsigned char stepLocal_10 = var_1_11;
	if (stepLocal_10 || ((abs (var_1_23)) >= var_1_24)) {
		var_1_56 = (min (var_1_20 , 25u));
	} else {
		if (stepLocal_11 <= (var_1_77 * (max (var_1_52 , var_1_23)))) {
			if (stepLocal_12 > ((min (var_1_96 , var_1_50)) ^ var_1_85)) {
	...
	if ((var_1_60 > var_1_8) || stepLocal_16) {
		...
		var_1_63 = ((max ((min (var_1_8 , var_1_64)) , var_1_65)) - (min (var_1_79 , (max (var_1_19 , 256u)))));
	}
	...
	if (var_1_54 <= (var_1_17 * var_1_33)) {
		if (var_1_45 >= 16.75f) {
			var_1_57 = (abs (var_1_21));
		} else {
			var_1_57 = (min (128 , var_1_85));
		}
	} else {
		var_1_57 = var_1_50;
	}
	...
	if (stepLocal_23 <= ((var_1_91 - var_1_89) - (min (var_1_48 , var_1_79)))) {
		if ((var_1_64 % (min (var_1_50 , var_1_52))) < stepLocal_22) {
			var_1_90 = ((max ((var_1_15 - var_1_62) , var_1_34)) + var_1_93);
		} else {
			var_1_90 = (var_1_15 - (max (var_1_35 , var_1_17)));
		}
	} else {
	...
	if ((var_1_90 == var_1_53) && var_1_26) {
		...
		if (((var_1_79 / var_1_24) ^ -64) == var_1_21) {
			var_1_73 = ((var_1_21 + (max (var_1_67 , var_1_50))) + (var_1_105 - var_1_115));
		}
	}
	...
	if (var_1_13) {
		var_1_18 = (max ((abs (var_1_8 - var_1_101)) , (max ((var_1_7 + var_1_6) , var_1_46))));
	} else {
		if ((var_1_73 * last_1_var_1_18) < stepLocal_2) {
			var_1_18 = (min (var_1_7 , (min ((var_1_101 + var_1_6) , (max (32u , 1u))))));
		} else {
	...
	if (var_1_21 > var_1_25) {
		...
		if (((-8 << var_1_23) | var_1_111) < (var_1_7 * var_1_19)) {
			var_1_37 = ((min ((min (var_1_96 , var_1_39)) , var_1_22)) + var_1_6);
		} else {
	...
	if (var_1_96 >= var_1_49) {
		if (var_1_50 != (min ((max (var_1_49 , var_1_37)) , var_1_79))) {
			var_1_58 = (var_1_16 + (var_1_36 + var_1_35));
		} else {
			var_1_58 = (max (((min (4.25f , var_1_15)) - var_1_17) , (var_1_33 + var_1_35)));
		}
	} else {
		if (var_1_61 <= ((- var_1_36) / (min (var_1_45 , var_1_17)))) {
			var_1_58 = (max (var_1_36 , (min (var_1_31 , 127.1f))));
		} else {
			var_1_58 = (abs (var_1_34));
		}
	}
}
...
int property() {
	return ((((((((((((((((((((((((((((((((((((((((((((((((((((var_1_11 ? ((! (var_1_107 != var_1_112)) ? (var_1_1 == ((unsigned long int) var_1_77)) : (var_1_1 == ((unsigned long int) ((min ((var_1_6 + var_1_7) , var_1_8)) - var_1_96)))) : (var_1_42 ? (var_1_1 == ((unsigned long int) (min (var_1_7 , var_1_77)))) : (var_1_1 == ((unsigned long int) var_1_7)))) && ((var_1_41 < ((var_1_96 & var_1_6) / var_1_8)) ? (var_1_11 == ((unsigned char) (var_1_26 || (! var_1_13)))) : 1)) && ((var_1_89 >= var_1_7) ? (var_1_14 == ((float) (50.25f - (var_1_15 + var_1_16)))) : (var_1_14 == ((float) ((var_1_17 - (max (63.875f , var_1_15))) - var_1_16))))) && (var_1_13 ? (var_1_18 == ((unsigned long int) (max ((abs (var_1_8 - var_1_101)) , (max ((var_1_7 + var_1_6) , var_1_46)))))) : (((var_1_73 * last_1_var_1_18) < var_1_101) ? (var_1_18 == ((unsigned long int) (min (var_1_7 , (min ((var_1_101 + var_1_6) , (max (32u , 1u)))))))) : (var_1_18 == ((unsigned long int) (min ((max (var_1_8 , 8u)) , var_1_7))))))) && (var_1_13 ? (var_1_19 == ((unsigned char) (min (var_1_20 , var_1_21)))) : (var_1_19 == ((unsigned char) (var_1_22 - (max (var_1_23 , (var_1_24 - var_1_25)))))))) && (var_1_26 == ((unsigned char) (var_1_13 || ((var_1_27 || var_1_28) || var_1_29))))) && ((var_1_25 > var_1_115) ? ((! ((var_1_17 + var_1_90) > (var_1_16 - var_1_15))) ? (((var_1_16 * (var_1_17 / 128.75f)) > ((var_1_15 + var_1_31) - var_1_32)) ? (var_1_30 == ((float) (var_1_15 - var_1_31))) : (var_1_30 == ((float) ((max (var_1_15 , var_1_16)) + var_1_33)))) : (var_1_30 == ((float) (var_1_16 + (var_1_34 + (var_1_35 - var_1_36)))))) : 1)) && ((var_1_21 > var_1_25) ? ((1 >= var_1_20) ? ((var_1_20 <= (abs (var_1_6))) ? (var_1_37 == ((unsigned long int) ((var_1_7 + var_1_39) - var_1_21))) : (var_1_37 == ((unsigned long int) (var_1_8 - var_1_18)))) : (var_1_37 == ((unsigned long int) (min (var_1_21 , var_1_24))))) : ((((-8 << var_1_23) | var_1_111) < (var_1_7 * var_1_19)) ? (var_1_37 == ((unsigned long int) ((min ((min (var_1_96 , var_1_39)) , var_1_22)) + var_1_6))) : (var_1_37 == ((unsigned long int) (max ((max (var_1_21 , (var_1_22 + var_1_39))) , var_1_8))))))) && (((var_1_24 - 10) >= var_1_72) ? (var_1_41 == ((unsigned short int) var_1_24)) : 1)) && ((! (var_1_13 && (500 < var_1_72))) ? (var_1_42 == ((unsigned char) 1)) : (var_1_42 == ((unsigned char) var_1_43)))) && (((var_1_32 * var_1_35) < var_1_15) ? ((((var_1_32 + var_1_17) / var_1_45) <= var_1_36) ? ((((10.5f + var_1_35) * var_1_36) <= var_1_32) ? (var_1_44 == ((signed long int) (var_1_22 + var_1_23))) : (var_1_44 == ((signed long int) var_1_88))) : (var_1_44 == ((signed long int) (var_1_21 - (1 + var_1_102))))) : 1)) && (last_1_var_1_26 ? ((var_1_32 <= last_1_var_1_103) ? (var_1_46 == ((unsigned short int) (last_1_var_1_59 + (var_1_20 + (abs (var_1_24)))))) : (var_1_46 == ((unsigned short int) (abs (abs (var_1_20)))))) : ((var_1_29 && var_1_28) ? (var_1_46 == ((unsigned short int) (max ((var_1_48 - var_1_22) , (min (var_1_25 , last_1_var_1_37)))))) : (var_1_46 == ((unsigned short int) (min (var_1_23 , 16))))))) && ((var_1_85 >= var_1_20) ? ((((2412700709u - var_1_21) * var_1_111) != var_1_7) ? ((! var_1_43) ? (var_1_49 == ((unsigned short int) (min (var_1_23 , var_1_48)))) : ((var_1_77 > 16) ? (var_1_49 == ((unsigned short int) (var_1_20 + var_1_22))) : (var_1_49 == ((unsigned short int) (((var_1_50 + var_1_51) + (var_1_52 - var_1_25)) - (abs (var_1_24))))))) : (var_1_49 == ((unsigned short int) (abs (var_1_52))))) : 1)) && (((var_1_105 * var_1_24) > (var_1_8 - 16u)) ? (var_1_53 == ((float) (var_1_35 + var_1_16))) : (var_1_53 == ((float) (var_1_16 - (var_1_54 - var_1_15)))))) && (var_1_26 ? (var_1_55 == ((signed short int) var_1_50)) : 1)) && ((var_1_11 || ((abs (var_1_23)) >= var_1_24)) ? (var_1_56 == ((unsigned long int) (min (var_1_20 , 25u)))) : (((max (var_1_6 , (~ -4))) <= (var_1_77 * (max (var_1_52 , var_1_23)))) ? (((var_1_20 * var_1_88) > ((min (var_1_96 , var_1_50)) ^ var_1_85)) ? (var_1_56 == ((unsigned long int) (var_1_52 + var_1_23))) : (var_1_56 == ((unsigned long int) (128u + var_1_115)))) : (var_1_56 == ((unsigned long int) var_1_24))))) && ((var_1_54 <= (var_1_17 * var_1_33)) ? ((var_1_45 >= 16.75f) ? (var_1_57 == ((signed long int) (abs (var_1_21)))) : (var_1_57 == ((signed long int) (min (128 , var_1_85))))) : (var_1_57 == ((signed long int) var_1_50)))) && ((var_1_96 >= var_1_49) ? ((var_1_50 != (min ((max (var_1_49 , var_1_37)) , var_1_79))) ? (var_1_58 == ((float) (var_1_16 + (var_1_36 + var_1_35)))) : (var_1_58 == ((float) (max (((min (4.25f , var_1_15)) - var_1_17) , (var_1_33 + var_1_35)))))) : ((var_1_61 <= ((- var_1_36) / (min (var_1_45 , var_1_17)))) ? (var_1_58 == ((float) (max (var_1_36 , (min (var_1_31 , 127.1f)))))) : (var_1_58 == ((float) (abs (var_1_34))))))) && ((var_1_33 < (- (24.5f + var_1_34))) ? (var_1_59 == ((unsigned char) (var_1_22 - var_1_25))) : (((var_1_42 && var_1_27) || var_1_26) ? (var_1_59 == ((unsigned char) ((min (var_1_25 , var_1_24)) + var_1_23))) : (var_1_59 == ((unsigned char) (max (var_1_22 , var_1_25))))))) && ((last_1_var_1_57 != (4 * last_1_var_1_72)) ? (var_1_60 == ((unsigned long int) (abs (var_1_39)))) : 1)) && ((var_1_31 < var_1_114) ? (var_1_61 == ((double) ((var_1_36 + (var_1_35 + var_1_62)) - (min (var_1_16 , var_1_31))))) : (var_1_61 == ((double) (min (var_1_16 , var_1_33)))))) && (((var_1_60 > var_1_8) || var_1_43) ? (((var_1_101 - var_1_60) > var_1_85) ? (var_1_63 == ((unsigned long int) (var_1_7 + 10u))) : (var_1_63 == ((unsigned long int) var_1_50))) : (var_1_63 == ((unsigned long int) ((max ((min (var_1_8 , var_1_64)) , var_1_65)) - (min (var_1_79 , (max (var_1_19 , 256u))))))))) && ((var_1_111 > 32) ? (var_1_66 == ((signed char) (var_1_25 + var_1_67))) : ((var_1_17 == var_1_33) ? ((((abs (var_1_8)) - var_1_25) >= var_1_98) ? (var_1_66 == ((signed char) (abs (5)))) : (var_1_66 == ((signed char) (var_1_25 + (abs (-10)))))) : (var_1_66 == ((signed char) ((max (var_1_25 , (var_1_68 + var_1_69))) - (max (var_1_70 , var_1_71)))))))) && (((last_1_var_1_77 * last_1_var_1_72) <= var_1_39) ? (((var_1_22 - var_1_70) < last_1_var_1_89) ? (((- last_1_var_1_37) >= (- 16u)) ? (var_1_72 == ((unsigned short int) (var_1_48 - var_1_52))) : (var_1_72 == ((unsigned short int) ((min (last_1_var_1_41 , 16)) + var_1_22)))) : (var_1_27 ? (var_1_72 == ((unsigned short int) (var_1_48 - last_1_var_1_55))) : 1)) : ((last_1_var_1_19 < 1000) ? (var_1_72 == ((unsigned short int) (33993 - (max (var_1_68 , var_1_24))))) : 1))) && (((var_1_90 == var_1_53) && var_1_26) ? ((var_1_101 > var_1_72) ? (var_1_73 == ((signed long int) (var_1_72 - var_1_99))) : 1) : ((((var_1_79 / var_1_24) ^ -64) == var_1_21) ? (var_1_73 == ((signed long int) ((var_1_21 + (max (var_1_67 , var_1_50))) + (var_1_105 - var_1_115)))) : 1))) && (var_1_76 == ((double) (var_1_16 - var_1_36)))) && ((-100 < (min ((var_1_89 + var_1_101) , var_1_25))) ? ((var_1_36 >= (var_1_35 * var_1_14)) ? (var_1_77 == ((unsigned char) var_1_21)) : (var_1_77 == ((unsigned char) (min ((var_1_22 - (var_1_69 + var_1_25)) , var_1_21))))) : 1)) && (((min (var_1_61 , var_1_114)) > (var_1_15 - var_1_31)) ? (var_1_79 == ((signed long int) (min ((var_1_89 + (max (var_1_24 , var_1_66))) , var_1_23)))) : (var_1_79 == ((signed long int) (var_1_77 + (var_1_59 - var_1_22)))))) && ((! var_1_26) ? (var_1_81 == ((signed short int) (max (var_1_89 , (abs (var_1_19)))))) : ((! var_1_42) ? ((((var_1_41 / var_1_24) / var_1_83) == var_1_107) ? (var_1_81 == ((signed short int) ((16 + (10000 - var_1_99)) - 64))) : (var_1_81 == ((signed short int) (var_1_23 + (max (var_1_19 , var_1_83)))))) : (var_1_81 == ((signed short int) ((var_1_84 - var_1_21) - (min (8 , var_1_22)))))))) && ((var_1_45 < var_1_108) ? (var_1_85 == ((unsigned short int) (var_1_60 + (24137 - var_1_70)))) : ((var_1_98 <= (abs (var_1_59))) ? ((var_1_33 < (min ((var_1_15 + var_1_34) , var_1_36))) ? (var_1_85 == ((unsigned short int) ((var_1_52 + var_1_86) - (max (2 , var_1_84))))) : 1) : (var_1_85 == ((unsigned short int) ((var_1_50 + (max (var_1_21 , var_1_113))) + (min (var_1_25 , (max (var_1_51 , var_1_59)))))))))) && ((-4 > var_1_1) ? (var_1_87 == ((signed char) -4)) : (var_1_26 ? (var_1_87 == ((signed char) (max (var_1_69 , (var_1_67 + var_1_25))))) : 1))) && (var_1_88 == ((signed short int) var_1_22))) && ((! last_1_var_1_11) ? ((! last_1_var_1_42) ? (var_1_89 == ((unsigned char) (min ((max (var_1_21 , 2)) , 5)))) : (var_1_89 == ((unsigned char) (50 + var_1_25)))) : ((! ((last_1_var_1_11 || last_1_var_1_11) && (last_1_var_1_97 >= last_1_var_1_105))) ? (var_1_89 == ((unsigned char) (var_1_70 + (var_1_69 + var_1_25)))) : 1))) && ((var_1_46 <= ((var_1_91 - var_1_89) - (min (var_1_48 , var_1_79)))) ? (((var_1_64 % (min (var_1_50 , var_1_52))) < var_1_105) ? (var_1_90 == ((float) ((max ((var_1_15 - var_1_62) , var_1_34)) + var_1_93))) : (var_1_90 == ((float) (var_1_15 - (max (var_1_35 , var_1_17)))))) : (var_1_90 == ((float) (var_1_16 - var_1_94))))) && ((var_1_86 >= ((var_1_69 + var_1_89) * var_1_98)) ? (var_1_95 == ((double) (max (256.8 , var_1_33)))) : (var_1_28 ? (var_1_95 == ((double) var_1_36)) : 1))) && (var_1_96 == ((unsigned short int) var_1_88))) && (var_1_97 == ((signed char) var_1_25))) && (var_1_98 == ((signed short int) var_1_19))) && (var_1_28 ? (var_1_99 == ((unsigned long int) last_1_var_1_99)) : (var_1_99 == ((unsigned long int) var_1_60)))) && (var_1_100 == ((signed short int) var_1_21))) && (var_1_101 == ((unsigned short int) var_1_86))) && (var_1_11 ? (var_1_102 == ((unsigned long int) var_1_19)) : (var_1_102 == ((unsigned long int) var_1_70)))) && (var_1_26 ? (var_1_103 == ((float) var_1_15)) : (var_1_103 == ((float) var_1_104)))) && (var_1_42 ? (var_1_105 == ((unsigned char) 50)) : 1)) && (var_1_107 == ((unsigned long int) var_1_25))) && (var_1_108 == ((float) var_1_33))) && (var_1_11 ? (var_1_109 == ((double) var_1_62)) : (var_1_109 == ((double) 63.4)))) && (var_1_27 ? (var_1_110 == ((signed char) var_1_69)) : 1)) && (var_1_43 ? (var_1_111 == ((signed short int) var_1_83)) : 1)) && (var_1_112 == ((signed char) var_1_70))) && (var_1_113 == ((signed char) var_1_67))) && (var_1_114 == ((double) (var_1_94 - (var_1_17 - var_1_62))))) && ((var_1_23 > (var_1_39 * var_1_8)) ? (var_1_115 == ((signed short int) ((max (var_1_50 , 4)) - (var_1_24 + 8)))) : 1)
;
}
int main(void) {
	isInitial = 1;
