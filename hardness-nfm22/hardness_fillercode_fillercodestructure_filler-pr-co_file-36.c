...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch36Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject5
	if (var_1_27 < ((min (var_1_24 , var_1_17)) / var_1_42)) {
	...
	// From: CodeObject2
	if (((var_1_24 ^ 8) * var_1_27) <= var_1_8) {
		var_1_28 = (abs (min ((max (var_1_30 , var_1_31)) , var_1_32)));
	}


	// From: Req7Batch36Filler_PR_CO
	...
	// From: CodeObject6
	if (((min (var_1_27 , var_1_8)) >> (var_1_44 - 4u)) >= var_1_42) {
