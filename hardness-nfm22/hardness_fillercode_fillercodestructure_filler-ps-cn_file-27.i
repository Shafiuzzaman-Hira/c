...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch27Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_26 >= var_1_25) {
  var_1_31 = ((((var_1_25) > (((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28))))) ? (var_1_25) : (((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28))))));
 }
 ...
 if (((((var_1_26) < (var_1_33)) ? (var_1_26) : (var_1_33))) < (var_1_39 + var_1_27)) {
