...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch9PS_CN_100.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_26 >= var_1_31) {
  var_1_39 = (var_1_25 + ((((var_1_33) < 0 ) ? -(var_1_33) : (var_1_33))));
 } else {
  var_1_39 = ((((((var_1_32) > (var_1_26)) ? (var_1_32) : (var_1_26))) - var_1_31) + (var_1_33 - ((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25)))));
 }
 if (var_1_20) {
  var_1_40 = ((((var_1_23) < 0 ) ? -(var_1_23) : (var_1_23)));
 }
 if (var_1_30) {
  var_1_41 = ((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36)));
 }
 if ((var_1_34 / var_1_32) != (var_1_26 + var_1_33)) {
  if (((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))) < var_1_38) {
   var_1_42 = var_1_34;
  } else {
   var_1_42 = ((((25 + var_1_34) < 0 ) ? -(25 + var_1_34) : (25 + var_1_34)));
  }
 } else {
  var_1_42 = ((((var_1_32) < (100)) ? (var_1_32) : (100)));
 }
