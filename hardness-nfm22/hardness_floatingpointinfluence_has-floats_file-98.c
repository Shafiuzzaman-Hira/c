...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch98has_floats.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch98has_floats
	var_1_1 = (var_1_2 - var_1_3);


	// From: Req4Batch98has_floats
