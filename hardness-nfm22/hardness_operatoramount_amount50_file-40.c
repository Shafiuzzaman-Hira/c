...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch40Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req9Batch40Amount50
	var_1_26 = var_1_12;


	// From: Req4Batch40Amount50
	var_1_16 = (min (((max (256 , var_1_12)) + var_1_12) , var_1_15));


	// From: Req8Batch40Amount50
	var_1_25 = var_1_20;


	// From: Req6Batch40Amount50
