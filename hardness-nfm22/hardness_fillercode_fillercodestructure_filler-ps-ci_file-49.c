...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch49Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject3
	if ((var_1_21 % (min (var_1_23 , var_1_23))) < var_1_19) {
	...
	// From: CodeObject4
	if ((var_1_21 <= (max (100 , var_1_8))) || ((- var_1_23) <= var_1_23)) {
		var_1_31 = var_1_21;
	} else {
		var_1_31 = var_1_23;
	}
	...
	if (var_1_19 >= var_1_20) {
		var_1_32 = ((max (var_1_33 , var_1_34)) - (abs (var_1_17)));
	} else {
	...
	// From: CodeObject6
	if ((abs (var_1_23)) > var_1_21) {
		var_1_36 = (max (var_1_18 , var_1_33));
	}
	...
	// From: CodeObject8
	if ((var_1_23 >> (min (var_1_40 , var_1_41))) >= -64) {
