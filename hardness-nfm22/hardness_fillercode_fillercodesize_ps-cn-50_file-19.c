...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch19PS_CN_50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch19PS_CN_50
	if (last_1_var_1_15) {
		var_1_10 = (var_1_12 || var_1_13);
	}


	// From: Req7Batch19PS_CN_50
	if (var_1_10) {
	...
	// From: Req5Batch19PS_CN_50
	if ((- var_1_24) == (var_1_24 + var_1_24)) {
		var_1_15 = var_1_12;
	}


	// From: Req6Batch19PS_CN_50
	...
	// From: Req8Batch19PS_CN_50
	if (var_1_24 != var_1_24) {
		var_1_29 = (max (var_1_2 , var_1_3));
	}


	// From: Req2Batch19PS_CN_50
	...
	// From: Req4Batch19PS_CN_50
	if (var_1_15) {
		var_1_14 = (min ((abs (max (var_1_3 , var_1_2))) , var_1_9));
	}


	// From: Req1Batch19PS_CN_50
