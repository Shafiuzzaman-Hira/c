...
void step(void) {
	...
	// From: CodeObject3
	var_1_35 = (max (var_1_28 , (max (8.9f , (var_1_27 - var_1_27)))));


	// From: Req5Batch19Filler_PR_CI
	...
	if ((~ var_1_3) < (var_1_3 * var_1_9)) {
		if (var_1_12) {
			var_1_39 = (min ((var_1_28 - (abs (var_1_28))) , (min (var_1_27 , var_1_26))));
		} else {
	...
	// From: CodeObject6
	if (var_1_10) {
		if (((~ var_1_3) ^ var_1_3) < ((var_1_9 | var_1_7) % (min (var_1_7 , var_1_2)))) {
	...
	// From: Req8Batch19Filler_PR_CI
	if (var_1_24 != var_1_24) {
		var_1_29 = (max (var_1_2 , var_1_3));
	}


	// From: Req2Batch19Filler_PR_CI
	...
	// From: CodeObject2
	var_1_32 = ((abs (var_1_3)) + var_1_3);


	// From: Req4Batch19Filler_PR_CI
	if (var_1_15) {
	...
	// From: CodeObject7
	if (var_1_27 >= (abs (var_1_21))) {
		var_1_47 = var_1_13;
	} else {
		if (2 >= (var_1_7 * (abs (var_1_9)))) {
			var_1_47 = 0;
		} else {
			var_1_47 = var_1_49;
		}
