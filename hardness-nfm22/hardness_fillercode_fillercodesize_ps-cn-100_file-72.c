...
void step(void) {
	...
	if (((var_1_45 + var_1_35) - var_1_36) > var_1_46) {
		var_1_49 = (max ((var_1_36 + -4) , var_1_46));
	} else {
		var_1_49 = (abs (var_1_45));
	}
	...
	// From: CodeObject8
	if (! ((abs (var_1_35)) >= (var_1_32 / 5))) {
		var_1_52 = (256 + (var_1_45 + var_1_47));
	} else {
		var_1_52 = (min ((abs (var_1_46)) , var_1_47));
	}
	...
	// From: CodeObject10
	if ((min (var_1_40 , var_1_39)) > (abs (var_1_56))) {
	...
	// From: Req8Batch72PS_CN_100
	var_1_31 = var_1_26;


	// From: Req7Batch72PS_CN_100
	var_1_29 = var_1_1;
}
