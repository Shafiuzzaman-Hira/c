...
int property() {
	return (((((- last_1_var_1_10) / var_1_3) != (last_1_var_1_10 / var_1_5)) ? ((last_1_var_1_10 != ((max (var_1_6 , var_1_7)) - var_1_8)) ? (var_1_1 == ((float) var_1_9)) : (var_1_1 == ((float) var_1_9))) : (var_1_1 == ((float) 64.51f))) && ((var_1_1 > (max ((var_1_9 * 128.4) , (var_1_5 * var_1_1)))) ? (var_1_10 == ((float) 1.00000000000004E13f)) : (var_1_10 == ((float) var_1_9)))) && ((! (var_1_3 <= var_1_10)) ? (var_1_11 == ((unsigned char) (var_1_12 && var_1_13))) : (((var_1_7 / var_1_3) < (min ((max (var_1_8 , var_1_6)) , var_1_5))) ? (var_1_11 == ((unsigned char) var_1_14)) : 1))
;
}
int main(void) {
	isInitial = 1;
