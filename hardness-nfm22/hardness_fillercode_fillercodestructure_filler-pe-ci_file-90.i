...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch90Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_26 = var_1_12;
 if (var_1_20) {
  if (var_1_12 < ((((((((var_1_14) < (var_1_24)) ? (var_1_14) : (var_1_24)))) > ((var_1_13 / var_1_4))) ? (((((var_1_14) < (var_1_24)) ? (var_1_14) : (var_1_24)))) : ((var_1_13 / var_1_4))))) {
 ...
 if (var_1_42 <= ((var_1_41 >> var_1_40) % var_1_3)) {
  var_1_46 = var_1_40;
 }
 if (var_1_20) {
  var_1_47 = ((var_1_42 + var_1_12) + ((((var_1_39) < ((var_1_48 - var_1_41))) ? (var_1_39) : ((var_1_48 - var_1_41)))));
 }
 if (var_1_3 >= (-1000 << var_1_12)) {
  if (var_1_12 > (var_1_39 | var_1_48)) {
