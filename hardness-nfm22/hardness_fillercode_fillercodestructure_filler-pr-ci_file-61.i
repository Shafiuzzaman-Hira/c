...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch61Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_35 <= 64.5) && var_1_18) {
  var_1_40 = ((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8)));
 } else {
  var_1_40 = var_1_36;
 }
 var_1_22 = var_1_23;
 ...
 if (var_1_17) {
  var_1_43 = ((((((((-16) < 0 ) ? -(-16) : (-16)))) > (var_1_23)) ? (((((-16) < 0 ) ? -(-16) : (-16)))) : (var_1_23)));
 }
 ...
 if (var_1_20 < ((var_1_4 + 16u) * var_1_9)) {
  if (var_1_18 && (var_1_35 < var_1_36)) {
   if (var_1_18) {
    if (var_1_9 <= var_1_5) {
     var_1_38 = (! var_1_39);
    }
 ...
 if (var_1_16 < var_1_9) {
  var_1_42 = ((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15)));
 }
 ...
 if (var_1_5 != var_1_14) {
  if ((~ var_1_20) != (-50 >> var_1_5)) {
   var_1_26 = (((((var_1_15) > (var_1_20)) ? (var_1_15) : (var_1_20))) + (((((((var_1_16) > (var_1_16)) ? (var_1_16) : (var_1_16))) < 0 ) ? -((((var_1_16) > (var_1_16)) ? (var_1_16) : (var_1_16))) : ((((var_1_16) > (var_1_16)) ? (var_1_16) : (var_1_16))))));
  } else {
   var_1_26 = ((((var_1_15 + var_1_16) < 0 ) ? -(var_1_15 + var_1_16) : (var_1_15 + var_1_16)));
  }
 } else {
  var_1_26 = 16u;
 }
