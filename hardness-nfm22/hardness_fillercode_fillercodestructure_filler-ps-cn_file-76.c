...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch76Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_28 < var_1_32) {
		...
		if ((- var_1_22) > var_1_21) {
			if (var_1_21 >= var_1_22) {
				var_1_34 = (abs (abs (var_1_35 - var_1_36)));
			} else {
				var_1_34 = var_1_29;
			}
		}
	...
	// From: CodeObject9
	if ((max (var_1_32 , var_1_30)) <= ((var_1_28 & var_1_36) & var_1_35)) {
