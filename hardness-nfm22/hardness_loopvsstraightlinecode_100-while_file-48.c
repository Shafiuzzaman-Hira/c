...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch48100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch48100_while
	var_1_8 = ((var_1_9 - var_1_10) + var_1_11);


	// From: Req5Batch48100_while
	if (var_1_3) {
