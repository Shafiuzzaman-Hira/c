...
void step(void) {
	...
	// From: Req5Batch31100_1loop
	if (! (! (last_1_var_1_7 && last_1_var_1_24))) {
		if (last_1_var_1_7) {
			var_1_15 = (max (last_1_var_1_33 , last_1_var_1_23));
		} else {
			var_1_15 = (min ((var_1_16 - var_1_6) , 10));
		}
	} else {
	...
	// From: Req4Batch31100_1loop
	var_1_14 = (var_1_6 + var_1_15);


	// From: Req9Batch31100_1loop
	unsigned char stepLocal_9 = last_1_var_1_7;
	if (! last_1_var_1_24) {
		if (stepLocal_9 && (last_1_var_1_33 >= (min (last_1_var_1_17 , var_1_4)))) {
	...
	// From: Req11Batch31100_1loop
	var_1_32 = var_1_29;


	// From: Req12Batch31100_1loop
	var_1_33 = var_1_22;


	// From: Req13Batch31100_1loop
	var_1_34 = var_1_29;


	// From: Req3Batch31100_1loop
	...
	// From: Req8Batch31100_1loop
	if (var_1_14 < var_1_13) {
		var_1_23 = (min ((var_1_14 + var_1_16) , (min ((var_1_18 - var_1_14) , -128))));
	} else {
		var_1_23 = var_1_18;
	}


	// From: Req6Batch31100_1loop
