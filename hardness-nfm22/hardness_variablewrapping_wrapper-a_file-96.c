...
void step(void) {
	// From: Req1Batch96Wrapper_A
	if (! last_1_BOOL_unsigned_char_Array_0_3_) {
		unsigned_short_int_Array_0[2] = (min (unsigned_short_int_Array_0[1] , unsigned_short_int_Array_0[0]));
	} else {
		unsigned_short_int_Array_0[2] = unsigned_short_int_Array_0[0];
	}


	// From: Req2Batch96Wrapper_A
	...
	// From: Req4Batch96Wrapper_A
	signed_long_int_Array_0[0] = unsigned_short_int_Array_0[2];


	// From: Req5Batch96Wrapper_A
	float_Array_0[0] = double_Array_0[0];


	// From: Req6Batch96Wrapper_A
	signed_char_Array_0[0] = signed_char_Array_0[1];


	// From: Req3Batch96Wrapper_A
	if ((abs (signed_long_int_Array_0[0])) > signed_long_int_Array_0[0]) {
		if ((signed_long_int_Array_0[0] / -5) >= ((unsigned_short_int_Array_0[0] + signed_long_int_Array_0[0]) - (min (unsigned_short_int_Array_0[2] , unsigned_short_int_Array_0[1])))) {
...
int property() {
	return ((((((! last_1_BOOL_unsigned_char_Array_0_3_) ? (unsigned_short_int_Array_0[2] == ((unsigned short int) (min (unsigned_short_int_Array_0[1] , unsigned_short_int_Array_0[0])))) : (unsigned_short_int_Array_0[2] == ((unsigned short int) unsigned_short_int_Array_0[0]))) && (BOOL_unsigned_char_Array_0[4] ? ((BOOL_unsigned_char_Array_0[2] && ((unsigned_short_int_Array_0[1] >= 16) || last_1_BOOL_unsigned_char_Array_0_3_)) ? (BOOL_unsigned_char_Array_0[2] ? (BOOL_unsigned_char_Array_0[3] == ((unsigned char) ((unsigned_short_int_Array_0[2] < unsigned_short_int_Array_0[2]) && BOOL_unsigned_char_Array_0[0]))) : (BOOL_unsigned_char_Array_0[3] == ((unsigned char) BOOL_unsigned_char_Array_0[1]))) : 1) : 1)) && (((abs (signed_long_int_Array_0[0])) > signed_long_int_Array_0[0]) ? (((signed_long_int_Array_0[0] / -5) >= ((unsigned_short_int_Array_0[0] + signed_long_int_Array_0[0]) - (min (unsigned_short_int_Array_0[2] , unsigned_short_int_Array_0[1])))) ? (double_Array_0[1] == ((double) (double_Array_0[0] + double_Array_0[2]))) : (double_Array_0[1] == ((double) double_Array_0[2]))) : 1)) && (signed_long_int_Array_0[0] == ((signed long int) unsigned_short_int_Array_0[2]))) && (float_Array_0[0] == ((float) double_Array_0[0]))) && (signed_char_Array_0[0] == ((signed char) signed_char_Array_0[1]))
;
}
int main(void) {
	isInitial = 1;
