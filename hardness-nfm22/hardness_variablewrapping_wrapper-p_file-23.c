...
void step(void) {
	// From: Req1Batch23Wrapper_P
	(*(var_1_1_Pointer)) = (min ((*(var_1_2_Pointer)) , (*(var_1_3_Pointer))));


	// From: Req2Batch23Wrapper_P
	if (((*(var_1_5_Pointer)) / (*(var_1_6_Pointer))) <= ((*(var_1_7_Pointer)) + ((*(var_1_8_Pointer)) - (*(var_1_9_Pointer))))) {
		(*(var_1_4_Pointer)) = (min ((*(var_1_2_Pointer)) , (*(var_1_3_Pointer))));
	}


	// From: Req3Batch23Wrapper_P
	(*(var_1_10_Pointer)) = (max ((*(var_1_2_Pointer)) , (((*(var_1_11_Pointer)) + (*(var_1_12_Pointer))) - (*(var_1_13_Pointer)))));


	// From: Req5Batch23Wrapper_P
