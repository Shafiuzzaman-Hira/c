...
void step(void) {
 ...
 if ((var_1_6 / var_1_6) < (var_1_14 | var_1_6)) {
  ...
  var_1_25 = ((((var_1_4) < (0)) ? (var_1_4) : (0)));
 }
 var_1_17 = var_1_4;
 if (var_1_11 == var_1_12) {
  var_1_20 = ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4)));
 }
 if (((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8))) > ((((128.5f) < (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))))) ? (128.5f) : (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))))))) {
  var_1_24 = ((((var_1_17) > (var_1_4)) ? (var_1_17) : (var_1_4)));
 }
 if (var_1_4 < ((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6)))) {
  if (((((var_1_12) > (var_1_11)) ? (var_1_12) : (var_1_11))) == ((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11)))) {
   if (-50 <= var_1_6) {
    var_1_31 = (var_1_33 - ((((var_1_34 - var_1_35) < 0 ) ? -(var_1_34 - var_1_35) : (var_1_34 - var_1_35))));
   } else {
    var_1_31 = ((((var_1_33) > (25)) ? (var_1_33) : (25)));
   }
  } else {
   if (var_1_15) {
    var_1_31 = var_1_34;
