...
void step(void) {
	...
	// From: Req3Batch75PS_CN_50
	if (! (var_1_4 < 16.8f)) {
		var_1_15 = var_1_6;
	}


	// From: Req7Batch75PS_CN_50
	var_1_25 = var_1_23;


	// From: Req2Batch75PS_CN_50
