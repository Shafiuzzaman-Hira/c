...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch15100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch15100_1loop
	var_1_22 = 0;


	// From: Req12Batch15100_1loop
	var_1_33 = var_1_10;


	// From: Req1Batch15100_1loop
	if (var_1_22) {
		var_1_1 = ((var_1_3 + var_1_4) + 8);
	}


	// From: Req4Batch15100_1loop
