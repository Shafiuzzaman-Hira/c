...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch16dependencies.c", 13, "reach_error"); }
...
void step(void) {
 if ((last_1_var_1_23 / -50) >= last_1_var_1_11) {
  if (var_1_4) {
 ...
 if (((var_1_9 + var_1_23) * var_1_9) < (var_1_5 | var_1_6)) {
  if (var_1_4) {
   var_1_11 = var_1_8;
  }
 } else {
