...
void step(void) {
	...
	// From: CodeObject8
	if (var_1_1 != (abs (var_1_7))) {
		if ((abs (127.4)) < var_1_7) {
			if (var_1_10) {
				var_1_41 = var_1_16;
			}
		} else {
	...
	// From: Req3Batch82Filler_PR_CO
	var_1_10 = (var_1_11 && (var_1_21 || var_1_13));


	// From: CodeObject3
	if (var_1_10) {
		if ((abs (var_1_25)) <= var_1_1) {
			if ((min ((var_1_27 % var_1_30) , var_1_16)) < (var_1_16 * (var_1_14 | var_1_23))) {
				if ((max (var_1_25 , var_1_1)) >= (var_1_1 * var_1_1)) {
					var_1_28 = var_1_25;
				}
			}
		} else {
