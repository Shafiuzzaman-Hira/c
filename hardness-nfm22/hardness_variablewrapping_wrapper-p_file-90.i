...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch90Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
 ...
 signed long int stepLocal_0 = ((((*(var_1_3_Pointer))) < ((*(var_1_5_Pointer)))) ? ((*(var_1_3_Pointer))) : ((*(var_1_5_Pointer))));
 ...
 if ((*(var_1_6_Pointer)) <= (*(var_1_7_Pointer))) {
  if ((*(var_1_15_Pointer)) > (*(var_1_6_Pointer))) {
 ...
 if ((*(var_1_2_Pointer))) {
  ...
  (*(var_1_10_Pointer)) = ((! (*(var_1_13_Pointer))) || (*(var_1_12_Pointer)));
 }
 (*(var_1_14_Pointer)) = (((((*(var_1_3_Pointer))) > (((*(var_1_15_Pointer)) - 256))) ? ((*(var_1_3_Pointer))) : (((*(var_1_15_Pointer)) - 256))));
 if ((*(var_1_10_Pointer))) {
  (*(var_1_1_Pointer)) = ((((((*(var_1_3_Pointer)) + (*(var_1_4_Pointer)))) < ((*(var_1_5_Pointer)))) ? (((*(var_1_3_Pointer)) + (*(var_1_4_Pointer)))) : ((*(var_1_5_Pointer)))));
 }
}
...
int property() {
 return (((((*(var_1_10_Pointer)) ? ((*(var_1_1_Pointer)) == ((signed short int) ((((((*(var_1_3_Pointer)) + (*(var_1_4_Pointer)))) < ((*(var_1_5_Pointer)))) ? (((*(var_1_3_Pointer)) + (*(var_1_4_Pointer)))) : ((*(var_1_5_Pointer))))))) : 1) && ((last_1_var_1_14 != (((((*(var_1_3_Pointer))) < ((*(var_1_5_Pointer)))) ? ((*(var_1_3_Pointer))) : ((*(var_1_5_Pointer)))))) ? ((((*(var_1_7_Pointer)) - (*(var_1_8_Pointer))) >= last_1_var_1_16) ? (last_1_var_1_10 ? ((*(var_1_6_Pointer)) == ((unsigned long int) (*(var_1_8_Pointer)))) : ((*(var_1_6_Pointer)) == ((unsigned long int) (*(var_1_8_Pointer))))) : ((*(var_1_6_Pointer)) == ((unsigned long int) (*(var_1_8_Pointer))))) : ((*(var_1_6_Pointer)) == ((unsigned long int) (*(var_1_8_Pointer)))))) && ((*(var_1_2_Pointer)) ? ((*(var_1_10_Pointer)) == ((unsigned char) ((*(var_1_11_Pointer)) || (! (*(var_1_12_Pointer)))))) : ((*(var_1_10_Pointer)) == ((unsigned char) ((! (*(var_1_13_Pointer))) || (*(var_1_12_Pointer))))))) && ((*(var_1_14_Pointer)) == ((signed short int) (((((*(var_1_3_Pointer))) > (((*(var_1_15_Pointer)) - 256))) ? ((*(var_1_3_Pointer))) : (((*(var_1_15_Pointer)) - 256))))))) && (((*(var_1_6_Pointer)) <= (*(var_1_7_Pointer))) ? (((*(var_1_15_Pointer)) > (*(var_1_6_Pointer))) ? ((*(var_1_16_Pointer)) == ((signed long int) (*(var_1_15_Pointer)))) : 1) : 1)
;
}
int main(void) {
 isInitial = 1;
