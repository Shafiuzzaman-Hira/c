...
void step(void) {
	...
	// From: Req13Batch62Amount250
	if (9.5f != var_1_44) {
		if ((last_1_var_1_63 / var_1_46) > last_1_var_1_42) {
			if (var_1_14 < (last_1_var_1_63 * (var_1_6 / var_1_46))) {
				var_1_53 = ((min (var_1_51 , (var_1_10 - var_1_35))) + last_1_var_1_17);
			}
		}
	}


	// From: Req23Batch62Amount250
	if (last_1_var_1_53 < (var_1_33 % var_1_58)) {
		var_1_74 = (max (var_1_51 , var_1_52));
	} else {
		var_1_74 = var_1_51;
	}


	// From: Req8Batch62Amount250
	unsigned char stepLocal_7 = last_1_var_1_65;
	if (stepLocal_7 && last_1_var_1_65) {
		if (var_1_4 == last_1_var_1_62) {
			var_1_30 = (min ((max (var_1_32 , (var_1_33 - var_1_34))) , (var_1_35 - 32)));
		} else {
			var_1_30 = (abs (var_1_34));
		}
	} else {
	...
	// From: Req7Batch62Amount250
	signed long int stepLocal_6 = var_1_75 ^ var_1_75;
	if (-64 >= stepLocal_6) {
		var_1_29 = (min (var_1_30 , var_1_25));
	}


	// From: Req17Batch62Amount250
	if (var_1_1 != var_1_60) {
	...
	// From: Req3Batch62Amount250
	if ((min (var_1_4 , var_1_6)) <= (var_1_13 - var_1_14)) {
		var_1_12 = (var_1_15 - var_1_16);
	} else {
		var_1_12 = (max ((var_1_6 + var_1_5) , var_1_4));
	}


	// From: Req6Batch62Amount250
	if (var_1_65) {
		var_1_28 = (var_1_6 + var_1_5);
	}


	// From: Req11Batch62Amount250
	var_1_43 = (((min (9.999999999999996E14 , var_1_44)) + (abs (100.6))) - var_1_16);


	// From: Req14Batch62Amount250
	var_1_54 = (var_1_36 - (var_1_33 + var_1_32));


	// From: Req15Batch62Amount250
	if (var_1_6 <= var_1_46) {
		var_1_55 = (min (var_1_5 , (min (var_1_44 , (max (4.8 , var_1_4))))));
	} else {
		var_1_55 = (255.5 - (var_1_44 + var_1_56));
	}


	// From: Req21Batch62Amount250
	var_1_69 = (var_1_59 - ((var_1_70 + var_1_71) - var_1_56));


	// From: Req25Batch62Amount250
	if (last_1_var_1_76) {
		var_1_76 = var_1_77;
	} else {
		var_1_76 = var_1_77;
	...
	// From: Req26Batch62Amount250
	if (var_1_47 < var_1_36) {
		var_1_78 = (((abs (var_1_44)) - 1.5f) + (var_1_61 - var_1_59));
	} else {
		var_1_78 = var_1_5;
	}


	// From: Req9Batch62Amount250
	unsigned long int stepLocal_9 = var_1_10;
	signed long int stepLocal_8 = 10;
	if (stepLocal_9 <= var_1_75) {
		var_1_37 = ((var_1_25 + (max (var_1_29 , var_1_53))) - var_1_33);
	} else {
	...
	// From: Req10Batch62Amount250
	signed long int stepLocal_10 = var_1_37;
	if (stepLocal_10 < (max (var_1_32 , var_1_9))) {
		if (! var_1_65) {
			var_1_42 = (min ((max ((var_1_5 + var_1_6) , (min (var_1_16 , var_1_4)))) , var_1_15));
		} else {
			var_1_42 = var_1_4;
		}
	} else {
	...
	// From: Req4Batch62Amount250
	unsigned long int stepLocal_3 = min (8u , var_1_74);
	if ((var_1_75 + var_1_10) < stepLocal_3) {
		var_1_17 = var_1_30;
	}


	// From: Req2Batch62Amount250
	unsigned long int stepLocal_2 = var_1_29 - var_1_75;
	unsigned long int stepLocal_1 = var_1_29;
	if (32 > stepLocal_1) {
		if ((- var_1_75) != stepLocal_2) {
			var_1_7 = (min ((min (5u , var_1_75)) , var_1_75));
		} else {
			var_1_7 = (var_1_9 - 32u);
		}
	} else {
		var_1_7 = (min ((max (var_1_75 , (var_1_75 + var_1_29))) , (var_1_9 - (var_1_10 - var_1_17))));
	}


	// From: Req12Batch62Amount250
	if (var_1_76) {
		if (var_1_16 <= (var_1_14 / var_1_46)) {
			...
			if ((min (var_1_36 , var_1_35)) > var_1_30) {
				var_1_45 = var_1_47;
			} else {
				var_1_45 = (var_1_48 + 4);
			}
		...
		if (var_1_76) {
			var_1_45 = (max (var_1_47 , ((min (var_1_48 , var_1_49)) + var_1_50)));
		} else {
	...
	if (stepLocal_12 != (var_1_17 / var_1_35)) {
		if (stepLocal_11 > var_1_53) {
			if (stepLocal_13 < (var_1_58 - var_1_30)) {
				var_1_57 = ((max (var_1_56 , var_1_44)) - ((max (var_1_59 , var_1_60)) + var_1_61));
			}
		}
	}


	// From: Req18Batch62Amount250
	signed long int stepLocal_17 = abs (var_1_32);
	...
	if (var_1_65 || stepLocal_14) {
		if (var_1_61 >= (- var_1_43)) {
			var_1_63 = (abs (var_1_5));
		}
	} else {
		if (stepLocal_16 <= var_1_75) {
			if (stepLocal_15 || var_1_65) {
				var_1_63 = (max (var_1_6 , var_1_44));
			} else {
	...
	// From: Req20Batch62Amount250
	unsigned long int stepLocal_19 = (min (var_1_7 , var_1_49)) / (max (var_1_35 , var_1_58));
	if (stepLocal_19 <= var_1_45) {
		if (var_1_67) {
			var_1_68 = ((max (var_1_25 , var_1_36)) - (var_1_39 - 5));
		}
	}


	// From: Req22Batch62Amount250
	if (((var_1_51 + var_1_73) - var_1_52) == var_1_33) {
		var_1_72 = ((max (var_1_51 , var_1_73)) + (min (var_1_50 , 8)));
	} else {
		if (var_1_17 != var_1_51) {
			var_1_72 = ((abs (var_1_49)) + var_1_50);
		} else {
			var_1_72 = var_1_47;
		}
	}
...
int property() {
	return ((((((((((((((((((((((((((var_1_74 >= var_1_30) ? (var_1_1 == ((double) (abs ((max (var_1_4 , var_1_5)) + var_1_6)))) : (var_1_1 == ((double) (var_1_4 + var_1_5)))) && ((32 > var_1_29) ? (((- var_1_75) != (var_1_29 - var_1_75)) ? (var_1_7 == ((unsigned long int) (min ((min (5u , var_1_75)) , var_1_75)))) : (var_1_7 == ((unsigned long int) (var_1_9 - 32u)))) : (var_1_7 == ((unsigned long int) (min ((max (var_1_75 , (var_1_75 + var_1_29))) , (var_1_9 - (var_1_10 - var_1_17)))))))) && (((min (var_1_4 , var_1_6)) <= (var_1_13 - var_1_14)) ? (var_1_12 == ((double) (var_1_15 - var_1_16))) : (var_1_12 == ((double) (max ((var_1_6 + var_1_5) , var_1_4)))))) && (((var_1_75 + var_1_10) < (min (8u , var_1_74))) ? (var_1_17 == ((unsigned short int) var_1_30)) : 1)) && ((var_1_65 && var_1_76) ? (var_1_19 == ((signed short int) (var_1_45 + (min (var_1_75 , var_1_45))))) : (((8 + var_1_45) == var_1_45) ? (var_1_19 == ((signed short int) ((var_1_25 - var_1_30) - var_1_30))) : 1))) && (var_1_65 ? (var_1_28 == ((float) (var_1_6 + var_1_5))) : 1)) && ((-64 >= (var_1_75 ^ var_1_75)) ? (var_1_29 == ((unsigned long int) (min (var_1_30 , var_1_25)))) : 1)) && ((last_1_var_1_65 && last_1_var_1_65) ? ((var_1_4 == last_1_var_1_62) ? (var_1_30 == ((unsigned char) (min ((max (var_1_32 , (var_1_33 - var_1_34))) , (var_1_35 - 32))))) : (var_1_30 == ((unsigned char) (abs (var_1_34))))) : (var_1_30 == ((unsigned char) (var_1_34 + var_1_36))))) && ((var_1_10 <= var_1_75) ? (var_1_37 == ((signed long int) ((var_1_25 + (max (var_1_29 , var_1_53))) - var_1_33))) : ((last_1_var_1_37 <= 10) ? (var_1_37 == ((signed long int) ((var_1_74 + var_1_36) - var_1_75))) : 1))) && ((var_1_37 < (max (var_1_32 , var_1_9))) ? ((! var_1_65) ? (var_1_42 == ((double) (min ((max ((var_1_5 + var_1_6) , (min (var_1_16 , var_1_4)))) , var_1_15)))) : (var_1_42 == ((double) var_1_4))) : (var_1_42 == ((double) var_1_16)))) && (var_1_43 == ((double) (((min (9.999999999999996E14 , var_1_44)) + (abs (100.6))) - var_1_16)))) && (var_1_76 ? ((var_1_16 <= (var_1_14 / var_1_46)) ? ((((var_1_74 + var_1_37) + var_1_17) >= var_1_17) ? (var_1_45 == ((signed char) var_1_47)) : 1) : (((min (var_1_36 , var_1_35)) > var_1_30) ? (var_1_45 == ((signed char) var_1_47)) : (var_1_45 == ((signed char) (var_1_48 + 4))))) : (var_1_76 ? (var_1_45 == ((signed char) (max (var_1_47 , ((min (var_1_48 , var_1_49)) + var_1_50))))) : (var_1_45 == ((signed char) ((2 + var_1_51) - var_1_52)))))) && ((9.5f != var_1_44) ? (((last_1_var_1_63 / var_1_46) > last_1_var_1_42) ? ((var_1_14 < (last_1_var_1_63 * (var_1_6 / var_1_46))) ? (var_1_53 == ((unsigned long int) ((min (var_1_51 , (var_1_10 - var_1_35))) + last_1_var_1_17))) : 1) : 1) : 1)) && (var_1_54 == ((signed short int) (var_1_36 - (var_1_33 + var_1_32))))) && ((var_1_6 <= var_1_46) ? (var_1_55 == ((double) (min (var_1_5 , (min (var_1_44 , (max (4.8 , var_1_4)))))))) : (var_1_55 == ((double) (255.5 - (var_1_44 + var_1_56)))))) && ((var_1_37 != (var_1_17 / var_1_35)) ? ((var_1_49 > var_1_53) ? ((var_1_29 < (var_1_58 - var_1_30)) ? (var_1_57 == ((float) ((max (var_1_56 , var_1_44)) - ((max (var_1_59 , var_1_60)) + var_1_61)))) : 1) : 1) : 1)) && ((var_1_1 != var_1_60) ? (var_1_62 == ((float) (var_1_60 - var_1_44))) : (var_1_62 == ((float) (var_1_4 + var_1_5))))) && ((var_1_65 || var_1_65) ? ((var_1_61 >= (- var_1_43)) ? (var_1_63 == ((float) (abs (var_1_5)))) : 1) : (((var_1_75 / var_1_33) <= var_1_75) ? (((var_1_69 < var_1_14) || var_1_65) ? (var_1_63 == ((float) (max (var_1_6 , var_1_44)))) : (var_1_63 == ((float) (var_1_56 - var_1_61)))) : (((abs (var_1_32)) > (var_1_39 + -32)) ? ((var_1_61 > var_1_56) ? (var_1_63 == ((float) (var_1_60 - var_1_61))) : 1) : (var_1_63 == ((float) 7.25f)))))) && ((last_1_var_1_75 <= ((var_1_48 + var_1_32) | var_1_35)) ? (var_1_65 == ((unsigned char) (last_1_var_1_76 || var_1_66))) : (var_1_65 == ((unsigned char) (((var_1_5 != last_1_var_1_43) || var_1_66) && var_1_67))))) && ((((min (var_1_7 , var_1_49)) / (max (var_1_35 , var_1_58))) <= var_1_45) ? (var_1_67 ? (var_1_68 == ((signed long int) ((max (var_1_25 , var_1_36)) - (var_1_39 - 5)))) : 1) : 1)) && (var_1_69 == ((float) (var_1_59 - ((var_1_70 + var_1_71) - var_1_56))))) && ((((var_1_51 + var_1_73) - var_1_52) == var_1_33) ? (var_1_72 == ((signed char) ((max (var_1_51 , var_1_73)) + (min (var_1_50 , 8))))) : ((var_1_17 != var_1_51) ? (var_1_72 == ((signed char) ((abs (var_1_49)) + var_1_50))) : (var_1_72 == ((signed char) var_1_47))))) && ((last_1_var_1_53 < (var_1_33 % var_1_58)) ? (var_1_74 == ((unsigned short int) (max (var_1_51 , var_1_52)))) : (var_1_74 == ((unsigned short int) var_1_51)))) && (var_1_65 ? (var_1_75 == ((unsigned char) var_1_73)) : (var_1_75 == ((unsigned char) var_1_34)))) && (last_1_var_1_76 ? (var_1_76 == ((unsigned char) var_1_77)) : (var_1_76 == ((unsigned char) var_1_77)))) && ((var_1_47 < var_1_36) ? (var_1_78 == ((float) (((abs (var_1_44)) - 1.5f) + (var_1_61 - var_1_59)))) : (var_1_78 == ((float) var_1_5)))
;
}
int main(void) {
	isInitial = 1;
