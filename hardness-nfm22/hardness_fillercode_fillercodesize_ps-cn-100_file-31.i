...
void step(void) {
 ...
 if (var_1_24 || (-64 <= -10)) {
  var_1_53 = ((((((((var_1_54) < 0 ) ? -(var_1_54) : (var_1_54))) - (var_1_50 + var_1_46)) < 0 ) ? -(((((var_1_54) < 0 ) ? -(var_1_54) : (var_1_54))) - (var_1_50 + var_1_46)) : (((((var_1_54) < 0 ) ? -(var_1_54) : (var_1_54))) - (var_1_50 + var_1_46))));
 } else {
  var_1_53 = ((((5) < 0 ) ? -(5) : (5)));
 }
 if (var_1_27 < var_1_22) {
  var_1_55 = ((((((var_1_48) < 0 ) ? -(var_1_48) : (var_1_48))) <= (var_1_50 - var_1_42)) && var_1_25);
 } else {
