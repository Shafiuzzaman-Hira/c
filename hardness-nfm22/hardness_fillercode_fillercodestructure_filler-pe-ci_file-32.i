...
void step(void) {
 ...
 var_1_23 = var_1_8;
 var_1_24 = var_1_6;
 if (var_1_13 < ((((var_1_20) < ((var_1_13 >> var_1_5))) ? (var_1_20) : ((var_1_13 >> var_1_5))))) {
  if (var_1_13 > var_1_20) {
   var_1_25 = var_1_6;
  } else {
   if (((var_1_5 ^ var_1_13) >> var_1_13) > ((((var_1_20) < 0 ) ? -(var_1_20) : (var_1_20)))) {
    var_1_25 = ((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)));
   }
  }
 } else {
  if ((var_1_5 - var_1_7) <= (~ (var_1_32 - var_1_5))) {
   var_1_25 = ((((var_1_6) > (var_1_7)) ? (var_1_6) : (var_1_7)));
  } else {
   var_1_25 = -32;
  }
 }
 ...
 if ((var_1_12 / ((((var_1_42) > (256.5)) ? (var_1_42) : (256.5)))) < var_1_11) {
  var_1_41 = var_1_5;
 }
 if ((((((var_1_18) < (var_1_11)) ? (var_1_18) : (var_1_11))) >= (var_1_12 / var_1_42)) || var_1_16) {
  if (var_1_16 || var_1_15) {
   var_1_43 = ((((99.65) < 0 ) ? -(99.65) : (99.65)));
  }
 }
