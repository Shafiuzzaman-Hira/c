...
void step(void) {
 ...
 if ((*(var_1_3_Pointer)) != stepLocal_2) {
  (*(var_1_6_Pointer)) = (((((*(var_1_7_Pointer)) - (((((*(var_1_8_Pointer))) > ((*(var_1_9_Pointer)))) ? ((*(var_1_8_Pointer))) : ((*(var_1_9_Pointer)))))) < 0 ) ? -((*(var_1_7_Pointer)) - (((((*(var_1_8_Pointer))) > ((*(var_1_9_Pointer)))) ? ((*(var_1_8_Pointer))) : ((*(var_1_9_Pointer)))))) : ((*(var_1_7_Pointer)) - (((((*(var_1_8_Pointer))) > ((*(var_1_9_Pointer)))) ? ((*(var_1_8_Pointer))) : ((*(var_1_9_Pointer))))))));
 }
...
int property() {
 return (((! (-50 < (*(var_1_6_Pointer)))) ? (((*(var_1_6_Pointer)) != (*(var_1_6_Pointer))) ? (((*(var_1_6_Pointer)) <= (*(var_1_6_Pointer))) ? ((*(var_1_1_Pointer)) == ((unsigned char) (*(var_1_4_Pointer)))) : 1) : ((*(var_1_1_Pointer)) == ((unsigned char) (*(var_1_5_Pointer))))) : 1) && (((*(var_1_3_Pointer)) != (*(var_1_2_Pointer))) ? ((*(var_1_6_Pointer)) == ((unsigned char) (((((*(var_1_7_Pointer)) - (((((*(var_1_8_Pointer))) > ((*(var_1_9_Pointer)))) ? ((*(var_1_8_Pointer))) : ((*(var_1_9_Pointer)))))) < 0 ) ? -((*(var_1_7_Pointer)) - (((((*(var_1_8_Pointer))) > ((*(var_1_9_Pointer)))) ? ((*(var_1_8_Pointer))) : ((*(var_1_9_Pointer)))))) : ((*(var_1_7_Pointer)) - (((((*(var_1_8_Pointer))) > ((*(var_1_9_Pointer)))) ? ((*(var_1_8_Pointer))) : ((*(var_1_9_Pointer)))))))))) : 1)) && ((((*(var_1_8_Pointer)) * ((*(var_1_6_Pointer)) + (*(var_1_6_Pointer)))) <= (*(var_1_9_Pointer))) ? (((128 + (*(var_1_9_Pointer))) < ((*(var_1_6_Pointer)) * ((*(var_1_6_Pointer)) + (*(var_1_6_Pointer))))) ? ((*(var_1_10_Pointer)) == ((unsigned char) ((*(var_1_4_Pointer)) || (! ((*(var_1_5_Pointer)) && (*(var_1_12_Pointer))))))) : ((*(var_1_10_Pointer)) == ((unsigned char) (*(var_1_5_Pointer))))) : ((*(var_1_10_Pointer)) == ((unsigned char) (*(var_1_12_Pointer)))))
;
}
int main(void) {
 isInitial = 1;
