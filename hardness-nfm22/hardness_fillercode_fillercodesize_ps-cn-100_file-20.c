...
void step(void) {
	...
	// From: CodeObject4
	if (var_1_20 < (min ((max (var_1_19 , var_1_28)) , (min (63.5f , var_1_30))))) {
	...
	// From: CodeObject6
	if (var_1_31 != ((var_1_25 + var_1_27) / (min (var_1_36 , var_1_37)))) {
		if ((max ((var_1_33 - var_1_31) , 5)) >= (min (var_1_34 , var_1_24))) {
			var_1_35 = (min (var_1_38 , (abs (var_1_39))));
		} else {
			var_1_35 = 0;
		}
	} else {
	...
	// From: CodeObject7
	if (((min (var_1_33 , 0)) <= var_1_34) && var_1_23) {
		var_1_41 = var_1_20;
	}
	...
	if ((var_1_43 - var_1_44) >= var_1_28) {
		if ((max (var_1_31 , (var_1_33 + var_1_34))) > (var_1_39 + var_1_35)) {
	...
	if (((var_1_49 + var_1_42) * var_1_47) >= var_1_48) {
		if (var_1_49 < (var_1_30 * var_1_20)) {
			var_1_50 = (min (16 , var_1_35));
		} else {
			var_1_50 = (var_1_32 - (abs (-256)));
		}
	}
	...
	if (var_1_49 <= var_1_47) {
		if (var_1_22) {
			var_1_51 = (var_1_32 - (var_1_52 - (min (var_1_33 , var_1_45))));
		} else {
			var_1_51 = (abs (var_1_36));
		}
	}


	// From: CodeObject11
	if ((var_1_34 & var_1_37) <= ((max (var_1_33 , var_1_38)) | (max (var_1_21 , var_1_27)))) {
		if (var_1_21 >= var_1_40) {
			var_1_53 = 5.05;
		}
	} else {
		if (var_1_47 > (abs (var_1_49))) {
			var_1_53 = (max (var_1_48 , (var_1_47 - 15.625)));
		}
	}
	...
	// From: Req5Batch20PS_CN_100
	var_1_15 = (var_1_14 + var_1_16);


	// From: Req6Batch20PS_CN_100
	if (var_1_2) {
