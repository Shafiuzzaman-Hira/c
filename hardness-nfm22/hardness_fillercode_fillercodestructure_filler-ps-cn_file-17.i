...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch17Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_25 > (var_1_37 >> var_1_23)) {
  if (var_1_28) {
   var_1_39 = ((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37)));
  } else {
   var_1_39 = (((((256 - (var_1_40 - var_1_38))) > (var_1_37)) ? ((256 - (var_1_40 - var_1_38))) : (var_1_37)));
  }
 } else {
  var_1_39 = var_1_35;
 }
