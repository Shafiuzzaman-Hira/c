...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch32stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch32stepLocals
	if (-32 < var_1_3) {
		var_1_1 = (((var_1_4 - var_1_5) + var_1_6) - (var_1_7 + (abs (var_1_8))));
	}


	// From: Req2Batch32stepLocals
	if ((var_1_10 + (max (var_1_3 , var_1_6))) == var_1_5) {
	...
	// From: Req3Batch32stepLocals
	if ((var_1_12 * (min (var_1_9 , var_1_11))) > (- var_1_14)) {
		if (var_1_6 <= var_1_8) {
			if (var_1_2) {
				var_1_13 = var_1_8;
			} else {
	...
	// From: Req6Batch32stepLocals
	if (var_1_11 == var_1_18) {
		var_1_20 = ((var_1_5 + var_1_21) + var_1_8);
	}


	// From: Req7Batch32stepLocals
	var_1_22 = var_1_12;


	// From: Req8Batch32stepLocals
	var_1_23 = var_1_8;


	// From: Req9Batch32stepLocals
	var_1_24 = var_1_6;
}
...
int property() {
	return (((((((((-32 < var_1_3) ? (var_1_1 == ((unsigned char) (((var_1_4 - var_1_5) + var_1_6) - (var_1_7 + (abs (var_1_8)))))) : 1) && (((var_1_10 + (max (var_1_3 , var_1_6))) == var_1_5) ? (var_1_9 == ((float) ((4.5f + var_1_11) - var_1_12))) : (var_1_9 == ((float) var_1_12)))) && (((var_1_12 * (min (var_1_9 , var_1_11))) > (- var_1_14)) ? ((var_1_6 <= var_1_8) ? (var_1_2 ? (var_1_13 == ((signed short int) var_1_8)) : (var_1_13 == ((signed short int) var_1_5))) : 1) : 1)) && ((var_1_5 >= var_1_6) ? ((var_1_13 <= var_1_10) ? (var_1_15 == ((unsigned char) var_1_16)) : ((var_1_2 || var_1_16) ? (var_1_15 == ((unsigned char) var_1_17)) : 1)) : (var_1_15 == ((unsigned char) var_1_17)))) && ((var_1_17 || var_1_15) ? ((var_1_15 && var_1_2) ? (var_1_18 == ((float) (var_1_11 + var_1_19))) : (var_1_18 == ((float) var_1_19))) : 1)) && ((var_1_11 == var_1_18) ? (var_1_20 == ((signed char) ((var_1_5 + var_1_21) + var_1_8))) : 1)) && (var_1_22 == ((double) var_1_12))) && (var_1_23 == ((unsigned long int) var_1_8))) && (var_1_24 == ((unsigned long int) var_1_6))
;
}
int main(void) {
	isInitial = 1;
