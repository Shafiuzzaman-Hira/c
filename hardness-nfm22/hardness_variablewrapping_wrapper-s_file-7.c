...
void step(void) {
	...
	if (WrapperStruct00.var_1_8) {
		if (WrapperStruct00.var_1_10 && (WrapperStruct00.var_1_4 <= WrapperStruct00.var_1_7)) {
			if ((max (WrapperStruct00.var_1_4 , WrapperStruct00.var_1_11)) > WrapperStruct00.var_1_7) {
				WrapperStruct00.var_1_12 = (max (((3725801564u - WrapperStruct00.var_1_6) - WrapperStruct00.var_1_1) , WrapperStruct00.var_1_9));
			} else {
