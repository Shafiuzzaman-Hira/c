...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch31PS_CN_100.c", 13, "reach_error"); }
...
unsigned short int var_1_54 = 65472;
...
void step(void) {
	...
	// From: CodeObject10
	if (var_1_24 || (-64 <= -10)) {
		var_1_53 = (abs ((abs (var_1_54)) - (var_1_50 + var_1_46)));
	} else {
		var_1_53 = (abs (5));
	}
	...
	if (var_1_27 < var_1_22) {
		var_1_55 = (((abs (var_1_48)) <= (var_1_50 - var_1_42)) && var_1_25);
	} else {
		var_1_55 = (var_1_26 || var_1_56);
	}


	// From: Req2Batch31PS_CN_100
	var_1_8 = (min ((var_1_5 + (64 - 16)) , 64));


	// From: Req4Batch31PS_CN_100
	...
	// From: Req6Batch31PS_CN_100
	var_1_17 = var_1_13;


	// From: Req7Batch31PS_CN_100
