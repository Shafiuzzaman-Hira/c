...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch62dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch62dependencies
	if (var_1_10 || var_1_20) {
		var_1_19 = (max (var_1_21 , 32));
	}


	// From: Req7Batch62dependencies
	if (var_1_10) {
	...
	// From: Req1Batch62dependencies
	if (var_1_19 > ((var_1_3 % var_1_4) * var_1_19)) {
