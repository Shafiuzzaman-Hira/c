...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch86Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_10 / (var_1_30 + var_1_31)) >= var_1_27) {
  if (var_1_19 || ((var_1_27 >> var_1_26) > (var_1_30 | 10))) {
 ...
 var_1_32 = var_1_25;
 var_1_33 = var_1_16;
 if (-2 >= (var_1_1 & var_1_26)) {
  var_1_34 = ((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28)));
 } else {
  var_1_34 = (((((((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31)))) < (var_1_28)) ? (((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31)))) : (var_1_28))) + var_1_30);
 }
 if (((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22))) > (~ (var_1_30 % var_1_31))) {
  if (var_1_28 >= 2) {
   var_1_35 = ((((var_1_31) > (var_1_28)) ? (var_1_31) : (var_1_28)));
  } else {
   var_1_35 = var_1_31;
  }
 }
 if (((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30))) <= (-2 ^ var_1_25)) {
  var_1_36 = var_1_28;
 } else {
  if ((var_1_10 ^ var_1_28) >= var_1_25) {
   var_1_36 = -2;
  }
 }
