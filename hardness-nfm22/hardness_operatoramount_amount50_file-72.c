...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch72Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch72Amount50
	var_1_17 = (var_1_18 && var_1_19);


	// From: Req4Batch72Amount50
	if (! var_1_18) {
		var_1_20 = (max (var_1_21 , var_1_22));
	}


	// From: Req6Batch72Amount50
	if (256 >= var_1_10) {
	...
	// From: Req8Batch72Amount50
	var_1_31 = var_1_26;


	// From: Req1Batch72Amount50
