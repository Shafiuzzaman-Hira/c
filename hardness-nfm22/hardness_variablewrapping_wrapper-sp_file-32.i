...
void step(void) {
 if (last_1_WrapperStruct00_var_1_6 >= -50) {
  (*(WrapperStruct00_var_1_1_Pointer)) = ((((((*(WrapperStruct00_var_1_3_Pointer)) + (((((*(WrapperStruct00_var_1_4_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_4_Pointer))) : ((*(WrapperStruct00_var_1_4_Pointer))))))) > ((*(WrapperStruct00_var_1_5_Pointer)))) ? (((*(WrapperStruct00_var_1_3_Pointer)) + (((((*(WrapperStruct00_var_1_4_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_4_Pointer))) : ((*(WrapperStruct00_var_1_4_Pointer))))))) : ((*(WrapperStruct00_var_1_5_Pointer)))));
 }
 ...
 if ((*(WrapperStruct00_var_1_4_Pointer)) <= stepLocal_2) {
  if ((*(WrapperStruct00_var_1_1_Pointer)) < stepLocal_1) {
   ...
   (*(WrapperStruct00_var_1_11_Pointer)) = (((((((*(WrapperStruct00_var_1_8_Pointer)) + (*(WrapperStruct00_var_1_3_Pointer))) - (*(WrapperStruct00_var_1_12_Pointer)))) > (100)) ? ((((*(WrapperStruct00_var_1_8_Pointer)) + (*(WrapperStruct00_var_1_3_Pointer))) - (*(WrapperStruct00_var_1_12_Pointer)))) : (100)));
  }
 } else {
