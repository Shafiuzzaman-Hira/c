...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch2450_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch2450_1loop
	var_1_23 = var_1_24;


	// From: Req3Batch2450_1loop
	if (128u >= var_1_8) {
		if (! var_1_23) {
