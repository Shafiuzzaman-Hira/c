...
void step(void) {
	...
	// From: CodeObject5
	if (((var_1_31 - var_1_32) + (var_1_14 / var_1_13)) < (abs (var_1_14))) {
		if (var_1_5 >= 10u) {
			if (var_1_8) {
				var_1_30 = (abs (abs (var_1_11)));
			} else {
				var_1_30 = (min ((max (var_1_11 , var_1_4)) , (var_1_5 + 64)));
			}
		} else {
			var_1_30 = (abs (var_1_5));
		}
	}
	...
	// From: CodeObject3
	if (var_1_20 >= (var_1_5 / (abs (var_1_19)))) {
		var_1_26 = var_1_14;
	}
