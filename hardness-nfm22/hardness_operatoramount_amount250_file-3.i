...
void step(void) {
 ...
 if (var_1_60 >= stepLocal_14) {
  ...
  if (! var_1_27) {
   var_1_56 = (((((((((var_1_25 - 0.25)) < (var_1_15)) ? ((var_1_25 - 0.25)) : (var_1_15)))) > (var_1_17)) ? ((((((var_1_25 - 0.25)) < (var_1_15)) ? ((var_1_25 - 0.25)) : (var_1_15)))) : (var_1_17)));
  } else {
   if (var_1_28) {
    var_1_56 = (((((var_1_25) < (var_1_16)) ? (var_1_25) : (var_1_16))) + (var_1_17 - var_1_26));
   } else {
    var_1_56 = ((((var_1_13) > (var_1_42)) ? (var_1_13) : (var_1_42)));
   }
  }
 }
 if (var_1_5 > (var_1_60 >> (var_1_46 - var_1_47))) {
  var_1_45 = ((((2) < ((36840 - var_1_21))) ? (2) : ((36840 - var_1_21))));
 } else {
  if (((- 32) >= var_1_60) || ((var_1_4 % var_1_8) >= 16)) {
   if (last_1_var_1_45 >= var_1_33) {
    var_1_45 = ((((((((var_1_46) < (var_1_54)) ? (var_1_46) : (var_1_54)))) > (var_1_9)) ? (((((var_1_46) < (var_1_54)) ? (var_1_46) : (var_1_54)))) : (var_1_9)));
   }
  } else {
   var_1_45 = (last_1_var_1_45 + var_1_47);
  }
 }
 unsigned char stepLocal_4 = ((((var_1_45) > (var_1_21)) ? (var_1_45) : (var_1_21))) >= 2;
 ...
 if (stepLocal_12 != (var_1_7 | (var_1_19 - var_1_5))) {
  var_1_53 = ((((var_1_7) < (var_1_6)) ? (var_1_7) : (var_1_6)));
 } else {
  var_1_53 = ((((2u + var_1_45) < 0 ) ? -(2u + var_1_45) : (2u + var_1_45)));
 }
 ...
 signed long int stepLocal_7 = (((var_1_54) < (var_1_60)) ? (var_1_54) : (var_1_60));
 if (stepLocal_7 != (((((var_1_21) < (var_1_32)) ? (var_1_21) : (var_1_32))) / var_1_8)) {
  var_1_34 = (((((var_1_8) > ((var_1_35 - var_1_9))) ? (var_1_8) : ((var_1_35 - var_1_9)))) - var_1_36);
 } else {
  var_1_34 = var_1_6;
 }
 signed long int stepLocal_3 = (var_1_6 | var_1_9) * var_1_34;
 if (((((((((var_1_8) > (var_1_4)) ? (var_1_8) : (var_1_4)))) < ((var_1_60 * var_1_7))) ? (((((var_1_8) > (var_1_4)) ? (var_1_8) : (var_1_4)))) : ((var_1_60 * var_1_7)))) <= stepLocal_3) {
  var_1_18 = (((((var_1_60) < 0 ) ? -(var_1_60) : (var_1_60))) + var_1_7);
 } else {
 ...
 if (stepLocal_11 <= var_1_8) {
  var_1_43 = (((((((((var_1_25) > (var_1_26)) ? (var_1_25) : (var_1_26))) + var_1_15)) < (9999.25f)) ? ((((((var_1_25) > (var_1_26)) ? (var_1_25) : (var_1_26))) + var_1_15)) : (9999.25f)));
 }
 ...
 if (var_1_6 <= -8) {
  if (var_1_27 || (var_1_5 == var_1_6)) {
   ...
   var_1_24 = ((((((var_1_16 + var_1_15)) > (((((-0.25) < 0 ) ? -(-0.25) : (-0.25))))) ? ((var_1_16 + var_1_15)) : (((((-0.25) < 0 ) ? -(-0.25) : (-0.25)))))) + (var_1_17 - (var_1_25 + var_1_26)));
  }
 } else {
  if (var_1_49) {
   var_1_24 = var_1_13;
 ...
 if (var_1_26 >= var_1_13) {
  var_1_57 = (((var_1_58 + var_1_59) + ((((var_1_16) > (var_1_26)) ? (var_1_16) : (var_1_26)))) + ((((var_1_14) > (var_1_25)) ? (var_1_14) : (var_1_25))));
 } else {
  if (0u <= var_1_54) {
   if (var_1_49) {
 ...
 if (((((var_1_13) > (var_1_43)) ? (var_1_13) : (var_1_43))) < var_1_25) {
  if (var_1_49) {
   var_1_31 = ((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9)));
  } else {
 ...
 if (var_1_43 <= ((var_1_41 - var_1_17) - var_1_26)) {
  var_1_40 = (((((var_1_17 - var_1_26)) < (var_1_13)) ? ((var_1_17 - var_1_26)) : (var_1_13)));
 } else {
  if (var_1_49) {
   if (stepLocal_10 < var_1_5) {
    var_1_40 = ((((((((var_1_14) < (var_1_26)) ? (var_1_14) : (var_1_26)))) > ((((((var_1_25) > (var_1_16)) ? (var_1_25) : (var_1_16))) + var_1_17))) ? (((((var_1_14) < (var_1_26)) ? (var_1_14) : (var_1_26)))) : ((((((var_1_25) > (var_1_16)) ? (var_1_25) : (var_1_16))) + var_1_17))));
   } else {
    if (stepLocal_9 <= var_1_37) {
     var_1_40 = ((((var_1_16) > (((((var_1_26) < (var_1_25)) ? (var_1_26) : (var_1_25))))) ? (var_1_16) : (((((var_1_26) < (var_1_25)) ? (var_1_26) : (var_1_25))))));
    } else {
     var_1_40 = ((((var_1_42) < (((((var_1_25) < (((((var_1_16) < (var_1_17)) ? (var_1_16) : (var_1_17))))) ? (var_1_25) : (((((var_1_16) < (var_1_17)) ? (var_1_16) : (var_1_17)))))))) ? (var_1_42) : (((((var_1_25) < (((((var_1_16) < (var_1_17)) ? (var_1_16) : (var_1_17))))) ? (var_1_25) : (((((var_1_16) < (var_1_17)) ? (var_1_16) : (var_1_17)))))))));
    }
   }
  } else {
   var_1_40 = var_1_25;
