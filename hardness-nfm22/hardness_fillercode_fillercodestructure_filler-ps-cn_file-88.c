...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch88Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject4
	if (((min (var_1_37 , var_1_38)) / 8.6f) <= (abs (var_1_39))) {
	...
	if (var_1_31 != var_1_28) {
		...
		var_1_43 = (var_1_34 + (abs (var_1_35)));
	}
