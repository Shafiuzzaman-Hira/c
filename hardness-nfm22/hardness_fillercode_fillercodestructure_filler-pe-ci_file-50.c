...
void step(void) {
	// From: Req3Batch50Filler_PE_CI
	if (var_1_8) {
		var_1_13 = (min ((var_1_14 + var_1_15) , (min (-0.2f , var_1_16))));
	}


	// From: Req6Batch50Filler_PE_CI
	if (var_1_8) {
		var_1_25 = (var_1_26 + var_1_27);
	}


	// From: Req8Batch50Filler_PE_CI
	var_1_29 = var_1_27;


	// From: Req9Batch50Filler_PE_CI
	var_1_30 = var_1_8;


	// From: Req2Batch50Filler_PE_CI
	...
	// From: Req4Batch50Filler_PE_CI
	var_1_17 = ((var_1_18 - 25) - var_1_25);


	// From: Req5Batch50Filler_PE_CI
	...
	// From: CodeObject2
	if (! var_1_7) {
		var_1_33 = (max (var_1_14 , (var_1_36 - var_1_37)));
	}


	// From: CodeObject3
	var_1_38 = (max (var_1_27 , var_1_27));
	...
	if (var_1_36 <= var_1_16) {
		if ((abs (var_1_16 + var_1_37)) < var_1_36) {
			var_1_44 = (min (31.35 , (min (var_1_37 , var_1_36))));
		}
	} else {
		var_1_44 = var_1_36;
	}
	...
	if ((var_1_14 * (var_1_46 - var_1_47)) < var_1_14) {
		if ((abs (max (var_1_27 , var_1_27))) > (min (var_1_18 , (256 + var_1_25)))) {
			var_1_45 = (min (var_1_37 , var_1_14));
		}
	} else {
		var_1_45 = (abs (min ((max (var_1_14 , var_1_36)) , var_1_37)));
	}
