...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch57Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((-1 - var_1_33) < ((var_1_1 / var_1_34) & var_1_20)) {
  if ((- ((((var_1_20) < 0 ) ? -(var_1_20) : (var_1_20)))) < (var_1_34 >> var_1_33)) {
   var_1_32 = var_1_33;
  } else {
   var_1_32 = var_1_33;
  }
 ...
 if (var_1_21 < ((var_1_29 / var_1_37) + var_1_21)) {
  if (((var_1_21 >= var_1_29) && var_1_25) && (var_1_31 <= ((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21))))) {
