...
void step(void) {
	...
	// From: Req8Batch61Filler_PR_CI
	var_1_22 = var_1_23;


	// From: Req1Batch61Filler_PR_CI
	...
	// From: CodeObject7
	if (var_1_16 < var_1_9) {
		var_1_42 = (abs (var_1_15));
	}


	// From: Req3Batch61Filler_PR_CI
	...
	if (var_1_5 != var_1_14) {
		if ((~ var_1_20) != (-50 >> var_1_5)) {
			var_1_26 = ((max (var_1_15 , var_1_20)) + (abs (max (var_1_16 , var_1_16))));
		} else {
			var_1_26 = (abs (var_1_15 + var_1_16));
		}
	} else {
		var_1_26 = 16u;
	}
