...
void step(void) {
	// From: Req3Batch24100_while
	var_1_10 = last_1_var_1_27;


	// From: Req6Batch24100_while
	...
	// From: Req9Batch24100_while
	if (((1.5899999999999999 * var_1_5) * (var_1_28 / 9.5)) <= var_1_6) {
		var_1_27 = var_1_19;
	}


	// From: Req4Batch24100_while
	if (var_1_16) {
