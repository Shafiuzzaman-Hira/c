...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch61Filler_PR_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch61Filler_PR_CN
	var_1_22 = var_1_23;


	// From: Req1Batch61Filler_PR_CN
