...
void step(void) {
 ...
 if ((var_1_41 << var_1_43) > ((((var_1_44) < ((32u >> var_1_32))) ? (var_1_44) : ((32u >> var_1_32))))) {
  if (((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29))) <= var_1_42) {
   if (((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29))) >= var_1_43) {
    var_1_46 = ((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29)));
   }
  } else {
   var_1_46 = ((((0) < (var_1_29)) ? (0) : (var_1_29)));
  }
 }
 if (((((var_1_42) < 0 ) ? -(var_1_42) : (var_1_42))) == var_1_26) {
  if (var_1_38) {
   var_1_47 = ((((((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31)))) < (25)) ? (((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31)))) : (25)));
  } else {
   if (var_1_39) {
    var_1_47 = var_1_46;
   } else {
 ...
 if ((var_1_49 - ((((var_1_50) < (var_1_51)) ? (var_1_50) : (var_1_51)))) >= var_1_36) {
  if (var_1_39) {
   if (((128 | var_1_33) / 5) <= var_1_27) {
    var_1_48 = ((((var_1_33) < 0 ) ? -(var_1_33) : (var_1_33)));
   } else {
    var_1_48 = (((((((var_1_52) < (var_1_42)) ? (var_1_52) : (var_1_42))) < 0 ) ? -((((var_1_52) < (var_1_42)) ? (var_1_52) : (var_1_42))) : ((((var_1_52) < (var_1_42)) ? (var_1_52) : (var_1_42)))));
   }
  } else {
   if (((((((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51)))) > (var_1_37)) ? (((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51)))) : (var_1_37))) <= var_1_36) {
    if (var_1_26 < var_1_42) {
     var_1_48 = ((((((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52)))) < (((((var_1_33) < (var_1_43)) ? (var_1_33) : (var_1_43))))) ? (((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52)))) : (((((var_1_33) < (var_1_43)) ? (var_1_33) : (var_1_43))))));
    }
   } else {
