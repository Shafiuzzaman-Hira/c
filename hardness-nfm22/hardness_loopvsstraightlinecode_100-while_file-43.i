...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch43100_while.c", 13, "reach_error"); }
...
void step(void) {
 if (last_1_var_1_6 || last_1_var_1_6) {
  if ((last_1_var_1_16 | ((((var_1_5) > (128)) ? (var_1_5) : (128)))) < last_1_var_1_25) {
 ...
 if (stepLocal_6 > (last_1_var_1_30 & last_1_var_1_25)) {
  ...
  var_1_26 = (4 + ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4))));
 }
 if (last_1_var_1_33 > last_1_var_1_33) {
  var_1_28 = (! ((var_1_4 != last_1_var_1_24) || var_1_29));
 }
 var_1_30 = ((((((var_1_31 + var_1_32)) < ((3305479224u - var_1_5))) ? ((var_1_31 + var_1_32)) : ((3305479224u - var_1_5)))) - ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4))));
 var_1_33 = var_1_20;
 var_1_34 = var_1_22;
 var_1_35 = var_1_30;
 ...
 if (var_1_18 <= (~ var_1_4)) {
  if (var_1_28) {
   var_1_24 = ((((256) < (((var_1_26 + var_1_18) + ((((last_1_var_1_24) < (var_1_5)) ? (last_1_var_1_24) : (var_1_5)))))) ? (256) : (((var_1_26 + var_1_18) + ((((last_1_var_1_24) < (var_1_5)) ? (last_1_var_1_24) : (var_1_5)))))));
  } else {
   var_1_24 = -5;
  }
 } else {
 ...
 if ((var_1_16 ^ 1) >= stepLocal_3) {
  if (var_1_28) {
   if (var_1_8 <= ((((var_1_33) > (last_1_var_1_19)) ? (var_1_33) : (last_1_var_1_19)))) {
 ...
 if ((10000 / 64) >= stepLocal_4) {
  ...
  if (stepLocal_5 < ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4)))) {
   var_1_25 = var_1_26;
  } else {
   var_1_25 = var_1_26;
  }
