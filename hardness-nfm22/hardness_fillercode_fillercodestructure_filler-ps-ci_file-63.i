...
void step(void) {
 if ((var_1_15 ^ var_1_1) < (var_1_13 | var_1_13)) {
  var_1_33 = ((((var_1_16) > (var_1_16)) ? (var_1_16) : (var_1_16)));
 } else {
  var_1_33 = (((((((var_1_16) < (var_1_16)) ? (var_1_16) : (var_1_16))) < 0 ) ? -((((var_1_16) < (var_1_16)) ? (var_1_16) : (var_1_16))) : ((((var_1_16) < (var_1_16)) ? (var_1_16) : (var_1_16)))));
 }
 if ((-32 & var_1_16) > var_1_32) {
  var_1_40 = ((((var_1_19) > (var_1_21)) ? (var_1_19) : (var_1_21)));
 } else {
  var_1_40 = (var_1_18 + var_1_18);
 }
 if (var_1_21 >= ((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19)))) {
 ...
 if (var_1_20 < var_1_22) {
  ...
  var_1_49 = ((((((((var_1_50) < (var_1_51)) ? (var_1_50) : (var_1_51)))) > (var_1_27)) ? (((((var_1_50) < (var_1_51)) ? (var_1_50) : (var_1_51)))) : (var_1_27)));
 }
 var_1_53 = var_1_11;
 var_1_54 = var_1_21;
 var_1_55 = var_1_11;
