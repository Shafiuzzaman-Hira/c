...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch66stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch66stepLocals
	if (var_1_2) {
		var_1_1 = (var_1_3 + var_1_4);
	}


	// From: Req2Batch66stepLocals
	...
	// From: Req5Batch66stepLocals
	if (-64 > (var_1_6 + var_1_1)) {
	...
	// From: Req6Batch66stepLocals
	signed long int stepLocal_3 = (max (var_1_11 , var_1_17)) + (var_1_15 / var_1_10);
	if (var_1_8 > stepLocal_3) {
		var_1_16 = var_1_4;
	}


	// From: Req7Batch66stepLocals
...
int property() {
	return (((((((var_1_2 ? (var_1_1 == ((signed char) (var_1_3 + var_1_4))) : 1) && ((var_1_4 >= (var_1_6 - var_1_7)) ? (var_1_2 ? (var_1_5 == ((double) 8.25)) : 1) : 1)) && ((-25 == var_1_6) ? ((var_1_2 && var_1_9) ? (var_1_8 == ((unsigned short int) (max (((var_1_10 - 10) - 16) , (var_1_11 - var_1_7))))) : 1) : (var_1_8 == ((unsigned short int) (max (var_1_7 , var_1_11)))))) && ((var_1_8 >= var_1_7) ? (var_1_12 == ((unsigned char) (! var_1_14))) : 1)) && ((-64 > (var_1_6 + var_1_1)) ? (var_1_15 == ((signed long int) (var_1_11 - var_1_7))) : ((! var_1_12) ? (var_1_12 ? (var_1_15 == ((signed long int) 4)) : 1) : 1))) && ((var_1_8 > ((max (var_1_11 , var_1_17)) + (var_1_15 / var_1_10))) ? (var_1_16 == ((signed short int) var_1_4)) : 1)) && ((var_1_1 < var_1_6) ? (var_1_18 == ((signed short int) (var_1_6 - var_1_7))) : (var_1_18 == ((signed short int) (min ((var_1_6 + var_1_4) , var_1_1)))))) && (var_1_13 ? (var_1_19 == ((signed short int) ((var_1_7 - (min (var_1_20 , var_1_21))) + var_1_6))) : 1)
;
}
int main(void) {
	isInitial = 1;
