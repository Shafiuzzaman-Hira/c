...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch74Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
 if ((~ (var_1_5 % 200u)) < 32u) {
  var_1_25 = (64 - var_1_13);
 }
 if (var_1_12 > var_1_16) {
  var_1_28 = ((((4.2f) < (1.25f)) ? (4.2f) : (1.25f)));
 }
 if ((~ (5 + var_1_16)) >= 10000u) {
  var_1_29 = (((((var_1_13 + var_1_12)) > (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))))) ? ((var_1_13 + var_1_12)) : (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))))));
 } else {
  var_1_29 = ((((((((((var_1_13) > (var_1_11)) ? (var_1_13) : (var_1_11))) < 0 ) ? -((((var_1_13) > (var_1_11)) ? (var_1_13) : (var_1_11))) : ((((var_1_13) > (var_1_11)) ? (var_1_13) : (var_1_11))))) < 0 ) ? -(((((((var_1_13) > (var_1_11)) ? (var_1_13) : (var_1_11))) < 0 ) ? -((((var_1_13) > (var_1_11)) ? (var_1_13) : (var_1_11))) : ((((var_1_13) > (var_1_11)) ? (var_1_13) : (var_1_11))))) : (((((((var_1_13) > (var_1_11)) ? (var_1_13) : (var_1_11))) < 0 ) ? -((((var_1_13) > (var_1_11)) ? (var_1_13) : (var_1_11))) : ((((var_1_13) > (var_1_11)) ? (var_1_13) : (var_1_11)))))));
 }
 var_1_31 = var_1_12;
 if (var_1_11 <= ((((var_1_13) < ((var_1_1 | -5))) ? (var_1_13) : ((var_1_1 | -5))))) {
  if (var_1_10) {
   var_1_32 = var_1_13;
  }
 }
 if (((((var_1_12) < (var_1_12)) ? (var_1_12) : (var_1_12))) <= var_1_11) {
  if (var_1_10) {
   if (var_1_10 || var_1_8) {
    if (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))) > var_1_12) {
     var_1_34 = var_1_12;
    }
   }
  }
 } else {
  if (((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12))) > var_1_11) {
   if (var_1_22 > 49.75f) {
    var_1_34 = (((((((((((var_1_11) < (var_1_5)) ? (var_1_11) : (var_1_5)))) < (-25)) ? (((((var_1_11) < (var_1_5)) ? (var_1_11) : (var_1_5)))) : (-25))) < 0 ) ? -((((((((var_1_11) < (var_1_5)) ? (var_1_11) : (var_1_5)))) < (-25)) ? (((((var_1_11) < (var_1_5)) ? (var_1_11) : (var_1_5)))) : (-25))) : ((((((((var_1_11) < (var_1_5)) ? (var_1_11) : (var_1_5)))) < (-25)) ? (((((var_1_11) < (var_1_5)) ? (var_1_11) : (var_1_5)))) : (-25)))));
   }
  } else {
   var_1_34 = var_1_12;
  }
