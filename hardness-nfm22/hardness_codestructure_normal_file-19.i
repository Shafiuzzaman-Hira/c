...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch19normal.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_7 - (var_1_8 - var_1_2)) >= var_1_4) {
