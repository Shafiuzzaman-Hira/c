...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch60dependencies.c", 13, "reach_error"); }
...
void step(void) {
 if (((var_1_10 * last_1_var_1_9) + last_1_var_1_1) > last_1_var_1_20) {
 ...
 if (last_1_var_1_11 < (last_1_var_1_11 + last_1_var_1_16)) {
  if (((((var_1_7) < (last_1_var_1_1)) ? (var_1_7) : (last_1_var_1_1))) > (var_1_6 * 1)) {
   var_1_9 = var_1_10;
  } else {
   var_1_9 = var_1_10;
  }
