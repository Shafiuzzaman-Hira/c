...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch65PS_CN_25.c", 13, "reach_error"); }
...
double var_1_44 = 49.6;
float var_1_45 = 128.5;
float var_1_46 = 4.8;
...
void step(void) {
	...
	// From: CodeObject7
	if ((max ((var_1_45 - var_1_46) , var_1_38)) < var_1_36) {
		var_1_44 = 31.375;
	}


	// From: Req4Batch65PS_CN_25
	...
	// From: Req5Batch65PS_CN_25
	var_1_20 = (var_1_21 - (var_1_22 + 1.5));


	// From: Req8Batch65PS_CN_25
	var_1_28 = var_1_21;


	// From: Req1Batch65PS_CN_25
	...
	// From: Req7Batch65PS_CN_25
	var_1_24 = ((var_1_1 <= (var_1_25 - var_1_26)) && var_1_27);


	// From: Req3Batch65PS_CN_25
