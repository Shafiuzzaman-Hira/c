...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch26PS_CN_100.c", 13, "reach_error"); }
...
double var_1_50 = 0.19999999999999996;
double var_1_51 = 24.2;
double var_1_52 = 127.6;
unsigned char var_1_53 = 1;
signed char var_1_54 = -25;
signed long int var_1_55 = 256;
unsigned char var_1_56 = 0;
double var_1_57 = 63.25;
...
void step(void) {
 ...
 if (var_1_33 >= (- 255.45f)) {
  ...
  if (var_1_40) {
   if (var_1_30 <= var_1_27) {
    var_1_38 = ((var_1_28 > var_1_32) || var_1_41);
   } else {
    var_1_38 = 0;
   }
  }
 }
 if (((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))) < (var_1_29 - (1911058301 - var_1_27))) {
  if (var_1_39) {
   var_1_42 = (var_1_44 + ((((var_1_45) < 0 ) ? -(var_1_45) : (var_1_45))));
  }
 } else {
  var_1_42 = (((((((var_1_44) < 0 ) ? -(var_1_44) : (var_1_44))) < 0 ) ? -((((var_1_44) < 0 ) ? -(var_1_44) : (var_1_44))) : ((((var_1_44) < 0 ) ? -(var_1_44) : (var_1_44)))));
 }
 if (var_1_41) {
  if (var_1_38) {
   if (var_1_31) {
    var_1_46 = ((((((((((var_1_37) < (var_1_42)) ? (var_1_37) : (var_1_42))) < 0 ) ? -((((var_1_37) < (var_1_42)) ? (var_1_37) : (var_1_42))) : ((((var_1_37) < (var_1_42)) ? (var_1_37) : (var_1_42))))) < 0 ) ? -(((((((var_1_37) < (var_1_42)) ? (var_1_37) : (var_1_42))) < 0 ) ? -((((var_1_37) < (var_1_42)) ? (var_1_37) : (var_1_42))) : ((((var_1_37) < (var_1_42)) ? (var_1_37) : (var_1_42))))) : (((((((var_1_37) < (var_1_42)) ? (var_1_37) : (var_1_42))) < 0 ) ? -((((var_1_37) < (var_1_42)) ? (var_1_37) : (var_1_42))) : ((((var_1_37) < (var_1_42)) ? (var_1_37) : (var_1_42)))))));
   }
  } else {
   var_1_46 = ((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37)));
  }
 }
 if (var_1_39) {
  if (var_1_41) {
  ...
  if ((var_1_35 <= var_1_32) && var_1_38) {
   var_1_47 = ((((var_1_49) < 0 ) ? -(var_1_49) : (var_1_49)));
  }
 }
 var_1_50 = (var_1_51 - var_1_52);
 if (((((63.125) > ((- var_1_34))) ? (63.125) : ((- var_1_34)))) <= var_1_50) {
  var_1_53 = ((! 0) && var_1_40);
 } else {
  if (((var_1_27 % var_1_54) / ((((-16) < 0 ) ? -(-16) : (-16)))) == -4) {
   if (var_1_38) {
    var_1_53 = var_1_41;
   } else {
    if (var_1_39 || var_1_40) {
     ...
     if (((var_1_48 ^ var_1_54) % var_1_55) != var_1_45) {
      var_1_53 = (! var_1_41);
     } else {
      var_1_53 = (var_1_39 || (var_1_31 && var_1_56));
     }
    }
   }
  } else {
 ...
 if (var_1_54 > 10) {
  var_1_57 = ((((var_1_52) < ((99999.4 + 32.625))) ? (var_1_52) : ((99999.4 + 32.625))));
 } else {
  if (var_1_27 >= 0) {
   if (! var_1_59) {
    var_1_57 = var_1_52;
