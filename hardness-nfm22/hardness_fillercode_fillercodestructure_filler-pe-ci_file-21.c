...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch21Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch21Filler_PE_CI
	var_1_8 = (((var_1_7 + var_1_6) + var_1_12) + (var_1_10 - var_1_12));


	// From: Req1Batch21Filler_PE_CI
