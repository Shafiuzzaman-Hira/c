...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch89Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
	// From: CodeObject1
	if ((var_1_12 & var_1_8) >= var_1_13) {
		var_1_19 = var_1_13;
	}


	// From: CodeObject2
	if ((min (var_1_12 , 25)) > (var_1_1 >> (min (var_1_25 , 1)))) {
	...
	if (var_1_14 && var_1_14) {
		if (var_1_1 < var_1_29) {
			if (var_1_14) {
				...
				var_1_32 = (var_1_13 + (abs (max (var_1_25 , var_1_8))));
			}
		}
	} else {
		if (var_1_14) {
	...
	// From: CodeObject6
	if (var_1_13 > var_1_8) {
		if ((min (var_1_17 , (var_1_17 / var_1_36))) <= var_1_17) {
			var_1_33 = ((abs (var_1_1)) + (var_1_12 + var_1_30));
		}
	}
	...
	// From: Req6Batch89Filler_PS_CI
	var_1_18 = var_1_8;


	// From: Req3Batch89Filler_PS_CI
