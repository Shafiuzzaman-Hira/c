...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch88dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch88dependencies
	if (last_1_var_1_21 < ((last_1_var_1_22 / var_1_16) * last_1_var_1_21)) {
	...
	// From: Req6Batch88dependencies
	if (var_1_19 == (var_1_18 << var_1_14)) {
		if (last_1_var_1_22 >= ((var_1_14 | var_1_18) / (var_1_24 - 1))) {
			var_1_22 = 2;
		} else {
			var_1_22 = var_1_20;
		}
