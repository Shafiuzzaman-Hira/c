...
void step(void) {
	// From: Req2Batch72Wrapper_P
	if ((*(var_1_9_Pointer))) {
		(*(var_1_10_Pointer)) = 2u;
	}


	// From: Req3Batch72Wrapper_P
	(*(var_1_11_Pointer)) = (min (((*(var_1_12_Pointer)) + (*(var_1_13_Pointer))) , (10 - (*(var_1_14_Pointer)))));


	// From: Req5Batch72Wrapper_P
	(*(var_1_20_Pointer)) = (*(var_1_19_Pointer));


	// From: Req6Batch72Wrapper_P
	(*(var_1_21_Pointer)) = 1;


	// From: Req7Batch72Wrapper_P
	(*(var_1_22_Pointer)) = 10;


	// From: Req4Batch72Wrapper_P
	if (((*(var_1_20_Pointer)) + ((*(var_1_20_Pointer)) / (*(var_1_16_Pointer)))) == (*(var_1_20_Pointer))) {
		if ((*(var_1_20_Pointer)) >= last_1_var_1_15) {
			(*(var_1_15_Pointer)) = ((*(var_1_17_Pointer)) - (min (((*(var_1_18_Pointer)) + (*(var_1_19_Pointer))) , 9.9999999999995E12)));
		} else {
			(*(var_1_15_Pointer)) = (min ((*(var_1_17_Pointer)) , (5.75 + (*(var_1_19_Pointer)))));
		}
	}


	// From: Req1Batch72Wrapper_P
	if ((*(var_1_20_Pointer)) < ((min ((*(var_1_15_Pointer)) , (*(var_1_15_Pointer)))) * (*(var_1_15_Pointer)))) {
...
int property() {
	return ((((((((*(var_1_20_Pointer)) < ((min ((*(var_1_15_Pointer)) , (*(var_1_15_Pointer)))) * (*(var_1_15_Pointer)))) ? ((*(var_1_1_Pointer)) == ((unsigned char) ((*(var_1_6_Pointer)) && ((last_1_var_1_1 || (*(var_1_8_Pointer))) && (*(var_1_9_Pointer)))))) : 1) && ((*(var_1_9_Pointer)) ? ((*(var_1_10_Pointer)) == ((unsigned long int) 2u)) : 1)) && ((*(var_1_11_Pointer)) == ((signed char) (min (((*(var_1_12_Pointer)) + (*(var_1_13_Pointer))) , (10 - (*(var_1_14_Pointer)))))))) && ((((*(var_1_20_Pointer)) + ((*(var_1_20_Pointer)) / (*(var_1_16_Pointer)))) == (*(var_1_20_Pointer))) ? (((*(var_1_20_Pointer)) >= last_1_var_1_15) ? ((*(var_1_15_Pointer)) == ((double) ((*(var_1_17_Pointer)) - (min (((*(var_1_18_Pointer)) + (*(var_1_19_Pointer))) , 9.9999999999995E12))))) : ((*(var_1_15_Pointer)) == ((double) (min ((*(var_1_17_Pointer)) , (5.75 + (*(var_1_19_Pointer)))))))) : 1)) && ((*(var_1_20_Pointer)) == ((double) (*(var_1_19_Pointer))))) && ((*(var_1_21_Pointer)) == ((signed char) 1))) && ((*(var_1_22_Pointer)) == ((unsigned short int) 10))
;
}
int main(void) {
	isInitial = 1;
