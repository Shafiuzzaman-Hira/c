...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch3225_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch3225_1loop
	if (var_1_7) {
		var_1_6 = (var_1_8 + var_1_9);
	}


	// From: Req3Batch3225_1loop
