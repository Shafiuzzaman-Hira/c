...
void step(void) {
	...
	// From: CodeObject26
	var_1_80 = (max (16.5 , var_1_35));


	// From: CodeObject27
	if ((min ((abs (var_1_41)) , var_1_51)) >= var_1_62) {
		var_1_81 = (max ((max (var_1_53 , var_1_63)) , var_1_35));
	} else {
		var_1_81 = var_1_63;
	}


	// From: Req7Batch6PS_CN_250
	if (last_1_var_1_17) {
