...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch65stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch65stepLocals
	unsigned char stepLocal_0 = var_1_4 > 4;
	...
	// From: Req3Batch65stepLocals
	signed short int stepLocal_1 = var_1_5;
	if (stepLocal_1 > (var_1_4 + (var_1_6 ^ var_1_7))) {
		var_1_14 = (var_1_9 || var_1_15);
	}


	// From: Req4Batch65stepLocals
	unsigned short int stepLocal_3 = var_1_4;
	unsigned char stepLocal_2 = var_1_14;
	if (var_1_1 < stepLocal_3) {
		if ((! (var_1_10 || var_1_9)) && stepLocal_2) {
	...
	// From: Req5Batch65stepLocals
	var_1_20 = (var_1_21 - (var_1_22 + 1.5));


	// From: Req6Batch65stepLocals
	...
	// From: Req7Batch65stepLocals
	var_1_24 = ((var_1_16 <= (var_1_25 - var_1_26)) && var_1_27);


	// From: Req8Batch65stepLocals
	var_1_28 = var_1_21;
}
