...
void step(void) {
	// From: Req2Batch69Wrapper_SP
	if ((*(WrapperStruct00_var_1_2_Pointer)) < (max (((*(WrapperStruct00_var_1_4_Pointer)) * (*(WrapperStruct00_var_1_5_Pointer))) , (*(WrapperStruct00_var_1_3_Pointer))))) {
	...
	// From: Req1Batch69Wrapper_SP
	unsigned long int stepLocal_1 = (*(WrapperStruct00_var_1_5_Pointer));
	unsigned long int stepLocal_0 = (*(WrapperStruct00_var_1_2_Pointer)) * (min ((*(WrapperStruct00_var_1_3_Pointer)) , (*(WrapperStruct00_var_1_4_Pointer))));
