...
void step(void) {
 ...
 if (WrapperStruct00.var_1_2) {
  if (last_1_WrapperStruct00_var_1_10 > stepLocal_0) {
   WrapperStruct00.var_1_1 = ((((((((WrapperStruct00.var_1_7) < (WrapperStruct00.var_1_8)) ? (WrapperStruct00.var_1_7) : (WrapperStruct00.var_1_8)))) > (WrapperStruct00.var_1_9)) ? (((((WrapperStruct00.var_1_7) < (WrapperStruct00.var_1_8)) ? (WrapperStruct00.var_1_7) : (WrapperStruct00.var_1_8)))) : (WrapperStruct00.var_1_9)));
  }
 } else {
 ...
 if (stepLocal_4 > WrapperStruct00.var_1_10) {
  ...
  WrapperStruct00.var_1_11 = (((((WrapperStruct00.var_1_13) < 0 ) ? -(WrapperStruct00.var_1_13) : (WrapperStruct00.var_1_13))) - WrapperStruct00.var_1_15);
 }
