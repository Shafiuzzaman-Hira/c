...
void step(void) {
	// From: Req2Batch31Filler_PE_CO
	var_1_8 = (min ((var_1_5 + (64 - 16)) , 64));


	// From: Req4Batch31Filler_PE_CO
	...
	// From: Req6Batch31Filler_PE_CO
	var_1_17 = var_1_13;


	// From: Req7Batch31Filler_PE_CO
	...
	if (! var_1_25) {
		...
		if (var_1_22 <= var_1_23) {
			if (((abs (var_1_1)) - var_1_1) < var_1_17) {
				if (var_1_17 < var_1_1) {
					var_1_27 = var_1_28;
				}
			} else {
	...
	if ((var_1_23 < var_1_34) || var_1_25) {
		if ((var_1_8 / (min (-10 , var_1_35))) >= (min (var_1_9 , var_1_8))) {
			var_1_33 = var_1_8;
		} else {
			var_1_33 = var_1_8;
		}
	...
	// From: CodeObject5
	if (var_1_16 > (var_1_16 | (abs (var_1_35)))) {
