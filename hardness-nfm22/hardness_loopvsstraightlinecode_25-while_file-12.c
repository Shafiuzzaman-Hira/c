...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch1225_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch1225_while
	if (var_1_13) {
		var_1_6 = (max (((min (var_1_7 , var_1_8)) - var_1_9) , var_1_10));
	}


	// From: Req3Batch1225_while
