...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch8950_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch8950_while
	var_1_18 = var_1_8;


	// From: Req3Batch8950_while
