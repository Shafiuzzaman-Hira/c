...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch325_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch325_while
	var_1_12 = var_1_13;


	// From: Req5Batch325_while
	var_1_14 = var_1_15;


	// From: Req2Batch325_while
	if (! var_1_14) {
