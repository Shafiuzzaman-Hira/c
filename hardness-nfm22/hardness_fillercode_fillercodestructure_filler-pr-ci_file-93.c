...
void step(void) {
	...
	// From: CodeObject4
	if ((var_1_20 + (min (var_1_24 , var_1_20))) <= var_1_17) {
		if (var_1_7 == (max ((abs (var_1_7)) , var_1_6))) {
	...
	// From: CodeObject1
	if ((abs (- var_1_5)) <= var_1_8) {
		if ((abs (min (var_1_8 , 25.6))) >= (abs (- var_1_5))) {
			var_1_26 = (max ((var_1_6 - var_1_6) , (max (var_1_8 , var_1_5))));
		}
	} else {
