...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch63normal.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (! var_1_7) {
		var_1_24 = (var_1_11 - (min ((max (var_1_9 , var_1_12)) , (var_1_13 + var_1_15))));
	} else {
		if (var_1_10 < var_1_9) {
			var_1_24 = -4;
		} else {
	...
	// From: Req8Batch63normal
	var_1_30 = var_1_12;


	// From: Req9Batch63normal
	var_1_31 = var_1_25;


	// From: Req10Batch63normal
	var_1_32 = var_1_16;
}
...
int property() {
	return ((((((((((32u < ((var_1_2 + 4u) | var_1_3)) ? (var_1_1 == ((signed long int) (var_1_4 + (var_1_5 + var_1_6)))) : ((! var_1_7) ? (var_1_1 == ((signed long int) (min (var_1_4 , (var_1_8 - var_1_9))))) : (var_1_1 == ((signed long int) (var_1_9 - var_1_10))))) && (((var_1_9 >> var_1_4) < var_1_1) ? (var_1_11 == ((unsigned short int) var_1_12)) : 1)) && ((var_1_2 != var_1_11) ? (var_1_13 == ((unsigned char) (min (var_1_15 , var_1_16)))) : 1)) && (var_1_7 ? (var_1_17 == ((double) (min (((var_1_18 + var_1_19) - (var_1_20 - var_1_21)) , (max (var_1_22 , var_1_23)))))) : (var_1_17 == ((double) var_1_22)))) && ((! var_1_7) ? (var_1_24 == ((signed long int) (var_1_11 - (min ((max (var_1_9 , var_1_12)) , (var_1_13 + var_1_15)))))) : ((var_1_10 < var_1_9) ? (var_1_24 == ((signed long int) -4)) : (var_1_24 == ((signed long int) var_1_25))))) && ((var_1_8 >= var_1_1) ? (var_1_26 == ((signed char) (var_1_27 + var_1_28))) : 1)) && (var_1_7 ? (var_1_29 == ((float) var_1_20)) : 1)) && (var_1_30 == ((unsigned short int) var_1_12))) && (var_1_31 == ((signed long int) var_1_25))) && (var_1_32 == ((unsigned char) var_1_16))
;
}
int main(void) {
	isInitial = 1;
