...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch21PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject2
	if ((abs (var_1_27)) < (var_1_26 / var_1_29)) {
		var_1_28 = var_1_30;
	}
