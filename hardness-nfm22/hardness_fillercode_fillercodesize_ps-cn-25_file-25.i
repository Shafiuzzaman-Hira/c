...
void step(void) {
 ...
 var_1_28 = var_1_29;
 if ((var_1_27 * var_1_24) >= (var_1_26 << ((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31))))) {
  var_1_30 = (var_1_31 - var_1_32);
 } else {
  var_1_30 = var_1_32;
 }
 if (var_1_25) {
  if (var_1_29 > (((((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28))) < 0 ) ? -((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28))) : ((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28)))))) {
   var_1_33 = (! var_1_34);
  }
 }
 var_1_35 = var_1_31;
 var_1_36 = ((((((((var_1_31) > (var_1_27)) ? (var_1_31) : (var_1_27)))) < (var_1_26)) ? (((((var_1_31) > (var_1_27)) ? (var_1_31) : (var_1_27)))) : (var_1_26)));
 var_1_37 = var_1_29;
