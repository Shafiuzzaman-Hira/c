...
void step(void) {
	...
	if (var_1_4 > (var_1_4 >> var_1_4)) {
		if (var_1_8) {
			...
			var_1_39 = (max ((256 - (var_1_40 - var_1_4)) , var_1_4));
		}
	} else {
		var_1_39 = var_1_4;
	}
	...
	// From: CodeObject2
	if (128u <= var_1_19) {
		if ((var_1_12 >= var_1_12) && ((var_1_19 * var_1_15) < (min (var_1_1 , var_1_19)))) {
	...
	if (var_1_19 > var_1_3) {
		...
		if ((var_1_4 - (max (var_1_4 , var_1_2))) < (abs (var_1_4))) {
	...
	// From: CodeObject1
	var_1_20 = (min (var_1_13 , var_1_13));
