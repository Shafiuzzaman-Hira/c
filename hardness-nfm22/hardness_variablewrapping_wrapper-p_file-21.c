...
void step(void) {
	...
	if ((last_1_var_1_13 + (max (last_1_var_1_13 , last_1_var_1_13))) < (last_1_var_1_13 * last_1_var_1_13)) {
		if (last_1_var_1_13 < (last_1_var_1_13 - last_1_var_1_13)) {
			if (last_1_var_1_13 != (abs (min (last_1_var_1_13 , last_1_var_1_13)))) {
	...
	if ((*(var_1_12_Pointer))) {
		if (((*(var_1_14_Pointer)) - (*(var_1_15_Pointer))) >= (((*(var_1_8_Pointer)) + (*(var_1_10_Pointer))) + (*(var_1_9_Pointer)))) {
			(*(var_1_13_Pointer)) = (max ((*(var_1_1_Pointer)) , (*(var_1_1_Pointer))));
		} else {
...
int property() {
	return ((((last_1_var_1_13 + (max (last_1_var_1_13 , last_1_var_1_13))) < (last_1_var_1_13 * last_1_var_1_13)) ? ((last_1_var_1_13 < (last_1_var_1_13 - last_1_var_1_13)) ? ((last_1_var_1_13 != (abs (min (last_1_var_1_13 , last_1_var_1_13)))) ? ((*(var_1_1_Pointer)) == ((unsigned short int) last_1_var_1_13)) : 1) : 1) : ((*(var_1_1_Pointer)) == ((unsigned short int) last_1_var_1_13))) && (((min ((*(var_1_8_Pointer)) , (*(var_1_9_Pointer)))) <= (*(var_1_10_Pointer))) ? ((last_1_var_1_7 && ((*(var_1_1_Pointer)) >= (*(var_1_1_Pointer)))) ? ((*(var_1_7_Pointer)) == ((unsigned char) 0)) : 1) : ((*(var_1_7_Pointer)) == ((unsigned char) (*(var_1_12_Pointer)))))) && ((*(var_1_12_Pointer)) ? ((((*(var_1_14_Pointer)) - (*(var_1_15_Pointer))) >= (((*(var_1_8_Pointer)) + (*(var_1_10_Pointer))) + (*(var_1_9_Pointer)))) ? ((*(var_1_13_Pointer)) == ((signed short int) (max ((*(var_1_1_Pointer)) , (*(var_1_1_Pointer)))))) : ((*(var_1_13_Pointer)) == ((signed short int) (*(var_1_1_Pointer))))) : 1)
;
}
int main(void) {
	isInitial = 1;
