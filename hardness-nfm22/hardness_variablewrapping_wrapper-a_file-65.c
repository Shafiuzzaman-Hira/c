...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch65Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (0.625f > last_1_double_Array_0_1_) {
		if (BOOL_unsigned_char_Array_0[0]) {
			float_Array_0[1] = (abs (float_Array_0[0]));
		}
	} else {
		float_Array_0[1] = (abs (float_Array_0[0]));
	}
	...
	if (BOOL_unsigned_char_Array_0[0]) {
		if (unsigned_short_int_Array_0[0] >= ((unsigned_short_int_Array_0[1] - unsigned_short_int_Array_0[0]) * 64)) {
	...
	if (float_Array_0[0] > double_Array_0[1]) {
		signed_long_int_Array_0[0] = ((max (unsigned_short_int_Array_0[0] , -64)) + ((unsigned_short_int_Array_0[0] + -2) + unsigned_short_int_Array_0[1]));
	}
}
...
int property() {
	return ((((((0.625f > last_1_double_Array_0_1_) ? (BOOL_unsigned_char_Array_0[0] ? (float_Array_0[1] == ((float) (abs (float_Array_0[0])))) : 1) : (float_Array_0[1] == ((float) (abs (float_Array_0[0]))))) && ((float_Array_0[0] > double_Array_0[1]) ? (signed_long_int_Array_0[0] == ((signed long int) ((max (unsigned_short_int_Array_0[0] , -64)) + ((unsigned_short_int_Array_0[0] + -2) + unsigned_short_int_Array_0[1])))) : 1)) && (BOOL_unsigned_char_Array_0[0] ? ((unsigned_short_int_Array_0[0] >= ((unsigned_short_int_Array_0[1] - unsigned_short_int_Array_0[0]) * 64)) ? (double_Array_0[1] == ((double) ((min (double_Array_0[0] , 50.5)) - double_Array_0[2]))) : 1) : ((float_Array_0[1] <= float_Array_0[1]) ? (double_Array_0[1] == ((double) (double_Array_0[2] - (double_Array_0[3] - double_Array_0[4])))) : 1))) && (signed_char_Array_0[0] == ((signed char) signed_char_Array_0[1]))) && (unsigned_short_int_Array_0[1] == ((unsigned short int) unsigned_short_int_Array_0[2]))) && (unsigned_short_int_Array_0[0] == ((unsigned short int) unsigned_short_int_Array_0[2]))
;
}
int main(void) {
	isInitial = 1;
