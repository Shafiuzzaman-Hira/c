...
void step(void) {
	...
	if ((var_1_60 - var_1_61) >= var_1_46) {
		if (var_1_30) {
			var_1_59 = (abs (abs (var_1_34)));
		}
	}


	// From: CodeObject11
	var_1_62 = (max (var_1_61 , var_1_45));


	// From: CodeObject12
	if ((var_1_40 & -128) > var_1_58) {
		if (var_1_30) {
			var_1_63 = (abs ((var_1_64 + var_1_65) - var_1_61));
		} else {
			if ((min (var_1_61 , (abs (var_1_23)))) <= var_1_65) {
				var_1_63 = (var_1_66 - var_1_64);
			} else {
				var_1_63 = (max ((44320 - var_1_25) , (max (var_1_66 , var_1_61))));
			}
		}
	} else {
		var_1_63 = (max (var_1_38 , (max (var_1_64 , var_1_25))));
	}


	// From: CodeObject13
	if ((var_1_43 * (var_1_53 / var_1_68)) >= var_1_42) {
		var_1_67 = (max (var_1_38 , (max (4u , (var_1_69 - var_1_22)))));
	} else {
		var_1_67 = (abs (min (50u , var_1_63)));
	}


	// From: CodeObject14
	if (var_1_31) {
		var_1_70 = (abs (var_1_42));
	} else {
	...
	if (((var_1_50 + var_1_46) + (var_1_22 - var_1_25)) >= var_1_65) {
		var_1_73 = ((abs (var_1_74)) - 16.9);
	}


	// From: CodeObject17
	var_1_75 = (var_1_64 - (abs (var_1_40)));


	// From: CodeObject18
	if (((var_1_60 - var_1_61) + (abs (var_1_48))) >= var_1_56) {
		var_1_76 = var_1_26;
	}
	...
	// From: CodeObject19
	if (! var_1_27) {
		var_1_78 = (var_1_65 + ((abs (2060522382u)) - var_1_66));
	}
	...
	// From: CodeObject23
	if (var_1_30) {
		var_1_82 = (abs (var_1_25 + var_1_64));
	}


	// From: CodeObject24
	if ((- 16) > (min ((max (var_1_78 , var_1_56)) , var_1_84))) {
	...
	// From: Req7Batch70PS_CN_250
	if ((var_1_14 / var_1_19) <= (min (var_1_18 , var_1_14))) {
		var_1_20 = var_1_13;
	}


	// From: Req4Batch70PS_CN_250
	if (var_1_20) {
		var_1_12 = var_1_13;
	}


	// From: Req3Batch70PS_CN_250
