...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch74PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
 var_1_25 = var_1_26;
 if ((var_1_26 > (var_1_25 ^ -64)) || (var_1_28 > var_1_29)) {
  var_1_27 = var_1_26;
 }
 var_1_30 = ((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28)));
 var_1_31 = var_1_26;
 if (((((100) < 0 ) ? -(100) : (100))) <= ((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29)))) {
  var_1_32 = var_1_33;
 }
 if (var_1_33) {
  if (var_1_28 <= var_1_31) {
   var_1_34 = ((((var_1_26) > (((((25) < (((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))))) ? (25) : (((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35)))))))) ? (var_1_26) : (((((25) < (((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))))) ? (25) : (((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35)))))))));
  }
 } else {
  var_1_34 = ((((var_1_36) < (var_1_35)) ? (var_1_36) : (var_1_35)));
 }
 var_1_37 = var_1_38;
