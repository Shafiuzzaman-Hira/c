...
void step(void) {
	...
	// From: Req3Batch27Wrapper_S
	unsigned long int stepLocal_1 = WrapperStruct00.var_1_7;
	if (WrapperStruct00.var_1_6 > stepLocal_1) {
		WrapperStruct00.var_1_11 = (WrapperStruct00.var_1_4 + (max (-4 , WrapperStruct00.var_1_5)));
	} else {
	...
	// From: Req1Batch27Wrapper_S
	signed long int stepLocal_0 = WrapperStruct00.var_1_11;
	if (32 >= stepLocal_0) {
		WrapperStruct00.var_1_1 = (WrapperStruct00.var_1_3 + (max ((WrapperStruct00.var_1_4 - WrapperStruct00.var_1_5) , WrapperStruct00.var_1_6)));
	} else {
	...
	signed long int stepLocal_2 = max ((WrapperStruct00.var_1_5 - WrapperStruct00.var_1_4) , WrapperStruct00.var_1_1);
	if (WrapperStruct00.var_1_8) {
