...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch98100_1loop.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_2 && var_1_11) {
  var_1_22 = (((((var_1_6 + var_1_10) + var_1_21) < 0 ) ? -((var_1_6 + var_1_10) + var_1_21) : ((var_1_6 + var_1_10) + var_1_21)));
 } else {
  var_1_22 = ((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28)));
 }
 if (10u <= ((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22)))) {
  if (((((16u) < (var_1_22)) ? (16u) : (var_1_22))) >= (var_1_8 % var_1_4)) {
   var_1_1 = ((var_1_5 - var_1_6) - var_1_7);
  }
 }
 if ((var_1_8 > var_1_22) && (var_1_19 < (var_1_15 / var_1_16))) {
  if (var_1_27 != (var_1_7 - var_1_6)) {
   var_1_29 = (((((var_1_6) > (var_1_7)) ? (var_1_6) : (var_1_7))) - ((10000 - var_1_5) + var_1_27));
  } else {
   var_1_29 = var_1_10;
  }
 } else {
