...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch82Filler_PR_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject8
	if (var_1_35 != (abs (var_1_24))) {
		if ((abs (127.4)) < var_1_36) {
			if (var_1_29) {
				var_1_41 = var_1_26;
			}
		} else {
	...
	// From: CodeObject6
	if ((var_1_34 * var_1_24) != var_1_25) {
		var_1_38 = (var_1_39 - (abs (var_1_25)));
	}


	// From: Req3Batch82Filler_PR_CN
	...
	if (var_1_29) {
		if ((abs (var_1_25)) <= var_1_24) {
			if ((min ((var_1_27 % var_1_30) , var_1_26)) < (var_1_31 * (var_1_32 | var_1_33))) {
				if ((max (var_1_25 , var_1_24)) >= (var_1_34 * var_1_35)) {
					var_1_28 = var_1_25;
				}
			}
		} else {
	...
	if (var_1_27 != var_1_30) {
		var_1_37 = ((abs (var_1_27)) - (abs (var_1_26)));
	} else {
		var_1_37 = (abs (max (var_1_26 , var_1_27)));
	}


	// From: Req4Batch82Filler_PR_CN
