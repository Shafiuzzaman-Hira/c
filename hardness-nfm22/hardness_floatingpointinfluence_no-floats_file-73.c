...
void step(void) {
	...
	// From: Req5Batch73no_floats
	var_1_19 = var_1_8;


	// From: Req3Batch73no_floats
	if (var_1_19 > var_1_9) {
		if (var_1_6) {
...
int property() {
	return (((((var_1_8 <= (max (var_1_8 , (var_1_8 + var_1_19)))) ? ((! var_1_6) ? (var_1_1 == ((signed long int) var_1_7)) : (var_1_1 == ((signed long int) var_1_7))) : 1) && (var_1_6 ? (var_1_8 == ((unsigned char) (max (var_1_9 , var_1_10)))) : ((last_1_var_1_12 < (last_1_var_1_12 + var_1_7)) ? (var_1_8 == ((unsigned char) (min (var_1_9 , var_1_10)))) : 1))) && ((var_1_19 > var_1_9) ? (var_1_6 ? (var_1_12 == ((signed long int) (var_1_13 - (abs (99999.25f))))) : ((var_1_14 && var_1_15) ? (var_1_12 == ((signed long int) (var_1_13 - var_1_16))) : (var_1_12 == ((signed long int) var_1_16)))) : (var_1_12 == ((signed long int) var_1_13)))) && (var_1_17 == ((signed char) var_1_18))) && (var_1_19 == ((signed long int) var_1_8))
;
}
int main(void) {
	isInitial = 1;
