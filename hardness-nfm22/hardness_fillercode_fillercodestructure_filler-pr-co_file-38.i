...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch38Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (-2 > (((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21))) | (-10 * var_1_25))) {
  var_1_37 = ((((((((25) < (var_1_21)) ? (25) : (var_1_21)))) > (((((var_1_32 + var_1_8) < 0 ) ? -(var_1_32 + var_1_8) : (var_1_32 + var_1_8))))) ? (((((25) < (var_1_21)) ? (25) : (var_1_21)))) : (((((var_1_32 + var_1_8) < 0 ) ? -(var_1_32 + var_1_8) : (var_1_32 + var_1_8))))));
 } else {
  if (((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8))) <= ((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21)))) {
   if ((var_1_8 * ((((var_1_25) > (var_1_25)) ? (var_1_25) : (var_1_25)))) <= var_1_21) {
    var_1_37 = ((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8)));
   }
  } else {
