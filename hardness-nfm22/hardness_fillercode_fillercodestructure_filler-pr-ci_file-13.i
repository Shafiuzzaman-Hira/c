...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch13Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_4 >= (var_1_21 % ((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))))) {
  if (var_1_4 < var_1_4) {
   if (var_1_9 && (((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4))) <= var_1_11)) {
    var_1_36 = var_1_4;
   }
  }
 }
 ...
 if (var_1_21 > var_1_21) {
  var_1_39 = ((((var_1_14) < (((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22))))) ? (var_1_14) : (((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22))))));
 }
 if (var_1_1 < ((((var_1_4) < (-64)) ? (var_1_4) : (-64)))) {
  var_1_40 = var_1_19;
 } else {
  if ((var_1_11 | var_1_11) < (8 + var_1_10)) {
   var_1_40 = (((((((((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19)))) > (var_1_17)) ? (((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19)))) : (var_1_17))) < 0 ) ? -((((((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19)))) > (var_1_17)) ? (((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19)))) : (var_1_17))) : ((((((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19)))) > (var_1_17)) ? (((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19)))) : (var_1_17)))));
  }
 }
 ...
 if ((var_1_18 >= var_1_18) && (var_1_4 >= var_1_4)) {
  if (var_1_5) {
   var_1_27 = ((((((((var_1_4) < (var_1_4)) ? (var_1_4) : (var_1_4)))) > (((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10))))) ? (((((var_1_4) < (var_1_4)) ? (var_1_4) : (var_1_4)))) : (((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10))))));
  } else {
   var_1_27 = (((((128) < 0 ) ? -(128) : (128))) - var_1_11);
  }
 }
 if (var_1_18 > var_1_18) {
  if (var_1_4 >= var_1_4) {
   var_1_35 = ((((((((var_1_11 + var_1_4)) < (var_1_4)) ? ((var_1_11 + var_1_4)) : (var_1_4))) < 0 ) ? -(((((var_1_11 + var_1_4)) < (var_1_4)) ? ((var_1_11 + var_1_4)) : (var_1_4))) : (((((var_1_11 + var_1_4)) < (var_1_4)) ? ((var_1_11 + var_1_4)) : (var_1_4)))));
  }
 }
}
