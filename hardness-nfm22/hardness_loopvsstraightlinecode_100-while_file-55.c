...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch55100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req14Batch55100_while
	var_1_32 = var_1_1;


	// From: Req2Batch55100_while
	if (var_1_5 > (last_1_var_1_13 % var_1_7)) {
		var_1_6 = var_1_5;
	} else {
	...
	// From: Req4Batch55100_while
	var_1_12 = var_1_11;


	// From: Req12Batch55100_while
	var_1_30 = var_1_1;


	// From: Req13Batch55100_while
	var_1_31 = 24.4f;


	// From: Req3Batch55100_while
