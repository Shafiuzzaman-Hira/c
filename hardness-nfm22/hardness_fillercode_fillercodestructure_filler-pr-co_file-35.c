...
void step(void) {
	...
	if (var_1_27 <= var_1_16) {
		if ((var_1_13 | (abs (var_1_31))) >= (var_1_6 + var_1_13)) {
	...
	if (32u >= ((max (var_1_13 , var_1_6)) % 16u)) {
		if ((-5 > var_1_31) && (var_1_6 <= (max (var_1_34 , var_1_12)))) {
			var_1_39 = var_1_27;
		} else {
