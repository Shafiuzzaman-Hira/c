...
void step(void) {
	...
	// From: Req1Batch14Filler_PE_CO
	var_1_1 = (var_1_15 + var_1_15);


	// From: Req8Batch14Filler_PE_CO
	var_1_28 = var_1_17;


	// From: Req7Batch14Filler_PE_CO
	...
	// From: CodeObject2
	if (var_1_4) {
		var_1_31 = (max (var_1_28 , var_1_28));
	} else {
		if ((max (var_1_28 , var_1_28)) > var_1_1) {
			if (var_1_30 > (abs (var_1_21 / var_1_36))) {
	...
	// From: CodeObject5
	if (! var_1_4) {
		var_1_42 = (min (((max (var_1_28 , var_1_40)) + (var_1_39 + var_1_1)) , -128));
	}


	// From: CodeObject6
	if ((var_1_21 + (max (var_1_30 , var_1_21))) < (max (var_1_36 , (var_1_21 + var_1_21)))) {
		if ((var_1_21 + (var_1_36 + var_1_21)) >= (max (25.5 , var_1_21))) {
