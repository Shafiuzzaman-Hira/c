...
void step(void) {
	...
	// From: Req5Batch20Filler_PE_CI
	var_1_15 = (var_1_14 + var_1_16);


	// From: Req6Batch20Filler_PE_CI
	if (var_1_2) {
	...
	// From: CodeObject4
	if (var_1_2) {
		if (var_1_16 > (var_1_13 / (abs (var_1_13)))) {
			var_1_23 = 100;
		} else {
			var_1_23 = 10;
		}
	...
	if (var_1_5 > var_1_5) {
		...
		if ((var_1_2 || var_1_2) || ((- var_1_16) <= var_1_14)) {
			var_1_26 = (min (9.99999999739E8 , var_1_16));
		}
	}
	...
	if (var_1_2 || (var_1_16 <= var_1_16)) {
		if ((var_1_12 | (var_1_3 * var_1_5)) == (min (var_1_1 , -32))) {
			var_1_29 = (max ((abs (var_1_3)) , var_1_11));
		} else {
			var_1_29 = (abs (min (var_1_3 , (abs (var_1_11)))));
		}
	} else {
		var_1_29 = (var_1_4 + ((abs (var_1_5)) + var_1_5));
	}
	...
	// From: CodeObject8
	if ((var_1_4 + (min (var_1_10 , var_1_3))) <= var_1_4) {
		if (var_1_2) {
			var_1_41 = var_1_3;
		}
	}
