...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch66PS_CN_100.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_27 > var_1_22) {
		if (var_1_29 < var_1_22) {
			if (var_1_29 <= (-64 & var_1_28)) {
				var_1_31 = (max (var_1_32 , (min (8 , var_1_33))));
			} else {
				var_1_31 = (var_1_34 + (max (4 , var_1_35)));
			}
		}
	}
	...
	// From: CodeObject5
	if ((max ((max (var_1_27 , var_1_28)) , var_1_25)) > var_1_30) {
		if (! (var_1_37 >= 128)) {
			var_1_36 = (abs (8));
		}
	} else {
	...
	// From: CodeObject7
	if (var_1_30 <= (~ (min (var_1_35 , var_1_32)))) {
		if (var_1_23) {
			if (var_1_40 != var_1_41) {
				var_1_42 = (abs (abs (var_1_36)));
			} else {
				var_1_42 = (var_1_37 + (max (var_1_36 , (max (var_1_38 , var_1_30)))));
			}
		} else {
			var_1_42 = (var_1_29 - (abs (max (var_1_30 , var_1_38))));
		}
	} else {
	...
	// From: CodeObject8
	if (var_1_29 > ((var_1_24 * var_1_30) >> var_1_37)) {
		if (var_1_39 >= var_1_40) {
			var_1_43 = (abs (var_1_40));
		}
	} else {
		var_1_43 = (var_1_45 - 7.4f);
	}


	// From: CodeObject9
	if ((abs (abs (32))) != var_1_25) {
		var_1_46 = (min (var_1_38 , var_1_32));
	}


	// From: CodeObject10
	if (var_1_36 < var_1_26) {
		var_1_47 = ((var_1_36 + var_1_38) + (5 + (min (var_1_48 , var_1_49))));
	} else {
		var_1_47 = var_1_38;
	}
	...
	// From: CodeObject11
	if (var_1_43 > (max (var_1_45 , var_1_41))) {
		var_1_50 = (min (var_1_30 , var_1_49));
	} else {
		if ((var_1_40 + var_1_41) >= (var_1_39 / 32.5)) {
			var_1_50 = var_1_33;
		}
	}
	...
	if (var_1_50 >= var_1_26) {
		var_1_51 = (! (var_1_44 && var_1_52));
	}


	// From: Req3Batch66PS_CN_100
	...
	// From: Req1Batch66PS_CN_100
	if (var_1_12) {
		var_1_1 = (var_1_3 + var_1_4);
	}


	// From: Req2Batch66PS_CN_100
	...
	// From: Req8Batch66PS_CN_100
	if (var_1_12) {
		var_1_19 = ((var_1_7 - (min (var_1_20 , var_1_21))) + var_1_6);
	}


	// From: Req5Batch66PS_CN_100
