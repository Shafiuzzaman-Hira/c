...
void step(void) {
	...
	// From: CodeObject3
	if (var_1_27 >= (abs (var_1_30 + var_1_31))) {
		var_1_29 = -4;
	}
	...
	// From: Req3Batch90PS_CN_10
	if (((var_1_15 - var_1_12) + var_1_24) < var_1_24) {
		var_1_14 = var_1_12;
	}


	// From: Req5Batch90PS_CN_10
