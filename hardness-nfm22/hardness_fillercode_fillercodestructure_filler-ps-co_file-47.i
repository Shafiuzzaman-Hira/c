...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch47Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_32 = var_1_33;
 if (var_1_12 > 32.8) {
  var_1_34 = (((((var_1_35 - var_1_20)) > (var_1_1)) ? ((var_1_35 - var_1_20)) : (var_1_1)));
 }
 if ((var_1_20 & var_1_33) <= var_1_1) {
  var_1_36 = 10;
 } else {
  if (var_1_12 > var_1_12) {
   if ((~ var_1_1) > (var_1_20 & var_1_1)) {
 ...
 if (var_1_33 == (var_1_22 | (var_1_1 + var_1_20))) {
  var_1_38 = var_1_29;
 }
 if (var_1_12 >= var_1_12) {
 ...
 if ((((((var_1_20) < 0 ) ? -(var_1_20) : (var_1_20))) / var_1_37) > (var_1_1 * 10)) {
  if (! var_1_19) {
   var_1_43 = var_1_33;
  } else {
   var_1_43 = var_1_33;
