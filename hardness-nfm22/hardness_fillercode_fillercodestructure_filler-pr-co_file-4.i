...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch4Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_24 >= (var_1_6 ^ (var_1_17 % var_1_41))) {
  if (var_1_41 > var_1_17) {
   if (var_1_9 >= var_1_39) {
    if (64 < var_1_14) {
     var_1_40 = var_1_29;
    }
 ...
 if (var_1_17 != ((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35)))) {
  var_1_36 = (((((var_1_17 - var_1_17)) < ((((((var_1_24 + var_1_17)) < (var_1_9)) ? ((var_1_24 + var_1_17)) : (var_1_9))))) ? ((var_1_17 - var_1_17)) : ((((((var_1_24 + var_1_17)) < (var_1_9)) ? ((var_1_24 + var_1_17)) : (var_1_9))))));
 }
 ...
 if ((var_1_9 * (var_1_38 - var_1_9)) <= var_1_9) {
