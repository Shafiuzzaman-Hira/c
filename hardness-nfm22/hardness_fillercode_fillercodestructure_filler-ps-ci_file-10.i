...
void step(void) {
 ...
 if (var_1_5 >= ((~ 128u) % ((((var_1_16) < (var_1_4)) ? (var_1_16) : (var_1_4))))) {
  if (var_1_9) {
   var_1_38 = (((((64 + var_1_37)) > (var_1_11)) ? ((64 + var_1_37)) : (var_1_11)));
  } else {
   if ((((((var_1_36 | var_1_11)) > ((var_1_30 & var_1_5))) ? ((var_1_36 | var_1_11)) : ((var_1_30 & var_1_5)))) < var_1_11) {
    var_1_38 = ((((var_1_37) > (var_1_11)) ? (var_1_37) : (var_1_11)));
   } else {
    var_1_38 = var_1_11;
   }
  }
