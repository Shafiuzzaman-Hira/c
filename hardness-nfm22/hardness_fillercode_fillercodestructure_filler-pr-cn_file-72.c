...
void step(void) {
	...
	// From: Req3Batch72Filler_PR_CN
	var_1_17 = (var_1_18 && var_1_19);


	// From: Req4Batch72Filler_PR_CN
	if (! var_1_18) {
		var_1_20 = (max (var_1_21 , var_1_22));
	}


	// From: Req6Batch72Filler_PR_CN
	if (256 >= var_1_10) {
