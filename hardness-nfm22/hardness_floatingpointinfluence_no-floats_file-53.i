...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch53no_floats.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_5 <= (var_1_13 - var_1_4)) {
  var_1_12 = ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)));
 }
 ...
 signed long int stepLocal_1 = (((var_1_12) < (var_1_12)) ? (var_1_12) : (var_1_12));
 unsigned long int stepLocal_0 = var_1_3;
 if (stepLocal_1 != ((((var_1_4) < (var_1_3)) ? (var_1_4) : (var_1_3)))) {
  if (var_1_9 == var_1_10) {
   if (var_1_6) {
