...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch41dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch41dependencies
	var_1_22 = 1;


	// From: Req9Batch41dependencies
	var_1_23 = var_1_22;


	// From: Req1Batch41dependencies
	if ((- var_1_13) > 31.9f) {
	...
	// From: Req5Batch41dependencies
	if (var_1_1) {
		var_1_15 = var_1_16;
	}


	// From: Req3Batch41dependencies
	if (var_1_15 > var_1_23) {
		var_1_8 = (min (var_1_11 , var_1_12));
	}


	// From: Req6Batch41dependencies
	if (var_1_1 || (var_1_23 < var_1_15)) {
	...
	// From: Req7Batch41dependencies
	if (((var_1_15 / var_1_18) * var_1_15) < -10) {
