...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch23Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch23Wrapper_S
	WrapperStruct00.var_1_1 = (min (WrapperStruct00.var_1_2 , WrapperStruct00.var_1_3));


	// From: Req2Batch23Wrapper_S
	if ((WrapperStruct00.var_1_5 / WrapperStruct00.var_1_6) <= (WrapperStruct00.var_1_7 + (WrapperStruct00.var_1_8 - WrapperStruct00.var_1_9))) {
		WrapperStruct00.var_1_4 = (min (WrapperStruct00.var_1_2 , WrapperStruct00.var_1_3));
	}


	// From: Req3Batch23Wrapper_S
	WrapperStruct00.var_1_10 = (max (WrapperStruct00.var_1_2 , ((WrapperStruct00.var_1_11 + WrapperStruct00.var_1_12) - WrapperStruct00.var_1_13)));


	// From: Req5Batch23Wrapper_S
	unsigned char stepLocal_0 = (- WrapperStruct00.var_1_5) != 1.9f;
	if (stepLocal_0 || ((WrapperStruct00.var_1_4 * WrapperStruct00.var_1_13) < WrapperStruct00.var_1_3)) {
	...
	// From: Req4Batch23Wrapper_S
	if (WrapperStruct00.var_1_18) {
		if (! ((WrapperStruct00.var_1_5 / WrapperStruct00.var_1_6) < (WrapperStruct00.var_1_8 - WrapperStruct00.var_1_9))) {
			if (WrapperStruct00.var_1_18) {
...
int property() {
	return ((((WrapperStruct00.var_1_1 == ((unsigned long int) (min (WrapperStruct00.var_1_2 , WrapperStruct00.var_1_3)))) && (((WrapperStruct00.var_1_5 / WrapperStruct00.var_1_6) <= (WrapperStruct00.var_1_7 + (WrapperStruct00.var_1_8 - WrapperStruct00.var_1_9))) ? (WrapperStruct00.var_1_4 == ((unsigned long int) (min (WrapperStruct00.var_1_2 , WrapperStruct00.var_1_3)))) : 1)) && (WrapperStruct00.var_1_10 == ((unsigned long int) (max (WrapperStruct00.var_1_2 , ((WrapperStruct00.var_1_11 + WrapperStruct00.var_1_12) - WrapperStruct00.var_1_13)))))) && (WrapperStruct00.var_1_18 ? ((! ((WrapperStruct00.var_1_5 / WrapperStruct00.var_1_6) < (WrapperStruct00.var_1_8 - WrapperStruct00.var_1_9))) ? (WrapperStruct00.var_1_18 ? (WrapperStruct00.var_1_14 == ((unsigned char) (! WrapperStruct00.var_1_17))) : 1) : 1) : 1)) && ((((- WrapperStruct00.var_1_5) != 1.9f) || ((WrapperStruct00.var_1_4 * WrapperStruct00.var_1_13) < WrapperStruct00.var_1_3)) ? (WrapperStruct00.var_1_18 == ((unsigned char) (! WrapperStruct00.var_1_19))) : (WrapperStruct00.var_1_18 == ((unsigned char) WrapperStruct00.var_1_19)))
;
}
int main(void) {
	isInitial = 1;
