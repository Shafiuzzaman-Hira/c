...
void step(void) {
	...
	// From: Req7Batch5dependencies
	var_1_21 = var_1_10;


	// From: Req4Batch5dependencies
	if ((abs (var_1_21)) <= (max (var_1_6 , var_1_4))) {
