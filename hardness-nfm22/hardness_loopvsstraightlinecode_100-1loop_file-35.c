...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch35100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch35100_1loop
	signed long int stepLocal_1 = last_1_var_1_7 >> (var_1_14 + var_1_15);
	unsigned char stepLocal_0 = (max (last_1_var_1_33 , last_1_var_1_33)) != last_1_var_1_9;
	...
	// From: Req1Batch35100_1loop
	if (last_1_var_1_35 < last_1_var_1_28) {
		if ((128 + (max (last_1_var_1_26 , 4))) <= (min (last_1_var_1_22 , 2))) {
			var_1_1 = var_1_6;
		} else {
			var_1_1 = 10;
		}
	...
	// From: Req10Batch35100_1loop
	if (var_1_13) {
		var_1_28 = (max (var_1_21 , (var_1_29 + var_1_30)));
	} else {
		if (var_1_31) {
	...
	// From: Req2Batch35100_1loop
	if (last_1_var_1_25 >= last_1_var_1_17) {
		var_1_7 = (min (last_1_var_1_17 , last_1_var_1_22));
	}


	// From: Req7Batch35100_1loop
	...
	// From: Req12Batch35100_1loop
	var_1_35 = var_1_30;


	// From: Req11Batch35100_1loop
	if (128 >= (var_1_26 / var_1_27)) {
		var_1_33 = (((abs (18346)) + (min (28846 , var_1_34))) - (min ((abs (var_1_7)) , var_1_12)));
	} else {
		var_1_33 = (16 + last_1_var_1_33);
	}


	// From: Req3Batch35100_1loop
	var_1_9 = ((var_1_7 + var_1_7) + (min (var_1_6 , (var_1_22 + var_1_1))));


	// From: Req5Batch35100_1loop
	if (var_1_13) {
		var_1_17 = ((var_1_12 + (var_1_6 + var_1_26)) + (var_1_15 - var_1_7));
	}


	// From: Req6Batch35100_1loop
	if ((var_1_35 * var_1_35) >= var_1_28) {
		if ((- (16 % var_1_20)) >= ((max (var_1_12 , var_1_7)) ^ var_1_1)) {
			var_1_18 = var_1_21;
		} else {
			var_1_18 = var_1_21;
		}
...
int property() {
	return ((((((((((((last_1_var_1_35 < last_1_var_1_28) ? (((128 + (max (last_1_var_1_26 , 4))) <= (min (last_1_var_1_22 , 2))) ? (var_1_1 == ((signed char) var_1_6)) : (var_1_1 == ((signed char) 10))) : (var_1_1 == ((signed char) var_1_6))) && ((last_1_var_1_25 >= last_1_var_1_17) ? (var_1_7 == ((unsigned short int) (min (last_1_var_1_17 , last_1_var_1_22)))) : 1)) && (var_1_9 == ((signed short int) ((var_1_7 + var_1_7) + (min (var_1_6 , (var_1_22 + var_1_1))))))) && ((var_1_13 || ((max (last_1_var_1_33 , last_1_var_1_33)) != last_1_var_1_9)) ? (((last_1_var_1_7 >> (var_1_14 + var_1_15)) >= (last_1_var_1_22 + last_1_var_1_33)) ? (var_1_13 ? (var_1_12 == ((unsigned char) 2)) : 1) : 1) : 1)) && (var_1_13 ? (var_1_17 == ((signed long int) ((var_1_12 + (var_1_6 + var_1_26)) + (var_1_15 - var_1_7)))) : 1)) && (((var_1_35 * var_1_35) >= var_1_28) ? (((- (16 % var_1_20)) >= ((max (var_1_12 , var_1_7)) ^ var_1_1)) ? (var_1_18 == ((float) var_1_21)) : (var_1_18 == ((float) var_1_21))) : (var_1_18 == ((float) var_1_21)))) && ((((last_1_var_1_17 + last_1_var_1_17) / (var_1_23 + var_1_24)) >= var_1_14) ? (var_1_22 == ((unsigned char) (200 - var_1_15))) : 1)) && ((var_1_18 > 1.75) ? (((var_1_1 <= (~ last_1_var_1_25)) && var_1_13) ? ((var_1_13 && (var_1_26 < var_1_33)) ? (var_1_25 == ((unsigned long int) (abs (var_1_22)))) : (var_1_25 == ((unsigned long int) var_1_24))) : 1) : 1)) && ((var_1_20 != var_1_23) ? ((! var_1_13) ? (var_1_26 == ((unsigned char) (var_1_27 - var_1_14))) : (var_1_26 == ((unsigned char) var_1_27))) : (var_1_26 == ((unsigned char) 2)))) && (var_1_13 ? (var_1_28 == ((float) (max (var_1_21 , (var_1_29 + var_1_30))))) : (var_1_31 ? ((! ((var_1_1 > var_1_12) || var_1_32)) ? (var_1_28 == ((float) var_1_30)) : (var_1_28 == ((float) var_1_29))) : (var_1_28 == ((float) 2.25f))))) && ((128 >= (var_1_26 / var_1_27)) ? (var_1_33 == ((unsigned short int) (((abs (18346)) + (min (28846 , var_1_34))) - (min ((abs (var_1_7)) , var_1_12))))) : (var_1_33 == ((unsigned short int) (16 + last_1_var_1_33))))) && (var_1_35 == ((double) var_1_30))
;
}
int main(void) {
	isInitial = 1;
