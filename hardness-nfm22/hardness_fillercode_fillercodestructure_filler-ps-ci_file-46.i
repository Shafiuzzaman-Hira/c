...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch46Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
 var_1_21 = ((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)));
 if (var_1_15 > var_1_9) {
  if (var_1_9 < var_1_15) {
   var_1_23 = (var_1_2 && var_1_25);
  }
 } else {
  var_1_23 = (! var_1_26);
 }
 var_1_27 = var_1_5;
 if (var_1_15 != (var_1_4 + var_1_4)) {
  var_1_29 = ((((var_1_4) > (((((((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15)))) < (var_1_6)) ? (((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15)))) : (var_1_6))))) ? (var_1_4) : (((((((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15)))) < (var_1_6)) ? (((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15)))) : (var_1_6))))));
 } else {
  var_1_29 = var_1_15;
 }
 if ((-25 + (var_1_7 + var_1_1)) <= var_1_5) {
  if ((16 >> ((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15)))) > (var_1_1 >> var_1_7)) {
   var_1_31 = var_1_4;
  } else {
   var_1_31 = ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4)));
  }
 }
 if (var_1_3 || (var_1_25 && var_1_2)) {
  if (var_1_6 >= var_1_14) {
   var_1_33 = ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)));
  } else {
   var_1_33 = (((((var_1_14 - var_1_15)) > (((var_1_14 + var_1_14) - 2))) ? ((var_1_14 - var_1_15)) : (((var_1_14 + var_1_14) - 2))));
  }
 } else {
  if ((! (! var_1_2)) && (((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14))) <= var_1_15)) {
   var_1_33 = var_1_14;
  }
 }
