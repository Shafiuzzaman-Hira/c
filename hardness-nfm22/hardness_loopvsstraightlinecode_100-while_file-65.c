...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch65100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch65100_while
	var_1_20 = (min (var_1_1 , 64u));


	// From: Req6Batch65100_while
	...
	// From: Req2Batch65100_while
	if (last_1_var_1_27) {
		var_1_5 = (min (var_1_6 , (var_1_7 - var_1_8)));
	}


	// From: Req4Batch65100_while
	if (last_1_var_1_27) {
