...
void step(void) {
	...
	if (var_1_5 >= stepLocal_1) {
		if (! (last_1_var_1_51 >= var_1_4)) {
			var_1_11 = ((5 + (min (var_1_4 , var_1_5))) - ((min (var_1_12 , 100)) - (var_1_13 + 25)));
		}
	}
	...
	if (! var_1_40) {
		if (var_1_10 <= stepLocal_6) {
			var_1_45 = (max (var_1_4 , (max (var_1_5 , var_1_13))));
		} else {
			var_1_45 = ((min ((last_1_var_1_45 + last_1_var_1_35) , -16)) + last_1_var_1_19);
		}
	} else {
	...
	// From: Req27Batch39Amount250
	signed long int stepLocal_8 = abs (var_1_12);
	...
	if ((var_1_10 >= (- var_1_12)) && last_1_var_1_52) {
		if (last_1_var_1_52) {
			var_1_37 = (min (((min (var_1_22 , var_1_4)) + var_1_5) , var_1_13));
		}
	} else {
		var_1_37 = (max (var_1_5 , var_1_10));
	}


	// From: Req28Batch39Amount250
	var_1_63 = var_1_37;


	// From: Req7Batch39Amount250
	if (-64 >= var_1_37) {
		var_1_25 = (min (var_1_17 , (abs (var_1_18))));
	} else {
	...
	if (last_1_var_1_34 >= ((min (last_1_var_1_49 , var_1_22)) - (1 + 8))) {
		var_1_30 = (min ((max (-50 , var_1_13)) , (var_1_4 + var_1_5)));
	} else {
		var_1_30 = ((max ((var_1_12 - var_1_13) , (var_1_31 + var_1_5))) - var_1_4);
	}
	...
	if ((var_1_7 - var_1_8) > last_1_var_1_61) {
		...
		var_1_6 = ((var_1_10 - (min (0u , last_1_var_1_23))) - var_1_4);
	}
	...
	if (stepLocal_3 <= var_1_12) {
		...
		if ((var_1_17 + var_1_8) <= var_1_7) {
			var_1_23 = ((min (var_1_13 , (abs (var_1_4)))) + var_1_12);
		}
	}


	// From: Req9Batch39Amount250
	var_1_32 = (min ((var_1_31 - var_1_5) , var_1_13));


	// From: Req10Batch39Amount250
	if ((abs (var_1_16)) >= var_1_7) {
		var_1_33 = var_1_29;
	} else {
	...
	// From: Req29Batch39Amount250
	var_1_64 = var_1_31;


	// From: Req5Batch39Amount250
	unsigned long int stepLocal_2 = max (var_1_37 , (var_1_4 + var_1_11));
	...
	if (var_1_63 > var_1_34) {
		var_1_14 = (((256.5f + var_1_15) + (max (var_1_16 , var_1_17))) + var_1_18);
	}
	...
	if ((var_1_23 >= (max (var_1_6 , var_1_24))) || var_1_40) {
		if (var_1_40) {
			var_1_52 = var_1_53;
		}
	} else {
	...
	if (var_1_40) {
		if (var_1_52) {
			var_1_44 = (max (((abs (var_1_13)) - (max (var_1_5 , var_1_12))) , var_1_31));
		} else {
			var_1_44 = (var_1_31 + -32);
		}
	} else {
		var_1_44 = (abs (var_1_31));
	}
	...
	if (var_1_52) {
		...
		var_1_49 = (min ((var_1_44 + var_1_44) , var_1_31));
	}
	...
	if ((var_1_42 - var_1_13) >= stepLocal_5) {
		...
		if (var_1_52) {
			if (stepLocal_4 <= var_1_5) {
				...
				if (var_1_8 <= (16.75f / (min (var_1_28 , var_1_43)))) {
	...
	if (var_1_60 <= var_1_1) {
		var_1_51 = (min (((max (var_1_13 , var_1_31)) - var_1_1) , var_1_48));
	}
...
int property() {
	return (((((((((((((((((((((((((((((((var_1_30 * var_1_6) << (var_1_4 - var_1_5)) <= -128) ? (var_1_1 == ((unsigned char) (var_1_5 + var_1_4))) : (var_1_1 == ((unsigned char) (abs (var_1_4))))) && (((var_1_7 - var_1_8) > last_1_var_1_61) ? (var_1_6 == ((unsigned long int) var_1_4)) : (var_1_6 == ((unsigned long int) ((var_1_10 - (min (0u , last_1_var_1_23))) - var_1_4))))) && ((var_1_5 >= (last_1_var_1_19 / var_1_4)) ? ((! (last_1_var_1_51 >= var_1_4)) ? (var_1_11 == ((signed char) ((5 + (min (var_1_4 , var_1_5))) - ((min (var_1_12 , 100)) - (var_1_13 + 25))))) : 1) : 1)) && ((var_1_63 > var_1_34) ? (var_1_14 == ((float) (((256.5f + var_1_15) + (max (var_1_16 , var_1_17))) + var_1_18))) : 1)) && ((var_1_47 > (max (var_1_37 , (var_1_4 + var_1_11)))) ? (var_1_19 == ((unsigned char) (var_1_12 + (var_1_22 - var_1_13)))) : 1)) && ((var_1_22 <= var_1_12) ? (var_1_23 == ((unsigned short int) ((var_1_24 - var_1_22) + var_1_5))) : (((var_1_17 + var_1_8) <= var_1_7) ? (var_1_23 == ((unsigned short int) ((min (var_1_13 , (abs (var_1_4)))) + var_1_12))) : 1))) && ((-64 >= var_1_37) ? (var_1_25 == ((float) (min (var_1_17 , (abs (var_1_18)))))) : (var_1_25 == ((float) (var_1_15 + (var_1_27 - (var_1_28 - var_1_29))))))) && ((last_1_var_1_34 >= ((min (last_1_var_1_49 , var_1_22)) - (1 + 8))) ? (var_1_30 == ((signed char) (min ((max (-50 , var_1_13)) , (var_1_4 + var_1_5))))) : (var_1_30 == ((signed char) ((max ((var_1_12 - var_1_13) , (var_1_31 + var_1_5))) - var_1_4))))) && (var_1_32 == ((signed char) (min ((var_1_31 - var_1_5) , var_1_13))))) && (((abs (var_1_16)) >= var_1_7) ? (var_1_33 == ((float) var_1_29)) : (var_1_33 == ((float) ((var_1_29 - var_1_27) + 3.6f))))) && (((var_1_8 - var_1_27) < 100.5f) ? (var_1_34 == ((signed short int) (last_1_var_1_35 + last_1_var_1_6))) : 1)) && (((- var_1_25) <= (var_1_27 - var_1_8)) ? (var_1_59 ? (var_1_35 == ((signed long int) (var_1_57 + var_1_12))) : ((var_1_23 <= var_1_63) ? (var_1_35 == ((signed long int) (var_1_45 + var_1_44))) : 1)) : ((var_1_13 >= var_1_63) ? ((var_1_23 < var_1_57) ? ((var_1_14 <= var_1_17) ? (var_1_35 == ((signed long int) var_1_32)) : 1) : (var_1_35 == ((signed long int) var_1_23))) : (var_1_35 == ((signed long int) var_1_60))))) && (((var_1_10 >= (- var_1_12)) && last_1_var_1_52) ? (last_1_var_1_52 ? (var_1_37 == ((unsigned long int) (min (((min (var_1_22 , var_1_4)) + var_1_5) , var_1_13)))) : 1) : (var_1_37 == ((unsigned long int) (max (var_1_5 , var_1_10)))))) && (var_1_59 ? (var_1_38 == ((signed short int) var_1_4)) : (var_1_38 == ((signed short int) (abs (var_1_35)))))) && (var_1_39 == ((unsigned char) (last_1_var_1_59 || (! var_1_40))))) && (((var_1_42 - var_1_13) >= var_1_63) ? (var_1_41 == ((float) ((8.0912819693463839E18f - var_1_29) - var_1_27))) : (var_1_52 ? (((- var_1_32) <= var_1_5) ? ((var_1_17 != ((var_1_61 + var_1_8) * (var_1_16 / var_1_28))) ? (var_1_41 == ((float) (var_1_29 - var_1_27))) : 1) : ((var_1_8 <= (16.75f / (min (var_1_28 , var_1_43)))) ? (var_1_41 == ((float) (var_1_17 + var_1_16))) : (var_1_41 == ((float) var_1_29)))) : (var_1_41 == ((float) (var_1_28 + var_1_16)))))) && (var_1_40 ? (var_1_52 ? (var_1_44 == ((signed char) (max (((abs (var_1_13)) - (max (var_1_5 , var_1_12))) , var_1_31)))) : (var_1_44 == ((signed char) (var_1_31 + -32)))) : (var_1_44 == ((signed char) (abs (var_1_31)))))) && ((! var_1_40) ? ((var_1_10 <= 10u) ? (var_1_45 == ((signed short int) (max (var_1_4 , (max (var_1_5 , var_1_13)))))) : (var_1_45 == ((signed short int) ((min ((last_1_var_1_45 + last_1_var_1_35) , -16)) + last_1_var_1_19)))) : (var_1_45 == ((signed short int) last_1_var_1_34)))) && ((var_1_40 || var_1_39) ? (var_1_47 == ((unsigned char) (var_1_22 + var_1_13))) : (var_1_47 == ((unsigned char) (var_1_48 - 1))))) && (var_1_52 ? (var_1_49 == ((signed short int) var_1_30)) : (var_1_49 == ((signed short int) (min ((var_1_44 + var_1_44) , var_1_31)))))) && ((var_1_60 <= var_1_1) ? (var_1_51 == ((signed long int) (min (((max (var_1_13 , var_1_31)) - var_1_1) , var_1_48)))) : 1)) && (((var_1_23 >= (max (var_1_6 , var_1_24))) || var_1_40) ? (var_1_40 ? (var_1_52 == ((unsigned char) var_1_53)) : 1) : (var_1_39 ? ((var_1_59 && var_1_53) ? (var_1_52 == ((unsigned char) (! (var_1_59 && var_1_54)))) : (var_1_52 == ((unsigned char) (var_1_53 && var_1_55)))) : (((- var_1_30) <= (var_1_4 - var_1_31)) ? (var_1_52 == ((unsigned char) ((! var_1_54) || var_1_53))) : (var_1_52 == ((unsigned char) (! (var_1_54 || (var_1_53 && var_1_56))))))))) && ((var_1_60 != (var_1_11 / var_1_12)) ? (var_1_57 == ((signed short int) (var_1_32 + var_1_45))) : 1)) && ((! (var_1_34 <= -4)) ? (var_1_58 == ((double) 31.15)) : 1)) && ((255.7f > var_1_7) ? ((var_1_61 >= var_1_33) ? (var_1_59 == ((unsigned char) var_1_40)) : (var_1_59 == ((unsigned char) var_1_40))) : (var_1_59 == ((unsigned char) var_1_53)))) && (var_1_39 ? (var_1_60 == ((unsigned char) var_1_31)) : (var_1_60 == ((unsigned char) var_1_5)))) && ((var_1_45 > (abs (var_1_12))) ? (var_1_61 == ((double) (var_1_27 - (var_1_62 - var_1_29)))) : 1)) && (var_1_63 == ((signed short int) var_1_37))) && (var_1_64 == ((signed char) var_1_31))
;
}
int main(void) {
	isInitial = 1;
