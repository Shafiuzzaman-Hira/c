...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch28Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_34 <= var_1_27) {
		var_1_37 = (min ((32 - 2) , var_1_32));
	} else {
		if (var_1_32 < var_1_29) {
			var_1_37 = (min (-8 , (abs (var_1_32))));
		} else {
	...
	// From: CodeObject7
	if (var_1_31 <= 9.6) {
		var_1_38 = (max ((var_1_34 + var_1_32) , var_1_27));
	} else {
		if (var_1_25 <= var_1_26) {
			if (var_1_27 > (var_1_33 >> var_1_25)) {
				var_1_38 = (abs (var_1_27));
			} else {
				var_1_38 = (min (var_1_34 , (min (var_1_29 , var_1_37))));
			}
		}
	}
