...
int property() {
	return (5u < (32u % var_1_2)) ? (var_1_1 == ((signed long int) (max (((var_1_3 - var_1_4) - var_1_5) , (var_1_6 - var_1_7))))) : (var_1_8 ? (var_1_1 == ((signed long int) var_1_6)) : (var_1_1 == ((signed long int) var_1_7)))
;
}
int main(void) {
	isInitial = 1;
