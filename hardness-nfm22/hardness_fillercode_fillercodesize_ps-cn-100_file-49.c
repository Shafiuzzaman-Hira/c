...
void step(void) {
	...
	// From: CodeObject3
	if ((var_1_26 % (min (var_1_29 , var_1_30))) < var_1_25) {
	...
	// From: CodeObject4
	if ((var_1_26 <= (max (100 , var_1_28))) || ((- var_1_30) <= var_1_29)) {
		var_1_31 = var_1_26;
	} else {
		var_1_31 = var_1_30;
	}
	...
	if (var_1_28 >= var_1_26) {
		var_1_32 = ((max (var_1_33 , var_1_34)) - (abs (var_1_35)));
	} else {
	...
	if ((abs (var_1_30)) > var_1_31) {
		var_1_36 = (max (var_1_35 , var_1_33));
	}
	...
	// From: CodeObject8
	if ((var_1_30 >> (min (var_1_40 , var_1_41))) >= -64) {
		var_1_39 = (min ((var_1_42 + 10000.9f) , (abs (var_1_34))));
	}
	...
	if (((~ var_1_25) / var_1_30) > var_1_29) {
		if (var_1_30 > (var_1_44 - var_1_41)) {
			if (var_1_32 >= (- (max (var_1_34 , var_1_35)))) {
				if (var_1_26 < var_1_44) {
					var_1_43 = (min ((var_1_45 - var_1_34) , (abs (0.75))));
				} else {
					var_1_43 = (abs (var_1_34));
				}
			}
		} else {
			if ((var_1_41 - (64 - var_1_40)) < var_1_29) {
				var_1_43 = (max ((min (var_1_45 , var_1_34)) , (var_1_42 + var_1_46)));
			}
		}
	}
	...
	if (var_1_37 && var_1_38) {
		...
		if (var_1_42 != (var_1_34 / var_1_48)) {
			var_1_47 = (abs (max (10 , (max (var_1_41 , var_1_40)))));
		} else {
			if (var_1_38) {
				var_1_47 = (min (var_1_41 , (min ((var_1_40 + var_1_49) , var_1_50))));
			}
		}
	}
