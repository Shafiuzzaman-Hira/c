...
void step(void) {
	...
	// From: Req7Batch37Amount100
	if (last_1_var_1_15 < (- var_1_14)) {
		var_1_18 = (var_1_2 || var_1_19);
	}


	// From: Req4Batch37Amount100
	var_1_10 = (min (var_1_5 , var_1_4));


	// From: Req5Batch37Amount100
	var_1_11 = (var_1_12 - (min (var_1_14 , var_1_13)));


	// From: Req8Batch37Amount100
	var_1_20 = var_1_5;


	// From: Req3Batch37Amount100
	if (var_1_21 != 10) {
