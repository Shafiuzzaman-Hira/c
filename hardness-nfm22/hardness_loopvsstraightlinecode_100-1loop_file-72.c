...
void step(void) {
	...
	// From: Req9Batch72100_1loop
	var_1_27 = var_1_24;


	// From: Req2Batch72100_1loop
	if (var_1_28) {
	...
	// From: Req6Batch72100_1loop
	if (var_1_20 > var_1_15) {
		var_1_22 = var_1_21;
	}


	// From: Req11Batch72100_1loop
