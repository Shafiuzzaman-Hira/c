...
void step(void) {
 ...
 if (! BOOL_unsigned_char_Array_0[0][0]) {
  ...
  signed_long_int_Array_0[4] = ((((((signed_long_int_Array_0[0]) < 0 ) ? -(signed_long_int_Array_0[0]) : (signed_long_int_Array_0[0]))) + signed_long_int_Array_0[1]) + signed_long_int_Array_0[3]);
 }
