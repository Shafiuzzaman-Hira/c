...
void step(void) {
	...
	// From: CodeObject4
	if (((~ var_1_41) >> (max (var_1_47 , var_1_48))) >= var_1_9) {
	...
	// From: Req7Batch96Filler_PS_CO
	var_1_31 = var_1_30;


	// From: Req1Batch96Filler_PS_CO
	if (var_1_23 < var_1_23) {
