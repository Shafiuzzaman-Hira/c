...
void step(void) {
	...
	if ((*(var_1_21_Pointer))) {
		(*(var_1_1_Pointer)) = (min (((*(var_1_17_Pointer)) + (*(var_1_6_Pointer))) , -16));
	} else {
		if ((*(var_1_8_Pointer))) {
...
int property() {
	return ((((((*(var_1_21_Pointer)) ? ((*(var_1_1_Pointer)) == ((signed long int) (min (((*(var_1_17_Pointer)) + (*(var_1_6_Pointer))) , -16)))) : ((*(var_1_8_Pointer)) ? ((*(var_1_1_Pointer)) == ((signed long int) ((*(var_1_6_Pointer)) + -4))) : ((*(var_1_1_Pointer)) == ((signed long int) (*(var_1_6_Pointer)))))) && ((*(var_1_6_Pointer)) == ((unsigned char) (min ((max (32 , (*(var_1_7_Pointer)))) , 16))))) && ((*(var_1_8_Pointer)) == ((unsigned char) (((*(var_1_9_Pointer)) || ((*(var_1_10_Pointer)) || (*(var_1_11_Pointer)))) || (*(var_1_12_Pointer)))))) && ((*(var_1_13_Pointer)) == ((unsigned char) (((*(var_1_14_Pointer)) && (*(var_1_15_Pointer))) && (*(var_1_16_Pointer)))))) && ((*(var_1_13_Pointer)) ? ((*(var_1_17_Pointer)) == ((signed char) ((min ((*(var_1_19_Pointer)) , 100)) - 64))) : ((*(var_1_17_Pointer)) == ((signed char) ((*(var_1_19_Pointer)) - (*(var_1_20_Pointer))))))) && ((((*(var_1_7_Pointer)) * ((*(var_1_6_Pointer)) / (*(var_1_23_Pointer)))) == (*(var_1_6_Pointer))) ? ((! (*(var_1_10_Pointer))) ? ((*(var_1_21_Pointer)) == ((unsigned char) (*(var_1_12_Pointer)))) : ((*(var_1_21_Pointer)) == ((unsigned char) (*(var_1_10_Pointer))))) : ((*(var_1_21_Pointer)) == ((unsigned char) (*(var_1_9_Pointer)))))
;
}
int main(void) {
	isInitial = 1;
