...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch53normal.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch53normal
	if ((var_1_2 * var_1_3) == var_1_4) {
		if ((var_1_4 > (var_1_5 - var_1_6)) && var_1_7) {
			var_1_1 = var_1_8;
		}
	}


	// From: Req2Batch53normal
	if ((var_1_1 || (var_1_6 <= var_1_2)) || (var_1_3 != var_1_4)) {
		if ((min (var_1_6 , 0)) <= (-5 + var_1_5)) {
			var_1_9 = var_1_6;
		}
	}


	// From: Req3Batch53normal
	if ((! var_1_1) || var_1_8) {
		var_1_10 = (min ((var_1_11 + var_1_12) , (abs (var_1_13))));
	} else {
		if ((var_1_11 < var_1_12) || (var_1_4 != var_1_6)) {
			var_1_10 = var_1_13;
		} else {
			var_1_10 = var_1_12;
		}
	...
	// From: Req5Batch53normal
	if (((max (var_1_15 , var_1_9)) / var_1_17) <= (256u << var_1_2)) {
		var_1_16 = (max (var_1_18 , var_1_19));
	}


	// From: Req6Batch53normal
	var_1_20 = var_1_21;


	// From: Req7Batch53normal
	var_1_22 = var_1_12;


	// From: Req8Batch53normal
	var_1_23 = var_1_21;
}
