...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch28Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_25 = var_1_17;
 if (var_1_34 <= var_1_6) {
  var_1_37 = (((((32 - 2)) < (var_1_15)) ? ((32 - 2)) : (var_1_15)));
 } else {
  if (var_1_15 < var_1_10) {
   var_1_37 = ((((-8) < (((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15))))) ? (-8) : (((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15))))));
  } else {
   if ((var_1_1 * var_1_10) < var_1_6) {
    var_1_37 = var_1_15;
   } else {
    var_1_37 = var_1_15;
   }
 ...
 if (var_1_22 <= 9.6) {
  var_1_38 = (((((var_1_34 + var_1_11)) > (var_1_1)) ? ((var_1_34 + var_1_11)) : (var_1_1)));
 } else {
  if (var_1_9 <= var_1_16) {
   if (var_1_1 > (var_1_6 >> var_1_9)) {
    var_1_38 = ((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)));
   } else {
    var_1_38 = ((((var_1_34) < (((((var_1_8) < (var_1_15)) ? (var_1_8) : (var_1_15))))) ? (var_1_34) : (((((var_1_8) < (var_1_15)) ? (var_1_8) : (var_1_15))))));
   }
  }
 }
 ...
 if ((var_1_1 < ((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17)))) || var_1_13) {
  var_1_27 = var_1_7;
 }
 if (var_1_10 <= (~ (var_1_8 & var_1_6))) {
 ...
 if (! var_1_14) {
  var_1_30 = ((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19)));
 }
}
