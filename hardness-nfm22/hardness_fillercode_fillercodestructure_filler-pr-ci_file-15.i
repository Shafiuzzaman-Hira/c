...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch15Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_34 = ((((128) < (((((var_1_8) > ((-5 + var_1_9))) ? (var_1_8) : ((-5 + var_1_9)))))) ? (128) : (((((var_1_8) > ((-5 + var_1_9))) ? (var_1_8) : ((-5 + var_1_9)))))));
 if (var_1_9 <= var_1_9) {
 ...
 if (! var_1_20) {
  if (var_1_20) {
   var_1_26 = (((((((var_1_10) < (var_1_8)) ? (var_1_10) : (var_1_8))) < 0 ) ? -((((var_1_10) < (var_1_8)) ? (var_1_10) : (var_1_8))) : ((((var_1_10) < (var_1_8)) ? (var_1_10) : (var_1_8)))));
  } else {
   if (var_1_8 >= 25) {
    if ((0 > var_1_8) || var_1_19) {
 ...
 if (var_1_19) {
  var_1_36 = (((((4.2) < (var_1_15)) ? (4.2) : (var_1_15))) - ((8.021944736140885E18 - var_1_38) - 16.75));
 } else {
  var_1_36 = ((((var_1_15) > (var_1_38)) ? (var_1_15) : (var_1_38)));
 }
 var_1_39 = var_1_11;
 ...
 if (var_1_19) {
  var_1_41 = ((((((((var_1_11) < (var_1_9)) ? (var_1_11) : (var_1_9)))) > (var_1_8)) ? (((((var_1_11) < (var_1_9)) ? (var_1_11) : (var_1_9)))) : (var_1_8)));
 }
}
