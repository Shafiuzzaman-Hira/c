...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch87no_floats.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_0 < var_1_4) {
  if (stepLocal_1 != var_1_12) {
   var_1_5 = (((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6))) - (((((var_1_7) < (var_1_8)) ? (var_1_7) : (var_1_8))) + var_1_9));
  } else {
   var_1_5 = -8;
  }
 } else {
 ...
 if ((last_1_var_1_10 * var_1_3) <= var_1_4) {
  if ((var_1_9 - ((((-1) < 0 ) ? -(-1) : (-1)))) <= (var_1_15 * var_1_8)) {
...
int property() {
 return (((((var_1_13 ? (var_1_1 == ((unsigned long int) ((((var_1_3 - var_1_4) < 0 ) ? -(var_1_3 - var_1_4) : (var_1_3 - var_1_4))))) : 1) && ((-8 < var_1_4) ? ((var_1_4 != var_1_12) ? (var_1_5 == ((signed char) (((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6))) - (((((var_1_7) < (var_1_8)) ? (var_1_7) : (var_1_8))) + var_1_9)))) : (var_1_5 == ((signed char) -8))) : (var_1_5 == ((signed char) var_1_8)))) && (((last_1_var_1_10 * var_1_3) <= var_1_4) ? (((var_1_9 - ((((-1) < 0 ) ? -(-1) : (-1)))) <= (var_1_15 * var_1_8)) ? (var_1_10 == ((signed long int) (var_1_8 - var_1_9))) : (var_1_10 == ((signed long int) var_1_7))) : (var_1_10 == ((signed long int) var_1_7)))) && (var_1_12 == ((signed long int) var_1_8))) && (var_1_13 == ((unsigned char) var_1_14))) && (var_1_15 == ((unsigned long int) var_1_9))
;
}
int main(void) {
 isInitial = 1;
