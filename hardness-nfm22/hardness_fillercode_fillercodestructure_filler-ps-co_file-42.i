...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch42Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
 if (var_1_19 || var_1_8) {
  var_1_21 = ((var_1_13 > -4) || var_1_25);
 }
 if (((var_1_13 + 25) % var_1_27) < 2) {
  var_1_26 = (((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28))) + var_1_29);
 }
 if ((- var_1_28) < ((((var_1_14) > (var_1_29)) ? (var_1_14) : (var_1_29)))) {
  var_1_30 = var_1_29;
 }
 if (((((((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)))) < (var_1_13)) ? (((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)))) : (var_1_13))) <= var_1_13) {
  var_1_31 = var_1_33;
 }
