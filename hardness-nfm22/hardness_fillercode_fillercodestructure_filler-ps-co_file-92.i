...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch92Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_28 = var_1_29;
 if (var_1_20 < 2) {
  var_1_30 = (((((((((var_1_26) > (var_1_27)) ? (var_1_26) : (var_1_27)))) > (var_1_20)) ? (((((var_1_26) > (var_1_27)) ? (var_1_26) : (var_1_27)))) : (var_1_20))) + var_1_17);
 } else {
  var_1_30 = var_1_26;
 }
 if ((~ (var_1_1 | var_1_20)) >= (~ (~ 32))) {
  var_1_32 = var_1_27;
 }
 if ((var_1_17 >> var_1_20) <= var_1_17) {
  if (var_1_16 > var_1_17) {
   var_1_33 = ((((10000) > (var_1_16)) ? (10000) : (var_1_16)));
  }
 }
 if (var_1_16 >= var_1_1) {
  if (var_1_1 > (((((var_1_12) < (-2)) ? (var_1_12) : (-2))) | var_1_27)) {
   var_1_34 = ((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35)));
  }
 }
 if (((var_1_20 - var_1_27) > var_1_16) && var_1_37) {
