...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch9100_while.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (! var_1_5) {
  if (-4 <= var_1_33) {
   if ((((((- var_1_33)) > (var_1_33)) ? ((- var_1_33)) : (var_1_33))) >= var_1_33) {
    var_1_14 = (((((var_1_33 + 5)) < (var_1_13)) ? ((var_1_33 + 5)) : (var_1_13)));
   } else {
 ...
 if (var_1_1 == 0) {
  var_1_6 = (((((var_1_1 + var_1_32)) > (var_1_14)) ? ((var_1_1 + var_1_32)) : (var_1_14)));
 } else {
  if (var_1_14 < var_1_1) {
   var_1_6 = var_1_1;
  } else {
 ...
 if (! var_1_5) {
  if (-2 >= stepLocal_0) {
   var_1_16 = (((((var_1_17 - var_1_18) - 32) < 0 ) ? -((var_1_17 - var_1_18) - 32) : ((var_1_17 - var_1_18) - 32)));
  }
 } else {
  var_1_16 = var_1_18;
 }
 ...
 if (var_1_5) {
  ...
  if (var_1_33 == ((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30)))) {
   var_1_10 = (((((var_1_12 - var_1_13)) < (var_1_11)) ? ((var_1_12 - var_1_13)) : (var_1_11)));
  } else {
   var_1_10 = var_1_13;
  }
 }
