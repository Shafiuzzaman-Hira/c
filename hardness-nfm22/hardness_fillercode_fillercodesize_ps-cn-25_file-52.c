...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch52PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject4
	var_1_33 = (max (var_1_30 , (128 - var_1_34)));


	// From: CodeObject5
	if ((abs (var_1_32)) <= (max (var_1_31 , var_1_36))) {
		var_1_35 = var_1_33;
	}
	...
	// From: CodeObject6
	if (var_1_30 > 5) {
		var_1_37 = (max (var_1_26 , var_1_33));
	} else {
		var_1_37 = (abs (-50));
	}
	...
	// From: Req8Batch52PS_CN_25
	var_1_20 = var_1_17;


	// From: Req4Batch52PS_CN_25
	var_1_12 = (var_1_13 && var_1_14);


	// From: Req9Batch52PS_CN_25
	var_1_21 = var_1_8;


	// From: Req10Batch52PS_CN_25
	var_1_22 = -256;


	// From: Req1Batch52PS_CN_25
