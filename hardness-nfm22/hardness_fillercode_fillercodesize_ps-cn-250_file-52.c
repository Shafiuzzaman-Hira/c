...
void step(void) {
	...
	if (var_1_42 <= var_1_27) {
		if (var_1_36 <= var_1_28) {
			var_1_44 = (var_1_40 - (min ((min (var_1_42 , var_1_45)) , var_1_46)));
		}
	}
	...
	// From: CodeObject9
	if ((var_1_51 - var_1_45) <= (abs (-8))) {
		if (var_1_39 >= (~ var_1_52)) {
			if ((~ (- var_1_51)) <= var_1_39) {
				var_1_50 = (max ((var_1_53 - (abs (var_1_40))) , var_1_46));
			} else {
				var_1_50 = (abs (var_1_42));
			}
		}
	}
	...
	// From: CodeObject10
	if (var_1_34) {
		if ((max (var_1_28 , var_1_53)) >= (var_1_39 & var_1_55)) {
	...
	// From: CodeObject11
	if (! var_1_43) {
		var_1_57 = (abs (abs (var_1_48)));
	} else {
		var_1_57 = (abs ((abs (var_1_48)) - var_1_58));
	}


	// From: CodeObject12
	if ((var_1_56 % var_1_53) <= var_1_51) {
		var_1_59 = (abs (min (var_1_58 , var_1_48)));
	} else {
		var_1_59 = (var_1_58 - (abs (var_1_48)));
	}


	// From: CodeObject13
	var_1_60 = (min ((max ((abs (var_1_58)) , var_1_48)) , (abs (var_1_61))));
	...
	if (var_1_33 && (var_1_40 <= var_1_36)) {
		if (32 > var_1_49) {
			if (var_1_23 <= (var_1_28 / -5)) {
				var_1_63 = (var_1_53 - (min (var_1_45 , 5)));
			} else {
				var_1_63 = (min ((max ((min (var_1_46 , var_1_40)) , 5)) , var_1_53));
			}
		}
	}
	...
	if ((var_1_23 ^ var_1_29) <= var_1_36) {
		if ((var_1_28 / var_1_51) > var_1_54) {
			var_1_68 = ((min ((var_1_69 + var_1_70) , var_1_39)) - ((100 - 10) - 8));
		}
	}
	...
	if ((var_1_61 / var_1_72) < var_1_38) {
		...
		var_1_71 = (min ((var_1_42 + var_1_52) , var_1_29));
	}
	...
	if ((abs (var_1_28)) <= (~ var_1_27)) {
		var_1_74 = (abs (var_1_30));
	} else {
		var_1_74 = (var_1_70 - (abs (var_1_69)));
	}


	// From: CodeObject22
	if (var_1_68 < var_1_52) {
		var_1_75 = (min (var_1_69 , (var_1_76 - var_1_70)));
	} else {
		var_1_75 = (abs (abs (var_1_70)));
	}
	...
	// From: CodeObject31
	if (var_1_49 < ((abs (var_1_30)) << var_1_29)) {
	...
	// From: Req8Batch52PS_CN_250
	var_1_20 = var_1_17;


	// From: Req4Batch52PS_CN_250
	var_1_12 = (var_1_13 && var_1_14);


	// From: Req9Batch52PS_CN_250
	var_1_21 = var_1_8;


	// From: Req10Batch52PS_CN_250
	var_1_22 = -256;


	// From: Req1Batch52PS_CN_250
