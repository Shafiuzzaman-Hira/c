...
void step(void) {
	...
	// From: Req4Batch22stepLocals
	if ((var_1_3 / var_1_18) > var_1_2) {
		var_1_17 = ((var_1_19 - (max (var_1_10 , var_1_12))) - var_1_7);
	}


	// From: Req5Batch22stepLocals
	if (var_1_14) {
	...
	// From: Req8Batch22stepLocals
	if ((- 3.75) < (min (var_1_3 , var_1_22))) {
		var_1_27 = 0;
	}
}
...
int property() {
	return ((((((((var_1_2 < var_1_3) ? (var_1_1 == ((unsigned short int) (min (var_1_4 , var_1_5)))) : (var_1_1 == ((unsigned short int) (((var_1_6 + var_1_7) - var_1_8) + var_1_9)))) && ((var_1_9 < (var_1_8 << var_1_4)) ? (var_1_10 == ((unsigned char) (var_1_11 + var_1_12))) : (var_1_10 == ((unsigned char) var_1_11)))) && (((var_1_4 <= var_1_9) || var_1_14) ? (var_1_13 == ((unsigned short int) (max ((max (var_1_5 , var_1_8)) , var_1_15)))) : (var_1_13 == ((unsigned short int) var_1_16)))) && (((var_1_3 / var_1_18) > var_1_2) ? (var_1_17 == ((unsigned short int) ((var_1_19 - (max (var_1_10 , var_1_12))) - var_1_7))) : 1)) && (var_1_14 ? (var_1_20 == ((double) ((max ((max (var_1_21 , var_1_22)) , 16.6)) - var_1_23))) : (var_1_20 == ((double) var_1_22)))) && ((var_1_7 == var_1_10) ? (var_1_24 == ((unsigned long int) (2332545940u - (1490203111u - var_1_11)))) : (var_1_24 == ((unsigned long int) (var_1_5 + (var_1_25 - var_1_11)))))) && ((var_1_4 > (var_1_19 - var_1_7)) ? (var_1_26 == ((unsigned long int) var_1_8)) : 1)) && (((- 3.75) < (min (var_1_3 , var_1_22))) ? (var_1_27 == ((unsigned char) 0)) : 1)
;
}
int main(void) {
	isInitial = 1;
