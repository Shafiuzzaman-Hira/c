...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch32Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch32Filler_PE_CO
	var_1_22 = var_1_12;


	// From: Req8Batch32Filler_PE_CO
	var_1_23 = var_1_8;


	// From: Req9Batch32Filler_PE_CO
	var_1_24 = var_1_6;


	// From: CodeObject1
	if (var_1_20 < (min (var_1_20 , (var_1_23 >> var_1_29)))) {
		if (var_1_20 > var_1_20) {
			var_1_25 = var_1_1;
		} else {
			if (((var_1_29 ^ var_1_23) >> var_1_20) > (abs (var_1_20))) {
				var_1_25 = (abs (var_1_1));
			}
		}
	} else {
		if ((var_1_29 - var_1_1) <= (~ (var_1_32 - var_1_1))) {
			var_1_25 = (max (var_1_1 , var_1_1));
		} else {
			var_1_25 = -32;
		}
	}
	...
	// From: CodeObject3
	if ((var_1_37 - var_1_38) >= (var_1_22 * var_1_22)) {
		var_1_36 = 5;
	}


	// From: CodeObject4
	if ((var_1_38 / (max (var_1_42 , 256.5))) < var_1_37) {
		var_1_41 = var_1_29;
	}


	// From: CodeObject5
	if (((min (var_1_22 , var_1_37)) >= (var_1_38 / var_1_42)) || var_1_35) {
		if (var_1_35 || var_1_15) {
			var_1_43 = (abs (99.65));
		}
	}
	...
	// From: CodeObject6
	if (var_1_29 <= (var_1_24 ^ (var_1_20 & var_1_13))) {
		if (var_1_35) {
			if (var_1_15) {
				var_1_45 = var_1_29;
			} else {
