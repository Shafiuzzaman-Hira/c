...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch1825_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch1825_1loop
	unsigned long int stepLocal_1 = last_1_var_1_10;
	unsigned long int stepLocal_0 = last_1_var_1_10 ^ (max (last_1_var_1_15 , last_1_var_1_10));
