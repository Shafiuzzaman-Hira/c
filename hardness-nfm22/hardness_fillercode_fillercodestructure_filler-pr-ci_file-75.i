...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch75Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_25 ^ (var_1_28 + var_1_24)) <= (((((((var_1_23) < (var_1_23)) ? (var_1_23) : (var_1_23))) < 0 ) ? -((((var_1_23) < (var_1_23)) ? (var_1_23) : (var_1_23))) : ((((var_1_23) < (var_1_23)) ? (var_1_23) : (var_1_23)))))) {
  var_1_33 = (((((((((((var_1_4) < (var_1_4)) ? (var_1_4) : (var_1_4)))) < (var_1_18)) ? (((((var_1_4) < (var_1_4)) ? (var_1_4) : (var_1_4)))) : (var_1_18))) < 0 ) ? -((((((((var_1_4) < (var_1_4)) ? (var_1_4) : (var_1_4)))) < (var_1_18)) ? (((((var_1_4) < (var_1_4)) ? (var_1_4) : (var_1_4)))) : (var_1_18))) : ((((((((var_1_4) < (var_1_4)) ? (var_1_4) : (var_1_4)))) < (var_1_18)) ? (((((var_1_4) < (var_1_4)) ? (var_1_4) : (var_1_4)))) : (var_1_18)))));
 } else {
  if (var_1_18 >= ((((var_1_4) > ((var_1_4 * var_1_16))) ? (var_1_4) : ((var_1_4 * var_1_16))))) {
   if (var_1_13) {
    var_1_33 = var_1_18;
   }
  }
 ...
 if (var_1_14) {
  if (var_1_12) {
   if (! (((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17))) > (4.5f + var_1_16))) {
    var_1_47 = var_1_48;
   }
  } else {
   var_1_47 = var_1_48;
 ...
 if (var_1_24 != var_1_25) {
  var_1_46 = ((((((((((var_1_6) < (var_1_4)) ? (var_1_6) : (var_1_4))) < 0 ) ? -((((var_1_6) < (var_1_4)) ? (var_1_6) : (var_1_4))) : ((((var_1_6) < (var_1_4)) ? (var_1_6) : (var_1_4))))) < 0 ) ? -(((((((var_1_6) < (var_1_4)) ? (var_1_6) : (var_1_4))) < 0 ) ? -((((var_1_6) < (var_1_4)) ? (var_1_6) : (var_1_4))) : ((((var_1_6) < (var_1_4)) ? (var_1_6) : (var_1_4))))) : (((((((var_1_6) < (var_1_4)) ? (var_1_6) : (var_1_4))) < 0 ) ? -((((var_1_6) < (var_1_4)) ? (var_1_6) : (var_1_4))) : ((((var_1_6) < (var_1_4)) ? (var_1_6) : (var_1_4)))))));
 } else {
  var_1_46 = ((((4.6) > (((((var_1_6) > (var_1_4)) ? (var_1_6) : (var_1_4))))) ? (4.6) : (((((var_1_6) > (var_1_4)) ? (var_1_6) : (var_1_4))))));
 }
 ...
 if ((var_1_25 % var_1_28) >= var_1_25) {
  var_1_26 = (var_1_7 || var_1_11);
 } else {
  var_1_26 = (var_1_7 && (var_1_11 && var_1_14));
 }
}
