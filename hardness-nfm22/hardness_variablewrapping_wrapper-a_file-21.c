...
void step(void) {
	...
	if (BOOL_unsigned_char_Array_0[0]) {
		if ((float_Array_0[0] - float_Array_0[1]) >= ((double_Array_0[1] + double_Array_0[2]) + double_Array_0[0])) {
			signed_short_int_Array_0[0] = (max (unsigned_short_int_Array_0[0] , unsigned_short_int_Array_0[0]));
		} else {
...
int property() {
	return ((((last_1_signed_short_int_Array_0_0_ + (max (last_1_signed_short_int_Array_0_0_ , last_1_signed_short_int_Array_0_0_))) < (last_1_signed_short_int_Array_0_0_ * last_1_signed_short_int_Array_0_0_)) ? ((last_1_signed_short_int_Array_0_0_ < (last_1_signed_short_int_Array_0_0_ - last_1_signed_short_int_Array_0_0_)) ? ((last_1_signed_short_int_Array_0_0_ != (abs (min (last_1_signed_short_int_Array_0_0_ , last_1_signed_short_int_Array_0_0_)))) ? (unsigned_short_int_Array_0[0] == ((unsigned short int) last_1_signed_short_int_Array_0_0_)) : 1) : 1) : (unsigned_short_int_Array_0[0] == ((unsigned short int) last_1_signed_short_int_Array_0_0_))) && (((min (double_Array_0[1] , double_Array_0[0])) <= double_Array_0[2]) ? ((last_1_BOOL_unsigned_char_Array_0_1_ && (unsigned_short_int_Array_0[0] >= unsigned_short_int_Array_0[0])) ? (BOOL_unsigned_char_Array_0[1] == ((unsigned char) 0)) : 1) : (BOOL_unsigned_char_Array_0[1] == ((unsigned char) BOOL_unsigned_char_Array_0[0])))) && (BOOL_unsigned_char_Array_0[0] ? (((float_Array_0[0] - float_Array_0[1]) >= ((double_Array_0[1] + double_Array_0[2]) + double_Array_0[0])) ? (signed_short_int_Array_0[0] == ((signed short int) (max (unsigned_short_int_Array_0[0] , unsigned_short_int_Array_0[0])))) : (signed_short_int_Array_0[0] == ((signed short int) unsigned_short_int_Array_0[0]))) : 1)
;
}
int main(void) {
	isInitial = 1;
