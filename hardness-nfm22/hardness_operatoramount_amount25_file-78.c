...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch78Amount25.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch78Amount25
	if (var_1_3) {
		var_1_14 = (2931747731u - var_1_10);
	}


	// From: Req1Batch78Amount25
