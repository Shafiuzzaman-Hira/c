...
void step(void) {
	...
	if ((var_1_12 + last_1_var_1_9) < last_1_var_1_25) {
		var_1_38 = ((max (last_1_var_1_1 , var_1_7)) + (max ((min (last_1_var_1_45 , var_1_8)) , last_1_var_1_39)));
	} else {
	...
	// From: Req23Batch47Amount250
	var_1_57 = var_1_17;


	// From: Req24Batch47Amount250
	var_1_58 = var_1_33;


	// From: Req9Batch47Amount250
	signed char stepLocal_8 = var_1_3;
	signed long int stepLocal_7 = (max (0 , 10)) | var_1_7;
	if (stepLocal_8 == var_1_15) {
		if (var_1_58 < stepLocal_7) {
			var_1_29 = (min ((var_1_30 - var_1_58) , var_1_6));
		} else {
			var_1_29 = (max (var_1_58 , (var_1_30 - var_1_6)));
		}
	}
	...
	if ((var_1_29 >> 4u) >= var_1_15) {
		if (var_1_16) {
			var_1_32 = (min ((var_1_33 - var_1_6) , ((64 - 32) + var_1_7)));
		}
	} else {
		var_1_32 = var_1_33;
	}
	...
	// From: Req21Batch47Amount250
	if (var_1_3 != last_1_var_1_48) {
		if (last_1_var_1_48 == (var_1_33 - 2)) {
			var_1_48 = ((max (var_1_7 , var_1_6)) + (var_1_49 + var_1_50));
		}
	} else {
	...
	if (1.5f < (var_1_12 * var_1_34)) {
		if (var_1_38 < stepLocal_12) {
			if (var_1_31) {
				var_1_46 = (var_1_11 + (abs (var_1_13)));
			} else {
				var_1_46 = (max (var_1_11 , ((var_1_10 - var_1_12) + var_1_13)));
			}
		} else {
			var_1_46 = ((max (var_1_11 , var_1_10)) - (max (var_1_12 , var_1_47)));
		}
	} else {
		if (stepLocal_14 >= var_1_29) {
			var_1_46 = ((min (var_1_47 , var_1_11)) - (max (5.75 , var_1_10)));
		} else {
			if (! var_1_57) {
				if (stepLocal_13 && var_1_17) {
					var_1_46 = (max (((var_1_12 + var_1_11) - var_1_10) , var_1_47));
				}
			}
		}
	}
	...
	// From: Req19Batch47Amount250
	signed char stepLocal_11 = var_1_6;
	if (stepLocal_11 != var_1_30) {
		var_1_45 = ((abs (var_1_29)) + ((min (var_1_33 , var_1_7)) - var_1_27));
	}
	...
	if (stepLocal_5 > var_1_3) {
		...
		var_1_25 = (min (var_1_10 , var_1_11));
	}


	// From: Req7Batch47Amount250
	if ((var_1_25 < var_1_13) || var_1_18) {
		if ((max (100000.5 , 9.99999999992E10)) >= var_1_12) {
			var_1_26 = (16 - 32);
		} else {
			var_1_26 = var_1_3;
		}
	...
	if (var_1_58 > var_1_29) {
		var_1_40 = (max ((max (var_1_33 , var_1_26)) , var_1_1));
	} else {
		var_1_40 = (abs (var_1_1));
	}
	...
	if (var_1_20 && stepLocal_10) {
		var_1_41 = (min (var_1_12 , var_1_10));
	} else {
	...
	if (var_1_41 <= ((min (var_1_11 , var_1_9)) + var_1_12)) {
		var_1_39 = (max ((max (var_1_33 , var_1_27)) , var_1_3));
	}


	// From: Req18Batch47Amount250
	var_1_42 = (((min (var_1_43 , var_1_44)) - (max (var_1_6 , var_1_39))) - (var_1_7 + var_1_33));


	// From: Req5Batch47Amount250
	if (! (var_1_11 != (var_1_12 - var_1_10))) {
		var_1_24 = (max ((min (var_1_42 , var_1_7)) , var_1_3));
	} else {
		var_1_24 = (var_1_6 - var_1_7);
	}


	// From: Req22Batch47Amount250
	signed long int stepLocal_15 = 100;
	if (var_1_7 <= stepLocal_15) {
		if (var_1_18) {
			var_1_56 = (var_1_24 + var_1_55);
		} else {
			var_1_56 = (abs (var_1_6));
		}
	} else {
		var_1_56 = var_1_24;
	}
	...
	if (var_1_57) {
		var_1_35 = (((min (var_1_36 , var_1_37)) - var_1_24) - var_1_6);
	} else {
...
int property() {
	return (((((((((((((((((((((((last_1_var_1_57 ? (var_1_1 == ((signed char) (abs (min (10 , var_1_3))))) : (last_1_var_1_14 ? ((var_1_3 <= last_1_var_1_24) ? (var_1_1 == ((signed char) 8)) : (var_1_1 == ((signed char) ((var_1_6 - var_1_7) - 64)))) : (var_1_1 == ((signed char) (var_1_7 + var_1_8))))) && ((var_1_6 > (var_1_7 + last_1_var_1_38)) ? ((var_1_3 >= var_1_6) ? (last_1_var_1_14 ? (var_1_9 == ((double) (((var_1_10 + var_1_11) - var_1_12) + var_1_13))) : (last_1_var_1_14 ? (var_1_9 == ((double) var_1_11)) : (var_1_9 == ((double) var_1_12)))) : (var_1_9 == ((double) var_1_13))) : (var_1_9 == ((double) var_1_13)))) && (last_1_var_1_31 ? (var_1_14 == ((unsigned char) (((var_1_6 / var_1_15) >= var_1_7) || (var_1_16 && var_1_17)))) : ((var_1_7 <= var_1_15) ? ((last_1_var_1_34 != var_1_12) ? (((var_1_7 / (abs (8u))) < 256u) ? (var_1_14 == ((unsigned char) (! (! 0)))) : (var_1_14 == ((unsigned char) (! (! var_1_16))))) : (var_1_14 == ((unsigned char) (var_1_18 || (var_1_16 && var_1_19))))) : 1))) && ((var_1_31 && var_1_14) ? ((var_1_11 == (var_1_46 / 128.5)) ? ((var_1_17 || (var_1_1 <= (var_1_6 - var_1_7))) ? (var_1_20 == ((unsigned char) (var_1_14 || var_1_16))) : (var_1_20 == ((unsigned char) (var_1_14 && var_1_19)))) : (var_1_20 == ((unsigned char) (((5 < var_1_15) || var_1_17) && var_1_16)))) : 1)) && ((! (var_1_11 != (var_1_12 - var_1_10))) ? (var_1_24 == ((signed short int) (max ((min (var_1_42 , var_1_7)) , var_1_3)))) : (var_1_24 == ((signed short int) (var_1_6 - var_1_7))))) && ((var_1_48 > var_1_3) ? (var_1_25 == ((float) var_1_11)) : (var_1_25 == ((float) (min (var_1_10 , var_1_11)))))) && (((var_1_25 < var_1_13) || var_1_18) ? (((max (100000.5 , 9.99999999992E10)) >= var_1_12) ? (var_1_26 == ((signed char) (16 - 32))) : (var_1_26 == ((signed char) var_1_3))) : 1)) && (((last_1_var_1_41 + var_1_11) != (- last_1_var_1_25)) ? ((last_1_var_1_56 < last_1_var_1_29) ? (var_1_27 == ((unsigned char) var_1_6)) : 1) : (var_1_27 == ((unsigned char) var_1_6)))) && ((var_1_3 == var_1_15) ? ((var_1_58 < ((max (0 , 10)) | var_1_7)) ? (var_1_29 == ((unsigned long int) (min ((var_1_30 - var_1_58) , var_1_6)))) : (var_1_29 == ((unsigned long int) (max (var_1_58 , (var_1_30 - var_1_6)))))) : 1)) && ((var_1_10 >= (var_1_12 - var_1_11)) ? ((((var_1_6 * var_1_27) / 100) < var_1_15) ? (var_1_31 == ((unsigned char) (! var_1_19))) : (var_1_31 == ((unsigned char) (var_1_18 || var_1_19)))) : (var_1_31 == ((unsigned char) (! 0))))) && (((var_1_29 >> 4u) >= var_1_15) ? (var_1_16 ? (var_1_32 == ((unsigned char) (min ((var_1_33 - var_1_6) , ((64 - 32) + var_1_7))))) : 1) : (var_1_32 == ((unsigned char) var_1_33)))) && ((var_1_13 > var_1_10) ? (var_1_34 == ((float) 4.5f)) : 1)) && (var_1_57 ? (var_1_35 == ((signed long int) (((min (var_1_36 , var_1_37)) - var_1_24) - var_1_6))) : (var_1_35 == ((signed long int) (var_1_36 - var_1_27))))) && (((var_1_12 + last_1_var_1_9) < last_1_var_1_25) ? (var_1_38 == ((signed long int) ((max (last_1_var_1_1 , var_1_7)) + (max ((min (last_1_var_1_45 , var_1_8)) , last_1_var_1_39))))) : (var_1_38 == ((signed long int) last_1_var_1_1)))) && ((var_1_41 <= ((min (var_1_11 , var_1_9)) + var_1_12)) ? (var_1_39 == ((signed long int) (max ((max (var_1_33 , var_1_27)) , var_1_3)))) : 1)) && ((var_1_58 > var_1_29) ? (var_1_40 == ((unsigned long int) (max ((max (var_1_33 , var_1_26)) , var_1_1)))) : (var_1_40 == ((unsigned long int) (abs (var_1_1)))))) && ((var_1_20 && var_1_14) ? (var_1_41 == ((double) (min (var_1_12 , var_1_10)))) : ((var_1_34 > (- var_1_25)) ? (var_1_41 == ((double) ((var_1_11 - var_1_12) + var_1_13))) : 1))) && (var_1_42 == ((signed short int) (((min (var_1_43 , var_1_44)) - (max (var_1_6 , var_1_39))) - (var_1_7 + var_1_33))))) && ((var_1_6 != var_1_30) ? (var_1_45 == ((signed short int) ((abs (var_1_29)) + ((min (var_1_33 , var_1_7)) - var_1_27)))) : 1)) && ((1.5f < (var_1_12 * var_1_34)) ? ((var_1_38 < (var_1_6 - var_1_7)) ? (var_1_31 ? (var_1_46 == ((double) (var_1_11 + (abs (var_1_13))))) : (var_1_46 == ((double) (max (var_1_11 , ((var_1_10 - var_1_12) + var_1_13)))))) : (var_1_46 == ((double) ((max (var_1_11 , var_1_10)) - (max (var_1_12 , var_1_47)))))) : ((var_1_38 >= var_1_29) ? (var_1_46 == ((double) ((min (var_1_47 , var_1_11)) - (max (5.75 , var_1_10))))) : ((! var_1_57) ? ((var_1_14 && var_1_17) ? (var_1_46 == ((double) (max (((var_1_12 + var_1_11) - var_1_10) , var_1_47)))) : 1) : 1)))) && ((var_1_3 != last_1_var_1_48) ? ((last_1_var_1_48 == (var_1_33 - 2)) ? (var_1_48 == ((unsigned char) ((max (var_1_7 , var_1_6)) + (var_1_49 + var_1_50)))) : 1) : ((last_1_var_1_48 > var_1_32) ? (var_1_48 == ((unsigned char) ((var_1_51 + (var_1_52 + var_1_53)) - (var_1_50 + (var_1_54 - var_1_55))))) : (var_1_48 == ((unsigned char) var_1_6))))) && ((var_1_7 <= 100) ? (var_1_18 ? (var_1_56 == ((signed short int) (var_1_24 + var_1_55))) : (var_1_56 == ((signed short int) (abs (var_1_6))))) : (var_1_56 == ((signed short int) var_1_24)))) && (var_1_57 == ((unsigned char) var_1_17))) && (var_1_58 == ((unsigned char) var_1_33))
;
}
int main(void) {
	isInitial = 1;
