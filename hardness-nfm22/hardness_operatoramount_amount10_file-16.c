...
void step(void) {
	...
	// From: Req2Batch16Amount10
	var_1_6 = var_1_5;


	// From: Req3Batch16Amount10
	var_1_7 = var_1_5;
}
...
int property() {
	return ((((var_1_2 - (var_1_3 + var_1_4)) <= (10u / 16u)) ? (var_1_1 == ((float) var_1_5)) : (var_1_1 == ((float) (abs (var_1_5))))) && (var_1_6 == ((float) var_1_5))) && (var_1_7 == ((double) var_1_5))
;
}
int main(void) {
	isInitial = 1;
