...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch32dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch32dependencies
	if (var_1_11 == var_1_18) {
		var_1_20 = ((var_1_5 + var_1_21) + var_1_8);
	}


	// From: Req2Batch32dependencies
	...
	// From: Req7Batch32dependencies
	var_1_22 = var_1_12;


	// From: Req8Batch32dependencies
	var_1_23 = var_1_8;


	// From: Req9Batch32dependencies
	var_1_24 = var_1_6;


	// From: Req1Batch32dependencies
	if (-32 < var_1_13) {
