...
void step(void) {
	...
	// From: Req4Batch32100_1loop
	if ((max ((var_1_14 / var_1_16) , var_1_10)) > var_1_11) {
		var_1_17 = (8.25 - 255.8);
	}


	// From: Req6Batch32100_1loop
	...
	// From: Req10Batch32100_1loop
	var_1_27 = ((var_1_28 - var_1_13) + var_1_16);


	// From: Req11Batch32100_1loop
	if (var_1_1) {
		var_1_29 = var_1_19;
	}


	// From: Req7Batch32100_1loop
