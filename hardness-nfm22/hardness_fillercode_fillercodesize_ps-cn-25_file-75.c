...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch75PS_CN_25.c", 13, "reach_error"); }
...
unsigned long int var_1_29 = 3910892853;
...
void step(void) {
	...
	// From: CodeObject4
	if (var_1_27 >= (max (50 , var_1_31))) {
		if ((max ((var_1_37 * var_1_38) , (abs (var_1_39)))) > 1000.65) {
			var_1_36 = var_1_35;
		}
	}
	...
	// From: Req3Batch75PS_CN_25
	if (! (var_1_4 < 16.8f)) {
		var_1_15 = var_1_6;
	}


	// From: Req7Batch75PS_CN_25
	var_1_25 = var_1_23;


	// From: Req2Batch75PS_CN_25
