...
void step(void) {
	...
	// From: Req5Batch10Amount100
	signed long int stepLocal_2 = 4 + var_1_13;
	if ((16 / -5) >= stepLocal_2) {
		var_1_18 = (max (var_1_19 , (max (var_1_20 , var_1_21))));
	}


	// From: Req14Batch10Amount100
	var_1_40 = var_1_14;


	// From: Req2Batch10Amount100
	var_1_10 = (var_1_40 - var_1_40);


	// From: Req3Batch10Amount100
	...
	// From: Req4Batch10Amount100
	if (var_1_8 <= var_1_40) {
		var_1_15 = (max (var_1_16 , var_1_17));
	}


	// From: Req7Batch10Amount100
	...
	// From: Req9Batch10Amount100
	if (var_1_37) {
		var_1_29 = (max (16 , (var_1_12 + var_1_7)));
	} else {
		var_1_29 = (((abs (var_1_8)) + var_1_30) - var_1_40);
	}


	// From: Req10Batch10Amount100
...
int property() {
	return (((((((((((((((var_1_26 <= 32) ? ((var_1_15 < var_1_15) ? (var_1_1 == ((unsigned short int) (var_1_26 + var_1_12))) : 1) : (var_1_1 == ((unsigned short int) ((var_1_12 + (var_1_7 - var_1_26)) + (var_1_8 - var_1_12))))) && (var_1_10 == ((signed short int) (var_1_40 - var_1_40)))) && ((var_1_40 >= 4) ? ((! ((var_1_13 - var_1_40) <= 64)) ? (var_1_12 == ((unsigned char) var_1_14)) : (var_1_12 == ((unsigned char) var_1_14))) : 1)) && ((var_1_8 <= var_1_40) ? (var_1_15 == ((float) (max (var_1_16 , var_1_17)))) : 1)) && (((16 / -5) >= (4 + var_1_13)) ? (var_1_18 == ((signed char) (max (var_1_19 , (max (var_1_20 , var_1_21)))))) : 1)) && ((((var_1_7 * var_1_12) * (var_1_29 * var_1_12)) == ((max (var_1_21 , var_1_20)) + var_1_35)) ? (var_1_22 == ((float) (var_1_23 + var_1_24))) : (var_1_41 ? (var_1_22 == ((float) var_1_17)) : (var_1_22 == ((float) var_1_24))))) && ((var_1_8 >= var_1_40) ? (var_1_26 == ((unsigned long int) var_1_7)) : 1)) && ((var_1_16 >= (var_1_17 / var_1_28)) ? (var_1_27 == ((unsigned short int) (last_1_var_1_26 + var_1_14))) : (((last_1_var_1_12 | last_1_var_1_35) < var_1_7) ? (var_1_27 == ((unsigned short int) last_1_var_1_12)) : 1))) && (var_1_37 ? (var_1_29 == ((unsigned short int) (max (16 , (var_1_12 + var_1_7))))) : (var_1_29 == ((unsigned short int) (((abs (var_1_8)) + var_1_30) - var_1_40))))) && (((var_1_40 / var_1_8) <= var_1_13) ? ((var_1_14 == (- var_1_40)) ? ((var_1_37 || var_1_37) ? (var_1_31 == ((float) var_1_24)) : 1) : (var_1_31 == ((float) var_1_17))) : (var_1_31 == ((float) var_1_16)))) && ((var_1_24 < var_1_16) ? (var_1_33 == ((signed long int) (var_1_30 + ((var_1_1 + var_1_27) - 10)))) : 1)) && (var_1_37 ? (var_1_35 == ((signed short int) (var_1_12 - (var_1_36 - var_1_12)))) : 1)) && ((var_1_36 <= var_1_30) ? (var_1_37 == ((unsigned char) ((! var_1_41) && var_1_38))) : (var_1_37 == ((unsigned char) (var_1_41 || var_1_39))))) && (var_1_40 == ((unsigned char) var_1_14))) && ((var_1_15 > (var_1_23 / var_1_28)) ? (((max ((var_1_33 | var_1_14) , var_1_36)) <= var_1_8) ? (var_1_41 == ((unsigned char) 0)) : (var_1_41 == ((unsigned char) 0))) : (var_1_41 == ((unsigned char) var_1_38)))
;
}
int main(void) {
	isInitial = 1;
