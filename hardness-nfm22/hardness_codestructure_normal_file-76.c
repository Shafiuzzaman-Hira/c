...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch76normal.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch76normal
	if ((var_1_6 * var_1_9) >= var_1_10) {
		if (var_1_2) {
			var_1_8 = var_1_4;
		}
	}
	...
	// From: Req4Batch76normal
	if (var_1_4 <= var_1_1) {
		var_1_11 = (var_1_9 + -128);
	} else {
		var_1_11 = ((min (-256 , var_1_9)) + (min (var_1_12 , (max (var_1_13 , 256)))));
	}


	// From: Req5Batch76normal
	if (var_1_5 >= var_1_1) {
		if ((abs (1.2)) < var_1_4) {
			var_1_14 = var_1_15;
		} else {
	...
	// From: Req6Batch76normal
	if (var_1_2) {
		if (var_1_1 == var_1_5) {
			if ((128 * (min (var_1_9 , var_1_10))) > 1) {
				var_1_17 = var_1_16;
			}
		} else {
			var_1_17 = var_1_15;
...
int property() {
	return (((((((! var_1_2) ? (var_1_1 == ((double) (min ((min (var_1_3 , var_1_4)) , var_1_5)))) : (var_1_1 == ((double) var_1_4))) && ((var_1_5 > (var_1_3 / var_1_7)) ? ((! var_1_2) ? (var_1_6 == ((signed long int) -10)) : 1) : 1)) && (((var_1_6 * var_1_9) >= var_1_10) ? (var_1_2 ? (var_1_8 == ((float) var_1_4)) : 1) : 1)) && ((var_1_4 <= var_1_1) ? (var_1_11 == ((signed long int) (var_1_9 + -128))) : (var_1_11 == ((signed long int) ((min (-256 , var_1_9)) + (min (var_1_12 , (max (var_1_13 , 256))))))))) && ((var_1_5 >= var_1_1) ? (((abs (1.2)) < var_1_4) ? (var_1_14 == ((unsigned short int) var_1_15)) : (var_1_14 == ((unsigned short int) var_1_16))) : 1)) && (var_1_2 ? ((var_1_1 == var_1_5) ? (((128 * (min (var_1_9 , var_1_10))) > 1) ? (var_1_17 == ((unsigned short int) var_1_16)) : 1) : (var_1_17 == ((unsigned short int) var_1_15))) : (var_1_17 == ((unsigned short int) var_1_16)))) && (((var_1_14 + (var_1_11 | var_1_6)) > var_1_16) ? (var_1_18 == ((unsigned char) (128 - (var_1_19 + var_1_20)))) : 1)
;
}
int main(void) {
	isInitial = 1;
