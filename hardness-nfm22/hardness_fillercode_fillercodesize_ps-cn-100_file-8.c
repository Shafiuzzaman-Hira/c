...
void step(void) {
	...
	// From: CodeObject6
	if (var_1_28 <= (max (var_1_37 , var_1_30))) {
		if (var_1_40 && var_1_31) {
			if (((abs (var_1_43)) - var_1_46) > var_1_44) {
				if (var_1_47) {
	...
	// From: CodeObject7
	if ((abs (var_1_52)) == (- (min (var_1_44 , var_1_50)))) {
		var_1_51 = (max (var_1_44 , var_1_53));
	}


	// From: CodeObject8
	if ((min ((abs (5.25f)) , var_1_43)) < (var_1_55 - var_1_46)) {
		var_1_54 = (abs (min ((var_1_56 - var_1_57) , (7.875 + 7.75))));
	}
	...
	// From: CodeObject10
	var_1_59 = ((min (var_1_60 , (abs (var_1_61)))) + var_1_62);


	// From: CodeObject11
	if (var_1_52 >= 15.51f) {
		if (var_1_60 > (abs (var_1_61))) {
			var_1_63 = (min (var_1_57 , var_1_56));
		}
	} else {
		if ((min (var_1_60 , var_1_32)) > (var_1_35 + 64)) {
			var_1_63 = var_1_53;
		}
	}
	...
	if (var_1_65 && var_1_48) {
		if ((var_1_37 % (abs (var_1_66))) > var_1_30) {
			var_1_64 = var_1_28;
		}
	} else {
		var_1_64 = var_1_27;
	...
	// From: Req1Batch8PS_CN_100
	if (last_1_var_1_13 == (last_1_var_1_13 % var_1_4)) {
		var_1_1 = (var_1_5 - var_1_6);
	}


	// From: Req5Batch8PS_CN_100
	if (var_1_10 == var_1_1) {
		if (var_1_11) {
	...
	// From: Req2Batch8PS_CN_100
	if (var_1_1 >= var_1_6) {
		var_1_7 = var_1_19;
	}


	// From: Req3Batch8PS_CN_100
