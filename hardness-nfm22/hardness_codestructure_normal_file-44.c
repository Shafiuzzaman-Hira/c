...
void step(void) {
	...
	if (var_1_3 == (min (var_1_4 , (var_1_6 / var_1_15)))) {
		var_1_14 = var_1_16;
	} else {
	...
	// From: Req7Batch44normal
	var_1_30 = (max (var_1_15 , var_1_13));


	// From: Req8Batch44normal
	var_1_31 = var_1_26;


	// From: Req9Batch44normal
	var_1_32 = var_1_21;
}
...
int property() {
	return (((((((((var_1_2 == ((var_1_3 + var_1_4) ^ (var_1_6 + var_1_7))) ? (var_1_1 == ((signed long int) var_1_2)) : 1) && (((abs (var_1_9)) < (min ((var_1_10 - var_1_11) , (abs (var_1_12))))) ? ((var_1_9 >= var_1_12) ? (var_1_8 == ((signed short int) var_1_13)) : (var_1_8 == ((signed short int) var_1_2))) : (var_1_8 == ((signed short int) 0)))) && ((var_1_3 == (min (var_1_4 , (var_1_6 / var_1_15)))) ? (var_1_14 == ((unsigned long int) var_1_16)) : (var_1_14 == ((unsigned long int) (var_1_17 - (16u + var_1_18)))))) && ((256 > var_1_18) ? (var_1_19 == ((signed char) (max ((abs (var_1_20)) , var_1_21)))) : 1)) && (((var_1_23 - var_1_24) > var_1_14) ? (var_1_22 == ((float) (var_1_25 - var_1_26))) : 1)) && ((! var_1_5) ? (var_1_27 == ((signed long int) ((var_1_13 + var_1_24) + (var_1_7 + (var_1_20 + var_1_8))))) : ((var_1_11 > var_1_22) ? (var_1_27 == ((signed long int) var_1_29)) : (var_1_27 == ((signed long int) var_1_6))))) && (var_1_30 == ((signed short int) (max (var_1_15 , var_1_13))))) && (var_1_31 == ((double) var_1_26))) && (var_1_32 == ((signed char) var_1_21))
;
}
int main(void) {
	isInitial = 1;
