...
void step(void) {
	...
	if (var_1_70 > var_1_88) {
		var_1_98 = (min (((var_1_76 + var_1_77) + var_1_54) , var_1_56));
	}
	...
	// From: Req6Batch93PS_CN_250
	if (var_1_15) {
		var_1_21 = ((var_1_22 + 25) - var_1_19);
	}


	// From: Req7Batch93PS_CN_250
	if (var_1_10) {
	...
	// From: Req5Batch93PS_CN_250
	if (var_1_16) {
		var_1_20 = (var_1_9 - 50);
	}


	// From: Req1Batch93PS_CN_250
