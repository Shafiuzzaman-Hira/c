...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch46Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject4
	if (var_1_6 != (var_1_6 + var_1_28)) {
		var_1_29 = (max (var_1_28 , (min ((abs (var_1_6)) , var_1_1))));
	} else {
		var_1_29 = var_1_6;
	}
	...
	// From: CodeObject5
	if ((-25 + (var_1_9 + var_1_9)) <= var_1_9) {
		if ((16 >> (abs (var_1_32))) > (var_1_9 >> var_1_9)) {
			var_1_31 = var_1_28;
		} else {
			var_1_31 = (abs (var_1_28));
		}
	}
	...
	if (var_1_24 || (var_1_25 && var_1_23)) {
		if (var_1_20 >= var_1_32) {
			...
			var_1_33 = (max ((var_1_32 - var_1_34) , ((var_1_35 + var_1_36) - 2)));
		}
	} else {
		if ((! (! var_1_23)) && ((abs (var_1_32)) <= var_1_34)) {
			var_1_33 = var_1_36;
		}
	}


	// From: Req3Batch46Filler_PS_CO
	...
	// From: Req6Batch46Filler_PS_CO
	var_1_17 = var_1_18;


	// From: Req7Batch46Filler_PS_CO
	var_1_19 = 5;


	// From: Req8Batch46Filler_PS_CO
	var_1_20 = var_1_15;


	// From: Req4Batch46Filler_PS_CO
	if (var_1_1 < var_1_20) {
