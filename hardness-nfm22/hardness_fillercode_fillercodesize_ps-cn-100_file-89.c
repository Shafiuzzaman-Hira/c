...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch89PS_CN_100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch89PS_CN_100
	var_1_18 = var_1_8;


	// From: Req3Batch89PS_CN_100
