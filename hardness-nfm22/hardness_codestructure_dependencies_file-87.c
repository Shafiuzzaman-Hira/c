...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch87dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch87dependencies
	if (var_1_6 <= ((var_1_18 * -50) + var_1_5)) {
		var_1_29 = var_1_30;
	}


	// From: Req8Batch87dependencies
	if (! (! var_1_1)) {
		if ((var_1_32 - var_1_33) != var_1_29) {
			var_1_31 = var_1_32;
		}
	} else {
		var_1_31 = var_1_33;
