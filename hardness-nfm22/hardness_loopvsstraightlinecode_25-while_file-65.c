...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch6525_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch6525_while
	if (var_1_3) {
		var_1_5 = ((10 + var_1_6) - 2);
	}


	// From: Req3Batch6525_while
