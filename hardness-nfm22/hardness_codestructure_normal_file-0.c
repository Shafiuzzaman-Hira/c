...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch0normal.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch0normal
	if (var_1_3 < var_1_2) {
		var_1_5 = ((var_1_2 - var_1_3) + var_1_4);
	}


	// From: Req3Batch0normal
	if (var_1_2 < (- var_1_5)) {
		var_1_6 = (32 - var_1_3);
	}


	// From: Req4Batch0normal
	if (var_1_1 > var_1_3) {
		if (var_1_4 <= var_1_6) {
			var_1_7 = (abs (var_1_3));
		}
	...
	// From: Req5Batch0normal
	if ((- 8u) >= (var_1_9 - var_1_2)) {
		var_1_8 = (! var_1_10);
	} else {
