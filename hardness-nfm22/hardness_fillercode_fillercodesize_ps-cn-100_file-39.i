...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch39PS_CN_100.c", 13, "reach_error"); }
...
unsigned short int var_1_52 = 50;
unsigned long int var_1_53 = 2;
signed short int var_1_54 = 2;
unsigned long int var_1_55 = 3827129176;
unsigned short int var_1_56 = 10;
...
void step(void) {
 ...
 if ((var_1_34 * var_1_27) <= (((((((2) > (var_1_30)) ? (2) : (var_1_30))) < 0 ) ? -((((2) > (var_1_30)) ? (2) : (var_1_30))) : ((((2) > (var_1_30)) ? (2) : (var_1_30)))))) {
  ...
  if ((var_1_27 & 64u) == (var_1_33 | (var_1_39 % var_1_40))) {
   var_1_38 = ((((((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36))) < 0 ) ? -((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36))) : ((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36))))) - var_1_35);
  } else {
   var_1_38 = ((((var_1_36) > (((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))))) ? (var_1_36) : (((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))))));
  }
 }
 if (var_1_28 || var_1_42) {
  if ((((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) >> 5) > var_1_27) {
   var_1_41 = ((((var_1_43) > (((((((((var_1_44) < 0 ) ? -(var_1_44) : (var_1_44)))) > (var_1_45)) ? (((((var_1_44) < 0 ) ? -(var_1_44) : (var_1_44)))) : (var_1_45))))) ? (var_1_43) : (((((((((var_1_44) < 0 ) ? -(var_1_44) : (var_1_44)))) > (var_1_45)) ? (((((var_1_44) < 0 ) ? -(var_1_44) : (var_1_44)))) : (var_1_45))))));
  }
 } else {
  var_1_41 = var_1_45;
 }
 if ((var_1_36 - var_1_47) < var_1_29) {
  if (((((var_1_48) < 0 ) ? -(var_1_48) : (var_1_48))) < var_1_41) {
   if (var_1_40 <= 8u) {
    if (var_1_49 < var_1_41) {
     if (var_1_28 || (var_1_49 < var_1_45)) {
      var_1_46 = ((((var_1_50) < (var_1_51)) ? (var_1_50) : (var_1_51)));
     }
    }
   } else {
    var_1_46 = ((((var_1_50) > (((((var_1_51) < (var_1_52)) ? (var_1_51) : (var_1_52))))) ? (var_1_50) : (((((var_1_51) < (var_1_52)) ? (var_1_51) : (var_1_52))))));
   }
  }
 }
 if (var_1_42 && var_1_28) {
  if ((var_1_33 ^ (var_1_39 + var_1_51)) >= (var_1_50 % var_1_40)) {
   var_1_53 = 10000u;
  }
 } else {
  if (var_1_32 > ((var_1_47 - var_1_35) + var_1_38)) {
   if ((4 - var_1_54) <= -64) {
    var_1_53 = (((((var_1_54 + var_1_51)) > ((((((var_1_55 - var_1_46)) < (var_1_52)) ? ((var_1_55 - var_1_46)) : (var_1_52))))) ? ((var_1_54 + var_1_51)) : ((((((var_1_55 - var_1_46)) < (var_1_52)) ? ((var_1_55 - var_1_46)) : (var_1_52))))));
   }
  }
 }
 if (var_1_33 == ((((var_1_50) < 0 ) ? -(var_1_50) : (var_1_50)))) {
  var_1_56 = (((((256) < 0 ) ? -(256) : (256))) + ((((var_1_54) < (var_1_57)) ? (var_1_54) : (var_1_57))));
 }
