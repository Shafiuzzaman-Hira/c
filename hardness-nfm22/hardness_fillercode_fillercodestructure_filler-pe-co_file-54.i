...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch54Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_33 = var_1_34;
 if ((var_1_14 ^ (var_1_1 >> var_1_34)) < var_1_14) {
  var_1_35 = var_1_1;
 }
 if (! var_1_13) {
 ...
 if (var_1_6 >= var_1_6) {
  ...
  if (var_1_30 <= ((((var_1_42 * var_1_18) < 0 ) ? -(var_1_42 * var_1_18) : (var_1_42 * var_1_18)))) {
   var_1_40 = ((((((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))) < 0 ) ? -((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))) : ((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))))) + ((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))));
  }
 }
 if ((var_1_38 < var_1_6) && (var_1_28 != var_1_41)) {
  if (var_1_6 > var_1_6) {
   var_1_43 = 8;
  } else {
   var_1_43 = var_1_38;
