...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch24Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch24Wrapper_S
	if (! WrapperStruct00.var_1_2) {
		WrapperStruct00.var_1_12 = WrapperStruct00.var_1_14;
	} else {
		WrapperStruct00.var_1_12 = ((! WrapperStruct00.var_1_15) || (! (! 0)));
	}


	// From: Req4Batch24Wrapper_S
	WrapperStruct00.var_1_16 = WrapperStruct00.var_1_5;


	// From: Req5Batch24Wrapper_S
	WrapperStruct00.var_1_17 = WrapperStruct00.var_1_18;


	// From: Req6Batch24Wrapper_S
	WrapperStruct00.var_1_19 = WrapperStruct00.var_1_4;


	// From: Req1Batch24Wrapper_S
	if (WrapperStruct00.var_1_12 || (64.75f < WrapperStruct00.var_1_17)) {
		if (WrapperStruct00.var_1_12) {
			WrapperStruct00.var_1_1 = (WrapperStruct00.var_1_4 - WrapperStruct00.var_1_5);
		} else {
			WrapperStruct00.var_1_1 = (min ((max (WrapperStruct00.var_1_4 , WrapperStruct00.var_1_5)) , WrapperStruct00.var_1_6));
		}
	} else {
	...
	// From: Req2Batch24Wrapper_S
	if ((max ((WrapperStruct00.var_1_17 * 127.75) , (WrapperStruct00.var_1_17 / 3.4))) >= WrapperStruct00.var_1_17) {
		WrapperStruct00.var_1_7 = (min ((WrapperStruct00.var_1_10 - (22925 - WrapperStruct00.var_1_5)) , WrapperStruct00.var_1_16));
	}
}
...
int property() {
	return ((((((WrapperStruct00.var_1_12 || (64.75f < WrapperStruct00.var_1_17)) ? (WrapperStruct00.var_1_12 ? (WrapperStruct00.var_1_1 == ((signed char) (WrapperStruct00.var_1_4 - WrapperStruct00.var_1_5))) : (WrapperStruct00.var_1_1 == ((signed char) (min ((max (WrapperStruct00.var_1_4 , WrapperStruct00.var_1_5)) , WrapperStruct00.var_1_6))))) : (WrapperStruct00.var_1_1 == ((signed char) WrapperStruct00.var_1_4))) && (((max ((WrapperStruct00.var_1_17 * 127.75) , (WrapperStruct00.var_1_17 / 3.4))) >= WrapperStruct00.var_1_17) ? (WrapperStruct00.var_1_7 == ((unsigned short int) (min ((WrapperStruct00.var_1_10 - (22925 - WrapperStruct00.var_1_5)) , WrapperStruct00.var_1_16)))) : 1)) && ((! WrapperStruct00.var_1_2) ? (WrapperStruct00.var_1_12 == ((unsigned char) WrapperStruct00.var_1_14)) : (WrapperStruct00.var_1_12 == ((unsigned char) ((! WrapperStruct00.var_1_15) || (! (! 0))))))) && (WrapperStruct00.var_1_16 == ((unsigned char) WrapperStruct00.var_1_5))) && (WrapperStruct00.var_1_17 == ((float) WrapperStruct00.var_1_18))) && (WrapperStruct00.var_1_19 == ((signed char) WrapperStruct00.var_1_4))
;
}
int main(void) {
	isInitial = 1;
