...
void step(void) {
	...
	// From: Req51Batch41Amount500
	var_1_106 = var_1_100;


	// From: Req29Batch41Amount500
	if (var_1_18 < ((abs (var_1_24)) / (abs (var_1_22)))) {
		var_1_79 = ((max (var_1_27 , (last_1_var_1_97 + 128))) - var_1_26);
	} else {
		var_1_79 = (max ((min (last_1_var_1_96 , (last_1_var_1_98 + last_1_var_1_69))) , last_1_var_1_75));
	}
	...
	if (last_1_var_1_99) {
		var_1_59 = (last_1_var_1_36 + (max (var_1_55 , last_1_var_1_97)));
	}
	...
	if (var_1_106 > stepLocal_32) {
		var_1_87 = (((var_1_27 + var_1_88) - var_1_86) + (min ((min (var_1_26 , var_1_28)) , var_1_53)));
	}
	...
	if (var_1_103) {
		if (var_1_94 >= (var_1_49 + var_1_18)) {
			if (stepLocal_17 || ((var_1_22 > 3.2f) || (var_1_103 || var_1_61))) {
				if (0 != stepLocal_19) {
					var_1_70 = (abs (var_1_30));
				} else {
					var_1_70 = (min ((max (var_1_57 , var_1_79)) , var_1_30));
				}
			} else {
				var_1_70 = (max (var_1_57 , (max (var_1_87 , (last_1_var_1_70 + var_1_29)))));
			}
		} else {
			var_1_70 = (var_1_25 - (min (var_1_10 , (var_1_72 - var_1_67))));
		}
	} else {
		if (stepLocal_20 < (min (var_1_79 , (- var_1_27)))) {
			var_1_70 = var_1_57;
		} else {
			if (var_1_67 <= stepLocal_18) {
				var_1_70 = (min ((min (var_1_95 , last_1_var_1_70)) , (var_1_79 - var_1_67)));
			}
		}
	}
	...
	if (var_1_87 >= (var_1_100 / var_1_8)) {
		...
		var_1_9 = ((min ((var_1_10 - var_1_59) , var_1_44)) - (max (var_1_59 , var_1_67)));
	}
	...
	if (stepLocal_8 || (var_1_67 <= var_1_17)) {
		if (last_1_var_1_46 >= stepLocal_9) {
			...
			var_1_46 = (min (var_1_43 , ((var_1_47 - var_1_27) + var_1_29)));
		}
	} else {
	...
	if (stepLocal_28 < var_1_43) {
		var_1_84 = (min (var_1_24 , (abs (var_1_50))));
	} else {
		var_1_84 = (min ((var_1_20 - var_1_22) , ((max (var_1_42 , var_1_24)) - (var_1_23 - var_1_50))));
	}


	// From: Req32Batch41Amount500
	signed long int stepLocal_31 = var_1_53 << (max (1 , var_1_86));
	...
	if ((var_1_24 >= var_1_94) && stepLocal_30) {
		if (stepLocal_31 < var_1_87) {
			if (var_1_53 < stepLocal_29) {
				if (((min (var_1_24 , var_1_50)) - var_1_20) >= var_1_18) {
					var_1_85 = (abs (var_1_19));
				} else {
					var_1_85 = (var_1_50 + (var_1_51 - var_1_42));
				}
			} else {
				var_1_85 = (max (var_1_21 , var_1_22));
			}
		}
	} else {
	...
	if (5u >= var_1_43) {
		var_1_91 = (var_1_102 + (max (var_1_10 , var_1_29)));
	}
	...
	if (var_1_80) {
		if (var_1_99) {
			var_1_34 = (max ((var_1_35 - var_1_100) , (var_1_27 + var_1_100)));
		}
	} else {
		var_1_34 = var_1_100;
	}
	...
	if ((- var_1_94) == var_1_84) {
		var_1_1 = (min (((abs (var_1_44)) + var_1_59) , var_1_97));
	} else {
		if (var_1_59 != (var_1_44 / (min (var_1_7 , var_1_8)))) {
			var_1_1 = (min (100000000u , (min ((2998348225u - var_1_59) , var_1_44))));
		}
	}
	...
	if ((var_1_86 + var_1_27) > stepLocal_36) {
		if (var_1_97 > stepLocal_35) {
			var_1_89 = ((max ((var_1_42 - 50.2f) , var_1_51)) + var_1_50);
		} else {
			var_1_89 = (abs (var_1_51 - (var_1_50 + var_1_42)));
		}
	} else {
		if (stepLocal_34 != ((var_1_47 / 25u) ^ var_1_57)) {
			if (stepLocal_33 >= var_1_97) {
				var_1_89 = (abs (var_1_24));
			} else {
				var_1_89 = (((max (1.4f , var_1_49)) + var_1_50) + (abs (var_1_18)));
			}
		} else {
			var_1_89 = (abs (min (var_1_49 , var_1_50)));
		}
	}
	...
	if (var_1_84 != (min ((min (var_1_101 , 7.375f)) , last_1_var_1_15))) {
	...
	if (var_1_29 > var_1_100) {
		if (var_1_80 || var_1_80) {
			if ((- var_1_35) <= var_1_10) {
				if ((var_1_97 * var_1_29) >= (min ((abs (var_1_35)) , var_1_100))) {
	...
	// From: Req49Batch41Amount500
	if (var_1_96 != var_1_87) {
		var_1_104 = (max (((var_1_22 - var_1_51) - var_1_42) , 4.6));
	}
	...
	if ((var_1_25 < var_1_97) || var_1_103) {
		if (((var_1_50 + var_1_23) + (var_1_18 + 1.5)) >= var_1_24) {
			if (var_1_96 > (min (var_1_93 , var_1_7))) {
				var_1_63 = ((max (var_1_28 , var_1_67)) - var_1_87);
			}
		} else {
			var_1_63 = (((min (var_1_58 , var_1_55)) + var_1_102) + var_1_38);
		}
	} else {
		var_1_63 = (max (((var_1_52 - var_1_53) + 4) , (max (var_1_28 , var_1_67))));
	}
	...
	if (stepLocal_22 >= var_1_37) {
		if (stepLocal_23 && var_1_60) {
			if ((max (var_1_87 , var_1_96)) >= stepLocal_21) {
				var_1_75 = var_1_37;
			}
		} else {
			var_1_75 = (abs (var_1_53));
		}
	}
}
...
int property() {
	return ((((((((((((((((((((((((((((((((((((((((((((((((((((- var_1_94) == var_1_84) ? (var_1_1 == ((unsigned long int) (min (((abs (var_1_44)) + var_1_59) , var_1_97)))) : ((var_1_59 != (var_1_44 / (min (var_1_7 , var_1_8)))) ? (var_1_1 == ((unsigned long int) (min (100000000u , (min ((2998348225u - var_1_59) , var_1_44)))))) : 1)) && ((var_1_87 >= (var_1_100 / var_1_8)) ? (var_1_9 == ((signed long int) ((var_1_10 - var_1_59) - var_1_44))) : (var_1_9 == ((signed long int) ((min ((var_1_10 - var_1_59) , var_1_44)) - (max (var_1_59 , var_1_67))))))) && ((var_1_84 != (min ((min (var_1_101 , 7.375f)) , last_1_var_1_15))) ? ((((var_1_67 / var_1_17) / var_1_8) > var_1_87) ? (var_1_15 == ((float) ((abs (var_1_18 + var_1_19)) - var_1_20))) : 1) : ((var_1_44 != (var_1_87 * var_1_67)) ? (var_1_15 == ((float) (min ((min ((var_1_19 + var_1_18) , var_1_20)) , var_1_21)))) : (var_1_15 == ((float) (9999999.25f - ((min (var_1_22 , var_1_23)) - var_1_24))))))) && (var_1_25 == ((signed char) (((var_1_26 + var_1_27) - var_1_28) - (min (var_1_29 , (5 + 1))))))) && (var_1_30 == ((signed short int) (max (var_1_29 , var_1_28))))) && (var_1_60 ? ((64 < var_1_29) ? (((var_1_59 == var_1_57) || var_1_99) ? (var_1_31 == ((double) var_1_18)) : 1) : (var_1_31 == ((double) (var_1_24 - var_1_23)))) : (var_1_31 == ((double) (max (var_1_20 , var_1_21)))))) && (var_1_80 ? (var_1_99 ? (var_1_34 == ((unsigned long int) (max ((var_1_35 - var_1_100) , (var_1_27 + var_1_100))))) : 1) : (var_1_34 == ((unsigned long int) var_1_100)))) && ((last_1_var_1_52 != last_1_var_1_1) ? (((var_1_10 / var_1_8) == var_1_27) ? (var_1_36 == ((signed char) (min ((min ((var_1_26 + var_1_27) , (var_1_29 - var_1_28))) , (min (var_1_37 , var_1_38)))))) : (var_1_36 == ((signed char) var_1_38))) : ((last_1_var_1_57 < (~ last_1_var_1_97)) ? (var_1_36 == ((signed char) (var_1_26 - var_1_29))) : (var_1_36 == ((signed char) (var_1_29 - var_1_27)))))) && ((var_1_29 > var_1_100) ? ((var_1_80 || var_1_80) ? (((- var_1_35) <= var_1_10) ? (((var_1_97 * var_1_29) >= (min ((abs (var_1_35)) , var_1_100))) ? (var_1_39 == ((double) (var_1_20 - var_1_22))) : (var_1_39 == ((double) (abs (31.5))))) : (var_1_39 == ((double) var_1_21))) : 1) : (var_1_39 == ((double) var_1_19)))) && (((var_1_22 <= (var_1_18 / var_1_23)) && var_1_80) ? ((var_1_23 >= var_1_21) ? (var_1_40 == ((double) (4.5 - 16.85))) : (var_1_40 == ((double) (var_1_23 - var_1_24)))) : 1)) && (((- 128) > var_1_57) ? (((- last_1_var_1_41) < (var_1_21 * var_1_39)) ? (var_1_41 == ((float) ((var_1_24 + var_1_42) - var_1_22))) : (var_1_41 == ((float) (abs (var_1_24))))) : 1)) && (var_1_99 ? (var_1_43 == ((unsigned char) (var_1_26 + var_1_27))) : 1)) && ((! var_1_60) ? (var_1_60 ? (var_1_44 == ((unsigned short int) var_1_29)) : 1) : (var_1_44 == ((unsigned short int) (var_1_27 + var_1_26))))) && ((var_1_99 || (var_1_67 <= var_1_17)) ? ((last_1_var_1_46 >= var_1_67) ? (var_1_46 == ((unsigned long int) (min ((var_1_35 - var_1_26) , 256u)))) : (var_1_46 == ((unsigned long int) (min (var_1_43 , ((var_1_47 - var_1_27) + var_1_29)))))) : (var_1_46 == ((unsigned long int) ((4118864680u - var_1_27) - var_1_47))))) && (((var_1_22 * var_1_42) < (- last_1_var_1_48)) ? (var_1_48 == ((float) (2.75f - ((min (var_1_42 , 9.5f)) + (var_1_49 + var_1_50))))) : (var_1_80 ? ((var_1_43 <= var_1_67) ? (var_1_48 == ((float) (var_1_18 + (min (var_1_50 , (min (var_1_24 , var_1_42))))))) : (var_1_48 == ((float) (var_1_20 - (var_1_23 - (var_1_51 - var_1_49)))))) : 1))) && (var_1_60 ? ((var_1_59 != (var_1_7 + var_1_43)) ? (var_1_52 == ((unsigned char) ((var_1_28 + var_1_26) + (var_1_27 + (var_1_53 + 16))))) : 1) : ((! (var_1_34 < var_1_70)) ? (var_1_52 == ((unsigned char) ((abs (var_1_55)) - var_1_29))) : ((var_1_99 || (var_1_34 <= var_1_38)) ? (((var_1_55 > var_1_27) && (var_1_64 && (var_1_79 <= var_1_59))) ? (var_1_52 == ((unsigned char) (var_1_26 + 50))) : (var_1_52 == ((unsigned char) (abs (var_1_26))))) : (var_1_52 == ((unsigned char) 8)))))) && (((last_1_var_1_44 + last_1_var_1_77) >= last_1_var_1_97) ? (((last_1_var_1_104 + (last_1_var_1_89 / var_1_51)) >= last_1_var_1_92) ? (((var_1_21 <= last_1_var_1_48) && (! last_1_var_1_60)) ? (var_1_57 == ((unsigned char) (var_1_55 - (abs (var_1_28))))) : (var_1_57 == ((unsigned char) (max ((abs (var_1_58)) , var_1_26))))) : 1) : 1)) && (last_1_var_1_99 ? (var_1_59 == ((unsigned short int) (last_1_var_1_36 + (max (var_1_55 , last_1_var_1_97))))) : 1)) && (((- var_1_18) < last_1_var_1_84) ? (var_1_60 == ((unsigned char) (last_1_var_1_80 && var_1_61))) : (var_1_60 == ((unsigned char) ((! var_1_62) || var_1_61))))) && (((var_1_25 < var_1_97) || var_1_103) ? ((((var_1_50 + var_1_23) + (var_1_18 + 1.5)) >= var_1_24) ? ((var_1_96 > (min (var_1_93 , var_1_7))) ? (var_1_63 == ((signed long int) ((max (var_1_28 , var_1_67)) - var_1_87))) : 1) : (var_1_63 == ((signed long int) (((min (var_1_58 , var_1_55)) + var_1_102) + var_1_38)))) : (var_1_63 == ((signed long int) (max (((var_1_52 - var_1_53) + 4) , (max (var_1_28 , var_1_67)))))))) && ((var_1_94 == var_1_101) ? (var_1_64 == ((unsigned char) var_1_61)) : (((var_1_23 + var_1_49) != (var_1_22 - (var_1_65 - var_1_50))) ? (var_1_64 == ((unsigned char) (! var_1_62))) : (var_1_64 == ((unsigned char) ((var_1_49 <= (var_1_65 - var_1_24)) || (var_1_103 || var_1_62))))))) && (var_1_66 == ((float) (min (var_1_20 , 7.5f))))) && ((var_1_7 < (last_1_var_1_67 % var_1_27)) ? (var_1_67 == ((unsigned char) (min (var_1_26 , (25 + (var_1_53 + var_1_28)))))) : 1)) && (var_1_62 ? (var_1_69 == ((signed char) (max (var_1_29 , var_1_26)))) : (var_1_69 == ((signed char) (abs ((abs (-50)) + var_1_53)))))) && (var_1_103 ? ((var_1_94 >= (var_1_49 + var_1_18)) ? ((var_1_60 || ((var_1_22 > 3.2f) || (var_1_103 || var_1_61))) ? ((0 != var_1_53) ? (var_1_70 == ((signed long int) (abs (var_1_30)))) : (var_1_70 == ((signed long int) (min ((max (var_1_57 , var_1_79)) , var_1_30))))) : (var_1_70 == ((signed long int) (max (var_1_57 , (max (var_1_87 , (last_1_var_1_70 + var_1_29)))))))) : (var_1_70 == ((signed long int) (var_1_25 - (min (var_1_10 , (var_1_72 - var_1_67))))))) : ((var_1_7 < (min (var_1_79 , (- var_1_27)))) ? (var_1_70 == ((signed long int) var_1_57)) : ((var_1_67 <= 10u) ? (var_1_70 == ((signed long int) (min ((min (var_1_95 , last_1_var_1_70)) , (var_1_79 - var_1_67))))) : 1)))) && ((! (var_1_55 > var_1_102)) ? (((! 1) && (var_1_29 > var_1_43)) ? (var_1_74 == ((double) (var_1_50 + var_1_49))) : 1) : (var_1_74 == ((double) (abs (var_1_18)))))) && ((var_1_77 >= var_1_37) ? (((var_1_47 < (3494519565u - var_1_53)) && var_1_60) ? (((max (var_1_87 , var_1_96)) >= (var_1_27 & var_1_57)) ? (var_1_75 == ((signed char) var_1_37)) : 1) : (var_1_75 == ((signed char) (abs (var_1_53))))) : 1)) && ((last_1_var_1_77 < var_1_58) ? (var_1_77 == ((unsigned long int) (var_1_35 - var_1_44))) : (var_1_77 == ((unsigned long int) var_1_59)))) && ((var_1_18 < ((abs (var_1_24)) / (abs (var_1_22)))) ? (var_1_79 == ((signed long int) ((max (var_1_27 , (last_1_var_1_97 + 128))) - var_1_26))) : (var_1_79 == ((signed long int) (max ((min (last_1_var_1_96 , (last_1_var_1_98 + last_1_var_1_69))) , last_1_var_1_75)))))) && ((var_1_59 == var_1_28) ? ((var_1_62 || (! (var_1_64 && var_1_61))) ? (var_1_80 == ((unsigned char) (var_1_60 && var_1_61))) : ((var_1_57 > var_1_36) ? (var_1_80 == ((unsigned char) (! ((var_1_64 || var_1_81) && var_1_62)))) : (var_1_80 == ((unsigned char) ((var_1_61 && var_1_82) || var_1_83))))) : (var_1_80 == ((unsigned char) var_1_82)))) && ((1u < var_1_43) ? (var_1_84 == ((double) (min (var_1_24 , (abs (var_1_50)))))) : (var_1_84 == ((double) (min ((var_1_20 - var_1_22) , ((max (var_1_42 , var_1_24)) - (var_1_23 - var_1_50)))))))) && (((var_1_24 >= var_1_94) && var_1_99) ? (((var_1_53 << (max (1 , var_1_86))) < var_1_87) ? ((var_1_53 < var_1_10) ? ((((min (var_1_24 , var_1_50)) - var_1_20) >= var_1_18) ? (var_1_85 == ((double) (abs (var_1_19)))) : (var_1_85 == ((double) (var_1_50 + (var_1_51 - var_1_42))))) : (var_1_85 == ((double) (max (var_1_21 , var_1_22))))) : 1) : (var_1_85 == ((double) ((6.4050959706936996E18 - 8.5) - var_1_42))))) && ((var_1_106 > var_1_59) ? (var_1_87 == ((unsigned char) (((var_1_27 + var_1_88) - var_1_86) + (min ((min (var_1_26 , var_1_28)) , var_1_53))))) : 1)) && (((var_1_86 + var_1_27) > var_1_26) ? ((var_1_97 > ((- var_1_35) * var_1_97)) ? (var_1_89 == ((float) ((max ((var_1_42 - 50.2f) , var_1_51)) + var_1_50))) : (var_1_89 == ((float) (abs (var_1_51 - (var_1_50 + var_1_42)))))) : (((- var_1_7) != ((var_1_47 / 25u) ^ var_1_57)) ? (((var_1_17 ^ var_1_53) >= var_1_97) ? (var_1_89 == ((float) (abs (var_1_24)))) : (var_1_89 == ((float) (((max (1.4f , var_1_49)) + var_1_50) + (abs (var_1_18)))))) : (var_1_89 == ((float) (abs (min (var_1_49 , var_1_50)))))))) && ((var_1_38 <= var_1_100) ? (var_1_90 == ((float) (63.6f - ((var_1_51 - var_1_49) + (3.4222737542221742E18f - var_1_50))))) : 1)) && ((5u >= var_1_43) ? (var_1_91 == ((unsigned long int) (var_1_102 + (max (var_1_10 , var_1_29))))) : 1)) && (var_1_92 == ((float) var_1_20))) && (var_1_93 == ((signed short int) var_1_98))) && (var_1_61 ? (var_1_94 == ((double) var_1_21)) : 1)) && (var_1_81 ? (var_1_95 == ((signed long int) var_1_79)) : (var_1_95 == ((signed long int) var_1_29)))) && (var_1_81 ? (var_1_96 == ((signed short int) last_1_var_1_96)) : (var_1_96 == ((signed short int) var_1_1)))) && (var_1_99 ? (var_1_97 == ((unsigned char) var_1_88)) : 1)) && (var_1_60 ? (var_1_98 == ((signed short int) var_1_102)) : 1)) && (var_1_99 == ((unsigned char) var_1_81))) && (var_1_100 == ((unsigned short int) last_1_var_1_36))) && (var_1_101 == ((double) var_1_22))) && (var_1_102 == ((signed long int) var_1_100))) && (var_1_60 ? (var_1_103 == ((unsigned char) var_1_81)) : (var_1_103 == ((unsigned char) 1)))) && ((var_1_96 != var_1_87) ? (var_1_104 == ((double) (max (((var_1_22 - var_1_51) - var_1_42) , 4.6)))) : 1)) && (var_1_105 == ((double) var_1_24))) && (var_1_106 == ((signed long int) var_1_100))
;
}
int main(void) {
	isInitial = 1;
