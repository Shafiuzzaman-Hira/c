...
void step(void) {
	...
	// From: Req6Batch27Filler_PR_CO
	var_1_20 = var_1_11;


	// From: CodeObject4
	if (var_1_20 >= var_1_20) {
		var_1_31 = (max (var_1_20 , (abs (var_1_20))));
	}


	// From: CodeObject7
	if ((min (var_1_21 , var_1_33)) < (var_1_39 + var_1_21)) {
		var_1_43 = (min (var_1_44 , (max ((100 + var_1_45) , (abs (var_1_46))))));
	}


	// From: Req7Batch27Filler_PR_CO
	var_1_21 = 8;


	// From: Req3Batch27Filler_PR_CO
