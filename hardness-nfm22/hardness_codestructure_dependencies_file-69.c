...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch69dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req6Batch69dependencies
	if (last_1_var_1_9 < last_1_var_1_1) {
	...
	// From: Req1Batch69dependencies
	if (last_1_var_1_14 >= (var_1_3 - var_1_4)) {
	...
	// From: Req4Batch69dependencies
	if (var_1_20 || (var_1_6 <= var_1_8)) {
		var_1_14 = var_1_6;
	}


	// From: Req2Batch69dependencies
	if ((var_1_8 - var_1_5) >= var_1_1) {
	...
	// From: Req3Batch69dependencies
	if (var_1_7 > var_1_1) {
		if (((var_1_1 + var_1_9) == var_1_1) && var_1_20) {
			if (! var_1_20) {
				var_1_12 = var_1_13;
			} else {
				var_1_12 = var_1_13;
