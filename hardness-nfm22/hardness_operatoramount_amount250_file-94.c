...
void step(void) {
	...
	// From: Req5Batch94Amount250
	signed long int stepLocal_1 = var_1_6 * var_1_10;
	signed long int stepLocal_0 = (max (var_1_9 , last_1_var_1_31)) * (min (var_1_10 , last_1_var_1_46));
	...
	if (var_1_13 < stepLocal_8) {
		...
		if (last_1_var_1_38 && stepLocal_7) {
			...
			if (! (var_1_5 > var_1_2)) {
				...
				var_1_23 = ((var_1_24 - var_1_17) - (min (var_1_7 , var_1_6)));
			}
		}
	}


	// From: Req20Batch94Amount250
	...
	// From: Req10Batch94Amount250
	if (var_1_18 >= last_1_var_1_14) {
		var_1_26 = var_1_18;
	}


	// From: Req1Batch94Amount250
	var_1_1 = (min (9.999999999999925E13 , (var_1_2 + (abs (var_1_3)))));


	// From: Req3Batch94Amount250
	var_1_8 = (var_1_9 - var_1_10);


	// From: Req4Batch94Amount250
	var_1_11 = (min (var_1_6 , var_1_7));


	// From: Req9Batch94Amount250
	var_1_25 = var_1_10;


	// From: Req14Batch94Amount250
	signed long int stepLocal_18 = abs (-2);
	if (stepLocal_18 <= ((var_1_7 - var_1_18) / (max (var_1_13 , var_1_24)))) {
		var_1_33 = (var_1_3 + var_1_2);
	}


	// From: Req15Batch94Amount250
	signed long int stepLocal_19 = -64;
	if (var_1_17 <= stepLocal_19) {
		var_1_34 = (abs (min (var_1_17 , var_1_7)));
	}


	// From: Req22Batch94Amount250
	if (var_1_40) {
		var_1_48 = var_1_37;
	} else {
		var_1_48 = var_1_44;
	...
	// From: Req23Batch94Amount250
	var_1_49 = var_1_9;


	// From: Req24Batch94Amount250
	if (var_1_38) {
		var_1_50 = var_1_18;
	} else {
	...
	// From: Req11Batch94Amount250
	if (! (var_1_49 >= (var_1_8 >> var_1_25))) {
		var_1_27 = (max (var_1_6 , var_1_12));
	} else {
		if ((var_1_28 - var_1_29) < var_1_2) {
			if (var_1_21) {
				var_1_27 = (min (var_1_12 , -10));
			} else {
				var_1_27 = (min ((var_1_18 - (min (10 , var_1_6))) , var_1_46));
			}
		}
	}


	// From: Req13Batch94Amount250
	...
	if (stepLocal_12 < (var_1_20 | var_1_25)) {
		...
		if (((var_1_10 + var_1_12) >> var_1_9) >= stepLocal_10) {
			if (var_1_9 == stepLocal_17) {
				var_1_31 = (min (var_1_6 , var_1_23));
			} else {
				var_1_31 = (var_1_6 - var_1_10);
			}
		} else {
			if (stepLocal_14 <= (max (var_1_12 , (abs (var_1_25))))) {
				if (((var_1_18 * var_1_34) % var_1_6) <= stepLocal_13) {
					var_1_31 = (var_1_12 - var_1_7);
				} else {
					if (last_1_var_1_31 == stepLocal_16) {
						var_1_31 = (min (4 , (max (5 , var_1_25))));
					} else {
						var_1_31 = ((min (1 , var_1_10)) + var_1_23);
					}
				}
			} else {
				var_1_31 = var_1_27;
	...
	// From: Req2Batch94Amount250
	if (var_1_35 <= (25.75 / var_1_5)) {
		var_1_4 = (var_1_6 - var_1_7);
	}


	// From: Req12Batch94Amount250
	if ((~ var_1_46) == (~ var_1_12)) {
		var_1_30 = var_1_13;
	} else {
		var_1_30 = (max (var_1_12 , var_1_8));
	}


	// From: Req21Batch94Amount250
	unsigned short int stepLocal_28 = var_1_13;
	signed char stepLocal_27 = var_1_9;
	if ((max (var_1_18 , (var_1_27 | last_1_var_1_47))) == stepLocal_28) {
		var_1_47 = (max ((min ((var_1_9 + var_1_17) , var_1_26)) , var_1_4));
	} else {
		if (stepLocal_27 < var_1_4) {
			var_1_47 = (abs (last_1_var_1_47 + var_1_23));
		} else {
			var_1_47 = var_1_25;
		}
	}
	...
	if ((var_1_27 == var_1_10) || stepLocal_2) {
		if ((var_1_16 - (abs (var_1_6))) > stepLocal_4) {
	...
	// From: Req18Batch94Amount250
	unsigned long int stepLocal_24 = var_1_16;
	signed long int stepLocal_23 = min (var_1_25 , var_1_34);
	if (stepLocal_23 > var_1_31) {
		var_1_41 = (max (10.7f , (min (var_1_2 , var_1_37))));
	} else {
		if (stepLocal_24 == (max ((var_1_47 + var_1_25) , var_1_17))) {
	...
	// From: Req25Batch94Amount250
	signed char stepLocal_30 = var_1_9;
	signed long int stepLocal_29 = max ((var_1_34 * var_1_47) , (var_1_10 + var_1_27));
	if (((min (var_1_13 , 42152)) - var_1_17) == stepLocal_30) {
...
int property() {
	return ((((((((((((((((((((((((var_1_1 == ((double) (min (9.999999999999925E13 , (var_1_2 + (abs (var_1_3))))))) && ((var_1_35 <= (25.75 / var_1_5)) ? (var_1_4 == ((unsigned char) (var_1_6 - var_1_7))) : 1)) && (var_1_8 == ((signed char) (var_1_9 - var_1_10)))) && (var_1_11 == ((unsigned char) (min (var_1_6 , var_1_7))))) && ((((max (var_1_9 , last_1_var_1_31)) * (min (var_1_10 , last_1_var_1_46))) > var_1_6) ? ((last_1_var_1_26 < (var_1_6 * var_1_10)) ? (var_1_12 == ((unsigned short int) ((var_1_13 - last_1_var_1_26) - 10))) : (var_1_12 == ((unsigned short int) 100))) : (var_1_12 == ((unsigned short int) var_1_10)))) && (((var_1_27 == var_1_10) || var_1_19) ? (((var_1_16 - (abs (var_1_6))) > var_1_30) ? (var_1_14 == ((signed char) (var_1_10 - (var_1_17 + var_1_18)))) : ((var_1_10 > ((var_1_16 * var_1_8) * var_1_30)) ? (var_1_14 == ((signed char) 4)) : (var_1_14 == ((signed char) (var_1_18 + var_1_17))))) : (var_1_14 == ((signed char) var_1_18)))) && (((var_1_17 <= (var_1_18 / var_1_20)) || var_1_38) ? ((var_1_38 || (var_1_49 < (~ var_1_10))) ? (var_1_19 == ((unsigned char) (! (! var_1_21)))) : (var_1_19 == ((unsigned char) ((! var_1_38) || var_1_21)))) : (var_1_19 == ((unsigned char) var_1_22)))) && ((var_1_13 < var_1_18) ? (var_1_23 == ((signed long int) (var_1_18 + var_1_17))) : ((last_1_var_1_38 && last_1_var_1_38) ? (var_1_23 == ((signed long int) (10 - last_1_var_1_8))) : ((! (var_1_5 > var_1_2)) ? (var_1_23 == ((signed long int) last_1_var_1_49)) : (var_1_23 == ((signed long int) ((var_1_24 - var_1_17) - (min (var_1_7 , var_1_6))))))))) && (var_1_25 == ((unsigned char) var_1_10))) && ((var_1_18 >= last_1_var_1_14) ? (var_1_26 == ((signed char) var_1_18)) : 1)) && ((! (var_1_49 >= (var_1_8 >> var_1_25))) ? (var_1_27 == ((signed short int) (max (var_1_6 , var_1_12)))) : (((var_1_28 - var_1_29) < var_1_2) ? (var_1_21 ? (var_1_27 == ((signed short int) (min (var_1_12 , -10)))) : (var_1_27 == ((signed short int) (min ((var_1_18 - (min (10 , var_1_6))) , var_1_46))))) : 1))) && (((~ var_1_46) == (~ var_1_12)) ? (var_1_30 == ((unsigned short int) var_1_13)) : (var_1_30 == ((unsigned short int) (max (var_1_12 , var_1_8)))))) && (((32 << var_1_10) < (var_1_20 | var_1_25)) ? (((var_1_6 - (min (var_1_7 , var_1_12))) > ((max (last_1_var_1_31 , var_1_25)) ^ var_1_18)) ? (var_1_31 == ((signed short int) var_1_25)) : ((var_1_34 >= var_1_34) ? ((3.625 >= (var_1_28 - var_1_29)) ? ((var_1_26 <= (var_1_34 * last_1_var_1_31)) ? (var_1_31 == ((signed short int) ((abs (var_1_18)) - var_1_17))) : (var_1_31 == ((signed short int) var_1_6))) : 1) : (var_1_31 == ((signed short int) ((var_1_25 + var_1_6) - (var_1_10 + var_1_12)))))) : ((((var_1_10 + var_1_12) >> var_1_9) >= var_1_26) ? ((var_1_9 == var_1_17) ? (var_1_31 == ((signed short int) (min (var_1_6 , var_1_23)))) : (var_1_31 == ((signed short int) (var_1_6 - var_1_10)))) : ((var_1_34 <= (max (var_1_12 , (abs (var_1_25))))) ? ((((var_1_18 * var_1_34) % var_1_6) <= var_1_27) ? (var_1_31 == ((signed short int) (var_1_12 - var_1_7))) : ((last_1_var_1_31 == var_1_26) ? (var_1_31 == ((signed short int) (min (4 , (max (5 , var_1_25)))))) : (var_1_31 == ((signed short int) ((min (1 , var_1_10)) + var_1_23))))) : (var_1_31 == ((signed short int) var_1_27)))))) && (((abs (-2)) <= ((var_1_7 - var_1_18) / (max (var_1_13 , var_1_24)))) ? (var_1_33 == ((double) (var_1_3 + var_1_2))) : 1)) && ((var_1_17 <= -64) ? (var_1_34 == ((unsigned char) (abs (min (var_1_17 , var_1_7))))) : 1)) && ((var_1_46 <= var_1_13) ? (var_1_35 == ((double) (var_1_36 - var_1_37))) : 1)) && (((min (var_1_18 , last_1_var_1_23)) > 25) ? (var_1_38 == ((unsigned char) (var_1_21 && (last_1_var_1_19 || var_1_39)))) : ((last_1_var_1_47 >= (2 * 1)) ? (var_1_38 == ((unsigned char) ((var_1_37 > (max (var_1_5 , 16.25))) || var_1_21))) : (var_1_38 == ((unsigned char) (var_1_22 || var_1_40)))))) && (((min (var_1_25 , var_1_34)) > var_1_31) ? (var_1_41 == ((float) (max (10.7f , (min (var_1_2 , var_1_37)))))) : ((var_1_16 == (max ((var_1_47 + var_1_25) , var_1_17))) ? (var_1_41 == ((float) (var_1_3 + var_1_2))) : (var_1_41 == ((float) (var_1_3 + var_1_2)))))) && ((var_1_3 < (var_1_35 + var_1_51)) ? ((0 > var_1_34) ? (var_1_43 == ((double) (var_1_2 + 10.6))) : (var_1_43 == ((double) ((var_1_44 - var_1_45) - var_1_37)))) : 1)) && ((last_1_var_1_38 && (last_1_var_1_26 <= 0)) ? (var_1_46 == ((signed short int) (var_1_9 + var_1_6))) : 1)) && (((max (var_1_18 , (var_1_27 | last_1_var_1_47))) == var_1_13) ? (var_1_47 == ((signed long int) (max ((min ((var_1_9 + var_1_17) , var_1_26)) , var_1_4)))) : ((var_1_9 < var_1_4) ? (var_1_47 == ((signed long int) (abs (last_1_var_1_47 + var_1_23)))) : (var_1_47 == ((signed long int) var_1_25))))) && (var_1_40 ? (var_1_48 == ((float) var_1_37)) : (var_1_48 == ((float) var_1_44)))) && (var_1_49 == ((signed short int) var_1_9))) && (var_1_38 ? (var_1_50 == ((signed long int) var_1_18)) : (var_1_50 == ((signed long int) last_1_var_1_50)))) && ((((min (var_1_13 , 42152)) - var_1_17) == var_1_9) ? (((max ((var_1_34 * var_1_47) , (var_1_10 + var_1_27))) <= var_1_20) ? (var_1_51 == ((double) var_1_37)) : (var_1_51 == ((double) 0.0))) : (var_1_51 == ((double) var_1_3)))
;
}
int main(void) {
	isInitial = 1;
