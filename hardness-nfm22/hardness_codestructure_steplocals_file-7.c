...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch7stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch7stepLocals
	var_1_9 = (max (var_1_5 , var_1_6));


	// From: Req4Batch7stepLocals
	signed long int stepLocal_1 = 10;
	signed long int stepLocal_0 = 56016 - var_1_11;
	...
	// From: Req6Batch7stepLocals
	var_1_15 = (var_1_14 - (max ((var_1_16 + var_1_17) , 4)));


	// From: Req7Batch7stepLocals
	if (var_1_4 > var_1_2) {
