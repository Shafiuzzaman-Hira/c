...
void step(void) {
	...
	// From: CodeObject2
	if ((var_1_25 ^ (var_1_28 + var_1_24)) <= (abs (min (var_1_23 , var_1_23)))) {
		var_1_33 = (abs (min ((min (var_1_4 , var_1_4)) , var_1_18)));
	} else {
		if (var_1_18 >= (max (var_1_4 , (var_1_4 * var_1_16)))) {
			if (var_1_13) {
				var_1_33 = var_1_18;
			}
		}
	...
	if (var_1_24 != var_1_25) {
		var_1_46 = (abs (abs (min (var_1_6 , var_1_4))));
	} else {
		var_1_46 = (max (4.6 , (max (var_1_6 , var_1_4))));
	}
