...
void step(void) {
	...
	// From: CodeObject4
	if ((abs (max (var_1_20 , 3.1))) < (abs (255.5))) {
	...
	// From: CodeObject6
	if ((abs (var_1_8)) < var_1_9) {
		if (((var_1_22 + var_1_22) / 1.000000000002E11) > var_1_13) {
			var_1_38 = (abs (abs (var_1_17)));
		}
	}
}
