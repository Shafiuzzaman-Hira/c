...
void step(void) {
 ...
 if ((*(var_1_16_Pointer))) {
  if (last_1_var_1_7 != last_1_var_1_7) {
   ...
   (*(var_1_7_Pointer)) = ((*(var_1_11_Pointer)) - ((((((*(var_1_14_Pointer))) > ((*(var_1_15_Pointer)))) ? ((*(var_1_14_Pointer))) : ((*(var_1_15_Pointer))))) - (*(var_1_12_Pointer))));
  }
 }
}
