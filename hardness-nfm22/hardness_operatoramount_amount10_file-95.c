...
void step(void) {
	...
	// From: Req2Batch95Amount10
	var_1_8 = var_1_9;


	// From: Req3Batch95Amount10
	var_1_10 = var_1_11;
}
...
int property() {
	return (((var_1_2 < (var_1_3 - 9.108)) ? (var_1_1 == ((double) (max (var_1_4 , var_1_5)))) : (var_1_1 == ((double) ((var_1_6 - var_1_7) - 32.925)))) && (var_1_8 == ((unsigned short int) var_1_9))) && (var_1_10 == ((signed char) var_1_11))
;
}
int main(void) {
	isInitial = 1;
