...
void step(void) {
 ...
 if (var_1_19) {
  var_1_32 = ((var_1_34 + ((((var_1_35) < (var_1_36)) ? (var_1_35) : (var_1_36)))) - ((var_1_22 + var_1_10) + ((((1000000000u) < (var_1_14)) ? (1000000000u) : (var_1_14)))));
 }
 if ((var_1_35 | var_1_10) > var_1_14) {
  if (var_1_29 <= ((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28)))) {
   var_1_38 = ((((var_1_18) < ((((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39))) - var_1_36))) ? (var_1_18) : ((((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39))) - var_1_36))));
  } else {
   if (var_1_39 > ((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10)))) {
    var_1_38 = var_1_39;
   } else {
