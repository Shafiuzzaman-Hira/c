...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch56Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
 if ((var_1_10 ^ var_1_6) >= var_1_12) {
  var_1_24 = ((((((((var_1_15 + var_1_19) < 0 ) ? -(var_1_15 + var_1_19) : (var_1_15 + var_1_19)))) > (var_1_12)) ? (((((var_1_15 + var_1_19) < 0 ) ? -(var_1_15 + var_1_19) : (var_1_15 + var_1_19)))) : (var_1_12)));
 }
 if (1000000u > var_1_19) {
  var_1_31 = ((1831787952u + var_1_32) - var_1_12);
 } else {
 ...
 var_1_34 = var_1_35;
 if (var_1_6 >= ((var_1_15 + var_1_18) % (32u + var_1_32))) {
  var_1_36 = ((((((((((((var_1_32) < (var_1_18)) ? (var_1_32) : (var_1_18)))) < (((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6))))) ? (((((var_1_32) < (var_1_18)) ? (var_1_32) : (var_1_18)))) : (((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6))))))) > (var_1_6)) ? (((((((((var_1_32) < (var_1_18)) ? (var_1_32) : (var_1_18)))) < (((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6))))) ? (((((var_1_32) < (var_1_18)) ? (var_1_32) : (var_1_18)))) : (((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6))))))) : (var_1_6)));
 } else {
  var_1_36 = var_1_18;
 }
 if (var_1_12 < (var_1_10 * var_1_10)) {
  if ((var_1_18 + var_1_18) > var_1_12) {
