...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch8925_1loop.c", 13, "reach_error"); }
...
double var_1_9 = 9.5;
double var_1_10 = -0.4;
double var_1_11 = 31.5;
double var_1_12 = 16.25;
double var_1_13 = 127.5;
double var_1_14 = 100000.5;
...
void step(void) {
	// From: Req1Batch8925_1loop
	if ((var_1_2 / var_1_3) >= var_1_4) {
		var_1_1 = (var_1_5 && var_1_6);
	} else {
		var_1_1 = ((var_1_3 >= var_1_2) && (var_1_7 || var_1_8));
	}


	// From: Req2Batch8925_1loop
	unsigned char stepLocal_0 = (var_1_6 && var_1_8) || (var_1_2 >= 5);
	...
	// From: Req3Batch8925_1loop
	unsigned char stepLocal_1 = var_1_6;
	if (((abs (var_1_3)) > (abs (var_1_2))) || stepLocal_1) {
...
int property() {
	return ((((var_1_2 / var_1_3) >= var_1_4) ? (var_1_1 == ((unsigned char) (var_1_5 && var_1_6))) : (var_1_1 == ((unsigned char) ((var_1_3 >= var_1_2) && (var_1_7 || var_1_8))))) && ((((var_1_6 && var_1_8) || (var_1_2 >= 5)) && (var_1_3 < var_1_4)) ? (var_1_9 == ((double) var_1_10)) : (var_1_9 == ((double) var_1_10)))) && ((((abs (var_1_3)) > (abs (var_1_2))) || var_1_6) ? (var_1_11 == ((double) ((min (var_1_12 , var_1_13)) + var_1_14))) : 1)
;
}
int main(void) {
	isInitial = 1;
