...
void step(void) {
	...
	if ((var_1_22 + last_1_var_1_87) < var_1_43) {
		if ((var_1_35 == var_1_43) && stepLocal_10) {
			if (stepLocal_9 <= (var_1_31 + var_1_32)) {
				var_1_47 = (max (var_1_8 , ((max (var_1_46 , 25)) + (var_1_7 - 1))));
			}
		} else {
			var_1_47 = var_1_46;
		}
	} else {
		var_1_47 = (max (((max (200 , var_1_11)) - var_1_8) , var_1_46));
	}
	...
	if (last_1_var_1_77 && stepLocal_1) {
		if (stepLocal_0 <= (max (last_1_var_1_83 , last_1_var_1_1))) {
			if (last_1_var_1_12) {
	...
	if (var_1_25 < (- 24.5f)) {
		var_1_80 = (min (last_1_var_1_80 , var_1_33));
	}
	...
	if (var_1_29 >= stepLocal_22) {
		var_1_79 = (min ((min (32 , var_1_74)) , (max (var_1_29 , var_1_9))));
	}
	...
	if (stepLocal_25 <= 5) {
		if (var_1_12) {
			if ((var_1_64 - (var_1_43 - 50.625f)) >= (min (24.6 , var_1_71))) {
				if (stepLocal_26 != last_1_var_1_83) {
					...
					if (! var_1_18) {
						...
						var_1_83 = (abs (var_1_30 - var_1_90));
					}
				}
			} else {
				if ((var_1_9 | (var_1_10 - var_1_46)) != stepLocal_24) {
					var_1_83 = (min (-16 , (var_1_31 + last_1_var_1_83)));
				} else {
					var_1_83 = (max (var_1_89 , (max (-128 , (max (var_1_76 , var_1_10))))));
				}
			}
		}
	} else {
	...
	if (((var_1_43 - var_1_40) - var_1_37) >= var_1_38) {
		if (stepLocal_6 > last_1_var_1_42) {
			...
			if (stepLocal_7 <= (var_1_85 / var_1_7)) {
				var_1_42 = (min (var_1_10 , var_1_32));
			}
		}
	} else {
		var_1_42 = var_1_8;
	...
	if (var_1_7 < (128 - var_1_10)) {
		var_1_44 = (max (var_1_31 , var_1_8));
	} else {
		var_1_44 = (max ((var_1_30 + var_1_31) , var_1_94));
	}
	...
	if (((var_1_43 - var_1_63) - (var_1_64 + var_1_37)) <= var_1_87) {
		var_1_69 = (max (((var_1_37 - var_1_64) + (var_1_63 + var_1_62)) , ((min (var_1_36 , var_1_24)) + (var_1_70 + var_1_71))));
	}
	...
	if ((- var_1_25) >= var_1_69) {
		if (var_1_16) {
			var_1_81 = (var_1_9 + ((min (var_1_7 , var_1_31)) - (max (var_1_32 , var_1_46))));
		} else {
			var_1_81 = (abs (var_1_9));
		}
	} else {
		var_1_81 = (max (var_1_9 , var_1_11));
	}
	...
	if (! var_1_12) {
		var_1_45 = (var_1_11 - ((min (var_1_9 , var_1_32)) + var_1_46));
	} else {
		if (var_1_24 < var_1_61) {
			...
			var_1_45 = (128 - (max (var_1_31 , (max (var_1_46 , var_1_8)))));
		}
	}


	// From: Req52Batch19Amount500
	signed long int stepLocal_28 = abs (var_1_31);
	if (var_1_17) {
	...
	if (var_1_69 <= var_1_86) {
		if (var_1_25 > var_1_24) {
			if ((max ((var_1_11 % var_1_8) , var_1_81)) < (abs (var_1_7))) {
				var_1_26 = (! var_1_18);
			} else {
				var_1_26 = var_1_18;
			}
	...
	if ((var_1_86 / 1.975f) >= var_1_24) {
		...
		if (var_1_69 >= (abs (var_1_35 - var_1_36))) {
			...
			if (var_1_7 <= (var_1_30 + last_1_var_1_78)) {
				if ((var_1_83 * var_1_76) > (var_1_11 >> var_1_42)) {
					if (var_1_55 || var_1_77) {
						var_1_78 = (max (var_1_75 , var_1_11));
					} else {
						if (var_1_36 >= (- (- var_1_34))) {
							...
							var_1_78 = (var_1_76 + (min (var_1_75 , (var_1_9 - var_1_32))));
						}
					}
				}
			}
	...
	if (var_1_37 < var_1_87) {
		if (var_1_82 == stepLocal_16) {
			...
			var_1_58 = (var_1_37 + (max (var_1_24 , var_1_36)));
		}
	} else {
	...
	if (stepLocal_20 || var_1_51) {
		var_1_72 = (min (var_1_11 , var_1_31));
	} else {
	...
	if ((var_1_34 * var_1_97) > var_1_25) {
		if (! var_1_51) {
			var_1_66 = (abs (max ((var_1_63 + var_1_24) , var_1_38)));
		} else {
			var_1_66 = (1000.8f - (abs (var_1_63)));
		}
	}
	...
	if (var_1_38 < (var_1_87 + var_1_70)) {
		if (var_1_12) {
			if ((var_1_8 / (min (var_1_31 , var_1_7))) == stepLocal_21) {
				var_1_73 = (max (var_1_74 , var_1_30));
			} else {
				if (var_1_69 > (- var_1_38)) {
					var_1_73 = (var_1_46 + var_1_32);
				} else {
					var_1_73 = (abs (var_1_31));
				}
			}
		} else {
			var_1_73 = (abs (var_1_46));
		}
	} else {
		var_1_73 = (min (((var_1_32 - var_1_9) + var_1_46) , (max ((var_1_75 + var_1_76) , (max (var_1_11 , var_1_30))))));
	}
	...
	if (var_1_93 >= ((var_1_9 + var_1_96) + (abs (var_1_10)))) {
		var_1_52 = ((max ((var_1_72 - var_1_10) , (2 + -2))) + var_1_7);
	} else {
		var_1_52 = ((var_1_11 - var_1_91) + (min (var_1_29 , 1)));
	}
	...
	if (stepLocal_11 > var_1_81) {
		var_1_48 = (max (var_1_30 , var_1_46));
	} else {
		var_1_48 = (min (var_1_9 , var_1_30));
	}
...
int property() {
	return ((((((((((((((((((((((((((((((((((((((((((((((((((((last_1_var_1_77 && last_1_var_1_12) ? ((last_1_var_1_28 <= (max (last_1_var_1_83 , last_1_var_1_1))) ? (last_1_var_1_12 ? (var_1_1 == ((unsigned char) (((var_1_7 + var_1_8) - var_1_9) - var_1_10))) : 1) : (var_1_1 == ((unsigned char) (var_1_8 + var_1_7)))) : (var_1_1 == ((unsigned char) ((var_1_11 - var_1_9) - var_1_10)))) && (((last_1_var_1_66 * (- last_1_var_1_58)) >= last_1_var_1_66) ? (var_1_12 == ((unsigned char) (var_1_16 || var_1_17))) : ((last_1_var_1_58 >= last_1_var_1_66) ? (var_1_12 == ((unsigned char) (var_1_18 && var_1_19))) : (var_1_12 == ((unsigned char) (var_1_17 || var_1_16)))))) && (((var_1_8 % var_1_11) <= 2) ? (var_1_20 == ((float) (min (var_1_21 , var_1_22)))) : 1)) && (((- (var_1_7 * var_1_9)) >= var_1_10) ? (var_1_18 ? ((var_1_82 != (~ var_1_8)) ? (var_1_23 == ((float) (abs (var_1_21)))) : (var_1_23 == ((float) (var_1_24 + var_1_25)))) : (var_1_23 == ((float) var_1_25))) : (var_1_23 == ((float) var_1_25)))) && ((var_1_69 <= var_1_86) ? ((var_1_25 > var_1_24) ? (((max ((var_1_11 % var_1_8) , var_1_81)) < (abs (var_1_7))) ? (var_1_26 == ((unsigned char) (! var_1_18))) : (var_1_26 == ((unsigned char) var_1_18))) : 1) : 1)) && (var_1_27 == ((signed long int) (max (-8 , var_1_10))))) && ((var_1_34 <= 99.6f) ? (var_1_28 == ((signed char) ((max (var_1_9 , var_1_29)) - ((max (var_1_30 , var_1_31)) - var_1_32)))) : (var_1_28 == ((signed char) (var_1_32 + var_1_9))))) && ((var_1_7 < last_1_var_1_33) ? (var_1_33 == ((signed short int) (var_1_31 + var_1_9))) : ((var_1_22 >= var_1_97) ? (var_1_33 == ((signed short int) (max (var_1_32 , var_1_9)))) : (var_1_33 == ((signed short int) var_1_11))))) && (((var_1_86 / 1.975f) >= var_1_24) ? (var_1_34 == ((double) ((var_1_35 - (var_1_36 - var_1_37)) - var_1_38))) : ((var_1_69 >= (abs (var_1_35 - var_1_36))) ? (var_1_34 == ((double) (var_1_25 + var_1_24))) : 1))) && (((var_1_36 - (var_1_37 + var_1_40)) >= 8.187) ? (var_1_39 == ((unsigned long int) ((max (3491399024u , var_1_41)) - var_1_11))) : 1)) && ((((var_1_43 - var_1_40) - var_1_37) >= var_1_38) ? ((var_1_92 > last_1_var_1_42) ? (var_1_42 == ((unsigned char) (var_1_11 - var_1_9))) : ((var_1_92 <= (var_1_85 / var_1_7)) ? (var_1_42 == ((unsigned char) (min (var_1_10 , var_1_32)))) : 1)) : (var_1_42 == ((unsigned char) var_1_8)))) && ((var_1_7 < (128 - var_1_10)) ? (var_1_44 == ((signed short int) (max (var_1_31 , var_1_8)))) : (var_1_44 == ((signed short int) (max ((var_1_30 + var_1_31) , var_1_94)))))) && ((! var_1_12) ? (var_1_45 == ((unsigned char) (var_1_11 - ((min (var_1_9 , var_1_32)) + var_1_46)))) : ((var_1_24 < var_1_61) ? ((var_1_16 || var_1_18) ? (var_1_45 == ((unsigned char) (var_1_11 - var_1_7))) : 1) : (var_1_45 == ((unsigned char) (128 - (max (var_1_31 , (max (var_1_46 , var_1_8)))))))))) && (((var_1_22 + last_1_var_1_87) < var_1_43) ? (((var_1_35 == var_1_43) && var_1_19) ? ((last_1_var_1_59 <= (var_1_31 + var_1_32)) ? (var_1_47 == ((unsigned char) (max (var_1_8 , ((max (var_1_46 , 25)) + (var_1_7 - 1)))))) : 1) : (var_1_47 == ((unsigned char) var_1_46))) : (var_1_47 == ((unsigned char) (max (((max (200 , var_1_11)) - var_1_8) , var_1_46)))))) && ((var_1_52 > var_1_81) ? (var_1_48 == ((signed char) (max (var_1_30 , var_1_46)))) : (var_1_48 == ((signed char) (min (var_1_9 , var_1_30)))))) && ((! var_1_16) ? (var_1_77 ? (var_1_49 == ((unsigned short int) (last_1_var_1_49 + (var_1_8 + var_1_31)))) : (var_1_49 == ((unsigned short int) var_1_8))) : 1)) && (((var_1_31 + (var_1_46 - var_1_79)) >= (var_1_44 + var_1_49)) ? (var_1_50 == ((unsigned long int) (max (var_1_30 , var_1_9)))) : (var_1_50 == ((unsigned long int) (var_1_41 - (var_1_31 + var_1_44)))))) && (var_1_56 ? ((var_1_43 <= var_1_97) ? ((! (var_1_45 < (var_1_57 / var_1_31))) ? (var_1_51 == ((unsigned char) ((var_1_30 >= (var_1_10 - var_1_32)) && var_1_17))) : 1) : (var_1_51 == ((unsigned char) (! var_1_18)))) : 1)) && ((var_1_93 >= ((var_1_9 + var_1_96) + (abs (var_1_10)))) ? (var_1_52 == ((signed short int) ((max ((var_1_72 - var_1_10) , (2 + -2))) + var_1_7))) : (var_1_52 == ((signed short int) ((var_1_11 - var_1_91) + (min (var_1_29 , 1))))))) && ((var_1_36 == (var_1_38 / var_1_35)) ? (var_1_53 == ((unsigned char) (var_1_77 && (! var_1_18)))) : (var_1_18 ? (var_1_53 == ((unsigned char) (((var_1_61 > 4.25f) && var_1_17) || var_1_16))) : ((var_1_7 >= var_1_47) ? (var_1_53 == ((unsigned char) (var_1_19 && (var_1_54 && var_1_55)))) : 1)))) && ((var_1_1 >= var_1_9) ? ((var_1_89 < var_1_89) ? (var_1_56 == ((unsigned char) (var_1_16 || var_1_17))) : (var_1_55 ? (var_1_56 == ((unsigned char) (var_1_17 || var_1_16))) : 1)) : (var_1_16 ? (var_1_56 == ((unsigned char) var_1_54)) : ((var_1_34 < (var_1_25 + (- var_1_21))) ? (var_1_56 == ((unsigned char) (! ((! var_1_17) && (var_1_67 || var_1_54))))) : (var_1_56 == ((unsigned char) var_1_19)))))) && (((last_1_var_1_20 + (var_1_35 * var_1_37)) == var_1_38) ? (var_1_57 == ((unsigned short int) last_1_var_1_52)) : 1)) && ((var_1_37 < var_1_87) ? ((var_1_82 == (var_1_78 & var_1_46)) ? (var_1_58 == ((double) var_1_38)) : (var_1_58 == ((double) (var_1_37 + (max (var_1_24 , var_1_36)))))) : ((var_1_1 <= ((var_1_32 + var_1_9) - (var_1_30 - var_1_46))) ? (var_1_58 == ((double) ((var_1_36 - var_1_37) + var_1_24))) : (var_1_58 == ((double) (var_1_40 - var_1_36)))))) && (((var_1_86 >= var_1_58) && var_1_19) ? (var_1_59 == ((unsigned short int) var_1_46)) : ((var_1_77 || var_1_65) ? (var_1_59 == ((unsigned short int) var_1_49)) : 1))) && ((var_1_32 != var_1_85) ? (var_1_61 == ((float) var_1_25)) : (var_1_61 == ((float) ((var_1_36 + var_1_37) - ((var_1_62 + var_1_63) + var_1_64)))))) && (var_1_51 ? ((var_1_34 > var_1_40) ? (var_1_65 == ((unsigned char) (! (var_1_53 || var_1_18)))) : ((var_1_66 >= var_1_35) ? (var_1_65 == ((unsigned char) (var_1_18 && (! var_1_16)))) : (var_1_65 == ((unsigned char) (! (var_1_17 && var_1_16)))))) : (var_1_65 == ((unsigned char) (var_1_53 || var_1_54))))) && (((var_1_34 * var_1_97) > var_1_25) ? ((! var_1_51) ? (var_1_66 == ((float) (abs (max ((var_1_63 + var_1_24) , var_1_38))))) : (var_1_66 == ((float) (1000.8f - (abs (var_1_63)))))) : 1)) && ((var_1_64 <= var_1_69) ? (var_1_67 == ((unsigned char) (((! var_1_54) || var_1_68) || (var_1_17 || var_1_16)))) : (var_1_67 == ((unsigned char) var_1_17)))) && ((((var_1_43 - var_1_63) - (var_1_64 + var_1_37)) <= var_1_87) ? (var_1_69 == ((float) (max (((var_1_37 - var_1_64) + (var_1_63 + var_1_62)) , ((min (var_1_36 , var_1_24)) + (var_1_70 + var_1_71)))))) : 1)) && ((var_1_68 || var_1_51) ? (var_1_72 == ((unsigned short int) (min (var_1_11 , var_1_31)))) : (var_1_72 == ((unsigned short int) (var_1_7 + var_1_46))))) && ((var_1_38 < (var_1_87 + var_1_70)) ? (var_1_12 ? (((var_1_8 / (min (var_1_31 , var_1_7))) == (var_1_28 ^ var_1_72)) ? (var_1_73 == ((signed char) (max (var_1_74 , var_1_30)))) : ((var_1_69 > (- var_1_38)) ? (var_1_73 == ((signed char) (var_1_46 + var_1_32))) : (var_1_73 == ((signed char) (abs (var_1_31)))))) : (var_1_73 == ((signed char) (abs (var_1_46))))) : (var_1_73 == ((signed char) (min (((var_1_32 - var_1_9) + var_1_46) , (max ((var_1_75 + var_1_76) , (max (var_1_11 , var_1_30)))))))))) && ((last_1_var_1_58 > (- last_1_var_1_23)) ? (var_1_77 == ((unsigned char) (! var_1_19))) : 1)) && (((var_1_8 != (var_1_10 / var_1_31)) && var_1_67) ? (var_1_16 ? ((var_1_7 <= (var_1_30 + last_1_var_1_78)) ? (((var_1_83 * var_1_76) > (var_1_11 >> var_1_42)) ? ((var_1_55 || var_1_77) ? (var_1_78 == ((signed char) (max (var_1_75 , var_1_11)))) : ((var_1_36 >= (- (- var_1_34))) ? ((var_1_67 && (var_1_8 >= var_1_81)) ? (var_1_78 == ((signed char) ((var_1_30 - var_1_32) - 5))) : (var_1_78 == ((signed char) (var_1_30 - var_1_9)))) : (var_1_78 == ((signed char) (var_1_76 + (min (var_1_75 , (var_1_9 - var_1_32)))))))) : 1) : 1) : (var_1_78 == ((signed char) var_1_11))) : 1)) && ((var_1_29 >= var_1_76) ? (var_1_79 == ((signed char) (min ((min (32 , var_1_74)) , (max (var_1_29 , var_1_9)))))) : 1)) && ((var_1_25 < (- 24.5f)) ? (var_1_80 == ((signed long int) (min (last_1_var_1_80 , var_1_33)))) : 1)) && (((- var_1_25) >= var_1_69) ? (var_1_16 ? (var_1_81 == ((unsigned char) (var_1_9 + ((min (var_1_7 , var_1_31)) - (max (var_1_32 , var_1_46)))))) : (var_1_81 == ((unsigned char) (abs (var_1_9))))) : (var_1_81 == ((unsigned char) (max (var_1_9 , var_1_11)))))) && ((var_1_45 > var_1_46) ? (var_1_82 == ((unsigned long int) (var_1_1 + var_1_83))) : 1)) && ((var_1_33 <= 5) ? (var_1_12 ? (((var_1_64 - (var_1_43 - 50.625f)) >= (min (24.6 , var_1_71))) ? ((var_1_39 != last_1_var_1_83) ? (var_1_83 == ((signed long int) var_1_8)) : ((! var_1_18) ? (var_1_83 == ((signed long int) (var_1_30 - (var_1_84 - var_1_10)))) : (var_1_83 == ((signed long int) (abs (var_1_30 - var_1_90)))))) : (((var_1_9 | (var_1_10 - var_1_46)) != var_1_80) ? (var_1_83 == ((signed long int) (min (-16 , (var_1_31 + last_1_var_1_83))))) : (var_1_83 == ((signed long int) (max (var_1_89 , (max (-128 , (max (var_1_76 , var_1_10)))))))))) : 1) : (var_1_83 == ((signed long int) var_1_8)))) && (var_1_16 ? (var_1_85 == ((unsigned long int) var_1_46)) : 1)) && (var_1_68 ? (var_1_86 == ((double) var_1_25)) : (var_1_86 == ((double) var_1_63)))) && (var_1_54 ? (var_1_87 == ((double) var_1_21)) : (var_1_87 == ((double) var_1_62)))) && (var_1_55 ? (var_1_88 == ((unsigned short int) var_1_46)) : (var_1_88 == ((unsigned short int) var_1_72)))) && (var_1_19 ? (var_1_89 == ((signed long int) last_1_var_1_89)) : (var_1_89 == ((signed long int) 1)))) && (var_1_90 == ((signed short int) var_1_11))) && (var_1_98 ? (var_1_91 == ((unsigned char) var_1_8)) : (var_1_91 == ((unsigned char) var_1_10)))) && (var_1_92 == ((signed short int) var_1_75))) && (var_1_18 ? (var_1_93 == ((unsigned short int) var_1_96)) : (var_1_93 == ((unsigned short int) var_1_96)))) && (var_1_94 == ((signed char) var_1_30))) && (var_1_98 ? (var_1_95 == ((unsigned long int) var_1_52)) : (var_1_95 == ((unsigned long int) 256u)))) && (var_1_16 ? (var_1_96 == ((unsigned short int) var_1_42)) : (var_1_96 == ((unsigned short int) var_1_85)))) && ((var_1_84 >= var_1_57) ? (var_1_97 == ((double) var_1_71)) : 1)) && (var_1_17 ? (((var_1_84 * var_1_45) > (abs (var_1_31))) ? (var_1_98 == ((unsigned char) (var_1_12 && var_1_16))) : 1) : (var_1_98 == ((unsigned char) var_1_19)))
;
}
int main(void) {
	isInitial = 1;
