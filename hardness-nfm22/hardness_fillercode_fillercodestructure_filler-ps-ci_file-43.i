...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch43Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_31 = 64;
 if ((var_1_14 | ((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18)))) > var_1_22) {
  if (var_1_13) {
   var_1_32 = ((((var_1_6) < (((((256.5f) > (var_1_6)) ? (256.5f) : (var_1_6))))) ? (var_1_6) : (((((256.5f) > (var_1_6)) ? (256.5f) : (var_1_6))))));
  }
 }
 if (var_1_13 && (var_1_22 >= var_1_15)) {
  var_1_37 = ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)));
 }
 if ((- var_1_1) < var_1_5) {
  if (var_1_2 > var_1_5) {
   if (((var_1_14 % var_1_14) % ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)))) == (var_1_22 / var_1_14)) {
