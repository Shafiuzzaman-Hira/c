...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch8825_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch8825_while
	var_1_13 = (var_1_14 && var_1_15);


	// From: Req5Batch8825_while
	var_1_17 = var_1_18;


	// From: Req6Batch8825_while
	var_1_19 = var_1_20;


	// From: Req2Batch8825_while
	if ((- (var_1_17 + var_1_17)) > var_1_17) {
		var_1_11 = var_1_12;
	}


	// From: Req4Batch8825_while
	var_1_16 = var_1_19;


	// From: Req1Batch8825_while
