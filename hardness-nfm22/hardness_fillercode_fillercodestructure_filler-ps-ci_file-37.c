...
void step(void) {
	...
	// From: Req6Batch37Filler_PS_CI
	var_1_17 = (var_1_18 - var_1_3);


	// From: Req3Batch37Filler_PS_CI
	if ((var_1_17 >= var_1_17) || (var_1_9 > last_1_var_1_10)) {
		var_1_10 = var_1_9;
	}


	// From: Req4Batch37Filler_PS_CI
