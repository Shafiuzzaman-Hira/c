...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch36Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_26 = var_1_11;
 if (((var_1_9 ^ 8) * var_1_10) <= var_1_8) {
  var_1_28 = (((((((((((var_1_4) > (var_1_6)) ? (var_1_4) : (var_1_6)))) < (var_1_5)) ? (((((var_1_4) > (var_1_6)) ? (var_1_4) : (var_1_6)))) : (var_1_5))) < 0 ) ? -((((((((var_1_4) > (var_1_6)) ? (var_1_4) : (var_1_6)))) < (var_1_5)) ? (((((var_1_4) > (var_1_6)) ? (var_1_4) : (var_1_6)))) : (var_1_5))) : ((((((((var_1_4) > (var_1_6)) ? (var_1_4) : (var_1_6)))) < (var_1_5)) ? (((((var_1_4) > (var_1_6)) ? (var_1_4) : (var_1_6)))) : (var_1_5)))));
 }
 if (var_1_25) {
  var_1_33 = var_1_35;
 }
 ...
 if (var_1_9 < (((((var_1_11) < (var_1_8)) ? (var_1_11) : (var_1_8))) / var_1_9)) {
  var_1_41 = (var_1_39 + 5.5f);
 } else {
  var_1_41 = ((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40)));
 }
 if ((((((var_1_9) < (var_1_9)) ? (var_1_9) : (var_1_9))) >> (var_1_44 - 4u)) >= var_1_10) {
  var_1_43 = ((var_1_45 - (10000 - var_1_44)) - ((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))));
 } else {
  if (((((((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35)))) > (var_1_11)) ? (((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35)))) : (var_1_11))) > var_1_10) {
   var_1_43 = 5;
  }
 }
 if (var_1_5 >= var_1_3) {
  var_1_46 = ((((var_1_11) > (4u)) ? (var_1_11) : (4u)));
 }
 var_1_47 = var_1_45;
}
