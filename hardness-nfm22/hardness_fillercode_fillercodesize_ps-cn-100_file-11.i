...
void step(void) {
 ...
 if (var_1_28) {
  var_1_27 = ((((var_1_29) < ((1.625f + ((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30)))))) ? (var_1_29) : ((1.625f + ((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30)))))));
 }
 if (var_1_23 >= var_1_24) {
  if ((var_1_25 >> (var_1_32 + var_1_33)) <= var_1_23) {
   if (var_1_30 >= var_1_29) {
    if (var_1_23 <= ((((var_1_22) < (var_1_32)) ? (var_1_22) : (var_1_32)))) {
     var_1_31 = var_1_30;
    }
   } else {
    var_1_31 = var_1_29;
 ...
 if (var_1_24 >= (var_1_22 ^ var_1_32)) {
  var_1_34 = ((((var_1_24) > (var_1_33)) ? (var_1_24) : (var_1_33)));
 } else {
  var_1_34 = ((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35)));
 }
 if (((var_1_26 | var_1_24) ^ var_1_34) < (var_1_23 + var_1_32)) {
  var_1_36 = ((((var_1_24) < (var_1_25)) ? (var_1_24) : (var_1_25)));
 }
 if (! (1000 > (var_1_26 & var_1_36))) {
  var_1_37 = (((((((((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30)))) > ((var_1_38 + var_1_39))) ? (((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30)))) : ((var_1_38 + var_1_39)))) < 0 ) ? -((((((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30)))) > ((var_1_38 + var_1_39))) ? (((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30)))) : ((var_1_38 + var_1_39)))) : ((((((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30)))) > ((var_1_38 + var_1_39))) ? (((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30)))) : ((var_1_38 + var_1_39))))));
 }
 if ((((((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))) < 0 ) ? -((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))) : ((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))))) < var_1_41) {
  if (var_1_28) {
 ...
 if (var_1_28) {
  if (var_1_26 >= var_1_32) {
   ...
   if (var_1_41 >= (((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))) - var_1_33)) {
    var_1_43 = ((((var_1_33) < 0 ) ? -(var_1_33) : (var_1_33)));
   }
  }
 }
 if (var_1_25 >= var_1_26) {
  var_1_44 = ((((var_1_35) < (((((((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43)))) > (var_1_22)) ? (((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43)))) : (var_1_22))))) ? (var_1_35) : (((((((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43)))) > (var_1_22)) ? (((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43)))) : (var_1_22))))));
 }
 if (((((var_1_32 - var_1_33) < 0 ) ? -(var_1_32 - var_1_33) : (var_1_32 - var_1_33))) < var_1_40) {
  if (((((var_1_33) < 0 ) ? -(var_1_33) : (var_1_33))) > (var_1_40 & var_1_41)) {
   var_1_45 = var_1_32;
  }
 }
 if (var_1_47 >= var_1_30) {
  if (var_1_28) {
   var_1_46 = (((((var_1_33) < 0 ) ? -(var_1_33) : (var_1_33))) - var_1_32);
  }
 }
