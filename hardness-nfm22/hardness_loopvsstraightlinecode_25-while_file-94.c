...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch9425_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch9425_while
	if (var_1_2 != var_1_3) {
		var_1_1 = ((var_1_4 - var_1_5) - var_1_6);
	}


	// From: Req2Batch9425_while
