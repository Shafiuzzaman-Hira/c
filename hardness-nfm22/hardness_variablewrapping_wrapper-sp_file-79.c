...
void step(void) {
	// From: Req2Batch79Wrapper_SP
	signed long int stepLocal_0 = max ((*(WrapperStruct00_var_1_5_Pointer)) , last_1_WrapperStruct00_var_1_10);
