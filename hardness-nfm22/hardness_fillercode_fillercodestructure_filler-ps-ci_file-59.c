...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch59Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((abs (var_1_8)) > (min (128.5f , (abs (var_1_8))))) {
		var_1_24 = (max (var_1_4 , var_1_4));
	}


	// From: CodeObject3
	if ((var_1_4 / var_1_6) < (var_1_14 | var_1_6)) {
		if ((- var_1_12) >= 256.75f) {
			var_1_25 = var_1_4;
		}
	} else {
	...
	// From: CodeObject4
	if ((var_1_6 ^ (~ var_1_17)) >= var_1_17) {
		var_1_28 = ((var_1_12 <= var_1_8) || var_1_16);
	}
	...
	// From: CodeObject6
	if (var_1_4 < (abs (var_1_4))) {
		if ((max (var_1_11 , var_1_8)) == (abs (var_1_12))) {
			if (-50 <= var_1_4) {
	...
	// From: Req6Batch59Filler_PS_CI
	var_1_17 = var_1_4;


	// From: Req7Batch59Filler_PS_CI
	var_1_18 = var_1_16;


	// From: Req8Batch59Filler_PS_CI
	var_1_19 = var_1_4;


	// From: Req1Batch59Filler_PS_CI
