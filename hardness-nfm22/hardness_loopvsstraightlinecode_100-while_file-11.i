...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch11100_while.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (last_1_var_1_14 <= last_1_var_1_15) {
  if (((last_1_var_1_26 % var_1_6) * (last_1_var_1_17 / 1000000000u)) >= ((((10u) < (var_1_13)) ? (10u) : (var_1_13)))) {
   var_1_14 = var_1_13;
  } else {
 ...
 if (stepLocal_4 > (last_1_var_1_17 & ((((last_1_var_1_25) < 0 ) ? -(last_1_var_1_25) : (last_1_var_1_25))))) {
 ...
 if ((var_1_9 + var_1_25) >= stepLocal_1) {
  var_1_18 = ((((var_1_7) > (((((var_1_8) > (var_1_19)) ? (var_1_8) : (var_1_19))))) ? (var_1_7) : (((((var_1_8) > (var_1_19)) ? (var_1_8) : (var_1_19))))));
 }
 var_1_17 = var_1_13;
 if (! var_1_2) {
 ...
 if (var_1_7 >= 4.5) {
  var_1_15 = (((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17))) - ((((var_1_13) > (var_1_25)) ? (var_1_13) : (var_1_25))));
 }
 var_1_28 = (var_1_29 - (var_1_13 + ((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15)))));
 ...
 if (var_1_2) {
  if (stepLocal_6 >= var_1_25) {
   if ((var_1_25 - 10) <= stepLocal_7) {
    if (var_1_27) {
     var_1_26 = (((((((((var_1_25) < (var_1_22)) ? (var_1_25) : (var_1_22)))) < (var_1_17)) ? (((((var_1_25) < (var_1_22)) ? (var_1_25) : (var_1_22)))) : (var_1_17))) + var_1_17);
    }
   } else {
    var_1_26 = ((((var_1_12) < (var_1_17)) ? (var_1_12) : (var_1_17)));
   }
  } else {
