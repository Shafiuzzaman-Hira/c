...
void step(void) {
	// From: Req1Batch38no_floats
	var_1_1 = ((max (var_1_2 , var_1_3)) - var_1_4);


	// From: Req2Batch38no_floats
	...
	// From: Req3Batch38no_floats
	var_1_7 = (var_1_8 + (var_1_9 + (var_1_10 + var_1_11)));


	// From: Req4Batch38no_floats
	if (! var_1_13) {
...
int property() {
	return ((((var_1_1 == ((unsigned short int) ((max (var_1_2 , var_1_3)) - var_1_4))) && ((var_1_4 > var_1_2) ? (var_1_5 == ((unsigned long int) (((var_1_6 - var_1_3) + 2144048120u) - var_1_2))) : 1)) && (var_1_7 == ((signed long int) (var_1_8 + (var_1_9 + (var_1_10 + var_1_11)))))) && ((! var_1_13) ? (var_1_12 == ((unsigned short int) (var_1_3 - (var_1_14 - var_1_15)))) : (var_1_13 ? (var_1_12 == ((unsigned short int) ((27636 + var_1_16) - (max ((16853 - 10) , var_1_14))))) : (var_1_12 == ((unsigned short int) var_1_3))))) && (((var_1_13 && var_1_18) && var_1_19) ? (var_1_17 == ((unsigned short int) (var_1_15 + var_1_14))) : 1)
;
}
int main(void) {
	isInitial = 1;
