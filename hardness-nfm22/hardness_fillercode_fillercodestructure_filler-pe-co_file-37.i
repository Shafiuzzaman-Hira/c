...
void step(void) {
 ...
 if (var_1_17 > var_1_11) {
  var_1_27 = ((((var_1_17) > (var_1_1)) ? (var_1_17) : (var_1_1)));
 }
 if (var_1_17 <= (((((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17))) < 0 ) ? -((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17))) : ((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17)))))) {
  var_1_28 = 4;
 }
 if (var_1_26 <= 16) {
 ...
 if ((var_1_17 & (~ var_1_11)) <= var_1_1) {
  if (var_1_35) {
   var_1_36 = ((((var_1_11) > (((((var_1_1) < (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))))) ? (var_1_1) : (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))))))) ? (var_1_11) : (((((var_1_1) < (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))))) ? (var_1_1) : (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))))))));
  }
 } else {
  if (var_1_37) {
   var_1_36 = -128;
