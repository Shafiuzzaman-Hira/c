...
void step(void) {
	...
	// From: CodeObject2
	if ((var_1_11 + 100000000u) != (max (var_1_26 , var_1_10))) {
		var_1_30 = (max ((var_1_10 + (abs (var_1_10))) , var_1_6));
	} else {
		var_1_30 = var_1_6;
	}
	...
	if (var_1_12 != (~ (var_1_12 % var_1_7))) {
		...
		if (var_1_7 < var_1_12) {
			if ((var_1_12 < var_1_12) && var_1_41) {
				if (var_1_22 <= (min (var_1_21 , var_1_20))) {
	...
	if (var_1_10 > var_1_12) {
		...
		var_1_37 = (min (var_1_22 , (abs (max (49.2 , var_1_22)))));
	}
