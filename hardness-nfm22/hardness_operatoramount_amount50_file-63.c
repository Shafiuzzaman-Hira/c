...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch63Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req9Batch63Amount50
	var_1_31 = var_1_13;


	// From: Req4Batch63Amount50
	if (var_1_7) {
	...
	// From: Req7Batch63Amount50
	if (var_1_7) {
		var_1_29 = var_1_20;
	}


	// From: Req10Batch63Amount50
	var_1_32 = var_1_16;


	// From: Req2Batch63Amount50
	...
	// From: Req8Batch63Amount50
	var_1_30 = var_1_32;


	// From: Req6Batch63Amount50
	if (var_1_11 >= var_1_30) {
		var_1_26 = (var_1_27 + var_1_28);
	}


	// From: Req5Batch63Amount50
