...
void step(void) {
	...
	// From: CodeObject5
	if (var_1_30 <= (min (var_1_27 , (var_1_25 | -5)))) {
		if (var_1_33) {
			var_1_32 = var_1_27;
		}
	}
	...
	// From: CodeObject6
	if ((min (var_1_31 , var_1_27)) <= var_1_30) {
		if (var_1_33) {
			if (var_1_35 || var_1_36) {
				if ((abs (var_1_30)) > var_1_27) {
					var_1_34 = var_1_31;
				}
			}
		}
	} else {
		if ((abs (var_1_27)) > var_1_30) {
			if (var_1_37 > 49.75f) {
				var_1_34 = (abs (min ((min (var_1_32 , var_1_25)) , -25)));
			}
		} else {
			var_1_34 = var_1_31;
		}
