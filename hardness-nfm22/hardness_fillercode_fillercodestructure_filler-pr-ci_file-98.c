...
void step(void) {
	...
	if (var_1_27 < var_1_34) {
		if ((abs (max (var_1_34 , var_1_21))) <= var_1_12) {
			var_1_38 = (min (((min (var_1_37 , var_1_36)) - var_1_39) , var_1_7));
		} else {
			var_1_38 = var_1_36;
		}
	} else {
	...
	// From: CodeObject4
	if (var_1_21 <= ((var_1_34 - var_1_31) - (min (var_1_21 , var_1_4)))) {
		var_1_33 = 128;
	}
	...
	if ((var_1_14 | var_1_11) > var_1_11) {
		if (-16 <= (max ((var_1_20 - var_1_31) , (abs (var_1_14))))) {
			var_1_35 = (63.2 - 7.4);
		} else {
			var_1_35 = ((var_1_36 - var_1_37) - (abs (var_1_7)));
		}
	} else {
	...
	// From: Req6Batch98Filler_PR_CI
	var_1_17 = var_1_18;


	// From: Req7Batch98Filler_PR_CI
	...
	// From: Req8Batch98Filler_PR_CI
	var_1_22 = var_1_18;


	// From: Req2Batch98Filler_PR_CI
	if (var_1_19 <= var_1_1) {
	...
	// From: CodeObject1
	if ((max ((abs (var_1_12)) , 2u)) > (var_1_11 & var_1_15)) {
