...
void step(void) {
	...
	// From: Req2Batch43stepLocals
	if (-4 > (var_1_8 & var_1_9)) {
		var_1_7 = var_1_10;
	}


	// From: Req3Batch43stepLocals
	if (var_1_1 > var_1_4) {
		var_1_11 = var_1_10;
	} else {
		var_1_11 = (min (var_1_7 , ((16 - 32) + (64 + var_1_10))));
	}


	// From: Req4Batch43stepLocals
	if (var_1_13) {
		var_1_12 = (var_1_14 - var_1_15);
	}


	// From: Req5Batch43stepLocals
	signed char stepLocal_0 = var_1_19;
	if (var_1_2 <= ((min (var_1_3 , var_1_17)) + var_1_1)) {
	...
	// From: Req6Batch43stepLocals
	if ((- (var_1_14 - var_1_24)) < var_1_10) {
		var_1_23 = (var_1_24 + (var_1_22 + 4u));
	} else {
		var_1_23 = (min (var_1_14 , var_1_25));
	}


	// From: Req7Batch43stepLocals
	if (var_1_6 != 49.125) {
		if ((abs (64u)) < var_1_9) {
			var_1_26 = var_1_15;
		}
...
int property() {
	return ((((((((- 1000.5f) != (var_1_2 * (var_1_3 / var_1_4))) ? (var_1_1 == ((double) (max (var_1_5 , var_1_6)))) : (var_1_1 == ((double) var_1_5))) && ((-4 > (var_1_8 & var_1_9)) ? (var_1_7 == ((signed char) var_1_10)) : 1)) && ((var_1_1 > var_1_4) ? (var_1_11 == ((signed short int) var_1_10)) : (var_1_11 == ((signed short int) (min (var_1_7 , ((16 - 32) + (64 + var_1_10)))))))) && (var_1_13 ? (var_1_12 == ((unsigned short int) (var_1_14 - var_1_15))) : 1)) && ((var_1_2 <= ((min (var_1_3 , var_1_17)) + var_1_1)) ? (var_1_16 == ((signed char) (min (var_1_10 , ((min (var_1_18 , var_1_19)) + var_1_20))))) : ((var_1_19 < var_1_20) ? (var_1_16 == ((signed char) (var_1_21 - var_1_22))) : (var_1_16 == ((signed char) var_1_10))))) && (((- (var_1_14 - var_1_24)) < var_1_10) ? (var_1_23 == ((unsigned long int) (var_1_24 + (var_1_22 + 4u)))) : (var_1_23 == ((unsigned long int) (min (var_1_14 , var_1_25)))))) && ((var_1_6 != 49.125) ? (((abs (64u)) < var_1_9) ? (var_1_26 == ((signed long int) var_1_15)) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
