...
void step(void) {
	...
	// From: CodeObject4
	if ((abs (max (var_1_22 , 3.1))) < (abs (255.5))) {
	...
	// From: Req8Batch16Filler_PS_CI
	if (var_1_4 && ((abs (var_1_1)) > var_1_5)) {
		var_1_23 = var_1_6;
	}


	// From: Req3Batch16Filler_PS_CI
	if (var_1_6 > 128) {
		var_1_9 = (var_1_8 - (var_1_10 - var_1_1));
	}


	// From: Req4Batch16Filler_PS_CI
