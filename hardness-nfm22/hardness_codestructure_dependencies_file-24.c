...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch24dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch24dependencies
	var_1_23 = var_1_24;


	// From: Req4Batch24dependencies
