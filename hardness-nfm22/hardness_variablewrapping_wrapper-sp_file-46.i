...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch46Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
 if (last_1_WrapperStruct00_var_1_10 <= ((*(WrapperStruct00_var_1_12_Pointer)) / (*(WrapperStruct00_var_1_4_Pointer)))) {
  if (last_1_WrapperStruct00_var_1_1) {
   (*(WrapperStruct00_var_1_13_Pointer)) = (*(WrapperStruct00_var_1_16_Pointer));
  }
 }
 signed long int stepLocal_1 = ((((*(WrapperStruct00_var_1_4_Pointer))) < ((*(WrapperStruct00_var_1_13_Pointer)))) ? ((*(WrapperStruct00_var_1_4_Pointer))) : ((*(WrapperStruct00_var_1_13_Pointer))));
 signed long int stepLocal_0 = (*(WrapperStruct00_var_1_13_Pointer)) / (*(WrapperStruct00_var_1_4_Pointer));
 ...
 signed char stepLocal_2 = (*(WrapperStruct00_var_1_13_Pointer));
 if ((((*(WrapperStruct00_var_1_13_Pointer)) | (*(WrapperStruct00_var_1_13_Pointer))) + (*(WrapperStruct00_var_1_4_Pointer))) < stepLocal_2) {
  (*(WrapperStruct00_var_1_10_Pointer)) = ((*(WrapperStruct00_var_1_12_Pointer)) - 256);
 } else {
  (*(WrapperStruct00_var_1_10_Pointer)) = 128;
 }
 if (1 == (*(WrapperStruct00_var_1_4_Pointer))) {
