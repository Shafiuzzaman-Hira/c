...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch9PS_CN_25.c", 13, "reach_error"); }
...
double var_1_25 = 127.75;
double var_1_26 = 9999999999999.2;
double var_1_27 = 9.1;
...
void step(void) {
	...
	if (var_1_23 > var_1_19) {
		var_1_25 = (abs (999999.5));
	}


	// From: CodeObject4
	if (var_1_22 < (abs (var_1_24))) {
		if (var_1_22 >= ((var_1_24 ^ var_1_19) ^ var_1_23)) {
			var_1_26 = var_1_27;
		}
	}
	...
	if (var_1_28 != -32) {
		...
		var_1_29 = (abs (50 + var_1_30));
	}


	// From: Req3Batch9PS_CN_25
	if (((var_1_6 >> 2) * last_1_var_1_13) > last_1_var_1_10) {
		var_1_12 = var_1_6;
	}


	// From: Req2Batch9PS_CN_25
	...
	// From: Req6Batch9PS_CN_25
	var_1_18 = var_1_3;


	// From: Req5Batch9PS_CN_25
