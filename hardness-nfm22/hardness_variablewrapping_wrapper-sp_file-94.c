...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch94Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch94Wrapper_SP
	if ((*(WrapperStruct00_var_1_5_Pointer)) > ((*(WrapperStruct00_var_1_1_Pointer)) / (*(WrapperStruct00_var_1_4_Pointer)))) {
		if ((*(WrapperStruct00_var_1_5_Pointer)) > ((*(WrapperStruct00_var_1_4_Pointer)) / (*(WrapperStruct00_var_1_8_Pointer)))) {
	...
	if ((*(WrapperStruct00_var_1_10_Pointer)) || (*(WrapperStruct00_var_1_9_Pointer))) {
		...
		(*(WrapperStruct00_var_1_11_Pointer)) = ((max ((*(WrapperStruct00_var_1_13_Pointer)) , (*(WrapperStruct00_var_1_14_Pointer)))) + ((*(WrapperStruct00_var_1_15_Pointer)) + (*(WrapperStruct00_var_1_16_Pointer))));
	}


	// From: Req4Batch94Wrapper_SP
	signed char stepLocal_0 = (*(WrapperStruct00_var_1_15_Pointer));
	if ((*(WrapperStruct00_var_1_6_Pointer)) > (*(WrapperStruct00_var_1_5_Pointer))) {
		if ((*(WrapperStruct00_var_1_1_Pointer)) != ((*(WrapperStruct00_var_1_4_Pointer)) / (*(WrapperStruct00_var_1_8_Pointer)))) {
			if (((*(WrapperStruct00_var_1_11_Pointer)) % ((*(WrapperStruct00_var_1_18_Pointer)) + (*(WrapperStruct00_var_1_19_Pointer)))) > stepLocal_0) {
				(*(WrapperStruct00_var_1_17_Pointer)) = -64;
			}
		}
	} else {
		(*(WrapperStruct00_var_1_17_Pointer)) = (*(WrapperStruct00_var_1_13_Pointer));
	}
}
