...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch70Amount10.c", 13, "reach_error"); }
...
int property() {
	return (var_1_2 && var_1_3) ? (var_1_1 == ((float) (var_1_4 - var_1_5))) : ((var_1_4 >= var_1_5) ? (var_1_3 ? (var_1_1 == ((float) (abs (var_1_5)))) : (var_1_1 == ((float) var_1_4))) : 1)
;
}
int main(void) {
	isInitial = 1;
