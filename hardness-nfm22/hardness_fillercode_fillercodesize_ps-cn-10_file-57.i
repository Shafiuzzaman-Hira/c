...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch57PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_30 = -64;
 if (var_1_25) {
  if (var_1_24 || var_1_32) {
   if (! var_1_32) {
    var_1_31 = ((((var_1_27) < (7.5f)) ? (var_1_27) : (7.5f)));
   }
  }
 } else {
  var_1_31 = var_1_33;
