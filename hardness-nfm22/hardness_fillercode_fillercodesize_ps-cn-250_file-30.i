...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch30PS_CN_250.c", 13, "reach_error"); }
...
double var_1_50 = 2.55;
double var_1_51 = 256.7;
double var_1_52 = 8.5;
...
void step(void) {
 ...
 if ((-2 | var_1_28) >= (~ var_1_29)) {
  var_1_31 = (((((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))) < 0 ) ? -((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))) : ((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32)))));
 } else {
  if (5 >= ((var_1_29 - var_1_28) << var_1_30)) {
   var_1_31 = var_1_32;
  }
 }
 if (var_1_32 <= var_1_31) {
  if (var_1_32 <= ((((10.9f) < (var_1_20)) ? (10.9f) : (var_1_20)))) {
   var_1_33 = (((((4) < 0 ) ? -(4) : (4))) + var_1_34);
  }
 }
 if (var_1_19 > var_1_27) {
  if (var_1_26 || (var_1_32 <= var_1_23)) {
   if (var_1_34 > var_1_33) {
    if ((((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) - ((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29)))) < var_1_27) {
     var_1_35 = var_1_36;
    }
   } else {
 ...
 if (var_1_26) {
  var_1_40 = ((((var_1_19) > ((((((var_1_41) < (var_1_28)) ? (var_1_41) : (var_1_28))) + 64))) ? (var_1_19) : ((((((var_1_41) < (var_1_28)) ? (var_1_41) : (var_1_28))) + 64))));
 } else {
  var_1_40 = ((((var_1_30) < (var_1_41)) ? (var_1_30) : (var_1_41)));
 }
 if (((((var_1_28) < (var_1_41)) ? (var_1_28) : (var_1_41))) < (var_1_19 * (var_1_33 / var_1_43))) {
  var_1_42 = ((((var_1_33) > (var_1_30)) ? (var_1_33) : (var_1_30)));
 }
 if (var_1_32 >= 3.5f) {
  var_1_44 = var_1_32;
 }
 if (var_1_26) {
  var_1_45 = (((((((var_1_28) < (var_1_29)) ? (var_1_28) : (var_1_29))) < 0 ) ? -((((var_1_28) < (var_1_29)) ? (var_1_28) : (var_1_29))) : ((((var_1_28) < (var_1_29)) ? (var_1_28) : (var_1_29)))));
 } else {
  if ((((((16 << var_1_19)) > (var_1_41)) ? ((16 << var_1_19)) : (var_1_41))) >= var_1_43) {
   if (var_1_42 >= var_1_40) {
    var_1_45 = ((((var_1_28) > (var_1_29)) ? (var_1_28) : (var_1_29)));
   } else {
    var_1_45 = ((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28)));
   }
  } else {
   var_1_45 = 64u;
  }
 }
 if ((var_1_28 - ((((var_1_47) > (100)) ? (var_1_47) : (100)))) > (~ var_1_19)) {
  var_1_46 = ((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29)));
 }
 if (var_1_38) {
  var_1_48 = (((((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29))) < 0 ) ? -((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29))) : ((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29)))));
 }
 if (var_1_21 >= var_1_20) {
  var_1_49 = ((((((((var_1_32) > (var_1_50)) ? (var_1_32) : (var_1_50)))) < ((((((var_1_51 - var_1_52)) < (256.4)) ? ((var_1_51 - var_1_52)) : (256.4))))) ? (((((var_1_32) > (var_1_50)) ? (var_1_32) : (var_1_50)))) : ((((((var_1_51 - var_1_52)) < (256.4)) ? ((var_1_51 - var_1_52)) : (256.4))))));
 }
 if (var_1_48 < var_1_41) {
  if (var_1_54 > (((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29))) & ((((var_1_46) < 0 ) ? -(var_1_46) : (var_1_46))))) {
   var_1_53 = ((var_1_29 + var_1_54) + var_1_46);
  } else {
   if (3.6f > var_1_49) {
    var_1_53 = (100u + var_1_28);
   }
  }
 }
 if (var_1_34 >= var_1_33) {
  var_1_55 = ((((var_1_54 + var_1_41) < 0 ) ? -(var_1_54 + var_1_41) : (var_1_54 + var_1_41)));
 } else {
  var_1_55 = ((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30)));
 }
 var_1_56 = ((((((((var_1_34) < (((((var_1_57) > (var_1_58)) ? (var_1_57) : (var_1_58))))) ? (var_1_34) : (((((var_1_57) > (var_1_58)) ? (var_1_57) : (var_1_58))))))) < (var_1_59)) ? (((((var_1_34) < (((((var_1_57) > (var_1_58)) ? (var_1_57) : (var_1_58))))) ? (var_1_34) : (((((var_1_57) > (var_1_58)) ? (var_1_57) : (var_1_58))))))) : (var_1_59)));
 if (((((var_1_55) < (256u)) ? (var_1_55) : (256u))) < (var_1_53 | var_1_29)) {
  var_1_60 = ((((2u) < 0 ) ? -(2u) : (2u)));
 } else {
  var_1_60 = ((((((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29)))) > (((var_1_28 + var_1_54) + var_1_48))) ? (((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29)))) : (((var_1_28 + var_1_54) + var_1_48))));
 }
 if (var_1_28 < ((((var_1_43) > (((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))))) ? (var_1_43) : (((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))))))) {
  if (((((var_1_28) > (var_1_56)) ? (var_1_28) : (var_1_56))) <= var_1_30) {
   var_1_61 = (var_1_54 - (((((((var_1_58) < 0 ) ? -(var_1_58) : (var_1_58))) < 0 ) ? -((((var_1_58) < 0 ) ? -(var_1_58) : (var_1_58))) : ((((var_1_58) < 0 ) ? -(var_1_58) : (var_1_58))))));
  } else {
   var_1_61 = (((((((-50) < 0 ) ? -(-50) : (-50))) < 0 ) ? -((((-50) < 0 ) ? -(-50) : (-50))) : ((((-50) < 0 ) ? -(-50) : (-50)))));
  }
 }
 if (var_1_34 > var_1_27) {
  if (var_1_52 == (((((- var_1_20)) < (var_1_63)) ? ((- var_1_20)) : (var_1_63)))) {
   var_1_62 = ((((((((((((var_1_56) < (var_1_28)) ? (var_1_56) : (var_1_28)))) < (var_1_58)) ? (((((var_1_56) < (var_1_28)) ? (var_1_56) : (var_1_28)))) : (var_1_58)))) < (var_1_57)) ? (((((((((var_1_56) < (var_1_28)) ? (var_1_56) : (var_1_28)))) < (var_1_58)) ? (((((var_1_56) < (var_1_28)) ? (var_1_56) : (var_1_28)))) : (var_1_58)))) : (var_1_57)));
  }
 } else {
  var_1_62 = ((((var_1_58) < 0 ) ? -(var_1_58) : (var_1_58)));
 }
 if (var_1_46 >= ((((((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41)))) > (var_1_28)) ? (((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41)))) : (var_1_28)))) {
  var_1_64 = (var_1_65 && var_1_66);
 }
 if (var_1_35) {
  var_1_67 = (var_1_66 && ((var_1_65 && var_1_68) && var_1_69));
 }
 if (var_1_46 < var_1_48) {
  var_1_70 = (var_1_29 - var_1_28);
 }
 if (((~ var_1_40) | var_1_56) <= -64) {
  var_1_71 = ((((((((var_1_57) < 0 ) ? -(var_1_57) : (var_1_57)))) > ((var_1_48 - var_1_28))) ? (((((var_1_57) < 0 ) ? -(var_1_57) : (var_1_57)))) : ((var_1_48 - var_1_28))));
 }
 if ((var_1_45 + var_1_28) > var_1_71) {
  var_1_72 = -1;
 } else {
  if (var_1_36 && var_1_65) {
   if ((var_1_51 / ((((9999.95f) < 0 ) ? -(9999.95f) : (9999.95f)))) > var_1_31) {
    var_1_72 = var_1_34;
   } else {
    var_1_72 = (((((((((((-8) < (var_1_57)) ? (-8) : (var_1_57)))) > (var_1_34)) ? (((((-8) < (var_1_57)) ? (-8) : (var_1_57)))) : (var_1_34))) < 0 ) ? -((((((((-8) < (var_1_57)) ? (-8) : (var_1_57)))) > (var_1_34)) ? (((((-8) < (var_1_57)) ? (-8) : (var_1_57)))) : (var_1_34))) : ((((((((-8) < (var_1_57)) ? (-8) : (var_1_57)))) > (var_1_34)) ? (((((-8) < (var_1_57)) ? (-8) : (var_1_57)))) : (var_1_34)))));
   }
  }
 }
 if (((((var_1_20) > (((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22))))) ? (var_1_20) : (((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22)))))) > var_1_49) {
  var_1_73 = ((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29)));
 }
 if ((var_1_54 ^ (var_1_59 >> var_1_60)) != ((((var_1_42) > (var_1_75)) ? (var_1_42) : (var_1_75)))) {
  var_1_74 = var_1_59;
 } else {
  var_1_74 = ((((((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34)))) < (((((var_1_76 - var_1_77) < 0 ) ? -(var_1_76 - var_1_77) : (var_1_76 - var_1_77))))) ? (((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34)))) : (((((var_1_76 - var_1_77) < 0 ) ? -(var_1_76 - var_1_77) : (var_1_76 - var_1_77))))));
 }
 if (var_1_68 && var_1_79) {
  var_1_78 = var_1_77;
 }
 if (var_1_48 != (var_1_72 ^ (~ var_1_43))) {
  var_1_80 = (((((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) < 0 ) ? -((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) : ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34)))));
 }
 var_1_81 = var_1_52;
 if (var_1_69) {
  var_1_82 = var_1_52;
 ...
 if (var_1_68) {
  if (var_1_50 == var_1_20) {
   if ((((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52))) + var_1_83) >= ((((var_1_49) > ((var_1_51 * var_1_22))) ? (var_1_49) : ((var_1_51 * var_1_22))))) {
    var_1_84 = var_1_76;
   } else {
    var_1_84 = var_1_76;
   }
