...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch69stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 signed long int stepLocal_2 = var_1_8 - var_1_5;
