...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch68PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_18 || var_1_17) {
		...
		if (var_1_21 >= var_1_28) {
			...
			var_1_29 = ((var_1_27 <= var_1_26) && var_1_18);
		}
	}


	// From: CodeObject7
	if (var_1_19 && ((var_1_23 + var_1_28) >= var_1_21)) {
		var_1_31 = var_1_25;
	}


	// From: Req5Batch68PS_CN_25
	...
	// From: Req8Batch68PS_CN_25
	var_1_16 = last_1_var_1_12;


	// From: Req6Batch68PS_CN_25
	...
	// From: Req7Batch68PS_CN_25
	var_1_15 = var_1_10;


	// From: Req3Batch68PS_CN_25
