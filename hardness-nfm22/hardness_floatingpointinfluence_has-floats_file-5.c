...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch5has_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch5has_floats
	if (var_1_12 <= ((var_1_8 / var_1_14) * (2 % var_1_15))) {
		var_1_13 = (var_1_8 + ((max (var_1_16 , var_1_17)) - var_1_15));
	}


	// From: Req1Batch5has_floats
	signed long int stepLocal_0 = var_1_8 - var_1_8;
	if ((var_1_13 - var_1_13) >= stepLocal_0) {
		var_1_1 = (abs (var_1_8 - var_1_8));
	}


	// From: Req4Batch5has_floats
	var_1_18 = -4;


	// From: Req5Batch5has_floats
	var_1_19 = var_1_8;


	// From: Req6Batch5has_floats
	var_1_20 = var_1_12;
}
...
int property() {
	return (((((((var_1_13 - var_1_13) >= (var_1_8 - var_1_8)) ? (var_1_1 == ((signed short int) (abs (var_1_8 - var_1_8)))) : 1) && (var_1_9 ? ((var_1_7 > (last_1_var_1_13 + (var_1_6 - var_1_10))) ? ((last_1_var_1_13 < (~ last_1_var_1_20)) ? (var_1_8 == ((unsigned char) var_1_12)) : (var_1_8 == ((unsigned char) var_1_12))) : (var_1_8 == ((unsigned char) var_1_12))) : 1)) && ((var_1_12 <= ((var_1_8 / var_1_14) * (2 % var_1_15))) ? (var_1_13 == ((unsigned short int) (var_1_8 + ((max (var_1_16 , var_1_17)) - var_1_15)))) : 1)) && (var_1_18 == ((signed long int) -4))) && (var_1_19 == ((signed short int) var_1_8))) && (var_1_20 == ((signed short int) var_1_12))
;
}
int main(void) {
	isInitial = 1;
