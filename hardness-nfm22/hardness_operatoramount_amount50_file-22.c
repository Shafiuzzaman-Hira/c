...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch22Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch22Amount50
	if ((- 3.75) < (min (var_1_20 , var_1_22))) {
		var_1_27 = 0;
	}


	// From: Req2Batch22Amount50
