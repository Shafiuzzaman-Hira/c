...
void step(void) {
	...
	if (WrapperStruct0.var_1_12) {
		if ((WrapperStruct0.var_1_14 - WrapperStruct0.var_1_15) >= ((WrapperStruct0.var_1_8 + WrapperStruct0.var_1_10) + WrapperStruct0.var_1_9)) {
			WrapperStruct0.var_1_13 = (max (WrapperStruct0.var_1_1 , WrapperStruct0.var_1_1));
		} else {
	...
	if ((min (WrapperStruct0.var_1_8 , WrapperStruct0.var_1_9)) <= WrapperStruct0.var_1_10) {
...
int property() {
	return ((((last_1_WrapperStruct0_var_1_13 + (max (last_1_WrapperStruct0_var_1_13 , last_1_WrapperStruct0_var_1_13))) < (last_1_WrapperStruct0_var_1_13 * last_1_WrapperStruct0_var_1_13)) ? ((last_1_WrapperStruct0_var_1_13 < (last_1_WrapperStruct0_var_1_13 - last_1_WrapperStruct0_var_1_13)) ? ((last_1_WrapperStruct0_var_1_13 != (abs (min (last_1_WrapperStruct0_var_1_13 , last_1_WrapperStruct0_var_1_13)))) ? (WrapperStruct0.var_1_1 == ((unsigned short int) last_1_WrapperStruct0_var_1_13)) : 1) : 1) : (WrapperStruct0.var_1_1 == ((unsigned short int) last_1_WrapperStruct0_var_1_13))) && (((min (WrapperStruct0.var_1_8 , WrapperStruct0.var_1_9)) <= WrapperStruct0.var_1_10) ? ((last_1_WrapperStruct0_var_1_7 && (WrapperStruct0.var_1_1 >= WrapperStruct0.var_1_1)) ? (WrapperStruct0.var_1_7 == ((unsigned char) 0)) : 1) : (WrapperStruct0.var_1_7 == ((unsigned char) WrapperStruct0.var_1_12)))) && (WrapperStruct0.var_1_12 ? (((WrapperStruct0.var_1_14 - WrapperStruct0.var_1_15) >= ((WrapperStruct0.var_1_8 + WrapperStruct0.var_1_10) + WrapperStruct0.var_1_9)) ? (WrapperStruct0.var_1_13 == ((signed short int) (max (WrapperStruct0.var_1_1 , WrapperStruct0.var_1_1)))) : (WrapperStruct0.var_1_13 == ((signed short int) WrapperStruct0.var_1_1))) : 1)
;
}
int main(void) {
	isInitial = 1;
