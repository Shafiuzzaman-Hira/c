...
void step(void) {
	...
	// From: Req7Batch61Filler_PE_CI
	var_1_21 = var_1_6;


	// From: Req8Batch61Filler_PE_CI
	var_1_22 = var_1_23;


	// From: Req1Batch61Filler_PE_CI
	if ((var_1_21 / (abs (64u))) == var_1_4) {
		var_1_1 = (8.8 - 255.2);
	}


	// From: Req4Batch61Filler_PE_CI
