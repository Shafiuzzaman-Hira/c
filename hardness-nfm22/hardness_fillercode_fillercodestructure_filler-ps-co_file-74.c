...
void step(void) {
	...
	if ((~ (5 + var_1_11)) >= 10000u) {
		var_1_29 = (max ((var_1_11 + var_1_27) , (abs (var_1_11))));
	} else {
		var_1_29 = (abs (abs (max (var_1_11 , var_1_11))));
	}
	...
	// From: CodeObject5
	if (var_1_11 <= (min (var_1_27 , (var_1_11 | -5)))) {
		if (var_1_8) {
			var_1_32 = var_1_27;
		}
	}
	...
	// From: CodeObject6
	if ((min (var_1_11 , var_1_27)) <= var_1_11) {
		if (var_1_8) {
			if (var_1_8 || var_1_8) {
				if ((abs (var_1_11)) > var_1_27) {
					var_1_34 = var_1_11;
				}
			}
		}
	} else {
		if ((abs (var_1_27)) > var_1_11) {
			if (var_1_24 > 49.75f) {
				var_1_34 = (abs (min ((min (var_1_1 , var_1_1)) , -25)));
			}
		} else {
			var_1_34 = var_1_11;
		}
