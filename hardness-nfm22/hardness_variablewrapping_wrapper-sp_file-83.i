...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch83Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
 ...
 signed long int stepLocal_0 = (*(WrapperStruct00_var_1_3_Pointer)) / (*(WrapperStruct00_var_1_4_Pointer));
 if ((*(WrapperStruct00_var_1_2_Pointer))) {
  ...
  if (stepLocal_0 >= (((((last_1_WrapperStruct00_var_1_1 * (*(WrapperStruct00_var_1_15_Pointer)))) < ((~ last_1_WrapperStruct00_var_1_1))) ? ((last_1_WrapperStruct00_var_1_1 * (*(WrapperStruct00_var_1_15_Pointer)))) : ((~ last_1_WrapperStruct00_var_1_1))))) {
 ...
 signed long int stepLocal_2 = (*(WrapperStruct00_var_1_3_Pointer)) + (*(WrapperStruct00_var_1_1_Pointer));
 signed long int stepLocal_1 = (*(WrapperStruct00_var_1_14_Pointer)) ^ (*(WrapperStruct00_var_1_15_Pointer));
 if ((*(WrapperStruct00_var_1_15_Pointer)) <= stepLocal_2) {
 ...
 if ((*(WrapperStruct00_var_1_15_Pointer)) > (*(WrapperStruct00_var_1_15_Pointer))) {
...
int property() {
 return ((((((*(WrapperStruct00_var_1_2_Pointer)) ? ((*(WrapperStruct00_var_1_1_Pointer)) == ((unsigned short int) ((((((((*(WrapperStruct00_var_1_3_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_3_Pointer))) : ((*(WrapperStruct00_var_1_3_Pointer))))) < 0 ) ? -(((((*(WrapperStruct00_var_1_3_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_3_Pointer))) : ((*(WrapperStruct00_var_1_3_Pointer))))) : (((((*(WrapperStruct00_var_1_3_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_3_Pointer))) : ((*(WrapperStruct00_var_1_3_Pointer))))))))) : ((((*(WrapperStruct00_var_1_3_Pointer)) / (*(WrapperStruct00_var_1_4_Pointer))) >= (((((last_1_WrapperStruct00_var_1_1 * (*(WrapperStruct00_var_1_15_Pointer)))) < ((~ last_1_WrapperStruct00_var_1_1))) ? ((last_1_WrapperStruct00_var_1_1 * (*(WrapperStruct00_var_1_15_Pointer)))) : ((~ last_1_WrapperStruct00_var_1_1))))) ? ((*(WrapperStruct00_var_1_1_Pointer)) == ((unsigned short int) (*(WrapperStruct00_var_1_4_Pointer)))) : ((*(WrapperStruct00_var_1_1_Pointer)) == ((unsigned short int) (*(WrapperStruct00_var_1_3_Pointer)))))) && (((*(WrapperStruct00_var_1_15_Pointer)) <= ((*(WrapperStruct00_var_1_3_Pointer)) + (*(WrapperStruct00_var_1_1_Pointer)))) ? (((*(WrapperStruct00_var_1_1_Pointer)) == ((*(WrapperStruct00_var_1_14_Pointer)) ^ (*(WrapperStruct00_var_1_15_Pointer)))) ? ((*(WrapperStruct00_var_1_8_Pointer)) == ((double) ((((((*(WrapperStruct00_var_1_10_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_10_Pointer))) : ((*(WrapperStruct00_var_1_10_Pointer))))) + (*(WrapperStruct00_var_1_11_Pointer))))) : ((*(WrapperStruct00_var_1_8_Pointer)) == ((double) (*(WrapperStruct00_var_1_11_Pointer))))) : ((*(WrapperStruct00_var_1_8_Pointer)) == ((double) (*(WrapperStruct00_var_1_10_Pointer)))))) && (((*(WrapperStruct00_var_1_15_Pointer)) > (*(WrapperStruct00_var_1_15_Pointer))) ? ((*(WrapperStruct00_var_1_12_Pointer)) == ((double) (((((*(WrapperStruct00_var_1_11_Pointer))) < ((*(WrapperStruct00_var_1_10_Pointer)))) ? ((*(WrapperStruct00_var_1_11_Pointer))) : ((*(WrapperStruct00_var_1_10_Pointer))))))) : 1)) && ((*(WrapperStruct00_var_1_14_Pointer)) == ((signed short int) 200))) && ((*(WrapperStruct00_var_1_15_Pointer)) == ((signed char) (*(WrapperStruct00_var_1_16_Pointer))))) && ((*(WrapperStruct00_var_1_17_Pointer)) == ((double) (*(WrapperStruct00_var_1_10_Pointer))))
;
}
int main(void) {
 isInitial = 1;
