...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch86Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_1 / (var_1_30 + var_1_31)) >= var_1_27) {
 ...
 if (((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12))) > (~ (var_1_30 % var_1_31))) {
  if (var_1_28 >= 2) {
