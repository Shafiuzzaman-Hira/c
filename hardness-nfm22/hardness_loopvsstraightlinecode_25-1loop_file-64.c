...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch6425_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch6425_1loop
	var_1_15 = var_1_16;


	// From: Req5Batch6425_1loop
	var_1_17 = var_1_5;


	// From: Req2Batch6425_1loop
	...
	// From: Req3Batch6425_1loop
	var_1_13 = var_1_15;


	// From: Req1Batch6425_1loop
