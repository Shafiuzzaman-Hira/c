...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch30Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
 if ((((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16))) - var_1_21) == (var_1_16 * var_1_7)) {
  var_1_19 = -4;
 }
 var_1_24 = var_1_11;
 if (var_1_21 != var_1_16) {
  if (var_1_5 < (var_1_10 / var_1_26)) {
   var_1_25 = ((((4) < 0 ) ? -(4) : (4)));
  } else {
   var_1_25 = 64;
  }
 ...
 if (var_1_7 > var_1_17) {
  ...
  if (var_1_1) {
   var_1_31 = ((((((((var_1_7) < (var_1_18)) ? (var_1_7) : (var_1_18))) < 0 ) ? -((((var_1_7) < (var_1_18)) ? (var_1_7) : (var_1_18))) : ((((var_1_7) < (var_1_18)) ? (var_1_7) : (var_1_18))))) - 256.35f);
  }
 }
 if (! ((1 + var_1_11) <= var_1_11)) {
  if (var_1_11 > (((((((-5) < 0 ) ? -(-5) : (-5))) < 0 ) ? -((((-5) < 0 ) ? -(-5) : (-5))) : ((((-5) < 0 ) ? -(-5) : (-5)))))) {
   var_1_35 = -128;
  }
 }
 if (var_1_21 < var_1_7) {
