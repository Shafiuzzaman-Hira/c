...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch78Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_35 = ((((var_1_26) > (((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28))))) ? (var_1_26) : (((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28))))));
 if (var_1_29 > var_1_30) {
  if ((var_1_28 ^ var_1_27) != (var_1_24 / 32)) {
   ...
   var_1_36 = ((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24)));
  }
 } else {
