...
void step(void) {
 ...
 if (BOOL_unsigned_char_Array_0[0] || stepLocal_0) {
  signed_char_Array_0[0] = ((((1 - signed_char_Array_0[2]) < 0 ) ? -(1 - signed_char_Array_0[2]) : (1 - signed_char_Array_0[2])));
 } else {
 ...
 if (stepLocal_1 <= (unsigned_short_int_Array_0[0] / signed_long_int_Array_0[0])) {
  double_Array_0[1][0][1] = ((((((((((((double_Array_0[1][1][0]) < (double_Array_0[0][0][1])) ? (double_Array_0[1][1][0]) : (double_Array_0[0][0][1])))) > (double_Array_0[0][1][1])) ? (((((double_Array_0[1][1][0]) < (double_Array_0[0][0][1])) ? (double_Array_0[1][1][0]) : (double_Array_0[0][0][1])))) : (double_Array_0[0][1][1])))) < (((((3.6) > (double_Array_0[1][1][1])) ? (3.6) : (double_Array_0[1][1][1]))))) ? (((((((((double_Array_0[1][1][0]) < (double_Array_0[0][0][1])) ? (double_Array_0[1][1][0]) : (double_Array_0[0][0][1])))) > (double_Array_0[0][1][1])) ? (((((double_Array_0[1][1][0]) < (double_Array_0[0][0][1])) ? (double_Array_0[1][1][0]) : (double_Array_0[0][0][1])))) : (double_Array_0[0][1][1])))) : (((((3.6) > (double_Array_0[1][1][1])) ? (3.6) : (double_Array_0[1][1][1]))))));
 } else {
  double_Array_0[1][0][1] = (double_Array_0[0][0][0] - double_Array_0[1][0][0]);
 }
 if ((((((unsigned_short_int_Array_0[0] - unsigned_short_int_Array_0[0])) > (signed_char_Array_0[0])) ? ((unsigned_short_int_Array_0[0] - unsigned_short_int_Array_0[0])) : (signed_char_Array_0[0]))) <= (((((unsigned_short_int_Array_0[0] - unsigned_short_int_Array_0[0])) < ((signed_char_Array_0[1] % signed_long_int_Array_0[0]))) ? ((unsigned_short_int_Array_0[0] - unsigned_short_int_Array_0[0])) : ((signed_char_Array_0[1] % signed_long_int_Array_0[0]))))) {
  signed_short_int_Array_0[2] = (((((signed_short_int_Array_0[0] - signed_short_int_Array_0[1])) < (signed_char_Array_0[0])) ? ((signed_short_int_Array_0[0] - signed_short_int_Array_0[1])) : (signed_char_Array_0[0])));
 }
}
