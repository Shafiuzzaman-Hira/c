...
int property() {
 return (((var_1_2 - 5u) <= (~ var_1_3)) ? ((var_1_2 >= var_1_3) ? (var_1_1 == ((signed char) ((((var_1_4) > (var_1_5)) ? (var_1_4) : (var_1_5))))) : (var_1_1 == ((signed char) var_1_5))) : 1) && (var_1_6 == ((unsigned char) var_1_7))
;
}
int main(void) {
 isInitial = 1;
