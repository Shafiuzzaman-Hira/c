...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch6Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch6Wrapper_SP
	if (((*(WrapperStruct00_var_1_4_Pointer)) - last_1_WrapperStruct00_var_1_20) == last_1_WrapperStruct00_var_1_18) {
		if ((((*(WrapperStruct00_var_1_9_Pointer)) - (*(WrapperStruct00_var_1_10_Pointer))) - (*(WrapperStruct00_var_1_11_Pointer))) > (*(WrapperStruct00_var_1_12_Pointer))) {
			(*(WrapperStruct00_var_1_6_Pointer)) = ((*(WrapperStruct00_var_1_13_Pointer)) - (*(WrapperStruct00_var_1_8_Pointer)));
		}
	} else {
		(*(WrapperStruct00_var_1_6_Pointer)) = (*(WrapperStruct00_var_1_13_Pointer));
	}


	// From: Req4Batch6Wrapper_SP
	if ((*(WrapperStruct00_var_1_13_Pointer)) > (*(WrapperStruct00_var_1_6_Pointer))) {
		(*(WrapperStruct00_var_1_18_Pointer)) = ((min ((*(WrapperStruct00_var_1_6_Pointer)) , (*(WrapperStruct00_var_1_13_Pointer)))) - (*(WrapperStruct00_var_1_6_Pointer)));
	}


	// From: Req3Batch6Wrapper_SP
	if (last_1_WrapperStruct00_var_1_14) {
		(*(WrapperStruct00_var_1_14_Pointer)) = ((*(WrapperStruct00_var_1_16_Pointer)) && (*(WrapperStruct00_var_1_17_Pointer)));
	}


	// From: Req5Batch6Wrapper_SP
	(*(WrapperStruct00_var_1_20_Pointer)) = (min ((abs (last_1_WrapperStruct00_var_1_20)) , ((*(WrapperStruct00_var_1_21_Pointer)) - (*(WrapperStruct00_var_1_7_Pointer)))));


	// From: Req1Batch6Wrapper_SP
	unsigned long int stepLocal_1 = (*(WrapperStruct00_var_1_20_Pointer));
	unsigned long int stepLocal_0 = (*(WrapperStruct00_var_1_20_Pointer));
	if (((max ((*(WrapperStruct00_var_1_18_Pointer)) , (*(WrapperStruct00_var_1_18_Pointer)))) / (*(WrapperStruct00_var_1_4_Pointer))) > stepLocal_1) {
		if (stepLocal_0 == (*(WrapperStruct00_var_1_18_Pointer))) {
			(*(WrapperStruct00_var_1_1_Pointer)) = 1000000000u;
		} else {
			(*(WrapperStruct00_var_1_1_Pointer)) = 128u;
		}
	}
}
