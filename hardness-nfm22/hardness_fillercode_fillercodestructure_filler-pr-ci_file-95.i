...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch95Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_8) {
  if (16u > ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4)))) {
   var_1_16 = ((var_1_19 + var_1_20) - var_1_4);
  } else {
   var_1_16 = var_1_20;
  }
 }
 if (((var_1_31 - var_1_32) + (var_1_14 / var_1_13)) < ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)))) {
  if (var_1_5 >= 10u) {
   if (var_1_8) {
    var_1_30 = (((((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))) < 0 ) ? -((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))) : ((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11)))));
   } else {
    var_1_30 = ((((((((var_1_11) > (var_1_4)) ? (var_1_11) : (var_1_4)))) < ((var_1_5 + 64))) ? (((((var_1_11) > (var_1_4)) ? (var_1_11) : (var_1_4)))) : ((var_1_5 + 64))));
   }
  } else {
   var_1_30 = ((((var_1_5) < 0 ) ? -(var_1_5) : (var_1_5)));
  }
 }
 var_1_40 = var_1_19;
 ...
 if (var_1_20 >= (var_1_5 / ((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19))))) {
  var_1_26 = var_1_14;
 }
 var_1_39 = var_1_19;
