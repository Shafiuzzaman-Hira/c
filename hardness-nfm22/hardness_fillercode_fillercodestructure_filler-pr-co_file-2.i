...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch2Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (((var_1_14 + 127.75f) * var_1_25) < var_1_26) {
  if (((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6))) <= (((((var_1_20) < (var_1_21)) ? (var_1_20) : (var_1_21))) & var_1_6)) {
   var_1_27 = var_1_30;
  }
 }
 if (var_1_6 <= var_1_6) {
