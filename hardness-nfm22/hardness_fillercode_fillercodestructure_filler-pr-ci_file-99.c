...
void step(void) {
	...
	if ((var_1_16 >> var_1_14) >= var_1_20) {
		var_1_31 = (max (var_1_21 , (4 - (var_1_34 - 25))));
	} else {
		var_1_31 = var_1_21;
	}
	...
	if (var_1_17 < var_1_16) {
		var_1_46 = (min (var_1_23 , (max (256u , var_1_34))));
	}
	...
	if (var_1_26 > var_1_14) {
		var_1_42 = (max ((min (var_1_34 , var_1_14)) , (abs (32))));
	} else {
		var_1_42 = (max ((abs (min (16 , var_1_14))) , var_1_34));
	}
