...
void step(void) {
	...
	// From: CodeObject6
	var_1_41 = (min ((abs (var_1_18)) , var_1_20));
	...
	// From: CodeObject3
	if (var_1_18 <= var_1_9) {
		if ((var_1_11 | (abs (var_1_25))) >= (var_1_12 + var_1_6)) {
	...
	if (32u >= ((max (var_1_6 , var_1_11)) % 16u)) {
		if ((-5 > var_1_25) && (var_1_6 <= (max (var_1_34 , var_1_23)))) {
			var_1_39 = var_1_17;
		} else {
			var_1_39 = (abs (var_1_17));
		}
	} else {
		if (! var_1_21) {
			var_1_39 = (max (var_1_17 , (abs (var_1_20))));
		}
	}
