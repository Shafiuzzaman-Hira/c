...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch54Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch54Wrapper_SP
	(*(WrapperStruct00_var_1_14_Pointer)) = (*(WrapperStruct00_var_1_12_Pointer));


	// From: Req5Batch54Wrapper_SP
	(*(WrapperStruct00_var_1_15_Pointer)) = (*(WrapperStruct00_var_1_16_Pointer));


	// From: Req1Batch54Wrapper_SP
	signed long int stepLocal_0 = -4;
	if (stepLocal_0 >= (*(WrapperStruct00_var_1_15_Pointer))) {
		(*(WrapperStruct00_var_1_1_Pointer)) = (min ((*(WrapperStruct00_var_1_3_Pointer)) , (abs (1))));
	}


	// From: Req3Batch54Wrapper_SP
	...
	if ((*(WrapperStruct00_var_1_9_Pointer))) {
		if (stepLocal_2 > (*(WrapperStruct00_var_1_15_Pointer))) {
			(*(WrapperStruct00_var_1_11_Pointer)) = (max ((max ((*(WrapperStruct00_var_1_12_Pointer)) , 16.5)) , (*(WrapperStruct00_var_1_13_Pointer))));
		} else {
	...
	// From: Req2Batch54Wrapper_SP
	signed long int stepLocal_1 = max (10 , (*(WrapperStruct00_var_1_1_Pointer)));
	if ((8 * (*(WrapperStruct00_var_1_1_Pointer))) == stepLocal_1) {
		if ((*(WrapperStruct00_var_1_6_Pointer))) {
			(*(WrapperStruct00_var_1_4_Pointer)) = (((*(WrapperStruct00_var_1_11_Pointer)) < (*(WrapperStruct00_var_1_14_Pointer))) && (*(WrapperStruct00_var_1_9_Pointer)));
		} else {
			if ((*(WrapperStruct00_var_1_14_Pointer)) >= (abs ((*(WrapperStruct00_var_1_11_Pointer))))) {
				(*(WrapperStruct00_var_1_4_Pointer)) = (! (*(WrapperStruct00_var_1_9_Pointer)));
			} else {
				(*(WrapperStruct00_var_1_4_Pointer)) = 0;
			}
		}
	} else {
		(*(WrapperStruct00_var_1_4_Pointer)) = (*(WrapperStruct00_var_1_10_Pointer));
	}
}
...
int property() {
	return (((((-4 >= (*(WrapperStruct00_var_1_15_Pointer))) ? ((*(WrapperStruct00_var_1_1_Pointer)) == ((unsigned char) (min ((*(WrapperStruct00_var_1_3_Pointer)) , (abs (1)))))) : 1) && (((8 * (*(WrapperStruct00_var_1_1_Pointer))) == (max (10 , (*(WrapperStruct00_var_1_1_Pointer))))) ? ((*(WrapperStruct00_var_1_6_Pointer)) ? ((*(WrapperStruct00_var_1_4_Pointer)) == ((unsigned char) (((*(WrapperStruct00_var_1_11_Pointer)) < (*(WrapperStruct00_var_1_14_Pointer))) && (*(WrapperStruct00_var_1_9_Pointer))))) : (((*(WrapperStruct00_var_1_14_Pointer)) >= (abs ((*(WrapperStruct00_var_1_11_Pointer))))) ? ((*(WrapperStruct00_var_1_4_Pointer)) == ((unsigned char) (! (*(WrapperStruct00_var_1_9_Pointer))))) : ((*(WrapperStruct00_var_1_4_Pointer)) == ((unsigned char) 0)))) : ((*(WrapperStruct00_var_1_4_Pointer)) == ((unsigned char) (*(WrapperStruct00_var_1_10_Pointer)))))) && ((*(WrapperStruct00_var_1_9_Pointer)) ? (((*(WrapperStruct00_var_1_3_Pointer)) > (*(WrapperStruct00_var_1_15_Pointer))) ? ((*(WrapperStruct00_var_1_11_Pointer)) == ((double) (max ((max ((*(WrapperStruct00_var_1_12_Pointer)) , 16.5)) , (*(WrapperStruct00_var_1_13_Pointer)))))) : ((*(WrapperStruct00_var_1_10_Pointer)) ? ((*(WrapperStruct00_var_1_11_Pointer)) == ((double) (*(WrapperStruct00_var_1_12_Pointer)))) : 1)) : 1)) && ((*(WrapperStruct00_var_1_14_Pointer)) == ((float) (*(WrapperStruct00_var_1_12_Pointer))))) && ((*(WrapperStruct00_var_1_15_Pointer)) == ((signed char) (*(WrapperStruct00_var_1_16_Pointer))))
;
}
int main(void) {
	isInitial = 1;
