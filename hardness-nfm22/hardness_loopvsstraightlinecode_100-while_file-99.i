...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch99100_while.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (last_1_var_1_25 < last_1_var_1_1) {
  if ((- last_1_var_1_17) < ((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22)))) {
 ...
 if (stepLocal_2 == ((((var_1_7) > (var_1_12)) ? (var_1_7) : (var_1_12)))) {
  if (! (var_1_12 > ((((var_1_7) < (var_1_4)) ? (var_1_7) : (var_1_4))))) {
   var_1_8 = var_1_9;
  }
 }
 if (var_1_12 < var_1_12) {
  var_1_10 = (var_1_25 - ((((var_1_5) < (16)) ? (var_1_5) : (16))));
 } else {
  if (var_1_28) {
   var_1_10 = var_1_4;
  } else {
  ...
  if (var_1_28) {
   ...
   if (stepLocal_9 <= (var_1_4 - var_1_5)) {
    if (stepLocal_10 || (var_1_19 < var_1_20)) {
     var_1_27 = (((((1) < (var_1_4)) ? (1) : (var_1_4))) + ((((var_1_14) > (var_1_10)) ? (var_1_14) : (var_1_10))));
    }
   }
  }
 }
 ...
 if (var_1_28) {
  ...
  if (stepLocal_1 && var_1_8) {
   var_1_6 = ((((var_1_27) > (var_1_4)) ? (var_1_27) : (var_1_4)));
  }
 }
