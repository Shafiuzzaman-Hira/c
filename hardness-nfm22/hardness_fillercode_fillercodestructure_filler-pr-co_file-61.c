...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch61Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch61Filler_PR_CO
	var_1_22 = var_1_23;


	// From: Req1Batch61Filler_PR_CO
	...
	// From: CodeObject5
	if (var_1_30 < ((var_1_4 + 16u) * var_1_4)) {
		if (var_1_13 && (var_1_35 < var_1_36)) {
			if (var_1_13) {
				if (var_1_4 <= var_1_25) {
					var_1_38 = (! var_1_39);
				}
