...
void step(void) {
 ...
 if ((50.75 * var_1_36) < var_1_33) {
  if (var_1_33 != var_1_36) {
   if ((var_1_31 / ((((var_1_34) < (var_1_30)) ? (var_1_34) : (var_1_30)))) <= var_1_29) {
    var_1_37 = var_1_30;
   }
  }
 } else {
 ...
 if (var_1_35) {
  var_1_38 = ((((var_1_27) < (var_1_28)) ? (var_1_27) : (var_1_28)));
 }
 if (var_1_29 > ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)))) {
  if ((var_1_31 & 256u) < var_1_37) {
   if (var_1_24) {
    var_1_39 = (((((var_1_40) < (var_1_41)) ? (var_1_40) : (var_1_41))) - var_1_42);
   }
  } else {
   var_1_39 = (((((var_1_43 + var_1_44)) < (var_1_42)) ? ((var_1_43 + var_1_44)) : (var_1_42)));
  }
 } else {
  if (((var_1_45 + var_1_36) / var_1_46) > var_1_33) {
   if (((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29))) == var_1_37) {
    var_1_39 = ((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43)));
   }
  } else {
   var_1_39 = ((((var_1_36) > (((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))))) ? (var_1_36) : (((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))))));
  }
 }
 if (var_1_23 > 5) {
  if (var_1_24) {
 ...
 if ((var_1_38 % var_1_31) >= var_1_27) {
  var_1_48 = (((((15.5 + var_1_43)) > (var_1_40)) ? ((15.5 + var_1_43)) : (var_1_40)));
 } else {
  var_1_48 = (var_1_40 - ((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))));
 }
 if (var_1_46 <= ((((var_1_42) < (var_1_43)) ? (var_1_42) : (var_1_43)))) {
  var_1_49 = var_1_44;
 }
