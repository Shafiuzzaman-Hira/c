...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch35Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch35Wrapper_S
	unsigned char stepLocal_1 = (WrapperStruct00.var_1_1 * WrapperStruct00.var_1_5) >= WrapperStruct00.var_1_4;
	if (WrapperStruct00.var_1_17 && stepLocal_1) {
		WrapperStruct00.var_1_18 = (2 + ((WrapperStruct00.var_1_19 - WrapperStruct00.var_1_20) + 32));
	} else {
	...
	if (WrapperStruct00.var_1_15) {
		WrapperStruct00.var_1_11 = ((WrapperStruct00.var_1_12 + (min (10 , WrapperStruct00.var_1_13))) + WrapperStruct00.var_1_14);
	}
	...
	if (WrapperStruct00.var_1_15) {
		if (WrapperStruct00.var_1_15) {
			WrapperStruct00.var_1_6 = (WrapperStruct00.var_1_11 + WrapperStruct00.var_1_11);
		} else {
			WrapperStruct00.var_1_6 = (WrapperStruct00.var_1_11 + WrapperStruct00.var_1_11);
		}
	} else {
