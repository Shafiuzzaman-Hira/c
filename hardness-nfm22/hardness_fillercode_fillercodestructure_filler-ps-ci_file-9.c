...
void step(void) {
	...
	// From: Req3Batch9Filler_PS_CI
	if (((var_1_6 >> 2) * last_1_var_1_13) > last_1_var_1_10) {
		var_1_12 = var_1_6;
	}


	// From: Req2Batch9Filler_PS_CI
	...
	// From: Req6Batch9Filler_PS_CI
	var_1_18 = var_1_3;


	// From: Req5Batch9Filler_PS_CI
