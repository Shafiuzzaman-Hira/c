...
void step(void) {
 ...
 if (stepLocal_1 <= ((*(var_1_3_Pointer)) - last_1_var_1_16)) {
  if (stepLocal_0 < (((((last_1_var_1_16 / (*(var_1_5_Pointer)))) > (last_1_var_1_16)) ? ((last_1_var_1_16 / (*(var_1_5_Pointer)))) : (last_1_var_1_16)))) {
