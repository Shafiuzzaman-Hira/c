...
void step(void) {
	...
	// From: Req17Batch2Amount250
	if ((max ((var_1_42 + last_1_var_1_53) , var_1_44)) > (last_1_var_1_31 - var_1_48)) {
		var_1_50 = ((min (var_1_32 , var_1_51)) - var_1_46);
	} else {
	...
	// From: Req25Batch2Amount250
	var_1_63 = var_1_50;


	// From: Req19Batch2Amount250
	signed long int stepLocal_13 = last_1_var_1_49;
	if (1 >= stepLocal_13) {
		var_1_56 = (! (last_1_var_1_23 && var_1_26));
	} else {
		var_1_56 = ((last_1_var_1_62 < (max (var_1_42 , var_1_46))) && var_1_26);
	}


	// From: Req21Batch2Amount250
	if (var_1_56) {
		var_1_58 = var_1_15;
	} else {
		var_1_58 = var_1_4;
	...
	// From: Req3Batch2Amount250
	if (var_1_56) {
		var_1_11 = (var_1_12 - var_1_10);
	}


	// From: Req15Batch2Amount250
	if (var_1_56) {
		var_1_47 = ((var_1_48 - var_1_45) - var_1_43);
	}


	// From: Req2Batch2Amount250
	var_1_8 = ((var_1_9 - var_1_10) + -2);


	// From: Req4Batch2Amount250
	if (var_1_56) {
	...
	if (var_1_26) {
		...
		if ((var_1_18 - var_1_16) >= ((max (var_1_19 , var_1_14)) - var_1_3)) {
			var_1_36 = (! var_1_28);
		} else {
			var_1_36 = (! var_1_25);
		}
	...
	// From: Req12Batch2Amount250
	var_1_37 = (var_1_3 - var_1_19);


	// From: Req16Batch2Amount250
	unsigned char stepLocal_10 = var_1_42;
	if (16 > stepLocal_10) {
		var_1_49 = (min (var_1_10 , var_1_42));
	}


	// From: Req23Batch2Amount250
	var_1_61 = var_1_42;


	// From: Req24Batch2Amount250
	var_1_62 = var_1_46;


	// From: Req6Batch2Amount250
	if (var_1_16 == var_1_3) {
	...
	if (stepLocal_4 && var_1_30) {
		if (stepLocal_2 < ((var_1_12 + var_1_47) - 128)) {
			var_1_20 = (min ((var_1_47 - var_1_10) , var_1_9));
		} else {
			if (stepLocal_1 > var_1_21) {
				...
				if (var_1_36) {
					...
					var_1_20 = (((abs (16)) + 256) - (max (0 , var_1_47)));
				}
			}
		}
	}
	...
	// From: Req14Batch2Amount250
	if (var_1_59 < ((var_1_40 - var_1_19) - var_1_17)) {
		if (31.5 > ((abs (5.5)) + (- var_1_13))) {
			if (var_1_36 && ((var_1_16 <= var_1_13) && var_1_36)) {
				var_1_39 = (var_1_10 + (abs (max (var_1_9 , var_1_42))));
			} else {
				var_1_39 = (max ((max (4 , var_1_9)) , var_1_43));
			}
		} else {
			if (-8 > ((var_1_10 + var_1_49) | var_1_50)) {
				var_1_39 = (min ((abs (var_1_10)) , var_1_43));
			}
		}
	} else {
	...
	if (stepLocal_8 <= var_1_32) {
		...
		if (stepLocal_7 && var_1_23) {
			var_1_34 = (abs (abs (max (var_1_21 , var_1_11))));
		}
	}


	// From: Req9Batch2Amount250
	...
	// From: Req20Batch2Amount250
	if (var_1_58 <= ((var_1_15 + var_1_19) + var_1_17)) {
		if (var_1_12 >= (abs (var_1_34))) {
	...
	// From: Req7Batch2Amount250
	if (((abs (var_1_4)) - var_1_18) > var_1_19) {
	...
	// From: Req13Batch2Amount250
	unsigned long int stepLocal_9 = max (var_1_31 , var_1_12);
	if (stepLocal_9 == var_1_49) {
		var_1_38 = (max (var_1_3 , var_1_4));
	}


	// From: Req18Batch2Amount250
	signed long int stepLocal_12 = var_1_44 % var_1_45;
	signed long int stepLocal_11 = 10000;
	if (var_1_56) {
		var_1_53 = var_1_47;
	} else {
		if ((var_1_31 ^ (max (last_1_var_1_53 , last_1_var_1_53))) > stepLocal_11) {
			if (stepLocal_12 == var_1_47) {
				if (var_1_1 != var_1_18) {
					var_1_53 = (var_1_48 - var_1_9);
				} else {
					var_1_53 = ((max ((max (var_1_47 , var_1_63)) , (var_1_29 + var_1_42))) + var_1_31);
				}
			}
		} else {
			var_1_53 = (min (((25 - var_1_49) + var_1_44) , (max (-5 , (var_1_31 + var_1_48)))));
		}
	}
}
...
int property() {
	return ((((((((((((((((((((((((var_1_30 ? (var_1_1 == ((double) (min ((var_1_3 - var_1_4) , var_1_5)))) : ((var_1_30 && var_1_56) ? (var_1_1 == ((double) (var_1_4 - var_1_3))) : 1)) && (var_1_8 == ((signed char) ((var_1_9 - var_1_10) + -2)))) && (var_1_56 ? (var_1_11 == ((unsigned short int) (var_1_12 - var_1_10))) : 1)) && (var_1_56 ? (var_1_13 == ((float) (((min (var_1_14 , var_1_15)) + var_1_16) - ((var_1_17 + 3.2738342843526195E18f) - (var_1_18 + var_1_19))))) : (var_1_13 == ((float) (min ((var_1_16 - (var_1_14 + var_1_19)) , (abs (var_1_18 - var_1_17)))))))) && ((var_1_30 && var_1_30) ? ((((var_1_9 / var_1_21) + var_1_10) < ((var_1_12 + var_1_47) - 128)) ? (var_1_20 == ((signed long int) (min ((var_1_47 - var_1_10) , var_1_9)))) : (((var_1_8 ^ var_1_47) > var_1_21) ? ((var_1_30 || (var_1_19 <= var_1_59)) ? (var_1_20 == ((signed long int) var_1_12)) : 1) : (var_1_36 ? (var_1_20 == ((signed long int) (max ((abs (var_1_10)) , var_1_12)))) : (var_1_20 == ((signed long int) (((abs (16)) + 256) - (max (0 , var_1_47)))))))) : 1)) && ((var_1_16 == var_1_3) ? (var_1_23 == ((unsigned char) ((var_1_56 && (var_1_24 || var_1_25)) || (var_1_26 || (var_1_30 && var_1_27))))) : (var_1_23 == ((unsigned char) var_1_28)))) && ((((abs (var_1_4)) - var_1_18) > var_1_19) ? ((var_1_57 >= var_1_15) ? (var_1_29 == ((signed short int) (last_1_var_1_29 + -128))) : ((var_1_16 <= var_1_58) ? (var_1_27 ? (var_1_29 == ((signed short int) ((var_1_9 + last_1_var_1_29) + 5))) : 1) : (var_1_29 == ((signed short int) var_1_21)))) : (var_1_29 == ((signed short int) last_1_var_1_29)))) && ((var_1_12 > last_1_var_1_53) ? ((var_1_25 && ((last_1_var_1_59 / var_1_17) < var_1_18)) ? (var_1_30 == ((unsigned char) (! (! var_1_26)))) : (var_1_30 == ((unsigned char) ((last_1_var_1_56 && (var_1_26 && var_1_27)) || var_1_25)))) : 1)) && (((var_1_8 == var_1_21) || (var_1_15 <= var_1_19)) ? (var_1_31 == ((unsigned long int) (var_1_32 - var_1_9))) : ((var_1_3 < var_1_15) ? (var_1_31 == ((unsigned long int) (var_1_12 + var_1_9))) : ((var_1_10 < var_1_34) ? (var_1_31 == ((unsigned long int) var_1_10)) : (var_1_31 == ((unsigned long int) var_1_9)))))) && ((var_1_50 <= var_1_32) ? (var_1_34 == ((signed short int) var_1_11)) : ((var_1_26 && var_1_23) ? (var_1_34 == ((signed short int) (abs (abs (max (var_1_21 , var_1_11)))))) : 1))) && (var_1_26 ? ((var_1_59 != var_1_15) ? (var_1_36 == ((unsigned char) ((var_1_18 > var_1_3) || var_1_28))) : (var_1_36 == ((unsigned char) var_1_28))) : (((var_1_18 - var_1_16) >= ((max (var_1_19 , var_1_14)) - var_1_3)) ? (var_1_36 == ((unsigned char) (! var_1_28))) : (var_1_36 == ((unsigned char) (! var_1_25)))))) && (var_1_37 == ((float) (var_1_3 - var_1_19)))) && (((max (var_1_31 , var_1_12)) == var_1_49) ? (var_1_38 == ((float) (max (var_1_3 , var_1_4)))) : 1)) && ((var_1_59 < ((var_1_40 - var_1_19) - var_1_17)) ? ((31.5 > ((abs (5.5)) + (- var_1_13))) ? ((var_1_36 && ((var_1_16 <= var_1_13) && var_1_36)) ? (var_1_39 == ((unsigned char) (var_1_10 + (abs (max (var_1_9 , var_1_42)))))) : (var_1_39 == ((unsigned char) (max ((max (4 , var_1_9)) , var_1_43))))) : ((-8 > ((var_1_10 + var_1_49) | var_1_50)) ? (var_1_39 == ((unsigned char) (min ((abs (var_1_10)) , var_1_43)))) : 1)) : ((var_1_59 <= ((- var_1_13) * var_1_3)) ? (var_1_39 == ((unsigned char) (((var_1_44 + var_1_45) - var_1_10) - (var_1_9 + var_1_46)))) : 1))) && (var_1_56 ? (var_1_47 == ((signed short int) ((var_1_48 - var_1_45) - var_1_43))) : 1)) && ((16 > var_1_42) ? (var_1_49 == ((unsigned short int) (min (var_1_10 , var_1_42)))) : 1)) && (((max ((var_1_42 + last_1_var_1_53) , var_1_44)) > (last_1_var_1_31 - var_1_48)) ? (var_1_50 == ((unsigned long int) ((min (var_1_32 , var_1_51)) - var_1_46))) : ((last_1_var_1_57 >= var_1_19) ? (var_1_50 == ((unsigned long int) (last_1_var_1_31 + var_1_42))) : 1))) && (var_1_56 ? (var_1_53 == ((signed long int) var_1_47)) : (((var_1_31 ^ (max (last_1_var_1_53 , last_1_var_1_53))) > 10000) ? (((var_1_44 % var_1_45) == var_1_47) ? ((var_1_1 != var_1_18) ? (var_1_53 == ((signed long int) (var_1_48 - var_1_9))) : (var_1_53 == ((signed long int) ((max ((max (var_1_47 , var_1_63)) , (var_1_29 + var_1_42))) + var_1_31)))) : 1) : (var_1_53 == ((signed long int) (min (((25 - var_1_49) + var_1_44) , (max (-5 , (var_1_31 + var_1_48)))))))))) && ((1 >= last_1_var_1_49) ? (var_1_56 == ((unsigned char) (! (last_1_var_1_23 && var_1_26)))) : (var_1_56 == ((unsigned char) ((last_1_var_1_62 < (max (var_1_42 , var_1_46))) && var_1_26))))) && ((var_1_58 <= ((var_1_15 + var_1_19) + var_1_17)) ? ((var_1_12 >= (abs (var_1_34))) ? ((var_1_17 < var_1_59) ? (var_1_57 == ((double) var_1_19)) : 1) : (var_1_57 == ((double) var_1_15))) : 1)) && (var_1_56 ? (var_1_58 == ((double) var_1_15)) : (var_1_58 == ((double) var_1_4)))) && ((((22760 + var_1_60) - var_1_46) >= var_1_50) ? (var_1_59 == ((float) var_1_4)) : 1)) && (var_1_61 == ((unsigned char) var_1_42))) && (var_1_62 == ((unsigned short int) var_1_46))) && (var_1_63 == ((signed long int) var_1_50))
;
}
int main(void) {
	isInitial = 1;
