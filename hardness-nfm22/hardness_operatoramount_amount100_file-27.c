...
void step(void) {
	// From: Req2Batch27Amount100
	var_1_7 = (max (var_1_3 , var_1_4));


	// From: Req3Batch27Amount100
	...
	// From: Req4Batch27Amount100
	var_1_9 = var_1_6;


	// From: Req8Batch27Amount100
	...
	// From: Req9Batch27Amount100
	var_1_24 = (var_1_16 + var_1_3);


	// From: Req11Batch27Amount100
	if (var_1_8 != (var_1_11 + var_1_5)) {
		var_1_27 = var_1_15;
	}


	// From: Req14Batch27Amount100
	var_1_31 = 0;


	// From: Req15Batch27Amount100
	var_1_32 = var_1_17;


	// From: Req1Batch27Amount100
	if (! (! var_1_31)) {
