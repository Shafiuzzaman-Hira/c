...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch30PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject4
	if ((var_1_26 <= (var_1_25 | var_1_19)) || var_1_28) {
		var_1_27 = var_1_29;
	}
	...
	// From: CodeObject5
	if (var_1_28) {
		var_1_30 = (max (2 , ((var_1_31 + var_1_32) + (min (var_1_33 , var_1_34)))));
	} else {
		var_1_30 = (max ((var_1_35 - var_1_34) , var_1_31));
	}
