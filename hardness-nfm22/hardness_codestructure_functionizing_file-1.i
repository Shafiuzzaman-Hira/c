...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch1functionizing.c", 13, "reach_error"); }
void __VERIFIER_assert(int cond) { if(!(cond)) { ERROR: {reach_error();abort();} } return; }
void assume_abort_if_not(int cond) { if(!cond) { abort(); } }
unsigned long int functionized0();
...
unsigned long int functionized4(unsigned long int functionized4_localFunctionVar0, unsigned long int functionized4_localFunctionVar1) {
 return ((((functionized4_localFunctionVar1) < (functionized4_localFunctionVar0)) ? (functionized4_localFunctionVar1) : (functionized4_localFunctionVar0)));
}
signed long int functionized5(signed char functionized5_localFunctionVar0) {
 return (((((var_1_19) > ((var_1_20 - functionized5_localFunctionVar0))) ? (var_1_19) : ((var_1_20 - functionized5_localFunctionVar0)))) + (((((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22))) < 0 ) ? -((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22))) : ((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22))))));
}
