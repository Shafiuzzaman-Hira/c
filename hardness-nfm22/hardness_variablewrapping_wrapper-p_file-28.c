...
void step(void) {
	...
	// From: Req3Batch28Wrapper_P
	(*(var_1_11_Pointer)) = (max ((*(var_1_9_Pointer)) , (*(var_1_10_Pointer))));


	// From: Req5Batch28Wrapper_P
	(*(var_1_18_Pointer)) = (*(var_1_5_Pointer));


	// From: Req6Batch28Wrapper_P
	(*(var_1_19_Pointer)) = (*(var_1_6_Pointer));


	// From: Req1Batch28Wrapper_P
	if (((*(var_1_2_Pointer)) - (*(var_1_3_Pointer))) <= (- (*(var_1_8_Pointer)))) {
		(*(var_1_1_Pointer)) = (min (((*(var_1_5_Pointer)) - (*(var_1_6_Pointer))) , (*(var_1_7_Pointer))));
	} else {
		(*(var_1_1_Pointer)) = (*(var_1_5_Pointer));
	}


	// From: Req4Batch28Wrapper_P
	signed long int stepLocal_1 = (*(var_1_6_Pointer)) | 5;
	if (stepLocal_1 <= (max ((*(var_1_5_Pointer)) , (*(var_1_7_Pointer))))) {
		(*(var_1_12_Pointer)) = ((min ((*(var_1_6_Pointer)) , ((*(var_1_13_Pointer)) - (*(var_1_19_Pointer))))) - ((*(var_1_15_Pointer)) - (abs ((*(var_1_5_Pointer))))));
	} else {
		(*(var_1_12_Pointer)) = ((*(var_1_6_Pointer)) + ((min ((*(var_1_19_Pointer)) , (*(var_1_19_Pointer)))) - (*(var_1_19_Pointer))));
	}
}
...
int property() {
	return ((((((((*(var_1_2_Pointer)) - (*(var_1_3_Pointer))) <= (- (*(var_1_8_Pointer)))) ? ((*(var_1_1_Pointer)) == ((signed char) (min (((*(var_1_5_Pointer)) - (*(var_1_6_Pointer))) , (*(var_1_7_Pointer)))))) : ((*(var_1_1_Pointer)) == ((signed char) (*(var_1_5_Pointer))))) && ((-4 < (*(var_1_6_Pointer))) ? ((*(var_1_8_Pointer)) == ((float) (min ((*(var_1_9_Pointer)) , (*(var_1_10_Pointer)))))) : 1)) && ((*(var_1_11_Pointer)) == ((float) (max ((*(var_1_9_Pointer)) , (*(var_1_10_Pointer))))))) && ((((*(var_1_6_Pointer)) | 5) <= (max ((*(var_1_5_Pointer)) , (*(var_1_7_Pointer))))) ? ((*(var_1_12_Pointer)) == ((signed long int) ((min ((*(var_1_6_Pointer)) , ((*(var_1_13_Pointer)) - (*(var_1_19_Pointer))))) - ((*(var_1_15_Pointer)) - (abs ((*(var_1_5_Pointer)))))))) : ((*(var_1_12_Pointer)) == ((signed long int) ((*(var_1_6_Pointer)) + ((min ((*(var_1_19_Pointer)) , (*(var_1_19_Pointer)))) - (*(var_1_19_Pointer)))))))) && ((*(var_1_18_Pointer)) == ((signed short int) (*(var_1_5_Pointer))))) && ((*(var_1_19_Pointer)) == ((unsigned short int) (*(var_1_6_Pointer))))
;
}
int main(void) {
	isInitial = 1;
