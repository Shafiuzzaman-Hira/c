...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch74Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (((((var_1_7) < (var_1_13)) ? (var_1_7) : (var_1_13))) <= var_1_11) {
  if (var_1_8) {
   if (var_1_9 || var_1_10) {
    if (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))) > var_1_13) {
     var_1_34 = var_1_7;
    }
   }
  }
 } else {
  if (((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13))) > var_1_11) {
   if (var_1_21 > 49.75f) {
    var_1_34 = (((((((((((var_1_5) < (var_1_11)) ? (var_1_5) : (var_1_11)))) < (-25)) ? (((((var_1_5) < (var_1_11)) ? (var_1_5) : (var_1_11)))) : (-25))) < 0 ) ? -((((((((var_1_5) < (var_1_11)) ? (var_1_5) : (var_1_11)))) < (-25)) ? (((((var_1_5) < (var_1_11)) ? (var_1_5) : (var_1_11)))) : (-25))) : ((((((((var_1_5) < (var_1_11)) ? (var_1_5) : (var_1_11)))) < (-25)) ? (((((var_1_5) < (var_1_11)) ? (var_1_5) : (var_1_11)))) : (-25)))));
   }
  } else {
   var_1_34 = var_1_7;
  }
 ...
 if ((~ (5 + var_1_12)) >= 10000u) {
  var_1_29 = (((((var_1_1 + var_1_12)) > (((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12))))) ? ((var_1_1 + var_1_12)) : (((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12))))));
 } else {
  var_1_29 = ((((((((((var_1_1) > (var_1_12)) ? (var_1_1) : (var_1_12))) < 0 ) ? -((((var_1_1) > (var_1_12)) ? (var_1_1) : (var_1_12))) : ((((var_1_1) > (var_1_12)) ? (var_1_1) : (var_1_12))))) < 0 ) ? -(((((((var_1_1) > (var_1_12)) ? (var_1_1) : (var_1_12))) < 0 ) ? -((((var_1_1) > (var_1_12)) ? (var_1_1) : (var_1_12))) : ((((var_1_1) > (var_1_12)) ? (var_1_1) : (var_1_12))))) : (((((((var_1_1) > (var_1_12)) ? (var_1_1) : (var_1_12))) < 0 ) ? -((((var_1_1) > (var_1_12)) ? (var_1_1) : (var_1_12))) : ((((var_1_1) > (var_1_12)) ? (var_1_1) : (var_1_12)))))));
 }
 if (var_1_11 <= ((((var_1_12) < ((var_1_12 | -5))) ? (var_1_12) : ((var_1_12 | -5))))) {
  if (var_1_10) {
   var_1_32 = var_1_12;
  }
 }
