...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_5_Pointer)) || stepLocal_0) {
		(*(WrapperStruct00_var_1_6_Pointer)) = (max ((*(WrapperStruct00_var_1_16_Pointer)) , (*(WrapperStruct00_var_1_16_Pointer))));
	} else {
	...
	if (stepLocal_1 != (abs ((*(WrapperStruct00_var_1_10_Pointer))))) {
