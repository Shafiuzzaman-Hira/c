...
void functionized1(signed long int functionized1_localFunctionVar0, unsigned short int functionized1_localFunctionVar1, signed long int functionized1_localFunctionVar2) {
 if (functionized1_localFunctionVar0 < functionized1_localFunctionVar2) {
  var_1_13 = (var_1_14 + (((((functionized1_localFunctionVar1) > (var_1_16)) ? (functionized1_localFunctionVar1) : (var_1_16))) - (var_1_17 + var_1_18)));
 }
}
...
signed long int functionized5(unsigned char functionized5_localFunctionVar0, unsigned char functionized5_localFunctionVar1, unsigned char functionized5_localFunctionVar2) {
 return ((((((((functionized5_localFunctionVar0) < (functionized5_localFunctionVar1)) ? (functionized5_localFunctionVar0) : (functionized5_localFunctionVar1)))) > (functionized5_localFunctionVar2)) ? (((((functionized5_localFunctionVar0) < (functionized5_localFunctionVar1)) ? (functionized5_localFunctionVar0) : (functionized5_localFunctionVar1)))) : (functionized5_localFunctionVar2)));
}
void initially(void) {
}
void step(void) {
...
int property() {
 return (((((((var_1_2 == (var_1_3 % var_1_4)) ? (var_1_1 == ((float) (var_1_5 - var_1_6))) : 1) && ((var_1_1 >= var_1_6) ? (var_1_7 == ((signed long int) var_1_8)) : 1)) && ((((var_1_6 * var_1_5) / var_1_10) > var_1_1) ? (var_1_11 ? (var_1_9 == ((unsigned long int) var_1_12)) : (var_1_9 == ((unsigned long int) var_1_12))) : 1)) && ((var_1_2 < var_1_3) ? (var_1_13 == ((unsigned short int) (var_1_14 + (((((var_1_15) > (var_1_16)) ? (var_1_15) : (var_1_16))) - (var_1_17 + var_1_18))))) : 1)) && ((var_1_10 == var_1_1) ? (var_1_11 ? (var_1_19 == ((unsigned char) (((32 + var_1_20) + var_1_21) - (var_1_22 + var_1_23)))) : (var_1_19 == ((unsigned char) (var_1_24 - var_1_23)))) : (var_1_19 == ((unsigned char) var_1_24)))) && (((25.3 * var_1_5) != var_1_1) ? (var_1_11 ? ((var_1_15 <= var_1_12) ? (var_1_25 == ((signed long int) var_1_14)) : 1) : (var_1_25 == ((signed long int) var_1_22))) : (var_1_25 == ((signed long int) var_1_20)))) && ((var_1_25 < (var_1_21 / var_1_20)) ? ((var_1_25 > var_1_18) ? (var_1_26 == ((unsigned char) ((((((((var_1_22) < (var_1_24)) ? (var_1_22) : (var_1_24)))) > (var_1_23)) ? (((((var_1_22) < (var_1_24)) ? (var_1_22) : (var_1_24)))) : (var_1_23))))) : (var_1_26 == ((unsigned char) var_1_22))) : 1)
;
}
int main(void) {
 isInitial = 1;
