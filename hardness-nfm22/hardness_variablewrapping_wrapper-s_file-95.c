...
void step(void) {
	// From: Req1Batch95Wrapper_S
	WrapperStruct00.var_1_1 = (abs (last_1_WrapperStruct00_var_1_7));


	// From: Req2Batch95Wrapper_S
	WrapperStruct00.var_1_3 = ((WrapperStruct00.var_1_4 - WrapperStruct00.var_1_5) + (min (256.5f , (WrapperStruct00.var_1_6 - 16.125f))));


	// From: Req5Batch95Wrapper_S
	WrapperStruct00.var_1_16 = WrapperStruct00.var_1_17;


	// From: Req3Batch95Wrapper_S
	...
	if ((- (3351680781u - WrapperStruct00.var_1_8)) > stepLocal_0) {
		WrapperStruct00.var_1_7 = ((min (WrapperStruct00.var_1_10 , (abs (WrapperStruct00.var_1_11)))) + WrapperStruct00.var_1_12);
	}


	// From: Req4Batch95Wrapper_S
	if ((WrapperStruct00.var_1_16 / WrapperStruct00.var_1_14) < (WrapperStruct00.var_1_7 >> WrapperStruct00.var_1_7)) {
		WrapperStruct00.var_1_13 = (abs (4 - WrapperStruct00.var_1_11));
	} else {
...
int property() {
	return ((((WrapperStruct00.var_1_1 == ((signed long int) (abs (last_1_WrapperStruct00_var_1_7)))) && (WrapperStruct00.var_1_3 == ((float) ((WrapperStruct00.var_1_4 - WrapperStruct00.var_1_5) + (min (256.5f , (WrapperStruct00.var_1_6 - 16.125f))))))) && (((- (3351680781u - WrapperStruct00.var_1_8)) > (WrapperStruct00.var_1_16 & WrapperStruct00.var_1_1)) ? (WrapperStruct00.var_1_7 == ((unsigned char) ((min (WrapperStruct00.var_1_10 , (abs (WrapperStruct00.var_1_11)))) + WrapperStruct00.var_1_12))) : 1)) && (((WrapperStruct00.var_1_16 / WrapperStruct00.var_1_14) < (WrapperStruct00.var_1_7 >> WrapperStruct00.var_1_7)) ? (WrapperStruct00.var_1_13 == ((signed short int) (abs (4 - WrapperStruct00.var_1_11)))) : ((WrapperStruct00.var_1_16 >= WrapperStruct00.var_1_1) ? (WrapperStruct00.var_1_13 == ((signed short int) (-5 + (WrapperStruct00.var_1_12 - WrapperStruct00.var_1_11)))) : (WrapperStruct00.var_1_13 == ((signed short int) 256))))) && (WrapperStruct00.var_1_16 == ((signed char) WrapperStruct00.var_1_17))
;
}
int main(void) {
	isInitial = 1;
