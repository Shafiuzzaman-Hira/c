...
void step(void) {
	...
	if ((var_1_34 * var_1_27) <= (abs (max (2 , var_1_30)))) {
		...
		if ((var_1_27 & 64u) == (var_1_33 | (var_1_39 % var_1_40))) {
			var_1_38 = ((abs (abs (var_1_36))) - var_1_35);
		} else {
			var_1_38 = (max (var_1_36 , (abs (var_1_35))));
		}
	}
	...
	if (var_1_28 || var_1_42) {
		if (((abs (var_1_34)) >> 5) > var_1_27) {
			var_1_41 = (max (var_1_43 , (max ((abs (var_1_44)) , var_1_45))));
		}
	} else {
		var_1_41 = var_1_45;
	}
			...
			if (var_1_40 <= 8u) {
				if (var_1_49 < var_1_41) {
					if (var_1_28 || (var_1_49 < var_1_45)) {
						var_1_46 = (min (var_1_50 , var_1_51));
					}
				}
			} else {
				var_1_46 = (max (var_1_50 , (min (var_1_51 , var_1_52))));
			}
		}
	}
	...
	if (var_1_42 && var_1_28) {
		...
		if (var_1_32 > ((var_1_47 - var_1_35) + var_1_38)) {
			if ((4 - var_1_54) <= -64) {
				var_1_53 = (max ((var_1_54 + var_1_51) , (min ((var_1_55 - var_1_46) , var_1_52))));
			}
		}
	}
	...
	if (var_1_33 == (abs (var_1_50))) {
		var_1_56 = ((abs (256)) + (min (var_1_54 , var_1_57)));
	}


	// From: Req1Batch39PS_CN_100
	...
	// From: Req7Batch39PS_CN_100
	var_1_24 = var_1_25;


	// From: Req8Batch39PS_CN_100
	var_1_26 = var_1_8;


	// From: Req3Batch39PS_CN_100
	var_1_10 = (min ((abs (var_1_11 - var_1_8)) , (max (0u , var_1_26))));


	// From: Req4Batch39PS_CN_100
