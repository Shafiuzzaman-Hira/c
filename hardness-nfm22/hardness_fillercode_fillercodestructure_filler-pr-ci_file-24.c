...
void step(void) {
	...
	// From: CodeObject7
	if ((var_1_18 / var_1_45) > (abs (var_1_36))) {
		var_1_44 = (min (var_1_45 , (abs (abs (var_1_16)))));
	} else {
		var_1_44 = var_1_16;
	}


	// From: Req6Batch24Filler_PR_CI
	var_1_23 = var_1_24;
	...
	if (! var_1_30) {
		...
		var_1_39 = (var_1_18 + (max (var_1_36 , (var_1_8 + var_1_8))));
	}
	...
	// From: CodeObject2
	if (var_1_17 > (max ((16u | var_1_16) , var_1_20))) {
		if (var_1_29) {
			var_1_31 = var_1_19;
		}
	}
	...
	if ((var_1_18 & -10) < var_1_16) {
		if ((~ (min (var_1_18 , var_1_16))) > var_1_20) {
			if ((min (var_1_16 , (var_1_18 * var_1_16))) < (var_1_16 ^ var_1_20)) {
				if (var_1_30) {
					var_1_35 = var_1_36;
				}
			}
