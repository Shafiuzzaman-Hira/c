...
void step(void) {
 if ((last_1_signed_char_Array_0_1_ % ((((signed_short_int_Array_0[2]) > (signed_short_int_Array_0[1])) ? (signed_short_int_Array_0[2]) : (signed_short_int_Array_0[1])))) <= -1000000) {
 ...
 if (float_Array_0[0] < (float_Array_0[2] / float_Array_0[1])) {
  if (BOOL_unsigned_char_Array_0[2] || stepLocal_0) {
   signed_char_Array_0[1] = ((((((signed_char_Array_0[3]) > (5)) ? (signed_char_Array_0[3]) : (5))) + (signed_char_Array_0[0] - signed_char_Array_0[2])) - signed_char_Array_0[4]);
  } else {
