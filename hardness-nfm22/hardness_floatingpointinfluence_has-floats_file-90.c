...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch90has_floats.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch90has_floats
	unsigned long int stepLocal_1 = var_1_7 - var_1_8;
	signed long int stepLocal_0 = min (var_1_3 , var_1_5);
	...
	// From: Req4Batch90has_floats
	var_1_14 = (max (var_1_3 , (var_1_15 - 256)));


	// From: Req1Batch90has_floats
	if (var_1_10) {
