...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch8525_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch8525_1loop
	if (var_1_2) {
		var_1_1 = (min ((var_1_7 + var_1_7) , -16));
	} else {
		if (var_1_5) {
			var_1_1 = (var_1_7 + -4);
		} else {
...
int property() {
	return ((var_1_2 ? (var_1_1 == ((signed long int) (min ((var_1_7 + var_1_7) , -16)))) : (var_1_5 ? (var_1_1 == ((signed long int) (var_1_7 + -4))) : (var_1_6 ? (var_1_1 == ((signed long int) var_1_7)) : (var_1_1 == ((signed long int) var_1_7))))) && (var_1_6 ? ((var_1_3 <= var_1_4) ? (var_1_7 == ((signed char) (max (var_1_8 , var_1_9)))) : 1) : 1)) && ((! var_1_6) ? (var_1_10 == ((double) (min (var_1_11 , var_1_12)))) : (((var_1_7 | var_1_1) <= var_1_9) ? ((var_1_5 && var_1_6) ? (var_1_10 == ((double) var_1_12)) : (var_1_10 == ((double) 5.5))) : 1))
;
}
int main(void) {
	isInitial = 1;
