...
void step(void) {
	...
	// From: Req2Batch16normal
	if (var_1_2 < var_1_6) {
		var_1_7 = (var_1_6 + var_1_8);
	}


	// From: Req3Batch16normal
	if (var_1_6 > 128) {
		var_1_9 = (var_1_8 - (var_1_10 - var_1_7));
	}


	// From: Req4Batch16normal
