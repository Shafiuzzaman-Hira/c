...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch1925_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch1925_1loop
	var_1_11 = (var_1_12 + (var_1_13 + var_1_14));


	// From: Req5Batch1925_1loop
	var_1_16 = 64;


	// From: Req4Batch1925_1loop
	if (var_1_9) {
		var_1_15 = (var_1_7 + var_1_16);
	}


	// From: Req1Batch1925_1loop
