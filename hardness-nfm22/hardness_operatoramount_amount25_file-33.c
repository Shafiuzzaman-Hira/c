...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch33Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch33Amount25
	var_1_16 = var_1_17;


	// From: Req6Batch33Amount25
	var_1_18 = var_1_8;


	// From: Req3Batch33Amount25
	...
	// From: Req2Batch33Amount25
	if (var_1_18 == var_1_18) {
		var_1_7 = var_1_8;
	}


	// From: Req4Batch33Amount25
