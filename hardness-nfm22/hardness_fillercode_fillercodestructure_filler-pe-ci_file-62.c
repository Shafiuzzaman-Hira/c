...
void step(void) {
	...
	// From: Req6Batch62Filler_PE_CI
	if (var_1_10 || var_1_20) {
		var_1_19 = (max (var_1_21 , 32));
	}


	// From: Req7Batch62Filler_PE_CI
	if (var_1_10) {
