...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch44dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch44dependencies
	if (256 > var_1_18) {
		var_1_19 = (max ((abs (var_1_20)) , var_1_21));
	}


	// From: Req8Batch44dependencies
	var_1_31 = var_1_26;


	// From: Req9Batch44dependencies
	var_1_32 = var_1_21;


	// From: Req7Batch44dependencies
	var_1_30 = (max (var_1_15 , var_1_32));


	// From: Req3Batch44dependencies
	...
	// From: Req5Batch44dependencies
	if ((var_1_23 - var_1_24) > var_1_14) {
		var_1_22 = (var_1_25 - var_1_26);
	}


	// From: Req1Batch44dependencies
	if (var_1_8 == ((var_1_32 + var_1_19) ^ (var_1_30 + var_1_32))) {
		var_1_1 = var_1_8;
	}


	// From: Req6Batch44dependencies
	if (! var_1_5) {
