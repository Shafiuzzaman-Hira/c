...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch2950_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch2950_while
	var_1_8 = (var_1_9 - (2 + var_1_10));


	// From: Req6Batch2950_while
	...
	// From: Req7Batch2950_while
	if (! ((var_1_9 - var_1_22) > var_1_12)) {
		var_1_27 = var_1_15;
	}


	// From: Req4Batch2950_while
