...
void step(void) {
	// From: Req1Batch99Wrapper_SP
	signed long int stepLocal_0 = abs (8);
	if (((min (200 , 128)) - (*(WrapperStruct00_var_1_2_Pointer))) > stepLocal_0) {
		(*(WrapperStruct00_var_1_1_Pointer)) = ((min ((*(WrapperStruct00_var_1_4_Pointer)) , (*(WrapperStruct00_var_1_5_Pointer)))) - (*(WrapperStruct00_var_1_6_Pointer)));
	} else {
		if ((*(WrapperStruct00_var_1_7_Pointer))) {
			(*(WrapperStruct00_var_1_1_Pointer)) = ((min ((*(WrapperStruct00_var_1_8_Pointer)) , (*(WrapperStruct00_var_1_9_Pointer)))) + (*(WrapperStruct00_var_1_10_Pointer)));
		}
	}


	// From: Req2Batch99Wrapper_SP
	if (((*(WrapperStruct00_var_1_5_Pointer)) + (*(WrapperStruct00_var_1_6_Pointer))) == (*(WrapperStruct00_var_1_1_Pointer))) {
		(*(WrapperStruct00_var_1_11_Pointer)) = ((min ((*(WrapperStruct00_var_1_2_Pointer)) , (*(WrapperStruct00_var_1_12_Pointer)))) - (*(WrapperStruct00_var_1_13_Pointer)));
	} else {
		(*(WrapperStruct00_var_1_11_Pointer)) = (*(WrapperStruct00_var_1_13_Pointer));
	}


	// From: Req3Batch99Wrapper_SP
	...
	if ((*(WrapperStruct00_var_1_9_Pointer)) == (*(WrapperStruct00_var_1_4_Pointer))) {
		...
		if (stepLocal_1 != (*(WrapperStruct00_var_1_13_Pointer))) {
			(*(WrapperStruct00_var_1_14_Pointer)) = (max ((((*(WrapperStruct00_var_1_15_Pointer)) + (*(WrapperStruct00_var_1_2_Pointer))) + (*(WrapperStruct00_var_1_16_Pointer))) , (*(WrapperStruct00_var_1_13_Pointer))));
		} else {
