...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch97dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch97dependencies
	var_1_20 = var_1_8;


	// From: Req8Batch97dependencies
	var_1_22 = var_1_23;
	...
	if (256 > (var_1_15 - (last_1_var_1_5 + var_1_8))) {
		var_1_5 = last_1_var_1_5;
	} else {
		if (var_1_22 || var_1_22) {
			if (((32 * -25) | last_1_var_1_5) >= var_1_15) {
				var_1_5 = var_1_8;
			}
		} else {
			var_1_5 = -10000;
