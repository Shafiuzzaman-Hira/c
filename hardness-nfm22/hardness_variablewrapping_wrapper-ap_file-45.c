...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch45Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) + (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))) / (*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer))) != last_1_unsigned_char_Array_0_1_) {
	...
	if (((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) / 32) < (min (((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) + (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer))) , (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer))))) {
