...
void step(void) {
	// From: Req2Batch26Wrapper_S
	WrapperStruct00.var_1_12 = ((0.85f - WrapperStruct00.var_1_13) + WrapperStruct00.var_1_14);


	// From: Req3Batch26Wrapper_S
	if ((- last_1_WrapperStruct00_var_1_15) >= (WrapperStruct00.var_1_4 / (abs (-4)))) {
		WrapperStruct00.var_1_15 = WrapperStruct00.var_1_16;
	}


	// From: Req5Batch26Wrapper_S
	WrapperStruct00.var_1_20 = WrapperStruct00.var_1_13;


	// From: Req1Batch26Wrapper_S
	if (WrapperStruct00.var_1_20 > WrapperStruct00.var_1_20) {
		WrapperStruct00.var_1_1 = (max (WrapperStruct00.var_1_15 , WrapperStruct00.var_1_15));
	} else {
		WrapperStruct00.var_1_1 = (min ((WrapperStruct00.var_1_15 - (max (WrapperStruct00.var_1_15 , WrapperStruct00.var_1_15))) , (WrapperStruct00.var_1_15 + (min (WrapperStruct00.var_1_15 , WrapperStruct00.var_1_15)))));
	}


	// From: Req4Batch26Wrapper_S
	...
	if (stepLocal_0 != (WrapperStruct00.var_1_15 * (WrapperStruct00.var_1_1 / WrapperStruct00.var_1_19))) {
		WrapperStruct00.var_1_17 = ((min (10u , (WrapperStruct00.var_1_1 + WrapperStruct00.var_1_15))) + WrapperStruct00.var_1_15);
	}
}
