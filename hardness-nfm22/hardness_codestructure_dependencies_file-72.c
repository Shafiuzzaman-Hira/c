...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch72dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req5Batch72dependencies
	if ((last_1_var_1_29 + last_1_var_1_29) > last_1_var_1_26) {
		var_1_23 = var_1_25;
	}


	// From: Req2Batch72dependencies
	...
	// From: Req3Batch72dependencies
	var_1_17 = (var_1_18 && var_1_19);


	// From: Req4Batch72dependencies
	if (! var_1_18) {
		var_1_20 = (max (var_1_21 , var_1_22));
	}


	// From: Req6Batch72dependencies
	if (256 >= var_1_10) {
	...
	// From: Req8Batch72dependencies
	var_1_31 = var_1_26;


	// From: Req1Batch72dependencies
	if ((min (var_1_20 , 63.5)) > (2.4 * var_1_20)) {
		if ((var_1_23 * var_1_26) <= (~ var_1_26)) {
