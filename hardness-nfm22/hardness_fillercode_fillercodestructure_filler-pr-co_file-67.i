...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch67Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_3) {
  if (((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16))) > ((-10 + var_1_16) & var_1_17)) {
   var_1_29 = (((((var_1_31 - 64u) < 0 ) ? -(var_1_31 - 64u) : (var_1_31 - 64u))) - var_1_17);
  } else {
   var_1_29 = var_1_17;
  }
 }
 ...
 if (var_1_15 > (var_1_39 - var_1_40)) {
  if (var_1_17 <= var_1_17) {
   var_1_38 = (var_1_17 + ((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17))));
  } else {
   if (((((((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)))) > (var_1_1)) ? (((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)))) : (var_1_1))) != var_1_28) {
