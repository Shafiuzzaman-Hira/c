...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch42Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_31 < ((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24)))) {
  var_1_34 = ((((((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31)))) > (var_1_33)) ? (((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31)))) : (var_1_33)));
 }
 if (var_1_25) {
  var_1_35 = var_1_33;
 }
