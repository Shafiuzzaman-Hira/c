...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch19Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_35 = ((((var_1_28) > (((((8.9f) > ((var_1_27 - var_1_27))) ? (8.9f) : ((var_1_27 - var_1_27)))))) ? (var_1_28) : (((((8.9f) > ((var_1_27 - var_1_27))) ? (8.9f) : ((var_1_27 - var_1_27)))))));
 if ((- var_1_24) == (var_1_24 + var_1_24)) {
  var_1_15 = var_1_12;
 }
 var_1_30 = ((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28)));
 if ((~ var_1_3) < (var_1_3 * var_1_9)) {
  if (var_1_12) {
   var_1_39 = (((((var_1_28 - ((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28))))) < (((((var_1_27) < (var_1_26)) ? (var_1_27) : (var_1_26))))) ? ((var_1_28 - ((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28))))) : (((((var_1_27) < (var_1_26)) ? (var_1_27) : (var_1_26))))));
  } else {
   if ((var_1_3 | var_1_9) >= var_1_3) {
    var_1_39 = var_1_28;
   }
  }
 } else {
 ...
 if (var_1_10) {
  if (((~ var_1_3) ^ var_1_3) < ((var_1_9 | var_1_7) % ((((var_1_7) < (var_1_2)) ? (var_1_7) : (var_1_2))))) {
 ...
 if (var_1_27 >= ((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21)))) {
  var_1_47 = var_1_13;
 } else {
  if (2 >= (var_1_7 * ((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9))))) {
   var_1_47 = 0;
  } else {
   var_1_47 = var_1_49;
  }
