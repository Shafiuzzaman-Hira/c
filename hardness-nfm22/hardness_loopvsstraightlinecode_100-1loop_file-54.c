...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch54100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req5Batch54100_1loop
	if (last_1_var_1_30 == var_1_8) {
		if (((max (var_1_12 , var_1_10)) + last_1_var_1_29) > last_1_var_1_9) {
			var_1_22 = var_1_14;
		}
	} else {
	...
	// From: Req6Batch54100_1loop
	var_1_23 = (max ((var_1_24 - (max (var_1_25 , var_1_26))) , var_1_27));


	// From: Req7Batch54100_1loop
	if (var_1_22 >= (var_1_5 + var_1_17)) {
		var_1_28 = (var_1_15 + var_1_17);
	}


	// From: Req8Batch54100_1loop
	if (var_1_21) {
		var_1_29 = ((var_1_26 + var_1_25) - 2);
	}


	// From: Req3Batch54100_1loop
	if (var_1_29 > var_1_5) {
		var_1_9 = ((min (var_1_10 , (max (var_1_11 , var_1_12)))) - (var_1_29 + var_1_5));
	}


	// From: Req10Batch54100_1loop
	signed long int stepLocal_4 = max (var_1_37 , var_1_26);
	...
	// From: Req4Batch54100_1loop
	unsigned short int stepLocal_0 = var_1_5;
	if (((min (var_1_15 , var_1_16)) - var_1_17) != stepLocal_0) {
...
int property() {
	return (((((((((((! ((- 9.9999999999925E11) >= var_1_30)) ? ((var_1_30 >= var_1_30) ? ((var_1_30 < 7.5) ? (var_1_13 ? (var_1_1 == ((unsigned short int) var_1_5)) : (var_1_1 == ((unsigned short int) var_1_5))) : (var_1_1 == ((unsigned short int) var_1_5))) : (var_1_1 == ((unsigned short int) var_1_5))) : (var_1_1 == ((unsigned short int) var_1_5))) && ((var_1_13 || (! var_1_13)) ? (((127.375f < (- var_1_30)) && var_1_13) ? (var_1_6 == ((float) 1.0000000000000095E14f)) : 1) : (var_1_6 == ((float) var_1_8)))) && ((var_1_29 > var_1_5) ? (var_1_9 == ((unsigned long int) ((min (var_1_10 , (max (var_1_11 , var_1_12)))) - (var_1_29 + var_1_5)))) : 1)) && ((((min (var_1_15 , var_1_16)) - var_1_17) != var_1_5) ? (var_1_13 == ((unsigned char) (var_1_18 && (! var_1_19)))) : (var_1_38 ? (var_1_19 ? (var_1_13 == ((unsigned char) 1)) : 1) : (var_1_13 == ((unsigned char) var_1_21))))) && ((last_1_var_1_30 == var_1_8) ? ((((max (var_1_12 , var_1_10)) + last_1_var_1_29) > last_1_var_1_9) ? (var_1_22 == ((signed long int) var_1_14)) : 1) : (var_1_22 == ((signed long int) (last_1_var_1_29 - var_1_5))))) && (var_1_23 == ((signed char) (max ((var_1_24 - (max (var_1_25 , var_1_26))) , var_1_27))))) && ((var_1_22 >= (var_1_5 + var_1_17)) ? (var_1_28 == ((signed short int) (var_1_15 + var_1_17))) : 1)) && (var_1_21 ? (var_1_29 == ((signed short int) ((var_1_26 + var_1_25) - 2))) : 1)) && (var_1_38 ? ((var_1_22 > var_1_27) ? (var_1_30 == ((float) ((min ((max (var_1_31 , var_1_32)) , var_1_33)) + (var_1_34 - var_1_35)))) : (var_1_30 == ((float) (var_1_31 + var_1_36)))) : (((var_1_37 - (var_1_17 + var_1_26)) < var_1_25) ? (var_1_30 == ((float) var_1_36)) : (var_1_30 == ((float) var_1_8))))) && (((var_1_12 + 8) <= (max (var_1_37 , var_1_26))) ? ((((var_1_5 * var_1_14) << (var_1_39 + var_1_40)) >= (var_1_9 ^ (~ var_1_17))) ? (var_1_38 == ((unsigned char) var_1_19)) : 1) : (var_1_38 == ((unsigned char) var_1_21)))) && (var_1_13 ? (var_1_21 ? (var_1_41 == ((unsigned short int) ((var_1_25 + (var_1_17 + 200)) + var_1_40))) : (var_1_41 == ((unsigned short int) (var_1_25 + var_1_17)))) : (var_1_41 == ((unsigned short int) var_1_26)))
;
}
int main(void) {
	isInitial = 1;
