...
void step(void) {
 ...
 if ((((((*(var_1_12_Pointer))) > (1)) ? ((*(var_1_12_Pointer))) : (1))) <= (256 + last_1_var_1_1)) {
...
int property() {
 return ((((((((*(var_1_12_Pointer))) > (1)) ? ((*(var_1_12_Pointer))) : (1))) <= (256 + last_1_var_1_1)) ? ((*(var_1_1_Pointer)) == ((signed long int) ((((*(var_1_4_Pointer)) - 128) + (*(var_1_12_Pointer))) + (*(var_1_7_Pointer))))) : ((*(var_1_1_Pointer)) == ((signed long int) ((*(var_1_4_Pointer)) + (*(var_1_12_Pointer)))))) && ((last_1_var_1_12 > (last_1_var_1_7 * ((*(var_1_4_Pointer)) - (*(var_1_8_Pointer))))) ? (((*(var_1_8_Pointer)) > last_1_var_1_7) ? ((*(var_1_7_Pointer)) == ((signed char) (((*(var_1_9_Pointer)) + (*(var_1_10_Pointer))) + (*(var_1_11_Pointer))))) : ((*(var_1_7_Pointer)) == ((signed char) (*(var_1_10_Pointer))))) : ((*(var_1_7_Pointer)) == ((signed char) (*(var_1_11_Pointer)))))) && ((last_1_var_1_1 > ((((last_1_var_1_7) < 0 ) ? -(last_1_var_1_7) : (last_1_var_1_7)))) ? ((*(var_1_12_Pointer)) == ((signed short int) ((*(var_1_13_Pointer)) - (*(var_1_14_Pointer))))) : (((*(var_1_15_Pointer)) || (*(var_1_16_Pointer))) ? ((2 < last_1_var_1_7) ? ((*(var_1_12_Pointer)) == ((signed short int) last_1_var_1_7)) : 1) : 1))
;
}
int main(void) {
 isInitial = 1;
