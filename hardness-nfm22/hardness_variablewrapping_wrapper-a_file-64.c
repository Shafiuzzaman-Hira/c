...
void step(void) {
	...
	if (stepLocal_1 <= (unsigned_long_int_Array_0[1] - last_1_unsigned_char_Array_0_0_)) {
		if (stepLocal_0 < (max ((last_1_unsigned_char_Array_0_0_ / unsigned_long_int_Array_0[0]) , last_1_unsigned_char_Array_0_0_))) {
