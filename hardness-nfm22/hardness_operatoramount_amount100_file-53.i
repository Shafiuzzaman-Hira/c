...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch53Amount100.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_6 || (var_1_28 >= last_1_var_1_20)) {
  ...
  var_1_20 = (var_1_4 - (((((((last_1_var_1_20) > (var_1_3)) ? (last_1_var_1_20) : (var_1_3))) < 0 ) ? -((((last_1_var_1_20) > (var_1_3)) ? (last_1_var_1_20) : (var_1_3))) : ((((last_1_var_1_20) > (var_1_3)) ? (last_1_var_1_20) : (var_1_3))))));
 }
 unsigned char stepLocal_8 = var_1_28 > var_1_7;
 if (stepLocal_8 || var_1_14) {
  var_1_23 = (((((var_1_3 + (var_1_2 - var_1_28))) < (var_1_4)) ? ((var_1_3 + (var_1_2 - var_1_28))) : (var_1_4)));
 } else {
  var_1_23 = (var_1_2 - var_1_28);
 }
 var_1_19 = ((((((((var_1_3) < (var_1_4)) ? (var_1_3) : (var_1_4)))) < (var_1_28)) ? (((((var_1_3) < (var_1_4)) ? (var_1_3) : (var_1_4)))) : (var_1_28)));
 unsigned char stepLocal_7 = ((((var_1_23) > (var_1_19)) ? (var_1_23) : (var_1_19))) <= 0;
