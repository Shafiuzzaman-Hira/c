...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch54Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_26 >= var_1_36) {
  ...
  if (var_1_30 <= ((((var_1_42 * var_1_23) < 0 ) ? -(var_1_42 * var_1_23) : (var_1_42 * var_1_23)))) {
   var_1_40 = ((((((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24))) < 0 ) ? -((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24))) : ((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24))))) + ((((var_1_33) < 0 ) ? -(var_1_33) : (var_1_33))));
  }
 }
