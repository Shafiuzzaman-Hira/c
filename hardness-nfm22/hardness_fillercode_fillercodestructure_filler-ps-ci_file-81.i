...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch81Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_7 > (var_1_24 & (~ var_1_14))) {
  if (((var_1_39 + var_1_40) - ((((var_1_41) > (var_1_42)) ? (var_1_41) : (var_1_42)))) > (((((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))) < 0 ) ? -((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))) : ((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43)))))) {
   var_1_38 = ((((var_1_7) > (((((var_1_5) < (var_1_22)) ? (var_1_5) : (var_1_22))))) ? (var_1_7) : (((((var_1_5) < (var_1_22)) ? (var_1_5) : (var_1_22))))));
  }
 } else {
  var_1_38 = ((((var_1_5) > (((((var_1_7) < (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))))) ? (var_1_7) : (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))))))) ? (var_1_5) : (((((var_1_7) < (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))))) ? (var_1_7) : (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))))))));
 }
 if ((var_1_17 + var_1_12) > (var_1_24 ^ ((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22))))) {
  var_1_44 = (2u + ((((var_1_17) > (var_1_5)) ? (var_1_17) : (var_1_5))));
 }
