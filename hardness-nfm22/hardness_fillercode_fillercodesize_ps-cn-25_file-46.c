...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch46PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((- var_1_25) < var_1_23) {
		if ((abs (var_1_22)) < (8u / var_1_27)) {
			var_1_26 = (var_1_24 || var_1_28);
		} else {
			var_1_26 = var_1_29;
		}
	}
	...
	// From: CodeObject5
	if (var_1_22 >= 100u) {
		var_1_32 = (var_1_31 + var_1_30);
	}


	// From: CodeObject6
	if ((var_1_21 | var_1_31) <= (var_1_27 >> var_1_32)) {
		var_1_33 = (var_1_34 - (min (var_1_35 , 32)));
	} else {
		var_1_33 = 5;
	}


	// From: Req3Batch46PS_CN_25
	...
	// From: Req6Batch46PS_CN_25
	var_1_17 = var_1_18;


	// From: Req7Batch46PS_CN_25
	var_1_19 = 5;


	// From: Req8Batch46PS_CN_25
	var_1_20 = var_1_15;


	// From: Req4Batch46PS_CN_25
	if (var_1_1 < var_1_20) {
