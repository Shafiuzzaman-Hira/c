...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch17Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_1 > (var_1_1 >> var_1_5)) {
  if (var_1_8) {
   var_1_39 = ((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)));
  } else {
   var_1_39 = (((((256 - (var_1_40 - var_1_1))) > (var_1_1)) ? ((256 - (var_1_40 - var_1_1))) : (var_1_1)));
  }
 } else {
  var_1_39 = var_1_14;
 }
 ...
 if (128u <= var_1_1) {
  if ((var_1_11 >= var_1_21) && ((var_1_1 * var_1_14) < ((((var_1_1) < (var_1_1)) ? (var_1_1) : (var_1_1))))) {
   if (var_1_14 > var_1_1) {
    var_1_23 = ((((4) < 0 ) ? -(4) : (4)));
   } else {
    if (var_1_8) {
 ...
 if (var_1_5 >= var_1_1) {
  var_1_30 = (((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31))) - var_1_1);
 }
 if (var_1_31 > var_1_1) {
  var_1_35 = var_1_36;
 } else {
  if ((var_1_36 - ((((var_1_1) > (var_1_1)) ? (var_1_1) : (var_1_1)))) < ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)))) {
   if ((var_1_18 | var_1_14) < var_1_1) {
    var_1_35 = var_1_36;
   }
  }
 }
