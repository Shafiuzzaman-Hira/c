...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch72PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject4
	if (var_1_36 >= ((abs (var_1_38)) | var_1_32)) {
		var_1_37 = var_1_39;
	}
	...
	// From: Req8Batch72PS_CN_10
	var_1_31 = var_1_26;


	// From: Req7Batch72PS_CN_10
	var_1_29 = var_1_1;
}
