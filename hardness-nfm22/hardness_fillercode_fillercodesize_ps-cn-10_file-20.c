...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch20PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject5
	if ((var_1_23 ^ (var_1_21 % var_1_26)) <= var_1_24) {
		var_1_25 = var_1_27;
	}
	...
	// From: Req5Batch20PS_CN_10
	var_1_15 = (var_1_14 + var_1_16);


	// From: Req6Batch20PS_CN_10
	if (var_1_2) {
