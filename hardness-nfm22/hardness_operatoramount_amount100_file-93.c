...
void step(void) {
	...
	// From: Req6Batch93Amount100
	if (var_1_4) {
		var_1_21 = (! var_1_22);
	}


	// From: Req7Batch93Amount100
	if (! var_1_21) {
		var_1_23 = var_1_8;
	}


	// From: Req9Batch93Amount100
	...
	// From: Req10Batch93Amount100
	if (var_1_22) {
		var_1_33 = ((var_1_28 - var_1_32) + (var_1_31 - var_1_34));
	}


	// From: Req12Batch93Amount100
	var_1_37 = var_1_10;


	// From: Req3Batch93Amount100
	if ((- var_1_8) != var_1_23) {
