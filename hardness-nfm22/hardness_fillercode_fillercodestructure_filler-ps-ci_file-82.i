...
void step(void) {
 ...
 if (var_1_11) {
  if (((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4))) <= var_1_4) {
   if ((((((var_1_27 % var_1_17)) < (var_1_20)) ? ((var_1_27 % var_1_17)) : (var_1_20))) < (var_1_23 * (var_1_23 | var_1_18))) {
    if (((((var_1_4) > (var_1_4)) ? (var_1_4) : (var_1_4))) >= (var_1_5 * var_1_4)) {
     var_1_28 = var_1_4;
    }
   }
  } else {
 ...
 if ((var_1_5 * var_1_4) != var_1_4) {
  var_1_38 = (var_1_4 - ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4))));
 }
 if (var_1_13) {
  var_1_40 = ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4)));
 } else {
  var_1_40 = ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4)));
 }
 if (var_1_9 != ((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)))) {
