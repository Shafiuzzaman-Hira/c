...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch14Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_29 = var_1_30;
 if (var_1_4) {
  var_1_31 = ((((var_1_28) > (var_1_28)) ? (var_1_28) : (var_1_28)));
 } else {
  if (((((var_1_28) > (var_1_28)) ? (var_1_28) : (var_1_28))) > var_1_1) {
 ...
 if (! var_1_4) {
  var_1_42 = (((((((((var_1_28) > (var_1_40)) ? (var_1_28) : (var_1_40))) + (var_1_39 + var_1_1))) < (-128)) ? ((((((var_1_28) > (var_1_40)) ? (var_1_28) : (var_1_40))) + (var_1_39 + var_1_1))) : (-128)));
 }
