...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch95dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch95dependencies
	if ((var_1_6 - last_1_var_1_15) < ((last_1_var_1_11 ^ last_1_var_1_15) / (max (-8 , var_1_5)))) {
