...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch47Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (stepLocal_0 || (*(var_1_14_Pointer))) {
		if (! (*(var_1_14_Pointer))) {
			(*(var_1_12_Pointer)) = (abs (min ((*(var_1_9_Pointer)) , (*(var_1_9_Pointer)))));
		} else {
	...
	if ((*(var_1_15_Pointer)) <= (*(var_1_15_Pointer))) {
		if (((*(var_1_12_Pointer)) + (*(var_1_12_Pointer))) >= ((*(var_1_12_Pointer)) + (*(var_1_9_Pointer)))) {
			(*(var_1_1_Pointer)) = (abs ((*(var_1_8_Pointer))));
		}
	} else {
		if ((*(var_1_12_Pointer)) > (*(var_1_9_Pointer))) {
...
int property() {
	return (((((*(var_1_15_Pointer)) <= (*(var_1_15_Pointer))) ? ((((*(var_1_12_Pointer)) + (*(var_1_12_Pointer))) >= ((*(var_1_12_Pointer)) + (*(var_1_9_Pointer)))) ? ((*(var_1_1_Pointer)) == ((double) (abs ((*(var_1_8_Pointer)))))) : 1) : (((*(var_1_12_Pointer)) > (*(var_1_9_Pointer))) ? ((*(var_1_1_Pointer)) == ((double) (*(var_1_8_Pointer)))) : 1)) && ((-4 > last_1_var_1_12) ? (((~ last_1_var_1_12) <= last_1_var_1_12) ? ((*(var_1_9_Pointer)) == ((signed char) (abs ((*(var_1_10_Pointer)) + (*(var_1_11_Pointer)))))) : 1) : ((*(var_1_9_Pointer)) == ((signed char) (*(var_1_10_Pointer)))))) && (((! (*(var_1_13_Pointer))) || (*(var_1_14_Pointer))) ? ((! (*(var_1_14_Pointer))) ? ((*(var_1_12_Pointer)) == ((signed long int) (abs (min ((*(var_1_9_Pointer)) , (*(var_1_9_Pointer))))))) : ((*(var_1_12_Pointer)) == ((signed long int) (*(var_1_9_Pointer))))) : 1)) && ((*(var_1_15_Pointer)) == ((double) (*(var_1_8_Pointer))))
;
}
int main(void) {
	isInitial = 1;
