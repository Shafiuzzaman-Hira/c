...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch48has_floats.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_16) {
  if (last_1_var_1_7 != last_1_var_1_7) {
   ...
   var_1_7 = (var_1_11 - (((((var_1_14) > (var_1_15)) ? (var_1_14) : (var_1_15))) - var_1_12));
  }
 }
}
