...
void step(void) {
	...
	if (var_1_22) {
		if (var_1_17) {
			var_1_25 = (min (var_1_21 , (min ((abs (var_1_19)) , var_1_20))));
		}
	} else {
		if (var_1_20 >= (abs (~ 10u))) {
			var_1_25 = (abs (var_1_21));
		}
	}
	...
	if (var_1_19 > var_1_18) {
		if ((min ((var_1_16 & var_1_18) , var_1_25)) >= ((var_1_19 | var_1_20) ^ (var_1_27 - var_1_21))) {
			var_1_26 = var_1_28;
		}
	}
	...
	// From: CodeObject5
	if (-128 > (abs (var_1_21))) {
		var_1_29 = (max (((min (var_1_30 , 128)) - var_1_31) , var_1_32));
	}
	...
	// From: CodeObject7
	if (var_1_29 >= (min (var_1_21 , var_1_16))) {
	...
	if (var_1_34 >= (32 + var_1_18)) {
		var_1_35 = (max (var_1_31 , (var_1_36 + var_1_37)));
	} else {
		if (var_1_23) {
			var_1_35 = (max (var_1_31 , var_1_36));
		} else {
	...
	if (var_1_24) {
		...
		if (var_1_37 < (abs (var_1_18))) {
			if (var_1_20 > var_1_35) {
				var_1_38 = (var_1_32 + (var_1_37 - var_1_34));
			} else {
				var_1_38 = (min ((max ((var_1_34 - var_1_37) , var_1_39)) , var_1_33));
			}
		} else {
			var_1_38 = ((min (var_1_31 , var_1_40)) + 128);
		}
	}


	// From: CodeObject10
	if ((var_1_25 >> (abs (var_1_42))) <= var_1_29) {
