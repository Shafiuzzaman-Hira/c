...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch92PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject6
	if (((- var_1_23) > (var_1_28 | var_1_25)) && var_1_30) {
		var_1_29 = var_1_23;
	}


	// From: Req1Batch92PS_CN_10
	...
	// From: Req5Batch92PS_CN_10
	var_1_17 = (4 - (min (var_1_18 , (var_1_19 - 1))));


	// From: Req6Batch92PS_CN_10
