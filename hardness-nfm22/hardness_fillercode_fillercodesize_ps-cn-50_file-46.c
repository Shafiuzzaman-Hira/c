...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch46PS_CN_50.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_27 != (var_1_21 + var_1_28)) {
		var_1_29 = (max (var_1_28 , (min ((abs (var_1_27)) , var_1_30))));
	} else {
		var_1_29 = var_1_27;
	}
	...
	if ((-25 + (var_1_21 + var_1_29)) <= var_1_22) {
		if ((16 >> (abs (var_1_32))) > (var_1_29 >> var_1_21)) {
			var_1_31 = var_1_28;
		} else {
	...
	// From: Req6Batch46PS_CN_50
	var_1_17 = var_1_18;


	// From: Req7Batch46PS_CN_50
	var_1_19 = 5;


	// From: Req8Batch46PS_CN_50
	var_1_20 = var_1_15;


	// From: Req4Batch46PS_CN_50
	if (var_1_1 < var_1_20) {
