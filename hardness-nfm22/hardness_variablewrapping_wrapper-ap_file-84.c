...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch84Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch84Wrapper_AP
	(*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) = (*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer));


	// From: Req3Batch84Wrapper_AP
	if ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var6_Pointer)) < (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer))) {
		if (((- 8) / ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)) - (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer)))) >= (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var3_Pointer))) {
			(*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) = ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)) - ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)) - (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer))));
		}
	}
}
