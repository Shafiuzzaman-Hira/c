...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch8225_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch8225_while
	unsigned char stepLocal_1 = var_1_5;
	if (stepLocal_1 != var_1_5) {
		if (var_1_1 >= var_1_4) {
			var_1_10 = (((var_1_9 + var_1_5) + (abs (var_1_5))) - var_1_5);
		} else {
			if (var_1_2) {
				var_1_10 = var_1_5;
			} else {
...
int property() {
	return (((! var_1_2) ? (var_1_2 ? (var_1_1 == ((float) (max (var_1_3 , var_1_4)))) : 1) : 1) && (((last_1_var_1_10 / -2) >= (last_1_var_1_10 | last_1_var_1_10)) ? (var_1_5 == ((unsigned char) (abs (var_1_9)))) : (var_1_5 == ((unsigned char) var_1_9)))) && ((var_1_5 != var_1_5) ? ((var_1_1 >= var_1_4) ? (var_1_10 == ((signed long int) (((var_1_9 + var_1_5) + (abs (var_1_5))) - var_1_5))) : (var_1_2 ? (var_1_10 == ((signed long int) var_1_5)) : (var_1_10 == ((signed long int) var_1_5)))) : (var_1_10 == ((signed long int) var_1_9)))
;
}
int main(void) {
	isInitial = 1;
