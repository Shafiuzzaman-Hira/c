...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch23Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_23 < 256.5) {
  if ((((((var_1_17) > (var_1_14)) ? (var_1_17) : (var_1_14))) > var_1_17) && (var_1_23 < var_1_9)) {
   var_1_26 = ((((var_1_17) > (var_1_17)) ? (var_1_17) : (var_1_17)));
  } else {
   if ((var_1_17 < var_1_14) && var_1_1) {
    var_1_26 = var_1_17;
   } else {
 ...
 if ((((((var_1_23) > (var_1_10)) ? (var_1_23) : (var_1_10))) / var_1_9) > ((((var_1_8) < (var_1_10)) ? (var_1_8) : (var_1_10)))) {
  if ((-5 < var_1_17) && var_1_1) {
   if (var_1_14 >= var_1_39) {
    var_1_43 = ((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13)));
   } else {
    var_1_43 = var_1_17;
   }
  }
 ...
 if (var_1_20 < ((((var_1_40) > (var_1_17)) ? (var_1_40) : (var_1_17)))) {
  if (var_1_2 || (128.5 <= var_1_11)) {
   var_1_47 = (var_1_22 - var_1_39);
  }
 } else {
  var_1_47 = ((((((((var_1_17) > (var_1_39)) ? (var_1_17) : (var_1_39)))) > (var_1_20)) ? (((((var_1_17) > (var_1_39)) ? (var_1_17) : (var_1_39)))) : (var_1_20)));
 }
