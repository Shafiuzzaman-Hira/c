...
void step(void) {
 ...
 if (var_1_22) {
  var_1_40 = ((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9)));
 } else {
  var_1_40 = ((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9)));
 }
 if (var_1_7 != ((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))) {
  if (((((127.4) < 0 ) ? -(127.4) : (127.4))) < var_1_9) {
   if (var_1_22) {
    var_1_41 = var_1_23;
   }
  } else {
 ...
 if ((var_1_1 * var_1_8) != var_1_8) {
  var_1_38 = (var_1_4 - ((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8))));
 }
 var_1_10 = (var_1_11 && (var_1_21 || var_1_13));
 if (var_1_13) {
  if (((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4))) <= var_1_4) {
   if ((((((var_1_27 % var_1_17)) < (var_1_15)) ? ((var_1_27 % var_1_17)) : (var_1_15))) < (var_1_19 * (var_1_20 | var_1_17))) {
    if (((((var_1_4) > (var_1_4)) ? (var_1_4) : (var_1_4))) >= (var_1_8 * var_1_5)) {
     var_1_28 = var_1_4;
    }
   }
  } else {
 ...
 if (var_1_27 != var_1_17) {
  var_1_37 = (((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))) - ((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17))));
 } else {
  var_1_37 = (((((((var_1_17) > (var_1_27)) ? (var_1_17) : (var_1_27))) < 0 ) ? -((((var_1_17) > (var_1_27)) ? (var_1_17) : (var_1_27))) : ((((var_1_17) > (var_1_27)) ? (var_1_17) : (var_1_27)))));
 }
