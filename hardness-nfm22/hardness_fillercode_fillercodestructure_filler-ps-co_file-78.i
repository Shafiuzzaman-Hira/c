...
void step(void) {
 var_1_22 = var_1_23;
 if (((((var_1_6) < (var_1_23)) ? (var_1_6) : (var_1_23))) >= var_1_15) {
  var_1_24 = ((var_1_26 + var_1_27) - var_1_23);
 }
 if (var_1_27 > 0) {
  var_1_28 = (((((((((var_1_29 + var_1_30)) > (var_1_23)) ? ((var_1_29 + var_1_30)) : (var_1_23)))) < (0)) ? ((((((var_1_29 + var_1_30)) > (var_1_23)) ? ((var_1_29 + var_1_30)) : (var_1_23)))) : (0)));
 }
 if (var_1_26 != 10) {
  if (var_1_26 <= var_1_29) {
   var_1_31 = ((((var_1_30) > (var_1_23)) ? (var_1_30) : (var_1_23)));
  }
 }
 if (var_1_26 > 100) {
  if ((((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))) ^ var_1_26) > var_1_21) {
   var_1_32 = (! var_1_33);
  } else {
   var_1_32 = var_1_34;
  }
 }
 var_1_35 = ((((var_1_26) > (((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3))))) ? (var_1_26) : (((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3))))));
 if (var_1_29 > var_1_30) {
  if ((var_1_1 ^ var_1_27) != (var_1_20 / 32)) {
   var_1_36 = ((((((((-5) < 0 ) ? -(-5) : (-5))) < 0 ) ? -((((-5) < 0 ) ? -(-5) : (-5))) : ((((-5) < 0 ) ? -(-5) : (-5))))) - (((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30))) + (1000000000 - var_1_23)));
  } else {
   var_1_36 = ((((var_1_20) < 0 ) ? -(var_1_20) : (var_1_20)));
  }
 } else {
  if (var_1_16 >= var_1_6) {
   var_1_36 = 100000000;
