...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch24PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject3
	if (var_1_28 > ((abs (8)) * (max (var_1_27 , -128)))) {
		var_1_30 = var_1_31;
	}
	...
	if (var_1_31 > 256u) {
		if (var_1_29 >= var_1_28) {
			if ((-8 % var_1_35) <= var_1_27) {
				var_1_34 = (max (var_1_36 , var_1_37));
			}
		} else {
			var_1_34 = var_1_36;
		}
	...
	// From: Req6Batch24PS_CN_25
	var_1_23 = var_1_24;


	// From: Req3Batch24PS_CN_25
	if (128u >= var_1_8) {
		if (! var_1_23) {
