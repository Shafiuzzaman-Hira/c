...
void step(void) {
	...
	if (((*(var_1_2_Pointer)) - (*(var_1_3_Pointer))) >= (*(var_1_10_Pointer))) {
		if (stepLocal_0 >= ((*(var_1_13_Pointer)) / (*(var_1_8_Pointer)))) {
			(*(var_1_1_Pointer)) = (abs ((*(var_1_21_Pointer))));
		}
	} else {
		if ((*(var_1_9_Pointer))) {
			(*(var_1_1_Pointer)) = (max ((*(var_1_21_Pointer)) , (*(var_1_18_Pointer))));
		}
	}
}
