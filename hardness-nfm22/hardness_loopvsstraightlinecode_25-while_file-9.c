...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch925_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch925_while
	var_1_9 = 64;


	// From: Req4Batch925_while
	var_1_10 = var_1_11;


	// From: Req2Batch925_while
	if ((10 << var_1_9) < (var_1_3 * var_1_1)) {
		var_1_8 = (var_1_9 + var_1_1);
	}


	// From: Req5Batch925_while
