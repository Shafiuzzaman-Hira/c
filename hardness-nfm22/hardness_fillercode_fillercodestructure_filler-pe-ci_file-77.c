...
void step(void) {
	...
	// From: Req2Batch77Filler_PE_CI
	if ((- var_1_7) < (var_1_1 * var_1_4)) {
		var_1_8 = var_1_9;
	}


	// From: Req4Batch77Filler_PE_CI
	...
	// From: Req3Batch77Filler_PE_CI
	var_1_10 = (50 + ((var_1_11 + 10000) - var_1_12));


	// From: Req6Batch77Filler_PE_CI
	...
	if (var_1_13 >= (var_1_8 & (var_1_22 >> var_1_4))) {
		var_1_24 = (var_1_22 - (abs (var_1_13)));
	} else {
		if (var_1_13 > (var_1_8 ^ var_1_22)) {
			var_1_24 = (min (var_1_13 , var_1_8));
		}
	}
	...
	if (var_1_16 >= (-128 & var_1_11)) {
		if (((max (var_1_3 , var_1_3)) <= var_1_3) && var_1_18) {
			var_1_25 = var_1_22;
		}
	} else {
		var_1_25 = var_1_22;
