...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch20Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch20Filler_PE_CN
	var_1_15 = (var_1_14 + var_1_16);


	// From: Req6Batch20Filler_PE_CN
	if (var_1_2) {
	...
	// From: CodeObject4
	if (var_1_24) {
		if (var_1_22 > (var_1_20 / (abs (var_1_25)))) {
			var_1_23 = 100;
		} else {
			var_1_23 = 10;
		}
	...
	if (var_1_27 || (var_1_22 <= var_1_19)) {
		if ((var_1_21 | (var_1_23 * var_1_30)) == (min (var_1_31 , -32))) {
			var_1_29 = (max ((abs (var_1_32)) , var_1_33));
		} else {
			var_1_29 = (abs (min (var_1_32 , (abs (var_1_33)))));
		}
	} else {
		var_1_29 = (var_1_34 + ((abs (var_1_35)) + var_1_36));
	}
	...
	// From: CodeObject8
	if ((var_1_21 + (min (var_1_32 , var_1_38))) <= var_1_30) {
		if (var_1_37) {
			var_1_41 = var_1_38;
		}
	}
