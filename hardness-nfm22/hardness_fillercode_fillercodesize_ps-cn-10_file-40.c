...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch40PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject6
	if (! var_1_35) {
		if ((var_1_28 + var_1_29) <= var_1_32) {
			var_1_34 = var_1_36;
		}
	}


	// From: Req3Batch40PS_CN_10
	...
	// From: Req9Batch40PS_CN_10
	var_1_26 = var_1_12;


	// From: Req6Batch40PS_CN_10
	...
	// From: Req4Batch40PS_CN_10
	var_1_16 = (min (((max (256 , var_1_12)) + var_1_12) , var_1_15));


	// From: Req8Batch40PS_CN_10
	var_1_25 = var_1_20;


	// From: Req1Batch40PS_CN_10
