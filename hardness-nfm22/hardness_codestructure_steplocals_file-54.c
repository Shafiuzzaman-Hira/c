...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch54stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch54stepLocals
	signed long int stepLocal_1 = (var_1_8 * var_1_1) + var_1_4;
	if (stepLocal_1 >= (min (var_1_6 , var_1_5))) {
		var_1_13 = var_1_12;
	}


	// From: Req5Batch54stepLocals
	if (var_1_2 < (max (var_1_3 , (var_1_15 - var_1_16)))) {
		var_1_14 = (var_1_17 - (var_1_8 + var_1_4));
	}


	// From: Req6Batch54stepLocals
...
int property() {
	return ((((((var_1_2 > var_1_3) ? (var_1_1 == ((signed short int) ((min ((2 + var_1_4) , var_1_5)) - 2))) : (var_1_1 == ((signed short int) var_1_4))) && (var_1_7 ? ((var_1_5 == var_1_4) ? (var_1_6 == ((signed short int) (min ((abs (var_1_5)) , (var_1_4 - var_1_8))))) : (var_1_6 == ((signed short int) var_1_8))) : (var_1_6 == ((signed short int) var_1_4)))) && ((((var_1_8 % var_1_10) * (8 + var_1_1)) >= var_1_6) ? (var_1_9 == ((unsigned char) ((! var_1_11) || var_1_12))) : (var_1_9 == ((unsigned char) (! var_1_12))))) && ((((var_1_8 * var_1_1) + var_1_4) >= (min (var_1_6 , var_1_5))) ? (var_1_13 == ((unsigned char) var_1_12)) : 1)) && ((var_1_2 < (max (var_1_3 , (var_1_15 - var_1_16)))) ? (var_1_14 == ((unsigned long int) (var_1_17 - (var_1_8 + var_1_4)))) : 1)) && ((-32 >= (var_1_5 - var_1_8)) ? ((var_1_10 > var_1_1) ? (var_1_18 == ((float) ((var_1_19 - var_1_20) + (var_1_21 + var_1_22)))) : (var_1_18 == ((float) var_1_20))) : (var_1_18 == ((float) var_1_19)))
;
}
int main(void) {
	isInitial = 1;
