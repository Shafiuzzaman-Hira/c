...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch6PS_CN_25.c", 13, "reach_error"); }
...
float var_1_24 = 999.5;
unsigned char var_1_25 = 1;
float var_1_26 = 9999999.5;
...
void step(void) {
	...
	// From: CodeObject3
	if (var_1_25 || (var_1_20 >= var_1_21)) {
		var_1_24 = (min (16.75f , var_1_26));
	}


	// From: CodeObject4
	if ((var_1_25 && var_1_28) && (var_1_20 > (var_1_21 & var_1_22))) {
		var_1_27 = var_1_29;
	}
	...
	// From: CodeObject6
	if (var_1_28) {
		var_1_31 = (abs (min (var_1_32 , 16)));
	}


	// From: Req7Batch6PS_CN_25
	if (last_1_var_1_17) {
