...
void step(void) {
	...
	if (var_1_26 >= var_1_31) {
		var_1_39 = (var_1_25 + (abs (var_1_33)));
	} else {
		var_1_39 = (((max (var_1_32 , var_1_26)) - var_1_31) + (var_1_33 - (abs (var_1_25))));
	}


	// From: CodeObject9
	if (var_1_20) {
		var_1_40 = (abs (var_1_23));
	}


	// From: CodeObject10
	if (var_1_30) {
		var_1_41 = (abs (var_1_36));
	}


	// From: CodeObject11
	if ((var_1_34 / var_1_32) != (var_1_26 + var_1_33)) {
		if ((abs (var_1_35)) < var_1_38) {
			var_1_42 = var_1_34;
		} else {
			var_1_42 = (abs (25 + var_1_34));
		}
	} else {
		var_1_42 = (min (var_1_32 , 100));
	}
	...
	// From: Req3Batch9PS_CN_100
	if (((var_1_6 >> 2) * last_1_var_1_13) > last_1_var_1_10) {
		var_1_12 = var_1_6;
	}


	// From: Req2Batch9PS_CN_100
	...
	// From: Req6Batch9PS_CN_100
	var_1_18 = var_1_3;


	// From: Req5Batch9PS_CN_100
