...
void step(void) {
 ...
 if ((var_1_26 % var_1_28) <= ((var_1_25 + var_1_32) & ((((var_1_33) < (var_1_34)) ? (var_1_33) : (var_1_34))))) {
  var_1_31 = ((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30)));
 }
 if ((var_1_27 + var_1_36) <= var_1_30) {
  var_1_35 = (var_1_28 + ((((var_1_25) > (((((var_1_26) < (var_1_37)) ? (var_1_26) : (var_1_37))))) ? (var_1_25) : (((((var_1_26) < (var_1_37)) ? (var_1_26) : (var_1_37)))))));
 } else {
  if (var_1_38) {
   if (((((((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30)))) > (var_1_36)) ? (((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30)))) : (var_1_36))) >= ((((var_1_29) < (var_1_31)) ? (var_1_29) : (var_1_31)))) {
    var_1_35 = ((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37)));
   } else {
    var_1_35 = ((((var_1_25) < ((var_1_39 - ((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28)))))) ? (var_1_25) : ((var_1_39 - ((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28)))))));
   }
  }
 }
 ...
 var_1_41 = ((((var_1_28 + ((((var_1_25) < (var_1_40)) ? (var_1_25) : (var_1_40)))) < 0 ) ? -(var_1_28 + ((((var_1_25) < (var_1_40)) ? (var_1_25) : (var_1_40)))) : (var_1_28 + ((((var_1_25) < (var_1_40)) ? (var_1_25) : (var_1_40))))));
 if ((~ var_1_39) != var_1_35) {
  if (-8 != ((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35)))) {
   var_1_42 = ((((((((var_1_35) > (var_1_26)) ? (var_1_35) : (var_1_26))) + 50u) < 0 ) ? -(((((var_1_35) > (var_1_26)) ? (var_1_35) : (var_1_26))) + 50u) : (((((var_1_35) > (var_1_26)) ? (var_1_35) : (var_1_26))) + 50u)));
  } else {
   var_1_42 = ((((var_1_35 + ((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40)))) < 0 ) ? -(var_1_35 + ((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40)))) : (var_1_35 + ((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))))));
  }
 } else {
  var_1_42 = ((((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))) + var_1_39) + var_1_28);
 }
 if ((- var_1_39) <= (var_1_40 & ((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))))) {
  var_1_43 = (((((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30))) < 0 ) ? -((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30))) : ((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30)))));
 }
 if (var_1_30 > var_1_43) {
  var_1_44 = ((((var_1_30) > (var_1_29)) ? (var_1_30) : (var_1_29)));
 }
 if (var_1_38) {
  var_1_45 = ((((var_1_29) > (((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30))))) ? (var_1_29) : (((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30))))));
 } else {
 ...
 if (var_1_54 >= (var_1_30 + var_1_36)) {
  if (-8 < var_1_55) {
   var_1_53 = (var_1_28 - ((((var_1_25) > (4)) ? (var_1_25) : (4))));
  } else {
   var_1_53 = ((((var_1_48) < 0 ) ? -(var_1_48) : (var_1_48)));
  }
 } else {
  var_1_53 = ((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26)));
 }
 if (var_1_44 >= var_1_47) {
  var_1_56 = (((((3160676631u) < 0 ) ? -(3160676631u) : (3160676631u))) - var_1_37);
 } else {
  var_1_56 = ((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25)));
 }
 if (var_1_25 <= var_1_51) {
  if ((var_1_34 & var_1_49) < (~ var_1_35)) {
   var_1_57 = ((((((((var_1_40) < (((((var_1_48) < 0 ) ? -(var_1_48) : (var_1_48))))) ? (var_1_40) : (((((var_1_48) < 0 ) ? -(var_1_48) : (var_1_48))))))) < (var_1_25)) ? (((((var_1_40) < (((((var_1_48) < 0 ) ? -(var_1_48) : (var_1_48))))) ? (var_1_40) : (((((var_1_48) < 0 ) ? -(var_1_48) : (var_1_48))))))) : (var_1_25)));
  }
 } else {
  if (var_1_38) {
 ...
 if (var_1_38) {
  var_1_59 = ((((var_1_60 - var_1_35) < 0 ) ? -(var_1_60 - var_1_35) : (var_1_60 - var_1_35)));
 } else {
  var_1_59 = 50u;
 }
 if (var_1_38 && (((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52))) > var_1_62)) {
  if ((- (- var_1_44)) <= (var_1_31 * var_1_58)) {
   var_1_61 = ((((1.6) < 0 ) ? -(1.6) : (1.6)));
  }
 }
 if (var_1_38 || (((((var_1_59) < (var_1_56)) ? (var_1_59) : (var_1_56))) <= (var_1_60 - var_1_40))) {
  var_1_63 = (((((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29))) < 0 ) ? -((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29))) : ((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29)))));
 }
 if (! var_1_38) {
 ...
 if (var_1_27 > 1.0000000000025E11f) {
  if (var_1_38 || var_1_66) {
   var_1_65 = (var_1_67 + (var_1_68 + ((((25.625f) < 0 ) ? -(25.625f) : (25.625f)))));
  }
 }
 var_1_69 = ((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39)));
 if (((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29))) >= 7.063f) {
  var_1_70 = ((((2) < 0 ) ? -(2) : (2)));
 } else {
  var_1_70 = ((((var_1_37 + var_1_48) < 0 ) ? -(var_1_37 + var_1_48) : (var_1_37 + var_1_48)));
 }
 if (var_1_27 != (var_1_29 * var_1_58)) {
  var_1_71 = ((((var_1_72) < 0 ) ? -(var_1_72) : (var_1_72)));
 }
 if (var_1_46 >= var_1_43) {
  var_1_73 = ((((var_1_49) < (var_1_74)) ? (var_1_49) : (var_1_74)));
 }
 if (((((var_1_63) < (var_1_47)) ? (var_1_63) : (var_1_47))) == ((((var_1_50) < (var_1_61)) ? (var_1_50) : (var_1_61)))) {
  var_1_75 = ((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28)));
 }
 if (var_1_52 >= var_1_62) {
  var_1_76 = ((((((((var_1_64) < (var_1_77)) ? (var_1_64) : (var_1_77))) + var_1_73) < 0 ) ? -(((((var_1_64) < (var_1_77)) ? (var_1_64) : (var_1_77))) + var_1_73) : (((((var_1_64) < (var_1_77)) ? (var_1_64) : (var_1_77))) + var_1_73)));
 }
 if (var_1_48 >= var_1_56) {
  if (var_1_77 <= var_1_35) {
   if (var_1_65 <= ((((var_1_45) < 0 ) ? -(var_1_45) : (var_1_45)))) {
  ...
  if (var_1_29 > ((((var_1_67) < (((((var_1_50) > (var_1_68)) ? (var_1_50) : (var_1_68))))) ? (var_1_67) : (((((var_1_50) > (var_1_68)) ? (var_1_50) : (var_1_68))))))) {
   var_1_78 = (var_1_79 && (var_1_38 || var_1_83));
  }
 }
 if ((- var_1_44) < ((((var_1_50) < 0 ) ? -(var_1_50) : (var_1_50)))) {
 ...
 if ((var_1_90 / var_1_28) <= var_1_39) {
  if ((((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))) * var_1_59) > (var_1_37 | var_1_71)) {
   var_1_89 = var_1_74;
  } else {
   var_1_89 = var_1_49;
  }
