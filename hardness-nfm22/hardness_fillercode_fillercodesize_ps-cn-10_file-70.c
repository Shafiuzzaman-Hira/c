...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch70PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch70PS_CN_10
	if ((var_1_14 / var_1_19) <= (min (var_1_18 , var_1_14))) {
		var_1_20 = var_1_13;
	}


	// From: Req4Batch70PS_CN_10
	if (var_1_20) {
		var_1_12 = var_1_13;
	}


	// From: Req3Batch70PS_CN_10
