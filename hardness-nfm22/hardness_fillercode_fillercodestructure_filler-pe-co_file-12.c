...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch12Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch12Filler_PE_CO
	var_1_21 = (abs (var_1_7));


	// From: Req2Batch12Filler_PE_CO
	...
	// From: CodeObject2
	if ((var_1_8 * var_1_18) < (abs (var_1_21))) {
		if (var_1_8 <= var_1_21) {
			var_1_29 = var_1_18;
		} else {
			var_1_29 = var_1_8;
	...
	// From: CodeObject3
	if (var_1_1 < (max (var_1_1 , var_1_8))) {
		if (var_1_27) {
			var_1_35 = var_1_22;
		}
	}
	...
	// From: CodeObject4
	if (var_1_1 < (var_1_21 / var_1_38)) {
		var_1_36 = var_1_1;
	} else {
		if (((abs (var_1_21)) / var_1_38) < var_1_21) {
			var_1_36 = var_1_1;
		}
	}
	...
	// From: CodeObject6
	if (var_1_18 >= (~ (max (var_1_1 , var_1_44)))) {
		if (var_1_1 >= (~ var_1_21)) {
