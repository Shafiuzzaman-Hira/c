...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch2750_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch2750_1loop
	if (var_1_6 == (var_1_4 / var_1_13)) {
		var_1_12 = var_1_11;
	}


	// From: Req6Batch2750_1loop
	var_1_20 = var_1_11;


	// From: Req7Batch2750_1loop
	var_1_21 = 8;


	// From: Req3Batch2750_1loop
