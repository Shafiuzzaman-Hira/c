...
void step(void) {
	...
	if (stepLocal_1 <= (*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer))) {
		if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var3_Pointer))) {
			(*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) = (3.17 - (max (127.2 , (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)))));
		}
	}


	// From: Req4Batch76Wrapper_AP
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var3_Pointer))) {
