...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch29Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_1) {
  if (var_1_1) {
   if (10000000 <= var_1_35) {
    var_1_41 = ((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11)));
   }
  }
 } else {
  if (var_1_27 > (var_1_34 | var_1_27)) {
 ...
 if (var_1_18 && var_1_18) {
  var_1_31 = ((((((((var_1_34 - var_1_35)) > (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))))) ? ((var_1_34 - var_1_35)) : (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11)))))) < 0 ) ? -(((((var_1_34 - var_1_35)) > (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))))) ? ((var_1_34 - var_1_35)) : (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11)))))) : (((((var_1_34 - var_1_35)) > (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))))) ? ((var_1_34 - var_1_35)) : (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))))))));
 } else {
  if (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))) > var_1_34) {
   if ((! var_1_18) && (var_1_30 > var_1_23)) {
