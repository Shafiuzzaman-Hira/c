...
void step(void) {
	...
	if (last_1_var_1_69 <= (var_1_12 * var_1_13)) {
		...
		if (0.2f > last_1_var_1_79) {
			if (last_1_var_1_51) {
				...
				var_1_81 = (min ((var_1_43 - var_1_40) , (last_1_var_1_71 - var_1_82)));
			}
		}
	}


	// From: Req19Batch67Amount500
	...
	// From: Req10Batch67Amount500
	signed long int stepLocal_8 = last_1_var_1_47 + (var_1_26 - var_1_24);
	if (last_1_var_1_38 <= stepLocal_8) {
		if ((max (last_1_var_1_85 , (var_1_20 + var_1_9))) > (- (min (var_1_11 , last_1_var_1_48)))) {
			var_1_38 = (var_1_39 - var_1_40);
		}
	} else {
		var_1_38 = (var_1_39 - ((max (var_1_41 , var_1_42)) + var_1_43));
	}


	// From: Req25Batch67Amount500
	if ((var_1_50 * (var_1_67 >> last_1_var_1_55)) <= ((last_1_var_1_90 >> var_1_65) ^ var_1_63)) {
		if (last_1_var_1_87 >= (~ (var_1_58 * var_1_67))) {
			...
			if (last_1_var_1_90 >= (var_1_50 - var_1_42)) {
				var_1_76 = (max (((var_1_50 + var_1_77) - var_1_40) , (var_1_39 - (min (var_1_67 , var_1_43)))));
			} else {
	...
	if ((var_1_13 - var_1_14) >= (var_1_10 + (min (var_1_12 , var_1_9)))) {
		...
		if (stepLocal_7 >= (max (var_1_16 , last_1_var_1_93))) {
	...
	// From: Req33Batch67Amount500
	if (var_1_29) {
		var_1_88 = 128;
	}


	// From: Req35Batch67Amount500
	var_1_90 = var_1_88;


	// From: Req2Batch67Amount500
	var_1_6 = var_1_7;


	// From: Req30Batch67Amount500
	if (var_1_30) {
		var_1_85 = (abs (var_1_11));
	}


	// From: Req36Batch67Amount500
	var_1_91 = var_1_12;


	// From: Req37Batch67Amount500
	var_1_92 = var_1_41;


	// From: Req38Batch67Amount500
	var_1_93 = var_1_78;


	// From: Req39Batch67Amount500
	var_1_94 = var_1_31;


	// From: Req40Batch67Amount500
	if (var_1_54) {
		var_1_95 = var_1_53;
	} else {
		var_1_95 = var_1_32;
	...
	// From: Req43Batch67Amount500
	var_1_99 = var_1_30;


	// From: Req44Batch67Amount500
	var_1_100 = var_1_12;


	// From: Req26Batch67Amount500
	signed long int stepLocal_26 = 5;
	unsigned long int stepLocal_25 = -4 & (max (var_1_41 , var_1_15));
	if ((abs (var_1_66)) < stepLocal_26) {
		var_1_79 = ((var_1_13 + var_1_14) - (max (var_1_70 , var_1_20)));
	} else {
	...
	// From: Req20Batch67Amount500
	if ((var_1_24 + 5u) <= var_1_46) {
		if (-256 != var_1_40) {
			if ((- (var_1_67 + var_1_66)) <= var_1_88) {
				var_1_69 = (min (var_1_37 , var_1_20));
			} else {
				var_1_69 = ((var_1_70 - var_1_13) - (min (var_1_20 , var_1_14)));
			}
		} else {
			var_1_69 = (abs (min (var_1_12 , var_1_37)));
		}
	}


	// From: Req32Batch67Amount500
	if (var_1_29) {
		var_1_87 = var_1_38;
	} else {
		var_1_87 = var_1_39;
	...
	// From: Req14Batch67Amount500
	if (var_1_79 > (var_1_13 - var_1_36)) {
		if (var_1_20 < var_1_37) {
			var_1_48 = (max (var_1_14 , (var_1_20 - var_1_13)));
		}
	}


	// From: Req13Batch67Amount500
	...
	if (stepLocal_10 || (0u > var_1_26)) {
		if (stepLocal_11 < ((var_1_39 + var_1_90) & var_1_92)) {
			var_1_47 = (var_1_39 - (abs (var_1_42 + var_1_43)));
		} else {
			var_1_47 = var_1_40;
		}
	}
	...
	// From: Req17Batch67Amount500
	unsigned char stepLocal_19 = var_1_30;
	if (stepLocal_19 || var_1_29) {
		var_1_55 = (var_1_26 - var_1_76);
	} else {
		var_1_55 = (max (var_1_42 , var_1_76));
	}


	// From: Req21Batch67Amount500
	if (var_1_99) {
		var_1_71 = (var_1_41 - (min (var_1_39 , var_1_76)));
	} else {
		var_1_71 = var_1_47;
	}


	// From: Req5Batch67Amount500
	...
	// From: Req24Batch67Amount500
	if (var_1_95) {
		var_1_74 = (var_1_61 + (min (var_1_62 , var_1_75)));
	}


	// From: Req31Batch67Amount500
	if ((var_1_68 / var_1_16) >= (var_1_64 << var_1_74)) {
		if ((var_1_59 * var_1_37) >= (var_1_69 / var_1_70)) {
			var_1_86 = (min ((var_1_14 - var_1_70) , var_1_12));
		}
	} else {
		var_1_86 = var_1_20;
	}
	...
	// From: Req1Batch67Amount500
	if ((var_1_88 & var_1_46) <= var_1_74) {
		var_1_1 = var_1_38;
	}


	// From: Req9Batch67Amount500
	if (var_1_18 > (var_1_13 - (var_1_36 - var_1_14))) {
		...
		if (var_1_14 == (1.35 + (var_1_13 - var_1_36))) {
			...
			if ((var_1_15 * (var_1_7 * var_1_16)) < var_1_27) {
				var_1_35 = ((max (var_1_12 , (max (var_1_14 , var_1_9)))) + (var_1_11 + var_1_13));
			} else {
				var_1_35 = ((min ((var_1_14 - var_1_13) , var_1_9)) + ((min (var_1_12 , var_1_11)) + var_1_37));
			}
		}
	}


	// From: Req42Batch67Amount500
	if (var_1_35 > ((var_1_20 - var_1_14) + var_1_91)) {
		var_1_97 = (! (! var_1_32));
	}


	// From: Req8Batch67Amount500
	if (-0.35f > (max (var_1_10 , var_1_14))) {
		var_1_33 = (var_1_38 - (var_1_47 + 256));
	} else {
		var_1_33 = (min (var_1_7 , 8));
	}


	// From: Req11Batch67Amount500
	if (var_1_30) {
		var_1_44 = ((var_1_23 + var_1_38) - var_1_55);
	}


	// From: Req23Batch67Amount500
	unsigned char stepLocal_24 = (5 / var_1_26) < var_1_46;
	if (! var_1_51) {
		var_1_73 = (max ((abs (var_1_10)) , var_1_9));
	} else {
		if (stepLocal_24 && var_1_30) {
			if (var_1_97) {
				var_1_73 = (min ((var_1_10 + var_1_11) , (var_1_70 - var_1_14)));
			} else {
				var_1_73 = (var_1_13 - var_1_14);
			}
		} else {
			var_1_73 = (var_1_20 - (abs (var_1_11)));
		}
	}


	// From: Req41Batch67Amount500
	if (var_1_99) {
		var_1_96 = var_1_76;
	} else {
		var_1_96 = var_1_44;
	...
	// From: Req22Batch67Amount500
	if (var_1_53) {
		if (! var_1_29) {
			var_1_72 = (max (var_1_61 , var_1_43));
		} else {
			var_1_72 = (max ((min (var_1_62 , (var_1_42 - var_1_43))) , (var_1_61 + var_1_66)));
		}
	} else {
		if ((var_1_44 / var_1_26) <= var_1_42) {
			var_1_72 = (max (var_1_67 , var_1_41));
		} else {
			if (var_1_68 < -25) {
				...
				if (((var_1_84 * var_1_1) >= var_1_68) && var_1_99) {
					...
					var_1_72 = (max (((min (var_1_66 , var_1_64)) - var_1_42) , (var_1_62 + var_1_43)));
				}
			}
		}
	}
	...
	if ((var_1_15 * (var_1_55 - var_1_26)) < stepLocal_20) {
		var_1_56 = (min ((max ((max (var_1_7 , var_1_43)) , (max (-2 , var_1_58)))) , -8));
	} else {
		if ((max (var_1_36 , var_1_20)) == (var_1_86 / (max (var_1_59 , var_1_60)))) {
			var_1_56 = (max (var_1_43 , ((min (var_1_61 , var_1_62)) + var_1_63)));
		} else {
			if ((min (var_1_72 , 16)) > stepLocal_21) {
	...
	// From: Req6Batch67Amount500
	if (var_1_51) {
		if (((min (var_1_20 , var_1_91)) * var_1_14) <= (var_1_13 - (abs (var_1_11)))) {
			if (var_1_16 <= (var_1_81 % var_1_22)) {
				if ((abs (var_1_88)) >= var_1_47) {
					if (var_1_90 != var_1_16) {
						var_1_21 = ((var_1_23 + var_1_24) - 32);
					} else {
						var_1_21 = (max (((var_1_24 - var_1_76) + var_1_23) , (var_1_26 - (var_1_27 - 32))));
					}
				}
			} else {
				var_1_21 = (min (var_1_23 , var_1_26));
			}
		} else {
			if (var_1_47 >= (min (var_1_23 , var_1_76))) {
				if (var_1_16 == var_1_26) {
					var_1_21 = (min ((var_1_76 + var_1_24) , (min (var_1_23 , (min (var_1_26 , var_1_27))))));
				}
			} else {
...
int property() {
	return (((((((((((((((((((((((((((((((((((((((((((((var_1_88 & var_1_46) <= var_1_74) ? (var_1_1 == ((signed short int) var_1_38)) : 1) && (var_1_6 == ((signed char) var_1_7))) && ((var_1_84 == var_1_71) ? (var_1_8 == ((double) (var_1_9 + var_1_10))) : ((var_1_47 <= (var_1_84 + var_1_38)) ? (var_1_8 == ((double) (abs ((var_1_11 + var_1_12) + 1.00000005E7)))) : (var_1_8 == ((double) (((var_1_13 - var_1_14) + var_1_12) + var_1_9)))))) && (((- last_1_var_1_21) >= (max ((last_1_var_1_89 % var_1_16) , last_1_var_1_15))) ? (((last_1_var_1_89 / var_1_16) <= last_1_var_1_76) ? (var_1_15 == ((unsigned long int) (last_1_var_1_21 + (last_1_var_1_21 + last_1_var_1_21)))) : 1) : 1)) && (((var_1_9 < var_1_100) || var_1_29) ? (var_1_18 == ((double) (max ((var_1_14 - var_1_20) , (max ((min (var_1_10 , var_1_9)) , (var_1_13 + var_1_11))))))) : 1)) && (var_1_51 ? ((((min (var_1_20 , var_1_91)) * var_1_14) <= (var_1_13 - (abs (var_1_11)))) ? ((var_1_16 <= (var_1_81 % var_1_22)) ? (((abs (var_1_88)) >= var_1_47) ? ((var_1_90 != var_1_16) ? (var_1_21 == ((unsigned short int) ((var_1_23 + var_1_24) - 32))) : (var_1_21 == ((unsigned short int) (max (((var_1_24 - var_1_76) + var_1_23) , (var_1_26 - (var_1_27 - 32))))))) : 1) : (var_1_21 == ((unsigned short int) (min (var_1_23 , var_1_26))))) : ((var_1_47 >= (min (var_1_23 , var_1_76))) ? ((var_1_16 == var_1_26) ? (var_1_21 == ((unsigned short int) (min ((var_1_76 + var_1_24) , (min (var_1_23 , (min (var_1_26 , var_1_27)))))))) : 1) : (((var_1_47 > var_1_72) || var_1_51) ? ((var_1_88 < var_1_84) ? (var_1_21 == ((unsigned short int) (var_1_27 + (var_1_23 - var_1_76)))) : 1) : (var_1_21 == ((unsigned short int) var_1_76))))) : (var_1_21 == ((unsigned short int) var_1_23)))) && (((var_1_13 - var_1_14) >= (var_1_10 + (min (var_1_12 , var_1_9)))) ? ((last_1_var_1_49 && (var_1_14 <= var_1_11)) ? (var_1_29 == ((unsigned char) var_1_30)) : ((var_1_24 <= var_1_16) ? (last_1_var_1_94 ? (var_1_29 == ((unsigned char) (! var_1_31))) : (var_1_29 == ((unsigned char) (last_1_var_1_49 && (! var_1_31))))) : ((last_1_var_1_69 != var_1_10) ? (var_1_29 == ((unsigned char) (! (var_1_31 && var_1_32)))) : (var_1_29 == ((unsigned char) ((var_1_12 != 255.25) || var_1_32)))))) : ((var_1_7 >= (max (var_1_16 , last_1_var_1_93))) ? (var_1_29 == ((unsigned char) ((var_1_22 == last_1_var_1_33) || var_1_32))) : (var_1_29 == ((unsigned char) 1))))) && ((-0.35f > (max (var_1_10 , var_1_14))) ? (var_1_33 == ((signed short int) (var_1_38 - (var_1_47 + 256)))) : (var_1_33 == ((signed short int) (min (var_1_7 , 8)))))) && ((var_1_18 > (var_1_13 - (var_1_36 - var_1_14))) ? (var_1_35 == ((float) var_1_12)) : ((var_1_14 == (1.35 + (var_1_13 - var_1_36))) ? ((var_1_14 > var_1_11) ? (var_1_35 == ((float) (var_1_11 + (var_1_14 - 5.5f)))) : 1) : (((var_1_15 * (var_1_7 * var_1_16)) < var_1_27) ? (var_1_35 == ((float) ((max (var_1_12 , (max (var_1_14 , var_1_9)))) + (var_1_11 + var_1_13)))) : (var_1_35 == ((float) ((min ((var_1_14 - var_1_13) , var_1_9)) + ((min (var_1_12 , var_1_11)) + var_1_37)))))))) && ((last_1_var_1_38 <= (last_1_var_1_47 + (var_1_26 - var_1_24))) ? (((max (last_1_var_1_85 , (var_1_20 + var_1_9))) > (- (min (var_1_11 , last_1_var_1_48)))) ? (var_1_38 == ((unsigned char) (var_1_39 - var_1_40))) : 1) : (var_1_38 == ((unsigned char) (var_1_39 - ((max (var_1_41 , var_1_42)) + var_1_43)))))) && (var_1_30 ? (var_1_44 == ((signed long int) ((var_1_23 + var_1_38) - var_1_55))) : 1)) && ((var_1_43 == (200 - var_1_42)) ? (var_1_46 == ((signed long int) (var_1_42 - (abs (max (last_1_var_1_15 , var_1_26)))))) : (var_1_46 == ((signed long int) ((last_1_var_1_81 + last_1_var_1_47) + -8))))) && ((var_1_94 || (0u > var_1_26)) ? ((var_1_76 < ((var_1_39 + var_1_90) & var_1_92)) ? (var_1_47 == ((unsigned char) (var_1_39 - (abs (var_1_42 + var_1_43))))) : (var_1_47 == ((unsigned char) var_1_40))) : 1)) && ((var_1_79 > (var_1_13 - var_1_36)) ? ((var_1_20 < var_1_37) ? (var_1_48 == ((float) (max (var_1_14 , (var_1_20 - var_1_13))))) : 1) : 1)) && ((var_1_26 <= 4) ? ((var_1_79 < var_1_13) ? (((var_1_27 * (var_1_87 / var_1_23)) <= var_1_41) ? ((((var_1_50 - var_1_41) - (32 + var_1_43)) >= var_1_55) ? (var_1_49 == ((unsigned char) (! (! var_1_32)))) : 1) : (var_1_49 == ((unsigned char) ((var_1_79 != var_1_10) || (! var_1_30))))) : (var_1_49 == ((unsigned char) (var_1_29 && (! var_1_31))))) : ((var_1_29 && (var_1_15 < (var_1_6 * var_1_46))) ? (var_1_49 == ((unsigned char) var_1_31)) : ((var_1_39 == var_1_46) ? (var_1_49 == ((unsigned char) (var_1_29 && var_1_30))) : (var_1_49 == ((unsigned char) (var_1_31 && var_1_32))))))) && (var_1_32 ? (var_1_51 == ((unsigned char) (((min (last_1_var_1_33 , last_1_var_1_81)) > last_1_var_1_1) || var_1_31))) : ((last_1_var_1_81 < last_1_var_1_21) ? (var_1_51 == ((unsigned char) ((var_1_30 || var_1_53) || var_1_54))) : (((max (last_1_var_1_21 , 128)) >= last_1_var_1_71) ? (var_1_51 == ((unsigned char) (! var_1_31))) : (var_1_51 == ((unsigned char) (last_1_var_1_51 && var_1_54))))))) && ((var_1_30 || var_1_29) ? (var_1_55 == ((unsigned short int) (var_1_26 - var_1_76))) : (var_1_55 == ((unsigned short int) (max (var_1_42 , var_1_76)))))) && (((var_1_15 * (var_1_55 - var_1_26)) < ((var_1_57 - var_1_42) - 5)) ? (var_1_56 == ((signed char) (min ((max ((max (var_1_7 , var_1_43)) , (max (-2 , var_1_58)))) , -8)))) : (((max (var_1_36 , var_1_20)) == (var_1_86 / (max (var_1_59 , var_1_60)))) ? (var_1_56 == ((signed char) (max (var_1_43 , ((min (var_1_61 , var_1_62)) + var_1_63))))) : (((min (var_1_72 , 16)) > var_1_39) ? (var_1_56 == ((signed char) (abs (var_1_43)))) : (var_1_56 == ((signed char) ((16 + (var_1_64 + var_1_65)) - ((var_1_66 + var_1_67) + var_1_43)))))))) && ((var_1_54 && (200 <= var_1_7)) ? ((last_1_var_1_21 >= (var_1_26 - var_1_65)) ? (var_1_68 == ((signed short int) (max (var_1_67 , var_1_64)))) : 1) : 1)) && (((var_1_24 + 5u) <= var_1_46) ? ((-256 != var_1_40) ? (((- (var_1_67 + var_1_66)) <= var_1_88) ? (var_1_69 == ((float) (min (var_1_37 , var_1_20)))) : (var_1_69 == ((float) ((var_1_70 - var_1_13) - (min (var_1_20 , var_1_14)))))) : (var_1_69 == ((float) (abs (min (var_1_12 , var_1_37)))))) : 1)) && (var_1_99 ? (var_1_71 == ((signed short int) (var_1_41 - (min (var_1_39 , var_1_76))))) : (var_1_71 == ((signed short int) var_1_47)))) && (var_1_53 ? ((! var_1_29) ? (var_1_72 == ((signed char) (max (var_1_61 , var_1_43)))) : (var_1_72 == ((signed char) (max ((min (var_1_62 , (var_1_42 - var_1_43))) , (var_1_61 + var_1_66)))))) : (((var_1_44 / var_1_26) <= var_1_42) ? (var_1_72 == ((signed char) (max (var_1_67 , var_1_41)))) : ((var_1_68 < -25) ? (var_1_72 == ((signed char) ((64 - (var_1_65 + var_1_67)) - var_1_64))) : ((((var_1_84 * var_1_1) >= var_1_68) && var_1_99) ? (var_1_72 == ((signed char) var_1_42)) : (var_1_72 == ((signed char) (max (((min (var_1_66 , var_1_64)) - var_1_42) , (var_1_62 + var_1_43)))))))))) && ((! var_1_51) ? (var_1_73 == ((float) (max ((abs (var_1_10)) , var_1_9)))) : ((((5 / var_1_26) < var_1_46) && var_1_30) ? (var_1_97 ? (var_1_73 == ((float) (min ((var_1_10 + var_1_11) , (var_1_70 - var_1_14))))) : (var_1_73 == ((float) (var_1_13 - var_1_14)))) : (var_1_73 == ((float) (var_1_20 - (abs (var_1_11)))))))) && (var_1_95 ? (var_1_74 == ((signed char) (var_1_61 + (min (var_1_62 , var_1_75))))) : 1)) && (((var_1_50 * (var_1_67 >> last_1_var_1_55)) <= ((last_1_var_1_90 >> var_1_65) ^ var_1_63)) ? ((last_1_var_1_87 >= (~ (var_1_58 * var_1_67))) ? (var_1_76 == ((unsigned char) (var_1_39 - 4))) : ((last_1_var_1_90 >= (var_1_50 - var_1_42)) ? (var_1_76 == ((unsigned char) (max (((var_1_50 + var_1_77) - var_1_40) , (var_1_39 - (min (var_1_67 , var_1_43))))))) : (var_1_76 == ((unsigned char) (var_1_64 + var_1_66))))) : (var_1_76 == ((unsigned char) ((var_1_66 + (var_1_64 + var_1_65)) + ((var_1_78 - var_1_67) + 32)))))) && (((abs (var_1_66)) < 5) ? (var_1_79 == ((float) ((var_1_13 + var_1_14) - (max (var_1_70 , var_1_20))))) : ((var_1_84 > (-4 & (max (var_1_41 , var_1_15)))) ? (var_1_79 == ((float) (var_1_70 - 4.2f))) : (var_1_79 == ((float) var_1_9))))) && ((((~ var_1_63) ^ -50) <= (var_1_89 >> var_1_76)) ? (var_1_80 == ((signed short int) (2 + (var_1_67 - (var_1_77 + var_1_74))))) : 1)) && ((last_1_var_1_69 <= (var_1_12 * var_1_13)) ? ((last_1_var_1_87 >= last_1_var_1_68) ? (((abs (last_1_var_1_46)) >= last_1_var_1_81) ? (var_1_81 == ((signed short int) (25 - (max (last_1_var_1_38 , (var_1_82 - var_1_40)))))) : 1) : (var_1_81 == ((signed short int) (var_1_42 + last_1_var_1_38)))) : ((0.2f > last_1_var_1_79) ? (last_1_var_1_51 ? (var_1_81 == ((signed short int) ((var_1_78 + var_1_7) + 4))) : (var_1_81 == ((signed short int) (min ((var_1_43 - var_1_40) , (last_1_var_1_71 - var_1_82)))))) : 1))) && ((! var_1_53) ? (var_1_84 == ((signed long int) last_1_var_1_80)) : 1)) && (var_1_30 ? (var_1_85 == ((float) (abs (var_1_11)))) : 1)) && (((var_1_68 / var_1_16) >= (var_1_64 << var_1_74)) ? (((var_1_59 * var_1_37) >= (var_1_69 / var_1_70)) ? (var_1_86 == ((double) (min ((var_1_14 - var_1_70) , var_1_12)))) : 1) : (var_1_86 == ((double) var_1_20)))) && (var_1_29 ? (var_1_87 == ((unsigned long int) var_1_38)) : (var_1_87 == ((unsigned long int) var_1_39)))) && (var_1_29 ? (var_1_88 == ((unsigned short int) 128)) : 1)) && (var_1_97 ? (var_1_89 == ((signed long int) var_1_33)) : (var_1_89 == ((signed long int) var_1_56)))) && (var_1_90 == ((unsigned long int) var_1_88))) && (var_1_91 == ((double) var_1_12))) && (var_1_92 == ((unsigned long int) var_1_41))) && (var_1_93 == ((signed short int) var_1_78))) && (var_1_94 == ((unsigned char) var_1_31))) && (var_1_54 ? (var_1_95 == ((unsigned char) var_1_53)) : (var_1_95 == ((unsigned char) var_1_32)))) && (var_1_99 ? (var_1_96 == ((signed long int) var_1_76)) : (var_1_96 == ((signed long int) var_1_44)))) && ((var_1_35 > ((var_1_20 - var_1_14) + var_1_91)) ? (var_1_97 == ((unsigned char) (! (! var_1_32)))) : 1)) && (var_1_99 == ((unsigned char) var_1_30))) && (var_1_100 == ((double) var_1_12))
;
}
int main(void) {
	isInitial = 1;
