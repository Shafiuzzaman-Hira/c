...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch45PS_CN_50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch45PS_CN_50
	if (var_1_2) {
		var_1_16 = (var_1_5 || var_1_17);
	}


	// From: Req8Batch45PS_CN_50
	var_1_18 = var_1_8;


	// From: Req2Batch45PS_CN_50
	...
	// From: Req3Batch45PS_CN_50
	var_1_7 = (min ((var_1_8 - var_1_18) , var_1_9));


	// From: Req5Batch45PS_CN_50
	if (! var_1_16) {
		if (var_1_16) {
