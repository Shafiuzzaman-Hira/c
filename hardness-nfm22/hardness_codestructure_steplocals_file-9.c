...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch9stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch9stepLocals
	signed long int stepLocal_1 = var_1_2 >> var_1_3;
	signed long int stepLocal_0 = var_1_3 << (var_1_6 - var_1_7);
	if (stepLocal_1 == (var_1_4 / var_1_5)) {
		if (stepLocal_0 > ((var_1_4 & 0) * var_1_5)) {
	...
	// From: Req2Batch9stepLocals
	signed char stepLocal_2 = var_1_6;
	if (stepLocal_2 <= (var_1_4 + var_1_7)) {
		var_1_10 = var_1_11;
	} else {
	...
	// From: Req3Batch9stepLocals
	if (((var_1_6 >> 2) * var_1_10) > var_1_4) {
		var_1_12 = var_1_6;
	}


	// From: Req4Batch9stepLocals
	if ((1 << var_1_2) != (-500 / -100)) {
		if ((var_1_6 - var_1_3) >= (var_1_10 + 256)) {
			var_1_13 = var_1_11;
		} else {
			var_1_13 = var_1_12;
		}
