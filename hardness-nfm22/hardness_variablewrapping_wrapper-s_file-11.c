...
void step(void) {
	...
	if (WrapperStruct00.var_1_3 >= WrapperStruct00.var_1_2) {
		if (last_1_WrapperStruct00_var_1_11) {
			if (! last_1_WrapperStruct00_var_1_11) {
				WrapperStruct00.var_1_8 = (max (WrapperStruct00.var_1_9 , (10.25f + WrapperStruct00.var_1_10)));
			} else {
	...
	// From: Req4Batch11Wrapper_S
	if (! WrapperStruct00.var_1_11) {
		WrapperStruct00.var_1_14 = (min ((min (WrapperStruct00.var_1_15 , (max (WrapperStruct00.var_1_16 , 5)))) , WrapperStruct00.var_1_17));
	} else {
