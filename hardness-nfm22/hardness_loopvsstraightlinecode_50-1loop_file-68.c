...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch6850_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch6850_1loop
	var_1_16 = last_1_var_1_12;


	// From: Req6Batch6850_1loop
	...
	// From: Req7Batch6850_1loop
	var_1_15 = var_1_10;


	// From: Req3Batch6850_1loop
