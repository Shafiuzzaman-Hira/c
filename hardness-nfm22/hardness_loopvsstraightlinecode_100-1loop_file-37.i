...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch37100_1loop.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_5 == stepLocal_3) {
  var_1_21 = ((var_1_4 - last_1_var_1_1) + ((((last_1_var_1_22) < 0 ) ? -(last_1_var_1_22) : (last_1_var_1_22))));
 } else {
  var_1_21 = ((((last_1_var_1_21) > (var_1_4)) ? (last_1_var_1_21) : (var_1_4)));
 }
 signed long int stepLocal_4 = last_1_var_1_10;
 if ((var_1_5 / ((((var_1_4) < (var_1_23)) ? (var_1_4) : (var_1_23)))) <= stepLocal_4) {
  if (var_1_19) {
   var_1_22 = (var_1_24 - (last_1_var_1_9 + var_1_4));
  } else {
   var_1_22 = (((((((((var_1_24) < (var_1_25)) ? (var_1_24) : (var_1_25))) - (last_1_var_1_9 + last_1_var_1_27))) < (((((last_1_var_1_10) > (((((var_1_4) > (var_1_5)) ? (var_1_4) : (var_1_5))))) ? (last_1_var_1_10) : (((((var_1_4) > (var_1_5)) ? (var_1_4) : (var_1_5)))))))) ? ((((((var_1_24) < (var_1_25)) ? (var_1_24) : (var_1_25))) - (last_1_var_1_9 + last_1_var_1_27))) : (((((last_1_var_1_10) > (((((var_1_4) > (var_1_5)) ? (var_1_4) : (var_1_5))))) ? (last_1_var_1_10) : (((((var_1_4) > (var_1_5)) ? (var_1_4) : (var_1_5)))))))));
  }
 }
 ...
 if (var_1_18 && var_1_19) {
  var_1_27 = ((((var_1_5) < (((var_1_4 + var_1_1) + var_1_1))) ? (var_1_5) : (((var_1_4 + var_1_1) + var_1_1))));
 }
 if ((var_1_13 - var_1_14) <= var_1_12) {
  var_1_26 = (var_1_25 - var_1_27);
 } else {
  var_1_26 = ((((var_1_27 + ((((var_1_9) > (var_1_5)) ? (var_1_9) : (var_1_5)))) < 0 ) ? -(var_1_27 + ((((var_1_9) > (var_1_5)) ? (var_1_9) : (var_1_5)))) : (var_1_27 + ((((var_1_9) > (var_1_5)) ? (var_1_9) : (var_1_5))))));
 }
 unsigned char stepLocal_5 = var_1_13 < var_1_15;
 if (var_1_18 || stepLocal_5) {
  if ((((((var_1_7 / var_1_13)) > (99.6f)) ? ((var_1_7 / var_1_13)) : (99.6f))) != var_1_15) {
   var_1_29 = (var_1_5 - 10);
  } else {
   var_1_29 = var_1_5;
  }
