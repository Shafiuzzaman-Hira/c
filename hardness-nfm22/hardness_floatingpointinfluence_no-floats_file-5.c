...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch5no_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch5no_floats
	var_1_18 = -4;


	// From: Req5Batch5no_floats
	var_1_19 = var_1_8;


	// From: Req6Batch5no_floats
	var_1_20 = var_1_12;
}
