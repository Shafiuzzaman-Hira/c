...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch98Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch98Wrapper_S
	WrapperStruct00.var_1_1 = (WrapperStruct00.var_1_2 - WrapperStruct00.var_1_3);


	// From: Req4Batch98Wrapper_S
	if ((min (-128 , last_1_WrapperStruct00_var_1_15)) < WrapperStruct00.var_1_13) {
		if (last_1_WrapperStruct00_var_1_15 > WrapperStruct00.var_1_7) {
			WrapperStruct00.var_1_15 = (WrapperStruct00.var_1_6 + WrapperStruct00.var_1_16);
		} else {
	...
	// From: Req2Batch98Wrapper_S
	unsigned long int stepLocal_0 = (WrapperStruct00.var_1_15 >> WrapperStruct00.var_1_6) / WrapperStruct00.var_1_7;
	if (8 < stepLocal_0) {
		WrapperStruct00.var_1_4 = (((WrapperStruct00.var_1_8 + WrapperStruct00.var_1_9) + (min (WrapperStruct00.var_1_10 , 1.9))) + (99.125 + WrapperStruct00.var_1_11));
	}


	// From: Req3Batch98Wrapper_S
	if (WrapperStruct00.var_1_2 < WrapperStruct00.var_1_8) {
		if (((- WrapperStruct00.var_1_15) <= WrapperStruct00.var_1_6) || (WrapperStruct00.var_1_4 < WrapperStruct00.var_1_10)) {
			WrapperStruct00.var_1_12 = (min (WrapperStruct00.var_1_6 , WrapperStruct00.var_1_13));
		} else {
			WrapperStruct00.var_1_12 = (WrapperStruct00.var_1_14 - WrapperStruct00.var_1_6);
		}
	}
}
...
int property() {
	return (((WrapperStruct00.var_1_1 == ((double) (WrapperStruct00.var_1_2 - WrapperStruct00.var_1_3))) && ((8 < ((WrapperStruct00.var_1_15 >> WrapperStruct00.var_1_6) / WrapperStruct00.var_1_7)) ? (WrapperStruct00.var_1_4 == ((double) (((WrapperStruct00.var_1_8 + WrapperStruct00.var_1_9) + (min (WrapperStruct00.var_1_10 , 1.9))) + (99.125 + WrapperStruct00.var_1_11)))) : 1)) && ((WrapperStruct00.var_1_2 < WrapperStruct00.var_1_8) ? ((((- WrapperStruct00.var_1_15) <= WrapperStruct00.var_1_6) || (WrapperStruct00.var_1_4 < WrapperStruct00.var_1_10)) ? (WrapperStruct00.var_1_12 == ((unsigned long int) (min (WrapperStruct00.var_1_6 , WrapperStruct00.var_1_13)))) : (WrapperStruct00.var_1_12 == ((unsigned long int) (WrapperStruct00.var_1_14 - WrapperStruct00.var_1_6)))) : 1)) && (((min (-128 , last_1_WrapperStruct00_var_1_15)) < WrapperStruct00.var_1_13) ? ((last_1_WrapperStruct00_var_1_15 > WrapperStruct00.var_1_7) ? (WrapperStruct00.var_1_15 == ((unsigned long int) (WrapperStruct00.var_1_6 + WrapperStruct00.var_1_16))) : (WrapperStruct00.var_1_15 == ((unsigned long int) WrapperStruct00.var_1_14))) : (WrapperStruct00.var_1_15 == ((unsigned long int) WrapperStruct00.var_1_16)))
;
}
int main(void) {
	isInitial = 1;
