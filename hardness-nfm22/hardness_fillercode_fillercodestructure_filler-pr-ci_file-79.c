...
void step(void) {
	...
	// From: CodeObject3
	var_1_36 = ((max (var_1_8 , (abs (var_1_7)))) + var_1_7);


	// From: CodeObject7
	if (0.83f > var_1_10) {
		if ((var_1_8 + (abs (var_1_27))) <= var_1_23) {
			var_1_49 = var_1_10;
		}
	} else {
		var_1_49 = var_1_10;
	...
	// From: CodeObject2
	var_1_32 = (max ((min (var_1_16 , var_1_17)) , var_1_16));
	...
	// From: Req8Batch79Filler_PR_CI
	var_1_27 = 10u;


	// From: CodeObject6
	if (((var_1_8 * var_1_24) | var_1_7) <= (var_1_7 + 8u)) {
		if ((min (16u , var_1_7)) < var_1_24) {
			var_1_45 = var_1_19;
		} else {
	...
	if (! (var_1_11 >= (var_1_16 - var_1_40))) {
		var_1_42 = (min ((var_1_24 - 256) , var_1_24));
	}


	// From: Req1Batch79Filler_PR_CI
	if (var_1_18) {
		if (! var_1_18) {
			var_1_1 = (var_1_7 + 5);
		} else {
	...
	// From: CodeObject4
	if (256 > (-10 >> var_1_20)) {
		var_1_38 = (var_1_16 - (min ((var_1_40 - 128.375) , var_1_17)));
	} else {
		var_1_38 = var_1_17;
	}


	// From: Req4Batch79Filler_PR_CI
