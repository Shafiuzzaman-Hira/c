...
void step(void) {
	...
	// From: Req4Batch58Filler_PS_CN
	var_1_12 = (min (var_1_13 , var_1_14));


	// From: Req5Batch58Filler_PS_CN
	if (var_1_7) {
		var_1_15 = ((min (32 , (16 + var_1_16))) - var_1_17);
	}


	// From: Req6Batch58Filler_PS_CN
