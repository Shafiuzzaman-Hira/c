...
void step(void) {
	...
	if (var_1_16 < (var_1_14 + var_1_13)) {
		...
		var_1_23 = (max (var_1_9 , var_1_10));
	}


	// From: CodeObject2
	if (var_1_3) {
		if ((abs (var_1_17)) > ((-10 + var_1_14) & var_1_17)) {
			var_1_29 = ((abs (var_1_31 - 64u)) - var_1_21);
		} else {
			var_1_29 = var_1_21;
		}
	}
	...
	// From: Req4Batch67Filler_PR_CI
	var_1_12 = (var_1_13 - var_1_14);


	// From: Req5Batch67Filler_PR_CI
	...
	if (var_1_1 > (var_1_39 - var_1_40)) {
		if (var_1_19 <= var_1_14) {
			var_1_38 = (var_1_14 + (abs (var_1_14)));
		} else {
			if ((max ((abs (var_1_11)) , var_1_10)) != var_1_10) {
