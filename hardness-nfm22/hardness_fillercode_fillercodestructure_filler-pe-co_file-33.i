...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch33Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((- ((((var_1_1) > (var_1_7)) ? (var_1_1) : (var_1_7)))) == var_1_5) {
  var_1_22 = var_1_26;
 }
 var_1_27 = var_1_28;
 if (var_1_19 > var_1_1) {
 ...
 if (0 <= (var_1_7 - ((((var_1_1) < (var_1_26)) ? (var_1_1) : (var_1_26))))) {
  var_1_31 = ((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26)));
 }
 if (var_1_1 <= (var_1_1 / (var_1_33 - var_1_34))) {
  if (-64 >= (((((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))) < 0 ) ? -((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))) : ((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11)))))) {
   if (-8 > var_1_14) {
 ...
 if (var_1_33 < var_1_7) {
  var_1_38 = ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)));
 } else {
  if (var_1_34 <= var_1_11) {
   var_1_38 = ((((var_1_37) < (((((var_1_14) > (var_1_7)) ? (var_1_14) : (var_1_7))))) ? (var_1_37) : (((((var_1_14) > (var_1_7)) ? (var_1_14) : (var_1_7))))));
  }
 }
