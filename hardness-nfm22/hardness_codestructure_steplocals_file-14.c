...
void step(void) {
	// From: Req1Batch14stepLocals
	var_1_1 = (var_1_2 + var_1_3);


	// From: Req2Batch14stepLocals
	...
	// From: Req3Batch14stepLocals
	if ((var_1_3 / var_1_12) <= var_1_1) {
		var_1_11 = (max (var_1_13 , var_1_14));
	}


	// From: Req4Batch14stepLocals
	if ((min (var_1_5 , -0.5)) > (10.9 * var_1_6)) {
		if (var_1_16) {
...
int property() {
	return (((((((var_1_1 == ((signed long int) (var_1_2 + var_1_3))) && (((var_1_5 + 9.999999999999994E14f) < (- var_1_6)) ? (var_1_4 == ((unsigned char) (var_1_7 && var_1_8))) : (var_1_7 ? (var_1_4 == ((unsigned char) ((var_1_8 || var_1_9) && var_1_10))) : 1))) && (((var_1_3 / var_1_12) <= var_1_1) ? (var_1_11 == ((unsigned long int) (max (var_1_13 , var_1_14)))) : 1)) && (((min (var_1_5 , -0.5)) > (10.9 * var_1_6)) ? (var_1_16 ? (var_1_15 == ((unsigned char) (min ((abs (var_1_17)) , var_1_18)))) : (var_1_15 == ((unsigned char) var_1_18))) : 1)) && (((var_1_13 % var_1_20) != var_1_1) ? ((var_1_18 == var_1_17) ? (var_1_16 ? (var_1_19 == ((signed long int) var_1_18)) : (var_1_19 == ((signed long int) var_1_15))) : 1) : 1)) && ((((~ var_1_15) * var_1_22) >= (var_1_3 % var_1_23)) ? (var_1_21 == ((float) (max (var_1_24 , var_1_25)))) : 1)) && ((var_1_9 || ((var_1_19 + var_1_27) <= 4)) ? (var_1_26 == ((signed long int) (var_1_15 - var_1_20))) : (var_1_26 == ((signed long int) (var_1_20 - var_1_17))))) && (var_1_28 == ((unsigned char) var_1_17))
;
}
int main(void) {
	isInitial = 1;
