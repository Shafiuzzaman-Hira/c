...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch66Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject7
	if (var_1_10 <= (~ (min (var_1_4 , var_1_6)))) {
		if (var_1_12) {
	...
	// From: CodeObject5
	if ((max ((max (var_1_21 , var_1_7)) , var_1_19)) > var_1_7) {
		if (! (var_1_11 >= 128)) {
			var_1_36 = (abs (8));
		}
	} else {
	...
	if (var_1_8 > var_1_18) {
		if (var_1_29 < var_1_18) {
			if (var_1_29 <= (-64 & var_1_18)) {
				var_1_31 = (max (var_1_7 , (min (8 , var_1_7))));
			} else {
				var_1_31 = (var_1_6 + (max (4 , var_1_4)));
			}
		}
	}


	// From: Req2Batch66Filler_PR_CI
	...
	// From: CodeObject3
	if ((abs (-256)) < var_1_4) {
		var_1_28 = (5 - ((abs (var_1_29)) - var_1_7));
	} else {
		var_1_28 = var_1_29;
	}


	// From: Req6Batch66Filler_PR_CI
