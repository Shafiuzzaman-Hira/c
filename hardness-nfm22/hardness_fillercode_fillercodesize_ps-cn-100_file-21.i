...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch21PS_CN_100.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_34 = var_1_35;
 var_1_36 = ((((var_1_29) > (var_1_32)) ? (var_1_29) : (var_1_32)));
 if (var_1_28 < var_1_26) {
  if (! (((((var_1_38) < (var_1_30)) ? (var_1_38) : (var_1_30))) > var_1_29)) {
   if ((var_1_35 - ((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29)))) < (var_1_28 ^ var_1_38)) {
    var_1_37 = ((((((((var_1_35) > (var_1_34)) ? (var_1_35) : (var_1_34)))) < (var_1_39)) ? (((((var_1_35) > (var_1_34)) ? (var_1_35) : (var_1_34)))) : (var_1_39)));
   }
  }
 }
 if (var_1_28 <= ((((((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34)))) > (var_1_39)) ? (((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34)))) : (var_1_39)))) {
  if ((~ var_1_37) >= (var_1_26 + var_1_36)) {
   if ((var_1_39 & var_1_37) < (100u | var_1_34)) {
    var_1_40 = ((((((((var_1_41 + var_1_42) < 0 ) ? -(var_1_41 + var_1_42) : (var_1_41 + var_1_42)))) < (var_1_35)) ? (((((var_1_41 + var_1_42) < 0 ) ? -(var_1_41 + var_1_42) : (var_1_41 + var_1_42)))) : (var_1_35)));
   }
  }
 }
 if ((var_1_29 / var_1_30) <= var_1_38) {
  var_1_43 = ((((var_1_34) < (var_1_42)) ? (var_1_34) : (var_1_42)));
 }
 if (var_1_39 >= (var_1_35 * var_1_26)) {
  var_1_44 = (((! var_1_45) && var_1_46) && var_1_47);
 }
 if (var_1_28 > var_1_38) {
  var_1_48 = (((((var_1_49) < (((((var_1_50) < 0 ) ? -(var_1_50) : (var_1_50))))) ? (var_1_49) : (((((var_1_50) < 0 ) ? -(var_1_50) : (var_1_50)))))) - (((((((var_1_42) > (var_1_41)) ? (var_1_42) : (var_1_41))) < 0 ) ? -((((var_1_42) > (var_1_41)) ? (var_1_42) : (var_1_41))) : ((((var_1_42) > (var_1_41)) ? (var_1_42) : (var_1_41))))));
 }
 if (var_1_31 > var_1_33) {
  var_1_51 = ((((var_1_41 - var_1_49) < 0 ) ? -(var_1_41 - var_1_49) : (var_1_41 - var_1_49)));
 } else {
  var_1_51 = (var_1_35 + var_1_48);
 }
 if (var_1_38 == var_1_48) {
  if (var_1_31 >= var_1_33) {
   var_1_52 = ((((((((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) < 0 ) ? -((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) : ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))))) < 0 ) ? -(((((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) < 0 ) ? -((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) : ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))))) : (((((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) < 0 ) ? -((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) : ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34)))))));
  }
 } else {
  if ((((((((var_1_31) < (9.8)) ? (var_1_31) : (9.8))) < 0 ) ? -((((var_1_31) < (9.8)) ? (var_1_31) : (9.8))) : ((((var_1_31) < (9.8)) ? (var_1_31) : (9.8))))) <= 64.3) {
   if (var_1_47) {
    var_1_52 = (((((256) < 0 ) ? -(256) : (256))) + var_1_34);
   } else {
    var_1_52 = var_1_42;
   }
  } else {
...
void updateVariables() {
 ...
 assume_abort_if_not(var_1_38 >= -32768);
