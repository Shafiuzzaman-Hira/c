...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch6550_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch6550_1loop
	var_1_20 = (var_1_21 - (var_1_22 + 1.5));


	// From: Req8Batch6550_1loop
	var_1_28 = var_1_21;


	// From: Req1Batch6550_1loop
	...
	// From: Req7Batch6550_1loop
	var_1_24 = ((var_1_1 <= (var_1_25 - var_1_26)) && var_1_27);


	// From: Req3Batch6550_1loop
