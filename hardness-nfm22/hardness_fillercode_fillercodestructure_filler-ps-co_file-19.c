...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch19Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch19Filler_PS_CO
	if (last_1_var_1_15) {
		var_1_10 = (var_1_12 || var_1_13);
	}


	// From: Req7Batch19Filler_PS_CO
	if (var_1_10) {
	...
	// From: Req5Batch19Filler_PS_CO
	if ((- var_1_24) == (var_1_24 + var_1_24)) {
		var_1_15 = var_1_12;
	}


	// From: Req6Batch19Filler_PS_CO
	...
	// From: Req8Batch19Filler_PS_CO
	if (var_1_24 != var_1_24) {
		var_1_29 = (max (var_1_2 , var_1_3));
	}


	// From: Req2Batch19Filler_PS_CO
	...
	// From: Req4Batch19Filler_PS_CO
	if (var_1_15) {
		var_1_14 = (min ((abs (max (var_1_3 , var_1_2))) , var_1_9));
	}


	// From: Req1Batch19Filler_PS_CO
