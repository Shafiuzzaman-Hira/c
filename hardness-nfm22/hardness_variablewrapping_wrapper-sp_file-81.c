...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch81Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
	...
	signed long int stepLocal_0 = min (-25 , last_1_WrapperStruct00_var_1_18);
	...
	unsigned char stepLocal_1 = (*(WrapperStruct00_var_1_11_Pointer)) >= (*(WrapperStruct00_var_1_7_Pointer));
	if (stepLocal_1 && (*(WrapperStruct00_var_1_14_Pointer))) {
	...
	signed char stepLocal_2 = (*(WrapperStruct00_var_1_7_Pointer));
	if (stepLocal_2 > (*(WrapperStruct00_var_1_16_Pointer))) {
