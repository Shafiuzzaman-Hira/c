...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch11Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject3
	if (var_1_18 <= (min (var_1_9 , (var_1_12 >> var_1_7)))) {
	...
	// From: CodeObject4
	if (var_1_1) {
		var_1_30 = (min (var_1_20 , (1.625f + (abs (var_1_32)))));
	}
	...
	if (var_1_9 >= var_1_8) {
		if ((var_1_27 >> (var_1_34 + var_1_35)) <= var_1_7) {
			if (var_1_34 >= var_1_8) {
				if (var_1_20 <= (abs (var_1_32))) {
					var_1_33 = (max (var_1_32 , var_1_20));
				}
			} else {
				var_1_33 = (max (var_1_20 , var_1_32));
			}
		} else {
			var_1_33 = var_1_20;
		}
	...
	if (var_1_27 >= (var_1_9 + var_1_9)) {
		if ((-0.95f * (abs (var_1_19))) > var_1_20) {
