...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch19PS_CN_100.c", 13, "reach_error"); }
...
signed long int var_1_59 = 1000000000;
...
void step(void) {
 ...
 var_1_43 = ((((var_1_33) < (-4)) ? (var_1_33) : (-4)));
 if (var_1_40 || (var_1_33 < var_1_43)) {
  if (64 < var_1_34) {
 ...
 if (-1000000 > var_1_33) {
  ...
  var_1_47 = (((((var_1_50) > (((((-5) < 0 ) ? -(-5) : (-5))))) ? (var_1_50) : (((((-5) < 0 ) ? -(-5) : (-5)))))) + var_1_51);
 }
 if ((((((((-2) < 0 ) ? -(-2) : (-2))) < 0 ) ? -((((-2) < 0 ) ? -(-2) : (-2))) : ((((-2) < 0 ) ? -(-2) : (-2))))) < var_1_47) {
  var_1_52 = (((((((var_1_36) > (var_1_37)) ? (var_1_36) : (var_1_37))) < 0 ) ? -((((var_1_36) > (var_1_37)) ? (var_1_36) : (var_1_37))) : ((((var_1_36) > (var_1_37)) ? (var_1_36) : (var_1_37)))));
 }
 if (var_1_49 < var_1_47) {
  var_1_53 = (var_1_33 + var_1_34);
 }
 if (var_1_44) {
  if (var_1_46) {
   var_1_54 = (((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) + var_1_47);
  }
 }
 if ((16 * var_1_34) > ((((var_1_43) > (var_1_32)) ? (var_1_43) : (var_1_32)))) {
  if (var_1_51 >= (var_1_54 ^ -100)) {
   var_1_55 = (var_1_45 || var_1_56);
  }
 } else {
  if (var_1_44 && var_1_45) {
   if (var_1_30 <= ((- var_1_52) + var_1_37)) {
    var_1_55 = (! var_1_45);
   } else {
    var_1_55 = var_1_56;
   }
  } else {
   var_1_55 = (var_1_45 || var_1_46);
  }
 }
 if ((var_1_32 & var_1_50) < 10000000) {
  var_1_57 = ((var_1_45 && var_1_46) || var_1_58);
 } else {
  var_1_57 = (var_1_55 || var_1_56);
 }
 if (var_1_43 <= (var_1_53 & (~ var_1_50))) {
  var_1_59 = var_1_53;
 } else {
  var_1_59 = var_1_54;
 }
 if (var_1_57) {
  var_1_60 = (((((((200 - var_1_34) < 0 ) ? -(200 - var_1_34) : (200 - var_1_34))) < 0 ) ? -((((200 - var_1_34) < 0 ) ? -(200 - var_1_34) : (200 - var_1_34))) : ((((200 - var_1_34) < 0 ) ? -(200 - var_1_34) : (200 - var_1_34)))));
 } else {
  var_1_60 = var_1_49;
 }
 if (last_1_var_1_15) {
