...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch80Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch80Filler_PE_CN
	if ((var_1_17 <= (- var_1_16)) && var_1_19) {
		var_1_18 = var_1_10;
	}


	// From: Req7Batch80Filler_PE_CN
	if (var_1_19) {
	...
	// From: CodeObject3
	if (var_1_33) {
		var_1_32 = ((var_1_34 + (min (var_1_35 , var_1_36))) - ((var_1_26 + var_1_25) + (min (1000000000u , var_1_37))));
	}
	...
	if ((var_1_35 | var_1_32) > var_1_26) {
		if (var_1_29 <= (abs (var_1_28))) {
			var_1_38 = (min (var_1_25 , ((abs (var_1_39)) - var_1_36)));
		} else {
			if (var_1_39 > (abs (var_1_32))) {
				var_1_38 = var_1_39;
			} else {
	...
	if ((min ((var_1_30 * var_1_24) , var_1_29)) >= (- var_1_27)) {
		if (var_1_35 > var_1_34) {
			var_1_40 = (8 + (min (var_1_41 , var_1_42)));
		} else {
			var_1_40 = var_1_43;
		}
	}
