...
void step(void) {
 ...
 if (float_Array_0[0] > float_Array_0[1]) {
  ...
  double_Array_0[0][1] = ((((double_Array_0[1][1]) > (((((double_Array_0[0][0]) > (double_Array_0[1][0])) ? (double_Array_0[0][0]) : (double_Array_0[1][0]))))) ? (double_Array_0[1][1]) : (((((double_Array_0[0][0]) > (double_Array_0[1][0])) ? (double_Array_0[0][0]) : (double_Array_0[1][0]))))));
 }
 unsigned char stepLocal_0 = double_Array_0[0][1] > double_Array_0[0][1];
 if (stepLocal_0 && BOOL_unsigned_char_Array_0[1]) {
  if (((((double_Array_0[0][1]) > ((- double_Array_0[0][1]))) ? (double_Array_0[0][1]) : ((- double_Array_0[0][1])))) != double_Array_0[0][1]) {
