...
void step(void) {
	// From: Req1Batch23stepLocals
	if (var_1_2) {
		var_1_1 = var_1_3;
	}


	// From: Req2Batch23stepLocals
	...
	// From: Req4Batch23stepLocals
	if ((- (var_1_13 / var_1_17)) > var_1_15) {
		var_1_18 = var_1_13;
	}


	// From: Req5Batch23stepLocals
	...
	// From: Req7Batch23stepLocals
	var_1_23 = var_1_10;


	// From: Req8Batch23stepLocals
	var_1_24 = 31.75f;


	// From: Req9Batch23stepLocals
	var_1_25 = -5;
}
...
int property() {
	return ((((((((var_1_2 ? (var_1_1 == ((unsigned char) var_1_3)) : 1) && (((var_1_5 <= var_1_6) || var_1_2) ? (var_1_4 == ((float) (max (31.5f , (min (var_1_7 , var_1_8)))))) : (var_1_4 == ((float) ((var_1_9 - var_1_10) - var_1_11))))) && ((((200 - var_1_13) - var_1_14) != var_1_15) ? (var_1_12 == ((signed long int) (var_1_13 + (min (var_1_14 , var_1_16))))) : (((var_1_15 / (128 - var_1_17)) < var_1_13) ? ((var_1_13 >= var_1_15) ? (var_1_12 == ((signed long int) var_1_14)) : (var_1_12 == ((signed long int) var_1_17))) : (var_1_12 == ((signed long int) var_1_17))))) && (((- (var_1_13 / var_1_17)) > var_1_15) ? (var_1_18 == ((unsigned long int) var_1_13)) : 1)) && (((var_1_16 / (min (var_1_17 , var_1_20))) > var_1_18) ? (var_1_19 == ((signed char) (max (var_1_17 , var_1_13)))) : (var_1_19 == ((signed char) var_1_17)))) && ((5 <= var_1_17) ? (var_1_21 == ((unsigned short int) (var_1_22 - var_1_17))) : (var_1_1 ? (var_1_2 ? (var_1_21 == ((unsigned short int) var_1_17)) : (var_1_21 == ((unsigned short int) var_1_17))) : 1))) && (var_1_23 == ((double) var_1_10))) && (var_1_24 == ((float) 31.75f))) && (var_1_25 == ((signed char) -5))
;
}
int main(void) {
	isInitial = 1;
