...
void step(void) {
	...
	// From: Req3Batch36Wrapper_P
	if ((*(var_1_5_Pointer)) > (*(var_1_3_Pointer))) {
		(*(var_1_10_Pointer)) = 4.6;
	} else {
		(*(var_1_10_Pointer)) = (max ((*(var_1_11_Pointer)) , (max ((*(var_1_12_Pointer)) , (*(var_1_13_Pointer))))));
	}


	// From: Req1Batch36Wrapper_P
