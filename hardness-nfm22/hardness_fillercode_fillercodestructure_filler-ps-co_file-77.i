...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch77Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_23 = var_1_22;
 if (var_1_1 >= (var_1_10 & (var_1_22 >> var_1_8))) {
  var_1_24 = (var_1_22 - ((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))));
 } else {
  if (var_1_1 > (var_1_10 ^ var_1_22)) {
   var_1_24 = ((((var_1_1) < (var_1_10)) ? (var_1_1) : (var_1_10)));
  }
 }
 if (var_1_10 >= (-128 & var_1_13)) {
 ...
 if (var_1_15) {
  ...
  if (! var_1_15) {
   if ((var_1_1 % var_1_32) <= var_1_1) {
    var_1_30 = (var_1_33 - ((((var_1_34) > ((var_1_35 - var_1_36))) ? (var_1_34) : ((var_1_35 - var_1_36)))));
   }
  }
 }
 if (((((var_1_1) > (var_1_10)) ? (var_1_1) : (var_1_10))) > var_1_32) {
  if (! var_1_15) {
   if (var_1_15) {
