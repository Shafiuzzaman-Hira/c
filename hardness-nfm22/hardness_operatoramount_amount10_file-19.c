...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch19Amount10.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch19Amount10
	if (var_1_2) {
		if ((var_1_3 / (var_1_4 + var_1_5)) < var_1_6) {
			var_1_1 = (max (var_1_7 , ((max (var_1_8 , var_1_9)) + -4)));
		} else {
			var_1_1 = var_1_9;
		}
	}
...
int property() {
	return var_1_2 ? (((var_1_3 / (var_1_4 + var_1_5)) < var_1_6) ? (var_1_1 == ((signed short int) (max (var_1_7 , ((max (var_1_8 , var_1_9)) + -4))))) : (var_1_1 == ((signed short int) var_1_9))) : 1
;
}
int main(void) {
	isInitial = 1;
