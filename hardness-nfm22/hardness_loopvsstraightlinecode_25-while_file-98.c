...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch9825_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch9825_while
	var_1_18 = var_1_6;


	// From: Req2Batch9825_while
