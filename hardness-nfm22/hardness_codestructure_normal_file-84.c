...
void step(void) {
	// From: Req1Batch84normal
	if (var_1_2) {
		var_1_1 = (min ((var_1_3 + (1 - var_1_4)) , var_1_5));
	}


	// From: Req2Batch84normal
	...
	// From: Req5Batch84normal
	if ((~ var_1_3) < var_1_14) {
		var_1_13 = (max ((var_1_4 + var_1_3) , -5));
	}


	// From: Req6Batch84normal
	if (((var_1_4 + var_1_14) & var_1_7) <= (var_1_10 - (min (var_1_11 , var_1_16)))) {
	...
	// From: Req7Batch84normal
	var_1_18 = var_1_17;


	// From: Req8Batch84normal
	var_1_19 = 0;


	// From: Req9Batch84normal
	var_1_20 = var_1_21;
}
