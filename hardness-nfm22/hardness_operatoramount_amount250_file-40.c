...
void step(void) {
	...
	if (((var_1_15 + var_1_17) + var_1_16) >= (var_1_12 / (min (var_1_18 , var_1_32)))) {
		var_1_31 = (min (16 , var_1_21));
	}


	// From: Req17Batch40Amount250
	if (var_1_35 < (min (var_1_34 , var_1_4))) {
		if (((min (256.6f , var_1_10)) / var_1_16) > var_1_15) {
			var_1_58 = (max (var_1_10 , var_1_13));
		}
	} else {
		var_1_58 = var_1_17;
	}
	...
	if ((last_1_var_1_20 / (var_1_3 + var_1_4)) == (min (8 , last_1_var_1_41))) {
	...
	if ((var_1_22 / var_1_21) > (-25 / var_1_3)) {
		...
		var_1_45 = ((var_1_47 - 1) + (max (var_1_43 , var_1_4)));
	}
	...
	if (stepLocal_1 < var_1_3) {
		if (var_1_36) {
			if (var_1_12 >= var_1_1) {
				if (var_1_12 >= var_1_1) {
					var_1_24 = ((min (var_1_26 , (var_1_27 + var_1_28))) - 128u);
				}
			} else {
		...
		if (var_1_26 > stepLocal_0) {
			var_1_24 = ((min (var_1_55 , 100000u)) + var_1_27);
		} else {
			var_1_24 = var_1_23;
		}
	}
	...
	if ((- (var_1_23 * var_1_4)) < stepLocal_2) {
		if (var_1_58 < (var_1_15 + var_1_1)) {
			var_1_30 = (max (var_1_34 , (min ((min (var_1_21 , var_1_3)) , var_1_23))));
		} else {
			if ((var_1_4 >> var_1_23) > stepLocal_3) {
				var_1_30 = ((min (var_1_4 , (var_1_34 - var_1_3))) + var_1_23);
			}
		}
	} else {
	...
	if (var_1_1 < var_1_1) {
		...
		if ((min (var_1_11 , var_1_18)) <= var_1_1) {
			var_1_33 = (min ((var_1_30 + var_1_30) , (min (var_1_22 , (var_1_31 + var_1_21)))));
		} else {
	...
	if ((last_1_var_1_56 == var_1_24) || stepLocal_19) {
		var_1_56 = (min (((var_1_33 + var_1_24) + var_1_23) , ((abs (var_1_47)) - var_1_44)));
	} else {
		if (var_1_13 <= var_1_16) {
			var_1_56 = (max (var_1_21 , var_1_23));
		} else {
			var_1_56 = ((min (var_1_54 , var_1_44)) - (min (var_1_47 , var_1_3)));
		}
	}
	...
	if (var_1_36) {
		if (var_1_1 > var_1_14) {
			var_1_20 = (var_1_21 - (min (var_1_4 , (abs (var_1_22)))));
		} else {
			var_1_20 = ((min (128 , var_1_21)) - var_1_23);
		}
	}
		...
		if (stepLocal_12 < var_1_44) {
			...
			if (stepLocal_16 <= var_1_44) {
				if ((var_1_16 <= var_1_15) && stepLocal_14) {
					...
					var_1_51 = (max (var_1_41 , ((var_1_54 - var_1_47) - (var_1_24 + var_1_43))));
				}
			}
		}
	}
...
int property() {
	return ((((((((((((((((((last_1_var_1_20 / (var_1_3 + var_1_4)) == (min (8 , last_1_var_1_41))) ? (((last_1_var_1_41 > last_1_var_1_20) && last_1_var_1_36) ? (((last_1_var_1_15 + last_1_var_1_15) != last_1_var_1_1) ? (var_1_1 == ((float) 8.6f)) : 1) : (((last_1_var_1_20 & last_1_var_1_41) != var_1_4) ? (last_1_var_1_36 ? (var_1_1 == ((float) (max ((var_1_10 + (max (127.3f , var_1_11))) , var_1_12)))) : 1) : (var_1_1 == ((float) ((max (31.5f , var_1_13)) - var_1_14))))) : 1) && ((-16 != (last_1_var_1_56 - var_1_3)) ? (var_1_15 == ((float) ((min ((var_1_16 - var_1_17) , (var_1_18 - 9.2f))) - var_1_13))) : ((((var_1_18 - var_1_17) * var_1_12) != (63.25f + last_1_var_1_58)) ? (var_1_15 == ((float) (min ((max (var_1_18 , 64.625f)) , var_1_14)))) : (last_1_var_1_36 ? (var_1_15 == ((float) var_1_11)) : (var_1_15 == ((float) var_1_11)))))) && (var_1_36 ? ((var_1_1 > var_1_14) ? (var_1_20 == ((unsigned char) (var_1_21 - (min (var_1_4 , (abs (var_1_22))))))) : (var_1_20 == ((unsigned char) ((min (128 , var_1_21)) - var_1_23)))) : 1)) && (((- var_1_4) < var_1_3) ? (var_1_36 ? ((var_1_12 >= var_1_1) ? ((var_1_12 >= var_1_1) ? (var_1_24 == ((unsigned long int) ((min (var_1_26 , (var_1_27 + var_1_28))) - 128u))) : 1) : (var_1_24 == ((unsigned long int) (var_1_4 + var_1_22)))) : 1) : ((var_1_26 > (var_1_31 + var_1_22)) ? (var_1_24 == ((unsigned long int) ((min (var_1_55 , 100000u)) + var_1_27))) : (var_1_24 == ((unsigned long int) var_1_23))))) && (((- (var_1_23 * var_1_4)) < var_1_22) ? ((var_1_58 < (var_1_15 + var_1_1)) ? (var_1_30 == ((signed short int) (max (var_1_34 , (min ((min (var_1_21 , var_1_3)) , var_1_23)))))) : (((var_1_4 >> var_1_23) > ((1 - var_1_21) / 100)) ? (var_1_30 == ((signed short int) ((min (var_1_4 , (var_1_34 - var_1_3))) + var_1_23))) : 1)) : ((var_1_34 > var_1_55) ? (var_1_30 == ((signed short int) var_1_34)) : (var_1_30 == ((signed short int) var_1_34))))) && ((((var_1_15 + var_1_17) + var_1_16) >= (var_1_12 / (min (var_1_18 , var_1_32)))) ? (var_1_31 == ((unsigned char) (min (16 , var_1_21)))) : 1)) && ((var_1_1 < var_1_1) ? (var_1_33 == ((signed long int) (var_1_4 - var_1_22))) : (((min (var_1_11 , var_1_18)) <= var_1_1) ? (var_1_33 == ((signed long int) (min ((var_1_30 + var_1_30) , (min (var_1_22 , (var_1_31 + var_1_21))))))) : (var_1_33 == ((signed long int) ((var_1_4 - var_1_23) + var_1_41)))))) && (((var_1_21 - var_1_23) != 2) ? (var_1_34 == ((signed short int) var_1_21)) : (var_1_34 == ((signed short int) (abs (last_1_var_1_35)))))) && (var_1_35 == ((signed short int) (var_1_34 + var_1_21)))) && (((- var_1_31) == var_1_35) ? (((58871 - var_1_41) > (32 + var_1_3)) ? (var_1_36 == ((unsigned char) (! var_1_37))) : (var_1_36 == ((unsigned char) (var_1_37 && var_1_38)))) : ((((-256 / var_1_21) << var_1_55) >= var_1_27) ? ((var_1_35 >= var_1_34) ? ((var_1_17 < (var_1_10 + 1.0000000098E8f)) ? (var_1_36 == ((unsigned char) ((var_1_38 || var_1_39) || var_1_40))) : 1) : (var_1_36 == ((unsigned char) var_1_37))) : (var_1_36 == ((unsigned char) var_1_40))))) && ((last_1_var_1_41 >= var_1_28) ? (var_1_41 == ((unsigned char) (((var_1_42 - var_1_43) + var_1_44) + 1))) : (((var_1_16 * var_1_58) >= (var_1_58 / 0.75f)) ? (var_1_41 == ((unsigned char) var_1_21)) : (var_1_41 == ((unsigned char) (var_1_23 + var_1_22)))))) && (((var_1_22 / var_1_21) > (-25 / var_1_3)) ? (var_1_45 == ((unsigned char) (var_1_44 + var_1_46))) : (var_1_45 == ((unsigned char) ((var_1_47 - 1) + (max (var_1_43 , var_1_4))))))) && ((last_1_var_1_48 < (- (var_1_3 + var_1_47))) ? ((! (var_1_24 > last_1_var_1_48)) ? (var_1_48 == ((unsigned long int) var_1_33)) : 1) : 1)) && ((var_1_45 >= (abs (var_1_31))) ? (((var_1_21 - var_1_4) != var_1_24) ? (var_1_51 == ((signed short int) (abs (var_1_44)))) : (var_1_51 == ((signed short int) ((max (var_1_3 , var_1_48)) + var_1_47)))) : ((var_1_42 < var_1_44) ? ((var_1_35 < (~ (var_1_22 + var_1_46))) ? (var_1_51 == ((signed short int) ((max (var_1_42 , var_1_43)) - var_1_41))) : (var_1_51 == ((signed short int) ((var_1_45 - 8) + var_1_43)))) : ((var_1_47 <= var_1_44) ? (((var_1_16 <= var_1_15) && var_1_37) ? (var_1_51 == ((signed short int) var_1_44)) : (var_1_51 == ((signed short int) (max (var_1_41 , ((var_1_54 - var_1_47) - (var_1_24 + var_1_43))))))) : 1)))) && ((-32 > var_1_42) ? (var_1_55 == ((signed long int) (var_1_23 + var_1_22))) : (var_1_55 == ((signed long int) var_1_47)))) && (((last_1_var_1_56 == var_1_24) || var_1_37) ? (var_1_56 == ((signed short int) (min (((var_1_33 + var_1_24) + var_1_23) , ((abs (var_1_47)) - var_1_44))))) : ((var_1_13 <= var_1_16) ? (var_1_56 == ((signed short int) (max (var_1_21 , var_1_23)))) : (var_1_56 == ((signed short int) ((min (var_1_54 , var_1_44)) - (min (var_1_47 , var_1_3)))))))) && ((var_1_35 < (min (var_1_34 , var_1_4))) ? ((((min (256.6f , var_1_10)) / var_1_16) > var_1_15) ? (var_1_58 == ((double) (max (var_1_10 , var_1_13)))) : 1) : (var_1_58 == ((double) var_1_17)))
;
}
int main(void) {
	isInitial = 1;
