...
void step(void) {
 ...
 if (var_1_39 <= var_1_45) {
  var_1_44 = (var_1_38 + (((((((var_1_42) > (-1)) ? (var_1_42) : (-1))) < 0 ) ? -((((var_1_42) > (-1)) ? (var_1_42) : (-1))) : ((((var_1_42) > (-1)) ? (var_1_42) : (-1))))));
 }
 if (((~ var_1_41) >> ((((var_1_47) > (var_1_48)) ? (var_1_47) : (var_1_48)))) >= var_1_32) {
  var_1_46 = (var_1_49 - var_1_47);
 }
 var_1_50 = var_1_51;
 if ((~ var_1_41) > var_1_44) {
  var_1_52 = ((((((var_1_47 + var_1_45) - ((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39))))) < (var_1_38)) ? (((var_1_47 + var_1_45) - ((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39))))) : (var_1_38)));
 } else {
  var_1_52 = ((((var_1_39) < (var_1_35)) ? (var_1_39) : (var_1_35)));
 }
 var_1_53 = var_1_47;
