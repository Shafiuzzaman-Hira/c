...
void step(void) {
	// From: Req2Batch51Wrapper_P
	unsigned long int stepLocal_1 = - last_1_var_1_17;
	if (((max ((*(var_1_11_Pointer)) , (*(var_1_12_Pointer)))) - (*(var_1_13_Pointer))) != stepLocal_1) {
		(*(var_1_10_Pointer)) = ((min ((*(var_1_15_Pointer)) , (*(var_1_16_Pointer)))) - (*(var_1_13_Pointer)));
	} else {
		(*(var_1_10_Pointer)) = (*(var_1_15_Pointer));
	}


	// From: Req3Batch51Wrapper_P
	if ((*(var_1_10_Pointer)) <= (*(var_1_10_Pointer))) {
		if ((*(var_1_2_Pointer)) && ((*(var_1_10_Pointer)) == (max ((*(var_1_16_Pointer)) , (*(var_1_12_Pointer)))))) {
	...
	if ((*(var_1_2_Pointer))) {
		if (stepLocal_0 >= ((*(var_1_10_Pointer)) / (*(var_1_5_Pointer)))) {
			...
			(*(var_1_1_Pointer)) = ((*(var_1_7_Pointer)) + (max ((*(var_1_8_Pointer)) , ((*(var_1_9_Pointer)) + 63.25))));
		}
	} else {
...
int property() {
	return (((*(var_1_2_Pointer)) ? (((*(var_1_10_Pointer)) >= ((*(var_1_10_Pointer)) / (*(var_1_5_Pointer)))) ? ((*(var_1_1_Pointer)) == ((double) (abs ((*(var_1_6_Pointer)))))) : ((*(var_1_1_Pointer)) == ((double) ((*(var_1_7_Pointer)) + (max ((*(var_1_8_Pointer)) , ((*(var_1_9_Pointer)) + 63.25))))))) : ((*(var_1_1_Pointer)) == ((double) (*(var_1_8_Pointer))))) && ((((max ((*(var_1_11_Pointer)) , (*(var_1_12_Pointer)))) - (*(var_1_13_Pointer))) != (- last_1_var_1_17)) ? ((*(var_1_10_Pointer)) == ((unsigned long int) ((min ((*(var_1_15_Pointer)) , (*(var_1_16_Pointer)))) - (*(var_1_13_Pointer))))) : ((*(var_1_10_Pointer)) == ((unsigned long int) (*(var_1_15_Pointer)))))) && (((*(var_1_10_Pointer)) <= (*(var_1_10_Pointer))) ? (((*(var_1_2_Pointer)) && ((*(var_1_10_Pointer)) == (max ((*(var_1_16_Pointer)) , (*(var_1_12_Pointer)))))) ? (((*(var_1_10_Pointer)) < (*(var_1_11_Pointer))) ? ((*(var_1_17_Pointer)) == ((unsigned long int) (*(var_1_15_Pointer)))) : 1) : 1) : ((*(var_1_17_Pointer)) == ((unsigned long int) (*(var_1_16_Pointer)))))
;
}
int main(void) {
	isInitial = 1;
