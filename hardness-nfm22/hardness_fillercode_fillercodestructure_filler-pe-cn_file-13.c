...
void step(void) {
	...
	// From: Req2Batch13Filler_PE_CN
	if (var_1_9) {
		var_1_8 = (var_1_10 - (var_1_11 - var_1_4));
	}


	// From: Req4Batch13Filler_PE_CN
	...
	// From: Req6Batch13Filler_PE_CN
	if (((- var_1_11) < 8) || var_1_9) {
		var_1_22 = (var_1_4 + (abs (var_1_11)));
	}


	// From: Req7Batch13Filler_PE_CN
	var_1_23 = (var_1_11 + var_1_4);


	// From: Req8Batch13Filler_PE_CN
