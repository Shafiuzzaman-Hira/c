...
void step(void) {
	...
	if (stepLocal_17 <= var_1_42) {
		if (var_1_39 < stepLocal_16) {
			...
			if (last_1_var_1_98 < stepLocal_19) {
				...
				if ((min (last_1_var_1_62 , last_1_var_1_89)) != stepLocal_15) {
	...
	signed long int stepLocal_6 = (last_1_var_1_43 / var_1_4) * (max (var_1_9 , last_1_var_1_62));
	if (((last_1_var_1_90 + 10u) * last_1_var_1_43) < stepLocal_6) {
		var_1_16 = ((32u + last_1_var_1_43) + (min (last_1_var_1_43 , last_1_var_1_41)));
	}


	// From: Req15Batch4Amount500
	signed long int stepLocal_14 = max ((var_1_37 - last_1_var_1_8) , var_1_27);
	...
	signed long int stepLocal_25 = abs (var_1_63);
	signed long int stepLocal_24 = last_1_var_1_62 - (var_1_68 - var_1_64);
	signed long int stepLocal_23 = (max (last_1_var_1_83 , var_1_9)) / (var_1_66 - var_1_4);
	if (0u <= stepLocal_25) {
		if (stepLocal_23 <= last_1_var_1_88) {
			var_1_65 = ((max ((max (var_1_39 , var_1_63)) , var_1_42)) + last_1_var_1_10);
		} else {
			var_1_65 = (max ((var_1_67 - (abs (var_1_44))) , last_1_var_1_17));
		}
	} else {
		if (stepLocal_24 <= -25) {
			if (last_1_var_1_33 < 16.6f) {
				var_1_65 = ((max (last_1_var_1_1 , var_1_36)) + (var_1_9 + (max (last_1_var_1_81 , var_1_68))));
			} else {
				var_1_65 = (max (last_1_var_1_62 , (var_1_67 - (var_1_69 - last_1_var_1_43))));
			}
		}
	}
	...
	if (((var_1_65 / var_1_44) % var_1_38) <= var_1_64) {
		var_1_70 = ((max (var_1_45 , var_1_39)) + last_1_var_1_70);
	} else {
	...
	if (stepLocal_26 < (max (var_1_88 , var_1_68))) {
		var_1_73 = (256u + 16u);
	} else {
		var_1_73 = (var_1_69 + (var_1_74 - (abs (var_1_43))));
	}
	...
	if (! (var_1_81 >= var_1_88)) {
		var_1_89 = (min (-128 , (max (var_1_34 , var_1_65))));
	}
	...
	if (var_1_63 < last_1_var_1_77) {
		var_1_77 = (max ((max (var_1_62 , var_1_64)) , var_1_44));
	} else {
	...
	if ((~ (min (var_1_37 , var_1_41))) >= stepLocal_20) {
		if (((abs (var_1_97)) - var_1_53) > (var_1_91 * var_1_46)) {
	...
	if ((var_1_35 * var_1_41) <= last_1_var_1_80) {
		var_1_80 = (min (var_1_87 , var_1_27));
	} else {
		if (var_1_91 > 0.66f) {
			var_1_80 = ((max (var_1_39 , var_1_35)) + var_1_22);
		}
	}
	...
	if (var_1_4 <= stepLocal_4) {
		if (((min (64513 , var_1_9)) - var_1_4) >= stepLocal_3) {
			var_1_8 = (max (var_1_41 , var_1_22));
		} else {
			var_1_8 = (var_1_83 - (abs (var_1_4)));
		}
	} else {
		var_1_8 = var_1_83;
	}
	...
	if (var_1_69 == stepLocal_32) {
		if ((- var_1_8) < stepLocal_31) {
			...
			if (var_1_85 == ((min (64.25 , var_1_85)) + (- var_1_48))) {
	...
	if (var_1_13) {
		if ((var_1_4 - (abs (var_1_94))) < (var_1_9 * var_1_28)) {
			var_1_17 = (((var_1_83 + var_1_98) + var_1_41) + var_1_62);
		}
	} else {
		var_1_17 = ((max (-2 , -128)) + (var_1_62 - (10000 - var_1_34)));
	}


	// From: Req3Batch4Amount500
	if ((abs (var_1_57)) > var_1_98) {
		if (var_1_4 > var_1_93) {
	...
	if (var_1_59 || stepLocal_37) {
		var_1_90 = (max (((min (var_1_96 , -16)) + var_1_34) , var_1_98));
	} else {
		if (stepLocal_36 && var_1_13) {
			var_1_90 = (max ((var_1_34 + var_1_64) , var_1_42));
		} else {
				...
				if (stepLocal_38 < var_1_64) {
					if (var_1_49 != var_1_86) {
						if (var_1_13) {
							...
							var_1_90 = (max (var_1_65 , var_1_34));
						}
					} else {
						var_1_90 = var_1_34;
					}
	...
	if (stepLocal_21 < 1) {
		var_1_61 = ((min (var_1_42 , var_1_4)) + (max (var_1_90 , (max (var_1_35 , var_1_41)))));
	} else {
...
int property() {
	return ((((((((((((((((((((((((((((((((((((((((((((((((var_1_41 <= var_1_70) ? (((- var_1_70) > var_1_41) ? (var_1_1 == ((signed short int) ((var_1_4 - var_1_41) - var_1_62))) : 1) : (((var_1_41 * (var_1_70 + var_1_4)) > var_1_62) ? (var_1_1 == ((signed short int) (var_1_41 + var_1_34))) : (var_1_1 == ((signed short int) var_1_62)))) && ((var_1_4 <= var_1_41) ? ((((min (64513 , var_1_9)) - var_1_4) >= (5 * var_1_41)) ? (var_1_8 == ((signed long int) (max (var_1_41 , var_1_22)))) : (var_1_8 == ((signed long int) (var_1_83 - (abs (var_1_4)))))) : (var_1_8 == ((signed long int) var_1_83)))) && (((abs (var_1_57)) > var_1_98) ? ((var_1_4 > var_1_93) ? (((var_1_9 >= (var_1_4 * var_1_17)) && var_1_75) ? (var_1_10 == ((signed short int) (var_1_4 - 500))) : 1) : (var_1_10 == ((signed short int) var_1_4))) : (var_1_10 == ((signed short int) var_1_4)))) && ((var_1_70 < var_1_34) ? (var_1_12 == ((unsigned char) (! var_1_13))) : (var_1_12 == ((unsigned char) (var_1_13 && var_1_14))))) && (var_1_15 == ((unsigned char) (! var_1_14)))) && ((((last_1_var_1_90 + 10u) * last_1_var_1_43) < ((last_1_var_1_43 / var_1_4) * (max (var_1_9 , last_1_var_1_62)))) ? (var_1_16 == ((unsigned long int) ((32u + last_1_var_1_43) + (min (last_1_var_1_43 , last_1_var_1_41))))) : 1)) && (var_1_13 ? (((var_1_4 - (abs (var_1_94))) < (var_1_9 * var_1_28)) ? (var_1_17 == ((signed short int) (((var_1_83 + var_1_98) + var_1_41) + var_1_62))) : 1) : (var_1_17 == ((signed short int) ((max (-2 , -128)) + (var_1_62 - (10000 - var_1_34))))))) && (((var_1_85 * (var_1_24 - 255.7f)) == var_1_91) ? (var_1_22 == ((signed char) (abs (var_1_26)))) : (var_1_22 == ((signed char) (min (var_1_26 , var_1_27)))))) && ((last_1_var_1_28 == (var_1_16 & var_1_83)) ? ((var_1_34 <= var_1_62) ? (var_1_28 == ((unsigned long int) (3421856207u - (var_1_34 + (var_1_9 + var_1_4))))) : (var_1_13 ? (var_1_28 == ((unsigned long int) (8u + var_1_34))) : (var_1_28 == ((unsigned long int) ((var_1_34 + var_1_34) + var_1_4))))) : 1)) && ((var_1_16 == var_1_41) ? (var_1_29 == ((float) (var_1_30 + (min (var_1_31 , var_1_32))))) : ((var_1_57 < var_1_4) ? (var_1_29 == ((float) (abs (var_1_32)))) : (var_1_29 == ((float) var_1_32))))) && ((((var_1_83 * var_1_4) > var_1_65) && var_1_13) ? (var_1_33 == ((float) (min (var_1_31 , (var_1_32 + 9.9999999999965E11f))))) : 1)) && ((last_1_var_1_87 >= last_1_var_1_87) ? (var_1_34 == ((unsigned char) (var_1_35 + (min ((1 + var_1_36) , var_1_37))))) : (var_1_34 == ((unsigned char) (((var_1_38 + 100) - (max (var_1_36 , var_1_39))) - var_1_37))))) && (var_1_40 == ((unsigned short int) var_1_4))) && ((last_1_var_1_1 <= last_1_var_1_22) ? (last_1_var_1_59 ? (var_1_41 == ((unsigned char) ((var_1_36 + var_1_39) + var_1_37))) : (var_1_13 ? (var_1_41 == ((unsigned char) (max (var_1_39 , var_1_37)))) : (var_1_41 == ((unsigned char) (max ((abs (25 + var_1_35)) , var_1_38)))))) : (var_1_41 == ((unsigned char) (var_1_37 + (max (var_1_36 , (var_1_39 + var_1_42)))))))) && ((((100 + var_1_38) - (var_1_44 - var_1_36)) > (max ((var_1_37 - last_1_var_1_8) , var_1_27))) ? (last_1_var_1_84 ? (var_1_43 == ((unsigned char) var_1_38)) : (var_1_43 == ((unsigned char) (var_1_36 + (var_1_44 - var_1_39))))) : (var_1_43 == ((unsigned char) ((var_1_44 + (var_1_38 - var_1_45)) - var_1_37))))) && (((last_1_var_1_61 + (2 - var_1_36)) <= var_1_42) ? ((var_1_39 < last_1_var_1_70) ? (var_1_46 == ((float) (max (((max (var_1_32 , var_1_30)) + (9.6f - var_1_48)) , (min (var_1_31 , var_1_49)))))) : ((last_1_var_1_98 < var_1_27) ? (var_1_46 == ((float) (499.45f - ((var_1_50 - var_1_51) + var_1_48)))) : (((min (last_1_var_1_62 , last_1_var_1_89)) != (var_1_42 - var_1_35)) ? (var_1_46 == ((float) (min (var_1_30 , (var_1_50 - (var_1_53 - var_1_48)))))) : ((last_1_var_1_12 && var_1_13) ? (var_1_46 == ((float) (min (var_1_51 , (max (var_1_48 , (var_1_50 + var_1_31))))))) : 1)))) : ((last_1_var_1_33 <= var_1_32) ? (var_1_46 == ((float) (abs (var_1_50 + var_1_48)))) : 1))) && (((~ (min (var_1_37 , var_1_41))) >= (var_1_36 * (var_1_65 + var_1_89))) ? ((((abs (var_1_97)) - var_1_53) > (var_1_91 * var_1_46)) ? (var_1_54 == ((unsigned char) (var_1_55 || var_1_56))) : (var_1_54 == ((unsigned char) ((! var_1_55) && var_1_14)))) : 1)) && ((last_1_var_1_29 != ((var_1_58 - var_1_50) - var_1_51)) ? (var_1_57 == ((signed short int) ((var_1_45 + 5) + (var_1_36 + last_1_var_1_65)))) : 1)) && (var_1_59 == ((unsigned char) (! var_1_14)))) && (((max (var_1_32 , var_1_49)) <= (var_1_50 / var_1_58)) ? (var_1_60 == ((signed char) (max (var_1_42 , (abs (var_1_39 - var_1_45)))))) : 1)) && ((var_1_92 < 1) ? (var_1_61 == ((unsigned long int) ((min (var_1_42 , var_1_4)) + (max (var_1_90 , (max (var_1_35 , var_1_41))))))) : ((var_1_45 > var_1_39) ? (var_1_61 == ((unsigned long int) (var_1_62 + var_1_4))) : 1))) && ((var_1_50 != last_1_var_1_29) ? (var_1_62 == ((unsigned char) (max ((var_1_63 - var_1_37) , (var_1_64 - var_1_36))))) : 1)) && ((0u <= (abs (var_1_63))) ? ((((max (last_1_var_1_83 , var_1_9)) / (var_1_66 - var_1_4)) <= last_1_var_1_88) ? (var_1_65 == ((unsigned long int) ((max ((max (var_1_39 , var_1_63)) , var_1_42)) + last_1_var_1_10))) : (var_1_65 == ((unsigned long int) (max ((var_1_67 - (abs (var_1_44))) , last_1_var_1_17))))) : (((last_1_var_1_62 - (var_1_68 - var_1_64)) <= -25) ? ((last_1_var_1_33 < 16.6f) ? (var_1_65 == ((unsigned long int) ((max (last_1_var_1_1 , var_1_36)) + (var_1_9 + (max (last_1_var_1_81 , var_1_68)))))) : (var_1_65 == ((unsigned long int) (max (last_1_var_1_62 , (var_1_67 - (var_1_69 - last_1_var_1_43))))))) : 1))) && ((((var_1_65 / var_1_44) % var_1_38) <= var_1_64) ? (var_1_70 == ((unsigned long int) ((max (var_1_45 , var_1_39)) + last_1_var_1_70))) : (var_1_70 == ((unsigned long int) (var_1_67 - (var_1_69 - 25u)))))) && (((var_1_101 / var_1_53) < var_1_58) ? (var_1_71 == ((double) ((max (var_1_50 , 2.75)) + var_1_51))) : 1)) && (((var_1_92 + 5) < (max (var_1_88 , var_1_68))) ? (var_1_73 == ((unsigned long int) (256u + 16u))) : (var_1_73 == ((unsigned long int) (var_1_69 + (var_1_74 - (abs (var_1_43)))))))) && ((var_1_30 <= (var_1_51 * (var_1_91 * var_1_50))) ? ((4u < var_1_28) ? ((4 < var_1_69) ? (var_1_75 == ((unsigned char) (var_1_13 && var_1_56))) : 1) : ((var_1_42 != var_1_22) ? (var_1_13 ? (var_1_75 == ((unsigned char) ((var_1_28 == var_1_73) || var_1_14))) : (var_1_75 == ((unsigned char) (var_1_14 && (var_1_15 && var_1_56))))) : 1)) : (((var_1_40 == (var_1_62 / var_1_64)) || var_1_56) ? (var_1_75 == ((unsigned char) (((var_1_42 * var_1_57) > -32) && (! var_1_14)))) : (var_1_75 == ((unsigned char) (var_1_84 || var_1_14)))))) && ((var_1_63 < last_1_var_1_77) ? (var_1_77 == ((unsigned short int) (max ((max (var_1_62 , var_1_64)) , var_1_44)))) : (((var_1_51 + 31.8f) >= (var_1_33 + (var_1_24 + var_1_97))) ? (var_1_77 == ((unsigned short int) (var_1_98 + (var_1_63 + (var_1_79 - var_1_45))))) : (var_1_77 == ((unsigned short int) (min (var_1_44 , var_1_35))))))) && (((var_1_35 * var_1_41) <= last_1_var_1_80) ? (var_1_80 == ((signed short int) (min (var_1_87 , var_1_27)))) : ((var_1_91 > 0.66f) ? (var_1_80 == ((signed short int) ((max (var_1_39 , var_1_35)) + var_1_22))) : 1))) && (var_1_81 == ((unsigned long int) (var_1_67 - (var_1_64 + (var_1_82 - var_1_34)))))) && (last_1_var_1_59 ? (last_1_var_1_12 ? (var_1_83 == ((unsigned char) (var_1_64 - var_1_37))) : (var_1_83 == ((unsigned char) (128 - 16)))) : ((last_1_var_1_85 >= last_1_var_1_46) ? (var_1_83 == ((unsigned char) (min (var_1_39 , var_1_45)))) : (var_1_83 == ((unsigned char) (min (var_1_35 , ((min (128 , var_1_63)) - var_1_36)))))))) && ((var_1_69 == var_1_98) ? (((- var_1_8) < var_1_82) ? (var_1_84 == ((unsigned char) (! var_1_56))) : ((var_1_85 == ((min (64.25 , var_1_85)) + (- var_1_48))) ? (((var_1_16 < var_1_64) && var_1_14) ? (var_1_84 == ((unsigned char) var_1_13)) : 1) : (var_1_84 == ((unsigned char) (var_1_14 && var_1_13))))) : ((var_1_97 <= (var_1_24 - var_1_58)) ? (var_1_84 == ((unsigned char) (! (! var_1_14)))) : (var_1_84 == ((unsigned char) (var_1_14 && var_1_13)))))) && ((((var_1_93 + 32) + (500 - var_1_74)) >= var_1_40) ? (var_1_85 == ((double) (min (var_1_32 , ((abs (31.5)) + (var_1_50 - 9999.5)))))) : (var_1_85 == ((double) (min ((min (var_1_49 , var_1_30)) , var_1_86)))))) && ((var_1_85 <= var_1_32) ? (var_1_87 == ((unsigned char) (max (var_1_38 , var_1_63)))) : ((last_1_var_1_87 > var_1_81) ? (var_1_87 == ((unsigned char) (var_1_63 - var_1_45))) : 1))) && ((var_1_31 > 32.5f) ? (var_1_88 == ((signed long int) (min (var_1_62 , -32)))) : 1)) && ((! (var_1_81 >= var_1_88)) ? (var_1_89 == ((signed short int) (min (-128 , (max (var_1_34 , var_1_65)))))) : 1)) && ((var_1_59 || var_1_56) ? (var_1_90 == ((signed short int) (max (((min (var_1_96 , -16)) + var_1_34) , var_1_98)))) : (((var_1_65 == (var_1_45 << var_1_4)) && var_1_13) ? (var_1_90 == ((signed short int) (max ((var_1_34 + var_1_64) , var_1_42)))) : ((var_1_46 < var_1_101) ? (((- var_1_73) < var_1_64) ? ((var_1_49 != var_1_86) ? (var_1_13 ? (var_1_90 == ((signed short int) ((var_1_60 + (var_1_8 + var_1_92)) + var_1_27))) : (var_1_90 == ((signed short int) (max (var_1_65 , var_1_34))))) : (var_1_90 == ((signed short int) var_1_34))) : (var_1_90 == ((signed short int) var_1_64))) : 1)))) && (var_1_91 == ((float) 64.75f))) && (last_1_var_1_54 ? (var_1_92 == ((signed char) var_1_42)) : (var_1_92 == ((signed char) var_1_36)))) && (var_1_15 ? (var_1_93 == ((signed char) var_1_36)) : (var_1_93 == ((signed char) var_1_42)))) && (var_1_84 ? (var_1_94 == ((signed char) var_1_27)) : (var_1_94 == ((signed char) var_1_39)))) && (var_1_95 == ((unsigned char) var_1_56))) && (var_1_75 ? (var_1_96 == ((signed char) var_1_39)) : (var_1_96 == ((signed char) var_1_36)))) && (var_1_14 ? (var_1_97 == ((float) var_1_49)) : (var_1_97 == ((float) var_1_86)))) && (var_1_13 ? (var_1_98 == ((unsigned char) 100)) : (var_1_98 == ((unsigned char) var_1_35)))) && (var_1_99 == ((signed short int) var_1_28))) && (var_1_15 ? (var_1_100 == ((unsigned char) var_1_44)) : (var_1_100 == ((unsigned char) var_1_35)))) && ((var_1_43 >= var_1_41) ? (((var_1_12 || var_1_12) && (1.6f > var_1_85)) ? (var_1_101 == ((double) var_1_30)) : (var_1_101 == ((double) (var_1_31 + (var_1_51 - var_1_50))))) : (var_1_101 == ((double) var_1_48)))
;
}
int main(void) {
	isInitial = 1;
