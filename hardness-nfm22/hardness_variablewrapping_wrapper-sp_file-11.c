...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_3_Pointer)) >= (*(WrapperStruct00_var_1_2_Pointer))) {
		if (last_1_WrapperStruct00_var_1_11) {
			if (! last_1_WrapperStruct00_var_1_11) {
				(*(WrapperStruct00_var_1_8_Pointer)) = (max ((*(WrapperStruct00_var_1_9_Pointer)) , (10.25f + (*(WrapperStruct00_var_1_10_Pointer)))));
			} else {
	...
	// From: Req4Batch11Wrapper_SP
	if (! (*(WrapperStruct00_var_1_11_Pointer))) {
		(*(WrapperStruct00_var_1_14_Pointer)) = (min ((min ((*(WrapperStruct00_var_1_15_Pointer)) , (max ((*(WrapperStruct00_var_1_16_Pointer)) , 5)))) , (*(WrapperStruct00_var_1_17_Pointer))));
	} else {
