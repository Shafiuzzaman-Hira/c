...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch87Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_37 > var_1_35) {
  ...
  if (var_1_37 >= var_1_40) {
   if ((var_1_34 % var_1_43) > (var_1_41 + var_1_40)) {
    ...
    if ((var_1_35 & var_1_34) <= ((((var_1_41) < (var_1_43)) ? (var_1_41) : (var_1_43)))) {
     var_1_42 = var_1_43;
    } else {
     var_1_42 = var_1_43;
    }
 ...
 if ((((((var_1_41) > (var_1_40)) ? (var_1_41) : (var_1_40))) & var_1_45) > (var_1_46 & var_1_47)) {
  var_1_44 = ((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36)));
 }
