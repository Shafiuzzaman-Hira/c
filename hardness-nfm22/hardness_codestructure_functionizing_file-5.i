...
void functionized1(unsigned char functionized1_localFunctionVar0, unsigned short int functionized1_localFunctionVar1) {
 if (functionized1_localFunctionVar0 == (functionized1_localFunctionVar1 / var_1_4)) {
  var_1_9 = ((((functionized1_localFunctionVar0) < (((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4))))) ? (functionized1_localFunctionVar0) : (((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4))))));
 } else {
...
signed long int functionized2(unsigned short int functionized2_localFunctionVar0) {
 return ((functionized2_localFunctionVar0 - var_1_5) + ((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9))));
}
void initially(void) {
}
void step(void) {
 ...
 if (((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3))) <= ((((var_1_13) > (var_1_4)) ? (var_1_13) : (var_1_4)))) {
