...
void step(void) {
 ...
 signed long int stepLocal_2 = (((256) > (last_1_var_1_12)) ? (256) : (last_1_var_1_12));
 if (last_1_var_1_30) {
 ...
 signed long int stepLocal_7 = var_1_15 - ((((var_1_16) > (var_1_28)) ? (var_1_16) : (var_1_28)));
 if (stepLocal_7 < (last_1_var_1_37 / ((((var_1_13) < (var_1_10)) ? (var_1_13) : (var_1_10))))) {
 ...
 if (var_1_1) {
  if (((((var_1_13) < (var_1_37)) ? (var_1_13) : (var_1_37))) > ((var_1_16 << var_1_37) / var_1_15)) {
