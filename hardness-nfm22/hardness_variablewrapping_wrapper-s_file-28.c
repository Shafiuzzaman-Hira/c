...
void step(void) {
	...
	// From: Req3Batch28Wrapper_S
	WrapperStruct00.var_1_11 = (max (WrapperStruct00.var_1_9 , WrapperStruct00.var_1_10));


	// From: Req5Batch28Wrapper_S
	WrapperStruct00.var_1_18 = WrapperStruct00.var_1_5;


	// From: Req6Batch28Wrapper_S
	WrapperStruct00.var_1_19 = WrapperStruct00.var_1_6;


	// From: Req1Batch28Wrapper_S
	if ((WrapperStruct00.var_1_2 - WrapperStruct00.var_1_3) <= (- WrapperStruct00.var_1_8)) {
		WrapperStruct00.var_1_1 = (min ((WrapperStruct00.var_1_5 - WrapperStruct00.var_1_6) , WrapperStruct00.var_1_7));
	} else {
		WrapperStruct00.var_1_1 = WrapperStruct00.var_1_5;
	}


	// From: Req4Batch28Wrapper_S
	signed long int stepLocal_1 = WrapperStruct00.var_1_6 | 5;
	if (stepLocal_1 <= (max (WrapperStruct00.var_1_5 , WrapperStruct00.var_1_7))) {
		WrapperStruct00.var_1_12 = ((min (WrapperStruct00.var_1_6 , (WrapperStruct00.var_1_13 - WrapperStruct00.var_1_19))) - (WrapperStruct00.var_1_15 - (abs (WrapperStruct00.var_1_5))));
	} else {
		WrapperStruct00.var_1_12 = (WrapperStruct00.var_1_6 + ((min (WrapperStruct00.var_1_19 , WrapperStruct00.var_1_19)) - WrapperStruct00.var_1_19));
	}
}
...
int property() {
	return (((((((WrapperStruct00.var_1_2 - WrapperStruct00.var_1_3) <= (- WrapperStruct00.var_1_8)) ? (WrapperStruct00.var_1_1 == ((signed char) (min ((WrapperStruct00.var_1_5 - WrapperStruct00.var_1_6) , WrapperStruct00.var_1_7)))) : (WrapperStruct00.var_1_1 == ((signed char) WrapperStruct00.var_1_5))) && ((-4 < WrapperStruct00.var_1_6) ? (WrapperStruct00.var_1_8 == ((float) (min (WrapperStruct00.var_1_9 , WrapperStruct00.var_1_10)))) : 1)) && (WrapperStruct00.var_1_11 == ((float) (max (WrapperStruct00.var_1_9 , WrapperStruct00.var_1_10))))) && (((WrapperStruct00.var_1_6 | 5) <= (max (WrapperStruct00.var_1_5 , WrapperStruct00.var_1_7))) ? (WrapperStruct00.var_1_12 == ((signed long int) ((min (WrapperStruct00.var_1_6 , (WrapperStruct00.var_1_13 - WrapperStruct00.var_1_19))) - (WrapperStruct00.var_1_15 - (abs (WrapperStruct00.var_1_5)))))) : (WrapperStruct00.var_1_12 == ((signed long int) (WrapperStruct00.var_1_6 + ((min (WrapperStruct00.var_1_19 , WrapperStruct00.var_1_19)) - WrapperStruct00.var_1_19)))))) && (WrapperStruct00.var_1_18 == ((signed short int) WrapperStruct00.var_1_5))) && (WrapperStruct00.var_1_19 == ((unsigned short int) WrapperStruct00.var_1_6))
;
}
int main(void) {
	isInitial = 1;
