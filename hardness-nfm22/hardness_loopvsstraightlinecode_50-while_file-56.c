...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch5650_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch5650_while
	var_1_12 = ((64 + var_1_13) - var_1_14);


	// From: Req5Batch5650_while
	var_1_15 = ((var_1_16 - var_1_17) - 10);


	// From: Req6Batch5650_while
	if (var_1_1) {
		var_1_18 = (var_1_16 - var_1_13);
	}


	// From: Req7Batch5650_while
	...
	// From: Req2Batch5650_while
	if (var_1_4) {
		var_1_6 = (var_1_15 + (min (var_1_15 , var_1_18)));
	}


	// From: Req3Batch5650_while
