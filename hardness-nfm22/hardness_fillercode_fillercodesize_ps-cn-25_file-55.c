...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch55PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_34 < var_1_35) {
		var_1_41 = (abs (var_1_34));
	} else {
		var_1_41 = (var_1_34 + (abs (var_1_33)));
	}
	...
	// From: Req3Batch55PS_CN_25
	if (var_1_23) {
		var_1_15 = (var_1_14 - var_1_13);
	}


	// From: Req5Batch55PS_CN_25
	if (var_1_23) {
