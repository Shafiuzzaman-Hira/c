...
void step(void) {
	...
	if (-1000000 > var_1_33) {
		...
		var_1_47 = ((max (var_1_50 , (abs (-5)))) + var_1_51);
	}


	// From: CodeObject9
	if ((abs (abs (-2))) < var_1_47) {
		var_1_52 = (abs (max (var_1_36 , var_1_37)));
	}
	...
	if (var_1_44) {
		if (var_1_46) {
			var_1_54 = ((abs (var_1_34)) + var_1_47);
		}
	}


	// From: CodeObject12
	if ((16 * var_1_34) > (max (var_1_43 , var_1_32))) {
	...
	// From: CodeObject15
	if (var_1_57) {
		var_1_60 = (abs (abs (200 - var_1_34)));
	} else {
		var_1_60 = var_1_49;
	}


	// From: Req3Batch19PS_CN_100
	if (last_1_var_1_15) {
		var_1_10 = (var_1_12 || var_1_13);
	}


	// From: Req7Batch19PS_CN_100
	if (var_1_10) {
	...
	// From: Req5Batch19PS_CN_100
	if ((- var_1_24) == (var_1_24 + var_1_24)) {
		var_1_15 = var_1_12;
	}


	// From: Req6Batch19PS_CN_100
	...
	// From: Req8Batch19PS_CN_100
	if (var_1_24 != var_1_24) {
		var_1_29 = (max (var_1_2 , var_1_3));
	}


	// From: Req2Batch19PS_CN_100
	...
	// From: Req4Batch19PS_CN_100
	if (var_1_15) {
		var_1_14 = (min ((abs (max (var_1_3 , var_1_2))) , var_1_9));
	}


	// From: Req1Batch19PS_CN_100
