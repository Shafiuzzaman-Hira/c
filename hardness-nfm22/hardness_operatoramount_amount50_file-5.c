...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch5Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch5Amount50
	var_1_21 = var_1_10;


	// From: Req4Batch5Amount50
