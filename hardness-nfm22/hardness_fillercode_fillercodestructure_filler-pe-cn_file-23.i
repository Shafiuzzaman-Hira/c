...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch23Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_46 = var_1_40;
 if (var_1_46 < ((((var_1_40) > (var_1_43)) ? (var_1_40) : (var_1_43)))) {
  if (var_1_34 || (128.5 <= var_1_31)) {
   var_1_47 = (var_1_48 - var_1_39);
  }
 } else {
  var_1_47 = ((((((((var_1_36) > (var_1_39)) ? (var_1_36) : (var_1_39)))) > (var_1_46)) ? (((((var_1_36) > (var_1_39)) ? (var_1_36) : (var_1_39)))) : (var_1_46)));
 }
 var_1_49 = var_1_32;
}
