...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch32Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_6 < ((((var_1_6) < ((var_1_13 >> var_1_5))) ? (var_1_6) : ((var_1_13 >> var_1_5))))) {
  if (var_1_6 > var_1_6) {
   var_1_25 = var_1_8;
  } else {
   if (((var_1_5 ^ var_1_13) >> var_1_6) > ((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6)))) {
    var_1_25 = ((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6)));
   }
  }
 } else {
  if ((var_1_5 - var_1_6) <= (~ (var_1_32 - var_1_8))) {
   var_1_25 = ((((var_1_8) > (var_1_6)) ? (var_1_8) : (var_1_6)));
  } else {
   var_1_25 = -32;
  }
 }
 ...
 if ((var_1_11 / ((((var_1_42) > (256.5)) ? (var_1_42) : (256.5)))) < var_1_12) {
  var_1_41 = var_1_5;
 }
 ...
 if ((var_1_11 - var_1_12) >= (var_1_19 * var_1_12)) {
  var_1_36 = 5;
 }
 if ((((((var_1_19) < (var_1_11)) ? (var_1_19) : (var_1_11))) >= (var_1_12 / var_1_42)) || var_1_16) {
  if (var_1_16 || var_1_15) {
   var_1_43 = ((((99.65) < 0 ) ? -(99.65) : (99.65)));
  }
 }
 if (var_1_5 <= (var_1_4 ^ (var_1_1 & var_1_7))) {
  if (var_1_16) {
   if (var_1_15) {
    var_1_45 = var_1_5;
   } else {
