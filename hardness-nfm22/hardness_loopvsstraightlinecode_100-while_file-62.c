...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch62100_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch62100_while
	var_1_9 = (min (((min (last_1_var_1_7 , last_1_var_1_30)) + (min (last_1_var_1_30 , last_1_var_1_30))) , last_1_var_1_30));


	// From: Req11Batch62100_while
	...
	if (stepLocal_7 && var_1_16) {
		var_1_30 = (var_1_31 - (abs (var_1_32 - var_1_33)));
	} else {
	...
	// From: Req7Batch62100_while
	if (var_1_13) {
		if (var_1_5 > var_1_18) {
			var_1_21 = (min (var_1_18 , var_1_6));
		}
	} else {
	...
	if ((var_1_30 / var_1_23) == stepLocal_4) {
		if ((var_1_30 + (- var_1_30)) >= stepLocal_3) {
			var_1_22 = ((var_1_24 + var_1_25) + (var_1_18 - (max (31.85f , 10.5f))));
		}
	} else {
		var_1_22 = 7.5f;
	}
	...
	// From: Req6Batch62100_while
	if ((var_1_30 == var_1_30) || var_1_12) {
		var_1_20 = (min (25.5f , var_1_4));
	}


	// From: Req9Batch62100_while
	if (var_1_1 > (var_1_20 * (var_1_24 / 2.8))) {
		if (var_1_14) {
			if (var_1_13) {
				var_1_26 = (max (var_1_27 , 0));
			} else {
				if (var_1_16) {
					var_1_26 = var_1_27;
				} else {
...
int property() {
	return (((((((((((var_1_30 >= var_1_9) ? (var_1_1 == ((double) (abs ((max (var_1_4 , var_1_5)) + var_1_6)))) : (var_1_1 == ((double) (var_1_4 + var_1_5)))) && ((32 > var_1_9) ? (((- var_1_30) != (var_1_9 - var_1_30)) ? (var_1_7 == ((unsigned long int) (min ((min (5u , var_1_30)) , var_1_30)))) : (var_1_7 == ((unsigned long int) var_1_9))) : (var_1_7 == ((unsigned long int) var_1_9)))) && (var_1_9 == ((unsigned long int) (min (((min (last_1_var_1_7 , last_1_var_1_30)) + (min (last_1_var_1_30 , last_1_var_1_30))) , last_1_var_1_30))))) && ((var_1_4 <= (var_1_21 + (var_1_5 * var_1_6))) ? (var_1_12 == ((unsigned char) ((var_1_13 && var_1_14) && var_1_15))) : (var_1_12 == ((unsigned char) var_1_16)))) && (var_1_13 ? (var_1_17 == ((double) ((var_1_18 - var_1_19) + var_1_4))) : (var_1_17 == ((double) var_1_6)))) && (((var_1_30 == var_1_30) || var_1_12) ? (var_1_20 == ((float) (min (25.5f , var_1_4)))) : 1)) && (var_1_13 ? ((var_1_5 > var_1_18) ? (var_1_21 == ((float) (min (var_1_18 , var_1_6)))) : 1) : (var_1_21 == ((float) (var_1_5 + (1.55f + 5.7f)))))) && (((var_1_30 / var_1_23) == (~ var_1_30)) ? (((var_1_30 + (- var_1_30)) >= var_1_30) ? (var_1_22 == ((float) ((var_1_24 + var_1_25) + (var_1_18 - (max (31.85f , 10.5f)))))) : 1) : (var_1_22 == ((float) 7.5f)))) && ((var_1_1 > (var_1_20 * (var_1_24 / 2.8))) ? (var_1_14 ? (var_1_13 ? (var_1_26 == ((signed char) (max (var_1_27 , 0)))) : (var_1_16 ? (var_1_26 == ((signed char) var_1_27)) : (var_1_26 == ((signed char) var_1_27)))) : (var_1_26 == ((signed char) var_1_27))) : 1)) && ((var_1_18 > var_1_24) ? ((var_1_23 <= var_1_30) ? (var_1_28 == ((signed char) (max (var_1_27 , var_1_29)))) : (var_1_28 == ((signed char) var_1_29))) : 1)) && ((var_1_14 && var_1_16) ? (var_1_30 == ((unsigned short int) (var_1_31 - (abs (var_1_32 - var_1_33))))) : (((var_1_13 && (last_1_var_1_1 > 64.177)) || var_1_14) ? ((var_1_10 >= var_1_32) ? (var_1_30 == ((unsigned short int) var_1_33)) : ((! (last_1_var_1_9 >= var_1_27)) ? (var_1_30 == ((unsigned short int) var_1_33)) : 1)) : 1))
;
}
int main(void) {
	isInitial = 1;
