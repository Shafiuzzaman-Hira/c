...
void step(void) {
	...
	// From: CodeObject2
	if ((var_1_34 & var_1_33) >= (abs (var_1_28))) {
	...
	// From: CodeObject3
	if (var_1_40) {
		if (((~ var_1_33) / (abs (var_1_41))) < (var_1_29 + var_1_32)) {
			var_1_39 = ((var_1_43 && var_1_44) || ((! var_1_45) || var_1_46));
		}
	} else {
		if ((abs (var_1_37)) < (- var_1_38)) {
	...
	if (var_1_30 >= var_1_32) {
		if ((max ((var_1_32 + var_1_30) , var_1_28)) <= var_1_42) {
			if (((var_1_31 * var_1_42) < (abs (var_1_28))) && ((- var_1_52) >= var_1_29)) {
	...
	if (var_1_43 || (0 <= (var_1_34 - var_1_56))) {
		var_1_55 = (abs (var_1_33));
	}


	// From: CodeObject7
	if ((var_1_32 | var_1_36) >= var_1_30) {
		var_1_57 = (abs (var_1_28 + (var_1_58 - var_1_34)));
	}
	...
	if (var_1_38 <= var_1_54) {
		if (var_1_39) {
			if ((max (var_1_37 , var_1_53)) > var_1_49) {
				var_1_59 = (abs (min (var_1_34 , var_1_28)));
			}
		}
	} else {
		var_1_59 = (abs (var_1_34));
	}


	// From: CodeObject9
	var_1_60 = (abs (max (var_1_28 , var_1_34)));


	// From: CodeObject10
	if (var_1_30 > (var_1_34 & var_1_62)) {
		var_1_61 = (abs (var_1_34 + (min (var_1_33 , var_1_28))));
	}
	...
	// From: Req5Batch1PS_CN_100
	var_1_15 = (var_1_16 - var_1_17);


	// From: Req8Batch1PS_CN_100
	var_1_27 = var_1_21;


	// From: Req1Batch1PS_CN_100
	...
	// From: Req2Batch1PS_CN_100
	if (var_1_27 < (var_1_27 - var_1_27)) {
		var_1_6 = var_1_9;
	}


	// From: Req3Batch1PS_CN_100
