...
void step(void) {
	...
	// From: Req4Batch3425_while
	var_1_12 = (max (128 , var_1_13));


	// From: Req5Batch3425_while
	var_1_14 = var_1_15;


	// From: Req6Batch3425_while
	var_1_16 = var_1_13;


	// From: Req7Batch3425_while
	var_1_17 = var_1_11;


	// From: Req3Batch3425_while
	if (var_1_17) {
