...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch8325_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch8325_1loop
	var_1_11 = ((var_1_12 + var_1_13) - (min (25 , var_1_14)));


	// From: Req4Batch8325_1loop
	var_1_15 = var_1_14;


	// From: Req1Batch8325_1loop
