...
void step(void) {
	...
	// From: CodeObject6
	if (var_1_34 <= var_1_6) {
		var_1_37 = (min ((32 - 2) , var_1_15));
	} else {
		if (var_1_15 < var_1_10) {
			var_1_37 = (min (-8 , (abs (var_1_15))));
		} else {
	...
	// From: CodeObject7
	if (var_1_22 <= 9.6) {
		var_1_38 = (max ((var_1_34 + var_1_11) , var_1_1));
	} else {
		if (var_1_9 <= var_1_16) {
			if (var_1_1 > (var_1_6 >> var_1_9)) {
				var_1_38 = (abs (var_1_1));
			} else {
				var_1_38 = (min (var_1_34 , (min (var_1_8 , var_1_15))));
			}
		}
	}
	...
	// From: CodeObject2
	if ((var_1_1 < (abs (var_1_17))) || var_1_13) {
		var_1_27 = var_1_7;
	}
