...
void step(void) {
	...
	// From: CodeObject3
	if (var_1_10 < var_1_8) {
		var_1_30 = (max (var_1_8 , var_1_11));
	}


	// From: CodeObject4
	if ((-1 - var_1_15) < ((var_1_1 / var_1_14) & var_1_5)) {
		if ((- (abs (var_1_5))) < (var_1_14 >> var_1_15)) {
			var_1_32 = var_1_15;
		} else {
			var_1_32 = var_1_15;
		}
	...
	if (var_1_10 < ((var_1_8 / var_1_37) + var_1_11)) {
		if (((var_1_10 >= var_1_8) && var_1_25) && (var_1_8 <= (abs (var_1_11)))) {
			var_1_36 = (abs (var_1_18));
		}
	} else {
		var_1_36 = (max (var_1_18 , (var_1_18 - var_1_18)));
	}
