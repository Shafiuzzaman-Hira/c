...
void step(void) {
	...
	// From: Req7Batch39Filler_PR_CN
	var_1_24 = var_1_25;


	// From: CodeObject4
	if ((var_1_37 % (abs (var_1_41))) >= (var_1_27 * var_1_39)) {
		var_1_40 = (max ((abs (var_1_38 + var_1_39)) , var_1_42));
	}


	// From: CodeObject6
	if (var_1_27 > var_1_39) {
		var_1_45 = (max (var_1_32 , (var_1_46 - (abs (var_1_47)))));
	} else {
		if (-32 < var_1_48) {
			var_1_45 = (max ((abs (var_1_47)) , var_1_32));
		}
	}
	...
	// From: Req8Batch39Filler_PR_CN
	var_1_26 = var_1_8;


	// From: Req3Batch39Filler_PR_CN
	...
	if (var_1_27 <= (var_1_37 & var_1_41)) {
		if ((var_1_31 * var_1_32) >= var_1_29) {
			if (! var_1_34) {
				var_1_43 = (3151323843u - (var_1_38 + (abs (var_1_44))));
			} else {
				var_1_43 = var_1_44;
			}
		} else {
