...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch13no_floats.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch13no_floats
	if (((var_1_12 - var_1_13) + var_1_14) <= (256.625 * (max (1.875 , var_1_15)))) {
		var_1_11 = ((abs (5)) + 5);
	}


	// From: Req1Batch13no_floats
	if (var_1_2) {
		var_1_1 = (max (var_1_11 , var_1_11));
	}


	// From: Req2Batch13no_floats
	...
	if (stepLocal_0 || (var_1_11 >= var_1_11)) {
		if (stepLocal_1 < ((var_1_9 - var_1_10) - 16)) {
			var_1_8 = (max (var_1_10 , 32));
		}
	} else {
		var_1_8 = (min (var_1_9 , var_1_11));
	}
}
...
int property() {
	return (((var_1_2 ? (var_1_1 == ((unsigned short int) (max (var_1_11 , var_1_11)))) : 1) && (((var_1_1 == 16) || (var_1_11 < (10 / var_1_6))) ? (var_1_5 == ((signed char) var_1_7)) : (var_1_5 == ((signed char) 5)))) && ((var_1_2 || (var_1_11 >= var_1_11)) ? ((var_1_11 < ((var_1_9 - var_1_10) - 16)) ? (var_1_8 == ((unsigned short int) (max (var_1_10 , 32)))) : 1) : (var_1_8 == ((unsigned short int) (min (var_1_9 , var_1_11)))))) && ((((var_1_12 - var_1_13) + var_1_14) <= (256.625 * (max (1.875 , var_1_15)))) ? (var_1_11 == ((unsigned char) ((abs (5)) + 5))) : 1)
;
}
int main(void) {
	isInitial = 1;
