...
void step(void) {
	...
	// From: Req6Batch46Filler_PE_CI
	var_1_17 = var_1_18;


	// From: Req7Batch46Filler_PE_CI
	var_1_19 = 5;


	// From: Req8Batch46Filler_PE_CI
	var_1_20 = var_1_15;


	// From: Req4Batch46Filler_PE_CI
	if (var_1_1 < var_1_20) {
	...
	if (var_1_15 != (var_1_4 + var_1_4)) {
		var_1_29 = (max (var_1_4 , (min ((abs (var_1_15)) , var_1_6))));
	} else {
		var_1_29 = var_1_15;
	}
	...
	if ((-25 + (var_1_7 + var_1_1)) <= var_1_5) {
		if ((16 >> (abs (var_1_15))) > (var_1_1 >> var_1_7)) {
			var_1_31 = var_1_4;
		} else {
	...
	if (var_1_3 || (var_1_25 && var_1_2)) {
		if (var_1_6 >= var_1_14) {
			...
			var_1_33 = (max ((var_1_14 - var_1_15) , ((var_1_14 + var_1_14) - 2)));
		}
	} else {
