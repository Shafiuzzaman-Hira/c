...
void step(void) {
	...
	// From: CodeObject5
	if (-2 > ((abs (var_1_21)) | (-10 * var_1_25))) {
		var_1_37 = (max ((min (25 , var_1_21)) , (abs (var_1_32 + var_1_8))));
	} else {
		if ((abs (var_1_8)) <= (abs (var_1_21))) {
			if ((var_1_8 * (max (var_1_25 , var_1_25))) <= var_1_21) {
				var_1_37 = (abs (var_1_8));
			}
		} else {
