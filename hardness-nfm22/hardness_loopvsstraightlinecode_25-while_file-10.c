...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch1025_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch1025_while
	var_1_17 = (var_1_8 + var_1_9);


	// From: Req5Batch1025_while
	var_1_18 = var_1_15;


	// From: Req6Batch1025_while
	var_1_19 = 8;


	// From: Req3Batch1025_while
	...
	// From: Req1Batch1025_while
	var_1_1 = var_1_12;


	// From: Req2Batch1025_while
