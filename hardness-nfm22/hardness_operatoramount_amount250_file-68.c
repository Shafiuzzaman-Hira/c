...
void step(void) {
	...
	// From: Req6Batch68Amount250
	unsigned char stepLocal_3 = -256 >= var_1_17;
	if ((var_1_6 >= (var_1_14 / var_1_12)) && stepLocal_3) {
		var_1_21 = ((abs (abs (var_1_25))) - (var_1_26 - (var_1_27 + var_1_28)));
	} else {
		var_1_21 = (min ((var_1_24 + (var_1_26 - var_1_28)) , var_1_25));
	}


	// From: Req18Batch68Amount250
	...
	// From: Req8Batch68Amount250
	if (var_1_14 <= ((-0.4f / var_1_12) + (last_1_var_1_11 * var_1_16))) {
		var_1_30 = (var_1_28 - var_1_25);
	} else {
		if (last_1_var_1_54) {
			if ((var_1_27 / var_1_25) < (abs (min (last_1_var_1_51 , last_1_var_1_21)))) {
	...
	// From: Req7Batch68Amount250
	if (var_1_15 >= var_1_6) {
		var_1_29 = (var_1_27 + var_1_26);
	}


	// From: Req14Batch68Amount250
	if (((var_1_46 - var_1_15) - var_1_36) < 7.2) {
		var_1_45 = (min ((max ((max (var_1_27 , var_1_28)) , -1)) , (var_1_47 - var_1_48)));
	}


	// From: Req15Batch68Amount250
	if (var_1_54) {
		var_1_49 = (((8.5755224913009244E18f - var_1_50) - var_1_16) - (abs (var_1_15)));
	}


	// From: Req21Batch68Amount250
	if (var_1_54) {
		var_1_67 = var_1_59;
	}


	// From: Req20Batch68Amount250
	if (var_1_54) {
		var_1_65 = var_1_45;
	} else {
		var_1_65 = 16;
	...
	// From: Req10Batch68Amount250
	signed short int stepLocal_6 = var_1_30;
	if (stepLocal_6 > ((min (last_1_var_1_35 , var_1_26)) | var_1_29)) {
		if (((max (var_1_36 , var_1_13)) - (var_1_16 + var_1_15)) <= 0.5) {
			var_1_35 = var_1_21;
		} else {
			var_1_35 = var_1_26;
		}
	...
	// From: Req2Batch68Amount250
	if (var_1_5 < var_1_4) {
		var_1_7 = (min ((var_1_8 - var_1_17) , var_1_29));
	} else {
		var_1_7 = var_1_17;
	}


	// From: Req3Batch68Amount250
	...
	// From: Req12Batch68Amount250
	if (var_1_54) {
		var_1_41 = (min (1 , (abs (var_1_26 - var_1_65))));
	}


	// From: Req11Batch68Amount250
	...
	if (((var_1_62 * var_1_41) % (max (var_1_26 , var_1_38))) >= stepLocal_7) {
		if (stepLocal_8 || ((var_1_21 * var_1_8) < var_1_25)) {
			if (stepLocal_9 > var_1_21) {
				var_1_37 = (abs (var_1_26));
			}
		}
	} else {
		...
		if ((var_1_8 < var_1_21) || (var_1_43 >= var_1_14)) {
			if (1.0000000002E9f <= (- var_1_44)) {
				if (var_1_37 >= (var_1_62 + (var_1_25 - var_1_17))) {
					var_1_51 = (min (var_1_28 , var_1_47));
				} else {
					var_1_51 = (var_1_28 + (var_1_27 + (max (var_1_52 , var_1_53))));
				}
			}
		} else {
			var_1_51 = ((max (4 , var_1_48)) - 64);
		}
	} else {
		var_1_51 = ((var_1_27 - var_1_28) + (max (var_1_53 , var_1_52)));
	}


	// From: Req1Batch68Amount250
	...
	// From: Req5Batch68Amount250
	if (var_1_14 <= var_1_1) {
		var_1_20 = var_1_8;
	}


	// From: Req9Batch68Amount250
	...
	if (var_1_21 >= stepLocal_4) {
		...
		if ((- 199.496f) <= (- var_1_15)) {
			var_1_31 = (min (((min (var_1_8 , var_1_34)) - var_1_23) , var_1_21));
		} else {
			var_1_31 = (min (var_1_29 , var_1_23));
		}
	}


	// From: Req19Batch68Amount250
	...
	if (stepLocal_11 || var_1_54) {
		if (! ((! var_1_54) && var_1_54)) {
			if (var_1_21 > stepLocal_10) {
				var_1_42 = ((abs (var_1_16)) - (abs (var_1_14)));
			}
		} else {
			if ((var_1_13 * (var_1_4 / var_1_43)) <= (- (- var_1_16))) {
				var_1_42 = var_1_15;
			} else {
				var_1_42 = (abs (var_1_14));
			}
		}
	} else {
...
int property() {
	return ((((((((((((((((((((((var_1_51 >= var_1_45) ? (var_1_1 == ((float) (max (var_1_4 , 9.999999996E8f)))) : (var_1_1 == ((float) (max ((var_1_5 + var_1_6) , var_1_4))))) && ((var_1_5 < var_1_4) ? (var_1_7 == ((unsigned long int) (min ((var_1_8 - var_1_17) , var_1_29)))) : (var_1_7 == ((unsigned long int) var_1_17)))) && ((4 < (var_1_29 + var_1_17)) ? ((((- var_1_4) / var_1_12) <= var_1_5) ? (var_1_11 == ((float) (32.5f + var_1_5))) : (var_1_11 == ((float) (var_1_13 - (var_1_14 - (max (var_1_15 , var_1_16))))))) : 1)) && ((((var_1_8 / 10u) < last_1_var_1_21) || ((~ last_1_var_1_21) < last_1_var_1_29)) ? ((! (16.75f <= var_1_12)) ? (last_1_var_1_54 ? (var_1_17 == ((unsigned short int) last_1_var_1_21)) : 1) : (var_1_17 == ((unsigned short int) last_1_var_1_21))) : 1)) && ((var_1_14 <= var_1_1) ? (var_1_20 == ((unsigned long int) var_1_8)) : 1)) && (((var_1_6 >= (var_1_14 / var_1_12)) && (-256 >= var_1_17)) ? (var_1_21 == ((unsigned char) ((abs (abs (var_1_25))) - (var_1_26 - (var_1_27 + var_1_28))))) : (var_1_21 == ((unsigned char) (min ((var_1_24 + (var_1_26 - var_1_28)) , var_1_25)))))) && ((var_1_15 >= var_1_6) ? (var_1_29 == ((unsigned short int) (var_1_27 + var_1_26))) : 1)) && ((var_1_14 <= ((-0.4f / var_1_12) + (last_1_var_1_11 * var_1_16))) ? (var_1_30 == ((signed short int) (var_1_28 - var_1_25))) : (last_1_var_1_54 ? (((var_1_27 / var_1_25) < (abs (min (last_1_var_1_51 , last_1_var_1_21)))) ? (var_1_30 == ((signed short int) last_1_var_1_37)) : (var_1_30 == ((signed short int) var_1_27))) : 1))) && ((var_1_21 >= (var_1_35 % (var_1_26 + var_1_25))) ? ((var_1_7 <= var_1_21) ? (var_1_54 ? ((! (var_1_11 < var_1_13)) ? ((! var_1_54) ? (var_1_31 == ((unsigned long int) (var_1_28 + (var_1_24 + (var_1_23 + var_1_26))))) : 1) : 1) : 1) : 1) : (((- 199.496f) <= (- var_1_15)) ? (var_1_31 == ((unsigned long int) (min (((min (var_1_8 , var_1_34)) - var_1_23) , var_1_21)))) : (var_1_31 == ((unsigned long int) (min (var_1_29 , var_1_23))))))) && ((var_1_30 > ((min (last_1_var_1_35 , var_1_26)) | var_1_29)) ? ((((max (var_1_36 , var_1_13)) - (var_1_16 + var_1_15)) <= 0.5) ? (var_1_35 == ((unsigned short int) var_1_21)) : (var_1_35 == ((unsigned short int) var_1_26))) : 1)) && ((((var_1_62 * var_1_41) % (max (var_1_26 , var_1_38))) >= var_1_30) ? ((var_1_54 || ((var_1_21 * var_1_8) < var_1_25)) ? ((((var_1_41 % 5u) * var_1_26) > var_1_21) ? (var_1_37 == ((signed short int) (abs (var_1_26)))) : 1) : 1) : (var_1_37 == ((signed short int) (var_1_17 - (var_1_40 - var_1_23)))))) && (var_1_54 ? (var_1_41 == ((signed short int) (min (1 , (abs (var_1_26 - var_1_65)))))) : 1)) && (((var_1_14 >= (var_1_36 * var_1_64)) || var_1_54) ? ((! ((! var_1_54) && var_1_54)) ? ((var_1_21 > (var_1_8 * var_1_27)) ? (var_1_42 == ((float) ((abs (var_1_16)) - (abs (var_1_14))))) : 1) : (((var_1_13 * (var_1_4 / var_1_43)) <= (- (- var_1_16))) ? (var_1_42 == ((float) var_1_15)) : (var_1_42 == ((float) (abs (var_1_14)))))) : (var_1_42 == ((float) (var_1_14 - (var_1_44 - var_1_16)))))) && ((((var_1_46 - var_1_15) - var_1_36) < 7.2) ? (var_1_45 == ((signed char) (min ((max ((max (var_1_27 , var_1_28)) , -1)) , (var_1_47 - var_1_48))))) : 1)) && (var_1_54 ? (var_1_49 == ((float) (((8.5755224913009244E18f - var_1_50) - var_1_16) - (abs (var_1_15))))) : 1)) && (((- var_1_35) >= last_1_var_1_51) ? (((var_1_8 < var_1_21) || (var_1_43 >= var_1_14)) ? ((1.0000000002E9f <= (- var_1_44)) ? ((var_1_37 >= (var_1_62 + (var_1_25 - var_1_17))) ? (var_1_51 == ((signed char) (min (var_1_28 , var_1_47)))) : (var_1_51 == ((signed char) (var_1_28 + (var_1_27 + (max (var_1_52 , var_1_53))))))) : 1) : (var_1_51 == ((signed char) ((max (4 , var_1_48)) - 64)))) : (var_1_51 == ((signed char) ((var_1_27 - var_1_28) + (max (var_1_53 , var_1_52))))))) && ((var_1_43 < var_1_5) ? ((var_1_27 == var_1_25) ? (var_1_54 == ((unsigned char) (var_1_55 && var_1_56))) : (var_1_54 == ((unsigned char) var_1_56))) : (((var_1_14 - (var_1_46 - var_1_16)) > var_1_4) ? (((last_1_var_1_65 >> (var_1_58 - var_1_59)) <= last_1_var_1_29) ? (var_1_54 == ((unsigned char) ((var_1_18 && (var_1_60 || var_1_61)) || (! var_1_55)))) : (var_1_54 == ((unsigned char) (! var_1_61)))) : 1))) && (((var_1_28 + last_1_var_1_68) < last_1_var_1_31) ? (var_1_62 == ((signed short int) last_1_var_1_62)) : 1)) && (((var_1_53 & (var_1_35 / var_1_25)) == var_1_51) ? (var_1_64 == ((float) (abs (var_1_16)))) : 1)) && (var_1_54 ? (var_1_65 == ((signed long int) var_1_45)) : (var_1_65 == ((signed long int) 16)))) && (var_1_54 ? (var_1_67 == ((signed char) var_1_59)) : 1)) && (((var_1_25 + (var_1_62 * var_1_20)) > var_1_21) ? (((var_1_17 - (var_1_69 - var_1_31)) <= (var_1_26 & var_1_30)) ? (var_1_68 == ((unsigned long int) var_1_20)) : (var_1_68 == ((unsigned long int) var_1_58))) : (var_1_68 == ((unsigned long int) var_1_35)))
;
}
int main(void) {
	isInitial = 1;
