...
void step(void) {
	...
	// From: CodeObject6
	if ((var_1_24 >> var_1_31) < (abs (-256))) {
		var_1_30 = var_1_27;
	}


	// From: Req1Batch58PS_CN_10
	...
	// From: Req4Batch58PS_CN_10
	var_1_12 = (min (var_1_13 , var_1_14));


	// From: Req5Batch58PS_CN_10
	if (var_1_7) {
		var_1_15 = ((min (32 , (16 + var_1_16))) - var_1_17);
	}


	// From: Req6Batch58PS_CN_10
