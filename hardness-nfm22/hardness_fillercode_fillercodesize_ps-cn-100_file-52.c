...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch52PS_CN_100.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((abs (var_1_41)) > (abs (var_1_37))) {
		...
		var_1_43 = (var_1_35 && var_1_34);
	}


	// From: CodeObject6
	if ((~ var_1_40) > (abs (var_1_30))) {
		if (var_1_28 >= (var_1_29 | var_1_25)) {
			var_1_46 = (! var_1_35);
		} else {
			var_1_46 = (var_1_43 && (! var_1_35));
		}
	}
	...
	// From: Req8Batch52PS_CN_100
	var_1_20 = var_1_17;


	// From: Req4Batch52PS_CN_100
	var_1_12 = (var_1_13 && var_1_14);


	// From: Req9Batch52PS_CN_100
	var_1_21 = var_1_8;


	// From: Req10Batch52PS_CN_100
	var_1_22 = -256;


	// From: Req1Batch52PS_CN_100
