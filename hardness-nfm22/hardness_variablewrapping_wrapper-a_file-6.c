...
void step(void) {
	...
	if (unsigned_short_int_Array_0[0] > unsigned_short_int_Array_0[1]) {
		signed_long_int_Array_0[2] = ((min (unsigned_short_int_Array_0[1] , unsigned_short_int_Array_0[0])) - unsigned_short_int_Array_0[1]);
	}
	...
	// From: Req5Batch6Wrapper_A
	unsigned_long_int_Array_0[0] = (min ((abs (last_1_unsigned_long_int_Array_0_0_)) , (unsigned_long_int_Array_0[1] - signed_long_int_Array_0[1])));
	...
	if (((max (signed_long_int_Array_0[2] , signed_long_int_Array_0[2])) / unsigned_short_int_Array_0[2]) > stepLocal_1) {
