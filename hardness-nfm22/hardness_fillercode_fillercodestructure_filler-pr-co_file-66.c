...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch66Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject7
	if (var_1_8 <= (~ (min (var_1_1 , var_1_1)))) {
		if (var_1_12) {
			if (var_1_40 != var_1_41) {
				var_1_42 = (var_1_29 - var_1_15);
			} else {
				var_1_42 = var_1_8;
			}
		} else {
	...
	// From: CodeObject5
	if ((max ((max (var_1_8 , var_1_19)) , var_1_18)) > var_1_8) {
		if (! (var_1_15 >= 128)) {
			var_1_36 = (abs (8));
		}
	} else {
	...
	if (var_1_8 > var_1_8) {
		if (var_1_29 < var_1_8) {
			if (var_1_29 <= (-64 & var_1_15)) {
				var_1_31 = (max (var_1_1 , (min (8 , var_1_1))));
			} else {
				var_1_31 = (var_1_1 + (max (4 , var_1_1)));
			}
		}
	}


	// From: Req2Batch66Filler_PR_CO
	...
	// From: CodeObject3
	if ((abs (-256)) < var_1_18) {
		var_1_28 = (5 - ((abs (var_1_29)) - var_1_8));
	} else {
		var_1_28 = var_1_29;
	}


	// From: Req6Batch66Filler_PR_CO
