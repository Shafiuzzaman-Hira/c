...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch4dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch4dependencies
	if (var_1_5) {
		if ((last_1_var_1_14 * (last_1_var_1_6 + last_1_var_1_17)) > last_1_var_1_9) {
			var_1_6 = 256;
		}
	}


	// From: Req5Batch4dependencies
	if (last_1_var_1_14 >= last_1_var_1_9) {
		var_1_14 = ((max (var_1_15 , (var_1_16 - var_1_10))) - last_1_var_1_17);
	}


	// From: Req1Batch4dependencies
	if (var_1_6 <= var_1_14) {
		if ((- var_1_14) > var_1_6) {
			var_1_1 = 0;
		}
	...
	// From: Req6Batch4dependencies
	if (var_1_1 && (var_1_5 && (var_1_12 < var_1_13))) {
		if (var_1_1 || (last_1_var_1_17 >= (max (var_1_14 , var_1_6)))) {
