...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch8325_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch8325_while
	var_1_11 = ((var_1_12 + var_1_13) - (min (25 , var_1_14)));


	// From: Req4Batch8325_while
	var_1_15 = var_1_14;


	// From: Req1Batch8325_while
	signed long int stepLocal_0 = var_1_3 / var_1_4;
	if (var_1_2) {
		var_1_1 = (abs (abs (var_1_3)));
	} else {
		if (stepLocal_0 >= (min ((var_1_15 * var_1_15) , var_1_11))) {
			var_1_1 = var_1_4;
		} else {
			var_1_1 = 5;
		}
	...
	// From: Req2Batch8325_while
	if (var_1_11 >= ((var_1_3 / var_1_4) + (var_1_1 * var_1_11))) {
...
int property() {
	return (((var_1_2 ? (var_1_1 == ((unsigned short int) (abs (abs (var_1_3))))) : (((var_1_3 / var_1_4) >= (min ((var_1_15 * var_1_15) , var_1_11))) ? (var_1_1 == ((unsigned short int) var_1_4)) : (var_1_1 == ((unsigned short int) 5)))) && ((var_1_11 >= ((var_1_3 / var_1_4) + (var_1_1 * var_1_11))) ? (var_1_8 == ((double) (var_1_9 + (abs (var_1_10))))) : (var_1_8 == ((double) var_1_9)))) && (var_1_11 == ((signed char) ((var_1_12 + var_1_13) - (min (25 , var_1_14)))))) && (var_1_15 == ((unsigned short int) var_1_14))
;
}
int main(void) {
	isInitial = 1;
