...
void step(void) {
 if ((var_1_25 & (var_1_26 + var_1_27)) <= ((var_1_28 | var_1_29) + var_1_30)) {
  ...
  var_1_24 = ((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31)));
 }
 if (((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))) < var_1_28) {
  if (var_1_27 <= (((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24))) / ((((var_1_31) < (var_1_34)) ? (var_1_31) : (var_1_34))))) {
   if ((var_1_25 + 8) <= (var_1_31 / var_1_34)) {
    var_1_33 = var_1_35;
   }
  }
 } else {
  var_1_33 = ((((var_1_35) < (((((((((var_1_36) > (var_1_37)) ? (var_1_36) : (var_1_37)))) < (255.1)) ? (((((var_1_36) > (var_1_37)) ? (var_1_36) : (var_1_37)))) : (255.1))))) ? (var_1_35) : (((((((((var_1_36) > (var_1_37)) ? (var_1_36) : (var_1_37)))) < (255.1)) ? (((((var_1_36) > (var_1_37)) ? (var_1_36) : (var_1_37)))) : (255.1))))));
 }
 if (((var_1_30 ^ var_1_25) + (var_1_24 + var_1_29)) > (var_1_32 % 5)) {
  var_1_38 = (((((var_1_26 + var_1_34)) < ((128 - ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)))))) ? ((var_1_26 + var_1_34)) : ((128 - ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)))))));
 } else {
  var_1_38 = (var_1_32 - ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))));
 }
 if (var_1_37 >= var_1_36) {
  if ((var_1_38 * var_1_27) != var_1_34) {
   var_1_39 = ((((((((var_1_36) < (var_1_35)) ? (var_1_36) : (var_1_35))) < 0 ) ? -((((var_1_36) < (var_1_35)) ? (var_1_36) : (var_1_35))) : ((((var_1_36) < (var_1_35)) ? (var_1_36) : (var_1_35))))) - ((((var_1_40) > (((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37))))) ? (var_1_40) : (((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37)))))));
  }
 } else {
  if (var_1_37 >= var_1_35) {
   var_1_39 = ((((var_1_41 + ((((var_1_42) > (var_1_43)) ? (var_1_42) : (var_1_43)))) < 0 ) ? -(var_1_41 + ((((var_1_42) > (var_1_43)) ? (var_1_42) : (var_1_43)))) : (var_1_41 + ((((var_1_42) > (var_1_43)) ? (var_1_42) : (var_1_43))))));
  } else {
   var_1_39 = (((((((var_1_44) < (var_1_41)) ? (var_1_44) : (var_1_41))) < 0 ) ? -((((var_1_44) < (var_1_41)) ? (var_1_44) : (var_1_41))) : ((((var_1_44) < (var_1_41)) ? (var_1_44) : (var_1_41)))));
  }
 }
 if ((var_1_24 - var_1_32) > var_1_30) {
  var_1_45 = ((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32)));
 }
 if (((((var_1_38) > (var_1_27)) ? (var_1_38) : (var_1_27))) >= var_1_26) {
  var_1_46 = ((((var_1_32) > ((1 - ((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31)))))) ? (var_1_32) : ((1 - ((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31)))))));
 } else {
  if (var_1_39 >= var_1_35) {
   ...
   if (var_1_42 < var_1_44) {
    if (var_1_28 >= ((-1 - var_1_31) | var_1_38)) {
     if (((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36))) <= var_1_40) {
      var_1_46 = ((((((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24)))) < (((var_1_47 - 64) - ((((var_1_31) < (var_1_32)) ? (var_1_31) : (var_1_32)))))) ? (((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24)))) : (((var_1_47 - 64) - ((((var_1_31) < (var_1_32)) ? (var_1_31) : (var_1_32)))))));
     }
    }
   }
  }
 ...
 if (var_1_28 <= var_1_38) {
  ...
  if ((var_1_36 + var_1_43) >= (- ((((var_1_40) > (var_1_44)) ? (var_1_40) : (var_1_44))))) {
   var_1_48 = (((((((var_1_43) > (63.6f)) ? (var_1_43) : (63.6f))) < 0 ) ? -((((var_1_43) > (63.6f)) ? (var_1_43) : (63.6f))) : ((((var_1_43) > (63.6f)) ? (var_1_43) : (63.6f)))));
  } else {
   var_1_48 = var_1_42;
  }
 }
 if (var_1_30 >= var_1_29) {
  if ((~ var_1_31) > var_1_47) {
   var_1_49 = ((((var_1_44) < (((((var_1_42) < (var_1_43)) ? (var_1_42) : (var_1_43))))) ? (var_1_44) : (((((var_1_42) < (var_1_43)) ? (var_1_42) : (var_1_43))))));
  } else {
   var_1_49 = ((((((((var_1_42) < 0 ) ? -(var_1_42) : (var_1_42))) < 0 ) ? -((((var_1_42) < 0 ) ? -(var_1_42) : (var_1_42))) : ((((var_1_42) < 0 ) ? -(var_1_42) : (var_1_42))))) + (((((var_1_50) > (var_1_51)) ? (var_1_50) : (var_1_51))) + var_1_52));
  }
 }
 if (var_1_38 <= ((var_1_25 + 128) | var_1_26)) {
  var_1_53 = (var_1_24 + var_1_31);
 } else {
  var_1_53 = ((((var_1_47) < (-2)) ? (var_1_47) : (-2)));
 }
 if (var_1_46 >= var_1_30) {
  var_1_54 = (var_1_55 && var_1_56);
 } else {
  if (((((((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34)))) > (var_1_46)) ? (((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34)))) : (var_1_46))) <= var_1_28) {
   var_1_54 = (! (! var_1_55));
  }
 }
 if (var_1_56) {
  if (var_1_41 >= var_1_50) {
   var_1_57 = (((((var_1_58) < 0 ) ? -(var_1_58) : (var_1_58))) - (var_1_24 + var_1_32));
  }
 } else {
  var_1_57 = ((((var_1_47) < (((((var_1_58) > (((((var_1_24) > (var_1_31)) ? (var_1_24) : (var_1_31))))) ? (var_1_58) : (((((var_1_24) > (var_1_31)) ? (var_1_24) : (var_1_31)))))))) ? (var_1_47) : (((((var_1_58) > (((((var_1_24) > (var_1_31)) ? (var_1_24) : (var_1_31))))) ? (var_1_58) : (((((var_1_24) > (var_1_31)) ? (var_1_24) : (var_1_31)))))))));
 }
 ...
 if (var_1_56 && (var_1_40 < 15.5f)) {
  var_1_62 = ((((var_1_60) < 0 ) ? -(var_1_60) : (var_1_60)));
 } else {
  var_1_62 = (var_1_63 - ((((((((var_1_47) < 0 ) ? -(var_1_47) : (var_1_47)))) > (5u)) ? (((((var_1_47) < 0 ) ? -(var_1_47) : (var_1_47)))) : (5u))));
 }
 if (var_1_65) {
  if (var_1_25 > var_1_38) {
   if (var_1_28 <= -32) {
    if (var_1_33 >= var_1_40) {
     var_1_64 = (((((var_1_47) < 0 ) ? -(var_1_47) : (var_1_47))) - (((((var_1_61 + var_1_32)) < (var_1_60)) ? ((var_1_61 + var_1_32)) : (var_1_60))));
    }
   }
  } else {
   if ((var_1_28 * var_1_57) <= var_1_31) {
    var_1_64 = (((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))) - 256);
   }
  }
 }
 if (((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51))) < var_1_35) {
  var_1_66 = ((var_1_50 + var_1_52) + var_1_51);
 } else {
  if (((var_1_63 & var_1_28) < var_1_32) || var_1_56) {
   var_1_66 = (((((var_1_50) < 0 ) ? -(var_1_50) : (var_1_50))) + var_1_43);
  }
 }
 if (var_1_27 < var_1_61) {
  var_1_67 = ((((1) > (var_1_31)) ? (1) : (var_1_31)));
 }
 if ((var_1_54 || var_1_65) && var_1_55) {
  var_1_68 = (((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))) + var_1_67);
 } else {
  if ((var_1_29 / var_1_34) < (var_1_67 ^ var_1_32)) {
   var_1_68 = ((((((((var_1_61) < 0 ) ? -(var_1_61) : (var_1_61)))) < ((128 - var_1_31))) ? (((((var_1_61) < 0 ) ? -(var_1_61) : (var_1_61)))) : ((128 - var_1_31))));
  } else {
   var_1_68 = var_1_67;
  }
 }
 if (var_1_54) {
  var_1_69 = ((((var_1_57) < (var_1_47)) ? (var_1_57) : (var_1_47)));
 }
 if (((- var_1_44) >= var_1_51) || var_1_65) {
  if (((((var_1_30) < ((2 + 1))) ? (var_1_30) : ((2 + 1)))) > (var_1_62 | var_1_25)) {
   var_1_70 = (((((((((var_1_32 + var_1_60)) < (var_1_31)) ? ((var_1_32 + var_1_60)) : (var_1_31)))) > (((50 + var_1_71) + ((((var_1_72) < 0 ) ? -(var_1_72) : (var_1_72)))))) ? ((((((var_1_32 + var_1_60)) < (var_1_31)) ? ((var_1_32 + var_1_60)) : (var_1_31)))) : (((50 + var_1_71) + ((((var_1_72) < 0 ) ? -(var_1_72) : (var_1_72)))))));
  }
 } else {
  var_1_70 = ((((var_1_72) < (var_1_31)) ? (var_1_72) : (var_1_31)));
 }
 if (var_1_54) {
  var_1_73 = var_1_72;
 } else {
 ...
 if ((var_1_24 | 1) >= var_1_32) {
  var_1_75 = (((((var_1_57 - var_1_76)) > (((((var_1_46) < 0 ) ? -(var_1_46) : (var_1_46))))) ? ((var_1_57 - var_1_76)) : (((((var_1_46) < 0 ) ? -(var_1_46) : (var_1_46))))));
 } else {
  if (10 == var_1_74) {
   var_1_75 = 16;
  }
