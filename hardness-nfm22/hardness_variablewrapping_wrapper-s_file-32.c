...
void step(void) {
	// From: Req1Batch32Wrapper_S
	if (last_1_WrapperStruct00_var_1_6 >= -50) {
		WrapperStruct00.var_1_1 = (max ((WrapperStruct00.var_1_3 + (abs (WrapperStruct00.var_1_4))) , WrapperStruct00.var_1_5));
	}


	// From: Req2Batch32Wrapper_S
	...
	if (WrapperStruct00.var_1_4 <= stepLocal_2) {
		if (WrapperStruct00.var_1_1 < stepLocal_1) {
			...
			WrapperStruct00.var_1_11 = (max (((WrapperStruct00.var_1_8 + WrapperStruct00.var_1_3) - WrapperStruct00.var_1_12) , 100));
		}
	} else {
