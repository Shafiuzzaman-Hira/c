...
void step(void) {
	...
	if ((var_1_34 / var_1_35) <= (var_1_36 - var_1_37)) {
		var_1_33 = (abs (abs (-0.875)));
	} else {
		var_1_33 = (255.8 + (max (var_1_38 , var_1_39)));
	}
	...
	if (var_1_37 == var_1_35) {
		var_1_41 = ((var_1_42 - 16.6) - (min (8.3 , var_1_43)));
	} else {
		if ((var_1_36 * -64) == (-2 & -5)) {
	...
	// From: CodeObject8
	if (var_1_25) {
		if ((- var_1_39) <= (abs (var_1_42))) {
			var_1_46 = (max ((abs (1.0000000004E9f)) , var_1_38));
		} else {
			var_1_46 = (min ((var_1_43 - var_1_42) , var_1_39));
		}
	} else {
		if (-128 < var_1_45) {
			var_1_46 = (max ((9.25f + 49.4f) , var_1_43));
		}
	}
	...
	// From: Req6Batch62PS_CN_100
	if (var_1_10 || var_1_20) {
		var_1_19 = (max (var_1_21 , 32));
	}


	// From: Req7Batch62PS_CN_100
	if (var_1_10) {
