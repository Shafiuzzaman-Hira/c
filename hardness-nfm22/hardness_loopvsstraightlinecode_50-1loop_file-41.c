...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch4150_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch4150_1loop
	if (var_1_1) {
		var_1_15 = var_1_16;
	}


	// From: Req8Batch4150_1loop
	var_1_22 = 1;


	// From: Req9Batch4150_1loop
	var_1_23 = var_1_22;


	// From: Req3Batch4150_1loop
