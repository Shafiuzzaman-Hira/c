...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch60Amount10.c", 13, "reach_error"); }
...
int property() {
 return (((var_1_2 || var_1_3) && var_1_4) ? (var_1_1 == ((signed char) (((((var_1_5 + var_1_6)) < (var_1_7)) ? ((var_1_5 + var_1_6)) : (var_1_7))))) : 1) && ((var_1_5 > ((-100 + var_1_1) ^ var_1_1)) ? (var_1_8 == ((signed char) var_1_6)) : 1)
;
}
int main(void) {
 isInitial = 1;
