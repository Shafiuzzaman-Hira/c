...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch93stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch93stepLocals
	unsigned char stepLocal_4 = var_1_1 < (var_1_8 / var_1_11);
	unsigned char stepLocal_3 = var_1_10;
	if (var_1_10 || stepLocal_4) {
		if (stepLocal_3 || (var_1_1 != var_1_11)) {
			var_1_9 = 8;
		}
	} else {
		var_1_9 = var_1_12;
	...
	// From: Req5Batch93stepLocals
	if (var_1_16) {
		var_1_20 = (var_1_3 - 50);
	}


	// From: Req6Batch93stepLocals
	if (var_1_15) {
		var_1_21 = ((var_1_22 + 25) - var_1_19);
	}


	// From: Req7Batch93stepLocals
	if (var_1_10) {
