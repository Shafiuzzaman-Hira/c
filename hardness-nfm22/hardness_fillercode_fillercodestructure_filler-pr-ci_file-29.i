...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch29Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_7) {
  if (var_1_7) {
   if (10000000 <= var_1_16) {
    var_1_41 = ((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15)));
   }
  }
 } else {
  if (var_1_16 > (var_1_15 | var_1_13)) {
   if (((1u ^ var_1_15) / var_1_22) > (var_1_16 / var_1_22)) {
    var_1_41 = var_1_15;
   } else {
    var_1_41 = var_1_16;
   }
 ...
 if (var_1_1 && var_1_7) {
  var_1_31 = ((((((((var_1_17 - var_1_15)) > (((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9))))) ? ((var_1_17 - var_1_15)) : (((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9)))))) < 0 ) ? -(((((var_1_17 - var_1_15)) > (((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9))))) ? ((var_1_17 - var_1_15)) : (((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9)))))) : (((((var_1_17 - var_1_15)) > (((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9))))) ? ((var_1_17 - var_1_15)) : (((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9))))))));
 } else {
  if (((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9))) > var_1_17) {
   if ((! var_1_7) && (var_1_26 > var_1_23)) {
    var_1_31 = (((((var_1_15) < (var_1_17)) ? (var_1_15) : (var_1_17))) - (var_1_16 + var_1_17));
   } else {
    var_1_31 = var_1_15;
   }
  }
