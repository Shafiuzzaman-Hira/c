...
void step(void) {
	// From: Req1Batch50normal
	if ((max (var_1_2 , var_1_3)) <= (var_1_5 - var_1_6)) {
		if (var_1_5 < var_1_6) {
			if (var_1_4) {
				var_1_1 = var_1_7;
			} else {
	...
	// From: Req3Batch50normal
	if (var_1_8) {
		var_1_13 = (min ((var_1_14 + var_1_15) , (min (-0.2f , var_1_16))));
	}


	// From: Req4Batch50normal
	var_1_17 = ((var_1_18 - 25) - var_1_19);


	// From: Req5Batch50normal
	if (((var_1_18 % var_1_21) & (abs (1u))) < (var_1_22 + var_1_3)) {
	...
	// From: Req6Batch50normal
	if (var_1_8) {
		var_1_25 = (var_1_26 + var_1_27);
	}


	// From: Req7Batch50normal
	if ((~ var_1_5) > var_1_3) {
		var_1_28 = (! var_1_7);
	} else {
	...
	// From: Req8Batch50normal
	var_1_29 = var_1_27;


	// From: Req9Batch50normal
	var_1_30 = var_1_8;
}
