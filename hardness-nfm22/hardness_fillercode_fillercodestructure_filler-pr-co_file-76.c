...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch76Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject9
	if ((max (var_1_14 , var_1_18)) <= ((var_1_14 & var_1_17) & var_1_18)) {
		var_1_38 = (abs (var_1_18));
	}


	// From: Req1Batch76Filler_PR_CO
	if (! var_1_2) {
