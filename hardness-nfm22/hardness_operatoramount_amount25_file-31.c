...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch31Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (stepLocal_1 >= last_1_var_1_1) {
		...
		if (stepLocal_2 == (last_1_var_1_8 ^ last_1_var_1_1)) {
			var_1_10 = (var_1_9 + (min (last_1_var_1_1 , 4)));
		} else {
	...
	// From: Req4Batch31Amount25
	var_1_11 = var_1_12;


	// From: Req1Batch31Amount25
	if (var_1_2) {
