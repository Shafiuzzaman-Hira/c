...
void step(void) {
	// From: Req3Batch12Amount10
	var_1_7 = 199.5;


	// From: Req4Batch12Amount10
	var_1_8 = var_1_9;


	// From: Req5Batch12Amount10
	var_1_10 = var_1_5;


	// From: Req1Batch12Amount10
	...
	// From: Req2Batch12Amount10
	var_1_6 = (max (var_1_4 , var_1_1));
}
...
int property() {
	return (((((var_1_10 >= last_1_var_1_1) ? (var_1_1 == ((signed char) (abs (min (var_1_4 , var_1_5))))) : 1) && (var_1_6 == ((signed long int) (max (var_1_4 , var_1_1))))) && (var_1_7 == ((double) 199.5))) && (var_1_8 == ((unsigned char) var_1_9))) && (var_1_10 == ((signed long int) var_1_5))
;
}
int main(void) {
	isInitial = 1;
