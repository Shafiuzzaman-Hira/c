...
void step(void) {
 if (var_1_28 > var_1_60) {
  if (last_1_var_1_72 >= (var_1_36 - (10.25f + var_1_57))) {
   var_1_71 = (((((-1) < (var_1_24)) ? (-1) : (var_1_24))) + var_1_4);
  }
 }
 signed short int stepLocal_15 = var_1_17;
 signed long int stepLocal_14 = 5 - var_1_29;
 if (stepLocal_15 >= (var_1_19 - ((((last_1_var_1_80) < (var_1_30)) ? (last_1_var_1_80) : (var_1_30))))) {
  if ((- last_1_var_1_46) > (var_1_36 - var_1_7)) {
   var_1_35 = ((((((((last_1_var_1_35) > (var_1_19)) ? (last_1_var_1_35) : (var_1_19)))) > (((var_1_5 + -10) + ((((last_1_var_1_22) > (last_1_var_1_78)) ? (last_1_var_1_22) : (last_1_var_1_78)))))) ? (((((last_1_var_1_35) > (var_1_19)) ? (last_1_var_1_35) : (var_1_19)))) : (((var_1_5 + -10) + ((((last_1_var_1_22) > (last_1_var_1_78)) ? (last_1_var_1_22) : (last_1_var_1_78)))))));
  } else {
  ...
  if (var_1_11) {
   ...
   if (var_1_20 >= stepLocal_3) {
    ...
    if (stepLocal_6 >= var_1_5) {
     ...
     var_1_22 = ((((var_1_71) < ((var_1_26 - var_1_5))) ? (var_1_71) : ((var_1_26 - var_1_5))));
    }
   }
  }
 } else {
 ...
 if (var_1_12 || var_1_49) {
  ...
  if (var_1_25 > 64u) {
   if (((((last_1_var_1_16) < (2.25)) ? (last_1_var_1_16) : (2.25))) != 4.4) {
    var_1_51 = (! (! var_1_15));
   } else {
    var_1_51 = (! 1);
   }
 ...
 if (((var_1_25 % var_1_24) * var_1_26) < stepLocal_20) {
  if (var_1_42 > stepLocal_19) {
   if (var_1_28 < ((((last_1_var_1_46) < (var_1_34)) ? (last_1_var_1_46) : (var_1_34)))) {
    var_1_46 = var_1_7;
   } else {
    var_1_46 = var_1_7;
   }
  ...
  var_1_46 = ((((var_1_7) < (var_1_34)) ? (var_1_7) : (var_1_34)));
 }
 var_1_63 = -10;
 unsigned long int stepLocal_30 = (var_1_63 ^ var_1_26) ^ (var_1_19 >> var_1_21);
 if (stepLocal_30 != (((((- var_1_39)) > (10000u)) ? ((- var_1_39)) : (10000u)))) {
  var_1_69 = (var_1_58 + ((((var_1_61) > (var_1_60)) ? (var_1_61) : (var_1_60))));
 } else {
  var_1_69 = (var_1_57 - var_1_7);
 }
 signed long int stepLocal_35 = - (var_1_68 * var_1_32);
 if (stepLocal_35 >= var_1_4) {
  var_1_73 = ((((var_1_61) < 0 ) ? -(var_1_61) : (var_1_61)));
 }
 if ((- var_1_57) >= 255.6) {
 ...
 if ((var_1_59 + var_1_8) >= (63.72 - 9999999.5)) {
  var_1_67 = (((((var_1_71) < ((var_1_63 - var_1_42))) ? (var_1_71) : ((var_1_63 - var_1_42)))) + var_1_35);
 }
 if (! var_1_12) {
  if (var_1_60 < var_1_16) {
   if ((var_1_25 / var_1_20) < var_1_29) {
    ...
    var_1_76 = ((var_1_77 - ((((var_1_43) < (var_1_21)) ? (var_1_43) : (var_1_21)))) - ((((var_1_19) > (var_1_42)) ? (var_1_19) : (var_1_42))));
   }
  } else {
   var_1_76 = ((((var_1_40) < (var_1_4)) ? (var_1_40) : (var_1_4)));
  }
 } else {
  var_1_76 = ((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24)));
 }
 if (var_1_13 == var_1_76) {
  var_1_95 = var_1_40;
 } else {
  var_1_95 = (((((var_1_77) < (var_1_39)) ? (var_1_77) : (var_1_39))) - (var_1_40 - var_1_21));
 }
 signed long int stepLocal_12 = var_1_4 / -256;
 unsigned char stepLocal_11 = var_1_15;
 signed long int stepLocal_10 = (((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18));
 ...
 if (stepLocal_26 < ((- var_1_31) + var_1_43)) {
  if (stepLocal_25 == (((((var_1_30) < (var_1_80)) ? (var_1_30) : (var_1_80))) / ((((-500) < 0 ) ? -(-500) : (-500))))) {
   var_1_53 = var_1_39;
  } else {
 ...
 if ((var_1_29 + var_1_39) >= var_1_13) {
  if (var_1_36 <= var_1_34) {
   if (var_1_45) {
    ...
    var_1_54 = ((((((var_1_57 - var_1_58)) > (((((var_1_59) < (var_1_60)) ? (var_1_59) : (var_1_60))))) ? ((var_1_57 - var_1_58)) : (((((var_1_59) < (var_1_60)) ? (var_1_59) : (var_1_60)))))) + var_1_61);
   }
  } else {
   var_1_54 = 4.287;
  }
 } else {
  if (((var_1_21 & var_1_30) >= ((((var_1_23) < 0 ) ? -(var_1_23) : (var_1_23)))) && (var_1_29 != var_1_24)) {
   var_1_54 = (var_1_7 - var_1_56);
  }
 }
 if (var_1_48) {
 ...
 if ((15.75f < (- var_1_88)) && stepLocal_18) {
  ...
  if (stepLocal_16 > var_1_95) {
   var_1_38 = ((((var_1_5) < (((var_1_20 + var_1_40) - var_1_4))) ? (var_1_5) : (((var_1_20 + var_1_40) - var_1_4))));
  } else {
   if ((var_1_31 != var_1_19) || stepLocal_17) {
    var_1_38 = (((((var_1_40) < (var_1_42)) ? (var_1_40) : (var_1_42))) + ((((var_1_19) > ((var_1_21 + var_1_43))) ? (var_1_19) : ((var_1_21 + var_1_43)))));
   } else {
    var_1_38 = ((var_1_21 + var_1_43) + ((((var_1_24) < (var_1_40)) ? (var_1_24) : (var_1_40))));
   }
  }
 }
 if (var_1_7 > var_1_36) {
 ...
 if (stepLocal_27 <= var_1_95) {
  var_1_62 = ((((var_1_43) < (var_1_20)) ? (var_1_43) : (var_1_20)));
 } else {
  if (var_1_47) {
   var_1_62 = (var_1_19 + var_1_42);
  } else {
   var_1_62 = (var_1_39 - ((((var_1_40) > (var_1_24)) ? (var_1_40) : (var_1_24))));
  }
 }
  ...
  if (var_1_66) {
   ...
   if (! (var_1_42 != var_1_23)) {
    ...
    if (var_1_61 != last_1_var_1_64) {
     ...
     var_1_64 = ((((var_1_59) < (((((24.6) < ((255.2 + var_1_61))) ? (24.6) : ((255.2 + var_1_61)))))) ? (var_1_59) : (((((24.6) < ((255.2 + var_1_61))) ? (24.6) : ((255.2 + var_1_61)))))));
    }
   }
  }
 }
 ...
 if (((((var_1_23) < (((((var_1_40) < (-100)) ? (var_1_40) : (-100))))) ? (var_1_23) : (((((var_1_40) < (-100)) ? (var_1_40) : (-100)))))) < stepLocal_28) {
  var_1_65 = ((((-16) > ((var_1_24 - var_1_40))) ? (-16) : ((var_1_24 - var_1_40))));
 }
 ...
 var_1_50 = (var_1_65 + ((((var_1_29) < (var_1_17)) ? (var_1_29) : (var_1_17))));
 ...
 if (var_1_51 || stepLocal_31) {
  ...
  if (var_1_12) {
   var_1_70 = ((((((var_1_50) < (var_1_39)) ? (var_1_50) : (var_1_39))) <= var_1_32) && var_1_49);
  } else {
   var_1_70 = ((((((15.4f) < 0 ) ? -(15.4f) : (15.4f))) > var_1_55) || (var_1_11 || (! var_1_49)));
  }
 }
 ...
 if (((var_1_7 + 100000.5f) - var_1_8) > (var_1_88 + var_1_83)) {
  if (var_1_8 > var_1_88) {
   ...
   if ((var_1_27 / var_1_13) != stepLocal_1) {
    ...
    var_1_6 = ((var_1_13 > ((((var_1_68) > (var_1_27)) ? (var_1_68) : (var_1_27)))) && var_1_12);
   }
  }
 } else {
  var_1_6 = var_1_15;
 ...
 signed long int stepLocal_33 = (((0) < (var_1_21)) ? (0) : (var_1_21));
  ...
  if (var_1_86 > stepLocal_33) {
   if (stepLocal_34 < var_1_67) {
    if (stepLocal_32 > -10000000) {
     var_1_72 = (((((((var_1_59) > (var_1_60)) ? (var_1_59) : (var_1_60))) < 0 ) ? -((((var_1_59) > (var_1_60)) ? (var_1_59) : (var_1_60))) : ((((var_1_59) > (var_1_60)) ? (var_1_59) : (var_1_60)))));
    }
   } else {
   ...
   if (var_1_83 <= var_1_33) {
    var_1_72 = ((((var_1_7 - ((((var_1_57) > (8.375f)) ? (var_1_57) : (8.375f)))) < 0 ) ? -(var_1_7 - ((((var_1_57) > (8.375f)) ? (var_1_57) : (8.375f)))) : (var_1_7 - ((((var_1_57) > (8.375f)) ? (var_1_57) : (8.375f))))));
   } else {
    var_1_72 = ((((var_1_57) > (var_1_7)) ? (var_1_57) : (var_1_7)));
   }
  }
 } else {
  var_1_72 = ((((((((var_1_61) < (var_1_56)) ? (var_1_61) : (var_1_56)))) < (var_1_7)) ? (((((var_1_61) < (var_1_56)) ? (var_1_61) : (var_1_56)))) : (var_1_7)));
 }
}
