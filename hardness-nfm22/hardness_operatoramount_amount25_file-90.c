...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch90Amount25.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch90Amount25
	var_1_15 = var_1_16;


	// From: Req5Batch90Amount25
	var_1_17 = var_1_18;


	// From: Req3Batch90Amount25
	if (var_1_15) {
		var_1_11 = (((var_1_12 + var_1_13) + var_1_14) - 50);
	}


	// From: Req1Batch90Amount25
	if (var_1_15) {
		var_1_1 = (min ((var_1_11 + var_1_11) , var_1_11));
	}


	// From: Req2Batch90Amount25
