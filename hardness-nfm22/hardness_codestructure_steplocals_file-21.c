...
void step(void) {
	...
	// From: Req2Batch21stepLocals
	var_1_8 = (((var_1_7 + var_1_6) + var_1_9) + (var_1_10 - var_1_11));


	// From: Req3Batch21stepLocals
	...
	// From: Req5Batch21stepLocals
	if ((min ((max (var_1_11 , var_1_6)) , var_1_8)) > (var_1_3 * var_1_12)) {
		var_1_17 = var_1_18;
	}


	// From: Req6Batch21stepLocals
