...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch69100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch69100_while
	if (last_1_var_1_15 >= (var_1_6 | (abs (64u)))) {
		if ((8 + 5) < var_1_6) {
			var_1_14 = var_1_13;
		} else {
			var_1_14 = var_1_13;
	...
	// From: Req1Batch69100_while
	if (var_1_24 && ((var_1_3 - var_1_4) <= var_1_23)) {
		var_1_1 = ((max ((var_1_3 + var_1_4) , (var_1_6 - var_1_20))) + var_1_20);
	} else {
		var_1_1 = var_1_4;
	}


	// From: Req5Batch69100_while
	if (var_1_13 >= var_1_14) {
		if (((- var_1_9) * (var_1_14 * var_1_13)) < var_1_12) {
			if ((- var_1_14) <= ((max (var_1_9 , 4.375f)) * (var_1_9 / var_1_17))) {
				var_1_16 = (min (var_1_18 , var_1_19));
			} else {
				var_1_16 = 1;
			}
		}
