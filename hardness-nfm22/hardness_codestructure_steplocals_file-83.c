...
void step(void) {
	...
	// From: Req6Batch83stepLocals
	if ((var_1_11 % var_1_20) < var_1_1) {
		var_1_22 = (max (10 , var_1_10));
	}


	// From: Req7Batch83stepLocals
