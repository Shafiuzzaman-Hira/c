...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch96PS_CN_25.c", 13, "reach_error"); }
...
unsigned long int var_1_45 = 2154444833;
double var_1_46 = 0.5;
signed short int var_1_47 = -8;
signed short int var_1_48 = -2;
float var_1_49 = 0.75;
float var_1_50 = 9.5;
float var_1_51 = 16.85;
...
void step(void) {
	...
	// From: CodeObject4
	if ((var_1_32 >> (var_1_39 + var_1_40)) < var_1_41) {
		var_1_38 = var_1_37;
	} else {
		var_1_38 = (var_1_35 && var_1_42);
	}
	...
	// From: CodeObject6
	if (var_1_33 > 64) {
		var_1_44 = (var_1_45 - (var_1_40 + (abs (var_1_34))));
	}


	// From: CodeObject7
	if (var_1_47 > (var_1_32 | var_1_48)) {
		if ((abs (var_1_49)) >= (var_1_50 * var_1_51)) {
			var_1_46 = 2.5;
		}
	}


	// From: Req4Batch96PS_CN_25
	if ((- last_1_var_1_9) < (last_1_var_1_9 + -500)) {
		var_1_23 = var_1_20;
	}


	// From: Req3Batch96PS_CN_25
	var_1_17 = ((min (var_1_18 , var_1_19)) - (var_1_20 + (var_1_21 - var_1_22)));


	// From: Req5Batch96PS_CN_25
	if (var_1_4) {
		var_1_24 = (! var_1_25);
	} else {
	...
	// From: Req7Batch96PS_CN_25
	var_1_31 = var_1_30;


	// From: Req1Batch96PS_CN_25
...
void updateVariables() {
	...
	assume_abort_if_not(var_1_39 <= 9);
	var_1_40 = __VERIFIER_nondet_short();
	assume_abort_if_not(var_1_40 >= 0);
	assume_abort_if_not(var_1_40 <= 8);
	...
	assume_abort_if_not(var_1_47 >= -32768);
