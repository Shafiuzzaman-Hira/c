...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch80stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch80stepLocals
	if ((var_1_17 <= (- var_1_16)) && var_1_11) {
		var_1_18 = var_1_6;
	}


	// From: Req6Batch80stepLocals
	...
	// From: Req7Batch80stepLocals
	if (var_1_19) {
		var_1_22 = (var_1_10 + var_1_14);
	} else {
		var_1_22 = (min ((var_1_23 - var_1_10) , var_1_14));
	}
}
...
int property() {
	return (((((((((var_1_2 - var_1_3) * var_1_4) < var_1_5) ? (var_1_1 == ((signed short int) (min (-8 , (var_1_6 + (min (var_1_7 , var_1_8))))))) : (var_1_1 == ((signed short int) var_1_6))) && ((var_1_8 >= var_1_7) ? (var_1_9 == ((signed short int) (-256 + var_1_6))) : (var_1_9 == ((signed short int) (var_1_7 + var_1_6))))) && (var_1_11 ? (var_1_10 == ((unsigned char) (min (0 , var_1_12)))) : ((! (var_1_5 > (255.9 / var_1_13))) ? (var_1_10 == ((unsigned char) var_1_12)) : 1))) && ((! var_1_11) ? ((((var_1_15 - var_1_16) - var_1_17) <= var_1_13) ? (var_1_14 == ((unsigned short int) var_1_10)) : (var_1_14 == ((unsigned short int) var_1_10))) : 1)) && (((var_1_17 <= (- var_1_16)) && var_1_11) ? (var_1_18 == ((signed short int) var_1_6)) : 1)) && ((var_1_9 > 0) ? (var_1_19 == ((unsigned char) ((var_1_5 >= (- var_1_15)) && (var_1_11 && (var_1_20 && var_1_21))))) : 1)) && (var_1_19 ? (var_1_22 == ((unsigned long int) (var_1_10 + var_1_14))) : (var_1_22 == ((unsigned long int) (min ((var_1_23 - var_1_10) , var_1_14)))))
;
}
int main(void) {
	isInitial = 1;
