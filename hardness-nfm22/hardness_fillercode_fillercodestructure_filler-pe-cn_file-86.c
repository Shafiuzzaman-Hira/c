...
void step(void) {
	...
	// From: Req2Batch86Filler_PE_CN
	if (var_1_19) {
		var_1_6 = (last_1_var_1_6 || var_1_9);
	}


	// From: Req4Batch86Filler_PE_CN
	...
	// From: Req7Batch86Filler_PE_CN
	var_1_22 = var_1_15;


	// From: Req5Batch86Filler_PE_CN
