...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch17Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_4 > (var_1_4 >> var_1_4)) {
  if (var_1_8) {
   var_1_39 = ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4)));
  } else {
   var_1_39 = (((((256 - (var_1_40 - var_1_4))) > (var_1_4)) ? ((256 - (var_1_40 - var_1_4))) : (var_1_4)));
  }
 } else {
  var_1_39 = var_1_4;
 }
 ...
 if (128u <= var_1_19) {
  if ((var_1_12 >= var_1_12) && ((var_1_19 * var_1_15) < ((((var_1_1) < (var_1_19)) ? (var_1_1) : (var_1_19))))) {
 ...
 if (var_1_1 >= var_1_14) {
  var_1_30 = (((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19))) - var_1_2);
 }
 if (var_1_19 > var_1_3) {
  var_1_35 = var_1_4;
 } else {
  if ((var_1_4 - ((((var_1_4) > (var_1_2)) ? (var_1_4) : (var_1_2)))) < ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4)))) {
   if ((var_1_2 | var_1_15) < var_1_3) {
    var_1_35 = var_1_4;
   }
  }
 }
 ...
 var_1_20 = ((((var_1_13) < (var_1_13)) ? (var_1_13) : (var_1_13)));
