...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch67Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch67Wrapper_P
	if (! (last_1_var_1_6 <= last_1_var_1_1)) {
		(*(var_1_1_Pointer)) = ((*(var_1_4_Pointer)) + (*(var_1_5_Pointer)));
	}


	// From: Req2Batch67Wrapper_P
	signed long int stepLocal_0 = 1 * (*(var_1_4_Pointer));
	if (((*(var_1_1_Pointer)) >> (*(var_1_5_Pointer))) > stepLocal_0) {
		(*(var_1_6_Pointer)) = (max ((42286 - (*(var_1_7_Pointer))) , 0));
	} else {
		(*(var_1_6_Pointer)) = (*(var_1_7_Pointer));
	}


	// From: Req4Batch67Wrapper_P
	(*(var_1_11_Pointer)) = (*(var_1_12_Pointer));


	// From: Req5Batch67Wrapper_P
	(*(var_1_13_Pointer)) = (*(var_1_12_Pointer));


	// From: Req6Batch67Wrapper_P
	(*(var_1_14_Pointer)) = (*(var_1_7_Pointer));


	// From: Req3Batch67Wrapper_P
	signed long int stepLocal_2 = (*(var_1_4_Pointer)) / (*(var_1_10_Pointer));
	unsigned short int stepLocal_1 = (*(var_1_7_Pointer));
	if ((*(var_1_9_Pointer))) {
		(*(var_1_8_Pointer)) = (min ((*(var_1_6_Pointer)) , last_1_var_1_8));
	} else {
		if ((*(var_1_14_Pointer)) > stepLocal_2) {
			if (stepLocal_1 > (*(var_1_6_Pointer))) {
				(*(var_1_8_Pointer)) = (min ((*(var_1_4_Pointer)) , 100));
			} else {
				(*(var_1_8_Pointer)) = (last_1_var_1_8 - (*(var_1_7_Pointer)));
			}
		} else {
			(*(var_1_8_Pointer)) = ((*(var_1_6_Pointer)) + (*(var_1_5_Pointer)));
		}
	}
}
...
int property() {
	return ((((((! (last_1_var_1_6 <= last_1_var_1_1)) ? ((*(var_1_1_Pointer)) == ((signed short int) ((*(var_1_4_Pointer)) + (*(var_1_5_Pointer))))) : 1) && ((((*(var_1_1_Pointer)) >> (*(var_1_5_Pointer))) > (1 * (*(var_1_4_Pointer)))) ? ((*(var_1_6_Pointer)) == ((unsigned short int) (max ((42286 - (*(var_1_7_Pointer))) , 0)))) : ((*(var_1_6_Pointer)) == ((unsigned short int) (*(var_1_7_Pointer)))))) && ((*(var_1_9_Pointer)) ? ((*(var_1_8_Pointer)) == ((signed long int) (min ((*(var_1_6_Pointer)) , last_1_var_1_8)))) : (((*(var_1_14_Pointer)) > ((*(var_1_4_Pointer)) / (*(var_1_10_Pointer)))) ? (((*(var_1_7_Pointer)) > (*(var_1_6_Pointer))) ? ((*(var_1_8_Pointer)) == ((signed long int) (min ((*(var_1_4_Pointer)) , 100)))) : ((*(var_1_8_Pointer)) == ((signed long int) (last_1_var_1_8 - (*(var_1_7_Pointer)))))) : ((*(var_1_8_Pointer)) == ((signed long int) ((*(var_1_6_Pointer)) + (*(var_1_5_Pointer)))))))) && ((*(var_1_11_Pointer)) == ((float) (*(var_1_12_Pointer))))) && ((*(var_1_13_Pointer)) == ((double) (*(var_1_12_Pointer))))) && ((*(var_1_14_Pointer)) == ((unsigned short int) (*(var_1_7_Pointer))))
;
}
int main(void) {
	isInitial = 1;
