...
int property() {
	return (((((var_1_20 > var_1_20) ? (var_1_1 == ((signed short int) (max (var_1_15 , var_1_15)))) : (var_1_1 == ((signed short int) (min ((var_1_15 - (max (var_1_15 , var_1_15))) , (var_1_15 + (min (var_1_15 , var_1_15)))))))) && (var_1_12 == ((float) ((0.85f - var_1_13) + var_1_14)))) && (((- last_1_var_1_15) >= (var_1_4 / (abs (-4)))) ? (var_1_15 == ((unsigned char) var_1_16)) : 1)) && (((var_1_15 + (var_1_15 + var_1_1)) != (var_1_15 * (var_1_1 / var_1_19))) ? (var_1_17 == ((unsigned long int) ((min (10u , (var_1_1 + var_1_15))) + var_1_15))) : 1)) && (var_1_20 == ((float) var_1_13))
;
}
int main(void) {
	isInitial = 1;
