...
void step(void) {
 ...
 if (stepLocal_0 >= (*(WrapperStruct00_var_1_15_Pointer))) {
  (*(WrapperStruct00_var_1_1_Pointer)) = (((((*(WrapperStruct00_var_1_3_Pointer))) < (((((1) < 0 ) ? -(1) : (1))))) ? ((*(WrapperStruct00_var_1_3_Pointer))) : (((((1) < 0 ) ? -(1) : (1))))));
 }
 ...
 if ((*(WrapperStruct00_var_1_9_Pointer))) {
  if (stepLocal_2 > (*(WrapperStruct00_var_1_15_Pointer))) {
   (*(WrapperStruct00_var_1_11_Pointer)) = (((((((((*(WrapperStruct00_var_1_12_Pointer))) > (16.5)) ? ((*(WrapperStruct00_var_1_12_Pointer))) : (16.5)))) > ((*(WrapperStruct00_var_1_13_Pointer)))) ? ((((((*(WrapperStruct00_var_1_12_Pointer))) > (16.5)) ? ((*(WrapperStruct00_var_1_12_Pointer))) : (16.5)))) : ((*(WrapperStruct00_var_1_13_Pointer)))));
  } else {
 ...
 signed long int stepLocal_1 = (((10) > ((*(WrapperStruct00_var_1_1_Pointer)))) ? (10) : ((*(WrapperStruct00_var_1_1_Pointer))));
 if ((8 * (*(WrapperStruct00_var_1_1_Pointer))) == stepLocal_1) {
  if ((*(WrapperStruct00_var_1_6_Pointer))) {
   ...
   if ((*(WrapperStruct00_var_1_14_Pointer)) >= (((((*(WrapperStruct00_var_1_11_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_11_Pointer))) : ((*(WrapperStruct00_var_1_11_Pointer)))))) {
