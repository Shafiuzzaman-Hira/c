...
void step(void) {
	// From: Req5Batch25Amount250
	if (last_1_var_1_33) {
		if (last_1_var_1_29 != (last_1_var_1_37 - var_1_24)) {
			var_1_27 = ((abs (last_1_var_1_37)) + (var_1_26 + last_1_var_1_57));
		} else {
			if (last_1_var_1_33) {
				var_1_27 = (last_1_var_1_57 - (max (var_1_22 , var_1_23)));
			}
		}
	}


	// From: Req7Batch25Amount250
	if ((16 / var_1_21) <= last_1_var_1_71) {
		var_1_31 = (max ((var_1_32 - last_1_var_1_52) , last_1_var_1_35));
	} else {
	...
	// From: Req16Batch25Amount250
	var_1_56 = var_1_12;


	// From: Req22Batch25Amount250
	var_1_74 = var_1_12;


	// From: Req4Batch25Amount250
	if ((last_1_var_1_46 / var_1_17) < (last_1_var_1_46 + (last_1_var_1_54 * last_1_var_1_51))) {
		if ((last_1_var_1_1 / var_1_14) <= (last_1_var_1_31 / (min (var_1_13 , var_1_21)))) {
			var_1_15 = (max (((var_1_22 - var_1_23) - var_1_24) , (var_1_25 - var_1_26)));
		} else {
			var_1_15 = var_1_24;
		}
	} else {
	...
	// From: Req12Batch25Amount250
	if (64u >= ((var_1_13 - var_1_74) + var_1_12)) {
		var_1_46 = (max ((max (128.75 , (var_1_47 - var_1_48))) , (var_1_49 - var_1_50)));
	}


	// From: Req6Batch25Amount250
	signed long int stepLocal_5 = (max (var_1_23 , var_1_24)) - var_1_26;
	if (stepLocal_5 <= last_1_var_1_15) {
		var_1_29 = ((min (var_1_25 , var_1_22)) - var_1_24);
	} else {
		if (last_1_var_1_33) {
			var_1_29 = (max ((min (var_1_25 , var_1_30)) , (var_1_23 + var_1_24)));
		}
	}


	// From: Req8Batch25Amount250
	var_1_33 = (! var_1_34);


	// From: Req13Batch25Amount250
	if (! var_1_33) {
		var_1_51 = (var_1_49 - var_1_47);
	} else {
		var_1_51 = (max (var_1_42 , (abs (255.5f))));
	}


	// From: Req15Batch25Amount250
	if (var_1_33) {
		var_1_54 = ((max ((1.6f + var_1_55) , var_1_42)) + var_1_43);
	}


	// From: Req20Batch25Amount250
	var_1_71 = var_1_61;


	// From: Req23Batch25Amount250
	var_1_75 = 49.375f;


	// From: Req24Batch25Amount250
	var_1_76 = 4.4f;


	// From: Req17Batch25Amount250
	if ((var_1_12 < (var_1_31 | var_1_14)) || var_1_33) {
		var_1_57 = (max ((var_1_23 - var_1_58) , var_1_22));
	} else {
			...
			if (var_1_33) {
				...
				if (((var_1_58 + var_1_29) / var_1_60) == 5) {
					if (var_1_33 || var_1_33) {
						var_1_57 = ((min ((var_1_23 - var_1_62) , var_1_61)) + (var_1_59 - var_1_60));
					} else {
						var_1_57 = 64;
					}
				}
	...
	// From: Req19Batch25Amount250
	if ((max ((var_1_31 * var_1_24) , var_1_29)) > var_1_56) {
		if (var_1_15 < (-2 * var_1_56)) {
			var_1_64 = (min (var_1_49 , var_1_45));
		} else {
			var_1_64 = (((max (var_1_55 , var_1_65)) + var_1_66) + ((var_1_67 - var_1_68) - var_1_69));
		}
	} else {
		var_1_64 = ((var_1_68 + var_1_69) - (max ((var_1_67 + var_1_70) , var_1_50)));
	}


	// From: Req9Batch25Amount250
	if (var_1_33 || var_1_34) {
		var_1_35 = (abs (var_1_29));
	} else {
		var_1_35 = ((max (4 , 25)) - (max (var_1_26 , var_1_15)));
	}


	// From: Req2Batch25Amount250
	...
	if (var_1_29 > stepLocal_4) {
		if (stepLocal_2 && var_1_33) {
			var_1_8 = (min (var_1_35 , (abs (var_1_27))));
		}
	} else {
		if (var_1_33) {
			var_1_8 = ((var_1_27 + var_1_35) - (var_1_29 + (min (var_1_15 , 2))));
		} else {
	...
	// From: Req21Batch25Amount250
	unsigned char stepLocal_11 = var_1_29;
	if (stepLocal_11 <= (var_1_39 * (abs (var_1_35)))) {
		var_1_72 = (max ((var_1_32 - var_1_29) , var_1_71));
	}


	// From: Req14Batch25Amount250
	if ((var_1_32 - var_1_24) > var_1_22) {
		if ((var_1_50 - var_1_47) >= var_1_17) {
			if ((var_1_56 < (var_1_15 / var_1_25)) && var_1_33) {
				var_1_52 = (max ((max (var_1_29 , var_1_74)) , var_1_57));
			}
		} else {
	...
	if (! (var_1_35 >= last_1_var_1_1)) {
		...
		if (stepLocal_1 >= (last_1_var_1_1 + var_1_35)) {
			...
			var_1_1 = ((max ((last_1_var_1_1 + var_1_35) , (var_1_31 - var_1_15))) + (min (var_1_29 , var_1_35)));
		}
	}


	// From: Req18Batch25Amount250
	...
	// From: Req11Batch25Amount250
	signed short int stepLocal_10 = var_1_52;
	if (var_1_15 == stepLocal_10) {
		if (var_1_33) {
			var_1_41 = (var_1_42 + (max (var_1_43 , var_1_44)));
		}
	} else {
		var_1_41 = (max ((var_1_45 + var_1_43) , (var_1_42 + var_1_44)));
	}


	// From: Req10Batch25Amount250
	...
	if ((var_1_29 < var_1_25) && stepLocal_8) {
		if ((- (var_1_25 - var_1_26)) < stepLocal_9) {
			...
			if (stepLocal_6 > var_1_26) {
				var_1_37 = ((var_1_39 - var_1_26) - (max ((var_1_14 - var_1_25) , var_1_1)));
			} else {
		...
		if (stepLocal_7 != var_1_1) {
			...
			var_1_37 = (min (var_1_23 , var_1_22));
		}
	}
}
...
int property() {
	return ((((((((((((((((((((((((! (var_1_35 >= last_1_var_1_1)) ? ((256 != var_1_35) ? (var_1_1 == ((signed long int) (last_1_var_1_1 + var_1_35))) : 1) : (((-128 / -2) >= (last_1_var_1_1 + var_1_35)) ? (var_1_1 == ((signed long int) (var_1_35 - last_1_var_1_1))) : (var_1_1 == ((signed long int) ((max ((last_1_var_1_1 + var_1_35) , (var_1_31 - var_1_15))) + (min (var_1_29 , var_1_35))))))) && ((var_1_29 > var_1_31) ? ((((var_1_35 + 10) <= var_1_35) && var_1_33) ? (var_1_8 == ((signed short int) (min (var_1_35 , (abs (var_1_27)))))) : 1) : (var_1_33 ? (var_1_8 == ((signed short int) ((var_1_27 + var_1_35) - (var_1_29 + (min (var_1_15 , 2)))))) : ((var_1_29 >= var_1_29) ? (var_1_8 == ((signed short int) var_1_29)) : 1)))) && ((! last_1_var_1_33) ? (var_1_12 == ((unsigned long int) (var_1_13 - last_1_var_1_15))) : (var_1_12 == ((unsigned long int) ((var_1_14 - last_1_var_1_27) + last_1_var_1_15))))) && (((last_1_var_1_46 / var_1_17) < (last_1_var_1_46 + (last_1_var_1_54 * last_1_var_1_51))) ? (((last_1_var_1_1 / var_1_14) <= (last_1_var_1_31 / (min (var_1_13 , var_1_21)))) ? (var_1_15 == ((unsigned char) (max (((var_1_22 - var_1_23) - var_1_24) , (var_1_25 - var_1_26))))) : (var_1_15 == ((unsigned char) var_1_24))) : (var_1_15 == ((unsigned char) var_1_23)))) && (last_1_var_1_33 ? ((last_1_var_1_29 != (last_1_var_1_37 - var_1_24)) ? (var_1_27 == ((signed short int) ((abs (last_1_var_1_37)) + (var_1_26 + last_1_var_1_57)))) : (last_1_var_1_33 ? (var_1_27 == ((signed short int) (last_1_var_1_57 - (max (var_1_22 , var_1_23))))) : 1)) : 1)) && ((((max (var_1_23 , var_1_24)) - var_1_26) <= last_1_var_1_15) ? (var_1_29 == ((unsigned char) ((min (var_1_25 , var_1_22)) - var_1_24))) : (last_1_var_1_33 ? (var_1_29 == ((unsigned char) (max ((min (var_1_25 , var_1_30)) , (var_1_23 + var_1_24))))) : 1))) && (((16 / var_1_21) <= last_1_var_1_71) ? (var_1_31 == ((unsigned short int) (max ((var_1_32 - last_1_var_1_52) , last_1_var_1_35)))) : (((last_1_var_1_29 / var_1_13) <= var_1_23) ? (var_1_31 == ((unsigned short int) (var_1_32 - var_1_23))) : 1))) && (var_1_33 == ((unsigned char) (! var_1_34)))) && ((var_1_33 || var_1_34) ? (var_1_35 == ((signed short int) (abs (var_1_29)))) : (var_1_35 == ((signed short int) ((max (4 , 25)) - (max (var_1_26 , var_1_15))))))) && (((var_1_29 < var_1_25) && (var_1_76 == var_1_63)) ? (((- (var_1_25 - var_1_26)) < var_1_30) ? (var_1_37 == ((unsigned long int) var_1_13)) : ((var_1_29 > var_1_26) ? (var_1_37 == ((unsigned long int) ((var_1_39 - var_1_26) - (max ((var_1_14 - var_1_25) , var_1_1))))) : (var_1_37 == ((unsigned long int) ((var_1_14 + 1604009696u) - (var_1_40 - var_1_52)))))) : ((var_1_27 != var_1_1) ? (var_1_37 == ((unsigned long int) (var_1_29 + (var_1_14 - last_1_var_1_37)))) : (var_1_37 == ((unsigned long int) (min (var_1_23 , var_1_22))))))) && ((var_1_15 == var_1_52) ? (var_1_33 ? (var_1_41 == ((float) (var_1_42 + (max (var_1_43 , var_1_44))))) : 1) : (var_1_41 == ((float) (max ((var_1_45 + var_1_43) , (var_1_42 + var_1_44))))))) && ((64u >= ((var_1_13 - var_1_74) + var_1_12)) ? (var_1_46 == ((double) (max ((max (128.75 , (var_1_47 - var_1_48))) , (var_1_49 - var_1_50))))) : 1)) && ((! var_1_33) ? (var_1_51 == ((float) (var_1_49 - var_1_47))) : (var_1_51 == ((float) (max (var_1_42 , (abs (255.5f)))))))) && (((var_1_32 - var_1_24) > var_1_22) ? (((var_1_50 - var_1_47) >= var_1_17) ? (((var_1_56 < (var_1_15 / var_1_25)) && var_1_33) ? (var_1_52 == ((signed short int) (max ((max (var_1_29 , var_1_74)) , var_1_57)))) : 1) : (var_1_52 == ((signed short int) (var_1_24 - (var_1_22 + var_1_30))))) : (var_1_33 ? (var_1_52 == ((signed short int) (var_1_15 + 64))) : 1))) && (var_1_33 ? (var_1_54 == ((float) ((max ((1.6f + var_1_55) , var_1_42)) + var_1_43))) : 1)) && (var_1_56 == ((signed short int) var_1_12))) && (((var_1_12 < (var_1_31 | var_1_14)) || var_1_33) ? (var_1_57 == ((signed char) (max ((var_1_23 - var_1_58) , var_1_22)))) : ((var_1_34 && var_1_33) ? (var_1_33 ? ((var_1_15 <= ((~ var_1_40) / var_1_22)) ? (var_1_57 == ((signed char) (var_1_23 + (var_1_59 - (var_1_60 - var_1_61))))) : 1) : ((((var_1_58 + var_1_29) / var_1_60) == 5) ? ((var_1_33 || var_1_33) ? (var_1_57 == ((signed char) ((min ((var_1_23 - var_1_62) , var_1_61)) + (var_1_59 - var_1_60)))) : (var_1_57 == ((signed char) 64))) : 1)) : 1))) && ((var_1_64 >= var_1_44) ? (var_1_63 == ((float) (abs (var_1_50)))) : (var_1_63 == ((float) var_1_47)))) && (((max ((var_1_31 * var_1_24) , var_1_29)) > var_1_56) ? ((var_1_15 < (-2 * var_1_56)) ? (var_1_64 == ((float) (min (var_1_49 , var_1_45)))) : (var_1_64 == ((float) (((max (var_1_55 , var_1_65)) + var_1_66) + ((var_1_67 - var_1_68) - var_1_69))))) : (var_1_64 == ((float) ((var_1_68 + var_1_69) - (max ((var_1_67 + var_1_70) , var_1_50))))))) && (var_1_71 == ((signed char) var_1_61))) && ((var_1_29 <= (var_1_39 * (abs (var_1_35)))) ? (var_1_72 == ((signed long int) (max ((var_1_32 - var_1_29) , var_1_71)))) : 1)) && (var_1_74 == ((unsigned long int) var_1_12))) && (var_1_75 == ((float) 49.375f))) && (var_1_76 == ((float) 4.4f))
;
}
int main(void) {
	isInitial = 1;
