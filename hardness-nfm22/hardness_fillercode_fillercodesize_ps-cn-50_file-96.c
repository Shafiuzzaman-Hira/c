...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch96PS_CN_50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch96PS_CN_50
	var_1_31 = var_1_30;


	// From: Req1Batch96PS_CN_50
