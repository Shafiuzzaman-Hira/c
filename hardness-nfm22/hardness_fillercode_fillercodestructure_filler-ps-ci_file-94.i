...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch94Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
 if ((var_1_22 * var_1_26) == var_1_17) {
  if (var_1_17 > var_1_22) {
   var_1_28 = (((var_1_12 * var_1_11) > (16.6f / var_1_34)) && var_1_7);
  }
 } else {
  if (5 <= ((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26)))) {
   var_1_28 = ((var_1_11 >= var_1_34) || var_1_6);
  }
 }
 if (var_1_6) {
  var_1_37 = (((((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8))) < 0 ) ? -((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8))) : ((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8)))));
 } else {
  if (var_1_14 >= (var_1_14 - var_1_13)) {
   var_1_37 = ((((var_1_8) > (var_1_21)) ? (var_1_8) : (var_1_21)));
  } else {
   if (var_1_21 > var_1_8) {
    var_1_37 = var_1_8;
   } else {
 ...
 if (var_1_34 <= var_1_14) {
  if (var_1_16 < -2) {
   ...
   var_1_43 = ((var_1_7 || var_1_7) && var_1_7);
  }
 }
 if ((var_1_14 - var_1_14) > var_1_13) {
  if (var_1_26 <= var_1_20) {
   var_1_45 = ((var_1_17 + var_1_22) + 5u);
  } else {
   var_1_45 = ((((var_1_17) > (var_1_22)) ? (var_1_17) : (var_1_22)));
  }
 } else {
  var_1_45 = var_1_22;
 }
