...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch59stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_2 < var_1_3) {
  ...
  if (! var_1_2) {
   var_1_5 = ((((var_1_3) > ((var_1_7 + var_1_4))) ? (var_1_3) : ((var_1_7 + var_1_4))));
  }
 }
 ...
 if (stepLocal_4 != ((var_1_6 / var_1_4) * ((((var_1_1) > (var_1_5)) ? (var_1_1) : (var_1_5))))) {
