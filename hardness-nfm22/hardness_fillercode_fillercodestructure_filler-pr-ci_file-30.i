...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch30Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16))) - var_1_21) == (var_1_10 * var_1_7)) {
  var_1_19 = -4;
 }
 ...
 if (var_1_7 > var_1_5) {
  ...
  if (var_1_1) {
   var_1_31 = ((((((((var_1_7) < (var_1_7)) ? (var_1_7) : (var_1_7))) < 0 ) ? -((((var_1_7) < (var_1_7)) ? (var_1_7) : (var_1_7))) : ((((var_1_7) < (var_1_7)) ? (var_1_7) : (var_1_7))))) - 256.35f);
  }
 }
 if (! ((1 + var_1_11) <= var_1_13)) {
