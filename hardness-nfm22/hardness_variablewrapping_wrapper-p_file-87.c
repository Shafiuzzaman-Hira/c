...
void step(void) {
	// From: Req4Batch87Wrapper_P
	(*(var_1_12_Pointer)) = (*(var_1_8_Pointer));


	// From: Req5Batch87Wrapper_P
	(*(var_1_13_Pointer)) = (*(var_1_14_Pointer));


	// From: Req6Batch87Wrapper_P
	(*(var_1_15_Pointer)) = (*(var_1_9_Pointer));


	// From: Req1Batch87Wrapper_P
	if ((*(var_1_13_Pointer))) {
		(*(var_1_1_Pointer)) = (abs ((*(var_1_3_Pointer)) - (*(var_1_4_Pointer))));
	}


	// From: Req2Batch87Wrapper_P
	...
	if (stepLocal_0 < (*(var_1_4_Pointer))) {
		if (stepLocal_1 != (*(var_1_12_Pointer))) {
			(*(var_1_5_Pointer)) = ((abs ((*(var_1_6_Pointer)))) - ((min ((*(var_1_7_Pointer)) , (*(var_1_8_Pointer)))) + (*(var_1_9_Pointer))));
		} else {
			(*(var_1_5_Pointer)) = -8;
		}
	} else {
	...
	// From: Req3Batch87Wrapper_P
	if ((last_1_var_1_10 * (*(var_1_3_Pointer))) <= (*(var_1_4_Pointer))) {
		if (((*(var_1_9_Pointer)) - (abs (-1))) <= ((*(var_1_15_Pointer)) * (*(var_1_8_Pointer)))) {
...
int property() {
	return ((((((*(var_1_13_Pointer)) ? ((*(var_1_1_Pointer)) == ((unsigned long int) (abs ((*(var_1_3_Pointer)) - (*(var_1_4_Pointer)))))) : 1) && ((-8 < (*(var_1_4_Pointer))) ? (((*(var_1_4_Pointer)) != (*(var_1_12_Pointer))) ? ((*(var_1_5_Pointer)) == ((signed char) ((abs ((*(var_1_6_Pointer)))) - ((min ((*(var_1_7_Pointer)) , (*(var_1_8_Pointer)))) + (*(var_1_9_Pointer)))))) : ((*(var_1_5_Pointer)) == ((signed char) -8))) : ((*(var_1_5_Pointer)) == ((signed char) (*(var_1_8_Pointer)))))) && (((last_1_var_1_10 * (*(var_1_3_Pointer))) <= (*(var_1_4_Pointer))) ? ((((*(var_1_9_Pointer)) - (abs (-1))) <= ((*(var_1_15_Pointer)) * (*(var_1_8_Pointer)))) ? ((*(var_1_10_Pointer)) == ((signed long int) ((*(var_1_8_Pointer)) - (*(var_1_9_Pointer))))) : ((*(var_1_10_Pointer)) == ((signed long int) (*(var_1_7_Pointer))))) : ((*(var_1_10_Pointer)) == ((signed long int) (*(var_1_7_Pointer)))))) && ((*(var_1_12_Pointer)) == ((signed long int) (*(var_1_8_Pointer))))) && ((*(var_1_13_Pointer)) == ((unsigned char) (*(var_1_14_Pointer))))) && ((*(var_1_15_Pointer)) == ((unsigned long int) (*(var_1_9_Pointer))))
;
}
int main(void) {
	isInitial = 1;
