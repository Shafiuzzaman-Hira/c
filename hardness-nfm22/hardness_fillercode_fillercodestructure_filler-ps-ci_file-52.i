...
void step(void) {
 if ((var_1_1 | ((((var_1_20) > (var_1_7)) ? (var_1_20) : (var_1_7)))) < (((((-5) < 0 ) ? -(-5) : (-5))) >> var_1_21)) {
  var_1_23 = var_1_28;
 }
 var_1_29 = var_1_10;
 if (var_1_20 != (~ -16)) {
 ...
 if ((var_1_11 | var_1_20) <= var_1_10) {
  var_1_36 = ((((var_1_11) > (((var_1_10 - 2) + var_1_10))) ? (var_1_11) : (((var_1_10 - 2) + var_1_10))));
 }
 if ((25u % var_1_9) < var_1_7) {
  var_1_37 = (((((var_1_10) < (((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10))))) ? (var_1_10) : (((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10)))))) + var_1_8);
 } else {
  if ((((((var_1_33) > (var_1_40)) ? (var_1_33) : (var_1_40))) >= var_1_31) && (var_1_8 <= var_1_17)) {
   var_1_37 = var_1_10;
  } else {
