...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch98Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_27 < var_1_34) {
  if ((((((((var_1_34) > (var_1_21)) ? (var_1_34) : (var_1_21))) < 0 ) ? -((((var_1_34) > (var_1_21)) ? (var_1_34) : (var_1_21))) : ((((var_1_34) > (var_1_21)) ? (var_1_34) : (var_1_21))))) <= var_1_12) {
   var_1_38 = (((((((((var_1_37) < (var_1_36)) ? (var_1_37) : (var_1_36))) - var_1_39)) < (var_1_7)) ? ((((((var_1_37) < (var_1_36)) ? (var_1_37) : (var_1_36))) - var_1_39)) : (var_1_7)));
  } else {
   var_1_38 = var_1_36;
  }
 } else {
 ...
 if (var_1_21 <= ((var_1_34 - var_1_31) - ((((var_1_21) < (var_1_4)) ? (var_1_21) : (var_1_4))))) {
  var_1_33 = 128;
 }
 if ((var_1_14 | var_1_11) > var_1_11) {
  if (-16 <= (((((var_1_20 - var_1_31)) > (((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14))))) ? ((var_1_20 - var_1_31)) : (((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14))))))) {
   var_1_35 = (63.2 - 7.4);
  } else {
   var_1_35 = ((var_1_36 - var_1_37) - ((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))));
  }
 } else {
 ...
 if (((((((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12)))) > (2u)) ? (((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12)))) : (2u))) > (var_1_11 & var_1_15)) {
  if (var_1_11 >= (var_1_27 - var_1_15)) {
