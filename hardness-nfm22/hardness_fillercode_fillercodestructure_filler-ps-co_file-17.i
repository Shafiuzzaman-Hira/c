...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch17Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (128u <= var_1_5) {
  if ((var_1_11 >= var_1_21) && ((var_1_5 * var_1_1) < ((((var_1_18) < (var_1_5)) ? (var_1_18) : (var_1_5))))) {
   if (var_1_1 > var_1_5) {
    var_1_23 = ((((4) < 0 ) ? -(4) : (4)));
   } else {
    if (var_1_8) {
 ...
 if (var_1_31 > var_1_1) {
  ...
  if ((var_1_36 - ((((var_1_1) > (var_1_1)) ? (var_1_1) : (var_1_1)))) < ((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))) {
