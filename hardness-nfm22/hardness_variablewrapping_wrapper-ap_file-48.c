...
void step(void) {
	...
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
		if (last_1_unsigned_char_Array_0_0__1_ != last_1_unsigned_char_Array_0_0__1_) {
			...
			(*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var3_Pointer)) = ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var4_Pointer)) - ((max ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var6_Pointer)) , (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var7_Pointer)))) - (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))));
		}
	}
}
