...
void step(void) {
 ...
 signed long int stepLocal_3 = (((((((var_1_3) > (var_1_6)) ? (var_1_3) : (var_1_6)))) > (var_1_5)) ? (((((var_1_3) > (var_1_6)) ? (var_1_3) : (var_1_6)))) : (var_1_5));
 ...
 if ((((((var_1_13) < (8)) ? (var_1_13) : (8))) <= var_1_5) || stepLocal_6) {
