...
void step(void) {
 ...
 var_1_36 = (((((var_1_20) > (((((var_1_20) < 0 ) ? -(var_1_20) : (var_1_20))))) ? (var_1_20) : (((((var_1_20) < 0 ) ? -(var_1_20) : (var_1_20)))))) + var_1_7);
 if (256 > (-10 >> var_1_7)) {
 ...
 if (! (var_1_35 >= (var_1_41 - var_1_40))) {
  var_1_42 = (((((var_1_7 - 256)) < (var_1_7)) ? ((var_1_7 - 256)) : (var_1_7)));
 }
 if (((var_1_27 * var_1_27) | var_1_7) <= (var_1_20 + 8u)) {
  if (((((16u) < (var_1_20)) ? (16u) : (var_1_20))) < var_1_27) {
   var_1_45 = var_1_46;
  } else {
 ...
 if (0.83f > var_1_35) {
  if ((var_1_7 + ((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)))) <= var_1_7) {
   var_1_49 = var_1_35;
  }
 } else {
  var_1_49 = var_1_35;
