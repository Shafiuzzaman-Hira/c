...
void step(void) {
	// From: Req1Batch8stepLocals
	if (var_1_2 == (var_1_3 % var_1_4)) {
		var_1_1 = (var_1_5 - var_1_6);
	}


	// From: Req2Batch8stepLocals
	if (var_1_1 >= var_1_6) {
		var_1_7 = var_1_8;
	}


	// From: Req3Batch8stepLocals
	...
	// From: Req4Batch8stepLocals
	if (var_1_2 < var_1_3) {
		var_1_13 = (var_1_14 + ((max (var_1_15 , var_1_16)) - (var_1_17 + var_1_18)));
	}


	// From: Req5Batch8stepLocals
	if (var_1_10 == var_1_1) {
		if (var_1_11) {
