...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch78Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch78Filler_PE_CI
	var_1_20 = (max ((var_1_5 + var_1_6) , var_1_4));


	// From: Req4Batch78Filler_PE_CI
	...
	// From: Req6Batch78Filler_PE_CI
	var_1_16 = (var_1_17 + (var_1_18 + (abs (var_1_19))));


	// From: Req1Batch78Filler_PE_CI
	var_1_1 = (abs (var_1_16));


	// From: Req8Batch78Filler_PE_CI
	...
	// From: CodeObject2
	if ((min (var_1_5 , var_1_4)) >= var_1_1) {
		var_1_24 = ((var_1_26 + var_1_27) - var_1_4);
	}


	// From: CodeObject3
	if (var_1_27 > 0) {
		var_1_28 = (min ((max ((var_1_29 + var_1_30) , var_1_5)) , 0));
	}
	...
	// From: CodeObject5
	if (var_1_26 > 100) {
		if (((abs (var_1_27)) ^ var_1_26) > var_1_6) {
			var_1_32 = (! var_1_33);
		} else {
			var_1_32 = var_1_34;
		}
	...
	// From: CodeObject6
	var_1_35 = (max (var_1_26 , (abs (var_1_5))));


	// From: CodeObject7
	if (var_1_29 > var_1_30) {
		if ((var_1_21 ^ var_1_27) != (var_1_5 / 32)) {
			var_1_36 = ((abs (abs (-5))) - ((abs (var_1_30)) + (1000000000 - var_1_4)));
		} else {
			var_1_36 = (abs (var_1_5));
		}
	} else {
