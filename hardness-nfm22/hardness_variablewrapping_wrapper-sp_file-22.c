...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_4_Pointer))) {
		...
		if (stepLocal_0 <= last_1_WrapperStruct00_var_1_1) {
			(*(WrapperStruct00_var_1_5_Pointer)) = (max (last_1_WrapperStruct00_var_1_11 , ((*(WrapperStruct00_var_1_6_Pointer)) - 8)));
		}
	}


	// From: Req1Batch22Wrapper_SP
	...
	// From: Req4Batch22Wrapper_SP
	if (last_1_WrapperStruct00_var_1_11 >= ((*(WrapperStruct00_var_1_5_Pointer)) & last_1_WrapperStruct00_var_1_11)) {
		(*(WrapperStruct00_var_1_11_Pointer)) = (min ((min ((min (50u , last_1_WrapperStruct00_var_1_11)) , (*(WrapperStruct00_var_1_6_Pointer)))) , ((*(WrapperStruct00_var_1_12_Pointer)) - last_1_WrapperStruct00_var_1_11)));
	} else {
...
int property() {
	return (((((*(WrapperStruct00_var_1_5_Pointer)) == (*(WrapperStruct00_var_1_5_Pointer))) ? ((*(WrapperStruct00_var_1_1_Pointer)) == ((signed short int) ((*(WrapperStruct00_var_1_5_Pointer)) + -16))) : ((*(WrapperStruct00_var_1_4_Pointer)) ? ((*(WrapperStruct00_var_1_1_Pointer)) == ((signed short int) (*(WrapperStruct00_var_1_5_Pointer)))) : 1)) && ((*(WrapperStruct00_var_1_4_Pointer)) ? ((*(WrapperStruct00_var_1_5_Pointer)) == ((unsigned short int) last_1_WrapperStruct00_var_1_1)) : ((last_1_WrapperStruct00_var_1_1 <= last_1_WrapperStruct00_var_1_1) ? ((*(WrapperStruct00_var_1_5_Pointer)) == ((unsigned short int) (max (last_1_WrapperStruct00_var_1_11 , ((*(WrapperStruct00_var_1_6_Pointer)) - 8))))) : 1))) && (((*(WrapperStruct00_var_1_1_Pointer)) < (*(WrapperStruct00_var_1_5_Pointer))) ? ((*(WrapperStruct00_var_1_7_Pointer)) == ((float) (((10.25f + (*(WrapperStruct00_var_1_8_Pointer))) + (*(WrapperStruct00_var_1_9_Pointer))) + (*(WrapperStruct00_var_1_10_Pointer))))) : 1)) && ((last_1_WrapperStruct00_var_1_11 >= ((*(WrapperStruct00_var_1_5_Pointer)) & last_1_WrapperStruct00_var_1_11)) ? ((*(WrapperStruct00_var_1_11_Pointer)) == ((unsigned long int) (min ((min ((min (50u , last_1_WrapperStruct00_var_1_11)) , (*(WrapperStruct00_var_1_6_Pointer)))) , ((*(WrapperStruct00_var_1_12_Pointer)) - last_1_WrapperStruct00_var_1_11))))) : ((5.7 < (*(WrapperStruct00_var_1_9_Pointer))) ? ((*(WrapperStruct00_var_1_11_Pointer)) == ((unsigned long int) last_1_WrapperStruct00_var_1_11)) : ((*(WrapperStruct00_var_1_11_Pointer)) == ((unsigned long int) last_1_WrapperStruct00_var_1_11))))
;
}
int main(void) {
	isInitial = 1;
