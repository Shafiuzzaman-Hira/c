...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch31no_floats.c", 13, "reach_error"); }
...
int property() {
	return (((var_1_2 ? (var_1_1 == ((signed long int) ((var_1_3 - var_1_9) - var_1_9))) : ((var_1_6 && (var_1_3 < var_1_9)) ? (var_1_1 == ((signed long int) var_1_3)) : 1)) && ((var_1_9 < var_1_9) ? (var_1_7 == ((signed long int) (var_1_9 + var_1_9))) : (var_1_7 == ((signed long int) (var_1_9 - var_1_3))))) && ((! (var_1_3 < (var_1_8 * last_1_var_1_7))) ? (((abs (last_1_var_1_13)) < last_1_var_1_13) ? (var_1_6 ? (var_1_9 == ((unsigned char) var_1_12)) : 1) : 1) : (var_1_9 == ((unsigned char) var_1_12)))) && (((var_1_9 + var_1_3) < var_1_9) ? ((var_1_2 && var_1_6) ? (var_1_6 ? (var_1_13 == ((signed long int) 0.8)) : (var_1_13 == ((signed long int) var_1_14))) : (var_1_13 == ((signed long int) var_1_14))) : (var_1_13 == ((signed long int) var_1_14)))
;
}
int main(void) {
	isInitial = 1;
