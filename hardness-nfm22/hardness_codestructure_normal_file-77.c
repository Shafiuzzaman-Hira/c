...
void step(void) {
	...
	// From: Req5Batch77normal
	if (var_1_3 != var_1_6) {
		if (var_1_1 >= (var_1_16 - (var_1_17 - 256))) {
			var_1_15 = var_1_18;
		} else {
			var_1_15 = var_1_18;
		}
	...
	// From: Req6Batch77normal
	if (var_1_10 < (- var_1_5)) {
		if ((var_1_7 + (128 + var_1_10)) <= var_1_8) {
			var_1_19 = var_1_4;
		}
	} else {
		if (var_1_10 < ((min (var_1_5 , var_1_17)) / var_1_11)) {
