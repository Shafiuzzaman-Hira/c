...
void step(void) {
	...
	// From: CodeObject5
	if ((min (var_1_35 , var_1_38)) != var_1_34) {
		if (var_1_36) {
			var_1_39 = var_1_40;
		}
	}
	...
	// From: Req8Batch44PS_CN_10
	var_1_31 = var_1_26;


	// From: Req9Batch44PS_CN_10
	var_1_32 = var_1_21;


	// From: Req7Batch44PS_CN_10
	var_1_30 = (max (var_1_15 , var_1_32));


	// From: Req1Batch44PS_CN_10
