...
void step(void) {
 ...
 if ((var_1_32 ^ (- var_1_30)) <= ((var_1_39 / 50) * var_1_27)) {
  var_1_40 = ((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36)));
 } else {
  var_1_40 = (((((((var_1_35) < (var_1_36)) ? (var_1_35) : (var_1_36))) < 0 ) ? -((((var_1_35) < (var_1_36)) ? (var_1_35) : (var_1_36))) : ((((var_1_35) < (var_1_36)) ? (var_1_35) : (var_1_36)))));
 }
 if (var_1_35 <= (((((var_1_33) < (var_1_40)) ? (var_1_33) : (var_1_40))) * 25.54)) {
  if (var_1_42) {
   var_1_41 = (((((((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35)))) > (((((var_1_43) < (var_1_44)) ? (var_1_43) : (var_1_44))))) ? (((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35)))) : (((((var_1_43) < (var_1_44)) ? (var_1_43) : (var_1_44)))))) - var_1_45);
  } else {
   var_1_41 = (((((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))) < 0 ) ? -((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))) : ((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43)))));
  }
 } else {
  var_1_41 = ((((127.18f) > (var_1_45)) ? (127.18f) : (var_1_45)));
 }
 ...
 if (var_1_39 == (~ var_1_31)) {
  if (var_1_42) {
   var_1_47 = (((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36))) - (var_1_48 + var_1_49));
  } else {
 ...
 if (var_1_33 >= var_1_41) {
  if ((var_1_40 > var_1_37) || (! 0)) {
   var_1_50 = (((((var_1_51 - 32) - var_1_52) < 0 ) ? -((var_1_51 - 32) - var_1_52) : ((var_1_51 - 32) - var_1_52)));
  } else {
 ...
 if (var_1_42) {
  ...
  if (var_1_33 >= ((((var_1_36 / var_1_56) < 0 ) ? -(var_1_36 / var_1_56) : (var_1_36 / var_1_56)))) {
   var_1_55 = var_1_52;
  }
 }
 if (((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))) < (var_1_44 / var_1_56)) {
  var_1_57 = var_1_32;
 }
