...
void step(void) {
	...
	// From: CodeObject1
	if (((abs (var_1_5)) - var_1_21) == (var_1_5 * var_1_16)) {
		var_1_19 = -4;
	}


	// From: Req1Batch30Filler_PR_CO
