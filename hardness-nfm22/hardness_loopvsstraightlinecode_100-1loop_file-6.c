...
void step(void) {
	// From: Req3Batch6100_1loop
	var_1_9 = ((abs (last_1_var_1_22)) - last_1_var_1_22);


	// From: Req9Batch6100_1loop
	...
	// From: Req4Batch6100_1loop
	var_1_10 = (var_1_5 - (var_1_22 + 1000));


	// From: Req5Batch6100_1loop
	if (! var_1_3) {
	...
	// From: Req12Batch6100_1loop
	var_1_28 = var_1_21;


	// From: Req10Batch6100_1loop
	if (! ((! var_1_3) && var_1_18)) {
