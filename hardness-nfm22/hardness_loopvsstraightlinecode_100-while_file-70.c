...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch70100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch70100_while
	if (var_1_26) {
		var_1_14 = var_1_3;
	}


	// From: Req7Batch70100_while
	var_1_21 = (abs (var_1_3));


	// From: Req14Batch70100_while
	var_1_41 = 16.625;


	// From: Req6Batch70100_while
	if ((var_1_17 - var_1_18) > var_1_21) {
		var_1_16 = (var_1_19 + var_1_20);
	}


	// From: Req3Batch70100_while
	if (var_1_30 >= var_1_4) {
		var_1_12 = (abs (var_1_30));
	}


	// From: Req9Batch70100_while
