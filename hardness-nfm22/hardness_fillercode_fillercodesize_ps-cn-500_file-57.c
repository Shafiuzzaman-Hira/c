...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch57PS_CN_500.c", 13, "reach_error"); }
...
float var_1_55 = 499.4;
float var_1_56 = 128.5;
signed char var_1_57 = 0;
signed char var_1_58 = 100;
double var_1_59 = 9.5;
signed char var_1_60 = 8;
unsigned short int var_1_61 = 50;
float var_1_62 = 24.8;
float var_1_63 = 15.6;
unsigned short int var_1_64 = 64160;
...
double var_1_78 = 10.1;
double var_1_79 = 128.8;
double var_1_80 = 127.2;
unsigned char var_1_81 = 0;
unsigned char var_1_82 = 0;
signed long int var_1_83 = 500;
unsigned char var_1_84 = 4;
signed short int var_1_85 = -100;
signed long int var_1_86 = 1584867576;
signed long int var_1_87 = 50;
float var_1_88 = 16.375;
float var_1_89 = 127.5;
double var_1_90 = 15.7;
double var_1_91 = 63.5;
float var_1_92 = 4.25;
float var_1_93 = 49.702;
double var_1_94 = 63.75;
unsigned char var_1_95 = 16;
float var_1_96 = 50.5;
double var_1_97 = 500.5;
float var_1_98 = 1.5;
signed short int var_1_99 = -25;
signed char var_1_100 = -4;
signed short int var_1_101 = 500;
signed short int var_1_102 = 256;
double var_1_103 = 128.5;
double var_1_104 = 4.125;
signed char var_1_105 = 10;
unsigned char var_1_106 = 1;
signed char var_1_107 = 1;
signed char var_1_108 = 4;
unsigned char var_1_109 = 10;
signed char var_1_110 = -64;
unsigned char var_1_111 = 1;
unsigned char var_1_112 = 1;
unsigned char var_1_113 = 0;
double var_1_114 = 64.2;
signed short int var_1_115 = 4;
signed char var_1_116 = -8;
signed char var_1_117 = -16;
signed char var_1_118 = -2;
signed char var_1_119 = 32;
signed char var_1_120 = -4;
unsigned char var_1_121 = 8;
unsigned char var_1_122 = 5;
unsigned long int var_1_123 = 10000000;
signed long int var_1_124 = 10;
signed long int var_1_125 = -5;
signed char var_1_126 = -100;
unsigned char var_1_127 = 1;
double var_1_128 = 9.5;
unsigned char var_1_129 = 1;
unsigned char var_1_130 = 16;
float var_1_131 = 99999999999999.5;
unsigned long int var_1_132 = 64;
unsigned char var_1_133 = 0;
signed long int var_1_134 = 5;
double var_1_135 = 9.4;
float var_1_136 = 31.7;
double var_1_137 = 4.15;
float var_1_138 = 1.6;
unsigned char var_1_139 = 16;
...
void step(void) {
	...
	// From: CodeObject9
	if (((max (var_1_47 , -256)) >> var_1_26) > var_1_34) {
		var_1_54 = ((var_1_55 + var_1_56) + (max (var_1_44 , (min (var_1_45 , var_1_46)))));
	} else {
		var_1_54 = (99999.6f - 9.999999999999925E13f);
	}
	...
	// From: CodeObject11
	if ((var_1_58 * (var_1_40 | var_1_36)) > var_1_39) {
		var_1_59 = (abs (var_1_55));
	}


	// From: CodeObject12
	if (var_1_29 >= (max (var_1_37 , var_1_50))) {
		var_1_60 = var_1_58;
	}


	// From: CodeObject13
	if (((var_1_41 + var_1_46) * (var_1_62 - var_1_63)) > var_1_43) {
		if ((max (var_1_38 , var_1_39)) <= var_1_57) {
			var_1_61 = (min ((abs (min (var_1_49 , var_1_50))) , (max ((abs (var_1_53)) , var_1_39))));
		} else {
			var_1_61 = (var_1_64 - var_1_48);
		}
	}
	...
	if (var_1_52 < var_1_34) {
		if (var_1_31) {
			if (var_1_30 || (var_1_28 || var_1_32)) {
				var_1_65 = var_1_66;
			}
		}
	} else {
		var_1_65 = (max (((abs (var_1_39)) + var_1_38) , (min (var_1_64 , var_1_51))));
	}


	// From: CodeObject15
	if (var_1_24) {
		var_1_67 = (((min (var_1_40 , var_1_49)) == var_1_65) || (var_1_68 && var_1_69));
	} else {
		var_1_67 = var_1_33;
	}
	...
	// From: CodeObject16
	if (var_1_49 > (var_1_52 & (var_1_36 % var_1_50))) {
		if (((abs (var_1_54)) - var_1_62) <= var_1_63) {
			var_1_70 = (abs (var_1_58));
		}
	} else {
		if (var_1_41 < (var_1_63 - var_1_62)) {
			if (4u <= var_1_48) {
				if (var_1_62 <= (var_1_44 / (abs (var_1_42)))) {
					var_1_70 = (abs (abs (max (var_1_58 , var_1_71))));
				}
			} else {
				var_1_70 = (abs ((var_1_72 - var_1_73) - var_1_74));
			}
		} else {
	...
	// From: CodeObject17
	if ((var_1_29 % var_1_72) >= var_1_37) {
		if (var_1_44 <= ((max (var_1_42 , var_1_46)) * (- var_1_35))) {
			if (var_1_52 < var_1_73) {
				var_1_75 = ((abs (var_1_74)) + var_1_49);
			}
		}
	} else {
		var_1_75 = (10 + (var_1_37 + var_1_47));
	}


	// From: CodeObject18
	if (var_1_34 == (~ var_1_74)) {
		if (10 >= (var_1_48 & var_1_66)) {
			if ((abs (var_1_39 / var_1_64)) < (~ var_1_25)) {
				var_1_76 = (max (var_1_37 , var_1_58));
			}
		}
	}
	...
	// From: CodeObject19
	if ((min ((abs (var_1_35)) , (var_1_62 - var_1_63))) >= 2.5f) {
		var_1_77 = (var_1_47 + (max (var_1_60 , var_1_57)));
	}


	// From: CodeObject20
	if (var_1_76 >= var_1_34) {
		var_1_78 = ((var_1_55 + var_1_56) + (var_1_79 - var_1_80));
	}


	// From: CodeObject21
	if (((var_1_70 + var_1_65) > (var_1_71 | var_1_26)) || var_1_69) {
		if ((max (var_1_80 , (max (64.6f , var_1_55)))) > var_1_44) {
			var_1_81 = (var_1_69 && var_1_32);
		}
	} else {
		if ((64 & var_1_70) > (var_1_26 / var_1_50)) {
			var_1_81 = (! var_1_68);
		} else {
			var_1_81 = (var_1_33 || (var_1_82 || (var_1_30 || var_1_32)));
		}
	}


	// From: CodeObject22
	if (((var_1_73 & var_1_40) / var_1_50) >= (var_1_60 ^ var_1_49)) {
		var_1_83 = (abs (abs (abs (var_1_36))));
	}


	// From: CodeObject23
	if (var_1_24 || (var_1_27 > var_1_53)) {
		var_1_84 = (abs (4 + var_1_73));
	} else {
		var_1_84 = (min (var_1_72 , var_1_73));
	}


	// From: CodeObject24
	if (((min (var_1_61 , var_1_48)) & var_1_83) <= (var_1_73 - (var_1_86 - var_1_52))) {
		var_1_85 = var_1_70;
	} else {
		var_1_85 = (((abs (var_1_39)) + var_1_70) + (var_1_48 - var_1_72));
	}


	// From: CodeObject25
	if (var_1_85 <= var_1_65) {
		var_1_87 = (max (var_1_85 , (min (var_1_25 , var_1_60))));
	}


	// From: CodeObject26
	if (var_1_66 <= var_1_27) {
		var_1_88 = (max (var_1_44 , (max ((var_1_55 + 63.25f) , var_1_46))));
	}


	// From: CodeObject27
	if (var_1_28 || var_1_82) {
		var_1_89 = (abs (var_1_45));
	} else {
		if (var_1_67) {
			var_1_89 = (abs (abs (1.000000075E7f)));
		}
	}


	// From: CodeObject28
	if ((var_1_61 ^ (var_1_74 * var_1_39)) <= var_1_58) {
		var_1_90 = (var_1_91 + 127.912);
	}


	// From: CodeObject29
	if (var_1_82) {
		var_1_92 = (var_1_80 - var_1_79);
	}


	// From: CodeObject30
	if (var_1_83 > (min (var_1_26 , var_1_72))) {
		if (var_1_56 > (abs (var_1_43))) {
			if (var_1_68) {
				var_1_93 = var_1_45;
			}
		}
	...
	// From: CodeObject31
	if (var_1_46 >= var_1_93) {
		var_1_94 = (var_1_80 - var_1_79);
	} else {
		var_1_94 = ((min (var_1_46 , var_1_80)) + var_1_45);
	}


	// From: CodeObject32
	if ((abs (max (var_1_64 , var_1_38))) > (var_1_60 | (~ -128))) {
		if (var_1_88 != var_1_94) {
			if ((abs (var_1_62)) <= var_1_94) {
				var_1_95 = (min (var_1_48 , var_1_74));
			} else {
				var_1_95 = var_1_74;
			}
		}
	} else {
		var_1_95 = (abs (var_1_50));
	}


	// From: CodeObject33
	if (var_1_90 <= (abs (var_1_97))) {
		var_1_96 = ((abs (var_1_91)) + var_1_56);
	}


	// From: CodeObject34
	if ((~ (var_1_66 & 1)) >= (var_1_27 ^ (min (var_1_25 , var_1_64)))) {
		if ((var_1_47 * var_1_60) >= var_1_85) {
			var_1_98 = var_1_80;
		}
	} else {
		if (var_1_84 <= 16) {
			var_1_98 = (abs (var_1_55));
		} else {
			var_1_98 = ((abs (var_1_79)) - var_1_80);
		}
	}


	// From: CodeObject35
	if (((abs (128)) << var_1_74) <= var_1_61) {
		if (var_1_90 >= 9.75) {
			var_1_99 = -10;
		}
	} else {
		var_1_99 = (abs (var_1_58));
	}


	// From: CodeObject36
	var_1_100 = (abs (var_1_72 - (min (var_1_73 , var_1_74))));


	// From: CodeObject37
	if (var_1_30) {
		var_1_101 = (abs (var_1_102 + var_1_51));
	} else {
		var_1_101 = (abs (var_1_26));
	}


	// From: CodeObject38
	if ((~ (var_1_49 ^ var_1_83)) <= var_1_72) {
		var_1_103 = (abs (var_1_46));
	}


	// From: CodeObject39
	if (var_1_75 <= (abs (var_1_37))) {
		if (var_1_58 <= var_1_73) {
			if ((~ var_1_36) <= var_1_102) {
				var_1_104 = ((abs (var_1_45)) - var_1_79);
			}
		} else {
			var_1_104 = (var_1_79 + var_1_46);
		}
	}
	...
	// From: CodeObject40
	if (var_1_106) {
		var_1_105 = ((abs (var_1_58)) - (min (var_1_73 , (var_1_107 + var_1_108))));
	} else {
		var_1_105 = ((var_1_108 - var_1_107) + -5);
	}


	// From: CodeObject41
	if ((abs (var_1_88)) >= var_1_93) {
		var_1_109 = (min ((max (var_1_38 , var_1_107)) , var_1_73));
	} else {
		if (var_1_69 && (0 < var_1_86)) {
			var_1_109 = (abs (var_1_108));
		}
	}


	// From: CodeObject42
	if (var_1_109 <= (min (var_1_66 , var_1_60))) {
		if (var_1_34 > var_1_40) {
			var_1_110 = (max (var_1_58 , var_1_107));
		} else {
			var_1_110 = (abs (var_1_58));
		}
	} else {
		var_1_110 = -2;
	}
	...
	// From: CodeObject43
	if (((max (255.4 , var_1_63)) - var_1_62) >= var_1_89) {
		if ((abs (var_1_104)) >= var_1_62) {
			var_1_111 = (var_1_68 && (var_1_69 && var_1_112));
		} else {
			var_1_111 = (! ((var_1_47 < var_1_70) && var_1_82));
		}
	}


	// From: CodeObject44
	if (! (var_1_40 > var_1_105)) {
		var_1_113 = (abs (var_1_38));
	} else {
		var_1_113 = (min (var_1_49 , var_1_50));
	}


	// From: CodeObject45
	if (var_1_66 > var_1_76) {
		if (var_1_90 < var_1_103) {
			var_1_114 = (var_1_56 + (abs (var_1_45)));
		} else {
			var_1_114 = (min (10.9 , var_1_55));
		}
	}


	// From: CodeObject46
	var_1_115 = (max ((abs (var_1_113)) , var_1_48));


	// From: CodeObject47
	if (var_1_29 < var_1_27) {
		if (var_1_81) {
			var_1_116 = (abs (var_1_73));
		}
	} else {
		if ((max ((abs (var_1_96)) , var_1_114)) >= var_1_88) {
			var_1_116 = (abs (min (var_1_71 , var_1_73)));
		} else {
			var_1_116 = (var_1_107 + (min ((var_1_117 + var_1_118) , (var_1_119 + var_1_120))));
		}
	}


	// From: CodeObject48
	if ((- var_1_104) <= var_1_79) {
		var_1_121 = 0;
	} else {
		var_1_121 = var_1_108;
	}
	...
	// From: CodeObject64
	if (var_1_91 > var_1_135) {
		var_1_137 = (var_1_79 - (var_1_80 + (abs (var_1_46))));
	}
...
void updateVariables() {
	...
	assume_abort_if_not((var_1_80 >= 0.0F && var_1_80 <= -1.0e-20F) || (var_1_80 <= 4611686.018427382800e+12F && var_1_80 >= 1.0e-20F ));
	...
	assume_abort_if_not(var_1_117 >= -31);
	assume_abort_if_not(var_1_117 <= 32);
	...
	assume_abort_if_not(var_1_119 <= 32);
	var_1_120 = __VERIFIER_nondet_char();
	assume_abort_if_not(var_1_120 >= -31);
	assume_abort_if_not(var_1_120 <= 31);
}
