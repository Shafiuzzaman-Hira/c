...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch73PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_28 < (- var_1_27)) {
		var_1_29 = (var_1_30 - (var_1_31 + (min (1 , var_1_32))));
	} else {
	...
	// From: CodeObject7
	if ((var_1_34 * (var_1_32 - var_1_38)) != var_1_35) {
		var_1_39 = var_1_40;
	}


	// From: Req3Batch73PS_CN_25
	if ((max ((last_1_var_1_19 / 2) , (~ last_1_var_1_16))) <= var_1_10) {
		var_1_12 = var_1_8;
	}


	// From: Req1Batch73PS_CN_25
	...
	// From: Req5Batch73PS_CN_25
	if (var_1_3 >= (last_1_var_1_12 * var_1_4)) {
		var_1_16 = var_1_18;
	}


	// From: Req7Batch73PS_CN_25
	var_1_22 = (abs (var_1_18));


	// From: Req8Batch73PS_CN_25
	if (var_1_1 > var_1_5) {
	...
	// From: Req9Batch73PS_CN_25
	var_1_26 = var_1_25;


	// From: Req4Batch73PS_CN_25
