...
void step(void) {
	...
	if (var_1_34 < var_1_30) {
		var_1_38 = (abs (max (var_1_22 , (min (var_1_13 , var_1_17)))));
	}


	// From: CodeObject4
	if (var_1_34 > var_1_30) {
		if ((max (32 , var_1_22)) <= var_1_22) {
			var_1_40 = (abs (var_1_27));
		} else {
			var_1_40 = (abs (min (128u , (min (var_1_13 , var_1_27)))));
		}
	} else {
		var_1_40 = var_1_27;
	}
	...
	// From: CodeObject6
	var_1_45 = (abs (var_1_27));


	// From: CodeObject7
	if (var_1_35 > var_1_34) {
		var_1_46 = ((abs (var_1_27)) - (min (var_1_27 , (abs (var_1_16)))));
	} else {
	...
	// From: Req4Batch64Filler_PS_CI
	var_1_19 = ((var_1_20 - var_1_21) - var_1_22);


	// From: Req6Batch64Filler_PS_CI
	...
	// From: Req3Batch64Filler_PS_CI
	if (var_1_10 != var_1_25) {
		var_1_18 = (min (var_1_13 , var_1_12));
	}


	// From: Req5Batch64Filler_PS_CI
	if (! ((64 * var_1_18) < var_1_18)) {
		var_1_23 = var_1_24;
	}


	// From: Req1Batch64Filler_PS_CI
	if (-8 <= var_1_10) {
