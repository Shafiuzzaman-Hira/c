...
void step(void) {
	// From: Req22Batch53Amount500
	if (last_1_var_1_90) {
		var_1_54 = ((last_1_var_1_77 + (var_1_55 - var_1_16)) + (max (var_1_2 , var_1_24)));
	} else {
			...
			if (last_1_var_1_90) {
				if (var_1_26) {
					if (last_1_var_1_76 < last_1_var_1_73) {
						...
						var_1_54 = ((max ((var_1_57 - last_1_var_1_69) , (var_1_45 + 10u))) + var_1_8);
					}
				} else {
					var_1_54 = (max (var_1_15 , last_1_var_1_77));
				}
			} else {
	...
	// From: Req16Batch53Amount500
	if (last_1_var_1_47) {
		var_1_46 = (max (last_1_var_1_46 , last_1_var_1_88));
	} else {
		var_1_46 = (var_1_2 + last_1_var_1_46);
	}


	// From: Req18Batch53Amount500
	signed short int stepLocal_7 = var_1_46;
	if (stepLocal_7 <= var_1_3) {
		var_1_48 = ((var_1_49 - var_1_45) - (min ((max (var_1_3 , var_1_4)) , var_1_24)));
	}


	// From: Req53Batch53Amount500
	...
	// From: Req25Batch53Amount500
	if ((16u <= var_1_102) && var_1_28) {
		var_1_64 = ((min ((max (var_1_65 , var_1_66)) , 40384)) - (max (var_1_16 , var_1_3)));
	} else {
		var_1_64 = ((var_1_67 - (var_1_68 - var_1_45)) - var_1_30);
	}


	// From: Req14Batch53Amount500
	unsigned long int stepLocal_5 = var_1_37 / (max (var_1_13 , var_1_33));
	if (var_1_102 <= stepLocal_5) {
		var_1_43 = var_1_30;
	}


	// From: Req11Batch53Amount500
	if ((last_1_var_1_1 / var_1_30) > ((max (last_1_var_1_88 , var_1_9)) - (var_1_37 - 2))) {
		if ((max (last_1_var_1_50 , last_1_var_1_1)) > var_1_15) {
			var_1_36 = (abs (200));
		}
	} else {
		if (last_1_var_1_90) {
	...
	// From: Req24Batch53Amount500
	if (var_1_27) {
		if (var_1_43 == (var_1_45 / var_1_49)) {
			if (var_1_62 < (var_1_41 - var_1_53)) {
				if (var_1_62 <= ((abs (var_1_53)) - var_1_40)) {
	...
	// From: Req3Batch53Amount500
	signed long int stepLocal_0 = var_1_9;
	if (stepLocal_0 > (var_1_3 ^ (max (var_1_2 , 4)))) {
		var_1_14 = (min (var_1_4 , var_1_2));
	} else {
		var_1_14 = (var_1_2 + ((max (var_1_15 , var_1_16)) - var_1_4));
	}


	// From: Req8Batch53Amount500
	var_1_29 = (var_1_30 - 32);


	// From: Req9Batch53Amount500
	var_1_31 = (4 - (abs (var_1_25)));


	// From: Req10Batch53Amount500
	if (((var_1_33 - var_1_4) - var_1_25) == var_1_16) {
		var_1_32 = (8.5 - ((8.05 + var_1_34) + var_1_35));
	}


	// From: Req12Batch53Amount500
	signed long int stepLocal_3 = 16;
	if (stepLocal_3 <= (var_1_33 + var_1_63)) {
		if (! (var_1_24 >= (min (var_1_16 , 256u)))) {
			if (15.6 >= (var_1_35 - 3.95)) {
				var_1_39 = (var_1_35 + (max (9.5f , (var_1_34 - var_1_40))));
			} else {
				var_1_39 = ((abs (var_1_40)) - (var_1_41 - var_1_34));
			}
		} else {
			var_1_39 = (min (var_1_41 , var_1_35));
		}
	} else {
		var_1_39 = (min (var_1_34 , 200.6f));
	}


	// From: Req19Batch53Amount500
	unsigned long int stepLocal_8 = var_1_24;
	if (200u >= stepLocal_8) {
		var_1_50 = (var_1_4 + (min (1u , (var_1_33 + var_1_24))));
	} else {
		var_1_50 = (min (var_1_45 , (var_1_3 + var_1_2)));
	}


	// From: Req20Batch53Amount500
	if (var_1_40 <= (var_1_35 - var_1_34)) {
		var_1_51 = (47137 - var_1_16);
	}


	// From: Req21Batch53Amount500
	if (1 < (-64 * var_1_8)) {
	...
	// From: Req23Batch53Amount500
	var_1_58 = (((min (var_1_53 , var_1_34)) + var_1_59) + (var_1_60 + (max (var_1_61 , var_1_62))));


	// From: Req29Batch53Amount500
	if (var_1_34 < (var_1_62 / (min (var_1_41 , var_1_22)))) {
		var_1_74 = (min (var_1_25 , ((min (var_1_24 , var_1_45)) + var_1_4)));
	} else {
		if (var_1_49 >= ((var_1_33 - var_1_45) - var_1_4)) {
			var_1_74 = ((min (var_1_25 , var_1_4)) + -50);
		} else {
			var_1_74 = (abs (var_1_4));
		}
	}


	// From: Req37Batch53Amount500
	var_1_85 = ((min (var_1_13 , var_1_18)) - var_1_68);


	// From: Req39Batch53Amount500
	if (var_1_81) {
		var_1_87 = (abs (var_1_53));
	}


	// From: Req41Batch53Amount500
	var_1_89 = var_1_24;


	// From: Req42Batch53Amount500
	var_1_90 = var_1_26;


	// From: Req43Batch53Amount500
	var_1_91 = var_1_62;


	// From: Req45Batch53Amount500
	var_1_93 = var_1_63;


	// From: Req46Batch53Amount500
	if (var_1_26) {
		var_1_94 = var_1_68;
	} else {
		var_1_94 = 8u;
	...
	// From: Req51Batch53Amount500
	var_1_100 = var_1_4;


	// From: Req7Batch53Amount500
	...
	// From: Req38Batch53Amount500
	if (var_1_52 != var_1_61) {
		var_1_86 = var_1_40;
	} else {
		if ((- var_1_87) < var_1_53) {
			if (var_1_80) {
				var_1_86 = ((max (var_1_35 , var_1_60)) + ((min (var_1_34 , 999.4f)) + var_1_61));
			} else {
				var_1_86 = var_1_60;
			}
		}
	...
	// From: Req15Batch53Amount500
	if (var_1_13 <= (- var_1_3)) {
		if (var_1_23 || var_1_80) {
			var_1_44 = (max (16 , (var_1_25 + var_1_4)));
		} else {
			var_1_44 = (max (5 , var_1_33));
		}
	} else {
	...
	// From: Req2Batch53Amount500
	if ((31.75 + 15.5) < (max (var_1_58 , var_1_87))) {
		var_1_10 = (abs (var_1_13 - var_1_4));
	} else {
		var_1_10 = (256u + var_1_8);
	}


	// From: Req5Batch53Amount500
	if (var_1_23) {
		var_1_19 = (max ((var_1_3 + (min (var_1_9 , var_1_15))) , var_1_13));
	} else {
		var_1_19 = (max (var_1_16 , (var_1_29 + var_1_3)));
	}


	// From: Req30Batch53Amount500
	if ((3.5 - var_1_34) > var_1_40) {
		if (var_1_90 || var_1_26) {
			var_1_76 = (max ((var_1_41 - var_1_35) , (var_1_53 + var_1_62)));
		}
	} else {
		if (var_1_26) {
			var_1_76 = (min ((var_1_53 - (var_1_41 - 256.6f)) , (max (var_1_60 , var_1_35))));
		}
	}


	// From: Req32Batch53Amount500
	unsigned long int stepLocal_12 = (var_1_66 - var_1_45) + var_1_57;
	if (stepLocal_12 <= (min (128u , 0u))) {
		var_1_79 = var_1_99;
	} else {
		var_1_79 = var_1_33;
	}
	...
	// From: Req34Batch53Amount500
	unsigned char stepLocal_13 = var_1_81;
	if (var_1_90) {
		if ((var_1_2 != var_1_68) && stepLocal_13) {
			var_1_82 = (min ((var_1_59 + var_1_53) , ((5.8 + var_1_40) - var_1_41)));
		}
	} else {
		if (var_1_28) {
			var_1_82 = (max (0.8 , ((var_1_34 + var_1_35) - var_1_53)));
		}
	}


	// From: Req36Batch53Amount500
	...
	if ((25 + var_1_36) < stepLocal_17) {
		...
		if (var_1_81) {
			if (var_1_86 > (var_1_53 * 100.2f)) {
				var_1_84 = ((min (var_1_45 , var_1_4)) + var_1_75);
			} else {
				var_1_84 = ((var_1_25 + 8) + var_1_45);
			}
		} else {
			var_1_84 = (min (var_1_45 , var_1_24));
		}
	}


	// From: Req28Batch53Amount500
	...
	// From: Req4Batch53Amount500
	if (var_1_23) {
		if (var_1_43 > var_1_4) {
			var_1_17 = ((max (var_1_13 , 3076280705u)) - var_1_4);
		}
	} else {
		var_1_17 = (max (((max (var_1_13 , var_1_18)) - var_1_16) , var_1_2));
	}


	// From: Req40Batch53Amount500
	if (var_1_32 > (var_1_73 + var_1_59)) {
		var_1_88 = (max ((var_1_94 + 100) , var_1_36));
	} else {
		var_1_88 = var_1_25;
	}


	// From: Req31Batch53Amount500
	if (var_1_48 != (var_1_4 / (var_1_9 + 5u))) {
		if (((var_1_100 + var_1_51) + var_1_48) >= var_1_67) {
			var_1_77 = ((var_1_45 + 5) + (max ((abs (var_1_3)) , var_1_14)));
		} else {
	...
	// From: Req13Batch53Amount500
	unsigned long int stepLocal_4 = (var_1_10 * var_1_30) / -128;
	if (var_1_26) {
		if ((min (var_1_102 , var_1_8)) < stepLocal_4) {
			var_1_42 = var_1_4;
		}
	} else {
	...
	// From: Req6Batch53Amount500
	if (var_1_47) {
		if (var_1_76 >= (- (var_1_32 / var_1_22))) {
			var_1_20 = (min (var_1_2 , (max (var_1_3 , var_1_4))));
		}
	}


	// From: Req26Batch53Amount500
	if (var_1_14 < var_1_42) {
		var_1_69 = (min (var_1_3 , ((max (var_1_54 , var_1_33)) + var_1_101)));
	}


	// From: Req35Batch53Amount500
	...
	if (var_1_97 < stepLocal_15) {
		if (var_1_81) {
			if (stepLocal_14 > (var_1_45 - (min (var_1_3 , var_1_24)))) {
	...
	if ((min (var_1_66 , (- var_1_63))) > stepLocal_11) {
		if ((min (var_1_49 , var_1_3)) > stepLocal_10) {
			if ((min (var_1_22 , (- 128.975))) >= var_1_95) {
				var_1_71 = ((var_1_97 + var_1_33) + var_1_20);
			}
		}
	} else {
		if (stepLocal_9 >= var_1_46) {
			var_1_71 = (max (var_1_67 , (var_1_33 - var_1_36)));
		} else {
			var_1_71 = ((min (var_1_49 , var_1_33)) - var_1_20);
		}
	}


	// From: Req48Batch53Amount500
	if (var_1_83) {
		var_1_96 = 8u;
	} else {
		var_1_96 = var_1_3;
	...
	// From: Req1Batch53Amount500
	if ((var_1_2 - (var_1_3 - var_1_4)) == var_1_54) {
		if ((var_1_3 + var_1_54) >= (var_1_4 / var_1_2)) {
			if (var_1_54 > var_1_4) {
				var_1_1 = ((var_1_3 + var_1_2) + var_1_46);
			} else {
				if (var_1_83 || (var_1_2 < (min (var_1_46 , var_1_54)))) {
					var_1_1 = (min (var_1_46 , ((var_1_3 - var_1_2) + (min (var_1_4 , 64)))));
				} else {
					if (var_1_83) {
						var_1_1 = (((min (var_1_8 , var_1_9)) - var_1_4) - (min (var_1_3 , var_1_2)));
					} else {
						var_1_1 = (min (-128 , ((var_1_9 - var_1_4) - (min (100 , var_1_3)))));
					}
				}
			}
		}
...
int property() {
	return ((((((((((((((((((((((((((((((((((((((((((((((((((((((var_1_2 - (var_1_3 - var_1_4)) == var_1_54) ? (((var_1_3 + var_1_54) >= (var_1_4 / var_1_2)) ? ((var_1_54 > var_1_4) ? (var_1_1 == ((signed long int) ((var_1_3 + var_1_2) + var_1_46))) : ((var_1_83 || (var_1_2 < (min (var_1_46 , var_1_54)))) ? (var_1_1 == ((signed long int) (min (var_1_46 , ((var_1_3 - var_1_2) + (min (var_1_4 , 64))))))) : (var_1_83 ? (var_1_1 == ((signed long int) (((min (var_1_8 , var_1_9)) - var_1_4) - (min (var_1_3 , var_1_2))))) : (var_1_1 == ((signed long int) (min (-128 , ((var_1_9 - var_1_4) - (min (100 , var_1_3)))))))))) : 1) : (var_1_1 == ((signed long int) var_1_3))) && (((31.75 + 15.5) < (max (var_1_58 , var_1_87))) ? (var_1_10 == ((unsigned long int) (abs (var_1_13 - var_1_4)))) : (var_1_10 == ((unsigned long int) (256u + var_1_8))))) && ((var_1_9 > (var_1_3 ^ (max (var_1_2 , 4)))) ? (var_1_14 == ((unsigned short int) (min (var_1_4 , var_1_2)))) : (var_1_14 == ((unsigned short int) (var_1_2 + ((max (var_1_15 , var_1_16)) - var_1_4)))))) && (var_1_23 ? ((var_1_43 > var_1_4) ? (var_1_17 == ((unsigned long int) ((max (var_1_13 , 3076280705u)) - var_1_4))) : 1) : (var_1_17 == ((unsigned long int) (max (((max (var_1_13 , var_1_18)) - var_1_16) , var_1_2)))))) && (var_1_23 ? (var_1_19 == ((unsigned long int) (max ((var_1_3 + (min (var_1_9 , var_1_15))) , var_1_13)))) : (var_1_19 == ((unsigned long int) (max (var_1_16 , (var_1_29 + var_1_3))))))) && (var_1_47 ? ((var_1_76 >= (- (var_1_32 / var_1_22))) ? (var_1_20 == ((signed short int) (min (var_1_2 , (max (var_1_3 , var_1_4)))))) : 1) : 1)) && (((var_1_29 >> (var_1_24 + var_1_25)) <= var_1_100) ? ((var_1_50 == ((var_1_9 % var_1_16) * var_1_101)) ? (var_1_23 == ((unsigned char) (! (! var_1_26)))) : (var_1_23 == ((unsigned char) (! (var_1_27 || var_1_28))))) : 1)) && (var_1_29 == ((unsigned char) (var_1_30 - 32)))) && (var_1_31 == ((signed char) (4 - (abs (var_1_25)))))) && ((((var_1_33 - var_1_4) - var_1_25) == var_1_16) ? (var_1_32 == ((double) (8.5 - ((8.05 + var_1_34) + var_1_35)))) : 1)) && (((last_1_var_1_1 / var_1_30) > ((max (last_1_var_1_88 , var_1_9)) - (var_1_37 - 2))) ? (((max (last_1_var_1_50 , last_1_var_1_1)) > var_1_15) ? (var_1_36 == ((signed long int) (abs (200)))) : 1) : (last_1_var_1_90 ? ((256u >= var_1_18) ? (last_1_var_1_23 ? (var_1_36 == ((signed long int) (50 - (1976409169 - var_1_25)))) : 1) : (var_1_28 ? (var_1_26 ? (var_1_36 == ((signed long int) (-10 + last_1_var_1_71))) : (var_1_36 == ((signed long int) var_1_16))) : (var_1_36 == ((signed long int) last_1_var_1_50)))) : (var_1_36 == ((signed long int) var_1_3))))) && ((16 <= (var_1_33 + var_1_63)) ? ((! (var_1_24 >= (min (var_1_16 , 256u)))) ? ((15.6 >= (var_1_35 - 3.95)) ? (var_1_39 == ((float) (var_1_35 + (max (9.5f , (var_1_34 - var_1_40)))))) : (var_1_39 == ((float) ((abs (var_1_40)) - (var_1_41 - var_1_34))))) : (var_1_39 == ((float) (min (var_1_41 , var_1_35))))) : (var_1_39 == ((float) (min (var_1_34 , 200.6f)))))) && (var_1_26 ? (((min (var_1_102 , var_1_8)) < ((var_1_10 * var_1_30) / -128)) ? (var_1_42 == ((signed char) var_1_4)) : 1) : ((! ((var_1_36 * var_1_64) < var_1_3)) ? (var_1_42 == ((signed char) var_1_33)) : 1))) && ((var_1_102 <= (var_1_37 / (max (var_1_13 , var_1_33)))) ? (var_1_43 == ((unsigned char) var_1_30)) : 1)) && ((var_1_13 <= (- var_1_3)) ? ((var_1_23 || var_1_80) ? (var_1_44 == ((signed char) (max (16 , (var_1_25 + var_1_4))))) : (var_1_44 == ((signed char) (max (5 , var_1_33))))) : (var_1_44 == ((signed char) (var_1_45 + var_1_4))))) && (last_1_var_1_47 ? (var_1_46 == ((signed short int) (max (last_1_var_1_46 , last_1_var_1_88)))) : (var_1_46 == ((signed short int) (var_1_2 + last_1_var_1_46))))) && ((var_1_2 >= (last_1_var_1_92 + var_1_25)) ? ((! (var_1_15 >= last_1_var_1_44)) ? (var_1_47 == ((unsigned char) ((! (var_1_27 || var_1_26)) || var_1_28))) : 1) : 1)) && ((var_1_46 <= var_1_3) ? (var_1_48 == ((unsigned char) ((var_1_49 - var_1_45) - (min ((max (var_1_3 , var_1_4)) , var_1_24))))) : 1)) && ((200u >= var_1_24) ? (var_1_50 == ((unsigned long int) (var_1_4 + (min (1u , (var_1_33 + var_1_24)))))) : (var_1_50 == ((unsigned long int) (min (var_1_45 , (var_1_3 + var_1_2))))))) && ((var_1_40 <= (var_1_35 - var_1_34)) ? (var_1_51 == ((unsigned short int) (47137 - var_1_16))) : 1)) && ((1 < (-64 * var_1_8)) ? (var_1_52 == ((float) (var_1_35 - ((var_1_34 + var_1_53) + var_1_40)))) : (var_1_52 == ((float) (0.75f - var_1_41))))) && (last_1_var_1_90 ? (var_1_54 == ((unsigned long int) ((last_1_var_1_77 + (var_1_55 - var_1_16)) + (max (var_1_2 , var_1_24))))) : (((var_1_56 - last_1_var_1_100) > var_1_8) ? (last_1_var_1_90 ? (var_1_26 ? ((last_1_var_1_76 < last_1_var_1_73) ? (var_1_54 == ((unsigned long int) last_1_var_1_100)) : (var_1_54 == ((unsigned long int) ((max ((var_1_57 - last_1_var_1_69) , (var_1_45 + 10u))) + var_1_8)))) : (var_1_54 == ((unsigned long int) (max (var_1_15 , last_1_var_1_77))))) : (var_1_54 == ((unsigned long int) (var_1_13 - var_1_55)))) : (var_1_54 == ((unsigned long int) (var_1_8 + var_1_57)))))) && (var_1_58 == ((float) (((min (var_1_53 , var_1_34)) + var_1_59) + (var_1_60 + (max (var_1_61 , var_1_62))))))) && (var_1_27 ? ((var_1_43 == (var_1_45 / var_1_49)) ? ((var_1_62 < (var_1_41 - var_1_53)) ? ((var_1_62 <= ((abs (var_1_53)) - var_1_40)) ? (var_1_63 == ((signed char) (var_1_4 + var_1_24))) : 1) : (var_1_63 == ((signed char) (var_1_4 + var_1_45)))) : 1) : (var_1_63 == ((signed char) (var_1_24 + -2))))) && (((16u <= var_1_102) && var_1_28) ? (var_1_64 == ((unsigned short int) ((min ((max (var_1_65 , var_1_66)) , 40384)) - (max (var_1_16 , var_1_3))))) : (var_1_64 == ((unsigned short int) ((var_1_67 - (var_1_68 - var_1_45)) - var_1_30))))) && ((var_1_14 < var_1_42) ? (var_1_69 == ((unsigned long int) (min (var_1_3 , ((max (var_1_54 , var_1_33)) + var_1_101))))) : 1)) && (((min (var_1_66 , (- var_1_63))) > (var_1_100 + var_1_15)) ? (((min (var_1_49 , var_1_3)) > var_1_68) ? (((min (var_1_22 , (- 128.975))) >= var_1_95) ? (var_1_71 == ((signed short int) ((var_1_97 + var_1_33) + var_1_20))) : 1) : 1) : ((var_1_46 >= var_1_46) ? (var_1_71 == ((signed short int) (max (var_1_67 , (var_1_33 - var_1_36))))) : (var_1_71 == ((signed short int) ((min (var_1_49 , var_1_33)) - var_1_20)))))) && ((var_1_60 != var_1_86) ? (var_1_28 ? (var_1_73 == ((double) var_1_61)) : (var_1_73 == ((double) var_1_60))) : (var_1_73 == ((double) var_1_61)))) && ((var_1_34 < (var_1_62 / (min (var_1_41 , var_1_22)))) ? (var_1_74 == ((signed char) (min (var_1_25 , ((min (var_1_24 , var_1_45)) + var_1_4))))) : ((var_1_49 >= ((var_1_33 - var_1_45) - var_1_4)) ? (var_1_74 == ((signed char) ((min (var_1_25 , var_1_4)) + -50))) : (var_1_74 == ((signed char) (abs (var_1_4))))))) && (((3.5 - var_1_34) > var_1_40) ? ((var_1_90 || var_1_26) ? (var_1_76 == ((float) (max ((var_1_41 - var_1_35) , (var_1_53 + var_1_62))))) : 1) : (var_1_26 ? (var_1_76 == ((float) (min ((var_1_53 - (var_1_41 - 256.6f)) , (max (var_1_60 , var_1_35)))))) : 1))) && ((var_1_48 != (var_1_4 / (var_1_9 + 5u))) ? ((((var_1_100 + var_1_51) + var_1_48) >= var_1_67) ? (var_1_77 == ((signed short int) ((var_1_45 + 5) + (max ((abs (var_1_3)) , var_1_14))))) : (var_1_77 == ((signed short int) ((var_1_14 + var_1_33) + (var_1_10 + var_1_45))))) : (var_1_77 == ((signed short int) var_1_24)))) && ((((var_1_66 - var_1_45) + var_1_57) <= (min (128u , 0u))) ? (var_1_79 == ((signed short int) var_1_99)) : (var_1_79 == ((signed short int) var_1_33)))) && ((! (last_1_var_1_48 < last_1_var_1_1)) ? (var_1_80 == ((unsigned char) var_1_26)) : (var_1_80 == ((unsigned char) (var_1_26 && ((var_1_28 || var_1_81) && (! var_1_27))))))) && (var_1_90 ? (((var_1_2 != var_1_68) && var_1_81) ? (var_1_82 == ((double) (min ((var_1_59 + var_1_53) , ((5.8 + var_1_40) - var_1_41))))) : 1) : (var_1_28 ? (var_1_82 == ((double) (max (0.8 , ((var_1_34 + var_1_35) - var_1_53))))) : 1))) && ((var_1_97 < (- 25u)) ? (var_1_81 ? ((var_1_17 > (var_1_45 - (min (var_1_3 , var_1_24)))) ? (var_1_83 == ((unsigned char) ((var_1_10 == var_1_10) || var_1_26))) : 1) : 1) : (var_1_47 ? ((var_1_20 > var_1_51) ? (var_1_83 == ((unsigned char) 1)) : (var_1_83 == ((unsigned char) ((! var_1_28) && (var_1_27 || var_1_26))))) : 1))) && (((25 + var_1_36) < (var_1_13 - var_1_57)) ? (var_1_84 == ((signed char) (8 + var_1_45))) : (var_1_81 ? ((var_1_86 > (var_1_53 * 100.2f)) ? (var_1_84 == ((signed char) ((min (var_1_45 , var_1_4)) + var_1_75))) : (var_1_84 == ((signed char) ((var_1_25 + 8) + var_1_45)))) : (var_1_84 == ((signed char) (min (var_1_45 , var_1_24))))))) && (var_1_85 == ((unsigned long int) ((min (var_1_13 , var_1_18)) - var_1_68)))) && ((var_1_52 != var_1_61) ? (var_1_86 == ((float) var_1_40)) : (((- var_1_87) < var_1_53) ? (var_1_80 ? (var_1_86 == ((float) ((max (var_1_35 , var_1_60)) + ((min (var_1_34 , 999.4f)) + var_1_61)))) : (var_1_86 == ((float) var_1_60))) : 1))) && (var_1_81 ? (var_1_87 == ((float) (abs (var_1_53)))) : 1)) && ((var_1_32 > (var_1_73 + var_1_59)) ? (var_1_88 == ((signed long int) (max ((var_1_94 + 100) , var_1_36)))) : (var_1_88 == ((signed long int) var_1_25)))) && (var_1_89 == ((signed char) var_1_24))) && (var_1_90 == ((unsigned char) var_1_26))) && (var_1_91 == ((float) var_1_62))) && (var_1_47 ? (var_1_92 == ((signed long int) var_1_50)) : (var_1_92 == ((signed long int) var_1_4)))) && (var_1_93 == ((unsigned short int) var_1_63))) && (var_1_26 ? (var_1_94 == ((unsigned long int) var_1_68)) : (var_1_94 == ((unsigned long int) 8u)))) && (var_1_27 ? (var_1_95 == ((double) var_1_61)) : (var_1_95 == ((double) var_1_60)))) && (var_1_83 ? (var_1_96 == ((unsigned long int) 8u)) : (var_1_96 == ((unsigned long int) var_1_3)))) && (var_1_27 ? (var_1_97 == ((unsigned long int) var_1_51)) : (var_1_97 == ((unsigned long int) var_1_64)))) && (var_1_26 ? (var_1_99 == ((signed char) var_1_49)) : (var_1_99 == ((signed char) var_1_75)))) && (var_1_100 == ((unsigned char) var_1_4))) && (var_1_80 ? (var_1_101 == ((unsigned char) var_1_45)) : (var_1_101 == ((unsigned char) var_1_4)))) && ((last_1_var_1_88 >= (last_1_var_1_17 * last_1_var_1_69)) ? (var_1_102 == ((unsigned short int) (var_1_66 - ((var_1_25 + var_1_30) + last_1_var_1_29)))) : (var_1_102 == ((unsigned short int) (last_1_var_1_29 + var_1_68))))
;
}
int main(void) {
	isInitial = 1;
