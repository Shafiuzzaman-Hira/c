...
void step(void) {
	// From: Req1Batch58Amount10
	if (var_1_2) {
		var_1_1 = (abs (var_1_3 + var_1_4));
	}


	// From: Req2Batch58Amount10
	var_1_5 = (((max (var_1_6 , 16)) - (var_1_7 + var_1_8)) + (var_1_9 - var_1_10));
}
...
int property() {
	return (var_1_2 ? (var_1_1 == ((unsigned long int) (abs (var_1_3 + var_1_4)))) : 1) && (var_1_5 == ((signed short int) (((max (var_1_6 , 16)) - (var_1_7 + var_1_8)) + (var_1_9 - var_1_10))))
;
}
int main(void) {
	isInitial = 1;
