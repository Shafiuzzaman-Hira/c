...
void step(void) {
	...
	// From: CodeObject2
	if (var_1_4) {
		var_1_31 = (max (var_1_28 , var_1_15));
	} else {
		if ((max (var_1_28 , var_1_15)) > var_1_15) {
	...
	// From: CodeObject5
	if (! var_1_4) {
		var_1_42 = (min (((max (var_1_15 , var_1_40)) + (var_1_39 + var_1_11)) , -128));
	}
	...
	// From: CodeObject4
	if ((var_1_39 - (min (32 , var_1_40))) > var_1_15) {
