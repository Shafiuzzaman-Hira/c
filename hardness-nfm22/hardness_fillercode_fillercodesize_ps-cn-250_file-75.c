...
void step(void) {
	...
	if ((var_1_29 & var_1_42) <= var_1_43) {
		if (var_1_38 <= var_1_33) {
			if (! var_1_31) {
				...
				var_1_41 = (abs (abs (var_1_45 - 100u)));
			}
		}
	}
	...
	if (var_1_42 < var_1_43) {
		if ((var_1_47 - (var_1_48 + var_1_49)) <= var_1_29) {
			var_1_46 = ((abs (abs (var_1_50))) - var_1_51);
		}
	} else {
		if (var_1_32 || ((~ var_1_48) > var_1_34)) {
			var_1_46 = ((abs (min (128 , var_1_50))) - 8);
		}
	}
	...
	if (var_1_51 <= var_1_46) {
		if (var_1_51 >= (max (var_1_35 , var_1_28))) {
			var_1_52 = (abs (abs (abs (var_1_47))));
		}
	}
	...
	if ((var_1_58 - var_1_59) > var_1_37) {
		if (var_1_59 >= var_1_36) {
			if ((~ var_1_44) < var_1_41) {
				var_1_57 = (abs (var_1_50));
			} else {
				var_1_57 = (min (var_1_56 , (min ((var_1_50 - var_1_51) , (abs (var_1_60))))));
			}
		}
	} else {
		if ((0.8f / (max (var_1_61 , var_1_62))) > (var_1_53 + var_1_40)) {
			if ((max (25.2f , var_1_59)) <= (var_1_38 + var_1_37)) {
				var_1_57 = (abs (abs (var_1_60)));
			}
		}
	}
	...
	if (var_1_48 > var_1_41) {
		var_1_64 = (min (((abs (var_1_65)) - var_1_51) , (abs (min (var_1_57 , var_1_56)))));
	}
	...
	// From: CodeObject13
	if (var_1_68) {
		var_1_70 = (min ((abs (var_1_40)) , var_1_37));
	}
	...
	if (-2 > (abs (var_1_51))) {
		if (var_1_48 < var_1_56) {
			var_1_71 = (abs (var_1_44));
		} else {
			if ((abs (abs (var_1_33))) > var_1_53) {
				var_1_71 = (abs (var_1_46));
			}
		}
	}
	...
	// From: CodeObject15
	if (var_1_68 || ((min (var_1_46 , var_1_57)) >= (max (var_1_64 , var_1_35)))) {
		var_1_72 = (min ((max (var_1_60 , var_1_65)) , (abs (max (var_1_51 , 256)))));
	}
	...
	if (var_1_69 >= var_1_44) {
		if (var_1_55 < var_1_46) {
			var_1_73 = (var_1_74 + (abs (var_1_75 - var_1_76)));
		} else {
			var_1_73 = ((max (var_1_76 , (abs (var_1_74)))) - (abs (abs (var_1_36))));
		}
	}
	...
	// From: CodeObject19
	if (var_1_74 > (min (var_1_38 , (var_1_61 + var_1_59)))) {
		var_1_79 = (((max (var_1_47 , 4)) >= var_1_51) || (! var_1_32));
	} else {
		var_1_79 = 0;
	}
	...
	// From: CodeObject20
	if ((min (var_1_33 , var_1_38)) < var_1_74) {
		if (var_1_26) {
			var_1_80 = (max ((var_1_81 + var_1_55) , (abs (var_1_56 + var_1_46))));
		}
	}
	...
	if (var_1_46 != var_1_80) {
		if (-2 >= var_1_78) {
			var_1_83 = (min (var_1_57 , var_1_51));
		} else {
			var_1_83 = ((abs (var_1_65)) - var_1_56);
		}
	} else {
		var_1_83 = (var_1_60 + (abs (var_1_51)));
	}
	...
	if (var_1_32 && var_1_79) {
		if (var_1_36 < (var_1_62 * var_1_39)) {
			if (var_1_33 > (var_1_58 - var_1_59)) {
				var_1_84 = ((max ((max (var_1_56 , 32)) , var_1_55)) - 2);
			} else {
				var_1_84 = var_1_56;
			}
		} else {
			var_1_84 = (abs (min (-64 , var_1_55)));
		}
	} else {
		var_1_84 = var_1_56;
	}
	...
	// From: Req3Batch75PS_CN_250
	if (! (var_1_4 < 16.8f)) {
		var_1_15 = var_1_6;
	}


	// From: Req7Batch75PS_CN_250
	var_1_25 = var_1_23;


	// From: Req2Batch75PS_CN_250
