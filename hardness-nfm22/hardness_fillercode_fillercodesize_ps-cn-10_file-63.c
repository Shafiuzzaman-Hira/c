...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch63PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	// From: CodeObject1
	if ((25.3f / var_1_34) > (- var_1_35)) {
		var_1_33 = var_1_36;
	}


	// From: CodeObject2
	if (((var_1_33 - var_1_36) * (256 / var_1_38)) <= var_1_39) {
		var_1_37 = 0;
	}


	// From: Req3Batch63PS_CN_10
	...
	// From: Req9Batch63PS_CN_10
	var_1_31 = var_1_13;


	// From: Req4Batch63PS_CN_10
	if (var_1_7) {
	...
	// From: Req7Batch63PS_CN_10
	if (var_1_7) {
		var_1_29 = var_1_20;
	}


	// From: Req10Batch63PS_CN_10
	var_1_32 = var_1_16;


	// From: Req8Batch63PS_CN_10
	var_1_30 = var_1_32;


	// From: Req2Batch63PS_CN_10
	...
	// From: Req6Batch63PS_CN_10
	if (var_1_11 >= var_1_30) {
		var_1_26 = (var_1_27 + var_1_28);
	}


	// From: Req1Batch63PS_CN_10
