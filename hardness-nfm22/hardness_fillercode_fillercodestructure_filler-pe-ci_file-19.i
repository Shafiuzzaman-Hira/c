...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch19Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_32 = (((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3))) + var_1_3);
 var_1_35 = ((((var_1_27) > (((((8.9f) > ((var_1_27 - var_1_27))) ? (8.9f) : ((var_1_27 - var_1_27)))))) ? (var_1_27) : (((((8.9f) > ((var_1_27 - var_1_27))) ? (8.9f) : ((var_1_27 - var_1_27)))))));
 var_1_38 = ((((50.8f) < 0 ) ? -(50.8f) : (50.8f)));
 if ((~ var_1_3) < (var_1_3 * var_1_2)) {
  if (var_1_10) {
   var_1_39 = (((((var_1_27 - ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))))) < (((((var_1_26) < (var_1_26)) ? (var_1_26) : (var_1_26))))) ? ((var_1_27 - ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))))) : (((((var_1_26) < (var_1_26)) ? (var_1_26) : (var_1_26))))));
  } else {
   if ((var_1_3 | var_1_2) >= var_1_3) {
    var_1_39 = var_1_27;
   }
  }
 } else {
 ...
 if (var_1_10) {
  if (((~ var_1_3) ^ var_1_3) < ((var_1_3 | var_1_9) % ((((var_1_9) < (var_1_8)) ? (var_1_9) : (var_1_8))))) {
   var_1_42 = (((((8 + var_1_46)) < (-25)) ? ((8 + var_1_46)) : (-25)));
  } else {
   var_1_42 = ((((var_1_46) < 0 ) ? -(var_1_46) : (var_1_46)));
  }
 }
 if (var_1_28 >= ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)))) {
  var_1_47 = var_1_13;
 } else {
  if (2 >= (var_1_7 * ((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3))))) {
   var_1_47 = 0;
  } else {
   var_1_47 = var_1_49;
  }
