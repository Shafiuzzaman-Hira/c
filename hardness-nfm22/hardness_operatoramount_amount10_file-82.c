...
int property() {
	return (last_1_var_1_1 >= (var_1_3 + (var_1_4 + var_1_5))) ? (var_1_1 == ((unsigned char) (min (var_1_6 , var_1_7)))) : ((last_1_var_1_1 > var_1_6) ? (var_1_8 ? (var_1_1 == ((unsigned char) var_1_6)) : (var_1_1 == ((unsigned char) var_1_7))) : (var_1_1 == ((unsigned char) var_1_6)))
;
}
int main(void) {
	isInitial = 1;
