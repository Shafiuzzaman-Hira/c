...
void step(void) {
	...
	// From: CodeObject2
	var_1_32 = (max ((min (var_1_33 , var_1_34)) , var_1_35));


	// From: CodeObject3
	var_1_36 = ((max (var_1_30 , (abs (var_1_29)))) + var_1_37);


	// From: CodeObject4
	if (256 > (-10 >> var_1_28)) {
		var_1_38 = (var_1_39 - (min ((var_1_40 - 128.375) , var_1_41)));
	} else {
		var_1_38 = var_1_41;
	}
	...
	if (! (var_1_35 >= (var_1_41 - var_1_40))) {
		var_1_42 = (min ((var_1_43 - 256) , var_1_44));
	}


	// From: CodeObject6
	if (((var_1_36 * var_1_28) | var_1_30) <= (var_1_31 + 8u)) {
		if ((min (16u , var_1_31)) < var_1_28) {
			var_1_45 = var_1_46;
		} else {
			var_1_45 = var_1_47;
		}
	...
	// From: CodeObject7
	if (var_1_46) {
		if ((var_1_36 <= var_1_43) || (var_1_33 < (min (var_1_41 , var_1_32)))) {
			var_1_48 = var_1_49;
		}
	} else {
	...
	if ((var_1_50 | 10) != var_1_42) {
		if (var_1_39 >= var_1_35) {
			var_1_54 = (var_1_40 - (max ((var_1_55 + var_1_56) , var_1_39)));
		} else {
			var_1_54 = (var_1_39 - var_1_57);
		}
	} else {
		var_1_54 = (min ((abs (var_1_58)) , (var_1_55 + (255.6f - var_1_56))));
	}


	// From: CodeObject10
	if (((var_1_36 / var_1_60) % var_1_61) >= (var_1_37 * (abs (var_1_43)))) {
		var_1_59 = ((abs (var_1_61)) + var_1_60);
	} else {
		var_1_59 = (min ((abs (var_1_60)) , (var_1_62 - var_1_63)));
	}


	// From: CodeObject11
	if (var_1_47) {
		var_1_64 = (abs (abs (max (var_1_65 , var_1_66))));
	} else {
		if (var_1_51) {
	...
	// From: Req7Batch79PS_CN_100
	var_1_26 = var_1_16;


	// From: Req8Batch79PS_CN_100
	var_1_27 = 10u;


	// From: Req3Batch79PS_CN_100
