...
void step(void) {
 var_1_20 = var_1_21;
 if (var_1_21 < ((((var_1_20) < 0 ) ? -(var_1_20) : (var_1_20)))) {
  if (var_1_21 <= ((((1.0000000000004E12f) < 0 ) ? -(1.0000000000004E12f) : (1.0000000000004E12f)))) {
   if (var_1_23) {
    var_1_22 = (((((((-256) < (var_1_24)) ? (-256) : (var_1_24))) < 0 ) ? -((((-256) < (var_1_24)) ? (-256) : (var_1_24))) : ((((-256) < (var_1_24)) ? (-256) : (var_1_24)))));
   }
  } else {
 ...
 var_1_28 = var_1_21;
 if (! var_1_23) {
  var_1_29 = (((((var_1_30 + var_1_31)) < (-32)) ? ((var_1_30 + var_1_31)) : (-32)));
 }
 var_1_32 = 2;
 var_1_33 = var_1_34;
 var_1_35 = var_1_26;
