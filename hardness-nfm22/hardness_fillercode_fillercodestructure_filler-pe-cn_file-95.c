...
void step(void) {
	...
	// From: CodeObject3
	if (var_1_20 >= (var_1_21 / (abs (var_1_19)))) {
		var_1_26 = var_1_27;
	}
	...
	// From: CodeObject5
	if (((var_1_31 - var_1_32) + (var_1_27 / var_1_33)) < (abs (var_1_26))) {
		if (var_1_21 >= 10u) {
			if (var_1_22) {
				var_1_30 = (abs (abs (var_1_34)));
			} else {
				var_1_30 = (min ((max (var_1_34 , var_1_29)) , (var_1_35 + 64)));
			}
		} else {
			var_1_30 = (abs (var_1_35));
		}
	}
