...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch69PS_CN_10.c", 13, "reach_error"); }
...
double var_1_32 = 200.5;
double var_1_33 = 200.3;
...
void step(void) {
	...
	// From: Req4Batch69PS_CN_10
	if (var_1_20 || (var_1_6 <= var_1_8)) {
		var_1_14 = var_1_6;
	}


	// From: Req1Batch69PS_CN_10
