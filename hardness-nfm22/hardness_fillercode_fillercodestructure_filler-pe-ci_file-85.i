...
void step(void) {
 ...
 if (var_1_5) {
  if ((var_1_14 - ((((var_1_13) < (var_1_13)) ? (var_1_13) : (var_1_13)))) <= var_1_13) {
   var_1_21 = var_1_27;
  }
 }
 var_1_28 = var_1_19;
 var_1_30 = ((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13)));
 if ((((((var_1_20 - var_1_20)) < (var_1_11)) ? ((var_1_20 - var_1_20)) : (var_1_11))) > (var_1_19 * 31.3)) {
  if (var_1_5) {
   var_1_31 = var_1_35;
  }
 } else {
 ...
 if ((var_1_7 / 25.4f) >= ((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)))) {
  var_1_37 = (! (var_1_36 || var_1_35));
 }
 if (! var_1_6) {
  if ((var_1_9 + var_1_13) >= ((var_1_13 + var_1_14) << ((((5) < (var_1_39)) ? (5) : (var_1_39))))) {
   if (var_1_17 && (4.166 >= var_1_20)) {
    var_1_38 = (((((((var_1_39) < (var_1_14)) ? (var_1_39) : (var_1_14))) < 0 ) ? -((((var_1_39) < (var_1_14)) ? (var_1_39) : (var_1_14))) : ((((var_1_39) < (var_1_14)) ? (var_1_39) : (var_1_14)))));
   } else {
