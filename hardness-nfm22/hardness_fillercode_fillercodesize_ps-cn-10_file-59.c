...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch59PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject5
	if ((abs (var_1_21)) >= var_1_27) {
		var_1_29 = var_1_28;
	}


	// From: Req3Batch59PS_CN_10
	...
	// From: Req6Batch59PS_CN_10
	var_1_17 = var_1_4;


	// From: Req7Batch59PS_CN_10
	var_1_18 = var_1_16;


	// From: Req8Batch59PS_CN_10
	var_1_19 = var_1_4;


	// From: Req1Batch59PS_CN_10
