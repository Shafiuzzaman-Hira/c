...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch94dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((-1 << last_1_var_1_19) < var_1_3) {
		if ((last_1_var_1_19 / var_1_3) > (-1000000000 + last_1_var_1_19)) {
	...
	// From: Req8Batch94dependencies
	var_1_26 = var_1_17;


	// From: Req9Batch94dependencies
	var_1_27 = var_1_6;
