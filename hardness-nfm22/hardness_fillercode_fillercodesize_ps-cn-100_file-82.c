...
void step(void) {
	...
	if (var_1_29) {
		if ((abs (var_1_25)) <= var_1_24) {
			if ((min ((var_1_27 % var_1_30) , var_1_26)) < (var_1_31 * (var_1_32 | var_1_33))) {
				if ((max (var_1_25 , var_1_24)) >= (var_1_34 * (var_1_35 - var_1_36))) {
					var_1_28 = ((abs (min (var_1_25 , var_1_37))) - (var_1_38 - (var_1_39 - 100.5f)));
				}
			}
		} else {
	...
	// From: CodeObject4
	var_1_42 = (abs (var_1_26 + var_1_27));


	// From: CodeObject5
	var_1_43 = ((max (var_1_40 , var_1_39)) + (abs (var_1_44)));
	...
	if (var_1_45 >= var_1_34) {
		var_1_46 = (min (var_1_27 , var_1_47));
	}


	// From: CodeObject8
	if (var_1_40 <= var_1_43) {
		if ((abs (var_1_47)) <= (var_1_27 * (abs (var_1_26)))) {
		...
		var_1_48 = (abs (var_1_50));
	}


	// From: CodeObject9
	if (var_1_29) {
		if ((max (-50 , var_1_46)) < var_1_27) {
			var_1_51 = (abs (abs (var_1_46)));
		}
	} else {
		if (var_1_42 == (abs (var_1_27))) {
			var_1_51 = 0u;
		}
	}
	...
	if (var_1_29 || (var_1_41 >= var_1_27)) {
		var_1_56 = ((min (128 , (abs (var_1_57)))) - var_1_58);
	}
	...
	// From: Req7Batch82PS_CN_100
	var_1_23 = last_1_var_1_14;


	// From: Req2Batch82PS_CN_100
	var_1_7 = (var_1_4 - (var_1_8 + var_1_9));


	// From: Req5Batch82PS_CN_100
	...
	// From: Req3Batch82PS_CN_100
	var_1_10 = (var_1_11 && (var_1_21 || var_1_13));


	// From: Req4Batch82PS_CN_100
