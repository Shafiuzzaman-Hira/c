...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch76Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (-25 >= unsigned_char_Array_0[0]) {
  signed_char_Array_0[1][0] = ((((signed_char_Array_0[0][0]) < (signed_char_Array_0[0][1])) ? (signed_char_Array_0[0][0]) : (signed_char_Array_0[0][1])));
 } else {
  if (signed_char_Array_0[0][1] == signed_long_int_Array_0[0]) {
   signed_char_Array_0[1][0] = (signed_char_Array_0[1][1] - 16);
  } else {
 ...
 signed char stepLocal_1 = signed_char_Array_0[1][0];
 if (stepLocal_1 <= signed_char_Array_0[1][0]) {
  if (BOOL_unsigned_char_Array_0[1][1]) {
   double_Array_0[1] = (3.17 - ((((127.2) > (double_Array_0[0])) ? (127.2) : (double_Array_0[0]))));
  }
 }
 if (BOOL_unsigned_char_Array_0[1][1]) {
  if ((double_Array_0[0] >= 24.2) || BOOL_unsigned_char_Array_0[0][1]) {
   BOOL_unsigned_char_Array_0[0][0] = (BOOL_unsigned_char_Array_0[0][1] || (! BOOL_unsigned_char_Array_0[1][0]));
  } else {
...
int property() {
 return ((((((- 5) + last_1_signed_char_Array_0_1__0_) >= last_1_signed_char_Array_0_1__0_) ? (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) (! BOOL_unsigned_char_Array_0[0][1]))) : (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) BOOL_unsigned_char_Array_0[0][1]))) && ((signed_char_Array_0[1][0] <= signed_char_Array_0[1][0]) ? (BOOL_unsigned_char_Array_0[1][1] ? (double_Array_0[1] == ((double) (3.17 - ((((127.2) > (double_Array_0[0])) ? (127.2) : (double_Array_0[0])))))) : 1) : 1)) && ((-25 >= unsigned_char_Array_0[0]) ? (signed_char_Array_0[1][0] == ((signed char) ((((signed_char_Array_0[0][0]) < (signed_char_Array_0[0][1])) ? (signed_char_Array_0[0][0]) : (signed_char_Array_0[0][1]))))) : ((signed_char_Array_0[0][1] == signed_long_int_Array_0[0]) ? (signed_char_Array_0[1][0] == ((signed char) (signed_char_Array_0[1][1] - 16))) : (BOOL_unsigned_char_Array_0[1][1] ? (signed_char_Array_0[1][0] == ((signed char) signed_char_Array_0[0][0])) : 1)))) && (BOOL_unsigned_char_Array_0[1][1] ? (((double_Array_0[0] >= 24.2) || BOOL_unsigned_char_Array_0[0][1]) ? (BOOL_unsigned_char_Array_0[0][0] == ((unsigned char) (BOOL_unsigned_char_Array_0[0][1] || (! BOOL_unsigned_char_Array_0[1][0])))) : (BOOL_unsigned_char_Array_0[0][0] == ((unsigned char) BOOL_unsigned_char_Array_0[0][1]))) : (BOOL_unsigned_char_Array_0[0][0] == ((unsigned char) BOOL_unsigned_char_Array_0[1][0])))
;
}
int main(void) {
 isInitial = 1;
