...
void step(void) {
	...
	signed long int stepLocal_15 = var_1_35 % (abs (var_1_43));
	if (stepLocal_15 > last_1_var_1_13) {
		var_1_51 = var_1_9;
	} else {
		if (last_1_var_1_33 < ((abs (var_1_8)) + 50.75)) {
			if (! (var_1_42 || var_1_4)) {
				var_1_51 = (var_1_9 - var_1_31);
			} else {
				var_1_51 = (min (var_1_11 , (var_1_25 - 0.75f)));
			}
		}
	}
	...
	if (var_1_42 && stepLocal_13) {
		if (var_1_51 == var_1_51) {
			var_1_45 = (max (var_1_17 , var_1_16));
		} else {
	...
	if (! var_1_4) {
		...
		var_1_52 = (min (var_1_35 , var_1_36));
	}


	// From: Req27Batch93Amount250
	if (var_1_58) {
		var_1_57 = var_1_14;
	}


	// From: Req28Batch93Amount250
	if (var_1_4) {
		var_1_59 = var_1_34;
	} else {
		var_1_59 = var_1_43;
	...
	// From: Req29Batch93Amount250
	unsigned char stepLocal_18 = var_1_22 >= var_1_9;
	if (stepLocal_18 || var_1_4) {
		var_1_61 = (var_1_17 + (max (var_1_18 , (var_1_62 + var_1_63))));
	}


	// From: Req30Batch93Amount250
	var_1_64 = var_1_62;


	// From: Req31Batch93Amount250
	var_1_65 = var_1_28;
	...
	if (var_1_9 < (var_1_8 - var_1_31)) {
		var_1_37 = ((abs (var_1_38)) - var_1_28);
	} else {
	...
	if (stepLocal_12 || var_1_42) {
		if ((min (var_1_24 , var_1_51)) <= 7.875) {
			var_1_41 = (min ((min (var_1_18 , (var_1_14 + var_1_15))) , var_1_34));
		} else {
			var_1_41 = (min (2 , (51214 - (abs (var_1_34)))));
		}
	} else {
	...
	var_1_50 = (min ((var_1_18 + var_1_16) , ((var_1_17 + var_1_61) - var_1_15)));


	// From: Req1Batch93Amount250
	if ((var_1_41 == var_1_37) && var_1_4) {
		var_1_1 = (min (var_1_29 , var_1_59));
	}
	...
	signed long int stepLocal_16 = min (var_1_49 , var_1_18);
	if (stepLocal_16 <= var_1_55) {
		var_1_53 = (min ((max ((128 - var_1_18) , 100)) , (max ((min (var_1_17 , 16)) , var_1_15))));
	}


	// From: Req25Batch93Amount250
	unsigned long int stepLocal_17 = var_1_37 & (min (var_1_41 , var_1_55));
	if (stepLocal_17 < (256 / var_1_44)) {
		var_1_54 = (var_1_25 + var_1_8);
	} else {
		var_1_54 = (min (var_1_10 , (abs (var_1_8 - var_1_31))));
	}


	// From: Req19Batch93Amount250
	if (! (var_1_30 >= 63.6f)) {
		var_1_46 = (min (((max (var_1_38 , var_1_47)) - (var_1_55 + var_1_65)) , var_1_13));
	} else {
		var_1_46 = (abs (var_1_55));
	}


	// From: Req4Batch93Amount250
	if ((min (var_1_15 , var_1_46)) <= -10) {
	...
	if (var_1_21 <= (var_1_12 * var_1_10)) {
		...
		if (var_1_59 <= stepLocal_4) {
			...
			var_1_23 = (max (((min (var_1_17 , var_1_46)) + var_1_18) , var_1_14));
		}
	}
...
int property() {
	return ((((((((((((((((((((((((((((((((var_1_41 == var_1_37) && var_1_4) ? (var_1_1 == ((signed long int) (min (var_1_29 , var_1_59)))) : 1) && ((var_1_13 == var_1_55) ? ((var_1_34 < var_1_29) ? (var_1_7 == ((double) ((var_1_8 - var_1_9) + var_1_10))) : ((var_1_29 >= 25) ? (var_1_7 == ((double) (max (((8.7955268025428961E18 - var_1_8) - var_1_9) , (var_1_10 + (var_1_11 + var_1_12)))))) : (var_1_7 == ((double) ((min (var_1_8 , var_1_10)) + (var_1_11 + 1.75)))))) : (var_1_7 == ((double) 10.15)))) && ((last_1_var_1_41 < last_1_var_1_29) ? (var_1_13 == ((unsigned char) (min ((max (var_1_14 , var_1_15)) , var_1_16)))) : (var_1_13 == ((unsigned char) ((var_1_17 + 4) + var_1_18))))) && (((min (var_1_15 , var_1_46)) <= -10) ? (var_1_19 == ((unsigned short int) (var_1_20 - var_1_13))) : 1)) && ((var_1_11 >= 1.000000000000823E12) ? (var_1_21 == ((double) var_1_8)) : 1)) && (var_1_4 ? (var_1_22 == ((double) var_1_12)) : 1)) && ((var_1_21 <= (var_1_12 * var_1_10)) ? ((var_1_65 <= var_1_29) ? (var_1_23 == ((signed long int) ((var_1_46 + var_1_16) + ((var_1_14 + var_1_17) - 10)))) : 1) : ((var_1_59 <= var_1_46) ? (var_1_23 == ((signed long int) (var_1_16 - var_1_46))) : (var_1_23 == ((signed long int) (max (((min (var_1_17 , var_1_46)) + var_1_18) , var_1_14))))))) && ((var_1_51 <= var_1_10) ? (var_1_4 ? (var_1_24 == ((float) (var_1_8 + var_1_10))) : 1) : (var_1_24 == ((float) (var_1_9 - ((var_1_25 + var_1_26) + var_1_8)))))) && ((! var_1_4) ? ((var_1_18 <= var_1_41) ? (var_1_27 == ((float) var_1_10)) : 1) : 1)) && (var_1_28 == ((unsigned char) var_1_17))) && (((var_1_9 - (var_1_8 + var_1_25)) >= var_1_11) ? (var_1_29 == ((unsigned short int) var_1_20)) : 1)) && (((var_1_9 >= (var_1_8 - var_1_25)) || (last_1_var_1_29 > (last_1_var_1_29 + last_1_var_1_19))) ? (((last_1_var_1_59 + last_1_var_1_29) >= var_1_15) ? (var_1_30 == ((double) (var_1_10 + var_1_11))) : (var_1_30 == ((double) 2.75))) : ((((last_1_var_1_13 / var_1_20) & (last_1_var_1_29 - last_1_var_1_46)) >= ((-64 + var_1_18) << last_1_var_1_65)) ? (var_1_30 == ((double) (var_1_25 - var_1_31))) : (var_1_30 == ((double) (min (var_1_9 , var_1_10))))))) && (((var_1_17 ^ (~ -5)) >= var_1_61) ? (var_1_32 == ((float) var_1_25)) : 1)) && ((var_1_45 >= (8 << var_1_1)) ? ((var_1_27 < var_1_12) ? (var_1_33 == ((float) (var_1_25 - var_1_26))) : 1) : (var_1_33 == ((float) var_1_26)))) && (var_1_4 ? (var_1_34 == ((signed char) (var_1_35 + var_1_36))) : (var_1_34 == ((signed char) (var_1_36 + var_1_35))))) && ((var_1_9 < (var_1_8 - var_1_31)) ? (var_1_37 == ((unsigned long int) ((abs (var_1_38)) - var_1_28))) : (((var_1_30 >= var_1_26) && var_1_4) ? (var_1_37 == ((unsigned long int) ((1479467232u + var_1_40) - var_1_15))) : (var_1_37 == ((unsigned long int) var_1_18))))) && ((var_1_4 || var_1_42) ? (((min (var_1_24 , var_1_51)) <= 7.875) ? (var_1_41 == ((unsigned short int) (min ((min (var_1_18 , (var_1_14 + var_1_15))) , var_1_34)))) : (var_1_41 == ((unsigned short int) (min (2 , (51214 - (abs (var_1_34)))))))) : (var_1_41 == ((unsigned short int) (((10000 + var_1_43) + var_1_44) - var_1_14))))) && ((var_1_42 && var_1_4) ? ((var_1_51 == var_1_51) ? (var_1_45 == ((unsigned char) (max (var_1_17 , var_1_16)))) : (var_1_45 == ((unsigned char) ((var_1_17 + 32) + var_1_18)))) : (var_1_45 == ((unsigned char) var_1_17)))) && ((! (var_1_30 >= 63.6f)) ? (var_1_46 == ((unsigned long int) (min (((max (var_1_38 , var_1_47)) - (var_1_55 + var_1_65)) , var_1_13)))) : (var_1_46 == ((unsigned long int) (abs (var_1_55)))))) && ((var_1_4 || (var_1_47 >= var_1_46)) ? (var_1_48 == ((unsigned short int) (var_1_44 + var_1_46))) : (var_1_48 == ((unsigned short int) (var_1_15 + ((var_1_49 - 1) - var_1_17)))))) && (var_1_50 == ((signed short int) (min ((var_1_18 + var_1_16) , ((var_1_17 + var_1_61) - var_1_15)))))) && (((var_1_35 % (abs (var_1_43))) > last_1_var_1_13) ? (var_1_51 == ((float) var_1_9)) : ((last_1_var_1_33 < ((abs (var_1_8)) + 50.75)) ? ((! (var_1_42 || var_1_4)) ? (var_1_51 == ((float) (var_1_9 - var_1_31))) : (var_1_51 == ((float) (min (var_1_11 , (var_1_25 - 0.75f)))))) : 1))) && ((! var_1_4) ? (var_1_52 == ((signed char) var_1_35)) : (var_1_52 == ((signed char) (min (var_1_35 , var_1_36)))))) && (((min (var_1_49 , var_1_18)) <= var_1_55) ? (var_1_53 == ((unsigned char) (min ((max ((128 - var_1_18) , 100)) , (max ((min (var_1_17 , 16)) , var_1_15)))))) : 1)) && (((var_1_37 & (min (var_1_41 , var_1_55))) < (256 / var_1_44)) ? (var_1_54 == ((float) (var_1_25 + var_1_8))) : (var_1_54 == ((float) (min (var_1_10 , (abs (var_1_8 - var_1_31)))))))) && ((! (var_1_38 >= var_1_13)) ? ((var_1_25 > (var_1_27 * var_1_27)) ? (var_1_55 == ((unsigned short int) (max (var_1_1 , var_1_16)))) : 1) : 1)) && (var_1_58 ? (var_1_57 == ((signed short int) var_1_14)) : 1)) && (var_1_4 ? (var_1_59 == ((signed short int) var_1_34)) : (var_1_59 == ((signed short int) var_1_43)))) && (((var_1_22 >= var_1_9) || var_1_4) ? (var_1_61 == ((unsigned char) (var_1_17 + (max (var_1_18 , (var_1_62 + var_1_63)))))) : 1)) && (var_1_64 == ((signed char) var_1_62))) && (var_1_65 == ((signed long int) var_1_28))
;
}
int main(void) {
	isInitial = 1;
