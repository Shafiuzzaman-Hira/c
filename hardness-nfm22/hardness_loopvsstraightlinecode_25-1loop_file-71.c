...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch7125_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch7125_1loop
	var_1_12 = 100;


	// From: Req4Batch7125_1loop
	var_1_13 = var_1_3;


	// From: Req5Batch7125_1loop
	var_1_14 = var_1_3;


	// From: Req2Batch7125_1loop
