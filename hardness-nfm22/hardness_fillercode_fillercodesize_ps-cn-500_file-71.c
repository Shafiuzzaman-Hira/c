...
void step(void) {
	...
	if ((var_1_31 % (min (var_1_32 , var_1_38))) <= var_1_33) {
		if (((max (var_1_34 , var_1_38)) <= var_1_30) || (var_1_39 || var_1_40)) {
			if ((abs (var_1_27)) <= var_1_28) {
				if (var_1_27 <= var_1_25) {
					var_1_37 = (min ((abs (var_1_34)) , (max (var_1_35 , (min (var_1_38 , -64))))));
				} else {
					var_1_37 = (min ((min (var_1_24 , (abs (var_1_36)))) , var_1_35));
				}
			}
		} else {
			if (var_1_29 >= var_1_25) {
				...
				if ((var_1_41 - var_1_36) < (min (var_1_32 , var_1_34))) {
	...
	if ((var_1_46 - var_1_36) > ((var_1_47 / var_1_32) | var_1_30)) {
		if ((max ((abs (var_1_36)) , (var_1_30 / var_1_38))) < var_1_32) {
			var_1_45 = var_1_34;
		}
	}
	...
	if (-256 > var_1_31) {
		if (var_1_49 < var_1_26) {
			var_1_48 = (abs (var_1_38));
		} else {
			var_1_48 = (abs (min (var_1_24 , var_1_41)));
		}
	} else {
		var_1_48 = (abs ((abs (var_1_35)) + var_1_34));
	}
	...
	if (var_1_50) {
		if (var_1_33 != ((-50 % var_1_41) * var_1_31)) {
			if (var_1_44) {
				var_1_52 = (abs (var_1_24 + var_1_45));
			}
		} else {
			if (((min (var_1_48 , var_1_24)) > (var_1_34 + var_1_33)) || (var_1_36 != (var_1_37 / var_1_38))) {
				if ((~ var_1_47) < -50) {
	...
	if (var_1_38 >= (var_1_52 % var_1_32)) {
		var_1_55 = (abs (var_1_36));
	}


	// From: CodeObject10
	if (128.2f >= (max (var_1_25 , 4.75f))) {
		var_1_56 = (min (var_1_38 , (abs (var_1_41))));
	} else {
		if ((var_1_31 ^ (var_1_34 / var_1_32)) >= (max ((var_1_48 + var_1_35) , var_1_55))) {
	...
	// From: CodeObject11
	if ((max ((var_1_31 >> var_1_36) , (max (var_1_35 , var_1_47)))) <= var_1_33) {
		var_1_58 = (abs (var_1_59));
	} else {
		if (((abs (61460)) - var_1_46) >= var_1_30) {
			if (var_1_54 < var_1_31) {
				if (var_1_30 > var_1_41) {
					var_1_58 = (((var_1_60 + var_1_61) - (max (var_1_62 , var_1_63))) - var_1_64);
				}
			}
		} else {
			var_1_58 = (abs (var_1_61));
		}
	}


	// From: CodeObject12
	if (var_1_27 >= (max (var_1_28 , (min (var_1_49 , var_1_58))))) {
		var_1_65 = (abs (var_1_59));
	}
	...
	if (var_1_33 >= var_1_68) {
		if (var_1_30 < ((var_1_41 - var_1_38) % var_1_32)) {
			var_1_67 = (min (var_1_36 , var_1_46));
		} else {
			if (var_1_42) {
				var_1_67 = ((abs (var_1_36)) + (abs (var_1_46)));
			}
		}
	}
	...
	if (var_1_57 >= var_1_46) {
		var_1_69 = (min ((min (var_1_41 , -5)) , var_1_55));
	} else {
		if (var_1_33 >= var_1_54) {
			var_1_69 = var_1_35;
		} else {
			if (var_1_49 <= (abs (var_1_65 + var_1_61))) {
				var_1_69 = (abs (var_1_38));
			}
		}
	}
	...
	if (var_1_53) {
		if (var_1_42) {
			var_1_75 = (min ((abs (var_1_71)) , var_1_38));
		} else {
			var_1_75 = (abs (abs (var_1_34)));
		}
	} else {
		if (var_1_43 && (var_1_36 < (min (var_1_76 , var_1_45)))) {
			if (var_1_50 || (var_1_72 || var_1_70)) {
				var_1_75 = (min ((max (var_1_36 , 0)) , (abs (max (var_1_55 , var_1_71)))));
			} else {
				var_1_75 = (abs (-1));
			}
		} else {
			var_1_75 = ((abs (var_1_24 + var_1_52)) + var_1_35);
		}
	}
	...
	if (var_1_76 >= (~ var_1_31)) {
		var_1_77 = (min ((abs (var_1_36)) , var_1_34));
	} else {
	...
	// From: CodeObject24
	if ((abs (var_1_55)) > var_1_47) {
		var_1_79 = var_1_46;
	}


	// From: CodeObject25
	if (((var_1_79 * 32) ^ (min (var_1_68 , var_1_71))) < var_1_76) {
		if ((~ (max (-25 , var_1_48))) >= (var_1_41 >> var_1_46)) {
			var_1_80 = (min ((max (64 , (min (var_1_36 , var_1_81)))) , (32 + (abs (var_1_82)))));
		} else {
			var_1_80 = (max (var_1_81 , (abs (var_1_82))));
		}
	} else {
		var_1_80 = (var_1_83 - (max (var_1_82 , var_1_36)));
	}
	...
	// From: CodeObject27
	if ((var_1_36 % (abs (var_1_38))) < var_1_76) {
		if (var_1_40) {
			var_1_85 = (max (0 , (var_1_81 + var_1_36)));
		}
	} else {
		if (-32 <= (~ var_1_69)) {
			if (var_1_26 >= (min (var_1_73 , 256.75f))) {
				var_1_85 = (abs (var_1_46));
			}
		}
	}
	...
	if (var_1_52 > var_1_35) {
		if (((var_1_27 / var_1_60) < (var_1_49 * 24.3f)) && ((var_1_46 - var_1_83) >= (max (var_1_30 , 16)))) {
			if ((var_1_68 | var_1_89) < var_1_38) {
				var_1_88 = (max (var_1_80 , var_1_46));
			}
		} else {
			var_1_88 = (min (var_1_46 , ((abs (var_1_36)) + var_1_83)));
		}
	}
	...
	if ((var_1_27 <= var_1_63) || var_1_43) {
		...
		var_1_90 = (var_1_57 - (min (1u , var_1_83)));
	}


	// From: CodeObject31
	if (var_1_60 < var_1_59) {
		var_1_91 = ((var_1_92 - (abs (var_1_81))) - (min (var_1_46 , var_1_36)));
	} else {
		var_1_91 = (abs (min (var_1_83 , var_1_46)));
	}
	...
	if (var_1_59 < var_1_74) {
		if (var_1_95 >= var_1_92) {
			if ((abs (var_1_96)) >= (var_1_84 / (var_1_57 - var_1_41))) {
				var_1_94 = var_1_89;
			}
		} else {
			if ((var_1_91 | (var_1_84 | 1)) < ((abs (var_1_57)) >> 10)) {
				var_1_94 = var_1_45;
			}
		}
	} else {
		if (var_1_36 >= var_1_75) {
			var_1_94 = (abs (max ((abs (var_1_82)) , var_1_92)));
		}
	}
	...
	if (var_1_83 < (var_1_54 / var_1_46)) {
		if (var_1_26 < var_1_60) {
			var_1_98 = (abs (var_1_45));
		}
	} else {
		var_1_98 = ((min (var_1_80 , var_1_83)) - var_1_46);
	}
	...
	if (var_1_70 || (var_1_66 >= (var_1_59 + var_1_73))) {
		if ((- var_1_62) < var_1_73) {
			if (-2 >= (var_1_71 / var_1_46)) {
				var_1_101 = (max (-64 , var_1_35));
			} else {
				var_1_101 = var_1_71;
			}
		}
	} else {
		var_1_101 = (max (var_1_71 , (var_1_83 + var_1_102)));
	}
	...
	// From: CodeObject40
	if (var_1_51) {
		if (var_1_93 || ((abs (var_1_25)) <= var_1_58)) {
			if ((- var_1_81) <= var_1_68) {
				var_1_105 = (abs (var_1_64));
			}
		}
	}
	...
	// From: CodeObject41
	if (var_1_44) {
		var_1_106 = (var_1_61 + (var_1_60 - (abs (var_1_63))));
	} else {
		if (var_1_50) {
			if (var_1_61 >= var_1_97) {
				var_1_106 = ((min (var_1_62 , (max (var_1_64 , 499.75)))) - var_1_63);
			} else {
				var_1_106 = (abs (var_1_61));
			}
		} else {
			if ((var_1_36 | var_1_34) < var_1_77) {
				var_1_106 = (max ((var_1_63 - var_1_61) , (var_1_60 - var_1_64)));
			}
		}
	}
	...
	// From: Req2Batch71PS_CN_500
	var_1_10 = var_1_11;


	// From: Req3Batch71PS_CN_500
	...
	// From: Req5Batch71PS_CN_500
	var_1_18 = (max ((max (255.5f , var_1_11)) , 5.5f));


	// From: Req7Batch71PS_CN_500
	var_1_20 = var_1_15;


	// From: Req8Batch71PS_CN_500
	var_1_21 = var_1_5;


	// From: Req9Batch71PS_CN_500
	var_1_22 = var_1_23;


	// From: Req6Batch71PS_CN_500
	if (var_1_3) {
