...
void step(void) {
	...
	if ((min (var_1_22 , var_1_23)) > var_1_24) {
		var_1_21 = (min ((10 + var_1_25) , var_1_26));
	}
	...
	if ((abs (var_1_31)) <= var_1_30) {
		var_1_33 = (max ((max (5.8 , (abs (var_1_34)))) , var_1_35));
	}
	...
	// From: Req7Batch70PS_CN_25
	if ((var_1_14 / var_1_19) <= (min (var_1_18 , var_1_14))) {
		var_1_20 = var_1_13;
	}


	// From: Req4Batch70PS_CN_25
	if (var_1_20) {
		var_1_12 = var_1_13;
	}


	// From: Req3Batch70PS_CN_25
