...
void step(void) {
	...
	// From: Req3Batch52Wrapper_SP
	if ((*(WrapperStruct00_var_1_7_Pointer))) {
		(*(WrapperStruct00_var_1_10_Pointer)) = ((*(WrapperStruct00_var_1_11_Pointer)) - (max (((*(WrapperStruct00_var_1_12_Pointer)) - (*(WrapperStruct00_var_1_13_Pointer))) , (*(WrapperStruct00_var_1_14_Pointer)))));
	}


	// From: Req1Batch52Wrapper_SP
