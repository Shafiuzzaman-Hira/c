...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch13100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (last_1_var_1_25 < stepLocal_3) {
		if ((128u <= last_1_var_1_29) && stepLocal_4) {
			if (stepLocal_2 && last_1_var_1_26) {
				...
				if ((min (var_1_19 , 1.6)) < (var_1_16 - var_1_15)) {
					var_1_26 = (! var_1_28);
				} else {
					var_1_26 = var_1_23;
				}
	...
	// From: Req5Batch13100_1loop
	if ((var_1_9 * (var_1_8 - 128)) < var_1_10) {
		var_1_20 = var_1_15;
	}


	// From: Req1Batch13100_1loop
	if ((var_1_9 <= var_1_29) || var_1_22) {
		var_1_1 = 0;
	}


	// From: Req11Batch13100_1loop
	unsigned long int stepLocal_9 = (var_1_35 - var_1_32) - (min (var_1_8 , var_1_33));
	...
	// From: Req2Batch13100_1loop
	if (var_1_1 || var_1_22) {
		var_1_5 = (min (50 , var_1_9));
	} else {
		if (var_1_22) {
	...
	// From: Req7Batch13100_1loop
	if (var_1_1 && ((var_1_8 >= var_1_29) || var_1_26)) {
		var_1_25 = (min (var_1_9 , (min ((var_1_10 + var_1_8) , var_1_7))));
	} else {
		var_1_25 = (var_1_5 + 16);
	}


	// From: Req10Batch13100_1loop
	...
	if (stepLocal_7 <= var_1_25) {
		if (stepLocal_6 > (var_1_12 + var_1_25)) {
			var_1_30 = (var_1_15 - (min (var_1_16 , (abs (var_1_18)))));
		} else {
			var_1_30 = var_1_18;
		}
	} else {
...
int property() {
	return ((((((((((((var_1_9 <= var_1_29) || var_1_22) ? (var_1_1 == ((unsigned char) 0)) : 1) && ((var_1_1 || var_1_22) ? (var_1_5 == ((signed short int) (min (50 , var_1_9)))) : (var_1_22 ? (var_1_5 == ((signed short int) (var_1_7 - var_1_8))) : 1))) && ((last_1_var_1_31 > var_1_7) ? (var_1_9 == ((signed char) ((var_1_10 + var_1_11) + var_1_12))) : 1)) && ((var_1_9 > var_1_31) ? (var_1_13 == ((double) ((var_1_15 - var_1_16) + ((max (var_1_17 , 499.25)) + var_1_18)))) : (var_1_22 ? (var_1_13 == ((double) var_1_15)) : (var_1_13 == ((double) var_1_19))))) && (((var_1_9 * (var_1_8 - 128)) < var_1_10) ? (var_1_20 == ((float) var_1_15)) : 1)) && ((9.6 <= last_1_var_1_13) ? ((var_1_19 == 4.125) ? (var_1_22 == ((unsigned char) (var_1_23 || var_1_24))) : 1) : 1)) && ((var_1_1 && ((var_1_8 >= var_1_29) || var_1_26)) ? (var_1_25 == ((signed long int) (min (var_1_9 , (min ((var_1_10 + var_1_8) , var_1_7)))))) : (var_1_25 == ((signed long int) (var_1_5 + 16))))) && ((last_1_var_1_25 < (last_1_var_1_9 % 50)) ? (((128u <= last_1_var_1_29) && (last_1_var_1_9 >= 4)) ? ((((- var_1_8) <= (last_1_var_1_9 & last_1_var_1_9)) && last_1_var_1_26) ? (var_1_26 == ((unsigned char) var_1_23)) : (((min (var_1_19 , 1.6)) < (var_1_16 - var_1_15)) ? (var_1_26 == ((unsigned char) (! var_1_28))) : (var_1_26 == ((unsigned char) var_1_23)))) : (var_1_26 == ((unsigned char) var_1_28))) : (var_1_26 == ((unsigned char) var_1_24)))) && ((var_1_24 && (var_1_17 != var_1_19)) ? ((! last_1_var_1_26) ? (var_1_29 == ((signed long int) -256)) : 1) : (var_1_29 == ((signed long int) last_1_var_1_5)))) && ((var_1_31 <= var_1_25) ? ((var_1_7 > (var_1_12 + var_1_25)) ? (var_1_30 == ((float) (var_1_15 - (min (var_1_16 , (abs (var_1_18))))))) : (var_1_30 == ((float) var_1_18))) : (var_1_30 == ((float) var_1_16)))) && (var_1_1 ? (((var_1_32 - (var_1_33 - var_1_34)) >= var_1_29) ? (var_1_31 == ((unsigned long int) (32u + var_1_33))) : 1) : ((last_1_var_1_31 <= ((var_1_35 - var_1_32) - (min (var_1_8 , var_1_33)))) ? (var_1_31 == ((unsigned long int) var_1_33)) : (var_1_31 == ((unsigned long int) var_1_8))))
;
}
int main(void) {
	isInitial = 1;
