...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch12Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch12Amount50
	var_1_21 = (abs (var_1_7));


	// From: Req2Batch12Amount50
