...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch3dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch3dependencies
	if ((var_1_5 * var_1_13) > last_1_var_1_10) {
		var_1_20 = (abs (max ((var_1_21 - var_1_14) , (var_1_22 + 8))));
	}


	// From: Req5Batch3dependencies
	...
	// From: Req3Batch3dependencies
	if (var_1_20 <= ((var_1_6 ^ var_1_20) + var_1_23)) {
