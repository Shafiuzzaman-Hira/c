...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch32PS_CN_25.c", 13, "reach_error"); }
...
unsigned long int var_1_37 = 1364252806;
...
void step(void) {
	...
	if (var_1_25 > var_1_26) {
		var_1_27 = (min (var_1_28 , -256));
	}


	// From: CodeObject3
	var_1_29 = (abs (var_1_30 + (var_1_31 + var_1_32)));


	// From: CodeObject4
	if (var_1_30 > (var_1_32 + var_1_31)) {
		if (var_1_34) {
			var_1_33 = var_1_32;
		}
	}
	...
	if (var_1_34) {
		if (var_1_36) {
			var_1_35 = (((abs (var_1_37)) - (1000000000u - var_1_38)) + (abs (var_1_30)));
		} else {
			if (var_1_39) {
				var_1_35 = var_1_30;
			}
	...
	// From: Req7Batch32PS_CN_25
	var_1_22 = var_1_12;


	// From: Req8Batch32PS_CN_25
	var_1_23 = var_1_8;


	// From: Req9Batch32PS_CN_25
	var_1_24 = var_1_6;
}
...
void updateVariables() {
	...
	assume_abort_if_not(var_1_38 <= 536870911);
