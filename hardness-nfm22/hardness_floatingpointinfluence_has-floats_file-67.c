...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch67has_floats.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch67has_floats
	if (! (last_1_var_1_6 <= last_1_var_1_1)) {
		var_1_1 = (var_1_4 + var_1_5);
	}


	// From: Req2Batch67has_floats
	...
	// From: Req4Batch67has_floats
	var_1_11 = var_1_12;


	// From: Req5Batch67has_floats
	var_1_13 = var_1_12;


	// From: Req6Batch67has_floats
	var_1_14 = var_1_7;


	// From: Req3Batch67has_floats
