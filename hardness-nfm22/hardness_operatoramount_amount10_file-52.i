...
void step(void) {
 if ((last_1_var_1_7 * last_1_var_1_7) != (last_1_var_1_7 - last_1_var_1_7)) {
  var_1_1 = ((((last_1_var_1_7) < (last_1_var_1_7)) ? (last_1_var_1_7) : (last_1_var_1_7)));
 }
...
int property() {
 return (((last_1_var_1_7 * last_1_var_1_7) != (last_1_var_1_7 - last_1_var_1_7)) ? (var_1_1 == ((signed long int) ((((last_1_var_1_7) < (last_1_var_1_7)) ? (last_1_var_1_7) : (last_1_var_1_7))))) : 1) && (var_1_8 ? ((var_1_1 >= (var_1_6 * last_1_var_1_7)) ? (var_1_7 == ((unsigned short int) var_1_9)) : 1) : 1)
;
}
int main(void) {
 isInitial = 1;
