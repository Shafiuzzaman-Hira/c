...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch30has_floats.c", 13, "reach_error"); }
...
int property() {
 return (((var_1_2 ? ((last_1_var_1_10 > ((last_1_var_1_10 / var_1_5) % var_1_6)) ? (var_1_1 == ((unsigned char) ((((((((var_1_7) < (var_1_8)) ? (var_1_7) : (var_1_8)))) > (var_1_9)) ? (((((var_1_7) < (var_1_8)) ? (var_1_7) : (var_1_8)))) : (var_1_9))))) : 1) : (var_1_1 == ((unsigned char) var_1_9))) && (((var_1_1 + var_1_1) < var_1_6) ? (var_1_2 ? ((var_1_5 > var_1_1) ? (var_1_10 == ((signed long int) var_1_1)) : 1) : (var_1_10 == ((signed long int) var_1_8))) : (var_1_10 == ((signed long int) var_1_9)))) && ((var_1_1 > var_1_10) ? ((var_1_1 <= ((var_1_9 / var_1_5) << var_1_6)) ? (var_1_11 == ((float) (var_1_13 + var_1_14))) : 1) : (var_1_11 == ((float) (((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13))) - var_1_15))))) && (var_1_16 == ((float) var_1_15))
;
}
int main(void) {
 isInitial = 1;
