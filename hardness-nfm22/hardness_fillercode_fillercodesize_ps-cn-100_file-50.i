...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch50PS_CN_100.c", 13, "reach_error"); }
...
float var_1_49 = 1000000000.2;
float var_1_50 = 32.48;
unsigned long int var_1_51 = 1;
unsigned char var_1_52 = 128;
unsigned char var_1_53 = 16;
unsigned long int var_1_54 = 1361739248;
unsigned long int var_1_55 = 1836318763;
unsigned long int var_1_56 = 1769322833;
...
void step(void) {
 if (! (var_1_32 < var_1_33)) {
  if (var_1_33 >= ((64 ^ var_1_32) % 64)) {
   if (var_1_33 >= var_1_32) {
    var_1_31 = ((((var_1_34 + var_1_35) < 0 ) ? -(var_1_34 + var_1_35) : (var_1_34 + var_1_35)));
   } else {
    var_1_31 = var_1_34;
   }
  } else {
 ...
 if (var_1_35 >= ((((var_1_32 % var_1_37) < 0 ) ? -(var_1_32 % var_1_37) : (var_1_32 % var_1_37)))) {
  var_1_36 = var_1_33;
 }
 if (((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31))) == (var_1_33 * (var_1_36 >> var_1_32))) {
  var_1_38 = ((((((((var_1_31) < (var_1_32)) ? (var_1_31) : (var_1_32)))) > (32)) ? (((((var_1_31) < (var_1_32)) ? (var_1_31) : (var_1_32)))) : (32)));
 }
 if (var_1_35 <= (8 * (var_1_32 % var_1_37))) {
  if (var_1_34 <= (- var_1_38)) {
   var_1_39 = var_1_41;
  }
 }
 if (((var_1_36 * var_1_37) / ((((5) < 0 ) ? -(5) : (5)))) < (~ var_1_33)) {
  if ((var_1_36 + var_1_33) >= ((5 % var_1_37) + var_1_35)) {
 ...
 if (var_1_40 || (1.2f < var_1_39)) {
  var_1_44 = (var_1_45 && (var_1_40 || var_1_46));
 }
 if ((- var_1_39) >= 24.875) {
  var_1_47 = (((((((var_1_35) < (var_1_34)) ? (var_1_35) : (var_1_34))) < 0 ) ? -((((var_1_35) < (var_1_34)) ? (var_1_35) : (var_1_34))) : ((((var_1_35) < (var_1_34)) ? (var_1_35) : (var_1_34)))));
 }
 if ((var_1_43 < var_1_42) && (var_1_32 < (var_1_31 % var_1_37))) {
  var_1_48 = ((((((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41)))) > ((var_1_49 + var_1_50))) ? (((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41)))) : ((var_1_49 + var_1_50))));
 }
 if (((((var_1_49) < 0 ) ? -(var_1_49) : (var_1_49))) < var_1_48) {
  if (var_1_38 > (var_1_33 ^ var_1_35)) {
   if (! var_1_40) {
    if (var_1_44) {
     if (var_1_47 <= (var_1_52 - var_1_53)) {
      var_1_51 = ((((((var_1_54) < (var_1_55)) ? (var_1_54) : (var_1_55))) + var_1_56) - var_1_57);
     } else {
      var_1_51 = var_1_55;
     }
    } else {
     if ((var_1_55 & var_1_38) < var_1_56) {
      var_1_51 = ((((var_1_47) > (var_1_37)) ? (var_1_47) : (var_1_37)));
     } else {
      var_1_51 = (var_1_33 + var_1_38);
     }
    }
   }
  } else {
...
void updateVariables() {
 ...
 assume_abort_if_not(var_1_56 >= 1073741824);
