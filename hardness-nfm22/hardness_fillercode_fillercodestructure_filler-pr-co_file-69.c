...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch69Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_20) {
		...
		if ((var_1_1 % var_1_34) != (var_1_15 + var_1_15)) {
			if ((min (8.4f , var_1_12)) < 127.2f) {
				var_1_32 = (abs (var_1_36));
			} else {
				var_1_32 = (abs (var_1_36));
			}
		} else {
			if (((abs (var_1_1)) << var_1_1) > var_1_34) {
				if ((-100 | var_1_1) >= var_1_1) {
					var_1_32 = var_1_33;
				}
			} else {
				var_1_32 = var_1_37;
	...
	// From: CodeObject1
	if (var_1_20) {
		var_1_24 = (((max (var_1_1 , var_1_1)) + var_1_1) + 1);
	}
	...
	// From: CodeObject4
	if (var_1_15 <= 100u) {
		var_1_31 = (abs (var_1_1));
	}


	// From: Req5Batch69Filler_PR_CO
