...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch80PS_CN_500.c", 13, "reach_error"); }
...
float var_1_77 = 25.5;
float var_1_78 = 8.5;
float var_1_79 = 9999999999.1;
double var_1_80 = 31.875;
unsigned short int var_1_81 = 16;
float var_1_82 = 64.25;
float var_1_83 = 199.5;
unsigned short int var_1_84 = 57331;
unsigned short int var_1_85 = 64;
signed long int var_1_86 = 16;
float var_1_87 = 0.375;
float var_1_88 = 16.25;
unsigned char var_1_89 = 5;
unsigned long int var_1_90 = 1;
double var_1_91 = 255.25;
signed short int var_1_92 = -32;
unsigned char var_1_93 = 128;
unsigned char var_1_94 = 1;
unsigned short int var_1_95 = 16;
unsigned long int var_1_96 = 100000000;
unsigned long int var_1_97 = 2124862001;
unsigned long int var_1_98 = 2562301936;
double var_1_99 = 4.8;
double var_1_100 = 100.54;
...
unsigned short int var_1_119 = 100;
unsigned long int var_1_120 = 1000000000;
unsigned char var_1_121 = 1;
unsigned char var_1_122 = 0;
signed long int var_1_123 = -64;
float var_1_124 = 255.5;
double var_1_125 = -0.375;
signed char var_1_126 = -4;
float var_1_127 = 127.8;
double var_1_128 = 127.05;
unsigned char var_1_129 = 5;
signed long int var_1_130 = -32;
...
void step(void) {
	...
	// From: CodeObject20
	if (var_1_47 > (abs (var_1_60))) {
		var_1_66 = ((abs (var_1_30)) - var_1_39);
	}


	// From: CodeObject21
	if (var_1_63 < (var_1_35 - 3.875f)) {
		if (var_1_58 > 100.2) {
			var_1_67 = (abs (var_1_42));
		}
	}
	...
	// From: CodeObject22
	if (var_1_40) {
		var_1_68 = (abs (var_1_41));
	}


	// From: CodeObject23
	var_1_69 = ((min (var_1_62 , var_1_61)) - var_1_35);


	// From: CodeObject24
	var_1_70 = ((var_1_62 <= var_1_64) && var_1_71);


	// From: CodeObject25
	if (((abs (var_1_32)) - (abs (var_1_35))) >= var_1_36) {
		var_1_72 = (max (var_1_51 , var_1_73));
	} else {
		var_1_72 = ((abs (16)) + var_1_74);
	}


	// From: CodeObject26
	if (! var_1_43) {
		var_1_75 = (max (var_1_54 , var_1_42));
	}
	...
	// From: CodeObject28
	if (-4 > var_1_39) {
		var_1_77 = ((var_1_62 - 8.75f) + (abs (var_1_61)));
	} else {
		var_1_77 = (var_1_63 + (var_1_78 + var_1_62));
	}


	// From: CodeObject29
	var_1_79 = (max (((min (var_1_36 , var_1_37)) - var_1_35) , (var_1_62 + var_1_78)));


	// From: CodeObject30
	if (! var_1_33) {
		if (var_1_72 < ((var_1_54 - var_1_41) / var_1_34)) {
			var_1_80 = (min (var_1_78 , var_1_62));
		}
	} else {
		if (var_1_61 <= var_1_32) {
			if ((abs (var_1_29)) <= (abs (var_1_25))) {
				var_1_80 = var_1_28;
			} else {
				if (! (1 > var_1_45)) {
					var_1_80 = (max (var_1_27 , var_1_61));
				} else {
					var_1_80 = (min ((abs (var_1_35)) , (var_1_36 - var_1_62)));
				}
			}
		} else {
			var_1_80 = ((max ((max (var_1_63 , var_1_62)) , var_1_78)) + (abs (var_1_61)));
		}
	}


	// From: CodeObject31
	if (var_1_82 <= (var_1_28 + (abs (var_1_83)))) {
		if (var_1_58 < 2.5) {
			if (var_1_39 >= var_1_49) {
				var_1_81 = (abs ((abs (var_1_54)) + var_1_68));
			} else {
				var_1_81 = (var_1_84 - (min (var_1_75 , var_1_49)));
			}
		} else {
			var_1_81 = (max (var_1_42 , var_1_41));
		}
	} else {
		if (var_1_65 == var_1_72) {
			var_1_81 = (abs (var_1_34));
		}
	}


	// From: CodeObject32
	if ((-1000000 ^ var_1_41) >= (var_1_86 - var_1_54)) {
		var_1_85 = (abs (var_1_84));
	}


	// From: CodeObject33
	if (var_1_47 > var_1_79) {
		if (! ((min (var_1_48 , var_1_24)) <= var_1_76)) {
			var_1_87 = (var_1_62 + 499.5f);
		}
	} else {
		var_1_87 = (abs (var_1_78));
	}


	// From: CodeObject34
	if ((abs (- var_1_63)) < var_1_64) {
		if (var_1_36 <= var_1_63) {
			var_1_88 = (abs (var_1_63));
		}
	} else {
		var_1_88 = (var_1_78 + (abs (abs (var_1_63))));
	}


	// From: CodeObject35
	if (((var_1_67 + var_1_26) <= var_1_86) || var_1_33) {
		var_1_89 = (min (var_1_42 , var_1_54));
	}


	// From: CodeObject36
	if (var_1_87 >= var_1_47) {
		var_1_90 = (var_1_65 + (abs (var_1_39)));
	}


	// From: CodeObject37
	if (var_1_59) {
		if ((var_1_84 ^ var_1_41) >= var_1_75) {
			var_1_91 = var_1_63;
		}
	}
	...
	// From: CodeObject38
	if (var_1_32 >= var_1_76) {
		var_1_92 = (max (var_1_73 , -1));
	}


	// From: CodeObject39
	if (var_1_75 <= var_1_45) {
		var_1_93 = (max (var_1_53 , 50));
	} else {
	...
	// From: CodeObject40
	if (((var_1_89 | var_1_68) & var_1_46) != (~ var_1_92)) {
		var_1_94 = (! var_1_57);
	} else {
		var_1_94 = var_1_71;
	}
	...
	// From: CodeObject41
	if (var_1_28 < 7.25f) {
		if ((max (var_1_66 , (min (0 , var_1_75)))) <= var_1_89) {
			if ((min (var_1_83 , var_1_36)) <= var_1_47) {
				var_1_95 = (min (var_1_75 , 128));
			} else {
				var_1_95 = (abs (max (16 , (max (16 , var_1_89)))));
			}
		} else {
			var_1_95 = (128 + var_1_89);
		}
	}


	// From: CodeObject42
	if (var_1_30 > var_1_42) {
		var_1_96 = (var_1_75 + (abs (var_1_97 - var_1_41)));
	} else {
		if (var_1_52 >= (var_1_49 + var_1_93)) {
			var_1_96 = (max (var_1_85 , (var_1_98 - (min (var_1_65 , var_1_26)))));
		}
	}


	// From: CodeObject43
	if (var_1_95 < (max (64 , var_1_68))) {
		var_1_99 = (abs (var_1_37 - var_1_100));
	} else {
	...
	// From: CodeObject44
	if (var_1_98 < var_1_90) {
		if (var_1_31 >= (var_1_95 | var_1_90)) {
			var_1_101 = (abs (abs (var_1_51)));
		}
	}


	// From: CodeObject45
	if (((var_1_98 | var_1_84) | var_1_75) <= var_1_96) {
		var_1_102 = (max ((abs (abs (var_1_75))) , var_1_68));
	} else {
		if (var_1_43) {
			var_1_102 = (abs (abs (var_1_54)));
		}
	}
	...
	// From: CodeObject46
	if (var_1_40) {
		var_1_103 = (10 + (abs (var_1_53)));
	}


	// From: CodeObject47
	if ((max (var_1_65 , var_1_90)) <= var_1_53) {
		var_1_104 = ((min (var_1_75 , var_1_93)) - (min (var_1_26 , (max (var_1_52 , var_1_42)))));
	}


	// From: CodeObject48
	if ((var_1_101 % (min (var_1_41 , var_1_42))) != (var_1_89 / (max (var_1_84 , var_1_34)))) {
		var_1_105 = (abs (var_1_75));
	} else {
		var_1_105 = (abs (abs (var_1_49)));
	}


	// From: CodeObject49
	if ((var_1_107 | var_1_105) < var_1_84) {
		if (var_1_45 <= var_1_34) {
			var_1_106 = (max ((min ((min (var_1_65 , 1000000000u)) , (abs (var_1_98)))) , var_1_107));
		}
	}
	...
	if (var_1_56) {
		if (var_1_71) {
			if ((var_1_88 + (10.6 + var_1_83)) > var_1_38) {
				var_1_108 = (min (((var_1_103 + var_1_49) - (abs (var_1_51))) , var_1_72));
			} else {
				var_1_108 = (((var_1_102 - var_1_52) + var_1_95) + var_1_103);
			}
		}
	}
	...
	// From: CodeObject51
	if (var_1_55 <= (min (-1 , (var_1_25 % -4)))) {
		var_1_109 = (abs (abs (var_1_61)));
	}


	// From: CodeObject52
	if (var_1_55 > (var_1_95 * var_1_51)) {
		var_1_110 = (min ((var_1_89 + var_1_53) , var_1_65));
	} else {
		var_1_110 = (var_1_34 + var_1_41);
	}


	// From: CodeObject53
	if (var_1_71) {
		if ((var_1_95 / var_1_84) <= (var_1_90 + var_1_46)) {
			var_1_111 = (min (var_1_89 , var_1_95));
		} else {
			var_1_111 = (min (var_1_73 , var_1_72));
		}
	} else {
		var_1_111 = (var_1_85 - var_1_112);
	}


	// From: CodeObject54
	if ((- var_1_98) <= var_1_89) {
		var_1_113 = (var_1_54 + (abs (var_1_53)));
	}
	...
	if (var_1_64 > var_1_69) {
		if (var_1_94) {
			if (var_1_51 >= var_1_53) {
				if ((max (var_1_77 , var_1_79)) < var_1_61) {
					var_1_114 = (min ((var_1_54 + (abs (var_1_41))) , var_1_53));
				} else {
					var_1_114 = (min ((abs (abs (var_1_42))) , (abs (var_1_41))));
				}
			} else {
				var_1_114 = (min ((abs (abs (var_1_54))) , var_1_53));
			}
		}
	}
	...
	if (var_1_57) {
		if (var_1_94) {
			var_1_115 = (abs (abs (min (var_1_26 , var_1_67))));
		} else {
			var_1_115 = (var_1_116 + 5);
		}
	} else {
		var_1_115 = (min (var_1_39 , var_1_107));
	}
	...
	// From: CodeObject70
	if (var_1_71 && (var_1_65 < 100)) {
		if ((var_1_67 | (var_1_30 ^ var_1_98)) <= var_1_131) {
			var_1_130 = var_1_85;
		} else {
			var_1_130 = var_1_105;
		}
	...
	// From: Req5Batch80PS_CN_500
	if ((var_1_17 <= (- var_1_16)) && var_1_19) {
		var_1_18 = var_1_10;
	}


	// From: Req7Batch80PS_CN_500
	if (var_1_19) {
...
void updateVariables() {
	...
	assume_abort_if_not((var_1_100 >= 0.0F && var_1_100 <= -1.0e-20F) || (var_1_100 <= 9223372.036854765600e+12F && var_1_100 >= 1.0e-20F ));
	...
	assume_abort_if_not(var_1_116 >= -1073741823);
	assume_abort_if_not(var_1_116 <= 1073741823);
	var_1_131 = __VERIFIER_nondet_ulong();
	assume_abort_if_not(var_1_131 >= 0);
	assume_abort_if_not(var_1_131 <= 4294967295);
}
