...
void step(void) {
	...
	// From: Req2Batch38normal
	if (var_1_2 < (max (var_1_3 , (128.5 * var_1_5)))) {
		var_1_7 = (var_1_1 && (! 1));
	}


	// From: Req3Batch38normal
	if ((var_1_9 * var_1_10) < ((max (-1 , var_1_11)) - var_1_12)) {
