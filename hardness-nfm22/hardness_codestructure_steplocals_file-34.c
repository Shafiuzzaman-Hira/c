...
void step(void) {
	...
	// From: Req5Batch34stepLocals
	unsigned long int stepLocal_3 = max (var_1_7 , (var_1_4 | var_1_9));
	...
	// From: Req7Batch34stepLocals
	if (var_1_3 > var_1_12) {
		var_1_18 = (! var_1_19);
	}


	// From: Req8Batch34stepLocals
	var_1_20 = var_1_21;
}
