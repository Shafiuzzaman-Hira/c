...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch28dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch28dependencies
	if (var_1_12) {
		if (var_1_13) {
			if ((last_1_var_1_6 > (~ var_1_10)) && var_1_14) {
	...
	// From: Req1Batch28dependencies
	if (var_1_11 <= var_1_6) {
		var_1_1 = (max ((min (var_1_11 , (max (var_1_6 , var_1_6)))) , var_1_6));
	}


	// From: Req6Batch28dependencies
	if (var_1_13) {
		if (var_1_14) {
			if (var_1_12) {
	...
	// From: Req4Batch28dependencies
	if (var_1_6 <= ((max (128 , var_1_16)) - var_1_17)) {
	...
	// From: Req5Batch28dependencies
	if (((200 << var_1_15) * (var_1_17 * var_1_7)) < var_1_1) {
		var_1_18 = var_1_19;
	}
}
