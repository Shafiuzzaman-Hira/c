...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch62Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (((var_1_19 >> var_1_19) % -10) >= var_1_17) {
  if ((var_1_37 - ((((var_1_33) < 0 ) ? -(var_1_33) : (var_1_33)))) != var_1_22) {
 ...
 if (var_1_37 < ((((var_1_33) < (var_1_1)) ? (var_1_33) : (var_1_1)))) {
