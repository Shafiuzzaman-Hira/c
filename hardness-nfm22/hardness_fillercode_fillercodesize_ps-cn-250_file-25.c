...
void step(void) {
	...
	// From: CodeObject22
	if (var_1_64 < (min ((var_1_62 & var_1_51) , var_1_32))) {
		var_1_73 = (abs (var_1_53));
	}
	...
	if (var_1_52 >= (5u ^ (var_1_64 - var_1_46))) {
		if (var_1_32 >= var_1_63) {
			var_1_74 = (max (var_1_50 , ((abs (var_1_75)) - var_1_49)));
		}
	} else {
		if (((var_1_58 / var_1_76) + var_1_65) < (max ((abs (var_1_61)) , (- var_1_29)))) {
			var_1_74 = (max (var_1_49 , var_1_75));
		}
	}
	...
	if (((-8 % -100) | var_1_24) < (var_1_42 + 16u)) {
		var_1_79 = (abs (abs (var_1_54)));
	} else {
		if (var_1_42 <= (-2 ^ -64)) {
			var_1_79 = (max (var_1_53 , (abs (var_1_55))));
		}
	}
	...
	if (var_1_46 >= ((var_1_26 * 256) % var_1_57)) {
		...
		var_1_80 = (abs (var_1_67 + var_1_61));
	}
	...
	if (var_1_44 >= ((var_1_40 >> var_1_49) | var_1_78)) {
		if (var_1_70) {
			var_1_82 = (abs (min (var_1_75 , var_1_50)));
		} else {
			var_1_82 = ((abs (var_1_83)) - var_1_50);
		}
	}


	// From: CodeObject30
	var_1_84 = (max ((min (var_1_73 , var_1_54)) , var_1_40));
	...
	// From: CodeObject32
	if (var_1_31) {
		if (var_1_29 < (min (var_1_60 , (max (var_1_67 , 127.375))))) {
	...
	// From: Req3Batch25PS_CN_250
	var_1_10 = (last_1_var_1_10 && var_1_11);


	// From: Req5Batch25PS_CN_250
	...
	// From: Req8Batch25PS_CN_250
	var_1_22 = last_1_var_1_22;


	// From: Req9Batch25PS_CN_250
	var_1_23 = var_1_14;


	// From: Req6Batch25PS_CN_250
	...
	// From: Req7Batch25PS_CN_250
	var_1_21 = var_1_22;


	// From: Req4Batch25PS_CN_250
	if (! (var_1_23 <= var_1_7)) {
