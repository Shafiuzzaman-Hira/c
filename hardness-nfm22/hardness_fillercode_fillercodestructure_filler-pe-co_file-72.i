...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch72Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_41 = var_1_42;
 if (var_1_37 <= ((((var_1_29) > (var_1_23)) ? (var_1_29) : (var_1_23)))) {
  var_1_43 = var_1_42;
 }
 if (var_1_31 <= ((((-8) > ((var_1_37 ^ var_1_40))) ? (-8) : ((var_1_37 ^ var_1_40))))) {
  if (var_1_17) {
