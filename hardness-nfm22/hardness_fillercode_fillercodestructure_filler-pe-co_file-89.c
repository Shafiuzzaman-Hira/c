...
void step(void) {
	...
	// From: Req6Batch89Filler_PE_CO
	var_1_18 = var_1_8;


	// From: Req3Batch89Filler_PE_CO
	...
	// From: CodeObject2
	if ((min (var_1_12 , 25)) > (var_1_18 >> (min (var_1_25 , 1)))) {
		if (var_1_8 >= var_1_23) {
			var_1_24 = var_1_8;
		} else {
			var_1_24 = var_1_18;
	...
	if (var_1_14 && var_1_14) {
		if (var_1_8 < var_1_29) {
			if (var_1_14) {
				...
				var_1_32 = (var_1_23 + (abs (max (var_1_25 , var_1_18))));
			}
		}
	} else {
		if (var_1_14) {
	...
	if (var_1_23 > var_1_1) {
		if ((min (var_1_16 , (var_1_16 / var_1_36))) <= var_1_16) {
			var_1_33 = ((abs (var_1_8)) + (var_1_18 + var_1_30));
		}
	}
