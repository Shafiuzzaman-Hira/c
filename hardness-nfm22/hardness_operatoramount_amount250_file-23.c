...
void step(void) {
	// From: Req17Batch23Amount250
	if (var_1_25 && last_1_var_1_22) {
		var_1_52 = ((max (var_1_43 , (min (var_1_18 , var_1_6)))) + (max (var_1_31 , (min (last_1_var_1_58 , 256)))));
	}


	// From: Req18Batch23Amount250
	signed long int stepLocal_24 = var_1_30 >> (var_1_54 - var_1_55);
	if (stepLocal_24 != var_1_52) {
		var_1_53 = ((var_1_41 - var_1_7) + (min (var_1_16 , var_1_55)));
	}


	// From: Req21Batch23Amount250
	...
	// From: Req7Batch23Amount250
	signed long int stepLocal_7 = (var_1_6 + var_1_7) - (min (var_1_16 , var_1_28));
	...
	// From: Req8Batch23Amount250
	signed long int stepLocal_9 = abs (var_1_18);
	unsigned long int stepLocal_8 = var_1_21;
	if (-32 != stepLocal_9) {
		if (var_1_28 > stepLocal_8) {
			var_1_29 = (abs ((var_1_30 - var_1_18) - (var_1_31 - 5)));
		}
	}


	// From: Req14Batch23Amount250
	var_1_40 = (var_1_7 - (var_1_41 - (var_1_42 + var_1_43)));


	// From: Req16Batch23Amount250
	signed char stepLocal_23 = var_1_6;
	if (var_1_26) {
		if (var_1_25) {
			var_1_50 = (var_1_51 - (max ((20363 - var_1_18) , var_1_52)));
		} else {
			var_1_50 = (max ((min ((abs (var_1_31)) , var_1_16)) , var_1_28));
		}
	} else {
		if (stepLocal_23 >= last_1_var_1_50) {
			var_1_50 = (max (((min (var_1_42 , var_1_41)) + var_1_31) , var_1_30));
		}
	}


	// From: Req19Batch23Amount250
	if (var_1_24) {
		var_1_56 = var_1_14;
	}


	// From: Req1Batch23Amount250
	...
	if (var_1_24) {
		...
		if (var_1_12 > var_1_14) {
			if (stepLocal_11 <= var_1_31) {
				...
				var_1_32 = (max ((1 - var_1_35) , (abs (var_1_5))));
			}
		} else {
			...
			if (stepLocal_18 >= var_1_30) {
				if ((var_1_14 + var_1_11) > last_1_var_1_36) {
					if (((var_1_11 / var_1_12) / var_1_38) >= var_1_14) {
						var_1_36 = (max (var_1_38 , (min (var_1_14 , (32.2f - var_1_39)))));
					}
				} else {
					var_1_36 = (abs (var_1_39));
				}
			} else {
	...
	if (var_1_22) {
		...
		if ((var_1_10 > var_1_8) || var_1_22) {
			...
			var_1_33 = (abs (var_1_1));
		}
	}


	// From: Req11Batch23Amount250
	...
	if ((min (var_1_30 , var_1_52)) <= stepLocal_14) {
		if (stepLocal_15 || var_1_22) {
			if (var_1_28 <= stepLocal_12) {
				var_1_34 = ((var_1_30 - var_1_18) - var_1_6);
			} else {
				var_1_34 = (min (var_1_58 , ((var_1_16 + var_1_28) - var_1_7)));
			}
		} else {
...
int property() {
	return ((((((((((((((((((((((((var_1_2 - 16u) != var_1_15) || var_1_22) ? (var_1_1 == ((signed char) (var_1_5 + (var_1_6 - var_1_7)))) : (var_1_1 == ((signed char) (abs (abs (var_1_7)))))) && (var_1_22 ? (((8u * (var_1_2 * var_1_7)) >= var_1_19) ? (var_1_8 == ((float) (min (var_1_10 , var_1_11)))) : 1) : ((((var_1_11 / var_1_12) == var_1_10) && var_1_22) ? (var_1_8 == ((float) (8.35f + var_1_14))) : (var_1_8 == ((float) (min (var_1_14 , var_1_11))))))) && ((var_1_2 <= (var_1_52 + var_1_7)) ? (var_1_15 == ((unsigned char) var_1_6)) : (var_1_15 == ((unsigned char) (var_1_7 + var_1_16))))) && (((var_1_6 << var_1_7) > var_1_5) ? (var_1_17 == ((signed short int) ((var_1_6 + (var_1_18 - var_1_16)) - (var_1_58 + var_1_7)))) : 1)) && ((var_1_6 >= -128) ? ((var_1_14 <= var_1_10) ? (var_1_19 == ((unsigned long int) (var_1_20 - 1u))) : 1) : (var_1_22 ? (var_1_19 == ((unsigned long int) (var_1_44 + (var_1_21 - 8u)))) : 1))) && ((var_1_6 >= (var_1_5 / (min (-16 , var_1_23)))) ? (var_1_22 == ((unsigned char) (var_1_24 && var_1_25))) : (((var_1_12 <= 0.6f) || ((var_1_21 / var_1_18) > (256u * var_1_2))) ? (var_1_22 == ((unsigned char) ((! var_1_25) || var_1_26))) : (var_1_22 == ((unsigned char) var_1_26))))) && ((var_1_15 >= ((var_1_6 + var_1_7) - (min (var_1_16 , var_1_28)))) ? (var_1_27 == ((float) var_1_11)) : (var_1_27 == ((float) 9.375f)))) && ((-32 != (abs (var_1_18))) ? ((var_1_28 > var_1_21) ? (var_1_29 == ((signed short int) (abs ((var_1_30 - var_1_18) - (var_1_31 - 5))))) : 1) : 1)) && (var_1_24 ? (var_1_32 == ((signed short int) -64)) : ((var_1_12 > var_1_14) ? ((var_1_50 <= var_1_31) ? (var_1_32 == ((signed short int) 0)) : (var_1_32 == ((signed short int) (max ((1 - var_1_35) , (abs (var_1_5))))))) : ((var_1_22 || var_1_22) ? (var_1_32 == ((signed short int) var_1_5)) : (var_1_32 == ((signed short int) var_1_18)))))) && (var_1_22 ? (var_1_33 == ((signed short int) (var_1_1 - var_1_16))) : (((var_1_10 > var_1_8) || var_1_22) ? (var_1_33 == ((signed short int) (var_1_5 + -5))) : (var_1_33 == ((signed short int) (abs (var_1_1))))))) && (((min (var_1_30 , var_1_52)) <= 16u) ? ((((var_1_30 / var_1_31) <= var_1_52) || var_1_22) ? ((var_1_28 <= (var_1_18 + var_1_33)) ? (var_1_34 == ((signed short int) ((var_1_30 - var_1_18) - var_1_6))) : (var_1_34 == ((signed short int) (min (var_1_58 , ((var_1_16 + var_1_28) - var_1_7)))))) : ((var_1_22 || ((var_1_14 * var_1_27) >= var_1_11)) ? (var_1_34 == ((signed short int) var_1_23)) : (var_1_34 == ((signed short int) var_1_31)))) : (var_1_34 == ((signed short int) var_1_31)))) && (((32 + var_1_50) >= 10000u) ? (var_1_35 == ((unsigned char) (max (var_1_7 , var_1_16)))) : (var_1_35 == ((unsigned char) (var_1_6 + var_1_28))))) && (var_1_22 ? (var_1_36 == ((float) (var_1_37 - (min (var_1_39 , var_1_38))))) : (((var_1_44 % var_1_18) > var_1_19) ? (var_1_22 ? (var_1_36 == ((float) (min ((min ((abs (99999.25f)) , (var_1_38 - var_1_37))) , var_1_10)))) : (var_1_36 == ((float) (var_1_39 + var_1_14)))) : ((var_1_17 >= var_1_30) ? (((var_1_14 + var_1_11) > last_1_var_1_36) ? ((((var_1_11 / var_1_12) / var_1_38) >= var_1_14) ? (var_1_36 == ((float) (max (var_1_38 , (min (var_1_14 , (32.2f - var_1_39))))))) : 1) : (var_1_36 == ((float) (abs (var_1_39))))) : ((((var_1_18 << var_1_17) / var_1_31) >= 64) ? (var_1_36 == ((float) var_1_38)) : 1))))) && (var_1_40 == ((signed char) (var_1_7 - (var_1_41 - (var_1_42 + var_1_43)))))) && ((last_1_var_1_44 < var_1_6) ? (var_1_22 ? (var_1_44 == ((signed char) (var_1_6 + var_1_42))) : (var_1_44 == ((signed char) (var_1_43 + -1)))) : ((((var_1_21 + var_1_47) - (var_1_48 - var_1_35)) < (var_1_20 - (var_1_49 - var_1_6))) ? ((5u < var_1_41) ? (var_1_44 == ((signed char) (var_1_43 - var_1_41))) : 1) : 1))) && (var_1_26 ? (var_1_25 ? (var_1_50 == ((unsigned short int) (var_1_51 - (max ((20363 - var_1_18) , var_1_52))))) : (var_1_50 == ((unsigned short int) (max ((min ((abs (var_1_31)) , var_1_16)) , var_1_28))))) : ((var_1_6 >= last_1_var_1_50) ? (var_1_50 == ((unsigned short int) (max (((min (var_1_42 , var_1_41)) + var_1_31) , var_1_30)))) : 1))) && ((var_1_25 && last_1_var_1_22) ? (var_1_52 == ((unsigned short int) ((max (var_1_43 , (min (var_1_18 , var_1_6)))) + (max (var_1_31 , (min (last_1_var_1_58 , 256))))))) : 1)) && (((var_1_30 >> (var_1_54 - var_1_55)) != var_1_52) ? (var_1_53 == ((unsigned char) ((var_1_41 - var_1_7) + (min (var_1_16 , var_1_55))))) : 1)) && (var_1_24 ? (var_1_56 == ((double) var_1_14)) : 1)) && ((var_1_55 <= var_1_47) ? (var_1_57 == ((signed long int) (32 - var_1_19))) : (var_1_57 == ((signed long int) (var_1_54 + (abs (var_1_28))))))) && ((var_1_54 < var_1_53) ? (var_1_58 == ((signed short int) 5)) : (var_1_58 == ((signed short int) var_1_43)))) && ((var_1_24 && var_1_26) ? ((((~ var_1_17) < -4) || (var_1_36 == (var_1_11 + var_1_36))) ? (var_1_59 == ((float) var_1_14)) : (var_1_59 == ((float) 2.25f))) : 1)
;
}
int main(void) {
	isInitial = 1;
