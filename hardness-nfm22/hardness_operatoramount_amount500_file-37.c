...
void step(void) {
	...
	var_1_78 = ((min (var_1_5 , var_1_57)) - (min (var_1_79 , (max (var_1_80 , var_1_81)))));
	...
	if (stepLocal_27 || (! var_1_100)) {
		if (! var_1_100) {
			var_1_104 = (min (var_1_57 , var_1_80));
		}
	} else {
		if (var_1_54) {
			var_1_104 = var_1_57;
	...
	if (var_1_100) {
		if (stepLocal_3 > last_1_var_1_18) {
			var_1_18 = (max ((max (var_1_103 , 8)) , var_1_5));
		} else {
			var_1_18 = ((var_1_20 - var_1_5) - var_1_4);
		}
	} else {
		var_1_18 = (max ((min (var_1_4 , var_1_103)) , var_1_20));
	}
	...
	signed long int stepLocal_4 = var_1_22 - (max (var_1_20 , var_1_4));
	...
	if (var_1_37 != ((var_1_29 * var_1_95) / (min (var_1_13 , 2.25f)))) {
	...
	if (! (var_1_4 < var_1_5)) {
		if (stepLocal_9 >= (min ((min (-10 , var_1_35)) , (var_1_40 * last_1_var_1_47)))) {
			if (var_1_52) {
	...
	signed long int stepLocal_23 = min (var_1_47 , var_1_76);
	if (var_1_32 > stepLocal_23) {
		var_1_84 = (var_1_92 + (min (var_1_5 , var_1_79)));
	} else {
		var_1_84 = (abs (var_1_41 - (var_1_45 - var_1_80)));
	}


	// From: Req1Batch37Amount500
	signed long int stepLocal_1 = max (var_1_5 , (max (var_1_73 , var_1_72)));
	signed long int stepLocal_0 = 500 * var_1_73;
	if (var_1_100) {
		if ((var_1_3 - (var_1_4 - var_1_5)) >= stepLocal_0) {
			var_1_1 = ((min ((min (var_1_4 , var_1_3)) , (var_1_5 - var_1_72))) + var_1_31);
		}
	} else {
		if (stepLocal_1 <= (~ (1 / -8))) {
	...
	if (var_1_55 && stepLocal_25) {
		if (var_1_49 <= stepLocal_26) {
			var_1_86 = (max ((var_1_29 - (var_1_26 + var_1_27)) , ((var_1_87 + 4.6) - var_1_28)));
		} else {
			var_1_86 = ((max (var_1_83 , var_1_17)) + var_1_87);
		}
	} else {
		var_1_86 = ((min ((var_1_88 + var_1_25) , var_1_83)) + (var_1_89 + var_1_90));
	}
	...
	if (stepLocal_15 != var_1_49) {
		if (var_1_68) {
			var_1_65 = (max ((var_1_64 + var_1_20) , (min (256 , var_1_63))));
		} else {
			if ((var_1_26 - (max (var_1_29 , var_1_27))) < var_1_28) {
				if (stepLocal_16 > (2 + var_1_14)) {
					var_1_65 = (min ((max (var_1_4 , var_1_5)) , var_1_78));
				} else {
					var_1_65 = 256;
				}
			} else {
	...
	if (var_1_68 || var_1_68) {
		var_1_66 = (min (var_1_28 , var_1_67));
	} else {
		if (var_1_17 >= (max (var_1_15 , var_1_30))) {
	...
	if (var_1_17 > (- var_1_27)) {
		if (var_1_38 < var_1_11) {
			if (stepLocal_13 >= (abs (var_1_101))) {
				var_1_59 = ((min (var_1_57 , var_1_5)) + var_1_4);
			}
		}
	}
	...
	if ((var_1_35 > (var_1_5 - var_1_4)) && (var_1_32 > var_1_34)) {
		var_1_39 = (min (var_1_5 , (min ((10000000u + var_1_14) , var_1_84))));
	} else {
	...
	if (var_1_68) {
		if (var_1_49 > ((- var_1_4) | (var_1_48 * var_1_61))) {
			if (var_1_48 >= last_1_var_1_69) {
				var_1_69 = (min (var_1_48 , ((min (var_1_92 , -10000)) + var_1_31)));
			} else {
				var_1_69 = ((min (var_1_62 , var_1_47)) - ((abs (-1227892636)) - 32));
			}
		}
	} else {
		if (((- var_1_64) * var_1_42) > (- 8u)) {
			var_1_69 = (max (var_1_64 , (max ((max (var_1_72 , 32)) , var_1_22))));
		} else {
	...
	if (var_1_22 > stepLocal_18) {
		var_1_70 = (abs (min (var_1_14 , var_1_20)));
	} else {
	...
	if ((var_1_3 + var_1_72) >= var_1_4) {
		if (var_1_61 > (min (var_1_45 , var_1_9))) {
			var_1_75 = (max (var_1_39 , var_1_5));
		} else {
			var_1_75 = ((max ((max (55230 , var_1_49)) , (var_1_76 + var_1_77))) - (min (var_1_64 , var_1_5)));
		}
	} else {
		if (var_1_53) {
			...
			if (! ((var_1_57 - var_1_5) < var_1_76)) {
				var_1_75 = (((abs (var_1_76)) + (24955 - var_1_5)) - (min (var_1_64 , var_1_4)));
			}
		}
	}
	...
	if (var_1_32 <= stepLocal_21) {
		if (stepLocal_22 <= var_1_96) {
			if (stepLocal_20 <= var_1_5) {
				var_1_82 = (max ((min (var_1_30 , var_1_67)) , ((var_1_25 + var_1_83) + (min (var_1_16 , var_1_27)))));
			} else {
				var_1_82 = (max (var_1_25 , var_1_16));
			}
		}
	}
	...
	if (! (var_1_1 > var_1_47)) {
		var_1_85 = (max ((max (var_1_76 , 32u)) , var_1_40));
	} else {
		if (last_1_var_1_85 > stepLocal_24) {
			var_1_85 = (max (var_1_80 , (min ((max (64u , var_1_49)) , var_1_50))));
		}
	}
	...
	if ((var_1_99 / 25) > var_1_59) {
		if ((max ((min (8 , var_1_71)) , var_1_81)) <= (var_1_20 - var_1_63)) {
			if (var_1_39 != (abs (500))) {
				var_1_91 = 64;
			}
		}
	...
	if (var_1_78 > stepLocal_8) {
		...
		if (stepLocal_7 || ((var_1_59 * var_1_22) != var_1_75)) {
			if (((min (16.375 , var_1_28)) - (var_1_38 - 1.000000075E7)) > var_1_94) {
...
int property() {
	return ((((((((((((((((((((((((((((((((((((((((((((var_1_100 ? (((var_1_3 - (var_1_4 - var_1_5)) >= (500 * var_1_73)) ? (var_1_1 == ((signed long int) ((min ((min (var_1_4 , var_1_3)) , (var_1_5 - var_1_72))) + var_1_31))) : 1) : (((max (var_1_5 , (max (var_1_73 , var_1_72)))) <= (~ (1 / -8))) ? (var_1_1 == ((signed long int) (var_1_72 - var_1_4))) : (var_1_1 == ((signed long int) var_1_5)))) && ((((var_1_10 - var_1_11) >= (var_1_102 / var_1_13)) || var_1_52) ? (var_1_9 == ((signed long int) ((var_1_14 - var_1_4) - var_1_5))) : (var_1_9 == ((signed long int) var_1_4)))) && (var_1_15 == ((double) (var_1_16 + (abs (var_1_17)))))) && (var_1_100 ? ((var_1_3 > last_1_var_1_18) ? (var_1_18 == ((signed short int) (max ((max (var_1_103 , 8)) , var_1_5)))) : (var_1_18 == ((signed short int) ((var_1_20 - var_1_5) - var_1_4)))) : (var_1_18 == ((signed short int) (max ((min (var_1_4 , var_1_103)) , var_1_20)))))) && ((var_1_3 > ((var_1_4 - var_1_5) * var_1_9)) ? (var_1_21 == ((unsigned short int) (max (var_1_5 , var_1_4)))) : (((var_1_22 - (max (var_1_20 , var_1_4))) > last_1_var_1_21) ? (var_1_21 == ((unsigned short int) var_1_20)) : 1))) && ((var_1_100 || var_1_100) ? (var_1_23 == ((double) (abs (abs (var_1_17))))) : (((- var_1_16) > var_1_11) ? (((~ 2) < var_1_70) ? (var_1_23 == ((double) ((var_1_25 + 32.5) + 7.75))) : 1) : (var_1_23 == ((double) ((max ((var_1_26 + var_1_27) , (var_1_28 - var_1_29))) - ((abs (var_1_30)) - 256.2))))))) && ((var_1_13 >= var_1_17) ? (var_1_31 == ((signed char) (min (var_1_32 , (var_1_5 + var_1_33))))) : ((var_1_52 && var_1_52) ? (var_1_31 == ((signed char) ((min (var_1_33 , (var_1_34 + var_1_35))) + 16))) : (var_1_31 == ((signed char) var_1_34))))) && ((var_1_78 > var_1_78) ? (var_1_36 == ((float) (max (var_1_28 , (var_1_29 - (var_1_37 - var_1_27)))))) : (((var_1_26 < var_1_37) || ((var_1_59 * var_1_22) != var_1_75)) ? ((((min (16.375 , var_1_28)) - (var_1_38 - 1.000000075E7)) > var_1_94) ? (var_1_36 == ((float) (var_1_25 + var_1_17))) : (var_1_36 == ((float) (max (((max (var_1_28 , var_1_37)) - var_1_27) , var_1_17))))) : (var_1_36 == ((float) (var_1_37 - var_1_28)))))) && (((var_1_35 > (var_1_5 - var_1_4)) && (var_1_32 > var_1_34)) ? (var_1_39 == ((unsigned long int) (min (var_1_5 , (min ((10000000u + var_1_14) , var_1_84)))))) : ((((var_1_96 & 16u) ^ var_1_65) > var_1_4) ? (((- var_1_29) != var_1_38) ? (var_1_39 == ((unsigned long int) (max (100000000u , var_1_22)))) : ((var_1_35 <= (abs (var_1_4))) ? (var_1_39 == ((unsigned long int) (var_1_40 - var_1_84))) : (var_1_39 == ((unsigned long int) ((max ((var_1_41 - var_1_22) , (3470546746u - var_1_20))) - (var_1_42 - (max (var_1_5 , var_1_4)))))))) : (var_1_39 == ((unsigned long int) var_1_20))))) && (var_1_68 ? ((var_1_52 && var_1_100) ? ((var_1_37 < var_1_38) ? (((var_1_10 * var_1_30) > (255.75 / (max (var_1_38 , var_1_37)))) ? (var_1_43 == ((signed long int) (var_1_14 - var_1_47))) : 1) : 1) : (var_1_43 == ((signed long int) (var_1_3 - var_1_4)))) : (var_1_43 == ((signed long int) (var_1_22 - (var_1_45 - var_1_4)))))) && ((var_1_37 != ((var_1_29 * var_1_95) / (min (var_1_13 , 2.25f)))) ? (var_1_46 == ((unsigned long int) (var_1_41 - var_1_92))) : (var_1_46 == ((unsigned long int) (max (var_1_40 , ((max (var_1_4 , var_1_42)) + var_1_14))))))) && ((! (var_1_4 < var_1_5)) ? ((var_1_99 >= (min ((min (-10 , var_1_35)) , (var_1_40 * last_1_var_1_47)))) ? (var_1_52 ? (var_1_47 == ((unsigned short int) (var_1_4 + (min (var_1_20 , var_1_5))))) : (var_1_47 == ((unsigned short int) var_1_5))) : 1) : 1)) && ((! (var_1_52 || (var_1_41 > var_1_59))) ? (var_1_48 == ((unsigned short int) (((max (var_1_49 , var_1_50)) - var_1_5) - 8))) : (((last_1_var_1_48 != var_1_20) && ((var_1_40 & var_1_41) >= (var_1_49 % var_1_51))) ? (var_1_48 == ((unsigned short int) (min ((max (var_1_50 , var_1_5)) , (max (var_1_4 , var_1_20)))))) : (var_1_52 ? ((-4 < last_1_var_1_48) ? (var_1_48 == ((unsigned short int) (var_1_49 - var_1_20))) : 1) : (var_1_48 == ((unsigned short int) (8 + var_1_20))))))) && (last_1_var_1_68 ? (var_1_52 == ((unsigned char) (var_1_53 || var_1_54))) : ((! (var_1_45 > (~ last_1_var_1_97))) ? (var_1_52 == ((unsigned char) (last_1_var_1_100 || var_1_55))) : ((last_1_var_1_48 < (last_1_var_1_46 >> var_1_57)) ? (((var_1_13 * (var_1_28 / 1.0000000000002E12)) >= var_1_27) ? (var_1_52 == ((unsigned char) (! (! (! var_1_55))))) : (var_1_52 == ((unsigned char) (var_1_55 && var_1_58)))) : (var_1_52 == ((unsigned char) ((last_1_var_1_59 > last_1_var_1_18) || (var_1_58 && (var_1_54 || var_1_55))))))))) && ((var_1_17 > (- var_1_27)) ? ((var_1_38 < var_1_11) ? ((var_1_101 >= (abs (var_1_101))) ? (var_1_59 == ((unsigned char) ((min (var_1_57 , var_1_5)) + var_1_4))) : 1) : 1) : 1)) && (var_1_55 ? ((var_1_20 > var_1_57) ? (var_1_61 == ((unsigned short int) var_1_57)) : (var_1_61 == ((unsigned short int) (abs (var_1_49))))) : 1)) && ((var_1_41 >= (- 32u)) ? (((var_1_49 < var_1_65) && var_1_68) ? (var_1_62 == ((unsigned short int) (var_1_20 + ((var_1_63 + var_1_64) - var_1_43)))) : (var_1_62 == ((unsigned short int) ((var_1_49 - (var_1_64 - var_1_43)) - var_1_20)))) : 1)) && ((var_1_71 != var_1_49) ? (var_1_68 ? (var_1_65 == ((unsigned short int) (max ((var_1_64 + var_1_20) , (min (256 , var_1_63)))))) : (((var_1_26 - (max (var_1_29 , var_1_27))) < var_1_28) ? (((-8 / var_1_49) > (2 + var_1_14)) ? (var_1_65 == ((unsigned short int) (min ((max (var_1_4 , var_1_5)) , var_1_78)))) : (var_1_65 == ((unsigned short int) 256))) : (var_1_65 == ((unsigned short int) (abs (10)))))) : 1)) && ((var_1_68 || var_1_68) ? (var_1_66 == ((float) (min (var_1_28 , var_1_67)))) : ((var_1_17 >= (max (var_1_15 , var_1_30))) ? (var_1_66 == ((float) (var_1_26 + var_1_16))) : 1))) && (((~ 1) >= (var_1_84 + (var_1_3 * -128))) ? (var_1_68 == ((unsigned char) ((var_1_84 < var_1_20) || var_1_55))) : (var_1_68 == ((unsigned char) ((var_1_100 || var_1_58) && var_1_55))))) && (var_1_68 ? ((var_1_49 > ((- var_1_4) | (var_1_48 * var_1_61))) ? ((var_1_48 >= last_1_var_1_69) ? (var_1_69 == ((signed long int) (min (var_1_48 , ((min (var_1_92 , -10000)) + var_1_31))))) : (var_1_69 == ((signed long int) ((min (var_1_62 , var_1_47)) - ((abs (-1227892636)) - 32))))) : 1) : ((((- var_1_64) * var_1_42) > (- 8u)) ? (var_1_69 == ((signed long int) (max (var_1_64 , (max ((max (var_1_72 , 32)) , var_1_22)))))) : (var_1_69 == ((signed long int) (var_1_3 - var_1_57)))))) && ((var_1_22 > 1) ? (var_1_70 == ((unsigned long int) (abs (min (var_1_14 , var_1_20))))) : (var_1_70 == ((unsigned long int) (var_1_104 + (var_1_59 + (var_1_84 + var_1_50))))))) && (var_1_71 == ((unsigned long int) var_1_46))) && ((var_1_73 >= var_1_71) ? (var_1_72 == ((unsigned short int) (var_1_50 - var_1_73))) : 1)) && (var_1_73 == ((signed char) (var_1_34 + var_1_33)))) && ((var_1_57 >= (- var_1_20)) ? (var_1_74 == ((unsigned short int) var_1_5)) : (var_1_74 == ((unsigned short int) 5)))) && (((var_1_3 + var_1_72) >= var_1_4) ? ((var_1_61 > (min (var_1_45 , var_1_9))) ? (var_1_75 == ((unsigned short int) (max (var_1_39 , var_1_5)))) : (var_1_75 == ((unsigned short int) ((max ((max (55230 , var_1_49)) , (var_1_76 + var_1_77))) - (min (var_1_64 , var_1_5)))))) : (var_1_53 ? ((var_1_16 < (var_1_95 * (- var_1_28))) ? (var_1_75 == ((unsigned short int) (var_1_39 + (var_1_5 + 4)))) : (var_1_75 == ((unsigned short int) (16 + var_1_39)))) : ((! ((var_1_57 - var_1_5) < var_1_76)) ? (var_1_75 == ((unsigned short int) (((abs (var_1_76)) + (24955 - var_1_5)) - (min (var_1_64 , var_1_4))))) : 1)))) && (var_1_78 == ((signed char) ((min (var_1_5 , var_1_57)) - (min (var_1_79 , (max (var_1_80 , var_1_81)))))))) && ((var_1_32 <= var_1_48) ? ((((- 32) / var_1_51) <= var_1_96) ? ((var_1_20 <= var_1_5) ? (var_1_82 == ((float) (max ((min (var_1_30 , var_1_67)) , ((var_1_25 + var_1_83) + (min (var_1_16 , var_1_27))))))) : (var_1_82 == ((float) (max (var_1_25 , var_1_16))))) : 1) : 1)) && ((var_1_32 > (min (var_1_47 , var_1_76))) ? (var_1_84 == ((unsigned long int) (var_1_92 + (min (var_1_5 , var_1_79))))) : (var_1_84 == ((unsigned long int) (abs (var_1_41 - (var_1_45 - var_1_80))))))) && ((! (var_1_1 > var_1_47)) ? (var_1_85 == ((unsigned long int) (max ((max (var_1_76 , 32u)) , var_1_40)))) : ((last_1_var_1_85 > var_1_62) ? (var_1_85 == ((unsigned long int) (max (var_1_80 , (min ((max (64u , var_1_49)) , var_1_50)))))) : 1))) && ((var_1_55 && (var_1_78 >= -4)) ? ((var_1_49 <= var_1_47) ? (var_1_86 == ((double) (max ((var_1_29 - (var_1_26 + var_1_27)) , ((var_1_87 + 4.6) - var_1_28))))) : (var_1_86 == ((double) ((max (var_1_83 , var_1_17)) + var_1_87)))) : (var_1_86 == ((double) ((min ((var_1_88 + var_1_25) , var_1_83)) + (var_1_89 + var_1_90)))))) && (((var_1_99 / 25) > var_1_59) ? (((max ((min (8 , var_1_71)) , var_1_81)) <= (var_1_20 - var_1_63)) ? ((var_1_39 != (abs (500))) ? (var_1_91 == ((signed short int) 64)) : 1) : 1) : (var_1_91 == ((signed short int) var_1_64)))) && (var_1_53 ? (var_1_92 == ((unsigned long int) var_1_14)) : (var_1_92 == ((unsigned long int) var_1_61)))) && (var_1_58 ? (var_1_94 == ((double) var_1_67)) : (var_1_94 == ((double) var_1_37)))) && (var_1_95 == ((double) var_1_29))) && (var_1_96 == ((signed long int) -4))) && (var_1_97 == ((signed char) 2))) && (var_1_52 ? (var_1_98 == ((double) var_1_30)) : (var_1_98 == ((double) var_1_88)))) && (var_1_100 ? (var_1_99 == ((signed char) var_1_80)) : (var_1_99 == ((signed char) var_1_33)))) && (var_1_100 == ((unsigned char) var_1_53))) && (var_1_55 ? (var_1_101 == ((unsigned long int) var_1_41)) : (var_1_101 == ((unsigned long int) var_1_43)))) && (var_1_52 ? (var_1_102 == ((float) var_1_25)) : 1)) && (var_1_52 ? (var_1_103 == ((unsigned char) var_1_57)) : (var_1_103 == ((unsigned char) var_1_81)))) && ((var_1_55 || (! var_1_100)) ? ((! var_1_100) ? (var_1_104 == ((unsigned char) (min (var_1_57 , var_1_80)))) : 1) : (var_1_54 ? (var_1_104 == ((unsigned char) var_1_57)) : (var_1_104 == ((unsigned char) var_1_4))))
;
}
int main(void) {
	isInitial = 1;
