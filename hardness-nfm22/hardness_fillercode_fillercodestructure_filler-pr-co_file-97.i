...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch97Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (((((var_1_8) < (var_1_17)) ? (var_1_8) : (var_1_17))) >= var_1_20) {
  var_1_37 = var_1_15;
 }
 var_1_20 = var_1_8;
 var_1_22 = var_1_23;
 if ((var_1_15 / var_1_30) < var_1_27) {
  var_1_29 = var_1_30;
 } else {
  var_1_29 = ((((((((((((var_1_30) < (var_1_8)) ? (var_1_30) : (var_1_8)))) > (var_1_8)) ? (((((var_1_30) < (var_1_8)) ? (var_1_30) : (var_1_8)))) : (var_1_8)))) > ((var_1_33 - var_1_8))) ? (((((((((var_1_30) < (var_1_8)) ? (var_1_30) : (var_1_8)))) > (var_1_8)) ? (((((var_1_30) < (var_1_8)) ? (var_1_30) : (var_1_8)))) : (var_1_8)))) : ((var_1_33 - var_1_8))));
 }
 if ((var_1_39 * (var_1_40 - var_1_41)) >= var_1_42) {
  if ((~ var_1_36) <= (((((((var_1_8) < (var_1_20)) ? (var_1_8) : (var_1_20))) < 0 ) ? -((((var_1_8) < (var_1_20)) ? (var_1_8) : (var_1_20))) : ((((var_1_8) < (var_1_20)) ? (var_1_8) : (var_1_20)))))) {
   var_1_38 = var_1_36;
  } else {
   var_1_38 = var_1_36;
  }
 ...
 if (var_1_22) {
  if (var_1_27 <= var_1_15) {
   var_1_24 = (((((var_1_27) > (((((-128) < (var_1_15)) ? (-128) : (var_1_15))))) ? (var_1_27) : (((((-128) < (var_1_15)) ? (-128) : (var_1_15)))))) + var_1_8);
  }
 } else {
  var_1_24 = ((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15)));
 }
 if (var_1_22) {
  var_1_35 = var_1_36;
 }
 ...
 if (((((var_1_39) > (64.75f)) ? (var_1_39) : (64.75f))) <= var_1_40) {
  if ((var_1_8 & var_1_8) > var_1_15) {
   if (var_1_1 <= (((((var_1_17) < (var_1_8)) ? (var_1_17) : (var_1_8))) ^ (128 - 16))) {
