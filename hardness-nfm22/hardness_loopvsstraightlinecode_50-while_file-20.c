...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch2050_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch2050_while
	var_1_15 = (var_1_14 + var_1_16);


	// From: Req6Batch2050_while
	if (var_1_2) {
