...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch5PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch5PS_CN_10
	var_1_21 = var_1_10;


	// From: Req6Batch5PS_CN_10
