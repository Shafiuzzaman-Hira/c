...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch14dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch14dependencies
	var_1_1 = (var_1_15 + var_1_15);


	// From: Req8Batch14dependencies
	var_1_28 = var_1_17;


	// From: Req7Batch14dependencies
	...
	// From: Req5Batch14dependencies
	if ((var_1_15 % var_1_20) != var_1_1) {
