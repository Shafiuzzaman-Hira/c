...
void step(void) {
	...
	// From: Req4Batch65no_floats
	var_1_16 = var_1_17;


	// From: Req5Batch65no_floats
	var_1_18 = var_1_19;


	// From: Req6Batch65no_floats
	var_1_20 = var_1_19;


	// From: Req3Batch65no_floats
	if (var_1_3) {
...
int property() {
	return ((((((0.625f > last_1_var_1_9) ? (var_1_3 ? (var_1_1 == ((signed long int) (abs (var_1_4)))) : 1) : (var_1_1 == ((signed long int) (abs (var_1_4))))) && ((var_1_4 > var_1_9) ? (var_1_5 == ((signed long int) ((max (var_1_20 , -64)) + ((var_1_20 + -2) + var_1_18)))) : 1)) && (var_1_3 ? ((var_1_20 >= ((var_1_18 - var_1_20) * 64)) ? (var_1_9 == ((signed long int) ((min (var_1_12 , 50.5)) - var_1_13))) : 1) : ((var_1_1 <= var_1_1) ? (var_1_9 == ((signed long int) (var_1_13 - (var_1_14 - var_1_15)))) : 1))) && (var_1_16 == ((signed char) var_1_17))) && (var_1_18 == ((unsigned short int) var_1_19))) && (var_1_20 == ((unsigned short int) var_1_19))
;
}
int main(void) {
	isInitial = 1;
