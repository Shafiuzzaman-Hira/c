...
void step(void) {
	// From: CodeObject1
	if (var_1_28 < (var_1_29 - (abs (var_1_30)))) {
		if (var_1_31) {
			var_1_27 = var_1_32;
		}
	}
	...
	// From: CodeObject3
	if (var_1_31) {
		var_1_35 = (max (var_1_32 , var_1_27));
	} else {
		if (var_1_36) {
			if (-8 < var_1_32) {
				var_1_35 = (abs (var_1_37 - var_1_27));
			}
		}
	}
	...
	// From: CodeObject5
	if ((abs (var_1_43)) < (var_1_29 - (1911058301 - var_1_27))) {
		if (var_1_39) {
			var_1_42 = (var_1_44 + (abs (var_1_45)));
		}
	} else {
		var_1_42 = (abs (abs (var_1_44)));
	}
	...
	if (var_1_41) {
		if (var_1_38) {
			if (var_1_31) {
				var_1_46 = (abs (abs (min (var_1_37 , var_1_42))));
			}
		} else {
			var_1_46 = (abs (var_1_37));
		}
	}
	...
	// From: CodeObject9
	if ((max (63.125 , (- var_1_34))) <= var_1_50) {
		var_1_53 = ((! 0) && var_1_40);
	} else {
		if (((var_1_27 % var_1_54) / (abs (-16))) == -4) {
			if (var_1_38) {
				var_1_53 = var_1_41;
			} else {
	...
	// From: CodeObject10
	if (var_1_54 > 10) {
		var_1_57 = (min (var_1_52 , (99999.4 + 32.625)));
	} else {
		if (var_1_27 >= 0) {
			if (! var_1_59) {
				var_1_57 = var_1_52;
	...
	// From: Req4Batch26PS_CN_100
	if (var_1_11 > (var_1_22 * (var_1_12 + var_1_22))) {
		var_1_20 = var_1_21;
	}


	// From: Req6Batch26PS_CN_100
