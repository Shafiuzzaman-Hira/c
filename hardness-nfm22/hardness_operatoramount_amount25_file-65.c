...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch65Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch65Amount25
	if (var_1_3) {
		var_1_5 = ((10 + var_1_6) - 2);
	}


	// From: Req3Batch65Amount25
