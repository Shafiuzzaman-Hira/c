...
void step(void) {
 ...
 if (var_1_36 && ((var_1_42 & var_1_45) >= var_1_33)) {
  if ((var_1_46 >> var_1_34) <= (((((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37))) < 0 ) ? -((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37))) : ((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37)))))) {
   var_1_49 = (var_1_44 || var_1_43);
  }
 }
 if (var_1_47) {
  if (var_1_36) {
   var_1_50 = ((((((((var_1_32) < (var_1_39)) ? (var_1_32) : (var_1_39)))) > (var_1_37)) ? (((((var_1_32) < (var_1_39)) ? (var_1_32) : (var_1_39)))) : (var_1_37)));
  }
 }
 if ((var_1_52 & var_1_46) < var_1_32) {
  if (! (((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))) >= var_1_34)) {
   var_1_51 = (var_1_53 - ((((var_1_54 + var_1_55) < 0 ) ? -(var_1_54 + var_1_55) : (var_1_54 + var_1_55))));
  } else {
   var_1_51 = ((8.9814221722709166E18 - var_1_56) - (((((var_1_57) < (var_1_58)) ? (var_1_57) : (var_1_58))) + var_1_59));
  }
 } else {
 ...
 if ((var_1_37 | var_1_50) > 16u) {
  if ((31.125 - ((((var_1_59) > (var_1_56)) ? (var_1_59) : (var_1_56)))) <= (var_1_58 - var_1_57)) {
   var_1_61 = (! var_1_44);
  }
 } else {
