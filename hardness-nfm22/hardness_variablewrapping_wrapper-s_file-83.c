...
void step(void) {
	// From: Req4Batch83Wrapper_S
	WrapperStruct00.var_1_14 = 200;


	// From: Req5Batch83Wrapper_S
	WrapperStruct00.var_1_15 = WrapperStruct00.var_1_16;


	// From: Req6Batch83Wrapper_S
	WrapperStruct00.var_1_17 = WrapperStruct00.var_1_10;


	// From: Req1Batch83Wrapper_S
	signed long int stepLocal_0 = WrapperStruct00.var_1_3 / WrapperStruct00.var_1_4;
	if (WrapperStruct00.var_1_2) {
		WrapperStruct00.var_1_1 = (abs (abs (WrapperStruct00.var_1_3)));
	} else {
		if (stepLocal_0 >= (min ((last_1_WrapperStruct00_var_1_1 * WrapperStruct00.var_1_15) , (~ last_1_WrapperStruct00_var_1_1)))) {
	...
	if (WrapperStruct00.var_1_15 <= stepLocal_2) {
		if (WrapperStruct00.var_1_1 == stepLocal_1) {
			WrapperStruct00.var_1_8 = ((abs (WrapperStruct00.var_1_10)) + WrapperStruct00.var_1_11);
		} else {
	...
	// From: Req3Batch83Wrapper_S
	if (WrapperStruct00.var_1_15 > WrapperStruct00.var_1_15) {
		WrapperStruct00.var_1_12 = (min (WrapperStruct00.var_1_11 , WrapperStruct00.var_1_10));
	}
}
