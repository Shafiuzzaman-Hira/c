...
void step(void) {
	...
	// From: CodeObject6
	if ((abs (var_1_22)) > (~ (var_1_30 % var_1_31))) {
		if (var_1_28 >= 2) {
	...
	// From: Req2Batch86Filler_PS_CO
	if (var_1_19) {
		var_1_6 = (last_1_var_1_6 || var_1_9);
	}


	// From: Req4Batch86Filler_PS_CO
	...
	// From: Req7Batch86Filler_PS_CO
	var_1_22 = var_1_15;


	// From: Req5Batch86Filler_PS_CO
