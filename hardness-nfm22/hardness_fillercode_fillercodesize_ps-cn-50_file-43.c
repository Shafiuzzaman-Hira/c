...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch43PS_CN_50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch43PS_CN_50
	if (var_1_13) {
		var_1_12 = (var_1_14 - var_1_15);
	}


	// From: Req5Batch43PS_CN_50
