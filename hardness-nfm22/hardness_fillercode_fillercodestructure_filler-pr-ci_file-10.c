...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch10Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject6
	if (var_1_1 >= ((~ 128u) % (min (var_1_4 , var_1_16)))) {
		if (var_1_8) {
			var_1_38 = (max ((64 + var_1_37) , var_1_5));
		} else {
			if ((max ((var_1_36 | var_1_5) , (var_1_30 & var_1_5))) < var_1_5) {
				var_1_38 = (max (var_1_37 , var_1_5));
			} else {
				var_1_38 = var_1_5;
			}
		}
