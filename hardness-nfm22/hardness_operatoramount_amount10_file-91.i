...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch91Amount10.c", 13, "reach_error"); }
...
int property() {
 return (((var_1_1 == ((unsigned long int) ((((var_1_2) > ((var_1_3 - var_1_4))) ? (var_1_2) : ((var_1_3 - var_1_4)))))) && ((var_1_2 > var_1_1) ? (var_1_5 == ((signed short int) (8 - var_1_6))) : (var_1_5 == ((signed short int) var_1_7)))) && (var_1_8 == ((signed short int) var_1_6))) && (var_1_9 == ((signed short int) var_1_7))
;
}
int main(void) {
 isInitial = 1;
