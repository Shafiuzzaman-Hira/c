...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch42Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
 if (var_1_11 || var_1_8) {
  var_1_21 = ((var_1_7 > -4) || var_1_11);
 }
 if (((var_1_1 + 25) % var_1_7) < 2) {
  var_1_26 = (((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15))) + var_1_15);
 }
 if ((- var_1_15) < ((((var_1_14) > (var_1_16)) ? (var_1_14) : (var_1_16)))) {
  var_1_30 = var_1_16;
 }
 if (((((((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)))) < (var_1_5)) ? (((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)))) : (var_1_5))) <= var_1_1) {
  var_1_31 = var_1_7;
 }
 if (var_1_6 < ((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13)))) {
  var_1_34 = ((((((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6)))) > (var_1_7)) ? (((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6)))) : (var_1_7)));
 }
 if (var_1_11) {
  var_1_35 = var_1_7;
 }
