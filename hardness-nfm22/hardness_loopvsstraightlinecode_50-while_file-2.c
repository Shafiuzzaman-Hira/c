...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch250_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch250_while
	if ((var_1_15 - (min (0 , var_1_16))) > last_1_var_1_6) {
		var_1_14 = var_1_12;
	}


	// From: Req3Batch250_while
	...
	// From: Req7Batch250_while
	var_1_20 = var_1_16;


	// From: Req8Batch250_while
	var_1_21 = var_1_16;


	// From: Req5Batch250_while
