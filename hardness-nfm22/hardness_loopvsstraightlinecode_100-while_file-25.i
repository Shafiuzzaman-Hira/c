...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch25100_while.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_5 && stepLocal_2) {
  var_1_4 = ((((last_1_var_1_24) < (-100)) ? (last_1_var_1_24) : (-100)));
 } else {
  if ((var_1_7 - var_1_8) > last_1_var_1_16) {
   var_1_4 = ((((((last_1_var_1_30 - last_1_var_1_24) + var_1_10)) > ((((((var_1_11 - var_1_12)) > (4)) ? ((var_1_11 - var_1_12)) : (4))))) ? (((last_1_var_1_30 - last_1_var_1_24) + var_1_10)) : ((((((var_1_11 - var_1_12)) > (4)) ? ((var_1_11 - var_1_12)) : (4))))));
  } else {
   var_1_4 = (last_1_var_1_30 + ((((var_1_10) > (last_1_var_1_24)) ? (var_1_10) : (last_1_var_1_24))));
  }
 }
 ...
 if ((last_1_var_1_28 + (- var_1_10)) > stepLocal_7) {
  var_1_28 = (((((var_1_11) < (var_1_12)) ? (var_1_11) : (var_1_12))) - var_1_26);
 }
 ...
 if (var_1_26 <= stepLocal_3) {
  if ((var_1_26 / (var_1_20 - 25)) >= stepLocal_4) {
   var_1_19 = (((((15.25 - var_1_21) < 0 ) ? -(15.25 - var_1_21) : (15.25 - var_1_21))) - (var_1_22 + var_1_23));
  } else {
   var_1_19 = var_1_22;
  }
 } else {
 ...
 if (var_1_6) {
  ...
  var_1_14 = (((((var_1_4) > (var_1_12)) ? (var_1_4) : (var_1_12))) - (last_1_var_1_14 + var_1_26));
 }
 ...
 unsigned long int stepLocal_9 = var_1_20 - ((((var_1_29) > (var_1_12)) ? (var_1_29) : (var_1_12)));
 unsigned char stepLocal_8 = var_1_6;
 if (stepLocal_8 || var_1_5) {
  if (stepLocal_9 >= var_1_11) {
   var_1_30 = var_1_29;
  } else {
   var_1_30 = (((((var_1_20) > (var_1_4)) ? (var_1_20) : (var_1_4))) + ((1000000000u + var_1_31) - var_1_29));
  }
 } else {
  var_1_30 = ((((var_1_26) > (var_1_29)) ? (var_1_26) : (var_1_29)));
 }
}
