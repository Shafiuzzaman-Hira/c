...
void step(void) {
	// From: Req17Batch11Amount250
	unsigned char stepLocal_9 = var_1_28;
	signed long int stepLocal_8 = last_1_var_1_26;
	if (stepLocal_8 == var_1_27) {
		var_1_56 = (max ((last_1_var_1_14 + (max (last_1_var_1_30 , last_1_var_1_26))) , (2204735768u - last_1_var_1_37)));
	} else {
		if (! (var_1_55 > (max (last_1_var_1_32 , var_1_49)))) {
			if (stepLocal_9 >= last_1_var_1_26) {
				var_1_56 = (var_1_43 - (abs (var_1_28 + var_1_35)));
			} else {
				var_1_56 = (max (last_1_var_1_56 , 256u));
			}
		}
	}


	// From: Req15Batch11Amount250
	...
	// From: Req5Batch11Amount250
	unsigned short int stepLocal_2 = var_1_10;
	if (stepLocal_2 <= (34429 - var_1_17)) {
		var_1_26 = var_1_27;
	} else {
		var_1_26 = (min (var_1_27 , (var_1_28 - 10)));
	}


	// From: Req9Batch11Amount250
	if (var_1_7 < var_1_23) {
		var_1_33 = (max ((var_1_31 - 5) , var_1_26));
	} else {
		var_1_33 = var_1_26;
	}


	// From: Req16Batch11Amount250
	var_1_54 = (var_1_55 - (abs (var_1_24)));


	// From: Req18Batch11Amount250
	...
	// From: Req21Batch11Amount250
	if (var_1_48) {
		if (var_1_51) {
			if (var_1_52) {
				var_1_60 = (abs (var_1_26));
			} else {
				var_1_60 = (max (var_1_26 , var_1_31));
			}
		} else {
	...
	// From: Req22Batch11Amount250
	var_1_61 = (var_1_27 + var_1_26);


	// From: Req23Batch11Amount250
	unsigned short int stepLocal_11 = var_1_35;
	if (stepLocal_11 >= (var_1_26 + var_1_26)) {
		var_1_62 = var_1_26;
	} else {
		var_1_62 = (max ((var_1_26 + var_1_26) , var_1_26));
	}


	// From: Req25Batch11Amount250
	unsigned short int stepLocal_13 = var_1_33;
	if (var_1_26 <= stepLocal_13) {
		var_1_66 = (var_1_55 - (abs (var_1_41)));
	} else {
		var_1_66 = (abs (abs (var_1_24)));
	}


	// From: Req26Batch11Amount250
	var_1_67 = var_1_44;


	// From: Req27Batch11Amount250
	var_1_68 = var_1_65;


	// From: Req29Batch11Amount250
	var_1_70 = var_1_36;


	// From: Req1Batch11Amount250
	...
	// From: Req11Batch11Amount250
	unsigned char stepLocal_4 = var_1_48 || var_1_48;
	if (var_1_48) {
		if (var_1_11 == var_1_1) {
			var_1_37 = ((var_1_27 + var_1_61) + (max (var_1_56 , var_1_56)));
		} else {
	...
	if (stepLocal_1 && (var_1_48 || var_1_48)) {
		...
		var_1_14 = ((min (var_1_26 , (var_1_26 + var_1_26))) + (max (var_1_26 , var_1_26)));
	}


	// From: Req10Batch11Amount250
	...
	// From: Req6Batch11Amount250
	if (var_1_33 > var_1_61) {
		var_1_29 = (var_1_24 + (abs (var_1_23)));
	}


	// From: Req8Batch11Amount250
	if ((abs (var_1_26)) >= ((1616384703 - var_1_62) - (min (var_1_26 , var_1_31)))) {
		var_1_32 = (max (var_1_8 , (abs (var_1_24))));
	}


	// From: Req12Batch11Amount250
	if (var_1_57 >= var_1_26) {
		var_1_40 = (((31.8f + 2.2f) + var_1_41) + 50.3f);
	}


	// From: Req13Batch11Amount250
	signed long int stepLocal_6 = var_1_28 / var_1_6;
	unsigned short int stepLocal_5 = var_1_33;
	if (var_1_8 < var_1_25) {
		if (stepLocal_6 == (64 - var_1_31)) {
			var_1_42 = (min (var_1_34 , (max ((var_1_43 - var_1_26) , var_1_31))));
		} else {
			var_1_42 = (((var_1_44 + var_1_45) - (min (last_1_var_1_42 , var_1_26))) + ((abs (var_1_46)) - 16u));
		}
	} else {
		if (((min (var_1_26 , var_1_27)) * var_1_46) > stepLocal_5) {
			var_1_42 = var_1_28;
		} else {
	...
	if (! var_1_48) {
		...
		var_1_63 = (min (((var_1_64 - 255.5f) - var_1_55) , (min ((25.5f - var_1_65) , var_1_25))));
	}


	// From: Req19Batch11Amount250
	if (var_1_50 <= var_1_49) {
		var_1_58 = ((min (var_1_61 , var_1_34)) + (min (var_1_26 , var_1_56)));
	}


	// From: Req20Batch11Amount250
	var_1_59 = ((last_1_var_1_59 + (abs (var_1_34))) + (min ((abs (var_1_69)) , var_1_62)));


	// From: Req14Batch11Amount250
	if (var_1_66 >= var_1_24) {
		var_1_47 = (2u + var_1_26);
	} else {
		var_1_47 = ((min (var_1_26 , (var_1_46 - var_1_58))) + (min (var_1_26 , var_1_45)));
	}


	// From: Req7Batch11Amount250
...
int property() {
	return ((((((((((((((((((((((((((((((((var_1_33 + var_1_56) | var_1_56) < (var_1_6 & 10000)) ? (var_1_1 == ((double) var_1_7)) : (var_1_1 == ((double) (max (var_1_7 , var_1_8))))) && ((var_1_26 > var_1_37) ? ((var_1_66 < var_1_7) ? (var_1_9 == ((unsigned short int) var_1_26)) : 1) : ((var_1_7 == ((- var_1_66) / var_1_11)) ? (((var_1_26 / var_1_6) == var_1_30) ? (((abs (- var_1_6)) <= -200) ? (var_1_9 == ((unsigned short int) var_1_26)) : (var_1_9 == ((unsigned short int) var_1_26))) : (var_1_9 == ((unsigned short int) var_1_26))) : 1))) && ((var_1_48 && (var_1_48 || var_1_48)) ? (var_1_48 ? (var_1_14 == ((unsigned short int) var_1_26)) : 1) : (var_1_14 == ((unsigned short int) ((min (var_1_26 , (var_1_26 + var_1_26))) + (max (var_1_26 , var_1_26))))))) && ((var_1_11 < (var_1_7 * var_1_1)) ? (var_1_22 == ((double) (var_1_23 + var_1_24))) : (var_1_22 == ((double) (max (var_1_25 , var_1_24)))))) && ((var_1_10 <= (34429 - var_1_17)) ? (var_1_26 == ((unsigned char) var_1_27)) : (var_1_26 == ((unsigned char) (min (var_1_27 , (var_1_28 - 10))))))) && ((var_1_33 > var_1_61) ? (var_1_29 == ((double) (var_1_24 + (abs (var_1_23))))) : 1)) && ((10 != ((var_1_58 - var_1_58) >> var_1_26)) ? (var_1_30 == ((unsigned short int) (var_1_31 - var_1_26))) : (var_1_30 == ((unsigned short int) (var_1_26 + var_1_26))))) && (((abs (var_1_26)) >= ((1616384703 - var_1_62) - (min (var_1_26 , var_1_31)))) ? (var_1_32 == ((double) (max (var_1_8 , (abs (var_1_24)))))) : 1)) && ((var_1_7 < var_1_23) ? (var_1_33 == ((unsigned short int) (max ((var_1_31 - 5) , var_1_26)))) : (var_1_33 == ((unsigned short int) var_1_26)))) && ((var_1_14 > var_1_26) ? (((var_1_31 / (var_1_28 + var_1_35)) < (var_1_26 * last_1_var_1_34)) ? (var_1_48 ? (var_1_34 == ((signed char) var_1_36)) : (var_1_34 == ((signed char) var_1_36))) : 1) : 1)) && (var_1_48 ? ((var_1_11 == var_1_1) ? (var_1_37 == ((signed short int) ((var_1_27 + var_1_61) + (max (var_1_56 , var_1_56))))) : (((var_1_48 || var_1_48) || var_1_48) ? (var_1_37 == ((signed short int) var_1_26)) : (var_1_37 == ((signed short int) var_1_26)))) : 1)) && ((var_1_57 >= var_1_26) ? (var_1_40 == ((float) (((31.8f + 2.2f) + var_1_41) + 50.3f))) : 1)) && ((var_1_8 < var_1_25) ? (((var_1_28 / var_1_6) == (64 - var_1_31)) ? (var_1_42 == ((unsigned long int) (min (var_1_34 , (max ((var_1_43 - var_1_26) , var_1_31)))))) : (var_1_42 == ((unsigned long int) (((var_1_44 + var_1_45) - (min (last_1_var_1_42 , var_1_26))) + ((abs (var_1_46)) - 16u))))) : ((((min (var_1_26 , var_1_27)) * var_1_46) > var_1_33) ? (var_1_42 == ((unsigned long int) var_1_28)) : (var_1_42 == ((unsigned long int) (var_1_43 - (last_1_var_1_42 + var_1_26))))))) && ((var_1_66 >= var_1_24) ? (var_1_47 == ((unsigned long int) (2u + var_1_26))) : (var_1_47 == ((unsigned long int) ((min (var_1_26 , (var_1_46 - var_1_58))) + (min (var_1_26 , var_1_45))))))) && ((64 <= ((500 << last_1_var_1_67) * last_1_var_1_59)) ? (((var_1_49 - var_1_50) >= last_1_var_1_1) ? (var_1_48 == ((unsigned char) (! (var_1_51 && var_1_52)))) : (var_1_48 == ((unsigned char) ((var_1_7 >= last_1_var_1_32) && var_1_53)))) : (var_1_48 == ((unsigned char) var_1_52)))) && (var_1_54 == ((float) (var_1_55 - (abs (var_1_24)))))) && ((last_1_var_1_26 == var_1_27) ? (var_1_56 == ((unsigned long int) (max ((last_1_var_1_14 + (max (last_1_var_1_30 , last_1_var_1_26))) , (2204735768u - last_1_var_1_37))))) : ((! (var_1_55 > (max (last_1_var_1_32 , var_1_49)))) ? ((var_1_28 >= last_1_var_1_26) ? (var_1_56 == ((unsigned long int) (var_1_43 - (abs (var_1_28 + var_1_35))))) : (var_1_56 == ((unsigned long int) (max (last_1_var_1_56 , 256u))))) : 1))) && (((1.875f <= var_1_11) || (var_1_24 >= var_1_25)) ? (var_1_57 == ((unsigned long int) var_1_28)) : 1)) && ((var_1_50 <= var_1_49) ? (var_1_58 == ((signed short int) ((min (var_1_61 , var_1_34)) + (min (var_1_26 , var_1_56))))) : 1)) && (var_1_59 == ((signed long int) ((last_1_var_1_59 + (abs (var_1_34))) + (min ((abs (var_1_69)) , var_1_62)))))) && (var_1_48 ? (var_1_51 ? (var_1_52 ? (var_1_60 == ((unsigned short int) (abs (var_1_26)))) : (var_1_60 == ((unsigned short int) (max (var_1_26 , var_1_31))))) : (var_1_60 == ((unsigned short int) (var_1_35 + var_1_26)))) : (var_1_60 == ((unsigned short int) (var_1_31 - var_1_26))))) && (var_1_61 == ((unsigned short int) (var_1_27 + var_1_26)))) && ((var_1_35 >= (var_1_26 + var_1_26)) ? (var_1_62 == ((unsigned short int) var_1_26)) : (var_1_62 == ((unsigned short int) (max ((var_1_26 + var_1_26) , var_1_26)))))) && ((! var_1_48) ? ((var_1_46 <= var_1_37) ? (var_1_63 == ((float) (var_1_23 + var_1_24))) : 1) : (var_1_63 == ((float) (min (((var_1_64 - 255.5f) - var_1_55) , (min ((25.5f - var_1_65) , var_1_25)))))))) && ((var_1_26 <= var_1_33) ? (var_1_66 == ((double) (var_1_55 - (abs (var_1_41))))) : (var_1_66 == ((double) (abs (abs (var_1_24))))))) && (var_1_67 == ((signed long int) var_1_44))) && (var_1_68 == ((float) var_1_65))) && (var_1_48 ? (var_1_69 == ((unsigned long int) var_1_28)) : (var_1_69 == ((unsigned long int) var_1_26)))) && (var_1_70 == ((signed char) var_1_36))) && ((var_1_30 <= (var_1_26 - var_1_26)) ? (var_1_71 == ((float) ((100000.9f + (1.00000000625E8f - var_1_72)) + var_1_23))) : ((var_1_26 < var_1_26) ? (var_1_71 == ((float) var_1_23)) : (var_1_71 == ((float) 0.75f))))
;
}
int main(void) {
	isInitial = 1;
