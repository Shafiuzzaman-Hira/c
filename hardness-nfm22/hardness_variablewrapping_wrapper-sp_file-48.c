...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_16_Pointer))) {
		if (last_1_WrapperStruct00_var_1_7 != last_1_WrapperStruct00_var_1_7) {
			...
			(*(WrapperStruct00_var_1_7_Pointer)) = ((*(WrapperStruct00_var_1_11_Pointer)) - ((max ((*(WrapperStruct00_var_1_14_Pointer)) , (*(WrapperStruct00_var_1_15_Pointer)))) - (*(WrapperStruct00_var_1_12_Pointer))));
		}
	}
}
