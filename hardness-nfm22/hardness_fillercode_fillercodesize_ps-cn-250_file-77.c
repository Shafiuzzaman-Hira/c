...
void step(void) {
	...
	if (var_1_27 > var_1_24) {
		if ((abs (var_1_20)) <= var_1_30) {
			var_1_37 = (var_1_38 + var_1_39);
		} else {
			var_1_37 = (8.6f - var_1_40);
		}
	} else {
		if ((abs (abs (var_1_31))) >= var_1_30) {
			if (var_1_27 != (var_1_24 - var_1_30)) {
				if (var_1_25 <= 32) {
					var_1_37 = (abs (var_1_39));
				} else {
					var_1_37 = (abs (max (var_1_40 , var_1_38)));
				}
			}
		}
	}
	...
	if (var_1_31 <= var_1_23) {
		if (var_1_26 <= (var_1_27 / 16)) {
			if (-64 <= ((-32 / var_1_29) % var_1_24)) {
				if ((~ var_1_32) >= var_1_24) {
					var_1_41 = (abs (var_1_42 - var_1_25));
				} else {
					if (var_1_32 < var_1_23) {
						var_1_41 = ((abs (min (var_1_42 , var_1_43))) - var_1_32);
					} else {
						if (var_1_22 <= (var_1_43 * var_1_24)) {
							var_1_41 = 4u;
						} else {
							if (var_1_22 <= var_1_23) {
								var_1_41 = (abs (var_1_31));
							} else {
								if ((var_1_40 - var_1_44) <= var_1_38) {
									var_1_41 = (max ((max ((abs (var_1_25)) , (max (var_1_26 , 1u)))) , (var_1_43 - 50u)));
								} else {
									var_1_41 = ((abs (var_1_43)) - (var_1_45 - var_1_28));
								}
							}
						}
					}
		...
		if (var_1_39 > var_1_46) {
			var_1_41 = (var_1_43 - (max (var_1_31 , var_1_27)));
		} else {
			if (var_1_44 <= (- var_1_39)) {
				if (var_1_31 <= 32) {
					var_1_41 = (max (var_1_30 , var_1_47));
				} else {
					var_1_41 = (max ((min (var_1_27 , var_1_30)) , var_1_23));
				}
			}
		}
	}
	...
	if ((- var_1_46) >= (9.75f * var_1_37)) {
		var_1_48 = ((min (var_1_24 , var_1_49)) - (max (var_1_31 , (var_1_30 + var_1_27))));
	} else {
	...
	// From: CodeObject9
	if (var_1_46 >= (min ((var_1_37 / -0.6f) , 9.999999999905E10f))) {
		if (var_1_32 <= (var_1_49 / var_1_24)) {
			var_1_50 = (abs (var_1_39));
		} else {
			if (var_1_33) {
				var_1_50 = (abs (var_1_40 - (var_1_51 - var_1_52)));
			} else {
				var_1_50 = (abs (abs (10.5 - var_1_40)));
			}
		}
	}
	...
	if (var_1_34 || var_1_35) {
		if (var_1_23 <= var_1_31) {
			...
			var_1_53 = (abs (abs (var_1_48)));
		}
	} else {
		var_1_53 = (min ((abs (var_1_30)) , (min (var_1_29 , var_1_32))));
	}


	// From: CodeObject11
	var_1_54 = (min (var_1_38 , (abs (var_1_40))));
	...
	if (var_1_44 < var_1_46) {
		...
		if ((max (var_1_49 , var_1_32)) > ((var_1_22 ^ var_1_29) ^ var_1_24)) {
	...
	// From: CodeObject13
	if (var_1_34) {
		if ((abs (min (var_1_57 , var_1_28))) <= var_1_26) {
			var_1_56 = (max (var_1_28 , (abs (var_1_27))));
		}
	} else {
		if (((min (var_1_30 , var_1_29)) - var_1_26) > var_1_25) {
			var_1_56 = ((abs (var_1_24 + var_1_48)) + (min (var_1_55 , var_1_25)));
		} else {
			if ((max (var_1_26 , var_1_31)) > -64) {
				var_1_56 = var_1_28;
			} else {
				var_1_56 = (1 - var_1_25);
			}
	...
	// From: CodeObject14
	if (var_1_33) {
		var_1_58 = (((min (var_1_22 , var_1_31)) <= var_1_25) || ((var_1_35 && var_1_59) && var_1_60));
	}
	...
	// From: CodeObject22
	if (var_1_48 < 5) {
		var_1_69 = (max ((var_1_25 + var_1_27) , (max (var_1_26 , var_1_30))));
	}
	...
	// From: Req2Batch77PS_CN_250
	if ((- var_1_7) < (var_1_1 * var_1_4)) {
		var_1_8 = var_1_9;
	}


	// From: Req4Batch77PS_CN_250
	...
	// From: Req3Batch77PS_CN_250
	var_1_10 = (50 + ((var_1_11 + 10000) - var_1_12));


	// From: Req6Batch77PS_CN_250
