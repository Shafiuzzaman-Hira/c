...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch3950_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch3950_1loop
	var_1_24 = var_1_25;


	// From: Req8Batch3950_1loop
	var_1_26 = var_1_8;


	// From: Req3Batch3950_1loop
	var_1_10 = (min ((abs (var_1_11 - var_1_8)) , (max (0u , var_1_26))));


	// From: Req4Batch3950_1loop
