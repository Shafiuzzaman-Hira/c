...
void step(void) {
 ...
 if (var_1_27 < (((((var_1_24) < (var_1_17)) ? (var_1_24) : (var_1_17))) / var_1_42)) {
 ...
 if ((((((var_1_27) < (var_1_8)) ? (var_1_27) : (var_1_8))) >> (var_1_44 - 4u)) >= var_1_42) {
  var_1_43 = ((var_1_45 - (10000 - var_1_44)) - ((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))));
 } else {
  if (((((((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35)))) > (var_1_8)) ? (((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35)))) : (var_1_8))) > var_1_42) {
   var_1_43 = 5;
  }
 }
