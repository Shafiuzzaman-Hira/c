...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch60Amount25.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_0 < var_1_4) {
  var_1_7 = (((((var_1_3 - (var_1_9 + var_1_10))) < ((var_1_11 + var_1_12))) ? ((var_1_3 - (var_1_9 + var_1_10))) : ((var_1_11 + var_1_12))));
 } else {
  var_1_7 = var_1_11;
 }
}
