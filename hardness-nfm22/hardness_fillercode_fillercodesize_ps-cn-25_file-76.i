...
void step(void) {
 ...
 if (var_1_24 || (var_1_21 >= var_1_22)) {
  if (var_1_22 < (((((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21))) < 0 ) ? -((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21))) : ((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21)))))) {
   if ((var_1_26 * var_1_27) < (var_1_28 * var_1_29)) {
    var_1_25 = ((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26)));
   }
  } else {
   var_1_25 = ((((var_1_27) < ((((((((var_1_26) < (var_1_30)) ? (var_1_26) : (var_1_30))) < 0 ) ? -((((var_1_26) < (var_1_30)) ? (var_1_26) : (var_1_30))) : ((((var_1_26) < (var_1_30)) ? (var_1_26) : (var_1_30))))))) ? (var_1_27) : ((((((((var_1_26) < (var_1_30)) ? (var_1_26) : (var_1_30))) < 0 ) ? -((((var_1_26) < (var_1_30)) ? (var_1_26) : (var_1_30))) : ((((var_1_26) < (var_1_30)) ? (var_1_26) : (var_1_30))))))));
  }
 } else {
  var_1_25 = var_1_30;
 }
