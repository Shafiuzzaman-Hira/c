...
void step(void) {
	...
	// From: Req10Batch59100_while
	if (100.5f < var_1_22) {
		var_1_27 = (! var_1_28);
	}


	// From: Req5Batch59100_while
	if (var_1_27 || var_1_27) {
		var_1_12 = (var_1_13 + (min (var_1_14 , var_1_15)));
	}


	// From: Req3Batch59100_while
