...
void step(void) {
	...
	// From: Req7Batch65Amount100
	var_1_20 = (min (var_1_1 , 64u));


	// From: Req2Batch65Amount100
	if (last_1_var_1_27) {
		var_1_5 = (min (var_1_6 , (var_1_7 - var_1_8)));
	}


	// From: Req4Batch65Amount100
	if (last_1_var_1_27) {
