...
void step(void) {
	...
	// From: Req2Batch97Amount250
	if (((- last_1_var_1_60) * last_1_var_1_60) == last_1_var_1_60) {
		if (last_1_var_1_49) {
			var_1_15 = (max (128 , (last_1_var_1_35 + 32)));
		} else {
			var_1_15 = (last_1_var_1_35 + (max (last_1_var_1_42 , (last_1_var_1_35 + last_1_var_1_40))));
		}
	} else {
	...
	// From: Req19Batch97Amount250
	unsigned char stepLocal_9 = var_1_38;
	unsigned long int stepLocal_8 = var_1_10;
	if ((- (min (last_1_var_1_60 , var_1_46))) == (abs (last_1_var_1_60))) {
	...
	// From: Req20Batch97Amount250
	if ((- var_1_46) <= var_1_60) {
		var_1_58 = 0;
	}


	// From: Req13Batch97Amount250
	if (var_1_60 <= 4.4) {
		var_1_40 = var_1_26;
	} else {
		if (! var_1_28) {
	...
	// From: Req5Batch97Amount250
	var_1_27 = (var_1_28 && var_1_29);


	// From: Req10Batch97Amount250
	var_1_36 = var_1_26;


	// From: Req14Batch97Amount250
	var_1_42 = (max (var_1_26 , var_1_24));


	// From: Req16Batch97Amount250
	if (var_1_58) {
		var_1_48 = (var_1_11 - var_1_34);
	} else {
		var_1_48 = (min (var_1_42 , var_1_47));
	}


	// From: Req21Batch97Amount250
	var_1_59 = var_1_36;


	// From: Req24Batch97Amount250
	var_1_63 = var_1_26;


	// From: Req18Batch97Amount250
	unsigned char stepLocal_7 = var_1_57;
	if (var_1_49) {
		if (stepLocal_7 || var_1_49) {
			var_1_56 = (var_1_47 - var_1_41);
		} else {
			var_1_56 = (min (var_1_26 , var_1_41));
		}
	}


	// From: Req1Batch97Amount250
	signed long int stepLocal_1 = abs (var_1_35);
		...
		if ((var_1_7 - var_1_15) <= stepLocal_1) {
			if (var_1_60 != var_1_60) {
				if (var_1_60 < var_1_60) {
					...
					var_1_1 = ((min ((var_1_10 + 1393715471u) , var_1_11)) - (256u + var_1_59));
				}
			} else {
				var_1_1 = (min ((var_1_15 + var_1_59) , var_1_11));
			}
		} else {
	...
	// From: Req15Batch97Amount250
	if (var_1_7 < ((var_1_41 << var_1_34) + (var_1_11 - var_1_15))) {
		if (var_1_42 <= var_1_63) {
			if ((var_1_60 / (min (var_1_45 , var_1_46))) >= var_1_60) {
	...
	// From: Req6Batch97Amount250
	if ((- (max (50.75 , var_1_60))) < (var_1_60 / 0.05)) {
	...
	// From: Req11Batch97Amount250
	unsigned char stepLocal_6 = var_1_35;
	if (stepLocal_6 >= var_1_14) {
		var_1_37 = (((min (var_1_43 , -1)) >= var_1_25) && var_1_38);
	}


	// From: Req3Batch97Amount250
	unsigned long int stepLocal_2 = var_1_35 | (var_1_59 + var_1_14);
	if (stepLocal_2 < (- (var_1_11 * var_1_35))) {
		if (var_1_60 >= var_1_60) {
			var_1_21 = (3729661190u - (max (var_1_35 , var_1_35)));
		}
	}


	// From: Req23Batch97Amount250
	unsigned char stepLocal_10 = var_1_46 < var_1_60;
	if (stepLocal_10 || ((var_1_10 + var_1_15) <= (abs (var_1_1)))) {
		var_1_62 = (min (16 , var_1_41));
	}


	// From: Req8Batch97Amount250
	if (var_1_60 < var_1_60) {
		var_1_32 = ((max (var_1_56 , var_1_35)) + (var_1_34 - 1));
	}


	// From: Req12Batch97Amount250
...
int property() {
	return ((((((((((((((((((((((((var_1_27 && var_1_57) ? ((var_1_60 == var_1_60) ? (var_1_1 == ((unsigned long int) (var_1_15 + 10u))) : 1) : (((var_1_7 - var_1_15) <= (abs (var_1_35))) ? ((var_1_60 != var_1_60) ? ((var_1_60 < var_1_60) ? (var_1_1 == ((unsigned long int) (((1000000000u - 10u) + var_1_59) + var_1_15))) : (var_1_1 == ((unsigned long int) ((min ((var_1_10 + 1393715471u) , var_1_11)) - (256u + var_1_59))))) : (var_1_1 == ((unsigned long int) (min ((var_1_15 + var_1_59) , var_1_11))))) : (var_1_1 == ((unsigned long int) (((var_1_12 + var_1_13) + var_1_14) - var_1_59))))) && ((((- last_1_var_1_60) * last_1_var_1_60) == last_1_var_1_60) ? (last_1_var_1_49 ? (var_1_15 == ((unsigned short int) (max (128 , (last_1_var_1_35 + 32))))) : (var_1_15 == ((unsigned short int) (last_1_var_1_35 + (max (last_1_var_1_42 , (last_1_var_1_35 + last_1_var_1_40))))))) : (var_1_15 == ((unsigned short int) last_1_var_1_35)))) && (((var_1_35 | (var_1_59 + var_1_14)) < (- (var_1_11 * var_1_35))) ? ((var_1_60 >= var_1_60) ? (var_1_21 == ((unsigned long int) (3729661190u - (max (var_1_35 , var_1_35))))) : 1) : 1)) && ((var_1_60 > var_1_60) ? (var_1_22 == ((signed char) var_1_23)) : (var_1_22 == ((signed char) (1 - ((var_1_24 + var_1_25) - var_1_26)))))) && (var_1_27 == ((unsigned char) (var_1_28 && var_1_29)))) && (((- (max (50.75 , var_1_60))) < (var_1_60 / 0.05)) ? (var_1_30 == ((unsigned long int) (var_1_11 - var_1_35))) : (var_1_30 == ((unsigned long int) var_1_42)))) && ((var_1_60 >= var_1_60) ? (var_1_31 == ((unsigned long int) var_1_24)) : (var_1_31 == ((unsigned long int) (var_1_35 + (var_1_24 + var_1_26)))))) && ((var_1_60 < var_1_60) ? (var_1_32 == ((unsigned short int) ((max (var_1_56 , var_1_35)) + (var_1_34 - 1)))) : 1)) && ((((32 + last_1_var_1_31) >> var_1_23) >= 2u) ? ((last_1_var_1_57 || (last_1_var_1_60 < last_1_var_1_60)) ? (var_1_35 == ((unsigned char) (var_1_24 + var_1_26))) : ((last_1_var_1_57 && var_1_28) ? (var_1_35 == ((unsigned char) ((var_1_26 + var_1_24) + var_1_25))) : (var_1_35 == ((unsigned char) (var_1_24 + var_1_26))))) : 1)) && (var_1_36 == ((signed short int) var_1_26))) && ((var_1_35 >= var_1_14) ? (var_1_37 == ((unsigned char) (((min (var_1_43 , -1)) >= var_1_25) && var_1_38))) : 1)) && ((var_1_62 >= (var_1_40 + var_1_13)) ? (var_1_39 == ((signed char) var_1_26)) : 1)) && ((var_1_60 <= 4.4) ? (var_1_40 == ((unsigned char) var_1_26)) : ((! var_1_28) ? (var_1_40 == ((unsigned char) (128 - (var_1_25 + (var_1_24 - var_1_41))))) : 1))) && (var_1_42 == ((unsigned char) (max (var_1_26 , var_1_24))))) && ((var_1_7 < ((var_1_41 << var_1_34) + (var_1_11 - var_1_15))) ? ((var_1_42 <= var_1_63) ? (((var_1_60 / (min (var_1_45 , var_1_46))) >= var_1_60) ? (var_1_43 == ((unsigned char) (abs (min (var_1_41 , var_1_26))))) : (var_1_43 == ((unsigned char) (var_1_47 - var_1_41)))) : 1) : 1)) && (var_1_58 ? (var_1_48 == ((unsigned long int) (var_1_11 - var_1_34))) : (var_1_48 == ((unsigned long int) (min (var_1_42 , var_1_47)))))) && (var_1_29 ? (last_1_var_1_58 ? ((! (last_1_var_1_60 <= last_1_var_1_60)) ? (var_1_49 == ((unsigned char) (! var_1_28))) : (((last_1_var_1_15 >> 10) > var_1_12) ? (var_1_49 == ((unsigned char) (! var_1_38))) : (var_1_49 == ((unsigned char) var_1_28)))) : (((var_1_7 & var_1_11) > (- var_1_47)) ? (var_1_49 == ((unsigned char) ((var_1_28 && (last_1_var_1_57 || var_1_50)) && var_1_51))) : (var_1_49 == ((unsigned char) (var_1_38 || var_1_52))))) : ((var_1_7 == last_1_var_1_36) ? (var_1_49 == ((unsigned char) ((! var_1_50) || ((last_1_var_1_58 || var_1_51) && var_1_52)))) : ((last_1_var_1_58 || var_1_52) ? (((last_1_var_1_27 || last_1_var_1_57) || (var_1_10 > var_1_34)) ? (var_1_49 == ((unsigned char) (! var_1_51))) : ((last_1_var_1_1 == (last_1_var_1_35 * last_1_var_1_36)) ? (var_1_49 == ((unsigned char) (((last_1_var_1_32 * var_1_12) == last_1_var_1_32) || (last_1_var_1_57 || (var_1_52 || var_1_51))))) : (var_1_49 == ((unsigned char) (last_1_var_1_27 || (! (! var_1_51))))))) : (var_1_49 == ((unsigned char) (var_1_52 || (! var_1_51)))))))) && (var_1_49 ? ((var_1_57 || var_1_49) ? (var_1_56 == ((unsigned char) (var_1_47 - var_1_41))) : (var_1_56 == ((unsigned char) (min (var_1_26 , var_1_41))))) : 1)) && (((- (min (last_1_var_1_60 , var_1_46))) == (abs (last_1_var_1_60))) ? ((var_1_38 || ((- 64u) >= var_1_10)) ? (var_1_57 == ((unsigned char) (! (var_1_29 && (var_1_51 && var_1_50))))) : ((var_1_10 >= (last_1_var_1_43 | (var_1_24 << last_1_var_1_30))) ? ((! last_1_var_1_58) ? (var_1_50 ? (var_1_57 == ((unsigned char) (! ((var_1_28 && var_1_29) && var_1_51)))) : (var_1_57 == ((unsigned char) (last_1_var_1_49 && (last_1_var_1_58 && (var_1_52 || var_1_38)))))) : 1) : (var_1_57 == ((unsigned char) (! var_1_51))))) : 1)) && (((- var_1_46) <= var_1_60) ? (var_1_58 == ((unsigned char) 0)) : 1)) && (var_1_59 == ((unsigned short int) var_1_36))) && (last_1_var_1_37 ? (var_1_60 == ((float) 3.5f)) : (var_1_60 == ((float) var_1_61)))) && (((var_1_46 < var_1_60) || ((var_1_10 + var_1_15) <= (abs (var_1_1)))) ? (var_1_62 == ((signed short int) (min (16 , var_1_41)))) : 1)) && (var_1_63 == ((signed char) var_1_26))
;
}
int main(void) {
	isInitial = 1;
