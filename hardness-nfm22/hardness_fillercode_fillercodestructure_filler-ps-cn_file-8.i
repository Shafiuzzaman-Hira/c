...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch8Filler_PS_CN.c", 13, "reach_error"); }
 ...
 if (var_1_32 <= var_1_28) {
  if (var_1_39 < 255.2f) {
   if ((16 <= var_1_27) && (var_1_32 >= var_1_30)) {
    var_1_40 = ((((var_1_34) > (var_1_41)) ? (var_1_34) : (var_1_41)));
   }
  }
 }
 if (var_1_41 < ((((((((var_1_34) > (var_1_40)) ? (var_1_34) : (var_1_40)))) > (var_1_35)) ? (((((var_1_34) > (var_1_40)) ? (var_1_34) : (var_1_40)))) : (var_1_35)))) {
  var_1_42 = var_1_39;
 } else {
