...
void step(void) {
	...
	// From: Req6Batch35Filler_PS_CI
	var_1_16 = (abs ((var_1_17 + var_1_18) + (min (var_1_19 , var_1_20))));


	// From: Req7Batch35Filler_PS_CI
