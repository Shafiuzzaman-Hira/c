...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch86PS_CN_10.c", 13, "reach_error"); }
...
float var_1_30 = 10000000.25;
float var_1_31 = 50.75;
...
void step(void) {
	...
	// From: Req2Batch86PS_CN_10
	if (var_1_19) {
		var_1_6 = (last_1_var_1_6 || var_1_9);
	}


	// From: Req4Batch86PS_CN_10
	...
	// From: Req7Batch86PS_CN_10
	var_1_22 = var_1_15;


	// From: Req5Batch86PS_CN_10
