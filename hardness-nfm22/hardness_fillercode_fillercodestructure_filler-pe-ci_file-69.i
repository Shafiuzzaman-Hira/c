...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch69Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_11) {
  var_1_24 = ((((((var_1_6) > (var_1_8)) ? (var_1_6) : (var_1_8))) + var_1_5) + 1);
 }
 var_1_29 = var_1_6;
 if (var_1_1 > var_1_1) {
  if (var_1_7 >= var_1_1) {
 ...
 if (var_1_10) {
  if (var_1_1 <= var_1_8) {
   ...
   var_1_32 = ((((var_1_6) < (0)) ? (var_1_6) : (0)));
  }
 } else {
  if ((var_1_1 % var_1_5) != (var_1_7 + var_1_4)) {
   if (((((8.4f) < (var_1_13)) ? (8.4f) : (var_1_13))) < 127.2f) {
    var_1_32 = ((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6)));
   } else {
    var_1_32 = ((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6)));
   }
  } else {
   if ((((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))) << var_1_1) > var_1_5) {
 ...
 if (var_1_7 >= ((((8) < (var_1_16)) ? (8) : (var_1_16)))) {
