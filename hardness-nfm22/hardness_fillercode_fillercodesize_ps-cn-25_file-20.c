...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch20PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject6
	if (((var_1_23 + var_1_21) % var_1_30) != 5) {
		var_1_29 = var_1_30;
	}


	// From: Req2Batch20PS_CN_25
	...
	// From: Req5Batch20PS_CN_25
	var_1_15 = (var_1_14 + var_1_16);


	// From: Req6Batch20PS_CN_25
	if (var_1_2) {
