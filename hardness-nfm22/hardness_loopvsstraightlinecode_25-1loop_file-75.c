...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch7525_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch7525_1loop
	signed long int stepLocal_0 = (last_1_var_1_17 * last_1_var_1_17) * last_1_var_1_17;
	if (stepLocal_0 < (max (last_1_var_1_17 , last_1_var_1_17))) {
		var_1_1 = (var_1_7 - ((min (var_1_8 , var_1_9)) - var_1_10));
	} else {
		var_1_1 = var_1_8;
	}


	// From: Req3Batch7525_1loop
	unsigned char stepLocal_1 = var_1_1;
	if (stepLocal_1 >= var_1_1) {
		var_1_17 = ((abs (var_1_7)) - (abs (max (var_1_9 , var_1_10))));
	} else {
		var_1_17 = var_1_8;
	}


	// From: Req2Batch7525_1loop
	if (var_1_12 || ((var_1_13 * 49.25) == 32.8)) {
		var_1_11 = (max ((var_1_14 + var_1_15) , var_1_16));
	} else {
		var_1_11 = var_1_15;
	}
}
...
int property() {
	return (((((last_1_var_1_17 * last_1_var_1_17) * last_1_var_1_17) < (max (last_1_var_1_17 , last_1_var_1_17))) ? (var_1_1 == ((unsigned char) (var_1_7 - ((min (var_1_8 , var_1_9)) - var_1_10)))) : (var_1_1 == ((unsigned char) var_1_8))) && ((var_1_12 || ((var_1_13 * 49.25) == 32.8)) ? (var_1_11 == ((float) (max ((var_1_14 + var_1_15) , var_1_16)))) : (var_1_11 == ((float) var_1_15)))) && ((var_1_1 >= var_1_1) ? (var_1_17 == ((unsigned char) ((abs (var_1_7)) - (abs (max (var_1_9 , var_1_10)))))) : (var_1_17 == ((unsigned char) var_1_8)))
;
}
int main(void) {
	isInitial = 1;
