...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch950_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch950_while
	if (((var_1_6 >> 2) * last_1_var_1_13) > last_1_var_1_10) {
		var_1_12 = var_1_6;
	}


	// From: Req2Batch950_while
	...
	// From: Req6Batch950_while
	var_1_18 = var_1_3;


	// From: Req5Batch950_while
