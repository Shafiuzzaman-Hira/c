...
void step(void) {
	...
	if (! var_1_30) {
		...
		var_1_39 = (var_1_21 + (max (var_1_36 , (var_1_21 + var_1_21))));
	}
	...
	// From: CodeObject2
	if (var_1_16 > (max ((16u | var_1_8) , var_1_16))) {
		if (var_1_29) {
			var_1_31 = var_1_34;
		}
	}
	...
	if ((var_1_21 & -10) < var_1_16) {
		if ((~ (min (var_1_21 , var_1_16))) > var_1_34) {
			if ((min (var_1_16 , (var_1_21 * var_1_16))) < (var_1_16 ^ var_1_34)) {
				if (var_1_30) {
					var_1_35 = var_1_36;
				}
			}
