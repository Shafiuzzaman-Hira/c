...
void step(void) {
	...
	// From: CodeObject4
	if (var_1_4 >= (var_1_21 % (abs (var_1_11)))) {
		if (var_1_4 < var_1_4) {
			if (var_1_9 && ((abs (var_1_4)) <= var_1_11)) {
				var_1_36 = var_1_4;
			}
		}
	}
	...
	if (var_1_21 > var_1_21) {
		var_1_39 = (min (var_1_14 , (abs (var_1_22))));
	}


	// From: CodeObject6
	if (var_1_1 < (min (var_1_4 , -64))) {
		var_1_40 = var_1_19;
	} else {
		if ((var_1_11 | var_1_11) < (8 + var_1_10)) {
			var_1_40 = (abs (max ((abs (var_1_19)) , var_1_17)));
		}
	}
	...
	if ((var_1_18 >= var_1_18) && (var_1_4 >= var_1_4)) {
		if (var_1_5) {
			var_1_27 = (max ((min (var_1_4 , var_1_4)) , (abs (var_1_10))));
		} else {
	...
	if (var_1_18 > var_1_18) {
		if (var_1_4 >= var_1_4) {
			var_1_35 = (abs (min ((var_1_11 + var_1_4) , var_1_4)));
		}
	}
}
