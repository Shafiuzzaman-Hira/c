...
void step(void) {
	...
	// From: Req8Batch22Filler_PE_CI
	if ((- 3.75) < (min (var_1_20 , var_1_22))) {
		var_1_27 = 0;
	}


	// From: Req2Batch22Filler_PE_CI
	...
	// From: CodeObject2
	if ((var_1_19 + 100000000u) != (max (var_1_7 , var_1_4))) {
		var_1_30 = (max ((var_1_10 + (abs (var_1_7))) , var_1_7));
	} else {
		var_1_30 = var_1_7;
	}
	...
	if (var_1_11 > var_1_6) {
		...
		var_1_37 = (min (var_1_21 , (abs (max (49.2 , var_1_22)))));
	}
	...
	if (var_1_11 != (~ (var_1_10 % var_1_7))) {
		...
		if (var_1_7 < var_1_11) {
			if ((var_1_10 < var_1_11) && var_1_41) {
				if (var_1_22 <= (min (var_1_22 , var_1_20))) {
