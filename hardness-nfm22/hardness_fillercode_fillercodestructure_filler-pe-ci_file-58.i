...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch58Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_3 / var_1_3) <= var_1_3) {
  if ((~ (var_1_16 - var_1_17)) < var_1_3) {
   if (((10 + var_1_16) <= (var_1_17 & var_1_3)) || var_1_8) {
    var_1_25 = var_1_17;
   }
  }
 } else {
 ...
 if (var_1_10 > (var_1_3 ^ (~ var_1_5))) {
  var_1_30 = (var_1_16 - var_1_16);
 } else {
  var_1_30 = (var_1_16 - var_1_16);
 }
 if ((var_1_13 / var_1_20) <= var_1_17) {
  var_1_33 = 2;
 } else {
  var_1_33 = (((((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17))) < 0 ) ? -((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17))) : ((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17)))));
 }
 if ((~ (var_1_3 & 64)) <= var_1_10) {
  if (var_1_24) {
   var_1_34 = var_1_16;
  }
 }
 if (var_1_9) {
  var_1_35 = (((((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17))) < 0 ) ? -((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17))) : ((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17)))));
 } else {
  var_1_35 = (((((var_1_17) > (var_1_17)) ? (var_1_17) : (var_1_17))) - var_1_5);
 }
 var_1_37 = var_1_16;
 var_1_38 = var_1_16;
 var_1_39 = var_1_17;
