...
void step(void) {
 if ((32 / var_1_20) > -500) {
  var_1_19 = ((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21)));
 }
 if ((~ var_1_20) >= var_1_23) {
  if (((((var_1_23) < (var_1_20)) ? (var_1_23) : (var_1_20))) >= -5) {
   var_1_22 = var_1_24;
  } else {
   var_1_22 = var_1_24;
  }
 }
 if (var_1_21 <= ((((var_1_19) > (var_1_26)) ? (var_1_19) : (var_1_26)))) {
  var_1_25 = (var_1_27 + 1);
 }
 if ((var_1_23 / var_1_20) > var_1_25) {
  if (var_1_29) {
   var_1_28 = ((((var_1_24) < (((((-500) < 0 ) ? -(-500) : (-500))))) ? (var_1_24) : (((((-500) < 0 ) ? -(-500) : (-500))))));
  } else {
   var_1_28 = var_1_24;
  }
 }
