...
void step(void) {
	// From: CodeObject1
	if (var_1_10 >= (max (var_1_6 , var_1_6))) {
		var_1_24 = (min ((max (var_1_6 , var_1_10)) , var_1_6));
	} else {
		var_1_24 = ((abs (var_1_10)) + (abs (var_1_6)));
	}
	...
	if (((var_1_10 ^ var_1_23) % var_1_31) > -10) {
		var_1_30 = (abs (var_1_6));
	}


	// From: CodeObject4
	if ((~ var_1_1) <= ((max (var_1_20 , -16)) & 16)) {
		var_1_32 = var_1_33;
	} else {
