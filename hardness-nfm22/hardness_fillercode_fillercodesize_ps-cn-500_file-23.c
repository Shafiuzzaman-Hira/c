...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch23PS_CN_500.c", 13, "reach_error"); }
...
double var_1_87 = 3.58;
double var_1_88 = 127.4;
signed short int var_1_89 = 16;
unsigned char var_1_90 = 8;
signed long int var_1_91 = -50;
unsigned char var_1_92 = 128;
signed long int var_1_93 = 1999259324;
float var_1_94 = 99.87;
float var_1_95 = 49.25;
unsigned short int var_1_96 = 256;
unsigned long int var_1_97 = 256;
float var_1_98 = 199.75;
float var_1_99 = 255.3;
signed short int var_1_100 = 32;
double var_1_101 = 5.5;
signed long int var_1_102 = 10;
unsigned long int var_1_103 = 25;
unsigned long int var_1_104 = 3098604849;
float var_1_105 = 4.875;
...
signed long int var_1_120 = -5;
unsigned short int var_1_121 = 0;
unsigned short int var_1_122 = 4;
unsigned char var_1_123 = 1;
signed char var_1_124 = -8;
unsigned char var_1_125 = 0;
unsigned short int var_1_126 = 64;
signed long int var_1_127 = 64;
signed long int var_1_128 = 32;
float var_1_129 = 0.0;
unsigned char var_1_130 = 64;
float var_1_131 = 9999999999.6;
unsigned char var_1_132 = 32;
signed long int var_1_133 = -2;
...
void step(void) {
	...
	if (var_1_52 != var_1_50) {
		if ((- var_1_40) <= var_1_71) {
			if ((var_1_39 << var_1_62) > (var_1_42 * (abs (var_1_61)))) {
				...
				var_1_85 = (abs (var_1_41 + (var_1_39 + var_1_69)));
			}
		} else {
			var_1_85 = (max ((abs (var_1_36)) , (min (var_1_78 , (min (var_1_69 , var_1_40))))));
		}
	} else {
		if ((var_1_43 ^ (~ var_1_79)) <= var_1_65) {
			var_1_85 = (abs (var_1_81));
		}
	}


	// From: CodeObject30
	if (var_1_83 > (abs (var_1_74))) {
		var_1_87 = (15.25 - var_1_47);
	} else {
		if (var_1_60) {
			var_1_87 = (abs (var_1_51 - (var_1_52 + var_1_88)));
		}
	}


	// From: CodeObject31
	if ((var_1_69 / var_1_67) <= var_1_78) {
		var_1_89 = (abs (32));
	} else {
		var_1_89 = (min (var_1_36 , (abs (var_1_79))));
	}


	// From: CodeObject32
	if (var_1_87 >= (var_1_51 - var_1_38)) {
		if ((64 + var_1_77) < (abs (25))) {
			if (var_1_76 > ((var_1_80 ^ var_1_40) * var_1_69)) {
				var_1_90 = (var_1_69 + var_1_40);
			} else {
				var_1_90 = (abs (abs (var_1_39)));
			}
		}
	} else {
		var_1_90 = var_1_39;
	...
	// From: CodeObject33
	if ((var_1_92 - var_1_39) <= (~ var_1_42)) {
		if (var_1_37 > var_1_83) {
			if (var_1_79 < var_1_40) {
				var_1_91 = var_1_69;
			} else {
				var_1_91 = (abs (var_1_43));
			}
		} else {
			var_1_91 = ((var_1_93 - var_1_42) - (abs (var_1_86)));
		}
	} else {
		var_1_91 = (min (var_1_69 , -1));
	}


	// From: CodeObject34
	if (var_1_81 < ((var_1_89 + 25) >> var_1_71)) {
		var_1_94 = var_1_95;
	}
	...
	if (var_1_72 <= var_1_58) {
		var_1_96 = (max ((var_1_81 - (max (var_1_69 , 1))) , (abs (var_1_92))));
	}


	// From: CodeObject36
	if (var_1_34) {
		var_1_97 = (abs (abs (var_1_36)));
	}


	// From: CodeObject37
	if (var_1_32 > -64) {
		if (var_1_94 >= var_1_74) {
			var_1_98 = (abs (var_1_84 + 100.9f));
		} else {
			var_1_98 = (var_1_84 + 16.5f);
		}
	}


	// From: CodeObject38
	if (var_1_60 && var_1_34) {
		var_1_99 = ((abs (var_1_52)) + var_1_88);
	}


	// From: CodeObject39
	var_1_100 = (min (var_1_61 , var_1_32));


	// From: CodeObject40
	if ((var_1_97 * var_1_92) >= var_1_30) {
		if (var_1_81 > var_1_70) {
			var_1_101 = (max (var_1_52 , var_1_95));
		} else {
			var_1_101 = ((var_1_88 + var_1_52) - (max (var_1_51 , (abs (var_1_49)))));
		}
	} else {
		if (var_1_66) {
			var_1_101 = (min (var_1_47 , var_1_49));
		} else {
			var_1_101 = var_1_50;
		}
	}
	...
	// From: CodeObject41
	if ((var_1_49 + var_1_95) >= (7.6f / var_1_44)) {
		if (var_1_64) {
			var_1_102 = (abs (var_1_40));
		}
	} else {
		var_1_102 = (min (-8 , var_1_86));
	}


	// From: CodeObject42
	var_1_103 = (max ((max (var_1_67 , var_1_61)) , (var_1_104 - 1u)));


	// From: CodeObject43
	var_1_105 = (var_1_47 - var_1_52);


	// From: CodeObject44
	if (var_1_99 >= var_1_38) {
		if (var_1_98 <= (var_1_47 + var_1_50)) {
			var_1_106 = (min ((abs (var_1_107)) , 64));
		} else {
			if (((min (var_1_86 , var_1_58)) | var_1_62) >= (abs (abs (var_1_71)))) {
				var_1_106 = (var_1_78 - var_1_61);
			}
		}
	} else {
		var_1_106 = var_1_41;
	...
	if (var_1_59) {
		...
		var_1_108 = (abs (abs (var_1_41)));
	}


	// From: CodeObject46
	if (var_1_100 <= (var_1_110 - (abs (var_1_43)))) {
		if (var_1_111 >= var_1_61) {
			if ((max ((abs (var_1_50)) , (var_1_44 + 32.4))) < var_1_98) {
				if ((abs (var_1_69)) >= (abs (var_1_67 - var_1_80))) {
					if (var_1_72 >= (~ var_1_106)) {
						var_1_109 = (min ((min (var_1_33 , var_1_32)) , var_1_35));
					}
				} else {
					var_1_109 = (abs (var_1_35));
				}
			} else {
				var_1_109 = (abs (abs (var_1_69)));
			}
		} else {
			if (var_1_61 < var_1_65) {
				var_1_109 = (abs (min (var_1_40 , (var_1_69 - var_1_112))));
			}
		}
	}
	...
	// From: CodeObject47
	if (var_1_111 <= (var_1_93 | var_1_61)) {
		var_1_113 = (abs (var_1_51));
	}


	// From: CodeObject48
	if ((var_1_42 * var_1_90) > var_1_75) {
		var_1_114 = (abs (min ((var_1_41 - var_1_90) , var_1_32)));
	} else {
		if ((var_1_110 & var_1_68) < (max (var_1_43 , var_1_96))) {
			if (var_1_56 && var_1_55) {
				var_1_114 = (var_1_112 - (min (var_1_111 , var_1_115)));
			} else {
				var_1_114 = (var_1_86 - var_1_42);
			}
		} else {
			var_1_114 = ((max (var_1_39 , var_1_35)) + (abs (min (var_1_80 , var_1_42))));
		}
	}


	// From: CodeObject49
	if ((abs (min (var_1_95 , var_1_47))) < (- var_1_50)) {
		var_1_116 = (abs (var_1_35));
	}


	// From: CodeObject50
	if (var_1_87 >= (min ((min (var_1_47 , var_1_44)) , var_1_88))) {
		var_1_117 = (var_1_40 + var_1_76);
	} else {
		var_1_117 = var_1_76;
	}
	...
	// From: CodeObject63
	if ((2 | var_1_76) > var_1_30) {
		var_1_132 = (max ((min (var_1_40 , var_1_69)) , var_1_41));
	}
	...
	// From: Req1Batch23PS_CN_500
	if (var_1_2) {
		var_1_1 = var_1_3;
	}


	// From: Req6Batch23PS_CN_500
	...
	// From: Req7Batch23PS_CN_500
	var_1_23 = var_1_10;


	// From: Req8Batch23PS_CN_500
	var_1_24 = 31.75f;


	// From: Req9Batch23PS_CN_500
	var_1_25 = -5;


	// From: Req2Batch23PS_CN_500
	...
	// From: Req4Batch23PS_CN_500
	if ((- (var_1_13 / var_1_17)) > var_1_25) {
		var_1_18 = var_1_13;
	}


	// From: Req5Batch23PS_CN_500
...
void updateVariables() {
	...
	assume_abort_if_not(var_1_93 >= 1073741822);
	...
	assume_abort_if_not(var_1_111 <= 255);
