...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch14Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_4) {
  var_1_31 = ((((var_1_28) > (var_1_15)) ? (var_1_28) : (var_1_15)));
 } else {
  if (((((var_1_28) > (var_1_15)) ? (var_1_28) : (var_1_15))) > var_1_15) {
   if (var_1_30 > ((((var_1_21 / var_1_36) < 0 ) ? -(var_1_21 / var_1_36) : (var_1_21 / var_1_36)))) {
    if ((var_1_21 / var_1_36) > var_1_30) {
     var_1_31 = var_1_28;
    }
   }
  } else {
 ...
 var_1_29 = var_1_30;
 if (! var_1_4) {
  var_1_42 = (((((((((var_1_15) > (var_1_40)) ? (var_1_15) : (var_1_40))) + (var_1_39 + var_1_11))) < (-128)) ? ((((((var_1_15) > (var_1_40)) ? (var_1_15) : (var_1_40))) + (var_1_39 + var_1_11))) : (-128)));
 }
 ...
 if ((var_1_39 - ((((32) < (var_1_40)) ? (32) : (var_1_40)))) > var_1_15) {
  var_1_38 = ((32.5f >= var_1_21) || (var_1_4 || var_1_41));
 }
 if ((var_1_21 + ((((var_1_30) > (var_1_21)) ? (var_1_30) : (var_1_21)))) < ((((var_1_36) > ((var_1_21 + var_1_21))) ? (var_1_36) : ((var_1_21 + var_1_21))))) {
  if ((var_1_21 + (var_1_36 + var_1_21)) >= ((((25.5) > (var_1_21)) ? (25.5) : (var_1_21)))) {
   if (var_1_28 < (var_1_26 >> 31u)) {
    var_1_44 = (((((((var_1_30) > (var_1_47)) ? (var_1_30) : (var_1_47))) < 0 ) ? -((((var_1_30) > (var_1_47)) ? (var_1_30) : (var_1_47))) : ((((var_1_30) > (var_1_47)) ? (var_1_30) : (var_1_47)))));
   }
  }
 }
