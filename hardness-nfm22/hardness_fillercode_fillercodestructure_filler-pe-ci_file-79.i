...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch79Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_21 - var_1_22) <= var_1_25) {
  var_1_28 = var_1_22;
 }
 var_1_32 = ((((((((var_1_16) < (var_1_16)) ? (var_1_16) : (var_1_16)))) > (var_1_10)) ? (((((var_1_16) < (var_1_16)) ? (var_1_16) : (var_1_16)))) : (var_1_10)));
 var_1_36 = (((((var_1_7) > (((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8))))) ? (var_1_7) : (((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8)))))) + var_1_7);
 if (256 > (-10 >> var_1_23)) {
  var_1_38 = (var_1_16 - (((((var_1_40 - 128.375)) < (var_1_16)) ? ((var_1_40 - 128.375)) : (var_1_16))));
 } else {
  var_1_38 = var_1_16;
 }
 if (! (var_1_17 >= (var_1_16 - var_1_40))) {
  var_1_42 = (((((var_1_7 - 256)) < (var_1_20)) ? ((var_1_7 - 256)) : (var_1_20)));
 }
 if (((var_1_8 * var_1_23) | var_1_7) <= (var_1_20 + 8u)) {
  if (((((16u) < (var_1_20)) ? (16u) : (var_1_20))) < var_1_23) {
   var_1_45 = var_1_19;
  } else {
   var_1_45 = ((var_1_23 != (var_1_20 % var_1_21)) || var_1_48);
  }
 }
 if (0.83f > var_1_11) {
  if ((var_1_24 + ((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24)))) <= var_1_24) {
   var_1_49 = var_1_11;
  }
 } else {
  var_1_49 = var_1_11;
