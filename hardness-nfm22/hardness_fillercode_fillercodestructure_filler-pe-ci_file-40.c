...
void step(void) {
	...
	// From: Req9Batch40Filler_PE_CI
	var_1_26 = var_1_12;


	// From: Req6Batch40Filler_PE_CI
	...
	// From: Req4Batch40Filler_PE_CI
	var_1_16 = (min (((max (256 , var_1_12)) + var_1_12) , var_1_15));


	// From: Req8Batch40Filler_PE_CI
	var_1_25 = var_1_20;


	// From: Req1Batch40Filler_PE_CI
	...
	// From: CodeObject2
	if (var_1_9 && var_1_11) {
		var_1_30 = (abs (max (var_1_29 , var_1_15)));
	}
	...
	// From: CodeObject6
	if ((max ((var_1_20 / var_1_39) , var_1_20)) > 100.3) {
	...
	if (var_1_12 > ((var_1_29 >> 1) + var_1_21)) {
		var_1_40 = ((abs (var_1_15)) + (abs (var_1_29)));
	}
	...
	if (var_1_28 > (var_1_12 | var_1_12)) {
		var_1_43 = (max (var_1_20 , (abs (abs (var_1_20)))));
	}
