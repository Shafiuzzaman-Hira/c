...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch6PS_CN_500.c", 13, "reach_error"); }
...
signed long int var_1_107 = 32;
signed long int var_1_108 = -64;
unsigned short int var_1_109 = 128;
unsigned short int var_1_110 = 50474;
unsigned short int var_1_111 = 1;
double var_1_112 = 10.5;
float var_1_113 = 1.8;
signed short int var_1_114 = -128;
unsigned long int var_1_115 = 64;
signed short int var_1_116 = 256;
signed short int var_1_117 = 8;
unsigned char var_1_118 = 10;
double var_1_119 = 10.5;
unsigned short int var_1_120 = 1;
unsigned long int var_1_121 = 1000000000;
signed char var_1_122 = -50;
unsigned char var_1_123 = 0;
signed short int var_1_124 = -256;
unsigned char var_1_125 = 10;
double var_1_126 = 2.5;
...
void step(void) {
 ...
 if (((((var_1_64) < 0 ) ? -(var_1_64) : (var_1_64))) < var_1_60) {
  ...
  if (var_1_34 <= var_1_30) {
   ...
   var_1_77 = (4 + ((((var_1_45) > (((((var_1_38) < 0 ) ? -(var_1_38) : (var_1_38))))) ? (var_1_45) : (((((var_1_38) < 0 ) ? -(var_1_38) : (var_1_38)))))));
  }
 }
 if (var_1_70) {
  if (var_1_21) {
   var_1_78 = ((((var_1_38) < ((((((((var_1_40) < (256u)) ? (var_1_40) : (256u))) < 0 ) ? -((((var_1_40) < (256u)) ? (var_1_40) : (256u))) : ((((var_1_40) < (256u)) ? (var_1_40) : (256u))))))) ? (var_1_38) : ((((((((var_1_40) < (256u)) ? (var_1_40) : (256u))) < 0 ) ? -((((var_1_40) < (256u)) ? (var_1_40) : (256u))) : ((((var_1_40) < (256u)) ? (var_1_40) : (256u))))))));
  } else {
   var_1_78 = (((((var_1_49) > ((3944834622u - var_1_44))) ? (var_1_49) : ((3944834622u - var_1_44)))) - var_1_29);
  }
 }
 if (-4 >= var_1_64) {
  var_1_79 = var_1_65;
 }
 if (var_1_38 >= (25 << var_1_24)) {
  var_1_80 = ((((((32.5 - var_1_81) + var_1_34)) < (var_1_63)) ? (((32.5 - var_1_81) + var_1_34)) : (var_1_63)));
 }
 if (var_1_76 >= ((var_1_67 * var_1_66) / var_1_37)) {
  var_1_82 = ((((((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39))) < 0 ) ? -((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39))) : ((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39))))) - var_1_83);
 }
 if (var_1_61 <= var_1_77) {
  if (1000u < var_1_66) {
   if ((var_1_66 >> var_1_76) > var_1_23) {
    if (var_1_78 < ((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43)))) {
     var_1_84 = ((((var_1_83) < 0 ) ? -(var_1_83) : (var_1_83)));
    }
   } else {
    var_1_84 = (((((((var_1_67) < (var_1_40)) ? (var_1_67) : (var_1_40))) < 0 ) ? -((((var_1_67) < (var_1_40)) ? (var_1_67) : (var_1_40))) : ((((var_1_67) < (var_1_40)) ? (var_1_67) : (var_1_40)))));
   }
  }
 } else {
  if ((var_1_43 * var_1_79) > var_1_83) {
   var_1_84 = ((((((((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))) < 0 ) ? -((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))) : ((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))))) < 0 ) ? -(((((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))) < 0 ) ? -((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))) : ((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))))) : (((((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))) < 0 ) ? -((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))) : ((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25)))))));
  } else {
   var_1_84 = (((((var_1_27) > (var_1_83)) ? (var_1_27) : (var_1_83))) + (1263276439u - var_1_44));
  }
 }
 if ((~ var_1_78) < ((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37)))) {
  if (var_1_70) {
   if (((var_1_20 + var_1_74) % var_1_23) >= var_1_65) {
    var_1_85 = ((((var_1_29 - ((((var_1_40) > (var_1_39)) ? (var_1_40) : (var_1_39)))) < 0 ) ? -(var_1_29 - ((((var_1_40) > (var_1_39)) ? (var_1_40) : (var_1_39)))) : (var_1_29 - ((((var_1_40) > (var_1_39)) ? (var_1_40) : (var_1_39))))));
   } else {
    var_1_85 = ((((var_1_83) < 0 ) ? -(var_1_83) : (var_1_83)));
   }
  }
 }
 if (var_1_46 < var_1_29) {
  if (((((var_1_54) < (var_1_32)) ? (var_1_54) : (var_1_32))) < var_1_30) {
   var_1_86 = (((var_1_22 * var_1_74) <= var_1_45) || var_1_70);
  } else {
   var_1_86 = ((var_1_72 || var_1_73) && (! var_1_87));
  }
 }
 if ((var_1_61 >= var_1_28) || (var_1_50 <= var_1_60)) {
  var_1_88 = (((((var_1_39) > (var_1_89)) ? (var_1_39) : (var_1_89))) + var_1_90);
 }
 var_1_91 = ((var_1_55 + var_1_54) + var_1_81);
 if (var_1_64 < var_1_74) {
  var_1_92 = (! 0);
 } else {
  if (((var_1_74 % var_1_38) + (var_1_64 + var_1_75)) <= var_1_27) {
   var_1_92 = (((var_1_87 || var_1_93) || (var_1_86 && var_1_94)) || var_1_95);
  } else {
   var_1_92 = (var_1_21 && var_1_95);
  }
 }
 if (! var_1_86) {
  var_1_96 = ((((10.6) > ((((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))) - ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34)))))) ? (10.6) : ((((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))) - ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34)))))));
 } else {
  if (var_1_94) {
   if (100 <= var_1_97) {
    var_1_96 = var_1_53;
   } else {
    var_1_96 = ((((var_1_35 + ((((var_1_55) < 0 ) ? -(var_1_55) : (var_1_55)))) < 0 ) ? -(var_1_35 + ((((var_1_55) < 0 ) ? -(var_1_55) : (var_1_55)))) : (var_1_35 + ((((var_1_55) < 0 ) ? -(var_1_55) : (var_1_55))))));
   }
  }
 }
 if ((var_1_41 / var_1_62) != var_1_99) {
  var_1_98 = (var_1_73 && var_1_87);
 }
 if (var_1_51 <= (((((var_1_63) < (var_1_41)) ? (var_1_63) : (var_1_41))) - 50.5)) {
  if (var_1_69 || (! var_1_94)) {
   var_1_100 = var_1_44;
  }
 } else {
  var_1_100 = ((((var_1_67 - 128) < 0 ) ? -(var_1_67 - 128) : (var_1_67 - 128)));
 }
 if (var_1_41 > var_1_34) {
  var_1_101 = (((((((var_1_59) < 0 ) ? -(var_1_59) : (var_1_59))) < 0 ) ? -((((var_1_59) < 0 ) ? -(var_1_59) : (var_1_59))) : ((((var_1_59) < 0 ) ? -(var_1_59) : (var_1_59)))));
 }
 if (var_1_34 >= ((var_1_62 - var_1_81) - var_1_63)) {
  if (var_1_48) {
   var_1_102 = ((((var_1_39) > (var_1_89)) ? (var_1_39) : (var_1_89)));
  } else {
   var_1_102 = ((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39)));
  }
 } else {
  if (var_1_25 >= (var_1_23 ^ var_1_68)) {
   var_1_102 = 2;
  }
 }
 if (var_1_78 < var_1_45) {
  var_1_103 = (((((var_1_39) > (var_1_83)) ? (var_1_39) : (var_1_83))) - var_1_104);
 }
 if (var_1_71 <= var_1_40) {
  if (var_1_77 <= var_1_97) {
   var_1_105 = (! (var_1_21 || var_1_70));
  }
 }
 if (var_1_94) {
  if ((var_1_57 + ((((var_1_100) > (2)) ? (var_1_100) : (2)))) >= ((var_1_67 % var_1_107) * var_1_66)) {
   if ((var_1_83 + var_1_43) != var_1_36) {
    var_1_106 = ((((var_1_58) < 0 ) ? -(var_1_58) : (var_1_58)));
   }
  } else {
   if ((- ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34)))) < 1.0000000065E8) {
    if (var_1_79 >= ((16 % var_1_38) % var_1_47)) {
     if (var_1_82 != var_1_104) {
      var_1_106 = ((((var_1_23) < 0 ) ? -(var_1_23) : (var_1_23)));
     } else {
      var_1_106 = ((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29)));
     }
    }
   } else {
    var_1_106 = ((((var_1_37) < (((var_1_88 + var_1_40) + var_1_66))) ? (var_1_37) : (((var_1_88 + var_1_40) + var_1_66))));
   }
  }
 } else {
  if (var_1_21) {
   if (((((var_1_60) < 0 ) ? -(var_1_60) : (var_1_60))) < ((((var_1_47 * var_1_44) < 0 ) ? -(var_1_47 * var_1_44) : (var_1_47 * var_1_44)))) {
    var_1_106 = (var_1_108 + ((((var_1_44) > (var_1_23)) ? (var_1_44) : (var_1_23))));
   } else {
    var_1_106 = ((((((var_1_77 + var_1_43) - var_1_66)) < (var_1_38)) ? (((var_1_77 + var_1_43) - var_1_66)) : (var_1_38)));
   }
  } else {
   var_1_106 = var_1_90;
  }
 }
 if (var_1_93 && var_1_21) {
  var_1_109 = ((var_1_110 - var_1_83) - 64);
 }
 if (var_1_78 >= var_1_47) {
  var_1_111 = (var_1_67 - ((((var_1_77) < (var_1_44)) ? (var_1_77) : (var_1_44))));
 } else {
  var_1_111 = 16;
 }
 if (var_1_93) {
 ...
 if (var_1_63 > var_1_126) {
  var_1_125 = ((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37)));
 } else {
  if ((var_1_58 / var_1_38) <= ((((5) < (var_1_111)) ? (5) : (var_1_111)))) {
   if (var_1_70) {
    var_1_125 = var_1_104;
   } else {
    var_1_125 = var_1_39;
...
void updateVariables() {
 ...
 var_1_107 = __VERIFIER_nondet_long();
 assume_abort_if_not(var_1_107 >= -2147483648);
 ...
 var_1_126 = __VERIFIER_nondet_double();
 assume_abort_if_not((var_1_126 >= -922337.2036854776000e+13F && var_1_126 <= -1.0e-20F) || (var_1_126 <= 9223372.036854776000e+12F && var_1_126 >= 1.0e-20F ));
}
