...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch27Amount50.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch27Amount50
	if (var_1_6 == (var_1_4 / var_1_13)) {
		var_1_12 = var_1_11;
	}


	// From: Req6Batch27Amount50
	var_1_20 = var_1_11;


	// From: Req7Batch27Amount50
	var_1_21 = 8;


	// From: Req3Batch27Amount50
