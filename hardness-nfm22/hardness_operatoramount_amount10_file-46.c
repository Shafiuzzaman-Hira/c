...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch46Amount10.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch46Amount10
	signed long int stepLocal_0 = max ((min (var_1_5 , var_1_6)) , var_1_7);
	if (var_1_2) {
...
int property() {
	return (var_1_2 ? (var_1_1 == ((double) (max (var_1_3 , var_1_4)))) : (((max ((min (var_1_5 , var_1_6)) , var_1_7)) < var_1_8) ? (var_1_1 == ((double) (var_1_9 + var_1_10))) : 1)) && (var_1_11 == ((double) var_1_3))
;
}
int main(void) {
	isInitial = 1;
