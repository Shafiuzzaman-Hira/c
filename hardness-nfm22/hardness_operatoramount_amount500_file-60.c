...
void step(void) {
	...
	if ((min (last_1_var_1_69 , var_1_12)) >= (min (last_1_var_1_36 , (var_1_38 - var_1_29)))) {
		if (last_1_var_1_106 >= var_1_37) {
			var_1_42 = ((min (last_1_var_1_94 , (var_1_43 - var_1_39))) + var_1_8);
		} else {
	...
	signed long int stepLocal_3 = abs (var_1_94);
	...
	if (var_1_74) {
		...
		if ((min (var_1_37 , var_1_101)) > ((max (var_1_8 , 5)) - var_1_12)) {
	...
	if (stepLocal_1 >= (var_1_33 + (max (var_1_8 , var_1_94)))) {
		var_1_11 = var_1_13;
	}
	...
	if (! var_1_13) {
		var_1_35 = (max ((min (var_1_28 , var_1_42)) , var_1_95));
	} else {
		var_1_35 = (abs (max (var_1_12 , var_1_95)));
	}


	// From: Req26Batch60Amount500
	signed long int stepLocal_20 = min (var_1_100 , (var_1_35 + var_1_55));
	if (stepLocal_20 == (var_1_47 & last_1_var_1_69)) {
		var_1_69 = (max (var_1_99 , ((var_1_8 - var_1_48) + var_1_106)));
	}
	...
	if (var_1_21 > (- var_1_25)) {
		var_1_81 = ((var_1_95 + var_1_70) + ((min (var_1_8 , var_1_82)) - var_1_63));
	}


	// From: Req1Batch60Amount500
	unsigned char stepLocal_0 = var_1_52 <= (max (var_1_72 , var_1_34));
	if (var_1_11) {
		if (var_1_97 && stepLocal_0) {
			if (var_1_52 >= var_1_34) {
				var_1_1 = (var_1_100 - (var_1_8 - var_1_26));
			} else {
				var_1_1 = ((max (var_1_26 , var_1_67)) + -1);
			}
		} else {
	...
	if (((var_1_15 + var_1_22) / 50.5f) < var_1_23) {
		if (! (var_1_15 >= var_1_25)) {
			...
			if (stepLocal_6 >= var_1_12) {
				if (var_1_31) {
					var_1_40 = ((var_1_29 + (max (var_1_87 , var_1_28))) + var_1_27);
				}
			} else {
	...
	if (var_1_80 == (var_1_21 / var_1_17)) {
		...
		if (stepLocal_8 == var_1_37) {
			var_1_51 = (var_1_37 + (max ((max (var_1_39 , var_1_29)) , var_1_100)));
		} else {
			var_1_51 = (var_1_39 - (min (var_1_104 , last_1_var_1_51)));
		}
	}
	...
	if (stepLocal_13 >= ((abs (var_1_38)) % (max (var_1_8 , var_1_55)))) {
		var_1_57 = var_1_94;
	}
	...
	if (stepLocal_14 > (max (var_1_57 , var_1_94))) {
		if (var_1_73) {
			var_1_60 = var_1_44;
		}
	}
	...
	// From: Req55Batch60Amount500
	signed long int stepLocal_33 = min (var_1_60 , var_1_51);
	...
	if (var_1_22 >= var_1_88) {
		if (stepLocal_10 && ((16 > last_1_var_1_54) && var_1_96)) {
			var_1_54 = ((max (var_1_27 , -32)) + var_1_60);
		} else {
		...
		if (stepLocal_11 > var_1_104) {
			if (stepLocal_12 <= (var_1_48 - var_1_28)) {
				var_1_54 = ((abs (abs (var_1_46))) + (max (var_1_49 , (var_1_48 - var_1_26))));
			} else {
	...
	if (stepLocal_23 == var_1_62) {
		if (var_1_12 == stepLocal_25) {
			...
			var_1_77 = (var_1_35 + ((abs (var_1_43)) - (min (var_1_87 , var_1_48))));
		}
	} else {
		if (((max (var_1_105 , var_1_48)) * var_1_66) == stepLocal_24) {
			if (var_1_93 || stepLocal_22) {
				var_1_77 = (((abs (var_1_43)) - var_1_87) + (min (var_1_12 , var_1_44)));
			} else {
...
int property() {
	return ((((((((((((((((((((((((((((((((((((((((((((((((((((((var_1_11 ? ((var_1_97 && (var_1_52 <= (max (var_1_72 , var_1_34)))) ? ((var_1_52 >= var_1_34) ? (var_1_1 == ((signed short int) (var_1_100 - (var_1_8 - var_1_26)))) : (var_1_1 == ((signed short int) ((max (var_1_26 , var_1_67)) + -1)))) : (var_1_1 == ((signed short int) (var_1_67 + var_1_26)))) : 1) && ((((32 % var_1_12) * var_1_104) >= (var_1_33 + (max (var_1_8 , var_1_94)))) ? (var_1_11 == ((unsigned char) var_1_13)) : 1)) && ((var_1_12 < var_1_85) ? ((var_1_103 >= ((var_1_103 + var_1_103) / var_1_15)) ? (var_1_14 == ((double) var_1_16)) : ((var_1_8 == (abs (var_1_94))) ? (var_1_14 == ((double) var_1_16)) : 1)) : (var_1_14 == ((double) ((var_1_17 - 9.75) - 31.25))))) && (((var_1_87 % var_1_12) >= var_1_95) ? (var_1_18 == ((double) (var_1_19 + var_1_20))) : ((! var_1_13) ? ((128.7 <= var_1_80) ? (var_1_18 == ((double) (max (var_1_17 , (var_1_20 + var_1_19))))) : (var_1_18 == ((double) ((var_1_21 + var_1_22) + (abs (var_1_20)))))) : (var_1_18 == ((double) 200.125))))) && (var_1_90 ? ((var_1_103 >= var_1_22) ? (var_1_23 == ((float) (var_1_17 - var_1_24))) : 1) : (((- var_1_52) < var_1_103) ? (var_1_23 == ((float) ((max (var_1_25 , var_1_17)) - var_1_24))) : (var_1_23 == ((float) 5.2f))))) && ((last_1_var_1_14 <= last_1_var_1_14) ? (last_1_var_1_96 ? (var_1_26 == ((unsigned char) (var_1_27 + (max (var_1_28 , var_1_29))))) : 1) : (var_1_26 == ((unsigned char) var_1_27)))) && ((((var_1_25 - var_1_17) <= var_1_20) && var_1_96) ? (var_1_30 == ((unsigned char) ((! var_1_13) || var_1_31))) : (var_1_30 == ((unsigned char) (! 0))))) && (((-10 % 5) > var_1_28) ? (var_1_32 == ((signed long int) (max (var_1_27 , ((var_1_29 + var_1_28) - var_1_8))))) : (var_1_32 == ((signed long int) (var_1_29 - var_1_42))))) && (var_1_33 == ((signed short int) (var_1_12 - (var_1_44 + var_1_89))))) && ((((var_1_67 - var_1_28) < (var_1_42 & var_1_27)) && var_1_31) ? (var_1_34 == ((float) (var_1_24 - var_1_17))) : (var_1_34 == ((float) (var_1_19 + var_1_22))))) && ((! var_1_13) ? (var_1_35 == ((unsigned short int) (max ((min (var_1_28 , var_1_42)) , var_1_95)))) : (var_1_35 == ((unsigned short int) (abs (max (var_1_12 , var_1_95))))))) && (((var_1_100 + var_1_8) < (var_1_99 & var_1_12)) ? (var_1_36 == ((signed char) (max (var_1_37 , (var_1_38 - var_1_39))))) : (var_1_36 == ((signed char) (max ((abs (var_1_38)) , (var_1_39 - 5))))))) && ((((var_1_15 + var_1_22) / 50.5f) < var_1_23) ? ((! (var_1_15 >= var_1_25)) ? ((var_1_88 > -0.06f) ? (var_1_40 == ((unsigned long int) (var_1_89 + (var_1_29 + var_1_28)))) : (var_1_40 == ((unsigned long int) (5u + var_1_28)))) : (((25u ^ var_1_27) >= var_1_12) ? (var_1_31 ? (var_1_40 == ((unsigned long int) ((var_1_29 + (max (var_1_87 , var_1_28))) + var_1_27))) : 1) : (var_1_40 == ((unsigned long int) (var_1_35 + var_1_87))))) : (var_1_40 == ((unsigned long int) (abs (var_1_28 + (abs (var_1_29)))))))) && (((min (last_1_var_1_69 , var_1_12)) >= (min (last_1_var_1_36 , (var_1_38 - var_1_29)))) ? ((last_1_var_1_106 >= var_1_37) ? (var_1_42 == ((unsigned long int) ((min (last_1_var_1_94 , (var_1_43 - var_1_39))) + var_1_8))) : (var_1_42 == ((unsigned long int) (min (var_1_43 , (min (1u , var_1_39))))))) : 1)) && (var_1_74 ? (var_1_44 == ((unsigned char) 25)) : (((min (var_1_37 , var_1_101)) > ((max (var_1_8 , 5)) - var_1_12)) ? (var_1_44 == ((unsigned char) (var_1_46 - ((var_1_47 - 2) + (min (var_1_48 , var_1_49)))))) : 1))) && ((var_1_28 == var_1_39) ? (var_1_50 == ((double) var_1_16)) : 1)) && ((var_1_80 == (var_1_21 / var_1_17)) ? (var_1_51 == ((signed long int) (var_1_38 + var_1_69))) : ((var_1_44 == var_1_37) ? (var_1_51 == ((signed long int) (var_1_37 + (max ((max (var_1_39 , var_1_29)) , var_1_100))))) : (var_1_51 == ((signed long int) (var_1_39 - (min (var_1_104 , last_1_var_1_51)))))))) && ((last_1_var_1_94 > last_1_var_1_81) ? (var_1_13 ? ((last_1_var_1_52 > (var_1_17 - var_1_24)) ? (var_1_52 == ((double) (var_1_19 + var_1_21))) : 1) : (var_1_52 == ((double) var_1_19))) : (var_1_31 ? (var_1_52 == ((double) (min (var_1_16 , var_1_24)))) : 1))) && ((var_1_22 >= var_1_88) ? ((var_1_13 && ((16 > last_1_var_1_54) && var_1_96)) ? (var_1_54 == ((signed long int) ((max (var_1_27 , -32)) + var_1_60))) : (var_1_54 == ((signed long int) ((var_1_49 - (var_1_55 - var_1_28)) + (var_1_12 + var_1_38))))) : ((((var_1_28 % var_1_47) / var_1_12) > var_1_104) ? ((var_1_83 <= (var_1_48 - var_1_28)) ? (var_1_54 == ((signed long int) ((abs (abs (var_1_46))) + (max (var_1_49 , (var_1_48 - var_1_26)))))) : (var_1_54 == ((signed long int) (10 - var_1_55)))) : (var_1_54 == ((signed long int) ((var_1_8 + var_1_49) - var_1_104)))))) && ((((var_1_94 ^ var_1_35) * (var_1_62 % var_1_46)) >= ((abs (var_1_38)) % (max (var_1_8 , var_1_55)))) ? (var_1_57 == ((signed short int) var_1_94)) : 1)) && ((((var_1_61 - var_1_29) % var_1_8) > (max (var_1_57 , var_1_94))) ? (var_1_73 ? (var_1_60 == ((signed short int) var_1_44)) : 1) : 1)) && ((var_1_48 > var_1_47) ? (((var_1_31 || var_1_74) && (! var_1_75)) ? (var_1_62 == ((signed char) ((var_1_49 + var_1_48) - var_1_47))) : 1) : ((var_1_38 >= var_1_87) ? (var_1_62 == ((signed char) (var_1_48 + ((var_1_63 - var_1_64) + (min (0 , var_1_65)))))) : (var_1_62 == ((signed char) (var_1_39 - (max (var_1_49 , var_1_48)))))))) && ((4 <= (var_1_87 & var_1_106)) ? (var_1_66 == ((unsigned long int) 256u)) : (var_1_66 == ((unsigned long int) last_1_var_1_66)))) && (((var_1_21 >= last_1_var_1_80) || last_1_var_1_90) ? (((last_1_var_1_50 + last_1_var_1_34) <= 100.25) ? (var_1_67 == ((unsigned char) var_1_27)) : 1) : 1)) && (((var_1_27 & var_1_39) <= var_1_49) ? (var_1_68 == ((signed char) (var_1_49 - var_1_47))) : (((var_1_46 + var_1_55) > (var_1_8 - var_1_94)) ? (var_1_68 == ((signed char) (min ((min (var_1_38 , (var_1_64 + var_1_65))) , (var_1_49 - var_1_63))))) : (var_1_68 == ((signed char) (min (((min (var_1_64 , var_1_49)) + var_1_65) , (abs (var_1_39 - var_1_47))))))))) && (((min (var_1_100 , (var_1_35 + var_1_55))) == (var_1_47 & last_1_var_1_69)) ? (var_1_69 == ((signed long int) (max (var_1_99 , ((var_1_8 - var_1_48) + var_1_106))))) : 1)) && ((var_1_25 <= (- (var_1_23 * 100.5f))) ? (((- var_1_14) <= (var_1_52 * var_1_88)) ? (var_1_70 == ((unsigned short int) (var_1_71 - (var_1_8 - var_1_48)))) : (var_1_70 == ((unsigned short int) (min ((max ((var_1_8 + var_1_48) , var_1_27)) , var_1_47))))) : (var_1_70 == ((unsigned short int) var_1_27)))) && (var_1_30 ? (var_1_72 == ((double) var_1_21)) : (var_1_72 == ((double) (var_1_24 - 5.8))))) && ((var_1_16 != (var_1_18 / var_1_17)) ? (var_1_73 == ((unsigned char) ((! (var_1_91 && var_1_31)) && (! 0)))) : 1)) && ((128.125f <= (last_1_var_1_50 / var_1_15)) ? (var_1_74 == ((unsigned char) (! (last_1_var_1_73 || var_1_13)))) : (last_1_var_1_96 ? (var_1_74 == ((unsigned char) var_1_31)) : (var_1_74 == ((unsigned char) (! (! var_1_13))))))) && ((var_1_74 && var_1_30) ? (var_1_75 == ((unsigned char) (var_1_13 && var_1_76))) : (var_1_75 == ((unsigned char) var_1_76)))) && (((var_1_51 / var_1_46) == var_1_62) ? ((var_1_12 == (var_1_36 & var_1_51)) ? (var_1_77 == ((unsigned long int) var_1_29)) : (var_1_77 == ((unsigned long int) (var_1_35 + ((abs (var_1_43)) - (min (var_1_87 , var_1_48))))))) : ((((max (var_1_105 , var_1_48)) * var_1_66) == var_1_33) ? ((var_1_93 || (var_1_12 >= var_1_107)) ? (var_1_77 == ((unsigned long int) (((abs (var_1_43)) - var_1_87) + (min (var_1_12 , var_1_44))))) : (var_1_77 == ((unsigned long int) (var_1_78 - var_1_66)))) : (var_1_77 == ((unsigned long int) ((var_1_79 - var_1_71) - (var_1_39 + var_1_28))))))) && ((var_1_63 < var_1_67) ? (var_1_75 ? (var_1_80 == ((float) var_1_19)) : 1) : (var_1_80 == ((float) var_1_17)))) && ((var_1_21 > (- var_1_25)) ? (var_1_81 == ((unsigned short int) ((var_1_95 + var_1_70) + ((min (var_1_8 , var_1_82)) - var_1_63)))) : 1)) && ((var_1_22 < var_1_18) ? (var_1_83 == ((unsigned short int) ((var_1_84 - var_1_39) - var_1_27))) : 1)) && (((var_1_94 + (var_1_79 / -1)) <= (var_1_105 + var_1_28)) ? (var_1_85 == ((signed char) ((min (var_1_86 , (min (var_1_48 , var_1_49)))) + 25))) : ((var_1_16 >= var_1_88) ? (var_1_85 == ((signed char) (min (var_1_38 , var_1_65)))) : (var_1_85 == ((signed char) (max (-64 , (abs (var_1_86))))))))) && (var_1_30 ? (var_1_87 == ((unsigned char) (var_1_63 + var_1_47))) : (var_1_87 == ((unsigned char) var_1_27)))) && ((((var_1_47 << last_1_var_1_54) + 256u) >= (var_1_78 - var_1_12)) ? ((var_1_12 <= last_1_var_1_26) ? (var_1_88 == ((double) (var_1_21 + var_1_22))) : (var_1_88 == ((double) (abs (max ((min (var_1_21 , var_1_20)) , var_1_22)))))) : (var_1_88 == ((double) 7.25)))) && ((var_1_50 > var_1_34) ? (var_1_89 == ((unsigned short int) (5 + (min (var_1_63 , var_1_28))))) : ((var_1_27 > (var_1_32 / var_1_47)) ? (var_1_89 == ((unsigned short int) (abs (var_1_28)))) : 1))) && (var_1_75 ? ((var_1_47 > var_1_44) ? (var_1_90 == ((unsigned char) (! var_1_13))) : 1) : (var_1_90 == ((unsigned char) (((! var_1_31) && var_1_13) && var_1_76))))) && ((var_1_28 < last_1_var_1_104) ? ((last_1_var_1_102 && last_1_var_1_96) ? (var_1_91 == ((unsigned char) var_1_31)) : (var_1_91 == ((unsigned char) var_1_13))) : 1)) && (var_1_90 ? (var_1_93 == ((unsigned char) var_1_13)) : (var_1_93 == ((unsigned char) var_1_13)))) && (var_1_94 == ((unsigned char) var_1_28))) && (var_1_90 ? (var_1_95 == ((unsigned char) var_1_29)) : (var_1_95 == ((unsigned char) var_1_29)))) && (var_1_96 == ((unsigned char) var_1_76))) && (var_1_31 ? (var_1_97 == ((unsigned char) var_1_98)) : 1)) && (var_1_74 ? (var_1_99 == ((signed char) var_1_86)) : (var_1_99 == ((signed char) var_1_49)))) && (var_1_102 ? (var_1_100 == ((unsigned char) 2)) : 1)) && (var_1_102 ? (var_1_101 == ((unsigned short int) var_1_12)) : (var_1_101 == ((unsigned short int) 25)))) && (var_1_31 ? (var_1_102 == ((unsigned char) var_1_13)) : 1)) && (var_1_31 ? (var_1_103 == ((float) var_1_24)) : (var_1_103 == ((float) var_1_17)))) && (var_1_91 ? (var_1_104 == ((signed char) var_1_49)) : 1)) && (var_1_105 == ((unsigned short int) var_1_64))) && (var_1_97 ? (var_1_106 == ((unsigned char) 8)) : (var_1_106 == ((unsigned char) var_1_48)))) && (((var_1_65 * 256) <= var_1_35) ? ((var_1_38 < var_1_63) ? ((last_1_var_1_107 > (min (var_1_60 , var_1_51))) ? (var_1_107 == ((signed char) var_1_38)) : (var_1_107 == ((signed char) var_1_65))) : (var_1_107 == ((signed char) var_1_47))) : 1)
;
}
int main(void) {
	isInitial = 1;
