...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch65dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch65dependencies
	if (last_1_var_1_23 < last_1_var_1_23) {
		if ((! (last_1_var_1_14 || last_1_var_1_14)) && last_1_var_1_24) {
	...
	// From: Req5Batch65dependencies
	var_1_20 = (var_1_21 - (var_1_22 + 1.5));


	// From: Req8Batch65dependencies
	var_1_28 = var_1_21;


	// From: Req1Batch65dependencies
	if ((var_1_23 <= var_1_23) || (var_1_23 > 4)) {
	...
	// From: Req7Batch65dependencies
	var_1_24 = ((var_1_1 <= (var_1_25 - var_1_26)) && var_1_27);


	// From: Req3Batch65dependencies
	if (var_1_16 > (var_1_23 + (var_1_16 ^ var_1_16))) {
		var_1_14 = (var_1_24 || var_1_15);
	}


	// From: Req2Batch65dependencies
	if (var_1_14) {
		if (var_1_24) {
