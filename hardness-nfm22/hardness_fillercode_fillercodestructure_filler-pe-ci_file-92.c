...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch92Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch92Filler_PE_CI
	var_1_17 = (4 - (min (var_1_18 , (var_1_19 - 1))));


	// From: Req6Batch92Filler_PE_CI
	...
	// From: CodeObject3
	if (var_1_16 < 2) {
		var_1_30 = ((max ((max (var_1_26 , var_1_19)) , var_1_12)) + var_1_19);
	} else {
		var_1_30 = var_1_26;
	}
	...
	if (var_1_12 >= var_1_11) {
		if (var_1_11 > ((min (var_1_9 , -2)) | var_1_19)) {
