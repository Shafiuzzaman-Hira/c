...
void step(void) {
 ...
 if (var_1_2 == stepLocal_0) {
  ...
  var_1_1 = ((var_1_7 - var_1_8) + ((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9))));
 }
}
...
int property() {
 return ((var_1_2 == (var_1_3 / var_1_4)) ? (var_1_1 == ((signed short int) (var_1_9 + var_1_9))) : (var_1_1 == ((signed short int) ((var_1_7 - var_1_8) + ((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9))))))) && (var_1_9 == ((signed char) 8))
;
}
int main(void) {
 isInitial = 1;
