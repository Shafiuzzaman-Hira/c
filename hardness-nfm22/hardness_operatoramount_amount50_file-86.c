...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch86Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch86Amount50
	if (var_1_19) {
		var_1_6 = (last_1_var_1_6 || var_1_9);
	}


	// From: Req1Batch86Amount50
	...
	// From: Req7Batch86Amount50
	var_1_22 = var_1_15;


	// From: Req5Batch86Amount50
