...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch39PS_CN_25.c", 13, "reach_error"); }
...
double var_1_43 = 0.0;
double var_1_44 = 100000000.2;
double var_1_45 = 999999.2;
...
void step(void) {
	...
	if (var_1_32 < var_1_31) {
		if (var_1_32 < ((var_1_43 - var_1_44) - var_1_45)) {
			var_1_42 = var_1_33;
		}
	}


	// From: Req1Batch39PS_CN_25
	...
	// From: Req7Batch39PS_CN_25
	var_1_24 = var_1_25;


	// From: Req8Batch39PS_CN_25
	var_1_26 = var_1_8;


	// From: Req3Batch39PS_CN_25
	var_1_10 = (min ((abs (var_1_11 - var_1_8)) , (max (0u , var_1_26))));


	// From: Req4Batch39PS_CN_25
...
void updateVariables() {
	...
	assume_abort_if_not((var_1_44 >= 0.0F && var_1_44 <= -1.0e-20F) || (var_1_44 <= 4611686.018427387900e+12F && var_1_44 >= 1.0e-20F ));
