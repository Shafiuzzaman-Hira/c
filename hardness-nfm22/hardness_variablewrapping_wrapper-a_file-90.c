...
void step(void) {
	// From: Req2Batch90Wrapper_A
	unsigned long int stepLocal_1 = unsigned_long_int_Array_0[1] - unsigned_long_int_Array_0[0];
	signed long int stepLocal_0 = min (signed_short_int_Array_0[0][2] , signed_short_int_Array_0[0][1]);
	...
	// From: Req4Batch90Wrapper_A
	signed_short_int_Array_0[0][0] = (max (signed_short_int_Array_0[0][2] , (signed_short_int_Array_0[1][0] - 256)));


	// From: Req1Batch90Wrapper_A
	if (BOOL_unsigned_char_Array_0[2]) {
		signed_short_int_Array_0[1][2] = (min ((signed_short_int_Array_0[0][2] + signed_short_int_Array_0[1][1]) , signed_short_int_Array_0[0][1]));
	}
}
...
int property() {
	return ((((BOOL_unsigned_char_Array_0[2] ? (signed_short_int_Array_0[1][2] == ((signed short int) (min ((signed_short_int_Array_0[0][2] + signed_short_int_Array_0[1][1]) , signed_short_int_Array_0[0][1])))) : 1) && ((last_1_signed_short_int_Array_0_0__0_ != (min (signed_short_int_Array_0[0][2] , signed_short_int_Array_0[0][1]))) ? (((unsigned_long_int_Array_0[1] - unsigned_long_int_Array_0[0]) >= last_1_signed_long_int_Array_0_0_) ? (last_1_BOOL_unsigned_char_Array_0_2_ ? (unsigned_long_int_Array_0[2] == ((unsigned long int) unsigned_long_int_Array_0[0])) : (unsigned_long_int_Array_0[2] == ((unsigned long int) unsigned_long_int_Array_0[0]))) : (unsigned_long_int_Array_0[2] == ((unsigned long int) unsigned_long_int_Array_0[0]))) : (unsigned_long_int_Array_0[2] == ((unsigned long int) unsigned_long_int_Array_0[0])))) && (BOOL_unsigned_char_Array_0[4] ? (BOOL_unsigned_char_Array_0[2] == ((unsigned char) (BOOL_unsigned_char_Array_0[3] || (! BOOL_unsigned_char_Array_0[0])))) : (BOOL_unsigned_char_Array_0[2] == ((unsigned char) ((! BOOL_unsigned_char_Array_0[1]) || BOOL_unsigned_char_Array_0[0]))))) && (signed_short_int_Array_0[0][0] == ((signed short int) (max (signed_short_int_Array_0[0][2] , (signed_short_int_Array_0[1][0] - 256)))))) && ((unsigned_long_int_Array_0[2] <= unsigned_long_int_Array_0[1]) ? ((signed_short_int_Array_0[1][0] > unsigned_long_int_Array_0[2]) ? (signed_long_int_Array_0[0] == ((signed long int) signed_short_int_Array_0[1][0])) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
