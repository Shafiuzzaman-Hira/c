...
void step(void) {
	// From: Req1Batch96Wrapper_AP
	if (! last_1_BOOL_unsigned_char_Array_0_3_) {
		(*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var2_Pointer)) = (min ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)) , (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer))));
	} else {
