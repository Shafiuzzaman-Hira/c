...
void step(void) {
 ...
 if (var_1_44 != (var_1_35 * var_1_58)) {
  var_1_62 = ((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51)));
 }
 if (var_1_60) {
  if (var_1_26 < var_1_44) {
   if (-64 > var_1_27) {
    var_1_63 = (((((((((var_1_54 + var_1_52)) < (var_1_48)) ? ((var_1_54 + var_1_52)) : (var_1_48)))) < (((((var_1_58) < 0 ) ? -(var_1_58) : (var_1_58))))) ? ((((((var_1_54 + var_1_52)) < (var_1_48)) ? ((var_1_54 + var_1_52)) : (var_1_48)))) : (((((var_1_58) < 0 ) ? -(var_1_58) : (var_1_58))))));
   } else {
    if (var_1_49 > var_1_32) {
     var_1_63 = ((((((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52)))) < (((((var_1_64 - var_1_51) < 0 ) ? -(var_1_64 - var_1_51) : (var_1_64 - var_1_51))))) ? (((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52)))) : (((((var_1_64 - var_1_51) < 0 ) ? -(var_1_64 - var_1_51) : (var_1_64 - var_1_51))))));
    } else {
     if ((var_1_35 & var_1_29) < var_1_54) {
      var_1_63 = (((((var_1_64) < 0 ) ? -(var_1_64) : (var_1_64))) - var_1_27);
     } else {
      var_1_63 = (((((var_1_27) > (var_1_55)) ? (var_1_27) : (var_1_55))) + 32);
     }
    }
   }
  }
 } else {
  var_1_63 = ((((var_1_64) < (((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52))))) ? (var_1_64) : (((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52))))));
 }
 if (var_1_50 < var_1_31) {
  var_1_65 = var_1_55;
 }
 if ((- var_1_25) >= var_1_67) {
  var_1_66 = (((((var_1_25) < (var_1_55)) ? (var_1_25) : (var_1_55))) - var_1_27);
 } else {
  var_1_66 = (((((((((var_1_68) < (var_1_44)) ? (var_1_68) : (var_1_44)))) < (var_1_55)) ? (((((var_1_68) < (var_1_44)) ? (var_1_68) : (var_1_44)))) : (var_1_55))) + (((((var_1_62) < (var_1_57)) ? (var_1_62) : (var_1_57))) - var_1_25));
 }
 if (var_1_60) {
  var_1_69 = (((((var_1_57) < 0 ) ? -(var_1_57) : (var_1_57))) + var_1_64);
 } else {
  var_1_69 = ((((var_1_57) < (var_1_51)) ? (var_1_57) : (var_1_51)));
 }
 if (8 < var_1_58) {
  var_1_70 = ((((((((var_1_71) < 0 ) ? -(var_1_71) : (var_1_71))) - ((((var_1_64) < (var_1_62)) ? (var_1_64) : (var_1_62)))) < 0 ) ? -(((((var_1_71) < 0 ) ? -(var_1_71) : (var_1_71))) - ((((var_1_64) < (var_1_62)) ? (var_1_64) : (var_1_62)))) : (((((var_1_71) < 0 ) ? -(var_1_71) : (var_1_71))) - ((((var_1_64) < (var_1_62)) ? (var_1_64) : (var_1_62))))));
 }
 if (var_1_39 <= ((((var_1_43) < (var_1_49)) ? (var_1_43) : (var_1_49)))) {
  var_1_72 = (! var_1_73);
 } else {
  if (((((var_1_55) < 0 ) ? -(var_1_55) : (var_1_55))) >= var_1_29) {
 ...
 if ((var_1_68 * -128) <= var_1_46) {
  if ((var_1_32 * 32.125f) >= ((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31)))) {
   var_1_76 = (((((((-64) < 0 ) ? -(-64) : (-64))) < 0 ) ? -((((-64) < 0 ) ? -(-64) : (-64))) : ((((-64) < 0 ) ? -(-64) : (-64)))));
  }
 } else {
  var_1_76 = var_1_62;
 }
 ...
 if (var_1_54 < var_1_82) {
  if (var_1_28 < var_1_51) {
   var_1_81 = ((((var_1_48) > (((((var_1_64) > (var_1_82)) ? (var_1_64) : (var_1_82))))) ? (var_1_48) : (((((var_1_64) > (var_1_82)) ? (var_1_64) : (var_1_82))))));
  } else {
   if (! var_1_73) {
    var_1_81 = var_1_51;
   }
