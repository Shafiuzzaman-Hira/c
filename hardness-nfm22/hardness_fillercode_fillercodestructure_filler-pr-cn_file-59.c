...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch59Filler_PR_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch59Filler_PR_CN
	var_1_18 = var_1_16;


	// From: Req8Batch59Filler_PR_CN
	var_1_19 = var_1_4;
