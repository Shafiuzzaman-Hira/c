...
void step(void) {
	...
	// From: Req11Batch43Amount100
	var_1_30 = ((min ((var_1_31 + var_1_32) , (3305479224u - var_1_5))) - (abs (var_1_4)));


	// From: Req12Batch43Amount100
	var_1_33 = var_1_20;


	// From: Req13Batch43Amount100
	var_1_34 = var_1_22;


	// From: Req14Batch43Amount100
	var_1_35 = var_1_30;


	// From: Req7Batch43Amount100
	if (var_1_18 <= (~ var_1_4)) {
		if (var_1_28) {
