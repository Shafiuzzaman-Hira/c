...
void step(void) {
	...
	if (var_1_45) {
		if (var_1_55) {
			...
			var_1_90 = (abs (9.99999999999995E13f));
		}
	} else {
		var_1_90 = (abs (var_1_59));
	}
	...
	// From: Req3Batch73PS_CN_250
	if ((max ((last_1_var_1_19 / 2) , (~ last_1_var_1_16))) <= var_1_10) {
		var_1_12 = var_1_8;
	}


	// From: Req1Batch73PS_CN_250
	...
	// From: Req5Batch73PS_CN_250
	if (var_1_3 >= (last_1_var_1_12 * var_1_4)) {
		var_1_16 = var_1_18;
	}


	// From: Req7Batch73PS_CN_250
	var_1_22 = (abs (var_1_18));


	// From: Req8Batch73PS_CN_250
	if (var_1_1 > var_1_5) {
	...
	// From: Req9Batch73PS_CN_250
	var_1_26 = var_1_25;


	// From: Req4Batch73PS_CN_250
