...
void step(void) {
	...
	// From: CodeObject1
	if (var_1_6 < (min (var_1_6 , (var_1_13 >> var_1_5)))) {
		if (var_1_6 > var_1_6) {
			var_1_25 = var_1_8;
		} else {
			if (((var_1_5 ^ var_1_13) >> var_1_6) > (abs (var_1_6))) {
				var_1_25 = (abs (var_1_6));
			}
		}
	} else {
		if ((var_1_5 - var_1_6) <= (~ (var_1_32 - var_1_8))) {
			var_1_25 = (max (var_1_8 , var_1_6));
		} else {
			var_1_25 = -32;
		}
	}
	...
	// From: CodeObject4
	if ((var_1_11 / (max (var_1_42 , 256.5))) < var_1_12) {
		var_1_41 = var_1_5;
	}
	...
	// From: CodeObject5
	if (((min (var_1_19 , var_1_11)) >= (var_1_12 / var_1_42)) || var_1_16) {
