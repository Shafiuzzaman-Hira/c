...
void step(void) {
	...
	if ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) > stepLocal_1) {
		(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) = ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)) + (max (-4 , (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)))));
	} else {
	...
	// From: Req4Batch27Wrapper_AP
	signed long int stepLocal_2 = max (((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer))) , (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var5_Pointer)));
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer))) {
