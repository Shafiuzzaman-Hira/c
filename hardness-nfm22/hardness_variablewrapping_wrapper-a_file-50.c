...
void step(void) {
	...
	if (stepLocal_1 >= 0) {
		signed_short_int_Array_0[0][0] = (max (signed_short_int_Array_0[1][0] , signed_short_int_Array_0[0][2]));
	} else {
		signed_short_int_Array_0[0][0] = (max (signed_short_int_Array_0[1][0] , (signed_short_int_Array_0[1][2] - (signed_short_int_Array_0[0][1] - signed_short_int_Array_0[1][1]))));
	}
	...
	signed long int stepLocal_0 = max (signed_short_int_Array_0[0][0] , signed_long_int_Array_0[0][1]);
	if ((min ((double_Array_0[1][1] + double_Array_0[0][1]) , (double_Array_0[1][0] - double_Array_0[0][0]))) != 31.9) {
...
int property() {
	return ((((min ((double_Array_0[1][1] + double_Array_0[0][1]) , (double_Array_0[1][0] - double_Array_0[0][0]))) != 31.9) ? (((max (signed_short_int_Array_0[0][0] , signed_long_int_Array_0[0][1])) < signed_long_int_Array_0[0][1]) ? (BOOL_unsigned_char_Array_0[0][0] ? (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) BOOL_unsigned_char_Array_0[1][0])) : (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) BOOL_unsigned_char_Array_0[1][0]))) : (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) BOOL_unsigned_char_Array_0[1][0]))) : (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) BOOL_unsigned_char_Array_0[0][1]))) && ((last_1_signed_long_int_Array_0_0__1_ >= 0) ? (signed_short_int_Array_0[0][0] == ((signed short int) (max (signed_short_int_Array_0[1][0] , signed_short_int_Array_0[0][2])))) : (signed_short_int_Array_0[0][0] == ((signed short int) (max (signed_short_int_Array_0[1][0] , (signed_short_int_Array_0[1][2] - (signed_short_int_Array_0[0][1] - signed_short_int_Array_0[1][1])))))))) && ((signed_short_int_Array_0[0][0] > (signed_short_int_Array_0[1][2] - signed_long_int_Array_0[1][1])) ? ((signed_short_int_Array_0[1][0] < signed_short_int_Array_0[0][0]) ? (signed_long_int_Array_0[0][1] == ((signed long int) ((signed_short_int_Array_0[1][1] + (signed_short_int_Array_0[0][1] + signed_long_int_Array_0[0][0])) - signed_long_int_Array_0[1][0]))) : 1) : (signed_long_int_Array_0[0][1] == ((signed long int) signed_short_int_Array_0[0][2])))
;
}
int main(void) {
	isInitial = 1;
