...
void step(void) {
	...
	// From: Req2Batch77Filler_PE_CO
	if ((- var_1_7) < (var_1_1 * var_1_4)) {
		var_1_8 = var_1_9;
	}


	// From: Req4Batch77Filler_PE_CO
	...
	// From: Req3Batch77Filler_PE_CO
	var_1_10 = (50 + ((var_1_11 + 10000) - var_1_12));


	// From: Req6Batch77Filler_PE_CO
	...
	if (var_1_1 >= (var_1_10 & (var_1_22 >> var_1_8))) {
		var_1_24 = (var_1_22 - (abs (var_1_1)));
	} else {
		if (var_1_1 > (var_1_10 ^ var_1_22)) {
			var_1_24 = (min (var_1_1 , var_1_10));
		}
	}
	...
	// From: CodeObject6
	if ((max (var_1_1 , var_1_10)) > var_1_32) {
		if (! var_1_15) {
			if (var_1_15) {
