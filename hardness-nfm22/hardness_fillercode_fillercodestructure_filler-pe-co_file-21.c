...
void step(void) {
	...
	// From: Req2Batch21Filler_PE_CO
	var_1_8 = (((var_1_7 + var_1_6) + var_1_12) + (var_1_10 - var_1_12));


	// From: Req1Batch21Filler_PE_CO
