...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch62Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_31 = var_1_30;
 if (var_1_19 <= var_1_19) {
  var_1_32 = (((((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8))) < 0 ) ? -((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8))) : ((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8)))));
 }
 ...
 if (var_1_12 < ((((var_1_6) < (var_1_7)) ? (var_1_6) : (var_1_7)))) {
