...
void step(void) {
	...
	if ((-32 & var_1_15) > var_1_11) {
		var_1_40 = (max (var_1_21 , var_1_19));
	} else {
	...
	if (var_1_21 < var_1_22) {
		...
		var_1_49 = (max ((min (var_1_50 , var_1_51)) , var_1_28));
	}
	...
	if ((var_1_30 ^ var_1_32) < (var_1_13 | var_1_11)) {
		var_1_33 = (max (var_1_15 , var_1_15));
	} else {
		var_1_33 = (abs (min (var_1_15 , var_1_15)));
	}
}
