...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch39Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_50 = var_1_51;
 var_1_24 = var_1_25;
 if ((var_1_37 % ((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41)))) >= (var_1_1 * var_1_39)) {
