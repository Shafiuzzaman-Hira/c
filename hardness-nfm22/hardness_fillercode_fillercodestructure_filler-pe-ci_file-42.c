...
void step(void) {
	...
	// From: Req7Batch42Filler_PE_CI
	if (var_1_14 <= var_1_15) {
		var_1_19 = (var_1_12 || var_1_20);
	}


	// From: Req2Batch42Filler_PE_CI
	if (var_1_5 >= -2) {
		var_1_6 = (var_1_7 - 100);
	}


	// From: Req4Batch42Filler_PE_CI
	...
	// From: CodeObject3
	if ((- var_1_15) < (max (var_1_14 , var_1_16))) {
		var_1_30 = var_1_16;
	}


	// From: CodeObject4
	if ((min ((abs (var_1_7)) , var_1_5)) <= var_1_1) {
		var_1_31 = var_1_7;
	}


	// From: CodeObject5
	if (var_1_6 < (abs (var_1_13))) {
		var_1_34 = (max ((abs (var_1_6)) , var_1_7));
	}
