...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch5Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_4 <= (((((var_1_12) < (var_1_5)) ? (var_1_12) : (var_1_5))) >> (var_1_26 - var_1_27))) {
  var_1_22 = ((((var_1_5) > (var_1_12)) ? (var_1_5) : (var_1_12)));
 } else {
  var_1_22 = var_1_5;
 }
 if (8.4 <= var_1_16) {
  var_1_28 = (((((((var_1_1) < (var_1_12)) ? (var_1_1) : (var_1_12))) < 0 ) ? -((((var_1_1) < (var_1_12)) ? (var_1_1) : (var_1_12))) : ((((var_1_1) < (var_1_12)) ? (var_1_1) : (var_1_12)))));
 } else {
  var_1_28 = ((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)));
 }
 if (var_1_18 == ((((32.5) < (var_1_17)) ? (32.5) : (var_1_17)))) {
  var_1_30 = var_1_27;
 } else {
  if (var_1_4 < var_1_6) {
   if (var_1_27 < var_1_6) {
 ...
 if (var_1_20) {
  var_1_32 = ((((var_1_5 + var_1_4) < 0 ) ? -(var_1_5 + var_1_4) : (var_1_5 + var_1_4)));
 }
 if (var_1_20) {
  if (var_1_20) {
   if (var_1_11 > var_1_5) {
   ...
   var_1_34 = (((((((((((var_1_17) < (var_1_18)) ? (var_1_17) : (var_1_18))) < 0 ) ? -((((var_1_17) < (var_1_18)) ? (var_1_17) : (var_1_18))) : ((((var_1_17) < (var_1_18)) ? (var_1_17) : (var_1_18)))))) < (var_1_18)) ? ((((((((var_1_17) < (var_1_18)) ? (var_1_17) : (var_1_18))) < 0 ) ? -((((var_1_17) < (var_1_18)) ? (var_1_17) : (var_1_18))) : ((((var_1_17) < (var_1_18)) ? (var_1_17) : (var_1_18)))))) : (var_1_18)));
  }
 }
 if (-256 < (var_1_4 * 10)) {
  if (var_1_17 >= var_1_16) {
   var_1_39 = (((((((((var_1_16) < (var_1_16)) ? (var_1_16) : (var_1_16)))) > (var_1_16)) ? (((((var_1_16) < (var_1_16)) ? (var_1_16) : (var_1_16)))) : (var_1_16))) - var_1_16);
  }
 } else {
  var_1_39 = var_1_16;
 }
