...
void step(void) {
	...
	// From: Req4Batch57has_floats
	var_1_17 = 128.91f;


	// From: Req2Batch57has_floats
...
int property() {
	return ((((! (last_1_var_1_14 >= last_1_var_1_9)) ? (((var_1_4 || var_1_5) && var_1_6) ? (var_1_1 == ((signed long int) (min (last_1_var_1_9 , last_1_var_1_14)))) : (var_1_1 == ((signed long int) last_1_var_1_14))) : (var_1_1 == ((signed long int) last_1_var_1_14))) && ((var_1_5 && var_1_4) ? ((var_1_6 || (var_1_14 == var_1_1)) ? (var_1_9 == ((signed char) (min (var_1_10 , var_1_11)))) : 1) : (var_1_9 == ((signed char) (var_1_12 - var_1_13))))) && ((var_1_12 < ((var_1_15 + var_1_16) - (max (64 , var_1_13)))) ? (var_1_14 == ((signed char) ((64 - var_1_16) - var_1_13))) : (var_1_14 == ((signed char) (min (var_1_10 , var_1_11)))))) && (var_1_17 == ((float) 128.91f))
;
}
int main(void) {
	isInitial = 1;
