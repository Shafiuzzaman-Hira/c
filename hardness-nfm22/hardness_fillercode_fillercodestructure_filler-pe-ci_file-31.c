...
void step(void) {
	// From: Req2Batch31Filler_PE_CI
	var_1_8 = (min ((var_1_5 + (64 - 16)) , 64));


	// From: Req4Batch31Filler_PE_CI
	...
	// From: Req6Batch31Filler_PE_CI
	var_1_17 = var_1_13;


	// From: Req7Batch31Filler_PE_CI
