...
void step(void) {
 ...
 if (! var_1_2) {
  if ((var_1_1 * ((((var_1_8) < (var_1_5)) ? (var_1_8) : (var_1_5)))) >= var_1_6) {
   var_1_12 = var_1_13;
  }
 } else {
  var_1_12 = 0;
