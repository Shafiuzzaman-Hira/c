...
void step(void) {
	...
	// From: CodeObject3
	var_1_36 = (abs ((min (64 , var_1_31)) + var_1_34));
	...
	if (var_1_38 > var_1_31) {
		...
		if (var_1_29 > var_1_38) {
			if (var_1_38 != (var_1_40 - (max (var_1_33 , var_1_36)))) {
				var_1_37 = (max (var_1_39 , var_1_41));
			} else {
				var_1_37 = (abs (abs (256.5f - var_1_42)));
			}
		} else {
			var_1_37 = var_1_39;
		}
	...
	// From: CodeObject5
	if ((abs (var_1_32)) < var_1_30) {
		if (var_1_33 <= 4) {
			var_1_43 = var_1_34;
		} else {
			var_1_43 = (abs (var_1_26));
		}
	} else {
		var_1_43 = (abs (min ((abs (var_1_30)) , var_1_35)));
	}


	// From: CodeObject6
	if ((abs (var_1_37)) > (max (var_1_41 , (abs (var_1_39))))) {
		var_1_44 = (4 + (abs (var_1_40)));
	} else {
	...
	// From: CodeObject7
	if (-0.5f < var_1_39) {
		var_1_45 = (abs (max ((var_1_31 + var_1_38) , var_1_40)));
	}
	...
	if (-1000000000 <= (var_1_27 | var_1_52)) {
		var_1_51 = (max (var_1_39 , var_1_41));
	} else {
	...
	// From: CodeObject12
	if (var_1_26 < (max ((var_1_35 + var_1_52) , (abs (var_1_28))))) {
		var_1_54 = (abs (var_1_33));
	}


	// From: CodeObject13
	if (var_1_48 || var_1_50) {
		var_1_55 = ((abs (var_1_33)) + (25 - (abs (var_1_34))));
	} else {
		var_1_55 = (var_1_35 - (min (var_1_33 , (max (var_1_34 , var_1_28)))));
	}


	// From: CodeObject14
	if (var_1_40 >= ((~ var_1_36) / (abs (var_1_57)))) {
		var_1_56 = (var_1_34 + var_1_35);
	} else {
		if (var_1_50) {
			var_1_56 = (abs (min (var_1_34 , var_1_35)));
		}
	}
	...
	if (var_1_23 >= (var_1_45 & (var_1_38 | var_1_26))) {
		...
		if (var_1_42 >= var_1_37) {
			var_1_58 = (min (var_1_33 , var_1_28));
		} else {
			var_1_58 = (max (var_1_25 , ((min (var_1_59 , 5)) + (var_1_34 - var_1_33))));
		}
	}
	...
	if (var_1_48) {
		if (var_1_49) {
			if (var_1_42 >= var_1_37) {
				var_1_60 = (min (var_1_33 , var_1_35));
			} else {
	...
	if (var_1_52 >= (var_1_43 & var_1_32)) {
		if (var_1_25 <= (var_1_31 ^ var_1_52)) {
			var_1_61 = (var_1_59 + (min (var_1_54 , var_1_47)));
		} else {
		...
		if (var_1_59 <= (~ var_1_31)) {
			var_1_61 = ((var_1_38 + (max (-1 , var_1_59))) + var_1_33);
		} else {
			var_1_61 = (abs (abs (var_1_28)));
		}
	}
	...
	if (var_1_46 <= var_1_60) {
		var_1_66 = (var_1_39 + (min (var_1_53 , var_1_67)));
	}


	// From: CodeObject21
	if (var_1_53 <= var_1_67) {
		var_1_68 = (abs (max ((min (var_1_26 , var_1_33)) , var_1_34)));
	}
	...
	if (var_1_58 <= var_1_60) {
		var_1_70 = (max ((var_1_34 + var_1_33) , (38981 - var_1_60)));
	} else {
		if (var_1_48) {
			var_1_70 = var_1_35;
		}
	...
	// From: CodeObject24
	if (-50 > var_1_57) {
		if (! (var_1_26 <= (abs (var_1_28)))) {
			var_1_71 = ((max (var_1_72 , (abs (var_1_73)))) - var_1_33);
		}
	}
	...
	if (var_1_68 > var_1_45) {
		var_1_74 = (min (var_1_41 , var_1_67));
	} else {
		var_1_74 = (min ((abs (64.5)) , (var_1_39 + (var_1_75 + var_1_76))));
	}


	// From: CodeObject26
	if (var_1_34 < -5) {
		if ((abs (var_1_69)) > var_1_65) {
			if ((var_1_52 < (min (var_1_40 , var_1_47))) && var_1_48) {
				if (var_1_50) {
					var_1_77 = var_1_33;
				}
			}
	...
	// From: Req2Batch86PS_CN_250
	if (var_1_19) {
		var_1_6 = (last_1_var_1_6 || var_1_9);
	}


	// From: Req4Batch86PS_CN_250
	...
	// From: Req7Batch86PS_CN_250
	var_1_22 = var_1_15;


	// From: Req5Batch86PS_CN_250
