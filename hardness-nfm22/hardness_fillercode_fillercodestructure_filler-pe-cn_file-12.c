...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch12Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch12Filler_PE_CN
	var_1_21 = (abs (var_1_7));


	// From: Req2Batch12Filler_PE_CN
