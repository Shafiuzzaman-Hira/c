...
void step(void) {
	...
	if (var_1_28 >= var_1_27) {
		var_1_33 = (max ((min (var_1_31 , var_1_34)) , var_1_35));
	}
	...
	// From: CodeObject6
	if (! ((abs (var_1_29)) != var_1_26)) {
		if (128.6 > (min ((var_1_36 / var_1_38) , var_1_26))) {
			var_1_37 = var_1_35;
		}
	}


	// From: Req2Batch57PS_CN_25
