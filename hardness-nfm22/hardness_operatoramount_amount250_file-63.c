...
void step(void) {
	...
	if ((var_1_37 - (max (var_1_42 , var_1_43))) != var_1_24) {
		if (! ((var_1_18 > var_1_15) || last_1_var_1_39)) {
			var_1_41 = ((min ((var_1_34 - var_1_14) , last_1_var_1_55)) + (max (var_1_5 , var_1_16)));
		} else {
			var_1_41 = (max ((last_1_var_1_54 - (var_1_44 - last_1_var_1_54)) , (min ((max (var_1_7 , var_1_28)) , var_1_5))));
		}
	} else {
	...
	signed long int stepLocal_4 = (max (var_1_18 , last_1_var_1_1)) >> var_1_14;
	...
	if (var_1_10) {
		...
		if (stepLocal_1 >= (last_1_var_1_8 | (min (last_1_var_1_55 , var_1_5)))) {
	...
	signed long int stepLocal_17 = min ((min (var_1_47 , var_1_6)) , (abs (var_1_7)));
	...
	if (var_1_26 < var_1_22) {
		if (var_1_11) {
			if ((max (var_1_12 , var_1_17)) >= (max (var_1_35 , (last_1_var_1_38 | var_1_1)))) {
				var_1_38 = (8 + var_1_18);
			}
		}
	}
	...
	if (var_1_9 || var_1_39) {
		...
		if (var_1_18 != (max (var_1_5 , var_1_38))) {
	...
	if (var_1_1 != var_1_27) {
		var_1_40 = (min (var_1_14 , (min ((max (var_1_33 , var_1_19)) , var_1_38))));
	} else {
		var_1_40 = var_1_32;
	}
	...
	signed long int stepLocal_13 = min (var_1_35 , var_1_31);
	if (stepLocal_16 <= var_1_1) {
		if ((abs (var_1_59)) >= stepLocal_14) {
			if ((var_1_17 + (var_1_53 | var_1_15)) > stepLocal_15) {
				if (-16 >= stepLocal_13) {
					if (var_1_39) {
						var_1_55 = (min (var_1_17 , var_1_18));
					}
				} else {
					var_1_55 = var_1_33;
				}
	...
	if (var_1_11) {
		if ((- (var_1_42 * var_1_37)) <= var_1_25) {
			...
			var_1_45 = ((max (var_1_15 , var_1_14)) - var_1_7);
		}
	} else {
	...
	if (stepLocal_10 < (var_1_38 + var_1_15)) {
		var_1_54 = (min (var_1_7 , var_1_15));
	} else {
		if (-25 >= stepLocal_12) {
			if (stepLocal_11 <= last_1_var_1_54) {
				var_1_54 = ((min ((var_1_53 + 8u) , var_1_45)) + ((var_1_18 + var_1_32) + var_1_50));
			} else {
				var_1_54 = ((var_1_49 - var_1_47) + var_1_13);
			}
		} else {
			var_1_54 = (var_1_27 + (min ((max (var_1_50 , var_1_49)) , var_1_44)));
		}
	}
	...
	if (var_1_27 > (var_1_16 - var_1_6)) {
		var_1_30 = ((var_1_18 + (var_1_40 - var_1_15)) + (min (var_1_54 , var_1_54)));
	} else {
		if (var_1_14 > var_1_15) {
			var_1_30 = (max (var_1_40 , var_1_27));
		} else {
			var_1_30 = (10 - var_1_6);
		}
	}
...
int property() {
	return ((((((((((((((((((((((((((last_1_var_1_17 / -2) <= last_1_var_1_41) && last_1_var_1_9) ? (var_1_1 == ((unsigned char) ((var_1_5 - var_1_6) - var_1_7))) : (var_1_1 == ((unsigned char) (var_1_6 + var_1_7)))) && (var_1_21 ? (var_1_8 == ((signed long int) (max (var_1_6 , var_1_7)))) : (var_1_8 == ((signed long int) (25 + var_1_6))))) && (((var_1_58 < var_1_17) && var_1_39) ? (var_1_9 == ((unsigned char) ((var_1_58 > var_1_17) || var_1_10))) : (var_1_9 == ((unsigned char) (! var_1_11))))) && (var_1_11 ? (var_1_12 == ((unsigned char) var_1_6)) : 1)) && (var_1_10 ? (var_1_13 == ((unsigned char) var_1_7)) : ((((var_1_6 + var_1_14) - var_1_7) >= (last_1_var_1_8 | (min (last_1_var_1_55 , var_1_5)))) ? (var_1_13 == ((unsigned char) ((var_1_15 + var_1_16) - var_1_6))) : (var_1_13 == ((unsigned char) var_1_14))))) && (last_1_var_1_21 ? ((var_1_16 >= last_1_var_1_19) ? (var_1_17 == ((unsigned char) (max (((abs (var_1_14)) + var_1_16) , var_1_7)))) : 1) : ((var_1_6 != (var_1_5 ^ 50)) ? (var_1_17 == ((unsigned char) (min (var_1_14 , var_1_6)))) : (var_1_17 == ((unsigned char) ((max (var_1_15 , var_1_6)) + (max (1 , (var_1_14 + var_1_18))))))))) && ((var_1_9 || var_1_39) ? (var_1_19 == ((unsigned char) (var_1_14 + (max (var_1_7 , var_1_16))))) : ((var_1_18 != (max (var_1_5 , var_1_38))) ? (var_1_19 == ((unsigned char) (var_1_5 - var_1_6))) : 1))) && ((((max (var_1_18 , last_1_var_1_1)) >> var_1_14) > last_1_var_1_41) ? (var_1_21 == ((unsigned char) (! var_1_10))) : 1)) && ((! (var_1_15 > (var_1_7 / var_1_16))) ? (var_1_22 == ((double) (((var_1_23 + var_1_24) + var_1_25) + var_1_26))) : 1)) && (var_1_27 == ((signed char) var_1_28))) && ((((~ 256) * var_1_15) <= (var_1_59 * (var_1_18 << 1))) ? (var_1_29 == ((signed long int) (((var_1_8 + 25) - var_1_7) + var_1_16))) : 1)) && ((var_1_27 > (var_1_16 - var_1_6)) ? (var_1_30 == ((signed short int) ((var_1_18 + (var_1_40 - var_1_15)) + (min (var_1_54 , var_1_54))))) : ((var_1_14 > var_1_15) ? (var_1_30 == ((signed short int) (max (var_1_40 , var_1_27)))) : (var_1_30 == ((signed short int) (10 - var_1_6)))))) && ((var_1_16 <= var_1_15) ? (var_1_21 ? (var_1_31 == ((signed char) 25)) : (var_1_31 == ((signed char) (((var_1_32 - var_1_33) - (var_1_34 + var_1_35)) + var_1_14)))) : (var_1_31 == ((signed char) var_1_32)))) && (var_1_21 ? (var_1_36 == ((float) (var_1_37 - 500.4f))) : 1)) && ((var_1_26 < var_1_22) ? (var_1_11 ? (((max (var_1_12 , var_1_17)) >= (max (var_1_35 , (last_1_var_1_38 | var_1_1)))) ? (var_1_38 == ((unsigned short int) (8 + var_1_18))) : 1) : 1) : 1)) && ((-100 <= var_1_5) ? (var_1_39 == ((unsigned char) (! var_1_10))) : 1)) && ((var_1_1 != var_1_27) ? (var_1_40 == ((unsigned short int) (min (var_1_14 , (min ((max (var_1_33 , var_1_19)) , var_1_38)))))) : (var_1_40 == ((unsigned short int) var_1_32)))) && (((var_1_37 - (max (var_1_42 , var_1_43))) != var_1_24) ? ((! ((var_1_18 > var_1_15) || last_1_var_1_39)) ? (var_1_41 == ((signed short int) ((min ((var_1_34 - var_1_14) , last_1_var_1_55)) + (max (var_1_5 , var_1_16))))) : (var_1_41 == ((signed short int) (max ((last_1_var_1_54 - (var_1_44 - last_1_var_1_54)) , (min ((max (var_1_7 , var_1_28)) , var_1_5))))))) : (var_1_41 == ((signed short int) ((1 - var_1_15) + var_1_34))))) && (var_1_11 ? (((- (var_1_42 * var_1_37)) <= var_1_25) ? ((var_1_15 <= var_1_34) ? (var_1_45 == ((signed long int) (var_1_7 - var_1_40))) : (((var_1_40 >> (4 + var_1_47)) > (~ var_1_16)) ? (var_1_45 == ((signed long int) var_1_28)) : (var_1_45 == ((signed long int) (var_1_13 - (var_1_49 - last_1_var_1_45)))))) : (var_1_45 == ((signed long int) ((max (var_1_15 , var_1_14)) - var_1_7)))) : (var_1_45 == ((signed long int) (var_1_44 + (var_1_40 - var_1_32)))))) && ((! ((var_1_41 > var_1_27) || var_1_9)) ? (var_1_50 == ((unsigned long int) (abs (var_1_51 - 1u)))) : (var_1_9 ? (var_1_50 == ((unsigned long int) (((var_1_52 + var_1_53) - var_1_35) + var_1_1))) : 1))) && (((var_1_7 >> var_1_58) < (var_1_38 + var_1_15)) ? (var_1_54 == ((unsigned long int) (min (var_1_7 , var_1_15)))) : ((-25 >= var_1_7) ? ((var_1_1 <= last_1_var_1_54) ? (var_1_54 == ((unsigned long int) ((min ((var_1_53 + 8u) , var_1_45)) + ((var_1_18 + var_1_32) + var_1_50)))) : (var_1_54 == ((unsigned long int) ((var_1_49 - var_1_47) + var_1_13)))) : (var_1_54 == ((unsigned long int) (var_1_27 + (min ((max (var_1_50 , var_1_49)) , var_1_44)))))))) && ((((-5 / var_1_5) * var_1_40) <= var_1_1) ? (((abs (var_1_59)) >= var_1_18) ? (((var_1_17 + (var_1_53 | var_1_15)) > ((var_1_12 + var_1_34) * var_1_8)) ? ((-16 >= (min (var_1_35 , var_1_31))) ? (var_1_39 ? (var_1_55 == ((unsigned long int) (min (var_1_17 , var_1_18)))) : 1) : (var_1_55 == ((unsigned long int) var_1_33))) : (var_1_55 == ((unsigned long int) var_1_7))) : 1) : (var_1_55 == ((unsigned long int) 4u)))) && (var_1_58 == ((signed short int) var_1_15))) && ((var_1_31 >= var_1_34) ? (((min ((min (var_1_47 , var_1_6)) , (abs (var_1_7)))) < var_1_13) ? (var_1_59 == ((signed char) (var_1_34 - var_1_32))) : (var_1_59 == ((signed char) var_1_5))) : (var_1_59 == ((signed char) var_1_32)))
;
}
int main(void) {
	isInitial = 1;
