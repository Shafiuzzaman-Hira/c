...
void step(void) {
 ...
 var_1_20 = ((((var_1_13) < (var_1_12)) ? (var_1_13) : (var_1_12)));
 if (128u <= var_1_1) {
  if ((var_1_13 >= var_1_13) && ((var_1_1 * var_1_15) < ((((var_1_3) < (var_1_19)) ? (var_1_3) : (var_1_19))))) {
   if (var_1_15 > var_1_1) {
    var_1_23 = ((((4) < 0 ) ? -(4) : (4)));
   } else {
    if (var_1_9) {
 ...
 if (var_1_2 >= var_1_2) {
  var_1_30 = (((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19))) - var_1_3);
 }
 var_1_33 = var_1_12;
 if (var_1_10) {
  var_1_34 = ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4)));
 }
 if (var_1_19 > var_1_3) {
  var_1_35 = var_1_4;
 } else {
  if ((var_1_4 - ((((var_1_1) > (var_1_2)) ? (var_1_1) : (var_1_2)))) < ((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))) {
 ...
 if (var_1_2 > (var_1_4 >> var_1_4)) {
  if (var_1_10) {
   var_1_39 = ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4)));
  } else {
   var_1_39 = (((((256 - (var_1_40 - var_1_3))) > (var_1_4)) ? ((256 - (var_1_40 - var_1_3))) : (var_1_4)));
  }
 } else {
  var_1_39 = var_1_2;
 }
