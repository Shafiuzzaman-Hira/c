...
void step(void) {
	...
	// From: CodeObject5
	if ((abs (1.25f)) != var_1_33) {
		if (var_1_28 >= (max (var_1_25 , (var_1_31 ^ var_1_34)))) {
			var_1_32 = (min ((abs (abs (var_1_31))) , (var_1_25 + var_1_26)));
		} else {
			var_1_32 = var_1_25;
		}
	} else {
	...
	// From: CodeObject6
	if (var_1_36) {
		var_1_35 = (max (var_1_30 , (abs (128))));
	}


	// From: Req2Batch3PS_CN_25
	if (var_1_3) {
