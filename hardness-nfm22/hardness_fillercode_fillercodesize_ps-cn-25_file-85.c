...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch85PS_CN_25.c", 13, "reach_error"); }
...
float var_1_28 = 8.95;
float var_1_29 = 16.4;
double var_1_30 = 16.7;
float var_1_31 = 127.4;
...
void step(void) {
	...
	// From: CodeObject6
	if (((var_1_35 + var_1_36) - (max (var_1_25 , var_1_24))) == 0) {
		if (var_1_33) {
			var_1_34 = var_1_21;
		}
	}
	...
	// From: Req5Batch85PS_CN_25
	var_1_13 = (abs (var_1_14));


	// From: Req7Batch85PS_CN_25
	var_1_16 = (var_1_6 && var_1_17);


	// From: Req6Batch85PS_CN_25
	if (var_1_5) {
		var_1_15 = (max (var_1_1 , (var_1_13 + (abs (var_1_14)))));
	}


	// From: Req3Batch85PS_CN_25
