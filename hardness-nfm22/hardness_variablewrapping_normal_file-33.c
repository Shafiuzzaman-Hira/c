...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch33normal.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch33normal
	if (var_1_5 < last_1_var_1_13) {
		var_1_7 = (var_1_8 + 1);
	}


	// From: Req6Batch33normal
	var_1_16 = var_1_7;


	// From: Req4Batch33normal
	...
	// From: Req5Batch33normal
	var_1_15 = var_1_11;


	// From: Req1Batch33normal
...
int property() {
	return ((((((((var_1_13 ^ var_1_7) + var_1_16) < -1) ? (var_1_1 == ((signed short int) 8)) : (var_1_1 == ((signed short int) (128 - (var_1_7 + var_1_7))))) && ((var_1_5 < last_1_var_1_13) ? (var_1_7 == ((unsigned char) (var_1_8 + 1))) : 1)) && ((var_1_7 < (var_1_13 & (var_1_7 | var_1_16))) ? (var_1_9 == ((float) (abs (var_1_10 + (var_1_11 - var_1_12))))) : 1)) && ((! var_1_14) ? (var_1_13 == ((signed long int) var_1_8)) : ((var_1_7 > (var_1_7 + var_1_7)) ? (var_1_13 == ((signed long int) var_1_7)) : (var_1_13 == ((signed long int) var_1_16))))) && (var_1_15 == ((float) var_1_11))) && (var_1_16 == ((signed long int) var_1_7))
;
}
int main(void) {
	isInitial = 1;
