 ...
 if (var_1_25 > 1) {
  if (var_1_27) {
   if ((var_1_23 * var_1_24) < var_1_25) {
    var_1_26 = ((((((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22)))) > (var_1_25)) ? (((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22)))) : (var_1_25)));
   }
  }
 }
 if (! var_1_27) {
  if ((var_1_29 * var_1_30) > var_1_31) {
   if (var_1_27) {
    var_1_28 = ((((var_1_22) < (((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))))) ? (var_1_22) : (((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))))));
   }
  }
 } else {
  if (var_1_32) {
