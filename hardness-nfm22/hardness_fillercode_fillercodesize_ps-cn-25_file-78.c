...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch78PS_CN_25.c", 13, "reach_error"); }
...
unsigned short int var_1_26 = 63232;
double var_1_27 = 1.75;
signed char var_1_28 = 32;
signed char var_1_29 = 4;
double var_1_30 = -0.5;
double var_1_31 = 100000000000000.5;
unsigned long int var_1_32 = 0;
unsigned char var_1_33 = 1;
unsigned long int var_1_34 = 3561574674;
double var_1_35 = 3.3;
...
void step(void) {
	...
	// From: CodeObject2
	if (var_1_22 > (min (var_1_23 , var_1_25))) {
		var_1_24 = (var_1_26 - var_1_22);
	}


	// From: CodeObject3
	if (((max (var_1_28 , 8)) - var_1_29) < (var_1_25 & var_1_22)) {
		var_1_27 = (min (var_1_30 , var_1_31));
	} else {
		var_1_27 = var_1_30;
	}
	...
	// From: CodeObject4
	if (! var_1_33) {
		var_1_32 = (var_1_34 - (max (var_1_22 , var_1_24)));
	}
	...
	// From: Req7Batch78PS_CN_25
	var_1_20 = (max ((var_1_5 + var_1_6) , var_1_4));


	// From: Req4Batch78PS_CN_25
	...
	// From: Req6Batch78PS_CN_25
	var_1_16 = (var_1_17 + (var_1_18 + (abs (var_1_19))));


	// From: Req1Batch78PS_CN_25
	var_1_1 = (abs (var_1_16));


	// From: Req8Batch78PS_CN_25
