...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch89Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch89Filler_PE_CN
	var_1_18 = var_1_8;


	// From: Req3Batch89Filler_PE_CN
