...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch96Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
 if ((var_1_23 <= var_1_20) || var_1_6) {
  if (((((5) < 0 ) ? -(5) : (5))) < var_1_23) {
   if (var_1_6) {
    var_1_32 = ((((((((var_1_10) < (var_1_12)) ? (var_1_10) : (var_1_12)))) > (var_1_21)) ? (((((var_1_10) < (var_1_12)) ? (var_1_10) : (var_1_12)))) : (var_1_21)));
   }
  }
 }
 if (((((4) < 0 ) ? -(4) : (4))) >= var_1_21) {
  if ((((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18))) % ((((var_1_21) < (var_1_21)) ? (var_1_21) : (var_1_21)))) <= (var_1_20 ^ var_1_21)) {
   if (((((((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18)))) < (var_1_21)) ? (((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18)))) : (var_1_21))) < var_1_21) {
    var_1_40 = var_1_43;
   } else {
    var_1_40 = var_1_43;
   }
 ...
 if (var_1_21 <= var_1_23) {
  var_1_44 = (var_1_23 + (((((((var_1_21) > (-1)) ? (var_1_21) : (-1))) < 0 ) ? -((((var_1_21) > (-1)) ? (var_1_21) : (-1))) : ((((var_1_21) > (-1)) ? (var_1_21) : (-1))))));
 }
 if (((~ var_1_10) >> ((((var_1_22) > (var_1_22)) ? (var_1_22) : (var_1_22)))) >= var_1_10) {
  var_1_46 = (var_1_49 - var_1_22);
 }
 var_1_50 = var_1_29;
 if ((~ var_1_20) > var_1_20) {
  var_1_52 = ((((((var_1_22 + var_1_23) - ((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21))))) < (var_1_20)) ? (((var_1_22 + var_1_23) - ((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21))))) : (var_1_20)));
 } else {
  var_1_52 = ((((var_1_21) < (var_1_21)) ? (var_1_21) : (var_1_21)));
 }
 var_1_53 = var_1_22;
