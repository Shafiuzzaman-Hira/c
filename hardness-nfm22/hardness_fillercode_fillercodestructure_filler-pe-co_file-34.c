...
void step(void) {
	...
	// From: Req7Batch34Filler_PE_CO
	if (var_1_15 > var_1_12) {
		var_1_18 = (! var_1_19);
	}


	// From: Req4Batch34Filler_PE_CO
	if (var_1_18) {
		var_1_14 = var_1_12;
	} else {
		var_1_14 = 64;
	...
	// From: Req8Batch34Filler_PE_CO
	var_1_20 = last_1_var_1_17;


	// From: Req6Batch34Filler_PE_CO
	...
	// From: CodeObject4
	if (var_1_20 <= (var_1_20 / (abs (var_1_33)))) {
		if ((var_1_14 / var_1_33) <= var_1_29) {
			var_1_32 = (min (var_1_14 , ((abs (var_1_35)) - (abs (var_1_20)))));
		}
	}


	// From: CodeObject5
	if ((abs (~ var_1_10)) >= (min (var_1_17 , 8u))) {
		var_1_36 = (abs (var_1_10));
	} else {
		var_1_36 = (var_1_37 - 2);
	}
	...
	if (var_1_24 > var_1_22) {
		if ((min (2 , 64)) < (max (var_1_37 , (var_1_1 + var_1_17)))) {
