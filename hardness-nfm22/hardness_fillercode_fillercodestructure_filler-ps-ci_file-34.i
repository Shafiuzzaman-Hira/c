...
void step(void) {
 ...
 if (var_1_14 < (~ (25u + var_1_13))) {
  var_1_26 = ((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12)));
 }
 if ((var_1_9 < var_1_13) || (var_1_20 >= var_1_13)) {
  var_1_30 = var_1_19;
 }
 if (var_1_11 <= (var_1_13 / ((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9))))) {
  if ((var_1_9 / var_1_9) <= var_1_13) {
   var_1_32 = ((((var_1_9) < ((((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))) - ((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13)))))) ? (var_1_9) : ((((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))) - ((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13)))))));
  }
 }
 if (((((~ var_1_11) < 0 ) ? -(~ var_1_11) : (~ var_1_11))) >= ((((var_1_1) < (8u)) ? (var_1_1) : (8u)))) {
  var_1_36 = ((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12)));
 } else {
  var_1_36 = (var_1_37 - 2);
 }
 if (var_1_10 < (var_1_20 + var_1_35)) {
  var_1_38 = ((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12)));
 }
 if (var_1_24 > var_1_22) {
  if (((((2) < (64)) ? (2) : (64))) < ((((var_1_37) > ((var_1_17 + var_1_1))) ? (var_1_37) : ((var_1_17 + var_1_1))))) {
