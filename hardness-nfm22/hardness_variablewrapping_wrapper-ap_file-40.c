...
void step(void) {
	// From: Req4Batch40Wrapper_AP
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
		(*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) = (max ((*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)) , (-2 + (*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)))));
	}


	// From: Req5Batch40Wrapper_AP
	(*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) = (*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer));


	// From: Req6Batch40Wrapper_AP
	...
	// From: Req3Batch40Wrapper_AP
	if ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) != (min (last_1_double_Array_0_0_ , (*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer))))) {
