...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch69PS_CN_25.c", 13, "reach_error"); }
...
double var_1_32 = 2.96;
double var_1_33 = 9.6;
double var_1_34 = 127.9;
double var_1_35 = 7.3;
...
void step(void) {
	...
	if (9.5 >= var_1_33) {
		if (var_1_25) {
			if (var_1_33 > var_1_34) {
				var_1_32 = ((max (var_1_35 , 4.25)) + 1.75);
			}
		} else {
			var_1_32 = (max (var_1_35 , var_1_36));
		}
	}
	...
	// From: Req4Batch69PS_CN_25
	if (var_1_20 || (var_1_6 <= var_1_8)) {
		var_1_14 = var_1_6;
	}


	// From: Req1Batch69PS_CN_25
