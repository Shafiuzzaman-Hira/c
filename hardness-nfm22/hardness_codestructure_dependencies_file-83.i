...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch83dependencies.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_9 % (var_1_8 - var_1_20)) > ((((var_1_23) < 0 ) ? -(var_1_23) : (var_1_23)))) {
  if ((var_1_3 ^ var_1_23) <= (var_1_7 ^ var_1_10)) {
   var_1_19 = var_1_17;
  }
 }
