...
void step(void) {
	...
	// From: Req6Batch35Filler_PE_CI
	var_1_16 = (abs ((var_1_17 + var_1_18) + (min (var_1_19 , var_1_20))));


	// From: Req7Batch35Filler_PE_CI
	...
	if (var_1_20 <= var_1_18) {
		if ((var_1_11 | (abs (var_1_25))) >= (var_1_24 + var_1_6)) {
	...
	// From: CodeObject5
	if (32u >= ((max (var_1_6 , var_1_11)) % 16u)) {
		if ((-5 > var_1_25) && (var_1_6 <= (max (var_1_34 , var_1_12)))) {
			var_1_39 = var_1_18;
		} else {
			var_1_39 = (abs (var_1_18));
		}
	} else {
		if (! var_1_4) {
			var_1_39 = (max (var_1_18 , (abs (var_1_18))));
		}
	}


	// From: CodeObject6
	var_1_41 = (min ((abs (var_1_19)) , var_1_20));
