...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch6350_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req9Batch6350_1loop
	var_1_31 = var_1_13;


	// From: Req4Batch6350_1loop
	if (var_1_7) {
	...
	// From: Req7Batch6350_1loop
	if (var_1_7) {
		var_1_29 = var_1_20;
	}


	// From: Req10Batch6350_1loop
	var_1_32 = var_1_16;


	// From: Req8Batch6350_1loop
	var_1_30 = var_1_32;


	// From: Req2Batch6350_1loop
	...
	// From: Req6Batch6350_1loop
	if (var_1_11 >= var_1_30) {
		var_1_26 = (var_1_27 + var_1_28);
	}


	// From: Req1Batch6350_1loop
