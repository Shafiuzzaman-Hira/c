...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch85PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject5
	if ((256u ^ (var_1_24 >> var_1_22)) != var_1_23) {
		if (var_1_29) {
			var_1_28 = var_1_27;
		}
	}
	...
	// From: Req5Batch85PS_CN_10
	var_1_13 = (abs (var_1_14));


	// From: Req7Batch85PS_CN_10
	var_1_16 = (var_1_6 && var_1_17);


	// From: Req6Batch85PS_CN_10
	if (var_1_5) {
		var_1_15 = (max (var_1_1 , (var_1_13 + (abs (var_1_14)))));
	}


	// From: Req3Batch85PS_CN_10
