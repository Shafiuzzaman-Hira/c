...
void step(void) {
 if (var_1_17 < (var_1_14 + var_1_17)) {
  ...
  var_1_23 = ((((var_1_9) > (var_1_11)) ? (var_1_9) : (var_1_11)));
 }
 if (var_1_6) {
  if (((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16))) > ((-10 + var_1_12) & var_1_4)) {
   var_1_29 = (((((var_1_31 - 64u) < 0 ) ? -(var_1_31 - 64u) : (var_1_31 - 64u))) - var_1_20);
  } else {
   var_1_29 = var_1_20;
  }
 }
 var_1_33 = var_1_34;
 var_1_35 = var_1_9;
 var_1_36 = ((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13)));
 if (var_1_15 > (var_1_39 - var_1_40)) {
  if (var_1_21 <= var_1_21) {
   var_1_38 = (var_1_21 + ((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17))));
  } else {
   if (((((((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11)))) > (var_1_11)) ? (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11)))) : (var_1_11))) != var_1_10) {
 ...
 if (var_1_3 || var_1_6) {
  if (var_1_16 <= (var_1_13 - 64)) {
   if (var_1_31 < ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)))) {
    var_1_44 = var_1_16;
   } else {
    var_1_44 = 16;
   }
