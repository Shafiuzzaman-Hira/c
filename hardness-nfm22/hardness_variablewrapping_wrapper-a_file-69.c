...
void step(void) {
	// From: Req2Batch69Wrapper_A
	if (unsigned_long_int_Array_0[1][1] < (max ((unsigned_long_int_Array_0[1][0] * unsigned_long_int_Array_0[0][0]) , unsigned_long_int_Array_0[0][1]))) {
	...
	// From: Req1Batch69Wrapper_A
	unsigned long int stepLocal_1 = unsigned_long_int_Array_0[0][0];
	unsigned long int stepLocal_0 = unsigned_long_int_Array_0[1][1] * (min (unsigned_long_int_Array_0[0][1] , unsigned_long_int_Array_0[1][0]));
