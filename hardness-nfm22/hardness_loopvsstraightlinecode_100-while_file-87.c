...
void step(void) {
	...
	// From: Req5Batch87100_while
	var_1_22 = (var_1_29 - (30604 - var_1_8));


	// From: Req6Batch87100_while
	if (var_1_16) {
		var_1_23 = (! (! 0));
	}


	// From: Req9Batch87100_while
	var_1_26 = (min ((abs (var_1_7)) , (abs (50))));


	// From: Req14Batch87100_while
	var_1_39 = var_1_36;


	// From: Req2Batch87100_while
	var_1_9 = ((min (var_1_8 , var_1_39)) + var_1_7);


	// From: Req11Batch87100_while
	...
	// From: Req10Batch87100_while
	var_1_27 = (var_1_8 + (max (var_1_7 , (32 + var_1_28))));


	// From: Req4Batch87100_while
