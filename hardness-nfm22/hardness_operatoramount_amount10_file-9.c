...
void step(void) {
	// From: Req1Batch9Amount10
	if (! var_1_2) {
		var_1_1 = var_1_3;
	}


	// From: Req2Batch9Amount10
	if (31.6 > var_1_5) {
		if (var_1_5 > var_1_6) {
			var_1_4 = (min (var_1_7 , var_1_8));
		} else {
			if (var_1_2) {
				var_1_4 = var_1_8;
			} else {
...
int property() {
	return ((! var_1_2) ? (var_1_1 == ((unsigned short int) var_1_3)) : 1) && ((31.6 > var_1_5) ? ((var_1_5 > var_1_6) ? (var_1_4 == ((double) (min (var_1_7 , var_1_8)))) : (var_1_2 ? (var_1_4 == ((double) var_1_8)) : (var_1_4 == ((double) 1.0000000000000875E13)))) : (var_1_4 == ((double) var_1_8)))
;
}
int main(void) {
	isInitial = 1;
