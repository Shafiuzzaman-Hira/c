...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch7Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
 if ((var_1_1 >> var_1_27) > ((var_1_12 ^ var_1_9) + ((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10))))) {
  var_1_25 = ((((((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)))) > (0)) ? (((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)))) : (0)));
 } else {
  if (((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18))) >= (var_1_32 - var_1_33)) {
   var_1_25 = var_1_27;
  }
 }
 if (var_1_10 >= ((((var_1_24 | var_1_27) < 0 ) ? -(var_1_24 | var_1_27) : (var_1_24 | var_1_27)))) {
  var_1_34 = (((((((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10)))) > (var_1_10)) ? (((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10)))) : (var_1_10))) - ((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))));
 } else {
  if (var_1_10 >= var_1_27) {
   if (var_1_32 > var_1_33) {
    var_1_34 = ((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)));
   }
  }
 }
 if ((-10 & var_1_15) <= var_1_1) {
  if (var_1_33 != var_1_32) {
   var_1_36 = var_1_37;
  }
 }
 var_1_38 = var_1_37;
 if (var_1_27 == (var_1_12 ^ var_1_12)) {
