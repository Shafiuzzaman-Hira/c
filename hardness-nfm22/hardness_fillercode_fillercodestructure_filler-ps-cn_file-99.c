...
void step(void) {
	...
	if (var_1_31 > var_1_36) {
		var_1_42 = (max ((min (var_1_34 , var_1_43)) , (abs (32))));
	} else {
		var_1_42 = (max ((abs (min (16 , var_1_43))) , var_1_34));
	}
	...
	if (var_1_29 < var_1_35) {
		var_1_46 = (min (var_1_43 , (max (256u , var_1_34))));
	}
