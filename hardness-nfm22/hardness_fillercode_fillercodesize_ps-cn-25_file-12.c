...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch12PS_CN_25.c", 13, "reach_error"); }
...
double var_1_31 = 4.5;
double var_1_32 = 999999999999999.9;
double var_1_33 = 4.4;
...
void step(void) {
	...
	if (var_1_32 != var_1_33) {
		...
		var_1_35 = ((1 - (abs (var_1_37))) + var_1_38);
	}
	...
	// From: Req6Batch12PS_CN_25
	var_1_21 = (abs (var_1_7));


	// From: Req2Batch12PS_CN_25
