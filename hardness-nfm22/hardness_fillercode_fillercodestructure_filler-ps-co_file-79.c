...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch79Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch79Filler_PS_CO
	var_1_26 = var_1_16;


	// From: Req8Batch79Filler_PS_CO
	var_1_27 = 10u;


	// From: Req3Batch79Filler_PS_CO
