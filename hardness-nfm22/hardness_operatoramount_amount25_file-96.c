...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch96Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch96Amount25
	var_1_14 = var_1_12;


	// From: Req5Batch96Amount25
	var_1_15 = var_1_16;


	// From: Req1Batch96Amount25
	if (! var_1_5) {
...
int property() {
	return (((((! var_1_5) ? (var_1_1 == ((unsigned short int) (min (var_1_3 , var_1_4)))) : (var_1_1 == ((unsigned short int) var_1_4))) && (var_1_2 ? ((var_1_6 && (var_1_7 || var_1_8)) ? (var_1_5 == ((unsigned char) var_1_9)) : 1) : 1)) && (((-2 / var_1_11) > ((max (var_1_4 , var_1_3)) * var_1_1)) ? (var_1_10 == ((float) ((var_1_12 - var_1_13) + 9.8f))) : (var_1_5 ? (var_1_5 ? (var_1_10 == ((float) var_1_12)) : (var_1_10 == ((float) var_1_13))) : (var_1_10 == ((float) var_1_12))))) && (var_1_14 == ((float) var_1_12))) && (var_1_15 == ((signed char) var_1_16))
;
}
int main(void) {
	isInitial = 1;
