...
void step(void) {
 ...
 if (BOOL_unsigned_char_Array_0[0]) {
  signed_long_int_Array_0[1] = ((((unsigned_short_int_Array_0[2]) < (last_1_signed_long_int_Array_0_1_)) ? (unsigned_short_int_Array_0[2]) : (last_1_signed_long_int_Array_0_1_)));
 } else {
  if (unsigned_short_int_Array_0[1] > stepLocal_2) {
   if (stepLocal_1 > unsigned_short_int_Array_0[2]) {
    signed_long_int_Array_0[1] = ((((signed_short_int_Array_0[1]) < (100)) ? (signed_short_int_Array_0[1]) : (100)));
   } else {
