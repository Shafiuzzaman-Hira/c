...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch62PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject6
	if ((var_1_36 * var_1_24) >= var_1_26) {
		var_1_35 = (var_1_34 + var_1_37);
	}


	// From: Req4Batch62PS_CN_25
	...
	// From: Req6Batch62PS_CN_25
	if (var_1_10 || var_1_20) {
		var_1_19 = (max (var_1_21 , 32));
	}


	// From: Req7Batch62PS_CN_25
	if (var_1_10) {
