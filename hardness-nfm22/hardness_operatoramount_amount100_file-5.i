...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch5Amount100.c", 13, "reach_error"); }
...
void step(void) {
 if (var_1_5) {
  ...
  var_1_15 = (var_1_18 - ((((((((var_1_17) > (var_1_19)) ? (var_1_17) : (var_1_19)))) > (var_1_20)) ? (((((var_1_17) > (var_1_19)) ? (var_1_17) : (var_1_19)))) : (var_1_20))));
 }
 if (! (1u <= var_1_9)) {
  var_1_21 = ((((((var_1_22) > (var_1_23)) ? (var_1_22) : (var_1_23))) - var_1_10) - var_1_9);
 }
 if (var_1_27 < var_1_26) {
  var_1_28 = (var_1_26 - ((((var_1_20) > (200.125f)) ? (var_1_20) : (200.125f))));
 }
 if (var_1_20 < (var_1_3 / var_1_26)) {
  var_1_29 = (var_1_9 + var_1_10);
 } else {
  var_1_29 = ((((((var_1_30) < (var_1_31)) ? (var_1_30) : (var_1_31))) + var_1_32) - 32);
 }
 var_1_39 = var_1_9;
 var_1_40 = var_1_41;
 ...
 if (var_1_10 >= var_1_39) {
  var_1_25 = ((var_1_17 + ((((7.6) < (var_1_18)) ? (7.6) : (var_1_18)))) - (5.5369585523483085E18 - 16.25));
 } else {
  var_1_25 = ((((var_1_27) > (var_1_20)) ? (var_1_27) : (var_1_20)));
 }
 ...
 if ((var_1_25 < ((((127.5f) < 0 ) ? -(127.5f) : (127.5f)))) || ((var_1_8 > var_1_17) || var_1_5)) {
  if (var_1_5 || var_1_34) {
   if ((var_1_10 - var_1_35) >= (var_1_31 << var_1_24)) {
    var_1_33 = ((((((var_1_27) > (var_1_36)) ? (var_1_27) : (var_1_36))) + (var_1_37 + var_1_38)) + var_1_16);
   } else {
    var_1_33 = ((((var_1_37) > (var_1_19)) ? (var_1_37) : (var_1_19)));
   }
  }
 }
}
