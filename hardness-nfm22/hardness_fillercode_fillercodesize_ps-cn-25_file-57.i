...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch57PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_28 ^ (var_1_27 + var_1_31)) >= 4u) {
  var_1_30 = var_1_32;
 }
 if (var_1_28 >= var_1_27) {
  var_1_33 = ((((((((var_1_31) < (var_1_34)) ? (var_1_31) : (var_1_34)))) > (var_1_35)) ? (((((var_1_31) < (var_1_34)) ? (var_1_31) : (var_1_34)))) : (var_1_35)));
 }
 var_1_36 = var_1_29;
 if (! (((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29))) != var_1_26)) {
  if (128.6 > (((((var_1_36 / var_1_38)) < (var_1_26)) ? ((var_1_36 / var_1_38)) : (var_1_26)))) {
   var_1_37 = var_1_35;
  }
 }
