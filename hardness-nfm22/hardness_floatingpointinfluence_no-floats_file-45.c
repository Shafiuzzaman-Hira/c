...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch45no_floats.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch45no_floats
	if (((var_1_2 + var_1_4) / var_1_19) != last_1_var_1_18) {
		var_1_18 = var_1_20;
	}


	// From: Req1Batch45no_floats
