...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch2PS_CN_10.c", 13, "reach_error"); }
...
float var_1_23 = 64.9;
signed long int var_1_24 = 10000;
...
void step(void) {
	...
	// From: CodeObject3
	if (((abs (var_1_24)) >> (abs (var_1_27))) < 25) {
		var_1_26 = var_1_28;
	}
	...
	// From: Req4Batch2PS_CN_10
	if ((var_1_15 - (min (0 , var_1_16))) > last_1_var_1_6) {
		var_1_14 = var_1_12;
	}


	// From: Req3Batch2PS_CN_10
	...
	// From: Req7Batch2PS_CN_10
	var_1_20 = var_1_16;


	// From: Req8Batch2PS_CN_10
	var_1_21 = var_1_16;


	// From: Req5Batch2PS_CN_10
