...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch34Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_1 < var_1_12) || (var_1_9 >= var_1_16)) {
  var_1_30 = var_1_19;
 }
 if (var_1_18) {
  var_1_14 = var_1_12;
 ...
 if (var_1_11 < (~ (25u + var_1_12))) {
  var_1_26 = ((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12)));
 }
 if (var_1_1 <= (var_1_1 / ((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9))))) {
  if ((var_1_20 / var_1_9) <= var_1_12) {
   var_1_32 = ((((var_1_20) < ((((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))) - ((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))))) ? (var_1_20) : ((((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))) - ((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))))));
  }
 }
 if (((((~ var_1_20) < 0 ) ? -(~ var_1_20) : (~ var_1_20))) >= ((((var_1_17) < (8u)) ? (var_1_17) : (8u)))) {
  var_1_36 = ((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)));
 } else {
  var_1_36 = (var_1_37 - 2);
 }
 ...
 if (var_1_1 < (var_1_13 + var_1_35)) {
  var_1_38 = ((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13)));
 }
