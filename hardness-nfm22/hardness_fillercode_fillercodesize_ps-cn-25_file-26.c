...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch26PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject3
	if (((var_1_29 ^ var_1_30) & var_1_27) == ((abs (var_1_32)) * var_1_28)) {
		if (var_1_31) {
			var_1_35 = var_1_36;
		}
	}
	...
	// From: CodeObject5
	if (((~ var_1_29) + var_1_28) > (abs (abs (var_1_30)))) {
		var_1_38 = (! (var_1_35 && var_1_36));
	}


	// From: Req2Batch26PS_CN_25
	if (! var_1_10) {
	...
	// From: Req4Batch26PS_CN_25
	if (var_1_11 > (var_1_22 * (var_1_12 + var_1_22))) {
		var_1_20 = var_1_21;
	}


	// From: Req6Batch26PS_CN_25
