...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch53Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
 ...
 (*(WrapperStruct00_var_1_1_Pointer)) = ((*(WrapperStruct00_var_1_12_Pointer)) + ((*(WrapperStruct00_var_1_3_Pointer)) - ((*(WrapperStruct00_var_1_4_Pointer)) - (*(WrapperStruct00_var_1_12_Pointer)))));
 signed long int stepLocal_1 = ((((*(WrapperStruct00_var_1_12_Pointer))) < ((*(WrapperStruct00_var_1_12_Pointer)))) ? ((*(WrapperStruct00_var_1_12_Pointer))) : ((*(WrapperStruct00_var_1_12_Pointer))));
 unsigned long int stepLocal_0 = (*(WrapperStruct00_var_1_3_Pointer));
 if (stepLocal_1 != (((((*(WrapperStruct00_var_1_4_Pointer))) < ((*(WrapperStruct00_var_1_3_Pointer)))) ? ((*(WrapperStruct00_var_1_4_Pointer))) : ((*(WrapperStruct00_var_1_3_Pointer)))))) {
