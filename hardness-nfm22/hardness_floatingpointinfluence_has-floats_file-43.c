...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch43has_floats.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req5Batch43has_floats
	var_1_18 = var_1_19;


	// From: Req6Batch43has_floats
	var_1_20 = var_1_21;
