...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch59Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
 if (last_1_signed_long_int_Array_0_2_ > ((((last_1_signed_char_Array_0_0__1_) < 0 ) ? -(last_1_signed_char_Array_0_0__1_) : (last_1_signed_char_Array_0_0__1_)))) {
  ...
  if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer)) || (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
   if (2 < last_1_signed_char_Array_0_0__1_) {
    (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) = last_1_signed_char_Array_0_0__1_;
   }
  }
 }
 if (last_1_signed_short_int_Array_0_0_ > (last_1_signed_char_Array_0_0__1_ * ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))))) {
  if ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) > last_1_signed_char_Array_0_0__1_) {
 ...
 if ((((((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))) > (1)) ? ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))) : (1))) <= (256 + last_1_signed_long_int_Array_0_2_)) {
  (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) = ((((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) - 128) + (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))) + (*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)));
 } else {
  (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) = ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) + (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)));
 }
}
...
int property() {
 return ((((((((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))) > (1)) ? ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))) : (1))) <= (256 + last_1_signed_long_int_Array_0_2_)) ? ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) == ((signed long int) ((((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) - 128) + (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))) + (*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer))))) : ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) == ((signed long int) ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) + (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)))))) && ((last_1_signed_short_int_Array_0_0_ > (last_1_signed_char_Array_0_0__1_ * ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))))) ? (((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) > last_1_signed_char_Array_0_0__1_) ? ((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)) == ((signed char) (((*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) + (*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer))) + (*(signed_char_Array_0_arraysigned_char_Array_0Var3_Pointer))))) : ((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)) == ((signed char) (*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer))))) : ((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)) == ((signed char) (*(signed_char_Array_0_arraysigned_char_Array_0Var3_Pointer)))))) && ((last_1_signed_long_int_Array_0_2_ > ((((last_1_signed_char_Array_0_0__1_) < 0 ) ? -(last_1_signed_char_Array_0_0__1_) : (last_1_signed_char_Array_0_0__1_)))) ? ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) == ((signed short int) ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)) - (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer))))) : (((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer)) || (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) ? ((2 < last_1_signed_char_Array_0_0__1_) ? ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) == ((signed short int) last_1_signed_char_Array_0_0__1_)) : 1) : 1))
;
}
int main(void) {
 isInitial = 1;
