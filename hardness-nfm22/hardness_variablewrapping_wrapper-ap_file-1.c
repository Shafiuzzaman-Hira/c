...
void step(void) {
	...
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer)) || stepLocal_0) {
		(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)) = (max ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) , (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))));
	} else {
	...
	if (stepLocal_1 != (abs ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))))) {
