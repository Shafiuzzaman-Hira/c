...
void step(void) {
	...
	if ((var_1_46 - var_1_36) > ((var_1_47 / var_1_32) | var_1_30)) {
		if ((max (var_1_37 , var_1_31)) < var_1_30) {
			var_1_45 = var_1_36;
		}
	}
	...
	// From: CodeObject5
	if (((min (var_1_37 , var_1_34)) >> var_1_45) < var_1_32) {
		var_1_48 = (min (-4 , (max ((var_1_38 - var_1_41) , (abs (var_1_45))))));
	}


	// From: CodeObject6
	if ((max (var_1_32 , 128)) <= var_1_33) {
		if (var_1_44) {
			var_1_49 = var_1_43;
		} else {
	...
	// From: CodeObject7
	if ((abs (var_1_29)) <= (- (min (var_1_25 , var_1_28)))) {
		var_1_51 = (abs (var_1_36 + var_1_34));
	} else {
		var_1_51 = var_1_36;
	}
	...
	if (var_1_25 <= var_1_28) {
		var_1_53 = (max ((var_1_54 - var_1_36) , var_1_46));
	}
	...
	if ((128 - var_1_36) > var_1_35) {
		if (var_1_35 > var_1_38) {
			var_1_55 = (max ((min (var_1_56 , (max (var_1_57 , var_1_58)))) , (min ((min (var_1_59 , var_1_60)) , 256.875f))));
		}
	} else {
		var_1_55 = (max (99.5f , var_1_59));
	}


	// From: CodeObject10
	if (var_1_55 < var_1_57) {
		if ((abs (var_1_46)) < var_1_32) {
			var_1_61 = var_1_46;
		}
	} else {
		var_1_61 = ((min (var_1_38 , 100u)) + (abs (abs (var_1_53))));
	}


	// From: CodeObject11
	if ((var_1_47 * var_1_37) < ((max (var_1_36 , var_1_38)) - (max (var_1_46 , 25)))) {
		if (var_1_40) {
			var_1_62 = var_1_34;
		}
	}
	...
	// From: CodeObject12
	if ((abs (abs (var_1_28))) >= var_1_58) {
		var_1_63 = (((abs (var_1_64)) - var_1_65) - var_1_66);
	} else {
		if ((2 >> var_1_46) < (abs (min (var_1_45 , var_1_38)))) {
			var_1_63 = (max (var_1_57 , var_1_64));
		} else {
			var_1_63 = (min (var_1_57 , var_1_59));
		}
	}
	...
	// From: CodeObject15
	if (var_1_45 >= (var_1_51 >> (max (var_1_70 , var_1_71)))) {
		if (var_1_68) {
			if (var_1_33 < var_1_47) {
				var_1_69 = (min ((abs (var_1_66 - var_1_72)) , var_1_64));
			} else {
	...
	// From: CodeObject16
	if (var_1_74) {
		if (((var_1_75 - var_1_41) - var_1_54) <= (max (2 , var_1_45))) {
			var_1_73 = var_1_70;
		} else {
			var_1_73 = 4u;
		}
	...
	// From: CodeObject18
	if (var_1_57 <= ((abs (var_1_60)) + var_1_55)) {
		var_1_78 = (((abs (var_1_35)) + (abs (var_1_70))) - var_1_71);
	}


	// From: CodeObject19
	if ((abs (var_1_54 - var_1_53)) <= var_1_24) {
		var_1_79 = (abs (var_1_36 + var_1_70));
	} else {
		var_1_79 = (abs (var_1_34));
	}
	...
	if ((~ var_1_52) <= var_1_73) {
		var_1_82 = ((max (var_1_83 , (min (var_1_66 , var_1_72)))) - (abs (var_1_60)));
	}


	// From: CodeObject22
	if ((abs (var_1_25)) < var_1_66) {
		var_1_84 = var_1_35;
	}


	// From: CodeObject23
	if ((abs (var_1_58)) >= ((abs (var_1_25)) * (var_1_65 - var_1_27))) {
		if (var_1_43) {
	...
	// From: Req2Batch71PS_CN_250
	var_1_10 = var_1_11;


	// From: Req3Batch71PS_CN_250
	...
	// From: Req5Batch71PS_CN_250
	var_1_18 = (max ((max (255.5f , var_1_11)) , 5.5f));


	// From: Req7Batch71PS_CN_250
	var_1_20 = var_1_15;


	// From: Req8Batch71PS_CN_250
	var_1_21 = var_1_5;


	// From: Req9Batch71PS_CN_250
	var_1_22 = var_1_23;


	// From: Req6Batch71PS_CN_250
	if (var_1_3) {
