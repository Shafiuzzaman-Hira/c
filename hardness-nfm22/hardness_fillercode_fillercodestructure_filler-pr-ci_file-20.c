...
void step(void) {
	...
	// From: CodeObject8
	if ((var_1_4 + (min (var_1_4 , var_1_10))) <= var_1_11) {
		if (var_1_2) {
			var_1_41 = var_1_10;
		}
	}
	...
	if (var_1_2 || (var_1_16 <= var_1_13)) {
		if ((var_1_3 | (var_1_5 * var_1_5)) == (min (var_1_5 , -32))) {
			var_1_29 = (max ((abs (var_1_1)) , var_1_5));
		} else {
			var_1_29 = (abs (min (var_1_1 , (abs (var_1_5)))));
		}
	} else {
		var_1_29 = (var_1_3 + ((abs (var_1_4)) + var_1_5));
	}
	...
	// From: CodeObject4
	if (var_1_2) {
		if (var_1_16 > (var_1_16 / (abs (var_1_13)))) {
			var_1_23 = 100;
		} else {
			var_1_23 = 10;
		}
