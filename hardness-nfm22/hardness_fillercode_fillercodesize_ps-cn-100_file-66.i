...
void step(void) {
 ...
 if (var_1_30 <= (~ ((((var_1_35) < (var_1_32)) ? (var_1_35) : (var_1_32))))) {
  if (var_1_23) {
   if (var_1_40 != var_1_41) {
    var_1_42 = (((((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36))) < 0 ) ? -((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36))) : ((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36)))));
   } else {
    var_1_42 = (var_1_37 + ((((var_1_36) > (((((var_1_38) > (var_1_30)) ? (var_1_38) : (var_1_30))))) ? (var_1_36) : (((((var_1_38) > (var_1_30)) ? (var_1_38) : (var_1_30)))))));
   }
  } else {
   var_1_42 = (var_1_29 - (((((((var_1_30) > (var_1_38)) ? (var_1_30) : (var_1_38))) < 0 ) ? -((((var_1_30) > (var_1_38)) ? (var_1_30) : (var_1_38))) : ((((var_1_30) > (var_1_38)) ? (var_1_30) : (var_1_38))))));
  }
 } else {
 ...
 if ((((((((32) < 0 ) ? -(32) : (32))) < 0 ) ? -((((32) < 0 ) ? -(32) : (32))) : ((((32) < 0 ) ? -(32) : (32))))) != var_1_25) {
  var_1_46 = ((((var_1_38) < (var_1_32)) ? (var_1_38) : (var_1_32)));
 }
 if (var_1_36 < var_1_26) {
  var_1_47 = ((var_1_36 + var_1_38) + (5 + ((((var_1_48) < (var_1_49)) ? (var_1_48) : (var_1_49)))));
 } else {
  var_1_47 = var_1_38;
 }
 if (var_1_43 > ((((var_1_45) > (var_1_41)) ? (var_1_45) : (var_1_41)))) {
  var_1_50 = ((((var_1_30) < (var_1_49)) ? (var_1_30) : (var_1_49)));
 } else {
