...
void step(void) {
 ...
 if (stepLocal_8 <= var_1_18) {
  ...
  if (stepLocal_7 < var_1_17) {
   ...
   var_1_38 = (var_1_41 - (((((var_1_42) > (var_1_43)) ? (var_1_42) : (var_1_43))) - var_1_44));
  }
 }
 var_1_10 = (var_1_5 - (var_1_38 + 1000));
 unsigned short int stepLocal_13 = var_1_5;
 unsigned short int stepLocal_12 = var_1_35;
 if ((64 / ((((var_1_40) < (var_1_42)) ? (var_1_40) : (var_1_42)))) == stepLocal_12) {
  if (last_1_var_1_54 != stepLocal_13) {
   var_1_54 = ((((((((var_1_55) < (var_1_43)) ? (var_1_55) : (var_1_43)))) > (((((var_1_41 - var_1_42) < 0 ) ? -(var_1_41 - var_1_42) : (var_1_41 - var_1_42))))) ? (((((var_1_55) < (var_1_43)) ? (var_1_55) : (var_1_43)))) : (((((var_1_41 - var_1_42) < 0 ) ? -(var_1_41 - var_1_42) : (var_1_41 - var_1_42))))));
  }
 } else {
  var_1_54 = ((var_1_43 + 64) - (var_1_44 + var_1_56));
 }
 var_1_61 = (var_1_14 - ((((((((var_1_59) < (var_1_60)) ? (var_1_59) : (var_1_60)))) < (var_1_13)) ? (((((var_1_59) < (var_1_60)) ? (var_1_59) : (var_1_60)))) : (var_1_13))));
 if (var_1_49) {
  var_1_63 = var_1_39;
 }
 var_1_64 = var_1_26;
 ...
 if (stepLocal_3 > (- 256)) {
  ...
  if (var_1_65) {
   var_1_27 = (((((var_1_38) > (var_1_25)) ? (var_1_38) : (var_1_25))) + 128u);
  }
 }
 var_1_9 = (((((var_1_54) < 0 ) ? -(var_1_54) : (var_1_54))) - var_1_54);
 ...
 if (var_1_47 || var_1_65) {
  var_1_1 = ((((var_1_54) < 0 ) ? -(var_1_54) : (var_1_54)));
 } else {
  var_1_1 = (((((var_1_5 - var_1_38)) < (var_1_54)) ? ((var_1_5 - var_1_38)) : (var_1_54)));
 }
 if (! var_1_47) {
 ...
 signed long int stepLocal_0 = (((var_1_54) < (var_1_38)) ? (var_1_54) : (var_1_38));
 if (var_1_65) {
 ...
 if (var_1_47) {
  ...
  if (stepLocal_2 < (var_1_17 / (var_1_5 + var_1_25))) {
   if (var_1_65) {
    var_1_24 = ((((((((7.25f) < (var_1_14)) ? (7.25f) : (var_1_14)))) > (var_1_13)) ? (((((7.25f) < (var_1_14)) ? (7.25f) : (var_1_14)))) : (var_1_13)));
   }
  } else {
   var_1_24 = ((((var_1_26) < ((var_1_15 + var_1_14))) ? (var_1_26) : ((var_1_15 + var_1_14))));
  }
 }
 ...
 if ((var_1_9 == var_1_17) || stepLocal_4) {
  if (var_1_65 || stepLocal_5) {
   var_1_28 = (((((var_1_30 - var_1_54) < 0 ) ? -(var_1_30 - var_1_54) : (var_1_30 - var_1_54))) - var_1_54);
  } else {
   var_1_28 = (((((var_1_30) > (var_1_5)) ? (var_1_30) : (var_1_5))) - ((((var_1_54) < 0 ) ? -(var_1_54) : (var_1_54))));
  }
 }
 if ((((((var_1_13 / var_1_14)) < (var_1_12)) ? ((var_1_13 / var_1_14)) : (var_1_12))) <= var_1_15) {
  var_1_57 = (((((var_1_13) < (var_1_14)) ? (var_1_13) : (var_1_14))) - (var_1_58 - var_1_59));
 } else {
  if (var_1_46 > (var_1_40 / -4)) {
   var_1_57 = ((((var_1_15) > ((var_1_13 - var_1_58))) ? (var_1_15) : ((var_1_13 - var_1_58))));
  } else {
   var_1_57 = ((var_1_13 + ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)))) - (((((var_1_59 + var_1_60)) > (var_1_58)) ? ((var_1_59 + var_1_60)) : (var_1_58))));
  }
 }
 ...
 if ((var_1_15 + (- var_1_13)) != (var_1_14 * var_1_24)) {
  var_1_19 = ((((var_1_38) > (-5)) ? (var_1_38) : (-5)));
 } else {
  var_1_19 = ((((var_1_38) < 0 ) ? -(var_1_38) : (var_1_38)));
 }
 if (! (! (var_1_62 <= var_1_38))) {
  ...
  var_1_32 = ((((((var_1_37) > (var_1_34)) ? (var_1_37) : (var_1_34))) + 30970) - ((((var_1_35) < (var_1_54)) ? (var_1_35) : (var_1_54))));
 }
 ...
 if (var_1_38 <= stepLocal_11) {
  if (var_1_47) {
   var_1_52 = ((((var_1_39) > (var_1_34)) ? (var_1_39) : (var_1_34)));
  } else {
   if (var_1_26 > (var_1_14 - var_1_13)) {
    var_1_52 = ((((((((var_1_25) < (var_1_32)) ? (var_1_25) : (var_1_32)))) < (500u)) ? (((((var_1_25) < (var_1_32)) ? (var_1_25) : (var_1_32)))) : (500u)));
   } else {
    var_1_52 = var_1_16;
   }
  }
 } else {
  var_1_52 = (((var_1_53 - 4u) - var_1_32) + ((((var_1_41 + var_1_36) < 0 ) ? -(var_1_41 + var_1_36) : (var_1_41 + var_1_36))));
 }
}
