...
void step(void) {
 ...
 if (last_1_unsigned_short_int_Array_0_0_ > stepLocal_0) {
  (*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)) = (((((-4 + (*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)))) < ((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)))) ? ((-4 + (*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)))) : ((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)))));
 }
