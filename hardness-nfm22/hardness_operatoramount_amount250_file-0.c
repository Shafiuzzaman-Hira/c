...
void step(void) {
	...
	if ((var_1_2 - var_1_3) == (- var_1_40)) {
		if (var_1_3 <= ((var_1_40 * 1.5) + 127.4)) {
			...
			var_1_1 = (min ((var_1_50 - (var_1_30 + var_1_30)) , var_1_50));
		}
	} else {
	...
	var_1_9 = ((max (var_1_50 , var_1_30)) - (max ((27761 - var_1_30) , var_1_50)));


	// From: Req6Batch0Amount250
	if (var_1_21) {
		if (var_1_14 >= (- 31.9)) {
			var_1_25 = (min (((max (var_1_30 , var_1_50)) + var_1_50) , -5));
		} else {
	...
	if (var_1_22) {
		...
		var_1_26 = (min (var_1_50 , var_1_30));
	}
	...
	if (stepLocal_1 < var_1_50) {
		var_1_27 = (max (var_1_50 , (min (var_1_30 , var_1_30))));
	}


	// From: Req9Batch0Amount250
	if (var_1_21) {
		var_1_28 = ((max (var_1_50 , 1000)) - var_1_30);
	}
	...
	if (var_1_36 || var_1_36) {
		if (var_1_30 == (min ((16 - var_1_50) , var_1_30))) {
			var_1_41 = (! (! var_1_22));
		} else {
			if ((! 1) || var_1_20) {
				var_1_41 = var_1_22;
	...
	if (last_1_var_1_54 == var_1_14) {
		...
		var_1_54 = (max (var_1_16 , (var_1_15 + var_1_14)));
	}
	...
	if (var_1_23 <= stepLocal_3) {
		var_1_35 = (var_1_55 - ((min (var_1_34 , var_1_26)) + (min (var_1_30 , var_1_31))));
	} else {
	...
	if (var_1_14 >= (var_1_16 + var_1_3)) {
		if ((var_1_55 + 10) >= ((-500 + var_1_50) * var_1_50)) {
			if ((min (var_1_50 , var_1_55)) >= var_1_50) {
				var_1_17 = (! (! var_1_18));
			}
		}
	} else {
	...
	if ((var_1_30 > var_1_1) || var_1_48) {
		...
		if (var_1_23 > var_1_43) {
			...
			if (var_1_22 || (var_1_43 >= (max (var_1_42 , var_1_33)))) {
	...
	signed long int stepLocal_7 = var_1_42 >> (min (var_1_45 , var_1_46));
...
int property() {
	return (((((((((((((((((((((((((((((var_1_2 - var_1_3) == (- var_1_40)) ? ((var_1_3 <= ((var_1_40 * 1.5) + 127.4)) ? (var_1_1 == ((signed short int) (var_1_50 - ((var_1_30 + var_1_30) + var_1_50)))) : (var_1_1 == ((signed short int) (min ((var_1_50 - (var_1_30 + var_1_30)) , var_1_50))))) : (var_1_1 == ((signed short int) (var_1_50 - (var_1_30 + var_1_30))))) && (var_1_9 == ((signed short int) ((max (var_1_50 , var_1_30)) - (max ((27761 - var_1_30) , var_1_50)))))) && (var_1_36 ? (((last_1_var_1_10 * (var_1_2 - var_1_3)) <= var_1_57) ? (var_1_10 == ((double) var_1_13)) : (var_1_10 == ((double) ((var_1_14 + var_1_15) - var_1_16)))) : 1)) && ((var_1_14 >= (var_1_16 + var_1_3)) ? (((var_1_55 + 10) >= ((-500 + var_1_50) * var_1_50)) ? (((min (var_1_50 , var_1_55)) >= var_1_50) ? (var_1_17 == ((unsigned char) (! (! var_1_18)))) : 1) : 1) : ((var_1_50 == ((var_1_50 + var_1_30) - var_1_50)) ? (var_1_17 == ((unsigned char) ((var_1_48 && var_1_18) || var_1_20))) : (((- var_1_50) == var_1_50) ? (var_1_17 == ((unsigned char) (! (var_1_20 && var_1_18)))) : (var_1_20 ? (var_1_18 ? (var_1_17 == ((unsigned char) ((var_1_16 != (- 9.125)) || var_1_21))) : (var_1_17 == ((unsigned char) var_1_22))) : 1))))) && ((var_1_41 || (var_1_50 <= var_1_50)) ? (var_1_23 == ((signed short int) (min (var_1_42 , 5)))) : 1)) && (var_1_21 ? ((var_1_14 >= (- 31.9)) ? (var_1_25 == ((signed short int) (min (((max (var_1_30 , var_1_50)) + var_1_50) , -5)))) : (var_1_25 == ((signed short int) (var_1_50 + var_1_30)))) : 1)) && (var_1_22 ? (var_1_26 == ((signed short int) (var_1_30 + var_1_30))) : (var_1_26 == ((signed short int) (min (var_1_50 , var_1_30)))))) && ((var_1_30 < var_1_50) ? (var_1_27 == ((signed short int) (max (var_1_50 , (min (var_1_30 , var_1_30)))))) : 1)) && (var_1_21 ? (var_1_28 == ((signed long int) ((max (var_1_50 , 1000)) - var_1_30))) : 1)) && (var_1_29 == ((unsigned short int) (var_1_50 + var_1_30)))) && ((((var_1_31 - var_1_32) - var_1_33) != last_1_var_1_30) ? (var_1_30 == ((unsigned char) var_1_33)) : (((last_1_var_1_50 - last_1_var_1_50) != last_1_var_1_30) ? (var_1_30 == ((unsigned char) (max (var_1_32 , (max (var_1_33 , var_1_34)))))) : (var_1_30 == ((unsigned char) var_1_32))))) && ((var_1_23 <= ((var_1_30 - var_1_50) * var_1_9)) ? (var_1_35 == ((signed long int) (var_1_55 - ((min (var_1_34 , var_1_26)) + (min (var_1_30 , var_1_31)))))) : (((var_1_20 || var_1_21) || (var_1_30 >= (var_1_50 - var_1_30))) ? (var_1_21 ? (var_1_35 == ((signed long int) (var_1_29 + last_1_var_1_35))) : 1) : 1))) && (((max ((min (var_1_2 , var_1_3)) , var_1_13)) > var_1_16) ? (var_1_36 == ((unsigned char) 0)) : 1)) && (((var_1_30 > var_1_1) || var_1_48) ? ((! var_1_48) ? (var_1_37 == ((unsigned char) (! (var_1_20 && var_1_18)))) : 1) : ((var_1_23 > var_1_43) ? (var_1_37 == ((unsigned char) ((! var_1_21) || (! var_1_20)))) : ((var_1_22 || (var_1_43 >= (max (var_1_42 , var_1_33)))) ? (var_1_37 == ((unsigned char) ((var_1_54 > var_1_2) || var_1_21))) : 1)))) && ((var_1_2 < (var_1_3 * 10.5)) ? ((var_1_32 > var_1_30) ? (var_1_38 == ((unsigned char) ((var_1_21 && var_1_18) && (var_1_48 || (var_1_17 || var_1_20))))) : (var_1_38 == ((unsigned char) (var_1_22 || var_1_39)))) : 1)) && ((var_1_30 >= var_1_30) ? (var_1_40 == ((float) (max (var_1_15 , var_1_14)))) : 1)) && ((var_1_36 || var_1_36) ? ((var_1_30 == (min ((16 - var_1_50) , var_1_30))) ? (var_1_41 == ((unsigned char) (! (! var_1_22)))) : (((! 1) || var_1_20) ? (var_1_41 == ((unsigned char) var_1_22)) : 1)) : (var_1_41 == ((unsigned char) ((var_1_18 && var_1_22) || (var_1_20 && var_1_39)))))) && ((! var_1_39) ? (var_1_42 == ((signed char) (abs (var_1_32)))) : 1)) && (var_1_43 == ((signed short int) (var_1_32 - 5)))) && (((var_1_42 >> (min (var_1_45 , var_1_46))) <= ((var_1_50 % var_1_31) & -25)) ? (var_1_17 ? ((var_1_30 >= var_1_31) ? (var_1_44 == ((signed long int) var_1_45)) : (var_1_44 == ((signed long int) ((min ((var_1_46 + var_1_34) , (abs (var_1_33)))) - var_1_25)))) : (((var_1_45 - var_1_46) <= ((3294629264u - var_1_50) + (var_1_42 + var_1_50))) ? (var_1_44 == ((signed long int) (var_1_34 - ((var_1_47 + 1000000000) - (abs (-10)))))) : 1)) : 1)) && (((var_1_47 & var_1_30) <= var_1_53) ? (var_1_48 == ((unsigned char) (last_1_var_1_48 && (var_1_22 || (var_1_39 || var_1_49))))) : (((-16 * (10 / var_1_31)) > var_1_30) ? (var_1_48 == ((unsigned char) (! (var_1_22 || var_1_39)))) : (var_1_48 == ((unsigned char) var_1_21))))) && (var_1_20 ? ((var_1_16 != var_1_40) ? (var_1_50 == ((unsigned char) var_1_46)) : 1) : 1)) && (var_1_52 == ((double) var_1_13))) && (var_1_22 ? (var_1_53 == ((unsigned short int) var_1_50)) : (var_1_53 == ((unsigned short int) var_1_50)))) && ((last_1_var_1_54 == var_1_14) ? (var_1_54 == ((float) var_1_14)) : (var_1_54 == ((float) (max (var_1_16 , (var_1_15 + var_1_14))))))) && (var_1_55 == ((unsigned long int) var_1_30))) && (var_1_56 == ((signed char) var_1_32))) && (var_1_57 == ((float) var_1_13))
;
}
int main(void) {
	isInitial = 1;
