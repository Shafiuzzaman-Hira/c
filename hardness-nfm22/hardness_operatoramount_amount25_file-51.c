...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch51Amount25.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch51Amount25
	if (! (var_1_5 >= (abs (var_1_8)))) {
		var_1_7 = (var_1_9 + 1);
	}


	// From: Req4Batch51Amount25
	var_1_12 = var_1_9;


	// From: Req5Batch51Amount25
	var_1_13 = var_1_14;


	// From: Req6Batch51Amount25
	var_1_15 = var_1_6;


	// From: Req1Batch51Amount25
