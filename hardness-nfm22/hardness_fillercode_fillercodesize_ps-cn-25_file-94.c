...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch94PS_CN_25.c", 13, "reach_error"); }
...
double var_1_36 = 24.2;
double var_1_37 = 500.48;
double var_1_38 = 0.0;
double var_1_39 = 499.65;
...
void step(void) {
	...
	// From: CodeObject4
	if (var_1_32) {
		if ((min (var_1_31 , var_1_33)) <= var_1_30) {
	...
	// From: CodeObject5
	if (-0.6f >= var_1_37) {
		var_1_40 = (max (var_1_41 , (min (var_1_42 , var_1_43))));
	} else {
	...
	// From: Req3Batch94PS_CN_25
	var_1_9 = ((min (var_1_10 , var_1_11)) + (var_1_12 + (var_1_13 - var_1_14)));


	// From: Req4Batch94PS_CN_25
	if (var_1_10 >= var_1_11) {
		var_1_15 = (max ((max ((abs (var_1_16)) , var_1_17)) , var_1_18));
	}


	// From: Req7Batch94PS_CN_25
	var_1_25 = -256;


	// From: Req8Batch94PS_CN_25
	var_1_26 = var_1_17;


	// From: Req9Batch94PS_CN_25
	var_1_27 = var_1_6;


	// From: Req2Batch94PS_CN_25
	if (var_1_7 || var_1_1) {
