...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch80100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req12Batch80100_1loop
	if (var_1_9) {
		var_1_30 = (! var_1_31);
	}


	// From: Req14Batch80100_1loop
	var_1_35 = var_1_16;


	// From: Req15Batch80100_1loop
	var_1_36 = var_1_14;


	// From: Req16Batch80100_1loop
	var_1_37 = var_1_25;


	// From: Req2Batch80100_1loop
	...
	// From: Req1Batch80100_1loop
	if (((~ var_1_17) + (var_1_19 + var_1_37)) <= var_1_23) {
		var_1_1 = (var_1_6 - var_1_7);
	}


	// From: Req10Batch80100_1loop
