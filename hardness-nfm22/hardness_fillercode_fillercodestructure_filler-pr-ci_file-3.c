...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch3Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_20 > var_1_21) {
		if (var_1_41 != var_1_14) {
			var_1_42 = (var_1_14 + var_1_22);
		} else {
			if ((var_1_17 > var_1_17) || var_1_3) {
				if (var_1_3) {
					var_1_42 = var_1_14;
				} else {
					var_1_42 = 10;
	...
	// From: CodeObject1
	if (var_1_14 >= (max (var_1_20 , var_1_6))) {
		var_1_24 = (min ((max (var_1_6 , var_1_14)) , var_1_20));
	} else {
		var_1_24 = ((abs (var_1_14)) + (abs (var_1_6)));
	}


	// From: Req4Batch3Filler_PR_CI
	...
	// From: CodeObject3
	if (((var_1_14 ^ var_1_21) % var_1_21) > -10) {
		var_1_30 = (abs (var_1_20));
	}


	// From: CodeObject5
	if (var_1_14 >= ((var_1_35 & var_1_20) >> var_1_14)) {
		var_1_37 = (min (var_1_16 , var_1_16));
	}


	// From: Req1Batch3Filler_PR_CI
	...
	// From: CodeObject4
	if ((~ var_1_23) <= ((max (var_1_5 , -16)) & 16)) {
		var_1_32 = var_1_16;
	} else {
		if (var_1_10 <= ((min (var_1_34 , var_1_35)) - (abs (var_1_14)))) {
			var_1_32 = var_1_16;
		} else {
			var_1_32 = var_1_16;
		}
