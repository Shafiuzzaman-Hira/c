...
void step(void) {
	// From: Req9Batch36Amount250
	signed long int stepLocal_6 = last_1_var_1_44 + (- last_1_var_1_61);
	if (last_1_var_1_72) {
		var_1_36 = (last_1_var_1_44 - last_1_var_1_44);
	} else {
		if (stepLocal_6 < 1) {
			var_1_36 = (max ((-64 + var_1_17) , var_1_16));
		} else {
			var_1_36 = (((max (var_1_38 , var_1_39)) - (last_1_var_1_44 + last_1_var_1_44)) - last_1_var_1_44);
		}
	}


	// From: Req16Batch36Amount250
	if (last_1_var_1_48) {
		if (last_1_var_1_71) {
			if ((last_1_var_1_24 * last_1_var_1_65) >= var_1_17) {
				var_1_57 = ((min (var_1_45 , last_1_var_1_44)) - (max (var_1_47 , var_1_39)));
			} else {
				var_1_57 = (25 - ((min (var_1_58 , var_1_59)) - var_1_46));
			}
		}
	} else {
	...
	// From: Req8Batch36Amount250
	if (last_1_var_1_48) {
		if (var_1_21 >= last_1_var_1_44) {
			var_1_32 = ((var_1_33 - last_1_var_1_44) + (min (last_1_var_1_44 , last_1_var_1_44)));
		} else {
	...
	// From: Req12Batch36Amount250
	var_1_48 = ((var_1_49 || var_1_50) || (! var_1_51));


	// From: Req21Batch36Amount250
	var_1_72 = (! var_1_51);


	// From: Req22Batch36Amount250
	if (var_1_51) {
		var_1_73 = (max (var_1_63 , var_1_59));
	}


	// From: Req10Batch36Amount250
	if (var_1_48) {
		if (var_1_48) {
			var_1_42 = (max ((var_1_23 + (1000.375 + var_1_43)) , var_1_22));
		}
	}


	// From: Req11Batch36Amount250
	...
	// From: Req17Batch36Amount250
	signed long int stepLocal_10 = -10;
	if (var_1_44 != stepLocal_10) {
		var_1_60 = var_1_44;
	} else {
		var_1_60 = (41209 - (min (var_1_44 , var_1_33)));
	}


	// From: Req23Batch36Amount250
	if (var_1_49) {
		var_1_74 = var_1_44;
	} else {
		var_1_74 = 0;
	...
	// From: Req25Batch36Amount250
	var_1_76 = var_1_44;


	// From: Req4Batch36Amount250
	if (var_1_44 < ((max (var_1_20 , var_1_21)) - 16u)) {
	...
	// From: Req7Batch36Amount250
	signed long int stepLocal_5 = min (var_1_44 , (var_1_16 * var_1_15));
	if ((var_1_23 + (- var_1_22)) <= ((var_1_4 + var_1_42) + var_1_5)) {
		var_1_26 = (var_1_27 - var_1_44);
	} else {
		if ((var_1_27 * var_1_17) > stepLocal_5) {
			var_1_26 = (min (var_1_27 , var_1_44));
		} else {
			var_1_26 = (min ((var_1_27 - var_1_44) , (min ((var_1_29 - var_1_44) , var_1_44))));
		}
	}


	// From: Req14Batch36Amount250
	signed char stepLocal_8 = var_1_18;
	if (stepLocal_8 == var_1_26) {
		if ((max (var_1_5 , var_1_22)) < var_1_42) {
			var_1_53 = (2.2f + (max (3.4f , var_1_22)));
		} else {
			var_1_53 = ((abs (var_1_43)) + (var_1_54 + var_1_55));
		}
	}


	// From: Req15Batch36Amount250
	...
	// From: Req24Batch36Amount250
	if (var_1_5 > (var_1_53 * var_1_43)) {
		var_1_75 = (max (var_1_64 , (var_1_15 + 1)));
	} else {
		var_1_75 = (max ((var_1_62 - var_1_63) , var_1_16));
	}


	// From: Req20Batch36Amount250
	if (var_1_5 >= var_1_4) {
		if (var_1_57 > (var_1_32 << var_1_24)) {
			var_1_71 = (var_1_72 && var_1_50);
		}
	} else {
		if (((min (var_1_44 , var_1_21)) << var_1_32) != var_1_75) {
			var_1_71 = (! var_1_49);
		}
	}


	// From: Req13Batch36Amount250
	...
	// From: Req2Batch36Amount250
	if (((var_1_4 - var_1_5) * var_1_19) <= var_1_6) {
		var_1_8 = var_1_26;
	} else {
		var_1_8 = (max ((max (var_1_26 , var_1_32)) , (min (var_1_32 , var_1_26))));
	}


	// From: Req6Batch36Amount250
	...
	if (var_1_1 >= (var_1_6 * var_1_1)) {
		if (var_1_17 >= stepLocal_12) {
			...
			var_1_61 = (min (var_1_15 , var_1_64));
		}
	} else {
	...
	// From: Req19Batch36Amount250
	signed long int stepLocal_15 = abs (var_1_44);
		...
		if (var_1_46 > stepLocal_13) {
			if (var_1_51) {
				if (stepLocal_14 == var_1_44) {
					var_1_65 = ((min (var_1_36 , (min (var_1_45 , var_1_61)))) + var_1_63);
				} else {
					var_1_65 = (((var_1_68 - var_1_44) - (var_1_69 - var_1_45)) + var_1_44);
				}
			} else {
				var_1_65 = ((abs (var_1_26)) - (var_1_44 + (var_1_69 - var_1_58)));
			}
		} else {
...
int property() {
	return ((((((((((((((((((((((((var_1_71 ? (((-5 + 64) < var_1_13) ? (var_1_1 == ((float) (max ((var_1_4 - var_1_5) , (var_1_6 - 5.4f))))) : (var_1_1 == ((float) (min ((min (-0.5f , 2.35f)) , var_1_6))))) : (var_1_48 ? (var_1_1 == ((float) (max (var_1_6 , var_1_4)))) : (var_1_1 == ((float) (var_1_5 - var_1_4))))) && ((((var_1_4 - var_1_5) * var_1_19) <= var_1_6) ? (var_1_8 == ((unsigned long int) var_1_26)) : (var_1_8 == ((unsigned long int) (max ((max (var_1_26 , var_1_32)) , (min (var_1_32 , var_1_26)))))))) && ((var_1_72 && (var_1_25 >= var_1_4)) ? (var_1_13 == ((signed char) ((var_1_15 + var_1_16) + var_1_17))) : (((var_1_16 << var_1_73) > last_1_var_1_13) ? (var_1_13 == ((signed char) (abs ((var_1_15 + var_1_16) + (min (var_1_17 , var_1_18)))))) : 1))) && ((var_1_44 < ((max (var_1_20 , var_1_21)) - 16u)) ? (var_1_19 == ((float) (255.5f - var_1_5))) : (var_1_19 == ((float) (var_1_22 + var_1_23))))) && ((var_1_17 < (last_1_var_1_24 + (var_1_32 * 2))) ? (var_1_24 == ((signed long int) var_1_16)) : 1)) && (((var_1_48 || (var_1_23 != var_1_53)) || (var_1_44 >= var_1_44)) ? (var_1_25 == ((double) (var_1_23 + var_1_22))) : 1)) && (((var_1_23 + (- var_1_22)) <= ((var_1_4 + var_1_42) + var_1_5)) ? (var_1_26 == ((unsigned short int) (var_1_27 - var_1_44))) : (((var_1_27 * var_1_17) > (min (var_1_44 , (var_1_16 * var_1_15)))) ? (var_1_26 == ((unsigned short int) (min (var_1_27 , var_1_44)))) : (var_1_26 == ((unsigned short int) (min ((var_1_27 - var_1_44) , (min ((var_1_29 - var_1_44) , var_1_44))))))))) && (last_1_var_1_48 ? ((var_1_21 >= last_1_var_1_44) ? (var_1_32 == ((unsigned short int) ((var_1_33 - last_1_var_1_44) + (min (last_1_var_1_44 , last_1_var_1_44))))) : ((((var_1_33 << last_1_var_1_44) * var_1_18) <= ((last_1_var_1_52 * var_1_27) ^ -4)) ? ((last_1_var_1_60 > var_1_21) ? (var_1_32 == ((unsigned short int) (var_1_27 - (last_1_var_1_44 + last_1_var_1_44)))) : (var_1_32 == ((unsigned short int) last_1_var_1_44))) : (var_1_32 == ((unsigned short int) var_1_27)))) : (var_1_32 == ((unsigned short int) last_1_var_1_44)))) && (last_1_var_1_72 ? (var_1_36 == ((signed short int) (last_1_var_1_44 - last_1_var_1_44))) : (((last_1_var_1_44 + (- last_1_var_1_61)) < 1) ? (var_1_36 == ((signed short int) (max ((-64 + var_1_17) , var_1_16)))) : (var_1_36 == ((signed short int) (((max (var_1_38 , var_1_39)) - (last_1_var_1_44 + last_1_var_1_44)) - last_1_var_1_44)))))) && (var_1_48 ? (var_1_48 ? (var_1_42 == ((double) (max ((var_1_23 + (1000.375 + var_1_43)) , var_1_22)))) : 1) : 1)) && (((var_1_27 - last_1_var_1_44) > last_1_var_1_44) ? (var_1_44 == ((unsigned char) var_1_45)) : ((! var_1_72) ? (var_1_44 == ((unsigned char) (var_1_46 - var_1_47))) : 1))) && (var_1_48 == ((unsigned char) ((var_1_49 || var_1_50) || (! var_1_51))))) && ((var_1_72 || (var_1_56 <= var_1_57)) ? (var_1_52 == ((signed short int) var_1_46)) : 1)) && ((var_1_18 == var_1_26) ? (((max (var_1_5 , var_1_22)) < var_1_42) ? (var_1_53 == ((float) (2.2f + (max (3.4f , var_1_22))))) : (var_1_53 == ((float) ((abs (var_1_43)) + (var_1_54 + var_1_55))))) : 1)) && ((var_1_26 > var_1_20) ? (var_1_56 == ((unsigned short int) (var_1_29 - var_1_46))) : 1)) && (last_1_var_1_48 ? (last_1_var_1_71 ? (((last_1_var_1_24 * last_1_var_1_65) >= var_1_17) ? (var_1_57 == ((signed short int) ((min (var_1_45 , last_1_var_1_44)) - (max (var_1_47 , var_1_39))))) : (var_1_57 == ((signed short int) (25 - ((min (var_1_58 , var_1_59)) - var_1_46))))) : 1) : (var_1_57 == ((signed short int) (last_1_var_1_44 - var_1_38))))) && ((var_1_44 != -10) ? (var_1_60 == ((unsigned short int) var_1_44)) : (var_1_60 == ((unsigned short int) (41209 - (min (var_1_44 , var_1_33))))))) && ((var_1_1 >= (var_1_6 * var_1_1)) ? ((var_1_17 >= var_1_36) ? (var_1_61 == ((signed char) (var_1_62 - var_1_63))) : (var_1_61 == ((signed char) (min (var_1_15 , var_1_64))))) : ((var_1_51 && var_1_49) ? (var_1_61 == ((signed char) (var_1_62 - var_1_63))) : (var_1_61 == ((signed char) (var_1_17 + var_1_15)))))) && (((abs (var_1_44)) < (var_1_44 ^ var_1_45)) ? (var_1_65 == ((signed long int) (var_1_32 + 25))) : ((var_1_46 > var_1_57) ? (var_1_51 ? ((((var_1_36 * var_1_45) / (var_1_29 - var_1_59)) == var_1_44) ? (var_1_65 == ((signed long int) ((min (var_1_36 , (min (var_1_45 , var_1_61)))) + var_1_63))) : (var_1_65 == ((signed long int) (((var_1_68 - var_1_44) - (var_1_69 - var_1_45)) + var_1_44)))) : (var_1_65 == ((signed long int) ((abs (var_1_26)) - (var_1_44 + (var_1_69 - var_1_58)))))) : (var_1_65 == ((signed long int) (var_1_29 - var_1_44)))))) && ((var_1_5 >= var_1_4) ? ((var_1_57 > (var_1_32 << var_1_24)) ? (var_1_71 == ((unsigned char) (var_1_72 && var_1_50))) : 1) : ((((min (var_1_44 , var_1_21)) << var_1_32) != var_1_75) ? (var_1_71 == ((unsigned char) (! var_1_49))) : 1))) && (var_1_72 == ((unsigned char) (! var_1_51)))) && (var_1_51 ? (var_1_73 == ((unsigned long int) (max (var_1_63 , var_1_59)))) : 1)) && (var_1_49 ? (var_1_74 == ((unsigned short int) var_1_44)) : (var_1_74 == ((unsigned short int) 0)))) && ((var_1_5 > (var_1_53 * var_1_43)) ? (var_1_75 == ((signed char) (max (var_1_64 , (var_1_15 + 1))))) : (var_1_75 == ((signed char) (max ((var_1_62 - var_1_63) , var_1_16)))))) && (var_1_76 == ((signed long int) var_1_44))
;
}
int main(void) {
	isInitial = 1;
