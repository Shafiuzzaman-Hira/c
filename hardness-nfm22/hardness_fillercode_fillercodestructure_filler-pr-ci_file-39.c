...
void step(void) {
	...
	// From: Req7Batch39Filler_PR_CI
	var_1_24 = var_1_25;


	// From: CodeObject4
	if ((var_1_37 % (abs (var_1_41))) >= (var_1_26 * var_1_39)) {
		var_1_40 = (max ((abs (var_1_38 + var_1_39)) , var_1_7));
	}


	// From: CodeObject6
	if (var_1_10 > var_1_39) {
		var_1_45 = (max (var_1_22 , (var_1_46 - (abs (var_1_21)))));
	} else {
		if (-32 < var_1_8) {
			var_1_45 = (max ((abs (var_1_21)) , var_1_22));
		}
	}
	...
	// From: Req8Batch39Filler_PR_CI
	var_1_26 = var_1_8;


	// From: Req3Batch39Filler_PR_CI
	...
	if (var_1_8 <= (var_1_37 & var_1_41)) {
		if ((var_1_23 * var_1_21) >= var_1_21) {
			if (! var_1_6) {
				var_1_43 = (3151323843u - (var_1_38 + (abs (var_1_8))));
			} else {
				var_1_43 = var_1_8;
			}
		} else {
	...
	// From: CodeObject1
	if (var_1_16) {
		if ((abs (min (127.5f , var_1_20))) > 10.5f) {
			var_1_27 = var_1_1;
		}
	}


	// From: Req6Batch39Filler_PR_CI
