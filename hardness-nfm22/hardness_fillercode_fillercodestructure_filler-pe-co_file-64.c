...
void step(void) {
	// From: Req4Batch64Filler_PE_CO
	var_1_19 = ((var_1_20 - var_1_21) - var_1_22);


	// From: Req6Batch64Filler_PE_CO
	...
	// From: Req3Batch64Filler_PE_CO
	if (var_1_10 != var_1_25) {
		var_1_18 = (min (var_1_13 , var_1_12));
	}


	// From: Req5Batch64Filler_PE_CO
	if (! ((64 * var_1_18) < var_1_18)) {
		var_1_23 = var_1_24;
	}


	// From: Req1Batch64Filler_PE_CO
	if (-8 <= var_1_10) {
