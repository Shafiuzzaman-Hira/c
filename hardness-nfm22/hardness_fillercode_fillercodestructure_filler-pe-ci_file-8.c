...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch8Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch8Filler_PE_CI
	if (last_1_var_1_13 == (last_1_var_1_13 % var_1_4)) {
		var_1_1 = (var_1_5 - var_1_6);
	}


	// From: Req5Batch8Filler_PE_CI
	if (var_1_10 == var_1_1) {
		if (var_1_11) {
	...
	// From: Req2Batch8Filler_PE_CI
	if (var_1_1 >= var_1_6) {
		var_1_7 = var_1_19;
	}


	// From: Req3Batch8Filler_PE_CI
	...
	// From: CodeObject1
	if (var_1_16 != (var_1_24 + var_1_21)) {
		if (var_1_11) {
			var_1_27 = (abs (var_1_19));
		}
	} else {
		var_1_27 = var_1_19;
	}
	...
	// From: CodeObject2
	if (var_1_11) {
		var_1_33 = (max (var_1_16 , var_1_26));
	}
	...
	if (var_1_20 <= var_1_22) {
		if (var_1_5 < 255.2f) {
			if ((16 <= var_1_26) && (var_1_20 >= var_1_16)) {
				var_1_40 = (max (var_1_26 , var_1_20));
			}
		}
	}
	...
	// From: CodeObject6
	if (var_1_24 < (max ((max (var_1_15 , var_1_20)) , var_1_15))) {
		var_1_42 = var_1_6;
	} else {
		if (var_1_6 <= var_1_6) {
			var_1_42 = (abs (abs (var_1_6)));
		} else {
			if (var_1_6 <= var_1_6) {
				var_1_42 = (max ((var_1_5 - var_1_5) , var_1_6));
			}
		}
	}
	...
	// From: CodeObject7
	if ((var_1_23 % var_1_20) < var_1_20) {
		var_1_45 = ((var_1_20 - var_1_23) + var_1_20);
	} else {
		var_1_45 = var_1_20;
	}
}
