...
void step(void) {
	...
	if (var_1_19 >= (var_1_1 & (var_1_22 >> var_1_1))) {
		var_1_24 = (var_1_22 - (abs (var_1_19)));
	} else {
		if (var_1_19 > (var_1_1 ^ var_1_22)) {
			var_1_24 = (min (var_1_19 , var_1_1));
		}
	}


	// From: Req2Batch77Filler_PR_CO
	...
	if (var_1_19 >= (-128 & var_1_10)) {
		if (((max (var_1_26 , var_1_27)) <= var_1_28) && var_1_15) {
			var_1_25 = var_1_22;
		}
	} else {
		var_1_25 = var_1_22;
	...
	// From: Req3Batch77Filler_PR_CO
	var_1_10 = (50 + ((var_1_11 + 10000) - var_1_12));


	// From: CodeObject6
	if ((max (var_1_1 , var_1_19)) > var_1_32) {
		if (! var_1_15) {
			if (var_1_15) {
