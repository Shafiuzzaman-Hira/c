...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch60normal.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch60normal
	if (((var_1_10 * var_1_7) + var_1_9) > var_1_1) {
		var_1_16 = (var_1_17 - (var_1_18 - var_1_19));
	}


	// From: Req6Batch60normal
	if (var_1_13) {
