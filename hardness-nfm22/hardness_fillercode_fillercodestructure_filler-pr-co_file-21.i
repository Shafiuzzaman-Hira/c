...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch21Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_17 && (var_1_25 > (var_1_13 / var_1_30))) {
  if (var_1_17) {
   var_1_26 = var_1_13;
  }
 }
 if ((25 & var_1_35) < (var_1_25 - 25)) {
  if ((((((var_1_25 & var_1_8)) < (25)) ? ((var_1_25 & var_1_8)) : (25))) > -64) {
