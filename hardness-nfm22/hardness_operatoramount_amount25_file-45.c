...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch45Amount25.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch45Amount25
	if (var_1_10) {
		var_1_9 = ((var_1_11 + var_1_12) - 5u);
	}


	// From: Req4Batch45Amount25
	var_1_19 = var_1_16;


	// From: Req3Batch45Amount25
