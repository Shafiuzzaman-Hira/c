...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch70Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
	// From: CodeObject1
	if ((min (var_1_9 , var_1_14)) > var_1_18) {
		var_1_21 = (min (((min (var_1_16 , 0)) + var_1_15) , 16));
	}


	// From: CodeObject2
	if ((var_1_15 <= var_1_9) && var_1_20) {
		if (! ((max (var_1_19 , var_1_15)) < (var_1_17 & var_1_14))) {
			var_1_27 = var_1_13;
		} else {
			if ((~ var_1_14) >= (var_1_19 & (abs (var_1_15)))) {
				var_1_27 = var_1_13;
			} else {
				var_1_27 = var_1_13;
			}
	...
	// From: CodeObject6
	if (((var_1_7 - var_1_6) + var_1_6) == var_1_8) {
		var_1_35 = var_1_14;
	}
	...
	// From: Req7Batch70Filler_PS_CI
	if ((var_1_14 / var_1_19) <= (min (var_1_18 , var_1_14))) {
		var_1_20 = var_1_13;
	}


	// From: Req4Batch70Filler_PS_CI
	if (var_1_20) {
		var_1_12 = var_1_13;
	}


	// From: Req3Batch70Filler_PS_CI
