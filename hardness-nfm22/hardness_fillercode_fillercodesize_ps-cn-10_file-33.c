...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch33PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch33PS_CN_10
	var_1_5 = (max (var_1_1 , var_1_14));


	// From: Req7Batch33PS_CN_10
