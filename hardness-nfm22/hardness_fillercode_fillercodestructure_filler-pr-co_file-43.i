...
void step(void) {
 ...
 if ((- var_1_1) < var_1_36) {
  if (var_1_1 > var_1_36) {
   if (((var_1_23 % var_1_40) % ((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41)))) == (var_1_12 / var_1_42)) {
    var_1_39 = (((((var_1_43) > (var_1_44)) ? (var_1_43) : (var_1_44))) - var_1_23);
   }
  }
 } else {
 ...
 if ((var_1_23 | ((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16)))) > var_1_12) {
  if (var_1_34) {
