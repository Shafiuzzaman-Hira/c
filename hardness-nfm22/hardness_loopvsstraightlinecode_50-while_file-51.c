...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch5150_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch5150_while
	if ((min ((~ var_1_1) , 8)) > var_1_11) {
		var_1_17 = var_1_18;
	}


	// From: Req2Batch5150_while
	if (! (var_1_17 > var_1_5)) {
