...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch61dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch61dependencies
	if (last_1_var_1_9 < last_1_var_1_9) {
		var_1_4 = (max (var_1_5 , var_1_6));
	}


	// From: Req7Batch61dependencies
	var_1_21 = var_1_6;


	// From: Req8Batch61dependencies
	var_1_22 = var_1_23;


	// From: Req4Batch61dependencies
	if (var_1_4 >= (4256310412u - 128u)) {
		var_1_9 = ((abs (var_1_22 + var_1_22)) + var_1_22);
	}


	// From: Req1Batch61dependencies
	if ((var_1_21 / (abs (64u))) == var_1_4) {
		var_1_1 = (8.8 - 255.2);
	}


	// From: Req3Batch61dependencies
	if (var_1_9 <= (max (var_1_21 , var_1_5))) {
		if (var_1_9 < var_1_5) {
			if (var_1_9 >= (var_1_21 ^ 4u)) {
				var_1_7 = var_1_8;
			}
		} else {
			var_1_7 = var_1_8;
	...
	// From: Req6Batch61dependencies
	if (((var_1_22 / 2) / var_1_20) >= (~ 100)) {
		if (var_1_13) {
