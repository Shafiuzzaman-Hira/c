...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch87PS_CN_500.c", 13, "reach_error"); }
...
unsigned char var_1_99 = 2;
unsigned char var_1_100 = 1;
unsigned char var_1_101 = 0;
double var_1_102 = 10.8;
unsigned char var_1_103 = 1;
signed long int var_1_104 = -16;
signed char var_1_105 = -64;
unsigned long int var_1_106 = 8;
unsigned long int var_1_107 = 1682103592;
unsigned long int var_1_108 = 200;
unsigned long int var_1_109 = 3532494319;
unsigned long int var_1_110 = 1;
unsigned long int var_1_111 = 32;
unsigned short int var_1_112 = 0;
unsigned short int var_1_113 = 64;
double var_1_114 = 50.75;
double var_1_115 = 255.55;
unsigned char var_1_116 = 0;
float var_1_117 = 8.6;
float var_1_118 = 3.75;
double var_1_119 = 63.75;
double var_1_120 = 256.222;
unsigned long int var_1_121 = 4;
unsigned long int var_1_122 = 64;
double var_1_123 = 63.2;
signed short int var_1_124 = 16;
double var_1_125 = 32.75;
signed long int var_1_126 = -10000000;
signed char var_1_127 = -128;
double var_1_128 = 128.6;
unsigned long int var_1_129 = 8;
float var_1_130 = 15.4;
float var_1_131 = 31.5;
unsigned long int var_1_132 = 32;
signed short int var_1_133 = 5;
unsigned long int var_1_134 = 128;
unsigned long int var_1_135 = 0;
signed char var_1_136 = 64;
float var_1_137 = 32.5;
...
void step(void) {
	...
	if (var_1_43) {
		...
		if (var_1_46 >= var_1_58) {
			var_1_71 = (max ((var_1_50 - var_1_51) , (abs (abs (var_1_36)))));
		}
	}
	...
	// From: CodeObject17
	if (var_1_42) {
		var_1_72 = (max (var_1_52 , var_1_50));
	}
	...
	if (var_1_42) {
		if ((var_1_36 > var_1_34) || (var_1_71 < var_1_46)) {
			var_1_73 = (min (var_1_40 , var_1_74));
		}
	}
	...
	if (var_1_45) {
		if (var_1_70) {
			var_1_76 = (min ((abs (var_1_49)) , var_1_34));
		}
	} else {
		var_1_76 = var_1_35;
	}
	...
	// From: CodeObject21
	if (var_1_59 < (max (var_1_34 , (var_1_67 % var_1_53)))) {
		if (var_1_78 < var_1_67) {
			var_1_77 = (min (((max (var_1_67 , var_1_53)) + var_1_63) , (max (var_1_52 , var_1_51))));
		} else {
			var_1_77 = (max (64 , var_1_67));
		}
	}
	...
	// From: CodeObject22
	if (var_1_41) {
		if ((abs (var_1_55)) < 1.4f) {
			var_1_79 = (((var_1_80 - var_1_81) + var_1_82) - (abs (0.2f)));
		} else {
			if ((var_1_78 >> (abs (var_1_83))) > var_1_47) {
				if (var_1_51 > (var_1_63 / var_1_67)) {
					if ((var_1_84 / var_1_67) <= var_1_76) {
						var_1_79 = ((max (var_1_81 , var_1_82)) + (var_1_80 - (min (var_1_85 , var_1_86))));
					} else {
						if ((abs (var_1_35)) >= var_1_37) {
							var_1_79 = (min ((abs (var_1_80)) , var_1_82));
						} else {
							if (var_1_69 && var_1_44) {
								var_1_79 = (max (var_1_81 , var_1_80));
							}
						}
					}
				}
	...
	// From: CodeObject23
	if (var_1_65 >= (min (var_1_37 , 64))) {
		if (var_1_65 <= (max (var_1_49 , (var_1_63 + var_1_53)))) {
			if ((var_1_71 | var_1_78) <= (abs (var_1_65 + var_1_37))) {
				var_1_87 = (abs (abs (var_1_61)));
			}
		}
	} else {
		var_1_87 = ((max ((var_1_77 + var_1_49) , (min (var_1_50 , var_1_61)))) - 1000000);
	}


	// From: CodeObject24
	if ((var_1_83 & (var_1_52 & var_1_37)) < (var_1_61 + 32)) {
		var_1_88 = ((min ((abs (var_1_82)) , var_1_81)) - (abs (abs (var_1_74))));
	} else {
		var_1_88 = (var_1_80 + (min ((abs (var_1_82)) , var_1_81)));
	}
	...
	if (var_1_74 >= 1.3f) {
		if (var_1_66) {
			if ((abs (var_1_53)) < var_1_34) {
				var_1_89 = (min ((abs (var_1_52)) , (var_1_51 - (abs (var_1_83)))));
			}
		}
	} else {
		if (var_1_41) {
			...
			var_1_89 = (var_1_52 - ((var_1_90 + var_1_91) + var_1_92));
		}
	}


	// From: CodeObject26
	if ((var_1_83 * (var_1_87 % var_1_53)) > var_1_75) {
		if ((abs (max (var_1_73 , var_1_88))) > (abs (var_1_62))) {
			var_1_93 = ((min (var_1_86 , var_1_85)) - var_1_81);
		} else {
			var_1_93 = (min (var_1_82 , (abs (var_1_80))));
		}
	} else {
		if ((var_1_85 * var_1_40) > var_1_88) {
			var_1_93 = (var_1_81 + (abs (var_1_82)));
		}
	}


	// From: CodeObject27
	if ((var_1_47 % (max (var_1_67 , var_1_53))) >= (max (var_1_51 , (var_1_91 + var_1_71)))) {
		if ((var_1_91 << var_1_61) == (var_1_67 - var_1_63)) {
			var_1_94 = (abs (var_1_90));
		}
	} else {
		if (var_1_88 >= (max ((var_1_93 * var_1_62) , var_1_80))) {
			var_1_94 = (max (0 , var_1_51));
		}
	}
	...
	// From: CodeObject28
	if (var_1_68) {
		if (var_1_51 == (~ var_1_78)) {
			var_1_95 = (var_1_49 + var_1_64);
		}
	}


	// From: CodeObject29
	if (var_1_84 < var_1_51) {
		var_1_96 = (abs (var_1_49));
	} else {
		if (var_1_76 > var_1_64) {
			if ((~ var_1_90) >= (var_1_37 + var_1_83)) {
				var_1_96 = var_1_61;
			}
		}
	}
	...
	// From: CodeObject30
	if ((max ((min (var_1_96 , var_1_98)) , var_1_65)) >= (var_1_77 | var_1_67)) {
		var_1_97 = (! (var_1_69 && var_1_68));
	}


	// From: CodeObject31
	if ((- (- var_1_93)) < var_1_88) {
		var_1_99 = (min ((var_1_67 + var_1_90) , (min ((abs (var_1_91)) , var_1_52))));
	}


	// From: CodeObject32
	if ((var_1_96 >> var_1_61) < (var_1_98 & (var_1_63 - var_1_90))) {
		var_1_100 = (((min (var_1_61 , var_1_83)) < (200 ^ var_1_58)) || var_1_101);
	}


	// From: CodeObject33
	if (var_1_50 > var_1_57) {
		var_1_102 = (abs (min ((max (var_1_81 , var_1_40)) , var_1_85)));
	}


	// From: CodeObject34
	if (! var_1_69) {
		var_1_103 = (abs (var_1_92));
	} else {
		if (((~ var_1_65) < 256) && var_1_43) {
			var_1_103 = (min (var_1_92 , var_1_91));
		}
	}
	...
	// From: CodeObject35
	if (var_1_69) {
		if (var_1_72 > ((var_1_67 % var_1_53) / (abs (var_1_50)))) {
			if (var_1_86 > var_1_62) {
				var_1_104 = (abs (abs (var_1_99)));
			}
		}
	} else {
		var_1_104 = (min ((var_1_61 - (abs (-64))) , (var_1_96 - (max (var_1_98 , var_1_103)))));
	}


	// From: CodeObject36
	if (var_1_57 <= var_1_37) {
		var_1_105 = ((abs (abs (var_1_91))) - 8);
	}


	// From: CodeObject37
	if (var_1_66 || ((max (var_1_102 , var_1_93)) < var_1_38)) {
		var_1_106 = ((var_1_107 - (max (5u , var_1_92))) + (abs (abs (var_1_67))));
	} else {
		var_1_106 = (abs (var_1_103));
	}


	// From: CodeObject38
	if (var_1_48 == var_1_63) {
		if ((abs (var_1_51)) < var_1_99) {
			var_1_108 = (var_1_109 - var_1_99);
		}
	}


	// From: CodeObject39
	var_1_110 = (var_1_103 + (abs (var_1_67)));


	// From: CodeObject40
	if (var_1_35 > var_1_75) {
		var_1_111 = (var_1_109 - var_1_91);
	} else {
		var_1_111 = (var_1_50 + (var_1_107 - (max (var_1_51 , var_1_53))));
	}


	// From: CodeObject41
	if (-25 > var_1_108) {
		var_1_112 = (min ((var_1_61 + var_1_51) , (min (var_1_63 , var_1_113))));
	} else {
		var_1_112 = ((min (var_1_61 , var_1_92)) + (max (var_1_67 , (min (var_1_53 , var_1_49)))));
	}


	// From: CodeObject42
	if ((var_1_82 + (min (var_1_38 , var_1_80))) > var_1_81) {
		var_1_114 = (min (var_1_80 , var_1_40));
	} else {
		if (var_1_42) {
			var_1_114 = (abs (var_1_115));
		}
	}


	// From: CodeObject43
	if (var_1_86 >= (min ((var_1_117 * var_1_114) , (max (var_1_74 , var_1_81))))) {
		var_1_116 = ((var_1_89 > var_1_75) && var_1_45);
	}
	...
	// From: CodeObject62
	if (var_1_98 > (var_1_111 >> var_1_64)) {
		var_1_137 = (abs (var_1_85));
	} else {
		var_1_137 = var_1_40;
	}
	...
	// From: CodeObject63
	if ((abs (var_1_57)) == var_1_63) {
		var_1_138 = var_1_45;
	}


	// From: Req1Batch87PS_CN_500
...
void updateVariables() {
	...
	assume_abort_if_not(var_1_98 <= 65535);
	...
	assume_abort_if_not(var_1_113 <= 65534);
