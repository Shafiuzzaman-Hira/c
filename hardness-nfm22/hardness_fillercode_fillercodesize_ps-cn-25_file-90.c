...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch90PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_27 < var_1_26) {
		if (var_1_30 > (var_1_29 >> var_1_31)) {
			if (-4 > (min ((abs (var_1_26)) , var_1_30))) {
				var_1_32 = (16 + var_1_33);
			} else {
				var_1_32 = (abs (var_1_33));
			}
		} else {
			if ((var_1_27 >> var_1_29) < var_1_30) {
				var_1_32 = -32;
			}
		}
	} else {
	...
	// From: Req3Batch90PS_CN_25
	if (((var_1_15 - var_1_12) + var_1_24) < var_1_24) {
		var_1_14 = var_1_12;
	}


	// From: Req5Batch90PS_CN_25
