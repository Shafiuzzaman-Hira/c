...
void step(void) {
	...
	// From: Req10Batch53100_while
	var_1_24 = (var_1_25 + (min (var_1_26 , var_1_27)));


	// From: Req11Batch53100_while
	if (! var_1_12) {
