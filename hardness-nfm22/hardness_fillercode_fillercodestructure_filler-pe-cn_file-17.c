...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch17Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch17Filler_PE_CN
	var_1_1 = (50 + (min (var_1_2 , (min (var_1_3 , var_1_4)))));


	// From: Req5Batch17Filler_PE_CN
	...
	// From: CodeObject7
	if (var_1_25 > (var_1_37 >> var_1_23)) {
		if (var_1_28) {
			var_1_39 = (abs (var_1_37));
		} else {
			var_1_39 = (max ((256 - (var_1_40 - var_1_38)) , var_1_37));
		}
	} else {
		var_1_39 = var_1_35;
	}
