...
void step(void) {
	...
	if ((25 & var_1_35) < (var_1_25 - 25)) {
		if ((min ((var_1_25 & var_1_8) , 25)) > -64) {
			var_1_44 = (abs (var_1_45 - var_1_35));
		}
	}


	// From: Req6Batch21Filler_PR_CO
