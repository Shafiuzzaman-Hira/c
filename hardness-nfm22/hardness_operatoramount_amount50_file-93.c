...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch93Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch93Amount50
	if (var_1_15) {
		var_1_21 = ((var_1_22 + 25) - var_1_19);
	}


	// From: Req7Batch93Amount50
	if (var_1_10) {
	...
	// From: Req5Batch93Amount50
	if (var_1_16) {
		var_1_20 = (var_1_9 - 50);
	}


	// From: Req1Batch93Amount50
