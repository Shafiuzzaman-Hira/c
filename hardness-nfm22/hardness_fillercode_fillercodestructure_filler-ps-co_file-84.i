...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch84Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_6 != ((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))) {
  var_1_33 = (5 + var_1_34);
 }
 if ((~ var_1_34) > (var_1_1 / var_1_36)) {
  var_1_35 = (((((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9))) < 0 ) ? -((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9))) : ((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9)))));
 }
