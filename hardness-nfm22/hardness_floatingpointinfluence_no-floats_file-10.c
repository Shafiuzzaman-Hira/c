...
void step(void) {
	// From: Req1Batch10no_floats
	var_1_1 = var_1_2;


	// From: Req5Batch10no_floats
	var_1_18 = var_1_8;


	// From: Req6Batch10no_floats
	var_1_19 = var_1_12;


	// From: Req7Batch10no_floats
	var_1_20 = var_1_21;


	// From: Req3Batch10no_floats
...
int property() {
	return ((((((var_1_1 == ((unsigned long int) var_1_2)) && ((var_1_15 < var_1_1) ? (var_1_3 == ((signed long int) -0.5)) : (((- last_1_var_1_3) == (var_1_6 - var_1_7)) ? (var_1_3 == ((signed long int) var_1_8)) : (var_1_3 == ((signed long int) var_1_8))))) && (((- (var_1_10 - var_1_11)) >= var_1_19) ? (var_1_9 == ((signed char) (var_1_12 - (max (var_1_13 , var_1_14))))) : (var_1_9 == ((signed char) (min (var_1_12 , var_1_14)))))) && (var_1_20 ? (var_1_15 == ((signed long int) (var_1_12 - var_1_14))) : (var_1_15 == ((signed long int) (var_1_13 - ((var_1_17 - 4) + (abs (var_1_11)))))))) && (var_1_18 == ((signed long int) var_1_8))) && (var_1_19 == ((signed char) var_1_12))) && (var_1_20 == ((unsigned char) var_1_21))
;
}
int main(void) {
	isInitial = 1;
