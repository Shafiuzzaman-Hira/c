...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch82100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch82100_while
	var_1_23 = (var_1_11 + ((max (var_1_24 , var_1_25)) + var_1_26));


	// From: Req8Batch82100_while
	if (1.000000000000075E13f > var_1_11) {
		var_1_27 = (var_1_28 && var_1_29);
	}


	// From: Req12Batch82100_while
	if (var_1_20 > (var_1_19 / var_1_37)) {
		var_1_36 = var_1_16;
	} else {
		var_1_36 = (abs (min (10 , var_1_16)));
	}


	// From: Req13Batch82100_while
	if (var_1_19 > var_1_26) {
		var_1_38 = ((var_1_29 && var_1_28) && var_1_39);
	}


	// From: Req2Batch82100_while
	if (var_1_27) {
		var_1_9 = (var_1_10 - (min ((8.3215551467477422E18f - var_1_11) , var_1_12)));
	} else {
		if (! var_1_27) {
			var_1_9 = var_1_10;
		} else {
	...
	// From: Req11Batch82100_while
	unsigned char stepLocal_6 = var_1_27;
	if (stepLocal_6 || var_1_29) {
		var_1_33 = ((max (var_1_34 , var_1_35)) - (abs (var_1_21)));
	}


	// From: Req6Batch82100_while
	if ((1.75f / (max (var_1_19 , var_1_20))) > var_1_12) {
		var_1_22 = (min ((max (var_1_36 , (max (var_1_33 , 1)))) , var_1_16));
	} else {
		var_1_22 = (var_1_36 - 8);
	}


	// From: Req4Batch82100_while
	...
	if (var_1_16 < stepLocal_1) {
		if (var_1_23 == var_1_23) {
			if (stepLocal_2 == var_1_22) {
				var_1_18 = (max (var_1_12 , var_1_11));
			}
		} else {
			var_1_18 = (((min (var_1_19 , var_1_20)) - var_1_11) - var_1_12);
		}
	}


	// From: Req1Batch82100_while
	...
	// From: Req9Batch82100_while
	signed long int stepLocal_4 = 4;
	if (stepLocal_4 >= var_1_1) {
		var_1_30 = (min (var_1_26 , (min (var_1_20 , var_1_24))));
	} else {
		var_1_30 = var_1_25;
	}


	// From: Req10Batch82100_while
	signed long int stepLocal_5 = var_1_22;
	if (var_1_12 != var_1_30) {
		if (stepLocal_5 < var_1_36) {
			var_1_31 = (max (var_1_16 , (var_1_7 + (var_1_21 + var_1_22))));
		}
	} else {
		if (! var_1_38) {
			var_1_31 = ((min (var_1_17 , var_1_8)) + var_1_1);
		} else {
			var_1_31 = var_1_7;
		}
	}
	...
	// From: Req3Batch82100_while
	if (((abs (var_1_31)) / (min (var_1_15 , 4))) > (var_1_33 + var_1_7)) {
...
int property() {
	return ((((((((((((var_1_27 ? (((var_1_36 <= var_1_22) || (var_1_18 >= var_1_9)) ? (var_1_1 == ((unsigned short int) (max (var_1_7 , var_1_8)))) : (var_1_1 == ((unsigned short int) 25))) : (var_1_1 == ((unsigned short int) var_1_7))) && (var_1_27 ? (var_1_9 == ((float) (var_1_10 - (min ((8.3215551467477422E18f - var_1_11) , var_1_12))))) : ((! var_1_27) ? (var_1_9 == ((float) var_1_10)) : (var_1_9 == ((float) var_1_11))))) && ((((abs (var_1_31)) / (min (var_1_15 , 4))) > (var_1_33 + var_1_7)) ? (var_1_14 == ((signed char) (max (var_1_16 , var_1_17)))) : (var_1_14 == ((signed char) var_1_16)))) && ((var_1_16 < var_1_8) ? ((var_1_23 == var_1_23) ? ((var_1_8 == var_1_22) ? (var_1_18 == ((float) (max (var_1_12 , var_1_11)))) : 1) : (var_1_18 == ((float) (((min (var_1_19 , var_1_20)) - var_1_11) - var_1_12)))) : 1)) && ((var_1_15 > (var_1_7 / 128)) ? (var_1_21 == ((unsigned long int) (var_1_7 + last_1_var_1_33))) : 1)) && (((1.75f / (max (var_1_19 , var_1_20))) > var_1_12) ? (var_1_22 == ((signed long int) (min ((max (var_1_36 , (max (var_1_33 , 1)))) , var_1_16)))) : (var_1_22 == ((signed long int) (var_1_36 - 8))))) && (var_1_23 == ((float) (var_1_11 + ((max (var_1_24 , var_1_25)) + var_1_26))))) && ((1.000000000000075E13f > var_1_11) ? (var_1_27 == ((unsigned char) (var_1_28 && var_1_29))) : 1)) && ((4 >= var_1_1) ? (var_1_30 == ((double) (min (var_1_26 , (min (var_1_20 , var_1_24)))))) : (var_1_30 == ((double) var_1_25)))) && ((var_1_12 != var_1_30) ? ((var_1_22 < var_1_36) ? (var_1_31 == ((signed long int) (max (var_1_16 , (var_1_7 + (var_1_21 + var_1_22)))))) : 1) : ((! var_1_38) ? (var_1_31 == ((signed long int) ((min (var_1_17 , var_1_8)) + var_1_1))) : (var_1_31 == ((signed long int) var_1_7))))) && ((var_1_27 || var_1_29) ? (var_1_33 == ((unsigned long int) ((max (var_1_34 , var_1_35)) - (abs (var_1_21))))) : 1)) && ((var_1_20 > (var_1_19 / var_1_37)) ? (var_1_36 == ((signed short int) var_1_16)) : (var_1_36 == ((signed short int) (abs (min (10 , var_1_16))))))) && ((var_1_19 > var_1_26) ? (var_1_38 == ((unsigned char) ((var_1_29 && var_1_28) && var_1_39))) : 1)
;
}
int main(void) {
	isInitial = 1;
