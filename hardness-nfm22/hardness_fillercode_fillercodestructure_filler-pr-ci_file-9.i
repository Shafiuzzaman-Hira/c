...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch9Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3))) == (~ 16u)) {
  if (var_1_15 || var_1_15) {
   var_1_23 = ((((10) > (((((var_1_3) < (var_1_11)) ? (var_1_3) : (var_1_11))))) ? (10) : (((((var_1_3) < (var_1_11)) ? (var_1_3) : (var_1_11))))));
  }
 }
 var_1_33 = var_1_8;
 ...
 var_1_18 = var_1_3;
 if (var_1_10 <= var_1_6) {
  if (var_1_10 <= (((((var_1_6) < (var_1_3)) ? (var_1_6) : (var_1_3))) / var_1_6)) {
   var_1_26 = ((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13)));
  }
 } else {
  if (var_1_6 > (2 ^ ((((var_1_10) > (var_1_6)) ? (var_1_10) : (var_1_6))))) {
 ...
 if ((var_1_8 / var_1_30) > ((((var_1_8 / var_1_32) < 0 ) ? -(var_1_8 / var_1_32) : (var_1_8 / var_1_32)))) {
  if (var_1_16 > var_1_6) {
   var_1_28 = var_1_16;
  }
 }
 ...
 if (var_1_15 || var_1_15) {
  var_1_19 = ((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3)));
 }
 if (((256 - var_1_7) <= (var_1_10 + var_1_6)) || var_1_15) {
  if (var_1_15) {
