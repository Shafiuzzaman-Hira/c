...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch72Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_41 = var_1_25;
 if (var_1_37 <= ((((var_1_26) > (var_1_25)) ? (var_1_26) : (var_1_25)))) {
  var_1_43 = var_1_28;
 }
 if (var_1_25 <= ((((-8) > ((var_1_37 ^ var_1_40))) ? (-8) : ((var_1_37 ^ var_1_40))))) {
  if (var_1_17) {
   var_1_44 = ((((var_1_11) > (var_1_11)) ? (var_1_11) : (var_1_11)));
  }
 } else {
  var_1_44 = 64;
 }
 if (var_1_17 || var_1_19) {
  ...
  if (var_1_19) {
   var_1_47 = ((((var_1_21) > (var_1_22)) ? (var_1_21) : (var_1_22)));
  } else {
   if (var_1_38 >= var_1_25) {
    var_1_47 = ((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21)));
   } else {
