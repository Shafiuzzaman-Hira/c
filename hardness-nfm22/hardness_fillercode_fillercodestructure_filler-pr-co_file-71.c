...
void step(void) {
	...
	// From: CodeObject8
	if (var_1_20 < (min (var_1_38 , var_1_36))) {
		if (var_1_45) {
			var_1_50 = var_1_51;
		}
	}
	...
	// From: CodeObject7
	if ((var_1_22 * (min (var_1_32 , var_1_47))) < var_1_22) {
		var_1_49 = (abs (var_1_38));
	}


	// From: Req9Batch71Filler_PR_CO
	var_1_22 = var_1_23;


	// From: CodeObject2
	if ((var_1_19 % (min (var_1_32 , var_1_38))) <= var_1_20) {
	...
	// From: CodeObject1
	if (((min (var_1_25 , var_1_26)) - var_1_27) <= (var_1_18 + var_1_10)) {
		if ((max (var_1_22 , (var_1_20 / var_1_32))) < var_1_14) {
