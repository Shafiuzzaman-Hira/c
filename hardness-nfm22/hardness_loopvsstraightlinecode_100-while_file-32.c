...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch32100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req9Batch32100_while
	if (var_1_3) {
		var_1_25 = (min (var_1_18 , (var_1_26 - var_1_13)));
	} else {
	...
	// From: Req4Batch32100_while
	if ((max ((var_1_14 / var_1_16) , var_1_10)) > var_1_11) {
		var_1_17 = (8.25 - 255.8);
	}


	// From: Req6Batch32100_while
	...
	// From: Req10Batch32100_while
	var_1_27 = ((var_1_28 - var_1_13) + var_1_16);


	// From: Req11Batch32100_while
	if (var_1_1) {
		var_1_29 = var_1_19;
	}


	// From: Req7Batch32100_while
	if ((max (var_1_19 , var_1_27)) <= (var_1_22 - 4u)) {
		var_1_21 = var_1_13;
	} else {
		var_1_21 = var_1_14;
	}
	...
	// From: Req12Batch32100_while
	if (var_1_26 > (abs (38760 - var_1_21))) {
		var_1_30 = ((abs (var_1_14)) - (max ((var_1_31 - var_1_18) , (var_1_32 - var_1_27))));
	} else {
...
int property() {
	return (((((((((((var_1_2 ? (var_1_1 == ((unsigned char) ((! (var_1_3 || var_1_4)) && var_1_5))) : (var_1_1 == ((unsigned char) var_1_4))) && (((var_1_30 >= var_1_29) && var_1_5) ? (var_1_6 == ((unsigned short int) var_1_29)) : ((! (! (var_1_29 < var_1_30))) ? (var_1_6 == ((unsigned short int) (var_1_29 + var_1_30))) : 1))) && ((var_1_27 > last_1_var_1_9) ? ((var_1_6 > (var_1_27 * last_1_var_1_9)) ? (var_1_9 == ((signed char) ((var_1_10 - var_1_11) + (max (var_1_12 , (var_1_13 - var_1_14)))))) : (var_1_9 == ((signed char) (max (var_1_15 , (var_1_13 - (var_1_16 - var_1_11))))))) : 1)) && (((max ((var_1_14 / var_1_16) , var_1_10)) > var_1_11) ? (var_1_17 == ((double) (8.25 - 255.8))) : 1)) && (last_1_var_1_1 ? (last_1_var_1_1 ? (var_1_18 == ((unsigned long int) last_1_var_1_18)) : ((((var_1_12 + last_1_var_1_18) * last_1_var_1_18) >= last_1_var_1_25) ? (var_1_18 == ((unsigned long int) (var_1_19 - var_1_16))) : (var_1_18 == ((unsigned long int) var_1_13)))) : 1)) && ((var_1_14 <= var_1_16) ? (var_1_20 == ((signed char) var_1_16)) : ((var_1_15 <= var_1_12) ? (var_1_20 == ((signed char) (max (var_1_12 , var_1_13)))) : (var_1_20 == ((signed char) var_1_11))))) && (((max (var_1_19 , var_1_27)) <= (var_1_22 - 4u)) ? (var_1_21 == ((unsigned long int) var_1_13)) : (var_1_21 == ((unsigned long int) var_1_14)))) && ((var_1_12 <= var_1_10) ? (((var_1_25 * var_1_13) == var_1_15) ? (var_1_23 == ((float) (abs (var_1_24)))) : ((0 >= var_1_14) ? (var_1_23 == ((float) var_1_24)) : (var_1_23 == ((float) var_1_24)))) : 1)) && (var_1_3 ? (var_1_25 == ((unsigned short int) (min (var_1_18 , (var_1_26 - var_1_13))))) : ((last_1_var_1_25 >= (16u * var_1_11)) ? (var_1_25 == ((unsigned short int) var_1_26)) : (var_1_25 == ((unsigned short int) var_1_18))))) && (var_1_27 == ((unsigned short int) ((var_1_28 - var_1_13) + var_1_16)))) && (var_1_1 ? (var_1_29 == ((unsigned long int) var_1_19)) : 1)) && ((var_1_26 > (abs (38760 - var_1_21))) ? (var_1_30 == ((signed long int) ((abs (var_1_14)) - (max ((var_1_31 - var_1_18) , (var_1_32 - var_1_27)))))) : ((var_1_10 == (var_1_14 - var_1_16)) ? (var_1_30 == ((signed long int) -1)) : (var_1_30 == ((signed long int) var_1_27))))
;
}
int main(void) {
	isInitial = 1;
