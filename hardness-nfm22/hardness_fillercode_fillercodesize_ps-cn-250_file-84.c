...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch84PS_CN_250.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject21
	if (var_1_24 <= (max (var_1_48 , var_1_28))) {
		var_1_79 = (abs (abs (var_1_70)));
	}


	// From: CodeObject22
	if (var_1_56 > var_1_58) {
		var_1_80 = (var_1_70 + var_1_44);
	}


	// From: CodeObject23
	if ((var_1_69 >> var_1_45) < var_1_55) {
		var_1_81 = 0.85f;
	}
	...
	// From: CodeObject24
	if (var_1_66) {
		var_1_82 = (min ((min ((min (var_1_78 , var_1_70)) , var_1_83)) , var_1_84));
	} else {
		if ((var_1_59 & var_1_30) != var_1_76) {
			var_1_82 = ((abs (var_1_85)) - (max (var_1_70 , 1)));
		} else {
			var_1_82 = var_1_85;
		}
	}
	...
	// From: CodeObject25
	if (var_1_87 >= var_1_62) {
		if ((max (var_1_70 , var_1_60)) >= (var_1_50 & (abs (4)))) {
			if (((var_1_57 ^ var_1_77) < var_1_54) && var_1_66) {
				var_1_86 = (abs (var_1_83));
			} else {
				if (! var_1_65) {
					var_1_86 = (abs (var_1_78));
				}
			}
		} else {
			var_1_86 = var_1_88;
	...
	if (var_1_90) {
		...
		if ((var_1_40 / var_1_60) >= ((min (var_1_79 , var_1_99)) >> (min (var_1_70 , var_1_100)))) {
			var_1_98 = var_1_29;
		}
	}


	// From: Req3Batch84PS_CN_250
	...
	// From: Req7Batch84PS_CN_250
	var_1_18 = var_1_17;


	// From: Req8Batch84PS_CN_250
	var_1_19 = 0;


	// From: Req9Batch84PS_CN_250
	var_1_20 = var_1_21;


	// From: Req1Batch84PS_CN_250
	if (var_1_19) {
		var_1_1 = (min ((var_1_3 + (1 - var_1_4)) , var_1_5));
	}


	// From: Req4Batch84PS_CN_250
	if (var_1_3 <= var_1_1) {
		var_1_12 = var_1_4;
	} else {
...
void updateVariables() {
	...
	assume_abort_if_not(var_1_87 >= -32768);
	...
	assume_abort_if_not(var_1_100 <= 32);
}
