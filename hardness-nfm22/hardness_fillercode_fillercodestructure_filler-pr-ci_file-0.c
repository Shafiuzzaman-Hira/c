...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch0Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject6
	if (((abs (var_1_6)) - (var_1_20 + var_1_38)) <= var_1_1) {
		var_1_37 = (max (var_1_30 , (min (var_1_38 , (var_1_39 - var_1_31)))));
	}


	// From: Req4Batch0Filler_PR_CI
	...
	// From: CodeObject3
	if ((var_1_20 & var_1_1) >= var_1_1) {
		var_1_28 = (abs (abs (var_1_20)));
	} else {
		if (var_1_10) {
			var_1_28 = (max ((var_1_20 - (max (var_1_30 , var_1_31))) , (abs (min (var_1_6 , var_1_6)))));
		}
	}


	// From: Req2Batch0Filler_PR_CI
