...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch64stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch64stepLocals
	signed long int stepLocal_0 = var_1_4 >> var_1_2;
	if (stepLocal_0 < (var_1_11 - (var_1_12 - var_1_13))) {
	...
	// From: Req3Batch64stepLocals
	if (var_1_10 != var_1_8) {
		var_1_18 = (min (var_1_13 , var_1_12));
	}


	// From: Req4Batch64stepLocals
	var_1_19 = ((var_1_20 - var_1_21) - var_1_22);


	// From: Req5Batch64stepLocals
	if (! ((64 * var_1_18) < var_1_1)) {
		var_1_23 = var_1_24;
	}


	// From: Req6Batch64stepLocals
	signed short int stepLocal_1 = var_1_22;
	if (((var_1_26 - var_1_27) + var_1_5) > stepLocal_1) {
	...
	// From: Req7Batch64stepLocals
	if ((var_1_18 * var_1_1) < var_1_29) {
...
int property() {
	return (((((((-8 <= var_1_2) ? ((var_1_2 == var_1_3) ? (var_1_1 == ((signed long int) ((min ((var_1_4 + var_1_5) , var_1_6)) + (var_1_7 + var_1_8)))) : 1) : ((128 < var_1_5) ? (var_1_1 == ((signed long int) var_1_8)) : (var_1_1 == ((signed long int) var_1_9)))) && (((var_1_4 >> var_1_2) < (var_1_11 - (var_1_12 - var_1_13))) ? (var_1_10 == ((signed char) (var_1_14 + (min (var_1_15 , var_1_16))))) : (var_1_10 == ((signed char) (var_1_17 + var_1_16))))) && ((var_1_10 != var_1_8) ? (var_1_18 == ((unsigned long int) (min (var_1_13 , var_1_12)))) : 1)) && (var_1_19 == ((signed short int) ((var_1_20 - var_1_21) - var_1_22)))) && ((! ((64 * var_1_18) < var_1_1)) ? (var_1_23 == ((unsigned char) var_1_24)) : 1)) && ((((var_1_26 - var_1_27) + var_1_5) > var_1_22) ? (var_1_25 == ((signed char) (max (var_1_16 , var_1_17)))) : (var_1_25 == ((signed char) (max ((abs (var_1_15)) , (abs (var_1_17)))))))) && (((var_1_18 * var_1_1) < var_1_29) ? ((var_1_18 < var_1_13) ? (var_1_28 == ((unsigned long int) 64u)) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
