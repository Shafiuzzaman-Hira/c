...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch17PS_CN_25.c", 13, "reach_error"); }
...
float var_1_28 = 15.75;
signed long int var_1_29 = -1000000;
...
void step(void) {
	...
	// From: CodeObject2
	if (var_1_21 < (abs (var_1_20))) {
		if (var_1_21 <= (abs (1.0000000000004E12f))) {
			if (var_1_23) {
				var_1_22 = (abs (min (-256 , var_1_24)));
			}
		} else {
	...
	// From: CodeObject5
	if (! var_1_23) {
		var_1_29 = (min ((var_1_30 + var_1_31) , -32));
	}
	...
	// From: Req1Batch17PS_CN_25
	var_1_1 = (50 + (min (var_1_2 , (min (var_1_3 , var_1_4)))));


	// From: Req5Batch17PS_CN_25
