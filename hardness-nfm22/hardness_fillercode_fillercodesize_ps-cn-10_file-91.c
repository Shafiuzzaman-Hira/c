...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch91PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch91PS_CN_10
	if (var_1_11 < 5) {
		var_1_17 = (max (var_1_18 , (var_1_19 - var_1_20)));
	}


	// From: Req7Batch91PS_CN_10
	var_1_24 = var_1_25;


	// From: Req8Batch91PS_CN_10
	var_1_26 = var_1_11;


	// From: Req6Batch91PS_CN_10
	if (var_1_24) {
