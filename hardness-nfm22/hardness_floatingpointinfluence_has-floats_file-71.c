...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch71has_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch71has_floats
	var_1_13 = var_1_14;


	// From: Req5Batch71has_floats
	var_1_15 = var_1_3;


	// From: Req3Batch71has_floats
	if (var_1_5 <= (max (var_1_3 , (var_1_10 - var_1_4)))) {
