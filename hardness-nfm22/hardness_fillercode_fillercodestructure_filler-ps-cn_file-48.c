...
void step(void) {
	...
	// From: Req4Batch48Filler_PS_CN
	if (var_1_2) {
		var_1_13 = var_1_11;
	}


	// From: Req6Batch48Filler_PS_CN
	if (var_1_8 == var_1_13) {
