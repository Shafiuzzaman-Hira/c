...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch5PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject3
	if ((max ((25 | var_1_25) , var_1_27)) > var_1_26) {
		if (var_1_32) {
			var_1_30 = var_1_27;
		}
	}
	...
	if (var_1_32) {
		if (var_1_28 == var_1_23) {
			var_1_33 = (min (var_1_26 , var_1_27));
		}
	} else {
		if (var_1_34) {
			var_1_33 = -64;
	...
	// From: Req7Batch5PS_CN_25
	var_1_21 = var_1_10;


	// From: Req6Batch5PS_CN_25
