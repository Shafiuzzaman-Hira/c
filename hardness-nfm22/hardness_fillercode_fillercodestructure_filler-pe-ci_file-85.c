...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch85Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch85Filler_PE_CI
	var_1_13 = (abs (var_1_14));


	// From: Req7Batch85Filler_PE_CI
	var_1_16 = (var_1_6 && var_1_17);


	// From: Req6Batch85Filler_PE_CI
	if (var_1_5) {
		var_1_15 = (max (var_1_1 , (var_1_13 + (abs (var_1_14)))));
	}


	// From: Req3Batch85Filler_PE_CI
	...
	// From: CodeObject1
	if (var_1_5) {
		if ((var_1_14 - (min (var_1_13 , var_1_13))) <= var_1_13) {
			var_1_21 = var_1_27;
		}
	}
	...
	// From: CodeObject3
	var_1_30 = (abs (var_1_13));


	// From: CodeObject4
	if ((min ((var_1_20 - var_1_20) , var_1_11)) > (var_1_19 * 31.3)) {
		if (var_1_5) {
			var_1_31 = var_1_35;
		}
	} else {
		var_1_31 = (var_1_35 && ((var_1_13 > var_1_13) && (! var_1_36)));
	}


	// From: CodeObject5
	if ((var_1_7 / 25.4f) >= (abs (var_1_7))) {
	...
	// From: CodeObject6
	if (! var_1_6) {
		if ((var_1_9 + var_1_13) >= ((var_1_13 + var_1_14) << (min (5 , var_1_39)))) {
			if (var_1_17 && (4.166 >= var_1_20)) {
				var_1_38 = (abs (min (var_1_39 , var_1_14)));
			} else {
				var_1_38 = (128 - (var_1_39 + var_1_41));
			}
		} else {
			if (! (var_1_14 >= var_1_41)) {
				var_1_38 = var_1_39;
			} else {
				var_1_38 = 0;
			}
