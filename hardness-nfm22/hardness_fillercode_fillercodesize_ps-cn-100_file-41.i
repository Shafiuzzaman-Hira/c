...
void step(void) {
 ...
 var_1_40 = ((((((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29)))) > (16)) ? (((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29)))) : (16)));
 if (var_1_37 > 5u) {
  var_1_41 = (((((var_1_33 + var_1_42)) > (var_1_29)) ? ((var_1_33 + var_1_42)) : (var_1_29)));
 }
 if (var_1_42 > (~ var_1_32)) {
  var_1_43 = (((((((((var_1_33) < (var_1_42)) ? (var_1_33) : (var_1_42)))) < (((((64) < (var_1_44)) ? (64) : (var_1_44))))) ? (((((var_1_33) < (var_1_42)) ? (var_1_33) : (var_1_42)))) : (((((64) < (var_1_44)) ? (64) : (var_1_44)))))) + (var_1_45 + var_1_46));
 }
 if ((var_1_32 > var_1_29) || var_1_35) {
  if (var_1_34 <= var_1_42) {
   var_1_47 = (var_1_46 - 64);
  } else {
   var_1_47 = ((((var_1_46) < 0 ) ? -(var_1_46) : (var_1_46)));
  }
 } else {
  if (var_1_36 > ((var_1_48 + var_1_44) & var_1_26)) {
   var_1_47 = ((((var_1_46) < (var_1_45)) ? (var_1_46) : (var_1_45)));
  }
 }
 if (var_1_50 > (var_1_38 + var_1_39)) {
  if (var_1_30 < 128) {
   ...
   var_1_49 = ((((var_1_52 - var_1_51) < 0 ) ? -(var_1_52 - var_1_51) : (var_1_52 - var_1_51)));
  }
 }
 if ((var_1_56 & ((((var_1_57) > (var_1_48)) ? (var_1_57) : (var_1_48)))) >= var_1_26) {
  if ((var_1_43 - var_1_28) >= (((((var_1_42) < (var_1_33)) ? (var_1_42) : (var_1_33))) - var_1_58)) {
   var_1_55 = ((((var_1_26) < (100000000)) ? (var_1_26) : (100000000)));
  }
 } else {
  var_1_55 = var_1_46;
 }
 if (var_1_52 <= var_1_38) {
  var_1_59 = ((((8) > (var_1_33)) ? (8) : (var_1_33)));
 }
 if (var_1_31) {
  var_1_60 = var_1_46;
 }
