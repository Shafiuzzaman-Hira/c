...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch43Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch43Filler_PE_CO
	if (var_1_13) {
		var_1_12 = (var_1_14 - var_1_15);
	}


	// From: Req5Batch43Filler_PE_CO
	...
	// From: CodeObject4
	if ((var_1_12 | (abs (var_1_7))) > var_1_12) {
		if (var_1_34) {
	...
	if ((- var_1_1) < var_1_36) {
		if (var_1_1 > var_1_36) {
			if (((var_1_23 % var_1_40) % (abs (var_1_41))) == (var_1_11 / var_1_42)) {
				var_1_39 = ((max (var_1_43 , var_1_44)) - var_1_26);
			}
		}
	} else {
		var_1_39 = (var_1_40 + var_1_26);
	}


	// From: CodeObject7
	if (var_1_23 > (~ (var_1_23 % var_1_43))) {
		if (((var_1_46 - 1000) >= var_1_23) && var_1_34) {
			var_1_45 = var_1_47;
		}
	} else {
		var_1_45 = var_1_47;
