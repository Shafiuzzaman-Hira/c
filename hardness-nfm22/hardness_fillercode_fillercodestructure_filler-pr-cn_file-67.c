...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch67Filler_PR_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch67Filler_PR_CN
	var_1_12 = (var_1_13 - var_1_14);


	// From: Req5Batch67Filler_PR_CN
