...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch17Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch17Filler_PE_CI
	var_1_1 = (50 + (min (var_1_2 , (min (var_1_3 , var_1_4)))));


	// From: Req5Batch17Filler_PE_CI
	...
	// From: CodeObject1
	var_1_20 = (min (var_1_13 , var_1_12));


	// From: CodeObject2
	if (128u <= var_1_1) {
		if ((var_1_13 >= var_1_13) && ((var_1_1 * var_1_15) < (min (var_1_3 , var_1_19)))) {
			if (var_1_15 > var_1_1) {
				var_1_23 = (abs (4));
			} else {
				if (var_1_9) {
	...
	if (var_1_19 > var_1_3) {
		...
		if ((var_1_4 - (max (var_1_1 , var_1_2))) < (abs (var_1_1))) {
			if ((var_1_2 | var_1_1) < var_1_3) {
				var_1_35 = var_1_4;
			}
		}
	}
	...
	// From: CodeObject7
	if (var_1_2 > (var_1_4 >> var_1_4)) {
		if (var_1_10) {
			var_1_39 = (abs (var_1_4));
		} else {
			var_1_39 = (max ((256 - (var_1_40 - var_1_3)) , var_1_4));
		}
	} else {
		var_1_39 = var_1_2;
	}
