...
void step(void) {
	...
	// From: Req1Batch17Filler_PS_CO
	var_1_1 = (50 + (min (var_1_2 , (min (var_1_3 , var_1_4)))));


	// From: Req5Batch17Filler_PS_CO
