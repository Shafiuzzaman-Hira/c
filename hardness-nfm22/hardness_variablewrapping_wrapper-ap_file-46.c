...
void step(void) {
	...
	// From: Req1Batch46Wrapper_AP
	signed long int stepLocal_1 = min ((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)) , (*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)));
