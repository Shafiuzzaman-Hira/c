...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch29Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req12Batch29Amount100
	var_1_40 = last_1_var_1_40;


	// From: Req5Batch29Amount100
	if (! var_1_1) {
		if (! (! (! var_1_5))) {
			var_1_17 = var_1_14;
		} else {
