...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch52Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_21 = var_1_8;
 var_1_22 = -256;
 if ((var_1_22 | ((((var_1_10) > (var_1_7)) ? (var_1_10) : (var_1_7)))) < (((((-5) < 0 ) ? -(-5) : (-5))) >> var_1_17)) {
  var_1_23 = var_1_28;
 }
 if ((25u % var_1_9) < var_1_17) {
  var_1_37 = (((((var_1_10) < (((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8))))) ? (var_1_10) : (((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8)))))) + var_1_21);
 } else {
  if ((((((var_1_33) > (var_1_40)) ? (var_1_33) : (var_1_40))) >= var_1_31) && (var_1_21 <= var_1_17)) {
   var_1_37 = var_1_8;
  } else {
 ...
 if (var_1_19 != (~ -16)) {
  if (var_1_12) {
   if (var_1_17 == var_1_28) {
    var_1_31 = (var_1_33 + ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))));
   } else {
 ...
 if ((var_1_1 | var_1_17) <= var_1_10) {
  var_1_36 = ((((var_1_1) > (((var_1_10 - 2) + var_1_10))) ? (var_1_1) : (((var_1_10 - 2) + var_1_10))));
 }
