...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch78has_floats.c", 13, "reach_error"); }
...
int property() {
	return ((((var_1_2 && var_1_3) ? ((var_1_2 && (var_1_15 > var_1_15)) ? (var_1_1 == ((signed long int) (var_1_15 - var_1_15))) : (var_1_1 == ((signed long int) ((var_1_15 + 5) - var_1_15)))) : 1) && (var_1_2 ? (var_1_9 == ((float) (var_1_10 - var_1_11))) : ((var_1_1 < var_1_15) ? (var_1_9 == ((float) (max (var_1_11 , var_1_10)))) : (var_1_9 == ((float) var_1_10))))) && ((var_1_1 <= (abs (8u))) ? (var_1_12 == ((double) (var_1_10 - 99.5))) : (var_1_12 == ((double) ((var_1_13 - var_1_14) - var_1_11))))) && ((0.8f > (- var_1_10)) ? (var_1_15 == ((unsigned char) var_1_16)) : 1)
;
}
int main(void) {
	isInitial = 1;
