...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch1100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch1100_while
	var_1_14 = (var_1_15 + var_1_16);


	// From: Req2Batch1100_while
	if (((- 16.1) + var_1_14) >= (var_1_11 - var_1_12)) {
		var_1_9 = var_1_13;
	}


	// From: Req6Batch1100_while
