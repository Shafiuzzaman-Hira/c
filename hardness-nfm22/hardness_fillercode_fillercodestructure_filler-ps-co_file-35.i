...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch35Filler_PS_CO.c", 13, "reach_error"); }
...
double var_1_39 = 7.75;
double var_1_40 = 99999.625;
float var_1_41 = 255.2;
unsigned char var_1_42 = 25;
unsigned char var_1_43 = 64;
unsigned char var_1_44 = 1;
float var_1_45 = 255.5;
float var_1_46 = 10.55;
...
void step(void) {
 var_1_26 = var_1_27;
 var_1_28 = var_1_6;
 if (var_1_27 <= var_1_16) {
  if ((var_1_13 | ((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31)))) >= (var_1_12 + var_1_12)) {
   var_1_30 = (((((((var_1_33) < 0 ) ? -(var_1_33) : (var_1_33))) < 0 ) ? -((((var_1_33) < 0 ) ? -(var_1_33) : (var_1_33))) : ((((var_1_33) < 0 ) ? -(var_1_33) : (var_1_33)))));
  }
 } else {
  var_1_30 = (50 + var_1_34);
 }
 if (! var_1_21) {
  if ((var_1_31 == var_1_23) && var_1_21) {
   var_1_35 = ((((var_1_6) < (var_1_6)) ? (var_1_6) : (var_1_6)));
  } else {
   var_1_35 = ((((var_1_6) < (var_1_6)) ? (var_1_6) : (var_1_6)));
  }
 }
 if (32u >= (((((var_1_13) > (var_1_6)) ? (var_1_13) : (var_1_6))) % 16u)) {
  if ((-5 > var_1_31) && (var_1_23 <= ((((var_1_34) > (var_1_13)) ? (var_1_34) : (var_1_13))))) {
   var_1_39 = var_1_27;
  } else {
  ...
  if (! var_1_21) {
   var_1_39 = ((((var_1_27) > (((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))))) ? (var_1_27) : (((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))))));
  }
 }
 var_1_41 = ((((((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)))) < (var_1_40)) ? (((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)))) : (var_1_40)));
 if (var_1_33 < (var_1_23 | var_1_6)) {
