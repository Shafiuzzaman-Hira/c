...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch98Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch98Filler_PE_CN
	var_1_17 = var_1_18;


	// From: Req7Batch98Filler_PE_CN
	...
	// From: Req8Batch98Filler_PE_CN
	var_1_22 = var_1_18;


	// From: Req2Batch98Filler_PE_CN
	if (var_1_19 <= var_1_1) {
	...
	// From: CodeObject4
	if (var_1_24 <= ((var_1_34 - var_1_31) - (min (var_1_28 , var_1_30)))) {
		var_1_33 = 128;
	}
	...
	if ((var_1_30 | var_1_25) > var_1_33) {
		if (-16 <= (max ((var_1_28 - var_1_31) , (abs (var_1_30))))) {
			var_1_35 = (63.2 - 7.4);
		} else {
	...
	if (var_1_27 < var_1_34) {
		if ((abs (max (var_1_34 , var_1_25))) <= var_1_26) {
