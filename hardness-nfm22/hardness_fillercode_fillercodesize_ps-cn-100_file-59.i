...
void step(void) {
 ...
 if ((var_1_24 >> var_1_21) <= (var_1_20 * ((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))))) {
  var_1_34 = ((((var_1_35) > (var_1_36)) ? (var_1_35) : (var_1_36)));
 }
 if (var_1_32) {
  var_1_37 = ((((-1) > (((((var_1_31) < (var_1_30)) ? (var_1_31) : (var_1_30))))) ? (-1) : (((((var_1_31) < (var_1_30)) ? (var_1_31) : (var_1_30))))));
 }
 ...
 if (var_1_31 == var_1_27) {
  if (256 >= var_1_28) {
   var_1_42 = ((((var_1_36) > (var_1_35)) ? (var_1_36) : (var_1_35)));
  } else {
   var_1_42 = ((((var_1_36) < (((((var_1_35) > (var_1_43)) ? (var_1_35) : (var_1_43))))) ? (var_1_36) : (((((var_1_35) > (var_1_43)) ? (var_1_35) : (var_1_43))))));
  }
 }
 if (! var_1_41) {
  if (var_1_40) {
   var_1_44 = ((((((((var_1_38 + var_1_25)) < (((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37))))) ? ((var_1_38 + var_1_25)) : (((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37)))))) < 0 ) ? -(((((var_1_38 + var_1_25)) < (((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37))))) ? ((var_1_38 + var_1_25)) : (((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37)))))) : (((((var_1_38 + var_1_25)) < (((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37))))) ? ((var_1_38 + var_1_25)) : (((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37))))))));
  }
 } else {
  var_1_44 = var_1_28;
 }
 if (((var_1_37 + var_1_25) >> var_1_22) >= var_1_21) {
  if (((((var_1_24 + 50) < 0 ) ? -(var_1_24 + 50) : (var_1_24 + 50))) >= 1) {
   var_1_45 = ((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22)));
  } else {
   if (((((var_1_31) < ((var_1_37 | var_1_26))) ? (var_1_31) : ((var_1_37 | var_1_26)))) >= var_1_22) {
    var_1_45 = (8 + var_1_22);
   } else {
    var_1_45 = ((((var_1_22) < ((var_1_46 - ((((var_1_47) > (var_1_48)) ? (var_1_47) : (var_1_48)))))) ? (var_1_22) : ((var_1_46 - ((((var_1_47) > (var_1_48)) ? (var_1_47) : (var_1_48)))))));
   }
  }
 }
 if (var_1_21 <= var_1_25) {
  if ((var_1_31 % var_1_46) <= var_1_28) {
   var_1_49 = ((((var_1_47) < (((((-64) < 0 ) ? -(-64) : (-64))))) ? (var_1_47) : (((((-64) < 0 ) ? -(-64) : (-64))))));
  }
 }
