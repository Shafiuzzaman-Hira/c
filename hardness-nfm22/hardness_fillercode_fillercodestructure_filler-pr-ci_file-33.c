...
void step(void) {
	...
	// From: CodeObject1
	if ((- (max (var_1_19 , var_1_19))) == var_1_7) {
		var_1_22 = var_1_16;
	}
	...
	// From: CodeObject4
	if (0 <= (var_1_7 - (min (var_1_1 , var_1_16)))) {
	...
	// From: CodeObject3
	if (var_1_5 > var_1_14) {
		var_1_29 = (max (-2 , var_1_17));
	}


	// From: CodeObject5
	if (var_1_19 <= (var_1_19 / (var_1_33 - var_1_34))) {
		if (-64 >= (abs (abs (var_1_17)))) {
			if (-8 > var_1_1) {
				if (var_1_8 >= var_1_28) {
					var_1_32 = (min ((var_1_15 + var_1_18) , 1));
				}
			} else {
	...
	if (var_1_33 < var_1_14) {
		...
		if (var_1_34 <= var_1_7) {
			var_1_38 = (min (var_1_37 , (max (var_1_20 , var_1_14))));
		}
	}
