...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch55Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_1 < (max ((var_1_40 / 15.175f) , (- var_1_1)))) {
		...
		if (var_1_50) {
			var_1_49 = (var_1_23 || (var_1_23 || var_1_52));
		}
	}
	...
	// From: CodeObject5
	if (var_1_23) {
		var_1_47 = (var_1_46 + (max (var_1_9 , var_1_44)));
	}
