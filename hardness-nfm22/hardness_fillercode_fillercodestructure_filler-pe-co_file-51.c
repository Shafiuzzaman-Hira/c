...
void step(void) {
	...
	// From: Req4Batch51Filler_PE_CO
	if ((min ((~ var_1_1) , 8)) > var_1_11) {
		var_1_17 = var_1_18;
	}


	// From: Req2Batch51Filler_PE_CO
	if (! (var_1_17 > var_1_5)) {
	...
	// From: CodeObject1
	if ((var_1_8 % (max (var_1_27 , var_1_28))) > var_1_19) {
