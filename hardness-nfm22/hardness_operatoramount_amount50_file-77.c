...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch77Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch77Amount50
	if ((- var_1_7) < (var_1_1 * var_1_4)) {
		var_1_8 = var_1_9;
	}


	// From: Req3Batch77Amount50
	var_1_10 = (50 + ((var_1_11 + 10000) - var_1_12));


	// From: Req6Batch77Amount50
