...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch86stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 signed long int stepLocal_0 = var_1_3 / -2;
 ...
 if (! var_1_7) {
  if (((var_1_15 - var_1_12) * (- var_1_2)) <= stepLocal_2) {
   var_1_14 = var_1_11;
  }
 }
 ...
 unsigned long int stepLocal_5 = (var_1_5 % var_1_15) + (var_1_18 / var_1_20);
