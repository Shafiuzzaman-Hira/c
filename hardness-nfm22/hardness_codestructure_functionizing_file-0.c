...
double functionized6(double functionized6_localFunctionVar0) {
	return (min (functionized6_localFunctionVar0 , var_1_16));
}
...
void step(void) {
	// From: Req1Batch0functionizing
	if (var_1_2 > (- var_1_3)) {
		var_1_1 = (max (var_1_3 , functionized0(var_1_4)));
	} else {
		var_1_1 = (min (functionized1(var_1_2) , 16));
	}


	// From: Req2Batch0functionizing
	functionized2(var_1_4, var_1_3);


	// From: Req3Batch0functionizing
	if (var_1_2 < functionized3(var_1_5)) {
		var_1_6 = functionized4(var_1_3);
	}


	// From: Req4Batch0functionizing
	if (var_1_1 > var_1_3) {
		if (var_1_4 <= var_1_6) {
			var_1_7 = (abs (var_1_3));
		}
	...
	// From: Req5Batch0functionizing
	functionized5(var_1_11, var_1_2, var_1_13);


	// From: Req6Batch0functionizing
