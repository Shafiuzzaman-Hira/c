...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch11Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_24 <= ((((var_1_22) < ((var_1_26 >> var_1_23))) ? (var_1_22) : ((var_1_26 >> var_1_23))))) {
 ...
 if (var_1_27 >= (var_1_28 + var_1_22)) {
  if ((-0.95f * ((((var_1_33) < 0 ) ? -(var_1_33) : (var_1_33)))) > var_1_31) {
