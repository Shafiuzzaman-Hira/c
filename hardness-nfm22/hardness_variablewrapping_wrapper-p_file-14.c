...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch14Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (((*(var_1_13_Pointer)) / (*(var_1_14_Pointer))) <= (*(var_1_15_Pointer))) {
		if (((*(var_1_16_Pointer)) - 2.3) > (*(var_1_14_Pointer))) {
			...
			(*(var_1_12_Pointer)) = (max ((*(var_1_7_Pointer)) , (abs ((*(var_1_17_Pointer)) - (*(var_1_8_Pointer))))));
		}
	} else {
	...
	// From: Req3Batch14Wrapper_P
	if ((((*(var_1_5_Pointer)) >= (*(var_1_12_Pointer))) && (*(var_1_2_Pointer))) && (*(var_1_3_Pointer))) {
