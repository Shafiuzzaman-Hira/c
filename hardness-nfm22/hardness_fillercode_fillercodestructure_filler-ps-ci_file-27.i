...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch27Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_11 >= var_1_11) {
  var_1_31 = ((((var_1_11) > (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))))) ? (var_1_11) : (((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))))));
 }
 if (var_1_20 < (~ (var_1_11 / var_1_33))) {
  if (var_1_17) {
   if ((var_1_13 * var_1_6) == var_1_5) {
    var_1_32 = var_1_19;
   }
  } else {
   var_1_32 = (var_1_19 || var_1_17);
  }
 } else {
  if (var_1_20 < (var_1_11 / var_1_33)) {
   var_1_32 = var_1_17;
 ...
 if (((((var_1_11) < (var_1_33)) ? (var_1_11) : (var_1_33))) < (var_1_39 + var_1_12)) {
