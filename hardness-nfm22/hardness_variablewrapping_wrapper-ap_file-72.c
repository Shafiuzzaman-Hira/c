...
void step(void) {
	// From: Req2Batch72Wrapper_AP
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
		(*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)) = 2u;
	}


	// From: Req3Batch72Wrapper_AP
	(*(signed_char_Array_0_arraysigned_char_Array_0Var3_Pointer)) = (min (((*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) + (*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer))) , (10 - (*(signed_char_Array_0_arraysigned_char_Array_0Var4_Pointer)))));


	// From: Req5Batch72Wrapper_AP
	(*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) = (*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer));


	// From: Req6Batch72Wrapper_AP
	(*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)) = 1;


	// From: Req7Batch72Wrapper_AP
	(*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) = 10;


	// From: Req4Batch72Wrapper_AP
	if (((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) + ((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) / (*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)))) == (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))) {
		if ((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) >= last_1_double_Array_0_2_) {
			(*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)) = ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) - (min (((*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)) + (*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer))) , 9.9999999999995E12)));
		} else {
			(*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)) = (min ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) , (5.75 + (*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer)))));
		}
	}


	// From: Req1Batch72Wrapper_AP
	if ((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) < ((min ((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)) , (*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)))) * (*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)))) {
