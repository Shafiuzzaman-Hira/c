...
void step(void) {
	...
	if (! var_1_11) {
		var_1_52 = (min (var_1_40 , (min (var_1_32 , var_1_23))));
	} else {
	...
	if (var_1_31 >= (var_1_26 * last_1_var_1_52)) {
		if (((max (var_1_22 , var_1_30)) << last_1_var_1_52) != (last_1_var_1_51 + last_1_var_1_38)) {
			var_1_38 = var_1_23;
		}
	} else {
		if (last_1_var_1_38 > var_1_29) {
			...
			var_1_38 = (min ((var_1_21 + (100 - var_1_30)) , var_1_23));
		}
	}
	...
	if ((var_1_11 || (var_1_14 > 15.3f)) || (last_1_var_1_1 == (8u >> last_1_var_1_20))) {
		...
		if ((abs (var_1_23)) == last_1_var_1_20) {
	...
	if (var_1_38 > stepLocal_2) {
		if (stepLocal_1 || var_1_42) {
			var_1_6 = (((var_1_7 + 1924803778u) - (max (var_1_38 , var_1_38))) - var_1_5);
		}
	}
	...
	if (var_1_12) {
		var_1_41 = (max ((4.375 + var_1_15) , var_1_14));
	}
	...
	if (! ((max (var_1_7 , var_1_52)) > (var_1_31 | var_1_52))) {
		if ((var_1_27 - var_1_28) > var_1_15) {
			var_1_37 = (max (var_1_25 , var_1_29));
		} else {
			if (var_1_42) {
				var_1_37 = ((max (var_1_32 , var_1_31)) - var_1_30);
			} else {
				var_1_37 = (var_1_30 + (max (var_1_32 , var_1_31)));
			}
		}
	}
	...
	if ((last_1_var_1_17 >= var_1_38) && ((min (-2 , var_1_5)) < var_1_52)) {
		var_1_17 = (var_1_5 + (var_1_20 + (min (var_1_38 , var_1_52))));
	} else {
		if (var_1_33 == var_1_16) {
			...
			var_1_17 = (var_1_52 + ((min (var_1_7 , var_1_5)) - var_1_38));
		}
	}
	...
	if (var_1_32 > stepLocal_10) {
		if (var_1_20 <= stepLocal_9) {
			if (var_1_26 < stepLocal_7) {
				var_1_36 = (max ((abs (var_1_14)) , var_1_35));
			}
		}
	} else {
	...
	if (! var_1_11) {
		if (var_1_12 && stepLocal_6) {
			var_1_24 = (min (var_1_23 , var_1_25));
		} else {
			if (stepLocal_5 != var_1_52) {
				var_1_24 = (max ((var_1_23 - var_1_26) , var_1_25));
			} else {
				var_1_24 = 25;
			}
		}
	} else {
		if ((max ((var_1_27 - var_1_28) , var_1_16)) > var_1_13) {
			if (var_1_15 < (abs (var_1_13))) {
				var_1_24 = (var_1_29 + ((min (25 , var_1_30)) - var_1_31));
			} else {
	...
	if (var_1_11 && stepLocal_13) {
		if (! var_1_42) {
			var_1_43 = (max (var_1_32 , var_1_25));
		}
	}
	...
	if (! ((var_1_19 - var_1_31) > var_1_43)) {
		var_1_44 = (var_1_30 + (max ((var_1_32 - var_1_31) , var_1_29)));
	} else {
		if (var_1_30 < ((min (var_1_32 , last_1_var_1_44)) * 32)) {
			if (var_1_12) {
				if (var_1_20 > var_1_21) {
					if (var_1_42 && (var_1_17 == 10u)) {
						var_1_44 = (min ((var_1_30 + 5) , (var_1_31 - (1 + var_1_32))));
					}
				} else {
					var_1_44 = (min (var_1_25 , (min (var_1_29 , (min (var_1_31 , var_1_26))))));
				}
			}
		} else {
			var_1_44 = ((abs (var_1_32)) + var_1_29);
		}
	}
}
...
int property() {
	return ((((((((((((((((((((var_1_51 != var_1_51) ? (var_1_42 ? (var_1_1 == ((unsigned long int) ((var_1_5 + 1668503833u) - (50u + 256u)))) : 1) : 1) && ((var_1_38 > var_1_5) ? (((var_1_5 < var_1_38) || var_1_42) ? (var_1_6 == ((unsigned long int) (((var_1_7 + 1924803778u) - (max (var_1_38 , var_1_38))) - var_1_5))) : 1) : 1)) && (((var_1_7 > var_1_20) && var_1_42) ? (var_1_10 == ((unsigned char) (var_1_11 && var_1_12))) : 1)) && ((-500 >= (var_1_17 * (var_1_52 ^ var_1_7))) ? (var_1_13 == ((float) ((abs (var_1_14)) + var_1_15))) : (var_1_13 == ((float) (abs (var_1_15 + var_1_16)))))) && (((last_1_var_1_17 >= var_1_38) && ((min (-2 , var_1_5)) < var_1_52)) ? (var_1_17 == ((unsigned long int) (var_1_5 + (var_1_20 + (min (var_1_38 , var_1_52)))))) : ((var_1_33 == var_1_16) ? (var_1_48 ? (var_1_17 == ((unsigned long int) ((min (var_1_19 , (var_1_5 + var_1_7))) - 256u))) : 1) : (var_1_17 == ((unsigned long int) (var_1_52 + ((min (var_1_7 , var_1_5)) - var_1_38))))))) && (((var_1_11 || (var_1_14 > 15.3f)) || (last_1_var_1_1 == (8u >> last_1_var_1_20))) ? ((last_1_var_1_20 > last_1_var_1_1) ? (var_1_20 == ((unsigned char) (max ((32 + var_1_21) , (var_1_22 + (var_1_23 + 4)))))) : 1) : (((abs (var_1_23)) == last_1_var_1_20) ? (((- last_1_var_1_51) < last_1_var_1_20) ? (var_1_20 == ((unsigned char) var_1_21)) : (var_1_20 == ((unsigned char) var_1_21))) : (var_1_20 == ((unsigned char) var_1_22))))) && ((! var_1_11) ? ((var_1_12 && var_1_11) ? (var_1_24 == ((signed char) (min (var_1_23 , var_1_25)))) : ((((var_1_37 % var_1_5) + var_1_38) != var_1_52) ? (var_1_24 == ((signed char) (max ((var_1_23 - var_1_26) , var_1_25)))) : (var_1_24 == ((signed char) 25)))) : (((max ((var_1_27 - var_1_28) , var_1_16)) > var_1_13) ? ((var_1_15 < (abs (var_1_13))) ? (var_1_24 == ((signed char) (var_1_29 + ((min (25 , var_1_30)) - var_1_31)))) : (var_1_24 == ((signed char) (abs (var_1_26))))) : (var_1_24 == ((signed char) (var_1_30 - (var_1_31 + var_1_32))))))) && ((! var_1_12) ? (var_1_33 == ((double) ((var_1_34 - var_1_35) + 7.5))) : 1)) && ((var_1_32 > (var_1_25 + var_1_52)) ? ((var_1_20 <= (var_1_19 - var_1_23)) ? ((var_1_26 < var_1_20) ? (var_1_36 == ((float) (max ((abs (var_1_14)) , var_1_35)))) : 1) : 1) : ((var_1_11 && var_1_10) ? (var_1_36 == ((float) var_1_14)) : (var_1_36 == ((float) var_1_14))))) && ((! ((max (var_1_7 , var_1_52)) > (var_1_31 | var_1_52))) ? (((var_1_27 - var_1_28) > var_1_15) ? (var_1_37 == ((signed char) (max (var_1_25 , var_1_29)))) : (var_1_42 ? (var_1_37 == ((signed char) ((max (var_1_32 , var_1_31)) - var_1_30))) : (var_1_37 == ((signed char) (var_1_30 + (max (var_1_32 , var_1_31))))))) : 1)) && ((var_1_31 >= (var_1_26 * last_1_var_1_52)) ? ((((max (var_1_22 , var_1_30)) << last_1_var_1_52) != (last_1_var_1_51 + last_1_var_1_38)) ? (var_1_38 == ((unsigned char) var_1_23)) : 1) : ((last_1_var_1_38 > var_1_29) ? ((last_1_var_1_42 && var_1_12) ? (var_1_38 == ((unsigned char) (abs (var_1_40)))) : 1) : (var_1_38 == ((unsigned char) (min ((var_1_21 + (100 - var_1_30)) , var_1_23))))))) && (var_1_12 ? (var_1_41 == ((double) (max ((4.375 + var_1_15) , var_1_14)))) : 1)) && (((5u << var_1_7) == (last_1_var_1_43 / var_1_19)) ? (var_1_42 == ((unsigned char) (! var_1_12))) : ((last_1_var_1_48 && var_1_12) ? (var_1_42 == ((unsigned char) var_1_11)) : (var_1_42 == ((unsigned char) 1))))) && ((var_1_11 && (var_1_32 < var_1_24)) ? ((! var_1_42) ? (var_1_43 == ((signed long int) (max (var_1_32 , var_1_25)))) : 1) : 1)) && ((! ((var_1_19 - var_1_31) > var_1_43)) ? (var_1_44 == ((signed char) (var_1_30 + (max ((var_1_32 - var_1_31) , var_1_29))))) : ((var_1_30 < ((min (var_1_32 , last_1_var_1_44)) * 32)) ? (var_1_12 ? ((var_1_20 > var_1_21) ? ((var_1_42 && (var_1_17 == 10u)) ? (var_1_44 == ((signed char) (min ((var_1_30 + 5) , (var_1_31 - (1 + var_1_32)))))) : 1) : (var_1_44 == ((signed char) (min (var_1_25 , (min (var_1_29 , (min (var_1_31 , var_1_26))))))))) : 1) : (var_1_44 == ((signed char) ((abs (var_1_32)) + var_1_29)))))) && ((var_1_1 <= (var_1_38 + var_1_19)) ? (var_1_45 == ((signed short int) (-1 + var_1_26))) : 1)) && ((((var_1_38 > var_1_38) && var_1_10) || var_1_10) ? ((var_1_34 >= 63.75) ? ((var_1_1 <= var_1_38) ? (var_1_46 == ((signed char) var_1_30)) : (var_1_46 == ((signed char) ((var_1_30 + (var_1_47 - 16)) - var_1_32)))) : (var_1_46 == ((signed char) (var_1_32 - var_1_23)))) : 1)) && (var_1_48 == ((unsigned char) (var_1_49 || var_1_50)))) && (var_1_49 ? ((last_1_var_1_24 <= last_1_var_1_20) ? ((! (var_1_7 <= last_1_var_1_46)) ? (var_1_51 == ((signed char) var_1_26)) : (var_1_51 == ((signed char) var_1_47))) : (var_1_51 == ((signed char) var_1_31))) : (var_1_51 == ((signed char) var_1_47)))) && ((! var_1_11) ? (var_1_52 == ((unsigned char) (min (var_1_40 , (min (var_1_32 , var_1_23)))))) : ((last_1_var_1_37 < last_1_var_1_37) ? (var_1_52 == ((unsigned char) var_1_31)) : (var_1_52 == ((unsigned char) var_1_21))))
;
}
int main(void) {
	isInitial = 1;
