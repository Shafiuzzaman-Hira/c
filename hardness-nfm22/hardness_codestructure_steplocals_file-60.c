...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch60stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch60stepLocals
	signed long int stepLocal_0 = var_1_6 * 1;
	if (var_1_8 < (var_1_3 + var_1_5)) {
		if ((min (var_1_7 , var_1_1)) > stepLocal_0) {
			var_1_9 = var_1_10;
		} else {
			var_1_9 = var_1_10;
		}
	...
	// From: Req4Batch60stepLocals
	if ((var_1_8 >= var_1_3) || ((var_1_2 && var_1_12) || (var_1_13 || var_1_14))) {
		if (var_1_2) {
			var_1_11 = var_1_15;
		} else {
			var_1_11 = var_1_15;
	...
	// From: Req5Batch60stepLocals
	signed short int stepLocal_1 = var_1_1;
	if (((var_1_10 * var_1_7) + var_1_9) > stepLocal_1) {
		var_1_16 = (var_1_17 - (var_1_18 - var_1_19));
	}


	// From: Req6Batch60stepLocals
	if (var_1_13) {
		var_1_20 = ((max (var_1_7 , 128u)) + var_1_9);
	} else {
		if (var_1_7 >= var_1_6) {
...
int property() {
	return (((((var_1_2 ? (((var_1_3 / var_1_4) <= var_1_5) ? (var_1_1 == ((signed short int) (var_1_6 - var_1_7))) : (var_1_1 == ((signed short int) var_1_6))) : (var_1_1 == ((signed short int) var_1_7))) && (((- var_1_5) <= var_1_4) ? (((var_1_3 <= var_1_4) || var_1_2) ? (var_1_8 == ((float) 3.3f)) : 1) : 1)) && ((var_1_8 < (var_1_3 + var_1_5)) ? (((min (var_1_7 , var_1_1)) > (var_1_6 * 1)) ? (var_1_9 == ((unsigned char) var_1_10)) : (var_1_9 == ((unsigned char) var_1_10))) : (var_1_9 == ((unsigned char) var_1_10)))) && (((var_1_8 >= var_1_3) || ((var_1_2 && var_1_12) || (var_1_13 || var_1_14))) ? (var_1_2 ? (var_1_11 == ((double) var_1_15)) : (var_1_11 == ((double) var_1_15))) : (var_1_11 == ((double) var_1_15)))) && ((((var_1_10 * var_1_7) + var_1_9) > var_1_1) ? (var_1_16 == ((double) (var_1_17 - (var_1_18 - var_1_19)))) : 1)) && (var_1_13 ? (var_1_20 == ((unsigned long int) ((max (var_1_7 , 128u)) + var_1_9))) : ((var_1_7 >= var_1_6) ? (var_1_20 == ((unsigned long int) (var_1_21 - var_1_9))) : (var_1_20 == ((unsigned long int) var_1_22))))
;
}
int main(void) {
	isInitial = 1;
