...
void step(void) {
	...
	// From: CodeObject2
	if (! var_1_34) {
		var_1_33 = (max (var_1_35 , (var_1_36 - var_1_37)));
	}


	// From: CodeObject3
	if ((var_1_31 / var_1_39) < (var_1_32 % -32)) {
		var_1_38 = (max (var_1_31 , var_1_32));
	}


	// From: CodeObject4
	if (var_1_34) {
		var_1_40 = (abs (min (var_1_32 , var_1_41)));
	} else {
		var_1_40 = (var_1_32 - (abs (128)));
	}
	...
	// From: CodeObject6
	if (var_1_32 >= (var_1_45 ^ (max (var_1_39 , var_1_48)))) {
		var_1_47 = (abs (var_1_31));
	} else {
		var_1_47 = (-1 - var_1_43);
	}
	...
	// From: CodeObject7
	if (var_1_34) {
		if (var_1_33 > (max ((3.2 + var_1_36) , (- var_1_37)))) {
			var_1_49 = (((max (var_1_50 , var_1_51)) + var_1_52) + var_1_53);
		}
	} else {
		if (var_1_51 != var_1_36) {
			if (((var_1_42 & var_1_48) * var_1_46) <= var_1_45) {
				var_1_49 = (max (var_1_51 , (min ((max (var_1_52 , var_1_36)) , (min (var_1_35 , var_1_50))))));
			}
		}
	}
	...
	if ((- var_1_38) < var_1_31) {
		if ((var_1_42 & (~ var_1_43)) <= ((~ var_1_46) * 16)) {
			var_1_54 = (max ((abs (var_1_35)) , 4.6));
		} else {
			var_1_54 = (min ((min (var_1_53 , (var_1_37 - var_1_36))) , var_1_35));
		}
	}
	...
	if (var_1_36 < (- (128.4 / var_1_56))) {
		var_1_55 = (max ((abs (-64)) , var_1_45));
	}


	// From: CodeObject10
	if (var_1_42 < (abs (var_1_39))) {
		var_1_57 = (min (((var_1_58 - var_1_59) - (abs (63.26f))) , var_1_52));
	} else {
		if ((max (var_1_44 , (var_1_43 ^ var_1_31))) < 10) {
			if (var_1_34) {
				var_1_57 = (min (var_1_60 , 9.999999999999975E13f));
			} else {
				if (var_1_50 < var_1_33) {
					var_1_57 = (abs (max (var_1_35 , var_1_51)));
				} else {
					var_1_57 = var_1_50;
				}
			}
		} else {
			var_1_57 = ((abs (var_1_60)) - var_1_58);
		}
	}
	...
	if (2u <= var_1_45) {
		if (var_1_44 >= (var_1_46 % var_1_39)) {
			if (var_1_34) {
				var_1_61 = (max (var_1_45 , var_1_62));
			}
		}
	}
	...
	// From: CodeObject12
	if (var_1_37 < (var_1_49 * (min (25.7 , var_1_35)))) {
		if (-16 > var_1_62) {
	...
	// From: CodeObject13
	if (var_1_51 > (max (var_1_33 , 255.25))) {
		var_1_67 = (abs (var_1_62));
	}


	// From: CodeObject14
	if (var_1_65) {
		var_1_68 = (min (var_1_44 , 4));
	}
	...
	if (var_1_52 > var_1_51) {
		...
		if ((var_1_67 / var_1_39) <= (var_1_55 * -256)) {
			var_1_70 = (max (((max (var_1_71 , var_1_72)) - var_1_43) , (abs (var_1_32))));
		}
	}
	...
	if (var_1_43 <= ((- var_1_31) >> var_1_62)) {
		if (var_1_59 <= var_1_49) {
			if (var_1_66 && ((var_1_31 & var_1_47) < var_1_44)) {
				var_1_73 = (max ((max ((abs (var_1_46)) , (abs (var_1_55)))) , var_1_62));
			}
		}
	} else {
		var_1_73 = var_1_46;
	...
	if ((var_1_68 * 16) >= var_1_45) {
		var_1_74 = (abs (min (var_1_71 , var_1_46)));
	}


	// From: CodeObject19
	var_1_75 = (abs (var_1_48));


	// From: CodeObject20
	if ((min (var_1_48 , var_1_72)) < ((var_1_44 * var_1_71) & (var_1_45 >> var_1_42))) {
		var_1_76 = var_1_45;
	}
	...
	if (var_1_55 <= var_1_70) {
		var_1_77 = (abs (var_1_52));
	} else {
		var_1_77 = (max (var_1_52 , var_1_35));
	}


	// From: CodeObject22
	if (var_1_55 > (var_1_62 >> var_1_41)) {
		var_1_78 = (min ((abs (var_1_45 - var_1_79)) , (max (var_1_62 , var_1_80))));
	} else {
		if (var_1_65) {
	...
	if (var_1_80 > var_1_72) {
		if (var_1_37 <= var_1_77) {
			var_1_83 = (max ((abs (var_1_81 - var_1_79)) , (max (var_1_45 , var_1_42))));
		}
	} else {
		if ((~ (abs (64u))) > ((var_1_84 + var_1_85) - var_1_45)) {
			var_1_83 = (var_1_43 - (abs (var_1_68)));
		}
	}


	// From: CodeObject24
	if (var_1_75 < (min (var_1_72 , var_1_82))) {
		var_1_86 = (max (var_1_44 , var_1_80));
	}
	...
	if ((var_1_60 >= var_1_77) || var_1_65) {
		...
		var_1_87 = (min ((abs (var_1_81)) , var_1_46));
	}


	// From: CodeObject26
	if (var_1_85 < var_1_32) {
		var_1_88 = (min (((var_1_50 + var_1_52) + var_1_51) , ((abs (var_1_59)) + var_1_53)));
	} else {
		var_1_88 = 2.65;
	}
	...
	// From: Req3Batch50PS_CN_250
	if (var_1_8) {
		var_1_13 = (min ((var_1_14 + var_1_15) , (min (-0.2f , var_1_16))));
	}


	// From: Req6Batch50PS_CN_250
	if (var_1_8) {
		var_1_25 = (var_1_26 + var_1_27);
	}


	// From: Req8Batch50PS_CN_250
	var_1_29 = var_1_27;


	// From: Req9Batch50PS_CN_250
	var_1_30 = var_1_8;


	// From: Req2Batch50PS_CN_250
	...
	// From: Req4Batch50PS_CN_250
	var_1_17 = ((var_1_18 - 25) - var_1_25);


	// From: Req5Batch50PS_CN_250
