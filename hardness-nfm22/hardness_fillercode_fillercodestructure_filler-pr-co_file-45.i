...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch45Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_16 && (var_1_34 > (var_1_18 + var_1_10))) {
 ...
 if (var_1_25 > (var_1_23 + var_1_29)) {
  var_1_35 = ((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10)));
 }
 if (var_1_6 <= ((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10)))) {
