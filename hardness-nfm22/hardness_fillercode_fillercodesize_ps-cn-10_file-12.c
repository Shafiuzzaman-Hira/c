...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch12PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject6
	if ((var_1_33 >= var_1_32) || var_1_24) {
		var_1_34 = (min (var_1_31 , var_1_28));
	}


	// From: Req5Batch12PS_CN_10
	...
	// From: Req6Batch12PS_CN_10
	var_1_21 = (abs (var_1_7));


	// From: Req2Batch12PS_CN_10
