...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch3625_1loop.c", 13, "reach_error"); }
...
// Last'ed variables
unsigned char last_1_var_1_13 = 128;
...
void step(void) {
	// From: Req2Batch3625_1loop
	if ((max (last_1_var_1_13 , last_1_var_1_13)) < (last_1_var_1_13 + last_1_var_1_13)) {
		var_1_9 = var_1_12;
	}


	// From: Req3Batch3625_1loop
	if (var_1_9 <= (16.2f / var_1_14)) {
		var_1_13 = (var_1_15 - 5);
	}


	// From: Req1Batch3625_1loop
	unsigned char stepLocal_0 = var_1_9 > var_1_9;
	if (stepLocal_0 && var_1_4) {
		if ((max (var_1_9 , (- var_1_9))) != var_1_9) {
			if (! (var_1_9 >= (var_1_6 - var_1_7))) {
				var_1_1 = var_1_13;
			} else {
				var_1_1 = var_1_13;
			}
