...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch22Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
 var_1_28 = var_1_10;
 if ((var_1_19 + 100000000u) != ((((var_1_7) > (var_1_4)) ? (var_1_7) : (var_1_4)))) {
  var_1_30 = (((((var_1_10 + ((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))))) > (var_1_7)) ? ((var_1_10 + ((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))))) : (var_1_7)));
 } else {
  var_1_30 = var_1_7;
 }
 var_1_35 = var_1_11;
 if (var_1_11 > var_1_6) {
  ...
  var_1_37 = ((((var_1_21) < ((((((((49.2) > (var_1_22)) ? (49.2) : (var_1_22))) < 0 ) ? -((((49.2) > (var_1_22)) ? (49.2) : (var_1_22))) : ((((49.2) > (var_1_22)) ? (49.2) : (var_1_22))))))) ? (var_1_21) : ((((((((49.2) > (var_1_22)) ? (49.2) : (var_1_22))) < 0 ) ? -((((49.2) > (var_1_22)) ? (49.2) : (var_1_22))) : ((((49.2) > (var_1_22)) ? (49.2) : (var_1_22))))))));
 }
 if (var_1_7 <= var_1_19) {
  if (var_1_18 <= var_1_22) {
   var_1_40 = (! var_1_41);
  } else {
   if (var_1_22 <= ((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18)))) {
    var_1_40 = (var_1_41 || ((var_1_18 >= var_1_22) || var_1_42));
   }
  }
 }
 if (var_1_11 != (~ (var_1_10 % var_1_7))) {
  var_1_43 = (var_1_45 - var_1_46);
 } else {
  if (var_1_7 < var_1_11) {
   if ((var_1_10 < var_1_11) && var_1_41) {
    if (var_1_22 <= ((((var_1_22) < (var_1_20)) ? (var_1_22) : (var_1_20)))) {
