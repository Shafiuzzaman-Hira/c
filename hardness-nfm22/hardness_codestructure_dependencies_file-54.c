...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch54dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch54dependencies
	if (var_1_18 < (max (var_1_18 , (var_1_15 - var_1_16)))) {
		var_1_14 = (var_1_17 - (var_1_8 + var_1_4));
	}


	// From: Req4Batch54dependencies
	if (((var_1_8 * var_1_1) + var_1_4) >= (min (var_1_14 , var_1_5))) {
		var_1_13 = var_1_12;
	}


	// From: Req3Batch54dependencies
	if (((var_1_8 % var_1_10) * (8 + var_1_14)) >= var_1_14) {
