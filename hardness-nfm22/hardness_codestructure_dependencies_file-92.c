...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch92dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch92dependencies
	if ((last_1_var_1_12 == last_1_var_1_1) && (last_1_var_1_13 >= last_1_var_1_13)) {
		if (var_1_6) {
			if (var_1_7) {
	...
	// From: Req5Batch92dependencies
	var_1_17 = (4 - (min (var_1_18 , (var_1_19 - 1))));


	// From: Req6Batch92dependencies
	if (var_1_6) {
	...
	// From: Req4Batch92dependencies
	if (var_1_6 && (var_1_9 < (var_1_10 + var_1_20))) {
		if (var_1_7 && var_1_6) {
			var_1_16 = var_1_10;
		}
	} else {
	...
	// From: Req3Batch92dependencies
	if (((min (var_1_10 , var_1_1)) + (var_1_9 % var_1_14)) >= (min (var_1_16 , var_1_8))) {
		var_1_13 = var_1_15;
	} else {
		var_1_13 = var_1_15;
	}
