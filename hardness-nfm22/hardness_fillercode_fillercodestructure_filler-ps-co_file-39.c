...
void step(void) {
	// From: CodeObject1
	if (var_1_28) {
		if ((abs (min (127.5f , var_1_19))) > 10.5f) {
			var_1_27 = var_1_26;
		}
	}
	...
	// From: CodeObject4
	if ((var_1_37 % (abs (var_1_41))) >= (var_1_24 * var_1_39)) {
	...
	// From: Req7Batch39Filler_PS_CO
	var_1_24 = var_1_25;


	// From: Req8Batch39Filler_PS_CO
	var_1_26 = var_1_8;


	// From: Req3Batch39Filler_PS_CO
	var_1_10 = (min ((abs (var_1_11 - var_1_8)) , (max (0u , var_1_26))));


	// From: Req4Batch39Filler_PS_CO
