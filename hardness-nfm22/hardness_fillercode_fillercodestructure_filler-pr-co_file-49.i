...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch49Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30))) > var_1_1) {
 ...
 if ((var_1_26 <= ((((100) > (var_1_8)) ? (100) : (var_1_8)))) || ((- var_1_30) <= var_1_29)) {
  var_1_31 = var_1_26;
 } else {
  var_1_31 = var_1_30;
 }
