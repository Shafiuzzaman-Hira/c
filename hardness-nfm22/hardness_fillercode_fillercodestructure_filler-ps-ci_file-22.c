...
void step(void) {
	...
	// From: Req8Batch22Filler_PS_CI
	if ((- 3.75) < (min (var_1_20 , var_1_22))) {
		var_1_27 = 0;
	}


	// From: Req2Batch22Filler_PS_CI
