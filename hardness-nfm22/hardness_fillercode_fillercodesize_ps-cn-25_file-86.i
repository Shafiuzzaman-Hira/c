...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch86PS_CN_25.c", 13, "reach_error"); }
...
double var_1_26 = 50.25;
signed long int var_1_27 = -32;
float var_1_28 = 64.375;
...
unsigned long int var_1_34 = 2281156945;
unsigned long int var_1_35 = 10;
unsigned short int var_1_36 = 2;
unsigned short int var_1_37 = 25;
...
void step(void) {
 ...
 var_1_25 = var_1_26;
 var_1_27 = var_1_23;
 if ((var_1_24 | var_1_27) > var_1_23) {
  if ((var_1_25 < var_1_26) || (var_1_23 < var_1_24)) {
   var_1_28 = var_1_26;
  }
 } else {
  var_1_28 = var_1_26;
 }
 if (((((var_1_27) > ((var_1_23 ^ 64))) ? (var_1_27) : ((var_1_23 ^ 64)))) <= var_1_24) {
  var_1_29 = ((((((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30)))) > (((((var_1_31) < (((((var_1_32) > (var_1_33)) ? (var_1_32) : (var_1_33))))) ? (var_1_31) : (((((var_1_32) > (var_1_33)) ? (var_1_32) : (var_1_33)))))))) ? (((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30)))) : (((((var_1_31) < (((((var_1_32) > (var_1_33)) ? (var_1_32) : (var_1_33))))) ? (var_1_31) : (((((var_1_32) > (var_1_33)) ? (var_1_32) : (var_1_33)))))))));
 } else {
  var_1_29 = (var_1_34 - var_1_35);
 }
 var_1_36 = var_1_37;
 var_1_38 = var_1_39;
