...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch70Amount25.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch70Amount25
	if (var_1_2) {
		var_1_1 = ((17222 - var_1_3) + ((min (29916 , var_1_4)) - var_1_5));
	}


	// From: Req3Batch70Amount25
	...
	// From: Req4Batch70Amount25
	if ((var_1_9 - (max (5 , var_1_10))) >= var_1_3) {
		var_1_8 = var_1_11;
	}


	// From: Req2Batch70Amount25
