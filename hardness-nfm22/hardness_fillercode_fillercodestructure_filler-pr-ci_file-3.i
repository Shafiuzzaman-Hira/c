...
void step(void) {
 ...
 if (var_1_14 >= ((((var_1_20) > (var_1_6)) ? (var_1_20) : (var_1_6)))) {
  var_1_24 = ((((((((var_1_6) > (var_1_14)) ? (var_1_6) : (var_1_14)))) < (var_1_20)) ? (((((var_1_6) > (var_1_14)) ? (var_1_6) : (var_1_14)))) : (var_1_20)));
 } else {
  var_1_24 = (((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14))) + ((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6))));
 }
 ...
 if (((var_1_14 ^ var_1_21) % var_1_21) > -10) {
  var_1_30 = ((((var_1_20) < 0 ) ? -(var_1_20) : (var_1_20)));
 }
 if (var_1_14 >= ((var_1_35 & var_1_20) >> var_1_14)) {
  var_1_37 = ((((var_1_16) < (var_1_16)) ? (var_1_16) : (var_1_16)));
 }
 ...
 if ((~ var_1_23) <= (((((var_1_5) > (-16)) ? (var_1_5) : (-16))) & 16)) {
  var_1_32 = var_1_16;
 } else {
  if (var_1_10 <= (((((var_1_34) < (var_1_35)) ? (var_1_34) : (var_1_35))) - ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14))))) {
   var_1_32 = var_1_16;
  } else {
   var_1_32 = var_1_16;
  }
