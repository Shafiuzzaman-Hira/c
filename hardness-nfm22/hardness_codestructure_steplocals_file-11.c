...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch11stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch11stepLocals
	var_1_1 = (var_1_2 || (! var_1_3));


	// From: Req2Batch11stepLocals
	if (var_1_5 == var_1_6) {
		var_1_4 = ((8 + (max (var_1_7 , var_1_8))) - var_1_9);
	}


	// From: Req3Batch11stepLocals
	var_1_10 = (4027026809u - ((abs (var_1_11)) - var_1_7));


	// From: Req4Batch11stepLocals
	...
	// From: Req7Batch11stepLocals
	var_1_19 = (min ((abs (var_1_20)) , 1.4));


	// From: Req8Batch11stepLocals
