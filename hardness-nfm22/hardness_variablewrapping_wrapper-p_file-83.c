...
void step(void) {
	...
	if ((*(var_1_2_Pointer))) {
		...
		if (stepLocal_0 >= (min ((last_1_var_1_1 * (*(var_1_15_Pointer))) , (~ last_1_var_1_1)))) {
...
int property() {
	return ((((((*(var_1_2_Pointer)) ? ((*(var_1_1_Pointer)) == ((unsigned short int) (abs (abs ((*(var_1_3_Pointer))))))) : ((((*(var_1_3_Pointer)) / (*(var_1_4_Pointer))) >= (min ((last_1_var_1_1 * (*(var_1_15_Pointer))) , (~ last_1_var_1_1)))) ? ((*(var_1_1_Pointer)) == ((unsigned short int) (*(var_1_4_Pointer)))) : ((*(var_1_1_Pointer)) == ((unsigned short int) (*(var_1_3_Pointer)))))) && (((*(var_1_15_Pointer)) <= ((*(var_1_3_Pointer)) + (*(var_1_1_Pointer)))) ? (((*(var_1_1_Pointer)) == ((*(var_1_14_Pointer)) ^ (*(var_1_15_Pointer)))) ? ((*(var_1_8_Pointer)) == ((double) ((abs ((*(var_1_10_Pointer)))) + (*(var_1_11_Pointer))))) : ((*(var_1_8_Pointer)) == ((double) (*(var_1_11_Pointer))))) : ((*(var_1_8_Pointer)) == ((double) (*(var_1_10_Pointer)))))) && (((*(var_1_15_Pointer)) > (*(var_1_15_Pointer))) ? ((*(var_1_12_Pointer)) == ((double) (min ((*(var_1_11_Pointer)) , (*(var_1_10_Pointer)))))) : 1)) && ((*(var_1_14_Pointer)) == ((signed short int) 200))) && ((*(var_1_15_Pointer)) == ((signed char) (*(var_1_16_Pointer))))) && ((*(var_1_17_Pointer)) == ((double) (*(var_1_10_Pointer))))
;
}
int main(void) {
	isInitial = 1;
