...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch42Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((- var_1_28) < ((((var_1_14) > (var_1_29)) ? (var_1_14) : (var_1_29)))) {
  var_1_30 = var_1_29;
 }
 if (var_1_25) {
  var_1_35 = var_1_33;
 ...
 if (var_1_25) {
  ...
  var_1_36 = (var_1_37 - ((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39))));
 }
 if (var_1_33 <= (~ var_1_1)) {
 ...
 if (((((((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)))) < (var_1_1)) ? (((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)))) : (var_1_1))) <= var_1_13) {
  var_1_31 = var_1_33;
 }
 if ((- var_1_1) != var_1_13) {
  var_1_40 = var_1_39;
 ...
 if (((var_1_1 + 25) % var_1_27) < 2) {
  var_1_26 = (((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28))) + var_1_29);
 }
 unsigned char stepLocal_7 = var_1_6;
 if (stepLocal_7 > var_1_6) {
  var_1_17 = ((((25) > ((var_1_13 + var_1_6))) ? (25) : ((var_1_13 + var_1_6))));
 }
 if (var_1_6 < ((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17)))) {
  var_1_34 = ((((((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6)))) > (var_1_33)) ? (((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6)))) : (var_1_33)));
 }
