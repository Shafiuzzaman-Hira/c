...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch6625_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch6625_1loop
	if ((last_1_var_1_13 + var_1_15) < 16.75f) {
		var_1_13 = (min ((max (2.625 , var_1_16)) , var_1_17));
	} else {
