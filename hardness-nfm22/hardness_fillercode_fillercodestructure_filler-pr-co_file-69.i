...
void step(void) {
 ...
 if (var_1_20) {
  ...
  if ((var_1_1 % var_1_34) != (var_1_15 + var_1_15)) {
   ...
   if ((((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))) << var_1_1) > var_1_34) {
 ...
 if (var_1_20) {
  var_1_24 = ((((((var_1_1) > (var_1_1)) ? (var_1_1) : (var_1_1))) + var_1_1) + 1);
 }
 if (var_1_1 > var_1_1) {
  if (var_1_1 >= var_1_1) {
   var_1_30 = var_1_1;
 ...
 if (var_1_15 <= 100u) {
  var_1_31 = ((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)));
 }
 ...
 if (var_1_1 >= ((((8) < (var_1_14)) ? (8) : (var_1_14)))) {
