...
void step(void) {
	...
	// From: CodeObject1
	if (var_1_17) {
		if ((var_1_14 - (min (var_1_14 , var_1_14))) <= var_1_15) {
			var_1_21 = var_1_27;
		}
	}
	...
	// From: CodeObject6
	if (! var_1_6) {
		if ((var_1_9 + var_1_13) >= ((var_1_15 + var_1_14) << (min (5 , var_1_39)))) {
	...
	// From: CodeObject4
	if ((min ((var_1_20 - var_1_20) , var_1_20)) > (var_1_11 * 31.3)) {
		if (var_1_5) {
			var_1_31 = var_1_35;
		}
	} else {
