...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch57dependencies.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_3 < ((var_1_2 * var_1_13) & var_1_1)) {
  var_1_20 = (((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18))) + var_1_14);
 }
 if ((((((var_1_1) > (var_1_5)) ? (var_1_1) : (var_1_5))) + (var_1_1 / var_1_14)) <= (var_1_1 & var_1_3)) {
  if (var_1_6) {
   var_1_21 = var_1_12;
  } else {
   var_1_21 = var_1_10;
