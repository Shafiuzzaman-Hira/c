...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch49PS_CN_500.c", 13, "reach_error"); }
...
double var_1_95 = 0.0;
double var_1_96 = 0.0;
signed long int var_1_97 = -500;
float var_1_98 = 15.075;
signed long int var_1_99 = 2018339958;
unsigned short int var_1_100 = 10000;
unsigned short int var_1_101 = 20084;
unsigned short int var_1_102 = 23221;
unsigned short int var_1_103 = 25144;
unsigned short int var_1_104 = 2;
unsigned short int var_1_105 = 2;
unsigned short int var_1_106 = 128;
double var_1_107 = 2.5;
signed long int var_1_108 = -8;
double var_1_109 = 32.8;
double var_1_110 = 63.76;
float var_1_111 = 1.5;
unsigned char var_1_112 = 1;
signed char var_1_113 = 5;
signed long int var_1_114 = -25;
unsigned char var_1_115 = 1;
signed short int var_1_116 = -500;
signed short int var_1_117 = 10;
unsigned char var_1_118 = 1;
unsigned char var_1_119 = 50;
float var_1_120 = 5.6;
unsigned char var_1_121 = 0;
unsigned char var_1_122 = 8;
float var_1_123 = 1000000000000.5;
unsigned char var_1_124 = 4;
unsigned short int var_1_125 = 0;
unsigned short int var_1_126 = 8;
unsigned long int var_1_127 = 64;
double var_1_128 = 32.6;
double var_1_129 = 127.7;
double var_1_130 = 8.4;
unsigned long int var_1_131 = 4;
signed long int var_1_132 = -1;
unsigned short int var_1_133 = 10;
unsigned char var_1_134 = 64;
signed short int var_1_135 = -10;
signed char var_1_136 = 32;
...
void step(void) {
	...
	// From: CodeObject30
	if ((abs (var_1_46)) < (abs (- var_1_61))) {
		if (var_1_54 <= 8.5f) {
			var_1_86 = (min ((min (var_1_87 , var_1_40)) , var_1_49));
		} else {
			if (((abs (var_1_76)) * var_1_28) > (var_1_37 - var_1_39)) {
				var_1_86 = ((max (var_1_26 , var_1_28)) - (max (var_1_40 , var_1_64)));
			} else {
				var_1_86 = ((abs (min (var_1_49 , var_1_73))) + var_1_48);
			}
		}
	}
	...
	// From: CodeObject32
	if ((! var_1_38) && (var_1_83 && var_1_81)) {
		if (var_1_30 >= var_1_54) {
			var_1_91 = (var_1_39 + var_1_25);
		} else {
			var_1_91 = (abs (var_1_28));
		}
	} else {
		if (var_1_66) {
			if (var_1_81) {
				if (var_1_74 == (abs (var_1_49))) {
					var_1_91 = (abs (var_1_64));
				}
			}
		}
	}
	...
	// From: CodeObject33
	if ((min ((min (var_1_37 , var_1_53)) , var_1_48)) >= var_1_59) {
		if (var_1_51 > (var_1_88 % var_1_39)) {
			var_1_92 = (var_1_60 - var_1_28);
		} else {
			if ((- var_1_45) >= var_1_47) {
				if (var_1_77 > (var_1_90 / (abs (var_1_28)))) {
					var_1_92 = (abs (abs (var_1_60)));
				}
			} else {
				var_1_92 = (var_1_40 + var_1_84);
			}
		}
	}
	...
	if (var_1_25 <= var_1_35) {
		...
		var_1_93 = (abs (abs (var_1_72)));
	}


	// From: CodeObject35
	if (((var_1_57 + var_1_70) & 1) <= (var_1_53 | var_1_28)) {
		var_1_94 = (var_1_68 + var_1_67);
	} else {
		var_1_94 = (var_1_46 - (var_1_95 - (var_1_96 - 0.6)));
	}


	// From: CodeObject36
	if (var_1_38) {
		if ((max ((abs (var_1_31)) , var_1_58)) < ((min (var_1_98 , var_1_46)) - 1.00000008E7f)) {
			if (var_1_34 >= (abs (max (var_1_48 , -32)))) {
				if (var_1_66) {
					if (-4 > var_1_57) {
						var_1_97 = (min (var_1_74 , var_1_90));
					}
				} else {
					var_1_97 = (abs ((var_1_99 - var_1_40) - 128));
				}
			}
		} else {
			if (var_1_96 < var_1_36) {
				var_1_97 = (abs (var_1_90));
			}
		}
	} else {
		if (var_1_65 > var_1_30) {
			var_1_97 = (abs (var_1_57));
		}
	}


	// From: CodeObject37
	if (var_1_31 <= (min ((abs (var_1_29)) , var_1_67))) {
		var_1_100 = (((min (var_1_101 , var_1_102)) + (var_1_103 - var_1_64)) - 10);
	}
	...
	if (var_1_82) {
		...
		if (var_1_102 > var_1_55) {
			var_1_104 = (min ((max ((abs (var_1_101)) , (var_1_39 - var_1_37))) , (max ((abs (64)) , var_1_40))));
		} else {
			var_1_104 = ((31251 + var_1_103) - (abs (1)));
		}
	}


	// From: CodeObject39
	var_1_105 = (max ((max ((abs (var_1_89)) , 2)) , var_1_106));


	// From: CodeObject40
	if (var_1_99 <= ((var_1_108 * var_1_106) / (abs (var_1_39)))) {
		var_1_107 = (abs (var_1_68));
	}


	// From: CodeObject41
	if (var_1_88 > (var_1_39 ^ -10)) {
		if (! var_1_81) {
			if ((var_1_102 & (- 4)) > 16) {
				var_1_109 = (var_1_67 + var_1_68);
			}
		} else {
			var_1_109 = (abs (max ((var_1_68 + var_1_67) , (min (var_1_29 , 9999999.375)))));
		}
	}
	...
	// From: CodeObject42
	if (var_1_60 >= (10u << 16)) {
		var_1_110 = ((max (var_1_95 , var_1_46)) - var_1_47);
	}


	// From: CodeObject43
	if ((var_1_49 + var_1_104) > var_1_101) {
		var_1_111 = (max (var_1_47 , var_1_29));
	}


	// From: CodeObject44
	if (var_1_43 < var_1_68) {
		var_1_112 = var_1_89;
	}


	// From: CodeObject45
	if (var_1_108 >= (var_1_112 | var_1_87)) {
		var_1_113 = (abs (max (var_1_90 , var_1_89)));
	}


	// From: CodeObject46
	if ((var_1_35 & (~ var_1_104)) >= var_1_52) {
		var_1_114 = (abs (var_1_113));
	} else {
		var_1_114 = var_1_102;
	}
	...
	// From: CodeObject47
	if (var_1_27 >= var_1_111) {
		var_1_115 = (var_1_79 && (! var_1_82));
	} else {
		var_1_115 = (! var_1_83);
	}
	...
	// From: CodeObject48
	if ((max (var_1_109 , var_1_44)) >= var_1_65) {
		if (32 <= (max (var_1_51 , var_1_74))) {
			var_1_116 = ((abs (-8)) + var_1_90);
		} else {
			var_1_116 = ((min (var_1_28 , (abs (var_1_89)))) + var_1_48);
		}
	} else {
		if (var_1_103 > (var_1_72 | var_1_70)) {
			var_1_116 = (min ((var_1_112 - var_1_26) , var_1_89));
		} else {
			var_1_116 = (max (var_1_74 , var_1_49));
		}
	}
	...
	// From: CodeObject65
	if (var_1_97 >= (var_1_37 + var_1_127)) {
		if ((min (var_1_68 , (min (var_1_109 , var_1_63)))) >= var_1_54) {
			var_1_136 = (max (var_1_74 , var_1_49));
		} else {
			var_1_136 = var_1_89;
		}
	} else {
...
void updateVariables() {
	...
	assume_abort_if_not((var_1_96 >= 2305843.009213691390e+12F && var_1_96 <= -1.0e-20F) || (var_1_96 <= 4611686.018427382800e+12F && var_1_96 >= 1.0e-20F ));
	var_1_98 = __VERIFIER_nondet_float();
	assume_abort_if_not((var_1_98 >= 0.0F && var_1_98 <= -1.0e-20F) || (var_1_98 <= 9223372.036854776000e+12F && var_1_98 >= 1.0e-20F ));
	...
	assume_abort_if_not(var_1_103 >= 24575);
	...
	assume_abort_if_not((var_1_129 >= -922337.2036854765600e+13F && var_1_129 <= -1.0e-20F) || (var_1_129 <= 9223372.036854765600e+12F && var_1_129 >= 1.0e-20F ));
	var_1_130 = __VERIFIER_nondet_double();
	assume_abort_if_not((var_1_130 >= -922337.2036854765600e+13F && var_1_130 <= -1.0e-20F) || (var_1_130 <= 9223372.036854765600e+12F && var_1_130 >= 1.0e-20F ));
}
