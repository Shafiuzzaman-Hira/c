...
void step(void) {
 ...
 if (var_1_35 != ((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24)))) {
  if (((((127.4) < 0 ) ? -(127.4) : (127.4))) < var_1_36) {
   if (var_1_29) {
    var_1_41 = var_1_26;
   }
  } else {
 ...
 if (var_1_29) {
  if (((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))) <= var_1_24) {
   if ((((((var_1_27 % var_1_30)) < (var_1_26)) ? ((var_1_27 % var_1_30)) : (var_1_26))) < (var_1_31 * (var_1_32 | var_1_33))) {
    if (((((var_1_25) > (var_1_24)) ? (var_1_25) : (var_1_24))) >= (var_1_34 * var_1_35)) {
     var_1_28 = var_1_25;
    }
   }
  } else {
 ...
 if (var_1_27 != var_1_30) {
  var_1_37 = (((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))) - ((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26))));
 } else {
  var_1_37 = (((((((var_1_26) > (var_1_27)) ? (var_1_26) : (var_1_27))) < 0 ) ? -((((var_1_26) > (var_1_27)) ? (var_1_26) : (var_1_27))) : ((((var_1_26) > (var_1_27)) ? (var_1_26) : (var_1_27)))));
 }
