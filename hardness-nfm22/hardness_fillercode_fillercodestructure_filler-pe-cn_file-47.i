...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch47Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_32 = var_1_33;
 if (var_1_30 > 32.8) {
  var_1_34 = (((((var_1_35 - var_1_26)) > (var_1_32)) ? ((var_1_35 - var_1_26)) : (var_1_32)));
 }
 if ((var_1_34 & var_1_33) <= var_1_26) {
  ...
  if (var_1_30 > var_1_25) {
   if ((~ var_1_26) > (var_1_32 & var_1_31)) {
    var_1_36 = (((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26))) + var_1_32);
   } else {
