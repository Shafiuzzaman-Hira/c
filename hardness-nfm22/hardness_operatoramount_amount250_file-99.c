...
void step(void) {
	...
	if (stepLocal_5 <= ((last_1_var_1_28 / var_1_4) * last_1_var_1_13)) {
		if (var_1_29 < 255.5) {
			var_1_33 = ((max (var_1_34 , (max (var_1_35 , 99.375)))) - ((var_1_36 - 1.0000000000000005E15) + var_1_37));
		}
	} else {
	...
	// From: Req17Batch99Amount250
	unsigned char stepLocal_11 = var_1_26;
	if (stepLocal_11 || (! var_1_21)) {
		var_1_53 = (min ((var_1_22 + 1) , var_1_32));
	}


	// From: Req10Batch99Amount250
	var_1_38 = var_1_18;


	// From: Req19Batch99Amount250
	var_1_59 = (var_1_37 - (var_1_60 - var_1_36));


	// From: Req21Batch99Amount250
	if (var_1_32 != (max ((var_1_50 % var_1_4) , last_1_var_1_63))) {
		var_1_63 = (var_1_57 + var_1_52);
	}


	// From: Req23Batch99Amount250
	if (var_1_55 <= var_1_40) {
		if (var_1_21) {
			if (var_1_29 < var_1_33) {
				var_1_65 = ((min (64 , var_1_22)) - var_1_50);
			}
		} else {
			var_1_65 = var_1_22;
		}
	...
	// From: Req2Batch99Amount250
	if (var_1_59 != (var_1_10 - var_1_11)) {
		if (var_1_21) {
			var_1_9 = (var_1_4 + (max (var_1_53 , (var_1_5 + 10))));
		}
	} else {
		if (var_1_21) {
			var_1_9 = 16;
	...
	// From: Req5Batch99Amount250
	if (var_1_10 > (var_1_38 + (var_1_59 + var_1_11))) {
		var_1_15 = (abs (max (7.25 , (min (var_1_16 , var_1_17)))));
	} else {
		var_1_15 = (min ((min (var_1_17 , (max (var_1_16 , var_1_18)))) , var_1_19));
	}


	// From: Req1Batch99Amount250
	...
	// From: Req15Batch99Amount250
	if (var_1_21 && var_1_24) {
		var_1_49 = (var_1_9 + (min (var_1_31 , var_1_1)));
	} else {
		var_1_49 = (max (((var_1_50 - var_1_1) - var_1_40) , var_1_9));
	}


	// From: Req4Batch99Amount250
	signed long int stepLocal_1 = (8 / var_1_4) * (min (var_1_65 , 16));
	if (var_1_59 >= var_1_33) {
		var_1_13 = (max (-16 , var_1_4));
	} else {
		if (var_1_5 <= stepLocal_1) {
			var_1_13 = (min (((var_1_5 - var_1_1) + var_1_4) , var_1_8));
		}
	}


	// From: Req12Batch99Amount250
	unsigned long int stepLocal_7 = (abs (3096462083u)) - var_1_8;
	...
	// From: Req20Batch99Amount250
	signed long int stepLocal_12 = (max (var_1_58 , var_1_56)) - (var_1_4 + var_1_8);
	...
	// From: Req16Batch99Amount250
	if (var_1_61 < 128) {
		if (var_1_59 != var_1_38) {
			if ((min ((var_1_61 / var_1_4) , var_1_47)) <= ((abs (var_1_46)) - var_1_5)) {
				var_1_51 = var_1_13;
			} else {
	...
	if (stepLocal_6 <= var_1_55) {
		...
		var_1_39 = (((var_1_40 + 10000) - var_1_64) + (abs (var_1_42)));
	}


	// From: Req6Batch99Amount250
	signed long int stepLocal_3 = abs (var_1_8);
	...
	// From: Req14Batch99Amount250
	unsigned short int stepLocal_10 = var_1_40;
	signed long int stepLocal_9 = abs (var_1_8);
	...
	// From: Req8Batch99Amount250
	if (var_1_27 && var_1_24) {
		var_1_28 = var_1_8;
	} else {
		if (var_1_18 >= (var_1_19 / (max (var_1_29 , var_1_30)))) {
...
int property() {
	return ((((((((((((((((((((((((! var_1_21) && var_1_21) ? (var_1_1 == ((unsigned char) (var_1_4 - var_1_5))) : (((64.888 * var_1_15) > var_1_33) ? (var_1_1 == ((unsigned char) (var_1_4 - (min (var_1_5 , var_1_8))))) : (var_1_1 == ((unsigned char) (var_1_5 + var_1_8))))) && ((var_1_59 != (var_1_10 - var_1_11)) ? (var_1_21 ? (var_1_9 == ((signed short int) (var_1_4 + (max (var_1_53 , (var_1_5 + 10)))))) : 1) : (var_1_21 ? (var_1_9 == ((signed short int) 16)) : (var_1_9 == ((signed short int) var_1_5))))) && ((! var_1_21) ? ((var_1_59 >= var_1_11) ? (var_1_12 == ((unsigned short int) (var_1_8 + 25))) : 1) : 1)) && ((var_1_59 >= var_1_33) ? (var_1_13 == ((signed short int) (max (-16 , var_1_4)))) : ((var_1_5 <= ((8 / var_1_4) * (min (var_1_65 , 16)))) ? (var_1_13 == ((signed short int) (min (((var_1_5 - var_1_1) + var_1_4) , var_1_8)))) : 1))) && ((var_1_10 > (var_1_38 + (var_1_59 + var_1_11))) ? (var_1_15 == ((double) (abs (max (7.25 , (min (var_1_16 , var_1_17))))))) : (var_1_15 == ((double) (min ((min (var_1_17 , (max (var_1_16 , var_1_18)))) , var_1_19)))))) && (((- var_1_1) != var_1_5) ? ((var_1_51 > (abs (var_1_8))) ? (var_1_20 == ((unsigned short int) ((var_1_4 + var_1_5) + var_1_8))) : (var_1_20 == ((unsigned short int) var_1_8))) : 1)) && ((last_1_var_1_33 >= var_1_16) ? (((var_1_5 << (var_1_22 - 0)) <= last_1_var_1_55) ? (var_1_21 == ((unsigned char) (((var_1_3 || var_1_23) && var_1_24) && var_1_25))) : (var_1_21 == ((unsigned char) (var_1_24 && (var_1_25 || var_1_23))))) : (var_1_21 == ((unsigned char) (var_1_26 || var_1_27))))) && ((var_1_27 && var_1_24) ? (var_1_28 == ((unsigned char) var_1_8)) : ((var_1_18 >= (var_1_19 / (max (var_1_29 , var_1_30)))) ? ((var_1_51 > var_1_55) ? (var_1_28 == ((unsigned char) (var_1_22 + var_1_8))) : 1) : (((var_1_12 / var_1_4) <= last_1_var_1_28) ? ((last_1_var_1_28 == last_1_var_1_28) ? (var_1_28 == ((unsigned char) var_1_8)) : 1) : (var_1_28 == ((unsigned char) (var_1_5 + (var_1_31 - (var_1_22 + var_1_32))))))))) && ((((var_1_22 - last_1_var_1_39) + last_1_var_1_1) <= ((last_1_var_1_28 / var_1_4) * last_1_var_1_13)) ? ((var_1_29 < 255.5) ? (var_1_33 == ((double) ((max (var_1_34 , (max (var_1_35 , 99.375)))) - ((var_1_36 - 1.0000000000000005E15) + var_1_37)))) : 1) : (var_1_33 == ((double) (var_1_34 - var_1_36))))) && (var_1_38 == ((float) var_1_18))) && ((var_1_4 <= var_1_55) ? ((var_1_36 >= var_1_11) ? (var_1_39 == ((unsigned short int) var_1_5)) : 1) : (var_1_39 == ((unsigned short int) (((var_1_40 + 10000) - var_1_64) + (abs (var_1_42))))))) && ((((abs (3096462083u)) - var_1_8) >= ((64u & var_1_53) + var_1_13)) ? (var_1_42 == ((signed char) var_1_22)) : (var_1_42 == ((signed char) (var_1_32 + var_1_22))))) && (var_1_21 ? (var_1_43 == ((unsigned long int) var_1_28)) : ((var_1_33 < var_1_29) ? (var_1_43 == ((unsigned long int) ((var_1_44 + (var_1_45 - var_1_8)) - var_1_5))) : (var_1_43 == ((unsigned long int) ((var_1_46 - (var_1_47 - var_1_28)) - var_1_28)))))) && ((var_1_40 <= (500 / var_1_4)) ? (((abs (var_1_8)) >= var_1_32) ? ((var_1_40 >= var_1_22) ? (var_1_21 ? (var_1_48 == ((signed short int) (var_1_39 + var_1_42))) : (var_1_27 ? (var_1_48 == ((signed short int) (min (var_1_39 , 50)))) : 1)) : 1) : 1) : (var_1_48 == ((signed short int) (var_1_31 - var_1_1))))) && ((var_1_21 && var_1_24) ? (var_1_49 == ((signed short int) (var_1_9 + (min (var_1_31 , var_1_1))))) : (var_1_49 == ((signed short int) (max (((var_1_50 - var_1_1) - var_1_40) , var_1_9)))))) && ((var_1_61 < 128) ? ((var_1_59 != var_1_38) ? (((min ((var_1_61 / var_1_4) , var_1_47)) <= ((abs (var_1_46)) - var_1_5)) ? (var_1_51 == ((unsigned short int) var_1_13)) : (var_1_51 == ((unsigned short int) (var_1_32 + var_1_4)))) : ((((var_1_61 % var_1_31) * var_1_55) < var_1_5) ? (var_1_51 == ((unsigned short int) (abs (var_1_13)))) : 1)) : ((! var_1_26) ? ((var_1_44 < var_1_40) ? (var_1_51 == ((unsigned short int) (var_1_40 + (var_1_52 - var_1_31)))) : (var_1_51 == ((unsigned short int) last_1_var_1_51))) : (var_1_51 == ((unsigned short int) 10))))) && ((var_1_26 || (! var_1_21)) ? (var_1_53 == ((signed char) (min ((var_1_22 + 1) , var_1_32)))) : 1)) && ((last_1_var_1_28 <= (var_1_56 - var_1_40)) ? (var_1_55 == ((unsigned short int) ((var_1_52 + var_1_57) - (last_1_var_1_55 + last_1_var_1_64)))) : (var_1_55 == ((unsigned short int) (var_1_58 - var_1_57))))) && (var_1_59 == ((float) (var_1_37 - (var_1_60 - var_1_36))))) && ((((max (var_1_58 , var_1_56)) - (var_1_4 + var_1_8)) != last_1_var_1_61) ? ((var_1_16 <= var_1_33) ? (var_1_61 == ((unsigned short int) (var_1_40 + var_1_31))) : (var_1_61 == ((unsigned short int) (var_1_58 - var_1_64)))) : 1)) && ((var_1_32 != (max ((var_1_50 % var_1_4) , last_1_var_1_63))) ? (var_1_63 == ((unsigned short int) (var_1_57 + var_1_52))) : 1)) && ((! (var_1_44 < var_1_9)) ? (var_1_64 == ((unsigned char) var_1_22)) : (var_1_64 == ((unsigned char) var_1_4)))) && ((var_1_55 <= var_1_40) ? (var_1_21 ? ((var_1_29 < var_1_33) ? (var_1_65 == ((signed short int) ((min (64 , var_1_22)) - var_1_50))) : 1) : (var_1_65 == ((signed short int) var_1_22))) : (var_1_65 == ((signed short int) var_1_55)))
;
}
int main(void) {
	isInitial = 1;
