...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch8Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_26 < ((((((((var_1_26) > (var_1_7)) ? (var_1_26) : (var_1_7)))) > (var_1_26)) ? (((((var_1_26) > (var_1_7)) ? (var_1_26) : (var_1_7)))) : (var_1_26)))) {
  var_1_42 = var_1_39;
 } else {
  if (var_1_1 <= var_1_39) {
