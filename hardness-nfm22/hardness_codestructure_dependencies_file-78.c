...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch78dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch78dependencies
	if ((last_1_var_1_20 ^ last_1_var_1_15) < -256) {
	...
	// From: Req7Batch78dependencies
	var_1_20 = (max ((var_1_5 + var_1_6) , var_1_4));


	// From: Req2Batch78dependencies
	if (last_1_var_1_6 < last_1_var_1_21) {
		var_1_3 = (max (var_1_4 , var_1_5));
	}


	// From: Req4Batch78dependencies
	...
	// From: Req6Batch78dependencies
	var_1_16 = (var_1_17 + (var_1_18 + (abs (var_1_19))));


	// From: Req1Batch78dependencies
	var_1_1 = (abs (var_1_16));


	// From: Req8Batch78dependencies
	if (var_1_6 == ((var_1_3 * var_1_17) & (var_1_1 * var_1_18))) {
		var_1_21 = (var_1_4 + 128);
	}


	// From: Req5Batch78dependencies
