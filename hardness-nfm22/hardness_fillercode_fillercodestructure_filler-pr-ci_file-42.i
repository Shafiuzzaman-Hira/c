...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch42Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((- var_1_15) < ((((var_1_14) > (var_1_15)) ? (var_1_14) : (var_1_15)))) {
  var_1_30 = var_1_15;
 }
 if (var_1_11) {
  var_1_35 = var_1_7;
 ...
 if (var_1_11) {
  var_1_36 = (var_1_7 - var_1_38);
 } else {
  var_1_36 = (var_1_7 - ((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39))));
 }
 if (var_1_7 <= (~ var_1_6)) {
  if (((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39))) >= var_1_38) {
   var_1_41 = ((((var_1_42 - var_1_38) < 0 ) ? -(var_1_42 - var_1_38) : (var_1_42 - var_1_38)));
  }
 } else {
  var_1_41 = var_1_6;
 }
 ...
 if (((((((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)))) < (var_1_5)) ? (((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)))) : (var_1_5))) <= var_1_13) {
  var_1_31 = var_1_7;
 }
 if ((- var_1_6) != var_1_7) {
  var_1_40 = var_1_39;
 ...
 if (((var_1_7 + 25) % var_1_7) < 2) {
  var_1_26 = (((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16))) + var_1_15);
 }
 unsigned char stepLocal_7 = var_1_6;
 if (stepLocal_7 > var_1_6) {
  var_1_17 = ((((25) > ((var_1_13 + var_1_6))) ? (25) : ((var_1_13 + var_1_6))));
 }
 if (var_1_7 < ((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13)))) {
  var_1_34 = ((((((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)))) > (var_1_7)) ? (((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)))) : (var_1_7)));
 }
