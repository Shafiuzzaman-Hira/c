...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch15Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch15Filler_PE_CO
	var_1_10 = var_1_11;


	// From: Req3Batch15Filler_PE_CO
	...
	if (! var_1_19) {
		if (var_1_19) {
			var_1_26 = (abs (min (var_1_17 , var_1_17)));
		} else {
			if (var_1_17 >= 25) {
	...
	// From: CodeObject2
	var_1_34 = (min (128 , (max (var_1_1 , (-5 + var_1_17)))));
	...
	// From: CodeObject5
	if (var_1_19) {
		var_1_41 = (max ((min (var_1_40 , var_1_32)) , var_1_10));
	}
