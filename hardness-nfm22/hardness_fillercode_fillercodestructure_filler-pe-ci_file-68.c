...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch68Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch68Filler_PE_CI
	var_1_16 = last_1_var_1_12;


	// From: Req6Batch68Filler_PE_CI
	...
	// From: Req7Batch68Filler_PE_CI
	var_1_15 = var_1_10;


	// From: Req3Batch68Filler_PE_CI
