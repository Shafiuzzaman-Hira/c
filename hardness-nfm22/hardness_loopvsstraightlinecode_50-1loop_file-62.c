...
void step(void) {
	...
	// From: Req6Batch6250_1loop
	if (var_1_10 || var_1_20) {
		var_1_19 = (max (var_1_21 , 32));
	}


	// From: Req7Batch6250_1loop
	if (var_1_10) {
