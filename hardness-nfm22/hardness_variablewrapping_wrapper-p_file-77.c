...
void step(void) {
	// From: Req2Batch77Wrapper_P
	if ((*(var_1_7_Pointer)) > (*(var_1_5_Pointer))) {
		(*(var_1_8_Pointer)) = (abs ((*(var_1_9_Pointer))));
	} else {
		(*(var_1_8_Pointer)) = ((max ((*(var_1_10_Pointer)) , (*(var_1_11_Pointer)))) - ((*(var_1_12_Pointer)) - 3.4f));
	}


	// From: Req3Batch77Wrapper_P
	unsigned short int stepLocal_0 = (*(var_1_6_Pointer));
	if (stepLocal_0 <= (*(var_1_5_Pointer))) {
		if ((max ((*(var_1_8_Pointer)) , ((*(var_1_12_Pointer)) / (*(var_1_15_Pointer))))) > (min ((*(var_1_10_Pointer)) , (*(var_1_8_Pointer))))) {
	...
	// From: Req4Batch77Wrapper_P
	if ((*(var_1_6_Pointer)) > ((*(var_1_13_Pointer)) * (max ((*(var_1_5_Pointer)) , (*(var_1_7_Pointer)))))) {
	...
	// From: Req1Batch77Wrapper_P
	if ((*(var_1_8_Pointer)) != (*(var_1_8_Pointer))) {
		(*(var_1_1_Pointer)) = ((*(var_1_4_Pointer)) - (min ((*(var_1_5_Pointer)) , ((*(var_1_6_Pointer)) - (*(var_1_7_Pointer))))));
	}
}
...
int property() {
	return (((((*(var_1_8_Pointer)) != (*(var_1_8_Pointer))) ? ((*(var_1_1_Pointer)) == ((unsigned short int) ((*(var_1_4_Pointer)) - (min ((*(var_1_5_Pointer)) , ((*(var_1_6_Pointer)) - (*(var_1_7_Pointer)))))))) : 1) && (((*(var_1_7_Pointer)) > (*(var_1_5_Pointer))) ? ((*(var_1_8_Pointer)) == ((float) (abs ((*(var_1_9_Pointer)))))) : ((*(var_1_8_Pointer)) == ((float) ((max ((*(var_1_10_Pointer)) , (*(var_1_11_Pointer)))) - ((*(var_1_12_Pointer)) - 3.4f)))))) && (((*(var_1_6_Pointer)) <= (*(var_1_5_Pointer))) ? (((max ((*(var_1_8_Pointer)) , ((*(var_1_12_Pointer)) / (*(var_1_15_Pointer))))) > (min ((*(var_1_10_Pointer)) , (*(var_1_8_Pointer))))) ? ((*(var_1_13_Pointer)) == ((signed short int) (*(var_1_7_Pointer)))) : 1) : ((*(var_1_13_Pointer)) == ((signed short int) (*(var_1_7_Pointer)))))) && (((*(var_1_6_Pointer)) > ((*(var_1_13_Pointer)) * (max ((*(var_1_5_Pointer)) , (*(var_1_7_Pointer)))))) ? (((*(var_1_17_Pointer)) || (*(var_1_18_Pointer))) ? ((*(var_1_16_Pointer)) == ((unsigned short int) (*(var_1_4_Pointer)))) : ((*(var_1_16_Pointer)) == ((unsigned short int) (*(var_1_7_Pointer))))) : ((*(var_1_16_Pointer)) == ((unsigned short int) (*(var_1_6_Pointer)))))
;
}
int main(void) {
	isInitial = 1;
