...
void step(void) {
 ...
 if (var_1_30 >= (((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))) - (var_1_37 + var_1_26))) {
  var_1_42 = (! var_1_44);
 } else {
  var_1_42 = (var_1_44 && var_1_45);
 }
 if (((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28))) > var_1_24) {
  var_1_46 = ((((var_1_47) < 0 ) ? -(var_1_47) : (var_1_47)));
 }
 if (var_1_24 <= var_1_26) {
  if ((- var_1_39) >= (var_1_28 / var_1_49)) {
   if ((var_1_50 - var_1_51) > (((((var_1_37) > (-8)) ? (var_1_37) : (-8))) << var_1_24)) {
    var_1_48 = (var_1_52 - ((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36))));
   }
  }
 } else {
  var_1_48 = (((((var_1_34 + var_1_36) < 0 ) ? -(var_1_34 + var_1_36) : (var_1_34 + var_1_36))) - var_1_52);
 }
 if (var_1_26 > var_1_46) {
  if ((((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) - 16.4f) == var_1_35) {
   var_1_53 = (! (! var_1_54));
  }
 }
 if (var_1_27 <= ((var_1_26 >> var_1_24) * 200)) {
  var_1_55 = ((((var_1_51) < (((((var_1_56) < 0 ) ? -(var_1_56) : (var_1_56))))) ? (var_1_51) : (((((var_1_56) < 0 ) ? -(var_1_56) : (var_1_56))))));
 }
 if (var_1_47 >= ((var_1_27 >> var_1_29) & var_1_55)) {
  var_1_57 = ((((var_1_36) < (25.625f)) ? (var_1_36) : (25.625f)));
 }
 var_1_58 = var_1_51;
 var_1_59 = var_1_52;
