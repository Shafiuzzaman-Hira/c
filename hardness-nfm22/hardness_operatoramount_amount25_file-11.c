...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch11Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch11Amount25
	signed long int stepLocal_1 = var_1_1 / (min (var_1_12 , var_1_13));
...
int property() {
	return ((((var_1_2 - 5.25) < (var_1_8 * (var_1_8 * 199.4))) ? ((var_1_5 && var_1_6) ? ((var_1_8 < var_1_8) ? (var_1_1 == ((signed char) var_1_7)) : (var_1_1 == ((signed char) var_1_7))) : 1) : 1) && ((last_1_var_1_8 >= var_1_2) ? (var_1_6 ? ((! var_1_5) ? (var_1_8 == ((float) (max (var_1_9 , var_1_10)))) : (var_1_8 == ((float) var_1_9))) : 1) : 1)) && (((var_1_1 / (min (var_1_12 , var_1_13))) < var_1_7) ? (var_1_11 == ((unsigned short int) (var_1_14 - var_1_15))) : 1)
;
}
int main(void) {
	isInitial = 1;
