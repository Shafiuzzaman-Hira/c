...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch86Filler_PR_CN.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) > (~ (var_1_30 % var_1_31))) {
  if (var_1_28 >= 2) {
