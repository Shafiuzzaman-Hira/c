...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch40100_while.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_23 / (var_1_3 + var_1_4)) == ((((8) < (var_1_32)) ? (8) : (var_1_32)))) {
 ...
 if (! var_1_16) {
  if (var_1_27 < ((((var_1_28) < ((var_1_31 - var_1_30))) ? (var_1_28) : ((var_1_31 - var_1_30))))) {
   if (var_1_6) {
    var_1_34 = var_1_3;
   }
  } else {
