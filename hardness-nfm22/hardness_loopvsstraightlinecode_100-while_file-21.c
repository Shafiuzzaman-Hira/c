...
void step(void) {
	...
	// From: Req13Batch21100_while
	var_1_39 = var_1_22;


	// From: Req14Batch21100_while
	var_1_40 = var_1_41;


	// From: Req15Batch21100_while
	var_1_42 = var_1_11;


	// From: Req6Batch21100_while
	...
	// From: Req3Batch21100_while
	if (! (! (var_1_9 <= var_1_12))) {
		var_1_13 = var_1_9;
	}


	// From: Req9Batch21100_while
	if (var_1_40) {
