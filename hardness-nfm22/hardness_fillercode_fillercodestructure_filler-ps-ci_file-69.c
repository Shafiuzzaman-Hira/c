...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch69Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
	// From: CodeObject1
	if (var_1_11) {
		var_1_24 = (((max (var_1_6 , var_1_8)) + var_1_5) + 1);
	}
	...
	if (var_1_10) {
		if (var_1_1 <= var_1_8) {
			...
			var_1_32 = (min (var_1_6 , 0));
		}
	} else {
		if ((var_1_1 % var_1_5) != (var_1_7 + var_1_4)) {
			...
			if (((abs (var_1_7)) << var_1_1) > var_1_5) {
				if ((-100 | var_1_6) >= var_1_1) {
					var_1_32 = var_1_6;
				}
			} else {
				var_1_32 = var_1_5;
	...
	// From: Req4Batch69Filler_PS_CI
	if (var_1_20 || (var_1_6 <= var_1_8)) {
		var_1_14 = var_1_6;
	}


	// From: Req1Batch69Filler_PS_CI
