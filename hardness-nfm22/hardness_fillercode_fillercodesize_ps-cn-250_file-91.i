...
void step(void) {
 ...
 var_1_39 = (((((((var_1_40) < (var_1_41)) ? (var_1_40) : (var_1_41))) < 0 ) ? -((((var_1_40) < (var_1_41)) ? (var_1_40) : (var_1_41))) : ((((var_1_40) < (var_1_41)) ? (var_1_40) : (var_1_41)))));
 if ((var_1_41 >= ((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39)))) || (var_1_35 <= var_1_40)) {
  var_1_42 = ((8.3877239533613629E18f - 10000.75f) - (6.5819518152542228E18f - var_1_43));
 } else {
  if ((var_1_44 - var_1_45) <= var_1_46) {
   var_1_42 = var_1_43;
  } else {
   if (var_1_40 <= (((((var_1_43) < (var_1_47)) ? (var_1_43) : (var_1_47))) - var_1_48)) {
    var_1_42 = ((((9.5f) > (((((var_1_49) < (var_1_40)) ? (var_1_49) : (var_1_40))))) ? (9.5f) : (((((var_1_49) < (var_1_40)) ? (var_1_49) : (var_1_40))))));
   }
  }
 }
 if (var_1_46 > var_1_45) {
  if (var_1_38) {
   var_1_50 = (((((((2) < 0 ) ? -(2) : (2))) < 0 ) ? -((((2) < 0 ) ? -(2) : (2))) : ((((2) < 0 ) ? -(2) : (2)))));
  } else {
   var_1_50 = (((((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51))) < 0 ) ? -((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51))) : ((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51)))));
  }
 }
 if (((((var_1_53 - 10) < 0 ) ? -(var_1_53 - 10) : (var_1_53 - 10))) < var_1_46) {
  var_1_52 = ((((var_1_50) < (var_1_53)) ? (var_1_50) : (var_1_53)));
 } else {
  var_1_52 = var_1_51;
 }
 if (var_1_30 || (var_1_41 >= ((((var_1_42) < 0 ) ? -(var_1_42) : (var_1_42))))) {
 ...
 if ((((((((var_1_51) > (var_1_50)) ? (var_1_51) : (var_1_50))) < 0 ) ? -((((var_1_51) > (var_1_50)) ? (var_1_51) : (var_1_50))) : ((((var_1_51) > (var_1_50)) ? (var_1_51) : (var_1_50))))) != (((((var_1_45 / var_1_58)) > (var_1_53)) ? ((var_1_45 / var_1_58)) : (var_1_53)))) {
  if ((! var_1_37) && var_1_59) {
   var_1_57 = ((var_1_48 < ((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40)))) || (! var_1_37));
  }
 } else {
  var_1_57 = var_1_33;
 }
 if (var_1_43 == var_1_48) {
  if (var_1_33) {
   var_1_60 = ((((((((((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52)))) > (((((var_1_53) < 0 ) ? -(var_1_53) : (var_1_53))))) ? (((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52)))) : (((((var_1_53) < 0 ) ? -(var_1_53) : (var_1_53))))))) > (((((var_1_55) < 0 ) ? -(var_1_55) : (var_1_55))))) ? (((((((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52)))) > (((((var_1_53) < 0 ) ? -(var_1_53) : (var_1_53))))) ? (((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52)))) : (((((var_1_53) < 0 ) ? -(var_1_53) : (var_1_53))))))) : (((((var_1_55) < 0 ) ? -(var_1_55) : (var_1_55))))));
  }
 } else {
  var_1_60 = ((((32) < 0 ) ? -(32) : (32)));
 }
 if (var_1_57) {
  var_1_61 = (var_1_43 + ((((7.75) > (((((var_1_62) < 0 ) ? -(var_1_62) : (var_1_62))))) ? (7.75) : (((((var_1_62) < 0 ) ? -(var_1_62) : (var_1_62)))))));
 } else {
  var_1_61 = (((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))) + var_1_62);
 }
 if (var_1_27) {
  var_1_63 = ((((var_1_64) < 0 ) ? -(var_1_64) : (var_1_64)));
 }
 if (var_1_51 < ((((var_1_44) > (var_1_55)) ? (var_1_44) : (var_1_55)))) {
  var_1_65 = (((((var_1_53 + var_1_66)) < (var_1_51)) ? ((var_1_53 + var_1_66)) : (var_1_51)));
 } else {
  var_1_65 = ((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51)));
 }
 if (var_1_28) {
  var_1_67 = ((((4u) < 0 ) ? -(4u) : (4u)));
 } else {
 ...
 if (var_1_27) {
  if (var_1_32 || ((- var_1_66) < var_1_50)) {
   var_1_70 = ((((var_1_62) < 0 ) ? -(var_1_62) : (var_1_62)));
  } else {
   var_1_70 = var_1_40;
  }
 } else {
  if (var_1_35 <= (var_1_43 * var_1_42)) {
   var_1_70 = ((((var_1_43 - var_1_71) < 0 ) ? -(var_1_43 - var_1_71) : (var_1_43 - var_1_71)));
  } else {
   var_1_70 = var_1_43;
  }
 }
 if (((((var_1_51) > (var_1_67)) ? (var_1_51) : (var_1_67))) < 8u) {
  if (2 < var_1_52) {
   var_1_72 = (var_1_43 - (((((var_1_73) < (var_1_74)) ? (var_1_73) : (var_1_74))) + ((((var_1_62) < 0 ) ? -(var_1_62) : (var_1_62)))));
  }
 }
 if (var_1_42 <= var_1_49) {
  var_1_75 = ((((((((var_1_76) > (var_1_77)) ? (var_1_76) : (var_1_77))) - var_1_78) < 0 ) ? -(((((var_1_76) > (var_1_77)) ? (var_1_76) : (var_1_77))) - var_1_78) : (((((var_1_76) > (var_1_77)) ? (var_1_76) : (var_1_77))) - var_1_78)));
 }
 var_1_79 = (((((((var_1_40) < (var_1_43)) ? (var_1_40) : (var_1_43))) < 0 ) ? -((((var_1_40) < (var_1_43)) ? (var_1_40) : (var_1_43))) : ((((var_1_40) < (var_1_43)) ? (var_1_40) : (var_1_43)))));
 if ((var_1_81 & (~ var_1_64)) < var_1_63) {
  if (var_1_27 || (var_1_42 >= var_1_40)) {
   var_1_80 = ((((var_1_51) < ((((((128) < (var_1_82)) ? (128) : (var_1_82))) - var_1_76))) ? (var_1_51) : ((((((128) < (var_1_82)) ? (128) : (var_1_82))) - var_1_76))));
  }
 }
 if ((((((var_1_50) < 0 ) ? -(var_1_50) : (var_1_50))) ^ (var_1_65 & var_1_53)) < (~ ((((var_1_55) < (var_1_63)) ? (var_1_55) : (var_1_63))))) {
  var_1_83 = var_1_65;
 }
 if (var_1_35 >= (- var_1_47)) {
  var_1_84 = ((((var_1_66) < 0 ) ? -(var_1_66) : (var_1_66)));
 } else {
  if (var_1_45 > ((((((((var_1_65) < 0 ) ? -(var_1_65) : (var_1_65)))) < (((((var_1_69) > (256u)) ? (var_1_69) : (256u))))) ? (((((var_1_65) < 0 ) ? -(var_1_65) : (var_1_65)))) : (((((var_1_69) > (256u)) ? (var_1_69) : (256u))))))) {
   var_1_84 = ((((var_1_80) < (var_1_82)) ? (var_1_80) : (var_1_82)));
  } else {
   var_1_84 = ((((((((var_1_51) > (var_1_53)) ? (var_1_51) : (var_1_53)))) > (var_1_65)) ? (((((var_1_51) > (var_1_53)) ? (var_1_51) : (var_1_53)))) : (var_1_65)));
  }
 }
 if (var_1_28) {
 ...
 if (var_1_65 >= (var_1_78 / var_1_82)) {
  if (var_1_49 >= (- var_1_40)) {
   if (var_1_71 > var_1_34) {
    ...
    var_1_86 = ((((var_1_66) < (256u)) ? (var_1_66) : (256u)));
   }
  }
 } else {
  if (var_1_80 == (var_1_66 << ((((var_1_88) < 0 ) ? -(var_1_88) : (var_1_88))))) {
   var_1_86 = (3615596346u - 100u);
  }
 }
 if ((((((((var_1_50) > (var_1_69)) ? (var_1_50) : (var_1_69))) < 0 ) ? -((((var_1_50) > (var_1_69)) ? (var_1_50) : (var_1_69))) : ((((var_1_50) > (var_1_69)) ? (var_1_50) : (var_1_69))))) <= ((((var_1_86) < 0 ) ? -(var_1_86) : (var_1_86)))) {
  if (var_1_41 <= var_1_72) {
   var_1_89 = ((((((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))) < 0 ) ? -((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))) : ((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))))) - ((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))));
  } else {
 ...
 if (var_1_72 != 50.45) {
  if (var_1_63 > ((var_1_55 + var_1_53) ^ var_1_80)) {
   var_1_94 = ((((var_1_74) < 0 ) ? -(var_1_74) : (var_1_74)));
  } else {
   var_1_94 = var_1_41;
  }
 } else {
