...
void step(void) {
	...
	if (var_1_33 > var_1_34) {
		if (var_1_24 <= var_1_22) {
			var_1_35 = ((abs (var_1_34)) - (abs (var_1_36)));
		}
	}
	...
	// From: Req7Batch84PS_CN_25
	var_1_18 = var_1_17;


	// From: Req8Batch84PS_CN_25
	var_1_19 = 0;


	// From: Req9Batch84PS_CN_25
	var_1_20 = var_1_21;


	// From: Req1Batch84PS_CN_25
	if (var_1_19) {
		var_1_1 = (min ((var_1_3 + (1 - var_1_4)) , var_1_5));
	}


	// From: Req4Batch84PS_CN_25
	if (var_1_3 <= var_1_1) {
		var_1_12 = var_1_4;
	} else {
