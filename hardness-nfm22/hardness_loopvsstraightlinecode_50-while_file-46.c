...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch4650_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch4650_while
	var_1_17 = var_1_18;


	// From: Req7Batch4650_while
	var_1_19 = 5;


	// From: Req8Batch4650_while
	var_1_20 = var_1_15;


	// From: Req4Batch4650_while
	if (var_1_1 < var_1_20) {
