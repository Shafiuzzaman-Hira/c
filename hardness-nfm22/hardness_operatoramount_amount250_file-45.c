...
void step(void) {
	...
	if (! last_1_var_1_45) {
		if (last_1_var_1_45) {
			var_1_14 = ((32 + last_1_var_1_42) + (abs (min (var_1_5 , -50))));
		} else {
			var_1_14 = (var_1_13 - (max (var_1_5 , last_1_var_1_27)));
		}
	}
	...
	if (stepLocal_18 < (min (var_1_17 , last_1_var_1_27))) {
	...
	if (stepLocal_9 != (min (var_1_8 , 64u))) {
		if (! last_1_var_1_56) {
			var_1_27 = var_1_13;
		} else {
			var_1_27 = (min (var_1_19 , (max (var_1_13 , 50))));
		}
	}
	...
	var_1_52 = (max (var_1_39 , (var_1_40 - (abs (var_1_41)))));
	...
	if (stepLocal_19 < var_1_14) {
		var_1_51 = (min ((min ((var_1_19 + var_1_35) , var_1_13)) , (var_1_58 + var_1_5)));
	}
	...
	if (var_1_56) {
		...
		var_1_26 = (var_1_13 - (abs (var_1_50)));
	}


	// From: Req10Batch45Amount250
	if (((var_1_21 < 49.5) || var_1_56) || ((max (var_1_20 , var_1_22)) >= 1.0000000002E9)) {
		if (128 >= (var_1_19 - var_1_34)) {
			var_1_28 = (min (var_1_21 , var_1_22));
		} else {
	...
	if (((var_1_33 + var_1_27) - (1325268161 - var_1_51)) != stepLocal_15) {
		var_1_36 = (abs (min ((var_1_21 + var_1_22) , 1.75f)));
	} else {
		if (var_1_56) {
	...
	if ((max (var_1_36 , var_1_39)) < (var_1_38 - var_1_41)) {
		var_1_55 = var_1_34;
	} else {
		var_1_55 = var_1_5;
	}
	...
	if ((var_1_14 >= var_1_9) || var_1_56) {
		if (var_1_38 > var_1_20) {
			...
			var_1_42 = (min ((var_1_27 + var_1_33) , var_1_58));
		}
	}
	...
	if (var_1_12 < stepLocal_8) {
		if (stepLocal_7 > var_1_27) {
			var_1_24 = (max (var_1_16 , var_1_17));
		} else {
			var_1_24 = (4 - var_1_18);
		}
	} else {
		var_1_24 = (min ((min (var_1_5 , var_1_17)) , (var_1_18 + var_1_58)));
	}
	...
	if ((last_1_var_1_1 >= var_1_55) || stepLocal_0) {
		if (((last_1_var_1_1 * var_1_55) >> var_1_5) >= stepLocal_1) {
			...
			var_1_1 = (var_1_5 + (min (var_1_50 , var_1_50)));
		}
	} else {
		if (var_1_45) {
	...
	if (stepLocal_20 < 16u) {
		...
		var_1_53 = (max (var_1_34 , var_1_33));
	}
}
...
int property() {
	return (((((((((((((((((((((((((last_1_var_1_1 >= var_1_55) || var_1_45) ? ((((last_1_var_1_1 * var_1_55) >> var_1_5) >= 50u) ? (var_1_1 == ((unsigned long int) (var_1_5 + (var_1_50 + var_1_50)))) : (var_1_1 == ((unsigned long int) (var_1_5 + (min (var_1_50 , var_1_50)))))) : (var_1_45 ? (var_1_1 == ((unsigned long int) ((min (var_1_8 , var_1_9)) - (var_1_10 - (var_1_11 - var_1_5))))) : 1)) && ((var_1_58 == var_1_5) ? (var_1_12 == ((signed char) (var_1_5 - (var_1_13 - 8)))) : 1)) && ((! last_1_var_1_45) ? (last_1_var_1_45 ? (var_1_14 == ((signed short int) ((32 + last_1_var_1_42) + (abs (min (var_1_5 , -50)))))) : (var_1_14 == ((signed short int) (var_1_13 - (max (var_1_5 , last_1_var_1_27)))))) : 1)) && ((var_1_23 >= (var_1_13 / var_1_11)) ? (var_1_16 == ((signed char) (min (var_1_5 , (min (var_1_13 , var_1_17)))))) : (var_1_16 == ((signed char) ((var_1_5 + var_1_18) - (max (var_1_13 , var_1_19))))))) && (((var_1_18 < var_1_50) && var_1_45) ? (((var_1_50 ^ var_1_27) <= (- (var_1_11 * var_1_10))) ? (var_1_20 == ((double) (var_1_21 + var_1_22))) : (var_1_20 == ((double) var_1_21))) : 1)) && (((last_1_var_1_23 > (var_1_9 - var_1_10)) && var_1_45) ? (((last_1_var_1_23 + var_1_50) > (var_1_50 + var_1_42)) ? (var_1_23 == ((signed long int) (var_1_18 - var_1_27))) : 1) : (var_1_23 == ((signed long int) (abs (var_1_27)))))) && ((var_1_12 < ((var_1_18 + var_1_5) - var_1_13)) ? (((-64 / var_1_13) > var_1_27) ? (var_1_24 == ((signed short int) (max (var_1_16 , var_1_17)))) : (var_1_24 == ((signed short int) (4 - var_1_18)))) : (var_1_24 == ((signed short int) (min ((min (var_1_5 , var_1_17)) , (var_1_18 + var_1_58))))))) && (var_1_56 ? (var_1_26 == ((signed long int) last_1_var_1_26)) : (var_1_26 == ((signed long int) (var_1_13 - (abs (var_1_50))))))) && (((last_1_var_1_24 & last_1_var_1_51) != (min (var_1_8 , 64u))) ? ((! last_1_var_1_56) ? (var_1_27 == ((unsigned char) var_1_13)) : (var_1_27 == ((unsigned char) (min (var_1_19 , (max (var_1_13 , 50))))))) : 1)) && ((((var_1_21 < 49.5) || var_1_56) || ((max (var_1_20 , var_1_22)) >= 1.0000000002E9)) ? ((128 >= (var_1_19 - var_1_34)) ? (var_1_28 == ((double) (min (var_1_21 , var_1_22)))) : (var_1_28 == ((double) (var_1_22 + var_1_21)))) : 1)) && (((var_1_10 <= 32u) || (var_1_45 || var_1_45)) ? ((var_1_55 >= var_1_19) ? (var_1_29 == ((signed char) var_1_19)) : (var_1_29 == ((signed char) var_1_17))) : (var_1_29 == ((signed char) var_1_17)))) && (((var_1_19 * (var_1_16 & var_1_8)) >= ((var_1_10 + var_1_32) - var_1_27)) ? (var_1_56 ? (var_1_31 == ((signed char) (32 - var_1_5))) : (((var_1_33 - var_1_19) > var_1_5) ? (var_1_31 == ((signed char) (min (var_1_5 , -64)))) : (var_1_31 == ((signed char) (2 - var_1_13))))) : ((var_1_1 <= ((var_1_10 + var_1_50) * (var_1_23 + var_1_27))) ? ((var_1_27 > (var_1_58 * var_1_50)) ? (var_1_31 == ((signed char) (var_1_5 - var_1_18))) : 1) : 1))) && ((last_1_var_1_34 <= var_1_10) ? (last_1_var_1_45 ? (var_1_34 == ((signed short int) var_1_5)) : (var_1_34 == ((signed short int) ((var_1_35 - var_1_5) - var_1_19)))) : (var_1_34 == ((signed short int) ((8 - var_1_18) + last_1_var_1_55))))) && ((((var_1_33 + var_1_27) - (1325268161 - var_1_51)) != var_1_51) ? (var_1_36 == ((float) (abs (min ((var_1_21 + var_1_22) , 1.75f))))) : (var_1_56 ? (var_1_36 == ((float) ((var_1_38 - var_1_39) - (var_1_40 - var_1_41)))) : (var_1_36 == ((float) var_1_21))))) && (((var_1_14 >= var_1_9) || var_1_56) ? ((var_1_38 > var_1_20) ? (var_1_42 == ((signed long int) ((var_1_27 + var_1_35) + var_1_26))) : (var_1_42 == ((signed long int) (min ((var_1_27 + var_1_33) , var_1_58))))) : 1)) && ((var_1_13 < (min (var_1_17 , last_1_var_1_27))) ? ((last_1_var_1_51 > (var_1_8 - var_1_19)) ? (var_1_45 == ((unsigned char) (var_1_47 || (last_1_var_1_45 && var_1_48)))) : ((10 > var_1_32) ? (var_1_45 == ((unsigned char) (! (! var_1_48)))) : (var_1_45 == ((unsigned char) ((var_1_35 >= var_1_13) && (var_1_47 || (var_1_48 && var_1_49))))))) : (var_1_45 == ((unsigned char) (! (! var_1_48)))))) && (var_1_50 == ((unsigned short int) (var_1_35 + 1)))) && ((var_1_11 < var_1_14) ? (var_1_51 == ((unsigned short int) (min ((min ((var_1_19 + var_1_35) , var_1_13)) , (var_1_58 + var_1_5))))) : 1)) && (var_1_52 == ((float) (max (var_1_39 , (var_1_40 - (abs (var_1_41)))))))) && ((var_1_8 < 16u) ? ((var_1_26 <= (var_1_31 >> var_1_23)) ? (var_1_53 == ((signed long int) (((var_1_14 + var_1_31) + var_1_26) + (var_1_29 + var_1_13)))) : (var_1_53 == ((signed long int) (var_1_5 - var_1_18)))) : (var_1_53 == ((signed long int) (max (var_1_34 , var_1_33)))))) && (var_1_45 ? (var_1_54 == ((double) var_1_40)) : 1)) && (((max (var_1_36 , var_1_39)) < (var_1_38 - var_1_41)) ? (var_1_55 == ((signed long int) var_1_34)) : (var_1_55 == ((signed long int) var_1_5)))) && (var_1_56 == ((unsigned char) var_1_57))) && ((last_1_var_1_23 <= (last_1_var_1_50 / var_1_10)) ? (((var_1_40 + (var_1_39 - var_1_41)) <= ((10.125f + last_1_var_1_20) / var_1_38)) ? (var_1_58 == ((signed long int) last_1_var_1_12)) : (var_1_58 == ((signed long int) var_1_11))) : (var_1_58 == ((signed long int) var_1_18)))
;
}
int main(void) {
	isInitial = 1;
