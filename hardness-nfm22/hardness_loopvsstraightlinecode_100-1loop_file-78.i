...
void step(void) {
 if (! last_1_var_1_25) {
  var_1_1 = (((((var_1_3) > (var_1_4)) ? (var_1_3) : (var_1_4))) - (5 + last_1_var_1_28));
 } else {
  var_1_1 = var_1_3;
 }
 ...
 if ((((((var_1_26) > (var_1_27)) ? (var_1_26) : (var_1_27))) - var_1_4) <= stepLocal_2) {
 ...
 if (stepLocal_4 >= ((((var_1_33) < ((- var_1_3))) ? (var_1_33) : ((- var_1_3))))) {
  if (var_1_25) {
   var_1_29 = var_1_17;
  }
 }
