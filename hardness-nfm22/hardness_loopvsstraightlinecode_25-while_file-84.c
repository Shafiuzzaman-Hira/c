...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch8425_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch8425_while
	var_1_13 = var_1_7;


	// From: Req5Batch8425_while
	var_1_14 = var_1_7;


	// From: Req1Batch8425_while
...
int property() {
	return (((((var_1_14 != var_1_14) ? (var_1_1 == ((unsigned char) (var_1_4 + (max ((min (var_1_5 , var_1_6)) , var_1_7))))) : (var_1_1 == ((unsigned char) (min ((min (var_1_4 , var_1_6)) , var_1_7))))) && ((var_1_5 > var_1_4) ? (var_1_8 == ((unsigned char) (128 - (max (10 , var_1_5))))) : 1)) && (((var_1_10 * var_1_11) > 16.75f) ? ((var_1_7 <= var_1_1) ? ((-8 > var_1_13) ? (var_1_9 == ((float) var_1_12)) : 1) : (var_1_9 == ((float) var_1_12))) : 1)) && (var_1_13 == ((signed long int) var_1_7))) && (var_1_14 == ((signed short int) var_1_7))
;
}
int main(void) {
	isInitial = 1;
