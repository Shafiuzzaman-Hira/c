...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch7125_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch7125_while
	var_1_12 = 100;


	// From: Req4Batch7125_while
	var_1_13 = var_1_3;


	// From: Req5Batch7125_while
	var_1_14 = var_1_3;


	// From: Req2Batch7125_while
	if ((var_1_13 >> var_1_3) <= var_1_5) {
		if ((25 > var_1_13) && var_1_7) {
			var_1_8 = (var_1_9 + (max (var_1_10 , var_1_11)));
		} else {
			var_1_8 = var_1_9;
		}
	} else {
...
int property() {
	return ((((var_1_2 ? (var_1_1 == ((unsigned char) (max ((max ((var_1_3 + var_1_4) , 50)) , var_1_5)))) : ((var_1_6 && var_1_7) ? (var_1_1 == ((unsigned char) var_1_5)) : (var_1_7 ? (var_1_1 == ((unsigned char) var_1_5)) : (var_1_1 == ((unsigned char) var_1_3))))) && (((var_1_13 >> var_1_3) <= var_1_5) ? (((25 > var_1_13) && var_1_7) ? (var_1_8 == ((float) (var_1_9 + (max (var_1_10 , var_1_11))))) : (var_1_8 == ((float) var_1_9))) : (var_1_8 == ((float) var_1_9)))) && (var_1_12 == ((unsigned short int) 100))) && (var_1_13 == ((unsigned char) var_1_3))) && (var_1_14 == ((unsigned short int) var_1_3))
;
}
int main(void) {
	isInitial = 1;
