...
void step(void) {
	...
	if (var_1_25 >= (max (var_1_26 , var_1_27))) {
		...
		var_1_24 = ((abs (var_1_25)) + (abs (var_1_27)));
	}


	// From: CodeObject2
	if (var_1_29) {
		var_1_28 = (min (((max (var_1_30 , var_1_31)) - var_1_32) , -64));
	} else {
		var_1_28 = (abs (var_1_32));
	}


	// From: CodeObject3
	if ((~ var_1_30) <= ((max (var_1_27 , -16)) & 16)) {
		var_1_33 = var_1_34;
	} else {
		if (var_1_25 <= ((min (var_1_35 , var_1_36)) - var_1_32)) {
			var_1_33 = var_1_34;
		} else {
			var_1_33 = var_1_34;
		}
	...
	if (var_1_28 >= var_1_31) {
		...
		var_1_37 = ((min (var_1_32 , var_1_26)) + var_1_35);
	}
	...
	if (var_1_39 > var_1_36) {
		var_1_42 = ((var_1_43 - (var_1_44 + var_1_45)) + (abs (var_1_32)));
	}


	// From: CodeObject8
	if (var_1_32 <= (var_1_30 - (max (var_1_43 , var_1_44)))) {
		var_1_46 = var_1_47;
	} else {
	...
	// From: CodeObject10
	if ((abs (var_1_43)) <= var_1_26) {
		var_1_50 = (abs (max (var_1_51 , var_1_52)));
	} else {
		if (var_1_25 <= (var_1_26 * 32)) {
			if ((8 - var_1_53) < var_1_37) {
				if ((var_1_26 > (var_1_35 % var_1_43)) && var_1_29) {
					var_1_50 = (abs (abs (var_1_52)));
				}
			}
		} else {
			var_1_50 = (max (var_1_52 , var_1_51));
		}
	}
