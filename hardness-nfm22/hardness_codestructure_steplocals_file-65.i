...
void step(void) {
 ...
 if (var_1_1 < stepLocal_3) {
  if ((! (var_1_10 || var_1_9)) && stepLocal_2) {
   if (((((2.75f) > (((((var_1_17) < (999999.95f)) ? (var_1_17) : (999999.95f))))) ? (2.75f) : (((((var_1_17) < (999999.95f)) ? (var_1_17) : (999999.95f)))))) != var_1_18) {
    var_1_16 = 10;
   } else {
    var_1_16 = var_1_19;
   }
 ...
 if ((((((var_1_3) > (var_1_5)) ? (var_1_3) : (var_1_5))) | var_1_6) >= var_1_8) {
  var_1_23 = (5 - var_1_12);
 } else {
  var_1_23 = ((((var_1_11) > (var_1_16)) ? (var_1_11) : (var_1_16)));
 }
