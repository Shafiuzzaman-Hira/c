...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch96Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_21 <= var_1_9) {
  var_1_44 = (var_1_21 + (((((((var_1_21) > (-1)) ? (var_1_21) : (-1))) < 0 ) ? -((((var_1_21) > (-1)) ? (var_1_21) : (-1))) : ((((var_1_21) > (-1)) ? (var_1_21) : (-1))))));
 }
 var_1_50 = var_1_30;
 var_1_17 = (((((var_1_18) < (var_1_19)) ? (var_1_18) : (var_1_19))) - (var_1_20 + (var_1_21 - var_1_22)));
 if ((var_1_13 <= var_1_12) || var_1_25) {
  if (((((5) < 0 ) ? -(5) : (5))) < var_1_13) {
   if (var_1_25) {
    var_1_32 = ((((((((var_1_21) < (var_1_20)) ? (var_1_21) : (var_1_20)))) > (var_1_20)) ? (((((var_1_21) < (var_1_20)) ? (var_1_21) : (var_1_20)))) : (var_1_20)));
   }
  }
 }
 var_1_53 = var_1_22;
 ...
 if (((~ var_1_21) >> ((((var_1_22) > (var_1_22)) ? (var_1_22) : (var_1_22)))) >= var_1_12) {
 ...
 if ((~ var_1_18) > var_1_13) {
  var_1_52 = ((((((var_1_22 + var_1_9) - ((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10))))) < (var_1_23)) ? (((var_1_22 + var_1_9) - ((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10))))) : (var_1_23)));
 } else {
  var_1_52 = ((((var_1_10) < (var_1_21)) ? (var_1_10) : (var_1_21)));
 }
 ...
 if (((((4) < 0 ) ? -(4) : (4))) >= var_1_21) {
  if ((((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8))) % ((((var_1_21) < (var_1_21)) ? (var_1_21) : (var_1_21)))) <= (var_1_23 ^ var_1_21)) {
   if (((((((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8)))) < (var_1_21)) ? (((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8)))) : (var_1_21))) < var_1_21) {
    var_1_40 = var_1_43;
   } else {
    var_1_40 = var_1_43;
   }
