...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch82PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch82PS_CN_10
	var_1_23 = last_1_var_1_14;


	// From: Req2Batch82PS_CN_10
	var_1_7 = (var_1_4 - (var_1_8 + var_1_9));


	// From: Req5Batch82PS_CN_10
	...
	// From: Req3Batch82PS_CN_10
	var_1_10 = (var_1_11 && (var_1_21 || var_1_13));


	// From: Req4Batch82PS_CN_10
