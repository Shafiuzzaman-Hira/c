...
void step(void) {
	...
	// From: Req3Batch74Amount100
	if (! var_1_28) {
		var_1_9 = (min (var_1_10 , var_1_11));
	}


	// From: Req5Batch74Amount100
	if (var_1_22) {
	...
	// From: Req6Batch74Amount100
	var_1_19 = (var_1_20 - var_1_21);


	// From: Req11Batch74Amount100
	...
	// From: Req8Batch74Amount100
	var_1_26 = ((var_1_27 - var_1_34) + var_1_10);


	// From: Req10Batch74Amount100
