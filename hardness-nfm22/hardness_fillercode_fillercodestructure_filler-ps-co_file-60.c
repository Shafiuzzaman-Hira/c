...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch60Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
	// From: CodeObject1
	if (var_1_9 <= (var_1_1 + var_1_9)) {
		if (var_1_1 < var_1_9) {
			var_1_23 = ((var_1_1 <= (~ var_1_1)) || var_1_29);
		} else {
			var_1_23 = var_1_30;
		}
	}
	...
	// From: CodeObject2
	if (var_1_9 != var_1_1) {
		var_1_31 = (((max (var_1_1 , var_1_9)) + var_1_9) - var_1_9);
	}
