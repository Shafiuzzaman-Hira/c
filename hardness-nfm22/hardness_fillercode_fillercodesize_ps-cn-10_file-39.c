...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch39PS_CN_10.c", 13, "reach_error"); }
...
unsigned short int var_1_37 = 62575;
...
void step(void) {
	...
	// From: CodeObject6
	if (((var_1_36 + var_1_28) * (var_1_37 - var_1_33)) != var_1_30) {
		var_1_35 = 0;
	}


	// From: Req1Batch39PS_CN_10
	...
	// From: Req7Batch39PS_CN_10
	var_1_24 = var_1_25;


	// From: Req8Batch39PS_CN_10
	var_1_26 = var_1_8;


	// From: Req3Batch39PS_CN_10
	var_1_10 = (min ((abs (var_1_11 - var_1_8)) , (max (0u , var_1_26))));


	// From: Req4Batch39PS_CN_10
