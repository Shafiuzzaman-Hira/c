...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch88PS_CN_500.c", 13, "reach_error"); }
...
signed long int var_1_102 = -2;
unsigned char var_1_103 = 1;
unsigned char var_1_104 = 50;
signed long int var_1_105 = 4;
unsigned short int var_1_106 = 4;
unsigned short int var_1_107 = 43289;
unsigned short int var_1_108 = 10;
unsigned long int var_1_109 = 50;
float var_1_110 = 128.4;
float var_1_111 = 25.6;
signed short int var_1_112 = 2;
unsigned char var_1_113 = 0;
float var_1_114 = 10.5;
double var_1_115 = 1.3;
double var_1_116 = 0.0;
double var_1_117 = 10.625;
double var_1_118 = 16.2;
double var_1_119 = 255.5;
double var_1_120 = 25.6;
unsigned char var_1_121 = 5;
double var_1_122 = 0.0;
double var_1_123 = 256.5;
unsigned char var_1_124 = 2;
unsigned long int var_1_125 = 256;
float var_1_126 = 3.5;
signed short int var_1_127 = 64;
double var_1_128 = 32.8;
signed char var_1_129 = 64;
signed char var_1_130 = 32;
signed short int var_1_131 = -5;
unsigned short int var_1_132 = 256;
...
void step(void) {
 if (var_1_29 && var_1_30) {
  if ((256 % var_1_31) >= ((((var_1_28) < (var_1_26)) ? (var_1_28) : (var_1_26)))) {
   if (var_1_27 <= (var_1_32 - (var_1_33 + var_1_34))) {
    var_1_25 = ((((var_1_33) < (((var_1_34 + var_1_35) + ((((var_1_36) < (var_1_37)) ? (var_1_36) : (var_1_37)))))) ? (var_1_33) : (((var_1_34 + var_1_35) + ((((var_1_36) < (var_1_37)) ? (var_1_36) : (var_1_37)))))));
   } else {
    if (-100 >= var_1_26) {
     var_1_25 = (((var_1_38 - 64u) + var_1_33) + (((((var_1_39 - 5u)) < (var_1_34)) ? ((var_1_39 - 5u)) : (var_1_34))));
    } else {
     if (var_1_36 <= var_1_39) {
      var_1_25 = (((((var_1_36) > ((var_1_35 + var_1_33))) ? (var_1_36) : ((var_1_35 + var_1_33)))) + (var_1_39 - var_1_34));
     } else {
      if (-8 != var_1_35) {
       var_1_25 = ((((var_1_34 + (var_1_39 - var_1_35)) < 0 ) ? -(var_1_34 + (var_1_39 - var_1_35)) : (var_1_34 + (var_1_39 - var_1_35))));
      }
     }
    }
   }
 ...
 if ((((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) - ((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32)))) <= var_1_36) {
  var_1_40 = ((((((((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))) < 0 ) ? -((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))) : ((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))))) < 0 ) ? -(((((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))) < 0 ) ? -((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))) : ((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))))) : (((((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))) < 0 ) ? -((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))) : ((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41)))))));
 } else {
  if (! var_1_30) {
   var_1_40 = (((((var_1_42 - 4)) < (var_1_33)) ? ((var_1_42 - 4)) : (var_1_33)));
  }
 }
 if ((~ var_1_40) != var_1_35) {
  var_1_43 = (((((((4u) < (var_1_35)) ? (4u) : (var_1_35))) < 0 ) ? -((((4u) < (var_1_35)) ? (4u) : (var_1_35))) : ((((4u) < (var_1_35)) ? (4u) : (var_1_35)))));
 } else {
 ...
 if (var_1_44 > ((((var_1_45) < 0 ) ? -(var_1_45) : (var_1_45)))) {
  var_1_47 = (var_1_29 && var_1_48);
 }
 if (var_1_50) {
  if (var_1_35 <= ((4u & var_1_40) / var_1_42)) {
   var_1_49 = (((((((((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51)))) > (var_1_52)) ? (((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51)))) : (var_1_52))) < 0 ) ? -((((((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51)))) > (var_1_52)) ? (((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51)))) : (var_1_52))) : ((((((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51)))) > (var_1_52)) ? (((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51)))) : (var_1_52)))));
  }
 }
 if (var_1_34 > var_1_31) {
  if (var_1_50) {
   var_1_53 = (((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))) + ((((var_1_42) < 0 ) ? -(var_1_42) : (var_1_42))));
  } else {
 ...
 if ((var_1_32 >= var_1_31) || (var_1_33 <= var_1_39)) {
  ...
  var_1_54 = (((((((var_1_51) < ((var_1_55 - var_1_56))) ? (var_1_51) : ((var_1_55 - var_1_56)))) < 0 ) ? -((((var_1_51) < ((var_1_55 - var_1_56))) ? (var_1_51) : ((var_1_55 - var_1_56)))) : ((((var_1_51) < ((var_1_55 - var_1_56))) ? (var_1_51) : ((var_1_55 - var_1_56))))));
 }
 if (var_1_45 > (((((1.5) < (var_1_52)) ? (1.5) : (var_1_52))) + 128.23)) {
 ...
 if (var_1_38 > (- (var_1_39 | var_1_61))) {
  if (var_1_54 >= var_1_45) {
   var_1_60 = ((((var_1_34) < (var_1_41)) ? (var_1_34) : (var_1_41)));
  } else {
 ...
 if (var_1_63 >= var_1_49) {
  if (var_1_46 > var_1_45) {
   ...
   if (128.6 < var_1_44) {
    var_1_62 = ((((var_1_34) < (var_1_33)) ? (var_1_34) : (var_1_33)));
   } else {
    var_1_62 = (((((((((((var_1_34) > (var_1_33)) ? (var_1_34) : (var_1_33))) < 0 ) ? -((((var_1_34) > (var_1_33)) ? (var_1_34) : (var_1_33))) : ((((var_1_34) > (var_1_33)) ? (var_1_34) : (var_1_33)))))) < (var_1_64)) ? ((((((((var_1_34) > (var_1_33)) ? (var_1_34) : (var_1_33))) < 0 ) ? -((((var_1_34) > (var_1_33)) ? (var_1_34) : (var_1_33))) : ((((var_1_34) > (var_1_33)) ? (var_1_34) : (var_1_33)))))) : (var_1_64)));
   }
  }
 }
 if (((((var_1_45) > (7.25)) ? (var_1_45) : (7.25))) > ((((var_1_58) < (var_1_57)) ? (var_1_58) : (var_1_57)))) {
  if (((var_1_34 >> var_1_64) ^ var_1_39) >= ((((25u >> var_1_27) < 0 ) ? -(25u >> var_1_27) : (25u >> var_1_27)))) {
   var_1_65 = ((((var_1_41) > (((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))))) ? (var_1_41) : (((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))))));
  }
 }
 if (! ((10 ^ var_1_34) > var_1_40)) {
  if (! (! var_1_50)) {
   if (var_1_51 <= var_1_49) {
    var_1_66 = ((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40)));
   }
  } else {
   if (var_1_44 >= ((((9.5) > (0.0)) ? (9.5) : (0.0)))) {
    var_1_66 = (var_1_67 - ((((var_1_34) > (16u)) ? (var_1_34) : (16u))));
   } else {
    var_1_66 = ((((var_1_38) < 0 ) ? -(var_1_38) : (var_1_38)));
   }
  }
 }
 if (var_1_38 <= ((((var_1_39) < (var_1_61)) ? (var_1_39) : (var_1_61)))) {
  if ((((((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))) < 0 ) ? -((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))) : ((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))))) != var_1_32) {
   var_1_68 = ((((var_1_33) > (var_1_41)) ? (var_1_33) : (var_1_41)));
  } else {
   if ((- var_1_45) <= var_1_52) {
    var_1_68 = (((((var_1_69) > (var_1_42)) ? (var_1_69) : (var_1_42))) - var_1_33);
   }
  }
 }
 if (var_1_50) {
  var_1_70 = ((((var_1_42) < (var_1_68)) ? (var_1_42) : (var_1_68)));
 }
 if ((var_1_31 % var_1_67) > ((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25)))) {
  var_1_71 = ((((var_1_72) > (((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36))))) ? (var_1_72) : (((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36))))));
 }
 if (4.5 == var_1_44) {
  if (var_1_65 >= var_1_66) {
   var_1_73 = ((((var_1_58) < 0 ) ? -(var_1_58) : (var_1_58)));
  }
 }
 ...
 if (var_1_80 < var_1_81) {
  if (var_1_45 <= ((((var_1_58) > (var_1_63)) ? (var_1_58) : (var_1_63)))) {
   if (var_1_54 > (var_1_57 * var_1_56)) {
    var_1_79 = (((((var_1_55) < (var_1_58)) ? (var_1_55) : (var_1_58))) - 256.4);
   }
  }
 } else {
  var_1_79 = ((((var_1_58) < (((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51))))) ? (var_1_58) : (((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51))))));
 }
 if ((var_1_66 == var_1_69) || var_1_74) {
  var_1_82 = ((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51)));
 }
 if ((~ var_1_84) < (var_1_66 * ((((var_1_39) < (var_1_38)) ? (var_1_39) : (var_1_38))))) {
  if (var_1_85 <= var_1_62) {
   if (var_1_31 >= (var_1_28 >> 5)) {
    var_1_83 = (((((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))) < 0 ) ? -((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))) : ((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41)))));
   } else {
    if (((((((((var_1_70) < 0 ) ? -(var_1_70) : (var_1_70)))) > (var_1_62)) ? (((((var_1_70) < 0 ) ? -(var_1_70) : (var_1_70)))) : (var_1_62))) < var_1_60) {
     var_1_83 = ((((((((var_1_34) > (var_1_33)) ? (var_1_34) : (var_1_33))) + var_1_86) < 0 ) ? -(((((var_1_34) > (var_1_33)) ? (var_1_34) : (var_1_33))) + var_1_86) : (((((var_1_34) > (var_1_33)) ? (var_1_34) : (var_1_33))) + var_1_86)));
    } else {
     var_1_83 = (var_1_33 + 16);
    }
   }
  }
 } else {
  var_1_83 = (((((var_1_33 + var_1_34)) > (var_1_69)) ? ((var_1_33 + var_1_34)) : (var_1_69)));
 }
 if (var_1_65 == var_1_42) {
  var_1_87 = var_1_40;
 } else {
  var_1_87 = (((((var_1_88) < 0 ) ? -(var_1_88) : (var_1_88))) - var_1_40);
 }
 if (((((var_1_81) < (((((var_1_44) < 0 ) ? -(var_1_44) : (var_1_44))))) ? (var_1_81) : (((((var_1_44) < 0 ) ? -(var_1_44) : (var_1_44)))))) < (((((var_1_82) > (var_1_54)) ? (var_1_82) : (var_1_54))) * var_1_55)) {
  if (((var_1_90 - var_1_33) - ((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32)))) > var_1_27) {
   var_1_89 = (((((((var_1_58) < 0 ) ? -(var_1_58) : (var_1_58))) < 0 ) ? -((((var_1_58) < 0 ) ? -(var_1_58) : (var_1_58))) : ((((var_1_58) < 0 ) ? -(var_1_58) : (var_1_58)))));
  }
 }
 if (((((var_1_84) < 0 ) ? -(var_1_84) : (var_1_84))) > var_1_39) {
  var_1_91 = ((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35)));
 }
 if ((var_1_68 >= ((((var_1_83) < (var_1_71)) ? (var_1_83) : (var_1_71)))) && (var_1_65 < var_1_28)) {
  if (-8 <= (-5 >> var_1_72)) {
   if (var_1_81 >= (((((((var_1_54) < 0 ) ? -(var_1_54) : (var_1_54))) < 0 ) ? -((((var_1_54) < 0 ) ? -(var_1_54) : (var_1_54))) : ((((var_1_54) < 0 ) ? -(var_1_54) : (var_1_54)))))) {
    var_1_92 = ((((((((var_1_86) < 0 ) ? -(var_1_86) : (var_1_86)))) > (var_1_90)) ? (((((var_1_86) < 0 ) ? -(var_1_86) : (var_1_86)))) : (var_1_90)));
   }
  } else {
   var_1_92 = ((((var_1_42) < 0 ) ? -(var_1_42) : (var_1_42)));
  }
 } else {
  if ((var_1_70 + var_1_60) >= (var_1_37 + var_1_65)) {
   var_1_92 = (var_1_69 - 2);
  }
 }
 var_1_93 = var_1_56;
 ...
 if ((~ var_1_60) > var_1_59) {
  var_1_104 = (var_1_34 + var_1_33);
 } else {
  var_1_104 = var_1_90;
 }
 if (var_1_32 < var_1_65) {
  if ((var_1_66 + (var_1_87 | var_1_40)) <= ((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36)))) {
   var_1_105 = (((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))) - var_1_70);
  } else {
   var_1_105 = ((((-16) < (((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))))) ? (-16) : (((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))))));
  }
 }
 if (var_1_30) {
  var_1_106 = (((((var_1_88) < (var_1_107)) ? (var_1_88) : (var_1_107))) - ((((var_1_104) < 0 ) ? -(var_1_104) : (var_1_104))));
 }
 if ((var_1_38 & var_1_96) >= var_1_43) {
  var_1_108 = ((((var_1_88) > (((((var_1_107 - var_1_83) < 0 ) ? -(var_1_107 - var_1_83) : (var_1_107 - var_1_83))))) ? (var_1_88) : (((((var_1_107 - var_1_83) < 0 ) ? -(var_1_107 - var_1_83) : (var_1_107 - var_1_83))))));
 }
 if (var_1_76) {
  var_1_109 = (var_1_67 - var_1_87);
 }
 if (((99999.3f + var_1_54) * var_1_82) < var_1_55) {
  if (var_1_77) {
   var_1_110 = (var_1_58 + var_1_111);
  } else {
   var_1_110 = ((((var_1_52) < (var_1_51)) ? (var_1_52) : (var_1_51)));
  }
 } else {
  if (var_1_76 || (var_1_65 < (var_1_70 / var_1_88))) {
   var_1_110 = ((((var_1_55) > (((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52))))) ? (var_1_55) : (((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52))))));
  }
 }
 if ((var_1_92 * var_1_102) > var_1_107) {
  if (((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))) >= var_1_105) {
   var_1_112 = ((((var_1_26) < (var_1_69)) ? (var_1_26) : (var_1_69)));
  }
 } else {
  var_1_112 = (((((var_1_96 - var_1_92) < 0 ) ? -(var_1_96 - var_1_92) : (var_1_96 - var_1_92))) - ((((var_1_42) > (var_1_104)) ? (var_1_42) : (var_1_104))));
 }
 if ((var_1_110 > var_1_111) || var_1_29) {
  if (var_1_90 <= var_1_97) {
   var_1_113 = (var_1_76 && (var_1_77 && var_1_75));
  }
 }
 if (var_1_57 < (((((var_1_89) < 0 ) ? -(var_1_89) : (var_1_89))) * (var_1_63 / 127.5f))) {
  var_1_114 = ((((1.5f) < 0 ) ? -(1.5f) : (1.5f)));
 } else {
  var_1_114 = (((((var_1_111 + ((((var_1_58) < 0 ) ? -(var_1_58) : (var_1_58))))) < (var_1_51)) ? ((var_1_111 + ((((var_1_58) < 0 ) ? -(var_1_58) : (var_1_58))))) : (var_1_51)));
 }
 if (var_1_103) {
  if (var_1_94) {
   var_1_115 = (((((var_1_58 - (var_1_116 - var_1_117))) < ((var_1_111 + ((((var_1_118) < 0 ) ? -(var_1_118) : (var_1_118)))))) ? ((var_1_58 - (var_1_116 - var_1_117))) : ((var_1_111 + ((((var_1_118) < 0 ) ? -(var_1_118) : (var_1_118)))))));
  } else {
   var_1_115 = ((((var_1_119) < ((((((var_1_55 - var_1_116)) < (var_1_52)) ? ((var_1_55 - var_1_116)) : (var_1_52))))) ? (var_1_119) : ((((((var_1_55 - var_1_116)) < (var_1_52)) ? ((var_1_55 - var_1_116)) : (var_1_52))))));
  }
 }
 if ((var_1_38 % (var_1_90 + var_1_121)) < var_1_36) {
  var_1_120 = (((((((((var_1_117) < 0 ) ? -(var_1_117) : (var_1_117)))) > (5.2)) ? (((((var_1_117) < 0 ) ? -(var_1_117) : (var_1_117)))) : (5.2))) + ((var_1_122 - var_1_123) - ((((var_1_118) < 0 ) ? -(var_1_118) : (var_1_118)))));
 }
 if ((- var_1_43) >= ((var_1_87 & var_1_106) & var_1_42)) {
  var_1_124 = ((((((((var_1_86) < 0 ) ? -(var_1_86) : (var_1_86)))) > (((((var_1_90) < (var_1_34)) ? (var_1_90) : (var_1_34))))) ? (((((var_1_86) < 0 ) ? -(var_1_86) : (var_1_86)))) : (((((var_1_90) < (var_1_34)) ? (var_1_90) : (var_1_34))))));
 }
 if (var_1_63 <= var_1_116) {
  if (var_1_32 >= (var_1_28 * ((((-4) > (100)) ? (-4) : (100))))) {
   var_1_125 = var_1_33;
  } else {
   if (-0.5 >= ((((var_1_79) < 0 ) ? -(var_1_79) : (var_1_79)))) {
    var_1_125 = ((((var_1_121) < 0 ) ? -(var_1_121) : (var_1_121)));
   }
  }
 }
 if (((((var_1_98) > (var_1_112)) ? (var_1_98) : (var_1_112))) < var_1_108) {
  var_1_126 = (((((var_1_117) > (((((var_1_116) < 0 ) ? -(var_1_116) : (var_1_116))))) ? (var_1_117) : (((((var_1_116) < 0 ) ? -(var_1_116) : (var_1_116)))))) - ((((var_1_58) < (((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52))))) ? (var_1_58) : (((((var_1_52) < 0 ) ? -(var_1_52) : (var_1_52)))))));
 } else {
  var_1_126 = (((((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51))) < 0 ) ? -((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51))) : ((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51)))));
 }
 if (var_1_101) {
  if (var_1_69 > ((((16) < 0 ) ? -(16) : (16)))) {
   if (var_1_77) {
    var_1_127 = ((((((((var_1_34) < (var_1_32)) ? (var_1_34) : (var_1_32)))) < (var_1_42)) ? (((((var_1_34) < (var_1_32)) ? (var_1_34) : (var_1_32)))) : (var_1_42)));
   }
  }
 }
 if (var_1_76) {
 ...
 var_1_131 = var_1_32;
 if (((((var_1_112) < 0 ) ? -(var_1_112) : (var_1_112))) > (((((var_1_39 - var_1_68)) > (-10)) ? ((var_1_39 - var_1_68)) : (-10)))) {
  var_1_132 = ((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41)));
 } else {
  if (var_1_125 <= 32u) {
   var_1_132 = var_1_34;
  } else {
...
void updateVariables() {
 ...
 assume_abort_if_not((var_1_116 >= 4611686.018427382800e+12F && var_1_116 <= -1.0e-20F) || (var_1_116 <= 9223372.036854765600e+12F && var_1_116 >= 1.0e-20F ));
 ...
 assume_abort_if_not((var_1_119 >= -922337.2036854765600e+13F && var_1_119 <= -1.0e-20F) || (var_1_119 <= 9223372.036854765600e+12F && var_1_119 >= 1.0e-20F ));
 var_1_121 = __VERIFIER_nondet_uchar();
 assume_abort_if_not(var_1_121 >= 1);
 assume_abort_if_not(var_1_121 <= 127);
 ...
 var_1_130 = __VERIFIER_nondet_char();
 assume_abort_if_not(var_1_130 >= -127);
 assume_abort_if_not(var_1_130 <= 126);
}
