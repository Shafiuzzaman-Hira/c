...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch24Amount100.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_16) {
  var_1_28 = ((((var_1_7) > (24.8f)) ? (var_1_7) : (24.8f)));
 } else {
  var_1_28 = (((((((((var_1_6) < (var_1_5)) ? (var_1_6) : (var_1_5))) - (var_1_29 - var_1_30))) < (var_1_7)) ? ((((((var_1_6) < (var_1_5)) ? (var_1_6) : (var_1_5))) - (var_1_29 - var_1_30))) : (var_1_7)));
 }
 if (var_1_16) {
 ...
 var_1_21 = ((((((((var_1_22) > (var_1_23)) ? (var_1_22) : (var_1_23))) < 0 ) ? -((((var_1_22) > (var_1_23)) ? (var_1_22) : (var_1_23))) : ((((var_1_22) > (var_1_23)) ? (var_1_22) : (var_1_23))))) + (((((var_1_24) > (var_1_25)) ? (var_1_24) : (var_1_25))) - var_1_26));
 if (var_1_10 <= var_1_21) {
  var_1_31 = ((var_1_32 + var_1_33) + ((((var_1_7) > (var_1_30)) ? (var_1_7) : (var_1_30))));
 } else {
  if (var_1_10 >= (((((var_1_18 + var_1_26)) < (25)) ? ((var_1_18 + var_1_26)) : (25)))) {
   var_1_31 = (var_1_32 + ((((((((var_1_33) < (var_1_30)) ? (var_1_33) : (var_1_30)))) < (var_1_7)) ? (((((var_1_33) < (var_1_30)) ? (var_1_33) : (var_1_30)))) : (var_1_7))));
  } else {
   var_1_31 = (32.5f - (64.4f + var_1_30));
  }
 }
 if ((- 3.75) < var_1_29) {
  var_1_34 = (((((((var_1_30 - var_1_29) < 0 ) ? -(var_1_30 - var_1_29) : (var_1_30 - var_1_29))) < 0 ) ? -((((var_1_30 - var_1_29) < 0 ) ? -(var_1_30 - var_1_29) : (var_1_30 - var_1_29))) : ((((var_1_30 - var_1_29) < 0 ) ? -(var_1_30 - var_1_29) : (var_1_30 - var_1_29)))));
 } else {
  var_1_34 = ((((var_1_30) < (8.75f)) ? (var_1_30) : (8.75f)));
 }
 ...
 if (var_1_10 > var_1_27) {
  if ((var_1_19 << 1) > (var_1_10 - (var_1_27 + var_1_27))) {
   var_1_20 = (((((((var_1_18) < (2u)) ? (var_1_18) : (2u))) < 0 ) ? -((((var_1_18) < (2u)) ? (var_1_18) : (2u))) : ((((var_1_18) < (2u)) ? (var_1_18) : (2u)))));
  } else {
   var_1_20 = ((((var_1_18) > (var_1_19)) ? (var_1_18) : (var_1_19)));
  }
 } else {
  var_1_20 = var_1_19;
 }
 ...
 if (var_1_5 >= var_1_6) {
  if (stepLocal_1 < var_1_20) {
   var_1_8 = (((((var_1_20 + ((((var_1_27) > (var_1_10)) ? (var_1_27) : (var_1_10))))) > (1u)) ? ((var_1_20 + ((((var_1_27) > (var_1_10)) ? (var_1_27) : (var_1_10))))) : (1u)));
  } else {
   var_1_8 = var_1_10;
  }
 } else {
