...
void step(void) {
	...
	if (last_1_unsigned_short_int_Array_0_0__0_ <= (last_1_unsigned_short_int_Array_0_0__0_ * last_1_unsigned_short_int_Array_0_1__2_)) {
		unsigned_short_int_Array_0[1][2] = (max (unsigned_short_int_Array_0[0][2] , (max ((unsigned_short_int_Array_0[1][1] - unsigned_short_int_Array_0[0][1]) , unsigned_short_int_Array_0[1][0]))));
	}


	// From: Req2Batch2Wrapper_A
	if (BOOL_unsigned_char_Array_0[0] || (unsigned_short_int_Array_0[1][1] == unsigned_short_int_Array_0[1][0])) {
		if (unsigned_short_int_Array_0[1][1] <= ((min (0 , unsigned_short_int_Array_0[1][2])) << unsigned_short_int_Array_0[1][2])) {
	...
	if (unsigned_short_int_Array_0[0][1] != unsigned_short_int_Array_0[1][1]) {
		if (unsigned_short_int_Array_0[0][1] <= unsigned_short_int_Array_0[0][0]) {
			float_Array_0[2] = (max (float_Array_0[0] , float_Array_0[1]));
		} else {
...
int property() {
	return (((last_1_unsigned_short_int_Array_0_0__0_ <= (last_1_unsigned_short_int_Array_0_0__0_ * last_1_unsigned_short_int_Array_0_1__2_)) ? (unsigned_short_int_Array_0[1][2] == ((unsigned short int) (max (unsigned_short_int_Array_0[0][2] , (max ((unsigned_short_int_Array_0[1][1] - unsigned_short_int_Array_0[0][1]) , unsigned_short_int_Array_0[1][0])))))) : 1) && ((BOOL_unsigned_char_Array_0[0] || (unsigned_short_int_Array_0[1][1] == unsigned_short_int_Array_0[1][0])) ? ((unsigned_short_int_Array_0[1][1] <= ((min (0 , unsigned_short_int_Array_0[1][2])) << unsigned_short_int_Array_0[1][2])) ? ((BOOL_unsigned_char_Array_0[0] && (unsigned_short_int_Array_0[1][2] == (unsigned_short_int_Array_0[1][1] * unsigned_short_int_Array_0[0][2]))) ? (unsigned_short_int_Array_0[0][0] == ((unsigned short int) unsigned_short_int_Array_0[0][2])) : (unsigned_short_int_Array_0[0][0] == ((unsigned short int) unsigned_short_int_Array_0[0][2]))) : (unsigned_short_int_Array_0[0][0] == ((unsigned short int) 2))) : (unsigned_short_int_Array_0[0][0] == ((unsigned short int) unsigned_short_int_Array_0[1][1])))) && ((unsigned_short_int_Array_0[0][1] != unsigned_short_int_Array_0[1][1]) ? ((unsigned_short_int_Array_0[0][1] <= unsigned_short_int_Array_0[0][0]) ? (float_Array_0[2] == ((float) (max (float_Array_0[0] , float_Array_0[1])))) : (float_Array_0[2] == ((float) float_Array_0[0]))) : (float_Array_0[2] == ((float) float_Array_0[0])))
;
}
int main(void) {
	isInitial = 1;
