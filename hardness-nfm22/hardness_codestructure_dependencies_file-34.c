...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch34dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req5Batch34dependencies
	if ((max (last_1_var_1_14 , (last_1_var_1_20 | var_1_9))) > var_1_13) {
	...
	// From: Req7Batch34dependencies
	if (var_1_15 > var_1_12) {
		var_1_18 = (! var_1_19);
	}


	// From: Req4Batch34dependencies
	if (var_1_18) {
		var_1_14 = var_1_12;
	} else {
		var_1_14 = 64;
	...
	// From: Req8Batch34dependencies
	var_1_20 = last_1_var_1_17;


	// From: Req6Batch34dependencies
	if (var_1_13 > var_1_1) {
		if (var_1_1 <= 32u) {
			if (var_1_20 <= last_1_var_1_17) {
				var_1_17 = var_1_16;
			} else {
				var_1_17 = -50;
			}
	...
	// From: Req2Batch34dependencies
	if (var_1_17 == var_1_20) {
		if ((var_1_20 + var_1_1) > (var_1_15 % var_1_9)) {
			var_1_7 = var_1_20;
		} else {
			var_1_7 = var_1_1;
		}
	...
	// From: Req3Batch34dependencies
	if (((- var_1_1) + var_1_20) >= var_1_9) {
