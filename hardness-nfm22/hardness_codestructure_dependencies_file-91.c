...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch91dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch91dependencies
	if (var_1_11 < 5) {
		var_1_17 = (max (var_1_18 , (var_1_19 - var_1_20)));
	}


	// From: Req7Batch91dependencies
	var_1_24 = var_1_25;


	// From: Req8Batch91dependencies
	var_1_26 = var_1_11;


	// From: Req3Batch91dependencies
	if ((- var_1_15) >= (var_1_1 * (var_1_15 % var_1_12))) {
		var_1_13 = var_1_26;
	}


	// From: Req6Batch91dependencies
	if (var_1_24) {
	...
	// From: Req2Batch91dependencies
	if (var_1_24) {
		var_1_9 = var_1_11;
	} else {
		if (var_1_15 <= (var_1_21 / var_1_12)) {
			var_1_9 = var_1_11;
		} else {
			var_1_9 = var_1_11;
		}
