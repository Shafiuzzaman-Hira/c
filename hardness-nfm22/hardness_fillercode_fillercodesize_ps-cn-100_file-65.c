...
void step(void) {
	...
	if (var_1_34) {
		...
		if ((min (var_1_36 , var_1_37)) < var_1_38) {
			var_1_33 = var_1_35;
		}
	}
	...
	if (var_1_29 != var_1_31) {
		if ((-5 | var_1_30) <= var_1_32) {
			var_1_41 = (max (var_1_39 , var_1_33));
		}
	}
	...
	if (var_1_34 && var_1_46) {
		var_1_45 = (max ((var_1_39 + var_1_40) , (abs (var_1_31))));
	} else {
		...
		if ((var_1_49 | var_1_39) > var_1_35) {
			...
			if (var_1_46) {
				if (var_1_42 >= var_1_44) {
					var_1_47 = ((var_1_50 + (min (1530535536u , var_1_51))) - (max ((var_1_52 - var_1_40) , (min (var_1_39 , 10u)))));
				}
			} else {
				var_1_47 = (abs (var_1_51));
			}
		}
	} else {
	...
	if (var_1_31 < var_1_35) {
		var_1_57 = (((abs (var_1_58)) + var_1_55) + var_1_56);
	} else {
	...
	// From: CodeObject11
	if (var_1_48) {
		var_1_59 = (abs (max (var_1_56 , var_1_54)));
	} else {
		var_1_59 = (min ((var_1_60 - var_1_55) , var_1_56));
	}


	// From: CodeObject12
	if (((abs (128)) - var_1_62) < var_1_49) {
		var_1_61 = var_1_43;
	}


	// From: Req4Batch65PS_CN_100
	...
	// From: Req5Batch65PS_CN_100
	var_1_20 = (var_1_21 - (var_1_22 + 1.5));


	// From: Req8Batch65PS_CN_100
	var_1_28 = var_1_21;


	// From: Req1Batch65PS_CN_100
	...
	// From: Req7Batch65PS_CN_100
	var_1_24 = ((var_1_1 <= (var_1_25 - var_1_26)) && var_1_27);


	// From: Req3Batch65PS_CN_100
