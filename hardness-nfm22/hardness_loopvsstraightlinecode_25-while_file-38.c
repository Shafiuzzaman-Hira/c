...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch3825_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch3825_while
	var_1_1 = ((max (var_1_2 , var_1_3)) - var_1_4);


	// From: Req2Batch3825_while
	...
	// From: Req3Batch3825_while
	var_1_7 = (var_1_8 + (var_1_9 + (var_1_10 + var_1_11)));


	// From: Req4Batch3825_while
	if (! var_1_13) {
