...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch31PS_CN_10.c", 13, "reach_error"); }
...
float var_1_23 = 99999999999999.2;
float var_1_24 = 49.125;
...
void step(void) {
	...
	// From: Req2Batch31PS_CN_10
	var_1_8 = (min ((var_1_5 + (64 - 16)) , 64));


	// From: Req4Batch31PS_CN_10
	...
	// From: Req6Batch31PS_CN_10
	var_1_17 = var_1_13;


	// From: Req7Batch31PS_CN_10
