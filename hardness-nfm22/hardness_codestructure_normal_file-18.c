...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch18normal.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch18normal
	if (var_1_7) {
		var_1_16 = var_1_8;
	} else {
		var_1_16 = (var_1_11 - (abs (var_1_10 - var_1_17)));
	}


	// From: Req5Batch18normal
	if (var_1_16 >= (var_1_10 + var_1_17)) {
		if (var_1_5 < 999.5f) {
			if (var_1_7) {
...
int property() {
	return (((((((var_1_2 / var_1_3) > ((var_1_4 - var_1_5) * var_1_6)) ? (var_1_7 ? (var_1_1 == ((signed char) var_1_8)) : (var_1_1 == ((signed char) var_1_9))) : (var_1_1 == ((signed char) var_1_8))) && ((var_1_9 < var_1_1) ? (((var_1_4 - var_1_5) > var_1_3) ? (var_1_10 == ((unsigned char) 8)) : 1) : (var_1_10 == ((unsigned char) var_1_11)))) && ((var_1_5 <= (var_1_6 / var_1_3)) ? (var_1_12 == ((float) (max (var_1_13 , (var_1_14 + var_1_15))))) : (var_1_12 == ((float) var_1_14)))) && (var_1_7 ? (var_1_16 == ((signed long int) var_1_8)) : (var_1_16 == ((signed long int) (var_1_11 - (abs (var_1_10 - var_1_17))))))) && ((var_1_16 >= (var_1_10 + var_1_17)) ? ((var_1_5 < 999.5f) ? (var_1_7 ? (var_1_18 == ((signed short int) (var_1_10 + var_1_1))) : (var_1_18 == ((signed short int) var_1_8))) : (var_1_18 == ((signed short int) var_1_9))) : (var_1_18 == ((signed short int) var_1_8)))) && ((! (var_1_10 > var_1_1)) ? (var_1_19 == ((double) (max (var_1_13 , (min ((0.05 + var_1_15) , var_1_14)))))) : ((var_1_1 > var_1_9) ? (var_1_19 == ((double) var_1_15)) : 1))
;
}
int main(void) {
	isInitial = 1;
