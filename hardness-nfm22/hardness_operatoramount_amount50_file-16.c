...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch16Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch16Amount50
	if (var_1_4 && ((abs (var_1_1)) > var_1_5)) {
		var_1_23 = var_1_6;
	}


	// From: Req3Batch16Amount50
	if (var_1_6 > 128) {
		var_1_9 = (var_1_8 - (var_1_10 - var_1_1));
	}


	// From: Req4Batch16Amount50
