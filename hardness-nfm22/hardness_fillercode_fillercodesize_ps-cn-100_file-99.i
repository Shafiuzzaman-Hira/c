...
void step(void) {
 ...
 if (var_1_38) {
  if (((((var_1_29) < (-32)) ? (var_1_29) : (-32))) <= var_1_34) {
   var_1_37 = ((((var_1_33) > (2)) ? (var_1_33) : (2)));
  }
 } else {
  var_1_37 = var_1_34;
 }
 ...
 if (var_1_37 > var_1_33) {
  if ((var_1_44 ^ var_1_30) > var_1_32) {
   if (((((((((-8) < 0 ) ? -(-8) : (-8)))) > (var_1_31)) ? (((((-8) < 0 ) ? -(-8) : (-8)))) : (var_1_31))) >= var_1_34) {
    var_1_43 = (((((var_1_34 + var_1_45) - var_1_46) < 0 ) ? -((var_1_34 + var_1_45) - var_1_46) : ((var_1_34 + var_1_45) - var_1_46)));
   } else {
    if ((~ var_1_32) >= var_1_45) {
     if (var_1_41) {
      var_1_43 = (var_1_33 + ((((((((-64) > (var_1_34)) ? (-64) : (var_1_34)))) > (var_1_36)) ? (((((-64) > (var_1_34)) ? (-64) : (var_1_34)))) : (var_1_36))));
     } else {
      var_1_43 = var_1_45;
     }
    }
 ...
 if ((((((var_1_52 + 8.25f)) < (((((var_1_53) < 0 ) ? -(var_1_53) : (var_1_53))))) ? ((var_1_52 + 8.25f)) : (((((var_1_53) < 0 ) ? -(var_1_53) : (var_1_53)))))) >= var_1_54) {
  if ((128 >> var_1_45) > var_1_33) {
   var_1_51 = ((((var_1_34) < (var_1_55)) ? (var_1_34) : (var_1_55)));
  } else {
