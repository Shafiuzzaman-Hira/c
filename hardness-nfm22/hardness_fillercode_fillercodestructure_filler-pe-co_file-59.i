...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch59Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_1 / var_1_26) < (var_1_13 | var_1_1)) {
  ...
  var_1_25 = ((((var_1_13) < (0)) ? (var_1_13) : (0)));
 }
 ...
 if (var_1_26 < ((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13)))) {
  if (((((var_1_8) > (var_1_8)) ? (var_1_8) : (var_1_8))) == ((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8)))) {
   if (-50 <= var_1_13) {
