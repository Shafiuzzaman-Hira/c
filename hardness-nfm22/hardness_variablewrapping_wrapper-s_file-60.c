...
void step(void) {
	...
	// From: Req4Batch60Wrapper_S
	WrapperStruct00.var_1_15 = 500.25;


	// From: Req5Batch60Wrapper_S
	if (WrapperStruct00.var_1_2 > last_1_WrapperStruct00_var_1_16) {
		if (WrapperStruct00.var_1_9) {
			if (WrapperStruct00.var_1_3 <= (min (last_1_WrapperStruct00_var_1_16 , WrapperStruct00.var_1_11))) {
