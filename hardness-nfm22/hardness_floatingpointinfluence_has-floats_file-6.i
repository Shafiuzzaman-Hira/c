...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch6has_floats.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_13 > var_1_6) {
  var_1_18 = (((((var_1_6) < (var_1_13)) ? (var_1_6) : (var_1_13))) - var_1_6);
 }
 if (last_1_var_1_14) {
  var_1_14 = (var_1_16 && var_1_17);
 }
 var_1_20 = ((((((((last_1_var_1_20) < 0 ) ? -(last_1_var_1_20) : (last_1_var_1_20)))) < ((var_1_21 - var_1_7))) ? (((((last_1_var_1_20) < 0 ) ? -(last_1_var_1_20) : (last_1_var_1_20)))) : ((var_1_21 - var_1_7))));
 unsigned long int stepLocal_1 = var_1_20;
 unsigned long int stepLocal_0 = var_1_20;
 if ((((((var_1_18) > (var_1_18)) ? (var_1_18) : (var_1_18))) / var_1_4) > stepLocal_1) {
