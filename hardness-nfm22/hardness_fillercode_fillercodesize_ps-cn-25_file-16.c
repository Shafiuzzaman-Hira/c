...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch16PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject5
	if ((var_1_32 + (var_1_25 >> var_1_24)) >= (var_1_28 % var_1_33)) {
		var_1_31 = (abs (abs (var_1_34)));
	} else {
		if ((var_1_24 ^ var_1_32) <= var_1_33) {
			if (var_1_27 >= (var_1_32 / (max (var_1_33 , var_1_35)))) {
				var_1_31 = (abs (var_1_34));
			}
		}
	}
	...
	if (var_1_24 >= var_1_33) {
		var_1_36 = (var_1_30 && var_1_37);
	}


	// From: Req1Batch16PS_CN_25
	...
	// From: Req8Batch16PS_CN_25
	if (var_1_4 && ((abs (var_1_1)) > var_1_5)) {
		var_1_23 = var_1_6;
	}


	// From: Req3Batch16PS_CN_25
	if (var_1_6 > 128) {
		var_1_9 = (var_1_8 - (var_1_10 - var_1_1));
	}


	// From: Req4Batch16PS_CN_25
