...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch93Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (((- last_1_WrapperStruct00_var_1_10) / (*(WrapperStruct00_var_1_3_Pointer))) != (last_1_WrapperStruct00_var_1_10 / (*(WrapperStruct00_var_1_5_Pointer)))) {
		if (last_1_WrapperStruct00_var_1_10 != ((max ((*(WrapperStruct00_var_1_6_Pointer)) , (*(WrapperStruct00_var_1_7_Pointer)))) - (*(WrapperStruct00_var_1_8_Pointer)))) {
	...
	if ((*(WrapperStruct00_var_1_1_Pointer)) > (max (((*(WrapperStruct00_var_1_9_Pointer)) * 128.4) , ((*(WrapperStruct00_var_1_5_Pointer)) * (*(WrapperStruct00_var_1_1_Pointer)))))) {
		(*(WrapperStruct00_var_1_10_Pointer)) = 1.00000000000004E13f;
	} else {
	...
	if (! ((*(WrapperStruct00_var_1_3_Pointer)) <= (*(WrapperStruct00_var_1_10_Pointer)))) {
		(*(WrapperStruct00_var_1_11_Pointer)) = ((*(WrapperStruct00_var_1_12_Pointer)) && (*(WrapperStruct00_var_1_13_Pointer)));
	} else {
		if (((*(WrapperStruct00_var_1_7_Pointer)) / (*(WrapperStruct00_var_1_3_Pointer))) < (min ((max ((*(WrapperStruct00_var_1_8_Pointer)) , (*(WrapperStruct00_var_1_6_Pointer)))) , (*(WrapperStruct00_var_1_5_Pointer))))) {
