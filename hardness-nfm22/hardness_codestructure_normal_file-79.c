...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch79normal.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch79normal
	if (var_1_3 && var_1_2) {
		if ((min (var_1_5 , (var_1_6 * var_1_4))) > var_1_1) {
			var_1_7 = var_1_8;
		} else {
			var_1_7 = var_1_8;
		}
	...
	// From: Req7Batch79normal
	var_1_26 = var_1_16;


	// From: Req8Batch79normal
	var_1_27 = 10u;
}
