...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch20Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch20Wrapper_AP
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer))) {
		(*(float_Array_0_arrayfloat_Array_0arrayVar4_Pointer)) = (((*(float_Array_0_arrayfloat_Array_0arrayVar3_Pointer)) - (*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer))) - (*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer)));
	} else {
		(*(float_Array_0_arrayfloat_Array_0arrayVar4_Pointer)) = ((*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) + (*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)));
	}


	// From: Req2Batch20Wrapper_AP
	(*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) = ((15.5 + (*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer))) - ((*(float_Array_0_arrayfloat_Array_0arrayVar3_Pointer)) - (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))));


	// From: Req4Batch20Wrapper_AP
	...
	if (stepLocal_1 >= (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var3_Pointer))) {
		if ((*(float_Array_0_arrayfloat_Array_0arrayVar4_Pointer)) >= (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))) {
			(*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) = (128 - 16);
		} else {
			if (stepLocal_2 >= (abs ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer))))) {
	...
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer)) || stepLocal_0) {
		(*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var2_Pointer)) = (((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var3_Pointer)) - (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer))) - (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)));
	} else {
		(*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var2_Pointer)) = ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) + (abs ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)))));
	}
}
