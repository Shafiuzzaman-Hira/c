...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch3325_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch3325_1loop
	var_1_16 = var_1_17;


	// From: Req6Batch3325_1loop
	var_1_18 = var_1_8;


	// From: Req2Batch3325_1loop
	if (var_1_18 == var_1_18) {
		var_1_7 = var_1_8;
	}


	// From: Req4Batch3325_1loop
