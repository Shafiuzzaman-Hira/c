...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch9Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch9Filler_PR_CO
	var_1_18 = var_1_3;


	// From: CodeObject3
	if (var_1_10 <= var_1_16) {
		if (var_1_10 <= ((min (var_1_25 , var_1_24)) / var_1_27)) {
			var_1_26 = (abs (var_1_16));
		}
	} else {
		if (var_1_25 > (2 ^ (max (var_1_10 , var_1_27)))) {
	...
	// From: CodeObject4
	if ((var_1_1 / var_1_30) > (abs (var_1_1 / var_1_32))) {
		if (var_1_18 > var_1_27) {
			var_1_28 = var_1_18;
		}
	}


	// From: Req1Batch9Filler_PR_CO
	...
	// From: CodeObject6
	if (((256 - var_1_25) <= (var_1_16 + var_1_13)) || var_1_20) {
		if (var_1_20) {
			if (((var_1_13 == var_1_27) && var_1_21) && var_1_36) {
				var_1_35 = var_1_34;
			}
		}
	}
