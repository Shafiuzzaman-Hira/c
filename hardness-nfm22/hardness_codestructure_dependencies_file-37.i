...
void step(void) {
 if (var_1_14) {
  if (last_1_var_1_13 <= var_1_9) {
   ...
   if (((((last_1_var_1_17) < ((var_1_2 * last_1_var_1_17))) ? (last_1_var_1_17) : ((var_1_2 * last_1_var_1_17)))) == (var_1_3 + last_1_var_1_19)) {
    var_1_13 = 8.75;
   } else {
 ...
 if ((var_1_19 / var_1_8) < (var_1_1 / ((((2) < (var_1_2)) ? (2) : (var_1_2))))) {
  if (var_1_1 >= var_1_3) {
   var_1_7 = 0.75f;
  } else {
   var_1_7 = var_1_9;
