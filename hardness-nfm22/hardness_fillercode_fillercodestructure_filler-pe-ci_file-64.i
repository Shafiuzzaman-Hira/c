...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch64Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_27 + var_1_19) < var_1_13) {
  var_1_30 = ((((var_1_34) < (((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))))) ? (var_1_34) : (((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))))));
 }
 var_1_36 = var_1_12;
 if (var_1_34 < var_1_30) {
  var_1_38 = (((((((var_1_22) > (((((var_1_13) < (var_1_17)) ? (var_1_13) : (var_1_17))))) ? (var_1_22) : (((((var_1_13) < (var_1_17)) ? (var_1_13) : (var_1_17)))))) < 0 ) ? -((((var_1_22) > (((((var_1_13) < (var_1_17)) ? (var_1_13) : (var_1_17))))) ? (var_1_22) : (((((var_1_13) < (var_1_17)) ? (var_1_13) : (var_1_17)))))) : ((((var_1_22) > (((((var_1_13) < (var_1_17)) ? (var_1_13) : (var_1_17))))) ? (var_1_22) : (((((var_1_13) < (var_1_17)) ? (var_1_13) : (var_1_17))))))));
 }
 if (var_1_34 > var_1_30) {
  if (((((32) > (var_1_22)) ? (32) : (var_1_22))) <= var_1_22) {
   var_1_40 = ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)));
  } else {
   var_1_40 = (((((((128u) < (((((var_1_13) < (var_1_27)) ? (var_1_13) : (var_1_27))))) ? (128u) : (((((var_1_13) < (var_1_27)) ? (var_1_13) : (var_1_27)))))) < 0 ) ? -((((128u) < (((((var_1_13) < (var_1_27)) ? (var_1_13) : (var_1_27))))) ? (128u) : (((((var_1_13) < (var_1_27)) ? (var_1_13) : (var_1_27)))))) : ((((128u) < (((((var_1_13) < (var_1_27)) ? (var_1_13) : (var_1_27))))) ? (128u) : (((((var_1_13) < (var_1_27)) ? (var_1_13) : (var_1_27))))))));
  }
 } else {
  var_1_40 = var_1_27;
 }
 if (var_1_27 <= 100u) {
  if ((var_1_27 - ((((-2) < 0 ) ? -(-2) : (-2)))) == (var_1_22 + -4)) {
   var_1_42 = var_1_27;
  }
 } else {
  var_1_42 = 16;
 ...
 if (var_1_35 > var_1_34) {
  var_1_46 = (((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))) - ((((var_1_27) < (((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16))))) ? (var_1_27) : (((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16)))))));
 } else {
  if (var_1_35 <= var_1_30) {
   var_1_46 = (var_1_1 - var_1_19);
  } else {
   var_1_46 = var_1_16;
  }
 }
