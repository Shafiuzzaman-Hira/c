...
void step(void) {
	...
	if (var_1_22) {
		if (var_1_27 <= var_1_8) {
			var_1_24 = ((max (var_1_27 , (min (-128 , var_1_8)))) + var_1_8);
		}
	} else {
	...
	// From: CodeObject4
	if ((min (var_1_8 , var_1_1)) >= var_1_15) {
		var_1_37 = var_1_20;
	}
	...
	if ((var_1_39 * (var_1_40 - var_1_41)) >= var_1_42) {
		if ((~ var_1_36) <= (abs (min (var_1_8 , var_1_16)))) {
			var_1_38 = var_1_36;
		} else {
			var_1_38 = var_1_36;
		}
	...
	if ((max (var_1_39 , 64.75f)) <= var_1_40) {
		if ((var_1_8 & var_1_8) > var_1_20) {
			if (var_1_17 <= ((min (var_1_17 , var_1_20)) ^ (128 - 16))) {
	...
	// From: Req3Batch97Filler_PS_CO
	if (var_1_9 > var_1_10) {
		var_1_8 = (min ((var_1_11 + (var_1_12 - var_1_13)) , (5 + var_1_14)));
	}


	// From: Req7Batch97Filler_PS_CO
	var_1_20 = var_1_8;


	// From: Req8Batch97Filler_PS_CO
	var_1_22 = var_1_23;


	// From: Req4Batch97Filler_PS_CO
	if (var_1_22) {
		var_1_15 = var_1_8;
	}


	// From: Req5Batch97Filler_PS_CO
	var_1_16 = ((min (var_1_15 , (max (var_1_13 , var_1_12)))) - var_1_11);


	// From: Req6Batch97Filler_PS_CO
	if (var_1_22) {
