...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch91PS_CN_25.c", 13, "reach_error"); }
...
double var_1_43 = 256.7;
unsigned char var_1_44 = 4;
float var_1_45 = 32.02;
...
void step(void) {
	...
	// From: CodeObject6
	if ((min ((var_1_44 % var_1_46) , var_1_41)) > var_1_42) {
		var_1_45 = var_1_40;
	}


	// From: Req1Batch91PS_CN_25
	...
	// From: Req5Batch91PS_CN_25
	if (var_1_11 < 5) {
		var_1_17 = (max (var_1_18 , (var_1_19 - var_1_20)));
	}


	// From: Req7Batch91PS_CN_25
	var_1_24 = var_1_25;


	// From: Req8Batch91PS_CN_25
	var_1_26 = var_1_11;


	// From: Req6Batch91PS_CN_25
	if (var_1_24) {
