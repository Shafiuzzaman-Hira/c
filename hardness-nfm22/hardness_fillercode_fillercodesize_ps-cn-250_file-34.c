...
void step(void) {
	...
	// From: CodeObject12
	if (var_1_32 < (var_1_30 + (abs (var_1_33)))) {
		var_1_54 = (var_1_35 + var_1_29);
	} else {
		if (var_1_30 >= 1u) {
			var_1_54 = (abs (max ((abs (var_1_51)) , var_1_55)));
		}
	}
	...
	if (var_1_49 < var_1_30) {
		var_1_58 = (abs (abs (var_1_59)));
	} else {
		if ((max (var_1_60 , var_1_34)) >= var_1_35) {
			var_1_58 = (max (var_1_59 , (abs (var_1_61))));
		} else {
	...
	// From: CodeObject15
	if (var_1_44 >= (abs (var_1_28 * var_1_26))) {
		if ((- 32u) < (abs (var_1_49))) {
			var_1_62 = ((max ((min (var_1_63 , 3587032421u)) , (var_1_64 - var_1_29))) - (min (var_1_34 , var_1_49)));
		}
	} else {
		if (((abs (var_1_29)) << var_1_54) <= var_1_46) {
			if ((var_1_55 + var_1_51) <= var_1_60) {
				var_1_62 = (var_1_63 - (abs (var_1_34)));
			}
		} else {
			var_1_62 = (abs (max (var_1_29 , 16u)));
		}
	}
	...
	// From: CodeObject16
	if (var_1_43) {
		if ((min (var_1_32 , var_1_49)) <= (max (var_1_60 , (var_1_63 - var_1_35)))) {
			var_1_65 = (max (var_1_66 , var_1_29));
		}
	} else {
		if (var_1_24) {
	...
	if (var_1_43 && var_1_27) {
		if ((abs (max (var_1_52 , var_1_25))) > var_1_22) {
			if (var_1_65 >= var_1_48) {
				var_1_67 = (min (var_1_49 , var_1_29));
			}
		}
	}
	...
	if (var_1_61 >= var_1_67) {
		var_1_68 = (abs (var_1_26));
	} else {
		if (var_1_50) {
			var_1_68 = (abs (var_1_25));
		} else {
			if (((abs (var_1_51)) - var_1_69) >= var_1_60) {
				if ((var_1_67 >> var_1_58) < ((var_1_30 | var_1_32) % (abs (var_1_64)))) {
					var_1_68 = (abs (var_1_25));
				}
			} else {
				var_1_68 = var_1_25;
	...
	// From: CodeObject19
	if ((max ((max (var_1_54 , var_1_33)) , var_1_46)) <= 10u) {
		if (var_1_59 >= (abs (var_1_51))) {
			if ((~ var_1_51) >= 100) {
				var_1_70 = var_1_71;
			}
		} else {
	...
	// From: CodeObject24
	if ((abs (var_1_26)) < var_1_53) {
		var_1_76 = (max ((abs (var_1_61)) , (abs (abs (var_1_35)))));
	} else {
		var_1_76 = var_1_74;
	}
	...
	// From: Req7Batch34PS_CN_250
	if (var_1_15 > var_1_12) {
		var_1_18 = (! var_1_19);
	}


	// From: Req4Batch34PS_CN_250
	if (var_1_18) {
		var_1_14 = var_1_12;
	} else {
		var_1_14 = 64;
	...
	// From: Req8Batch34PS_CN_250
	var_1_20 = last_1_var_1_17;


	// From: Req6Batch34PS_CN_250
