...
void step(void) {
	...
	if ((last_1_unsigned_char_Array_0_1__1__1_ / -2) >= stepLocal_0) {
		unsigned_char_Array_0[1][1][1] = (abs (unsigned_char_Array_0[1][0][0]));
	} else {
		unsigned_char_Array_0[1][1][1] = (unsigned_char_Array_0[0][1][0] - (abs (unsigned_char_Array_0[1][1][0])));
	}


	// From: Req1Batch82Wrapper_A
	if (! BOOL_unsigned_char_Array_0[0]) {
		if (BOOL_unsigned_char_Array_0[0]) {
			float_Array_0[2] = (max (float_Array_0[1] , float_Array_0[0]));
		}
	}


	// From: Req4Batch82Wrapper_A
	double_Array_0[0] = float_Array_0[0];


	// From: Req5Batch82Wrapper_A
	unsigned_char_Array_0[0][0][1] = unsigned_char_Array_0[1][0][0];


	// From: Req6Batch82Wrapper_A
	double_Array_0[1] = float_Array_0[1];


	// From: Req3Batch82Wrapper_A
	...
	if ((unsigned_char_Array_0[1][1][1] + unsigned_char_Array_0[1][1][0]) >= stepLocal_1) {
		if ((max (float_Array_0[0] , (float_Array_0[2] * float_Array_0[1]))) <= float_Array_0[2]) {
			unsigned_char_Array_0[0][0][0] = (max (unsigned_char_Array_0[1][1][0] , unsigned_char_Array_0[1][0][1]));
		} else {
			if (BOOL_unsigned_char_Array_0[0]) {
