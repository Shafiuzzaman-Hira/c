...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch2100_1loop.c", 13, "reach_error"); }
...
void step(void) {
 if ((var_1_3 / var_1_15) >= (var_1_4 - var_1_16)) {
  ...
  var_1_14 = ((((((((var_1_11) < ((var_1_10 + last_1_var_1_18))) ? (var_1_11) : ((var_1_10 + last_1_var_1_18))))) > (last_1_var_1_21)) ? (((((var_1_11) < ((var_1_10 + last_1_var_1_18))) ? (var_1_11) : ((var_1_10 + last_1_var_1_18))))) : (last_1_var_1_21)));
 }
 ...
 if (stepLocal_4 >= (var_1_27 - var_1_23)) {
  if (var_1_20 <= stepLocal_6) {
   if (! (var_1_15 > 3.8f)) {
    var_1_29 = ((((var_1_10) > (((((var_1_11) < (var_1_27)) ? (var_1_11) : (var_1_27))))) ? (var_1_10) : (((((var_1_11) < (var_1_27)) ? (var_1_11) : (var_1_27))))));
   }
  } else {
   if (((((var_1_23) < ((var_1_24 * var_1_14))) ? (var_1_23) : ((var_1_24 * var_1_14)))) <= stepLocal_7) {
    var_1_29 = ((var_1_30 + (1 - var_1_31)) + (var_1_32 + ((((var_1_33) < (var_1_34)) ? (var_1_33) : (var_1_34)))));
   }
  }
 } else {
 ...
 var_1_25 = (((((9.999999999999975E13f) > (var_1_4)) ? (9.999999999999975E13f) : (var_1_4))) - var_1_3);
 if ((- 4.75) < (- var_1_15)) {
  var_1_26 = ((((var_1_11) > ((var_1_10 - 16))) ? (var_1_11) : ((var_1_10 - 16))));
 } else {
 ...
 if (stepLocal_1 || var_1_2) {
  if (var_1_7) {
   var_1_8 = (var_1_10 - ((((25) < 0 ) ? -(25) : (25))));
  }
 } else {
  var_1_8 = (-2 + var_1_11);
 }
 var_1_13 = ((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26)));
 unsigned char stepLocal_3 = var_1_21;
 if (var_1_29 <= stepLocal_3) {
  if ((var_1_1 + var_1_1) != var_1_36) {
   var_1_28 = ((var_1_23 + var_1_27) + (((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24))) + var_1_26));
  }
 } else {
  var_1_28 = var_1_27;
 }
 if ((var_1_28 ^ ((((var_1_26) > (var_1_8)) ? (var_1_26) : (var_1_8)))) > var_1_10) {
