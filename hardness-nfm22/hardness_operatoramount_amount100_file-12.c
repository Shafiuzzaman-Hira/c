...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch12Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch12Amount100
	signed long int stepLocal_1 = (last_1_var_1_24 - last_1_var_1_28) << (min (var_1_7 , var_1_8));
	...
	// From: Req5Batch12Amount100
	signed long int stepLocal_3 = last_1_var_1_26 + var_1_8;
	if (var_1_5) {
		if ((min (last_1_var_1_6 , (1.0000000075E8 - var_1_19))) > var_1_12) {
	...
	// From: Req7Batch12Amount100
	if (! (last_1_var_1_18 <= (var_1_7 / var_1_15))) {
		var_1_21 = (max (((var_1_22 - 7.5) - var_1_23) , var_1_12));
	} else {
		var_1_21 = var_1_22;
	}


	// From: Req8Batch12Amount100
	if (var_1_17 || (var_1_8 >= last_1_var_1_24)) {
		if (var_1_17 && (var_1_21 != var_1_23)) {
			var_1_24 = (min (var_1_7 , var_1_25));
		}
	} else {
		var_1_24 = var_1_7;
	}
	...
	// From: Req6Batch12Amount100
	if (var_1_19 == var_1_21) {
		if (! var_1_17) {
			var_1_20 = (max (var_1_7 , var_1_8));
		} else {
			var_1_20 = var_1_7;
		}
	}
	...
	// From: Req4Batch12Amount100
	if (var_1_5 && var_1_17) {
		var_1_16 = (max (last_1_var_1_16 , var_1_15));
	} else {
		var_1_16 = (var_1_8 - var_1_7);
	}


	// From: Req3Batch12Amount100
	...
	// From: Req10Batch12Amount100
	if (var_1_17) {
		if (var_1_21 <= ((var_1_6 / var_1_22) + (var_1_21 / var_1_29))) {
			var_1_28 = ((59265 - (max (var_1_8 , var_1_18))) - (var_1_30 - var_1_13));
		} else {
			var_1_28 = var_1_13;
		}
	} else {
	...
	// From: Req9Batch12Amount100
	if (! var_1_17) {
		if (var_1_17) {
			if (var_1_6 <= (abs (var_1_6))) {
...
int property() {
	return ((((((((((((last_1_var_1_26 * last_1_var_1_20) >= last_1_var_1_28) && (! var_1_5)) ? (var_1_1 == ((signed short int) last_1_var_1_26)) : (var_1_1 == ((signed short int) last_1_var_1_26))) && ((last_1_var_1_18 <= ((last_1_var_1_24 - last_1_var_1_28) << (min (var_1_7 , var_1_8)))) ? (((- last_1_var_1_21) > (last_1_var_1_6 + (- last_1_var_1_21))) ? (var_1_6 == ((double) var_1_12)) : (var_1_6 == ((double) var_1_12))) : 1)) && ((var_1_21 > var_1_21) ? (var_1_13 == ((signed long int) (var_1_7 - var_1_24))) : (((var_1_16 / var_1_15) < var_1_24) ? (var_1_13 == ((signed long int) var_1_7)) : (var_1_13 == ((signed long int) var_1_15))))) && ((var_1_5 && var_1_17) ? (var_1_16 == ((signed long int) (max (last_1_var_1_16 , var_1_15)))) : (var_1_16 == ((signed long int) (var_1_8 - var_1_7))))) && (var_1_5 ? (((min (last_1_var_1_6 , (1.0000000075E8 - var_1_19))) > var_1_12) ? (((last_1_var_1_26 + var_1_8) >= last_1_var_1_24) ? (var_1_18 == ((signed short int) var_1_7)) : (var_1_18 == ((signed short int) last_1_var_1_24))) : (var_1_18 == ((signed short int) var_1_8))) : 1)) && ((var_1_19 == var_1_21) ? ((! var_1_17) ? (var_1_20 == ((signed char) (max (var_1_7 , var_1_8)))) : (var_1_20 == ((signed char) var_1_7))) : 1)) && ((! (last_1_var_1_18 <= (var_1_7 / var_1_15))) ? (var_1_21 == ((double) (max (((var_1_22 - 7.5) - var_1_23) , var_1_12)))) : (var_1_21 == ((double) var_1_22)))) && ((var_1_17 || (var_1_8 >= last_1_var_1_24)) ? ((var_1_17 && (var_1_21 != var_1_23)) ? (var_1_24 == ((unsigned char) (min (var_1_7 , var_1_25)))) : 1) : (var_1_24 == ((unsigned char) var_1_7)))) && ((! var_1_17) ? (var_1_17 ? ((var_1_6 <= (abs (var_1_6))) ? ((var_1_19 <= ((var_1_12 + var_1_6) / var_1_22)) ? (((~ var_1_24) > var_1_1) ? (var_1_26 == ((unsigned short int) var_1_13)) : (var_1_26 == ((unsigned short int) var_1_7))) : 1) : (var_1_26 == ((unsigned short int) var_1_18))) : (var_1_26 == ((unsigned short int) var_1_18))) : (var_1_26 == ((unsigned short int) var_1_8)))) && (var_1_17 ? ((var_1_21 <= ((var_1_6 / var_1_22) + (var_1_21 / var_1_29))) ? (var_1_28 == ((unsigned short int) ((59265 - (max (var_1_8 , var_1_18))) - (var_1_30 - var_1_13)))) : (var_1_28 == ((unsigned short int) var_1_13))) : (var_1_28 == ((unsigned short int) var_1_1)))
;
}
int main(void) {
	isInitial = 1;
