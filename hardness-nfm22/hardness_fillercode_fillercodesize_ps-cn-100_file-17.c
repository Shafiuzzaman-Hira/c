...
void step(void) {
	...
	if (! var_1_39) {
		...
		if (var_1_28 && var_1_40) {
			...
			if (var_1_32 >= var_1_46) {
				var_1_42 = (min (((min (var_1_45 , var_1_44)) + var_1_47) , var_1_21));
			}
		}
	}
	...
	// From: CodeObject11
	if (var_1_50 <= (max (var_1_54 , var_1_42))) {
		var_1_53 = (max (var_1_37 , var_1_29));
	} else {
		if ((var_1_44 * var_1_45) == (abs (var_1_54))) {
			var_1_53 = var_1_36;
		}
	}
	...
	// From: Req1Batch17PS_CN_100
	var_1_1 = (50 + (min (var_1_2 , (min (var_1_3 , var_1_4)))));


	// From: Req5Batch17PS_CN_100
