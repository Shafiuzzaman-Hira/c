...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch32Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
	// From: CodeObject1
	if (var_1_13 < (min (var_1_20 , (var_1_13 >> var_1_5)))) {
		if (var_1_13 > var_1_20) {
			var_1_25 = var_1_6;
		} else {
			if (((var_1_5 ^ var_1_13) >> var_1_13) > (abs (var_1_20))) {
				var_1_25 = (abs (var_1_7));
			}
		}
	} else {
		if ((var_1_5 - var_1_7) <= (~ (var_1_32 - var_1_5))) {
			var_1_25 = (max (var_1_6 , var_1_7));
		} else {
			var_1_25 = -32;
		}
	}
	...
	// From: CodeObject3
	if ((var_1_12 - var_1_12) >= (var_1_11 * var_1_11)) {
		var_1_36 = 5;
	}


	// From: CodeObject4
	if ((var_1_12 / (max (var_1_42 , 256.5))) < var_1_11) {
		var_1_41 = var_1_5;
	}


	// From: CodeObject5
	if (((min (var_1_18 , var_1_11)) >= (var_1_12 / var_1_42)) || var_1_16) {
	...
	// From: CodeObject6
	if (var_1_5 <= (var_1_13 ^ (var_1_5 & var_1_4))) {
		if (var_1_16) {
			if (var_1_15) {
				var_1_45 = var_1_5;
			} else {
	...
	// From: Req7Batch32Filler_PS_CI
	var_1_22 = var_1_12;


	// From: Req8Batch32Filler_PS_CI
	var_1_23 = var_1_8;


	// From: Req9Batch32Filler_PS_CI
	var_1_24 = var_1_6;
}
