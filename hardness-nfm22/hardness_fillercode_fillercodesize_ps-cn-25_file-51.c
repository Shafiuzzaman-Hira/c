...
void step(void) {
	...
	if (var_1_32 >= var_1_29) {
		var_1_33 = (abs (max (var_1_28 , (var_1_34 + var_1_35))));
	}


	// From: CodeObject6
	if (var_1_25 == var_1_30) {
		var_1_36 = (min ((min (var_1_37 , var_1_38)) , var_1_39));
	}


	// From: CodeObject7
	if ((abs (var_1_32)) < (~ var_1_39)) {
		var_1_40 = var_1_32;
	}


	// From: Req5Batch51PS_CN_25
	...
	// From: Req4Batch51PS_CN_25
	if ((min ((~ var_1_1) , 8)) > var_1_11) {
		var_1_17 = var_1_18;
	}


	// From: Req2Batch51PS_CN_25
	if (! (var_1_17 > var_1_5)) {
