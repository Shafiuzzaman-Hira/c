...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch80PS_CN_50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch80PS_CN_50
	if ((var_1_17 <= (- var_1_16)) && var_1_19) {
		var_1_18 = var_1_10;
	}


	// From: Req7Batch80PS_CN_50
	if (var_1_19) {
