...
void step(void) {
 ...
 if (var_1_10 > (var_1_16 & (~ var_1_33))) {
  if (((var_1_39 + var_1_40) - ((((var_1_41) > (var_1_42)) ? (var_1_41) : (var_1_42)))) > (((((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))) < 0 ) ? -((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))) : ((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43)))))) {
   var_1_38 = ((((var_1_11) > (((((var_1_34) < (var_1_37)) ? (var_1_34) : (var_1_37))))) ? (var_1_11) : (((((var_1_34) < (var_1_37)) ? (var_1_34) : (var_1_37))))));
  }
 } else {
  var_1_38 = ((((var_1_34) > (((((var_1_11) < (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))))) ? (var_1_11) : (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))))))) ? (var_1_34) : (((((var_1_11) < (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))))) ? (var_1_11) : (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))))))));
 }
 var_1_24 = var_1_12;
 if ((var_1_24 + var_1_33) > (var_1_10 ^ ((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37))))) {
  var_1_44 = (2u + ((((var_1_24) > (var_1_34)) ? (var_1_24) : (var_1_34))));
 }
