...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch96has_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch96has_floats
	var_1_15 = var_1_1;


	// From: Req5Batch96has_floats
	var_1_16 = var_1_13;


	// From: Req6Batch96has_floats
	var_1_17 = var_1_18;


	// From: Req3Batch96has_floats
