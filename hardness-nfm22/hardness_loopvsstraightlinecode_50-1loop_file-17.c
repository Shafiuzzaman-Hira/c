...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch1750_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch1750_1loop
	var_1_1 = (50 + (min (var_1_2 , (min (var_1_3 , var_1_4)))));


	// From: Req5Batch1750_1loop
