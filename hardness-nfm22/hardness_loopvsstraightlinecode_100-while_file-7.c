...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch7100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch7100_while
	if (var_1_8) {
		var_1_20 = var_1_15;
	}


	// From: Req5Batch7100_while
	if (var_1_16 >= (9.99999999999994E13f * var_1_20)) {
		var_1_21 = (var_1_22 - (max (4 , var_1_23)));
	}


	// From: Req8Batch7100_while
	if (((max (var_1_17 , var_1_16)) * var_1_19) <= (0.25f / 5.75f)) {
		if (var_1_12) {
			var_1_30 = var_1_26;
		} else {
			var_1_30 = var_1_22;
	...
	// From: Req11Batch7100_while
	var_1_33 = ((max ((var_1_34 + var_1_35) , (var_1_36 - var_1_37))) - var_1_23);


	// From: Req12Batch7100_while
	unsigned char stepLocal_3 = var_1_37;
	if (var_1_34 <= stepLocal_3) {
		if (var_1_20 > var_1_20) {
			var_1_38 = (max ((max (var_1_37 , var_1_36)) , var_1_22));
		} else {
	...
	// From: Req2Batch7100_while
	unsigned char stepLocal_1 = var_1_33;
	if (stepLocal_1 <= var_1_30) {
		if (var_1_8) {
			var_1_7 = (max (var_1_33 , (var_1_10 - var_1_24)));
		} else {
	...
	// From: Req3Batch7100_while
	signed long int stepLocal_2 = - var_1_7;
	if (stepLocal_2 <= var_1_24) {
		var_1_13 = (max (var_1_14 , var_1_15));
	} else {
		var_1_13 = ((max (var_1_16 , (var_1_17 + var_1_18))) + var_1_19);
	}


	// From: Req9Batch7100_while
	if ((var_1_22 / var_1_28) == 32) {
		var_1_31 = (min (var_1_25 , var_1_38));
	} else {
		if ((min ((- var_1_13) , (- var_1_19))) > 8.95f) {
	...
	// From: Req7Batch7100_while
	if (var_1_14 <= var_1_15) {
		var_1_27 = (var_1_26 - (min (var_1_21 , (var_1_23 + var_1_24))));
	} else {
		var_1_27 = var_1_30;
	}
}
...
int property() {
	return ((((((((((((var_1_30 > var_1_24) ? (((abs (var_1_32)) < var_1_32) ? (var_1_1 == ((signed char) var_1_6)) : (var_1_1 == ((signed char) var_1_6))) : (var_1_1 == ((signed char) var_1_6))) && ((var_1_33 <= var_1_30) ? (var_1_8 ? (var_1_7 == ((unsigned short int) (max (var_1_33 , (var_1_10 - var_1_24))))) : (var_1_7 == ((unsigned short int) (var_1_10 - var_1_24)))) : (var_1_12 ? (var_1_7 == ((unsigned short int) var_1_33)) : (var_1_7 == ((unsigned short int) var_1_10))))) && (((- var_1_7) <= var_1_24) ? (var_1_13 == ((float) (max (var_1_14 , var_1_15)))) : (var_1_13 == ((float) ((max (var_1_16 , (var_1_17 + var_1_18))) + var_1_19))))) && (var_1_8 ? (var_1_20 == ((float) var_1_15)) : 1)) && ((var_1_16 >= (9.99999999999994E13f * var_1_20)) ? (var_1_21 == ((signed char) (var_1_22 - (max (4 , var_1_23))))) : 1)) && ((-64 <= last_1_var_1_38) ? ((((last_1_var_1_33 - last_1_var_1_33) / var_1_10) > (var_1_23 - (var_1_25 - last_1_var_1_27))) ? (var_1_24 == ((unsigned char) (max (var_1_23 , var_1_26)))) : (var_1_24 == ((unsigned char) 4))) : (var_1_24 == ((unsigned char) var_1_23)))) && ((var_1_14 <= var_1_15) ? (var_1_27 == ((signed short int) (var_1_26 - (min (var_1_21 , (var_1_23 + var_1_24)))))) : (var_1_27 == ((signed short int) var_1_30)))) && ((((max (var_1_17 , var_1_16)) * var_1_19) <= (0.25f / 5.75f)) ? (var_1_12 ? (var_1_30 == ((signed long int) var_1_26)) : (var_1_30 == ((signed long int) var_1_22))) : (var_1_30 == ((signed long int) -1)))) && (((var_1_22 / var_1_28) == 32) ? (var_1_31 == ((unsigned long int) (min (var_1_25 , var_1_38)))) : (((min ((- var_1_13) , (- var_1_19))) > 8.95f) ? ((var_1_33 <= var_1_33) ? (var_1_31 == ((unsigned long int) var_1_33)) : 1) : (var_1_31 == ((unsigned long int) var_1_33))))) && (((~ (var_1_7 ^ var_1_33)) >= var_1_7) ? (var_1_32 == ((double) var_1_15)) : (var_1_8 ? (var_1_32 == ((double) var_1_19)) : 1))) && (var_1_33 == ((unsigned char) ((max ((var_1_34 + var_1_35) , (var_1_36 - var_1_37))) - var_1_23)))) && ((var_1_34 <= var_1_37) ? ((var_1_20 > var_1_20) ? (var_1_38 == ((signed char) (max ((max (var_1_37 , var_1_36)) , var_1_22)))) : (var_1_38 == ((signed char) (var_1_37 + var_1_39)))) : (var_1_38 == ((signed char) var_1_22)))
;
}
int main(void) {
	isInitial = 1;
