...
void step(void) {
 ...
 if ((*(var_1_13_Pointer)) > (*(var_1_6_Pointer))) {
  (*(var_1_18_Pointer)) = ((((((*(var_1_6_Pointer))) < ((*(var_1_13_Pointer)))) ? ((*(var_1_6_Pointer))) : ((*(var_1_13_Pointer))))) - (*(var_1_6_Pointer)));
 }
 if (last_1_var_1_14) {
  (*(var_1_14_Pointer)) = ((*(var_1_16_Pointer)) && (*(var_1_17_Pointer)));
 }
 (*(var_1_20_Pointer)) = ((((((((last_1_var_1_20) < 0 ) ? -(last_1_var_1_20) : (last_1_var_1_20)))) < (((*(var_1_21_Pointer)) - (*(var_1_7_Pointer))))) ? (((((last_1_var_1_20) < 0 ) ? -(last_1_var_1_20) : (last_1_var_1_20)))) : (((*(var_1_21_Pointer)) - (*(var_1_7_Pointer))))));
 unsigned long int stepLocal_1 = (*(var_1_20_Pointer));
 unsigned long int stepLocal_0 = (*(var_1_20_Pointer));
 if (((((((*(var_1_18_Pointer))) > ((*(var_1_18_Pointer)))) ? ((*(var_1_18_Pointer))) : ((*(var_1_18_Pointer))))) / (*(var_1_4_Pointer))) > stepLocal_1) {
