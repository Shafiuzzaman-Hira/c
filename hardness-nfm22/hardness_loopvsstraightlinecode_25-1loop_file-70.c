...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch7025_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch7025_1loop
	if (var_1_2) {
		var_1_1 = ((17222 - var_1_3) + ((min (29916 , var_1_4)) - var_1_5));
	}


	// From: Req3Batch7025_1loop
	unsigned short int stepLocal_0 = var_1_4;
	if (stepLocal_0 <= (max (var_1_3 , (var_1_5 << var_1_1)))) {
	...
	// From: Req4Batch7025_1loop
	if ((var_1_9 - (max (5 , var_1_10))) >= var_1_3) {
		var_1_8 = var_1_11;
	}


	// From: Req2Batch7025_1loop
...
int property() {
	return (((var_1_2 ? (var_1_1 == ((unsigned short int) ((17222 - var_1_3) + ((min (29916 , var_1_4)) - var_1_5)))) : 1) && ((var_1_2 && (var_1_4 >= (var_1_3 + var_1_7))) ? (var_1_6 == ((signed char) 8)) : 1)) && ((var_1_4 <= (max (var_1_3 , (var_1_5 << var_1_1)))) ? (var_1_7 == ((signed long int) (min ((var_1_5 - var_1_3) , var_1_4)))) : (var_1_7 == ((signed long int) (var_1_5 + (var_1_1 + var_1_4)))))) && (((var_1_9 - (max (5 , var_1_10))) >= var_1_3) ? (var_1_8 == ((double) var_1_11)) : 1)
;
}
int main(void) {
	isInitial = 1;
