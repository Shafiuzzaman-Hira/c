...
void step(void) {
	...
	// From: Req5Batch81PS_CN_50
	var_1_16 = (last_1_var_1_17 - 1);


	// From: Req2Batch81PS_CN_50
	...
	// From: Req3Batch81PS_CN_50
	if (! var_1_9) {
		var_1_10 = (min (var_1_1 , var_1_5));
	}


	// From: Req4Batch81PS_CN_50
	if (var_1_8) {
		var_1_11 = ((max (var_1_12 , var_1_13)) - ((var_1_14 + var_1_15) - last_1_var_1_11));
	}


	// From: Req8Batch81PS_CN_50
	var_1_24 = var_1_12;


	// From: Req7Batch81PS_CN_50
