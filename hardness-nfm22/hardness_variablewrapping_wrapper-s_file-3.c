...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch3Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch3Wrapper_S
	signed long int stepLocal_2 = WrapperStruct00.var_1_7;
	...
	// From: Req2Batch3Wrapper_S
	if (! WrapperStruct00.var_1_11) {
		WrapperStruct00.var_1_6 = (WrapperStruct00.var_1_7 + WrapperStruct00.var_1_8);
	} else {
		WrapperStruct00.var_1_6 = (((abs (WrapperStruct00.var_1_9)) + WrapperStruct00.var_1_10) + WrapperStruct00.var_1_7);
	}


	// From: Req4Batch3Wrapper_S
	if (WrapperStruct00.var_1_4) {
		WrapperStruct00.var_1_12 = (min (((max (WrapperStruct00.var_1_13 , WrapperStruct00.var_1_14)) + WrapperStruct00.var_1_15) , (abs (min (3.5 , WrapperStruct00.var_1_16)))));
	} else {
...
int property() {
	return ((((! last_1_WrapperStruct00_var_1_11) ? ((last_1_WrapperStruct00_var_1_11 && last_1_WrapperStruct00_var_1_11) ? (WrapperStruct00.var_1_1 == ((unsigned char) (WrapperStruct00.var_1_4 || WrapperStruct00.var_1_5))) : 1) : 1) && ((! WrapperStruct00.var_1_11) ? (WrapperStruct00.var_1_6 == ((signed long int) (WrapperStruct00.var_1_7 + WrapperStruct00.var_1_8))) : (WrapperStruct00.var_1_6 == ((signed long int) (((abs (WrapperStruct00.var_1_9)) + WrapperStruct00.var_1_10) + WrapperStruct00.var_1_7))))) && ((WrapperStruct00.var_1_8 <= WrapperStruct00.var_1_7) ? ((WrapperStruct00.var_1_10 >= WrapperStruct00.var_1_9) ? (WrapperStruct00.var_1_11 == ((unsigned char) (! WrapperStruct00.var_1_5))) : (WrapperStruct00.var_1_11 == ((unsigned char) (WrapperStruct00.var_1_1 || (! WrapperStruct00.var_1_5))))) : 1)) && (WrapperStruct00.var_1_4 ? (WrapperStruct00.var_1_12 == ((double) (min (((max (WrapperStruct00.var_1_13 , WrapperStruct00.var_1_14)) + WrapperStruct00.var_1_15) , (abs (min (3.5 , WrapperStruct00.var_1_16))))))) : (WrapperStruct00.var_1_12 == ((double) WrapperStruct00.var_1_15)))
;
}
int main(void) {
	isInitial = 1;
