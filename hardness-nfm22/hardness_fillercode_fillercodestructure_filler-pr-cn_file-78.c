...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch78Filler_PR_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject2
	if ((min (var_1_22 , var_1_23)) >= var_1_25) {
		var_1_24 = ((var_1_26 + var_1_27) - var_1_23);
	}


	// From: Req7Batch78Filler_PR_CN
	var_1_20 = (max ((var_1_5 + var_1_6) , var_1_4));


	// From: CodeObject5
	if (var_1_26 > 100) {
		if (((abs (var_1_27)) ^ var_1_26) > var_1_25) {
			var_1_32 = (! var_1_33);
		} else {
			var_1_32 = var_1_34;
		}
	...
	// From: CodeObject6
	var_1_35 = (max (var_1_26 , (abs (var_1_28))));


	// From: Req6Batch78Filler_PR_CN
	...
	if (var_1_26 != 10) {
		if (var_1_26 <= var_1_29) {
			var_1_31 = (max (var_1_30 , var_1_23));
		}
	}


	// From: Req1Batch78Filler_PR_CN
	var_1_1 = (abs (var_1_16));


	// From: CodeObject3
	if (var_1_27 > 0) {
		var_1_28 = (min ((max ((var_1_29 + var_1_30) , var_1_23)) , 0));
	}


	// From: Req8Batch78Filler_PR_CN
	...
	if (var_1_29 > var_1_30) {
		if ((var_1_28 ^ var_1_27) != (var_1_24 / 32)) {
			var_1_36 = ((abs (abs (-5))) - ((abs (var_1_30)) + (1000000000 - var_1_23)));
		} else {
			var_1_36 = (abs (var_1_24));
		}
	} else {
