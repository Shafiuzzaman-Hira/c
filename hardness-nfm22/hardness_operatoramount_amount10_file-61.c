...
void step(void) {
	// From: Req1Batch61Amount10
	if ((999.375 / (max (var_1_2 , -0.19))) >= var_1_3) {
		var_1_1 = (var_1_4 + -32);
	} else {
...
int property() {
	return (((999.375 / (max (var_1_2 , -0.19))) >= var_1_3) ? (var_1_1 == ((signed char) (var_1_4 + -32))) : (var_1_1 == ((signed char) ((max (var_1_5 , var_1_6)) - var_1_7)))) && (var_1_8 == ((unsigned long int) var_1_7))
;
}
int main(void) {
	isInitial = 1;
