...
void step(void) {
 if ((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) >= (*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer))) {
  if (last_1_BOOL_unsigned_char_Array_0_2_) {
   if (! last_1_BOOL_unsigned_char_Array_0_2_) {
    (*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer)) = (((((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer))) > ((10.25f + (*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer))))) ? ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer))) : ((10.25f + (*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer))))));
   } else {
 ...
 if (! (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var2_Pointer))) {
  (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer)) = (((((((((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var3_Pointer))) < ((((((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) > (5)) ? ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) : (5))))) ? ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var3_Pointer))) : ((((((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) > (5)) ? ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) : (5))))))) < ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)))) ? ((((((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var3_Pointer))) < ((((((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) > (5)) ? ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) : (5))))) ? ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var3_Pointer))) : ((((((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) > (5)) ? ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) : (5))))))) : ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)))));
 } else {
