...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch81Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
 signed long int stepLocal_0 = (((-25) < (last_1_WrapperStruct00_var_1_18)) ? (-25) : (last_1_WrapperStruct00_var_1_18));
 if (stepLocal_0 != (last_1_WrapperStruct00_var_1_18 ^ last_1_WrapperStruct00_var_1_13)) {
  if (WrapperStruct00.var_1_2) {
   WrapperStruct00.var_1_7 = (WrapperStruct00.var_1_11 + WrapperStruct00.var_1_12);
  }
 } else {
  WrapperStruct00.var_1_7 = ((((WrapperStruct00.var_1_12) < (WrapperStruct00.var_1_11)) ? (WrapperStruct00.var_1_12) : (WrapperStruct00.var_1_11)));
 }
 unsigned char stepLocal_1 = WrapperStruct00.var_1_11 >= WrapperStruct00.var_1_7;
 if (stepLocal_1 && WrapperStruct00.var_1_14) {
  WrapperStruct00.var_1_13 = ((((WrapperStruct00.var_1_15) < (100)) ? (WrapperStruct00.var_1_15) : (100)));
 } else {
  WrapperStruct00.var_1_13 = ((WrapperStruct00.var_1_16 - 5) + WrapperStruct00.var_1_17);
 }
 signed char stepLocal_2 = WrapperStruct00.var_1_7;
 if (stepLocal_2 > WrapperStruct00.var_1_16) {
  if (WrapperStruct00.var_1_3 < (WrapperStruct00.var_1_5 - WrapperStruct00.var_1_6)) {
   WrapperStruct00.var_1_18 = ((((WrapperStruct00.var_1_15) < 0 ) ? -(WrapperStruct00.var_1_15) : (WrapperStruct00.var_1_15)));
  } else {
...
void updateVariables() {
 ...
 assume_abort_if_not((WrapperStruct00.var_1_5 >= 4611686.018427382800e+12F && WrapperStruct00.var_1_5 <= -1.0e-20F) || (WrapperStruct00.var_1_5 <= 9223372.036854765600e+12F && WrapperStruct00.var_1_5 >= 1.0e-20F ));
