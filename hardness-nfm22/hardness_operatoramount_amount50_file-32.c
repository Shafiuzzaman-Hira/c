...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch32Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch32Amount50
	var_1_22 = var_1_12;


	// From: Req8Batch32Amount50
	var_1_23 = var_1_8;


	// From: Req9Batch32Amount50
	var_1_24 = var_1_6;


	// From: Req1Batch32Amount50
	if (-32 < var_1_13) {
