...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch85100_1loop.c", 13, "reach_error"); }
...
void step(void) {
 ...
 signed long int stepLocal_4 = (((var_1_8) > (var_1_10)) ? (var_1_8) : (var_1_10));
 ...
 if (stepLocal_7 < last_1_var_1_29) {
  if (! var_1_13) {
   var_1_29 = ((((var_1_9) < (((var_1_30 + var_1_31) + ((((var_1_32) < (var_1_33)) ? (var_1_32) : (var_1_33)))))) ? (var_1_9) : (((var_1_30 + var_1_31) + ((((var_1_32) < (var_1_33)) ? (var_1_32) : (var_1_33)))))));
  }
 }
 var_1_26 = (! (! var_1_13));
 var_1_34 = var_1_35;
 var_1_36 = var_1_17;
 var_1_37 = var_1_8;
 signed long int stepLocal_2 = (((var_1_8) > (var_1_9)) ? (var_1_8) : (var_1_9));
 if (var_1_26) {
  var_1_14 = 49.5;
 } else {
  if (! var_1_13) {
   if (var_1_13) {
    ...
    var_1_14 = (((((var_1_16) < (var_1_17)) ? (var_1_16) : (var_1_17))) + (var_1_18 + ((((var_1_19) > (var_1_20)) ? (var_1_19) : (var_1_20)))));
   }
  } else {
 ...
 if (var_1_37 >= (var_1_8 - var_1_9)) {
  ...
  var_1_28 = ((((var_1_16) > (((((((((var_1_20) > (var_1_19)) ? (var_1_20) : (var_1_19)))) > (63.4f)) ? (((((var_1_20) > (var_1_19)) ? (var_1_20) : (var_1_19)))) : (63.4f))))) ? (var_1_16) : (((((((((var_1_20) > (var_1_19)) ? (var_1_20) : (var_1_19)))) > (63.4f)) ? (((((var_1_20) > (var_1_19)) ? (var_1_20) : (var_1_19)))) : (63.4f))))));
 }
 ...
 signed long int stepLocal_0 = ((((var_1_25 / var_1_3)) > ((var_1_7 % var_1_5))) ? ((var_1_25 / var_1_3)) : ((var_1_7 % var_1_5)));
 if (stepLocal_0 != -16) {
  var_1_1 = ((((var_1_23) < 0 ) ? -(var_1_23) : (var_1_23)));
 } else {
  var_1_1 = ((((var_1_23) > (32)) ? (var_1_23) : (32)));
 }
 if (var_1_26) {
 ...
 if (var_1_26) {
  if (var_1_5 <= var_1_3) {
   var_1_27 = (((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))) + var_1_25);
  }
 }
 if (var_1_10 <= var_1_9) {
  if ((((((var_1_9) < (var_1_1)) ? (var_1_9) : (var_1_1))) * var_1_7) >= var_1_21) {
   var_1_12 = 0;
  } else {
   var_1_12 = var_1_13;
  }
