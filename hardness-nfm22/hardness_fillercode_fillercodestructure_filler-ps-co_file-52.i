...
void step(void) {
 if ((var_1_22 | ((((var_1_22) > (var_1_18)) ? (var_1_22) : (var_1_18)))) < (((((-5) < 0 ) ? -(-5) : (-5))) >> var_1_7)) {
  var_1_23 = var_1_28;
 }
 var_1_29 = var_1_30;
 if (var_1_1 != (~ -16)) {
 ...
 if ((var_1_18 | var_1_20) <= var_1_15) {
  var_1_36 = ((((var_1_18) > (((var_1_15 - 2) + var_1_30))) ? (var_1_18) : (((var_1_15 - 2) + var_1_30))));
 }
 if ((25u % var_1_38) < var_1_20) {
  var_1_37 = (((((var_1_30) < (((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18))))) ? (var_1_30) : (((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18)))))) + var_1_21);
 } else {
  if ((((((var_1_33) > (var_1_40)) ? (var_1_33) : (var_1_40))) >= var_1_31) && (var_1_21 <= var_1_20)) {
   var_1_37 = var_1_18;
  } else {
