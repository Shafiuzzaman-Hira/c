...
void step(void) {
	...
	signed long int stepLocal_8 = (abs (var_1_6)) - (min (var_1_14 , var_1_13));
	...
	if (last_1_var_1_1 > stepLocal_10) {
		if (stepLocal_9 <= (last_1_var_1_36 / var_1_13)) {
			if (stepLocal_8 < var_1_10) {
				...
				if (stepLocal_7 <= (max (last_1_var_1_64 , (last_1_var_1_60 / var_1_13)))) {
	...
	if (((var_1_29 - last_1_var_1_60) - (max (var_1_7 , last_1_var_1_64))) == var_1_26) {
		var_1_28 = (min (last_1_var_1_61 , (max ((var_1_26 + var_1_8) , (var_1_7 + last_1_var_1_57)))));
	}
	...
	if (stepLocal_22 <= var_1_8) {
		var_1_62 = (((30089 - last_1_var_1_62) - (var_1_63 - last_1_var_1_28)) + (max (var_1_45 , var_1_8)));
	} else {
		var_1_62 = (max (var_1_7 , var_1_25));
	}
	...
	if (var_1_34 > (last_1_var_1_32 + last_1_var_1_12)) {
		if (stepLocal_15 > last_1_var_1_60) {
			...
			var_1_44 = (max ((last_1_var_1_21 + (30135 - var_1_13)) , var_1_45));
		}
	}
	...
	if ((max ((var_1_6 * var_1_60) , var_1_36)) > stepLocal_5) {
		var_1_21 = var_1_13;
	} else {
		if (stepLocal_6 == ((min (var_1_7 , var_1_62)) / var_1_23)) {
			var_1_21 = var_1_14;
		} else {
			var_1_21 = var_1_13;
		}
	...
	if (var_1_50 <= ((var_1_7 + var_1_8) / var_1_10)) {
		if (7.5 >= var_1_12) {
			var_1_9 = (abs (var_1_8 - (var_1_50 + var_1_7)));
		} else {
			var_1_9 = var_1_50;
		}
	}
	...
	if (var_1_8 >= var_1_29) {
		...
		var_1_56 = (max (var_1_14 , var_1_7));
	}


	// From: Req15Batch65Amount250
	signed long int stepLocal_14 = var_1_43;
	if (((min (var_1_8 , var_1_50)) - (min (var_1_44 , var_1_9))) >= stepLocal_14) {
		var_1_42 = (min ((abs (1)) , (min (var_1_26 , var_1_14))));
	}
	...
	if (var_1_37) {
		if (stepLocal_4 || ((2.25 + var_1_12) != 31.625)) {
			...
			var_1_19 = (((max (var_1_60 , var_1_8)) < var_1_56) || var_1_20);
		}
	}
	...
	if ((max (var_1_44 , var_1_8)) != stepLocal_20) {
		if (var_1_46 > stepLocal_19) {
			if ((var_1_16 * var_1_12) <= (var_1_33 - var_1_35)) {
				var_1_57 = (min (var_1_45 , (var_1_58 - (abs (var_1_50)))));
			} else {
				var_1_57 = (var_1_58 - (max ((var_1_40 - var_1_7) , var_1_42)));
			}
		} else {
			var_1_57 = (min ((var_1_58 - var_1_17) , (min (var_1_29 , var_1_61))));
		}
	}
}
...
int property() {
	return (((((((((((((((((((((((((var_1_37 ? (var_1_51 ? (var_1_1 == ((signed long int) (16 - 2))) : (var_1_1 == ((signed long int) var_1_50))) : 1) && (var_1_47 ? (var_1_5 == ((unsigned char) (min (var_1_6 , (var_1_7 - var_1_8))))) : 1)) && ((var_1_50 <= ((var_1_7 + var_1_8) / var_1_10)) ? ((7.5 >= var_1_12) ? (var_1_9 == ((signed short int) (abs (var_1_8 - (var_1_50 + var_1_7))))) : (var_1_9 == ((signed short int) var_1_50))) : 1)) && ((var_1_7 > ((var_1_13 - var_1_14) - 10)) ? (var_1_12 == ((double) ((max ((31.25 + var_1_15) , (abs (5.5)))) - var_1_16))) : 1)) && ((var_1_18 > var_1_7) ? (var_1_17 == ((signed long int) (5 + (var_1_7 + (max (var_1_14 , var_1_18)))))) : (var_1_17 == ((signed long int) (var_1_6 + var_1_62))))) && ((((var_1_5 + var_1_36) * var_1_10) <= var_1_62) ? ((var_1_8 <= var_1_13) ? (var_1_18 == ((signed long int) (var_1_13 + var_1_56))) : 1) : 1)) && (var_1_37 ? ((var_1_51 || ((2.25 + var_1_12) != 31.625)) ? (var_1_19 == ((unsigned char) (! var_1_20))) : (var_1_19 == ((unsigned char) (((max (var_1_60 , var_1_8)) < var_1_56) || var_1_20)))) : 1)) && (((max ((var_1_6 * var_1_60) , var_1_36)) > var_1_64) ? (var_1_21 == ((signed char) var_1_13)) : ((var_1_50 == ((min (var_1_7 , var_1_62)) / var_1_23)) ? (var_1_21 == ((signed char) var_1_14)) : (var_1_21 == ((signed char) var_1_13))))) && ((last_1_var_1_1 > ((last_1_var_1_44 + var_1_6) - (var_1_8 + var_1_14))) ? ((var_1_10 <= (last_1_var_1_36 / var_1_13)) ? ((((abs (var_1_6)) - (min (var_1_14 , var_1_13))) < var_1_10) ? (var_1_24 == ((unsigned char) ((var_1_25 - var_1_26) + var_1_14))) : ((var_1_8 <= (max (last_1_var_1_64 , (last_1_var_1_60 / var_1_13)))) ? (var_1_24 == ((unsigned char) (min (var_1_6 , var_1_25)))) : (var_1_24 == ((unsigned char) (min (var_1_14 , (var_1_7 - (abs (var_1_26))))))))) : (var_1_24 == ((unsigned char) (var_1_7 - var_1_14)))) : (var_1_24 == ((unsigned char) (min (((abs (var_1_7)) - var_1_25) , (abs (var_1_8)))))))) && ((((var_1_29 - last_1_var_1_60) - (max (var_1_7 , last_1_var_1_64))) == var_1_26) ? (var_1_28 == ((signed long int) (min (last_1_var_1_61 , (max ((var_1_26 + var_1_8) , (var_1_7 + last_1_var_1_57))))))) : 1)) && ((var_1_24 <= var_1_50) ? (var_1_32 == ((double) ((var_1_15 - var_1_33) + var_1_34))) : (var_1_37 ? (var_1_32 == ((double) ((max ((min (var_1_33 , var_1_15)) , var_1_16)) - var_1_35))) : (var_1_32 == ((double) (min ((max ((var_1_34 + 1.00000000625E8) , (var_1_15 - 1.00000000025E9))) , var_1_16))))))) && ((((last_1_var_1_9 + 8) / var_1_10) != last_1_var_1_28) ? ((last_1_var_1_28 <= var_1_26) ? (var_1_36 == ((unsigned char) (var_1_7 - (min (var_1_14 , var_1_26))))) : (var_1_36 == ((unsigned char) (abs (var_1_14))))) : 1)) && (var_1_37 == ((unsigned char) (! (var_1_20 && var_1_38))))) && (var_1_39 == ((unsigned long int) ((var_1_40 + var_1_41) - var_1_13)))) && ((((min (var_1_8 , var_1_50)) - (min (var_1_44 , var_1_9))) >= var_1_43) ? (var_1_42 == ((unsigned char) (min ((abs (1)) , (min (var_1_26 , var_1_14)))))) : 1)) && (var_1_20 ? (var_1_43 == ((signed long int) (var_1_64 + var_1_36))) : 1)) && ((var_1_34 > (last_1_var_1_32 + last_1_var_1_12)) ? ((last_1_var_1_64 > last_1_var_1_60) ? (var_1_44 == ((unsigned short int) ((var_1_45 + var_1_46) - last_1_var_1_64))) : (var_1_44 == ((unsigned short int) (max ((last_1_var_1_21 + (30135 - var_1_13)) , var_1_45))))) : 1)) && ((var_1_37 && (var_1_32 <= (var_1_16 - var_1_15))) ? (var_1_47 == ((unsigned char) ((var_1_43 >= var_1_60) && (! (! 0))))) : ((var_1_61 < var_1_25) ? (var_1_47 == ((unsigned char) (var_1_20 || var_1_38))) : 1))) && ((var_1_6 <= var_1_23) ? (var_1_50 == ((unsigned char) (var_1_7 - var_1_25))) : 1)) && ((var_1_6 < var_1_24) ? (((- (var_1_16 / var_1_52)) > var_1_15) ? (var_1_51 == ((unsigned char) ((var_1_38 && var_1_53) || (var_1_54 || var_1_55)))) : 1) : ((! (var_1_37 && last_1_var_1_51)) ? (var_1_51 == ((unsigned char) (var_1_55 || (! var_1_38)))) : (var_1_51 == ((unsigned char) ((! var_1_53) && var_1_20)))))) && ((var_1_8 >= var_1_29) ? (var_1_56 == ((unsigned long int) (var_1_28 + var_1_9))) : (var_1_56 == ((unsigned long int) (max (var_1_14 , var_1_7)))))) && (((max (var_1_44 , var_1_8)) != (var_1_41 << var_1_61)) ? ((var_1_46 > (- var_1_10)) ? (((var_1_16 * var_1_12) <= (var_1_33 - var_1_35)) ? (var_1_57 == ((unsigned long int) (min (var_1_45 , (var_1_58 - (abs (var_1_50))))))) : (var_1_57 == ((unsigned long int) (var_1_58 - (max ((var_1_40 - var_1_7) , var_1_42)))))) : (var_1_57 == ((unsigned long int) (min ((var_1_58 - var_1_17) , (min (var_1_29 , var_1_61))))))) : 1)) && ((last_1_var_1_36 != ((last_1_var_1_42 >> last_1_var_1_43) + (var_1_41 * var_1_6))) ? (var_1_60 == ((unsigned char) var_1_7)) : (var_1_60 == ((unsigned char) var_1_7)))) && (var_1_61 == ((signed char) var_1_14))) && ((last_1_var_1_5 <= var_1_8) ? (var_1_62 == ((unsigned short int) (((30089 - last_1_var_1_62) - (var_1_63 - last_1_var_1_28)) + (max (var_1_45 , var_1_8))))) : (var_1_62 == ((unsigned short int) (max (var_1_7 , var_1_25)))))) && (var_1_64 == ((unsigned char) var_1_8))
;
}
int main(void) {
	isInitial = 1;
