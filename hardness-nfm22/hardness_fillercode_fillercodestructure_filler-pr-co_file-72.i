...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch72Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_17 || var_1_17) {
  ...
  if (var_1_17) {
   ...
   if (var_1_38 >= var_1_42) {
    var_1_47 = ((((var_1_48) < 0 ) ? -(var_1_48) : (var_1_48)));
   } else {
 ...
 var_1_53 = 5.5;
 var_1_31 = var_1_26;
 if (var_1_37 <= ((((var_1_26) > (var_1_29)) ? (var_1_26) : (var_1_29)))) {
  var_1_43 = var_1_42;
 }
 var_1_29 = var_1_1;
 if (var_1_17 && var_1_17) {
  if (var_1_26 <= var_1_31) {
   var_1_32 = (((((var_1_37) < (((((var_1_38) < 0 ) ? -(var_1_38) : (var_1_38))))) ? (var_1_37) : (((((var_1_38) < 0 ) ? -(var_1_38) : (var_1_38)))))) - var_1_26);
  }
 }
 if ((- var_1_38) <= (- var_1_37)) {
  var_1_39 = (2368197193u - var_1_26);
 } else {
  if (var_1_17) {
   var_1_39 = ((((var_1_37) < ((((((var_1_38) > (var_1_40)) ? (var_1_38) : (var_1_40))) - var_1_26))) ? (var_1_37) : ((((((var_1_38) > (var_1_40)) ? (var_1_38) : (var_1_40))) - var_1_26))));
  } else {
   var_1_39 = var_1_40;
  }
 }
