...
void step(void) {
	// From: Req4Batch64Filler_PE_CN
	var_1_19 = ((var_1_20 - var_1_21) - var_1_22);


	// From: Req6Batch64Filler_PE_CN
	...
	// From: Req3Batch64Filler_PE_CN
	if (var_1_10 != var_1_25) {
		var_1_18 = (min (var_1_13 , var_1_12));
	}


	// From: Req5Batch64Filler_PE_CN
	if (! ((64 * var_1_18) < var_1_18)) {
		var_1_23 = var_1_24;
	}


	// From: Req1Batch64Filler_PE_CN
	if (-8 <= var_1_10) {
	...
	if (var_1_35 > var_1_34) {
		var_1_46 = ((abs (var_1_43)) - (min (var_1_44 , (abs (var_1_39)))));
	} else {
