...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch61Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject5
	if (var_1_30 < ((var_1_21 + 16u) * var_1_4)) {
		if (var_1_19 && (var_1_35 < var_1_36)) {
			if (var_1_19) {
				if (var_1_4 <= var_1_25) {
					var_1_38 = (! var_1_39);
				}
	...
	// From: Req7Batch61Filler_PS_CO
	var_1_21 = var_1_6;


	// From: Req8Batch61Filler_PS_CO
	var_1_22 = var_1_23;


	// From: Req1Batch61Filler_PS_CO
	if ((var_1_21 / (abs (64u))) == var_1_4) {
		var_1_1 = (8.8 - 255.2);
	}


	// From: Req4Batch61Filler_PS_CO
