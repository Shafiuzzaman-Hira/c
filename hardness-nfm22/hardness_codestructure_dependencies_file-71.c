...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch71dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch71dependencies
	if (var_1_2) {
		if ((var_1_4 - var_1_5) > ((last_1_var_1_14 + last_1_var_1_20) * last_1_var_1_21)) {
	...
	// From: Req4Batch71dependencies
	if (! (var_1_5 < var_1_1)) {
		if (last_1_var_1_14 >= var_1_1) {
	...
	// From: Req2Batch71dependencies
	var_1_10 = var_1_11;


	// From: Req3Batch71dependencies
	...
	// From: Req5Batch71dependencies
	var_1_18 = (max ((max (255.5f , var_1_11)) , 5.5f));


	// From: Req7Batch71dependencies
	var_1_20 = var_1_15;


	// From: Req8Batch71dependencies
	var_1_21 = var_1_5;


	// From: Req9Batch71dependencies
	var_1_22 = var_1_23;


	// From: Req6Batch71dependencies
	if (var_1_3) {
