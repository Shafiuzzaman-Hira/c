...
void step(void) {
	...
	// From: Req6Batch7Filler_PR_CI
	var_1_15 = (var_1_14 - (max ((var_1_16 + var_1_17) , 4)));


	// From: CodeObject1
	if ((var_1_11 >> var_1_27) > ((var_1_5 ^ var_1_5) + (abs (var_1_11)))) {
		var_1_25 = (max ((abs (var_1_27)) , 0));
	} else {
		if ((abs (var_1_18)) >= (var_1_4 - var_1_21)) {
			var_1_25 = var_1_27;
		}
	}


	// From: Req7Batch7Filler_PR_CI
	if (var_1_4 > var_1_2) {
	...
	// From: Req8Batch7Filler_PR_CI
	var_1_24 = 16;


	// From: Req1Batch7Filler_PR_CI
	...
	// From: CodeObject2
	if (var_1_5 >= (abs (var_1_10 | var_1_27))) {
		var_1_34 = ((max ((abs (var_1_5)) , var_1_5)) - (abs (var_1_6)));
	} else {
		if (var_1_5 >= var_1_27) {
			if (var_1_4 > var_1_4) {
				var_1_34 = (abs (var_1_6));
			}
		}
	}
	...
	if (var_1_27 == (var_1_6 ^ var_1_16)) {
		var_1_39 = ((min (var_1_21 , (min (var_1_21 , var_1_22)))) - (var_1_43 - var_1_44));
	} else {
		var_1_39 = ((min ((abs (var_1_22)) , var_1_43)) - 255.4f);
	}
