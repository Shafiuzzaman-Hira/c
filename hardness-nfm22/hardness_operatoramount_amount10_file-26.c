...
void step(void) {
	// From: Req1Batch26Amount10
	if (var_1_2) {
		var_1_1 = (max (var_1_3 , (var_1_4 + var_1_5)));
	} else {
		var_1_1 = (3164264966u - (min (var_1_5 , (var_1_6 - var_1_7))));
	}


	// From: Req2Batch26Amount10
	var_1_8 = var_1_9;


	// From: Req3Batch26Amount10
	var_1_10 = var_1_11;
}
...
int property() {
	return ((var_1_2 ? (var_1_1 == ((unsigned long int) (max (var_1_3 , (var_1_4 + var_1_5))))) : (var_1_1 == ((unsigned long int) (3164264966u - (min (var_1_5 , (var_1_6 - var_1_7))))))) && (var_1_8 == ((double) var_1_9))) && (var_1_10 == ((signed short int) var_1_11))
;
}
int main(void) {
	isInitial = 1;
