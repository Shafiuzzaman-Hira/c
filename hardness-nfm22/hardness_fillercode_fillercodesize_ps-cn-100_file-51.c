...
void step(void) {
	...
	// From: Req4Batch51PS_CN_100
	if ((min ((~ var_1_1) , 8)) > var_1_11) {
		var_1_17 = var_1_18;
	}


	// From: Req2Batch51PS_CN_100
	if (! (var_1_17 > var_1_5)) {
