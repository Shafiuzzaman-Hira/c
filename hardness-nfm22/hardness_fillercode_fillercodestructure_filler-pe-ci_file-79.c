...
void step(void) {
	...
	// From: Req7Batch79Filler_PE_CI
	var_1_26 = var_1_16;


	// From: Req8Batch79Filler_PE_CI
	var_1_27 = 10u;
	...
	// From: CodeObject2
	var_1_32 = (max ((min (var_1_16 , var_1_16)) , var_1_10));


	// From: CodeObject3
	var_1_36 = ((max (var_1_7 , (abs (var_1_8)))) + var_1_7);


	// From: CodeObject4
	if (256 > (-10 >> var_1_23)) {
		var_1_38 = (var_1_16 - (min ((var_1_40 - 128.375) , var_1_16)));
	} else {
		var_1_38 = var_1_16;
	}
	...
	if (! (var_1_17 >= (var_1_16 - var_1_40))) {
		var_1_42 = (min ((var_1_7 - 256) , var_1_20));
	}


	// From: CodeObject6
	if (((var_1_8 * var_1_23) | var_1_7) <= (var_1_20 + 8u)) {
		if ((min (16u , var_1_20)) < var_1_23) {
			var_1_45 = var_1_19;
		} else {
	...
	// From: CodeObject7
	if (0.83f > var_1_11) {
		if ((var_1_24 + (abs (var_1_24))) <= var_1_24) {
			var_1_49 = var_1_11;
		}
	} else {
		var_1_49 = var_1_11;
