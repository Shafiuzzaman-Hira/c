...
void step(void) {
 ...
 if (stepLocal_0 >= (*(var_1_15_Pointer))) {
  (*(var_1_1_Pointer)) = (((((*(var_1_3_Pointer))) < (((((1) < 0 ) ? -(1) : (1))))) ? ((*(var_1_3_Pointer))) : (((((1) < 0 ) ? -(1) : (1))))));
 }
 unsigned char stepLocal_2 = (*(var_1_3_Pointer));
 if ((*(var_1_9_Pointer))) {
  if (stepLocal_2 > (*(var_1_15_Pointer))) {
   (*(var_1_11_Pointer)) = (((((((((*(var_1_12_Pointer))) > (16.5)) ? ((*(var_1_12_Pointer))) : (16.5)))) > ((*(var_1_13_Pointer)))) ? ((((((*(var_1_12_Pointer))) > (16.5)) ? ((*(var_1_12_Pointer))) : (16.5)))) : ((*(var_1_13_Pointer)))));
  } else {
   if ((*(var_1_10_Pointer))) {
 ...
 signed long int stepLocal_1 = (((10) > ((*(var_1_1_Pointer)))) ? (10) : ((*(var_1_1_Pointer))));
 if ((8 * (*(var_1_1_Pointer))) == stepLocal_1) {
  if ((*(var_1_6_Pointer))) {
   (*(var_1_4_Pointer)) = (((*(var_1_11_Pointer)) < (*(var_1_14_Pointer))) && (*(var_1_9_Pointer)));
  } else {
   if ((*(var_1_14_Pointer)) >= (((((*(var_1_11_Pointer))) < 0 ) ? -((*(var_1_11_Pointer))) : ((*(var_1_11_Pointer)))))) {
