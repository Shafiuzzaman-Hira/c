...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch44PS_CN_25.c", 13, "reach_error"); }
...
double var_1_38 = 10000000000.4;
double var_1_39 = 8.4;
double var_1_40 = 200.5;
unsigned short int var_1_41 = 256;
unsigned short int var_1_42 = 5;
unsigned long int var_1_43 = 2299204783;
...
void step(void) {
	...
	if (var_1_33 > var_1_34) {
		if ((var_1_33 / var_1_36) <= (var_1_34 | var_1_37)) {
			if ((min (var_1_38 , var_1_39)) < var_1_40) {
				var_1_35 = var_1_34;
			} else {
				var_1_35 = 5;
			}
	...
	// From: CodeObject4
	if ((-10 % var_1_36) >= (~ (var_1_43 - var_1_34))) {
		if (var_1_44) {
			var_1_42 = var_1_33;
		}
	} else {
	...
	if (var_1_42 < var_1_46) {
		var_1_45 = ((var_1_34 + (var_1_47 - var_1_33)) - var_1_48);
	}


	// From: Req2Batch44PS_CN_25
	...
	// From: Req8Batch44PS_CN_25
	var_1_31 = var_1_26;


	// From: Req9Batch44PS_CN_25
	var_1_32 = var_1_21;


	// From: Req7Batch44PS_CN_25
	var_1_30 = (max (var_1_15 , var_1_32));


	// From: Req1Batch44PS_CN_25
