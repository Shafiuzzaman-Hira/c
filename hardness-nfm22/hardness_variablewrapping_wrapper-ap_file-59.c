...
void step(void) {
	...
	// From: Req1Batch59Wrapper_AP
	if ((max ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) , 1)) <= (256 + last_1_signed_long_int_Array_0_2_)) {
