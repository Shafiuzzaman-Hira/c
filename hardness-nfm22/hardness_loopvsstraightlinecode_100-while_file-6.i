...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch6100_while.c", 13, "reach_error"); }
...
void step(void) {
 var_1_9 = (((((last_1_var_1_22) < 0 ) ? -(last_1_var_1_22) : (last_1_var_1_22))) - last_1_var_1_22);
 ...
 if (var_1_2 || var_1_3) {
  var_1_1 = ((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22)));
 } else {
  var_1_1 = (((((var_1_5 - var_1_22)) < (var_1_22)) ? ((var_1_5 - var_1_22)) : (var_1_22)));
 }
 if (var_1_22 <= (- 500)) {
  if (var_1_2) {
   var_1_7 = (var_1_22 - 64);
 ...
 if (var_1_2) {
  ...
  if (((((var_1_22) < (var_1_22)) ? (var_1_22) : (var_1_22))) <= stepLocal_0) {
   var_1_16 = 128u;
  } else {
   var_1_16 = var_1_22;
  }
 ...
 var_1_28 = var_1_21;
 if (! ((! var_1_3) && var_1_18)) {
  var_1_24 = ((((((((var_1_22) < (var_1_22)) ? (var_1_22) : (var_1_22)))) < (var_1_28)) ? (((((var_1_22) < (var_1_22)) ? (var_1_22) : (var_1_22)))) : (var_1_28)));
 } else {
 ...
 if (((var_1_14 - var_1_13) / ((((var_1_26) > (var_1_27)) ? (var_1_26) : (var_1_27)))) >= var_1_15) {
  if (var_1_14 >= var_1_13) {
   if ((var_1_22 << var_1_22) <= stepLocal_4) {
    var_1_25 = (((((var_1_22) < (var_1_16)) ? (var_1_22) : (var_1_16))) - var_1_23);
   } else {
 ...
 if (var_1_24 >= stepLocal_1) {
  if (! var_1_2) {
   ...
   if (var_1_2) {
    if (var_1_18) {
     var_1_19 = ((var_1_21 - ((((var_1_20) > (var_1_22)) ? (var_1_20) : (var_1_22)))) - (var_1_22 + ((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25)))));
    }
   }
  }
 } else {
