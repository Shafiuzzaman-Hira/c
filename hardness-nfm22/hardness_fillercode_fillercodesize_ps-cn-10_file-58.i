...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch58PS_CN_10.c", 13, "reach_error"); }
...
double var_1_28 = 31.5;
double var_1_29 = 0.30000000000000004;
...
void step(void) {
 ...
 var_1_27 = 0;
 var_1_28 = var_1_29;
 if ((var_1_24 >> var_1_31) < ((((-256) < 0 ) ? -(-256) : (-256)))) {
  var_1_30 = var_1_27;
 }
