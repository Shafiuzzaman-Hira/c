...
void step(void) {
 signed long int stepLocal_1 = (((((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer))) < ((*(signed_char_Array_0_arraysigned_char_Array_0Var3_Pointer)))) ? ((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer))) : ((*(signed_char_Array_0_arraysigned_char_Array_0Var3_Pointer))))) / (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer));
 ...
 if (((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) - (((((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer))) < 0 ) ? -((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer))) : ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)))))) >= (*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer))) {
