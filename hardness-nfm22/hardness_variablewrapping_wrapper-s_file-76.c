...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch76Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch76Wrapper_S
	signed char stepLocal_1 = WrapperStruct00.var_1_8;
	if (stepLocal_1 <= WrapperStruct00.var_1_8) {
		if (WrapperStruct00.var_1_1) {
			WrapperStruct00.var_1_6 = (3.17 - (max (127.2 , WrapperStruct00.var_1_7)));
		}
	}


	// From: Req4Batch76Wrapper_S
	if (WrapperStruct00.var_1_1) {
