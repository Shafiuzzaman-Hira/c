...
void step(void) {
	...
	if ((var_1_23 <= var_1_20) || var_1_6) {
		if ((abs (5)) < var_1_23) {
			if (var_1_6) {
				var_1_32 = (max ((min (var_1_10 , var_1_12)) , var_1_21));
			}
		}
	}
	...
	// From: CodeObject2
	if ((abs (4)) >= var_1_21) {
		if (((abs (var_1_18)) % (min (var_1_21 , var_1_21))) <= (var_1_20 ^ var_1_21)) {
			if ((min ((abs (var_1_18)) , var_1_21)) < var_1_21) {
				var_1_40 = var_1_43;
			} else {
				var_1_40 = var_1_43;
			}
	...
	if (var_1_21 <= var_1_23) {
		var_1_44 = (var_1_23 + (abs (max (var_1_21 , -1))));
	}


	// From: CodeObject4
	if (((~ var_1_10) >> (max (var_1_22 , var_1_22))) >= var_1_10) {
	...
	if ((~ var_1_20) > var_1_20) {
		var_1_52 = (min (((var_1_22 + var_1_23) - (abs (var_1_21))) , var_1_20));
	} else {
		var_1_52 = (min (var_1_21 , var_1_21));
	}
	...
	// From: Req7Batch96Filler_PS_CI
	var_1_31 = var_1_30;


	// From: Req1Batch96Filler_PS_CI
