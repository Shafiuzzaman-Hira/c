...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch1625_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch1625_while
	if ((var_1_10 % (max (var_1_3 , var_1_4))) <= -1000000) {
		var_1_1 = (((var_1_4 * var_1_3) >= var_1_10) || var_1_5);
	}


	// From: Req3Batch1625_while
	var_1_8 = (4 - var_1_9);
}
...
int property() {
	return (((((var_1_10 % (max (var_1_3 , var_1_4))) <= -1000000) ? (var_1_1 == ((unsigned char) (((var_1_4 * var_1_3) >= var_1_10) || var_1_5))) : 1) && ((last_1_var_1_10 <= (var_1_4 + var_1_3)) ? (var_1_6 == ((signed char) var_1_7)) : 1)) && (var_1_8 == ((signed short int) (4 - var_1_9)))) && (((var_1_9 / var_1_4) == var_1_6) ? (var_1_10 == ((signed char) var_1_7)) : ((var_1_7 >= var_1_6) ? (var_1_10 == ((signed char) (var_1_11 + (max ((var_1_12 + var_1_13) , var_1_14))))) : (var_1_10 == ((signed char) var_1_12))))
;
}
int main(void) {
	isInitial = 1;
