...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch34PS_CN_100.c", 13, "reach_error"); }
...
float var_1_46 = 0.09999999999999998;
...
void step(void) {
 ...
 if (var_1_27 < (~ (25u + var_1_28))) {
  var_1_26 = ((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29)));
 }
 if ((var_1_26 < var_1_29) || (var_1_28 >= var_1_27)) {
  var_1_30 = var_1_31;
 }
 if (var_1_28 <= (var_1_26 / ((((var_1_33) < 0 ) ? -(var_1_33) : (var_1_33))))) {
  if ((var_1_34 / var_1_33) <= var_1_29) {
   var_1_32 = ((((var_1_34) < ((((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))) - ((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26)))))) ? (var_1_34) : ((((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))) - ((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26)))))));
  }
 }
 if (((((~ var_1_27) < 0 ) ? -(~ var_1_27) : (~ var_1_27))) >= ((((var_1_34) < (8u)) ? (var_1_34) : (8u)))) {
  var_1_36 = ((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26)));
 } else {
  var_1_36 = (var_1_37 - 2);
 }
 if (var_1_28 < (var_1_34 + var_1_35)) {
  var_1_38 = ((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29)));
 }
 if (var_1_24 > var_1_22) {
  if (((((2) < (64)) ? (2) : (64))) < ((((var_1_37) > ((var_1_36 + var_1_38))) ? (var_1_37) : ((var_1_36 + var_1_38))))) {
   if (((((var_1_27) > (var_1_26)) ? (var_1_27) : (var_1_26))) <= var_1_35) {
    var_1_39 = (((((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29))) < 0 ) ? -((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29))) : ((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29)))));
   } else {
    var_1_39 = ((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29)));
   }
  } else {
   if (((((var_1_33) > (var_1_36)) ? (var_1_33) : (var_1_36))) >= var_1_28) {
    var_1_39 = (var_1_40 - ((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))));
   } else {
    if (var_1_28 >= var_1_36) {
     var_1_39 = (var_1_40 - var_1_41);
    } else {
     var_1_39 = ((((((((var_1_40) < (var_1_41)) ? (var_1_40) : (var_1_41)))) < (((((var_1_42 + var_1_43) < 0 ) ? -(var_1_42 + var_1_43) : (var_1_42 + var_1_43))))) ? (((((var_1_40) < (var_1_41)) ? (var_1_40) : (var_1_41)))) : (((((var_1_42 + var_1_43) < 0 ) ? -(var_1_42 + var_1_43) : (var_1_42 + var_1_43))))));
    }
   }
  }
 }
 if (((((var_1_41) > ((var_1_37 - var_1_43))) ? (var_1_41) : ((var_1_37 - var_1_43)))) <= (((((10000000 % var_1_33)) < (var_1_40)) ? ((10000000 % var_1_33)) : (var_1_40)))) {
  if (var_1_31) {
   if ((((((var_1_29) < (var_1_28)) ? (var_1_29) : (var_1_28))) + (var_1_36 % var_1_33)) <= var_1_45) {
    var_1_44 = ((((((((var_1_24) > (var_1_23)) ? (var_1_24) : (var_1_23)))) > (((((9.5f) > (var_1_46)) ? (9.5f) : (var_1_46))))) ? (((((var_1_24) > (var_1_23)) ? (var_1_24) : (var_1_23)))) : (((((9.5f) > (var_1_46)) ? (9.5f) : (var_1_46))))));
   } else {
    var_1_44 = (var_1_25 + 1.7f);
   }
  }
 }
 var_1_47 = ((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39)));
 if (var_1_39 < var_1_45) {
  if (var_1_39 > var_1_28) {
   var_1_48 = (var_1_25 + var_1_24);
  } else {
   var_1_48 = ((((var_1_25) > ((var_1_23 + var_1_24))) ? (var_1_25) : ((var_1_23 + var_1_24))));
  }
 }
