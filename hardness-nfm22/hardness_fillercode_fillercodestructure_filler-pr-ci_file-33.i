...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch33Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((- ((((var_1_19) > (var_1_19)) ? (var_1_19) : (var_1_19)))) == var_1_7) {
  var_1_22 = var_1_16;
 }
 ...
 if (0 <= (var_1_7 - ((((var_1_1) < (var_1_16)) ? (var_1_1) : (var_1_16))))) {
 ...
 var_1_27 = var_1_28;
 if (var_1_5 > var_1_14) {
  var_1_29 = ((((-2) > (var_1_17)) ? (-2) : (var_1_17)));
 }
 if (var_1_19 <= (var_1_19 / (var_1_33 - var_1_34))) {
  if (-64 >= (((((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17))) < 0 ) ? -((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17))) : ((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17)))))) {
   if (-8 > var_1_1) {
    if (var_1_8 >= var_1_28) {
     var_1_32 = (((((var_1_15 + var_1_18)) < (1)) ? ((var_1_15 + var_1_18)) : (1)));
    }
   } else {
    var_1_32 = (((((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15))) < 0 ) ? -((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15))) : ((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15)))));
   }
  } else {
   var_1_32 = (var_1_37 - var_1_15);
  }
 }
 if (var_1_33 < var_1_14) {
  var_1_38 = ((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19)));
 } else {
  if (var_1_34 <= var_1_7) {
   var_1_38 = ((((var_1_37) < (((((var_1_20) > (var_1_14)) ? (var_1_20) : (var_1_14))))) ? (var_1_37) : (((((var_1_20) > (var_1_14)) ? (var_1_20) : (var_1_14))))));
  }
 }
