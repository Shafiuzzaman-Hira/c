...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch88Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
	// From: CodeObject1
	if (var_1_8 && var_1_8) {
		if ((256 % var_1_31) >= (min (var_1_12 , var_1_21))) {
			var_1_25 = var_1_21;
		} else {
			var_1_25 = var_1_21;
		}
