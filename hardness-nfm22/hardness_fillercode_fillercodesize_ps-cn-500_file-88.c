...
void step(void) {
	...
	if (var_1_80 < var_1_81) {
		...
		var_1_79 = (min (var_1_58 , (abs (var_1_51))));
	}


	// From: CodeObject20
	if ((var_1_66 == var_1_69) || var_1_74) {
		var_1_82 = (abs (var_1_51));
	}


	// From: CodeObject21
	if ((~ var_1_84) < (var_1_66 * (min (var_1_39 , var_1_38)))) {
		if (var_1_85 <= var_1_62) {
			if (var_1_31 >= (var_1_28 >> 5)) {
				var_1_83 = (abs (abs (var_1_41)));
			} else {
				if ((max ((abs (var_1_70)) , var_1_62)) < var_1_60) {
					var_1_83 = (abs ((max (var_1_34 , var_1_33)) + var_1_86));
				} else {
		...
		var_1_83 = (max ((var_1_33 + var_1_34) , var_1_69));
	}
	...
	if (var_1_65 == var_1_42) {
		...
		var_1_87 = ((abs (var_1_88)) - var_1_40);
	}


	// From: CodeObject23
	if ((min (var_1_81 , (abs (var_1_44)))) < ((max (var_1_82 , var_1_54)) * var_1_55)) {
		if (((var_1_90 - var_1_33) - (abs (var_1_32))) > var_1_27) {
			var_1_89 = (abs (abs (var_1_58)));
		}
	}


	// From: CodeObject24
	if ((abs (var_1_84)) > var_1_39) {
		var_1_91 = (abs (var_1_35));
	}


	// From: CodeObject25
	if ((var_1_68 >= (min (var_1_83 , var_1_71))) && (var_1_65 < var_1_28)) {
		if (-8 <= (-5 >> var_1_72)) {
			if (var_1_81 >= (abs (abs (var_1_54)))) {
				var_1_92 = (max ((abs (var_1_86)) , var_1_90));
			}
		} else {
			var_1_92 = (abs (var_1_42));
		}
	} else {
	...
	if (var_1_32 < var_1_65) {
		if ((var_1_66 + (var_1_87 | var_1_40)) <= (abs (var_1_36))) {
			var_1_105 = ((abs (var_1_32)) - var_1_70);
		} else {
			var_1_105 = (min (-16 , (abs (var_1_41))));
		}
	}
	...
	// From: CodeObject38
	if (var_1_30) {
		var_1_106 = ((min (var_1_88 , var_1_107)) - (abs (var_1_104)));
	}


	// From: CodeObject39
	if ((var_1_38 & var_1_96) >= var_1_43) {
		var_1_108 = (max (var_1_88 , (abs (var_1_107 - var_1_83))));
	}
	...
	if (((99999.3f + var_1_54) * var_1_82) < var_1_55) {
		if (var_1_77) {
			...
			var_1_110 = (min (var_1_52 , var_1_51));
		}
	} else {
		if (var_1_76 || (var_1_65 < (var_1_70 / var_1_88))) {
			var_1_110 = (max (var_1_55 , (abs (var_1_52))));
		}
	}
	...
	if ((var_1_92 * var_1_102) > var_1_107) {
		if ((abs (var_1_43)) >= var_1_105) {
			var_1_112 = (min (var_1_26 , var_1_69));
		}
	} else {
		var_1_112 = ((abs (var_1_96 - var_1_92)) - (max (var_1_42 , var_1_104)));
	}
	...
	// From: CodeObject44
	if (var_1_57 < ((abs (var_1_89)) * (var_1_63 / 127.5f))) {
		var_1_114 = (abs (1.5f));
	} else {
		var_1_114 = (min ((var_1_111 + (abs (var_1_58))) , var_1_51));
	}
	...
	if (var_1_103) {
		if (var_1_94) {
			var_1_115 = (min ((var_1_58 - (var_1_116 - var_1_117)) , (var_1_111 + (abs (var_1_118)))));
		} else {
			var_1_115 = (min (var_1_119 , (min ((var_1_55 - var_1_116) , var_1_52))));
		}
	}
	...
	if ((var_1_38 % (var_1_90 + var_1_121)) < var_1_36) {
		var_1_120 = ((max ((abs (var_1_117)) , 5.2)) + ((var_1_122 - var_1_123) - (abs (var_1_118))));
	}


	// From: CodeObject47
	if ((- var_1_43) >= ((var_1_87 & var_1_106) & var_1_42)) {
		var_1_124 = (max ((abs (var_1_86)) , (min (var_1_90 , var_1_34))));
	}


	// From: CodeObject48
	if (var_1_63 <= var_1_116) {
		if (var_1_32 >= (var_1_28 * (max (-4 , 100)))) {
			var_1_125 = var_1_33;
		} else {
			if (-0.5 >= (abs (var_1_79))) {
				var_1_125 = (abs (var_1_121));
			}
		}
	}
	...
	// From: CodeObject49
	if ((max (var_1_98 , var_1_112)) < var_1_108) {
		var_1_126 = ((max (var_1_117 , (abs (var_1_116)))) - (min (var_1_58 , (abs (var_1_52)))));
	} else {
		var_1_126 = (abs (abs (var_1_51)));
	}
	...
	if (var_1_101) {
		if (var_1_69 > (abs (16))) {
			if (var_1_77) {
				var_1_127 = (min ((min (var_1_34 , var_1_32)) , var_1_42));
			}
		}
	}
	...
	// From: CodeObject54
	if ((abs (var_1_112)) > (max ((var_1_39 - var_1_68) , -10))) {
		var_1_132 = (abs (var_1_41));
	} else {
		if (var_1_125 <= 32u) {
			var_1_132 = var_1_34;
		} else {
