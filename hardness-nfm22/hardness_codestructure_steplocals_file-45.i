...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch45stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_7 = (((((var_1_8 - var_1_3)) < (var_1_9)) ? ((var_1_8 - var_1_3)) : (var_1_9)));
 if (var_1_8 > var_1_9) {
 ...
 if (! var_1_2) {
  if (var_1_2) {
   var_1_14 = ((32 + var_1_3) + ((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))));
  } else {
   var_1_14 = -50;
  }
 }
...
int property() {
 return (((((((var_1_2 ? (((~ var_1_3) <= (var_1_4 + 100000000)) ? ((! var_1_5) ? (var_1_1 == ((signed short int) ((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3))))) : (var_1_1 == ((signed short int) (var_1_3 + 32)))) : (var_1_1 == ((signed short int) var_1_3))) : (var_1_1 == ((signed short int) var_1_3))) && ((var_1_1 <= var_1_4) ? ((var_1_4 <= var_1_3) ? (var_1_6 == ((signed long int) var_1_3)) : 1) : 1)) && (var_1_7 == ((unsigned short int) (((((var_1_8 - var_1_3)) < (var_1_9)) ? ((var_1_8 - var_1_3)) : (var_1_9)))))) && ((var_1_8 > var_1_9) ? (var_1_10 == ((signed char) ((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))))) : (var_1_10 == ((signed char) (var_1_12 - (var_1_13 - 8)))))) && ((! var_1_2) ? (var_1_2 ? (var_1_14 == ((signed short int) ((32 + var_1_3) + ((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11)))))) : (var_1_14 == ((signed short int) -50))) : 1)) && ((var_1_10 >= (var_1_6 * (var_1_4 + var_1_8))) ? (var_1_15 == ((signed char) ((((((((var_1_13) > (var_1_11)) ? (var_1_13) : (var_1_11)))) < (((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12))))) ? (((((var_1_13) > (var_1_11)) ? (var_1_13) : (var_1_11)))) : (((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12)))))))) : (var_1_15 == ((signed char) ((((var_1_11) < (var_1_12)) ? (var_1_11) : (var_1_12))))))) && (var_1_2 ? (var_1_16 == ((unsigned char) (var_1_5 || var_1_17))) : 1)) && (var_1_18 == ((unsigned long int) var_1_8))
;
}
int main(void) {
 isInitial = 1;
