...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch9PS_CN_10.c", 13, "reach_error"); }
...
double var_1_26 = 99999999.01;
float var_1_27 = 999999999.5;
...
void step(void) {
	...
	// From: Req3Batch9PS_CN_10
	if (((var_1_6 >> 2) * last_1_var_1_13) > last_1_var_1_10) {
		var_1_12 = var_1_6;
	}


	// From: Req2Batch9PS_CN_10
	...
	// From: Req6Batch9PS_CN_10
	var_1_18 = var_1_3;


	// From: Req5Batch9PS_CN_10
