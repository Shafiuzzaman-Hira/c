...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch62Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch62Filler_PS_CN
	if (var_1_10 || var_1_20) {
		var_1_19 = (max (var_1_21 , 32));
	}


	// From: Req7Batch62Filler_PS_CN
	if (var_1_10) {
