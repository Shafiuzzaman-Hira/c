...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch24PS_CN_50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch24PS_CN_50
	var_1_23 = var_1_24;


	// From: Req3Batch24PS_CN_50
	if (128u >= var_1_8) {
		if (! var_1_23) {
