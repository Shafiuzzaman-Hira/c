...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch2825_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch2825_1loop
	var_1_11 = (max (var_1_9 , var_1_10));


	// From: Req4Batch2825_1loop
