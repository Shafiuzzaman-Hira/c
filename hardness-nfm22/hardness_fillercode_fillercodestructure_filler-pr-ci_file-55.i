...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch55Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_1 > var_1_1) {
  if ((var_1_1 * ((((var_1_1) > (var_1_8)) ? (var_1_1) : (var_1_8)))) < ((((var_1_8) < (32.55f)) ? (var_1_8) : (32.55f)))) {
   if (var_1_8 > 24.443f) {
    var_1_32 = var_1_14;
   }
  }
 ...
 if (var_1_1 >= 127.5f) {
  if ((var_1_14 >> var_1_18) < ((((-1) < 0 ) ? -(-1) : (-1)))) {
   var_1_41 = (((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19))) + (var_1_28 - (2 + var_1_20)));
  } else {
   var_1_41 = var_1_19;
  }
 } else {
 ...
 if (var_1_1 < (((((var_1_7 / 15.175f)) > ((- var_1_8))) ? ((var_1_7 / 15.175f)) : ((- var_1_8))))) {
  var_1_49 = (! var_1_25);
 } else {
  if (var_1_25) {
   var_1_49 = (var_1_31 || (var_1_23 || var_1_24));
  }
 }
 ...
 if (var_1_24) {
  var_1_47 = (var_1_18 + ((((var_1_12) > (var_1_19)) ? (var_1_12) : (var_1_19))));
 }
 if (var_1_23) {
