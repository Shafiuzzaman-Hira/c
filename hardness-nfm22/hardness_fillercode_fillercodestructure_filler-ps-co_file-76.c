...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch76Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject6
	if (var_1_18 < (abs (var_1_18))) {
		if (var_1_25 && ((~ 0u) > var_1_17)) {
			var_1_32 = var_1_18;
		}
	}
	...
	if (var_1_18 < var_1_14) {
		...
		if ((- var_1_22) > var_1_8) {
			if (var_1_8 >= var_1_22) {
				var_1_34 = (abs (abs (var_1_18 - var_1_14)));
			} else {
				var_1_34 = var_1_11;
			}
		}
	...
	// From: CodeObject9
	if ((max (var_1_18 , var_1_18)) <= ((var_1_18 & var_1_14) & var_1_18)) {
