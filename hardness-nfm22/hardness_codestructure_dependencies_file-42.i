...
void step(void) {
 ...
 if (last_1_var_1_13 >= (var_1_6 / var_1_7)) {
  if (var_1_6 != ((((((((var_1_6) > (last_1_var_1_13)) ? (var_1_6) : (last_1_var_1_13)))) > (var_1_5)) ? (((((var_1_6) > (last_1_var_1_13)) ? (var_1_6) : (last_1_var_1_13)))) : (var_1_5)))) {
   var_1_13 = var_1_7;
  } else {
 ...
 if (var_1_19) {
  ...
  if (((((var_1_5) < 0 ) ? -(var_1_5) : (var_1_5))) >= var_1_6) {
   var_1_1 = var_1_5;
  }
 }
