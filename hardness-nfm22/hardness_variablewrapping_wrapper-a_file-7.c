...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch7Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (! (last_1_double_Array_0_0_ <= (float_Array_0[1] - float_Array_0[0]))) {
	...
	if (BOOL_unsigned_char_Array_0[0] || ((unsigned_char_Array_0[0] / unsigned_short_int_Array_0[0]) >= unsigned_char_Array_0[1])) {
	...
	if (BOOL_unsigned_char_Array_0[0]) {
		if (BOOL_unsigned_char_Array_0[1] && (float_Array_0[0] <= double_Array_0[0])) {
			if ((max (float_Array_0[0] , double_Array_0[1])) > double_Array_0[0]) {
				unsigned_long_int_Array_0[0] = (max (((3725801564u - unsigned_char_Array_0[0]) - unsigned_char_Array_0[1]) , unsigned_short_int_Array_0[0]));
			} else {
