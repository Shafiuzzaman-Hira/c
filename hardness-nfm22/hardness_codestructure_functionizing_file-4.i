...
signed long int functionized4(signed long int localFunctionVar0) {
 return ((((var_1_19) > (localFunctionVar0)) ? (var_1_19) : (localFunctionVar0)));
}
void initially(void) {
}
void step(void) {
 ...
 if (var_1_1 && (functionized3(var_1_5, var_1_13))) {
  if (var_1_1 || (var_1_9 >= ((((var_1_18) > (var_1_7)) ? (var_1_18) : (var_1_7))))) {
   var_1_17 = (((((functionized4(256) + (var_1_20 - var_1_21))) < ((var_1_22 + 64))) ? ((functionized4(256) + (var_1_20 - var_1_21))) : ((var_1_22 + 64))));
  } else {
   var_1_17 = var_1_19;
  }
 }
