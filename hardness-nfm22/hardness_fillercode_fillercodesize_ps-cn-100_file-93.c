...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch93PS_CN_100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject9
	if ((- var_1_45) >= (~ (var_1_48 / var_1_59))) {
		var_1_58 = var_1_54;
	}


	// From: Req3Batch93PS_CN_100
	if (var_1_10) {
	...
	// From: Req6Batch93PS_CN_100
	if (var_1_15) {
		var_1_21 = ((var_1_22 + 25) - var_1_19);
	}


	// From: Req7Batch93PS_CN_100
	if (var_1_10) {
	...
	// From: Req5Batch93PS_CN_100
	if (var_1_16) {
		var_1_20 = (var_1_9 - 50);
	}


	// From: Req1Batch93PS_CN_100
...
void updateVariables() {
	...
	assume_abort_if_not(var_1_59 >= -2147483648);
