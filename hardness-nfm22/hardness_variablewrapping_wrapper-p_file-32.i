...
void step(void) {
 if (last_1_var_1_6 >= -50) {
  (*(var_1_1_Pointer)) = ((((((*(var_1_3_Pointer)) + (((((*(var_1_4_Pointer))) < 0 ) ? -((*(var_1_4_Pointer))) : ((*(var_1_4_Pointer))))))) > ((*(var_1_5_Pointer)))) ? (((*(var_1_3_Pointer)) + (((((*(var_1_4_Pointer))) < 0 ) ? -((*(var_1_4_Pointer))) : ((*(var_1_4_Pointer))))))) : ((*(var_1_5_Pointer)))));
 }
 ...
 if ((*(var_1_4_Pointer)) <= stepLocal_2) {
  if ((*(var_1_1_Pointer)) < stepLocal_1) {
   ...
   (*(var_1_11_Pointer)) = (((((((*(var_1_8_Pointer)) + (*(var_1_3_Pointer))) - (*(var_1_12_Pointer)))) > (100)) ? ((((*(var_1_8_Pointer)) + (*(var_1_3_Pointer))) - (*(var_1_12_Pointer)))) : (100)));
  }
 } else {
...
int property() {
 return (((last_1_var_1_6 >= -50) ? ((*(var_1_1_Pointer)) == ((unsigned short int) ((((((*(var_1_3_Pointer)) + (((((*(var_1_4_Pointer))) < 0 ) ? -((*(var_1_4_Pointer))) : ((*(var_1_4_Pointer))))))) > ((*(var_1_5_Pointer)))) ? (((*(var_1_3_Pointer)) + (((((*(var_1_4_Pointer))) < 0 ) ? -((*(var_1_4_Pointer))) : ((*(var_1_4_Pointer))))))) : ((*(var_1_5_Pointer))))))) : 1) && ((((*(var_1_7_Pointer)) - (*(var_1_8_Pointer))) < (*(var_1_1_Pointer))) ? ((*(var_1_9_Pointer)) ? ((*(var_1_6_Pointer)) == ((signed short int) (*(var_1_8_Pointer)))) : ((*(var_1_10_Pointer)) ? ((*(var_1_6_Pointer)) == ((signed short int) (*(var_1_7_Pointer)))) : 1)) : 1)) && (((*(var_1_4_Pointer)) <= ((*(var_1_6_Pointer)) + (*(var_1_3_Pointer)))) ? (((*(var_1_1_Pointer)) < ((*(var_1_7_Pointer)) + (4 - (*(var_1_3_Pointer))))) ? ((*(var_1_9_Pointer)) ? ((*(var_1_11_Pointer)) == ((signed long int) ((*(var_1_3_Pointer)) - ((*(var_1_12_Pointer)) - ((*(var_1_13_Pointer)) - (*(var_1_4_Pointer))))))) : 1) : ((*(var_1_11_Pointer)) == ((signed long int) (((((((*(var_1_8_Pointer)) + (*(var_1_3_Pointer))) - (*(var_1_12_Pointer)))) > (100)) ? ((((*(var_1_8_Pointer)) + (*(var_1_3_Pointer))) - (*(var_1_12_Pointer)))) : (100)))))) : ((*(var_1_11_Pointer)) == ((signed long int) (*(var_1_7_Pointer)))))
;
}
int main(void) {
 isInitial = 1;
