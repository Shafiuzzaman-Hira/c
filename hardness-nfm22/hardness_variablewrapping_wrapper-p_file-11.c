...
void step(void) {
	...
	if ((*(var_1_3_Pointer)) >= (*(var_1_2_Pointer))) {
		if (last_1_var_1_11) {
			if (! last_1_var_1_11) {
				(*(var_1_8_Pointer)) = (max ((*(var_1_9_Pointer)) , (10.25f + (*(var_1_10_Pointer)))));
			} else {
	...
	// From: Req4Batch11Wrapper_P
	if (! (*(var_1_11_Pointer))) {
		(*(var_1_14_Pointer)) = (min ((min ((*(var_1_15_Pointer)) , (max ((*(var_1_16_Pointer)) , 5)))) , (*(var_1_17_Pointer))));
	} else {
