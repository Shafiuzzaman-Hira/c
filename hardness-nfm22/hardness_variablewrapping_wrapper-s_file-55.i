...
void step(void) {
 ...
 if (WrapperStruct00.var_1_2) {
  if (stepLocal_1 && WrapperStruct00.var_1_5) {
   if (last_1_WrapperStruct00_var_1_12 >= stepLocal_0) {
    ...
    WrapperStruct00.var_1_1 = ((((25) < (last_1_WrapperStruct00_var_1_17)) ? (25) : (last_1_WrapperStruct00_var_1_17)));
   }
  }
 } else {
 ...
 signed long int stepLocal_3 = ((((-4 >> WrapperStruct00.var_1_1)) < (WrapperStruct00.var_1_1)) ? ((-4 >> WrapperStruct00.var_1_1)) : (WrapperStruct00.var_1_1));
