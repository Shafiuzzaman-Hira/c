...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch27Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_29 = var_1_30;
 if (var_1_8 >= var_1_8) {
  var_1_31 = ((((var_1_8) > (((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12))))) ? (var_1_8) : (((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12))))));
 }
 ...
 if (((((var_1_22) < (var_1_33)) ? (var_1_22) : (var_1_33))) < (var_1_39 + var_1_8)) {
