...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch34no_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch34no_floats
	if (var_1_1 >= (- (var_1_4 * var_1_1))) {
		var_1_17 = var_1_15;
	}


	// From: Req2Batch34no_floats
...
int property() {
	return (((last_1_var_1_5 ? (last_1_var_1_5 ? (var_1_1 == ((signed long int) (abs (var_1_4)))) : 1) : 1) && ((var_1_3 || (256 >= (var_1_17 + 4))) ? (var_1_5 == ((unsigned char) ((var_1_2 || var_1_3) || var_1_7))) : (var_1_5 == ((unsigned char) (! (! (var_1_8 || var_1_9))))))) && ((-10 >= var_1_17) ? ((((var_1_11 + var_1_12) - (min (var_1_13 , 1))) > (~ var_1_17)) ? (var_1_10 == ((signed char) (var_1_14 + var_1_15))) : (var_1_10 == ((signed char) var_1_16))) : 1)) && ((var_1_1 >= (- (var_1_4 * var_1_1))) ? (var_1_17 == ((signed char) var_1_15)) : 1)
;
}
int main(void) {
	isInitial = 1;
