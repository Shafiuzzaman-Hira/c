...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch3Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject1
	if (var_1_6 >= (max (var_1_23 , var_1_23))) {
		var_1_24 = (min ((max (var_1_23 , var_1_6)) , var_1_23));
	} else {
		var_1_24 = ((abs (var_1_6)) + (abs (var_1_23)));
	}


	// From: Req4Batch3Filler_PR_CO
	...
	// From: CodeObject3
	if (((var_1_23 ^ var_1_20) % var_1_31) > -10) {
		var_1_30 = (abs (var_1_1));
	}


	// From: CodeObject5
	if (var_1_23 >= ((var_1_35 & var_1_6) >> var_1_20)) {
		var_1_37 = (min (var_1_33 , var_1_38));
	}


	// From: Req1Batch3Filler_PR_CO
	...
	// From: CodeObject4
	if ((~ var_1_20) <= ((max (var_1_10 , -16)) & 16)) {
		var_1_32 = var_1_33;
	} else {
		if (var_1_6 <= ((min (var_1_34 , var_1_35)) - (abs (var_1_20)))) {
			var_1_32 = var_1_33;
		} else {
			var_1_32 = var_1_33;
		}
