...
void step(void) {
	// From: Req3Batch61Wrapper_A
	if (BOOL_unsigned_char_Array_0[0][0]) {
		unsigned_char_Array_0[4] = (unsigned_char_Array_0[3] + (max (unsigned_char_Array_0[0] , unsigned_char_Array_0[1])));
	} else {
	...
	// From: Req2Batch61Wrapper_A
	if (double_Array_0[0] < (max (float_Array_0[0] , float_Array_0[0]))) {
