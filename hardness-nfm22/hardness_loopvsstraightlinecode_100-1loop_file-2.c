...
void step(void) {
	...
	// From: Req3Batch2100_1loop
	if (var_1_7) {
		var_1_12 = var_1_5;
	}


	// From: Req7Batch2100_1loop
	...
	// From: Req13Batch2100_1loop
	var_1_36 = var_1_3;


	// From: Req14Batch2100_1loop
	var_1_37 = var_1_4;


	// From: Req2Batch2100_1loop
	...
	// From: Req4Batch2100_1loop
	var_1_13 = (abs (var_1_26));


	// From: Req10Batch2100_1loop
