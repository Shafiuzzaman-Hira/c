...
void step(void) {
	// From: CodeObject1
	if (var_1_25 < (var_1_18 - (abs (var_1_22)))) {
		if (var_1_10) {
			var_1_27 = var_1_22;
		}
	}
	...
	// From: CodeObject5
	if ((abs (var_1_24)) < (var_1_12 % var_1_4)) {
	...
	// From: CodeObject6
	if (var_1_10) {
		var_1_46 = (var_1_23 + (abs (var_1_22)));
	} else {
	...
	// From: Req4Batch26Filler_PS_CI
	if (var_1_11 > (var_1_22 * (var_1_12 + var_1_22))) {
		var_1_20 = var_1_21;
	}


	// From: Req6Batch26Filler_PS_CI
