...
void step(void) {
	// From: Req4Batch87no_floats
	var_1_12 = var_1_8;


	// From: Req5Batch87no_floats
	var_1_13 = var_1_14;


	// From: Req6Batch87no_floats
	var_1_15 = var_1_9;


	// From: Req1Batch87no_floats
	if (var_1_13) {
		var_1_1 = (abs (var_1_3 - var_1_4));
	}


	// From: Req2Batch87no_floats
