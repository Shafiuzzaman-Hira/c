...
void step(void) {
	...
	if ((last_1_var_1_31 + var_1_7) > stepLocal_5) {
		...
		var_1_32 = (var_1_8 + (max ((last_1_var_1_38 + var_1_10) , var_1_33)));
	}


	// From: Req1Batch19Amount250
	unsigned char stepLocal_1 = last_1_var_1_12;
	signed long int stepLocal_0 = last_1_var_1_40;
	if (stepLocal_1 && last_1_var_1_46) {
		if (stepLocal_0 <= (max (last_1_var_1_34 , last_1_var_1_40))) {
			if (last_1_var_1_46) {
	...
	// From: Req17Batch19Amount250
	if (var_1_12 && var_1_12) {
		var_1_52 = (abs (var_1_9));
	}


	// From: Req3Batch19Amount250
	...
	// From: Req6Batch19Amount250
	var_1_31 = (abs (var_1_11));


	// From: Req19Batch19Amount250
	var_1_54 = var_1_11;


	// From: Req20Batch19Amount250
	var_1_55 = var_1_11;


	// From: Req11Batch19Amount250
	...
	// From: Req14Batch19Amount250
	signed long int stepLocal_16 = var_1_31 / (min (var_1_33 , 10000));
	...
	// From: Req12Batch19Amount250
	if (var_1_46) {
		var_1_41 = var_1_55;
	}


	// From: Req15Batch19Amount250
	if (var_1_32 < var_1_31) {
		if (var_1_18) {
			var_1_47 = (min (var_1_21 , var_1_29));
		} else {
			if (25.85 < var_1_25) {
				var_1_47 = (max (var_1_26 , var_1_30));
			} else {
		...
		if (var_1_8 < var_1_41) {
			if (var_1_46) {
				...
				var_1_47 = (max (((4.3 + var_1_29) - (var_1_48 - var_1_28)) , (min (var_1_22 , var_1_26))));
			}
		} else {
	...
	if (var_1_47 >= (abs (var_1_47))) {
		if (var_1_33 < stepLocal_8) {
			if (last_1_var_1_34 < stepLocal_9) {
				var_1_34 = (min (var_1_9 , var_1_7));
			} else {
				var_1_34 = (min ((var_1_10 - var_1_8) , var_1_11));
			}
		}
	} else {
	...
	// From: Req9Batch19Amount250
	var_1_36 = ((var_1_37 - var_1_41) - (max (var_1_34 , var_1_9)));


	// From: Req13Batch19Amount250
	...
	if (var_1_24 < 9.8f) {
		...
		if (stepLocal_15 > var_1_7) {
			if (! (var_1_12 && var_1_19)) {
				var_1_42 = ((abs (var_1_43 - var_1_32)) + var_1_9);
			} else {
				if (var_1_10 != stepLocal_14) {
					var_1_42 = ((min (var_1_37 , 3600336302u)) - var_1_9);
				}
			}
		} else {
			if (var_1_22 > (var_1_25 + (var_1_24 / var_1_44))) {
				var_1_42 = (var_1_43 + (var_1_9 + (max (var_1_1 , var_1_10))));
			} else {
				var_1_42 = ((abs (min (var_1_37 , var_1_45))) - var_1_7);
			}
		}
	}


	// From: Req21Batch19Amount250
	if (var_1_18 || ((- var_1_27) >= (var_1_22 * var_1_47))) {
		if ((abs (var_1_41)) == var_1_42) {
			var_1_56 = ((min (var_1_9 , var_1_58)) + -25);
		}
	} else {
		var_1_56 = var_1_59;
	}
	...
	if ((- (var_1_7 * var_1_9)) >= stepLocal_3) {
		if (var_1_18) {
			if (var_1_42 != stepLocal_4) {
				...
				var_1_23 = ((abs (var_1_24)) + (var_1_25 + var_1_26));
			}
		} else {
	...
	// From: Req16Batch19Amount250
	unsigned char stepLocal_18 = var_1_12;
	signed long int stepLocal_17 = 5;
	if ((var_1_40 <= 2) || stepLocal_18) {
		var_1_49 = (var_1_39 + (min (var_1_11 , var_1_32)));
	} else {
		if ((var_1_30 - 16.25f) > ((var_1_29 + 3.4f) - (abs (var_1_23)))) {
			if ((var_1_42 * (abs (var_1_33))) >= stepLocal_17) {
				var_1_49 = ((var_1_43 + (1784827551u - var_1_42)) - ((var_1_51 - var_1_10) + 64u));
			} else {
				var_1_49 = (max (var_1_7 , var_1_33));
			}
		} else {
...
int property() {
	return (((((((((((((((((((((last_1_var_1_12 && last_1_var_1_46) ? ((last_1_var_1_40 <= (max (last_1_var_1_34 , last_1_var_1_40))) ? (last_1_var_1_46 ? (var_1_1 == ((unsigned char) (((var_1_7 + var_1_8) - var_1_9) - var_1_10))) : 1) : (var_1_1 == ((unsigned char) (var_1_8 + var_1_7)))) : (var_1_1 == ((unsigned char) ((var_1_11 - var_1_9) - var_1_10)))) && (((last_1_var_1_47 * (- last_1_var_1_20)) >= last_1_var_1_27) ? (var_1_12 == ((unsigned char) (var_1_16 || var_1_17))) : ((last_1_var_1_20 >= last_1_var_1_27) ? (var_1_12 == ((unsigned char) (var_1_18 && var_1_19))) : (var_1_12 == ((unsigned char) (var_1_17 || var_1_16)))))) && (((var_1_8 % var_1_11) <= 2) ? (var_1_20 == ((float) (min (var_1_21 , var_1_22)))) : 1)) && (((- (var_1_7 * var_1_9)) >= var_1_10) ? (var_1_18 ? ((var_1_42 != (~ var_1_8)) ? (var_1_23 == ((float) (abs (var_1_21)))) : (var_1_23 == ((float) ((abs (var_1_24)) + (var_1_25 + var_1_26))))) : ((var_1_27 <= var_1_21) ? (var_1_23 == ((float) var_1_26)) : (var_1_23 == ((float) var_1_21)))) : (var_1_23 == ((float) var_1_24)))) && (var_1_46 ? (var_1_27 == ((float) ((var_1_28 + var_1_29) - var_1_30))) : (var_1_27 == ((float) ((256.5f - var_1_29) + var_1_25))))) && (var_1_31 == ((unsigned char) (abs (var_1_11))))) && (((last_1_var_1_31 + var_1_7) > var_1_11) ? (var_1_32 == ((unsigned short int) ((var_1_33 + 19944) - ((10000 - last_1_var_1_31) + var_1_8)))) : (var_1_32 == ((unsigned short int) (var_1_8 + (max ((last_1_var_1_38 + var_1_10) , var_1_33))))))) && ((var_1_47 >= (abs (var_1_47))) ? ((var_1_33 < (var_1_8 + (var_1_52 / var_1_7))) ? ((last_1_var_1_34 < var_1_31) ? (var_1_34 == ((signed short int) (min (var_1_9 , var_1_7)))) : (var_1_34 == ((signed short int) (min ((var_1_10 - var_1_8) , var_1_11))))) : 1) : (((var_1_1 + last_1_var_1_34) > var_1_33) ? ((last_1_var_1_34 >= var_1_33) ? (var_1_34 == ((signed short int) ((var_1_9 + var_1_52) - (var_1_11 + var_1_7)))) : (var_1_34 == ((signed short int) var_1_9))) : ((var_1_1 <= var_1_11) ? (var_1_34 == ((signed short int) -16)) : 1)))) && (var_1_36 == ((unsigned long int) ((var_1_37 - var_1_41) - (max (var_1_34 , var_1_9)))))) && ((! (var_1_21 > last_1_var_1_23)) ? (((var_1_39 - var_1_10) <= (var_1_11 * last_1_var_1_53)) ? (var_1_38 == ((unsigned long int) (min (var_1_9 , (16u + var_1_7))))) : (var_1_38 == ((unsigned long int) last_1_var_1_38))) : 1)) && ((-10 >= var_1_1) ? ((var_1_1 < var_1_11) ? (var_1_40 == ((unsigned char) var_1_7)) : 1) : (((var_1_38 - var_1_11) > var_1_39) ? (var_1_40 == ((unsigned char) var_1_10)) : 1))) && (var_1_46 ? (var_1_41 == ((unsigned long int) var_1_55)) : 1)) && ((var_1_24 < 9.8f) ? (var_1_42 == ((unsigned long int) (var_1_10 + (var_1_43 - var_1_34)))) : ((-10 > var_1_7) ? ((! (var_1_12 && var_1_19)) ? (var_1_42 == ((unsigned long int) ((abs (var_1_43 - var_1_32)) + var_1_9))) : ((var_1_10 != (var_1_34 / var_1_8)) ? (var_1_42 == ((unsigned long int) ((min (var_1_37 , 3600336302u)) - var_1_9))) : 1)) : ((var_1_22 > (var_1_25 + (var_1_24 / var_1_44))) ? (var_1_42 == ((unsigned long int) (var_1_43 + (var_1_9 + (max (var_1_1 , var_1_10)))))) : (var_1_42 == ((unsigned long int) ((abs (min (var_1_37 , var_1_45))) - var_1_7))))))) && (((var_1_31 / (min (var_1_33 , 10000))) >= (var_1_7 / var_1_43)) ? (var_1_46 == ((unsigned char) var_1_16)) : (var_1_46 == ((unsigned char) (var_1_16 || ((var_1_12 || var_1_19) && var_1_18)))))) && ((var_1_32 < var_1_31) ? (var_1_18 ? (var_1_47 == ((double) (min (var_1_21 , var_1_29)))) : ((25.85 < var_1_25) ? (var_1_47 == ((double) (max (var_1_26 , var_1_30)))) : (var_1_47 == ((double) (var_1_29 - var_1_28))))) : ((var_1_8 < var_1_41) ? (var_1_46 ? (var_1_47 == ((double) 4.5)) : (var_1_47 == ((double) (max (((4.3 + var_1_29) - (var_1_48 - var_1_28)) , (min (var_1_22 , var_1_26))))))) : ((! ((var_1_16 || var_1_12) && var_1_12)) ? (var_1_47 == ((double) (var_1_30 - (var_1_48 - var_1_29)))) : 1)))) && (((var_1_40 <= 2) || var_1_12) ? (var_1_49 == ((unsigned long int) (var_1_39 + (min (var_1_11 , var_1_32))))) : (((var_1_30 - 16.25f) > ((var_1_29 + 3.4f) - (abs (var_1_23)))) ? (((var_1_42 * (abs (var_1_33))) >= 5) ? (var_1_49 == ((unsigned long int) ((var_1_43 + (1784827551u - var_1_42)) - ((var_1_51 - var_1_10) + 64u)))) : (var_1_49 == ((unsigned long int) (max (var_1_7 , var_1_33))))) : (var_1_49 == ((unsigned long int) ((var_1_9 + var_1_31) + var_1_8)))))) && ((var_1_12 && var_1_12) ? (var_1_52 == ((signed char) (abs (var_1_9)))) : 1)) && ((24.5 > var_1_22) ? ((var_1_43 <= (var_1_49 | var_1_8)) ? (var_1_53 == ((signed short int) last_1_var_1_53)) : 1) : (var_1_18 ? (var_1_53 == ((signed short int) (max (var_1_38 , var_1_7)))) : (var_1_53 == ((signed short int) var_1_38))))) && (var_1_54 == ((signed char) var_1_11))) && (var_1_55 == ((unsigned char) var_1_11))) && ((var_1_18 || ((- var_1_27) >= (var_1_22 * var_1_47))) ? (((abs (var_1_41)) == var_1_42) ? (var_1_56 == ((signed char) ((min (var_1_9 , var_1_58)) + -25))) : 1) : (var_1_56 == ((signed char) var_1_59)))
;
}
int main(void) {
	isInitial = 1;
