...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch1dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req5Batch1dependencies
	var_1_15 = (var_1_16 - var_1_17);


	// From: Req8Batch1dependencies
	var_1_27 = var_1_21;


	// From: Req1Batch1dependencies
	...
	// From: Req2Batch1dependencies
	if (var_1_27 < (var_1_27 - var_1_27)) {
		var_1_6 = var_1_9;
	}


	// From: Req3Batch1dependencies
	...
	// From: Req4Batch1dependencies
	if (var_1_23 && (var_1_18 >= var_1_27)) {
		var_1_12 = var_1_11;
	} else {
		if (1 >= var_1_27) {
			var_1_12 = var_1_11;
