...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch4850_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch4850_1loop
	if (var_1_2) {
		var_1_13 = var_1_11;
	}


	// From: Req6Batch4850_1loop
	if (var_1_8 == var_1_13) {
