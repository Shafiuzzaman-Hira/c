...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch90Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject7
	if (var_1_20) {
		var_1_47 = ((var_1_42 + var_1_13) + (min (var_1_39 , (var_1_48 - var_1_41))));
	}


	// From: CodeObject8
	if (var_1_4 >= (-1000 << var_1_3)) {
		if (var_1_3 > (var_1_39 | var_1_48)) {
			var_1_49 = ((abs (var_1_50)) - 32u);
		}
	} else {
		var_1_49 = var_1_40;
	}
	...
	// From: CodeObject2
	if (var_1_20) {
		if (var_1_12 < (max ((min (var_1_14 , var_1_4)) , (var_1_14 / var_1_4)))) {
			if ((abs (var_1_18)) < var_1_18) {
				var_1_28 = (var_1_20 || var_1_36);
			} else {
				if (var_1_20) {
	...
	// From: CodeObject6
	if (var_1_42 <= ((var_1_41 >> var_1_40) % var_1_4)) {
		var_1_46 = var_1_40;
	}


	// From: Req2Batch90Filler_PR_CI
	if (var_1_18 != (var_1_18 + var_1_18)) {
		var_1_11 = ((var_1_12 + var_1_13) + 32);
	}


	// From: Req4Batch90Filler_PR_CI
