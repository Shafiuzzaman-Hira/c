...
void step(void) {
	...
	// From: Req3Batch34Wrapper_P
	signed long int stepLocal_1 = ((*(var_1_11_Pointer)) + (*(var_1_12_Pointer))) - (min ((*(var_1_13_Pointer)) , 1));
