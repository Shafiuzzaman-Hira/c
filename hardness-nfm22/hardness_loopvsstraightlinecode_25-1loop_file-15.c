...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch1525_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch1525_1loop
	var_1_10 = var_1_11;


	// From: Req4Batch1525_1loop
	var_1_12 = var_1_13;


	// From: Req2Batch1525_1loop
	if (var_1_10) {
