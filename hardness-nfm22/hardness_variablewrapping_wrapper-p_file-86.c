...
void step(void) {
	// From: Req1Batch86Wrapper_P
	if (! (*(var_1_2_Pointer))) {
		(*(var_1_1_Pointer)) = (min (((*(var_1_3_Pointer)) + ((*(var_1_4_Pointer)) + (*(var_1_5_Pointer)))) , (*(var_1_6_Pointer))));
	} else {
		(*(var_1_1_Pointer)) = (*(var_1_5_Pointer));
	}


	// From: Req2Batch86Wrapper_P
	...
	// From: Req4Batch86Wrapper_P
	(*(var_1_18_Pointer)) = (*(var_1_17_Pointer));


	// From: Req3Batch86Wrapper_P
	if ((*(var_1_2_Pointer)) && (*(var_1_12_Pointer))) {
		(*(var_1_11_Pointer)) = ((*(var_1_13_Pointer)) + (min ((max ((*(var_1_14_Pointer)) , (*(var_1_15_Pointer)))) , (*(var_1_16_Pointer)))));
	} else {
		if ((*(var_1_3_Pointer)) < (200 * (-25 << (*(var_1_18_Pointer))))) {
			(*(var_1_11_Pointer)) = (abs (max (((*(var_1_17_Pointer)) - 10000) , (min ((*(var_1_15_Pointer)) , (*(var_1_14_Pointer)))))));
		} else {
...
int property() {
	return ((((! (*(var_1_2_Pointer))) ? ((*(var_1_1_Pointer)) == ((signed short int) (min (((*(var_1_3_Pointer)) + ((*(var_1_4_Pointer)) + (*(var_1_5_Pointer)))) , (*(var_1_6_Pointer)))))) : ((*(var_1_1_Pointer)) == ((signed short int) (*(var_1_5_Pointer))))) && (((*(var_1_5_Pointer)) > 2) ? ((*(var_1_7_Pointer)) == ((float) (((*(var_1_8_Pointer)) + (*(var_1_9_Pointer))) - (*(var_1_10_Pointer))))) : 1)) && (((*(var_1_2_Pointer)) && (*(var_1_12_Pointer))) ? ((*(var_1_11_Pointer)) == ((unsigned short int) ((*(var_1_13_Pointer)) + (min ((max ((*(var_1_14_Pointer)) , (*(var_1_15_Pointer)))) , (*(var_1_16_Pointer))))))) : (((*(var_1_3_Pointer)) < (200 * (-25 << (*(var_1_18_Pointer))))) ? ((*(var_1_11_Pointer)) == ((unsigned short int) (abs (max (((*(var_1_17_Pointer)) - 10000) , (min ((*(var_1_15_Pointer)) , (*(var_1_14_Pointer))))))))) : ((*(var_1_11_Pointer)) == ((unsigned short int) ((*(var_1_17_Pointer)) - (*(var_1_15_Pointer)))))))) && ((*(var_1_18_Pointer)) == ((unsigned long int) (*(var_1_17_Pointer))))
;
}
int main(void) {
	isInitial = 1;
