...
void step(void) {
 ...
 if (stepLocal_0 || BOOL_unsigned_char_Array_0[1]) {
  if (! BOOL_unsigned_char_Array_0[1]) {
   signed_long_int_Array_0[0] = (((((((signed_char_Array_0[0]) < (signed_char_Array_0[0])) ? (signed_char_Array_0[0]) : (signed_char_Array_0[0]))) < 0 ) ? -((((signed_char_Array_0[0]) < (signed_char_Array_0[0])) ? (signed_char_Array_0[0]) : (signed_char_Array_0[0]))) : ((((signed_char_Array_0[0]) < (signed_char_Array_0[0])) ? (signed_char_Array_0[0]) : (signed_char_Array_0[0])))));
  } else {
 ...
 if (double_Array_0[1] <= double_Array_0[1]) {
  if ((signed_long_int_Array_0[0] + signed_long_int_Array_0[0]) >= (signed_long_int_Array_0[0] + signed_char_Array_0[0])) {
   double_Array_0[2] = ((((double_Array_0[0]) < 0 ) ? -(double_Array_0[0]) : (double_Array_0[0])));
  }
 } else {
