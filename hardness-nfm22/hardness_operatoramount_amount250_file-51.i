...
void step(void) {
 ...
 if (var_1_21) {
  var_1_58 = ((((((var_1_19) < (var_1_59)) ? (var_1_19) : (var_1_59))) - (var_1_60 + var_1_61)) + var_1_8);
 } else {
 ...
 if (var_1_7 < (~ (var_1_8 - var_1_15))) {
  ...
  var_1_16 = ((((var_1_58) < (((((var_1_13) < (var_1_11)) ? (var_1_13) : (var_1_11))))) ? (var_1_58) : (((((var_1_13) < (var_1_11)) ? (var_1_13) : (var_1_11))))));
 }
 unsigned char stepLocal_10 = var_1_27;
 if (var_1_25 || stepLocal_10) {
  if (var_1_26) {
   var_1_44 = ((((var_1_11) < (((var_1_54 - var_1_31) + var_1_7))) ? (var_1_11) : (((var_1_54 - var_1_31) + var_1_7))));
  } else {
 ...
 if (var_1_25) {
  var_1_35 = ((((((((var_1_58) < (var_1_15)) ? (var_1_58) : (var_1_15)))) > (var_1_17)) ? (((((var_1_58) < (var_1_15)) ? (var_1_58) : (var_1_15)))) : (var_1_17)));
 } else {
  if (-128 <= stepLocal_6) {
   if (stepLocal_5 == (((((var_1_17) < (var_1_31)) ? (var_1_17) : (var_1_31))) / var_1_36)) {
    var_1_35 = (((((var_1_14 - 50) + var_1_15) < 0 ) ? -((var_1_14 - 50) + var_1_15) : ((var_1_14 - 50) + var_1_15)));
   }
  } else {
   if (var_1_27) {
    var_1_35 = ((((-64) < (var_1_28)) ? (-64) : (var_1_28)));
   }
  }
 }
 if (! var_1_47) {
  var_1_12 = (((((var_1_13 - var_1_11)) < ((var_1_8 + var_1_10))) ? ((var_1_13 - var_1_11)) : ((var_1_8 + var_1_10))));
 } else {
  if (var_1_11 > ((128 - var_1_8) / (var_1_14 + var_1_15))) {
   if (((- var_1_15) / 100) > (var_1_58 / ((((50) > (-1000000000)) ? (50) : (-1000000000))))) {
    var_1_12 = 8;
   }
  } else {
   var_1_12 = var_1_14;
 ...
 if (var_1_35 >= (((((var_1_15) > (var_1_50)) ? (var_1_15) : (var_1_50))) >> var_1_12)) {
  var_1_55 = (var_1_56 - 8u);
 }
 unsigned char stepLocal_2 = var_1_21;
 if ((var_1_6 > ((((var_1_4) < (var_1_3)) ? (var_1_4) : (var_1_3)))) && stepLocal_2) {
  if (! var_1_37) {
   var_1_33 = ((((var_1_39 + (last_1_var_1_33 + last_1_var_1_33)) < 0 ) ? -(var_1_39 + (last_1_var_1_33 + last_1_var_1_33)) : (var_1_39 + (last_1_var_1_33 + last_1_var_1_33))));
  }
 } else {
  if (! var_1_27) {
   if (! var_1_25) {
 ...
 if (stepLocal_3 <= var_1_20) {
  var_1_34 = ((((((((((((var_1_54) > (var_1_15)) ? (var_1_54) : (var_1_15)))) < (var_1_11)) ? (((((var_1_54) > (var_1_15)) ? (var_1_54) : (var_1_15)))) : (var_1_11)))) < (var_1_13)) ? (((((((((var_1_54) > (var_1_15)) ? (var_1_54) : (var_1_15)))) < (var_1_11)) ? (((((var_1_54) > (var_1_15)) ? (var_1_54) : (var_1_15)))) : (var_1_11)))) : (var_1_13)));
 } else {
  if (stepLocal_4 < var_1_39) {
   var_1_34 = (var_1_20 + (var_1_30 + var_1_13));
  }
 }
 signed long int stepLocal_14 = ((((var_1_13 + var_1_28)) < ((~ var_1_28))) ? ((var_1_13 + var_1_28)) : ((~ var_1_28)));
