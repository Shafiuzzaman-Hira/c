...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch4stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_5) {
  if ((var_1_2 * (var_1_3 + var_1_7)) > stepLocal_0) {
   var_1_6 = 256;
  }
 }
 ...
 if (stepLocal_3 >= var_1_3) {
  var_1_14 = (((((var_1_15) > ((var_1_16 - var_1_10))) ? (var_1_15) : ((var_1_16 - var_1_10)))) - var_1_2);
 }
 unsigned char stepLocal_5 = var_1_1;
 unsigned char stepLocal_4 = var_1_5 && (var_1_12 < var_1_13);
 if (var_1_1 && stepLocal_4) {
  if (stepLocal_5 || (var_1_9 >= ((((var_1_18) > (var_1_7)) ? (var_1_18) : (var_1_7))))) {
