...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch27PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject4
	var_1_29 = (min ((max (10 , var_1_30)) , (max (var_1_31 , -8))));
	...
	// From: Req4Batch27PS_CN_10
	if (var_1_6 == (var_1_4 / var_1_13)) {
		var_1_12 = var_1_11;
	}


	// From: Req6Batch27PS_CN_10
	var_1_20 = var_1_11;


	// From: Req7Batch27PS_CN_10
	var_1_21 = 8;


	// From: Req3Batch27PS_CN_10
