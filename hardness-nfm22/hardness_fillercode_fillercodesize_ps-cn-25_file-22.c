...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch22PS_CN_25.c", 13, "reach_error"); }
...
unsigned long int var_1_35 = 4092582027;
...
void step(void) {
	...
	// From: CodeObject4
	if ((var_1_32 + (var_1_30 >> var_1_29)) < var_1_28) {
		var_1_33 = var_1_31;
	}


	// From: CodeObject5
	if (var_1_29 > (var_1_32 ^ var_1_28)) {
		if ((var_1_29 | var_1_31) == var_1_33) {
			var_1_34 = (var_1_35 - var_1_32);
		} else {
			var_1_34 = (abs (var_1_31));
		}
	} else {
	...
	// From: CodeObject6
	if (var_1_32 > (var_1_33 / var_1_37)) {
		var_1_36 = (var_1_38 || var_1_39);
	}


	// From: Req5Batch22PS_CN_25
	if (last_1_var_1_27) {
	...
	// From: Req8Batch22PS_CN_25
	if ((- 3.75) < (min (var_1_20 , var_1_22))) {
		var_1_27 = 0;
	}


	// From: Req2Batch22PS_CN_25
