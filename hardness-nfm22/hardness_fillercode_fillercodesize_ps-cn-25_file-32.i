...
void step(void) {
 ...
 if (var_1_25 > var_1_26) {
  var_1_27 = ((((var_1_28) < (-256)) ? (var_1_28) : (-256)));
 }
 var_1_29 = ((((var_1_30 + (var_1_31 + var_1_32)) < 0 ) ? -(var_1_30 + (var_1_31 + var_1_32)) : (var_1_30 + (var_1_31 + var_1_32))));
 ...
 if (var_1_34) {
  if (var_1_36) {
   var_1_35 = ((((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37))) - (1000000000u - var_1_38)) + ((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30))));
  } else {
   if (var_1_39) {
    var_1_35 = var_1_30;
   }
