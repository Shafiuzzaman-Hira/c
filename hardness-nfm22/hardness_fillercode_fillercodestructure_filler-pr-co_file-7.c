...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch7Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch7Filler_PR_CO
	var_1_9 = (max (var_1_5 , var_1_6));


	// From: CodeObject3
	if ((-10 & var_1_24) <= var_1_24) {
	...
	// From: Req6Batch7Filler_PR_CO
	var_1_15 = (var_1_14 - (max ((var_1_16 + var_1_17) , 4)));


	// From: CodeObject1
	if ((var_1_12 >> var_1_27) > ((var_1_10 ^ var_1_15) + (abs (var_1_1)))) {
		var_1_25 = (max ((abs (var_1_27)) , 0));
	} else {
		if ((abs (var_1_18)) >= (var_1_32 - var_1_33)) {
			var_1_25 = var_1_27;
		}
	}


	// From: Req7Batch7Filler_PR_CO
	if (var_1_4 > var_1_2) {
	...
	// From: Req8Batch7Filler_PR_CO
	var_1_24 = 16;


	// From: Req1Batch7Filler_PR_CO
	...
	// From: CodeObject2
	if (var_1_15 >= (abs (var_1_15 | var_1_27))) {
		var_1_34 = ((max ((abs (var_1_15)) , var_1_15)) - (abs (var_1_10)));
	} else {
		if (var_1_15 >= var_1_27) {
			if (var_1_32 > var_1_33) {
				var_1_34 = (abs (var_1_10));
			}
		}
	}
	...
	// From: CodeObject5
	if (var_1_27 == (var_1_12 ^ var_1_9)) {
		var_1_39 = ((min (var_1_40 , (min (var_1_41 , var_1_42)))) - (var_1_43 - var_1_44));
	} else {
		var_1_39 = ((min ((abs (var_1_42)) , var_1_43)) - 255.4f);
	}
