...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch95Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (((var_1_31 - var_1_32) + (var_1_27 / var_1_33)) < ((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12)))) {
  if (var_1_11 >= 10u) {
   if (var_1_22) {
    var_1_30 = (((((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))) < 0 ) ? -((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))) : ((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)))));
   } else {
    var_1_30 = ((((((((var_1_7) > (var_1_1)) ? (var_1_7) : (var_1_1)))) < ((var_1_10 + 64))) ? (((((var_1_7) > (var_1_1)) ? (var_1_7) : (var_1_1)))) : ((var_1_10 + 64))));
   }
  } else {
 ...
 if (var_1_23) {
  ...
  if (var_1_19 <= (~ (var_1_1 % var_1_20))) {
   var_1_22 = (! var_1_24);
  } else {
   var_1_22 = var_1_25;
  }
 }
 if (var_1_20 >= (var_1_1 / ((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19))))) {
  var_1_26 = var_1_27;
 }
 var_1_39 = var_1_19;
