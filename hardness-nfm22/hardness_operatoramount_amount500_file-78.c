...
void step(void) {
	...
	if (((9.99999999999901E12f - var_1_54) + (last_1_var_1_74 / var_1_36)) == var_1_45) {
		var_1_72 = (max (((var_1_57 + var_1_56) + (var_1_30 - var_1_31)) , ((64 - var_1_73) + (min (var_1_15 , var_1_17)))));
	} else {
		var_1_72 = var_1_17;
	}
	...
	if (last_1_var_1_21) {
		if (stepLocal_20 && ((last_1_var_1_90 >= last_1_var_1_39) || last_1_var_1_21)) {
			var_1_66 = (min (var_1_17 , 10));
		} else {
			var_1_66 = ((abs (max (var_1_67 , var_1_68))) - 5);
		}
	} else {
		if (last_1_var_1_93 >= stepLocal_19) {
			var_1_66 = (max (var_1_67 , (var_1_68 - (var_1_56 + var_1_31))));
		} else {
			var_1_66 = var_1_68;
		}
	}
	...
	var_1_62 = (min ((var_1_66 - var_1_17) , var_1_58));


	// From: Req12Batch78Amount500
	signed long int stepLocal_10 = last_1_var_1_29;
	unsigned long int stepLocal_9 = (max (last_1_var_1_91 , last_1_var_1_100)) & (last_1_var_1_87 / var_1_20);
	if ((last_1_var_1_97 ^ var_1_30) >= stepLocal_9) {
		if (((- last_1_var_1_89) / (max (var_1_35 , var_1_36))) >= var_1_10) {
	...
	if (var_1_22) {
		if (var_1_26 == stepLocal_6) {
			var_1_29 = (max (var_1_17 , (var_1_15 + (var_1_30 - var_1_31))));
		}
	}


	// From: Req6Batch78Amount500
	var_1_23 = (256 - (max (var_1_72 , var_1_15)));
	...
	if (stepLocal_14 <= var_1_13) {
		var_1_47 = (min ((var_1_46 + var_1_9) , ((var_1_45 + var_1_49) + (var_1_41 - var_1_50))));
	} else {
		var_1_47 = ((var_1_50 + (abs (var_1_9))) - (min (var_1_42 , var_1_41)));
	}
	...
	if (4u > var_1_72) {
		if (var_1_22) {
			var_1_55 = (var_1_31 + (min ((var_1_56 - var_1_57) , var_1_58)));
		}
	} else {
	...
	if (! var_1_38) {
		var_1_70 = (var_1_50 - (max (var_1_54 , var_1_42)));
	} else {
	...
	if ((var_1_77 - (5.5168762982299771E18f - var_1_78)) <= var_1_27) {
		var_1_79 = (var_1_43 - (min ((var_1_54 + var_1_77) , var_1_42)));
	} else {
		var_1_79 = var_1_75;
	}
	...
	if ((var_1_72 >> var_1_95) != stepLocal_21) {
		...
		var_1_69 = ((min ((var_1_46 + var_1_49) , var_1_50)) + (var_1_45 + 9.9999999975E8));
	}
	...
	if (((var_1_4 / var_1_19) ^ (var_1_16 / var_1_20)) < stepLocal_4) {
		var_1_18 = ((abs (var_1_66)) + (var_1_4 + (var_1_17 + var_1_15)));
	} else {
		if (stepLocal_3 >= var_1_17) {
			var_1_18 = (min ((var_1_17 + var_1_93) , (var_1_25 + var_1_66)));
		} else {
			var_1_18 = (min ((max (var_1_15 , var_1_25)) , var_1_29));
		}
	}
	...
	if (var_1_13 == (~ var_1_19)) {
		if (var_1_38 || ((abs (var_1_29)) > var_1_29)) {
			var_1_53 = (var_1_41 + (var_1_50 - var_1_54));
		} else {
			if ((~ var_1_72) < (- (var_1_26 * var_1_95))) {
				var_1_53 = (max (var_1_54 , var_1_44));
			} else {
				var_1_53 = (min (var_1_49 , (min ((var_1_41 + var_1_54) , var_1_45))));
			}
		}
	} else {
		var_1_53 = ((max (var_1_43 , (var_1_42 - var_1_41))) - var_1_50);
	}


	// From: Req19Batch78Amount500
	unsigned char stepLocal_16 = var_1_31;
	if (9.25 >= (min (var_1_69 , (- var_1_79)))) {
		if (var_1_88) {
			var_1_59 = (((var_1_72 + var_1_56) + var_1_66) - var_1_30);
		} else {
			if (var_1_72 > stepLocal_16) {
				var_1_59 = (min (var_1_20 , var_1_72));
			} else {
				var_1_59 = (var_1_30 - 8);
			}
		}
	...
	if (var_1_69 < var_1_41) {
		var_1_61 = (min (((abs (var_1_45)) + (min (100.125f , var_1_50))) , 2.95f));
	}


	// From: Req33Batch78Amount500
	unsigned char stepLocal_26 = var_1_31;
	if (((32 - var_1_73) / (abs (var_1_67))) >= stepLocal_26) {
		var_1_86 = (var_1_34 && (! (var_1_37 || var_1_38)));
	} else {
		var_1_86 = (((min (var_1_91 , var_1_20)) != var_1_17) || var_1_38);
	}
	...
	if (! var_1_86) {
		var_1_1 = ((max (var_1_3 , var_1_4)) - ((min (var_1_72 , var_1_72)) + var_1_29));
	} else {
		if (stepLocal_1 <= (var_1_4 - (abs (var_1_72)))) {
			if (stepLocal_0 <= 10) {
				var_1_1 = (var_1_4 - var_1_72);
			}
		} else {
			if (var_1_86) {
				var_1_1 = (abs (abs (var_1_72)));
			} else {
	...
	if ((~ (var_1_57 * var_1_64)) > (max (var_1_72 , (var_1_67 - var_1_95)))) {
		if ((abs (var_1_11 + var_1_67)) < var_1_4) {
			var_1_74 = (max ((min (var_1_54 , (var_1_41 - var_1_50))) , (min (var_1_75 , var_1_9))));
		} else {
			if (var_1_86) {
				var_1_74 = var_1_44;
			} else {
				var_1_74 = ((min ((var_1_41 + var_1_50) , var_1_54)) - ((max (var_1_76 , var_1_77)) + var_1_78));
			}
		}
	}
	...
	unsigned long int stepLocal_25 = min (var_1_15 , (16u / var_1_3));
	...
	if (var_1_51 < stepLocal_25) {
		...
		if (stepLocal_23 < var_1_20) {
			var_1_80 = (min (last_1_var_1_80 , last_1_var_1_80));
		} else {
	...
	if ((var_1_1 - var_1_93) > stepLocal_11) {
		if ((var_1_35 + var_1_27) < var_1_10) {
			...
			if (var_1_88) {
				var_1_39 = (max ((var_1_9 + var_1_41) , var_1_10));
			}
		}
	} else {
		if (stepLocal_12 >= var_1_3) {
			if (var_1_88) {
				...
				var_1_39 = (var_1_9 + (max (var_1_41 , var_1_44)));
			}
		} else {
			if (stepLocal_13 != (var_1_31 - 1)) {
				var_1_39 = ((min (var_1_9 , (var_1_45 + var_1_46))) + var_1_44);
			} else {
				if (var_1_37) {
					var_1_39 = (max ((abs (var_1_45)) , var_1_10));
				} else {
					var_1_39 = (max ((max (var_1_41 , var_1_45)) , 3.4f));
				}
			}
		}
	}
	...
	signed long int stepLocal_18 = min ((var_1_80 * var_1_19) , var_1_31);
	signed long int stepLocal_17 = (max (var_1_1 , var_1_91)) + (var_1_66 + var_1_93);
	if ((9.99999995E7 + var_1_49) < var_1_35) {
		if (stepLocal_17 <= ((var_1_64 - var_1_15) - (var_1_3 + var_1_57))) {
			if (var_1_90 <= (max (var_1_90 , var_1_27))) {
				var_1_63 = (var_1_50 - var_1_42);
			} else {
				if (stepLocal_18 <= (128 - (var_1_64 - 10))) {
					var_1_63 = (max ((var_1_54 - (var_1_41 + var_1_50)) , (var_1_42 - 100.75f)));
				}
			}
		}
	}
		...
		if (var_1_88) {
			...
			if (var_1_88) {
				if (stepLocal_8 >= (8u & var_1_93)) {
					var_1_32 = (abs (var_1_15 - 10));
				} else {
					var_1_32 = ((min (var_1_31 , (abs (var_1_33)))) - var_1_15);
				}
			} else {
				var_1_32 = (var_1_31 - var_1_15);
			}
	...
	if ((var_1_25 & (var_1_30 << var_1_62)) < ((var_1_17 - var_1_72) * var_1_52)) {
		if ((2u <= (max (var_1_95 , var_1_72))) && var_1_21) {
			if ((abs (var_1_28)) <= (- var_1_101)) {
				var_1_82 = (min (var_1_4 , ((var_1_31 + var_1_94) + (1 + var_1_30))));
			} else {
...
int property() {
	return ((((((((((((((((((((((((((((((((((((((((((((((((! var_1_86) ? (var_1_1 == ((unsigned short int) ((max (var_1_3 , var_1_4)) - ((min (var_1_72 , var_1_72)) + var_1_29)))) : ((var_1_72 <= (var_1_4 - (abs (var_1_72)))) ? ((var_1_4 <= 10) ? (var_1_1 == ((unsigned short int) (var_1_4 - var_1_72))) : 1) : (var_1_86 ? (var_1_1 == ((unsigned short int) (abs (abs (var_1_72))))) : (var_1_1 == ((unsigned short int) (1 + (27338 - var_1_29))))))) && ((var_1_29 >= var_1_25) ? (var_1_8 == ((double) (max ((var_1_9 + 32.9) , 100000.5)))) : (var_1_8 == ((double) var_1_10)))) && ((var_1_101 > var_1_9) ? (var_1_86 ? (var_1_21 ? (var_1_11 == ((signed char) var_1_13)) : (var_1_11 == ((signed char) (var_1_14 - var_1_15)))) : (var_1_11 == ((signed char) (min (var_1_15 , ((min (var_1_16 , var_1_14)) - var_1_17)))))) : 1)) && ((((var_1_4 / var_1_19) ^ (var_1_16 / var_1_20)) < (var_1_93 / var_1_3)) ? (var_1_18 == ((unsigned long int) ((abs (var_1_66)) + (var_1_4 + (var_1_17 + var_1_15))))) : (((- var_1_66) >= var_1_17) ? (var_1_18 == ((unsigned long int) (min ((var_1_17 + var_1_93) , (var_1_25 + var_1_66))))) : (var_1_18 == ((unsigned long int) (min ((max (var_1_15 , var_1_25)) , var_1_29))))))) && (var_1_88 ? ((var_1_92 || ((-1 - 64) <= (var_1_93 << var_1_19))) ? (var_1_21 == ((unsigned char) var_1_22)) : (var_1_21 == ((unsigned char) var_1_22))) : 1)) && (var_1_23 == ((signed short int) (256 - (max (var_1_72 , var_1_15)))))) && ((var_1_66 == var_1_17) ? (var_1_24 == ((unsigned long int) var_1_29)) : 1)) && (var_1_25 == ((unsigned long int) (var_1_26 - var_1_15)))) && ((! (9.999999975E7f != var_1_10)) ? (var_1_27 == ((double) var_1_28)) : (var_1_27 == ((double) var_1_9)))) && (var_1_22 ? ((var_1_26 == (last_1_var_1_72 + var_1_17)) ? (var_1_29 == ((unsigned char) (max (var_1_17 , (var_1_15 + (var_1_30 - var_1_31)))))) : 1) : 1)) && ((var_1_27 >= (- var_1_79)) ? (var_1_88 ? (((var_1_16 - var_1_17) != ((var_1_80 + var_1_19) / -25)) ? (var_1_32 == ((signed char) (var_1_31 - var_1_15))) : 1) : (var_1_88 ? ((var_1_26 >= (8u & var_1_93)) ? (var_1_32 == ((signed char) (abs (var_1_15 - 10)))) : (var_1_32 == ((signed char) ((min (var_1_31 , (abs (var_1_33)))) - var_1_15)))) : (var_1_32 == ((signed char) (var_1_31 - var_1_15))))) : 1)) && (((last_1_var_1_97 ^ var_1_30) >= ((max (last_1_var_1_91 , last_1_var_1_100)) & (last_1_var_1_87 / var_1_20))) ? ((((- last_1_var_1_89) / (max (var_1_35 , var_1_36))) >= var_1_10) ? (var_1_34 == ((unsigned char) (var_1_37 && var_1_38))) : ((var_1_19 > last_1_var_1_29) ? (var_1_34 == ((unsigned char) (var_1_22 || var_1_37))) : (var_1_34 == ((unsigned char) var_1_37)))) : 1)) && (((var_1_1 - var_1_93) > ((~ var_1_20) / var_1_30)) ? (((var_1_35 + var_1_27) < var_1_10) ? (var_1_39 == ((float) (var_1_9 + (8.5f - (var_1_41 - 7.8f))))) : (var_1_88 ? (var_1_39 == ((float) (max ((var_1_9 + var_1_41) , var_1_10)))) : 1)) : (((50 + (var_1_72 / var_1_19)) >= var_1_3) ? (var_1_88 ? (var_1_39 == ((float) ((var_1_42 - var_1_41) - var_1_43))) : (var_1_39 == ((float) (var_1_9 + (max (var_1_41 , var_1_44)))))) : ((var_1_20 != (var_1_31 - 1)) ? (var_1_39 == ((float) ((min (var_1_9 , (var_1_45 + var_1_46))) + var_1_44))) : (var_1_37 ? (var_1_39 == ((float) (max ((abs (var_1_45)) , var_1_10)))) : (var_1_39 == ((float) (max ((max (var_1_41 , var_1_45)) , 3.4f))))))))) && ((var_1_24 <= var_1_13) ? (var_1_47 == ((float) (min ((var_1_46 + var_1_9) , ((var_1_45 + var_1_49) + (var_1_41 - var_1_50)))))) : (var_1_47 == ((float) ((var_1_50 + (abs (var_1_9))) - (min (var_1_42 , var_1_41))))))) && (((var_1_4 > var_1_18) && (var_1_49 > var_1_44)) ? (var_1_51 == ((signed long int) ((var_1_4 - var_1_15) + var_1_20))) : (var_1_51 == ((signed long int) (var_1_66 + var_1_33))))) && ((256 >= ((var_1_62 + var_1_97) / var_1_3)) ? (var_1_34 ? (var_1_52 == ((signed short int) (var_1_13 + var_1_84))) : 1) : (var_1_37 ? (var_1_52 == ((signed short int) var_1_15)) : (var_1_52 == ((signed short int) var_1_16))))) && ((var_1_13 == (~ var_1_19)) ? ((var_1_38 || ((abs (var_1_29)) > var_1_29)) ? (var_1_53 == ((double) (var_1_41 + (var_1_50 - var_1_54)))) : (((~ var_1_72) < (- (var_1_26 * var_1_95))) ? (var_1_53 == ((double) (max (var_1_54 , var_1_44)))) : (var_1_53 == ((double) (min (var_1_49 , (min ((var_1_41 + var_1_54) , var_1_45)))))))) : (var_1_53 == ((double) ((max (var_1_43 , (var_1_42 - var_1_41))) - var_1_50))))) && ((4u > var_1_72) ? (var_1_22 ? (var_1_55 == ((signed char) (var_1_31 + (min ((var_1_56 - var_1_57) , var_1_58))))) : 1) : (var_1_55 == ((signed char) (var_1_57 + var_1_31))))) && ((9.25 >= (min (var_1_69 , (- var_1_79)))) ? (var_1_88 ? (var_1_59 == ((signed short int) (((var_1_72 + var_1_56) + var_1_66) - var_1_30))) : ((var_1_72 > var_1_31) ? (var_1_59 == ((signed short int) (min (var_1_20 , var_1_72)))) : (var_1_59 == ((signed short int) (var_1_30 - 8))))) : (var_1_59 == ((signed short int) ((var_1_51 + (var_1_58 + var_1_13)) + var_1_15))))) && ((var_1_69 < var_1_41) ? (var_1_61 == ((float) (min (((abs (var_1_45)) + (min (100.125f , var_1_50))) , 2.95f)))) : 1)) && (var_1_62 == ((signed short int) (min ((var_1_66 - var_1_17) , var_1_58))))) && (((9.99999995E7 + var_1_49) < var_1_35) ? ((((max (var_1_1 , var_1_91)) + (var_1_66 + var_1_93)) <= ((var_1_64 - var_1_15) - (var_1_3 + var_1_57))) ? ((var_1_90 <= (max (var_1_90 , var_1_27))) ? (var_1_63 == ((float) (var_1_50 - var_1_42))) : (((min ((var_1_80 * var_1_19) , var_1_31)) <= (128 - (var_1_64 - 10))) ? (var_1_63 == ((float) (max ((var_1_54 - (var_1_41 + var_1_50)) , (var_1_42 - 100.75f))))) : 1)) : 1) : 1)) && (last_1_var_1_21 ? (((var_1_58 == var_1_3) && ((last_1_var_1_90 >= last_1_var_1_39) || last_1_var_1_21)) ? (var_1_66 == ((unsigned char) (min (var_1_17 , 10)))) : (var_1_66 == ((unsigned char) ((abs (max (var_1_67 , var_1_68))) - 5)))) : ((last_1_var_1_93 >= last_1_var_1_1) ? (var_1_66 == ((unsigned char) (max (var_1_67 , (var_1_68 - (var_1_56 + var_1_31)))))) : (var_1_66 == ((unsigned char) var_1_68))))) && (((var_1_72 >> var_1_95) != var_1_93) ? (var_1_69 == ((double) (var_1_46 + var_1_45))) : (var_1_69 == ((double) ((min ((var_1_46 + var_1_49) , var_1_50)) + (var_1_45 + 9.9999999975E8)))))) && ((! var_1_38) ? (var_1_70 == ((double) (var_1_50 - (max (var_1_54 , var_1_42))))) : (var_1_70 == ((double) (var_1_42 - var_1_43))))) && (((var_1_59 > (var_1_29 / var_1_19)) && var_1_37) ? (var_1_71 == ((signed short int) var_1_33)) : (var_1_71 == ((signed short int) (min (-128 , var_1_11)))))) && ((((9.99999999999901E12f - var_1_54) + (last_1_var_1_74 / var_1_36)) == var_1_45) ? (var_1_72 == ((unsigned char) (max (((var_1_57 + var_1_56) + (var_1_30 - var_1_31)) , ((64 - var_1_73) + (min (var_1_15 , var_1_17))))))) : (var_1_72 == ((unsigned char) var_1_17)))) && (((~ (var_1_57 * var_1_64)) > (max (var_1_72 , (var_1_67 - var_1_95)))) ? (((abs (var_1_11 + var_1_67)) < var_1_4) ? (var_1_74 == ((double) (max ((min (var_1_54 , (var_1_41 - var_1_50))) , (min (var_1_75 , var_1_9)))))) : (var_1_86 ? (var_1_74 == ((double) var_1_44)) : (var_1_74 == ((double) ((min ((var_1_41 + var_1_50) , var_1_54)) - ((max (var_1_76 , var_1_77)) + var_1_78)))))) : 1)) && (((var_1_77 - (5.5168762982299771E18f - var_1_78)) <= var_1_27) ? (var_1_79 == ((double) (var_1_43 - (min ((var_1_54 + var_1_77) , var_1_42))))) : (var_1_79 == ((double) var_1_75)))) && ((var_1_51 < (min (var_1_15 , (16u / var_1_3)))) ? (((var_1_1 / var_1_19) < (var_1_66 / 32)) ? (var_1_80 == ((signed short int) (var_1_67 - (var_1_29 + var_1_1)))) : 1) : ((var_1_93 < var_1_20) ? (var_1_80 == ((signed short int) (min (last_1_var_1_80 , last_1_var_1_80)))) : (var_1_80 == ((signed short int) (var_1_16 - 100)))))) && (((var_1_25 & (var_1_30 << var_1_62)) < ((var_1_17 - var_1_72) * var_1_52)) ? (((2u <= (max (var_1_95 , var_1_72))) && var_1_21) ? (((abs (var_1_28)) <= (- var_1_101)) ? (var_1_82 == ((unsigned short int) (min (var_1_4 , ((var_1_31 + var_1_94) + (1 + var_1_30)))))) : (var_1_82 == ((unsigned short int) (var_1_29 + 128)))) : 1) : (var_1_82 == ((unsigned short int) var_1_29)))) && ((var_1_27 >= var_1_46) ? (var_1_84 == ((signed short int) ((-4 + var_1_32) + var_1_11))) : (var_1_84 == ((signed short int) (var_1_66 + var_1_14))))) && ((((32 - var_1_73) / (abs (var_1_67))) >= var_1_31) ? (var_1_86 == ((unsigned char) (var_1_34 && (! (var_1_37 || var_1_38))))) : (var_1_86 == ((unsigned char) (((min (var_1_91 , var_1_20)) != var_1_17) || var_1_38))))) && ((var_1_34 && var_1_37) ? (var_1_87 == ((signed char) (var_1_57 - var_1_73))) : (((var_1_90 != var_1_35) || ((var_1_93 & var_1_52) < var_1_30)) ? (var_1_87 == ((signed char) (abs (var_1_31)))) : 1))) && ((last_1_var_1_61 > (var_1_78 - var_1_54)) ? (last_1_var_1_34 ? (((-2 * (last_1_var_1_29 / var_1_30)) <= last_1_var_1_52) ? (var_1_88 == ((unsigned char) var_1_37)) : (var_1_88 == ((unsigned char) var_1_22))) : (var_1_88 == ((unsigned char) var_1_38))) : (var_1_88 == ((unsigned char) var_1_38)))) && (var_1_89 == ((double) var_1_50))) && (var_1_34 ? (var_1_90 == ((double) var_1_43)) : 1)) && (var_1_92 ? (var_1_91 == ((unsigned short int) var_1_68)) : (var_1_91 == ((unsigned short int) var_1_56)))) && (last_1_var_1_92 ? (var_1_92 == ((unsigned char) var_1_37)) : (var_1_92 == ((unsigned char) var_1_38)))) && (var_1_93 == ((unsigned char) var_1_31))) && (var_1_92 ? (var_1_94 == ((signed long int) var_1_17)) : (var_1_94 == ((signed long int) var_1_66)))) && (var_1_95 == ((unsigned short int) var_1_68))) && (var_1_96 == ((signed char) var_1_14))) && (var_1_21 ? (var_1_97 == ((signed short int) var_1_67)) : (var_1_97 == ((signed short int) var_1_30)))) && (var_1_98 == ((signed char) -8))) && (var_1_99 == ((signed char) var_1_33))) && (var_1_88 ? (var_1_100 == ((unsigned long int) last_1_var_1_100)) : (var_1_100 == ((unsigned long int) var_1_56)))) && ((var_1_75 <= var_1_54) ? (((var_1_25 / (var_1_68 + var_1_30)) < ((var_1_26 / var_1_4) / var_1_3)) ? (var_1_101 == ((double) ((var_1_42 - var_1_54) - 15.4))) : (var_1_101 == ((double) var_1_75))) : (var_1_101 == ((double) var_1_43)))
;
}
int main(void) {
	isInitial = 1;
