...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch6225_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch6225_while
	var_1_1 = (16 - 2);


	// From: Req2Batch6225_while
	if (var_1_3) {
		var_1_2 = (abs (-4));
	} else {
		var_1_2 = (abs (var_1_4));
