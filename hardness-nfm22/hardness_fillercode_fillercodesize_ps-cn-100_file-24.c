...
void step(void) {
	...
	if (var_1_29 || (var_1_36 > (var_1_35 * var_1_31))) {
		...
		var_1_37 = (max (var_1_38 , ((var_1_40 + var_1_41) + var_1_42)));
	}


	// From: CodeObject4
	if (var_1_28 || var_1_29) {
		var_1_43 = (max (var_1_44 , (max (15.8 , var_1_45))));
	}
	...
	if (var_1_42 >= var_1_26) {
		if (var_1_42 < (var_1_38 | var_1_39)) {
			if ((abs (- var_1_44)) <= (max (var_1_43 , var_1_45))) {
				if (var_1_38 > ((var_1_39 - var_1_47) % (abs (var_1_48)))) {
					var_1_46 = (var_1_34 - (abs (10u)));
				}
			} else {
				if (var_1_30) {
					var_1_46 = ((abs (var_1_35)) + (max (var_1_47 , var_1_36)));
				}
			}
		}
	}
	...
	if (var_1_28) {
		if (var_1_37 > var_1_26) {
			var_1_50 = (abs (var_1_33));
		} else {
			var_1_50 = (abs (var_1_47));
		}
	} else {
		var_1_50 = ((abs (var_1_51 + var_1_52)) - var_1_35);
	}


	// From: CodeObject8
	if ((abs (var_1_26 % var_1_54)) > 256) {
		var_1_53 = (abs (var_1_47));
	}


	// From: CodeObject9
	if (var_1_26 <= (max ((~ var_1_36) , var_1_32))) {
	...
	// From: Req6Batch24PS_CN_100
	var_1_23 = var_1_24;


	// From: Req3Batch24PS_CN_100
	if (128u >= var_1_8) {
		if (! var_1_23) {
