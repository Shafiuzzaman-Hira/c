...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch7325_1loop.c", 13, "reach_error"); }
...
void step(void) {
 signed long int stepLocal_0 = (((last_1_var_1_8) > ((last_1_var_1_14 + last_1_var_1_14))) ? (last_1_var_1_8) : ((last_1_var_1_14 + last_1_var_1_14)));
 ...
 if ((9.99999999999995E13f + var_1_1) >= var_1_1) {
  ...
  var_1_13 = (((((var_1_9) < (8)) ? (var_1_9) : (8))) - 32);
 }
 var_1_15 = var_1_12;
 var_1_14 = var_1_15;
}
