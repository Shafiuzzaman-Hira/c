...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch86100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch86100_1loop
	if (var_1_13) {
		var_1_22 = (max (var_1_10 , var_1_9));
	} else {
		var_1_22 = ((var_1_7 + 8) + var_1_9);
	}


	// From: Req11Batch86100_1loop
	var_1_31 = var_1_8;


	// From: Req12Batch86100_1loop
	var_1_32 = 0;


	// From: Req5Batch86100_1loop
	if (var_1_13) {
		if (var_1_32) {
			var_1_20 = (max ((var_1_17 + var_1_18) , var_1_19));
		}
	}


	// From: Req8Batch86100_1loop
	signed char stepLocal_3 = var_1_11;
	if (stepLocal_3 < (var_1_10 >> var_1_12)) {
		var_1_26 = (var_1_9 + var_1_7);
	} else {
		if (var_1_20 != var_1_23) {
			var_1_26 = (min (var_1_10 , var_1_7));
		} else {
			var_1_26 = var_1_9;
		}
	}
	...
	// From: Req10Batch86100_1loop
	signed char stepLocal_5 = var_1_9;
	if (stepLocal_5 < var_1_15) {
		var_1_30 = (var_1_10 - (max (var_1_9 , var_1_11)));
	} else {
		if ((var_1_16 / 1.5) < 8.725) {
			if (var_1_20 != (min ((- var_1_20) , var_1_16))) {
...
int property() {
	return ((((((((((((! (var_1_32 || (var_1_16 > var_1_23))) ? (var_1_32 ? (var_1_13 ? (var_1_1 == ((signed char) (abs ((var_1_6 - var_1_7) + var_1_8)))) : (var_1_1 == ((signed char) (min ((var_1_7 - var_1_6) , ((var_1_9 + var_1_10) - var_1_11)))))) : (var_1_1 == ((signed char) var_1_12))) : (var_1_1 == ((signed char) var_1_10))) && ((10u <= (var_1_7 << var_1_6)) ? (last_1_var_1_27 ? (var_1_13 == ((unsigned char) (last_1_var_1_27 && var_1_14))) : (var_1_13 == ((unsigned char) (! var_1_14)))) : 1)) && (((-100000 >> var_1_8) < var_1_9) ? (var_1_15 == ((signed short int) ((4 - var_1_11) + (-1 + last_1_var_1_30)))) : (last_1_var_1_27 ? (var_1_15 == ((signed short int) var_1_6)) : (var_1_15 == ((signed short int) var_1_10))))) && ((((8 * var_1_15) > var_1_6) || var_1_13) ? ((last_1_var_1_16 < var_1_20) ? (var_1_16 == ((float) (min (((var_1_17 + var_1_18) + 4.5f) , (min (256.25f , var_1_19)))))) : 1) : (var_1_16 == ((float) var_1_19)))) && (var_1_13 ? (var_1_32 ? (var_1_20 == ((float) (max ((var_1_17 + var_1_18) , var_1_19)))) : 1) : 1)) && (var_1_13 ? (var_1_22 == ((unsigned short int) (max (var_1_10 , var_1_9)))) : (var_1_22 == ((unsigned short int) ((var_1_7 + 8) + var_1_9))))) && (((var_1_6 >> var_1_15) >= var_1_8) ? (var_1_23 == ((float) (var_1_24 - var_1_25))) : 1)) && ((var_1_11 < (var_1_10 >> var_1_12)) ? (var_1_26 == ((signed short int) (var_1_9 + var_1_7))) : ((var_1_20 != var_1_23) ? (var_1_26 == ((signed short int) (min (var_1_10 , var_1_7)))) : (var_1_26 == ((signed short int) var_1_9))))) && ((var_1_10 > (var_1_26 & var_1_11)) ? (var_1_27 == ((unsigned char) (var_1_28 && (! (! var_1_29))))) : ((! var_1_13) ? (var_1_27 == ((unsigned char) var_1_29)) : (var_1_27 == ((unsigned char) var_1_14))))) && ((var_1_9 < var_1_15) ? (var_1_30 == ((signed short int) (var_1_10 - (max (var_1_9 , var_1_11))))) : (((var_1_16 / 1.5) < 8.725) ? ((var_1_20 != (min ((- var_1_20) , var_1_16))) ? (var_1_30 == ((signed short int) (var_1_8 + 128))) : 1) : 1))) && (var_1_31 == ((signed long int) var_1_8))) && (var_1_32 == ((unsigned char) 0))
;
}
int main(void) {
	isInitial = 1;
