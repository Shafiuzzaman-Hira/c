...
void step(void) {
	...
	if (var_1_7 <= stepLocal_23) {
		if (var_1_35) {
			var_1_86 = ((var_1_52 - var_1_53) + (max (1.75 , 31.25)));
		}
	} else {
		var_1_86 = 15.6;
	}
	...
	signed long int stepLocal_6 = (max (last_1_var_1_58 , var_1_10)) + var_1_21;
	...
	if ((- var_1_1) != (1.000000000025E10 * (max (var_1_2 , var_1_5)))) {
		var_1_48 = ((abs (var_1_2)) - var_1_49);
	} else {
		var_1_48 = (var_1_49 - (max (var_1_50 , (abs (var_1_2)))));
	}


	// From: Req24Batch94Amount500
	var_1_62 = (min (var_1_13 , (var_1_63 - var_1_60)));


	// From: Req26Batch94Amount500
	var_1_65 = (max ((max ((abs (var_1_49)) , (var_1_50 - var_1_52))) , (var_1_54 - (min (var_1_57 , var_1_53)))));
	...
	if ((- var_1_52) == (31.4 - var_1_50)) {
		var_1_67 = ((min ((var_1_21 + var_1_23) , 2)) + (abs (var_1_7)));
	}


	// From: Req29Batch94Amount500
	if (var_1_35 || (var_1_54 <= (var_1_57 * var_1_2))) {
		var_1_68 = (max (var_1_62 , (min (var_1_18 , var_1_10))));
	}
	...
	var_1_89 = (abs ((min (var_1_76 , var_1_27)) - var_1_22));
	...
	// From: Req46Batch94Amount500
	var_1_94 = 256u;


	// From: Req47Batch94Amount500
	if (var_1_34) {
		var_1_95 = var_1_30;
	} else {
		var_1_95 = 1;
	...
	// From: Req52Batch94Amount500
	var_1_100 = var_1_11;


	// From: Req54Batch94Amount500
	var_1_102 = var_1_30;


	// From: Req56Batch94Amount500
	if (var_1_34) {
		var_1_104 = 1;
	}


	// From: Req57Batch94Amount500
	if (var_1_102) {
		var_1_105 = var_1_52;
	} else {
		var_1_105 = var_1_2;
	...
	if (var_1_66 && (var_1_7 > var_1_106)) {
		var_1_40 = ((max (var_1_19 , 8)) + (min (var_1_23 , var_1_20)));
	} else {
		var_1_40 = (min ((var_1_27 + var_1_21) , -2));
	}
	...
	if (stepLocal_7 && (var_1_94 < var_1_27)) {
		var_1_41 = ((max ((var_1_42 + 2) , var_1_10)) + var_1_22);
	} else {
		var_1_41 = (((abs (var_1_28)) - var_1_22) + 64);
	}
	...
	if (var_1_32) {
		if ((var_1_48 + (1.375f + var_1_2)) > var_1_3) {
			var_1_43 = ((var_1_28 + var_1_67) + (abs (var_1_26)));
		}
	}
	...
	if (var_1_50 <= var_1_105) {
		if (var_1_102) {
			var_1_77 = ((abs (min (var_1_13 , var_1_63))) - (last_1_var_1_77 + var_1_28));
		} else {
	...
	if (-200 > ((var_1_22 - 200) + var_1_9)) {
		if (var_1_20 < (var_1_93 + var_1_18)) {
			var_1_24 = (min (var_1_20 , var_1_18));
		}
	}
	...
	if ((max (var_1_10 , var_1_8)) < stepLocal_4) {
		var_1_25 = ((2 + (var_1_26 + var_1_27)) + (min ((var_1_23 + var_1_22) , var_1_7)));
	} else {
	...
	if (var_1_2 > var_1_3) {
		if ((var_1_27 >> var_1_24) == stepLocal_10) {
			var_1_51 = (max ((var_1_50 - (var_1_52 + var_1_53)) , (var_1_49 - var_1_54)));
		} else {
			var_1_51 = var_1_2;
		}
	} else {
	...
	if (var_1_34) {
		if ((var_1_3 >= var_1_49) || var_1_70) {
			...
			var_1_55 = (max (var_1_27 , ((var_1_28 + var_1_25) + var_1_22)));
		}
	} else {
		if (var_1_53 != var_1_54) {
			var_1_55 = (abs (var_1_7));
		} else {
			if (var_1_37 < var_1_22) {
				var_1_55 = var_1_42;
			} else {
				var_1_55 = (max ((var_1_13 - (max (var_1_6 , var_1_28))) , var_1_24));
			}
		}
	}
	...
	unsigned char stepLocal_13 = var_1_38 <= (min (var_1_92 , var_1_26));
	if (var_1_32) {
		var_1_64 = (max (var_1_50 , var_1_57));
	} else {
		if (stepLocal_13 && var_1_87) {
			if (var_1_30) {
				if (var_1_50 != var_1_49) {
					var_1_64 = (var_1_53 + (max (var_1_2 , -0.2)));
				}
			} else {
				var_1_64 = (max (2.75 , (var_1_53 - var_1_52)));
			}
		}
	}
	...
	if (var_1_57 == var_1_3) {
		...
		if (var_1_34) {
			if (((min (var_1_60 , -4)) ^ var_1_10) == var_1_36) {
				var_1_81 = (var_1_6 - ((var_1_75 + var_1_82) - (abs (var_1_21))));
			}
		} else {
	...
	// From: Req55Batch94Amount500
	var_1_103 = var_1_81;


	// From: Req59Batch94Amount500
	if ((min (var_1_28 , var_1_60)) > var_1_61) {
		var_1_107 = ((min ((var_1_42 + var_1_75) , var_1_7)) + var_1_23);
	} else {
		if (var_1_103 != 5) {
			var_1_107 = var_1_6;
		} else {
	...
	if (((var_1_53 + var_1_101) / (abs (var_1_5))) <= var_1_86) {
		if (var_1_3 >= ((3.1 * 1.8) / (abs (var_1_5)))) {
			if (stepLocal_26 >= var_1_43) {
				var_1_90 = (var_1_6 + (min (var_1_76 , var_1_60)));
			}
		}
	}
	...
	if (var_1_32 && var_1_104) {
		...
		if (var_1_11 < ((min (var_1_42 , var_1_62)) | var_1_90)) {
	...
	if (var_1_69) {
		var_1_88 = (min (var_1_61 , var_1_22));
	} else {
	...
	if (stepLocal_9 == ((var_1_55 / var_1_6) * var_1_8)) {
		var_1_45 = (min (var_1_28 , (max (var_1_55 , (var_1_88 + var_1_24)))));
	} else {
		if (stepLocal_8 < var_1_106) {
			var_1_45 = ((var_1_47 - var_1_13) - (min (var_1_24 , var_1_8)));
		}
	}
	...
	if (((max (var_1_9 , var_1_71)) * (min (var_1_10 , var_1_4))) > stepLocal_1) {
	...
	signed long int stepLocal_17 = (min (var_1_23 , 0)) - (var_1_28 - var_1_22);
	...
	if (stepLocal_16 || var_1_66) {
		if (var_1_22 == stepLocal_15) {
			if (var_1_104) {
				...
				if ((max ((min (var_1_57 , var_1_49)) , 255.875)) > ((var_1_73 - var_1_53) - var_1_54)) {
					var_1_72 = (var_1_27 + var_1_20);
				} else {
					var_1_72 = (min (var_1_19 , -64));
				}
			}
		} else {
			var_1_72 = ((max (var_1_9 , (min (var_1_10 , var_1_22)))) - var_1_23);
		}
	} else {
		if (var_1_20 > stepLocal_17) {
			...
			if (stepLocal_18 >= ((50 << 1) ^ var_1_81)) {
				var_1_72 = (var_1_74 + (min ((var_1_27 + var_1_20) , (min (var_1_23 , var_1_26)))));
			} else {
...
int property() {
	return ((((((((((((((((((((((((((((((((((((((((((((((((((((((((((var_1_1 == ((double) (min (9.999999999999925E13 , (var_1_2 + (abs (var_1_3))))))) && ((var_1_84 <= (25.75 / var_1_5)) ? (var_1_4 == ((unsigned char) (var_1_6 - var_1_7))) : 1)) && (var_1_8 == ((signed char) (var_1_9 - var_1_10)))) && (var_1_11 == ((unsigned char) (min (var_1_6 , var_1_7))))) && ((((max (var_1_9 , var_1_71)) * (min (var_1_10 , var_1_4))) > var_1_6) ? ((var_1_62 < (var_1_6 * var_1_10)) ? (var_1_12 == ((unsigned short int) ((var_1_13 - var_1_62) - 10))) : (((- var_1_2) >= 0.125) ? (var_1_12 == ((unsigned short int) 128)) : (var_1_12 == ((unsigned short int) var_1_4)))) : (var_1_12 == ((unsigned short int) var_1_4)))) && ((var_1_7 < var_1_10) ? (var_1_14 == ((signed long int) (var_1_13 - (var_1_6 + var_1_36)))) : ((var_1_5 < var_1_101) ? (var_1_14 == ((signed long int) var_1_13)) : (var_1_14 == ((signed long int) -4))))) && ((! var_1_95) ? (var_1_15 == ((signed char) (var_1_18 + (var_1_19 + var_1_20)))) : (var_1_15 == ((signed char) (var_1_20 + ((max (var_1_21 , var_1_22)) - var_1_23)))))) && ((-200 > ((var_1_22 - 200) + var_1_9)) ? ((var_1_20 < (var_1_93 + var_1_18)) ? (var_1_24 == ((signed char) (min (var_1_20 , var_1_18)))) : 1) : 1)) && (((max (var_1_10 , var_1_8)) < (var_1_11 * var_1_23)) ? (var_1_25 == ((unsigned char) ((2 + (var_1_26 + var_1_27)) + (min ((var_1_23 + var_1_22) , var_1_7))))) : ((var_1_27 >= var_1_23) ? (var_1_25 == ((unsigned char) (var_1_6 - (var_1_28 - var_1_26)))) : ((var_1_2 > (var_1_101 * var_1_3)) ? (var_1_25 == ((unsigned char) 10)) : 1)))) && ((var_1_10 < last_1_var_1_45) ? ((((max (last_1_var_1_58 , var_1_10)) + var_1_21) >= last_1_var_1_92) ? (var_1_29 == ((unsigned char) var_1_30)) : (var_1_29 == ((unsigned char) (var_1_30 && var_1_31)))) : (var_1_29 == ((unsigned char) var_1_32)))) && ((! last_1_var_1_33) ? (var_1_33 == ((unsigned char) (! (last_1_var_1_33 && var_1_32)))) : (var_1_33 == ((unsigned char) ((var_1_32 && var_1_34) || var_1_35))))) && ((var_1_3 < var_1_105) ? (var_1_36 == ((unsigned long int) (var_1_37 - ((var_1_38 - var_1_28) - (var_1_41 + var_1_27))))) : (var_1_36 == ((unsigned long int) var_1_10)))) && ((var_1_66 && (var_1_7 > var_1_106)) ? (var_1_40 == ((signed char) ((max (var_1_19 , 8)) + (min (var_1_23 , var_1_20))))) : (var_1_40 == ((signed char) (min ((var_1_27 + var_1_21) , -2)))))) && ((var_1_102 && (var_1_94 < var_1_27)) ? (var_1_41 == ((unsigned char) ((max ((var_1_42 + 2) , var_1_10)) + var_1_22))) : (var_1_41 == ((unsigned char) (((abs (var_1_28)) - var_1_22) + 64))))) && (var_1_32 ? (((var_1_48 + (1.375f + var_1_2)) > var_1_3) ? (var_1_43 == ((signed long int) ((var_1_28 + var_1_67) + (abs (var_1_26))))) : 1) : 1)) && (var_1_32 ? (var_1_44 == ((unsigned char) ((var_1_14 != var_1_37) && (var_1_35 || var_1_34)))) : 1)) && ((var_1_42 == ((var_1_55 / var_1_6) * var_1_8)) ? (var_1_45 == ((unsigned long int) (min (var_1_28 , (max (var_1_55 , (var_1_88 + var_1_24))))))) : (((~ var_1_6) < var_1_106) ? (var_1_45 == ((unsigned long int) ((var_1_47 - var_1_13) - (min (var_1_24 , var_1_8))))) : 1))) && (((- var_1_1) != (1.000000000025E10 * (max (var_1_2 , var_1_5)))) ? (var_1_48 == ((double) ((abs (var_1_2)) - var_1_49))) : (var_1_48 == ((double) (var_1_49 - (max (var_1_50 , (abs (var_1_2))))))))) && ((var_1_2 > var_1_3) ? (((var_1_27 >> var_1_24) == var_1_47) ? (var_1_51 == ((double) (max ((var_1_50 - (var_1_52 + var_1_53)) , (var_1_49 - var_1_54))))) : (var_1_51 == ((double) var_1_2))) : (var_1_66 ? (var_1_51 == ((double) (var_1_50 - var_1_52))) : 1))) && (var_1_34 ? (((var_1_3 >= var_1_49) || var_1_70) ? (var_1_55 == ((unsigned short int) var_1_21)) : (var_1_55 == ((unsigned short int) (max (var_1_27 , ((var_1_28 + var_1_25) + var_1_22)))))) : ((var_1_53 != var_1_54) ? (var_1_55 == ((unsigned short int) (abs (var_1_7)))) : ((var_1_37 < var_1_22) ? (var_1_55 == ((unsigned short int) var_1_42)) : (var_1_55 == ((unsigned short int) (max ((var_1_13 - (max (var_1_6 , var_1_28))) , var_1_24)))))))) && ((var_1_27 < (var_1_81 / var_1_28)) ? ((0 > var_1_67) ? (var_1_56 == ((double) (var_1_3 + 10.6))) : (var_1_56 == ((double) ((var_1_57 - var_1_53) - var_1_50)))) : 1)) && (var_1_87 ? (var_1_58 == ((signed long int) (abs (var_1_21)))) : (var_1_58 == ((signed long int) var_1_11)))) && ((var_1_32 && var_1_104) ? (var_1_59 == ((unsigned short int) (60191 - var_1_6))) : ((var_1_11 < ((min (var_1_42 , var_1_62)) | var_1_90)) ? (var_1_59 == ((unsigned short int) (var_1_13 - var_1_10))) : (var_1_59 == ((unsigned short int) (var_1_13 - ((var_1_60 - var_1_42) - (var_1_61 - var_1_26)))))))) && (var_1_62 == ((unsigned short int) (min (var_1_13 , (var_1_63 - var_1_60)))))) && (var_1_32 ? (var_1_64 == ((double) (max (var_1_50 , var_1_57)))) : (((var_1_38 <= (min (var_1_92 , var_1_26))) && var_1_87) ? (var_1_30 ? ((var_1_50 != var_1_49) ? (var_1_64 == ((double) (var_1_53 + (max (var_1_2 , -0.2))))) : 1) : (var_1_64 == ((double) (max (2.75 , (var_1_53 - var_1_52)))))) : 1))) && (var_1_65 == ((double) (max ((max ((abs (var_1_49)) , (var_1_50 - var_1_52))) , (var_1_54 - (min (var_1_57 , var_1_53)))))))) && (var_1_66 == ((unsigned char) (! (! var_1_35))))) && (((- var_1_52) == (31.4 - var_1_50)) ? (var_1_67 == ((unsigned char) ((min ((var_1_21 + var_1_23) , 2)) + (abs (var_1_7))))) : 1)) && ((var_1_35 || (var_1_54 <= (var_1_57 * var_1_2))) ? (var_1_68 == ((signed long int) (max (var_1_62 , (min (var_1_18 , var_1_10)))))) : 1)) && ((var_1_62 < 256) ? (var_1_69 == ((unsigned char) var_1_31)) : (((- var_1_57) < var_1_105) ? ((var_1_101 < (15.5 + var_1_105)) ? (var_1_69 == ((unsigned char) (! 0))) : (var_1_69 == ((unsigned char) (var_1_34 || (! var_1_30))))) : (var_1_69 == ((unsigned char) var_1_32))))) && (var_1_70 == ((unsigned char) ((! var_1_31) || var_1_32)))) && ((! var_1_66) ? (var_1_71 == ((unsigned long int) var_1_37)) : 1)) && (((var_1_42 >= var_1_4) || var_1_66) ? ((var_1_22 == var_1_38) ? (var_1_104 ? (var_1_72 == ((signed char) (var_1_22 + var_1_26))) : (((max ((min (var_1_57 , var_1_49)) , 255.875)) > ((var_1_73 - var_1_53) - var_1_54)) ? (var_1_72 == ((signed char) (var_1_27 + var_1_20))) : (var_1_72 == ((signed char) (min (var_1_19 , -64)))))) : (var_1_72 == ((signed char) ((max (var_1_9 , (min (var_1_10 , var_1_22)))) - var_1_23)))) : ((var_1_20 > ((min (var_1_23 , 0)) - (var_1_28 - var_1_22))) ? (var_1_72 == ((signed char) ((8 - var_1_27) + (var_1_26 - var_1_21)))) : ((var_1_103 >= ((50 << 1) ^ var_1_81)) ? (var_1_72 == ((signed char) (var_1_74 + (min ((var_1_27 + var_1_20) , (min (var_1_23 , var_1_26))))))) : (var_1_72 == ((signed char) (((var_1_75 + var_1_76) - 10) - (var_1_26 + var_1_22)))))))) && ((var_1_50 <= var_1_105) ? (var_1_102 ? (var_1_77 == ((unsigned short int) ((abs (min (var_1_13 , var_1_63))) - (last_1_var_1_77 + var_1_28)))) : (((var_1_21 - var_1_23) < 16) ? (var_1_77 == ((unsigned short int) (var_1_13 - 5))) : 1)) : 1)) && ((var_1_6 < ((var_1_92 | var_1_68) + var_1_37)) ? (var_1_78 == ((signed long int) ((var_1_79 - var_1_63) - var_1_75))) : (var_1_78 == ((signed long int) (max ((1 - 50) , var_1_76)))))) && (var_1_44 ? (var_1_80 == ((signed short int) var_1_18)) : (var_1_80 == ((signed short int) (var_1_36 - var_1_76))))) && ((var_1_57 == var_1_3) ? (var_1_81 == ((unsigned char) var_1_7)) : (var_1_34 ? ((((min (var_1_60 , -4)) ^ var_1_10) == var_1_36) ? (var_1_81 == ((unsigned char) (var_1_6 - ((var_1_75 + var_1_82) - (abs (var_1_21)))))) : 1) : (((var_1_99 | 1) != var_1_6) ? ((1000000 < (var_1_100 & var_1_41)) ? (var_1_81 == ((unsigned char) (((var_1_83 - var_1_26) - var_1_21) - var_1_10))) : 1) : 1)))) && ((var_1_83 <= var_1_21) ? ((var_1_1 <= var_1_64) ? ((var_1_21 > (var_1_22 - var_1_82)) ? ((! var_1_98) ? (var_1_84 == ((double) (abs (var_1_53)))) : 1) : 1) : (((var_1_1 + var_1_2) <= 31.5) ? ((((var_1_83 * var_1_20) <= (var_1_59 * var_1_75)) && var_1_104) ? (var_1_84 == ((double) (((min (var_1_53 , var_1_52)) + var_1_85) - var_1_50))) : 1) : 1)) : 1)) && ((var_1_7 <= last_1_var_1_90) ? (var_1_35 ? (var_1_86 == ((double) ((var_1_52 - var_1_53) + (max (1.75 , 31.25))))) : 1) : (var_1_86 == ((double) 15.6)))) && ((var_1_18 >= (var_1_78 * var_1_75)) ? (var_1_87 == ((unsigned char) (! var_1_32))) : 1)) && (var_1_69 ? (var_1_88 == ((unsigned short int) (min (var_1_61 , var_1_22)))) : ((var_1_36 < (var_1_80 & var_1_83)) ? (var_1_88 == ((unsigned short int) (var_1_13 - 256))) : (var_1_88 == ((unsigned short int) (var_1_13 - var_1_82)))))) && (var_1_89 == ((signed char) (abs ((min (var_1_76 , var_1_27)) - var_1_22))))) && ((((var_1_53 + var_1_101) / (abs (var_1_5))) <= var_1_86) ? ((var_1_3 >= ((3.1 * 1.8) / (abs (var_1_5)))) ? (((var_1_24 / var_1_76) >= var_1_43) ? (var_1_90 == ((unsigned short int) (var_1_6 + (min (var_1_76 , var_1_60))))) : 1) : 1) : 1)) && (var_1_92 == ((signed short int) (var_1_74 + (var_1_10 - var_1_76))))) && (var_1_98 ? (var_1_93 == ((unsigned char) 5)) : (var_1_93 == ((unsigned char) var_1_42)))) && (var_1_94 == ((unsigned long int) 256u))) && (var_1_34 ? (var_1_95 == ((unsigned char) var_1_30)) : (var_1_95 == ((unsigned char) 1)))) && (var_1_33 ? (var_1_96 == ((signed long int) last_1_var_1_96)) : (var_1_96 == ((signed long int) var_1_97)))) && (var_1_44 ? (var_1_97 == ((signed short int) var_1_83)) : (var_1_97 == ((signed short int) var_1_23)))) && (last_1_var_1_98 ? (var_1_98 == ((unsigned char) var_1_35)) : (var_1_98 == ((unsigned char) var_1_35)))) && (var_1_70 ? (var_1_99 == ((unsigned char) var_1_26)) : (var_1_99 == ((unsigned char) var_1_83)))) && (var_1_100 == ((signed short int) var_1_11))) && (var_1_104 ? (var_1_101 == ((float) var_1_57)) : (var_1_101 == ((float) var_1_52)))) && (var_1_102 == ((unsigned char) var_1_30))) && (var_1_103 == ((unsigned short int) var_1_81))) && (var_1_34 ? (var_1_104 == ((unsigned char) 1)) : 1)) && (var_1_102 ? (var_1_105 == ((double) var_1_52)) : (var_1_105 == ((double) var_1_2)))) && (var_1_29 ? (var_1_106 == ((signed char) var_1_21)) : (var_1_106 == ((signed char) var_1_42)))) && (((min (var_1_28 , var_1_60)) > var_1_61) ? (var_1_107 == ((unsigned char) ((min ((var_1_42 + var_1_75) , var_1_7)) + var_1_23))) : ((var_1_103 != 5) ? (var_1_107 == ((unsigned char) var_1_6)) : (var_1_107 == ((unsigned char) var_1_6))))
;
}
int main(void) {
	isInitial = 1;
