...
void step(void) {
	...
	// From: Req7Batch70Filler_PR_CI
	if ((var_1_14 / var_1_19) <= (min (var_1_18 , var_1_14))) {
		var_1_20 = var_1_13;
	}


	// From: Req4Batch70Filler_PR_CI
	if (var_1_20) {
		var_1_12 = var_1_13;
	}
	...
	if ((var_1_9 <= var_1_17) && var_1_20) {
		if (! ((max (var_1_18 , var_1_9)) < (var_1_14 & var_1_17))) {
			var_1_27 = var_1_13;
		} else {
			if ((~ var_1_17) >= (var_1_18 & (abs (var_1_9)))) {
				var_1_27 = var_1_13;
			} else {
				var_1_27 = var_1_13;
			}
	...
	// From: Req3Batch70Filler_PR_CI
	var_1_11 = (var_1_9 + ((min (var_1_18 , var_1_9)) + 2u));


	// From: CodeObject1
	if ((min (var_1_11 , var_1_15)) > var_1_14) {
		var_1_21 = (min (((min (var_1_14 , 0)) + var_1_17) , 16));
	}
