...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch81Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((var_1_9 == last_1_var_1_17) || stepLocal_4) {
		if (stepLocal_3 >= var_1_24) {
			if (stepLocal_2 < var_1_28) {
				var_1_31 = (abs (max (var_1_28 , var_1_24)));
			} else {
	...
	// From: Req5Batch81Amount100
	var_1_18 = var_1_19;


	// From: Req7Batch81Amount100
	var_1_22 = ((min (0 , var_1_23)) + var_1_24);


	// From: Req9Batch81Amount100
	signed long int stepLocal_1 = (var_1_27 + var_1_28) - (max (var_1_29 , var_1_30));
	if (stepLocal_1 >= var_1_22) {
		var_1_26 = (var_1_14 - var_1_13);
	}


	// From: Req8Batch81Amount100
...
int property() {
	return (((((((((((! (var_1_11 > var_1_26)) ? (((~ (abs (4))) >= (var_1_31 ^ var_1_22)) ? (var_1_1 == ((signed long int) 16)) : (var_1_1 == ((signed long int) var_1_25))) : 1) && ((! var_1_20) ? (var_1_8 == ((unsigned short int) (max (var_1_9 , var_1_10)))) : 1)) && ((last_1_var_1_33 == (1.00000000000528E11 - var_1_12)) ? (var_1_11 == ((float) (max (((max (var_1_13 , var_1_14)) - var_1_15) , (abs (abs (var_1_16))))))) : (var_1_11 == ((float) var_1_16)))) && ((var_1_12 >= var_1_26) ? (var_1_17 == ((signed long int) (var_1_25 + 25))) : 1)) && (var_1_18 == ((double) var_1_19))) && ((last_1_var_1_1 >= (last_1_var_1_22 + last_1_var_1_31)) ? (var_1_20 == ((unsigned char) (var_1_4 && ((1.8f == last_1_var_1_33) && var_1_21)))) : (((max (last_1_var_1_11 , var_1_15)) != var_1_19) ? (var_1_20 == ((unsigned char) var_1_21)) : 1))) && (var_1_22 == ((signed char) ((min (0 , var_1_23)) + var_1_24)))) && ((((var_1_8 + var_1_9) + (var_1_31 * var_1_31)) >= var_1_23) ? ((var_1_21 || (var_1_13 > var_1_18)) ? (var_1_25 == ((unsigned short int) var_1_9)) : (var_1_25 == ((unsigned short int) var_1_9))) : (var_1_25 == ((unsigned short int) var_1_9)))) && ((((var_1_27 + var_1_28) - (max (var_1_29 , var_1_30))) >= var_1_22) ? (var_1_26 == ((double) (var_1_14 - var_1_13))) : 1)) && (((var_1_9 == last_1_var_1_17) || last_1_var_1_20) ? ((last_1_var_1_8 >= var_1_24) ? (((8 | last_1_var_1_22) < var_1_28) ? (var_1_31 == ((signed long int) (abs (max (var_1_28 , var_1_24))))) : (var_1_31 == ((signed long int) last_1_var_1_22))) : 1) : 1)) && ((var_1_30 >= var_1_22) ? (((var_1_13 / var_1_34) <= var_1_11) ? (var_1_20 ? ((var_1_14 <= (var_1_34 / (max (var_1_35 , var_1_36)))) ? (var_1_33 == ((float) (var_1_37 + var_1_38))) : ((var_1_26 <= var_1_13) ? (var_1_33 == ((float) (max (var_1_37 , var_1_38)))) : (var_1_33 == ((float) (var_1_13 - var_1_14))))) : (var_1_33 == ((float) (max (var_1_16 , (var_1_38 + var_1_37)))))) : (var_1_33 == ((float) (var_1_39 - var_1_14)))) : ((0.3 < var_1_34) ? (var_1_33 == ((float) var_1_15)) : (var_1_33 == ((float) var_1_16))))
;
}
int main(void) {
	isInitial = 1;
