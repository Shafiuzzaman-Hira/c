...
void step(void) {
	...
	if (var_1_24 < var_1_31) {
		if ((var_1_30 & var_1_24) >= var_1_33) {
			var_1_32 = (max ((min ((abs (10)) , (max (var_1_34 , var_1_35)))) , (51998 - (5 + var_1_36))));
		}
	}
	...
	// From: Req2Batch71PS_CN_25
	var_1_10 = var_1_11;


	// From: Req3Batch71PS_CN_25
	...
	// From: Req5Batch71PS_CN_25
	var_1_18 = (max ((max (255.5f , var_1_11)) , 5.5f));


	// From: Req7Batch71PS_CN_25
	var_1_20 = var_1_15;


	// From: Req8Batch71PS_CN_25
	var_1_21 = var_1_5;


	// From: Req9Batch71PS_CN_25
	var_1_22 = var_1_23;


	// From: Req6Batch71PS_CN_25
	if (var_1_3) {
