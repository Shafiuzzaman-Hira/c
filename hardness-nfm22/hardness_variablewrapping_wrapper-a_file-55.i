...
void step(void) {
 ...
 if (BOOL_unsigned_char_Array_0[1]) {
  if (stepLocal_1 && BOOL_unsigned_char_Array_0[0]) {
   if (last_1_signed_long_int_Array_0_0_ >= stepLocal_0) {
    ...
    unsigned_short_int_Array_0[0] = ((((25) < (last_1_unsigned_char_Array_0_0_)) ? (25) : (last_1_unsigned_char_Array_0_0_)));
   }
  }
 } else {
 ...
 signed long int stepLocal_3 = ((((-4 >> unsigned_short_int_Array_0[0])) < (unsigned_short_int_Array_0[0])) ? ((-4 >> unsigned_short_int_Array_0[0])) : (unsigned_short_int_Array_0[0]));
