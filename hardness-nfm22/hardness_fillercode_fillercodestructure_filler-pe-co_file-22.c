...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch22Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch22Filler_PE_CO
	if ((- 3.75) < (min (var_1_20 , var_1_22))) {
		var_1_27 = 0;
	}


	// From: Req2Batch22Filler_PE_CO
