...
void step(void) {
	...
	// From: CodeObject6
	if ((min (var_1_7 , var_1_13)) <= var_1_11) {
		if (var_1_8) {
			if (var_1_9 || var_1_10) {
				if ((abs (var_1_11)) > var_1_13) {
					var_1_34 = var_1_7;
				}
			}
		}
	} else {
		if ((abs (var_1_13)) > var_1_11) {
			if (var_1_21 > 49.75f) {
				var_1_34 = (abs (min ((min (var_1_5 , var_1_11)) , -25)));
			}
		} else {
			var_1_34 = var_1_7;
		}
	...
	if ((~ (5 + var_1_12)) >= 10000u) {
		var_1_29 = (max ((var_1_1 + var_1_12) , (abs (var_1_12))));
	} else {
		var_1_29 = (abs (abs (max (var_1_1 , var_1_12))));
	}


	// From: CodeObject5
	if (var_1_11 <= (min (var_1_12 , (var_1_12 | -5)))) {
		if (var_1_10) {
			var_1_32 = var_1_12;
		}
	}
