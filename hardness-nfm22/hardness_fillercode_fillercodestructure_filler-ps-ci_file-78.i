...
void step(void) {
 var_1_22 = var_1_5;
 if (((((var_1_5) < (var_1_4)) ? (var_1_5) : (var_1_4))) >= var_1_1) {
  var_1_24 = ((var_1_26 + var_1_27) - var_1_4);
 }
 if (var_1_27 > 0) {
  var_1_28 = (((((((((var_1_29 + var_1_30)) > (var_1_5)) ? ((var_1_29 + var_1_30)) : (var_1_5)))) < (0)) ? ((((((var_1_29 + var_1_30)) > (var_1_5)) ? ((var_1_29 + var_1_30)) : (var_1_5)))) : (0)));
 }
 if (var_1_26 != 10) {
 ...
 if (var_1_26 > 100) {
  if ((((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))) ^ var_1_26) > var_1_6) {
   var_1_32 = (! var_1_33);
  } else {
   var_1_32 = var_1_34;
  }
 }
 var_1_35 = ((((var_1_26) > (((((var_1_5) < 0 ) ? -(var_1_5) : (var_1_5))))) ? (var_1_26) : (((((var_1_5) < 0 ) ? -(var_1_5) : (var_1_5))))));
