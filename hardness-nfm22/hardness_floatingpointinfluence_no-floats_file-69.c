...
int property() {
	return ((((var_1_2 * (min (var_1_3 , var_1_4))) < var_1_5) ? ((var_1_5 > var_1_2) ? (var_1_1 == ((signed short int) var_1_7)) : (var_1_1 == ((signed short int) var_1_7))) : 1) && ((var_1_2 < (max ((var_1_4 * var_1_5) , var_1_3))) ? (var_1_7 == ((signed char) var_1_8)) : ((var_1_9 || var_1_10) ? (var_1_7 == ((signed char) var_1_8)) : ((var_1_3 < var_1_4) ? (var_1_7 == ((signed char) var_1_8)) : (var_1_7 == ((signed char) -4)))))) && ((((var_1_7 + var_1_8) == var_1_4) && var_1_9) ? ((! var_1_10) ? (((var_1_1 + var_1_7) != var_1_8) ? (var_1_11 == ((signed long int) var_1_13)) : (var_1_11 == ((signed long int) var_1_13))) : (var_1_11 == ((signed long int) var_1_13))) : (var_1_11 == ((signed long int) var_1_13)))
;
}
int main(void) {
	isInitial = 1;
