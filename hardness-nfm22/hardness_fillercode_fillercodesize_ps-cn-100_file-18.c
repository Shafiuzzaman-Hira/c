...
void step(void) {
	...
	// From: CodeObject7
	if ((10 + (abs (var_1_22))) <= var_1_23) {
		var_1_38 = (abs (16));
	}


	// From: CodeObject8
	if (var_1_40 >= (abs (var_1_41))) {
	...
	if (var_1_35 == (var_1_30 % var_1_33)) {
		if (var_1_40 >= var_1_41) {
			var_1_43 = (max ((abs (var_1_22)) , (100 - var_1_35)));
		} else {
			var_1_43 = var_1_25;
		}
	} else {
	...
	// From: CodeObject10
	if (var_1_29 > ((abs (var_1_34)) % var_1_33)) {
		var_1_44 = (abs (abs (var_1_25)));
	}


	// From: CodeObject11
	var_1_45 = ((min (var_1_30 , var_1_25)) - 1);
