...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch16Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch16Wrapper_A
	if ((last_1_signed_char_Array_0_1_ % (max (signed_short_int_Array_0[2] , signed_short_int_Array_0[1]))) <= -1000000) {
		BOOL_unsigned_char_Array_0[2] = (BOOL_unsigned_char_Array_0[1] || BOOL_unsigned_char_Array_0[0]);
	}


	// From: Req2Batch16Wrapper_A
	float_Array_0[2] = float_Array_0[0];


	// From: Req4Batch16Wrapper_A
	signed char stepLocal_2 = signed_char_Array_0[3];
	unsigned char stepLocal_1 = 99999.375 <= float_Array_0[1];
	if (signed_char_Array_0[2] <= stepLocal_2) {
		if ((float_Array_0[0] < float_Array_0[2]) && stepLocal_1) {
			signed_short_int_Array_0[0] = (signed_char_Array_0[2] + signed_char_Array_0[4]);
		}
	} else {
		signed_short_int_Array_0[0] = -25;
	}


	// From: Req3Batch16Wrapper_A
	unsigned char stepLocal_0 = BOOL_unsigned_char_Array_0[0];
	if (float_Array_0[0] < (float_Array_0[2] / float_Array_0[1])) {
		if (BOOL_unsigned_char_Array_0[2] || stepLocal_0) {
			signed_char_Array_0[1] = (((max (signed_char_Array_0[3] , 5)) + (signed_char_Array_0[0] - signed_char_Array_0[2])) - signed_char_Array_0[4]);
		} else {
			if (float_Array_0[1] > float_Array_0[0]) {
				signed_char_Array_0[1] = signed_char_Array_0[3];
			} else {
...
int property() {
	return (((((last_1_signed_char_Array_0_1_ % (max (signed_short_int_Array_0[2] , signed_short_int_Array_0[1]))) <= -1000000) ? (BOOL_unsigned_char_Array_0[2] == ((unsigned char) (BOOL_unsigned_char_Array_0[1] || BOOL_unsigned_char_Array_0[0]))) : 1) && (float_Array_0[2] == ((float) float_Array_0[0]))) && ((float_Array_0[0] < (float_Array_0[2] / float_Array_0[1])) ? ((BOOL_unsigned_char_Array_0[2] || BOOL_unsigned_char_Array_0[0]) ? (signed_char_Array_0[1] == ((signed char) (((max (signed_char_Array_0[3] , 5)) + (signed_char_Array_0[0] - signed_char_Array_0[2])) - signed_char_Array_0[4]))) : ((float_Array_0[1] > float_Array_0[0]) ? (signed_char_Array_0[1] == ((signed char) signed_char_Array_0[3])) : (signed_char_Array_0[1] == ((signed char) signed_char_Array_0[0])))) : 1)) && ((signed_char_Array_0[2] <= signed_char_Array_0[3]) ? (((float_Array_0[0] < float_Array_0[2]) && (99999.375 <= float_Array_0[1])) ? (signed_short_int_Array_0[0] == ((signed short int) (signed_char_Array_0[2] + signed_char_Array_0[4]))) : 1) : (signed_short_int_Array_0[0] == ((signed short int) -25)))
;
}
int main(void) {
	isInitial = 1;
