...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch1100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req11Batch1100_1loop
	signed long int stepLocal_6 = last_1_var_1_24;
	if ((min ((var_1_19 / 2) , var_1_26)) <= stepLocal_6) {
		var_1_35 = (last_1_var_1_34 + (min (var_1_20 , var_1_32)));
	}


	// From: Req3Batch1100_1loop
	var_1_14 = (var_1_15 + var_1_16);


	// From: Req2Batch1100_1loop
	if (((- 16.1) + var_1_14) >= (var_1_11 - var_1_12)) {
		var_1_9 = var_1_13;
	}


	// From: Req6Batch1100_1loop
	if (var_1_9 <= (- 0.19999999999999996)) {
		if (var_1_6) {
			var_1_24 = (abs (var_1_19));
		} else {
			var_1_24 = (var_1_18 - 1);
		}
	}
	...
	// From: Req4Batch1100_1loop
	if ((var_1_12 - var_1_11) >= 3.4) {
		var_1_17 = ((var_1_18 - var_1_19) - var_1_20);
	} else {
		if ((var_1_15 / (abs (var_1_21))) <= (var_1_36 / var_1_22)) {
			var_1_17 = var_1_20;
		}
	}


	// From: Req5Batch1100_1loop
...
int property() {
	return ((((((((((((var_1_34 <= var_1_25) ? (((var_1_34 ^ (var_1_25 ^ var_1_24)) < var_1_35) ? (var_1_1 == ((unsigned char) (var_1_6 || var_1_7))) : (var_1_6 ? (var_1_1 == ((unsigned char) var_1_8)) : (var_1_1 == ((unsigned char) var_1_8)))) : 1) && ((((- 16.1) + var_1_14) >= (var_1_11 - var_1_12)) ? (var_1_9 == ((double) var_1_13)) : 1)) && (var_1_14 == ((float) (var_1_15 + var_1_16)))) && (((var_1_12 - var_1_11) >= 3.4) ? (var_1_17 == ((unsigned char) ((var_1_18 - var_1_19) - var_1_20))) : (((var_1_15 / (abs (var_1_21))) <= (var_1_36 / var_1_22)) ? (var_1_17 == ((unsigned char) var_1_20)) : 1))) && ((var_1_36 <= (var_1_36 * var_1_16)) ? (var_1_23 == ((unsigned char) ((! (500.1f >= var_1_36)) && (var_1_6 && var_1_7)))) : (var_1_23 == ((unsigned char) (var_1_7 || var_1_6))))) && ((var_1_9 <= (- 0.19999999999999996)) ? (var_1_6 ? (var_1_24 == ((unsigned char) (abs (var_1_19)))) : (var_1_24 == ((unsigned char) (var_1_18 - 1)))) : 1)) && (((var_1_34 <= var_1_20) || (var_1_15 == var_1_9)) ? (var_1_25 == ((unsigned long int) (var_1_26 - var_1_34))) : (var_1_25 == ((unsigned long int) var_1_34)))) && ((var_1_25 == ((var_1_25 + var_1_34) * (var_1_19 / var_1_18))) ? (var_1_27 == ((unsigned long int) ((var_1_29 - var_1_34) + var_1_35))) : 1)) && ((var_1_18 != (100 % (var_1_31 - var_1_32))) ? ((var_1_21 < (abs (- var_1_22))) ? ((var_1_23 && var_1_8) ? (var_1_30 == ((signed long int) (min ((var_1_24 - var_1_24) , var_1_32)))) : 1) : (var_1_30 == ((signed long int) var_1_35))) : 1)) && ((var_1_17 > var_1_30) ? (((var_1_31 <= var_1_17) || var_1_6) ? (var_1_34 == ((signed short int) (var_1_20 - var_1_18))) : 1) : (var_1_34 == ((signed short int) var_1_35)))) && (((min ((var_1_19 / 2) , var_1_26)) <= last_1_var_1_24) ? (var_1_35 == ((signed long int) (last_1_var_1_34 + (min (var_1_20 , var_1_32))))) : 1)) && ((var_1_9 <= var_1_13) ? (var_1_36 == ((double) (var_1_37 - var_1_38))) : (((var_1_20 / var_1_32) < 256) ? (var_1_36 == ((double) var_1_39)) : 1))
;
}
int main(void) {
	isInitial = 1;
