...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch50dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch50dependencies
	if (var_1_8) {
		var_1_13 = (min ((var_1_14 + var_1_15) , (min (-0.2f , var_1_16))));
	}


	// From: Req6Batch50dependencies
	if (var_1_8) {
		var_1_25 = (var_1_26 + var_1_27);
	}


	// From: Req8Batch50dependencies
	var_1_29 = var_1_27;


	// From: Req9Batch50dependencies
	var_1_30 = var_1_8;


	// From: Req2Batch50dependencies
	...
	// From: Req4Batch50dependencies
	var_1_17 = ((var_1_18 - 25) - var_1_25);


	// From: Req5Batch50dependencies
	if (((var_1_18 % var_1_21) & (abs (1u))) < (var_1_25 + var_1_17)) {
	...
	// From: Req1Batch50dependencies
	if ((max (var_1_9 , var_1_25)) <= (var_1_25 - var_1_25)) {
