...
void step(void) {
	...
	// From: CodeObject4
	if (var_1_16 <= ((var_1_34 - var_1_31) - (min (var_1_12 , var_1_21)))) {
		var_1_33 = 128;
	}
	...
	if ((var_1_1 | var_1_11) > var_1_14) {
		if (-16 <= (max ((var_1_12 - var_1_31) , (abs (var_1_1))))) {
			var_1_35 = (63.2 - 7.4);
		} else {
	...
	if (var_1_27 < var_1_34) {
		if ((abs (max (var_1_34 , var_1_20))) <= var_1_11) {
			var_1_38 = (min (((min (var_1_37 , var_1_36)) - var_1_39) , var_1_8));
		} else {
			var_1_38 = var_1_36;
		}
	} else {
	...
	// From: Req6Batch98Filler_PS_CI
	var_1_17 = var_1_18;


	// From: Req7Batch98Filler_PS_CI
	...
	// From: Req8Batch98Filler_PS_CI
	var_1_22 = var_1_18;


	// From: Req2Batch98Filler_PS_CI
	if (var_1_19 <= var_1_1) {
