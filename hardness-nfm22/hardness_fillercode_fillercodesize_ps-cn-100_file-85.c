...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch85PS_CN_100.c", 13, "reach_error"); }
...
double var_1_44 = 10.2;
double var_1_45 = 8.5;
double var_1_46 = 10.875;
double var_1_47 = 25.8;
signed short int var_1_48 = 0;
signed short int var_1_49 = 31128;
...
void step(void) {
	...
	// From: CodeObject4
	if ((min ((var_1_32 - var_1_33) , var_1_29)) > (var_1_34 * 31.3)) {
		if (var_1_22) {
			var_1_31 = var_1_35;
		}
	} else {
	...
	// From: CodeObject5
	if ((var_1_34 / 25.4f) >= (abs (var_1_28))) {
	...
	// From: CodeObject6
	if (! var_1_37) {
		if ((var_1_30 + var_1_24) >= ((var_1_21 + var_1_23) << (min (5 , var_1_39)))) {
			if (var_1_22 && (4.166 >= var_1_29)) {
				var_1_38 = (abs (min (var_1_39 , var_1_40)));
			} else {
				var_1_38 = (128 - (var_1_39 + var_1_41));
			}
		} else {
			if (! (var_1_26 >= var_1_41)) {
				if (var_1_25 != ((max (50 , var_1_21)) | (var_1_23 | var_1_39))) {
					var_1_38 = (abs (abs (var_1_39)));
				}
			} else {
				if (var_1_40 >= var_1_21) {
					var_1_38 = (min (var_1_39 , var_1_40));
				}
			}
		}
	}
	...
	// From: CodeObject10
	if (! var_1_22) {
		var_1_45 = (max (var_1_29 , (var_1_46 - (abs (var_1_47)))));
	}


	// From: CodeObject11
	if (var_1_21 <= var_1_41) {
		var_1_48 = ((var_1_49 - var_1_38) - (min (var_1_39 , (abs (var_1_41)))));
	} else {
		if (var_1_42 >= var_1_41) {
			if (4u > var_1_39) {
				var_1_48 = ((min (var_1_39 , var_1_27)) + var_1_40);
			}
		}
	}
	...
	if (var_1_50) {
		if (var_1_34 <= var_1_46) {
			var_1_51 = (max ((max ((var_1_40 + var_1_25) , var_1_38)) , var_1_24));
		} else {
			var_1_51 = var_1_24;
		}
	}
	...
	// From: Req5Batch85PS_CN_100
	var_1_13 = (abs (var_1_14));


	// From: Req7Batch85PS_CN_100
	var_1_16 = (var_1_6 && var_1_17);


	// From: Req6Batch85PS_CN_100
	if (var_1_5) {
		var_1_15 = (max (var_1_1 , (var_1_13 + (abs (var_1_14)))));
	}


	// From: Req3Batch85PS_CN_100
