...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch2650_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch2650_1loop
	if (var_1_11 > (var_1_22 * (var_1_12 + var_1_22))) {
		var_1_20 = var_1_21;
	}


	// From: Req6Batch2650_1loop
