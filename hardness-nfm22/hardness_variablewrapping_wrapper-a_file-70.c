...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch70Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req5Batch70Wrapper_A
	unsigned_char_Array_0[0] = unsigned_char_Array_0[1];


	// From: Req6Batch70Wrapper_A
	signed_char_Array_0[1] = signed_char_Array_0[0];


	// From: Req1Batch70Wrapper_A
	if (BOOL_unsigned_char_Array_0[0]) {
		unsigned_short_int_Array_0[1] = ((17222 - unsigned_char_Array_0[0]) + ((min (29916 , unsigned_short_int_Array_0[0])) - unsigned_char_Array_0[0]));
	}


	// From: Req2Batch70Wrapper_A
	if (BOOL_unsigned_char_Array_0[0] && (unsigned_short_int_Array_0[0] >= (unsigned_char_Array_0[0] + unsigned_short_int_Array_0[1]))) {
		signed_char_Array_0[2] = 8;
	}


	// From: Req3Batch70Wrapper_A
	unsigned short int stepLocal_0 = unsigned_short_int_Array_0[0];
	if (stepLocal_0 <= (max (unsigned_char_Array_0[0] , (unsigned_char_Array_0[0] << unsigned_char_Array_0[0])))) {
		signed_long_int_Array_0[0] = (min ((unsigned_char_Array_0[0] - unsigned_char_Array_0[0]) , unsigned_short_int_Array_0[0]));
	} else {
		signed_long_int_Array_0[0] = (unsigned_char_Array_0[0] + (unsigned_short_int_Array_0[1] + unsigned_short_int_Array_0[0]));
	}


	// From: Req4Batch70Wrapper_A
	unsigned char stepLocal_1 = unsigned_char_Array_0[0];
	if (unsigned_char_Array_0[0] < stepLocal_1) {
		double_Array_0[2] = (double_Array_0[1] - double_Array_0[3]);
	} else {
		double_Array_0[2] = ((double_Array_0[4] - double_Array_0[0]) - double_Array_0[1]);
	}
}
