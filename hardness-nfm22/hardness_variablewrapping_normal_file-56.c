...
void step(void) {
	...
	// From: Req3Batch56normal
	if ((var_1_8 + var_1_1) >= var_1_7) {
		var_1_14 = var_1_6;
	}


	// From: Req4Batch56normal
...
int property() {
	return (((((last_1_var_1_14 >> var_1_3) >= last_1_var_1_14) ? (var_1_1 == ((unsigned char) (min (var_1_3 , (var_1_5 - (max (var_1_6 , var_1_7))))))) : (var_1_1 == ((unsigned char) ((min (var_1_6 , var_1_3)) + (min ((var_1_8 + 1) , var_1_7)))))) && (var_1_16 ? ((var_1_16 || var_1_16) ? ((var_1_14 > var_1_6) ? (var_1_9 == ((double) var_1_13)) : 1) : 1) : 1)) && (((var_1_8 + var_1_1) >= var_1_7) ? (var_1_14 == ((unsigned char) var_1_6)) : 1)) && ((var_1_12 || var_1_10) ? ((var_1_1 >= (var_1_8 << var_1_3)) ? ((var_1_6 > var_1_7) ? (var_1_16 == ((unsigned char) var_1_17)) : (var_1_16 == ((unsigned char) 1))) : (var_1_16 == ((unsigned char) var_1_18))) : (var_1_16 == ((unsigned char) var_1_17)))
;
}
int main(void) {
	isInitial = 1;
