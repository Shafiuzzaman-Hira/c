...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch5Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
 if (var_1_12 <= (((((var_1_9) < (var_1_9)) ? (var_1_9) : (var_1_9))) >> (var_1_26 - var_1_27))) {
  var_1_22 = ((((var_1_9) > (var_1_9)) ? (var_1_9) : (var_1_9)));
 } else {
  var_1_22 = var_1_9;
 }
 if (8.4 <= var_1_15) {
  var_1_28 = (((((((var_1_21) < (var_1_12)) ? (var_1_21) : (var_1_12))) < 0 ) ? -((((var_1_21) < (var_1_12)) ? (var_1_21) : (var_1_12))) : ((((var_1_21) < (var_1_12)) ? (var_1_21) : (var_1_12)))));
 } else {
  var_1_28 = ((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21)));
 }
 if (var_1_15 == ((((32.5) < (var_1_15)) ? (32.5) : (var_1_15)))) {
  var_1_30 = var_1_27;
 } else {
  if (var_1_1 < var_1_21) {
   if (var_1_27 < var_1_1) {
 ...
 if (var_1_19) {
  var_1_32 = ((((var_1_21 + var_1_9) < 0 ) ? -(var_1_21 + var_1_9) : (var_1_21 + var_1_9)));
 }
 if (var_1_19) {
  if (var_1_19) {
   if (var_1_21 > var_1_9) {
