...
void step(void) {
 ...
 if (var_1_2) {
  var_1_45 = (((((var_1_10 + var_1_38)) < (var_1_10)) ? ((var_1_10 + var_1_38)) : (var_1_10)));
 }
 ...
 if (var_1_2) {
  var_1_40 = ((((var_1_17) > ((var_1_18 + var_1_17))) ? (var_1_17) : ((var_1_18 + var_1_17))));
 }
 if (((((var_1_16) > (var_1_16)) ? (var_1_16) : (var_1_16))) <= (- (var_1_19 / 4.9f))) {
  var_1_12 = 31.5f;
 }
 if ((((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))) >= (var_1_20 % var_1_20)) || var_1_2) {
 ...
 if (var_1_17 != var_1_19) {
  if (var_1_20 >= var_1_11) {
   var_1_44 = (((((var_1_3 + var_1_20)) > (((((var_1_9) < (var_1_9)) ? (var_1_9) : (var_1_9))))) ? ((var_1_3 + var_1_20)) : (((((var_1_9) < (var_1_9)) ? (var_1_9) : (var_1_9))))));
  }
 }
}
