...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch6150_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch6150_while
	var_1_21 = var_1_6;


	// From: Req8Batch6150_while
	var_1_22 = var_1_23;


	// From: Req1Batch6150_while
	if ((var_1_21 / (abs (64u))) == var_1_4) {
		var_1_1 = (8.8 - 255.2);
	}


	// From: Req4Batch6150_while
