...
void step(void) {
	// From: Req13Batch94Amount100
	if (last_1_var_1_9) {
		var_1_32 = ((var_1_33 - last_1_var_1_15) - var_1_6);
	}


	// From: Req12Batch94Amount100
