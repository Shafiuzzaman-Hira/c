...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch84Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch84Wrapper_S
	signed long int stepLocal_0 = last_1_WrapperStruct00_var_1_11;
	if (stepLocal_0 != last_1_WrapperStruct00_var_1_8) {
		WrapperStruct00.var_1_1 = (WrapperStruct00.var_1_4 + (max ((min (WrapperStruct00.var_1_5 , WrapperStruct00.var_1_6)) , WrapperStruct00.var_1_7)));
	} else {
		WrapperStruct00.var_1_1 = WrapperStruct00.var_1_4;
	}


	// From: Req2Batch84Wrapper_S
	if (WrapperStruct00.var_1_9) {
		WrapperStruct00.var_1_8 = ((WrapperStruct00.var_1_10 + 23103) - (32 + WrapperStruct00.var_1_6));
	}


	// From: Req4Batch84Wrapper_S
	if (! (WrapperStruct00.var_1_5 > WrapperStruct00.var_1_10)) {
		WrapperStruct00.var_1_16 = (32 - 8);
	} else {
		WrapperStruct00.var_1_16 = (WrapperStruct00.var_1_13 - WrapperStruct00.var_1_4);
	}


	// From: Req5Batch84Wrapper_S
	WrapperStruct00.var_1_17 = WrapperStruct00.var_1_18;


	// From: Req3Batch84Wrapper_S
	if (WrapperStruct00.var_1_1 < WrapperStruct00.var_1_16) {
		if (((- 8) / (WrapperStruct00.var_1_13 - WrapperStruct00.var_1_14)) >= WrapperStruct00.var_1_6) {
			WrapperStruct00.var_1_11 = (WrapperStruct00.var_1_16 - (WrapperStruct00.var_1_15 - WrapperStruct00.var_1_14));
		}
	}
}
