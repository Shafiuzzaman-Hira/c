...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch77Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_19 >= (var_1_1 & (var_1_22 >> var_1_1))) {
  var_1_24 = (var_1_22 - ((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19))));
 } else {
  if (var_1_19 > (var_1_1 ^ var_1_22)) {
   var_1_24 = ((((var_1_19) < (var_1_1)) ? (var_1_19) : (var_1_1)));
  }
 }
 ...
 var_1_23 = var_1_22;
 if (var_1_19 >= (-128 & var_1_10)) {
  if ((((((var_1_26) > (var_1_27)) ? (var_1_26) : (var_1_27))) <= var_1_28) && var_1_15) {
   var_1_25 = var_1_22;
  }
 } else {
  var_1_25 = var_1_22;
