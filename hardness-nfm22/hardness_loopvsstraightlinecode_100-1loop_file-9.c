...
void step(void) {
	...
	// From: Req11Batch9100_1loop
	var_1_32 = var_1_23;


	// From: Req12Batch9100_1loop
	var_1_33 = var_1_18;


	// From: Req4Batch9100_1loop
	if (! var_1_5) {
		if (-4 <= var_1_33) {
	...
	// From: Req6Batch9100_1loop
	var_1_19 = var_1_16;


	// From: Req10Batch9100_1loop
