...
void step(void) {
	...
	if ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) > (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var3_Pointer))) {
		...
		(*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) = ((max ((*(float_Array_0_arrayfloat_Array_0arrayVar3_Pointer)) , (*(float_Array_0_arrayfloat_Array_0arrayVar4_Pointer)))) - ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) - 3.4f));
	}


	// From: Req3Batch77Wrapper_AP
	...
	if (stepLocal_0 <= (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var3_Pointer))) {
		if ((max ((*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) , ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) / (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))))) > (min ((*(float_Array_0_arrayfloat_Array_0arrayVar3_Pointer)) , (*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer))))) {
	...
	// From: Req4Batch77Wrapper_AP
	if ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var2_Pointer)) > ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) * (max ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var3_Pointer)) , (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)))))) {
