...
void step(void) {
	...
	// From: Req4Batch48Filler_PE_CI
	if (var_1_2) {
		var_1_13 = var_1_11;
	}


	// From: Req6Batch48Filler_PE_CI
	if (var_1_8 == var_1_13) {
	...
	// From: CodeObject4
	if (var_1_2) {
		var_1_29 = (min (var_1_4 , var_1_4));
	}


	// From: CodeObject5
	if (((abs (var_1_15)) - (abs (var_1_16))) <= var_1_11) {
		var_1_32 = (abs (var_1_17));
	}
