...
void step(void) {
 ...
 if (((*(var_1_1_Pointer)) >> (*(var_1_5_Pointer))) > stepLocal_0) {
  (*(var_1_6_Pointer)) = (((((42286 - (*(var_1_7_Pointer)))) > (0)) ? ((42286 - (*(var_1_7_Pointer)))) : (0)));
 } else {
 ...
 if ((*(var_1_9_Pointer))) {
  (*(var_1_8_Pointer)) = (((((*(var_1_6_Pointer))) < (last_1_var_1_8)) ? ((*(var_1_6_Pointer))) : (last_1_var_1_8)));
 } else {
  if ((*(var_1_14_Pointer)) > stepLocal_2) {
   if (stepLocal_1 > (*(var_1_6_Pointer))) {
    (*(var_1_8_Pointer)) = (((((*(var_1_4_Pointer))) < (100)) ? ((*(var_1_4_Pointer))) : (100)));
   } else {
