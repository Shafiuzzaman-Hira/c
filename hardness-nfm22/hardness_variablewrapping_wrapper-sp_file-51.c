...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch51Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch51Wrapper_SP
	unsigned long int stepLocal_1 = - last_1_WrapperStruct00_var_1_17;
	if (((max ((*(WrapperStruct00_var_1_11_Pointer)) , (*(WrapperStruct00_var_1_12_Pointer)))) - (*(WrapperStruct00_var_1_13_Pointer))) != stepLocal_1) {
		(*(WrapperStruct00_var_1_10_Pointer)) = ((min ((*(WrapperStruct00_var_1_15_Pointer)) , (*(WrapperStruct00_var_1_16_Pointer)))) - (*(WrapperStruct00_var_1_13_Pointer)));
	} else {
		(*(WrapperStruct00_var_1_10_Pointer)) = (*(WrapperStruct00_var_1_15_Pointer));
	}


	// From: Req3Batch51Wrapper_SP
	if ((*(WrapperStruct00_var_1_10_Pointer)) <= (*(WrapperStruct00_var_1_10_Pointer))) {
		if ((*(WrapperStruct00_var_1_2_Pointer)) && ((*(WrapperStruct00_var_1_10_Pointer)) == (max ((*(WrapperStruct00_var_1_16_Pointer)) , (*(WrapperStruct00_var_1_12_Pointer)))))) {
		...
		(*(WrapperStruct00_var_1_17_Pointer)) = (*(WrapperStruct00_var_1_16_Pointer));
	}


	// From: Req1Batch51Wrapper_SP
	unsigned long int stepLocal_0 = (*(WrapperStruct00_var_1_10_Pointer));
	if ((*(WrapperStruct00_var_1_2_Pointer))) {
		if (stepLocal_0 >= ((*(WrapperStruct00_var_1_10_Pointer)) / (*(WrapperStruct00_var_1_5_Pointer)))) {
			(*(WrapperStruct00_var_1_1_Pointer)) = (abs ((*(WrapperStruct00_var_1_6_Pointer))));
		} else {
			(*(WrapperStruct00_var_1_1_Pointer)) = ((*(WrapperStruct00_var_1_7_Pointer)) + (max ((*(WrapperStruct00_var_1_8_Pointer)) , ((*(WrapperStruct00_var_1_9_Pointer)) + 63.25))));
		}
	} else {
