...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch8250_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req7Batch8250_1loop
	var_1_23 = last_1_var_1_14;


	// From: Req2Batch8250_1loop
	var_1_7 = (var_1_4 - (var_1_8 + var_1_9));


	// From: Req5Batch8250_1loop
	...
	// From: Req3Batch8250_1loop
	var_1_10 = (var_1_11 && (var_1_21 || var_1_13));


	// From: Req4Batch8250_1loop
