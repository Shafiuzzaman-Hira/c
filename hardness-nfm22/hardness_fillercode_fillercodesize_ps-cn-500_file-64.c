...
void step(void) {
	...
	// From: CodeObject10
	if ((max (var_1_44 , var_1_52)) >= 0) {
		if ((var_1_65 | (var_1_60 | var_1_66)) >= var_1_62) {
			if ((var_1_56 * var_1_61) != var_1_58) {
				var_1_64 = (min (var_1_59 , var_1_56));
			} else {
				if (var_1_54) {
					if ((var_1_66 ^ (var_1_62 % var_1_53)) < (2810281807u - (abs (var_1_65)))) {
						var_1_64 = ((abs (var_1_45)) + var_1_42);
					} else {
						var_1_64 = (abs (var_1_63));
					}
				}
			}
		}
	} else {
		var_1_64 = (max ((abs (var_1_57)) , (abs (abs (var_1_31)))));
	}
	...
	if ((! var_1_54) && var_1_39) {
		...
		if (var_1_49 <= ((var_1_47 - var_1_51) * (var_1_35 * var_1_34))) {
			var_1_68 = (var_1_62 + (abs (abs (var_1_56))));
		} else {
			var_1_68 = ((max (var_1_32 , (var_1_59 - var_1_56))) + (abs (var_1_57)));
		}
	}
	...
	if (var_1_54 && var_1_70) {
		...
		var_1_69 = (abs ((var_1_71 - var_1_62) + var_1_72));
	}


	// From: CodeObject14
	if ((var_1_64 % (abs (var_1_71))) <= (min (-256 , (abs (var_1_41))))) {
		var_1_73 = ((abs (abs (55475))) - (abs (var_1_72)));
	} else {
	...
	// From: CodeObject16
	if ((var_1_71 - (abs (var_1_62))) >= (var_1_66 * var_1_76)) {
		if (-16 > var_1_61) {
			var_1_75 = (abs (var_1_31));
		} else {
			if (var_1_62 >= var_1_72) {
				var_1_75 = (abs (var_1_72));
			} else {
	...
	// From: CodeObject23
	if ((max (var_1_60 , var_1_69)) > var_1_82) {
	...
	if (((var_1_84 / var_1_65) / var_1_83) <= -100) {
		if (var_1_70) {
			var_1_87 = ((abs (min (var_1_62 , var_1_86))) - var_1_88);
		}
	}
	...
	// From: CodeObject27
	if (var_1_91) {
		var_1_92 = (max ((max (var_1_58 , var_1_69)) , (max ((64 + 8) , var_1_85))));
	}


	// From: CodeObject28
	if (var_1_38 < var_1_64) {
		var_1_93 = (var_1_49 - (max ((max (var_1_48 , var_1_51)) , var_1_50)));
	}
	...
	if (var_1_41 != var_1_58) {
		var_1_98 = (var_1_56 - (var_1_69 + (min (var_1_86 , var_1_88))));
	}


	// From: CodeObject32
	if ((~ var_1_87) <= var_1_86) {
		var_1_99 = (min ((var_1_86 + var_1_62) , var_1_88));
	} else {
		var_1_99 = (var_1_88 - (abs (var_1_62)));
	}


	// From: CodeObject33
	if (((abs (var_1_73)) < (var_1_66 << 1)) && var_1_97) {
		var_1_100 = (abs (min (-4 , var_1_61)));
	}


	// From: CodeObject34
	if ((var_1_53 + -10) < var_1_38) {
		var_1_101 = (abs (var_1_62));
	} else {
		var_1_101 = (abs ((abs (var_1_86)) + var_1_62));
	}


	// From: CodeObject35
	if ((var_1_50 - (var_1_51 + 99.25)) < var_1_35) {
		if (var_1_35 <= (max (var_1_93 , var_1_48))) {
			var_1_102 = var_1_99;
		} else {
			var_1_102 = (min (var_1_61 , var_1_72));
		}
	} else {
		if (var_1_42 <= var_1_83) {
			var_1_102 = (max (((max (var_1_32 , -50)) + var_1_61) , var_1_58));
		} else {
			var_1_102 = (max (var_1_85 , var_1_71));
		}
	}
	...
	if ((var_1_60 >> var_1_99) < var_1_45) {
		var_1_103 = (min (var_1_51 , (abs (abs (var_1_35)))));
	}
	...
	// From: CodeObject38
	if ((abs (var_1_83)) != (max (var_1_101 , (max (var_1_42 , var_1_85))))) {
		if (var_1_53 <= (abs (var_1_84))) {
			if (128u == (max (var_1_58 , (abs (16u))))) {
				var_1_105 = (abs (abs (var_1_65 - var_1_66)));
			}
		} else {
			var_1_105 = (max (var_1_63 , (min ((abs (var_1_69)) , var_1_98))));
		}
	}


	// From: CodeObject39
	if (var_1_92 < (min (var_1_102 , (128 % var_1_66)))) {
		var_1_106 = var_1_83;
	}
	...
	if ((4 - var_1_72) >= var_1_84) {
		if (var_1_104) {
			if ((abs (var_1_103)) >= (var_1_47 * var_1_51)) {
				if (var_1_91) {
					var_1_107 = var_1_86;
				}
			} else {
		...
		var_1_107 = (max ((abs (var_1_62)) , (abs (var_1_88))));
	}
	...
	// From: CodeObject42
	if ((2u + var_1_82) >= (abs (var_1_81 + var_1_84))) {
		if (var_1_90) {
			if ((var_1_88 & var_1_81) >= (var_1_84 / var_1_44)) {
				var_1_110 = (min ((abs (var_1_58)) , (var_1_62 + (min (var_1_71 , var_1_83)))));
			} else {
				var_1_110 = (abs (var_1_58));
			}
		} else {
			var_1_110 = (max ((max (var_1_88 , var_1_72)) , var_1_83));
		}
	}
	...
	if (var_1_106 < var_1_31) {
		if (var_1_34 >= var_1_113) {
			var_1_114 = (min ((var_1_55 + var_1_101) , var_1_83));
		} else {
			if (var_1_65 <= (max (var_1_78 , var_1_75))) {
				var_1_114 = (abs (var_1_81));
			} else {
				var_1_114 = (abs (var_1_66));
			}
		}
	} else {
		var_1_114 = (min (var_1_107 , (min ((min (var_1_92 , -8)) , var_1_88))));
	}


	// From: CodeObject46
	if (((abs (var_1_77)) - (abs (var_1_35))) < var_1_79) {
		if (var_1_96) {
			if ((-5 & var_1_74) < (max (var_1_31 , var_1_44))) {
				var_1_115 = ((abs (var_1_57)) - var_1_71);
			}
		} else {
			var_1_115 = (abs (var_1_80));
		}
	}
	...
	if (var_1_95 > var_1_43) {
		if (var_1_77 > var_1_30) {
			var_1_116 = (max (var_1_48 , var_1_35));
		}
	}
	...
	// From: CodeObject48
	if (var_1_96) {
		var_1_118 = (min (var_1_80 , (abs (var_1_31))));
	} else {
		if (var_1_90) {
			var_1_118 = (min ((abs (var_1_68)) , var_1_58));
		} else {
			var_1_118 = (min (var_1_58 , var_1_57));
		}
	}
	...
	if (var_1_39 && (10 <= (-64 + var_1_75))) {
		if ((- var_1_51) == var_1_103) {
			var_1_119 = (max (var_1_50 , (abs (var_1_49))));
		} else {
			var_1_119 = (abs (var_1_35));
		}
	}
	...
	// From: Req4Batch64PS_CN_500
	var_1_19 = ((var_1_20 - var_1_21) - var_1_22);


	// From: Req6Batch64PS_CN_500
	...
	// From: Req3Batch64PS_CN_500
	if (var_1_10 != var_1_25) {
		var_1_18 = (min (var_1_13 , var_1_12));
	}


	// From: Req5Batch64PS_CN_500
	if (! ((64 * var_1_18) < var_1_18)) {
		var_1_23 = var_1_24;
	}


	// From: Req1Batch64PS_CN_500
	if (-8 <= var_1_10) {
