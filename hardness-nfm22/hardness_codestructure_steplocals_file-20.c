...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch20stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch20stepLocals
	signed long int stepLocal_0 = var_1_1 - (var_1_4 + var_1_7);
	if ((64 + (var_1_5 / var_1_3)) != stepLocal_0) {
		var_1_6 = var_1_4;
	} else {
		var_1_6 = 128;
	}
	...
	// From: Req3Batch20stepLocals
	signed long int stepLocal_1 = var_1_3 - var_1_5;
	if ((var_1_6 + var_1_1) >= stepLocal_1) {
	...
	// From: Req5Batch20stepLocals
	var_1_15 = (var_1_14 + var_1_16);


	// From: Req6Batch20stepLocals
	if (var_1_2) {
...
int property() {
	return ((((((var_1_2 ? (var_1_1 == ((unsigned char) (var_1_3 - var_1_4))) : (var_1_1 == ((unsigned char) (var_1_4 + var_1_5)))) && (((64 + (var_1_5 / var_1_3)) != (var_1_1 - (var_1_4 + var_1_7))) ? (var_1_6 == ((unsigned char) var_1_4)) : (var_1_6 == ((unsigned char) 128)))) && (((var_1_6 + var_1_1) >= (var_1_3 - var_1_5)) ? (var_1_8 == ((unsigned short int) (max (var_1_1 , var_1_3)))) : (var_1_8 == ((unsigned short int) var_1_1)))) && ((((var_1_10 - var_1_11) - (16 + var_1_12)) != var_1_5) ? (var_1_9 == ((float) (64.8f - (var_1_13 - var_1_14)))) : (var_1_9 == ((float) var_1_13)))) && (var_1_15 == ((float) (var_1_14 + var_1_16)))) && (var_1_2 ? (var_1_17 == ((signed short int) (var_1_3 + var_1_12))) : ((var_1_14 == ((min (99.8f , var_1_16)) / (max (255.6f , var_1_13)))) ? (var_1_17 == ((signed short int) var_1_4)) : (var_1_17 == ((signed short int) (var_1_5 - var_1_3)))))) && (((var_1_2 || (var_1_16 > var_1_13)) && (var_1_3 < var_1_8)) ? (((var_1_11 << var_1_12) > var_1_5) ? (var_1_18 == ((double) var_1_13)) : 1) : (var_1_18 == ((double) var_1_16)))
;
}
int main(void) {
	isInitial = 1;
