...
void step(void) {
 ...
 if (stepLocal_1 <= (*(var_1_8_Pointer))) {
  if ((*(var_1_1_Pointer))) {
   (*(var_1_6_Pointer)) = (3.17 - ((((127.2) > ((*(var_1_7_Pointer)))) ? (127.2) : ((*(var_1_7_Pointer))))));
  }
 }
 if ((*(var_1_1_Pointer))) {
