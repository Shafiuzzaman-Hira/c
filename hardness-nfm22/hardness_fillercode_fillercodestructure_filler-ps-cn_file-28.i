...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch28Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_34 <= var_1_27) {
  var_1_37 = (((((32 - 2)) < (var_1_32)) ? ((32 - 2)) : (var_1_32)));
 } else {
  if (var_1_32 < var_1_29) {
   var_1_37 = ((((-8) < (((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))))) ? (-8) : (((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))))));
  } else {
 ...
 if (var_1_31 <= 9.6) {
  var_1_38 = (((((var_1_34 + var_1_32)) > (var_1_27)) ? ((var_1_34 + var_1_32)) : (var_1_27)));
 } else {
  if (var_1_25 <= var_1_26) {
   if (var_1_27 > (var_1_33 >> var_1_25)) {
    var_1_38 = ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)));
   } else {
    var_1_38 = ((((var_1_34) < (((((var_1_29) < (var_1_37)) ? (var_1_29) : (var_1_37))))) ? (var_1_34) : (((((var_1_29) < (var_1_37)) ? (var_1_29) : (var_1_37))))));
   }
  }
 }
 var_1_39 = var_1_34;
