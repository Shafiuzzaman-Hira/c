...
void step(void) {
	...
	// From: Req10Batch39100_1loop
	var_1_29 = (var_1_12 + (max (9.999999999999995E14f , var_1_13)));


	// From: Req11Batch39100_1loop
	if (var_1_19 != 25u) {
		if (! var_1_21) {
			var_1_30 = var_1_8;
		}
