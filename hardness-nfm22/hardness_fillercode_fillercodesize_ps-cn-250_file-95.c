...
void step(void) {
	...
	if (var_1_24 < var_1_34) {
		...
		if (((min (var_1_21 , var_1_19)) >= (var_1_34 >> var_1_22)) && (! var_1_26)) {
	...
	if ((- (max (var_1_21 , var_1_20))) >= var_1_19) {
		var_1_39 = ((var_1_40 - (abs (var_1_41))) + var_1_42);
	}
	...
	if ((var_1_25 >= var_1_31) || (var_1_28 != var_1_27)) {
		if (var_1_26 && var_1_37) {
			var_1_45 = (max ((abs (abs (var_1_44))) , var_1_40));
		}
	} else {
		var_1_45 = var_1_40;
	}
	...
	// From: CodeObject9
	if (var_1_32 >= (max (var_1_29 , (15.1 - var_1_47)))) {
		var_1_46 = (min ((max (var_1_33 , var_1_32)) , (abs (var_1_48))));
	}


	// From: CodeObject10
	if ((var_1_21 % var_1_19) <= var_1_45) {
		if ((var_1_27 - (max (var_1_47 , var_1_33))) >= var_1_31) {
		...
		if (var_1_17) {
			...
			var_1_49 = (max (var_1_23 , var_1_24));
		}
	}
	...
	if (var_1_41 > var_1_21) {
		if ((var_1_26 || var_1_37) || var_1_17) {
			var_1_50 = (abs (max (var_1_41 , var_1_24)));
		}
	} else {
	...
	// From: CodeObject14
	if ((100 - (min (var_1_20 , var_1_19))) > (var_1_34 * var_1_44)) {
		if (var_1_46 <= (- (abs (100.25)))) {
			var_1_53 = (abs (max (var_1_40 , var_1_42)));
		} else {
			if (var_1_36) {
				if (var_1_37) {
					var_1_53 = var_1_41;
				} else {
					var_1_53 = (max (var_1_41 , (var_1_40 + var_1_42)));
				}
			}
		}
	} else {
	...
	// From: CodeObject15
	if ((min (var_1_24 , 128u)) == var_1_21) {
		if ((min (var_1_32 , (max (var_1_30 , 16.95f)))) <= (abs (var_1_47 - var_1_33))) {
			if (var_1_46 <= var_1_25) {
				var_1_54 = var_1_48;
			} else {
				var_1_54 = (var_1_55 + (abs (var_1_56)));
			}
		} else {
			var_1_54 = var_1_56;
		}
	...
	if (var_1_28 >= var_1_54) {
		var_1_57 = (abs (var_1_55 + var_1_56));
	}
	...
	// From: CodeObject18
	if ((var_1_52 / (min (-10000 , var_1_19))) >= (max ((abs (var_1_50)) , (var_1_62 - var_1_20)))) {
		var_1_61 = var_1_60;
	}


	// From: CodeObject19
	var_1_63 = (abs (abs (var_1_40)));
	...
	// From: CodeObject25
	if ((var_1_63 + (var_1_65 >> var_1_62)) >= (max (var_1_34 , var_1_21))) {
	...
	if (var_1_65 != var_1_23) {
		var_1_71 = (abs (var_1_52 - var_1_23));
	}
	...
	if (var_1_16 >= (128u / var_1_20)) {
		if (16.35f <= var_1_30) {
			var_1_72 = (abs (var_1_41));
		} else {
			var_1_72 = (abs (var_1_41));
		}
	} else {
		if (var_1_54 <= var_1_58) {
			var_1_72 = (min (var_1_42 , ((abs (var_1_41)) - var_1_40)));
		}
	}


	// From: CodeObject28
	if ((var_1_44 * (abs (var_1_18))) > (var_1_62 * var_1_19)) {
