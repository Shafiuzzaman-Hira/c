...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch4050_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req9Batch4050_while
	var_1_26 = var_1_12;


	// From: Req6Batch4050_while
	...
	// From: Req4Batch4050_while
	var_1_16 = (min (((max (256 , var_1_12)) + var_1_12) , var_1_15));


	// From: Req8Batch4050_while
	var_1_25 = var_1_20;


	// From: Req1Batch4050_while
