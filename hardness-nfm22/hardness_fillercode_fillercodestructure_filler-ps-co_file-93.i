...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch93Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
 if (((((- var_1_1) < 0 ) ? -(- var_1_1) : (- var_1_1))) <= var_1_13) {
  if ((((((((var_1_13) < (25.6)) ? (var_1_13) : (25.6))) < 0 ) ? -((((var_1_13) < (25.6)) ? (var_1_13) : (25.6))) : ((((var_1_13) < (25.6)) ? (var_1_13) : (25.6))))) >= ((((- var_1_1) < 0 ) ? -(- var_1_1) : (- var_1_1)))) {
 ...
 if ((var_1_14 + ((((var_1_23) < (var_1_14)) ? (var_1_23) : (var_1_14)))) <= var_1_14) {
  if (var_1_29 == ((((((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32)))) > (var_1_13)) ? (((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32)))) : (var_1_13)))) {
 ...
 if (var_1_13 > var_1_1) {
  if (var_1_21 <= var_1_45) {
   if (((var_1_30 - var_1_29) / var_1_52) > var_1_32) {
    var_1_51 = var_1_49;
   } else {
    var_1_51 = var_1_49;
   }
