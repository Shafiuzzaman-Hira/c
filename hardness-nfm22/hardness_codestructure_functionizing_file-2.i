...
void functionized2(float functionized2_localFunctionVar0, float functionized2_localFunctionVar1, float functionized2_localFunctionVar2) {
 if ((var_1_5 / var_1_11) >= (var_1_8 - functionized2_localFunctionVar2)) {
  var_1_10 = (((((var_1_5 - (functionized2_localFunctionVar1 - functionized2_localFunctionVar0))) < (functionized2_localFunctionVar2)) ? ((var_1_5 - (functionized2_localFunctionVar1 - functionized2_localFunctionVar0))) : (functionized2_localFunctionVar2)));
 } else {
  var_1_10 = 4.2f;
 }
}
signed long int functionized3(signed char functionized3_localFunctionVar0) {
 return (var_1_15 - ((((0) < (functionized3_localFunctionVar0)) ? (0) : (functionized3_localFunctionVar0))));
}
...
void step(void) {
 ...
 if (var_1_7) {
  if (((((var_1_1) > (((((var_1_5) > (199.78)) ? (var_1_5) : (199.78))))) ? (var_1_1) : (((((var_1_5) > (199.78)) ? (var_1_5) : (199.78)))))) != (var_1_4 - var_1_8)) {
