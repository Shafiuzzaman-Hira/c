...
void step(void) {
	...
	// From: Req10Batch53Amount100
	var_1_24 = (var_1_25 + (min (var_1_26 , var_1_27)));


	// From: Req11Batch53Amount100
	if (! var_1_12) {
	...
	// From: Req6Batch53Amount100
	var_1_19 = (min ((min (var_1_3 , var_1_4)) , var_1_28));


	// From: Req8Batch53Amount100
