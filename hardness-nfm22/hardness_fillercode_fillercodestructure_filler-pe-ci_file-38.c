...
void step(void) {
	...
	// From: CodeObject1
	if (var_1_18 >= (abs (max (var_1_18 , var_1_14)))) {
	...
	// From: CodeObject2
	if (var_1_18 >= (min (var_1_17 , var_1_14))) {
	...
	// From: CodeObject5
	if (-2 > ((abs (var_1_15)) | (-10 * var_1_15))) {
		var_1_37 = (max ((min (25 , var_1_15)) , (abs (var_1_32 + var_1_21))));
	} else {
		if ((abs (var_1_21)) <= (abs (var_1_15))) {
			if ((var_1_21 * (max (var_1_21 , var_1_15))) <= var_1_15) {
				var_1_37 = (abs (var_1_21));
			}
		} else {
