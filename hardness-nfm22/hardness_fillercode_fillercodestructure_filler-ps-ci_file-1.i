...
void step(void) {
 ...
 if (var_1_21 >= (var_1_21 >> var_1_21)) {
  if (var_1_23 || (var_1_17 < var_1_21)) {
   var_1_33 = ((((var_1_35 - var_1_27) < 0 ) ? -(var_1_35 - var_1_27) : (var_1_35 - var_1_27)));
  }
 }
 if (var_1_27 > (var_1_20 / var_1_35)) {
  var_1_36 = ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)));
 }
 if (63.75f <= var_1_11) {
  var_1_37 = ((var_1_39 + ((((var_1_40) > (var_1_41)) ? (var_1_40) : (var_1_41)))) - ((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21))));
 }
 if (var_1_41 < ((((var_1_27) < (var_1_27)) ? (var_1_27) : (var_1_27)))) {
  var_1_42 = (! ((var_1_13 && var_1_25) || (var_1_25 && var_1_25)));
 } else {
  var_1_42 = (var_1_25 || var_1_25);
 }
 if (var_1_25) {
  if (var_1_21 <= ((((var_1_41) < (var_1_27)) ? (var_1_41) : (var_1_27)))) {
   if (var_1_27 > var_1_35) {
    var_1_46 = (var_1_23 || (var_1_24 && var_1_24));
   }
  }
 }
 if ((var_1_39 - ((((-50) < 0 ) ? -(-50) : (-50)))) < var_1_27) {
  if (var_1_25) {
   var_1_49 = var_1_27;
  }
 }
