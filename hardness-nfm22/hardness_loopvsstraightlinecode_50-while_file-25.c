...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch2550_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch2550_while
	var_1_10 = (last_1_var_1_10 && var_1_11);


	// From: Req5Batch2550_while
	...
	// From: Req8Batch2550_while
	var_1_22 = last_1_var_1_22;


	// From: Req9Batch2550_while
	var_1_23 = var_1_14;


	// From: Req6Batch2550_while
	...
	// From: Req7Batch2550_while
	var_1_21 = var_1_22;


	// From: Req4Batch2550_while
	if (! (var_1_23 <= var_1_7)) {
