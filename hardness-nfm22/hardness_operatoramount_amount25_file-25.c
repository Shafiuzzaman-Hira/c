...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch25Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch25Amount25
	unsigned long int stepLocal_1 = var_1_1;
	if (((~ -128) / (max (var_1_9 , var_1_13))) > stepLocal_1) {
...
int property() {
	return ((last_1_var_1_6 ? ((var_1_3 <= var_1_4) ? (var_1_1 == ((unsigned long int) ((max (var_1_3 , var_1_4)) + var_1_5))) : 1) : (var_1_1 == ((unsigned long int) var_1_5))) && ((((1 + var_1_8) - (var_1_9 - var_1_10)) != var_1_1) ? (var_1_6 == ((unsigned char) ((var_1_8 >= var_1_12) && (! 1)))) : (var_1_6 == ((unsigned char) var_1_11)))) && ((((~ -128) / (max (var_1_9 , var_1_13))) > var_1_1) ? (var_1_12 == ((signed char) ((var_1_14 + var_1_15) + var_1_16))) : (var_1_12 == ((signed char) var_1_16)))
;
}
int main(void) {
	isInitial = 1;
