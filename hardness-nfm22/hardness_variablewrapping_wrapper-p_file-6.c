...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch6Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (((*(var_1_4_Pointer)) - last_1_var_1_20) == last_1_var_1_18) {
		if ((((*(var_1_9_Pointer)) - (*(var_1_10_Pointer))) - (*(var_1_11_Pointer))) > (*(var_1_12_Pointer))) {
			(*(var_1_6_Pointer)) = ((*(var_1_13_Pointer)) - (*(var_1_8_Pointer)));
		}
	} else {
		(*(var_1_6_Pointer)) = (*(var_1_13_Pointer));
	}


	// From: Req4Batch6Wrapper_P
	if ((*(var_1_13_Pointer)) > (*(var_1_6_Pointer))) {
		(*(var_1_18_Pointer)) = ((min ((*(var_1_6_Pointer)) , (*(var_1_13_Pointer)))) - (*(var_1_6_Pointer)));
	}


	// From: Req3Batch6Wrapper_P
	if (last_1_var_1_14) {
		(*(var_1_14_Pointer)) = ((*(var_1_16_Pointer)) && (*(var_1_17_Pointer)));
	}


	// From: Req5Batch6Wrapper_P
	(*(var_1_20_Pointer)) = (min ((abs (last_1_var_1_20)) , ((*(var_1_21_Pointer)) - (*(var_1_7_Pointer)))));


	// From: Req1Batch6Wrapper_P
	unsigned long int stepLocal_1 = (*(var_1_20_Pointer));
	unsigned long int stepLocal_0 = (*(var_1_20_Pointer));
	if (((max ((*(var_1_18_Pointer)) , (*(var_1_18_Pointer)))) / (*(var_1_4_Pointer))) > stepLocal_1) {
...
void updateVariables() {
	...
	assume_abort_if_not((var_1_9 >= 4611686.018427387900e+12F && var_1_9 <= -1.0e-20F) || (var_1_9 <= 9223372.036854776000e+12F && var_1_9 >= 1.0e-20F ));
