...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch15dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch15dependencies
	var_1_10 = var_1_11;


	// From: Req3Batch15dependencies
	...
	// From: Req1Batch15dependencies
	if (var_1_19 || (var_1_12 > var_1_12)) {
	...
	// From: Req6Batch15dependencies
	if (var_1_20) {
		if (var_1_10 < ((var_1_22 - var_1_23) - var_1_9)) {
			if (var_1_19) {
				if (last_1_var_1_21 == (var_1_22 + var_1_11)) {
					var_1_21 = var_1_1;
				}
			} else {
				var_1_21 = var_1_10;
