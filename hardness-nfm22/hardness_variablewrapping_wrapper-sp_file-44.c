...
void step(void) {
	// From: Req1Batch44Wrapper_SP
	signed long int stepLocal_1 = (min ((*(WrapperStruct00_var_1_4_Pointer)) , (*(WrapperStruct00_var_1_3_Pointer)))) / (*(WrapperStruct00_var_1_7_Pointer));
	...
	// From: Req4Batch44Wrapper_SP
	(*(WrapperStruct00_var_1_18_Pointer)) = (*(WrapperStruct00_var_1_19_Pointer));


	// From: Req3Batch44Wrapper_SP
	if (((*(WrapperStruct00_var_1_12_Pointer)) - (abs ((*(WrapperStruct00_var_1_18_Pointer))))) >= (*(WrapperStruct00_var_1_18_Pointer))) {
