...
void step(void) {
	...
	if (last_1_var_1_75 && stepLocal_17) {
		var_1_65 = (max (last_1_var_1_44 , last_1_var_1_87));
	} else {
		var_1_65 = (var_1_32 + (max (last_1_var_1_52 , last_1_var_1_31)));
	}


	// From: Req15Batch2Amount500
	if (var_1_14 < var_1_3) {
		var_1_44 = (((abs (var_1_10)) + var_1_9) + var_1_65);
	} else {
		var_1_44 = var_1_65;
	}
	...
	if (! last_1_var_1_90) {
		...
		if (var_1_28 >= (var_1_30 * last_1_var_1_27)) {
			...
			if ((- last_1_var_1_76) <= (min (last_1_var_1_101 , var_1_30))) {
	...
	if ((min (last_1_var_1_41 , var_1_38)) >= var_1_9) {
		if (var_1_32 > (var_1_12 / (min (-1 , -25)))) {
			var_1_67 = (var_1_62 - var_1_55);
		} else {
			if ((last_1_var_1_67 / (min (var_1_42 , 200u))) > last_1_var_1_20) {
				var_1_67 = (abs (last_1_var_1_31));
			} else {
				var_1_67 = var_1_38;
			}
		}
	} else {
		var_1_67 = (var_1_62 - ((max (var_1_64 , var_1_68)) - (var_1_69 - last_1_var_1_94)));
	}


	// From: Req8Batch2Amount500
	if (((var_1_10 - var_1_9) / (max (var_1_21 , var_1_32))) > last_1_var_1_44) {
		var_1_31 = (var_1_10 - var_1_9);
	}


	// From: Req19Batch2Amount500
	signed long int stepLocal_11 = max (last_1_var_1_47 , (var_1_12 * last_1_var_1_11));
	if (last_1_var_1_33) {
		if (var_1_14 < (var_1_17 * (0.28f + last_1_var_1_70))) {
			var_1_52 = (max (var_1_36 , var_1_12));
		} else {
		...
		if (stepLocal_11 > var_1_21) {
			...
			var_1_52 = ((max (var_1_12 , 64694)) - var_1_39);
		}
	}
	...
	if (var_1_5 <= (- var_1_17)) {
		if ((var_1_36 / var_1_42) > stepLocal_10) {
			var_1_47 = (((var_1_48 + var_1_49) - (max (var_1_38 , var_1_44))) - var_1_67);
		}
	} else {
		var_1_47 = (abs (var_1_49));
	}
	...
	var_1_60 = (min (((var_1_9 - var_1_38) + var_1_86) , (var_1_8 + (var_1_67 + -16))));
		...
		if (var_1_15 == (var_1_4 - var_1_18)) {
			if (! (var_1_15 <= var_1_18)) {
				if ((var_1_3 * (var_1_30 + var_1_92)) == ((var_1_5 + var_1_14) / var_1_17)) {
					var_1_37 = (min ((var_1_38 - 64) , 0));
				}
			} else {
				var_1_37 = (var_1_9 + var_1_36);
			}
		} else {
			var_1_37 = (max (((var_1_39 - var_1_36) + var_1_10) , var_1_9));
		}
	} else {
		var_1_37 = (var_1_9 + var_1_36);
	}
	...
	if (((max (var_1_38 , var_1_37)) - 200) < stepLocal_13) {
		if ((var_1_14 - var_1_19) <= (var_1_29 * (var_1_93 + var_1_18))) {
			var_1_58 = (var_1_10 + (abs (var_1_36)));
		} else {
			var_1_58 = (var_1_36 + (var_1_10 - (abs (var_1_9))));
		}
	}
	...
	if (var_1_3 >= (var_1_30 * 256.75)) {
		if (var_1_5 <= ((var_1_30 / var_1_17) + var_1_15)) {
			var_1_61 = ((max (var_1_62 , var_1_63)) - var_1_10);
		} else {
			if (stepLocal_15 && (0.7 > var_1_4)) {
				var_1_61 = (max (var_1_49 , (var_1_38 + (var_1_64 - var_1_52))));
			}
		}
	} else {
		if (((var_1_4 - 9.5f) <= var_1_15) || stepLocal_14) {
			if (stepLocal_16 || (var_1_9 > var_1_39)) {
				var_1_61 = (var_1_63 - (max ((var_1_64 - var_1_49) , var_1_31)));
			} else {
	...
	signed long int stepLocal_5 = max (var_1_10 , var_1_58);
	...
	if (var_1_23 || stepLocal_18) {
		...
		if ((var_1_10 / var_1_71) < stepLocal_19) {
			...
			var_1_70 = (abs ((var_1_73 - var_1_18) - (max (var_1_4 , var_1_3))));
		}
	}
	...
	if (stepLocal_22 != (var_1_36 / (max (var_1_32 , var_1_48)))) {
		if (var_1_94 < stepLocal_23) {
			if (var_1_100) {
				var_1_76 = (max (var_1_30 , var_1_29));
			} else {
				var_1_76 = ((min ((var_1_18 + var_1_29) , var_1_28)) + (var_1_30 + (abs (var_1_19))));
			}
		} else {
			var_1_76 = (min (8.5f , (min (var_1_5 , (var_1_15 + var_1_14)))));
		}
	} else {
		if (var_1_67 <= stepLocal_20) {
			var_1_76 = (max (63.8f , var_1_17));
		} else {
	...
	if (var_1_25) {
		if (var_1_26) {
			var_1_40 = (min ((min ((var_1_56 + -1) , var_1_32)) , (min (var_1_21 , var_1_86))));
		}
	} else {
	...
	if (var_1_56 != (- (var_1_12 - var_1_39))) {
		...
		var_1_74 = (max ((max (16 , var_1_38)) , var_1_10));
	}


	// From: Req50Batch2Amount500
	...
	if (stepLocal_27 == var_1_82) {
		if (var_1_24) {
			if (stepLocal_28 == var_1_68) {
				var_1_102 = (var_1_15 + (max (var_1_17 , var_1_29)));
			} else {
				var_1_102 = var_1_28;
			}
		}
	...
	if (var_1_85 && stepLocal_1) {
		if (((var_1_9 / var_1_21) + var_1_10) < stepLocal_4) {
			var_1_20 = (min ((var_1_89 - var_1_10) , var_1_9));
		} else {
			if ((var_1_8 ^ var_1_89) > stepLocal_3) {
				...
				if (var_1_84) {
					...
					var_1_20 = (((abs (16)) + 256) - (max (0 , var_1_89)));
				}
			}
		}
	}
	...
	if (var_1_35 <= stepLocal_25) {
		var_1_80 = (((min (1159028602u , var_1_64)) + (max (1897264008u , var_1_82))) - (abs (var_1_68)));
	} else {
		var_1_80 = (min (var_1_87 , ((var_1_83 - var_1_12) - var_1_65)));
	}
	...
	if (stepLocal_7 == ((min (var_1_43 , 2174276204u)) - var_1_10)) {
		if (var_1_26) {
			var_1_41 = ((min ((var_1_32 + var_1_36) , 5)) + var_1_80);
		} else {
			if (var_1_90 && stepLocal_8) {
				var_1_41 = (abs ((max (var_1_39 , var_1_38)) - var_1_9));
			} else {
				var_1_41 = (min ((min (var_1_39 , (max (var_1_80 , var_1_10)))) , var_1_9));
			}
		}
	} else {
		if (var_1_23) {
			...
			var_1_41 = (var_1_9 - (min (var_1_20 , 128)));
		}
	}
	...
	if (var_1_31 >= (var_1_42 + var_1_41)) {
		var_1_57 = (var_1_19 + ((min (var_1_14 , var_1_16)) - var_1_17));
	} else {
		if (var_1_9 < var_1_61) {
			var_1_57 = (var_1_18 + (var_1_14 - var_1_15));
		} else {
			if (((var_1_43 - var_1_10) >> var_1_52) <= var_1_55) {
				var_1_57 = ((abs (var_1_28)) - var_1_18);
			} else {
				var_1_57 = (min ((var_1_16 - var_1_14) , (min (var_1_15 , (var_1_18 - var_1_4)))));
			}
		}
	}
...
int property() {
	return (((((((((((((((((((((((((((((((((((((((((((((((((var_1_50 ? (var_1_1 == ((double) (min ((var_1_3 - var_1_4) , var_1_5)))) : ((var_1_23 && var_1_84) ? (var_1_1 == ((double) (var_1_4 - var_1_3))) : 1)) && (var_1_8 == ((signed char) ((var_1_9 - var_1_10) + -2)))) && (var_1_84 ? (var_1_11 == ((unsigned short int) (var_1_12 - var_1_10))) : 1)) && (var_1_84 ? (var_1_13 == ((float) (((min (var_1_14 , var_1_15)) + var_1_16) - ((var_1_17 + 3.2738342843526195E18f) - (var_1_18 + var_1_19))))) : (var_1_13 == ((float) (min ((var_1_16 - (var_1_14 + var_1_19)) , (abs (var_1_18 - var_1_17)))))))) && ((var_1_85 && var_1_50) ? ((((var_1_9 / var_1_21) + var_1_10) < ((var_1_12 + var_1_89) - 128)) ? (var_1_20 == ((signed long int) (min ((var_1_89 - var_1_10) , var_1_9)))) : (((var_1_8 ^ var_1_89) > var_1_21) ? ((var_1_50 || (var_1_19 <= var_1_1)) ? (var_1_20 == ((signed long int) var_1_12)) : 1) : (var_1_84 ? (var_1_20 == ((signed long int) (max ((abs (var_1_10)) , var_1_12)))) : (var_1_20 == ((signed long int) (((abs (16)) + 256) - (max (0 , var_1_89)))))))) : 1)) && ((var_1_16 == var_1_3) ? (var_1_23 == ((unsigned char) ((var_1_33 && var_1_24) || var_1_25))) : (var_1_23 == ((unsigned char) var_1_26)))) && ((127.6f >= (var_1_4 + var_1_14)) ? (var_1_27 == ((double) (var_1_18 + ((max (var_1_19 , var_1_28)) + (var_1_29 + var_1_30))))) : ((var_1_14 <= var_1_57) ? ((var_1_15 <= (var_1_3 + var_1_101)) ? (var_1_27 == ((double) (var_1_28 + var_1_15))) : (var_1_27 == ((double) (var_1_19 - 16.5)))) : 1))) && ((((var_1_10 - var_1_9) / (max (var_1_21 , var_1_32))) > last_1_var_1_44) ? (var_1_31 == ((signed char) (var_1_10 - var_1_9))) : 1)) && ((var_1_3 <= ((var_1_5 * var_1_29) * var_1_28)) ? (var_1_33 == ((unsigned char) (! (var_1_24 || var_1_25)))) : ((var_1_93 == (var_1_19 / var_1_17)) ? (var_1_33 == ((unsigned char) ((var_1_14 != var_1_30) && var_1_24))) : (var_1_33 == ((unsigned char) var_1_26))))) && (((max (var_1_10 , var_1_58)) >= var_1_12) ? (var_1_34 == ((unsigned char) (var_1_24 || (! var_1_26)))) : (var_1_34 == ((unsigned char) ((! var_1_24) && var_1_26))))) && ((var_1_23 && (var_1_52 >= var_1_10)) ? (((var_1_16 * var_1_3) >= var_1_102) ? (var_1_35 == ((unsigned char) (var_1_10 + (var_1_9 + var_1_36)))) : (var_1_35 == ((unsigned char) (max (var_1_10 , var_1_36))))) : 1)) && (((last_1_var_1_37 >> var_1_11) <= var_1_32) ? ((var_1_15 == (var_1_4 - var_1_18)) ? ((! (var_1_15 <= var_1_18)) ? (((var_1_3 * (var_1_30 + var_1_92)) == ((var_1_5 + var_1_14) / var_1_17)) ? (var_1_37 == ((unsigned char) (min ((var_1_38 - 64) , 0)))) : 1) : (var_1_37 == ((unsigned char) (var_1_9 + var_1_36)))) : (var_1_37 == ((unsigned char) (max (((var_1_39 - var_1_36) + var_1_10) , var_1_9))))) : (var_1_37 == ((unsigned char) (var_1_9 + var_1_36))))) && (var_1_25 ? (var_1_26 ? (var_1_40 == ((signed short int) (min ((min ((var_1_56 + -1) , var_1_32)) , (min (var_1_21 , var_1_86)))))) : 1) : (var_1_40 == ((signed short int) (var_1_89 + var_1_32))))) && (((var_1_11 / var_1_42) == ((min (var_1_43 , 2174276204u)) - var_1_10)) ? (var_1_26 ? (var_1_41 == ((signed long int) ((min ((var_1_32 + var_1_36) , 5)) + var_1_80))) : ((var_1_90 && var_1_25) ? (var_1_41 == ((signed long int) (abs ((max (var_1_39 , var_1_38)) - var_1_9)))) : (var_1_41 == ((signed long int) (min ((min (var_1_39 , (max (var_1_80 , var_1_10)))) , var_1_9)))))) : (var_1_23 ? (var_1_41 == ((signed long int) (var_1_80 + (var_1_9 + var_1_12)))) : (var_1_41 == ((signed long int) (var_1_9 - (min (var_1_20 , 128)))))))) && ((var_1_14 < var_1_3) ? (var_1_44 == ((unsigned short int) (((abs (var_1_10)) + var_1_9) + var_1_65))) : (var_1_44 == ((unsigned short int) var_1_65)))) && ((var_1_60 >= var_1_80) ? (var_1_45 == ((double) (var_1_17 - (var_1_16 + var_1_19)))) : (var_1_45 == ((double) var_1_29)))) && ((var_1_5 <= (- var_1_17)) ? (((var_1_36 / var_1_42) > var_1_67) ? (var_1_47 == ((signed short int) (((var_1_48 + var_1_49) - (max (var_1_38 , var_1_44))) - var_1_67))) : 1) : (var_1_47 == ((signed short int) (abs (var_1_49)))))) && (((- var_1_70) >= var_1_16) ? (var_1_50 == ((unsigned char) (var_1_34 && ((var_1_84 || var_1_75) && (var_1_85 && var_1_25))))) : 1)) && (last_1_var_1_33 ? ((var_1_14 < (var_1_17 * (0.28f + last_1_var_1_70))) ? (var_1_52 == ((unsigned short int) (max (var_1_36 , var_1_12)))) : (var_1_52 == ((unsigned short int) ((62232 - last_1_var_1_52) - var_1_36)))) : (((max (last_1_var_1_47 , (var_1_12 * last_1_var_1_11))) > var_1_21) ? (var_1_52 == ((unsigned short int) ((var_1_53 + var_1_54) - (var_1_55 - var_1_38)))) : (var_1_52 == ((unsigned short int) ((max (var_1_12 , 64694)) - var_1_39)))))) && ((var_1_55 > var_1_43) ? (var_1_56 == ((signed short int) var_1_32)) : (var_1_56 == ((signed short int) (max (var_1_61 , var_1_9)))))) && ((var_1_31 >= (var_1_42 + var_1_41)) ? (var_1_57 == ((float) (var_1_19 + ((min (var_1_14 , var_1_16)) - var_1_17)))) : ((var_1_9 < var_1_61) ? (var_1_57 == ((float) (var_1_18 + (var_1_14 - var_1_15)))) : ((((var_1_43 - var_1_10) >> var_1_52) <= var_1_55) ? (var_1_57 == ((float) ((abs (var_1_28)) - var_1_18))) : (var_1_57 == ((float) (min ((var_1_16 - var_1_14) , (min (var_1_15 , (var_1_18 - var_1_4))))))))))) && ((((max (var_1_38 , var_1_37)) - 200) < (var_1_89 + var_1_36)) ? (((var_1_14 - var_1_19) <= (var_1_29 * (var_1_93 + var_1_18))) ? (var_1_58 == ((signed char) (var_1_10 + (abs (var_1_36))))) : (var_1_58 == ((signed char) (var_1_36 + (var_1_10 - (abs (var_1_9))))))) : 1)) && (var_1_60 == ((signed short int) (min (((var_1_9 - var_1_38) + var_1_86) , (var_1_8 + (var_1_67 + -16))))))) && ((var_1_3 >= (var_1_30 * 256.75)) ? ((var_1_5 <= ((var_1_30 / var_1_17) + var_1_15)) ? (var_1_61 == ((unsigned long int) ((max (var_1_62 , var_1_63)) - var_1_10))) : ((var_1_33 && (0.7 > var_1_4)) ? (var_1_61 == ((unsigned long int) (max (var_1_49 , (var_1_38 + (var_1_64 - var_1_52)))))) : 1)) : ((((var_1_4 - 9.5f) <= var_1_15) || var_1_33) ? ((((~ var_1_53) < var_1_32) || (var_1_9 > var_1_39)) ? (var_1_61 == ((unsigned long int) (var_1_63 - (max ((var_1_64 - var_1_49) , var_1_31))))) : (var_1_61 == ((unsigned long int) (var_1_63 - var_1_55)))) : 1))) && ((last_1_var_1_75 && last_1_var_1_23) ? (var_1_65 == ((signed long int) (max (last_1_var_1_44 , last_1_var_1_87)))) : (var_1_65 == ((signed long int) (var_1_32 + (max (last_1_var_1_52 , last_1_var_1_31))))))) && (((min (last_1_var_1_41 , var_1_38)) >= var_1_9) ? ((var_1_32 > (var_1_12 / (min (-1 , -25)))) ? (var_1_67 == ((unsigned long int) (var_1_62 - var_1_55))) : (((last_1_var_1_67 / (min (var_1_42 , 200u))) > last_1_var_1_20) ? (var_1_67 == ((unsigned long int) (abs (last_1_var_1_31)))) : (var_1_67 == ((unsigned long int) var_1_38)))) : (var_1_67 == ((unsigned long int) (var_1_62 - ((max (var_1_64 , var_1_68)) - (var_1_69 - last_1_var_1_94))))))) && ((var_1_23 || var_1_75) ? (var_1_70 == ((double) (((var_1_19 + var_1_18) - var_1_16) + var_1_28))) : (((var_1_10 / var_1_71) < (var_1_67 & var_1_60)) ? (var_1_70 == ((double) ((var_1_19 + var_1_18) + (var_1_72 - var_1_15)))) : (var_1_70 == ((double) (abs ((var_1_73 - var_1_18) - (max (var_1_4 , var_1_3))))))))) && ((var_1_56 != (- (var_1_12 - var_1_39))) ? (var_1_74 == ((unsigned char) (var_1_9 + var_1_36))) : (var_1_74 == ((unsigned char) (max ((max (16 , var_1_38)) , var_1_10)))))) && ((! last_1_var_1_90) ? (((var_1_72 + 0.5f) == var_1_4) ? ((var_1_10 >= last_1_var_1_89) ? (var_1_75 == ((unsigned char) var_1_26)) : 1) : 1) : ((var_1_28 >= (var_1_30 * last_1_var_1_27)) ? (var_1_75 == ((unsigned char) var_1_25)) : (((- last_1_var_1_76) <= (min (last_1_var_1_101 , var_1_30))) ? (var_1_75 == ((unsigned char) (var_1_24 || var_1_25))) : 1)))) && ((((var_1_71 % var_1_55) + 100) != (var_1_36 / (max (var_1_32 , var_1_48)))) ? ((var_1_94 < (var_1_10 - var_1_52)) ? (var_1_100 ? (var_1_76 == ((float) (max (var_1_30 , var_1_29)))) : (var_1_76 == ((float) ((min ((var_1_18 + var_1_29) , var_1_28)) + (var_1_30 + (abs (var_1_19))))))) : (var_1_76 == ((float) (min (8.5f , (min (var_1_5 , (var_1_15 + var_1_14)))))))) : ((var_1_67 <= var_1_9) ? (var_1_76 == ((float) (max (63.8f , var_1_17)))) : ((var_1_71 >= (- var_1_42)) ? (var_1_76 == ((float) var_1_28)) : 1)))) && ((var_1_65 <= var_1_39) ? (var_1_77 == ((unsigned char) var_1_26)) : (var_1_77 == ((unsigned char) (var_1_26 && var_1_79))))) && ((var_1_35 <= var_1_39) ? (var_1_80 == ((unsigned long int) (((min (1159028602u , var_1_64)) + (max (1897264008u , var_1_82))) - (abs (var_1_68))))) : (var_1_80 == ((unsigned long int) (min (var_1_87 , ((var_1_83 - var_1_12) - var_1_65))))))) && ((var_1_9 > var_1_8) ? (var_1_84 == ((unsigned char) (! ((var_1_64 < var_1_69) || (! var_1_24))))) : (var_1_84 == ((unsigned char) (var_1_26 && var_1_24))))) && ((var_1_21 < var_1_49) ? (var_1_85 == ((unsigned char) var_1_26)) : 1)) && (var_1_86 == ((unsigned short int) (var_1_36 + var_1_39)))) && ((var_1_55 < var_1_43) ? (var_1_87 == ((signed short int) (var_1_21 + var_1_94))) : (var_1_87 == ((signed short int) var_1_52)))) && (var_1_85 ? (var_1_88 == ((signed short int) var_1_99)) : (var_1_88 == ((signed short int) var_1_49)))) && (var_1_89 == ((unsigned char) var_1_9))) && (var_1_90 == ((unsigned char) var_1_24))) && (var_1_90 ? (var_1_91 == ((double) var_1_73)) : (var_1_91 == ((double) var_1_29)))) && (var_1_90 ? (var_1_92 == ((float) var_1_73)) : (var_1_92 == ((float) var_1_17)))) && (var_1_24 ? (var_1_93 == ((float) var_1_28)) : (var_1_93 == ((float) var_1_29)))) && (var_1_79 ? (var_1_94 == ((unsigned long int) var_1_10)) : (var_1_94 == ((unsigned long int) 8u)))) && (var_1_33 ? (var_1_95 == ((unsigned short int) last_1_var_1_95)) : (var_1_95 == ((unsigned short int) var_1_48)))) && (var_1_33 ? (var_1_96 == ((double) var_1_29)) : (var_1_96 == ((double) var_1_97)))) && (var_1_98 == ((double) var_1_3))) && (var_1_99 == ((signed char) var_1_36))) && (var_1_34 ? (var_1_100 == ((unsigned char) var_1_26)) : 1)) && (var_1_85 ? (var_1_101 == ((double) var_1_3)) : 1)) && (((var_1_40 * (var_1_89 + var_1_74)) == var_1_82) ? (var_1_24 ? ((64u == var_1_68) ? (var_1_102 == ((float) (var_1_15 + (max (var_1_17 , var_1_29))))) : (var_1_102 == ((float) var_1_28))) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
