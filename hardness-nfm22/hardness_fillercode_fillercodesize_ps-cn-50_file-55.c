...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch55PS_CN_50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch55PS_CN_50
	if (var_1_23) {
		var_1_15 = (var_1_14 - var_1_13);
	}


	// From: Req5Batch55PS_CN_50
	if (var_1_23) {
