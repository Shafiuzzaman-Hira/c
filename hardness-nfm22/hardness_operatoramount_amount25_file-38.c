...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch38Amount25.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch38Amount25
	var_1_1 = ((max (var_1_2 , var_1_3)) - var_1_4);


	// From: Req2Batch38Amount25
	...
	// From: Req3Batch38Amount25
	var_1_7 = (var_1_8 + (var_1_9 + (var_1_10 + var_1_11)));


	// From: Req4Batch38Amount25
	if (! var_1_13) {
