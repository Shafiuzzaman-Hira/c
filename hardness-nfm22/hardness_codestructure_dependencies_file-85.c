...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch85dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch85dependencies
	if (last_1_var_1_13 < ((- last_1_var_1_12) * 64)) {
		if (last_1_var_1_5) {
			var_1_1 = (abs (last_1_var_1_12));
		} else {
			if (-10000000 < last_1_var_1_13) {
	...
	// From: Req2Batch85dependencies
	if (last_1_var_1_13 <= (last_1_var_1_15 + last_1_var_1_1)) {
	...
	// From: Req8Batch85dependencies
	if (var_1_5 || var_1_17) {
		var_1_18 = (((abs (var_1_19)) + var_1_20) - 63.6);
	}


	// From: Req5Batch85dependencies
	var_1_13 = (abs (var_1_14));


	// From: Req7Batch85dependencies
	var_1_16 = (var_1_6 && var_1_17);


	// From: Req6Batch85dependencies
	if (var_1_5) {
		var_1_15 = (max (var_1_1 , (var_1_13 + (abs (var_1_14)))));
	}


	// From: Req3Batch85dependencies
