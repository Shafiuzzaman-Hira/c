...
void step(void) {
	...
	if (stepLocal_4 > signed_long_int_Array_0[0]) {
		...
		float_Array_0[1] = ((abs (float_Array_0[0])) - float_Array_0[4]);
	}


	// From: Req4Batch30Wrapper_A
