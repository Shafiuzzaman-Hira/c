...
void step(void) {
	...
	// From: Req4Batch56Filler_PE_CI
	var_1_12 = ((64 + var_1_13) - var_1_14);


	// From: Req5Batch56Filler_PE_CI
	var_1_15 = ((var_1_16 - var_1_17) - 10);


	// From: Req6Batch56Filler_PE_CI
	if (var_1_1) {
		var_1_18 = (var_1_16 - var_1_13);
	}


	// From: Req7Batch56Filler_PE_CI
	...
	// From: Req2Batch56Filler_PE_CI
	if (var_1_4) {
		var_1_6 = (var_1_15 + (min (var_1_15 , var_1_18)));
	}


	// From: Req3Batch56Filler_PE_CI
