...
void step(void) {
	// From: Req10Batch79Amount250
	if (-1 > var_1_25) {
		if (last_1_var_1_34 != 8) {
			if ((last_1_var_1_62 + (abs (last_1_var_1_60))) >= (last_1_var_1_49 / var_1_28)) {
	...
	// From: Req1Batch79Amount250
	if (last_1_var_1_29 && last_1_var_1_29) {
		if (last_1_var_1_38 != 16.5) {
			var_1_1 = (max (-256 , last_1_var_1_49));
		} else {
			var_1_1 = (last_1_var_1_60 - last_1_var_1_60);
		}
	} else {
		var_1_1 = ((min (last_1_var_1_49 , last_1_var_1_24)) + last_1_var_1_24);
	}


	// From: Req9Batch79Amount250
	...
	if (var_1_33) {
		if (stepLocal_12 < last_1_var_1_49) {
			...
			if (((var_1_12 - var_1_37) > (last_1_var_1_52 * var_1_28)) && stepLocal_11) {
				var_1_36 = ((max (-8 , last_1_var_1_60)) + last_1_var_1_24);
			} else {
	...
	if (stepLocal_5 && last_1_var_1_29) {
		...
		if (last_1_var_1_29 || stepLocal_6) {
			var_1_24 = (min (var_1_12 , var_1_25));
		}
	}


	// From: Req14Batch79Amount250
	var_1_49 = (var_1_12 + 1);


	// From: Req20Batch79Amount250
	var_1_60 = (var_1_61 - var_1_37);


	// From: Req21Batch79Amount250
	...
	// From: Req2Batch79Amount250
	signed long int stepLocal_3 = var_1_49 ^ var_1_49;
	signed char stepLocal_2 = var_1_49;
	signed long int stepLocal_1 = (var_1_49 + var_1_60) << (abs (var_1_12));
	signed long int stepLocal_0 = (var_1_24 * var_1_60) & (max (-50 , var_1_24));
		...
		if ((~ (var_1_49 ^ var_1_60)) <= stepLocal_0) {
			if (var_1_29) {
				if ((last_1_var_1_11 | (var_1_60 << var_1_60)) >= stepLocal_2) {
					var_1_11 = (max (var_1_49 , var_1_49));
				}
			} else {
	...
	// From: Req19Batch79Amount250
	if (var_1_12 >= 100) {
		if (((var_1_36 + var_1_24) + var_1_34) <= -8) {
			var_1_59 = (var_1_60 - (max (var_1_24 , var_1_34)));
		} else {
			if ((max (var_1_36 , (last_1_var_1_59 * var_1_37))) != var_1_60) {
	...
	// From: Req4Batch79Amount250
	var_1_19 = (max ((abs (var_1_49)) , (var_1_49 + var_1_12)));


	// From: Req15Batch79Amount250
	...
	// From: Req18Batch79Amount250
	if (-5 < var_1_12) {
		if (var_1_29) {
			var_1_57 = (min (var_1_24 , ((var_1_55 + var_1_60) - (var_1_12 + var_1_49))));
		} else {
		...
		if (! var_1_33) {
			if (((var_1_62 / var_1_54) + -16) > var_1_60) {
				var_1_57 = ((min ((var_1_58 - var_1_60) , var_1_55)) - var_1_24);
			} else {
				var_1_57 = 50;
			}
		} else {
	...
	// From: Req13Batch79Amount250
	if ((var_1_1 > var_1_60) && var_1_33) {
		if (var_1_49 < (10 * var_1_11)) {
			if ((max (var_1_24 , (var_1_35 | var_1_50))) >= var_1_28) {
				var_1_42 = var_1_17;
			} else {
				var_1_42 = (var_1_16 + (var_1_45 - var_1_46));
			}
		} else {
			var_1_42 = (max ((min (var_1_40 , var_1_18)) , var_1_45));
		}
	} else {
	...
	// From: Req16Batch79Amount250
	if (var_1_36 != (var_1_25 + var_1_53)) {
		var_1_52 = (var_1_62 + var_1_12);
	}


	// From: Req3Batch79Amount250
	signed short int stepLocal_4 = var_1_52;
	if (-32 != stepLocal_4) {
		var_1_15 = (min ((max (8.25f , (var_1_16 + var_1_17))) , var_1_18));
	} else {
		var_1_15 = (127.5f + var_1_16);
	}


	// From: Req6Batch79Amount250
	if (var_1_24 <= var_1_59) {
		if (var_1_29 || ((abs (var_1_15)) <= var_1_17)) {
			var_1_21 = ((min (var_1_24 , var_1_24)) + var_1_12);
		} else {
			var_1_21 = ((var_1_22 - (max (var_1_24 , var_1_12))) - (var_1_60 + (abs (4))));
		}
	} else {
		var_1_21 = var_1_24;
	}
	...
	if (var_1_29) {
		if ((var_1_36 + var_1_62) < -50) {
			...
			if (var_1_38 > ((31.6 * var_1_18) / 5.5)) {
				...
				var_1_20 = (min ((var_1_24 - var_1_12) , var_1_60));
			}
		}
	}


	// From: Req8Batch79Amount250
	...
	if (var_1_50 >= stepLocal_7) {
		if ((33351 - (abs (var_1_20))) == stepLocal_8) {
			if ((var_1_62 / (min (var_1_22 , var_1_28))) != stepLocal_9) {
				var_1_26 = var_1_24;
			} else {
				var_1_26 = var_1_24;
			}
...
int property() {
	return (((((((((((((((((((((last_1_var_1_29 && last_1_var_1_29) ? ((last_1_var_1_38 != 16.5) ? (var_1_1 == ((signed short int) (max (-256 , last_1_var_1_49)))) : (var_1_1 == ((signed short int) (last_1_var_1_60 - last_1_var_1_60)))) : (var_1_1 == ((signed short int) ((min (last_1_var_1_49 , last_1_var_1_24)) + last_1_var_1_24)))) && ((((var_1_49 + var_1_60) << (abs (var_1_12))) <= (var_1_49 * var_1_60)) ? (var_1_11 == ((signed short int) ((var_1_12 + var_1_24) - var_1_60))) : (((~ (var_1_49 ^ var_1_60)) <= ((var_1_24 * var_1_60) & (max (-50 , var_1_24)))) ? (var_1_29 ? (((last_1_var_1_11 | (var_1_60 << var_1_60)) >= var_1_49) ? (var_1_11 == ((signed short int) (max (var_1_49 , var_1_49)))) : 1) : (((var_1_49 ^ var_1_49) > var_1_60) ? (var_1_11 == ((signed short int) -2)) : 1)) : (var_1_11 == ((signed short int) var_1_60))))) && ((-32 != var_1_52) ? (var_1_15 == ((float) (min ((max (8.25f , (var_1_16 + var_1_17))) , var_1_18)))) : (var_1_15 == ((float) (127.5f + var_1_16))))) && (var_1_19 == ((signed short int) (max ((abs (var_1_49)) , (var_1_49 + var_1_12)))))) && (var_1_29 ? (((var_1_36 + var_1_62) < -50) ? (var_1_20 == ((signed long int) (128 - var_1_12))) : ((var_1_38 > ((31.6 * var_1_18) / 5.5)) ? (var_1_20 == ((signed long int) (var_1_12 + -8))) : (var_1_20 == ((signed long int) (min ((var_1_24 - var_1_12) , var_1_60)))))) : 1)) && ((var_1_24 <= var_1_59) ? ((var_1_29 || ((abs (var_1_15)) <= var_1_17)) ? (var_1_21 == ((unsigned short int) ((min (var_1_24 , var_1_24)) + var_1_12))) : (var_1_21 == ((unsigned short int) ((var_1_22 - (max (var_1_24 , var_1_12))) - (var_1_60 + (abs (4))))))) : (var_1_21 == ((unsigned short int) var_1_24)))) && ((last_1_var_1_29 && last_1_var_1_29) ? (var_1_24 == ((unsigned char) var_1_12)) : ((last_1_var_1_29 || last_1_var_1_29) ? (var_1_24 == ((unsigned char) (min (var_1_12 , var_1_25)))) : 1))) && ((var_1_50 >= var_1_24) ? (((33351 - (abs (var_1_20))) == (var_1_62 + (var_1_24 + var_1_24))) ? (((var_1_62 / (min (var_1_22 , var_1_28))) != var_1_60) ? (var_1_26 == ((signed long int) var_1_24)) : (var_1_26 == ((signed long int) var_1_24))) : (var_1_26 == ((signed long int) var_1_24))) : (var_1_26 == ((signed long int) var_1_24)))) && (((last_1_var_1_11 < last_1_var_1_24) && var_1_2) ? (var_1_29 == ((unsigned char) ((var_1_30 || var_1_31) || (var_1_3 && (var_1_32 || var_1_33))))) : 1)) && ((-1 > var_1_25) ? ((last_1_var_1_34 != 8) ? (((last_1_var_1_62 + (abs (last_1_var_1_60))) >= (last_1_var_1_49 / var_1_28)) ? (var_1_34 == ((signed long int) (last_1_var_1_60 + (var_1_22 - (var_1_35 - last_1_var_1_24))))) : 1) : 1) : 1)) && (var_1_33 ? ((last_1_var_1_52 < last_1_var_1_49) ? (var_1_36 == ((signed long int) ((last_1_var_1_60 + 256) - last_1_var_1_52))) : ((((var_1_12 - var_1_37) > (last_1_var_1_52 * var_1_28)) && (last_1_var_1_57 == last_1_var_1_53)) ? (var_1_36 == ((signed long int) ((max (-8 , last_1_var_1_60)) + last_1_var_1_24))) : (var_1_36 == ((signed long int) last_1_var_1_49)))) : (var_1_36 == ((signed long int) last_1_var_1_57)))) && (((var_1_18 > var_1_42) || var_1_32) ? (var_1_38 == ((float) (var_1_40 - var_1_41))) : 1)) && (((var_1_1 > var_1_60) && var_1_33) ? ((var_1_49 < (10 * var_1_11)) ? (((max (var_1_24 , (var_1_35 | var_1_50))) >= var_1_28) ? (var_1_42 == ((double) var_1_17)) : (var_1_42 == ((double) (var_1_16 + (var_1_45 - var_1_46))))) : (var_1_42 == ((double) (max ((min (var_1_40 , var_1_18)) , var_1_45))))) : (var_1_42 == ((double) ((var_1_47 + var_1_48) + (var_1_45 - var_1_46)))))) && (var_1_49 == ((signed char) (var_1_12 + 1)))) && ((var_1_31 || var_1_29) ? ((16 <= ((var_1_51 - var_1_60) - var_1_37)) ? (var_1_50 == ((unsigned long int) var_1_37)) : 1) : (var_1_50 == ((unsigned long int) var_1_25)))) && ((var_1_36 != (var_1_25 + var_1_53)) ? (var_1_52 == ((signed short int) (var_1_62 + var_1_12))) : 1)) && ((((min (var_1_54 , var_1_55)) - var_1_12) <= ((var_1_51 - 128) - var_1_60)) ? ((var_1_60 < (var_1_35 + var_1_11)) ? (var_1_53 == ((unsigned long int) (var_1_56 - var_1_25))) : 1) : (var_1_32 ? (var_1_53 == ((unsigned long int) (var_1_56 - var_1_59))) : 1))) && ((-5 < var_1_12) ? (var_1_29 ? (var_1_57 == ((signed short int) (min (var_1_24 , ((var_1_55 + var_1_60) - (var_1_12 + var_1_49)))))) : (var_1_57 == ((signed short int) (var_1_24 - var_1_12)))) : ((! var_1_33) ? ((((var_1_62 / var_1_54) + -16) > var_1_60) ? (var_1_57 == ((signed short int) ((min ((var_1_58 - var_1_60) , var_1_55)) - var_1_24))) : (var_1_57 == ((signed short int) 50))) : (var_1_57 == ((signed short int) (var_1_24 - 128)))))) && ((var_1_12 >= 100) ? ((((var_1_36 + var_1_24) + var_1_34) <= -8) ? (var_1_59 == ((signed short int) (var_1_60 - (max (var_1_24 , var_1_34))))) : (((max (var_1_36 , (last_1_var_1_59 * var_1_37))) != var_1_60) ? (((var_1_56 - var_1_12) > (- (var_1_51 / var_1_22))) ? (var_1_59 == ((signed short int) var_1_24)) : 1) : 1)) : (var_1_59 == ((signed short int) var_1_58)))) && (var_1_60 == ((unsigned char) (var_1_61 - var_1_37)))) && ((var_1_37 <= ((var_1_63 - var_1_12) - var_1_64)) ? (var_1_30 ? (var_1_29 ? (var_1_62 == ((signed long int) var_1_58)) : (var_1_62 == ((signed long int) var_1_55))) : (var_1_62 == ((signed long int) var_1_34))) : 1)
;
}
int main(void) {
	isInitial = 1;
