...
void step(void) {
	...
	// From: CodeObject5
	if (var_1_5 > (var_1_15 | (abs (var_1_6)))) {
		var_1_36 = (max (8 , (max ((max (var_1_4 , var_1_12)) , var_1_4))));
	}
	...
	if (! var_1_20) {
		...
		if (var_1_22 <= var_1_23) {
			if (((abs (var_1_4)) - var_1_7) < var_1_7) {
				if (var_1_7 < var_1_7) {
					var_1_27 = var_1_28;
				}
			} else {
	...
	if ((var_1_23 < var_1_34) || var_1_20) {
		if ((var_1_14 / (min (-10 , var_1_5))) >= (min (var_1_7 , var_1_12))) {
			var_1_33 = var_1_12;
		} else {
			var_1_33 = var_1_12;
		}
