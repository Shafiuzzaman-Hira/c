...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch42Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch42Amount50
	if (var_1_14 <= var_1_15) {
		var_1_19 = (var_1_12 || var_1_20);
	}


	// From: Req2Batch42Amount50
	if (var_1_5 >= -2) {
		var_1_6 = (var_1_7 - 100);
	}


	// From: Req4Batch42Amount50
