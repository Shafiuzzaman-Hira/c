...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch7750_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch7750_while
	if ((- var_1_7) < (var_1_1 * var_1_4)) {
		var_1_8 = var_1_9;
	}


	// From: Req4Batch7750_while
	...
	// From: Req3Batch7750_while
	var_1_10 = (50 + ((var_1_11 + 10000) - var_1_12));


	// From: Req6Batch7750_while
