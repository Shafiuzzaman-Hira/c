...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch45Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch45Filler_PE_CN
	if (var_1_2) {
		var_1_16 = (var_1_5 || var_1_17);
	}


	// From: Req8Batch45Filler_PE_CN
	var_1_18 = var_1_8;


	// From: Req2Batch45Filler_PE_CN
	...
	// From: Req3Batch45Filler_PE_CN
	var_1_7 = (min ((var_1_8 - var_1_18) , var_1_9));


	// From: Req5Batch45Filler_PE_CN
	if (! var_1_16) {
		if (var_1_16) {
