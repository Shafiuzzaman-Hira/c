...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch60PS_CN_25.c", 13, "reach_error"); }
...
double var_1_26 = 15.75;
signed long int var_1_27 = 5;
...
void step(void) {
	...
	// From: CodeObject5
	if (((abs (var_1_28)) | var_1_27) > var_1_30) {
		if (var_1_26 < (abs (var_1_25 + var_1_32))) {
			if ((abs (var_1_33)) >= (var_1_28 ^ var_1_27)) {
				var_1_31 = (min (var_1_30 , (var_1_34 + 5)));
			} else {
				var_1_31 = 0;
			}
		} else {
