...
void step(void) {
	// From: CodeObject1
	if (var_1_12 <= ((min (var_1_9 , var_1_9)) >> (var_1_26 - var_1_27))) {
		var_1_22 = (max (var_1_9 , var_1_9));
	} else {
		var_1_22 = var_1_9;
	}
	...
	// From: CodeObject2
	if (8.4 <= var_1_15) {
		var_1_28 = (abs (min (var_1_21 , var_1_12)));
	} else {
	...
	// From: Req7Batch5Filler_PS_CO
	var_1_21 = var_1_10;


	// From: Req6Batch5Filler_PS_CO
