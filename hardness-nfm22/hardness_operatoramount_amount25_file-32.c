...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch32Amount25.c", 13, "reach_error"); }
...
int property() {
	return ((((last_1_var_1_13 >= -50) ? (var_1_1 == ((unsigned short int) (max ((var_1_3 + (abs (var_1_4))) , var_1_5)))) : 1) && (var_1_7 ? (var_1_6 == ((signed short int) (var_1_8 + var_1_9))) : 1)) && (((var_1_6 / (var_1_11 + var_1_12)) != ((last_1_var_1_10 >> var_1_1) ^ (var_1_8 << var_1_5))) ? (var_1_10 == ((unsigned long int) (min (var_1_12 , var_1_4)))) : (var_1_10 == ((unsigned long int) var_1_11)))) && (var_1_7 ? (var_1_13 == ((unsigned long int) (max (var_1_11 , var_1_1)))) : (((var_1_11 & var_1_12) != var_1_1) ? (var_1_13 == ((unsigned long int) var_1_12)) : 1))
;
}
int main(void) {
	isInitial = 1;
