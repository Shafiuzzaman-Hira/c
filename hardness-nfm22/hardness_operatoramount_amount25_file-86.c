...
void step(void) {
	...
	// From: Req3Batch86Amount25
	unsigned long int stepLocal_1 = 0u;
	if (stepLocal_1 >= (max ((var_1_13 - var_1_7) , var_1_7))) {
		var_1_12 = (var_1_7 - var_1_7);
	}


	// From: Req1Batch86Amount25
	if (! var_1_16) {
		var_1_1 = (min ((var_1_7 + (var_1_7 + var_1_7)) , var_1_7));
	} else {
		var_1_1 = (min (var_1_7 , var_1_7));
	}
}
...
int property() {
	return ((((! var_1_16) ? (var_1_1 == ((signed short int) (min ((var_1_7 + (var_1_7 + var_1_7)) , var_1_7)))) : (var_1_1 == ((signed short int) (min (var_1_7 , var_1_7))))) && (((var_1_3 / var_1_8) <= (var_1_9 - var_1_10)) ? (var_1_16 ? (var_1_7 == ((unsigned char) var_1_11)) : 1) : 1)) && ((0u >= (max ((var_1_13 - var_1_7) , var_1_7))) ? (var_1_12 == ((signed short int) (var_1_7 - var_1_7))) : 1)) && ((((var_1_17 - 100u) - (var_1_11 + last_1_var_1_1)) < var_1_13) ? (var_1_16 == ((unsigned char) var_1_18)) : 1)
;
}
int main(void) {
	isInitial = 1;
