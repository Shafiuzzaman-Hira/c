...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch4PS_CN_10.c", 13, "reach_error"); }
...
unsigned short int var_1_29 = 39250;
...
void step(void) {
	...
	// From: CodeObject4
	if (var_1_28) {
		var_1_27 = (min ((var_1_29 - var_1_30) , var_1_31));
	}
