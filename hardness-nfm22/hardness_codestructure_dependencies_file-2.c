...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch2dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch2dependencies
	var_1_20 = var_1_16;


	// From: Req8Batch2dependencies
	var_1_21 = var_1_16;
