...
void step(void) {
	...
	// From: Req2Batch58normal
	if (var_1_3 <= var_1_2) {
		var_1_10 = (min (var_1_5 , var_1_3));
	}


	// From: Req3Batch58normal
	if (var_1_1 >= ((min (var_1_2 , var_1_10)) + var_1_5)) {
	...
	// From: Req4Batch58normal
	var_1_12 = (min (var_1_13 , var_1_14));


	// From: Req5Batch58normal
	if (var_1_7) {
		var_1_15 = ((min (32 , (16 + var_1_16))) - var_1_17);
	}


	// From: Req6Batch58normal
	if (var_1_16 <= (max (var_1_13 , var_1_3))) {
