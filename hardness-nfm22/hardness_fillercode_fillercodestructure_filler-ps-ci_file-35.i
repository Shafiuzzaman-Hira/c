...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch35Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_20 <= var_1_18) {
  if ((var_1_11 | ((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25)))) >= (var_1_24 + var_1_6)) {
 ...
 if (! var_1_22) {
  if ((var_1_25 == var_1_13) && var_1_22) {
   var_1_35 = ((((var_1_11) < (var_1_6)) ? (var_1_11) : (var_1_6)));
  } else {
   var_1_35 = ((((var_1_11) < (var_1_6)) ? (var_1_11) : (var_1_6)));
  }
 }
 if (32u >= (((((var_1_6) > (var_1_11)) ? (var_1_6) : (var_1_11))) % 16u)) {
  if ((-5 > var_1_25) && (var_1_6 <= ((((var_1_34) > (var_1_12)) ? (var_1_34) : (var_1_12))))) {
   var_1_39 = var_1_18;
  } else {
   var_1_39 = ((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18)));
  }
 } else {
  if (! var_1_4) {
   var_1_39 = ((((var_1_18) > (((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18))))) ? (var_1_18) : (((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18))))));
  }
 }
 var_1_41 = ((((((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19)))) < (var_1_20)) ? (((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19)))) : (var_1_20)));
 if (var_1_33 < (var_1_11 | var_1_6)) {
