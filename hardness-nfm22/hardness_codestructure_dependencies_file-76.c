...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch76dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch76dependencies
	if ((var_1_6 + (var_1_6 | var_1_6)) > var_1_16) {
		var_1_18 = (128 - (var_1_19 + var_1_20));
	}


	// From: Req5Batch76dependencies
	if (var_1_5 >= var_1_1) {
		if ((abs (1.2)) < var_1_4) {
			var_1_14 = var_1_18;
		} else {
	...
	// From: Req3Batch76dependencies
	if ((var_1_14 * var_1_17) >= var_1_11) {
		if (var_1_2) {
			var_1_8 = var_1_4;
		}
	}
