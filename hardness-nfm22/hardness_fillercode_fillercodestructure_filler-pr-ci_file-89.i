...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch89Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_38 = var_1_25;
 var_1_18 = var_1_8;
 if (((((var_1_8) < (25)) ? (var_1_8) : (25))) > (var_1_9 >> ((((var_1_25) < (1)) ? (var_1_25) : (1))))) {
  if (var_1_1 >= var_1_13) {
   var_1_24 = var_1_1;
  } else {
   var_1_24 = var_1_9;
 ...
 if (var_1_13 > var_1_18) {
  if (((((var_1_17) < ((var_1_17 / var_1_36))) ? (var_1_17) : ((var_1_17 / var_1_36)))) <= var_1_17) {
   var_1_33 = (((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8))) + (var_1_8 + var_1_30));
  }
 }
 ...
 if (var_1_15 && var_1_14) {
  if (var_1_8 < var_1_29) {
   if (var_1_15) {
    ...
    var_1_32 = (var_1_13 + (((((((var_1_25) > (var_1_18)) ? (var_1_25) : (var_1_18))) < 0 ) ? -((((var_1_25) > (var_1_18)) ? (var_1_25) : (var_1_18))) : ((((var_1_25) > (var_1_18)) ? (var_1_25) : (var_1_18))))));
   }
  }
 } else {
  if (var_1_14) {
