...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch96dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch96dependencies
	var_1_31 = var_1_30;


	// From: Req1Batch96dependencies
