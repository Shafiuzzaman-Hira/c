...
void step(void) {
 if (BOOL_unsigned_char_Array_0[1]) {
  unsigned_long_int_Array_0[1] = ((1514707036u + ((((unsigned_long_int_Array_0[0]) < 0 ) ? -(unsigned_long_int_Array_0[0]) : (unsigned_long_int_Array_0[0])))) - last_1_signed_long_int_Array_0_0_);
 } else {
  unsigned_long_int_Array_0[1] = ((((last_1_signed_long_int_Array_0_0_) > (unsigned_long_int_Array_0[0])) ? (last_1_signed_long_int_Array_0_0_) : (unsigned_long_int_Array_0[0])));
 }
 if (BOOL_unsigned_char_Array_0[1]) {
  signed_long_int_Array_0[0] = (unsigned_long_int_Array_0[1] + ((((signed_char_Array_0[0]) < 0 ) ? -(signed_char_Array_0[0]) : (signed_char_Array_0[0]))));
 }
 ...
 if (signed_char_Array_0[1] >= signed_char_Array_0[1]) {
  double_Array_0[2] = (double_Array_0[0] - (((((double_Array_0[1] + double_Array_0[3])) > (double_Array_0[4])) ? ((double_Array_0[1] + double_Array_0[3])) : (double_Array_0[4]))));
 } else {
  double_Array_0[2] = ((((double_Array_0[3]) > (double_Array_0[1])) ? (double_Array_0[3]) : (double_Array_0[1])));
 }
}
