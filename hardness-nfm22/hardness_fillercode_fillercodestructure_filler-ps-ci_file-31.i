...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch31Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (! var_1_20) {
  ...
  if (var_1_22 <= var_1_23) {
   if ((((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8))) - var_1_3) < var_1_8) {
    if (var_1_8 < var_1_3) {
     var_1_27 = var_1_28;
    }
   } else {
 ...
 if ((var_1_23 < var_1_34) || var_1_20) {
  if ((var_1_6 / ((((-10) < (var_1_6)) ? (-10) : (var_1_6)))) >= ((((var_1_11) < (var_1_7)) ? (var_1_11) : (var_1_7)))) {
   var_1_33 = var_1_7;
  } else {
   var_1_33 = var_1_7;
  }
 }
 if (var_1_12 > (var_1_8 | ((((var_1_5) < 0 ) ? -(var_1_5) : (var_1_5))))) {
  var_1_36 = ((((8) > (((((((((var_1_5) > (var_1_4)) ? (var_1_5) : (var_1_4)))) > (var_1_3)) ? (((((var_1_5) > (var_1_4)) ? (var_1_5) : (var_1_4)))) : (var_1_3))))) ? (8) : (((((((((var_1_5) > (var_1_4)) ? (var_1_5) : (var_1_4)))) > (var_1_3)) ? (((((var_1_5) > (var_1_4)) ? (var_1_5) : (var_1_4)))) : (var_1_3))))));
 }
