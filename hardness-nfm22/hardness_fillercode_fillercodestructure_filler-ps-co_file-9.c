...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch9Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_12 <= var_1_12) {
		if (var_1_12 <= ((min (var_1_25 , var_1_24)) / var_1_27)) {
			var_1_26 = (abs (var_1_16));
		}
	} else {
		if (var_1_25 > (2 ^ (max (var_1_12 , var_1_27)))) {
	...
	// From: CodeObject6
	if (((256 - var_1_25) <= (var_1_13 + var_1_16)) || var_1_20) {
		if (var_1_20) {
	...
	// From: Req3Batch9Filler_PS_CO
	if (((var_1_6 >> 2) * last_1_var_1_13) > last_1_var_1_10) {
		var_1_12 = var_1_6;
	}


	// From: Req2Batch9Filler_PS_CO
	...
	// From: Req6Batch9Filler_PS_CO
	var_1_18 = var_1_3;


	// From: Req5Batch9Filler_PS_CO
