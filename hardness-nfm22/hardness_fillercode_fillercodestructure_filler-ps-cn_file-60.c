...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch60Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_26 != var_1_24) {
		var_1_31 = (((max (var_1_27 , var_1_32)) + var_1_33) - var_1_34);
	}
	...
	// From: CodeObject5
	if (var_1_30) {
		if (var_1_37 > (min (var_1_35 , var_1_36))) {
	...
	// From: CodeObject6
	if ((abs (var_1_32)) <= (2 / (abs (var_1_44)))) {
		var_1_43 = (max (var_1_39 , var_1_45));
	}


	// From: Req3Batch60Filler_PS_CN
