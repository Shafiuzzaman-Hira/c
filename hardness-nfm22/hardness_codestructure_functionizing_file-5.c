...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch5functionizing.c", 13, "reach_error"); }
...
void functionized1(unsigned char, unsigned short int);
...
unsigned char functionized0(signed long int functionized0_localFunctionVar0) {
	return (((- 64) + var_1_2) == functionized0_localFunctionVar0);
}
void functionized1(unsigned char functionized1_localFunctionVar0, unsigned short int functionized1_localFunctionVar1) {
	if (functionized1_localFunctionVar0 == (functionized1_localFunctionVar1 / var_1_4)) {
		var_1_9 = (min (functionized1_localFunctionVar0 , (abs (var_1_4))));
	} else {
		var_1_9 = ((var_1_10 + var_1_11) - functionized1_localFunctionVar0);
	}
}
signed long int functionized2(unsigned short int functionized2_localFunctionVar0) {
	return ((functionized2_localFunctionVar0 - var_1_5) + (abs (var_1_9)));
}
...
void step(void) {
	...
	// From: Req3Batch5functionizing
	functionized1(var_1_5, var_1_2);


	// From: Req4Batch5functionizing
	if ((abs (var_1_3)) <= (max (var_1_13 , var_1_4))) {
		var_1_12 = functionized2(var_1_14);
	} else {
		var_1_12 = var_1_9;
	}


	// From: Req5Batch5functionizing
