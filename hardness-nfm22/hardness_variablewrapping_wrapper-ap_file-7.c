...
void step(void) {
	...
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
		if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer)) && ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) <= (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)))) {
			if ((max ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) , (*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)))) > (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))) {
				(*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)) = (max (((3725801564u - (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) - (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer))) , (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer))));
			} else {
