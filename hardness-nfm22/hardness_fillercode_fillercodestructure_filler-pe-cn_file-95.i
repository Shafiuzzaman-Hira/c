...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch95Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (((var_1_31 - var_1_32) + (var_1_27 / var_1_33)) < ((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26)))) {
  if (var_1_21 >= 10u) {
   if (var_1_22) {
    var_1_30 = (((((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) < 0 ) ? -((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) : ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34)))));
   } else {
    var_1_30 = ((((((((var_1_34) > (var_1_29)) ? (var_1_34) : (var_1_29)))) < ((var_1_35 + 64))) ? (((((var_1_34) > (var_1_29)) ? (var_1_34) : (var_1_29)))) : ((var_1_35 + 64))));
   }
  } else {
   var_1_30 = ((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35)));
  }
 }
 if (var_1_24) {
