...
void step(void) {
	// From: Req1Batch79Amount10
	unsigned long int stepLocal_1 = var_1_5;
	unsigned long int stepLocal_0 = min ((var_1_3 - var_1_4) , var_1_5);
	if (stepLocal_0 <= 50u) {
		if (var_1_2) {
...
int property() {
	return ((min ((var_1_3 - var_1_4) , var_1_5)) <= 50u) ? (var_1_2 ? ((var_1_3 > var_1_5) ? (var_1_1 == ((double) (var_1_6 + var_1_7))) : 1) : 1) : (var_1_1 == ((double) var_1_7))
;
}
int main(void) {
	isInitial = 1;
