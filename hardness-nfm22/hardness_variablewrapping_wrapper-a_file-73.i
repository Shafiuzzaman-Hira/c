...
void step(void) {
 if (BOOL_unsigned_char_Array_0[2]) {
  unsigned_char_Array_0[1] = ((((unsigned_char_Array_0[0]) > (unsigned_char_Array_0[2])) ? (unsigned_char_Array_0[0]) : (unsigned_char_Array_0[2])));
 } else {
 ...
 if (signed_long_int_Array_0[0] > unsigned_char_Array_0[0]) {
  if (BOOL_unsigned_char_Array_0[2]) {
   float_Array_0[0] = (float_Array_0[1] - ((((99999.25f) < 0 ) ? -(99999.25f) : (99999.25f))));
  } else {
 ...
 signed long int stepLocal_0 = (((unsigned_char_Array_0[1]) > ((unsigned_char_Array_0[1] + signed_long_int_Array_0[0]))) ? (unsigned_char_Array_0[1]) : ((unsigned_char_Array_0[1] + signed_long_int_Array_0[0])));
