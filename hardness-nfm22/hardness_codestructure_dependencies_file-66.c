...
void step(void) {
	...
	// From: Req4Batch66dependencies
	if (var_1_8 >= var_1_7) {
		var_1_12 = (! var_1_14);
	}


	// From: Req1Batch66dependencies
	if (var_1_12) {
		var_1_1 = (var_1_3 + var_1_4);
	}


	// From: Req2Batch66dependencies
	...
	// From: Req8Batch66dependencies
	if (var_1_12) {
		var_1_19 = ((var_1_7 - (min (var_1_20 , var_1_21))) + var_1_6);
	}


	// From: Req5Batch66dependencies
	...
	// From: Req6Batch66dependencies
	if (var_1_19 > ((max (var_1_11 , var_1_18)) + (var_1_15 / var_1_10))) {
		var_1_16 = var_1_4;
	}
}
