...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch89Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_28 && var_1_27) {
		if (var_1_20 < var_1_29) {
			if (var_1_28) {
				...
				var_1_32 = (var_1_23 + (abs (max (var_1_25 , var_1_21))));
			}
		}
	} else {
		if (var_1_27) {
	...
	// From: CodeObject6
	if (var_1_23 > var_1_19) {
		if ((min (var_1_34 , (var_1_35 / var_1_36))) <= var_1_37) {
			var_1_33 = ((abs (var_1_26)) + (var_1_21 + var_1_30));
		}
	}
	...
	// From: Req6Batch89Filler_PS_CN
	var_1_18 = var_1_8;


	// From: Req3Batch89Filler_PS_CN
