...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch27Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
 if (WrapperStruct00.var_1_8 || (! WrapperStruct00.var_1_9)) {
  WrapperStruct00.var_1_7 = (WrapperStruct00.var_1_10 - WrapperStruct00.var_1_4);
 }
 unsigned long int stepLocal_1 = WrapperStruct00.var_1_7;
 if (WrapperStruct00.var_1_6 > stepLocal_1) {
  WrapperStruct00.var_1_11 = (WrapperStruct00.var_1_4 + ((((-4) > (WrapperStruct00.var_1_5)) ? (-4) : (WrapperStruct00.var_1_5))));
 } else {
  if (WrapperStruct00.var_1_8) {
   WrapperStruct00.var_1_11 = WrapperStruct00.var_1_6;
  }
 }
 signed long int stepLocal_0 = WrapperStruct00.var_1_11;
 if (32 >= stepLocal_0) {
  WrapperStruct00.var_1_1 = (WrapperStruct00.var_1_3 + (((((WrapperStruct00.var_1_4 - WrapperStruct00.var_1_5)) > (WrapperStruct00.var_1_6)) ? ((WrapperStruct00.var_1_4 - WrapperStruct00.var_1_5)) : (WrapperStruct00.var_1_6))));
 } else {
  WrapperStruct00.var_1_1 = (WrapperStruct00.var_1_4 - WrapperStruct00.var_1_5);
 }
 signed long int stepLocal_2 = ((((WrapperStruct00.var_1_5 - WrapperStruct00.var_1_4)) > (WrapperStruct00.var_1_1)) ? ((WrapperStruct00.var_1_5 - WrapperStruct00.var_1_4)) : (WrapperStruct00.var_1_1));
 if (WrapperStruct00.var_1_8) {
  if (((WrapperStruct00.var_1_7 * 128) / WrapperStruct00.var_1_13) != stepLocal_2) {
   WrapperStruct00.var_1_12 = (WrapperStruct00.var_1_10 - WrapperStruct00.var_1_13);
  } else {
