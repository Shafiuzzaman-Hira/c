...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch97Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch97Wrapper_S
	WrapperStruct00.var_1_18 = WrapperStruct00.var_1_19;


	// From: Req5Batch97Wrapper_S
	WrapperStruct00.var_1_20 = WrapperStruct00.var_1_21;


	// From: Req6Batch97Wrapper_S
	WrapperStruct00.var_1_22 = WrapperStruct00.var_1_12;


	// From: Req3Batch97Wrapper_S
	if (127.5f > WrapperStruct00.var_1_20) {
		WrapperStruct00.var_1_13 = (WrapperStruct00.var_1_15 && WrapperStruct00.var_1_16);
	} else {
		WrapperStruct00.var_1_13 = ((WrapperStruct00.var_1_20 >= WrapperStruct00.var_1_20) || WrapperStruct00.var_1_15);
	}


	// From: Req2Batch97Wrapper_S
