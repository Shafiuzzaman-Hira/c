...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch93dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch93dependencies
	if (var_1_10 || (var_1_13 < (var_1_8 / var_1_11))) {
	...
	// From: Req5Batch93dependencies
	if (var_1_16) {
		var_1_20 = (var_1_9 - 50);
	}


	// From: Req1Batch93dependencies
	if ((var_1_20 + var_1_14) < var_1_21) {
		if (var_1_21 <= (var_1_14 - var_1_20)) {
