...
void step(void) {
 ...
 if ((((((200) < (128)) ? (200) : (128))) - (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) > stepLocal_0) {
  (*(float_Array_0_arrayfloat_Array_0arrayVar6_Pointer)) = ((((((*(float_Array_0_arrayfloat_Array_0arrayVar5_Pointer))) < ((*(float_Array_0_arrayfloat_Array_0arrayVar4_Pointer)))) ? ((*(float_Array_0_arrayfloat_Array_0arrayVar5_Pointer))) : ((*(float_Array_0_arrayfloat_Array_0arrayVar4_Pointer))))) - (*(float_Array_0_arrayfloat_Array_0arrayVar3_Pointer)));
 } else {
  if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
   (*(float_Array_0_arrayfloat_Array_0arrayVar6_Pointer)) = ((((((*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer))) < ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)))) ? ((*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer))) : ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer))))) + (*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)));
  }
 }
