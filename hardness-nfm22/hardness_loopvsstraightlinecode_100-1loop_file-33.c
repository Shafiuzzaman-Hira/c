...
void step(void) {
	...
	// From: Req2Batch33100_1loop
	var_1_4 = (max (((var_1_5 + var_1_6) + var_1_7) , var_1_8));


	// From: Req9Batch33100_1loop
	if (var_1_21) {
	...
	// From: Req14Batch33100_1loop
	var_1_41 = var_1_29;


	// From: Req15Batch33100_1loop
	var_1_42 = var_1_35;


	// From: Req6Batch33100_1loop
