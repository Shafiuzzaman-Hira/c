...
void step(void) {
	// From: Req2Batch15Wrapper_P
	if ((*(var_1_2_Pointer))) {
		(*(var_1_8_Pointer)) = ((1514707036u + (abs ((*(var_1_9_Pointer))))) - last_1_var_1_10);
	} else {
		(*(var_1_8_Pointer)) = (max (last_1_var_1_10 , (*(var_1_9_Pointer))));
	}


	// From: Req3Batch15Wrapper_P
	if ((*(var_1_2_Pointer))) {
		(*(var_1_10_Pointer)) = ((*(var_1_8_Pointer)) + (abs ((*(var_1_7_Pointer)))));
	}


	// From: Req1Batch15Wrapper_P
	...
	// From: Req4Batch15Wrapper_P
	if ((*(var_1_1_Pointer)) >= (*(var_1_1_Pointer))) {
		(*(var_1_11_Pointer)) = ((*(var_1_12_Pointer)) - (max (((*(var_1_13_Pointer)) + (*(var_1_14_Pointer))) , (*(var_1_15_Pointer)))));
	} else {
		(*(var_1_11_Pointer)) = (max ((*(var_1_14_Pointer)) , (*(var_1_13_Pointer))));
	}
}
...
int property() {
	return (((((*(var_1_2_Pointer)) || ((~ (*(var_1_10_Pointer))) >= (*(var_1_10_Pointer)))) ? (((*(var_1_10_Pointer)) < (*(var_1_8_Pointer))) ? ((! (*(var_1_6_Pointer))) ? ((*(var_1_1_Pointer)) == ((signed char) (*(var_1_7_Pointer)))) : 1) : ((*(var_1_1_Pointer)) == ((signed char) 2))) : ((*(var_1_1_Pointer)) == ((signed char) (*(var_1_7_Pointer))))) && ((*(var_1_2_Pointer)) ? ((*(var_1_8_Pointer)) == ((unsigned long int) ((1514707036u + (abs ((*(var_1_9_Pointer))))) - last_1_var_1_10))) : ((*(var_1_8_Pointer)) == ((unsigned long int) (max (last_1_var_1_10 , (*(var_1_9_Pointer)))))))) && ((*(var_1_2_Pointer)) ? ((*(var_1_10_Pointer)) == ((signed long int) ((*(var_1_8_Pointer)) + (abs ((*(var_1_7_Pointer))))))) : 1)) && (((*(var_1_1_Pointer)) >= (*(var_1_1_Pointer))) ? ((*(var_1_11_Pointer)) == ((double) ((*(var_1_12_Pointer)) - (max (((*(var_1_13_Pointer)) + (*(var_1_14_Pointer))) , (*(var_1_15_Pointer))))))) : ((*(var_1_11_Pointer)) == ((double) (max ((*(var_1_14_Pointer)) , (*(var_1_13_Pointer)))))))
;
}
int main(void) {
	isInitial = 1;
