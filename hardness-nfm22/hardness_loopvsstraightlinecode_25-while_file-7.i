...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch725_while.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_0 < 0) {
  ...
  var_1_6 = ((((((var_1_5) > (var_1_1)) ? (var_1_5) : (var_1_1))) + ((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))) + var_1_1);
 }
 if (var_1_1 <= var_1_6) {
  if (var_1_2 >= var_1_3) {
   var_1_9 = var_1_10;
