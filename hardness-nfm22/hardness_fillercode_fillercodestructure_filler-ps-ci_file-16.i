...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch16Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_26 = 0.1;
 var_1_27 = var_1_17;
 if ((((((((var_1_22) > (3.1)) ? (var_1_22) : (3.1))) < 0 ) ? -((((var_1_22) > (3.1)) ? (var_1_22) : (3.1))) : ((((var_1_22) > (3.1)) ? (var_1_22) : (3.1))))) < ((((255.5) < 0 ) ? -(255.5) : (255.5)))) {
  var_1_29 = (var_1_30 && ((var_1_31 && var_1_32) && var_1_33));
 } else {
  var_1_29 = var_1_34;
 }
 if (((var_1_15 / var_1_36) ^ var_1_6) > var_1_23) {
  if (var_1_34) {
   var_1_35 = (var_1_37 - ((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36))));
  } else {
   var_1_35 = var_1_36;
  }
 }
 if (((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6))) < var_1_5) {
  if (((var_1_13 + var_1_21) / 1.000000000002E11) > var_1_13) {
   var_1_38 = (((((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15))) < 0 ) ? -((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15))) : ((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15)))));
  }
 }
 var_1_42 = ((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16)));
 if (var_1_17 == ((var_1_36 / var_1_46) % var_1_47)) {
  var_1_44 = ((((-10) < 0 ) ? -(-10) : (-10)));
 } else {
  if ((var_1_48 - var_1_8) <= ((var_1_10 - var_1_5) - (var_1_10 - var_1_16))) {
   var_1_44 = var_1_17;
  } else {
   var_1_44 = var_1_15;
  }
