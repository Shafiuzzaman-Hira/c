...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch42PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject5
	if ((var_1_24 & 100) <= (var_1_23 >> (max (var_1_29 , 5)))) {
		var_1_28 = var_1_26;
	}


	// From: Req5Batch42PS_CN_10
	...
	// From: Req7Batch42PS_CN_10
	if (var_1_14 <= var_1_15) {
		var_1_19 = (var_1_12 || var_1_20);
	}


	// From: Req2Batch42PS_CN_10
	if (var_1_5 >= -2) {
		var_1_6 = (var_1_7 - 100);
	}


	// From: Req4Batch42PS_CN_10
