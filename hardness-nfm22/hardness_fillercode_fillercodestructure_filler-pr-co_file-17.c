...
void step(void) {
	...
	// From: Req1Batch17Filler_PR_CO
	var_1_1 = (50 + (min (var_1_2 , (min (var_1_3 , var_1_4)))));


	// From: CodeObject2
	if (128u <= var_1_1) {
		if ((var_1_11 >= var_1_21) && ((var_1_1 * var_1_14) < (min (var_1_1 , var_1_1)))) {
			if (var_1_14 > var_1_1) {
				var_1_23 = (abs (4));
			} else {
				if (var_1_8) {
	...
	if (var_1_31 > var_1_1) {
		...
		if ((var_1_36 - (max (var_1_1 , var_1_1))) < (abs (var_1_14))) {
