...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch68dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req5Batch68dependencies
	if (last_1_var_1_14) {
		if (var_1_10 >= (- last_1_var_1_9)) {
			if (var_1_8 != last_1_var_1_16) {
				var_1_12 = var_1_13;
			} else {
				var_1_12 = 50;
			}
	...
	// From: Req8Batch68dependencies
	var_1_16 = last_1_var_1_12;


	// From: Req6Batch68dependencies
	if ((var_1_13 % (5u + 256u)) <= var_1_16) {
		if ((var_1_13 + 16) >= var_1_16) {
			var_1_14 = var_1_7;
		} else {
			var_1_14 = var_1_7;
		}
	...
	// From: Req1Batch68dependencies
	if (var_1_12 <= (var_1_12 ^ var_1_12)) {
		var_1_1 = (! var_1_5);
	} else {
		var_1_1 = (! var_1_5);
	}
	...
	// From: Req2Batch68dependencies
	if (-256 >= var_1_16) {
		var_1_6 = (var_1_1 || var_1_7);
	} else {
		if ((var_1_12 < (var_1_16 / var_1_8)) || ((var_1_5 && var_1_7) && var_1_1)) {
			var_1_6 = var_1_7;
		}
	}


	// From: Req4Batch68dependencies
	if ((var_1_7 && var_1_14) || (! var_1_5)) {
		var_1_11 = var_1_10;
	}


	// From: Req7Batch68dependencies
	var_1_15 = var_1_10;


	// From: Req3Batch68dependencies
