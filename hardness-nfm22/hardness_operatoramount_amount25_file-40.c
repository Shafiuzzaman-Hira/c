...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch40Amount25.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch40Amount25
	if ((var_1_10 - var_1_11) >= last_1_var_1_9) {
		var_1_9 = (var_1_11 + 2u);
	}


	// From: Req3Batch40Amount25
	if (var_1_2) {
	...
	// From: Req4Batch40Amount25
	var_1_17 = -4;


	// From: Req1Batch40Amount25
	if (var_1_2) {
