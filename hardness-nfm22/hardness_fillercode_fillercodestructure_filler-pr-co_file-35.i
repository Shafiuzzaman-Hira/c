...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch35Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (32u >= (((((var_1_13) > (var_1_6)) ? (var_1_13) : (var_1_6))) % 16u)) {
  if ((-5 > var_1_31) && (var_1_6 <= ((((var_1_34) > (var_1_12)) ? (var_1_34) : (var_1_12))))) {
   var_1_39 = var_1_27;
  } else {
