...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch92normal.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (((min (var_1_10 , var_1_3)) + (var_1_9 % var_1_14)) >= (min (var_1_12 , var_1_8))) {
		var_1_13 = var_1_15;
	} else {
		var_1_13 = var_1_15;
	}
	...
	if (var_1_6 && (var_1_9 < (var_1_10 + var_1_12))) {
		if (var_1_7 && var_1_6) {
			var_1_16 = var_1_10;
		}
	} else {
