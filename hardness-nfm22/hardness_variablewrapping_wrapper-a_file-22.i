...
void step(void) {
 ...
 if (BOOL_unsigned_char_Array_0[0]) {
  ...
  if (stepLocal_0 <= last_1_signed_short_int_Array_0_0_) {
   unsigned_short_int_Array_0[1] = ((((last_1_unsigned_long_int_Array_0_1_) > ((unsigned_short_int_Array_0[0] - 8))) ? (last_1_unsigned_long_int_Array_0_1_) : ((unsigned_short_int_Array_0[0] - 8))));
  }
 }
