...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch33Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch33Filler_PE_CI
	var_1_5 = (max (var_1_1 , var_1_14));


	// From: Req7Batch33Filler_PE_CI
	...
	// From: CodeObject1
	if ((- (max (var_1_15 , var_1_16))) == var_1_19) {
		var_1_22 = var_1_17;
	}
	...
	if (var_1_17 > var_1_21) {
		var_1_29 = (max (-2 , var_1_18));
	}


	// From: CodeObject4
	if (0 <= (var_1_19 - (min (var_1_19 , var_1_16)))) {
	...
	if (var_1_1 <= (var_1_5 / (var_1_33 - var_1_34))) {
		if (-64 >= (abs (abs (var_1_7)))) {
			if (-8 > var_1_14) {
				if (var_1_9 >= var_1_28) {
					var_1_32 = (min ((var_1_18 + var_1_16) , 1));
				}
			} else {
				var_1_32 = (abs (abs (var_1_18)));
			}
		} else {
	...
	// From: CodeObject6
	if (var_1_33 < var_1_1) {
		var_1_38 = (abs (var_1_18));
	} else {
		if (var_1_34 <= var_1_17) {
			var_1_38 = (min (var_1_37 , (max (var_1_16 , var_1_1))));
		}
	}
