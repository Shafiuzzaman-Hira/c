...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch58dependencies.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_16 <= ((((var_1_13) > (var_1_3)) ? (var_1_13) : (var_1_3)))) {
 ...
 if (last_1_var_1_11 >= (((((var_1_15) < (var_1_10)) ? (var_1_15) : (var_1_10))) + var_1_5)) {
