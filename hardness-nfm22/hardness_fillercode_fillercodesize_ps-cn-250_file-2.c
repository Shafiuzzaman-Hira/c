...
void step(void) {
	...
	// From: CodeObject18
	if (var_1_61 >= 16) {
		var_1_67 = (min (var_1_46 , (abs (var_1_54))));
	} else {
		if ((var_1_51 * var_1_58) >= var_1_56) {
			var_1_67 = (((abs (var_1_44)) + 50) - (min ((abs (var_1_39)) , var_1_38)));
		}
	}
	...
	if (var_1_31 <= var_1_45) {
		if (50 >= var_1_32) {
			var_1_68 = (abs ((max (5 , 32)) + var_1_67));
		}
	}


	// From: CodeObject20
	var_1_69 = (min (var_1_39 , var_1_24));


	// From: CodeObject21
	if (var_1_71) {
		var_1_70 = (abs (var_1_46));
	} else {
		if ((~ var_1_37) > (var_1_63 % (abs (var_1_48)))) {
			if (var_1_54 < var_1_24) {
				var_1_70 = (max (var_1_45 , var_1_46));
			}
		}
	}
	...
	if (! ((var_1_51 * var_1_22) <= var_1_58)) {
		var_1_72 = (min ((min ((abs (var_1_37)) , var_1_61)) , var_1_65));
	} else {
	...
	// From: CodeObject23
	if (var_1_33) {
		var_1_73 = ((abs (var_1_49)) + var_1_23);
	}


	// From: CodeObject24
	if (var_1_65 >= (var_1_75 & var_1_41)) {
		var_1_74 = (var_1_76 - (var_1_48 - (abs (var_1_44))));
	} else {
		var_1_74 = (min ((32u + var_1_44) , (abs (abs (var_1_24)))));
	}
	...
	if ((~ var_1_45) < (var_1_68 | var_1_39)) {
		if (var_1_61 >= var_1_39) {
			if (var_1_32 == var_1_47) {
				var_1_77 = (min (var_1_26 , (abs (var_1_25))));
			} else {
				if (((var_1_70 & var_1_52) >> var_1_72) > (-16 % var_1_59)) {
					var_1_77 = (max (var_1_26 , var_1_25));
				} else {
					var_1_77 = var_1_25;
				}
			}
	...
	// From: Req4Batch2PS_CN_250
	if ((var_1_15 - (min (0 , var_1_16))) > last_1_var_1_6) {
		var_1_14 = var_1_12;
	}


	// From: Req3Batch2PS_CN_250
	...
	// From: Req7Batch2PS_CN_250
	var_1_20 = var_1_16;


	// From: Req8Batch2PS_CN_250
	var_1_21 = var_1_16;


	// From: Req5Batch2PS_CN_250
