...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch4225_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch4225_1loop
	if (last_1_var_1_1 >= -1000) {
		var_1_6 = (var_1_7 - 100);
	}


	// From: Req4Batch4225_1loop
	var_1_16 = var_1_6;


	// From: Req5Batch4225_1loop
	var_1_17 = var_1_7;


	// From: Req3Batch4225_1loop
