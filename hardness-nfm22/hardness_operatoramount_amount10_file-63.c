...
void step(void) {
	// From: Req2Batch63Amount10
	var_1_8 = var_1_4;


	// From: Req1Batch63Amount10
	signed long int stepLocal_0 = (max (var_1_2 , var_1_3)) - var_1_4;
	if (stepLocal_0 >= var_1_8) {
		var_1_1 = ((abs (var_1_6 - var_1_7)) - 0.8);
	} else {
		var_1_1 = var_1_7;
	}
}
...
int property() {
	return ((((max (var_1_2 , var_1_3)) - var_1_4) >= var_1_8) ? (var_1_1 == ((double) ((abs (var_1_6 - var_1_7)) - 0.8))) : (var_1_1 == ((double) var_1_7))) && (var_1_8 == ((unsigned long int) var_1_4))
;
}
int main(void) {
	isInitial = 1;
