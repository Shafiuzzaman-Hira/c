...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch33PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject4
	if ((- var_1_27) > (max (var_1_28 , var_1_32))) {
		var_1_31 = var_1_30;
	}


	// From: CodeObject5
	if (var_1_22 <= (min ((100 | var_1_23) , var_1_24))) {
		var_1_33 = (var_1_26 + (min (2u , var_1_22)));
	}
	...
	// From: Req2Batch33PS_CN_25
	var_1_5 = (max (var_1_1 , var_1_14));


	// From: Req7Batch33PS_CN_25
