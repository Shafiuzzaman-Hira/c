...
void step(void) {
	...
	// From: CodeObject3
	if (var_1_19) {
		var_1_32 = ((var_1_34 + (min (var_1_35 , var_1_36))) - ((var_1_10 + var_1_10) + (min (1000000000u , var_1_10))));
	}


	// From: Req6Batch80Filler_PR_CI
	...
	// From: CodeObject5
	if ((min ((var_1_30 * var_1_17) , var_1_29)) >= (- var_1_16)) {
		if (var_1_35 > var_1_34) {
			var_1_40 = (8 + (min (var_1_10 , var_1_12)));
		} else {
			var_1_40 = var_1_10;
		}
	}
	...
	if ((var_1_35 | var_1_10) > var_1_18) {
		if (var_1_29 <= (abs (var_1_5))) {
			var_1_38 = (min (var_1_9 , ((abs (var_1_23)) - var_1_36)));
		} else {
