...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch74Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_31 = var_1_27;
 if (var_1_30 <= ((((var_1_27) < ((var_1_25 | -5))) ? (var_1_27) : ((var_1_25 | -5))))) {
  if (var_1_33) {
   var_1_32 = var_1_27;
  }
 }
 if (((((var_1_31) < (var_1_27)) ? (var_1_31) : (var_1_27))) <= var_1_30) {
  if (var_1_33) {
   if (var_1_35 || var_1_36) {
    if (((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30))) > var_1_27) {
     var_1_34 = var_1_31;
    }
   }
  }
 } else {
  if (((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))) > var_1_30) {
   if (var_1_37 > 49.75f) {
    var_1_34 = (((((((((((var_1_32) < (var_1_25)) ? (var_1_32) : (var_1_25)))) < (-25)) ? (((((var_1_32) < (var_1_25)) ? (var_1_32) : (var_1_25)))) : (-25))) < 0 ) ? -((((((((var_1_32) < (var_1_25)) ? (var_1_32) : (var_1_25)))) < (-25)) ? (((((var_1_32) < (var_1_25)) ? (var_1_32) : (var_1_25)))) : (-25))) : ((((((((var_1_32) < (var_1_25)) ? (var_1_32) : (var_1_25)))) < (-25)) ? (((((var_1_32) < (var_1_25)) ? (var_1_32) : (var_1_25)))) : (-25)))));
   }
  } else {
   var_1_34 = var_1_31;
  }
