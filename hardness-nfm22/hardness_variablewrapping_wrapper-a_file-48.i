...
void step(void) {
 ...
 if (BOOL_unsigned_char_Array_0[0]) {
  if (last_1_unsigned_char_Array_0_0__1_ != last_1_unsigned_char_Array_0_0__1_) {
   ...
   unsigned_char_Array_0[0][1] = (unsigned_char_Array_0[1][1] - (((((unsigned_char_Array_0[0][2]) > (unsigned_char_Array_0[1][2])) ? (unsigned_char_Array_0[0][2]) : (unsigned_char_Array_0[1][2]))) - unsigned_char_Array_0[0][0]));
  }
 }
}
