...
void step(void) {
	...
	if (stepLocal_2 > unsigned_short_int_Array_0[1][0]) {
		if (double_Array_0[3] < (double_Array_0[1] - double_Array_0[0])) {
			signed_long_int_Array_0[0] = (abs (unsigned_short_int_Array_0[1][1]));
		} else {
	...
	// From: Req1Batch81Wrapper_A
	if (BOOL_unsigned_char_Array_0[1]) {
		double_Array_0[4] = (max (double_Array_0[3] , (double_Array_0[2] - (double_Array_0[1] - double_Array_0[0]))));
	}
}
...
int property() {
	return (((BOOL_unsigned_char_Array_0[1] ? (double_Array_0[4] == ((double) (max (double_Array_0[3] , (double_Array_0[2] - (double_Array_0[1] - double_Array_0[0])))))) : 1) && (((min (-25 , last_1_signed_long_int_Array_0_0_)) != (last_1_signed_long_int_Array_0_0_ ^ last_1_unsigned_short_int_Array_0_0__0_)) ? (BOOL_unsigned_char_Array_0[1] ? (signed_char_Array_0[1] == ((signed char) (signed_char_Array_0[2] + signed_char_Array_0[0]))) : 1) : (signed_char_Array_0[1] == ((signed char) (min (signed_char_Array_0[0] , signed_char_Array_0[2])))))) && (((signed_char_Array_0[2] >= signed_char_Array_0[1]) && BOOL_unsigned_char_Array_0[0]) ? (unsigned_short_int_Array_0[0][0] == ((unsigned short int) (min (unsigned_short_int_Array_0[1][1] , 100)))) : (unsigned_short_int_Array_0[0][0] == ((unsigned short int) ((unsigned_short_int_Array_0[1][0] - 5) + unsigned_short_int_Array_0[0][1]))))) && ((signed_char_Array_0[1] > unsigned_short_int_Array_0[1][0]) ? ((double_Array_0[3] < (double_Array_0[1] - double_Array_0[0])) ? (signed_long_int_Array_0[0] == ((signed long int) (abs (unsigned_short_int_Array_0[1][1])))) : (signed_long_int_Array_0[0] == ((signed long int) unsigned_short_int_Array_0[0][0]))) : (signed_long_int_Array_0[0] == ((signed long int) unsigned_short_int_Array_0[1][1])))
;
}
int main(void) {
	isInitial = 1;
