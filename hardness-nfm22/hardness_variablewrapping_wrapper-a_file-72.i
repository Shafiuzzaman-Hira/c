...
void step(void) {
 ...
 signed_char_Array_0[3] = (((((signed_char_Array_0[0] + signed_char_Array_0[1])) < ((10 - signed_char_Array_0[4]))) ? ((signed_char_Array_0[0] + signed_char_Array_0[1])) : ((10 - signed_char_Array_0[4]))));
 ...
 if ((double_Array_0[0] + (double_Array_0[0] / float_Array_0[0])) == double_Array_0[0]) {
  if (double_Array_0[0] >= last_1_double_Array_0_2_) {
   double_Array_0[2] = (double_Array_0[1] - (((((double_Array_0[3] + double_Array_0[4])) < (9.9999999999995E12)) ? ((double_Array_0[3] + double_Array_0[4])) : (9.9999999999995E12))));
  } else {
   double_Array_0[2] = ((((double_Array_0[1]) < ((5.75 + double_Array_0[4]))) ? (double_Array_0[1]) : ((5.75 + double_Array_0[4]))));
  }
 }
 if (double_Array_0[0] < (((((double_Array_0[2]) < (double_Array_0[2])) ? (double_Array_0[2]) : (double_Array_0[2]))) * double_Array_0[2])) {
