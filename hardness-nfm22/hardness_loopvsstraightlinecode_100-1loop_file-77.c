...
void step(void) {
	...
	// From: Req6Batch77100_1loop
	if (var_1_16 <= ((var_1_31 / -128) + var_1_1)) {
		var_1_21 = var_1_23;
	}


	// From: Req2Batch77100_1loop
	...
	// From: Req4Batch77100_1loop
	if (var_1_9 > var_1_13) {
		var_1_18 = (var_1_24 + var_1_31);
	}


	// From: Req8Batch77100_1loop
