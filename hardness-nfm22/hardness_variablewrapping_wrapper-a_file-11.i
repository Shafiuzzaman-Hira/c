...
void step(void) {
 if (double_Array_0[0] >= double_Array_0[1]) {
  if (last_1_BOOL_unsigned_char_Array_0_2_) {
   if (! last_1_BOOL_unsigned_char_Array_0_2_) {
    float_Array_0[1] = ((((float_Array_0[0]) > ((10.25f + float_Array_0[2]))) ? (float_Array_0[0]) : ((10.25f + float_Array_0[2]))));
   } else {
 ...
 if (! BOOL_unsigned_char_Array_0[2]) {
  unsigned_char_Array_0[0][1] = ((((((((unsigned_char_Array_0[1][1]) < (((((unsigned_char_Array_0[0][0]) > (5)) ? (unsigned_char_Array_0[0][0]) : (5))))) ? (unsigned_char_Array_0[1][1]) : (((((unsigned_char_Array_0[0][0]) > (5)) ? (unsigned_char_Array_0[0][0]) : (5))))))) < (unsigned_char_Array_0[1][0])) ? (((((unsigned_char_Array_0[1][1]) < (((((unsigned_char_Array_0[0][0]) > (5)) ? (unsigned_char_Array_0[0][0]) : (5))))) ? (unsigned_char_Array_0[1][1]) : (((((unsigned_char_Array_0[0][0]) > (5)) ? (unsigned_char_Array_0[0][0]) : (5))))))) : (unsigned_char_Array_0[1][0])));
 } else {
