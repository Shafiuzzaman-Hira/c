...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch93100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (stepLocal_6 < (last_1_var_1_35 | 100000000)) {
		if (stepLocal_5 > last_1_var_1_35) {
			if (var_1_19 < stepLocal_4) {
				...
				var_1_35 = (max ((var_1_34 + (max (var_1_28 , 32))) , (abs (last_1_var_1_33))));
			}
		} else {
			var_1_35 = (max (var_1_32 , (max (var_1_31 , var_1_28))));
		}
	} else {
		if (var_1_8 != var_1_10) {
			var_1_35 = (max (last_1_var_1_33 , last_1_var_1_26));
		} else {
			var_1_35 = var_1_28;
		}
	}
	...
	// From: Req6Batch93100_while
	if (var_1_4) {
		var_1_21 = (! var_1_22);
	}


	// From: Req7Batch93100_while
	if (! var_1_21) {
		var_1_23 = var_1_8;
	}


	// From: Req9Batch93100_while
	...
	// From: Req10Batch93100_while
	if (var_1_22) {
		var_1_33 = ((var_1_28 - var_1_32) + (var_1_31 - var_1_34));
	}


	// From: Req12Batch93100_while
	var_1_37 = var_1_10;


	// From: Req3Batch93100_while
	if ((- var_1_8) != var_1_23) {
		var_1_11 = (500 + var_1_26);
	} else {
		var_1_11 = (min (var_1_26 , (var_1_26 + var_1_26)));
	}


	// From: Req4Batch93100_while
	if (var_1_26 == var_1_11) {
		var_1_15 = (max (var_1_26 , var_1_35));
	} else {
		if (var_1_9 < var_1_37) {
			var_1_15 = var_1_35;
		} else {
	...
	// From: Req1Batch93100_while
	if ((var_1_11 == var_1_15) && var_1_21) {
		var_1_1 = (min (var_1_33 , var_1_33));
	}


	// From: Req5Batch93100_while
	signed short int stepLocal_3 = var_1_11;
	if (var_1_1 != stepLocal_3) {
		var_1_18 = (8 - (max (10 , (var_1_19 - var_1_26))));
	}


	// From: Req8Batch93100_while
...
int property() {
	return (((((((((((((var_1_11 == var_1_15) && var_1_21) ? (var_1_1 == ((signed long int) (min (var_1_33 , var_1_33)))) : 1) && ((var_1_35 == var_1_1) ? ((var_1_11 < var_1_1) ? (var_1_7 == ((double) ((var_1_8 - var_1_9) + var_1_10))) : ((var_1_1 >= 25) ? (var_1_7 == ((double) (max ((var_1_8 - var_1_9) , var_1_10)))) : (var_1_7 == ((double) var_1_10)))) : (var_1_7 == ((double) var_1_10)))) && (((- var_1_8) != var_1_23) ? (var_1_11 == ((signed short int) (500 + var_1_26))) : (var_1_11 == ((signed short int) (min (var_1_26 , (var_1_26 + var_1_26))))))) && ((var_1_26 == var_1_11) ? (var_1_15 == ((unsigned long int) (max (var_1_26 , var_1_35)))) : ((var_1_9 < var_1_37) ? (var_1_15 == ((unsigned long int) var_1_35)) : (var_1_15 == ((unsigned long int) var_1_35))))) && ((var_1_1 != var_1_11) ? (var_1_18 == ((signed short int) (8 - (max (10 , (var_1_19 - var_1_26)))))) : 1)) && (var_1_4 ? (var_1_21 == ((unsigned char) (! var_1_22))) : 1)) && ((! var_1_21) ? (var_1_23 == ((float) var_1_8)) : 1)) && ((var_1_18 != var_1_18) ? (((1u ^ var_1_19) > (- var_1_35)) ? (var_1_24 == ((signed long int) var_1_26)) : (var_1_22 ? (var_1_24 == ((signed long int) last_1_var_1_24)) : 1)) : (var_1_24 == ((signed long int) var_1_26)))) && (((var_1_8 + 199.375) <= 10.5) ? (var_1_26 == ((unsigned char) ((var_1_27 - var_1_28) - (var_1_29 - 1)))) : (var_1_21 ? (var_1_26 == ((unsigned char) ((var_1_29 - var_1_28) + ((var_1_30 + var_1_31) - var_1_32)))) : (var_1_26 == ((unsigned char) var_1_28))))) && (var_1_22 ? (var_1_33 == ((signed char) ((var_1_28 - var_1_32) + (var_1_31 - var_1_34)))) : 1)) && ((last_1_var_1_24 < (last_1_var_1_35 | 100000000)) ? ((var_1_30 > last_1_var_1_35) ? ((var_1_19 < last_1_var_1_24) ? (var_1_35 == ((unsigned short int) ((var_1_29 + var_1_28) + var_1_31))) : (var_1_35 == ((unsigned short int) (max ((var_1_34 + (max (var_1_28 , 32))) , (abs (last_1_var_1_33))))))) : (var_1_35 == ((unsigned short int) (max (var_1_32 , (max (var_1_31 , var_1_28))))))) : ((var_1_8 != var_1_10) ? (var_1_35 == ((unsigned short int) (max (last_1_var_1_33 , last_1_var_1_26)))) : (var_1_35 == ((unsigned short int) var_1_28))))) && (var_1_37 == ((float) var_1_10))
;
}
int main(void) {
	isInitial = 1;
