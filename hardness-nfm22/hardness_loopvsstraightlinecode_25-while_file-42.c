...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch4225_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch4225_while
	if (last_1_var_1_1 >= -1000) {
		var_1_6 = (var_1_7 - 100);
	}


	// From: Req4Batch4225_while
	var_1_16 = var_1_6;


	// From: Req5Batch4225_while
	var_1_17 = var_1_7;


	// From: Req3Batch4225_while
	...
	// From: Req1Batch4225_while
	if (var_1_16 > var_1_6) {
		var_1_1 = ((min (var_1_17 , var_1_17)) - 10);
	} else {
		var_1_1 = var_1_17;
	}
}
...
int property() {
	return (((((var_1_16 > var_1_6) ? (var_1_1 == ((signed long int) ((min (var_1_17 , var_1_17)) - 10))) : (var_1_1 == ((signed long int) var_1_17))) && ((last_1_var_1_1 >= -1000) ? (var_1_6 == ((unsigned char) (var_1_7 - 100))) : 1)) && (((49.5f <= var_1_9) && (var_1_10 && var_1_11)) ? ((var_1_6 < var_1_17) ? (var_1_8 == ((unsigned char) (var_1_11 || var_1_12))) : (var_1_8 == ((unsigned char) (! (var_1_13 || (var_1_14 || var_1_15)))))) : (var_1_8 == ((unsigned char) var_1_12)))) && (var_1_16 == ((signed long int) var_1_6))) && (var_1_17 == ((unsigned char) var_1_7))
;
}
int main(void) {
	isInitial = 1;
