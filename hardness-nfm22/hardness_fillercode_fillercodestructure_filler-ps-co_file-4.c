...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch4Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject6
	if (var_1_17 != (abs (var_1_35))) {
		var_1_36 = (min ((var_1_17 - var_1_14) , (min ((var_1_24 + var_1_17) , var_1_9))));
	}
	...
	if ((var_1_17 * (var_1_38 - var_1_6)) <= var_1_17) {
		...
		if (var_1_6 <= (var_1_38 * 64)) {
			var_1_37 = (max (var_1_6 , (abs (var_1_35))));
		}
	}
