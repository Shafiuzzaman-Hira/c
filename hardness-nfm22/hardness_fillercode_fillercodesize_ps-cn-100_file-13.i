...
void step(void) {
 ...
 if ((var_1_26 >= var_1_25) && (var_1_28 >= var_1_29)) {
  if (var_1_30) {
   ...
   var_1_27 = (((((128) < 0 ) ? -(128) : (128))) - ((((var_1_34) > ((var_1_35 - var_1_36))) ? (var_1_34) : ((var_1_35 - var_1_36)))));
  }
 }
 if (((((var_1_29) < 0 ) ? -(var_1_29) : (var_1_29))) == var_1_35) {
  if (var_1_32 <= (((((var_1_31) < (var_1_36)) ? (var_1_31) : (var_1_36))) + var_1_28)) {
  ...
  if (var_1_38) {
   if (((((var_1_34) > (((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))))) ? (var_1_34) : (((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32)))))) > var_1_29) {
 ...
 if ((var_1_26 / var_1_43) > var_1_25) {
  if (var_1_38) {
   var_1_42 = ((((var_1_32) < (var_1_31)) ? (var_1_32) : (var_1_31)));
  }
 } else {
  if (var_1_30) {
   if (var_1_28 < var_1_34) {
    if ((- var_1_26) >= var_1_43) {
     var_1_42 = ((((var_1_31) > (var_1_44)) ? (var_1_31) : (var_1_44)));
    } else {
     var_1_42 = var_1_45;
    }
   }
 ...
 if (var_1_38) {
  if (128.625f > (- (63.1f * var_1_26))) {
   var_1_46 = ((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26)));
  }
 } else {
  var_1_46 = var_1_26;
 }
 if (var_1_38) {
  if (var_1_44 <= (3913602695u - var_1_33)) {
   var_1_47 = ((((var_1_36) < (-10)) ? (var_1_36) : (-10)));
  }
 } else {
  if ((~ var_1_35) < (var_1_34 >> var_1_42)) {
   var_1_47 = ((((((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36)))) > (((((var_1_48) < (var_1_49)) ? (var_1_48) : (var_1_49))))) ? (((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36)))) : (((((var_1_48) < (var_1_49)) ? (var_1_48) : (var_1_49))))));
  }
 }
 var_1_50 = var_1_32;
 if ((var_1_50 ^ (var_1_52 - var_1_36)) <= var_1_34) {
  if (var_1_48 <= var_1_36) {
   var_1_51 = ((((((((((5) < 0 ) ? -(5) : (5))) < 0 ) ? -((((5) < 0 ) ? -(5) : (5))) : ((((5) < 0 ) ? -(5) : (5))))) < 0 ) ? -(((((((5) < 0 ) ? -(5) : (5))) < 0 ) ? -((((5) < 0 ) ? -(5) : (5))) : ((((5) < 0 ) ? -(5) : (5))))) : (((((((5) < 0 ) ? -(5) : (5))) < 0 ) ? -((((5) < 0 ) ? -(5) : (5))) : ((((5) < 0 ) ? -(5) : (5)))))));
  }
 }
 ...
 if (var_1_26 >= (var_1_25 / var_1_43)) {
  var_1_54 = (((((((var_1_34) > (var_1_33)) ? (var_1_34) : (var_1_33))) < 0 ) ? -((((var_1_34) > (var_1_33)) ? (var_1_34) : (var_1_33))) : ((((var_1_34) > (var_1_33)) ? (var_1_34) : (var_1_33)))));
 } else {
  if (! var_1_30) {
   var_1_54 = var_1_32;
  }
