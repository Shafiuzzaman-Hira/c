...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch45Amount100.c", 13, "reach_error"); }
...
void step(void) {
 if (! (((((last_1_var_1_6) > (last_1_var_1_36)) ? (last_1_var_1_6) : (last_1_var_1_36))) > (var_1_29 >> var_1_5))) {
  if (last_1_var_1_16 <= var_1_19) {
   var_1_34 = ((((((var_1_28 - var_1_5)) > (var_1_8)) ? ((var_1_28 - var_1_5)) : (var_1_8))) + last_1_var_1_32);
  }
 } else {
  var_1_34 = var_1_29;
 }
 signed long int stepLocal_6 = (((last_1_var_1_34) < ((last_1_var_1_6 % var_1_8))) ? (last_1_var_1_34) : ((last_1_var_1_6 % var_1_8)));
 if (stepLocal_6 >= last_1_var_1_1) {
  var_1_20 = (var_1_5 + ((((16) < (1)) ? (16) : (1))));
 }
 unsigned long int stepLocal_3 = (((var_1_5) > (last_1_var_1_1)) ? (var_1_5) : (last_1_var_1_1));
 signed long int stepLocal_2 = var_1_5;
 if (stepLocal_2 >= ((((last_1_var_1_20) > (last_1_var_1_1)) ? (last_1_var_1_20) : (last_1_var_1_1)))) {
 ...
 if (var_1_14) {
  ...
  if (var_1_15) {
   var_1_26 = (((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))) - ((((var_1_5) > (var_1_29)) ? (var_1_5) : (var_1_29))));
  }
 }
 ...
 if (stepLocal_7 < (var_1_20 + var_1_6)) {
  ...
  var_1_32 = (((((var_1_6) < (var_1_8)) ? (var_1_6) : (var_1_8))) - 16);
 }
 ...
 if (var_1_20 < stepLocal_4) {
  if (! (var_1_7 >= var_1_5)) {
   if (var_1_20 < stepLocal_5) {
    ...
    var_1_16 = (var_1_17 - ((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10))));
   }
  } else {
   var_1_16 = ((((var_1_18 + var_1_19) < 0 ) ? -(var_1_18 + var_1_19) : (var_1_18 + var_1_19)));
  }
 } else {
  var_1_16 = ((((var_1_18) > (((((var_1_17) < (var_1_10)) ? (var_1_17) : (var_1_10))))) ? (var_1_18) : (((((var_1_17) < (var_1_10)) ? (var_1_17) : (var_1_10))))));
 }
}
