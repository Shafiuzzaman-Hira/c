...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch12no_floats.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch12no_floats
	signed long int stepLocal_2 = var_1_2;
	if (var_1_3 != stepLocal_2) {
		var_1_6 = (abs (var_1_7 - (max (var_1_8 , var_1_9))));
	}


	// From: Req3Batch12no_floats
...
int property() {
	return (((! (-50 < var_1_6)) ? ((var_1_6 != var_1_6) ? ((var_1_6 <= var_1_6) ? (var_1_1 == ((unsigned char) var_1_4)) : 1) : (var_1_1 == ((unsigned char) var_1_5))) : 1) && ((var_1_3 != var_1_2) ? (var_1_6 == ((unsigned char) (abs (var_1_7 - (max (var_1_8 , var_1_9)))))) : 1)) && (((var_1_8 * (var_1_6 + var_1_6)) <= var_1_9) ? (((128 + var_1_9) < (var_1_6 * (var_1_6 + var_1_6))) ? (var_1_10 == ((unsigned char) (var_1_4 || (! (var_1_5 && var_1_12))))) : (var_1_10 == ((unsigned char) var_1_5))) : (var_1_10 == ((unsigned char) var_1_12)))
;
}
int main(void) {
	isInitial = 1;
