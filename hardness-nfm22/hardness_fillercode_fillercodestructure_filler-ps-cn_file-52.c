...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch52Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch52Filler_PS_CN
	var_1_20 = var_1_17;


	// From: Req4Batch52Filler_PS_CN
	var_1_12 = (var_1_13 && var_1_14);


	// From: Req9Batch52Filler_PS_CN
	var_1_21 = var_1_8;


	// From: Req10Batch52Filler_PS_CN
	var_1_22 = -256;


	// From: Req1Batch52Filler_PS_CN
