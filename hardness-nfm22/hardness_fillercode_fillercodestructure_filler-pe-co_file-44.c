...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch44Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch44Filler_PE_CO
	var_1_31 = var_1_26;


	// From: Req9Batch44Filler_PE_CO
	var_1_32 = var_1_21;


	// From: Req7Batch44Filler_PE_CO
	var_1_30 = (max (var_1_15 , var_1_32));


	// From: Req1Batch44Filler_PE_CO
