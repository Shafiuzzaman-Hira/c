...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch11Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject3
	if (var_1_4 <= (min (var_1_10 , (var_1_4 >> var_1_15)))) {
