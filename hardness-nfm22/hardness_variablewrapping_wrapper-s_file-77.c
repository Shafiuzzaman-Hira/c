...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch77Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch77Wrapper_S
	if (WrapperStruct00.var_1_7 > WrapperStruct00.var_1_5) {
		WrapperStruct00.var_1_8 = (abs (WrapperStruct00.var_1_9));
	} else {
		WrapperStruct00.var_1_8 = ((max (WrapperStruct00.var_1_10 , WrapperStruct00.var_1_11)) - (WrapperStruct00.var_1_12 - 3.4f));
	}


	// From: Req3Batch77Wrapper_S
	unsigned short int stepLocal_0 = WrapperStruct00.var_1_6;
	if (stepLocal_0 <= WrapperStruct00.var_1_5) {
		if ((max (WrapperStruct00.var_1_8 , (WrapperStruct00.var_1_12 / WrapperStruct00.var_1_15))) > (min (WrapperStruct00.var_1_10 , WrapperStruct00.var_1_8))) {
	...
	// From: Req4Batch77Wrapper_S
	if (WrapperStruct00.var_1_6 > (WrapperStruct00.var_1_13 * (max (WrapperStruct00.var_1_5 , WrapperStruct00.var_1_7)))) {
		if (WrapperStruct00.var_1_17 || WrapperStruct00.var_1_18) {
	...
	// From: Req1Batch77Wrapper_S
	if (WrapperStruct00.var_1_8 != WrapperStruct00.var_1_8) {
		WrapperStruct00.var_1_1 = (WrapperStruct00.var_1_4 - (min (WrapperStruct00.var_1_5 , (WrapperStruct00.var_1_6 - WrapperStruct00.var_1_7))));
	}
}
...
int property() {
	return ((((WrapperStruct00.var_1_8 != WrapperStruct00.var_1_8) ? (WrapperStruct00.var_1_1 == ((unsigned short int) (WrapperStruct00.var_1_4 - (min (WrapperStruct00.var_1_5 , (WrapperStruct00.var_1_6 - WrapperStruct00.var_1_7)))))) : 1) && ((WrapperStruct00.var_1_7 > WrapperStruct00.var_1_5) ? (WrapperStruct00.var_1_8 == ((float) (abs (WrapperStruct00.var_1_9)))) : (WrapperStruct00.var_1_8 == ((float) ((max (WrapperStruct00.var_1_10 , WrapperStruct00.var_1_11)) - (WrapperStruct00.var_1_12 - 3.4f)))))) && ((WrapperStruct00.var_1_6 <= WrapperStruct00.var_1_5) ? (((max (WrapperStruct00.var_1_8 , (WrapperStruct00.var_1_12 / WrapperStruct00.var_1_15))) > (min (WrapperStruct00.var_1_10 , WrapperStruct00.var_1_8))) ? (WrapperStruct00.var_1_13 == ((signed short int) WrapperStruct00.var_1_7)) : 1) : (WrapperStruct00.var_1_13 == ((signed short int) WrapperStruct00.var_1_7)))) && ((WrapperStruct00.var_1_6 > (WrapperStruct00.var_1_13 * (max (WrapperStruct00.var_1_5 , WrapperStruct00.var_1_7)))) ? ((WrapperStruct00.var_1_17 || WrapperStruct00.var_1_18) ? (WrapperStruct00.var_1_16 == ((unsigned short int) WrapperStruct00.var_1_4)) : (WrapperStruct00.var_1_16 == ((unsigned short int) WrapperStruct00.var_1_7))) : (WrapperStruct00.var_1_16 == ((unsigned short int) WrapperStruct00.var_1_6)))
;
}
int main(void) {
	isInitial = 1;
