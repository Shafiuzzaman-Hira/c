...
void step(void) {
	...
	signed long int stepLocal_1 = ((*(WrapperStruct00_var_1_11_Pointer)) + (*(WrapperStruct00_var_1_12_Pointer))) - (min ((*(WrapperStruct00_var_1_13_Pointer)) , 1));
