...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch40has_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch40has_floats
	var_1_19 = var_1_15;


	// From: Req6Batch40has_floats
	var_1_20 = var_1_16;


	// From: Req7Batch40has_floats
	var_1_21 = var_1_18;
...
int property() {
	return ((((((var_1_2 ? ((var_1_3 && (var_1_19 <= (- 63.9f))) ? ((var_1_19 >= var_1_19) ? (var_1_3 ? (var_1_1 == ((signed long int) var_1_21)) : 1) : 1) : 1) : 1) && ((((var_1_16 / var_1_8) / var_1_9) >= (var_1_21 | var_1_16)) ? (var_1_7 == ((unsigned char) (var_1_11 - var_1_12))) : (var_1_7 == ((unsigned char) var_1_12)))) && ((var_1_19 != (min (last_1_var_1_13 , var_1_19))) ? (var_1_13 == ((double) (var_1_15 + (127.4 - 8.25)))) : 1)) && (var_1_3 ? (var_1_16 == ((signed char) (max (var_1_17 , (-2 + var_1_18))))) : 1)) && (var_1_19 == ((float) var_1_15))) && (var_1_20 == ((signed short int) var_1_16))) && (var_1_21 == ((signed short int) var_1_18))
;
}
int main(void) {
	isInitial = 1;
