...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch84dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch84dependencies
	if (((var_1_4 + var_1_9) & var_1_7) <= (var_1_10 - (min (var_1_11 , var_1_16)))) {
	...
	// From: Req7Batch84dependencies
	var_1_18 = var_1_17;


	// From: Req8Batch84dependencies
	var_1_19 = 0;


	// From: Req9Batch84dependencies
	var_1_20 = var_1_21;


	// From: Req1Batch84dependencies
	if (var_1_19) {
		var_1_1 = (min ((var_1_3 + (1 - var_1_4)) , var_1_5));
	}


	// From: Req4Batch84dependencies
	if (var_1_3 <= var_1_1) {
		var_1_12 = var_1_4;
	} else {
