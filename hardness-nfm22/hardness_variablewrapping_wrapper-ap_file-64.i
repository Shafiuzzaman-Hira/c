...
void step(void) {
 ...
 if (stepLocal_1 <= ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)) - last_1_unsigned_char_Array_0_0_)) {
  if (stepLocal_0 < (((((last_1_unsigned_char_Array_0_0_ / (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)))) > (last_1_unsigned_char_Array_0_0_)) ? ((last_1_unsigned_char_Array_0_0_ / (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)))) : (last_1_unsigned_char_Array_0_0_)))) {
