...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch44Amount100.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch44Amount100
	var_1_9 = (min (-10 , var_1_10));


	// From: Req4Batch44Amount100
	var_1_11 = ((var_1_8 || var_1_4) && var_1_12);


	// From: Req6Batch44Amount100
	var_1_20 = (45013 - var_1_21);


	// From: Req7Batch44Amount100
	var_1_22 = (max ((max ((max (var_1_15 , var_1_16)) , var_1_19)) , var_1_17));


	// From: Req8Batch44Amount100
	if ((9999999.6 / var_1_18) > var_1_16) {
		var_1_23 = (abs (var_1_21 + var_1_24));
	}


	// From: Req9Batch44Amount100
	var_1_25 = (max (((max (var_1_19 , 999.5)) - var_1_17) , var_1_16));


	// From: Req13Batch44Amount100
	var_1_40 = var_1_28;


	// From: Req14Batch44Amount100
	var_1_41 = 10;


	// From: Req1Batch44Amount100
	if (var_1_9 >= var_1_23) {
		var_1_1 = (! var_1_4);
	}


	// From: Req2Batch44Amount100
