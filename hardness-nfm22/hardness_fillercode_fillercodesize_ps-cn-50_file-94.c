...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch94PS_CN_50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch94PS_CN_50
	var_1_9 = ((min (var_1_10 , var_1_11)) + (var_1_12 + (var_1_13 - var_1_14)));


	// From: Req4Batch94PS_CN_50
	if (var_1_10 >= var_1_11) {
		var_1_15 = (max ((max ((abs (var_1_16)) , var_1_17)) , var_1_18));
	}


	// From: Req7Batch94PS_CN_50
	var_1_25 = -256;


	// From: Req8Batch94PS_CN_50
	var_1_26 = var_1_17;


	// From: Req9Batch94PS_CN_50
	var_1_27 = var_1_6;


	// From: Req2Batch94PS_CN_50
	if (var_1_7 || var_1_1) {
