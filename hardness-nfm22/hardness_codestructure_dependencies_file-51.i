...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch51dependencies.c", 13, "reach_error"); }
...
void step(void) {
 if (last_1_var_1_21 || (((((var_1_4) > (last_1_var_1_17)) ? (var_1_4) : (last_1_var_1_17))) > var_1_18)) {
