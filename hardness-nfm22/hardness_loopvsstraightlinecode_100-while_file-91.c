...
void step(void) {
	...
	// From: Req14Batch91100_while
	var_1_34 = var_1_1;


	// From: Req8Batch91100_while
	if (var_1_10 == var_1_34) {
		var_1_20 = (var_1_6 + var_1_5);
	}


	// From: Req5Batch91100_while
	var_1_14 = (max ((max (var_1_6 , (min (var_1_1 , var_1_4)))) , var_1_1));


	// From: Req13Batch91100_while
