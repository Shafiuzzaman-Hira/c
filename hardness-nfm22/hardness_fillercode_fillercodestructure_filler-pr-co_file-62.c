...
void step(void) {
	...
	if (((var_1_17 >> var_1_19) % -10) >= var_1_13) {
		if ((var_1_37 - (abs (var_1_33))) != var_1_1) {
			var_1_35 = (min (var_1_19 , var_1_19));
		}
	}


	// From: Req6Batch62Filler_PR_CO
	if (var_1_10 || var_1_20) {
		var_1_19 = (max (var_1_21 , 32));
	}


	// From: Req7Batch62Filler_PR_CO
	if (var_1_10) {
	...
	// From: CodeObject9
	if (var_1_37 < (min (var_1_33 , var_1_22))) {
