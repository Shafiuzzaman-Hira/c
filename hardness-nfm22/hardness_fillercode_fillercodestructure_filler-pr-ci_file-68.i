...
void step(void) {
 ...
 var_1_25 = var_1_12;
 if (((((var_1_10) > (var_1_24)) ? (var_1_10) : (var_1_24))) > var_1_23) {
  if (var_1_10 > var_1_23) {
   var_1_27 = (100000000 + (var_1_12 - var_1_16));
  } else {
   if (((((var_1_12) < (var_1_16)) ? (var_1_12) : (var_1_16))) > (var_1_12 - ((((var_1_12) < (10)) ? (var_1_12) : (10))))) {
    if ((((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31))) - var_1_32) < 2) {
     var_1_27 = ((((var_1_32) > (((((var_1_31) > (var_1_16)) ? (var_1_31) : (var_1_16))))) ? (var_1_32) : (((((var_1_31) > (var_1_16)) ? (var_1_31) : (var_1_16))))));
    }
   } else {
    var_1_27 = var_1_31;
   }
