...
void step(void) {
 ...
 if ((var_1_18 * var_1_19) == var_1_21) {
  ...
  if (5 <= ((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19)))) {
   var_1_28 = ((var_1_11 >= var_1_34) || var_1_6);
  }
 }
 if (var_1_6) {
  var_1_37 = (((((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15))) < 0 ) ? -((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15))) : ((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15)))));
 } else {
  if (var_1_13 >= (var_1_13 - var_1_13)) {
   var_1_37 = ((((var_1_15) > (var_1_26)) ? (var_1_15) : (var_1_26)));
  } else {
 ...
 if ((var_1_13 - var_1_14) > var_1_13) {
  if (var_1_15 <= var_1_23) {
   ...
   var_1_45 = ((((var_1_17) > (var_1_17)) ? (var_1_17) : (var_1_17)));
  }
 } else {
  var_1_45 = var_1_17;
 }
