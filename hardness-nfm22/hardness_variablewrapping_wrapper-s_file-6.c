...
void step(void) {
	...
	if (WrapperStruct00.var_1_13 > WrapperStruct00.var_1_6) {
		WrapperStruct00.var_1_18 = ((min (WrapperStruct00.var_1_6 , WrapperStruct00.var_1_13)) - WrapperStruct00.var_1_6);
	}
	...
	// From: Req5Batch6Wrapper_S
	WrapperStruct00.var_1_20 = (min ((abs (last_1_WrapperStruct00_var_1_20)) , (WrapperStruct00.var_1_21 - WrapperStruct00.var_1_7)));
	...
	if (((max (WrapperStruct00.var_1_18 , WrapperStruct00.var_1_18)) / WrapperStruct00.var_1_4) > stepLocal_1) {
