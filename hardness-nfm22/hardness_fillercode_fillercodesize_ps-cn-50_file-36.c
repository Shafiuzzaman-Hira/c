...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch36PS_CN_50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch36PS_CN_50
	if (var_1_3 <= var_1_4) {
		var_1_16 = (min (var_1_6 , var_1_4));
	}


	// From: Req7Batch36PS_CN_50
