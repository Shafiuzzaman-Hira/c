...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch18Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject7
	if (var_1_37 < var_1_24) {
		var_1_38 = (abs (min (5 , var_1_25)));
	}


	// From: CodeObject8
	if (100.75 >= (abs (var_1_32 + var_1_33))) {
		var_1_39 = (min (var_1_37 , var_1_34));
	}
}
