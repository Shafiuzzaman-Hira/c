...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch37Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_17 & (~ var_1_2)) <= var_1_1) {
  if (var_1_14) {
   var_1_36 = ((((var_1_2) > (((((var_1_8) < (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))))) ? (var_1_8) : (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))))))) ? (var_1_2) : (((((var_1_8) < (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))))) ? (var_1_8) : (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))))))));
  }
 } else {
  if (var_1_14) {
   var_1_36 = -128;
 ...
 if (var_1_2 > var_1_12) {
  var_1_27 = ((((var_1_2) > (var_1_18)) ? (var_1_2) : (var_1_18)));
 }
 if (var_1_12 <= 16) {
  var_1_29 = (((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30))) - var_1_31);
 }
 if (var_1_17 >= var_1_3) {
  var_1_32 = ((((4) < (((((var_1_12) < ((var_1_31 - var_1_33))) ? (var_1_12) : ((var_1_31 - var_1_33)))))) ? (4) : (((((var_1_12) < ((var_1_31 - var_1_33))) ? (var_1_12) : ((var_1_31 - var_1_33)))))));
 } else {
  var_1_32 = var_1_12;
 }
 ...
 if (var_1_3 <= (((((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19))) < 0 ) ? -((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19))) : ((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19)))))) {
  var_1_28 = 4;
 }
 if (((var_1_3 & var_1_8) ^ var_1_17) < (var_1_17 & var_1_33)) {
