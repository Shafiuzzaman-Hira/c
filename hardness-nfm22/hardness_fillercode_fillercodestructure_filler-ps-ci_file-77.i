...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch77Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_23 = var_1_22;
 if (var_1_13 >= (var_1_8 & (var_1_22 >> var_1_4))) {
  var_1_24 = (var_1_22 - ((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13))));
 } else {
  if (var_1_13 > (var_1_8 ^ var_1_22)) {
   var_1_24 = ((((var_1_13) < (var_1_8)) ? (var_1_13) : (var_1_8)));
  }
 }
 if (var_1_16 >= (-128 & var_1_11)) {
  if ((((((var_1_3) > (var_1_3)) ? (var_1_3) : (var_1_3))) <= var_1_3) && var_1_18) {
   var_1_25 = var_1_22;
  }
 } else {
  var_1_25 = var_1_22;
