...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch81dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req5Batch81dependencies
	var_1_16 = (last_1_var_1_17 - 1);


	// From: Req2Batch81dependencies
	if (((var_1_6 / var_1_5) != (min (var_1_16 , last_1_var_1_7))) && var_1_8) {
		var_1_7 = var_1_5;
	} else {
	...
	// From: Req1Batch81dependencies
	if (last_1_var_1_1 != (var_1_7 + var_1_16)) {
		var_1_1 = (var_1_5 - (min (0 , var_1_6)));
	}


	// From: Req3Batch81dependencies
	if (! var_1_9) {
		var_1_10 = (min (var_1_1 , var_1_5));
	}


	// From: Req4Batch81dependencies
	if (var_1_8) {
		var_1_11 = ((max (var_1_12 , var_1_13)) - ((var_1_14 + var_1_15) - last_1_var_1_11));
	}


	// From: Req8Batch81dependencies
	var_1_24 = var_1_12;


	// From: Req7Batch81dependencies
