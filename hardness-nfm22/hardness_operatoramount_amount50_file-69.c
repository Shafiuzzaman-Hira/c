...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch69Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch69Amount50
	if (var_1_20 || (var_1_6 <= var_1_8)) {
		var_1_14 = var_1_6;
	}


	// From: Req2Batch69Amount50
