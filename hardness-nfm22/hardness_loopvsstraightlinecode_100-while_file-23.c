...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch23100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req9Batch23100_while
	if (var_1_11 < var_1_10) {
		var_1_35 = (var_1_15 - var_1_36);
	} else {
		if (var_1_38) {
			var_1_35 = (max (var_1_15 , var_1_6));
		} else {
			var_1_35 = var_1_36;
		}
	}
	...
	// From: Req13Batch23100_while
	var_1_40 = var_1_10;


	// From: Req12Batch23100_while
	var_1_39 = var_1_1;


	// From: Req8Batch23100_while
	...
	// From: Req7Batch23100_while
	if ((var_1_14 * var_1_14) <= var_1_5) {
		var_1_31 = (max (var_1_33 , var_1_15));
	} else {
		var_1_31 = var_1_33;
	}


	// From: Req4Batch23100_while
	unsigned long int stepLocal_5 = var_1_36 + var_1_15;
	if (var_1_12 < (var_1_11 / var_1_18)) {
		if ((var_1_7 + (max (var_1_31 , var_1_33))) <= stepLocal_5) {
			var_1_17 = var_1_10;
		} else {
			var_1_17 = var_1_10;
		}
