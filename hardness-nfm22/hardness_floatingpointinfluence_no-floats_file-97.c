...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch97no_floats.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch97no_floats
	var_1_18 = var_1_19;


	// From: Req5Batch97no_floats
	var_1_20 = var_1_21;


	// From: Req6Batch97no_floats
	var_1_22 = var_1_12;


	// From: Req3Batch97no_floats
	if (127.5f > var_1_20) {
...
int property() {
	return (((((var_1_13 ? ((var_1_10 > var_1_22) ? (var_1_13 ? (var_1_1 == ((signed short int) (var_1_7 - (var_1_8 - var_1_9)))) : (var_1_1 == ((signed short int) var_1_18))) : (var_1_1 == ((signed short int) 8))) : 1) && ((var_1_18 == var_1_7) ? (var_1_10 == ((signed char) (var_1_11 + (var_1_12 + -25)))) : ((((32 * -25) | var_1_22) >= var_1_11) ? (var_1_13 ? (var_1_10 == ((signed char) var_1_12)) : 1) : 1))) && ((127.5f > var_1_20) ? (var_1_13 == ((unsigned char) (var_1_15 && var_1_16))) : (var_1_13 == ((unsigned char) ((var_1_20 >= var_1_20) || var_1_15))))) && (var_1_18 == ((unsigned short int) var_1_19))) && (var_1_20 == ((signed long int) var_1_21))) && (var_1_22 == ((signed short int) var_1_12))
;
}
int main(void) {
	isInitial = 1;
