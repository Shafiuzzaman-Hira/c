...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch28Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject2
	if ((var_1_1 < (abs (var_1_6))) || var_1_28) {
		var_1_27 = var_1_6;
	}
	...
	// From: CodeObject7
	if (var_1_31 <= 9.6) {
		var_1_38 = (max ((var_1_34 + var_1_6) , var_1_11));
	} else {
		if (var_1_15 <= var_1_6) {
			if (var_1_11 > (var_1_15 >> var_1_15)) {
				var_1_38 = (abs (var_1_11));
			} else {
				var_1_38 = (min (var_1_34 , (min (var_1_6 , var_1_1))));
			}
		}
	}
