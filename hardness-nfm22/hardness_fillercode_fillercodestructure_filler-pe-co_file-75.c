...
void step(void) {
	// From: Req3Batch75Filler_PE_CO
	if (! (var_1_4 < 16.8f)) {
		var_1_15 = var_1_6;
	}


	// From: Req7Batch75Filler_PE_CO
	var_1_25 = var_1_23;


	// From: Req2Batch75Filler_PE_CO
	...
	// From: CodeObject2
	if ((var_1_25 ^ (var_1_28 + var_1_25)) <= (abs (min (var_1_21 , var_1_21)))) {
		var_1_33 = (abs (min ((min (var_1_36 , var_1_37)) , var_1_38)));
	} else {
		if (var_1_38 >= (max (var_1_37 , (var_1_36 * var_1_1)))) {
			if (var_1_31) {
				var_1_33 = var_1_40;
			}
		}
