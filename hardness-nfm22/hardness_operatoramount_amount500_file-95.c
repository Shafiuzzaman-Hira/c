...
void step(void) {
	...
	if (last_1_var_1_92) {
		...
		var_1_72 = (((max (last_1_var_1_58 , last_1_var_1_51)) < var_1_14) || (! (var_1_73 && var_1_75)));
	}
	...
	signed long int stepLocal_5 = max (var_1_10 , var_1_36);
	if (stepLocal_6 > (abs (last_1_var_1_50))) {
		if (stepLocal_5 >= (max (last_1_var_1_65 , 50))) {
			var_1_42 = ((min ((min (var_1_31 , var_1_30)) , var_1_32)) + var_1_29);
		} else {
			var_1_42 = (var_1_29 + (var_1_31 - var_1_30));
		}
	} else {
		if (last_1_var_1_34 == stepLocal_7) {
			var_1_42 = (min (var_1_30 , (max (var_1_43 , var_1_28))));
		} else {
			var_1_42 = ((var_1_30 + (max (10.375f , var_1_44))) + (var_1_29 - var_1_31));
		}
	}
	...
	if ((4.5 / 9999.5) > (max (var_1_33 , var_1_86))) {
		var_1_21 = 4.6f;
	} else {
		if (var_1_87) {
			var_1_21 = var_1_22;
	...
	if ((max (var_1_28 , (var_1_32 + 63.125))) <= (var_1_22 / var_1_39)) {
		if (var_1_15) {
			var_1_38 = var_1_90;
		}
	} else {
	...
	var_1_20 = (var_1_13 - ((var_1_11 + 50) + (max (var_1_85 , var_1_19))));
	...
	if (var_1_87) {
		...
		if (var_1_31 == (max (var_1_22 , (var_1_86 + var_1_86)))) {
	...
	if (var_1_39 > var_1_22) {
		var_1_41 = ((max (var_1_26 , (256 + var_1_84))) - var_1_11);
	}
	...
	if (var_1_96 >= var_1_37) {
		...
		if (var_1_10 != -5) {
			var_1_51 = (min (var_1_52 , (var_1_49 + (abs (var_1_13)))));
		} else {
			var_1_51 = (max (var_1_26 , var_1_36));
		}
	}
	...
	if (var_1_86 < (var_1_30 / var_1_62)) {
		if (stepLocal_24 >= ((var_1_56 - var_1_35) * (var_1_95 + var_1_54))) {
			...
			var_1_77 = ((min (var_1_8 , 50)) + (var_1_49 + (max (var_1_78 , var_1_79))));
		}
	} else {
	...
	if ((var_1_52 - var_1_56) < stepLocal_21) {
		if (var_1_15) {
			if (stepLocal_22 >= var_1_77) {
				...
				var_1_69 = ((max (-16 , (abs (var_1_49)))) + (min (var_1_11 , last_1_var_1_69)));
			}
		} else {
			var_1_69 = (min (((min (var_1_19 , var_1_24)) - (var_1_70 - var_1_26)) , -50));
		}
	} else {
		var_1_69 = ((var_1_11 + (min (var_1_10 , var_1_19))) + var_1_77);
	}
	...
	if (var_1_42 < var_1_30) {
		if ((var_1_86 * var_1_60) < var_1_86) {
			if (var_1_41 <= stepLocal_27) {
				var_1_82 = (((max (var_1_79 , -1)) + var_1_83) + var_1_49);
			}
		}
	} else {
		if (! var_1_72) {
	...
	if (var_1_8 == (~ (max (var_1_26 , var_1_13)))) {
	...
	signed long int stepLocal_19 = (min (var_1_50 , var_1_37)) / var_1_35;
	if (200 < stepLocal_20) {
		if (stepLocal_19 <= var_1_53) {
			var_1_65 = var_1_13;
		} else {
			if (var_1_63 != (min ((var_1_30 / var_1_39) , (- var_1_62)))) {
		...
		var_1_65 = ((min (var_1_38 , (min (var_1_20 , last_1_var_1_65)))) + var_1_13);
	}
	...
	if (var_1_97 >= stepLocal_12) {
		...
		if (var_1_72) {
			if (((var_1_56 - var_1_8) - var_1_49) < stepLocal_11) {
				var_1_55 = (abs (var_1_26));
			} else {
				var_1_55 = ((abs (var_1_19)) - var_1_13);
			}
		}
	}
	...
	if (stepLocal_18 != (min (var_1_52 , (var_1_35 - var_1_64)))) {
		if ((abs (var_1_35)) < stepLocal_17) {
		...
		if (stepLocal_16 < (var_1_37 + var_1_26)) {
			var_1_61 = (abs (max ((abs (var_1_63)) , (var_1_29 - var_1_62))));
		}
	}
	...
	if (((var_1_68 - var_1_63) / var_1_39) != (100000.65 + var_1_61)) {
		...
		if (stepLocal_23 >= var_1_10) {
			var_1_76 = (min (var_1_44 , var_1_62));
		}
	}
	...
	if (stepLocal_8 != ((var_1_37 / var_1_19) * var_1_13)) {
		if (var_1_16) {
			if (var_1_28 <= (min (var_1_76 , (max (49.35 , var_1_76))))) {
				var_1_45 = ((min (var_1_46 , var_1_47)) - (var_1_37 - (1000000000u - 1u)));
			} else {
		...
		if (stepLocal_9 <= var_1_14) {
			var_1_45 = (max (((var_1_48 - var_1_26) - (min (0u , var_1_37))) , (max (var_1_8 , var_1_13))));
		}
	}
	...
	if (var_1_92 && stepLocal_14) {
		var_1_58 = (abs (var_1_36 + var_1_11));
	} else {
		if (stepLocal_15 == var_1_69) {
			if ((var_1_42 / (max (var_1_28 , var_1_60))) <= var_1_32) {
				var_1_58 = (min (var_1_19 , (var_1_11 + var_1_13)));
			} else {
	...
	signed long int stepLocal_28 = (max (var_1_99 , 41991)) - var_1_8;
	...
	if ((abs (var_1_28)) < ((var_1_68 - var_1_63) - (1.75 + var_1_31))) {
		if (var_1_15) {
			if (var_1_28 > (var_1_22 * var_1_76)) {
				var_1_67 = (abs (var_1_12));
			}
		} else {
			var_1_67 = (max (var_1_95 , (var_1_82 - var_1_19)));
		}
	}
	...
	signed long int stepLocal_25 = var_1_14 / (max (var_1_54 , var_1_56));
	if (var_1_25 <= stepLocal_25) {
		if (((var_1_82 + var_1_88) * var_1_37) <= stepLocal_26) {
			var_1_80 = (var_1_52 - (max ((var_1_36 - var_1_13) , var_1_19)));
		} else {
			if ((- (var_1_32 + var_1_43)) == var_1_27) {
				var_1_80 = ((var_1_54 - var_1_50) + var_1_25);
			} else {
				var_1_80 = ((min (var_1_52 , var_1_81)) - last_1_var_1_80);
			}
		}
	} else {
	...
	signed long int stepLocal_4 = (var_1_35 + var_1_36) - (min (64 , var_1_67));
	...
	if (stepLocal_4 <= ((var_1_10 + var_1_11) - (var_1_37 - var_1_26))) {
		if ((var_1_11 / var_1_36) < stepLocal_3) {
			var_1_34 = (min (var_1_11 , var_1_36));
		} else {
			var_1_34 = (max (var_1_8 , 32));
		}
	} else {
		var_1_34 = (max (var_1_11 , var_1_67));
	}
}
...
int property() {
	return ((((((((((((((((((((((((((((((((((((((((((((((((var_1_33 > var_1_42) ? ((var_1_42 < var_1_33) ? ((((var_1_87 || var_1_87) && var_1_72) && var_1_15) ? (var_1_1 == ((signed char) (8 - (64 - var_1_8)))) : ((var_1_86 <= (var_1_42 / 15.8)) ? (var_1_1 == ((signed char) -4)) : (var_1_1 == ((signed char) (max (((var_1_10 - var_1_8) - var_1_11) , (min ((var_1_12 - var_1_13) , var_1_14)))))))) : 1) : 1) && ((last_1_var_1_21 > last_1_var_1_86) ? (var_1_15 == ((unsigned char) ((last_1_var_1_86 == 31.65) || var_1_16))) : 1)) && (((abs (var_1_11)) == (var_1_13 + var_1_10)) ? (((var_1_82 * 256) >= var_1_11) ? (var_1_17 == ((signed char) (max ((var_1_12 - var_1_10) , (min (var_1_14 , (min (var_1_8 , -5)))))))) : (var_1_17 == ((signed char) var_1_13))) : 1)) && (var_1_16 ? (var_1_18 == ((unsigned char) (abs (var_1_8)))) : (var_1_18 == ((unsigned char) (var_1_19 - 64))))) && (var_1_20 == ((signed short int) (var_1_13 - ((var_1_11 + 50) + (max (var_1_85 , var_1_19))))))) && (((4.5 / 9999.5) > (max (var_1_33 , var_1_86))) ? (var_1_21 == ((float) 4.6f)) : (var_1_87 ? (var_1_21 == ((float) var_1_22)) : (var_1_21 == ((float) (min (var_1_22 , 64.8f))))))) && ((! var_1_72) ? (var_1_23 == ((signed short int) (min (var_1_8 , var_1_69)))) : ((var_1_72 || (var_1_10 > var_1_13)) ? (var_1_23 == ((signed short int) ((var_1_19 + 2) - var_1_10))) : (var_1_23 == ((signed short int) var_1_19))))) && (var_1_24 == ((signed long int) -100))) && (var_1_16 ? (var_1_25 == ((unsigned char) (max (var_1_11 , (var_1_19 - (64 - var_1_8)))))) : (var_1_25 == ((unsigned char) (var_1_19 - (max (var_1_10 , var_1_26))))))) && (var_1_87 ? (var_1_27 == ((double) ((var_1_28 - var_1_29) - ((4.1406872328101468E18 - var_1_30) + var_1_31)))) : ((var_1_31 == (max (var_1_22 , (var_1_86 + var_1_86)))) ? (var_1_27 == ((double) (min ((var_1_30 + var_1_29) , (min ((var_1_31 + var_1_32) , var_1_28)))))) : (var_1_27 == ((double) (max ((min ((var_1_28 - var_1_30) , (var_1_31 - var_1_29))) , 2.75))))))) && (((last_1_var_1_15 || (last_1_var_1_98 > var_1_8)) && (last_1_var_1_42 > var_1_30)) ? (var_1_33 == ((double) (var_1_31 - var_1_29))) : (var_1_33 == ((double) (var_1_31 + var_1_30))))) && ((((var_1_35 + var_1_36) - (min (64 , var_1_67))) <= ((var_1_10 + var_1_11) - (var_1_37 - var_1_26))) ? (((var_1_11 / var_1_36) < (var_1_14 >> var_1_37)) ? (var_1_34 == ((unsigned short int) (min (var_1_11 , var_1_36)))) : (var_1_34 == ((unsigned short int) (max (var_1_8 , 32))))) : (var_1_34 == ((unsigned short int) (max (var_1_11 , var_1_67)))))) && (((max (var_1_28 , (var_1_32 + 63.125))) <= (var_1_22 / var_1_39)) ? (var_1_15 ? (var_1_38 == ((signed long int) var_1_90)) : 1) : (var_1_38 == ((signed long int) var_1_94)))) && ((! (var_1_30 <= var_1_22)) ? ((var_1_29 > (var_1_30 + (var_1_28 - var_1_31))) ? (var_1_40 == ((signed long int) (min (var_1_8 , var_1_10)))) : 1) : 1)) && ((var_1_39 > var_1_22) ? (var_1_41 == ((signed short int) ((max (var_1_26 , (256 + var_1_84))) - var_1_11))) : 1)) && ((last_1_var_1_34 > (abs (last_1_var_1_50))) ? (((max (var_1_10 , var_1_36)) >= (max (last_1_var_1_65 , 50))) ? (var_1_42 == ((float) ((min ((min (var_1_31 , var_1_30)) , var_1_32)) + var_1_29))) : (var_1_42 == ((float) (var_1_29 + (var_1_31 - var_1_30))))) : ((last_1_var_1_34 == (256 - 5)) ? (var_1_42 == ((float) (min (var_1_30 , (max (var_1_43 , var_1_28)))))) : (var_1_42 == ((float) ((var_1_30 + (max (10.375f , var_1_44))) + (var_1_29 - var_1_31))))))) && ((16u != ((var_1_37 / var_1_19) * var_1_13)) ? (var_1_16 ? ((var_1_28 <= (min (var_1_76 , (max (49.35 , var_1_76))))) ? (var_1_45 == ((unsigned long int) ((min (var_1_46 , var_1_47)) - (var_1_37 - (1000000000u - 1u))))) : (var_1_45 == ((unsigned long int) ((var_1_48 - var_1_10) - last_1_var_1_45)))) : 1) : (((var_1_8 << var_1_49) <= var_1_14) ? (var_1_45 == ((unsigned long int) (max (((var_1_48 - var_1_26) - (min (0u , var_1_37))) , (max (var_1_8 , var_1_13)))))) : 1))) && ((var_1_8 == (~ (max (var_1_26 , var_1_13)))) ? ((var_1_15 && var_1_87) ? (((var_1_57 + var_1_19) >= var_1_48) ? (var_1_50 == ((signed long int) (var_1_8 + (var_1_57 + var_1_14)))) : 1) : (var_1_50 == ((signed long int) (var_1_26 - var_1_35)))) : (var_1_50 == ((signed long int) last_1_var_1_50)))) && ((var_1_96 >= var_1_37) ? (var_1_51 == ((unsigned short int) (var_1_52 - var_1_93))) : ((var_1_10 != -5) ? (var_1_51 == ((unsigned short int) (min (var_1_52 , (var_1_49 + (abs (var_1_13))))))) : (var_1_51 == ((unsigned short int) (max (var_1_26 , var_1_36))))))) && (((var_1_27 > (var_1_28 - var_1_31)) || var_1_72) ? (var_1_53 == ((unsigned short int) ((var_1_36 + var_1_54) - last_1_var_1_53))) : (var_1_53 == ((unsigned short int) (max (var_1_36 , var_1_8)))))) && ((var_1_97 >= (var_1_19 - var_1_26)) ? ((var_1_42 <= (var_1_31 + var_1_22)) ? (var_1_55 == ((unsigned char) (var_1_26 + var_1_13))) : 1) : (var_1_72 ? ((((var_1_56 - var_1_8) - var_1_49) < var_1_23) ? (var_1_55 == ((unsigned char) (abs (var_1_26)))) : (var_1_55 == ((unsigned char) ((abs (var_1_19)) - var_1_13)))) : 1))) && (var_1_57 == ((signed short int) (((var_1_77 + var_1_26) + var_1_49) + var_1_82)))) && ((var_1_92 && var_1_16) ? (var_1_58 == ((unsigned short int) (abs (var_1_36 + var_1_11)))) : ((var_1_65 == var_1_69) ? (((var_1_42 / (max (var_1_28 , var_1_60))) <= var_1_32) ? (var_1_58 == ((unsigned short int) (min (var_1_19 , (var_1_11 + var_1_13))))) : (((last_1_var_1_58 * var_1_77) < 2) ? (var_1_58 == ((unsigned short int) (var_1_52 - var_1_36))) : 1)) : ((var_1_60 <= (var_1_61 * var_1_22)) ? (var_1_58 == ((unsigned short int) (abs (var_1_65)))) : (var_1_58 == ((unsigned short int) var_1_26)))))) && (((var_1_49 / var_1_56) != (min (var_1_52 , (var_1_35 - var_1_64)))) ? (((abs (var_1_35)) < (~ (var_1_36 * var_1_84))) ? (var_1_61 == ((float) (var_1_44 + var_1_31))) : (var_1_61 == ((float) ((var_1_30 + (var_1_62 - var_1_63)) - var_1_31)))) : ((((var_1_64 - var_1_13) & (var_1_71 ^ var_1_8)) < (var_1_37 + var_1_26)) ? (var_1_61 == ((float) (abs (max ((abs (var_1_63)) , (var_1_29 - var_1_62)))))) : 1))) && (var_1_64 == ((unsigned long int) ((var_1_37 - var_1_69) + var_1_26)))) && ((200 < var_1_12) ? ((((min (var_1_50 , var_1_37)) / var_1_35) <= var_1_53) ? (var_1_65 == ((signed short int) var_1_13)) : ((var_1_63 != (min ((var_1_30 / var_1_39) , (- var_1_62)))) ? (var_1_65 == ((signed short int) ((var_1_49 + 16) - var_1_20))) : (var_1_65 == ((signed short int) ((var_1_25 + var_1_20) - var_1_19))))) : (var_1_65 == ((signed short int) ((min (var_1_38 , (min (var_1_20 , last_1_var_1_65)))) + var_1_13))))) && (((abs (var_1_28)) < ((var_1_68 - var_1_63) - (1.75 + var_1_31))) ? (var_1_15 ? ((var_1_28 > (var_1_22 * var_1_76)) ? (var_1_67 == ((signed short int) (abs (var_1_12)))) : 1) : (var_1_67 == ((signed short int) (max (var_1_95 , (var_1_82 - var_1_19)))))) : 1)) && (((var_1_52 - var_1_56) < var_1_35) ? (var_1_15 ? ((var_1_35 >= var_1_77) ? (var_1_69 == ((signed short int) (var_1_11 - (var_1_70 - var_1_1)))) : (var_1_69 == ((signed short int) ((max (-16 , (abs (var_1_49)))) + (min (var_1_11 , last_1_var_1_69)))))) : (var_1_69 == ((signed short int) (min (((min (var_1_19 , var_1_24)) - (var_1_70 - var_1_26)) , -50))))) : (var_1_69 == ((signed short int) ((var_1_11 + (min (var_1_10 , var_1_19))) + var_1_77))))) && (((var_1_56 + (5 * var_1_36)) >= var_1_13) ? ((var_1_72 || (var_1_21 == var_1_21)) ? (var_1_71 == ((signed long int) (-5 + var_1_13))) : (var_1_71 == ((signed long int) var_1_50))) : (var_1_71 == ((signed long int) var_1_19)))) && (last_1_var_1_92 ? ((var_1_29 <= last_1_var_1_42) ? (var_1_72 == ((unsigned char) var_1_73)) : 1) : (var_1_72 == ((unsigned char) (((max (last_1_var_1_58 , last_1_var_1_51)) < var_1_14) || (! (var_1_73 && var_1_75))))))) && ((((var_1_68 - var_1_63) / var_1_39) != (100000.65 + var_1_61)) ? (var_1_76 == ((float) var_1_43)) : ((var_1_8 >= var_1_10) ? (var_1_76 == ((float) (min (var_1_44 , var_1_62)))) : 1))) && ((var_1_86 < (var_1_30 / var_1_62)) ? (((var_1_26 << var_1_11) >= ((var_1_56 - var_1_35) * (var_1_95 + var_1_54))) ? (var_1_77 == ((signed char) (var_1_8 + var_1_49))) : (var_1_77 == ((signed char) ((min (var_1_8 , 50)) + (var_1_49 + (max (var_1_78 , var_1_79))))))) : (var_1_77 == ((signed char) (var_1_11 - var_1_10))))) && ((var_1_25 <= (var_1_14 / (max (var_1_54 , var_1_56)))) ? ((((var_1_82 + var_1_88) * var_1_37) <= (var_1_69 + var_1_98)) ? (var_1_80 == ((unsigned short int) (var_1_52 - (max ((var_1_36 - var_1_13) , var_1_19))))) : (((- (var_1_32 + var_1_43)) == var_1_27) ? (var_1_80 == ((unsigned short int) ((var_1_54 - var_1_50) + var_1_25))) : (var_1_80 == ((unsigned short int) ((min (var_1_52 , var_1_81)) - last_1_var_1_80))))) : (var_1_80 == ((unsigned short int) (var_1_52 - last_1_var_1_80))))) && ((var_1_42 < var_1_30) ? (((var_1_86 * var_1_60) < var_1_86) ? ((var_1_41 <= var_1_96) ? (var_1_82 == ((signed char) (((max (var_1_79 , -1)) + var_1_83) + var_1_49))) : 1) : 1) : ((! var_1_72) ? ((var_1_28 <= var_1_39) ? (var_1_82 == ((signed char) var_1_10)) : (var_1_82 == ((signed char) var_1_49))) : (var_1_82 == ((signed char) var_1_13))))) && (var_1_73 ? (var_1_84 == ((signed long int) -1)) : (var_1_84 == ((signed long int) 64)))) && (var_1_75 ? (var_1_85 == ((unsigned short int) var_1_70)) : 1)) && (var_1_16 ? (var_1_86 == ((double) var_1_62)) : (var_1_86 == ((double) var_1_63)))) && (var_1_87 == ((unsigned char) var_1_16))) && (var_1_72 ? (var_1_88 == ((unsigned short int) var_1_36)) : (var_1_88 == ((unsigned short int) var_1_25)))) && (var_1_75 ? (var_1_90 == ((unsigned long int) var_1_10)) : (var_1_90 == ((unsigned long int) var_1_47)))) && (var_1_91 == ((signed long int) var_1_54))) && (var_1_92 == ((unsigned char) var_1_75))) && (var_1_87 ? (var_1_93 == ((unsigned short int) var_1_52)) : 1)) && (var_1_94 == ((unsigned char) var_1_49))) && (var_1_87 ? (var_1_95 == ((signed short int) var_1_8)) : 1)) && (var_1_96 == ((signed long int) var_1_93))) && (var_1_15 ? (var_1_97 == ((signed short int) var_1_13)) : (var_1_97 == ((signed short int) var_1_69)))) && ((var_1_94 >= -16) ? (var_1_15 ? (var_1_98 == ((signed long int) var_1_58)) : 1) : ((var_1_94 < ((max (var_1_99 , 41991)) - var_1_8)) ? (var_1_98 == ((signed long int) var_1_49)) : (var_1_98 == ((signed long int) var_1_52))))
;
}
int main(void) {
	isInitial = 1;
