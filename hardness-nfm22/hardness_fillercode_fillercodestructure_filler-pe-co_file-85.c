...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch85Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch85Filler_PE_CO
	var_1_13 = (abs (var_1_14));


	// From: Req7Batch85Filler_PE_CO
	var_1_16 = (var_1_6 && var_1_17);


	// From: Req6Batch85Filler_PE_CO
	if (var_1_5) {
		var_1_15 = (max (var_1_1 , (var_1_13 + (abs (var_1_14)))));
	}


	// From: Req3Batch85Filler_PE_CO
	...
	// From: CodeObject1
	if (var_1_5) {
		if ((var_1_13 - (min (var_1_13 , var_1_13))) <= var_1_15) {
			var_1_21 = var_1_27;
		}
	}
	...
	// From: CodeObject4
	if ((min ((var_1_32 - var_1_33) , var_1_29)) > (var_1_7 * 31.3)) {
		if (var_1_5) {
			var_1_31 = var_1_35;
		}
	} else {
	...
	// From: CodeObject6
	if (! var_1_5) {
		if ((var_1_13 + var_1_13) >= ((var_1_15 + var_1_13) << (min (5 , var_1_39)))) {
			if (var_1_16 && (4.166 >= var_1_29)) {
