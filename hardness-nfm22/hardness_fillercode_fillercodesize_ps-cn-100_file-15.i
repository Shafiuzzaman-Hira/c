...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch15PS_CN_100.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (((1 - var_1_33) <= (~ var_1_28)) || ((64 < var_1_29) || var_1_30)) {
  if (var_1_29 > (var_1_28 >> var_1_33)) {
   if (((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35))) >= 3.2) {
    if (var_1_30) {
     var_1_34 = var_1_36;
    } else {
     var_1_34 = var_1_36;
 ...
 if ((var_1_33 / var_1_38) <= var_1_34) {
  if (var_1_36 <= (~ ((((var_1_29) > (var_1_38)) ? (var_1_29) : (var_1_38))))) {
   var_1_37 = (((((var_1_39) < (var_1_40)) ? (var_1_39) : (var_1_40))) + ((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))));
  }
 } else {
  var_1_37 = (((((25 + var_1_42) < 0 ) ? -(25 + var_1_42) : (25 + var_1_42))) + (var_1_43 + var_1_44));
 }
 if ((((((var_1_43 >> var_1_28)) < ((var_1_44 - var_1_33))) ? ((var_1_43 >> var_1_28)) : ((var_1_44 - var_1_33)))) <= var_1_40) {
  var_1_45 = var_1_42;
 }
 if (var_1_35 < ((((-0.275) > (var_1_47)) ? (-0.275) : (var_1_47)))) {
  var_1_46 = var_1_42;
 } else {
  var_1_46 = (var_1_48 - var_1_37);
 }
 if (var_1_46 > (var_1_45 + var_1_50)) {
  var_1_49 = ((((((((var_1_42) > (var_1_44)) ? (var_1_42) : (var_1_44)))) > (var_1_36)) ? (((((var_1_42) > (var_1_44)) ? (var_1_42) : (var_1_44)))) : (var_1_36)));
 } else {
  var_1_49 = (var_1_44 + var_1_42);
 }
 if (((((var_1_43) < (var_1_50)) ? (var_1_43) : (var_1_50))) < (((((((8) < 0 ) ? -(8) : (8))) < 0 ) ? -((((8) < 0 ) ? -(8) : (8))) : ((((8) < 0 ) ? -(8) : (8)))))) {
  var_1_51 = (((((((var_1_44) > (((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))))) ? (var_1_44) : (((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40)))))) < 0 ) ? -((((var_1_44) > (((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))))) ? (var_1_44) : (((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40)))))) : ((((var_1_44) > (((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))))) ? (var_1_44) : (((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))))))));
 }
 if ((~ (var_1_37 & 10)) == ((var_1_48 & var_1_46) + var_1_32)) {
  if ((((((var_1_35) > (var_1_47)) ? (var_1_35) : (var_1_47))) * var_1_53) >= 8.4) {
   if (var_1_30) {
    var_1_52 = ((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39)));
   }
  }
 }
 var_1_54 = var_1_42;
