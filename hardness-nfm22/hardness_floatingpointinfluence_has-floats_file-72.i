...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch72has_floats.c", 13, "reach_error"); }
...
float var_1_16 = 0.25;
double var_1_17 = 1000000000.2;
double var_1_18 = 50.5;
double var_1_19 = 9.5;
double var_1_20 = 1000000000.4;
...
void step(void) {
 ...
 if ((var_1_20 + (var_1_20 / var_1_16)) == var_1_20) {
  if (var_1_20 >= last_1_var_1_15) {
   ...
   var_1_15 = ((((var_1_17) < ((5.75 + var_1_19))) ? (var_1_17) : ((5.75 + var_1_19))));
  }
 }
 if (var_1_20 < (((((var_1_15) < (var_1_15)) ? (var_1_15) : (var_1_15))) * var_1_15)) {
