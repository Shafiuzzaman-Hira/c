...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch40Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_35 = var_1_20;
 var_1_26 = var_1_12;
 if ((var_1_11 && var_1_9) && (var_1_12 > var_1_16)) {
  var_1_37 = var_1_12;
 }
 if (var_1_28 > (var_1_8 | var_1_12)) {
 ...
 if ((((((var_1_20 / var_1_39)) > (var_1_24)) ? ((var_1_20 / var_1_39)) : (var_1_24))) > 100.3) {
 ...
 if (var_1_12 > ((var_1_29 >> 1) + var_1_15)) {
