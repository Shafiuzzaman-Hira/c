...
void step(void) {
	...
	// From: Req2Batch98stepLocals
	if (var_1_2 <= var_1_3) {
		var_1_6 = (var_1_7 + var_1_8);
	}


	// From: Req3Batch98stepLocals
	if (var_1_10) {
...
int property() {
	return ((((((((var_1_2 <= ((var_1_3 / var_1_4) & 8)) ? ((-16 <= var_1_3) ? ((var_1_2 != (var_1_3 / (min (var_1_4 , var_1_5)))) ? (var_1_1 == ((signed long int) (max (var_1_3 , var_1_2)))) : (var_1_1 == ((signed long int) (abs (var_1_2))))) : 1) : ((var_1_3 <= var_1_2) ? (var_1_1 == ((signed long int) var_1_4)) : (var_1_1 == ((signed long int) var_1_3)))) && ((var_1_2 <= var_1_3) ? (var_1_6 == ((double) (var_1_7 + var_1_8))) : 1)) && (var_1_10 ? ((var_1_4 < (var_1_1 + var_1_5)) ? (var_1_9 == ((unsigned short int) 16)) : 1) : 1)) && (var_1_11 == ((unsigned long int) (abs (max (2u , (3986216790u - var_1_9))))))) && (((var_1_5 * (var_1_13 - var_1_14)) <= var_1_3) ? (var_1_12 == ((unsigned short int) (var_1_15 - (max (var_1_14 , var_1_16))))) : 1)) && (var_1_17 == ((signed char) var_1_18))) && ((var_1_13 <= var_1_12) ? (var_1_19 == ((signed short int) ((var_1_17 + 25) + (var_1_20 - (var_1_21 - 1))))) : (var_1_19 == ((signed short int) (max ((abs (var_1_18)) , var_1_17)))))) && (var_1_22 == ((signed char) var_1_18))
;
}
int main(void) {
	isInitial = 1;
