...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch8Amount50.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch8Amount50
	if (last_1_var_1_13 == (last_1_var_1_13 % var_1_4)) {
		var_1_1 = (var_1_5 - var_1_6);
	}


	// From: Req5Batch8Amount50
	if (var_1_10 == var_1_1) {
		if (var_1_11) {
	...
	// From: Req2Batch8Amount50
	if (var_1_1 >= var_1_6) {
		var_1_7 = var_1_19;
	}


	// From: Req3Batch8Amount50
