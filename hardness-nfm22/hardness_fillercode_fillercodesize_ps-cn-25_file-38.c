...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch38PS_CN_25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject5
	if ((-1 / var_1_37) >= (abs (var_1_35))) {
		var_1_36 = var_1_34;
	}


	// From: Req5Batch38PS_CN_25
