...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch56PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_24 >= var_1_28) {
		var_1_32 = ((var_1_33 - var_1_34) - 10);
	}


	// From: Req1Batch56PS_CN_10
	...
	// From: Req4Batch56PS_CN_10
	var_1_12 = ((64 + var_1_13) - var_1_14);


	// From: Req5Batch56PS_CN_10
	var_1_15 = ((var_1_16 - var_1_17) - 10);


	// From: Req6Batch56PS_CN_10
	if (var_1_1) {
		var_1_18 = (var_1_16 - var_1_13);
	}


	// From: Req7Batch56PS_CN_10
	...
	// From: Req2Batch56PS_CN_10
	if (var_1_4) {
		var_1_6 = (var_1_15 + (min (var_1_15 , var_1_18)));
	}


	// From: Req3Batch56PS_CN_10
