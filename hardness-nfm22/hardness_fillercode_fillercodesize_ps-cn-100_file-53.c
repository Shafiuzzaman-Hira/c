...
void step(void) {
	...
	if (var_1_24 >= var_1_29) {
		if ((4 % var_1_32) > var_1_30) {
			var_1_31 = (abs ((abs (var_1_32)) + 256));
		} else {
			var_1_31 = ((var_1_33 - (abs (var_1_32))) + var_1_34);
		}
	}
	...
	if (var_1_40 <= ((- 64) ^ (var_1_43 - var_1_44))) {
		var_1_42 = (min ((var_1_45 - var_1_46) , var_1_44));
	}


	// From: CodeObject7
	if ((var_1_44 | var_1_31) < (abs (var_1_29))) {
		if ((~ (var_1_30 / var_1_45)) <= 64) {
			var_1_47 = ((max (var_1_34 , var_1_45)) + (var_1_46 + var_1_32));
		} else {
	...
	if (var_1_26 && var_1_25) {
		if (var_1_27 >= var_1_35) {
			var_1_48 = (min (var_1_32 , var_1_43));
		}
	} else {
		var_1_48 = var_1_43;
	}
	...
	if (var_1_39 <= var_1_43) {
		...
		var_1_49 = (min ((max (var_1_38 , (max (var_1_36 , var_1_37)))) , var_1_50));
	}


	// From: CodeObject10
	if (var_1_25) {
		if (var_1_31 <= (abs (abs (var_1_33)))) {
			var_1_51 = var_1_39;
		}
	}
	...
	if ((- var_1_42) >= var_1_46) {
		...
		if ((var_1_27 / var_1_53) <= var_1_37) {
			if ((abs (var_1_53)) > var_1_36) {
				var_1_52 = (abs (min (var_1_42 , var_1_33)));
			}
		}
	}
	...
	// From: CodeObject12
	if ((var_1_55 / var_1_45) < (abs (abs (var_1_46)))) {
		var_1_54 = (min (var_1_56 , (min (2 , var_1_57))));
	}


	// From: CodeObject13
	if (var_1_29 <= (max (var_1_51 , var_1_40))) {
		var_1_58 = (var_1_46 + var_1_54);
	}


	// From: Req1Batch53PS_CN_100
	...
	// From: Req6Batch53PS_CN_100
	var_1_20 = var_1_21;


	// From: Req7Batch53PS_CN_100
	var_1_22 = var_1_12;


	// From: Req8Batch53PS_CN_100
	var_1_23 = var_1_21;


	// From: Req4Batch53PS_CN_100
	if (var_1_1) {
