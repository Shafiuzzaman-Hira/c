...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch17PS_CN_50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch17PS_CN_50
	var_1_1 = (50 + (min (var_1_2 , (min (var_1_3 , var_1_4)))));


	// From: Req5Batch17PS_CN_50
