...
void step(void) {
 ...
 signed long int stepLocal_1 = (((10) > (unsigned_char_Array_0[1])) ? (10) : (unsigned_char_Array_0[1]));
 if ((8 * unsigned_char_Array_0[1]) == stepLocal_1) {
  if (BOOL_unsigned_char_Array_0[0][1]) {
   ...
   if (float_Array_0[0] >= ((((double_Array_0[2]) < 0 ) ? -(double_Array_0[2]) : (double_Array_0[2])))) {
