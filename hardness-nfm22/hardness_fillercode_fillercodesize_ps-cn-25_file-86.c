...
void step(void) {
	...
	// From: CodeObject5
	if ((max (var_1_27 , (var_1_23 ^ 64))) <= var_1_24) {
		var_1_29 = (max ((abs (var_1_30)) , (min (var_1_31 , (max (var_1_32 , var_1_33))))));
	} else {
	...
	// From: Req2Batch86PS_CN_25
	if (var_1_19) {
		var_1_6 = (last_1_var_1_6 || var_1_9);
	}


	// From: Req4Batch86PS_CN_25
	...
	// From: Req7Batch86PS_CN_25
	var_1_22 = var_1_15;


	// From: Req5Batch86PS_CN_25
