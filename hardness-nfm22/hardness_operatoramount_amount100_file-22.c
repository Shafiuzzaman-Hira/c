...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch22Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch22Amount100
	signed long int stepLocal_0 = 50 * last_1_var_1_29;
	if ((last_1_var_1_16 | last_1_var_1_9) >= stepLocal_0) {
		var_1_1 = (min (last_1_var_1_9 , (max (last_1_var_1_16 , last_1_var_1_33))));
	}


	// From: Req3Batch22Amount100
	...
	// From: Req6Batch22Amount100
	var_1_19 = var_1_20;


	// From: Req7Batch22Amount100
	var_1_21 = (min (var_1_12 , (var_1_22 - (var_1_23 + var_1_24))));


	// From: Req9Batch22Amount100
	var_1_27 = ((max ((var_1_24 + 50) , var_1_23)) + var_1_28);


	// From: Req13Batch22Amount100
	var_1_38 = var_1_20;


	// From: Req14Batch22Amount100
	var_1_39 = 128;


	// From: Req4Batch22Amount100
	if (var_1_7) {
		if (! var_1_8) {
			var_1_16 = (abs (var_1_27 + var_1_27));
		} else {
			var_1_16 = var_1_33;
		}
	} else {
	...
	// From: Req8Batch22Amount100
	unsigned char stepLocal_2 = var_1_7;
	if (var_1_38 <= (max (var_1_38 , var_1_19))) {
	...
	// From: Req10Batch22Amount100
	if ((var_1_35 << (max (var_1_30 , var_1_31))) >= var_1_18) {
		if (var_1_35 != (max (-64 , var_1_23))) {
			var_1_29 = (abs ((50 + var_1_23) - var_1_33));
		}
	} else {
...
int property() {
	return (((((((((((((((last_1_var_1_16 | last_1_var_1_9) >= (50 * last_1_var_1_29)) ? (var_1_1 == ((unsigned short int) (min (last_1_var_1_9 , (max (last_1_var_1_16 , last_1_var_1_33)))))) : 1) && ((var_1_21 > var_1_29) ? (var_1_6 == ((signed short int) (var_1_21 - last_1_var_1_6))) : ((var_1_7 && var_1_8) ? (var_1_6 == ((signed short int) last_1_var_1_6)) : (var_1_6 == ((signed short int) -2))))) && (((last_1_var_1_19 + last_1_var_1_19) > 200.875f) ? ((last_1_var_1_25 > last_1_var_1_18) ? (var_1_9 == ((signed char) (max (var_1_12 , (max (var_1_13 , (var_1_14 + var_1_15))))))) : (var_1_9 == ((signed char) (max ((min (-32 , 100)) , var_1_13))))) : 1)) && (var_1_7 ? ((! var_1_8) ? (var_1_16 == ((unsigned short int) (abs (var_1_27 + var_1_27)))) : (var_1_16 == ((unsigned short int) var_1_33))) : (var_1_16 == ((unsigned short int) var_1_9)))) && ((var_1_1 <= var_1_35) ? (var_1_18 == ((signed char) ((min ((abs (4)) , var_1_15)) + var_1_14))) : (var_1_18 == ((signed char) var_1_13)))) && (var_1_19 == ((float) var_1_20))) && (var_1_21 == ((signed char) (min (var_1_12 , (var_1_22 - (var_1_23 + var_1_24))))))) && ((var_1_38 <= (max (var_1_38 , var_1_19))) ? (((! (var_1_27 < var_1_27)) && var_1_7) ? (var_1_25 == ((unsigned long int) var_1_1)) : 1) : (var_1_25 == ((unsigned long int) 2u)))) && (var_1_27 == ((unsigned char) ((max ((var_1_24 + 50) , var_1_23)) + var_1_28)))) && (((var_1_35 << (max (var_1_30 , var_1_31))) >= var_1_18) ? ((var_1_35 != (max (-64 , var_1_23))) ? (var_1_29 == ((signed short int) (abs ((50 + var_1_23) - var_1_33)))) : 1) : (var_1_29 == ((signed short int) (var_1_28 - var_1_30))))) && ((last_1_var_1_16 <= last_1_var_1_9) ? (var_1_33 == ((unsigned char) (var_1_34 - var_1_28))) : (((var_1_24 % var_1_34) >= last_1_var_1_27) ? (var_1_7 ? (var_1_33 == ((unsigned char) ((max ((max (var_1_28 , var_1_23)) , (64 - var_1_30))) + 1))) : (var_1_33 == ((unsigned char) var_1_28))) : 1))) && (((var_1_25 - last_1_var_1_35) <= (var_1_30 + var_1_39)) ? (var_1_7 ? (var_1_35 == ((unsigned char) var_1_28)) : (var_1_35 == ((unsigned char) ((var_1_36 - (var_1_37 - var_1_30)) - (min (var_1_28 , var_1_24)))))) : 1)) && (var_1_38 == ((double) var_1_20))) && (var_1_39 == ((signed short int) 128))
;
}
int main(void) {
	isInitial = 1;
