...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch57Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_24 = var_1_25;
 if ((25u | (var_1_27 - 5u)) >= var_1_5) {
  var_1_26 = (((((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))) < 0 ) ? -((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))) : ((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11)))));
 } else {
  if (var_1_5 < var_1_27) {
   var_1_26 = var_1_11;
  }
 ...
 if (var_1_10 < var_1_8) {
  var_1_30 = ((((var_1_8) > (var_1_11)) ? (var_1_8) : (var_1_11)));
 }
 if ((-1 - var_1_15) < ((var_1_1 / var_1_14) & var_1_5)) {
  if ((- ((((var_1_5) < 0 ) ? -(var_1_5) : (var_1_5)))) < (var_1_14 >> var_1_15)) {
   var_1_32 = var_1_15;
  } else {
   var_1_32 = var_1_15;
  }
 ...
 if (var_1_10 < ((var_1_8 / var_1_37) + var_1_11)) {
  if (((var_1_10 >= var_1_8) && var_1_25) && (var_1_8 <= ((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))))) {
   var_1_36 = ((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18)));
  }
 } else {
  var_1_36 = ((((var_1_18) > ((var_1_18 - var_1_18))) ? (var_1_18) : ((var_1_18 - var_1_18))));
 }
 if ((var_1_27 >> var_1_15) <= var_1_18) {
  var_1_41 = ((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15)));
 }
 var_1_42 = var_1_17;
 var_1_43 = var_1_3;
}
