...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch68Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch68Filler_PR_CI
	var_1_16 = last_1_var_1_12;


	// From: CodeObject6
	if (var_1_31 >= var_1_32) {
		if ((var_1_8 > var_1_16) || var_1_14) {
			var_1_34 = ((var_1_5 && var_1_5) || var_1_5);
		}
	} else {
		var_1_34 = ((var_1_24 >= (var_1_10 / var_1_35)) || var_1_7);
	}


	// From: CodeObject7
	if ((var_1_12 ^ (var_1_13 | var_1_13)) < (var_1_31 ^ var_1_12)) {
		var_1_37 = var_1_31;
	}


	// From: Req6Batch68Filler_PR_CI
	...
	// From: CodeObject4
	if ((max (var_1_10 , var_1_24)) > var_1_23) {
		if (var_1_10 > var_1_23) {
			var_1_27 = (100000000 + (var_1_12 - var_1_16));
		} else {
			if ((min (var_1_12 , var_1_16)) > (var_1_12 - (min (var_1_12 , 10)))) {
				if (((abs (var_1_31)) - var_1_32) < 2) {
					var_1_27 = (max (var_1_32 , (max (var_1_31 , var_1_16))));
				}
			} else {
				var_1_27 = var_1_31;
			}
	...
	// From: Req7Batch68Filler_PR_CI
	var_1_15 = var_1_10;


	// From: Req3Batch68Filler_PR_CI
	...
	// From: CodeObject1
	var_1_17 = (var_1_5 || (var_1_7 && var_1_5));
