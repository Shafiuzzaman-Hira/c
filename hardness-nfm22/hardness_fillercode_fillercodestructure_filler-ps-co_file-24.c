...
void step(void) {
	...
	// From: Req6Batch24Filler_PS_CO
	var_1_23 = var_1_24;


	// From: Req3Batch24Filler_PS_CO
	if (128u >= var_1_8) {
		if (! var_1_23) {
