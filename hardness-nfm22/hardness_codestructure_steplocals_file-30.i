...
void step(void) {
 signed long int stepLocal_0 = var_1_2 / ((((-16) < 0 ) ? -(-16) : (-16)));
 ...
 if (((((var_1_12) < (var_1_5)) ? (var_1_12) : (var_1_5))) >= var_1_7) {
