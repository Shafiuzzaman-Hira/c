...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch51PS_CN_10.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch51PS_CN_10
	if ((min ((~ var_1_1) , 8)) > var_1_11) {
		var_1_17 = var_1_18;
	}


	// From: Req2Batch51PS_CN_10
	if (! (var_1_17 > var_1_5)) {
