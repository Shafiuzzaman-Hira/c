...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch90no_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch90no_floats
	var_1_14 = (max (var_1_3 , (var_1_15 - 256)));


	// From: Req1Batch90no_floats
	if (var_1_10) {
