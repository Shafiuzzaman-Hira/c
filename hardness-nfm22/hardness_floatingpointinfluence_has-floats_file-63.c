...
void step(void) {
	// From: Req3Batch63has_floats
	var_1_13 = var_1_14;


	// From: Req5Batch63has_floats
	var_1_21 = last_1_var_1_21;


	// From: Req6Batch63has_floats
	var_1_22 = var_1_16;


	// From: Req7Batch63has_floats
	var_1_23 = var_1_6;


	// From: Req1Batch63has_floats
	if ((min (1.1f , var_1_2)) > (var_1_3 * var_1_4)) {
		var_1_1 = (var_1_23 && var_1_6);
	}


	// From: Req4Batch63has_floats
