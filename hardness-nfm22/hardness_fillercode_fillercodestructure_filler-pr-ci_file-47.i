...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch47Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8))) / var_1_4) > (var_1_6 * 10)) {
  if (! var_1_19) {
   var_1_43 = var_1_11;
  } else {
   var_1_43 = var_1_11;
 ...
 if ((var_1_20 & var_1_11) <= var_1_20) {
  var_1_36 = 10;
 } else {
  if (var_1_13 > var_1_3) {
   if ((~ var_1_20) > (var_1_8 & var_1_5)) {
    var_1_36 = (((((var_1_20) < 0 ) ? -(var_1_20) : (var_1_20))) + var_1_8);
   } else {
    var_1_36 = (var_1_4 - var_1_11);
   }
  }
 }
 if (var_1_16) {
 ...
 if (var_1_14 >= var_1_13) {
  ...
  var_1_39 = (((((((var_1_42) > (-8)) ? (var_1_42) : (-8))) < 0 ) ? -((((var_1_42) > (-8)) ? (var_1_42) : (-8))) : ((((var_1_42) > (-8)) ? (var_1_42) : (-8)))));
 }
 if (var_1_1 >= (((((var_1_4 * var_1_8)) > ((2 ^ var_1_20))) ? ((var_1_4 * var_1_8)) : ((2 ^ var_1_20))))) {
  var_1_22 = var_1_1;
 }
 if (var_1_12 > 32.8) {
  var_1_34 = (((((var_1_35 - var_1_8)) > (var_1_1)) ? ((var_1_35 - var_1_8)) : (var_1_1)));
 }
 if (var_1_11 == (var_1_1 | (var_1_6 + var_1_11))) {
  var_1_38 = var_1_15;
 }
}
