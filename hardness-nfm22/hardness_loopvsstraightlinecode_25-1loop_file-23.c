...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch2325_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch2325_1loop
	var_1_1 = (min (var_1_2 , var_1_3));


	// From: Req3Batch2325_1loop
	var_1_10 = (max (var_1_2 , ((var_1_11 + var_1_12) - var_1_13)));


	// From: Req5Batch2325_1loop
	var_1_18 = var_1_17;


	// From: Req6Batch2325_1loop
	var_1_19 = var_1_20;


	// From: Req7Batch2325_1loop
	var_1_21 = var_1_22;


	// From: Req2Batch2325_1loop
	if ((var_1_19 / var_1_6) <= (var_1_19 + (var_1_8 - var_1_9))) {
		var_1_4 = (min (var_1_2 , var_1_3));
	}


	// From: Req4Batch2325_1loop
	if (var_1_21) {
