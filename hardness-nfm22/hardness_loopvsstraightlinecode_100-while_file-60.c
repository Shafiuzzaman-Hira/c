...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch60100_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req12Batch60100_while
	if (((max (last_1_var_1_1 , var_1_12)) ^ last_1_var_1_31) > var_1_8) {
		var_1_38 = (var_1_39 - var_1_8);
	}


	// From: Req10Batch60100_while
	signed long int stepLocal_4 = 128 + (min (var_1_7 , var_1_38));
	if (stepLocal_4 != (max (var_1_12 , var_1_29))) {
		var_1_34 = ((var_1_35 - var_1_9) - (max (var_1_8 , var_1_12)));
	}


	// From: Req3Batch60100_while
	signed long int stepLocal_1 = (32 % var_1_12) * var_1_38;
	if (stepLocal_1 >= (var_1_34 + (max (var_1_8 , var_1_9)))) {
		var_1_11 = var_1_13;
	}


	// From: Req8Batch60100_while
	if (! last_1_var_1_24) {
	...
	// From: Req5Batch60100_while
	if (var_1_36 >= ((var_1_16 * var_1_15) / (max (1.2f , var_1_18)))) {
		var_1_17 = (max ((var_1_19 - (max (var_1_20 , 4.4))) , (var_1_21 + (var_1_22 + var_1_23))));
	} else {
		var_1_17 = var_1_20;
	}


	// From: Req7Batch60100_while
	signed long int stepLocal_3 = var_1_31 % (min (var_1_12 , var_1_29));
	if (stepLocal_3 <= var_1_7) {
		var_1_28 = (last_1_var_1_28 && var_1_30);
	}


	// From: Req2Batch60100_while
	var_1_10 = (max ((var_1_9 - var_1_8) , var_1_7));


	// From: Req6Batch60100_while
	if ((var_1_18 / (max (var_1_15 , var_1_25))) >= (var_1_19 - (var_1_26 + var_1_27))) {
		var_1_24 = (! var_1_13);
	}


	// From: Req9Batch60100_while
	var_1_33 = (-10 + var_1_38);


	// From: Req13Batch60100_while
	unsigned long int stepLocal_7 = var_1_35;
	unsigned char stepLocal_6 = var_1_24;
	if (stepLocal_6 && (! var_1_28)) {
		var_1_40 = ((min (1 , var_1_41)) - (var_1_42 + 4));
	} else {
	...
	// From: Req1Batch60100_while
	unsigned char stepLocal_0 = var_1_28;
	if (var_1_11) {
		if (stepLocal_0 && (var_1_17 <= (max (var_1_36 , var_1_17)))) {
...
int property() {
	return ((((((((((((var_1_11 ? ((var_1_28 && (var_1_17 <= (max (var_1_36 , var_1_17)))) ? ((var_1_17 >= var_1_17) ? (var_1_1 == ((signed short int) (var_1_7 - (var_1_8 - var_1_9)))) : (var_1_1 == ((signed short int) var_1_9))) : (var_1_1 == ((signed short int) var_1_7))) : 1) && (var_1_10 == ((signed long int) (max ((var_1_9 - var_1_8) , var_1_7))))) && ((((32 % var_1_12) * var_1_38) >= (var_1_34 + (max (var_1_8 , var_1_9)))) ? (var_1_11 == ((unsigned char) var_1_13)) : 1)) && ((var_1_12 < var_1_10) ? ((var_1_36 >= ((var_1_36 + var_1_36) / var_1_15)) ? (var_1_14 == ((double) var_1_16)) : (var_1_14 == ((double) var_1_16))) : (var_1_14 == ((double) var_1_16)))) && ((var_1_36 >= ((var_1_16 * var_1_15) / (max (1.2f , var_1_18)))) ? (var_1_17 == ((double) (max ((var_1_19 - (max (var_1_20 , 4.4))) , (var_1_21 + (var_1_22 + var_1_23)))))) : (var_1_17 == ((double) var_1_20)))) && (((var_1_18 / (max (var_1_15 , var_1_25))) >= (var_1_19 - (var_1_26 + var_1_27))) ? (var_1_24 == ((unsigned char) (! var_1_13))) : 1)) && (((var_1_31 % (min (var_1_12 , var_1_29))) <= var_1_7) ? (var_1_28 == ((unsigned char) (last_1_var_1_28 && var_1_30))) : 1)) && ((! last_1_var_1_24) ? ((last_1_var_1_14 == 2.94f) ? ((var_1_20 > var_1_27) ? ((var_1_8 <= var_1_9) ? (var_1_31 == ((signed long int) var_1_7)) : 1) : (var_1_31 == ((signed long int) last_1_var_1_1))) : (var_1_31 == ((signed long int) -16))) : (var_1_31 == ((signed long int) var_1_29)))) && (var_1_33 == ((signed long int) (-10 + var_1_38)))) && (((128 + (min (var_1_7 , var_1_38))) != (max (var_1_12 , var_1_29))) ? (var_1_34 == ((unsigned long int) ((var_1_35 - var_1_9) - (max (var_1_8 , var_1_12))))) : 1)) && ((var_1_31 >= var_1_8) ? (var_1_36 == ((float) (var_1_22 + 64.8f))) : 1)) && ((((max (last_1_var_1_1 , var_1_12)) ^ last_1_var_1_31) > var_1_8) ? (var_1_38 == ((unsigned short int) (var_1_39 - var_1_8))) : 1)) && ((var_1_24 && (! var_1_28)) ? (var_1_40 == ((signed char) ((min (1 , var_1_41)) - (var_1_42 + 4)))) : ((var_1_7 >= var_1_35) ? (var_1_40 == ((signed char) var_1_42)) : (var_1_40 == ((signed char) var_1_42))))
;
}
int main(void) {
	isInitial = 1;
