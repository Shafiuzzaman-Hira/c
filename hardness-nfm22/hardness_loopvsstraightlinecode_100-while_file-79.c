...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch79100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (stepLocal_4 > last_1_var_1_39) {
		if (last_1_var_1_32) {
			if (stepLocal_3 == ((var_1_20 + last_1_var_1_13) / var_1_19)) {
				var_1_30 = (max (var_1_22 , 10u));
			}
		} else {
			var_1_30 = (max (var_1_22 , (var_1_31 - var_1_20)));
		}
	} else {
	...
	// From: Req2Batch79100_while
	if (var_1_32) {
		var_1_8 = ((var_1_9 + (max (31.5 , var_1_10))) - (min (var_1_11 , var_1_12)));
	}


	// From: Req4Batch79100_while
	var_1_23 = ((abs (var_1_11)) - var_1_9);


	// From: Req6Batch79100_while
	if (! ((var_1_12 < 9999999.625) && var_1_32)) {
		var_1_25 = var_1_19;
	} else {
		var_1_25 = (min (var_1_20 , (min (var_1_7 , var_1_19))));
	}


	// From: Req8Batch79100_while
	if (-32 > var_1_20) {
		var_1_27 = (min (((max (var_1_9 , var_1_10)) + (var_1_28 - var_1_29)) , var_1_11));
	} else {
		var_1_27 = 63.75;
	}


	// From: Req5Batch79100_while
	...
	// From: Req1Batch79100_while
	if (var_1_32 && var_1_32) {
		if (var_1_27 != 16.5) {
			var_1_1 = (max (-256 , var_1_34));
		} else {
	...
	// From: Req12Batch79100_while
	if (var_1_26 == var_1_27) {
		var_1_39 = (abs (var_1_38));
	} else {
	...
	// From: Req3Batch79100_while
	unsigned long int stepLocal_0 = var_1_7 * var_1_30;
	if (stepLocal_0 != (var_1_39 / (var_1_16 + var_1_17))) {
		if (var_1_23 >= (min ((var_1_12 * var_1_26) , var_1_8))) {
			var_1_13 = var_1_7;
		} else {
			if (var_1_32) {
				var_1_13 = ((var_1_19 - var_1_20) - (max ((8 + var_1_21) , var_1_22)));
			}
		}
	} else {
		var_1_13 = (max (var_1_19 , (var_1_7 + var_1_20)));
	}
}
...
int property() {
	return ((((((((((((var_1_32 && var_1_32) ? ((var_1_27 != 16.5) ? (var_1_1 == ((signed short int) (max (-256 , var_1_34)))) : (var_1_1 == ((signed short int) (var_1_6 - var_1_7)))) : (var_1_1 == ((signed short int) var_1_6))) && (var_1_32 ? (var_1_8 == ((double) ((var_1_9 + (max (31.5 , var_1_10))) - (min (var_1_11 , var_1_12))))) : 1)) && (((var_1_7 * var_1_30) != (var_1_39 / (var_1_16 + var_1_17))) ? ((var_1_23 >= (min ((var_1_12 * var_1_26) , var_1_8))) ? (var_1_13 == ((unsigned short int) var_1_7)) : (var_1_32 ? (var_1_13 == ((unsigned short int) ((var_1_19 - var_1_20) - (max ((8 + var_1_21) , var_1_22))))) : 1)) : (var_1_13 == ((unsigned short int) (max (var_1_19 , (var_1_7 + var_1_20))))))) && (var_1_23 == ((float) ((abs (var_1_11)) - var_1_9)))) && (last_1_var_1_32 ? ((-10000000 <= last_1_var_1_30) ? (var_1_24 == ((signed long int) (last_1_var_1_30 - var_1_20))) : 1) : 1)) && ((! ((var_1_12 < 9999999.625) && var_1_32)) ? (var_1_25 == ((unsigned short int) var_1_19)) : (var_1_25 == ((unsigned short int) (min (var_1_20 , (min (var_1_7 , var_1_19)))))))) && ((32 >= var_1_24) ? (var_1_26 == ((double) (var_1_9 - 8.625))) : 1)) && ((-32 > var_1_20) ? (var_1_27 == ((double) (min (((max (var_1_9 , var_1_10)) + (var_1_28 - var_1_29)) , var_1_11)))) : (var_1_27 == ((double) 63.75)))) && (((last_1_var_1_24 | var_1_22) > last_1_var_1_39) ? (last_1_var_1_32 ? ((last_1_var_1_1 == ((var_1_20 + last_1_var_1_13) / var_1_19)) ? (var_1_30 == ((unsigned long int) (max (var_1_22 , 10u)))) : 1) : (var_1_30 == ((unsigned long int) (max (var_1_22 , (var_1_31 - var_1_20)))))) : ((var_1_7 > last_1_var_1_13) ? (var_1_30 == ((unsigned long int) var_1_21)) : (var_1_30 == ((unsigned long int) var_1_31))))) && (((var_1_29 - var_1_11) <= last_1_var_1_8) ? ((last_1_var_1_39 == var_1_19) ? (var_1_32 == ((unsigned char) var_1_33)) : 1) : 1)) && ((var_1_20 >= var_1_16) ? ((var_1_30 > var_1_24) ? (var_1_34 == ((signed char) (var_1_35 + var_1_36))) : (var_1_34 == ((signed char) (var_1_37 - var_1_38)))) : 1)) && ((var_1_26 == var_1_27) ? (var_1_39 == ((unsigned long int) (abs (var_1_38)))) : (((var_1_19 * 64u) < var_1_38) ? (var_1_39 == ((unsigned long int) var_1_19)) : (var_1_39 == ((unsigned long int) var_1_16))))
;
}
int main(void) {
	isInitial = 1;
