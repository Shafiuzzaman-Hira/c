...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch33dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch33dependencies
	if ((- last_1_var_1_19) >= (-10 + (min (last_1_var_1_7 , last_1_var_1_11)))) {
		if ((~ (last_1_var_1_7 | last_1_var_1_19)) >= last_1_var_1_11) {
	...
	// From: Req6Batch33dependencies
	var_1_14 = (((max (var_1_15 , 1)) - var_1_16) + (var_1_17 - (4 + var_1_18)));


	// From: Req2Batch33dependencies
	var_1_5 = (max (var_1_1 , var_1_14));


	// From: Req5Batch33dependencies
	var_1_12 = (! ((var_1_14 < var_1_14) || var_1_13));


	// From: Req3Batch33dependencies
	if (((32.6 * var_1_8) >= var_1_9) && var_1_12) {
		var_1_7 = var_1_1;
	}


	// From: Req7Batch33dependencies
