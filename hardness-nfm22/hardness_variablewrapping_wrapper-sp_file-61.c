...
void step(void) {
	// From: Req3Batch61Wrapper_SP
	if ((*(WrapperStruct00_var_1_6_Pointer))) {
		(*(WrapperStruct00_var_1_11_Pointer)) = ((*(WrapperStruct00_var_1_10_Pointer)) + (max ((*(WrapperStruct00_var_1_12_Pointer)) , (*(WrapperStruct00_var_1_13_Pointer)))));
	} else {
	...
	// From: Req2Batch61Wrapper_SP
	if ((*(WrapperStruct00_var_1_23_Pointer)) < (max ((*(WrapperStruct00_var_1_20_Pointer)) , (*(WrapperStruct00_var_1_20_Pointer))))) {
