...
void step(void) {
 ...
 var_1_37 = (((((64.6 + var_1_38)) < (var_1_39)) ? ((64.6 + var_1_38)) : (var_1_39)));
 if (200u > (~ var_1_41)) {
  var_1_40 = var_1_38;
 } else {
  if (var_1_22 <= 50) {
   ...
   var_1_40 = ((((((((var_1_38 + var_1_42)) > ((var_1_43 - var_1_44))) ? ((var_1_38 + var_1_42)) : ((var_1_43 - var_1_44)))) < 0 ) ? -(((((var_1_38 + var_1_42)) > ((var_1_43 - var_1_44))) ? ((var_1_38 + var_1_42)) : ((var_1_43 - var_1_44)))) : (((((var_1_38 + var_1_42)) > ((var_1_43 - var_1_44))) ? ((var_1_38 + var_1_42)) : ((var_1_43 - var_1_44))))));
  }
 }
 ...
 if (((var_1_43 - var_1_44) / var_1_24) >= var_1_38) {
  var_1_47 = ((var_1_48 - ((((var_1_42) < 0 ) ? -(var_1_42) : (var_1_42)))) + var_1_38);
 }
 if (var_1_23 >= var_1_25) {
  if (((((var_1_46) < 0 ) ? -(var_1_46) : (var_1_46))) >= ((((((((var_1_27) > (0)) ? (var_1_27) : (0)))) < (((((var_1_26) < (100)) ? (var_1_26) : (100))))) ? (((((var_1_27) > (0)) ? (var_1_27) : (0)))) : (((((var_1_26) < (100)) ? (var_1_26) : (100))))))) {
   if (var_1_39 >= var_1_25) {
    var_1_49 = ((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31)));
   } else {
 ...
 if (((var_1_26 << var_1_34) * var_1_35) < var_1_46) {
  var_1_50 = (((((var_1_51) < 0 ) ? -(var_1_51) : (var_1_51))) - (((((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26))) < 0 ) ? -((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26))) : ((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26))))));
 }
 if (var_1_33) {
  var_1_52 = (var_1_36 && var_1_53);
 } else {
  if (((((8.3) < 0 ) ? -(8.3) : (8.3))) <= (- var_1_42)) {
   var_1_52 = var_1_54;
  }
 }
 if (var_1_53) {
  if (var_1_39 >= (24.4 / var_1_24)) {
   var_1_55 = ((((var_1_38) > (var_1_43)) ? (var_1_38) : (var_1_43)));
  } else {
   var_1_55 = ((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43)));
  }
 }
