...
void step(void) {
	...
	if (var_1_15 < var_1_15) {
		var_1_46 = (min (var_1_13 , (max (256u , var_1_34))));
	}
	...
	// From: Req9Batch99Filler_PR_CO
	var_1_28 = var_1_16;


	// From: Req2Batch99Filler_PR_CO
	var_1_6 = ((var_1_28 - var_1_26) + var_1_26);


	// From: Req3Batch99Filler_PR_CO
