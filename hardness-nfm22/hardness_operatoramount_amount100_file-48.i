...
void step(void) {
 ...
 if (var_1_8 <= (var_1_24 * ((((var_1_11) < (var_1_10)) ? (var_1_11) : (var_1_10))))) {
 ...
 if ((((((var_1_13) > (0)) ? (var_1_13) : (0))) - var_1_32) >= var_1_32) {
 ...
 if (stepLocal_9 && var_1_18) {
  if ((var_1_10 - (var_1_9 + var_1_24)) == var_1_23) {
   var_1_29 = ((((var_1_14) < (((((1) < (var_1_21)) ? (1) : (var_1_21))))) ? (var_1_14) : (((((1) < (var_1_21)) ? (1) : (var_1_21))))));
  }
 } else {
  var_1_29 = 1000;
 }
