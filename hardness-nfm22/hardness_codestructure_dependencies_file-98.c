...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch98dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch98dependencies
	var_1_17 = var_1_18;


	// From: Req7Batch98dependencies
	...
	// From: Req8Batch98dependencies
	var_1_22 = var_1_18;


	// From: Req1Batch98dependencies
	if (var_1_12 <= ((var_1_11 / var_1_4) & 8)) {
		if (-16 <= var_1_11) {
			if (var_1_12 != (var_1_11 / (min (var_1_4 , var_1_5)))) {
