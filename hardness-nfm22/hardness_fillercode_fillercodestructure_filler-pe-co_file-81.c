...
void step(void) {
	// From: Req5Batch81Filler_PE_CO
	var_1_16 = (last_1_var_1_17 - 1);


	// From: Req2Batch81Filler_PE_CO
	...
	// From: Req3Batch81Filler_PE_CO
	if (! var_1_9) {
		var_1_10 = (min (var_1_1 , var_1_5));
	}


	// From: Req4Batch81Filler_PE_CO
	if (var_1_8) {
		var_1_11 = ((max (var_1_12 , var_1_13)) - ((var_1_14 + var_1_15) - last_1_var_1_11));
	}


	// From: Req8Batch81Filler_PE_CO
	var_1_24 = var_1_12;


	// From: Req7Batch81Filler_PE_CO
	...
	if (var_1_17 > (var_1_11 & (~ var_1_33))) {
		if (((var_1_39 + var_1_40) - (max (var_1_41 , var_1_42))) > (abs (abs (var_1_43)))) {
			var_1_38 = (max (var_1_7 , (min (var_1_34 , var_1_37))));
		}
	} else {
		var_1_38 = (max (var_1_34 , (min (var_1_7 , (abs (var_1_1))))));
	}


	// From: CodeObject6
	if ((var_1_16 + var_1_33) > (var_1_24 ^ (abs (var_1_37)))) {
		var_1_44 = (2u + (max (var_1_16 , var_1_34)));
	}
