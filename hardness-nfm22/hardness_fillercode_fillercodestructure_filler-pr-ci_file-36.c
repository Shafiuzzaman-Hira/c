...
void step(void) {
	...
	// From: CodeObject7
	if (var_1_3 >= var_1_6) {
		var_1_46 = (max (var_1_10 , 4u));
	}


	// From: Req4Batch36Filler_PR_CI
	var_1_14 = var_1_6;


	// From: CodeObject4
	if (var_1_11 > var_1_10) {
		var_1_36 = (abs (min ((var_1_13 - var_1_3) , (var_1_39 + var_1_40))));
	} else {
		if (var_1_11 != var_1_9) {
	...
	// From: CodeObject5
	if (var_1_11 < ((min (var_1_11 , var_1_20)) / var_1_9)) {
	...
	if (((var_1_11 ^ 8) * var_1_10) <= var_1_21) {
		var_1_28 = (abs (min ((max (var_1_7 , var_1_13)) , var_1_13)));
	}


	// From: Req7Batch36Filler_PR_CI
	...
	// From: CodeObject6
	if (((min (var_1_10 , var_1_9)) >> (var_1_44 - 4u)) >= var_1_9) {
		var_1_43 = ((var_1_45 - (10000 - var_1_44)) - (abs (var_1_35)));
	} else {
		if ((max ((abs (var_1_35)) , var_1_10)) > var_1_9) {
			var_1_43 = 5;
		}
	}


	// From: Req8Batch36Filler_PR_CI
