...
void step(void) {
	...
	if ((var_1_16 ^ var_1_13) >= var_1_13) {
		var_1_24 = (max ((abs (var_1_13 + var_1_21)) , var_1_14));
	}
	...
	if (var_1_16 >= ((var_1_10 + var_1_20) % (32u + var_1_32))) {
		var_1_36 = (max ((min ((min (var_1_32 , var_1_20)) , (abs (var_1_21)))) , var_1_13));
	} else {
		var_1_36 = var_1_20;
	}
	...
	if (var_1_4) {
		...
		if (-4 < (~ var_1_18)) {
			...
			if (var_1_32 > var_1_17) {
				var_1_42 = (min (var_1_44 , var_1_35));
			}
		}
	}
	...
	// From: Req4Batch56Filler_PS_CI
	var_1_12 = ((64 + var_1_13) - var_1_14);


	// From: Req5Batch56Filler_PS_CI
	var_1_15 = ((var_1_16 - var_1_17) - 10);


	// From: Req6Batch56Filler_PS_CI
	if (var_1_1) {
		var_1_18 = (var_1_16 - var_1_13);
	}


	// From: Req7Batch56Filler_PS_CI
	...
	// From: Req2Batch56Filler_PS_CI
	if (var_1_4) {
		var_1_6 = (var_1_15 + (min (var_1_15 , var_1_18)));
	}


	// From: Req3Batch56Filler_PS_CI
