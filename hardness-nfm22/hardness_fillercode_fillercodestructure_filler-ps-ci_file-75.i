...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch75Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_25 ^ (var_1_28 + var_1_25)) <= (((((((var_1_23) < (var_1_23)) ? (var_1_23) : (var_1_23))) < 0 ) ? -((((var_1_23) < (var_1_23)) ? (var_1_23) : (var_1_23))) : ((((var_1_23) < (var_1_23)) ? (var_1_23) : (var_1_23)))))) {
  var_1_33 = (((((((((((var_1_18) < (var_1_4)) ? (var_1_18) : (var_1_4)))) < (var_1_5)) ? (((((var_1_18) < (var_1_4)) ? (var_1_18) : (var_1_4)))) : (var_1_5))) < 0 ) ? -((((((((var_1_18) < (var_1_4)) ? (var_1_18) : (var_1_4)))) < (var_1_5)) ? (((((var_1_18) < (var_1_4)) ? (var_1_18) : (var_1_4)))) : (var_1_5))) : ((((((((var_1_18) < (var_1_4)) ? (var_1_18) : (var_1_4)))) < (var_1_5)) ? (((((var_1_18) < (var_1_4)) ? (var_1_18) : (var_1_4)))) : (var_1_5)))));
 } else {
  if (var_1_5 >= ((((var_1_4) > ((var_1_18 * var_1_5))) ? (var_1_4) : ((var_1_18 * var_1_5))))) {
   if (var_1_11) {
    var_1_33 = var_1_20;
   }
  }
 ...
 if (var_1_25 != var_1_25) {
  var_1_46 = ((((((((((var_1_6) < (var_1_6)) ? (var_1_6) : (var_1_6))) < 0 ) ? -((((var_1_6) < (var_1_6)) ? (var_1_6) : (var_1_6))) : ((((var_1_6) < (var_1_6)) ? (var_1_6) : (var_1_6))))) < 0 ) ? -(((((((var_1_6) < (var_1_6)) ? (var_1_6) : (var_1_6))) < 0 ) ? -((((var_1_6) < (var_1_6)) ? (var_1_6) : (var_1_6))) : ((((var_1_6) < (var_1_6)) ? (var_1_6) : (var_1_6))))) : (((((((var_1_6) < (var_1_6)) ? (var_1_6) : (var_1_6))) < 0 ) ? -((((var_1_6) < (var_1_6)) ? (var_1_6) : (var_1_6))) : ((((var_1_6) < (var_1_6)) ? (var_1_6) : (var_1_6)))))));
 } else {
  var_1_46 = ((((4.6) > (((((var_1_6) > (var_1_20)) ? (var_1_6) : (var_1_20))))) ? (4.6) : (((((var_1_6) > (var_1_20)) ? (var_1_6) : (var_1_20))))));
 }
 if (var_1_14) {
  if (var_1_11) {
   if (! (((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17))) > (4.5f + var_1_17))) {
    var_1_47 = var_1_48;
   }
  } else {
   var_1_47 = var_1_48;
