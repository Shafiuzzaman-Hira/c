...
void step(void) {
	...
	if (stepLocal_25 || ((last_1_var_1_90 * var_1_15) == last_1_var_1_62)) {
		...
		var_1_90 = ((last_1_var_1_41 + var_1_40) + (min ((var_1_13 + var_1_12) , last_1_var_1_78)));
	}
	...
	if (var_1_14 <= stepLocal_23) {
		if (stepLocal_24 < (64 - var_1_4)) {
			...
			var_1_85 = (min (((var_1_43 - var_1_15) - last_1_var_1_42) , (max (var_1_6 , (min (last_1_var_1_48 , last_1_var_1_72))))));
		}
	}
	...
	if (! var_1_108) {
		var_1_69 = (max (var_1_15 , var_1_6));
	}


	// From: Req2Batch91Amount500
	var_1_7 = (abs ((max (0 , var_1_6)) - var_1_69));


	// From: Req18Batch91Amount500
	signed short int stepLocal_15 = var_1_7;
	if (stepLocal_15 <= var_1_43) {
		var_1_50 = ((var_1_51 - (min (var_1_40 , var_1_4))) - var_1_17);
	}


	// From: Req44Batch91Amount500
	if (var_1_108) {
		var_1_91 = (max ((max (var_1_45 , 99.75)) , (abs (var_1_26 + var_1_27))));
	}
	...
	if (! (63.9 > var_1_38)) {
		...
		if (((var_1_15 >> last_1_var_1_97) ^ 8) > (abs (var_1_10))) {
	...
	if (var_1_32) {
		...
		var_1_46 = ((min (var_1_15 , var_1_36)) - var_1_16);
	}
	...
	if (last_1_var_1_48 < stepLocal_14) {
		...
		var_1_48 = ((max (var_1_15 , var_1_36)) + var_1_16);
	}
	...
	if ((- 15.25f) >= var_1_55) {
		...
		var_1_57 = (var_1_39 - (max (var_1_5 , var_1_17)));
	}


	// From: Req36Batch91Amount500
	if (var_1_67) {
		var_1_80 = (max (var_1_15 , (max (var_1_4 , var_1_40))));
	} else {
	...
	var_1_86 = (abs (var_1_5));


	// From: Req42Batch91Amount500
	if ((var_1_5 >> (max (var_1_88 , var_1_89))) < 8) {
		var_1_87 = var_1_39;
	}
	...
	if ((max (var_1_19 , (min (var_1_45 , var_1_56)))) <= var_1_26) {
		var_1_71 = (! var_1_31);
	} else {
	...
	if (var_1_28) {
		var_1_93 = (min (var_1_5 , var_1_40));
	} else {
		if (var_1_107 > ((- var_1_99) ^ (- var_1_24))) {
			var_1_93 = (max (var_1_36 , (var_1_39 - var_1_17)));
		} else {
			var_1_93 = (10 + 100);
		}
	}
	...
	if (var_1_94 >= stepLocal_21) {
		var_1_81 = (max (var_1_15 , (var_1_36 + var_1_40)));
	} else {
		var_1_81 = (max ((var_1_4 - (var_1_40 + var_1_16)) , var_1_6));
	}
	...
	if (var_1_36 < (32 - var_1_15)) {
		...
		var_1_82 = ((min (var_1_19 , var_1_55)) - var_1_54);
	}
	...
	signed long int stepLocal_22 = min (var_1_40 , 5);
	if (var_1_41 >= stepLocal_22) {
		if (var_1_31) {
			...
			var_1_84 = (var_1_17 - (max ((var_1_40 + var_1_16) , var_1_15)));
		}
	}
		...
		if (stepLocal_8 && (var_1_91 > (var_1_20 * var_1_26))) {
			...
			if (stepLocal_9 != (var_1_50 * var_1_23)) {
				if (stepLocal_7 && var_1_32) {
					...
					var_1_33 = (var_1_24 - (max (var_1_81 , var_1_16)));
				}
			} else {
	...
	if (stepLocal_3 >= (max (var_1_33 , -128))) {
	...
	var_1_58 = ((max (var_1_39 , (var_1_59 + var_1_60))) - var_1_21);


	// From: Req32Batch91Amount500
	if ((min (var_1_98 , var_1_56)) != (var_1_18 * var_1_53)) {
		var_1_73 = var_1_21;
	}
	...
	if ((min (var_1_80 , (var_1_5 / var_1_4))) < stepLocal_1) {
	...
	if (! ((var_1_41 + var_1_59) >= last_1_var_1_76)) {
		if (var_1_46 <= stepLocal_20) {
			...
			var_1_76 = (min (((var_1_85 + var_1_40) + var_1_50) , var_1_51));
		}
	} else {
		var_1_76 = (max ((var_1_50 + var_1_93) , var_1_21));
	}


	// From: Req25Batch91Amount500
	if (var_1_20 < (var_1_91 / (min (var_1_53 , var_1_38)))) {
		var_1_64 = (min ((abs (9.5f)) , (var_1_54 - var_1_56)));
	} else {
		if ((~ (- 100)) > var_1_9) {
			if (var_1_56 <= (10.5f - (var_1_65 - var_1_53))) {
				var_1_64 = (min (var_1_27 , 8.8f));
			}
		} else {
			if (((var_1_17 / var_1_39) << var_1_69) >= var_1_16) {
				var_1_64 = (abs (max (var_1_26 , (min (5.4f , var_1_54)))));
			} else {
	...
	if (stepLocal_26 >= var_1_59) {
		var_1_92 = (min ((max (var_1_9 , var_1_33)) , var_1_1));
	} else {
		if (var_1_98 >= (abs (var_1_19))) {
			var_1_92 = (max (((var_1_39 - var_1_51) - var_1_1) , var_1_89));
		} else {
			var_1_92 = (var_1_58 + (max (var_1_4 , 16u)));
		}
	}
	...
	if (var_1_31 || var_1_32) {
		if (var_1_20 <= (var_1_53 - (max (var_1_56 , var_1_19)))) {
			var_1_78 = (min (var_1_17 , var_1_76));
		} else {
			var_1_78 = (var_1_9 + var_1_36);
		}
	} else {
		var_1_78 = (min (var_1_9 , (min (var_1_51 , var_1_1))));
	}
	...
	if (! var_1_31) {
		...
		var_1_63 = ((max (var_1_9 , (var_1_15 + var_1_78))) - var_1_17);
	}
	...
	if (stepLocal_16 > var_1_36) {
		var_1_52 = (((var_1_53 - var_1_54) - var_1_55) + (min (4.375f , (var_1_56 - 256.9f))));
	} else {
		if ((max (var_1_27 , var_1_64)) == (min (var_1_38 , var_1_91))) {
			var_1_52 = var_1_26;
		}
	}
	...
	if (var_1_108) {
		if (var_1_20 > (- (7.2f * var_1_25))) {
			if ((var_1_53 - var_1_54) >= ((max (var_1_26 , var_1_20)) + 15.5f)) {
				var_1_61 = (min (var_1_5 , (var_1_4 - (1945860689 - var_1_92))));
			} else {
				var_1_61 = (var_1_41 + -5);
			}
		}
	...
	if (stepLocal_18 == var_1_92) {
		var_1_70 = (min ((35033 - 5) , var_1_40));
	} else {
		var_1_70 = (max ((max (var_1_86 , (var_1_36 + var_1_100))) , ((min (var_1_17 , var_1_16)) + var_1_69)));
	}
}
...
int property() {
	return (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((var_1_85 != var_1_103) ? (var_1_1 == ((unsigned char) (var_1_4 - var_1_5))) : (var_1_1 == ((unsigned char) ((max (50 , var_1_5)) + var_1_6)))) && (var_1_7 == ((signed short int) (abs ((max (0 , var_1_6)) - var_1_69))))) && (((min (var_1_80 , (var_1_5 / var_1_4))) < (var_1_41 * (var_1_6 + var_1_49))) ? ((var_1_49 < (var_1_75 - var_1_5)) ? (var_1_9 == ((signed char) (min (var_1_10 , (min ((min (var_1_11 , var_1_12)) , var_1_13)))))) : 1) : (var_1_9 == ((signed char) (var_1_14 - ((min (var_1_15 , 64)) - (var_1_16 - var_1_17))))))) && ((((var_1_46 / var_1_4) ^ var_1_6) > (var_1_10 | (var_1_14 / var_1_15))) ? (var_1_18 == ((float) (var_1_19 - var_1_20))) : (var_1_18 == ((float) var_1_20)))) && (((var_1_95 + var_1_17) >= (max (var_1_33 , -128))) ? (var_1_21 == ((unsigned long int) ((var_1_23 - var_1_95) + (var_1_5 + var_1_93)))) : (((var_1_15 / var_1_4) < var_1_94) ? (var_1_21 == ((unsigned long int) (var_1_93 + 4u))) : (var_1_21 == ((unsigned long int) (var_1_24 - var_1_95)))))) && (var_1_25 == ((double) (var_1_26 + var_1_27)))) && ((var_1_16 <= 16) ? (var_1_106 ? (((var_1_20 - var_1_19) == var_1_18) ? (var_1_28 == ((unsigned char) (! var_1_30))) : (var_1_30 ? (var_1_28 == ((unsigned char) var_1_31)) : (var_1_28 == ((unsigned char) var_1_32)))) : 1) : 1)) && ((var_1_32 || var_1_30) ? (var_1_33 == ((unsigned long int) (var_1_4 + (var_1_50 + var_1_5)))) : ((var_1_30 && (var_1_91 > (var_1_20 * var_1_26))) ? (var_1_33 == ((unsigned long int) var_1_6)) : (((var_1_4 - 5) != (var_1_50 * var_1_23)) ? (((var_1_10 <= var_1_86) && var_1_32) ? (var_1_33 == ((unsigned long int) 4u)) : (var_1_33 == ((unsigned long int) (var_1_24 - (max (var_1_81 , var_1_16)))))) : (var_1_33 == ((unsigned long int) (var_1_34 - (var_1_17 + var_1_15)))))))) && ((var_1_66 || var_1_31) ? (var_1_35 == ((signed char) (-16 + var_1_16))) : (var_1_35 == ((signed char) (min ((var_1_15 - (var_1_36 - var_1_17)) , 10)))))) && ((((var_1_19 - var_1_20) / var_1_38) < (- var_1_27)) ? (var_1_37 == ((signed char) (((abs (var_1_39)) - (var_1_17 + var_1_40)) - var_1_16))) : (var_1_37 == ((signed char) (var_1_16 + var_1_17))))) && ((var_1_17 < var_1_102) ? (var_1_41 == ((signed long int) (var_1_16 - var_1_5))) : 1)) && ((! (63.9 > var_1_38)) ? ((var_1_6 < (var_1_39 * last_1_var_1_42)) ? (var_1_42 == ((signed long int) (max (var_1_15 , var_1_4)))) : (var_1_42 == ((signed long int) var_1_12))) : ((((var_1_15 >> last_1_var_1_97) ^ 8) > (abs (var_1_10))) ? (((last_1_var_1_49 + last_1_var_1_97) < last_1_var_1_97) ? ((last_1_var_1_69 > 32) ? (var_1_42 == ((signed long int) var_1_6)) : (var_1_42 == ((signed long int) ((var_1_15 + last_1_var_1_97) + var_1_14)))) : (var_1_42 == ((signed long int) (var_1_4 - (var_1_6 + (var_1_40 + var_1_36)))))) : (var_1_42 == ((signed long int) (var_1_16 - (var_1_43 - last_1_var_1_69))))))) && ((var_1_7 < (~ (var_1_36 - var_1_16))) ? (var_1_44 == ((float) (127.75f + (9.999999999975E10f + var_1_45)))) : (var_1_44 == ((float) var_1_27)))) && (var_1_32 ? (var_1_46 == ((signed char) var_1_16)) : (var_1_46 == ((signed char) ((min (var_1_15 , var_1_36)) - var_1_16))))) && (((var_1_23 << var_1_42) != var_1_107) ? (var_1_47 == ((double) (var_1_26 + var_1_45))) : 1)) && ((last_1_var_1_48 < var_1_4) ? (var_1_48 == ((unsigned char) (var_1_39 - (var_1_36 - var_1_40)))) : (var_1_48 == ((unsigned char) ((max (var_1_15 , var_1_36)) + var_1_16))))) && ((var_1_32 && ((var_1_19 - var_1_20) == 1.6f)) ? ((var_1_90 <= var_1_43) ? (var_1_49 == ((unsigned char) (var_1_4 - (var_1_40 + var_1_16)))) : 1) : (var_1_49 == ((unsigned char) (min (var_1_6 , var_1_17)))))) && ((var_1_7 <= var_1_43) ? (var_1_50 == ((signed short int) ((var_1_51 - (min (var_1_40 , var_1_4))) - var_1_17))) : 1)) && ((var_1_9 > var_1_36) ? (var_1_52 == ((float) (((var_1_53 - var_1_54) - var_1_55) + (min (4.375f , (var_1_56 - 256.9f)))))) : (((max (var_1_27 , var_1_64)) == (min (var_1_38 , var_1_91))) ? (var_1_52 == ((float) var_1_26)) : 1))) && (((- 15.25f) >= var_1_55) ? (var_1_57 == ((unsigned char) (var_1_4 - var_1_16))) : (var_1_57 == ((unsigned char) (var_1_39 - (max (var_1_5 , var_1_17))))))) && (var_1_58 == ((unsigned short int) ((max (var_1_39 , (var_1_59 + var_1_60))) - var_1_21)))) && (var_1_108 ? ((var_1_20 > (- (7.2f * var_1_25))) ? (((var_1_53 - var_1_54) >= ((max (var_1_26 , var_1_20)) + 15.5f)) ? (var_1_61 == ((signed long int) (min (var_1_5 , (var_1_4 - (1945860689 - var_1_92)))))) : (var_1_61 == ((signed long int) (var_1_41 + -5)))) : 1) : 1)) && ((var_1_75 > ((var_1_39 + var_1_16) ^ -2)) ? (var_1_62 == ((unsigned short int) var_1_36)) : 1)) && ((! var_1_31) ? (var_1_63 == ((signed long int) (256 - 4))) : (var_1_63 == ((signed long int) ((max (var_1_9 , (var_1_15 + var_1_78))) - var_1_17))))) && ((var_1_20 < (var_1_91 / (min (var_1_53 , var_1_38)))) ? (var_1_64 == ((float) (min ((abs (9.5f)) , (var_1_54 - var_1_56))))) : (((~ (- 100)) > var_1_9) ? ((var_1_56 <= (10.5f - (var_1_65 - var_1_53))) ? (var_1_64 == ((float) (min (var_1_27 , 8.8f)))) : 1) : ((((var_1_17 / var_1_39) << var_1_69) >= var_1_16) ? (var_1_64 == ((float) (abs (max (var_1_26 , (min (5.4f , var_1_54))))))) : (var_1_64 == ((float) (var_1_56 - var_1_54))))))) && ((! var_1_106) ? (var_1_66 == ((unsigned char) (! var_1_31))) : (var_1_66 == ((unsigned char) ((var_1_32 || var_1_30) || var_1_67))))) && ((((var_1_55 - var_1_53) < var_1_82) || var_1_30) ? (var_1_71 ? (var_1_68 == ((unsigned char) (var_1_30 || (var_1_32 || (! var_1_31))))) : (var_1_68 == ((unsigned char) ((var_1_86 < (~ var_1_42)) && var_1_30)))) : (var_1_68 == ((unsigned char) ((var_1_6 <= var_1_7) || (! var_1_67)))))) && ((! var_1_108) ? (var_1_69 == ((unsigned char) (max (var_1_15 , var_1_6)))) : 1)) && ((var_1_40 == var_1_92) ? (var_1_70 == ((unsigned short int) (min ((35033 - 5) , var_1_40)))) : (var_1_70 == ((unsigned short int) (max ((max (var_1_86 , (var_1_36 + var_1_100))) , ((min (var_1_17 , var_1_16)) + var_1_69))))))) && (((max (var_1_19 , (min (var_1_45 , var_1_56)))) <= var_1_26) ? (var_1_71 == ((unsigned char) (! var_1_31))) : (var_1_71 == ((unsigned char) ((last_1_var_1_71 && (var_1_103 != var_1_17)) || var_1_31))))) && (var_1_68 ? ((var_1_32 || var_1_68) ? (var_1_72 == ((unsigned char) var_1_17)) : 1) : 1)) && (((min (var_1_98 , var_1_56)) != (var_1_18 * var_1_53)) ? (var_1_73 == ((signed short int) var_1_21)) : 1)) && (var_1_75 == ((signed short int) var_1_101))) && ((! ((var_1_41 + var_1_59) >= last_1_var_1_76)) ? ((var_1_46 <= var_1_46) ? (var_1_76 == ((unsigned short int) var_1_36)) : (var_1_76 == ((unsigned short int) (min (((var_1_85 + var_1_40) + var_1_50) , var_1_51))))) : (var_1_76 == ((unsigned short int) (max ((var_1_50 + var_1_93) , var_1_21)))))) && ((var_1_31 || var_1_32) ? ((var_1_20 <= (var_1_53 - (max (var_1_56 , var_1_19)))) ? (var_1_78 == ((unsigned short int) (min (var_1_17 , var_1_76)))) : (var_1_78 == ((unsigned short int) (var_1_9 + var_1_36)))) : (var_1_78 == ((unsigned short int) (min (var_1_9 , (min (var_1_51 , var_1_1)))))))) && (var_1_67 ? (var_1_80 == ((unsigned char) (max (var_1_15 , (max (var_1_4 , var_1_40)))))) : (var_1_80 == ((unsigned char) (var_1_39 - var_1_36))))) && ((var_1_94 >= var_1_40) ? (var_1_81 == ((unsigned char) (max (var_1_15 , (var_1_36 + var_1_40))))) : (var_1_81 == ((unsigned char) (max ((var_1_4 - (var_1_40 + var_1_16)) , var_1_6)))))) && ((var_1_36 < (32 - var_1_15)) ? (((var_1_108 || var_1_28) && var_1_28) ? (var_1_82 == ((float) (var_1_54 - var_1_56))) : 1) : (var_1_82 == ((float) ((min (var_1_19 , var_1_55)) - var_1_54))))) && ((var_1_41 >= (min (var_1_40 , 5))) ? (var_1_31 ? ((var_1_18 > (var_1_54 - var_1_20)) ? (var_1_84 == ((signed char) var_1_12)) : 1) : (var_1_84 == ((signed char) (var_1_17 - (max ((var_1_40 + var_1_16) , var_1_15)))))) : 1)) && ((var_1_14 <= var_1_59) ? (((last_1_var_1_48 ^ last_1_var_1_90) < (64 - var_1_4)) ? (var_1_85 == ((signed long int) (-25 + (var_1_40 - 10)))) : (var_1_85 == ((signed long int) (min (((var_1_43 - var_1_15) - last_1_var_1_42) , (max (var_1_6 , (min (last_1_var_1_48 , last_1_var_1_72))))))))) : 1)) && (var_1_86 == ((unsigned char) (abs (var_1_5))))) && (((var_1_5 >> (max (var_1_88 , var_1_89))) < 8) ? (var_1_87 == ((signed char) var_1_39)) : 1)) && (((last_1_var_1_41 < var_1_4) || ((last_1_var_1_90 * var_1_15) == last_1_var_1_62)) ? (last_1_var_1_106 ? (var_1_90 == ((signed short int) (var_1_88 + var_1_17))) : 1) : (var_1_90 == ((signed short int) ((last_1_var_1_41 + var_1_40) + (min ((var_1_13 + var_1_12) , last_1_var_1_78))))))) && (var_1_108 ? (var_1_91 == ((double) (max ((max (var_1_45 , 99.75)) , (abs (var_1_26 + var_1_27)))))) : 1)) && ((var_1_57 >= var_1_59) ? (var_1_92 == ((unsigned long int) (min ((max (var_1_9 , var_1_33)) , var_1_1)))) : ((var_1_98 >= (abs (var_1_19))) ? (var_1_92 == ((unsigned long int) (max (((var_1_39 - var_1_51) - var_1_1) , var_1_89)))) : (var_1_92 == ((unsigned long int) (var_1_58 + (max (var_1_4 , 16u)))))))) && (var_1_28 ? (var_1_93 == ((unsigned char) (min (var_1_5 , var_1_40)))) : ((var_1_107 > ((- var_1_99) ^ (- var_1_24))) ? (var_1_93 == ((unsigned char) (max (var_1_36 , (var_1_39 - var_1_17))))) : (var_1_93 == ((unsigned char) (10 + 100)))))) && (var_1_106 ? (((var_1_47 == var_1_47) && var_1_31) ? (var_1_94 == ((signed long int) 4)) : (var_1_94 == ((signed long int) var_1_69))) : 1)) && (var_1_32 ? (var_1_95 == ((signed short int) var_1_10)) : 1)) && (var_1_96 == ((unsigned short int) var_1_16))) && (var_1_97 == ((signed char) var_1_39))) && (var_1_98 == ((double) var_1_26))) && (var_1_99 == ((unsigned char) var_1_4))) && (var_1_100 == ((signed char) var_1_11))) && (var_1_68 ? (var_1_101 == ((signed short int) var_1_13)) : (var_1_101 == ((signed short int) last_1_var_1_101)))) && (var_1_108 ? (var_1_102 == ((unsigned long int) var_1_99)) : (var_1_102 == ((unsigned long int) var_1_34)))) && (var_1_103 == ((unsigned short int) var_1_99))) && (var_1_106 ? (var_1_104 == ((unsigned short int) 2)) : 1)) && (var_1_30 ? (var_1_105 == ((unsigned short int) last_1_var_1_105)) : 1)) && (var_1_30 ? (var_1_106 == ((unsigned char) var_1_32)) : (var_1_106 == ((unsigned char) var_1_31)))) && (var_1_106 ? (var_1_107 == ((unsigned char) var_1_40)) : (var_1_107 == ((unsigned char) var_1_4)))) && ((last_1_var_1_42 >= (var_1_16 - var_1_89)) ? ((last_1_var_1_63 > last_1_var_1_87) ? (var_1_108 == ((unsigned char) (! (var_1_32 || var_1_67)))) : (var_1_108 == ((unsigned char) var_1_32))) : (var_1_108 == ((unsigned char) var_1_32)))
;
}
int main(void) {
	isInitial = 1;
