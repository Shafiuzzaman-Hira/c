...
void step(void) {
 ...
 if (stepLocal_0 >= WrapperStruct00.var_1_15) {
  WrapperStruct00.var_1_1 = ((((WrapperStruct00.var_1_3) < (((((1) < 0 ) ? -(1) : (1))))) ? (WrapperStruct00.var_1_3) : (((((1) < 0 ) ? -(1) : (1))))));
 }
 unsigned char stepLocal_2 = WrapperStruct00.var_1_3;
 if (WrapperStruct00.var_1_9) {
  if (stepLocal_2 > WrapperStruct00.var_1_15) {
   WrapperStruct00.var_1_11 = ((((((((WrapperStruct00.var_1_12) > (16.5)) ? (WrapperStruct00.var_1_12) : (16.5)))) > (WrapperStruct00.var_1_13)) ? (((((WrapperStruct00.var_1_12) > (16.5)) ? (WrapperStruct00.var_1_12) : (16.5)))) : (WrapperStruct00.var_1_13)));
  } else {
 ...
 signed long int stepLocal_1 = (((10) > (WrapperStruct00.var_1_1)) ? (10) : (WrapperStruct00.var_1_1));
 if ((8 * WrapperStruct00.var_1_1) == stepLocal_1) {
  if (WrapperStruct00.var_1_6) {
   ...
   if (WrapperStruct00.var_1_14 >= ((((WrapperStruct00.var_1_11) < 0 ) ? -(WrapperStruct00.var_1_11) : (WrapperStruct00.var_1_11)))) {
