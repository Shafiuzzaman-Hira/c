...
void step(void) {
	...
	// From: CodeObject3
	if ((abs (var_1_21)) <= (- 15.25)) {
		var_1_27 = (min ((abs (var_1_28)) , ((var_1_29 + 128) + 10)));
	}


	// From: CodeObject4
	if ((abs (min (var_1_22 , var_1_21))) >= (var_1_31 - (abs (var_1_32)))) {
		if (var_1_26) {
			var_1_30 = (abs (var_1_33));
		} else {
			var_1_30 = (abs (max ((max (10u , var_1_33)) , var_1_34)));
		}
	} else {
		var_1_30 = (abs (min (var_1_34 , var_1_33)));
	}
	...
	if (var_1_32 > var_1_22) {
		var_1_41 = (abs (var_1_42 - (max (var_1_36 , var_1_35))));
	} else {
		var_1_41 = (abs (var_1_40 + (abs (var_1_37))));
	}


	// From: CodeObject8
	if ((var_1_22 * (abs (var_1_21))) < (var_1_31 - var_1_44)) {
		if (var_1_21 < (- var_1_31)) {
			var_1_43 = ((min (var_1_42 , var_1_45)) - (max (var_1_40 , 256u)));
		} else {
			if (var_1_40 >= (var_1_34 >> var_1_39)) {
				var_1_43 = (min (var_1_36 , var_1_40));
			}
		}
	} else {
	...
	// From: CodeObject9
	if ((abs (var_1_40)) > var_1_36) {
		var_1_46 = var_1_33;
	} else {
		if (var_1_36 >= var_1_35) {
			if (var_1_41 >= var_1_33) {
				var_1_46 = (abs (var_1_35));
			}
		} else {
	...
	// From: CodeObject10
	if (0 <= var_1_30) {
		var_1_47 = (abs (min (var_1_40 , var_1_39)));
	}


	// From: Req6Batch76PS_CN_100
	if (var_1_2) {
