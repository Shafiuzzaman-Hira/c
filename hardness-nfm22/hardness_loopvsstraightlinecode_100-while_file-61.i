...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch61100_while.c", 13, "reach_error"); }
...
void step(void) {
 ...
 unsigned long int stepLocal_4 = (((0u) < (((((last_1_var_1_7) > (last_1_var_1_24)) ? (last_1_var_1_7) : (last_1_var_1_24))))) ? (0u) : (((((last_1_var_1_7) > (last_1_var_1_24)) ? (last_1_var_1_7) : (last_1_var_1_24)))));
 ...
 if (var_1_22 <= ((((var_1_21) < (var_1_25)) ? (var_1_21) : (var_1_25)))) {
  var_1_24 = (((((var_1_26 - ((((last_1_var_1_24) < (var_1_12)) ? (last_1_var_1_24) : (var_1_12))))) > (last_1_var_1_7)) ? ((var_1_26 - ((((last_1_var_1_24) < (var_1_12)) ? (last_1_var_1_24) : (var_1_12))))) : (last_1_var_1_7)));
 } else {
  if ((last_1_var_1_24 + (last_1_var_1_18 / 16)) < stepLocal_6) {
   var_1_24 = (((((((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12)))) < (last_1_var_1_24)) ? (((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12)))) : (last_1_var_1_24))) + (((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28))) - (last_1_var_1_7 + 2)));
  }
 }
 if ((last_1_var_1_7 >> var_1_2) >= (((((var_1_8) < (var_1_9)) ? (var_1_8) : (var_1_9))) - ((((last_1_var_1_24) < (last_1_var_1_24)) ? (last_1_var_1_24) : (last_1_var_1_24))))) {
  var_1_7 = var_1_12;
 } else {
  var_1_7 = var_1_12;
 }
 if (((((var_1_21) < (var_1_22)) ? (var_1_21) : (var_1_22))) >= (- 9.5)) {
  var_1_20 = var_1_7;
 }
 var_1_1 = (var_1_2 - 8u);
 ...
 if (stepLocal_0 > 16u) {
  if (var_1_14 < stepLocal_1) {
   var_1_13 = ((((((((var_1_7) > (var_1_2)) ? (var_1_7) : (var_1_2)))) > (((var_1_15 - var_1_23) - var_1_24))) ? (((((var_1_7) > (var_1_2)) ? (var_1_7) : (var_1_2)))) : (((var_1_15 - var_1_23) - var_1_24))));
  }
 } else {
  var_1_13 = ((((var_1_24) < (var_1_7)) ? (var_1_24) : (var_1_7)));
 }
 if (var_1_12 >= var_1_7) {
  var_1_16 = var_1_17;
 }
 ...
 if ((last_1_var_1_30 / var_1_26) != stepLocal_8) {
  if (var_1_23 <= stepLocal_7) {
   var_1_30 = ((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28)));
  } else {
 ...
 if (var_1_8 > stepLocal_2) {
  var_1_18 = (((((-32) > (var_1_12)) ? (-32) : (var_1_12))) + ((((var_1_20) < (last_1_var_1_18)) ? (var_1_20) : (last_1_var_1_18))));
 } else {
  if (var_1_3) {
   var_1_18 = var_1_12;
  } else {
