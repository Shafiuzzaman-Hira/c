...
int property() {
	return ((((var_1_2 || ((~ var_1_10) >= var_1_10)) ? ((var_1_10 < var_1_8) ? ((! var_1_6) ? (var_1_1 == ((signed char) var_1_7)) : 1) : (var_1_1 == ((signed char) 2))) : (var_1_1 == ((signed char) var_1_7))) && (var_1_2 ? (var_1_8 == ((unsigned long int) ((1514707036u + (abs (var_1_9))) - last_1_var_1_10))) : (var_1_8 == ((unsigned long int) (max (last_1_var_1_10 , var_1_9)))))) && (var_1_2 ? (var_1_10 == ((signed long int) (var_1_8 + (abs (var_1_7))))) : 1)) && ((var_1_1 >= var_1_1) ? (var_1_11 == ((signed long int) (var_1_12 - (max ((var_1_13 + var_1_14) , var_1_15))))) : (var_1_11 == ((signed long int) (max (var_1_14 , var_1_13)))))
;
}
int main(void) {
	isInitial = 1;
