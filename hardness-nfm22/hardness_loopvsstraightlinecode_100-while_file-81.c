...
void reach_error() { __assert_fail("0", "Req1_Prop1_Batch81100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch81100_while
	if (! var_1_20) {
		var_1_8 = (max (var_1_9 , var_1_10));
	}


	// From: Req3Batch81100_while
	...
	// From: Req5Batch81100_while
	var_1_18 = var_1_19;


	// From: Req7Batch81100_while
	var_1_22 = ((min (0 , var_1_23)) + var_1_24);


	// From: Req9Batch81100_while
