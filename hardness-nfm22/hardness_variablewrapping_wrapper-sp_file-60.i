...
void step(void) {
 ...
 if ((*(WrapperStruct00_var_1_2_Pointer)) > last_1_WrapperStruct00_var_1_16) {
  if ((*(WrapperStruct00_var_1_9_Pointer))) {
   if ((*(WrapperStruct00_var_1_3_Pointer)) <= ((((last_1_WrapperStruct00_var_1_16) < ((*(WrapperStruct00_var_1_11_Pointer)))) ? (last_1_WrapperStruct00_var_1_16) : ((*(WrapperStruct00_var_1_11_Pointer)))))) {
