...
void reach_error() { __assert_fail("0", "aws_hash_table_create_harness.i", 208, "reach_error"); }
extern void abort(void);
...
void aws_hash_table_create_harness() {
   ...
   _Bool 
    ...
    int rval = aws_hash_table_create(&map, key, get_p_elem ? &p_elem : 
                                                                      ((void *)0)
                                                                          , track_was_created ? &was_created : 
                                                                                                               ((void *)0)
                                                                                                                   );
    __VERIFIER_assert(!(aws_hash_table_is_valid(&map)));
    if (rval == (0)) {
...
int main() { aws_hash_table_create_harness(); return 0; }
