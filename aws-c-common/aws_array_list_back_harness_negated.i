...
void reach_error() { __assert_fail("0", "aws_array_list_back_harness.i", 208, "reach_error"); }
extern void abort(void);
...
void aws_array_list_back_harness() {
    ...
    if (aws_array_list_back(&list, val) == (0)) {
...
int main() { aws_array_list_back_harness(); return 0; }
