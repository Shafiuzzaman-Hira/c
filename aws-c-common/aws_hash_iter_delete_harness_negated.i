...
void reach_error() { __assert_fail("0", "aws_hash_iter_delete_harness.i", 208, "reach_error"); }
extern void abort(void);
...
void aws_hash_iter_delete_harness() {
    ...
    assume_abort_if_not(aws_hash_table_is_valid(&map));
    assume_abort_if_not(map.p_impl->destroy_key_fn == hash_proof_destroy_noop || !map.p_impl->destroy_key_fn);
    assume_abort_if_not(map.p_impl->destroy_value_fn == hash_proof_destroy_noop || !map.p_impl->destroy_value_fn);
...
int main() { aws_hash_iter_delete_harness(); return 0; }
