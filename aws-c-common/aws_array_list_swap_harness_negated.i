...
void aws_array_list_swap_harness() {
    ...
    assume_abort_if_not(index_a < aws_array_list_length(&list));
    assume_abort_if_not(index_b < aws_array_list_length(&list));
...
int main() { aws_array_list_swap_harness(); return 0; }
