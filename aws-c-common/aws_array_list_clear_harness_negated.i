...
void reach_error() { __assert_fail("0", "aws_array_list_clear_harness.i", 208, "reach_error"); }
extern void abort(void);
...
void aws_array_list_clear_harness() {
    ...
    __VERIFIER_assert(!(list.data == old.data));
}
int main() { aws_array_list_clear_harness(); return 0; }
