...
void reach_error() { __assert_fail("0", "aws_hash_table_move_harness.i", 208, "reach_error"); }
extern void abort(void);
...
void aws_hash_table_move_harness() {
    ...
    ensure_allocated_hash_table(&from, 
                                      (18446744073709551615UL)
                                              );
    assume_abort_if_not(aws_hash_table_is_valid(&from));
...
int main() { aws_hash_table_move_harness(); return 0; }
