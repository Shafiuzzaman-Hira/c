...
void reach_error() { __assert_fail("0", "aws_linked_list_pop_back_harness.i", 208, "reach_error"); }
extern void abort(void);
...
void aws_linked_list_pop_back_harness() {
   ...
   ((void *)0)
    ...
    __VERIFIER_assert(!(list.tail.prev == old_prev_last));
}
int main() { aws_linked_list_pop_back_harness(); return 0; }
