...
void reach_error() { __assert_fail("0", "aws_linked_list_prev_harness.i", 208, "reach_error"); }
extern void abort(void);
...
void aws_linked_list_prev_harness() {
    ...
    __VERIFIER_assert(!(aws_linked_list_node_prev_is_valid(&node)));
    __VERIFIER_assert(!(aws_linked_list_node_next_is_valid(rval)));
    __VERIFIER_assert(!(rval == &before));
}
int main() { aws_linked_list_prev_harness(); return 0; }
