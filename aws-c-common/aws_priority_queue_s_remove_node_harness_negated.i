...
void reach_error() { __assert_fail("0", "aws_priority_queue_s_remove_node_harness.i", 208, "reach_error"); }
extern void abort(void);
...
void aws_priority_queue_s_remove_node_harness() {
    ...
    if (__CPROVER_file_local_priority_queue_c_s_remove_node(&queue, item, index) == (0)) {
        ...
        if (queue.backpointers.data) {
            ...
            if (node) {
                ...
                __VERIFIER_assert(node->current_index == 
               (18446744073709551615UL)
               );
            }
        }
...
int main() { aws_priority_queue_s_remove_node_harness(); return 0; }
