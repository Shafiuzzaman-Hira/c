...
void reach_error() { __assert_fail("0", "aws_hash_string_harness.i", 208, "reach_error"); }
extern void abort(void);
...
void aws_hash_string_harness() {
    struct aws_string *str = ensure_string_is_allocated_bounded_length(32);
    uint64_t rval = aws_hash_string(str);
}
int main() { aws_hash_string_harness(); return 0; }
